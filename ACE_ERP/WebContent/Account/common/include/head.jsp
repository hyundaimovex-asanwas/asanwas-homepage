...
<%//회계용... %>
<link href="<%=dirPath%>/Account/common/css/common.css" rel="stylesheet" type="text/css">

<%//회계용... %>
	<script language="javascript" src="<%=dirPath%>/Account/common/include/PubFun.js"></script>
	<script language="javascript" src="<%=dirPath%>/Account/common/include/Account.js"></script>
