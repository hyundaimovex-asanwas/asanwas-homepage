	  ...
	  if (gcds_mst.countrow<1){  
		...
		if (gcds_dtl.countrow<1){                   
			var s_temp = "FDCODE:STRING,FSDAT:STRING,FSNBR:STRING,FSSEQ:STRING,ATCODE:STRING,"
								 ...
								 + "BGTDIV:STRING,FUNDDIV:STRING,BANJAEREF:STRING,LASTREF:STRING,BANJAEMOD:STRING";
...
function ln_PrtSetDataHeader(){
	if(gcds_print.countrow<1){
		var s_temp = "FDCODE:STRING,FSDAT:STRING,FSNBR:STRING,FSSEQ:STRING,ATCODE:STRING,"
							 ...
							 + "CHASUM:STRING,DAESUM:STRING,C1:STRING,C2:STRING,C3:STRING,C4:STRING,C5:STRING";
...
<B>id=Footer ,left=0 ,top=1500 ,right=2871 ,bottom=2000 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='C5', left=1326, top=273, right=1471, bottom=384, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='C3', left=2249, top=98, right=2429, bottom=143, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='C1', left=1865, top=98, right=2045, bottom=143, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='C2', left=2058, top=98, right=2238, bottom=143, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
">
</object></comment><script>__ws__(__NSID__);</script> 
