...
<!---------------------------------------------------------------------------
+ 시 스 템 명	:  거래처담당자관리 - 거래처코드	
+ 프로그램 ID	:  A010047_poopup.html
+ 기 능 정 의	:  거래처코드 팝업창
+ 작   성  자	:   정하나
+ 작 성 일 자	:  2009.06.23
-----------------------------------------------------------------------------
		...
		<td class="tab21" colspan="3">
			<comment id="__NSID__"><object  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp style="width:476;height:239px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
			  ...
			  <PARAM NAME="Format"		 VALUE="  
					...
					<C>ID=VEND_ID,		 Name='사업자번호',		width=120,	HeadBgColor=#B9D4DC, align=center,    mask={decode(VEND_ID_LEN,10,'XXX-XX-XXXXXX',13,'XXXXXX-XXXXXXX')} ,Edit=none sort=true</C>
