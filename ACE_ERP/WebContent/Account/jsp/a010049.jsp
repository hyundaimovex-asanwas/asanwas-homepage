...
******************************************************************************/
function ln_Query(){
  gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a010049_s2?v_str1=" + gcem_regno.text //사업자 등록번호 
	                                                      +"&v_str2="+gs_userid//
...
<script language=JavaScript for=gcgd_data event=OnCloseUp(row,colid)>
     ...
     gs_comname_s = "현대아산주식회사(고성본사)";   //현대아산주식회사(지점 서울)
     gs_comname_g = "현대아산주식회사(고성본사)";   //현대아산주식회사(본사 고성)  
				...
				<comment id="__NSID__">
					<object classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_data style="WIDTH:874px;HEIGHT:377px;border:1 solid #777777;display:block;">
  					...
  					<PARAM NAME="Format"			  VALUE="  		
						<C> Name='사업자등록번호'	  ID=FND_REGNO	             HeadAlign=Center HeadBgColor=#B9D4DC Width=90	align=center   EditStyle=Combo	Data='2218113834:221-81-13834' </C>
						<C> Name='사업장명'		      ID=FND_REGNO_NAME 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=180	align=left		  BgColor='#C1FFFF'  edit=none </C>
						<C> Name='사번'   		          ID=FND_USER 	             HeadAlign=Center HeadBgColor=#B9D4DC Width=60      align=center	  BgColor='#C1FFFF'  edit=none  sort=true</C>
						<C> Name='사원명'                 ID=FND_USER_NAME       HeadAlign=Center HeadBgColor=#B9D4DC Width=70	    align=center   EditStyle=PopupFix sort=true </C>
						...
						<C> Name='스마트빌Email'      ID=SMART_EMAIL 	          HeadAlign=Center HeadBgColor=#B9D4DC Width=220	align=left  	 </C>
					">
					</object>
				</comment><script>__ws__(__NSID__);</script>
			</td>
