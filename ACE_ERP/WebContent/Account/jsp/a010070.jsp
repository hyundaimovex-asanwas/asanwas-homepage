...
function ln_Query22(e){
	...
	var str9 = '99999999';
	if(e==""){
		gcds_dept11.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010003_s1?v_str4="+str1+"&v_str9="+str9;	//Tree조직리스트
		gcds_dept11.Reset();
	}else if(e=="2") {
		gcds_dept11.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010003_s1?v_str4="+str1+"&v_str9="+str9;	//Tree조직리스트
		gcds_dept11.Reset();

		gcds_dept2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010003_s1?v_str4=F&v_str5=1";		        //하위소속
		gcds_dept2.Reset();
	}else if(e=="3"){
		gcds_dept11.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010003_s1?v_str4="+str1+"&v_str9="+str9;	//Tree조직리스트
...
function ln_Query2(e,e2){
	var str1 = "F";
	if(e==""){
		gcds_dept2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010003_s1?v_str4="+str1;		//하위소속
		gcds_dept2.Reset();
	}else if(e!=""&&e2!="") {
		if(e!="0000") {
			if(e2=="2") {
...
function ln_Move(arg){
	if (arg =='GORIGHT') {	//하위소속 --(RIGHT)----> 전체소속
		...
		if (gcds_dept3.countrow>0) {	//하위소속 <----(LEFT)-- 전체소속
			...
			var man_lvel = gcds_dept11.namevalue(gcds_dept11.rowposition,"DEPT_LEVEL");	//레벨
			var suc_tree = "";	//완료 조직도
			var suc_lvel = "";	//완료 레벨
			...
			gcds_dept2.namevalue(lpos,"DEPT_LEVEL")		=		suc_lvel;	//레벨
			gcds_dept3.namevalue(rpos,"DEPT_LEVEL")    =   suc_lvel;	//전체소속도 변경된 레벨로 적용
		      ...
		      <tr> 
		        <td style="width:875" align=center valign=top>
		          <comment id="__NSID__"><OBJECT id=gcgd_dept classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH:645px;HEIGHT:479px;border:1 solid #777777;display:block;" viewastext>
		            ...
		            <PARAM NAME="Format"          VALUE="  
		              <FC>Name='코드'	   ID=DEPTCD	HeadAlign=Center HeadBgColor=#B9D4DC Width=45	align=CENTER,   sort = true </FC> 
		              ...
		              <C> Name='근무지'	   ID=DEPTPRT	HeadAlign=Center HeadBgColor=#B9D4DC Width=125	align=LEFT		EditStyle=Lookup   Data='gcds_dept1:MINORCD:MINORNM',  sort = true show=false</C>
					  ...
					  <C> Name='출력순'	   ID=GROUPID	HeadAlign=Center HeadBgColor=#B9D4DC Width=114	align=LEFT	    EditStyle=Lookup   Data='gcds_GROUPID:MINORCD:MINORNM', sort = true show=false</C>
					  <C> Name='변경년월'    ID=CHGYM     HeadAlign=Center HeadBgColor=#B9D4DC Width=65	align=CENTER	Mask='XXXX/XX' </C>
					  <C> Name='현장등급'    ID=SITE      HeadAlign=Center HeadBgColor=#B9D4DC Width=90	align=LEFT	    EditStyle=Lookup   Data='gcds_site:MINORCD:MINORNM', sort = true show=falSe</C>
					  <C> Name='조직도'     ID=TREECD     HeadAlign=Center HeadBgColor=#B9D4DC Width=65	align=CENTER	sort = true</C>
					  <C> Name='레벨'      ID=DEPT_LEVEL HeadAlign=Center HeadBgColor=#B9D4DC Width=40	align=CENTER	</C>
		              "><!-- CheckBoxText='USEYN' -->
		            </OBJECT></comment><script>__ws__(__NSID__);</script>
		          </td>
         		  <TD align=left>
						<table border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0  style='width:227px;height:479px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
							...
							<tr>
				                ...
				                <td Style="height:25px;border:0 solid #708090;border-bottom-width:1px"><nobr>
									<input id="txt_useyn2" name="txt_useyn2" type="checkbox"  style="width:15px;height:15px;position:relative;left:5px;" onClick="ln_Valchk2(this, 'REDTAXYN')" maxlength="1" onBlur="bytelength(this,this.value,1);"><input type=text STYLE="BORDER:0px;position:relative;top:2.2px;left:6px" style="font-size:9pt;" value=" 면세 및 감면 대상">&nbsp;</nobr>
								</td>
				            </tr>
							<tr>
							...
							<tr>
              				...
              				<tr>
				                <td style="height:25px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=CENTER class="txtbox" >레벨</td>
				                <td  Style="height:25px;border:0 solid #708090;border-bottom-width:1px">
				            ...
				            <tr>
				                <td style="height:25px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=CENTER class="txtbox" >지점</td>
				                <td  Style="height:25px;border:0 solid #708090;border-bottom-width:1px">
				            ...
				            <tr>
				                <td style="height:25px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=CENTER class="txtbox" >예산부서</td>
				                <td  Style="height:25px;border:0 solid #708090;border-bottom-width:1px">
				            ...
				            <tr>
				                <td style="height:25px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=CENTER class="txtbox" >상위부서</td>
				                <td  Style="height:25px;border:0 solid #708090;border-bottom-width:1px">
