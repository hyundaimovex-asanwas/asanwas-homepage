...
******************************************************************************/
function ln_Excel(){
	gcgd_disp02.GridToExcel("전표결재","",2);
}
    ...
    ///////////////////////////////////////////////// 
		...
		if(gcds_dtl.namevalue(i,"BANJAEYN")=="Y"){ //반제
			 ...
			 if(gcds_dtl.namevalue(i,"ATDECR")=="1"){ //차변
				...
				if(gs_userid!="2060006"&&gs_userid!="6180021"&&gs_userid!="2140004"){
             	...
             	<tr  width=876px  >			
							  <td color="#0000FF" width="476px"></td>
								...
								<span id=sp2>
								 ...
								 <span id=sp1>
								  <img src="../../common/img/btn/com_btn_batch_modify.gif"	 style="cursor:hand;position:" onClick="ln_Popup_Batch_Modify()">
								 </span>
