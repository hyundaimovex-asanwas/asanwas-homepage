...
alert(1);
       var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                  + ",v_bid_status=" ;
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a030013_s1_proc",
            "JSP(O:DS_DEFAULT=gcds_code01)",
            param);
        tr_post(tr1);
...
function ln_SetDataHeader(){
		...
		if (gcds_print2.countrow<1){
			...
			s_temp+="BEVAL:DECIMAL,DETOT:DECIMAL,CRTOT:DECIMAL,SLPVAL:DECIMAL,FSREFNM:STRING,";
    ...
    <td colspan=2>
        ...
        <tr> 
           ...
           <comment id="__NSID__"><object  id=gcem_actdat_to classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F
					...
					<comment id="__NSID__"><object  id=gcem_atkornam_fr01 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:130px;height:20px;position:relative;left:5px;top:5px;" onkeydown="ln_Onblur_Atcode('02','gcem_atkornam_fr01')";">
			      ...
			      <param name=Text					value="">
					...
					<tr>
						...
						<td style="border:0 solid #708090;border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;text-align;height:25px;font-family:굴림;font-size:9pt; " colspan="5" >
							...
							<input id="txt_vend_fr" type="text" class="txtbox"  style= "position:relative;left:2px;top:0px;width:160px; height:20px;" maxlength="36" onkeydown="ln_Onblur('fr','txt_vend_fr');" > 
						  <img SRC="../../Common/img/btn/com_b_find.gif" BORDER="0" ALT="검색합니다" style="cursor:hand;position:relative;left:2px;top:-1px" align=center onclick="ln_Popup('fr');">
							...
							<input id="txt_vend_to" type="text" class="txtbox"  style= "position:relative;left:1px;top:0px;width:160px; height:20px;" maxlength="36" onkeydown="ln_Onblur('to','txt_vend_to');" >
						  <img SRC="../../Common/img/btn/com_b_find.gif" BORDER="0" ALT="검색합니다" style="cursor:hand;position:relative;left:1px;top:0px" align=center onclick="ln_Popup('to');">
