...
function ln_Query(s){
   ...
   if (fn_trim(gcem_atcode_fr03.text) == "") 	{alert("계정선택은 필수항목입니다"); gcem_atcode_fr03.focus();	return; 
		...
		/*
		gcds_data3.DataID = "/services/servlet/Account.a030023_s3?v_str1="+str31
														                              + "&v_str2="+str32
														                              + "&v_str3="+str33
															                            + "&v_str4="+str34
														                              + "&v_str5="+str35
   ...
   if (fn_trim(gcem_atcode_fr04.text) == "") 	{alert("계정선택은 필수항목입니다"); gcem_atcode_fr04.focus();	return; 
		...
		/*
		gcds_data4.DataID = "/services/servlet/Account.a030023_s4?v_str1="+str41
														                              + "&v_str2="+str42
														                              + "&v_str3="+str43
															                            + "&v_str4="+str44
														                              + "&v_str5="+str45
														                           	  + "&v_str6="+str46;
		*/
    gcds_data4.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a030023_s14_2?v_str1="+str41
														                              + "&v_str2="+str42
														                              + "&v_str3="+str43
															                            + "&v_str4="+str44
														                              + "&v_str5="+str45
	  ...
	  if(fn_trim(txt_scccode13.value) == "") {alert("거래처선택은 필수항목입니다"); txt_scccode13.focus(); return;
		...
		**/
		...
		/*
		gcds_data5.DataID = "/services/servlet/Account.a030023_s5?v_str1="+str51
														                              + "&v_str2="+str52
														                              + "&v_str3="+str53
															                            + "&v_str4="+str54;
    */
...
if(s == "01"){
		...
		gcds_print1.DataID = "/services/servlet/Account.a030023_s1?v_str1="+str11
														                              + "&v_str2="+str12
														                              + "&v_str3="+str13
															                            + "&v_str4="+str14
														                              + "&v_str5="+str15
		...
		*/
		...
		gcds_print2.DataID  = "/services/servlet/Account.a030023_s2?v_str1="+str21
														                              + "&v_str2="+str22
														                              + "&v_str3="+str23
														                          	  + "&v_str4="+str24
												                        		      + "&v_str5="+str25
		...
		*/
		...
		gcds_print3.DataID = "/services/servlet/Account.a030023_s3?v_str1="+str31
														                              + "&v_str2="+str32
														                              + "&v_str3="+str33
															                            + "&v_str4="+str34
														                              + "&v_str5="+str35
		...
		*/
		...
		gcds_print4.DataID = "/services/servlet/Account.a030023_s4?v_str1="+str41
														                              + "&v_str2="+str42
														                              + "&v_str3="+str43
															                            + "&v_str4="+str44
														                              + "&v_str5="+str45
    ...
    var str51 = gclx_sfdcode5.BindColVal; 
		...
		gcds_print5.DataID = "/services/servlet/Account.a030023_s5?v_str1="+str51
														                              + "&v_str2="+str52
														                              + "&v_str3="+str53
															                            + "&v_str4="+str54;
		gcds_print5.Reset();
...
function ln_Excel(e){
  ...
  if(e=="01") {
	...
	gcgd_disp04.GridToExcel("거래처원장","",2);
	}
  else if(e=="05") {
	gcgd_disp05.GridToExcel("거래처원장","",2);
	}
...
function ln_Before(){
	...
	gcds_sfdcode5.Reset();
	//거래처코드
	//gcds_scccode.DataID = "/services/servlet/Account.vendcode_s1?v_str1="; 
	//gcds_scccode.Reset();
...
<script language="JavaScript" for="gcgd_disp03" event="OnDblClick(row, colid)">
  ...
  /****
  gcds_data4.DataID = "/services/servlet/Account.a030023_s4?v_str1="+str1
														                              + "&v_str2="+str2
														                              + "&v_str3="+str3
														                          	  + "&v_str4="+str4
												                        		      + "&v_str5="+str5
...
<table width="875" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td background="../../Common/img/com_t_bg.gif"><img src="../img/a030023_head.gif"></td>
						...
						<comment id="__NSID__"><object  id=gcte_disp classid=clsid:ED382953-E907-11D3-B694-006097AD7252 VIEWASTEXT style="width:660px;height:20px;">
   					  ...
   					  <PARAM NAME="titleHeight"					VALUE="20px">
						  ...
						  <PARAM NAME="Format"						  VALUE="
								<T>divid=div_1		title=계정별잔액</T>
							    <T>divid=div_2		title=계정별내용</T>
								<T>divid=div_3		title=거래처별잔액</T>
							    <T>divid=div_4		title=거래처별내용</T>
...
<!------------- 계정별잔액 --------------->
<fieldset id=field1 style="position:absolute;top:158px;left:18px;height:455px;width:878px;bacground-color:#708090"></fieldset>
		...
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;top:3px;left:-147px;width:866px;border:1 solid #708090;">
			<tr>
				...
				<td class="tab22" width="220px">&nbsp;
					<nobr>
					<input id="txt_scccode2" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:150px;height:20px;" maxlength="32">
					...
					<input id="txt_scccode1" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:90px;height:20px;" maxlength="13">
					</nobr>
				</td>
			...
			<tr>			
				...
				<td class="tab10" colspan="5" width="490px"><nobr>
					<input id="txt_atkornam_fr01" type="text" class="txtbox"  style= "position:relative;left:2px;top:-2px;width:130px;height:20px;" maxlength="36"  disabled>
					...
					<font style="position:relative;left:10px">~</font>&nbsp;
 					<input id="txt_atkornam_to01" type="text" class="txtbox"  style= "position:relative;left:5px;top:-2px;width:130px;height:20px;" maxlength="36"  disabled>
...
<!------------- 계정별내용 --------------->
<fieldset id=field2 style="position:absolute;top:158px;left:18px;height:455px;width:878px;bacground-color:#708090"></fieldset>
	...
	<tr><td align="center" colspan=2>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;top:3px;left:-147px;width:866px;border:1 solid #708090;">
			<tr>
				...
				<td class="tab22" width="220px">&nbsp;
					<nobr>
					<input id="txt_scccode4" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:150px;height:20px;" maxlength="32">
					...
					<input id="txt_scccode3" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:90px;height:20px;" maxlength="13">
					</nobr>
				</td>
				<td class="tab22" width="50px">&nbsp;</td>
				<td class="tab22">&nbsp;</td>
			...
			<tr>			
				...
				<td class="tab12" style="height:25px;width:80px;" bgcolor="#eeeeee">계정과목</td>
				<td class="tab10" colspan="5" width="490px"><nobr>
					<input id="txt_atkornam_fr02" type="text" class="txtbox"  style= "position:relative;left:5px;top:-2px;width:130px;height:20px;" maxlength="36"  disabled>
					...
					<font style="position:relative;left:10px">~</font>&nbsp;
					<input id="txt_atkornam_to02" type="text" class="txtbox"  style= "position:relative;left:5px;top:-2px;width:130px;height:20px;" maxlength="36"  disabled>
...
<!------------- 거래처별잔액 --------------->
<fieldset id=field3 style="position:absolute;top:158px;left:18px;height:455px;width:878px;bacground-color:#708090"></fieldset>
<div id="div_3" style="position:absolute;top:160px;left:168px;height:485px;width:870px;" >
	...
	<tr><td align="center" colspan=2>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;top:3px;left:-147px;width:866px;border:1 solid #708090;">
			...
			<tr>			
				...
				<input id="txt_atcode_fr03" type="text" class="txtbox"  style= "position:relative;left:5px;top:-2px;width:100px;height:20px;" maxlength="36"  disabled>
					...
					<comment id="__NSID__"><object  id=gcem_atcode_fr03 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:50px;height:20px;position:relative;left:10px;top:5px;">		
						<param name=Text					value="">
						<param name=Alignment     value=0>
						<param name=Border        value=true>
						<param name=Numeric       value=false>
				...
				<td class="tab10" colspan="5" width="490px">&nbsp;
					<nobr>
					<input id="txt_scccode6" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:105px;height:20px;" maxlength="32">
					...
					<input id="txt_scccode5" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:45px;height:20px;" maxlength="13">~&nbsp;
					<input id="txt_scccode8" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:105px;height:20px;" maxlength="32">
					...
					<input id="txt_scccode7" type="text" class="txtbox"  style= "position:relative;left:-7px;top:0px;width:45px;height:20px;" maxlength="13">
					</nobr>
				</td>
			</tr>
		</table>
...
<!------------- 거래처별내용 --------------->
<fieldset id=field4 style="position:absolute;top:158px;left:18px;height:455px;width:878px;bacground-color:#708090"></fieldset>
<div id="div_4" style="position:absolute;top:160px;left:168px;height:485px;width:870px;" >
	...
	<tr><td align="center" colspan=2>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;top:3px;left:-147px;width:866px;border:1 solid #708090;">
			...
			<tr>			
				<td class="tab12" width="80px" bgcolor="#eeeeee">계정과목</td>
				<td class="tab23" style="height:30px;width:250px;"><nobr>
					<input id="txt_atcode_fr04" type="text" class="txtbox"  style= "position:relative;left:5px;top:-2px;width:100px;height:20px;" maxlength="36"  disabled></nobr>
					<img SRC="../../Common/img/btn/com_b_find.gif" BORDER="0" ALT="계정코드를 검색합니다" style="cursor:hand;position:relative;left:5px;top:1px" align=center onclick="ln_Popup4();">
					<comment id="__NSID__"><object  id=gcem_atcode_fr04 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:50px;height:20px;position:relative;left:10px;top:5px;">		
						<param name=Text					value="">
						<param name=Alignment     value=0>
						<param name=Border        value=true>
						<param name=Numeric       value=false>
...
<!------------- 거래처별채권채무 --------------->
<fieldset id=field5 style="position:absolute;top:158px;left:18px;height:455px;width:878px;bacground-color:#708090"></fieldset>
	...
	<tr><td align="center" colspan=2>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;top:3px;left:-147px;width:866px;border:1 solid #708090;">
			...
			<tr>			
				...
				<td class="tab10" colspan="5" width="490px">&nbsp;
					<nobr>
					<input id="txt_scccode14" type="text" class="txtbox"  style= "position:relative;left:-7px;top:3px;width:105px;height:20px;" maxlength="32">			
					...
					<input id="txt_scccode13" type="text" class="txtbox"  style= "position:relative;left:-7px;top:3px;width:65px;height:20px;" maxlength="13">
					</nobr>
				</td>
			</tr>
		</table>
			...
			<tr> 			
				<td style="width:280" ALIGN=LEFT VALIGN=TOP>
			      ...
			      <PARAM NAME="viewSummary"      VALUE="0">						
					  ...
					  <PARAM NAME="SortView"		     VALUE="left">
						<PARAM NAME="Format"			     VALUE="
						<C> Name='업체코드'	ID=FSREFVAL HeadAlign=Center  HeadBgColor=#B9D4DC Width=80	 align=center    edit=none</C>
						<C> Name='업체명'	  ID=CDNAM HeadAlign=Center  HeadBgColor=#B9D4DC Width=245	   align=left      edit=none  sort = true</C>
						
						<C> Name='외상매출금'	     ID=VAL1 HeadAlign=Center  HeadBgColor=#B9D4DC Width=105	 align=right  edit=none</C> 
						<C> Name='미수금'	         ID=VAL2 HeadAlign=Center  HeadBgColor=#B9D4DC Width=105	 align=right  edit=none</C>
						<C> Name='공사용역미수금'	 ID=VAL3 HeadAlign=Center  HeadBgColor=#B9D4DC Width=105	 align=right  edit=none</C> 
						<C> Name='외상매입금'	     ID=VAL4 HeadAlign=Center  HeadBgColor=#B9D4DC Width=105	 align=right  edit=none</C>
						<C> Name='미지급금'	       ID=VAL5 HeadAlign=Center  HeadBgColor=#B9D4DC Width=105	 align=right  edit=none</C>
