...
function ln_Query1(){
	...
	var str2 = gcem_staxdatto.text;			  //계산서기간 년
...
function ln_Before(){ 
	...
	gcem_staxdatto.text		 = gs_date2;				//계산서기간 년
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  ...
  <tr> 
    <td COLSPAN=2>
        ...
        <tr> 
					...
					<td width="100px" class="tab12" bgcolor="#eeeeee"><nobr>&nbsp;회계년&nbsp;</nobr></td>
					<td width="150px"><nobr>&nbsp;
  ...
  <tr> 
	...
	<C>ID=DETOT,	Name='잔액',width=130, SumBgColor=#C3D0DB HeadBgColor=#B9D4DC,HeadAlign=center, align=right</C>
	<C>ID=DESUM,	Name='합계' ,width=130, SumBgColor=#C3D0DB HeadBgColor=#B9D4DC,HeadAlign=center,	align=right</C>
	</G>
	<C>ID=ATKORNAM, Name='계정과목' ,width=335, SumBgColor=#C3D0DB HeadBgColor=#B9D4DC,HeadAlign=center, align=center sumtext='합계'</C>
	<G>Name='대변', HeadBgColor=#B9D4DC,HeadAlign=center
	<C>ID=CRSUM,	Name='합계' ,width=130, SumBgColor=#C3D0DB HeadBgColor=#B9D4DC,HeadAlign=center,	align=right</C>
	<C>ID=CRTOT,	Name='잔액',width=130, SumBgColor=#C3D0DB HeadBgColor=#B9D4DC,HeadAlign=center, align=right</C>
	</G>
							">
            </object></comment><script>__ws__(__NSID__);</script> 
