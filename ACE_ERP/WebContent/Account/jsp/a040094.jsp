...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		   
    <table border='0' cellpadding='0' cellspacing='0' width="845px"> 
        ...
        <tr height='10px'>
            <td><b><font size="2" color="blue">[분양매출정보]</font></b></td>
        </tr>
        <tr>
            <td valign="top">
                        ...
                        <td valign='top' width="845px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='170px' border='1'>
                                ...
                                <param name="Format"                 value="
                                     ...
                                     <C> name='구분'	            ID='GUBUN'    	         width=40 	align=center	 sumtext='총'</C>
                                     <C> name='계정코드'       ID='ATCODE'       	     width=60 	align=center      sumtext='@cnt' sumtextalign='center'       </C>
                                     <C> name='계정명'		    ID='ATKORNAM' 		 width=73 	align=left      	 sumtext='건'     sumtextalign='center'       BgColor={IF(CurLevel=0,'#FFFFFF','#FFCC66')} </C>
									 <C> name='거래처' 	        ID='VENDCD'             width=60 	    align=left       	 </C>
									 <C> name='거래처명' 	    ID='VENDNM'    	     width=120 	align=left      	 </C>
                                     <C> name='지급금액'  	ID='JANAMT'              width=80 	align=right 		 sumtext='@sum'  </C>
                                     <C> name='회계일자'      ID='ACTDAT'   	         width=65 	align=center      mask ='XXXX/XX/XX' </C>
                                     <C> name='지급일자'      ID='PAYDAT'   	         width=65 	align=center   	 mask ='XXXX/XX/XX' </C>
                                     <C> name='적요'            ID='REMARK'      	     width=170 	align=left  	    </C>
                                     <C> name='만기일자'      ID='FULDAT'      	     width=65  	align=center  	 mask ='XXXX/XX/XX'</C>                                     
                                     <C> name='지점'	           ID='FDCODE'    	          width=80 	align=center 	</C>
                                     <C> name='접수일자'	   ID='FSDAT'    	          width=80 	align=center 	</C>
                                     <C> name='접수번호'      ID='FSNBR'    	          width=80 	align=center 	</C>
                             ">
                            </object>   
                            <%=HDConstant.COMMENT_END%>
                        </td>                      
