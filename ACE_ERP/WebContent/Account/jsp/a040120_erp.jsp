...
+ 수   정   자     :  이 동 훈
+ 수 정 일 자     :  2017.07.21
+ 수 정 내 용     :  건설 zace에서 바로 매출 세금계산서 발행 금지, 승인 후 발행토록 수정
------------------------------------------------------------------------------>

<% /*
	* [ 수정일자 ][수정자] 내용
	* [2015-09-22][이동훈] ZACE 에서 매출 발행시 
	* 	파라미터1	
	*				FSDAT1=A
	*/

	String strParam0 = request.getParameter("TAXNBR");
...
function ln_Initial(){
	...
	var strParam_taxnbr = "<%=strParam0%>";
	//2015-09-22 이동훈 :끝

	gcem_taxnbr_s.text=strParam_taxnbr;
...
<table id="div_disp1" cellpadding="0" cellspacing="0" border="0">	
		...
		<td align=left style="position:relative;left:6px;top:-2px" colspan=2>
			<table cellpadding="0" cellspacing="0" border="0" style='width:950px;height:20px;border:1 solid #708090'>
				<tr>
					...
					<td align="right">&nbsp;<nobr>      
						<!--<img src="../../Common/img/btn/com_b_query.gif"    style="cursor:hand;position:relative;top:1px;right:2px" onClick="ln_Query()">-->
    ...
    <tr>
	 ...
	 <tr>
     	<td style="width:865;height:20px;border:0 solid #708090;border-top-width:1px"  colspan=2> <font color="red" size=3>&nbsp;&nbsp;[매출발행]</font>은 회계 ERP에서 1차승인:건설지원팀, 2차승인:경영관리팀(회계)을 받은 뒤에 발행하시기 바랍니다.
     	    <br>&nbsp;&nbsp;&nbsp;세금계산서발행 프로세스 강화 안내 회람 참고(지원 17-07-06-133)
		</td>
     </tr>
</table> 
