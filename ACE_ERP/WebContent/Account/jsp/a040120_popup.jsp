...
function ln_Chk(){
	 ...
	 //입금예정일
	 if (fn_trim(gcem_duedate.text)=="")   { alert("입금예정일이  존재하지 않습니다. 확인하십시요."); gcem_duedate.Focus(); return false; }
	 if (fn_trim(gcem_duedate.text).length!=8) { alert("입금예정일이 정확하지 않습니다. 확인하십시요."); gcem_duedate.Focus(); return false; }
...
function ln_Chk_Status(){
	...
	if(gcds_taxmst.namevalue(1,"TAXSTS")!=""&&gcds_taxmst.namevalue(1,"TAXSTS")!="N"&&gcds_taxmst.namevalue(1,"TAXSTS")!="B"){
		alert(gcds_taxmst.namevalue(1,"VEND_NM")+"의 결재상태가  대상이  아닙니다.");
		return false;
	}else{
	   	...
	   	<td style="position:relative;left:6px" colspan=2>
			<table cellpadding="1" cellspacing="0" border="0" style='width:950px;height:30px;border:1 solid #708090'>
				<tr>
					...
					<td class="tab22" >
						 <comment id="__NSID__"> 
							<object  id=gcem_empnm classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:20px;position:relative;left:5px;top:0px;">		
								<param name=Text		  value="">
								<param name=Alignment           value=0>
								<param name=border              value=false>
								<param name=GeneralEdit         value=true>
				...
				<tr>
					...
					<td class="tab22" >
						<comment id="__NSID__">
							<object  id=gclx_taxdiv classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 style="position:relative;left:5px;top:0px;font-size:12px;width:100px;">
				...
				<tr>
					...
					<td class="tab22" >
						 <comment id="__NSID__">
							<object  id=gclx_fsstat classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  style="position:relative;left:5px;top:1px;font-size:12px;width:100px;">
				...
				<tr>
					...
					<td class="tab22" >
						 <comment id="__NSID__">
							<object  id=gclx_ebillgb classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  style="position:relative;left:5px;top:1px;font-size:12px;width:100px;">
				...
				<tr>
					...
					<td class="tab22" ><nobr>
						<comment id="__NSID__">
							<object  id=gcem_total_amount classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:110px;height:20px;position:relative;left:5px;top:1px">		
								<param name=Text		  value="">
								<param name=Alignment     value=2>
								<param name=Border        value=false>
								<param name=Language	  value=1>
					...
					<td class="tab33" width="70px" bgcolor="#eeeeee"><nobr>결재상태</nobr></td>
					<td class="tab22" ><nobr>
						<comment id="__NSID__">
							<object  id=gclx_taxsts classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  style="position:relative;left:5px;top:1px;font-size:12px;width:80px;">
