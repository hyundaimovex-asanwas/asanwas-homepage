...
function ln_Query(s){
	...
	var str3  = fn_trim(gcem_sgetdatefr1.text);			//입금일자fr
	var str4  = fn_trim(gcem_sgetdateto2.text);			//입금일자to
...
function ln_Excel(e){
	if(e=="01"){
		...
		else gcgd_disp01.RunExcel('사전입금현황');
	}
}
								...
								<td style="width:460" ALIGN=LEFT VALIGN=TOP>
									<comment id="__NSID__"><OBJECT id=gcgd_disp01 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH:867px;HEIGHT:380px;border:1 solid #777777;display:block;position:relative;left:-1px" viewastext>
										...
										<PARAM NAME="Format"        VALUE="  
											...
											<C> Name='입금일자'		ID=ACDATE		HeadAlign=Center HeadBgColor=#B9D4DC Width=70	align=center    SumText='계'	    SumBgColor='#C3D0DB' Mask='XXXX/XX/XX'	SubSumText='일계'</C>
											<C> Name='부서'			ID=DEPTCD		HeadAlign=Center HeadBgColor=#B9D4DC Width=320	align=left		SumText=''		SumBgColor='#C3D0DB' EditStyle='lookup' Data='gcds_dept00:DEPTCD:DEPTNM' SubSumText=''</C>
											<C> Name='입금액'			ID=PYAMT		HeadAlign=Center HeadBgColor=#B9D4DC Width=140	align=right		SumText=@sum	SumBgColor='#C3D0DB' </C>
											<C> Name='적요'			ID=REMARK		HeadAlign=Center HeadBgColor=#B9D4DC Width=280	align=left		SumText=''		SumBgColor='#C3D0DB' SubSumText=''</C>
											">
									</OBJECT></comment><script>__ws__(__NSID__);</script>
