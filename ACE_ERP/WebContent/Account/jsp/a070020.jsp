...
function ln_Query(){ 
    ...
    if(gcrd_gubun.codevalue=="1"){            //저장전 
    	...
    	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a070020_s1"
	   ...
	   // 지급일자 체크  
	    ...
	    gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a070020_s2"
									     + "?v_str1="+gclx_fdcode.BindColVal     
									 	 + "&v_str2="+gcem_actyymm.text           
	...
	if(gcds_code01.IsUpdated){
		if(ln_Chk()){
		     if(confirm("협력업체 대금지급 내용을  저장하시겠습니까?")){
					gctr_code01.KeyValue = "Account.a070020_t1(I:USER=gcds_code01)";
					gctr_code01.Action      = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a070020_t1?";
...
<table width="860px" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
	<tr> 
		<td background="../../Common/img/com_t_bg.gif"  align=left ><img src="../img/a070020_head.gif"></td>
	...
	<tr> 
		...
		<td class="tab28" >&nbsp;
			...
			<span id=sp0 style="display:none;">
				<img src="../../Common/img/btn/com_b_delete.gif"	style="cursor:hand;position:relative;top:2px;left:20px;>"       onClick="ln_Delete()">
			</span>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		<td>
			...
			<object  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp01  
			  style="position:relative;left:0px;width:858px; height:450px; border:1 solid #708090;display:block;" viewastext>
