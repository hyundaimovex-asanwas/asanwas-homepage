...
<!---------------------------------------------------------------------------
+ 시 스 템 명	:  예산관리 - 일반관리비현황
+ 프로그램 ID	:  A080007.html
+ 기 능 정 의	:  
+ 작   성  자 :  YS.JEONG
+ 수 정 일 자 :  2010.08.04
-----------------------------------------------------------------------------
...
function ln_Query(){
  ...
  if(gclx_frmonth.bindcolval==""){
	...
	gcds_data01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a080007_s1?v_str1="+gclx_fdcode.bindcolval
...
<comment id="__NSID__"><object  id=gcds_crossTab classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	...
	<param name=GroupExpr  value="ATCODE:PRTNAM,BGTDIVNM,AMT">
					...
					<comment id="__NSID__"><object  id=gcgd_disp01 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  
						style="position:relative;left:3px;width:875px; height:400px; border:1 solid #708090;display:block;" viewastext>
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<R>
									<C>ID=AMT_$$    name={mid(xkeyname_$$,3)},  value={Number(AMT_$$)} HeadAlign=Center HeadBgColor=#B9D4DC  width=99  SumBgColor=#C3D0DB  sumtext={sum(AMT_$$)}   </C>
								</R>
