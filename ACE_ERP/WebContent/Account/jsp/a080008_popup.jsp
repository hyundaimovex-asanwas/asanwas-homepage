...
<!---------------------------------------------------------------------------
+ 시 스 템 명	:  예산관리 - 일반관리비 현황 - 그리드 팝업
+ 프로그램 ID	:  A080007_popup
+ 기 능 정 의	:  일반관리비 현황 팝업
+ 작   성  자 :  정 영 식
+ 작 성 일 자 :  2010.08.11
-----------------------------------------------------------------------------
...
function ln_Start(){
	...
	gcem_bgtdpt.text   = strParam[6];
	gcem_bgtdptnm.text = strParam[7];
...
******************************************************************************/
function ln_Before(){
	gcds_code02.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>commdtil_s1?v_str1=2171"; 
	gcds_code02.Reset();
}
...
******************************************************************************/
function ln_Query(){
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a080008_popup_s1?v_str1="+gcem_fdcode.text
	                                                                                                               + "&v_str2="+gcem_frymd.text		
																									  		       + "&v_str3="+gcem_toymd.text		
																											       + "&v_str4="+gcem_atcode.text	
																												   + "&v_str5="+gcem_bgtdpt.text;	
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:795px;border:1 solid #708090">
	<tr>
		<td class="tab19" width="80px;" bgcolor="#eeeeee" align=center>지점</td>
		<td class="tab19" width="300px"><nobr>
		...
		<td class="tab19" width="80px;" bgcolor="#eeeeee" align=center>기간</td>
		<td class="tab22" width="370px;" ><nobr>
	...
	<tr>
    <td class="tab19" width="80px;" height="25px;" bgcolor="#eeeeee" align=center>예산부서</td>
		<td class="tab19" >
			<comment id="__NSID__"><object  id=gcem_bgtdpt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
			style="position:relative;left:2px;top:3px; width:40px; height:20px;">
			<param name=Alignment	    value=0>
			<param name=Border	      value=true>
			<param name=ReadOnlyBackColor  value="#ccffcc">
			<param name=ReadOnly           value="true">
			...
			<comment id="__NSID__"><object  id=gcem_bgtdptnm classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
				style="position:relative;left:-3px;top:3px; width:150px; height:20px;">
				<param name=Alignment	    value=0>
				<param name=Border	      value=true>
				<param name=PromptChar	  value="_">
				<param name=ReadOnlyBackColor  value="#ccffcc">
		...
		<td class="tab19" width="80px;" bgcolor="#eeeeee" align=center>계정</td>
		<td class="tab22"  ><nobr>
