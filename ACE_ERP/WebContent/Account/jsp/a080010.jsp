...
function ln_Query(){
  ...
  if(gclx_frmonth.bindcolval==""){
	...
	gcds_data01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a080010_s1?v_str1="+gclx_fdcode.bindcolval
...
function ln_Excel(){
	...
	gcgd_disp01.GridToExcel("세목별일반관리비현황","",2);
...
**********************************************************************************************/
function ln_Popup2(sfdcode,sfdcodenm,sfrymd,stoymd,satcode,satcodenm,xsatcode,ssatgb,ssatcode,ssatcodenm){
	var arrParam	= new Array();
	var arrResult	= new Array();
	var strURL;	
	var strPos;
	...
	arrParam[7] = ssatgb;	
	arrParam[8] = ssatcode;	
	arrParam[9] = ssatcodenm;	

	strURL = "./a080010_popup.jsp";
...
<comment id="__NSID__"><object  id=gcds_crossTab classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	...
	<param name=GroupExpr  value="ATCODE:PRTNAM:SATNAM:SATGB:SATCODE,BGTDPTNM,AMT">
...
<script language=JavaScript for=gcgd_disp01 event=OnDblClick(row,colid)>
  ...
  if(colid=="PRTNAM "||colid=="SATNAM"||colid=="SUM") return;
	...
	var ssatgb        = gcds_crossTab.namevalue(row,"SATGB");	        //세목구분
	var ssatcode      = gcds_crossTab.namevalue(row,"SATCODE");	        //세목코드
	var ssatcodenm    = gcds_crossTab.namevalue(row,"SATNAM");	 
	
	
	if(ssatcode =="0"){ssatcode=""; }
	...
	//alert("sfdcode::"+sfdcode+"sfdcodenm::"+sfdcodenm+"sfrymd::"+sfrymd+"stoymd::"+stoymd+"satcode::"+satcode+"satcodenm::"+satcodenm+"xsatcode::"+xsatcode+"ssatgb::"+ssatgb+"ssatcode::"+ssatcode);

	ln_Popup2(sfdcode,sfdcodenm,sfrymd,stoymd,satcode,satcodenm,xsatcode,ssatgb,ssatcode,ssatcodenm );	
</script>
		...
		<table cellpadding="0" cellspacing="0" border="3" style="position:relative;left:3px;width:877px;border:0 solid #708090;">
			...
			<tr>
				...
				<td class="tab19" style="width:120px" colspan=5><nobr>				
					<comment id="__NSID__"><object  id=gcem_atkornam classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:130px;height:20px;position:relative;left:5px;top:2px;" onkeydown="ln_Onblur('02','fr','gcem_atkornam')";">
			      <param name=Text					value="">
					...
					<comment id="__NSID__"><object  id=gcem_atcode classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:50px;height:20px;position:relative;left:5px;top:2px;">
			      <param name=Text					value="">
						<param name=Alignment     value=0>
						<param name=Border        value=true>
						<param name=Numeric       value=false>
					...
					&nbsp;
					<img SRC="../../Common/img/btn/com_b_clear.gif" BORDER="0" style="cursor:hand;position:relative;left:3px;top:2px" align=center onclick="ln_Clear();">
					</nobr>
				</td>
			</tr>
		</table>
					...
					<comment id="__NSID__"><object  id=gcgd_disp01 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  
						style="position:relative;left:3px;width:875px; height:400px; border:1 solid #708090;display:block;" viewastext>
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<F> ID=SATGB    Title='세목구분' 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=80 align=center sort=false show=false</F> 
								<F> ID=SATCOD   Title='세목코드' 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=80 align=center sort=false show=false</F> 
								<F> ID=PRTNAM   Title='계정과목' 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=140 align=left sort=false  SumBgColor=#C3D0DB sumtext='합계'</F> 
								<F> ID=SATNAM   Title='세목' 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=130 align=left sort=false  SumBgColor=#C3D0DB </F>
