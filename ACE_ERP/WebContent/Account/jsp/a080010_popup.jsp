...
function ln_Start(){
	...
	xssatgb  = strParam[7];  //세목구분
	gcem_satcode.text = strParam[8];  //세목코드
	gcem_satcodenm.text = strParam[9];  //세목명
...
******************************************************************************/
function ln_Query(){
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a080010_popup_s1?v_str1="+gcem_fdcode.text
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:795px;border:1 solid #708090">
	...
	<tr>
        <td class="tab19" width="80px;" height="25px;" bgcolor="#eeeeee" align=center>세목구분</td>
		<td class="tab19" colspan=3>
		<nobr>
			<comment id="__NSID__">
			<object  id=gcem_satcode  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
			style="position:relative;left:2px;top:3px; width:30px; height:20px;" class="txtbox">
			<param name=Alignment	    value=0>
			<param name=Border	      value=true>
			<param name=Format	      value="##">
			<param name=PromptChar	  value="_">
			...
			<comment id="__NSID__">
			    <object  id=gcem_satcodenm classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
				style="position:relative;left:-3px;top:3px; width:200px; height:20px;" class="txtbox">
				<param name=Alignment	    value=0>
				<param name=Border	      value=true>
				<param name=PromptChar	  value="_">
				<param name=ReadOnlyBackColor  value="#ccffcc">
