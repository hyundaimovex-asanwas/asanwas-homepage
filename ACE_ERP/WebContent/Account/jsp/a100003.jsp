...
function ln_Print(){
	...
	if(gcds_data01.countrow<1)
		...
		gcds_temp01.namevalue(1,"TITLE") = "월별 " + fdcodenm + " 비용명세서";
...
******************************************************************************/
function ln_Excel(){
		//gcgd_disp01.runexcel("월별비용명세서");
gcgd_disp01.GridToExcel("월별비용명세서","",2);
}
			...
			<tr> 			
              ...
              <param name="Editable"    value="false">
							<PARAM NAME="Format"			VALUE="  
								...
								<FC> Name='계정과목'	ID=PRTNAM HeadAlign=Center HeadBgColor=#B9D4DC Width=160 align=left SumBgColor=#C3D0DB SumText='계' sort=false</FC> 
...
<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=449 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='KISU1', left=1013, top=191, right=1892, bottom=241, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<L> left=71 ,top=370 ,right=2807 ,bottom=370 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='계' ,left=2646 ,top=389 ,right=2781 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='12월' ,left=2461 ,top=389 ,right=2596 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='4월' ,left=976 ,top=389 ,right=1111 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='5월' ,left=1164 ,top=389 ,right=1299 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='6월' ,left=1347 ,top=389 ,right=1482 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='3월' ,left=794 ,top=389 ,right=929 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='2월' ,left=609 ,top=389 ,right=743 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='구 분' ,left=106 ,top=389 ,right=373 ,bottom=434 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='FDCODENM', left=79, top=315, right=1008, bottom=360, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
<B>id=default ,left=0,top=0 ,right=2871 ,bottom=63 ,face='Arial' ,size=10 ,penwidth=1
	<C>id='TSUM', left=2619, top=8, right=2807, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A12', left=2432, top=8, right=2622, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A11', left=2246, top=8, right=2437, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A10', left=2061, top=8, right=2252, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A09', left=1876, top=8, right=2066, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A08', left=1691, top=8, right=1881, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A07', left=1505, top=8, right=1699, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A06', left=1320, top=8, right=1511, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A05', left=1135, top=8, right=1326, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A04', left=950, top=8, right=1140, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A03', left=762, top=8, right=953, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A02', left=574, top=8, right=765, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A01', left=386, top=8, right=577, bottom=50, align='right', face='굴림', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PRTNAM', left=79, top=8, right=389, bottom=50, align='left', face='굴림', size=8, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
<B>id=LDFooter ,left=0,top=0 ,right=2871 ,bottom=64 ,face='Arial' ,size=10 ,penwidth=1
	...
	<S>id='{Sum(TSUM)}' ,left=2619 ,top=11 ,right=2807 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A12)}' ,left=2434 ,top=11 ,right=2622 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A10)}' ,left=2064 ,top=11 ,right=2252 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A11)}' ,left=2249 ,top=11 ,right=2437 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A08)}' ,left=1693 ,top=11 ,right=1881 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A09)}' ,left=1879 ,top=11 ,right=2066 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A07)}' ,left=1508 ,top=11 ,right=1696 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A06)}' ,left=1323 ,top=11 ,right=1511 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A04)}' ,left=950 ,top=11 ,right=1140 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A05)}' ,left=1138 ,top=11 ,right=1326 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A02)}' ,left=574 ,top=11 ,right=765 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A03)}' ,left=762 ,top=11 ,right=953 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<S>id='{Sum(A01)}' ,left=386 ,top=11 ,right=577 ,bottom=53 ,align='right' ,face='돋움체' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</S>
	<T>id='계' ,left=79 ,top=11 ,right=389 ,bottom=53 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
<B>id=Footer ,left=0 ,top=1857 ,right=2871 ,bottom=2000 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='CURDT', left=79, top=13, right=479, bottom=58, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CURTM', left=476, top=13, right=820, bottom=58, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
