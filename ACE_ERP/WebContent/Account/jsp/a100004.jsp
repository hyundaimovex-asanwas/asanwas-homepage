...
function ln_Query(){
	...
	gcds_data01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a100004_s1?v_str1="+gclx_fdcode.bindcolval
...
function ln_Excel(){
	...
	gcgd_disp01.ExportFile('원가별비용명세서',true)
}
...
<table width="877" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td background="../../Common/img/com_t_bg.gif"><img src="../img/a100004_head.gif"></td>
			...
			<tr> 			
              ...
              <param name="Editable"    value="false">
							...
							<PARAM NAME="Format"			VALUE="  
								<F> ID=ATCODE   Title='계정코드' 	 HeadAlign=Center HeadBgColor=#B9D4DC Width=80 align=center sort=false SumBgColor=#C3D0DB SumText='합계' show=false</F> 
	              ...
	              <FC>Id=Sum	name='계'	 HeadAlign=Center HeadBgColor=#B9D4DC width=100	Bgcolor='#E3E3FF'	Value={CrossTabSum(AMT)}	Align=Right SumBgColor=#C3D0DB SumText={sum(CrossTabSum(AMT))}  </FC>
								<R>
									<C>ID=AMT_$$   name=$xkeyname_$$  HeadAlign=Center HeadBgColor=#B9D4DC  width=180 SumBgColor=#C3D0DB SumText=@sum  </C>
							  </R>
