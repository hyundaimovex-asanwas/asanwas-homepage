...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:  어음관리 - 전표일자별현황
+ 프로그램 ID	:  A200003.html
+ 기 능 정 의	:  전표일자별현황 조회 및 출력 화면이다.
+ 작   성  자 :  이 순 미
+ 서 블 릿 명	:	 a200003_s1
-------------------------------------------------------------------------------->
...
function ln_Query(s){
	if(s=="01") {
		...
		var str3  = fn_trim(gcem_fsdatfr1.text);	//전표일자fr
		var str4  = fn_trim(gcem_fsdatto1.text);	//전표일자to 
		gcds_data1.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a200003_s1?v_str1="+str1
...
function ln_Excel(e){
  if(e=="01") {
		...
		else gcgd_disp01.RunExcel('전표일자별현황');
	}
}
...
******************************************************************************/
function ln_Before(){
	gcem_fsdatfr1.text = gs_date2+"01";	//[검색]전표from
	gcem_fsdatto1.text = gs_date;				//[검색]전표to
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/a200003_head.gif"></td>
		...
		<td colspan=8 align=left style="position:relative;left:0px">
			<table cellpadding="1" cellspacing="0" border="0" style='width:869px;height:30px;border:1 solid #708090'>
				<tr>
					...
					<td class="tab12" style="width:70px;" bgcolor="#eeeeee"><nobr>자금구분</nobr></td>
					<td class="tab23" style="width:90px">
					...
					<td class="tab12" style="width:70px;" bgcolor="#eeeeee"><nobr>전표일자</nobr></td>
					<td style="width:210px"><comment id="__NSID__">
						<object id=gcem_fsdatfr1 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
					...
					<img src="../img/calender.gif" value="calender.gif" id=img_calendar1 OnClick="__GetCallCalendar('gcem_fsdatfr1', 'Text')" style="position:relative;width:20px;left:9px;top:1px;cursor:hand;">&nbsp;~
					<comment id="__NSID__"><object id=gcem_fsdatto1 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
							style="position:relative; left:5px;top:2px; width:70px; height:20px;" class="txtbox">
						<param name=Alignment			value=0>
						<param name=Border	      value=true>
						<param name=Format	      value="YYYY/MM/DD">
					...
					<img src="../img/calender.gif" value="calender.gif" id=img_calendar2 OnClick="__GetCallCalendar('gcem_fsdatto1', 'Text')" style="position:relative;width:20px;left:9px;top:1px;cursor:hand;">
					</td>
					<td align="right">&nbsp;<nobr>      
						...
						<td style="width:460" ALIGN=LEFT VALIGN=TOP><comment id="__NSID__">
							<OBJECT id=gcgd_disp01 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH:867px;HEIGHT:380px;border:1 solid #777777;display:block;position:relative;left:-1px" viewastext>
								...
								<PARAM NAME="Format"        VALUE="  
									...
									<C> Name='전표일자'			ID=FSDAT		HeadAlign=Center HeadBgColor=#B9D4DC Width=70		align=left	  SumText=''		SumBgColor='#C3D0DB' Mask='XXXX/XX/XX'</C>
									...
									<G> Name='발행금액'     HeadAlign=Center HeadBgColor=#B9D4DC
										...
										<C> Name='대변'				ID=CRAMT		HeadAlign=Center HeadBgColor=#B9D4DC Width=100	align=right	  SumText=@sum	SumBgColor='#C3D0DB' Mask='XXXX/XX/XX'</C>
									</G>
									...
									<C> Name='적요'					ID=REMARK		HeadAlign=Center HeadBgColor=#B9D4DC Width=200	align=left		SumText=''		SumBgColor='#C3D0DB'</C>
								">
							</OBJECT></comment><script>__ws__(__NSID__);</script>
