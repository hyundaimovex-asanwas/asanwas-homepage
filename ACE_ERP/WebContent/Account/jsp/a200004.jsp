...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:  어음관리 - 은행별현황
+ 프로그램 ID	:  A200004.html
+ 기 능 정 의	:  은행별현황 조회 및 출력 화면이다.
+ 작   성  자 :  이 순 미
+ 서 블 릿 명	:	 a200004_s1
-------------------------------------------------------------------------------->
...
function ln_Query(s){
	if(s=="01") {
		...
		gcds_data1.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a200004_s1"
...
function ln_Excel(e){
  if(e=="01") {
		...
		else gcgd_disp01.RunExcel('은행별현황');
	}
}
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/a200004_head.gif"></td>
			...
			<table cellpadding="1" cellspacing="0" border="0" style='width:869px;height:30px;border:1 solid #708090'>
				...
				<tr>
					...
					<td width="250px" colspan="4"><nobr><comment id="__NSID__">
						<object  id=gcem_sbancodnm1 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:155px;height:20px;position:relative;left:5px;top:0px" onkeydown="if(event.keyCode==13) ln_Query('01');">		
