...
function fnCreateSelect() {
	  ...
	  //서블릿 조회해야지		
	  ds_slipdtl.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a300065_s1?v_str1="+gclx_fdcode.bindcolval
																				    +"&v_str2="+gcem_appdate.text
																				    +"&v_str3="+gcem_reqdate.text
																				    +"&v_str4="+gcem_appempno.text
	 																			    +"&v_str5="+strAppno;	
					...
					<td style="width:460;position:relative;top:3px" align=left valign=top >
						...
						<OBJECT id=gcgd_disp01 classid=clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B style="WIDTH:998px;HEIGHT:245px;border:1 solid #777777;display:block;position:relative;left:5px" viewastext>
							...
							<PARAM NAME="Format"        VALUE="  
								...
								<C> Name='코드'	     ID=ATCODE 	       HeadAlign=Center HeadBgColor=#B9D4DC Width=50     	align=center 	SumBgColor='#C3D0DB'  edit=none EditStyle=Popup</C>
								<C> Name='계정명'	     ID=ATKORNAM	   HeadAlign=Center HeadBgColor=#B9D4DC Width=100  	    align=left  	SumBgColor='#C3D0DB'  edit=none</C>
								</G>
								<G> Name='원가/예산정보' HeadAlign=Center HeadBgColor=#B9D4DC
								<C> Name='구분'	     ID=COSTGB  	   HeadAlign=Center HeadBgColor=#B9D4DC Width=30    	align=center 	SumBgColor='#C3D0DB'  edit=none EditStyle=Combo, Data='1:원가,2:예산'</C>
								<C> Name='코드'	     ID=COSTBGT  	   HeadAlign=Center HeadBgColor=#B9D4DC Width=50    	align=left  	SumBgColor='#C3D0DB'  edit=none EditStyle=Popup </C>
								<C> Name='원가/예산명'	 ID=COSTBGTNM  	   HeadAlign=Center HeadBgColor=#B9D4DC Width=100    	align=left  	SumBgColor='#C3D0DB'  edit=none</C>
								</G>
