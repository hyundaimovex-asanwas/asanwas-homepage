...
<%
    ...
    //System.out.println("a0400140_fileDownload:::dir:::"+dir);
    
    if(dir == null) dir = "";
	String path = "";
	if(dir.equals("")) {
		path = HDConstant.FILE_UPLOAD_PATH_FILE;	//로컬 첨부파일 저장 경로
	}	else {
		path = HDConstant.FILE_UPLOAD_PATH_FILE + dir ;
	}

	//System.out.println("a0400140_fileDownload:::path:::"+path);
    ...
    if( request.getParameter("filename")!=null)
    {
    	...
    	filename3 = request.getParameter("sysfilename");
    }
 	...
 	if( request.getParameter("sysfilename")!=null)
    {
 	...
 	//System.out.println("filename3::"+filename3+":sysfilename::"+sysfilename);
