...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	: 인감관리 - 인감날인 결재현황
+ 프로그램 ID	: a400170.jsp
+ 기 능 정 의	: 인감날인 결재현황
+ 최 초 이 력	: 2017.04.25 jys
+ 가우스 버젼    : 5.2
-----------------------------------------------------------------------------
+ 변 경 이 력	:   
+ 변 경 내 용	:  
...
function ln_Query(){
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a400170_s1?v_str1="+gcem_app_date_fr.text
						...
						<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:-3px;width:280px;border:0 solid #708090;">
							<tr> 			
								<td ALIGN=LEFT VALIGN=TOP>
									<comment id="__NSID__"><object classid=clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B id=gcgd_data style="WIDTH:998px;HEIGHT:550px;border:1 solid #777777;display:block;" viewastext>
								     ...
								     <PARAM NAME="Format"		VALUE="  
										...
										<C> ID=APP_TEAMNM       Name=소속,    	    width=150,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true  </C>
										<C> ID=APP_JOBNM        Name=직위,    	    width=70,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true  </C>
										<C> ID=APP_EMPNM        Name=이름,    	    width=70,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true  </C>
										<C> ID=DOC_GU2NM        Name=구분,    	    width=70,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true  </C>
										<C> ID=APP_DATE         Name=신청일자,	    width=80,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center,	sort = true  MASK='XXXX/XX/XX'</C>
										<C> ID=SIGNET_USE       Name=용도,	        width=200,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,	sort = true  </C>
										<C> ID=SIGNET_SUBMIT    Name=제출처,	        width=200,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,	sort = true  </C>
										<C> ID=AP_STATUS_M_NM   Name=결재상태,        width=80,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center,	sort = true  </C>
