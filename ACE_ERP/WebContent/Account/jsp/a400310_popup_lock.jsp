...
<!---------------------------------------------------------------------------
+ 시 스 템 명	:  지출신청 - 거래처별 계좌번호 조회
+ 프로그램 ID	:  a400310_popup_lock.jsp
+ 기 능 정 의	:  거래처별 계좌번호 조회 
+ 작   성  자 :  정영식
+ 작 성 일 자 :  2017.10.17
-----------------------------------------------------------------------------
+ 수 정 내 용 : 
  ...
  <tr>  
    <td>
		<table  cellpadding="1" cellspacing="0" style='width:670px;height:30px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
        		<tr> 
					<td class="tab21" style="height:30px;width:60px;" bgcolor="#eeeeee" align="center" style="border:0 solid #708090;border-left-width:1px;border-right-width:1px;border-top-width:0px;border-bottom-width:0px;">등록번호</td> 
			...
			<td style="width:280" ALIGN=LEFT VALIGN=TOP>
				...
				<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp01  
					style="position:relative;left:3px;width:670px; height:290px; border:1 solid #708090;display:block;" viewastext>
						...
						<C> Name='거래처명'		    ID=VEND_NM 	   HeadAlign=Center HeadBgColor=#B9D4DC Width=160	  align=left  	SumBgColor='#C3D0DB'	</C> 
						<C> Name='계좌번호'		   	ID=ACCT_NO     HeadAlign=Center HeadBgColor=#B9D4DC Width=145	  align=left    SumBgColor='#C3D0DB'	</C>
						<C> Name='사업자번호'		   	ID=VEND_ID     HeadAlign=Center HeadBgColor=#B9D4DC Width=98	  align=center  SumBgColor='#C3D0DB'  mask={decode(VEND_ID_LEN,10,'XXX-XX-XXXXXX',13,'XXXXXX-XX****X')}	</C>
						<C> Name='예금주'		        ID=ACCT_AUTH   HeadAlign=Center HeadBgColor=#B9D4DC Width=160	  align=left  	SumBgColor='#C3D0DB'	</C> 
						">
				</OBJECT>
