...
function ln_Query(){ 
	...
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a500000_s1"
			...
			<td style="width:280" ALIGN=LEFT VALIGN=TOP>
				...
				<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp01  
					style="position:relative;left:3px;width:470px; height:290px; border:1 solid #708090;display:block;" viewastext>
						...
						<C> Name='사업자번호'		   	ID=VEND_ID     HeadAlign=Center HeadBgColor=#B9D4DC Width=98	  align=center  SumBgColor='#C3D0DB'	</C> 
						">
				</OBJECT>
