...
function ln_Query(){ 
	...
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a500000_s2"
...
<script language="javascript" for="gcgd_disp01" event="OnDblClick()">
		...
		window.returnValue = gcds_code01.namevalue(row,"VEND_CD") + ";" 
							...
							+ gcds_code01.namevalue(row,"BANK_CD") + ";" 							
			...
			<td style="width:280" ALIGN=LEFT VALIGN=TOP>
				...
				<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp01  
					style="position:relative;left:3px;width:470px; height:290px; border:1 solid #708090;display:block;" viewastext>
						...
						<C> Name='거래처'		        ID=VEND_CD	   HeadAlign=Center HeadBgColor=#B9D4DC Width=140	  align=left  	SumBgColor='#C3D0DB'	show=false</C> 
						<C> Name='거래처명'		    ID=VEND_NM 	   HeadAlign=Center HeadBgColor=#B9D4DC Width=140	  align=left  	SumBgColor='#C3D0DB'	</C> 
						<C> Name='거래처명'		    ID=VEND_CD 	   HeadAlign=Center HeadBgColor=#B9D4DC Width=140	  align=left  	SumBgColor='#C3D0DB'	show=false</C> 
						<C> Name='은행'		   		ID=BANK_NM     HeadAlign=Center HeadBgColor=#B9D4DC Width=250	  align=center  SumBgColor='#C3D0DB'	</C> 
						">
				</OBJECT>
