...
function ln_Query(){ 
	...
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a500000_s3"
									   							+"?v_str1="+txt_banknm.value;
...
<script language="javascript" for="gcgd_disp01" event="OnDblClick()">
		...
		window.returnValue = gcds_code01.namevalue(row,"BANK_CD") + ";" 							
					   	 	+ gcds_code01.namevalue(row,"BANK_NM")+";";
  ...
  <tr>  
    <td>
		<table  cellpadding="1" cellspacing="0" style='width:470px;height:30px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
        		<tr> 
					<td class="tab21" style="height:30px;width:60px;" bgcolor="#eeeeee" align="center" style="border:0 solid #708090;border-left-width:1px;border-right-width:1px;border-top-width:0px;border-bottom-width:0px;">은행명</td> 
				  	<td style="border:0 solid #708090;border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom-width:0px;text-align;height:30px;font-family:굴림;font-size:9pt;">&nbsp;    
						<input id="txt_banknm" type="text"  style= "position:relative;top:-1px;left:-1px; width:150px; height:20px;" class="txtbox" onkeydown="if(event.keyCode==13) ln_Query();">			
					</td>
				</tr>
			</table>
		</td>
			...
			<td style="width:280" ALIGN=LEFT VALIGN=TOP>
				...
				<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp01  
					style="position:relative;left:3px;width:470px; height:290px; border:1 solid #708090;display:block;" viewastext>
						...
						<C> Name='은행코드'		    ID=BANK_CD	   HeadAlign=Center HeadBgColor=#B9D4DC Width=100	  align=center	SumBgColor='#C3D0DB'	</C> 
						<C> Name='은행'		   		ID=BANK_NM     HeadAlign=Center HeadBgColor=#B9D4DC Width=300	  align=center  SumBgColor='#C3D0DB'	</C> 
						">
				</OBJECT>
