...
function fnFileDown(){
	...
	var strReal_file=real_file10.slice(0,1);
	...
	if(strReal_file==""){
		...
		return;
	}else if(strReal_file.length==1){
		strSys_file=gcds_data.namevalue(gcds_data.rowposition,"SYS_FILE_NAME");
		location.href ="./a500010_fileDownload.jsp?dir=&filename="+strReal_file+"&sysfilename="+strSys_file; //운영
	}
}
  ...
  <tr>
	 <td>
		...
		<tr> 
			...
			<td class="tab17" width="80px;" bgcolor="#eeeeee" align="center">상태</td>
			...
			<td class="tab20" width="80px;" bgcolor="#eeeeee" align="center">은행</td>
			<td class="tab20"  align="left" >
		...
		<table>
			...
			<td>
				...
				<tr>
						...
						<input type=checkbox  id=chkbox_v_acctno_chk  style="width:15px;position:relative;left:5px;top:-3px"   onclick="ln_Check_Vacctno()">&nbsp;가상계좌 체크
						</td>
				</tr>
