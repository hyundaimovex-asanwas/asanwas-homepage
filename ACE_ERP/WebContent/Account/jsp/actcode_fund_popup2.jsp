...
******************************************************************************/
function ln_Query(){
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>actcode_fund_s2?v_str1="+txt_atcode.value
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					<C>ID=ATCODE,		 Name=코드,   	  width=60,	  Common/BgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true</C>
					<C>ID=ATKORNAM,	 Name=계정과목명, width=220,	Common/BgColor=#B9D4DC, bgcolor=#ffffff, align=left,		sort = true</C>
					<C>ID=FUNDIV,	   Name=구분,       width=50,	  Common/BgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true</C>
