...
function ln_Start(){
	...
	//계정구분
	gcds_comcode01.DataID = g_servlet+"/Account.comcode_s1?v_str1=0033";
...
******************************************************************************/
function ln_Query(){
	gcds_code01.DataID =  "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>actcode_cost_s1?v_str1="+txt_atcode.value+"&v_str2="+txt_atkornam.value
