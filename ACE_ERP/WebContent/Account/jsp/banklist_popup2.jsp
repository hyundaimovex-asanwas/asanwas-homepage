...
function ln_Query(){
	...
	gcds_bank1.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a010006_s4?v_str1="+txt_bankname.value; 
	gcds_bank1.Reset();
}
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:469px;border:1 solid #708090">
	<tr>
		...
		<td><img src="../../Common/img/btn/com_b_find.gif" alt="분류코드를 검색합니다" style="position:relative;left:12px;top:0px;cursor:hand;" onclick="ln_Query()"></td>
	</tr>
</table>
<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:5px;top:10px">
	<tr>
		<td class="tab21" colspan="3">
			<comment id="__NSID__"><object  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp style="width:468;height:239px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
		    <PARAM NAME="DataID"			VALUE="gcds_bank1">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					<C>ID=BANCOD,		Name=결재은행,	width=150,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, Align=Center, sort=true</C>
					<C>ID=BANNAM,   Name=은행명, width=300, HeadBgColor=#B9D4DC, bgcolor=#ffffff, Align=Left, sort=true</C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
	<tr>
		<td>
			<fieldset id=ft_div1 style="width:470;height:20px;border:1 solid #708090;border-top-width:0px;text-align:left;">
