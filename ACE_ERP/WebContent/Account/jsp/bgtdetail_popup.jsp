		...
		<td>
			...
			<tr> 			
				<td style="width:280" ALIGN=LEFT VALIGN=TOP>
					...
					<fieldset style="position:relative;left:8px;width:866px;height:53px;border:1 solid #708090;border-top-width:0px;border-bottom-width:1px;text-align:left;"><nobr><input type="text" class="txtbox" value="신청사유:" style="position:relative;top:-30px;left:5px;border:0;width:70px"><comment id="__NSID__">
...
<table id="div_disp2" cellpadding="0" cellspacing="0" border="0" style="display:none">
	<tr><td align="center" colspan=2>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:8px;width:866px;border:1 solid #708090;">
			<tr>
				...
				<td class="tab11" style="height:25px;width:80px;" bgcolor="#eeeeee">작성일자</td>
				<td class="tab21" width="100px"><comment id="__NSID__">
					<object id=gcem_swrdt2 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
							style="position:relative; left:5px;top:2px; width:70px; height:20px;" class="txtbox">
						<param name=Alignment			value=0>
						<param name=Border	      value=true>
						<param name=Format	      value="YYYY/MM/DD">
					...
					<img src="../img/calender.gif" value="calender.gif" id=img_calendar1 OnClick="__GetCallCalendar('gcem_swrdt2', 'Text')" style="position:relative;width:20px;left:9px;top:1px;cursor:hand;">
				</td>
				<td class="tab11" style="height:25px;width:80px;" bgcolor="#eeeeee">신청부서</td>
				<td class="tab22" width="40px"><comment id="__NSID__">
					<object  id=gclx_sbgtdpt2 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  style="position:relative;left:5px;top:1px;width:160px;height:200px;">
	...
	<tr>
		<td>
		<table border="1" cellpadding="0" cellspacing="0" style="position:relative;left:8px;top:-1px;width:866px;border:0 solid #708090;">
			<tr>
				<td class="tab38" width="486">
					&nbsp;배&nbsp;&nbsp;&nbsp;정&nbsp;&nbsp;&nbsp;액 : 
				<comment id="__NSID__"><object  id=gcem_bgtamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:-2px;top:2px;left:7px;width:122px;height:15px">
					<param name=Text				value="">
					...
					<param name=Enable			value="false">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;재&nbsp;&nbsp;배&nbsp;정&nbsp;액 : 
				<comment id="__NSID__"><object  id=gcem_rebgtamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:-2px;top:2px;left:7px;width:122px;height:15px">
					<param name=Text				value="">
					<param name=Alignment		value=2>
					<param name=Border			value=true>
					<param name=Format			value="000,000,000,000,000">
					...
					<param name=Enable			value="false">
							...
							&nbsp;기집행누계액 : 
				<comment id="__NSID__"><object  id=gcem_resultamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:-2px;top:2px;left:7px;width:122px;height:15px">
					<param name=Text				value="">
					<param name=Alignment		value=2>
					<param name=Border			value=true>
					<param name=Format			value="000,000,000,000,000">
					...
					<param name=Enable			value="false">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;가용사용잔액 : 
				<comment id="__NSID__"><object  id=gcem_remaintamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:-2px;top:2px;left:7px;width:122px;height:15px">
					<param name=Text				value="">
					<param name=Alignment		value=2>
					<param name=Border			value=true>
					<param name=Format			value="000,000,000,000,000">
					...
					<param name=Enable			value="false">
							...
							&nbsp;요&nbsp;&nbsp;&nbsp;청&nbsp;&nbsp;&nbsp;액 : 
				<comment id="__NSID__"><object  id=gcem_bgtrqamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:-2px;top:2px;left:7px;width:122px;height:15px">
					<param name=Text				value="">
					<param name=Alignment		value=2>
					<param name=Border			value=true>
					<param name=Format			value="000,000,000,000,000">
			...
			<td class="tab15" width="390" ALIGN=LEFT VALIGN=TOP><nobr><input type="text" class="txtbox" value="신청사유:" style="position:relative;top:-38px;left:5px;border:0;width:70px"><comment id="__NSID__">
				<object  id=gcem_whybgtrqnote2 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:300px;height:54px;position:relative;left:3px;top:1px">		
					<param name=Text					value="">
					<param name=Border        value=true>
					<param name=GeneralEdit   value="true">
					<param name=BackColor     value="#CCCCCC">
		...
		<tr>
			<td height="2px" align="right">
				<img src="../../Common/img/btn/com_b_print.gif"		style="position:relative;right:3px;top:-188px;cursor:hand" onClick="ln_Print()">
				<img src="../../Common/img/btn/com_b_query.gif"		style="position:relative;right:3px;top:-188px;cursor:hand" onclick="ln_Query('01')">
			</td>
		</tr>
		<tr> 			
			<td style="width:280" ALIGN=LEFT VALIGN=TOP>
				<comment id="__NSID__"><object  id=gcgd_disp02 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49   
					style="position:relative;top:-22px;left:8px;width:864px;height:300px; border:1 solid #708090;display:block;" viewastext>
					<PARAM NAME="DataID"			VALUE="gcds_data2">
					<PARAM NAME="IndWidth"		VALUE="0">
					<PARAM NAME="BorderStyle" VALUE="0">
					<PARAM NAME="Fillarea"		VALUE="true">
					...
					<PARAM NAME="ViewSummary"	VALUE="1">
					<PARAM NAME="Format"			VALUE="  
						<F> Name='월'					ID=BGTRQMON		HeadAlign=Center HeadBgColor=#B9D4DC Width=40	align=center SumBgColor=#C3D0DB SumText='계' BgColor='#f5f5f5'</F> 
						<F> Name='배정액'			ID=BGTAMT   	HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right	 SumBgColor=#C3D0DB SumText=@sum BgColor='#f5f5f5'</F> 
						<F> Name='추가예산'		ID=BGTADAMT	  HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right	 SumBgColor=#C3D0DB SumText=@sum BgColor='#f5f5f5'</F> 
						<F> Name='전기이월'		ID=AMTFROMB  	HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right	 SumBgColor=#C3D0DB SumText=@sum BgColor='#f5f5f5'</F> 
						<F> Name='차기이월'		ID=AMTGIVETO	HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right	 SumBgColor=#C3D0DB SumText=@sum BgColor='#f5f5f5'</F> 
						<C> Name='조기집행'		ID=AMTFROMA		HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right	 SumBgColor=#C3D0DB SumText=@sum</C>
						<C> Name='피조기집행'	ID=AMTGVTOB		HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right  SumBgColor=#C3D0DB SumText=@sum</C>
						<C> Name='전용'				ID=DVTFRAMT		HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right  SumBgColor=#C3D0DB SumText=@sum</C>
						<C> Name='피전용'			ID=CHGBGT			HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right  SumBgColor=#C3D0DB SumText=@sum</C>
						<C> Name='총예산'			ID=BASICBGT		HeadAlign=Center HeadBgColor=#B9D4DC Width=80	align=right  SumBgColor=#C3D0DB SumText=@sum</C>
						<C> Name='실적'				ID=BASICBGT		HeadAlign=Center HeadBgColor=#B9D4DC Width=90	align=right  SumBgColor=#C3D0DB SumText=@sum</C>
					">
				</object></comment><script>__ws__(__NSID__);</script> 
				<fieldset style="position:relative;top:-22px;left:8px;width:866px;height:20px;border:1 solid #708090;border-top-width:0px;border-bottom-width:1px;text-align:left;">
					&nbsp;<font id="ft_cnt02" style="position:relative;top:4px;"></font>
