...
function ln_Query(p){
	...
	gcds_code01.DataID ="<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>commdtil_s1?v_str1="+p+"&v_str2="+txt_cdcode.value+"&v_str3="+txt_cdnam.value+"&v_str4=C"; 
	gcds_code01.Reset();
}
...
<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:5px;top:10px">
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					...
					<C>ID=CDNAM,		Name=코드명,		width=145,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left, sort = true</C>
					<C>ID=DSUDT,		Name=폐기일자,	width=75,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true</C>
					<C>ID=CDREMARK,	Name=비고,	    width=170,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left</C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
	...
	<tr>
		<td height="30px;" align="center">
			<img name="btn_select" border="0" src="<%=HDConstant.PATH_ACC_COMMON%>img/btn/com_b_select.gif" style="cursor:hand" onClick="ln_Close('A')">
			<img name="btn_close" border="0" src="<%=HDConstant.PATH_ACC_COMMON%>img/btn/com_b_close.gif" style="cursor:hand" onClick="ln_Close('C')">
		</td>
	</tr>
</table>
