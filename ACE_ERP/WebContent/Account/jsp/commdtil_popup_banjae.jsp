...
function ln_Query(){
	...
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>commdtil_s3?v_str1="+g_cmtype
	                                                          +"&v_str2="+txt_cdcodenm.value
																														+"&v_str3="+txt_remark.value; 
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:382px;border:1 solid #708090">
	<tr>
		<td class="tab12" width="60px;" bgcolor="#eeeeee">코드명칭</td>
		<td width="130px"><input type="text" class="txt11" id="txt_cdcodenm" style="position:relative;left:4px;width:125px;" onkeydown="if(event.keyCode==13) ln_Query();"></td>
		<td class="tab41" width="40px;" bgcolor="#eeeeee">비고</td>
		<td width="90px"><input type="text" class="txt11" id="txt_remark" style="position:relative;left:4px;width:85px;" onkeydown="if(event.keyCode==13) ln_Query();"></td>
		<td><img src="../../Common/img/btn/com_b_find.gif" alt="코드 및 코드명을 검색합니다" style="cursor:hand;position:relative;left:10px;" onclick="ln_Query()"></td>
	</tr>
</table>
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					...
					<C>ID=CDNAM,		Name=명칭,	width=195,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
				  <C>ID=REMARK,	  Name=비고,	width=100,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
