...
+ 프로그램 ID	:  Commdtil_popup_card.html
+ 기 능 정 의	:  카드번호
+ 작   성  자 :  정 영 식
+ 작 성 일 자 :  2006.09.14
-----------------------------------------------------------------------------
...
function ln_Query(){
	...
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>commdtil_s4?v_str1="+g_cmtype+"&v_str2="+txt_cdcodenm.value+"&v_str3=&v_str4="+g_gbcd; 
...
function ln_Close(p){
	if (p=="A") {
		...
		window.returnValue = gcds_code01.namevalue(row,"CDCODE")+";" 
		                   + gcds_code01.namevalue(row,"CARDNUM")+";" 
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					...
					<C>ID=CARDNUM,	Name=카드번호, width=195,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
					<C>ID=BANKNM,		Name=카드구분, width=100,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
