...
function ln_Query(e){
    ...
    gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>empno_asnhr_s1?v_str1="+txt_nm.value;
...
function ln_Close(e){
  var row= gcds_data.rowposition;
	...
	if(e=="A"){
		window.returnValue = gcds_data.namevalue(row,"EMPID") + ";" 
		...
		<td class="tab21" colspan="3">
			...
			<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp style="width:358;height:239px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
			  ...
			  <PARAM NAME="Format"			VALUE="  
				<C>ID=EMPID,		Name=관리자ID,   width=70,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true</C>
				<C>ID=EMPNO,		Name=사번,	   width=80,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
				<C>ID=EMPNMK,		Name=성명,	   width=106,	    HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
				<C>ID=DEPTNMK,		Name=소속명,	   width=86,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,   sort = true</C>
			 ">
	    	</OBJECT>
	    	</comment><script>__ws__(__NSID__);</script>
		</td>
