		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					<C>ID=DEPTCD,		 Name=부서코드,   width=140,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true</C>
					<C>ID=DEPTNM,		 Name=부서명,			width=320,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,		sort=true</C>
					<C>ID=DEPTNMK,	 Name=부서명1,    width=50,	  HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true show = false </C>
					<C>ID=DEPTCD2,	 Name=부서코드2,  width=50,	  HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true show = false </C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
