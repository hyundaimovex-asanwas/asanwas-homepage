...
******************************************************************************/
function ln_Query(){
	gcds_code01.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>hcdept_s2?v_str1="+txt_deptcd.value+"&v_str2="+txt_deptnm.value;
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:478px;border:1 solid #708090">
	<tr>
    	<td class="tab12" width="65px;" bgcolor="#eeeeee" align="center">부서명</td>
		...
		<td class="tab16" width="70px;" bgcolor="#eeeeee" align="center">부서코드</td>
		...
		<td><img src="../../Common/img/btn/com_b_clear.gif" alt="부서코드를 검색합니다" style="position:relative;left:-10px;top:0px;cursor:hand;" onclick="ln_Clear()"></td>
	</tr>
</table>
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					<C>ID=CDCODE,		 Name=부서코드,   width=140,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true</C>
					<C>ID=CDNAM,		 Name=부서명,			width=320,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,		sort=true</C>
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
