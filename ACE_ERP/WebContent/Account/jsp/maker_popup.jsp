...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:478px;border:1 solid #708090">
	<tr>
    <td class="tab12" width="65px;" bgcolor="#eeeeee" align="center">제작처명</td>
		...
		<td class="tab16" width="70px;" bgcolor="#eeeeee" align="center">제작처코드</td>
		...
		<td class="tab21" colspan="3">
		    ...
		    <PARAM NAME="DataID"			VALUE="gcds_code01">
			  ...
			  <PARAM NAME="Format"			VALUE="  
					<C>ID=CMTYPE,		 Name=자산코드,   width=140,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true show=false</C>
					<C>ID=CDCODE,		 Name=자산코드,   width=140,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort=true</C>
					<C>ID=CDNAM,		 Name=자산명,			width=320,	HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left,		sort=true</C>				
				">
	    </object></comment><script>__ws__(__NSID__);</script> 
		</td>
	</tr>
