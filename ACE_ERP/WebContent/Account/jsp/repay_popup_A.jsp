...
function ln_Query(){
	...
	gcds_data010.DataID = "<%=dirPath%><%=HDConstant.PATH_ACCOUNT%>a020003_s1?v_str1="+gs_fdcode                     //지점       
...
function ln_Chk(){
	...
	for(i=1;i<=gcds_data010.CountRow;i++){
		if(gcds_data010.namevalue(1,"CHK")=="T"){
			strRetrun="true";
		}
	}
...
function ln_Chk2(){
   ...
   _out:
	for(j=1;j<=gcds_data010.CountRow-1;j++){
		if(gcds_data010.namevalue(j,"CHK")=="T"){
			for(k=j+1;k<=gcds_data010.CountRow;k++){
				if(gcds_data010.namevalue(k,"CHK")=="T"){
					if(gcds_data010.namevalue(k,"ATCODE")=="1112500"){
						if(gcds_data010.namevalue(j,"VENDCD")==gcds_data010.namevalue(k,"VENDCD")){
						...
						if(gcds_data010.namevalue(j,"VENDCD")==gcds_data010.namevalue(k,"VENDCD")&&gcds_data010.namevalue(j,"FSREFCD")==gcds_data010.namevalue(k,"FSREFCD")&&gcds_data010.namevalue(j,"FSREFVAL")==gcds_data010.namevalue(k,"FSREFVAL")){
...
function ln_Data(){
	...
	gs_banjaeyn="N";
 	 ...
 	 for (i=1;i<=gcds_data010.countrow;i++){
	  //alert("i::"+i+"FDCODE:"+gcds_data010.namevalue(i,"FDCODE")+"::FSNBR::"+gcds_data010.namevalue(i,"FSNBR")+"::chk::"+gcds_data010.namevalue(i,"CHK"));
		if(gcds_data010.namevalue(i,"CHK")=="T"){ //체크된 항목
		  //alert("i::"+i);
		  	gcds_data02.addrow();
			//alert("position"+gcds_data02.rowposition);
			gcds_data02.namevalue(gcds_data02.rowposition,"FTSTAT") = strFtstat;
			gcds_data02.namevalue(gcds_data02.rowposition,"FDCODE") = gcds_data010.namevalue(i,"FDCODE");
			gcds_data02.namevalue(gcds_data02.rowposition,"TSDAT")  = gcds_data010.namevalue(i,"FSDAT");
			gcds_data02.namevalue(gcds_data02.rowposition,"TSNBR")  = gcds_data010.namevalue(i,"FSNBR");
			gcds_data02.namevalue(gcds_data02.rowposition,"TSSEQ")  = gcds_data010.namevalue(i,"FSSEQ");
			...
			//합계금액
		  if(gcds_data010.namevalue(i,"ATDECR")=="1"){
				dblSum+=gcds_data010.namevalue(i,"CHAAMT");
				gs_rechaamt +=gcds_data010.namevalue(i,"CHAAMT"); 
			}else if(gcds_data010.namevalue(i,"ATDECR")=="2"){
				dblSum+=gcds_data010.namevalue(i,"DAEAMT");
				gs_redaeamt +=gcds_data010.namevalue(i,"CHAAMT"); 
			}
      		dblTotal+=gcds_data010.namevalue(i,"TOTAL");
		}else{                       //체크안된항목
...
function ln_Data_Mst_Save(i){
    ...
    strParam.gcds_banjaemst.namevalue(row,"FDCODE")=gcds_data010.namevalue(i,"FDCODE");
	strParam.gcds_banjaemst.namevalue(row,"TSDAT")=gcds_data010.namevalue(i,"FSDAT");
	strParam.gcds_banjaemst.namevalue(row,"TSNBR")=gcds_data010.namevalue(i,"FSNBR");
	strParam.gcds_banjaemst.namevalue(row,"TSSEQ")=gcds_data010.namevalue(i,"FSSEQ");
	strParam.gcds_banjaemst.namevalue(row,"ATCODE")=gcds_data010.namevalue(i,"ATCODE");
	
	strParam.gcds_banjaemst.namevalue(row,"DEPTCD")=gcds_data010.namevalue(i,"DEPTCD");   
	strParam.gcds_banjaemst.namevalue(row,"VENDCD")=gcds_data010.namevalue(i,"VENDCD");   
	strParam.gcds_banjaemst.namevalue(row,"FSREFCD")=gcds_data010.namevalue(i,"FSREFCD");   
	strParam.gcds_banjaemst.namevalue(row,"FSREFVAL")=gcds_data010.namevalue(i,"FSREFVAL");

	//차변과 대변을 바꿔서 입력함...............(정산되기 때문)////////////////////////////////////
	strParam.gcds_banjaemst.namevalue(row,"DEAMT")= gcds_data010.namevalue(i,"DAEAMT");
	strParam.gcds_banjaemst.namevalue(row,"CRAMT")=	gcds_data010.namevalue(i,"CHAAMT"); 
	///////////////////////////////////////////////////////////////////////////////////////////////
	strParam.gcds_banjaemst.namevalue(row,"STATUS")="";
	strParam.gcds_banjaemst.namevalue(row,"SSDAT")=gcds_data010.namevalue(i,"SSDAT");
	strParam.gcds_banjaemst.namevalue(row,"SSNBR")=gcds_data010.namevalue(i,"SSNBR");
	strParam.gcds_banjaemst.namevalue(row,"FSNUM")=gcds_data010.namevalue(i,"FSNUM");
    strParam.gcds_banjaemst.namevalue(row,"REMARK")=gcds_data010.namevalue(i,"REMARK");
	...
	//반제대상 원래의 금액(정산하기 전의 금액임)///////////////////////////////////////////////////
     if(gcds_data010.namevalue(i,"CHAAMT")==0){ 
		dblAmt = gcds_data010.namevalue(i,"DAEAMT");
		dbldeamt=gcds_data010.namevalue(i,"BANJAEAMT");
		dblcramt=0;
	}else if(gcds_data010.namevalue(i,"DAEAMT")==0){
		dblAmt = gcds_data010.namevalue(i,"CHAAMT");
		dbldeamt=0;
		dblcramt = gcds_data010.namevalue(i,"BANJAEAMT");
	}else{
		if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")>0){
			//dblAmt = gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT");
			dblAmt = gcds_data010.namevalue(i,"CHAAMT");
			dbldeamt=0;
			dblcramt = gcds_data010.namevalue(i,"BANJAEAMT");
		}else if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")<0){
			//dblAmt = gcds_data010.namevalue(i,"DAEAMT")-gcds_data010.namevalue(i,"CHAAMT");
			dblAmt = gcds_data010.namevalue(i,"DAEAMT");
			dbldeamt=gcds_data010.namevalue(i,"BANJAEAMT");
			dblcramt=0;
		}
...
function ln_Data_Rel_Save(i){
  var row=0;
	...
	strParam.gcds_banjae.namevalue(row,"FDCODE")=gcds_data010.namevalue(i,"FDCODE");
	strParam.gcds_banjae.namevalue(row,"TSDAT")=gcds_data010.namevalue(i,"FSDAT");
	strParam.gcds_banjae.namevalue(row,"TSNBR")=gcds_data010.namevalue(i,"FSNBR");
	strParam.gcds_banjae.namevalue(row,"TSSEQ")=gcds_data010.namevalue(i,"FSSEQ");
	...
	strParam.gcds_banjae.namevalue(row,"SSDAT")=gcds_data010.namevalue(i,"SSDAT");  

	strParam.gcds_banjae.namevalue(row,"SSNBR")=gcds_data010.namevalue(i,"SSNBR");
	strParam.gcds_banjae.namevalue(row,"FSNUM")=gcds_data010.namevalue(i,"FSNUM");
	...
	if(gcds_data010.namevalue(i,"CHAAMT")==0){ 
		strParam.gcds_banjae.namevalue(row,"BJDEAMT") = gcds_data010.namevalue(i,"BANJAEAMT"); 
		strParam.gcds_banjae.namevalue(row,"BJCRAMT") = 0;
	}else if(gcds_data010.namevalue(i,"DAEAMT")==0){
		strParam.gcds_banjae.namevalue(row,"BJDEAMT") = 0; 
		strParam.gcds_banjae.namevalue(row,"BJCRAMT") = gcds_data010.namevalue(i,"BANJAEAMT");
	}else{
		if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")>0){
			strParam.gcds_banjae.namevalue(row,"BJDEAMT") = 0; 
			strParam.gcds_banjae.namevalue(row,"BJCRAMT") = gcds_data010.namevalue(i,"BANJAEAMT");
...
function ln_Amt_Chk(p1,i){
	...
	if(strParam.gcds_banjae.countrow>0){
		for(j=1;j<=strParam.gcds_banjae.countrow;j++){
			if(gcds_data010.namevalue(i,"FDCODE")==strParam.gcds_banjae.namevalue(j,"FDCODE")&&
				 gcds_data010.namevalue(i,"FSDAT")==strParam.gcds_banjae.namevalue(j,"TSDAT")&&
				 gcds_data010.namevalue(i,"FSNBR")==strParam.gcds_banjae.namevalue(j,"TSNBR")&&
				 gcds_data010.namevalue(i,"FSSEQ")==strParam.gcds_banjae.namevalue(j,"TSSEQ")){
...
function ln_Dtl_Amt_Chk_Return(i,gubun){
	...
	for(k=1;k<=strParam.gcds_banjae.countrow;k++){
		if(gcds_data010.namevalue(i,"FDCODE")==strParam.gcds_banjae.namevalue(k,"FDCODE")&&
			 gcds_data010.namevalue(i,"FSDAT")==strParam.gcds_banjae.namevalue(k,"TSDAT")&&
			 gcds_data010.namevalue(i,"FSNBR")==strParam.gcds_banjae.namevalue(k,"TSNBR")&&
			 gcds_data010.namevalue(i,"FSSEQ")==strParam.gcds_banjae.namevalue(k,"TSSEQ")){
        
			 if(gcds_data010.namevalue(i,"DAEAMT")==0){       //차변발생
					dblDaeamt += strParam.gcds_banjae.namevalue(k,"BJCRAMT"); 
			 }else if(gcds_data010.namevalue(i,"CHAAMT")==0){ //대변발생
					dblChaamt+= strParam.gcds_banjae.namevalue(k,"BJDEAMT");
			 }else{
					if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")>0){ //차변발생
						 //dblDaeamt=dblDaeamt+gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")+strParam.gcds_banjae.namevalue(k,"BJDEAMT");
						 dblDaeamt=dblDaeamt+strParam.gcds_banjae.namevalue(k,"BJCRAMT");
						 //alert("dblChaamt"+dblChaamt);
					}else if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")<0){  //대변발생
						 //dblChaamt=dblChaamt+gcds_data010.namevalue(i,"DAEAMT")-gcds_data010.namevalue(i,"CHAAMT")+strParam.gcds_banjae.namevalue(k,"BJCRAMT");
						 //alert("dblChaamt"+dblChaamt);
	...
	if(gcds_data010.namevalue(i,"DAEAMT")==0){  //차변발생
		gcds_data010.namevalue(i,"JANAMT")=gcds_data010.namevalue(i,"CHAAMT")-dblDaeamt;
	}else if(gcds_data010.namevalue(i,"CHAAMT")==0){
		gcds_data010.namevalue(i,"JANAMT")=gcds_data010.namevalue(i,"DAEAMT")-dblChaamt;
	}else{
		if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")>0){
      		gcds_data010.namevalue(i,"JANAMT")=gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")-dblDaeamt;
		}else if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")<0){
			gcds_data010.namevalue(i,"JANAMT")=gcds_data010.namevalue(i,"DAEAMT")-gcds_data010.namevalue(i,"CHAAMT")-dblChaamt;
		}
	}
	...
	if(gubun=="2"){
		...
		return gcds_data010.namevalue(i,"JANAMT");
	}
}
...
function ln_Close(){
   ...
   for(i=1;i<=gcds_data010.countrow;i++){
		...
		if(gcds_data010.namevalue(i,"CHK")=="T"){
			
			ln_Data_Mst_Save(i);
			ln_Data_Rel_Save(i);

      		if(strremark==""){
				strremark =gcds_data010.namevalue(i,"REMARK");
			}
      		      
			if(gcds_data010.namevalue(i,"DAEAMT")==0){
				gs_rechaamt +=gcds_data010.namevalue(i,"BANJAEAMT");  
			}else if(gcds_data010.namevalue(i,"CHAAMT")==0){
				gs_redaeamt +=gcds_data010.namevalue(i,"BANJAEAMT");  
			}else{
				if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")>0){
					gs_rechaamt +=gcds_data010.namevalue(i,"BANJAEAMT"); 
				}else if(gcds_data010.namevalue(i,"CHAAMT")-gcds_data010.namevalue(i,"DAEAMT")<0){
			...
			if(strfsrefcd==""&&strfsrefval==""){
				strfsrefcd = gcds_data010.namevalue(i,"FSREFCD");  
				strfsrefval = gcds_data010.namevalue(i,"FSREFVAL");  
				strfsrefvalnm = gcds_data010.namevalue(i,"FSREFNM"); 
				
				if(gcds_data010.namevalue(i,"REFCD2")!=""&&gcds_data010.namevalue(i,"REFCD2")!=undefined&&gcds_data010.namevalue(i,"REFVAL2")!=""&&gcds_data010.namevalue(i,"REFVAL2")!=undefined){
					strrefcd2=gcds_data010.namevalue(i,"REFCD2");
					strrefval2=gcds_data010.namevalue(i,"REFVAL2");
					strrefvalnm2=gcds_data010.namevalue(i,"REFVALNM2");
				}else{
          			strrefcd2="";
					strrefval2="";
					strrefvalnm2="";
	...
	for(i=1;i<=gcds_data010.countrow;i++){
		...
		for(j=1;j<=strParam.gcds_banjae.countrow;j++){
			if(gcds_data010.namevalue(i,"FDCODE")==strParam.gcds_banjae.namevalue(j,"FDCODE")&&
				 ...
				 if(gcds_data010.namevalue(i,"ATDECR")=="2"){
					 tempbjdeamt += strParam.gcds_banjae.namevalue(j,"BJDEAMT");
				 }else if(gcds_data010.namevalue(i,"ATDECR")=="1"){
					 tempbjcramt += strParam.gcds_banjae.namevalue(j,"BJCRAMT");
				 }
			}
		}//for j
		...
		if(gcds_data010.namevalue(i,"ATDECR")=="1"){
			gcds_data010.namevalue(i,"JANAMT")= gcds_data010.namevalue(i,"JANAMT") - tempbjcramt; 
   	    }else if(gcds_data010.namevalue(i,"ATDECR")=="2"){
      		gcds_data010.namevalue(i,"JANAMT")= gcds_data010.namevalue(i,"JANAMT") - tempbjdeamt; 
		}else{
      		gcds_data010.namevalue(i,"JANAMT")=0;
		}
	}//for i
}
	...
	var dbltemp=0;
	  ...
	  if(row>0){
		   //alert("row::"+row);
			if(colid=="CHK") {
				//alert("step1");
				if(gs_userid!="2210014"){//
					//2015.07.01 jys  대금지급 생성건은 msgbox 처리 ///////////////////////////////////
				    if(gcds_data010.namevalue(row,"GCUSTPAY_CHK")=="Y"){
				    	if(gcds_data010.namevalue(row,"ATCODE")=="2100110"){
				    		alert("외상매입금 (일반업체)는 일괄 대금지급건입니다. 건별 반제 불가.  ");
				    		return false;
				    	}else if(gcds_data010.namevalue(row,"ATCODE")=="2100510"){
				...
				//alert("step2:CHK:"+gcds_data010.namevalue(row,"CHK"));
				//alert("strParam.gcds_banjae.countrow:"+strParam.gcds_banjae.countrow);			
				if(gcds_data010.namevalue(row,"CHK") == "T"){
					if(strParam.gcds_banjae.countrow<=0){
						gcds_data010.namevalue(row,"CHK") = "F";
						gcds_data010.namevalue(row,"JANAMT") = gcds_data010.OrgNameValue(row,"JANAMT");
						gcds_data010.namevalue(row,"BANJAEAMT")=0;
					}else{
						gcds_data010.namevalue(row,"CHK") = "F";
						dbltemp=ln_Dtl_Amt_Chk_Return(row,'');
						gcds_data010.namevalue(row,"JANAMT")=dbltemp;
						gcds_data010.namevalue(row,"BANJAEAMT")=0;
					}
				}else{
					if(strParam.gcds_banjae.countrow<=0){
						gcds_data010.namevalue(row,"CHK") = "T";
						gcds_data010.namevalue(row,"BANJAEAMT")=gcds_data010.namevalue(row,"JANAMT");
						gcds_data010.namevalue(row,"JANAMT")=gcds_data010.namevalue(row,"JANAMT")-gcds_data010.namevalue(row,"BANJAEAMT");
					}else{
						gcds_data010.namevalue(row,"CHK") = "T";
						dbltemp=ln_Dtl_Amt_Chk_Return(row,'');
						gcds_data010.namevalue(row,"BANJAEAMT")=dbltemp;
						gcds_data010.namevalue(row,"JANAMT")=dbltemp-gcds_data010.namevalue(row,"BANJAEAMT");
					}
				}
			}
		...
		if(colid=="BANJAEAMT"&&gcds_data010.namevalue(row,"CHK")=="T") {
...
------------------------------------------------------------------------------>
<!-- 반제조회 -->
<comment id="__NSID__"><object  id=gcds_data010 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
...
<script language="javascript" for="gcds_data010" event="OnLoadStarted()">
	ft_cnt01.innerText="데이타 조회중입니다.";
	document.all.LowerFrame.style.visibility="visible";
</script>

<script language="javascript" for="gcds_data010" event="onloadCompleted(row,colid)">
  
 
	if(gcds_data010.countrow<=0){
		alert("조회된 데이타가 없습니다.");
	}else{
	  //2007.06.28 추가한 내용
		if(gcds_data010.namevalue(row,"ATCODE")=="2100520"){
...
<script language="javascript" for="gcgd_disp01" event="OnClick(row,colid)">
	...
	if(gs_userid=="2050053"||gs_userid=="6070001"){
		...
		if((row==0) && (colid=="CHK")){
			...
			for(var i=1;i<=gcds_data010.countrow;i++){
...
<script language="javascript"  for=gcgd_disp01 event=OnExit(row,colid,olddata)>
	...
	if(colid=="BANJAEAMT"){
		if(gcds_data010.namevalue(row,"CHAAMT")!=0&&gcds_data010.namevalue(row,"DAEAMT")==0){ //차변발생
			tempamt = ln_Amt_Chk("01",row);
			dblAmt=gcds_data010.namevalue(row,"CHAAMT")-gcds_data010.namevalue(row,"DAEAMT");
		}else if(gcds_data010.namevalue(row,"CHAAMT")==0&&gcds_data010.namevalue(row,"DAEAMT")!=0){
			tempamt = ln_Amt_Chk("02",row);
			dblAmt=gcds_data010.namevalue(row,"DAEAMT")-gcds_data010.namevalue(row,"CHAAMT");
		}else{
		  if(gcds_data010.namevalue(row,"CHAAMT")-gcds_data010.namevalue(row,"DAEAMT")>0){ //차변발생
			  tempamt = ln_Amt_Chk("01",row);
				dblAmt=gcds_data010.namevalue(row,"CHAAMT")-gcds_data010.namevalue(row,"DAEAMT")
      }else if(gcds_data010.namevalue(row,"CHAAMT")-gcds_data010.namevalue(row,"DAEAMT")<0){ //대변발생
		  	tempamt = ln_Amt_Chk("02",row);
        dblAmt=gcds_data010.namevalue(row,"DAEAMT")-gcds_data010.namevalue(row,"CHAAMT");
			}
		}

		if(dblAmt <gcds_data010.namevalue(row,"BANJAEAMT")+tempamt) {
			alert("반제금액이 잔액보다 클 수 없습니다.");
			gcds_data010.namevalue(row,"BANJAEAMT")=olddata;
		}else{
			gcds_data010.namevalue(row,"JANAMT")=Number(dblAmt)-gcds_data010.namevalue(row,"BANJAEAMT")-Number(tempamt);
		}
	}
...
<table  cellpadding="0" cellspacing="0" border=0 style="position:relative;left:3px;width:860px;height:30px;font-size:9pt;background-color:#ffffff;">
	...
	<tr>
			...
			<nobr>&nbsp;<comment id="__NSID__">
				...
				<img SRC="../../Common/img/btn/com_b_find.gif" BORDER="0" ALT="관리항목을 검색합니다" style="cursor:hand;position:relative;left:-4px;top:0px; height:20px" align=center onclick="ln_Popup('03','fr');"> 
	...
	<tr> 
		<td>
			...
			style="position:relative;left:5px;width:850px; height:280px; border:1 solid #708090;display:block;" viewastext>
				<PARAM NAME="DataID"		VALUE="gcds_data010">
