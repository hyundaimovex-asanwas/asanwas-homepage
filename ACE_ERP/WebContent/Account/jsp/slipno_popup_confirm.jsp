  ...
  var p2 = gcem_fs02.text+gcem_fsdat02.text;
	...
	if(hid_docuval.value==""){
	  ...
	  var strdocuval =hid_docuval.value;
		arrParam[0]=strdocuval.substring(0,1);   //매입매출구분 (A-매입, B-매출) C-개성매입, D-개성매출 , G-건설erp 매입 , H-건설ERP매출
		arrParam[1]=p1;                          //지점코드
...
function ln_Fswrkdiv_Setting(){
    ...
    //금강산은 예외처리 2007.05.19 정영식
		...
		//2008.03.31 정영식 수정 관리자용 팝업만 사용함.
		//(영업외비용/기부금 : 4521300일 경우 예산 적용 미적용 선택가능 - 봉대리 요청)
    if(gcem_atcode02.text=="4521300"){
			gclx_fswrkdiv02.enable = true;
		}
	}
...
function ln_Chk_Save(){
    ...
    //2015.09.01 
    if(gcds_data01_2.namevalue(gcds_data01_2.rowposition,"FSKND")=="J"&&gs_userid!="6060002"&&gs_userid!="6070001" ) {
  ...
  */
  ...
  //DataSet 건별로 체크하기 
    ...
    /////////////////////////////////////// 
		...
		//2015.12.11 이동훈 수정 ㅜㅜ	
		if(gs_userid!="6060002"){
...
*/
    ...
    ///////////////////////////////////////////////// 
		...
		if(gcds_dtl.namevalue(i,"BANJAEYN")=="Y"){ //반제
			 if(gs_userid!="2060006"&&gs_userid!="6180021"&&gs_userid!="6070001"){
			 //////////////////////////////////////////////////////////////////
			 //2010.06.15
...
function ln_Chk_Atcode_Amt(){
	 ...
	 if(str1char=="4"){ //비용 수익계정
			if(hid_atdecr.value=="1"){ //차변
				...
				if(gcem_detot02.text!=0&&egcem_detot02.text!=""){
...
function ln_Popup_Repay_Modify(){
  ...
  //반제단위 관리항목값을 저장함.
	...
	strURL = "./Commrepay_popup_modify.html";
