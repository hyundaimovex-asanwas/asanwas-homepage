...
<!-------------------------------------------------------------------------------
+ ½Ã ½º ÅÛ ¸í	:	¼¼±Ý°è»ê¼­°ü¸®/¸ÅÀÔ¸ÅÃâµî·Ï ÆË¾÷
+ ÇÁ·Î±×·¥ ID	: TaxBill_popup.html
+ ±â ´É Á¤ ÀÇ	: Á¶È¸|µî·Ï|ÀúÀå|»èÁ¦|Ãâ·Â
+ ÃÖ ÃÊ ÀÌ ·Â	: ÀÌ¼ø¹Ì
+ ¼­ ºí ¸´ ¸í	: a040001_s1,a040001_s2,a040001_s3,
								a040001_s4,a040001_t1,a040001_t2,
                taxcdnbr_s1,commdtil_s1,vendcode_s1,atcode_s1
-----------------------------------------------------------------------------
+ ¼ö Á¤ ³» ¿ë :	ÀüÀÚ¼¼±Ý°è»ê¼­ ¼öÁ¤¼¼±Ý°è»ê¼­ ¹Ý¿µÀ» À§ÇÑ ÄÚµå Ãß°¡
                ÀüÀÚ¼¼±Ý°è»ê¼­ ¹ßÇà°ú ÀüÀÚ¼¼±Ý°è»ê¼­ ¾Æ´Ñ °ÍÀ¸·Î ¹ßÇàÇÑ ¼¼±Ý°è»ê¼­ ±¸ºÐÀÚ Ãß°¡
              : ATTAXMST : GUBUN VARDHAR(1) 
							             AMEND_CODE VARCHAR(2)
													 AMEND_REMARK VARCHAR(100)
+ ¼ö   Á¤  ÀÚ : Á¤  ¿µ  ½Ä
+ ¼ö Á¤ ÀÏ ÀÚ :  2009.12.07
+ ¼­ ºí ¸´ ¸í	:
------------------------------------------------------------------------------>
...
var cuserid = gusrid;		//´ã´çÀÚ
var gdeptcd = gdeptcd;	//ºÎ¼­
var g_fdcod = gfdcode;	//ÁöÁ¡
...
function ln_Start(){
	...
	if (strParam[0] =="A"||strParam[0] =="C"||strParam[0] =="E") {
		...
		gclx_fdcode.BindColVal = strParam[1];	//ÁöÁ¡ÄÚµå
		gcem_staxnbr.text			 = strParam[2];	//°è»ê¼­¹øÈ£
		ln_Query('1');
	}else if (strParam[0] =="B"||strParam[0] =="D"||strParam[0] =="F") {
		ln_DispChk(1);
		gcte_disp.ActiveIndex = "2";
		gclx_fdcode2.BindColVal = strParam[1];	//ÁöÁ¡ÄÚµå
		gcem_staxnbr2.text	    = strParam[2];	//°è»ê¼­¹øÈ£
		ln_Query2('1');
	}
}

/******************************************************************************
	Description : ±âº»Á¶È¸ - ¸ÅÀÔ
******************************************************************************/
function ln_Query(e){
...
function ln_Add(e){
	...
	if (e=='1') {
		...
		//gcra_taxprtyn.CodeValue  = "N";				//¹ßÇà¿©ºÎ
		//gcra_taxtype.CodeValue	 = "N";				//¹ßÇà±¸ºÐ
		//gcem_lastprt.text				 = gs_date;		//ÃÖÁ¾Ãâ·ÂÀÏ

		gclx_worktype.bindcolval = "A";				//È¸°è±¸ºÐ
		gclx_taxdiv.bindcolval	 = "0001";		//±Í¼Ó±¸ºÐ
		gclx_taxknd.bindcolval	 = "1";				//ºÎ°¡¼¼Á¾·ù
		//gclx_actcode1.bindcolval = "2100101";		//¿ÀºêÁ§Æ® º¯°æÈÄ »ç¿ë¾ÈÇÔ(¼±ÅÃÇÏµµ·ÏÇÔ)
		//gclx_actcode1.text			 = "¿Ü»ó¸ÅÀÔ±Ý";
		//gcem_atcode.text				 = "2100101"; 
		//txt_atkornam.value			 = "¿Ü»ó¸ÅÀÔ±Ý";

		gclx_cocode.bindcolval   = "02";			//»ç¾÷¼Ò
		gcem_taxdat.text				 = gs_date;		//Á¢¼öÀÏÀÚ
		gcem_wrdt.text					 = gs_date;		//ÀÛ¾÷ÀÏÀÚ
		gcem_staxnbr.Enable			 = false;			//Á¢¼ö¹øÈ£
		if (cuserid!=null)  gclx_empno.bindcolval  = cuserid;	//´ã´çÀÚ
		if (gdeptcd!=null)	gclx_dept.bindcolval   = gdeptcd;	//´ã´çºÎ¼­
		if (g_fdcod!=null)	gclx_fdcode.bindcolval = g_fdcod;	//ÁöÁ¡
		gclx_empno.enable				 = false;

		var strdat = gcem_taxdat.text;
		if (strdat.substring(4,6) <='01' || strdat.substring(4,6) <='06') {
			gcds_data1.namevalue(gcds_data1.rowposition,"TAXKIDIV") = "1";	//±â¼ö[1]
		}else if(strdat.substring(4,6) <='07' || strdat.substring(4,6) <='12') {
			gcds_data1.namevalue(gcds_data1.rowposition,"TAXKIDIV") = "2";	//±â¼ö[2]
		}
	}else if (e=='2') {
		gcds_data2.AddRow();
...
function ln_Add2(e){
	...
	if (e=='1') {
		...
		gclx_worktype2.bindcolval = "A";			//È¸°è±¸ºÐ
		gclx_taxdiv2.bindcolval	 = "0001";		//±Í¼Ó±¸ºÐ
		gclx_taxknd2.bindcolval	 = "1";				//ºÎ°¡¼¼Á¾·ù
		//gclx_actcode1.bindcolval = "1110601";		////¿ÀºêÁ§Æ® º¯°æÈÄ »ç¿ë¾ÈÇÔ(¼±ÅÃÇÏµµ·ÏÇÔ)
		//gcem_atcode2.text				 = "1110601"; 
		//txt_atkornam_2.value		 = "¿Ü»ó¸ÅÃâ±Ý";

		gclx_taxprtyn.bindcolval  = "N";				//¹ßÇà¿©ºÎ
		gclx_taxtype2.bindcolval	= "N";				//¹ßÇà±¸ºÐ
		gclx_cocode2.bindcolval		= "02";				//»ç¾÷¼Ò
		gcem_taxdat2.text					= gs_date;		//Á¢¼öÀÏÀÚ
		gcem_wrdt2.text						= gs_date;		//ÀÛ¾÷ÀÏÀÚ
		gcem_lastprt2.text				= gs_date;		//ÃÖÁ¾Ãâ·ÂÀÏ
		gcem_staxnbr2.Enable			= false;			//Á¢¼ö¹øÈ£
		if (cuserid!=null)  gclx_empno2.bindcolval  = cuserid;	//´ã´çÀÚ
		if (gdeptcd!=null)	gclx_dept2.bindcolval   = gdeptcd;	//´ã´çºÎ¼­
		if (g_fdcod!=null)	gclx_fdcode2.bindcolval = g_fdcod;	//ÁöÁ¡
		gclx_empno2.enable				= false;

		var strdat = gcem_taxdat2.text;
		if (strdat.substring(4,6) <='01' || strdat.substring(4,6) <='06') {
			gcds_data1_2.namevalue(gcds_data1_2.rowposition,"TAXKIDIV") = "1";	//±â¼ö[1]
		}else if(strdat.substring(4,6) <='07' || strdat.substring(4,6) <='12') {
			gcds_data1_2.namevalue(gcds_data1_2.rowposition,"TAXKIDIV") = "2";	//±â¼ö[2]
		}
...
function ln_Save(e){
	...
	if(!gcds_data1.IsUpdated && !gcds_data2.IsUpdated) {
		alert("ÀúÀåÇÏ½Ç Á¤º¸°¡ ¾ø½À´Ï´Ù.");
	}else if(gcds_data1.IsUpdated && gcds_data2.IsUpdated && gcds_data1.SysStatus(row1) == '1') {
		if (!ln_Check('A'))	return false;
		
		var str4  = gcds_data1.namevalue(row1,"COCODE");		//»ç¾÷¼Ò              
		var str5  = gcds_data1.namevalue(row1,"DEPTCD");		//ºÎ¼­ÄÚµå            
		var str6  = gcds_data1.namevalue(row1,"EMPNO");			//»ç¹ø                
		var str7  = gcds_data1.namevalue(row1,"TAXIODIV");	//°è»ê¼­±¸ºÐ          
		var str8  = gcds_data1.namevalue(row1,"TAXDIV");		//±Í¼Ó±¸ºÐ            
		var str9  = gcds_data1.namevalue(row1,"TAXKND");		//°è»ê¼­Á¾·ù          
		var str10 = gcds_data1.namevalue(row1,"VEND_CD");		//°Å·¡Ã³ÄÚµå          
		var str11 = gcds_data1.namevalue(row1,"TAXDAT");		//°è»ê¼­ÀÏÀÚ          
		var str12 = gcds_data1.namevalue(row1,"TAXSUM");		//°ø±Þ°¡¾×            
		var str13 = gcds_data1.namevalue(row1,"TAXVATAMT");	//ºÎ°¡¼¼¾×            
		var str14 = gcds_data1.namevalue(row1,"TAXTOT");		//ÇÕ°è±Ý¾×            
		var str15 = gcds_data1.namevalue(row1,"REMARK");		//Àû¿ä                
		var str16 = gcds_data1.namevalue(row1,"TAXCDNBR");	//½Å¿ëÄ«µå¹øÈ£        
		var str17 = gcds_data1.namevalue(row1,"ATCODE");		//°èÁ¤ÄÚµå            
		var str18 = gcds_data1.namevalue(row1,"TAXPRTYN");	//¹ßÇà¿©ºÎ            
		var str19 = gcds_data1.namevalue(row1,"TAXCNT");		//¹ßÇàÈ½¼ö            
		var str20 = gcds_data1.namevalue(row1,"LASTPRT");		//ÃÖÁ¾Ãâ·ÂÀÏ          
		var str21 = gcds_data1.namevalue(row1,"TAXTYPE");		//¹ßÇà±¸ºÐ            
		var str22 = gcds_data1.namevalue(row1,"FSDAT");			//ÀüÇ¥ÀÏÀÚ            
		var str23 = gcds_data1.namevalue(row1,"FSNBR");			//ÀüÇ¥¹øÈ£            
		var str24 = gcds_data1.namevalue(row1,"TAXKIDIV");	//±â¼ö±¸ºÐ            
		var str25 = gcds_data1.namevalue(row1,"FDCODE");		//ÁöÁ¡ÄÚµå            
		var str26 = gcds_data1.namevalue(row1,"WORKTYPE");	//È¸°è±¸ºÐ            
		var str27 = "A";	//¸ÅÀÔ[A]/¸ÅÃâ[B]±¸ºÐ 

		if (gcem_fsdat.text == "") {	//¸ÅÀÔMST
		...
		if (gcem_fsdat.text == "") {	/*¸ÅÀÔMST*/
			...
			if (gcds_data2.countrow>0){	/*¸ÅÀÔDTL*/
...
function ln_Save2(e){
	...
	if(!gcds_data1_2.IsUpdated && !gcds_data2_2.IsUpdated) {
		...
		var str4  = gcds_data1_2.namevalue(row1,"COCODE");		//»ç¾÷¼Ò              
		var str5  = gcds_data1_2.namevalue(row1,"DEPTCD");		//ºÎ¼­ÄÚµå            
		var str6  = gcds_data1_2.namevalue(row1,"EMPNO");			//»ç¹ø                
		var str7  = gcds_data1_2.namevalue(row1,"TAXIODIV");	//°è»ê¼­±¸ºÐ          
		var str8  = gcds_data1_2.namevalue(row1,"TAXDIV");		//±Í¼Ó±¸ºÐ            
		var str9  = gcds_data1_2.namevalue(row1,"TAXKND");		//°è»ê¼­Á¾·ù          
		var str10 = gcds_data1_2.namevalue(row1,"VEND_CD");		//°Å·¡Ã³ÄÚµå          
		var str11 = gcds_data1_2.namevalue(row1,"TAXDAT");		//°è»ê¼­ÀÏÀÚ          
		var str12 = gcds_data1_2.namevalue(row1,"TAXSUM");		//°ø±Þ°¡¾×            
		var str13 = gcds_data1_2.namevalue(row1,"TAXVATAMT");	//ºÎ°¡¼¼¾×            
		var str14 = gcds_data1_2.namevalue(row1,"TAXTOT");		//ÇÕ°è±Ý¾×            
		var str15 = gcds_data1_2.namevalue(row1,"REMARK");		//Àû¿ä                
		var str16 = gcds_data1_2.namevalue(row1,"TAXCDNBR");	//½Å¿ëÄ«µå¹øÈ£        
		var str17 = gcds_data1_2.namevalue(row1,"ATCODE");		//°èÁ¤ÄÚµå            
		var str18 = gcds_data1_2.namevalue(row1,"TAXPRTYN");	//¹ßÇà¿©ºÎ            
		var str19 = gcds_data1_2.namevalue(row1,"TAXCNT");		//¹ßÇàÈ½¼ö            
		var str20 = gcds_data1_2.namevalue(row1,"LASTPRT");		//ÃÖÁ¾Ãâ·ÂÀÏ          
		var str21 = gcds_data1_2.namevalue(row1,"TAXTYPE");		//¹ßÇà±¸ºÐ            
		var str22 = gcds_data1_2.namevalue(row1,"FSDAT");			//ÀüÇ¥ÀÏÀÚ            
		var str23 = gcds_data1_2.namevalue(row1,"FSNBR");			//ÀüÇ¥¹øÈ£            
		var str24 = gcds_data1_2.namevalue(row1,"TAXKIDIV");	//±â¼ö±¸ºÐ            
		var str25 = gcds_data1_2.namevalue(row1,"FDCODE");		//ÁöÁ¡ÄÚµå            
		var str26 = gcds_data1_2.namevalue(row1,"WORKTYPE");	//È¸°è±¸ºÐ            
		var str27 = "B";	//¸ÅÀÔ[A]/¸ÅÃâ[B]±¸ºÐ 

		if (gcem_fsdat2.text == "") {	//¸ÅÃâMST
		...
		if (gcem_fsdat2.text == "") {	/*¸ÅÃâMST*/
			...
			if (gcds_data2_2.countrow>=1){	/*¸ÅÃâDTL*/
...
/******************************************************************************
	Description : ÀúÀå - ¸ÅÃâ(°ø±Þ°¡¾×-ºÎ°¡¼¼¾×)gctr_data1_1
******************************************************************************/
function ln_Save2_2(){
		return;
...
/******************************************************************************
	Description : ÀÔ·Â°ª Ã¼Å© - ¸ÅÃâ
******************************************************************************/
function ln_Check(e) {
	if (e=="A") {
		if (gcem_vendcd.text == "") {
			alert("°Å·¡Ã³ÄÚµå¸¦ ÀÔ·ÂÇØ ÁÖ¼¼¿ä");
			return false;
		}
		if (gcem_atcode.text == "") {
			alert("°èÁ¤°ú¸ñÀ» ÀÔ·ÂÇØ ÁÖ¼¼¿ä");
			return false;
		}
	}else if(e=="B") {
...
function ln_Delete(e) {
	...
	if (e=='1') {
		if (gcem_fsdat.text != "" && gcem_fsstat.text == "N") {
			var str1 = gcds_data1.namevalue(row1,"FDCODE");	//ÁöÁ¡ÄÚµå
			var str2 = gcds_data1.namevalue(row1,"FSDAT");	//ÀüÇ¥ÀÏÀÚ
			var str3 = gcds_data1.namevalue(row1,"FSNBR");	//ÀüÇ¥¹øÈ£
			var str4 = "00" + gcds_data1.namevalue(row1,"TAXKND");	//ÁõºùÄÚµå
			var str5 = gcds_data1.namevalue(row1,"TAXNBR");	//Áõºù¸í(°è»ê¼­¹øÈ£)
...
function ln_Delete2(e) {
	...
	if (e=='1') {
		if (gcem_fsdat2.text != "" && gcem_fsstat2.text == "N") {
			var str1 = gcds_data1_2.namevalue(row1,"FDCODE");	//ÁöÁ¡ÄÚµå
			var str2 = gcds_data1_2.namevalue(row1,"FSDAT");	//ÀüÇ¥ÀÏÀÚ
			var str3 = gcds_data1_2.namevalue(row1,"FSNBR");	//ÀüÇ¥¹øÈ£
			var str4 = "00" + gcds_data1_2.namevalue(row1,"TAXKND");	//ÁõºùÄÚµå
			var str5 = gcds_data1_2.namevalue(row1,"TAXNBR");	//Áõºù¸í(°è»ê¼­¹øÈ£)
...
function ln_Print(){
	...
	if (gcds_data1_2.countrow<1) {
		...
		if(sknd=="1"||sknd=="2") {
			...
			/* [1]¼¼±Ý°è»ê¼­ Format */
			ln_RptFormat1();	
			gcrp_print.preview();	//¼¼±Ý°è»ê¼­ ¹Ì¸®º¸±â
		}else if(sknd == "3") {
			/* [2]°è  »ê  ¼­ Format */
			ln_RptFormat2();	
			gcrp_print.preview();	//¼¼±Ý°è»ê¼­ ¹Ì¸®º¸±â
		}else{
			alert("Ãâ·ÂÇÏ½Ç °è»ê¼­ Á¾·ù¸¦ ¼±ÅÃÇØ ÁÖ¼¼¿ä.");
			return false;
		}
	}
}
...
function ln_RptFormat1() {
	...
	ls_for += " 	<T>id='ÀÚ' ,left=37 ,top=484 ,right=82 ,bottom=561 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                             ";	
	ls_for += " 	<T>id='°ø' ,left=37 ,top=273 ,right=82 ,bottom=349 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                             ";	
  ...
  ls_for += " 	<L> left=1725 ,top=151 ,right=1725 ,bottom=225 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                         ";
	...
	ls_for += " 	<T>id='¸í' ,left=1519 ,top=373 ,right=1564 ,bottom=413 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¼º' ,left=1519 ,top=328 ,right=1564 ,bottom=368 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='ÁÖ     ¼Ò' ,left=987 ,top=468 ,right=1191 ,bottom=508 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                   ";	
  ls_for += " 	<T>id='±Þ' ,left=37 ,top=381 ,right=82 ,bottom=458 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                             ";
	ls_for += " 	<T>id='ÀÚ' ,left=934 ,top=508 ,right=979 ,bottom=566 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='´Â' ,left=934 ,top=450 ,right=979 ,bottom=505 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='¹Þ' ,left=934 ,top=392 ,right=979 ,bottom=447 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='±Þ' ,left=934 ,top=331 ,right=979 ,bottom=386 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='°ø' ,left=934 ,top=273 ,right=979 ,bottom=328 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";
	...
	ls_for += " 	<T>id='Ã¥ ¹ø È£' ,left=1307 ,top=82 ,right=1508 ,bottom=148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='ÀÏ·Ã¹øÈ£' ,left=1307 ,top=156 ,right=1508 ,bottom=222 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                   ";	
  ls_for += " 	<L> left=29 ,top=225 ,right=1834 ,bottom=225 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                           ";
	...
	ls_for += " 	<T>id='¼¼ ±Ý °è »ê ¼­' ,left=37 ,top=66 ,right=984 ,bottom=201 ,face='±¼¸²' ,size=23 ,bold=true ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                  ";	
	ls_for += " 	<T>id='»ç ¾÷ Àå' ,left=987 ,top=426 ,right=1191 ,bottom=466 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='µî·Ï¹øÈ£' ,left=90 ,top=230 ,right=288 ,bottom=315 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                      ";	
  ls_for += " 	<L> left=85 ,top=320 ,right=929 ,bottom=320 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                            ";
	...
	ls_for += " 	<T>id='µî·Ï¹øÈ£' ,left=987 ,top=230 ,right=1191 ,bottom=315 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='(¹ýÀÎ¸í)' ,left=987 ,top=368 ,right=1191 ,bottom=413 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='»ó    È£' ,left=987 ,top=325 ,right=1191 ,bottom=365 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
  ls_for += " 	<T>id='(¹ýÀÎ¸í)' ,left=90 ,top=368 ,right=288 ,bottom=413 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                      ";
	ls_for += " 	<T>id='»ó    È£' ,left=90 ,top=325 ,right=288 ,bottom=365 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                      ";	
	ls_for += " 	<T>id='Çö´ë¾Æ»êÁÖ½ÄÈ¸»ç' ,left=299 ,top=325 ,right=606 ,bottom=410 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                               ";	
	ls_for += " 	<T>id='¼º' ,left=616 ,top=325 ,right=659 ,bottom=365 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='¸í' ,left=616 ,top=368 ,right=659 ,bottom=410 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='ÀÎ' ,left=881 ,top=325 ,right=926 ,bottom=413 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";
	//ls_for += " 	<T>id='À±¸¸ÁØ' ,left=669 ,top=325 ,right=876 ,bottom=410 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                         ";	
	ls_for += " 	<T>id='ÀÎ' ,left=1783 ,top=328 ,right=1828 ,bottom=413 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
  ...
  ls_for += " 	<L> left=982 ,top=415 ,right=1834 ,bottom=415 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                          ";
	...
	ls_for += " 	<T>id='»ç ¾÷ Àå' ,left=90 ,top=421 ,right=288 ,bottom=463 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                      ";	
	ls_for += " 	<T>id='ÁÖ     ¼Ò' ,left=90 ,top=466 ,right=288 ,bottom=505 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                     ";	
  ls_for += " 	<C>id='ADDNM', left=1201, top=431, right=1831, bottom=505, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true</C>                        ";
	ls_for += " 	<T>id='¼­¿ï½Ã Á¾·Î±¸ °èµ¿ 140-2' ,left=296 ,top=421 ,right=926 ,bottom=505 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                       ";	
	...
	ls_for += " 	<T>id='¼­ºñ½º' ,left=296 ,top=516 ,right=606 ,bottom=598 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                         ";	
  ls_for += " 	<T>id='¾÷     ÅÂ' ,left=90 ,top=516 ,right=288 ,bottom=598 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                     ";
	...
	ls_for += " 	<T>id='¾÷     ÅÂ' ,left=987 ,top=516 ,right=1191 ,bottom=598 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                   ";	
	ls_for += " 	<T>id='¸ñ' ,left=616 ,top=558 ,right=659 ,bottom=601 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='Á¾' ,left=616 ,top=516 ,right=659 ,bottom=556 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";
	ls_for += " 	<T>id='¸ñ' ,left=1519 ,top=558 ,right=1564 ,bottom=601 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='Á¾' ,left=1519 ,top=516 ,right=1564 ,bottom=556 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
  ...
  ls_for += " 	<L> left=1566 ,top=151 ,right=1566 ,bottom=225 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                         ";
	ls_for += " 	<T>id='ºñ        °í' ,left=1519 ,top=611 ,right=1828 ,bottom=654 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                               ";	
	...
	ls_for += " 	<T>id='°ø     ±Þ     °¡     ¾×' ,left=296 ,top=611 ,right=979 ,bottom=654 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                      ";	
	ls_for += " 	<T>id='ÀÛ      ¼º' ,left=37 ,top=611 ,right=288 ,bottom=654 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
  ls_for += " 	<L> left=29 ,top=656 ,right=1834 ,bottom=656 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                           ";
	ls_for += " 	<T>id='ÀÏ' ,left=1466 ,top=661 ,right=1508 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='ÀÏ' ,left=233 ,top=661 ,right=288 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='°ø¶õ¼ö' ,left=296 ,top=661 ,right=394 ,bottom=706 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                         ";	
	ls_for += " 	<T>id='¹é' ,left=402 ,top=661 ,right=447 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='¾ï' ,left=508 ,top=661 ,right=553 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";
	ls_for += " 	<T>id='½Ê' ,left=881 ,top=661 ,right=926 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='¹é' ,left=828 ,top=661 ,right=873 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='Ãµ' ,left=775 ,top=661 ,right=820 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ...
  ls_for += " 	<T>id='½Ê' ,left=669 ,top=661 ,right=712 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";
	ls_for += " 	<T>id='¹é' ,left=616 ,top=661 ,right=659 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='Ãµ' ,left=564 ,top=661 ,right=606 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='ÀÏ' ,left=934 ,top=661 ,right=979 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
	ls_for += " 	<T>id='½Ê' ,left=455 ,top=661 ,right=500 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='¾ï' ,left=1040 ,top=661 ,right=1085 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='Ãµ' ,left=1093 ,top=661 ,right=1138 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¹é' ,left=1148 ,top=661 ,right=1191 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='½Ê' ,left=1201 ,top=661 ,right=1244 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
  ...
  ls_for += " 	<T>id='Ãµ' ,left=1307 ,top=661 ,right=1349 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='¹é' ,left=1360 ,top=661 ,right=1402 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='½Ê' ,left=1413 ,top=661 ,right=1455 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='½Ê' ,left=987 ,top=661 ,right=1032 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                          ";	
	ls_for += " 	<L> left=32 ,top=773 ,right=1834 ,bottom=773 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>                                                                                                                           ";	
  ls_for += " 	<T>id='³â' ,left=37 ,top=661 ,right=164 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                            ";
	ls_for += " 	<T>id='¿ù' ,left=172 ,top=661 ,right=225 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ...
  ls_for += " 	<L> left=982 ,top=225 ,right=982 ,bottom=773 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>                                                                                                                           ";
	ls_for += " 	<T>id='¿ù' ,left=37 ,top=781 ,right=95 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                             ";	
	ls_for += " 	<T>id='ºñ°í' ,left=1701 ,top=781 ,right=1828 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                       ";	
	...
	ls_for += " 	<T>id='°ø ±Þ °¡ ¾×' ,left=1093 ,top=781 ,right=1402 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                ";	
  ls_for += " 	<T>id='´Ü    °¡' ,left=828 ,top=781 ,right=1085 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";
	ls_for += " 	<T>id='¼ö·®' ,left=722 ,top=781 ,right=820 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='±Ô°Ý' ,left=616 ,top=781 ,right=712 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='Ç°        ¸ñ' ,left=172 ,top=781 ,right=606 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                 ";	
	ls_for += " 	<T>id='ÀÏ' ,left=103 ,top=781 ,right=164 ,bottom=823 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                           ";	
  ...
  ls_for += " 	<T>id='22226-28131ÀÏ ¡®96.3.27½ÂÀÎ' ,left=32 ,top=1228 ,right=585 ,bottom=1270 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                     ";
	ls_for += " 	<T>id='ÀÎ¼â¿ëÁö(Æ¯±Þ)34g/m2 182mmx128mm' ,left=1098 ,top=1228 ,right=1839 ,bottom=1270 ,align='right' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>           ";	
	ls_for += " 	<T>id='°ø  ±Þ  ÀÚ' ,left=987 ,top=101 ,right=1296 ,bottom=140 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                  ";	
	ls_for += " 	<T>id='º¸  °ü  ¿ë' ,left=987 ,top=159 ,right=1296 ,bottom=204 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                  ";	
  ...
  ls_for += " 	<C>id='TAXPDTNAM_2', left=172, top=900, right=606, bottom=958, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                                    ";
	...
	ls_for += " 	<T>id='ÇÕ°è±Ý¾×' ,left=40 ,top=1106 ,right=344 ,bottom=1148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
  ls_for += " 	<T>id='Çö  ±Ý' ,left=352 ,top=1106 ,right=606 ,bottom=1148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                     ";
	ls_for += " 	<T>id='¼ö  Ç¥' ,left=616 ,top=1106 ,right=876 ,bottom=1148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                     ";	
	ls_for += " 	<T>id='¾î  À½' ,left=884 ,top=1106 ,right=1140 ,bottom=1148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='¿Ü»ó¹Ì¼ö±Ý' ,left=1151 ,top=1106 ,right=1402 ,bottom=1148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                               ";	
  ...
  ls_for += " 	<L> left=32 ,top=2588 ,right=1834 ,bottom=2588 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                         ";
	ls_for += " 	<T>id='ÀÎ¼â¿ëÁö(Æ¯±Þ)34g/m2 182mmx128mm' ,left=1098 ,top=2598 ,right=1839 ,bottom=2638 ,align='right' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>           ";	
	ls_for += " 	<T>id='22226-28131ÀÏ ¡®96.3.27½ÂÀÎ' ,left=32 ,top=2598 ,right=585 ,bottom=2638 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                     ";	
  ...
  ls_for += " 	<L> left=32 ,top=2519 ,right=1405 ,bottom=2519 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>                                                                                                                         ";
	ls_for += " 	<T>id='¿Ü»ó¹Ì¼ö±Ý' ,left=1151 ,top=2474 ,right=1402 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                               ";	
	ls_for += " 	<T>id='¾î  À½' ,left=884 ,top=2474 ,right=1140 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='¼ö  Ç¥' ,left=616 ,top=2474 ,right=876 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                     ";	
	ls_for += " 	<T>id='Çö  ±Ý' ,left=352 ,top=2474 ,right=606 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                     ";	
  ls_for += " 	<T>id='ÇÕ°è±Ý¾×' ,left=40 ,top=2474 ,right=344 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";
  ...
  ls_for += " 	<C>id='TAXPDTNAM_1', left=172, top=2199, right=606, bottom=2260, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                                  ";
	ls_for += " 	<T>id='°ø±Þ¹Þ´ÂÀÚ' ,left=987 ,top=1471 ,right=1296 ,bottom=1511 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                ";	
	ls_for += " 	<T>id='º¸  °ü  ¿ë' ,left=987 ,top=1529 ,right=1296 ,bottom=1572 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                ";	
  ...
  ls_for += " 	<L> left=609 ,top=2024 ,right=609 ,bottom=2588 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>                                                                                                                         ";
	...
	ls_for += " 	<T>id='ÀÏ' ,left=103 ,top=2151 ,right=164 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='Ç°        ¸ñ' ,left=172 ,top=2151 ,right=606 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                               ";
	ls_for += " 	<T>id='±Ô°Ý' ,left=616 ,top=2151 ,right=712 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='¼ö·®' ,left=722 ,top=2151 ,right=820 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='´Ü    °¡' ,left=828 ,top=2151 ,right=1085 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";	
	ls_for += " 	<T>id='°ø ±Þ °¡ ¾×' ,left=1093 ,top=2151 ,right=1402 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                              ";	
  ls_for += " 	<T>id='¼¼       ¾×' ,left=1413 ,top=2151 ,right=1691 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                              ";
	ls_for += " 	<T>id='ºñ°í' ,left=1701 ,top=2151 ,right=1828 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                     ";	
	ls_for += " 	<T>id='¿ù' ,left=37 ,top=2151 ,right=95 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                           ";	
  ...
  ls_for += " 	<T>id='¿ù' ,left=172 ,top=2032 ,right=225 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='³â' ,left=37 ,top=2032 ,right=164 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                          ";	
	ls_for += " 	<L> left=32 ,top=2140 ,right=1834 ,bottom=2140 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                         ";	
	ls_for += " 	<T>id='½Ê' ,left=987 ,top=2032 ,right=1032 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                        ";	
	ls_for += " 	<T>id='½Ê' ,left=1413 ,top=2032 ,right=1455 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
  ls_for += " 	<T>id='¹é' ,left=1360 ,top=2032 ,right=1402 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";
	ls_for += " 	<T>id='Ãµ' ,left=1307 ,top=2032 ,right=1349 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	...
	ls_for += " 	<T>id='½Ê' ,left=1201 ,top=2032 ,right=1244 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='¹é' ,left=1148 ,top=2032 ,right=1191 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
  ls_for += " 	<T>id='Ãµ' ,left=1093 ,top=2032 ,right=1138 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";
	ls_for += " 	<T>id='¾ï' ,left=1040 ,top=2032 ,right=1085 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='½Ê' ,left=455 ,top=2032 ,right=500 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='ÀÏ' ,left=934 ,top=2032 ,right=979 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='Ãµ' ,left=564 ,top=2032 ,right=606 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='¹é' ,left=616 ,top=2032 ,right=659 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='½Ê' ,left=669 ,top=2032 ,right=712 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	...
	ls_for += " 	<T>id='Ãµ' ,left=775 ,top=2032 ,right=820 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¹é' ,left=828 ,top=2032 ,right=873 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='½Ê' ,left=881 ,top=2032 ,right=926 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='¾ï' ,left=508 ,top=2032 ,right=553 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¹é' ,left=402 ,top=2032 ,right=447 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='°ø¶õ¼ö' ,left=296 ,top=2032 ,right=394 ,bottom=2074 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                       ";	
	ls_for += " 	<T>id='ÀÏ' ,left=233 ,top=2032 ,right=288 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='ÀÏ' ,left=1466 ,top=2032 ,right=1508 ,bottom=2074 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";
	ls_for += " 	<L> left=32 ,top=2024 ,right=1834 ,bottom=2024 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>                                                                                                                         ";	
	ls_for += " 	<T>id='ÀÛ      ¼º' ,left=37 ,top=1982 ,right=288 ,bottom=2021 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";	
	ls_for += " 	<T>id='°ø     ±Þ     °¡     ¾×' ,left=296 ,top=1982 ,right=979 ,bottom=2021 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                    ";	
  ...
  ls_for += " 	<T>id='ºñ        °í' ,left=1519 ,top=1982 ,right=1828 ,bottom=2021 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                             ";
	ls_for += " 	<L> left=32 ,top=1971 ,right=1834 ,bottom=1971 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                         ";	
	ls_for += " 	<T>id='Á¾' ,left=1519 ,top=1884 ,right=1564 ,bottom=1926 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='¸ñ' ,left=1519 ,top=1929 ,right=1564 ,bottom=1969 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='Á¾' ,left=616 ,top=1884 ,right=659 ,bottom=1926 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¸ñ' ,left=616 ,top=1929 ,right=659 ,bottom=1969 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='¾÷     ÅÂ' ,left=987 ,top=1884 ,right=1191 ,bottom=1966 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                 ";	
	...
	ls_for += " 	<T>id='¾÷     ÅÂ' ,left=90 ,top=1884 ,right=288 ,bottom=1966 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                   ";	
  ls_for += " 	<T>id='¼­ºñ½º' ,left=296 ,top=1884 ,right=606 ,bottom=1966 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                       ";
	...
	ls_for += " 	<T>id='¼­¿ï½Ã Á¾·Î±¸ °èµ¿ 140-2' ,left=296 ,top=1791 ,right=926 ,bottom=1876 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                     ";	
  ...
  ls_for += " 	<T>id='ÁÖ     ¼Ò' ,left=90 ,top=1834 ,right=288 ,bottom=1876 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                   ";
	ls_for += " 	<T>id='»ç ¾÷ Àå' ,left=90 ,top=1791 ,right=288 ,bottom=1831 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";	
  ...
  ls_for += " 	<C>id='VD_DIRECT', left=1572, top=1696, right=1778, bottom=1781, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                                  ";
	ls_for += " 	<T>id='ÀÎ' ,left=1783 ,top=1696 ,right=1828 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	//ls_for += " 	<T>id='À±¸¸ÁØ' ,left=669 ,top=1693 ,right=876 ,bottom=1778 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                       ";	
	ls_for += " 	<T>id='ÀÎ' ,left=881 ,top=1693 ,right=926 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¸í' ,left=616 ,top=1738 ,right=659 ,bottom=1778 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='¼º' ,left=616 ,top=1693 ,right=659 ,bottom=1733 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='Çö´ë¾Æ»êÁÖ½ÄÈ¸»ç' ,left=299 ,top=1693 ,right=606 ,bottom=1778 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                             ";	
	ls_for += " 	<T>id='»ó    È£' ,left=90 ,top=1693 ,right=288 ,bottom=1733 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='(¹ýÀÎ¸í)' ,left=90 ,top=1738 ,right=288 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";	
	ls_for += " 	<T>id='»ó    È£' ,left=987 ,top=1693 ,right=1191 ,bottom=1733 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";	
  ls_for += " 	<T>id='(¹ýÀÎ¸í)' ,left=987 ,top=1738 ,right=1191 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";
	ls_for += " 	<T>id='µî·Ï¹øÈ£' ,left=987 ,top=1601 ,right=1191 ,bottom=1683 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";	
	ls_for += " 	<L> left=85 ,top=1688 ,right=929 ,bottom=1688 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>                                                                                                                          ";	
	ls_for += " 	<T>id='µî·Ï¹øÈ£' ,left=90 ,top=1601 ,right=288 ,bottom=1683 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                    ";	
  ...
  ls_for += " 	<L> left=32 ,top=1593 ,right=1834 ,bottom=1593 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>                                                                                                                         ";
	ls_for += " 	<T>id='ÀÏ·Ã¹øÈ£' ,left=1307 ,top=1524 ,right=1508 ,bottom=1590 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                 ";	
	ls_for += " 	<T>id='Ã¥ ¹ø È£' ,left=1307 ,top=1450 ,right=1508 ,bottom=1516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                 ";	
  ...
  ls_for += " 	<T>id='°ø' ,left=934 ,top=1640 ,right=979 ,bottom=1696 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";
	ls_for += " 	<T>id='±Þ' ,left=934 ,top=1701 ,right=979 ,bottom=1757 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='¹Þ' ,left=934 ,top=1759 ,right=979 ,bottom=1815 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='´Â' ,left=934 ,top=1818 ,right=979 ,bottom=1876 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
	ls_for += " 	<T>id='ÀÚ' ,left=934 ,top=1879 ,right=979 ,bottom=1934 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                         ";	
  ls_for += " 	<T>id='±Þ' ,left=37 ,top=1749 ,right=82 ,bottom=1828 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                           ";
	ls_for += " 	<T>id='¼º' ,left=1519 ,top=1696 ,right=1564 ,bottom=1738 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<T>id='¸í' ,left=1519 ,top=1741 ,right=1564 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<L> left=291 ,top=1593 ,right=929 ,bottom=1593 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                         ";	
	ls_for += " 	<T>id='°ø' ,left=37 ,top=1640 ,right=82 ,bottom=1720 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                           ";	
  ls_for += " 	<T>id='ÀÚ' ,left=37 ,top=1852 ,right=82 ,bottom=1931 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                           ";
  ...
  ls_for += " 	<T>id='»ç ¾÷ Àå' ,left=987 ,top=1791 ,right=1191 ,bottom=1831 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                  ";
	ls_for += " 	<T>id='ÁÖ     ¼Ò' ,left=987 ,top=1834 ,right=1191 ,bottom=1876 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                 ";	
	ls_for += " 	<T>id='¼¼ ±Ý °è »ê ¼­' ,left=37 ,top=1434 ,right=984 ,bottom=1569 ,face='±¼¸²' ,size=23 ,bold=true ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                               ";	
  ...
  ls_for += " 	<L> left=32 ,top=74 ,right=1834 ,bottom=74 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>                                                                                                                             ";
	ls_for += " 	<T>id='[º°Áö Á¦11È£ ¼­½Ä]' ,left=29 ,top=37 ,right=434 ,bottom=71 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                 ";	
	ls_for += " 	<L> left=32 ,top=1445 ,right=1834 ,bottom=1445 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                         ";	
	ls_for += " 	<T>id='[º°Áö Á¦11È£ ¼­½Ä]' ,left=32 ,top=1405 ,right=439 ,bottom=1442 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                             ";	
  ...
  ls_for += " 	<C>id='SEQ_3', left=1625, top=153, right=1670, bottom=220, face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                                                      ";
	...
	ls_for += " 	<T>id='±Ç' ,left=1627 ,top=82 ,right=1670 ,bottom=148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                          ";	
  ls_for += " 	<T>id='È£' ,left=1786 ,top=82 ,right=1828 ,bottom=148 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                          ";
  ...
  ls_for += " 	<C>id='TAXDAT', left=1519, top=1450, right=1622, bottom=1516 ,mask='XXXX', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#0000FF, backcolor=#FFFFFF, Dec=0</C>                               ";
	ls_for += " 	<T>id='±Ç' ,left=1627 ,top=1450 ,right=1670 ,bottom=1516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	...
	ls_for += " 	<T>id='È£' ,left=1786 ,top=1450 ,right=1828 ,bottom=1516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";	
	ls_for += " 	<L> left=1834 ,top=1445 ,right=1834 ,bottom=2588 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>                                                                                                                       ";	
  ls_for += " 	<T>id='ÇÔ' ,left=1736 ,top=2474 ,right=1818 ,bottom=2580 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                       ";
	...
	ls_for += " 	<T>id='À§ ±Ý¾×À»' ,left=1416 ,top=2474 ,right=1582 ,bottom=2580 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>                                                ";	
	ls_for += " 	<T>id='À§ ±Ý¾×À»' ,left=1413 ,top=1106 ,right=1580 ,bottom=1212 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                ";	
  ...
  ls_for += " 	<T>id='ÇÔ' ,left=1736 ,top=1106 ,right=1818 ,bottom=1212 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>                                                       ";
	ls_for += " 	<T>id='±âÅ¸»ç¾÷³²ºÏ°æÁ¦' ,left=669 ,top=516 ,right=926 ,bottom=556 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                ";	
	ls_for += " 	<T>id='Çù·Â»ç¾÷' ,left=669 ,top=558 ,right=926 ,bottom=598 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                        ";	
	ls_for += " 	<T>id='±âÅ¸»ç¾÷³²ºÏ°æÁ¦' ,left=669 ,top=1884 ,right=926 ,bottom=1924 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                              ";	
	ls_for += " 	<T>id='Çù·Â»ç¾÷' ,left=669 ,top=1926 ,right=926 ,bottom=1966 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                      ";	
...
ls_for += "	<T>id='º¸     °ü     ¿ë' ,left=988 ,top=172 ,right=1297 ,bottom=216 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='ÀÚ' ,left=38 ,top=484 ,right=81 ,bottom=562 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='°ø' ,left=38 ,top=272 ,right=81 ,bottom=350 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='¸í' ,left=1519 ,top=372 ,right=1563 ,bottom=412 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼º' ,left=1519 ,top=328 ,right=1563 ,bottom=369 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<C>id='CNT', left=1678, top=81, right=1828, bottom=147 ,mask='XXXX È£', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#0000FF, backcolor=#FFFFFF</C>							";
ls_for += "	<T>id='ÁÖ     ¼Ò' ,left=988 ,top=469 ,right=1191 ,bottom=509 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='±Þ' ,left=38 ,top=381 ,right=81 ,bottom=459 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='ÀÚ' ,left=934 ,top=509 ,right=978 ,bottom=566 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='´Â' ,left=934 ,top=450 ,right=978 ,bottom=506 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¹Þ' ,left=934 ,top=391 ,right=978 ,bottom=447 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='±Þ' ,left=934 ,top=331 ,right=978 ,bottom=387 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='°ø' ,left=934 ,top=272 ,right=978 ,bottom=328 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='Ã¥ ¹ø È£' ,left=1306 ,top=81 ,right=1509 ,bottom=147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='ÀÏ·Ã¹øÈ£' ,left=1306 ,top=156 ,right=1509 ,bottom=222 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<C>id='TAXDAT', left=1519, top=81, right=1669, bottom=147 ,mask='XXXX ±Ç', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#0000FF, backcolor=#FFFFFF, Dec=0</C>						";
...
ls_for += "	<T>id='°è    »ê    ¼­' ,left=38 ,top=66 ,right=984 ,bottom=200 ,face='±¼¸²' ,size=23 ,bold=true ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='»ç ¾÷ Àå' ,left=988 ,top=425 ,right=1191 ,bottom=466 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='µî·Ï¹øÈ£' ,left=91 ,top=231 ,right=288 ,bottom=316 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='µî·Ï¹øÈ£' ,left=988 ,top=231 ,right=1191 ,bottom=316 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='(¹ýÀÎ¸í)' ,left=988 ,top=369 ,right=1191 ,bottom=412 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='»ó    È£' ,left=988 ,top=325 ,right=1191 ,bottom=366 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='(¹ýÀÎ¸í)' ,left=91 ,top=369 ,right=288 ,bottom=412 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='»ó    È£' ,left=91 ,top=325 ,right=288 ,bottom=366 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Çö´ë¾Æ»ê(ÁÖ)' ,left=300 ,top=325 ,right=606 ,bottom=409 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='¼º' ,left=616 ,top=325 ,right=659 ,bottom=366 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¸í' ,left=616 ,top=369 ,right=659 ,bottom=409 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='ÀÎ' ,left=881 ,top=325 ,right=925 ,bottom=412 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='ÀÎ' ,left=1784 ,top=328 ,right=1828 ,bottom=412 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='»ç ¾÷ Àå' ,left=91 ,top=422 ,right=288 ,bottom=462 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='ÁÖ     ¼Ò' ,left=91 ,top=466 ,right=288 ,bottom=506 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='¼­¿ï½Ã Á¾·Î±¸ °èµ¿ Çö´ëºôµù 140-2' ,left=297 ,top=422 ,right=925 ,bottom=506 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>				";
...
ls_for += "	<T>id='°ü±¤' ,left=669 ,top=516 ,right=925 ,bottom=597 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='¼­ºñ½º¾÷' ,left=297 ,top=516 ,right=606 ,bottom=597 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='¾÷     ÅÂ' ,left=91 ,top=516 ,right=288 ,bottom=597 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='¾÷     ÅÂ' ,left=988 ,top=516 ,right=1191 ,bottom=597 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¸ñ' ,left=616 ,top=559 ,right=659 ,bottom=600 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='Á¾' ,left=616 ,top=516 ,right=659 ,bottom=556 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¸ñ' ,left=1519 ,top=559 ,right=1563 ,bottom=600 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Á¾' ,left=1519 ,top=516 ,right=1563 ,bottom=556 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='°ø     ±Þ     °¡     ¾×' ,left=297 ,top=612 ,right=978 ,bottom=653 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='ÀÛ      ¼º' ,left=38 ,top=612 ,right=288 ,bottom=653 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<L> left=28 ,top=656 ,right=1834 ,bottom=656 ,penstyle=solid ,penwidth=1 ,pencolor=#0000FF </L>																		";
ls_for += "	<T>id='ÀÏ' ,left=234 ,top=662 ,right=288 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='°ø¶õ¼ö' ,left=297 ,top=662 ,right=394 ,bottom=706 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='¹é' ,left=403 ,top=662 ,right=447 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¾ï' ,left=509 ,top=662 ,right=553 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='½Ê' ,left=881 ,top=662 ,right=925 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¹é' ,left=828 ,top=662 ,right=872 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='Ãµ' ,left=775 ,top=662 ,right=819 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='½Ê' ,left=669 ,top=662 ,right=713 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¹é' ,left=616 ,top=662 ,right=659 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='Ãµ' ,left=563 ,top=662 ,right=606 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='ÀÏ' ,left=934 ,top=662 ,right=978 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='½Ê' ,left=456 ,top=662 ,right=500 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<L> left=31 ,top=772 ,right=1834 ,bottom=772 ,penstyle=solid ,penwidth=3 ,pencolor=#0000FF </L>																		";
ls_for += "	<T>id='³â' ,left=38 ,top=662 ,right=163 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='¿ù' ,left=172 ,top=662 ,right=225 ,bottom=706 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='¿ù' ,left=38 ,top=781 ,right=94 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='´Ü    °¡' ,left=828 ,top=781 ,right=1084 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼ö·®' ,left=722 ,top=781 ,right=819 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='±Ô°Ý' ,left=616 ,top=781 ,right=713 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Ç°        ¸ñ' ,left=172 ,top=781 ,right=606 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='ÀÏ' ,left=103 ,top=781 ,right=163 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='22226-28131ÀÏ ¡®96.3.27½ÂÀÎ' ,left=31 ,top=1228 ,right=584 ,bottom=1269 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>					";
ls_for += "	<T>id='ÀÎ¼â¿ëÁö(Æ¯±Þ)34g/m2 182mmx128mm' ,left=1097 ,top=1228 ,right=1838 ,bottom=1269 ,align='right' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>				";
ls_for += "	<T>id='°ø ±Þ ¹Þ ´Â ÀÚ' ,left=988 ,top=91 ,right=1297 ,bottom=131 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='ÇÕ°è±Ý¾×' ,left=41 ,top=1106 ,right=344 ,bottom=1147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Çö  ±Ý' ,left=353 ,top=1106 ,right=606 ,bottom=1147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼ö  Ç¥' ,left=616 ,top=1106 ,right=875 ,bottom=1147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¾î  À½' ,left=884 ,top=1106 ,right=1141 ,bottom=1147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¿Ü»ó¹Ì¼ö±Ý' ,left=1150 ,top=1106 ,right=1403 ,bottom=1147 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='ÀÎ¼â¿ëÁö(Æ¯±Þ)34g/m2 182mmx128mm' ,left=1097 ,top=2597 ,right=1838 ,bottom=2637 ,align='right' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>				";
ls_for += "	<T>id='22226-28131ÀÏ ¡®96.3.27½ÂÀÎ' ,left=31 ,top=2597 ,right=584 ,bottom=2637 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>					";
...
ls_for += "	<T>id='¿Ü»ó¹Ì¼ö±Ý' ,left=1150 ,top=2475 ,right=1403 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='¾î  À½' ,left=884 ,top=2475 ,right=1141 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼ö  Ç¥' ,left=616 ,top=2475 ,right=875 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Çö  ±Ý' ,left=353 ,top=2475 ,right=606 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='ÇÕ°è±Ý¾×' ,left=41 ,top=2475 ,right=344 ,bottom=2516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='°ø     ±Þ     ÀÚ' ,left=988 ,top=1459 ,right=1297 ,bottom=1500 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
...
ls_for += "	<T>id='ÀÏ' ,left=103 ,top=2150 ,right=163 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Ç°        ¸ñ' ,left=172 ,top=2150 ,right=606 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='±Ô°Ý' ,left=616 ,top=2150 ,right=713 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼ö·®' ,left=722 ,top=2150 ,right=819 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='´Ü    °¡' ,left=828 ,top=2150 ,right=1084 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='°ø ±Þ °¡ ¾×' ,left=1094 ,top=2150 ,right=1563 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='ºñ°í' ,left=1572 ,top=2150 ,right=1828 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¿ù' ,left=38 ,top=2150 ,right=94 ,bottom=2191 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>										";
...
ls_for += "	<T>id='¿ù' ,left=172 ,top=2031 ,right=225 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='³â' ,left=38 ,top=2031 ,right=163 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<L> left=31 ,top=2141 ,right=1834 ,bottom=2141 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='½Ê' ,left=456 ,top=2031 ,right=500 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='ÀÏ' ,left=934 ,top=2031 ,right=978 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Ãµ' ,left=563 ,top=2031 ,right=606 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¹é' ,left=616 ,top=2031 ,right=659 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='½Ê' ,left=669 ,top=2031 ,right=713 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='Ãµ' ,left=775 ,top=2031 ,right=819 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¹é' ,left=828 ,top=2031 ,right=872 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='½Ê' ,left=881 ,top=2031 ,right=925 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¾ï' ,left=509 ,top=2031 ,right=553 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¹é' ,left=403 ,top=2031 ,right=447 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='°ø¶õ¼ö' ,left=297 ,top=2031 ,right=394 ,bottom=2075 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='ÀÏ' ,left=234 ,top=2031 ,right=288 ,bottom=2075 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<L> left=31 ,top=2025 ,right=1834 ,bottom=2025 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='ÀÛ      ¼º' ,left=38 ,top=1981 ,right=288 ,bottom=2022 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='°ø     ±Þ     °¡     ¾×' ,left=297 ,top=1981 ,right=978 ,bottom=2022 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
ls_for += "	<L> left=31 ,top=1972 ,right=1834 ,bottom=1972 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='Á¾' ,left=1519 ,top=1884 ,right=1563 ,bottom=1925 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¸ñ' ,left=1519 ,top=1928 ,right=1563 ,bottom=1969 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Á¾' ,left=616 ,top=1884 ,right=659 ,bottom=1925 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¸ñ' ,left=616 ,top=1928 ,right=659 ,bottom=1969 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¾÷     ÅÂ' ,left=988 ,top=1884 ,right=1191 ,bottom=1966 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='¾÷     ÅÂ' ,left=91 ,top=1884 ,right=288 ,bottom=1966 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼­ºñ½º¾÷' ,left=297 ,top=1884 ,right=606 ,bottom=1966 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='°ü±¤' ,left=669 ,top=1884 ,right=925 ,bottom=1966 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
...
ls_for += "	<T>id='¼­¿ï½Ã Á¾·Î±¸ °èµ¿ Çö´ëºôµù 140-2' ,left=297 ,top=1791 ,right=925 ,bottom=1875 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>				";
...
ls_for += "	<T>id='ÁÖ     ¼Ò' ,left=91 ,top=1834 ,right=288 ,bottom=1875 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='»ç ¾÷ Àå' ,left=91 ,top=1791 ,right=288 ,bottom=1831 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='ÀÎ' ,left=1784 ,top=1697 ,right=1828 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='ÀÎ' ,left=881 ,top=1694 ,right=925 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¸í' ,left=616 ,top=1737 ,right=659 ,bottom=1778 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¼º' ,left=616 ,top=1694 ,right=659 ,bottom=1734 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='Çö´ë¾Æ»ê(ÁÖ)' ,left=300 ,top=1694 ,right=606 ,bottom=1778 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>						";
ls_for += "	<T>id='»ó    È£' ,left=91 ,top=1694 ,right=288 ,bottom=1734 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='(¹ýÀÎ¸í)' ,left=91 ,top=1737 ,right=288 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='»ó    È£' ,left=988 ,top=1694 ,right=1191 ,bottom=1734 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='(¹ýÀÎ¸í)' ,left=988 ,top=1737 ,right=1191 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='µî·Ï¹øÈ£' ,left=988 ,top=1600 ,right=1191 ,bottom=1684 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<L> left=84 ,top=1687 ,right=928 ,bottom=1687 ,penstyle=solid ,penwidth=1 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='µî·Ï¹øÈ£' ,left=91 ,top=1600 ,right=288 ,bottom=1684 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<C>id='TAXDAT', left=1519, top=1450, right=1669, bottom=1516 ,mask='XXXX ±Ç', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#FF0000, backcolor=#FFFFFF, Dec=0</C>						";
ls_for += "	<T>id='ÀÏ·Ã¹øÈ£' ,left=1306 ,top=1525 ,right=1509 ,bottom=1591 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='Ã¥ ¹ø È£' ,left=1306 ,top=1450 ,right=1509 ,bottom=1516 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='°ø' ,left=934 ,top=1641 ,right=978 ,bottom=1697 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='±Þ' ,left=934 ,top=1700 ,right=978 ,bottom=1756 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¹Þ' ,left=934 ,top=1759 ,right=978 ,bottom=1816 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='´Â' ,left=934 ,top=1819 ,right=978 ,bottom=1875 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='ÀÚ' ,left=934 ,top=1878 ,right=978 ,bottom=1934 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='±Þ' ,left=38 ,top=1750 ,right=81 ,bottom=1828 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>										";
ls_for += "	<C>id='CNT', left=1678, top=1450, right=1828, bottom=1516 ,mask='XXXX È£', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#FF0000, backcolor=#FFFFFF</C>							";
ls_for += "	<T>id='¼º' ,left=1519 ,top=1697 ,right=1563 ,bottom=1737 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<T>id='¸í' ,left=1519 ,top=1741 ,right=1563 ,bottom=1781 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>									";
ls_for += "	<L> left=291 ,top=1594 ,right=928 ,bottom=1594 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='°ø' ,left=38 ,top=1641 ,right=81 ,bottom=1719 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='ÀÚ' ,left=38 ,top=1853 ,right=81 ,bottom=1931 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>										";
ls_for += "	<T>id='º¸     °ü     ¿ë' ,left=988 ,top=1541 ,right=1297 ,bottom=1584 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
...
ls_for += "	<T>id='»ç ¾÷ Àå' ,left=988 ,top=1791 ,right=1191 ,bottom=1831 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='ÁÖ     ¼Ò' ,left=988 ,top=1834 ,right=1191 ,bottom=1875 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
ls_for += "	<T>id='°è    »ê    ¼­' ,left=38 ,top=1434 ,right=984 ,bottom=1569 ,face='±¼¸²' ,size=23 ,bold=true ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='[º°Áö Á¦11È£ ¼­½Ä]' ,left=28 ,top=37 ,right=434 ,bottom=72 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>						";
ls_for += "	<L> left=31 ,top=1444 ,right=1834 ,bottom=1444 ,penstyle=solid ,penwidth=3 ,pencolor=#FF0000 </L>																	";
ls_for += "	<T>id='[º°Áö Á¦11È£ ¼­½Ä]' ,left=31 ,top=1406 ,right=438 ,bottom=1441 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>						";
...
ls_for += "	<T>id='ÀÌ ±Ý¾×À»  Ã»±¸  ÇÔ' ,left=1413 ,top=1106 ,right=1828 ,bottom=1212 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>							";
ls_for += "	<T>id='ÀÌ ±Ý¾×À»  Ã»±¸  ÇÔ' ,left=1413 ,top=2475 ,right=1828 ,bottom=2581 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>							";
...
ls_for += "	<T>id='ºñ        °í' ,left=988 ,top=612 ,right=1828 ,bottom=653 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='ºñ        °í' ,left=988 ,top=1981 ,right=1828 ,bottom=2022 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FF0000 ,backcolor=#FFFFFF</T>								";
...
ls_for += "	<T>id='ºñ°í' ,left=1572 ,top=781 ,right=1828 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>									";
...
ls_for += "	<T>id='°ø ±Þ °¡ ¾×' ,left=1094 ,top=781 ,right=1563 ,bottom=822 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#0000FF ,backcolor=#FFFFFF</T>								";
...
function ln_Valchk(){
	if (fn_trim(gcem_taxnbr.text) == "") {			
		alert("Á¤È®ÇÑ °è»ê¼­¹øÈ£¸¦ ÀÔ·ÂÇØ ÁÖ½Ê½Ã¿À");
		gcem_taxnbr.text ="";
		gcem_taxnbr.focus();
		return false;
	}
...
function ln_Before(){ 
		...
		/*¸ÅÃâ ¼±Á¶È¸*/
		gclx_taxprtyn2.BindColVal = "N";				//¹ßÇà¿©ºÎ
		gclx_taxtype2.BindColVal	= "N";				//¹ßÇà±¸ºÐ
		gclx_cocode2.BindColVal		= "02";				//»ç¾÷¼Ò
		gcem_taxdat2.text					= gs_date;		//Á¢¼öÀÏÀÚ
		gcem_wrdt2.text						= gs_date;		//ÀÛ¾÷ÀÏÀÚ
...
/******************************************************************************
	Description : °Å·¡Ã³ ±âº»Á¶È¸ Ç×¸ñ
******************************************************************************/
function ln_Vend(){
	var row = gcds_data1.rowposition;
	txt_vddirect.value = gcds_data1.namevalue(row, "VD_DIRECT");	//´ëÇ¥ÀÚ
	txt_bsnscnd.value  = gcds_data1.namevalue(row, "BSNS_CND");		//¾÷ÅÂ
	txt_bsnsknd.value  = gcds_data1.namevalue(row, "BSNS_KND");		//Á¾¸ñ
}

/******************************************************************************
	Description : Ã£±â - °Å·¡Ã³ÄÚµå
******************************************************************************/
function ln_Popup(p){
	if(p=="A") {	//¸ÅÀÔ
...
/***********************************************************************************************
	Description : ¸ÅÀÔ[ÀüÇ¥Á¶È¸]
	parameter   : fcod - ÁöÁ¡ÄÚµå, fsdt - ÀüÇ¥ÀÏÀÚ, fnbr - ÀüÇ¥¹øÈ£
**********************************************************************************************/
function ln_TaxQuery(){
	if(gcem_fsdat.text != "") {
		...
		alert("¹ßÇà µÈ ÀüÇ¥°¡ ¾ø½À´Ï´Ù.");
	}
}

/***********************************************************************************************
	Description : ¸ÅÃâ[ÀüÇ¥Á¶È¸]
	parameter   : fcod - ÁöÁ¡ÄÚµå, fsdt - ÀüÇ¥ÀÏÀÚ, fnbr - ÀüÇ¥¹øÈ£
**********************************************************************************************/
...
/***********************************************************************************************
	Description : ¸ÅÀÔ[ÀüÇ¥¹ßÇà - FSLIPMST]
	parameter   : arrParam[0]  = "T",					arrParam[1]  = ÁöÁ¡,					arrParam[2]  = ÀüÇ¥ÀÏÀÚ,
	              arrParam[3]  = ÀüÇ¥¹øÈ£,		arrParam[4]  = ÀüÇ¥»óÅÂ(N),		arrParam[5]  = ºÎ¼­,
	              arrParam[6]  = ºÎ¼­¸í,			arrParam[7]  = ´ã´çÀÚ»ç¹ø,		arrParam[8]  = ´ã´çÀÚ¸í,
	              arrParam[9]  = Àû¿ä,				arrParam[10] = »ç¾÷¼ÒÄÚµå,		arrParam[11] = º»ºÎÄÚµå,
	              arrParam[12] = DTLÇÕ°è±Ý¾×
	----------------------------------------------------------------------------------------------
	Description : ¸ÅÀÔ[ÀüÇ¥¹ßÇà - FSLIPDTL]
	parameter   : arrParam[0]  = °èÁ¤ÄÚµå,		arrParam[1]  = °èÁ¤¸í,				arrParam[2]  = °Å·¡Ã³ÄÚµå,
	              arrParam[3]  = °Å·¡Ã³¸í,		arrParam[4]  = ºÎ¼­ÄÚµå,			arrParam[5]  = ºÎ¼­¸í,
	              arrParam[6]  = Àû¿ä,				arrParam[7]  = Â÷º¯±Ý¾×,			arrParam[8]  = ´ëº¯±Ý¾×,
	              arrParam[9]  = ¼¼±Ý°è»ê¼­¹øÈ£, 
								arrParam[10] = Áõºù¸í(001:¼¼±Ý°è»ê¼­,  002:°è»ê¼­,    003:½Å¿ëÄ«µå,
								                      004:Çö±Ý¼Òµæ°øÁ¦,005:°£ÀÌ¿µ¼öÁõ,006:°£ÁÖ°ø±Þ)
**********************************************************************************************/
function ln_TaxIssue(){
	...
	for(var i=1;i<=gcds_data2.countrow;i++) {
		...
		if(i==1) {
			...
			if (gcds_data2.namevalue(i,"TAXSUM") != "") {	/*¼¼±Ý°è»ê¼­(¸ÅÀÔ)-°ø±Þ°¡¾×*/
				...
				arrParam[Number(j+6)]  = gclx_dept.text;
				arrParam[Number(j+7)]  = gcem_remark.text;
				arrParam[Number(j+8)]  = gcds_data2.namevalue(i,"TAXSUM");	//¸ÅÀÔ->´ëº¯[2] => Â÷º¯±Ý¾×
				arrParam[Number(j+9)]  = 0;
				arrParam[Number(j+10)] = gcem_taxnbr.text;
				arrParam[Number(j+11)] = gcds_taxknd.namevalue(gcds_taxknd.rowposition,"GBCD");
			}

			if (gcds_data2.namevalue(i,"TAXVATAMT") != "") {	/*ºÎ°¡°¡Ä¡¼¼[¸ÅÀÔ]*/
				j = j + 11;
				arrParam[Number(j+1)]  = "1112300";
				arrParam[Number(j+2)]  = "¼±±ÞºÎ°¡°¡Ä¡¼¼";
				arrParam[Number(j+3)]  = gcem_vendcd.text;
				arrParam[Number(j+4)]  = txt_fdcodenm.value;
				arrParam[Number(j+5)]  = gclx_dept.bindcolval;
				arrParam[Number(j+6)]  = gclx_dept.text;
				arrParam[Number(j+7)]  = gcem_remark.text;
				arrParam[Number(j+8)]  = gcds_data2.namevalue(i,"TAXVATAMT");	//¸ÅÀÔ->´ëº¯[2] => Â÷º¯±Ý¾×
				arrParam[Number(j+9)]  = 0;
				arrParam[Number(j+10)] = gcem_taxnbr.text;
				arrParam[Number(j+11)] = gcds_taxknd.namevalue(gcds_taxknd.rowposition,"GBCD");
			}
	...
	ln_Query('1');
		...
		alert("ÀüÇ¥°¡ ÀÌ¹Ì ¹ßÇàµÇ¾ú½À´Ï´Ù.");
	}
}

/***********************************************************************************************
	Description : ¸ÅÃâ[ÀüÇ¥¹ßÇà - FSLIPMST]
	parameter   : arrParam[0]  = "T",					arrParam[1]  = ÁöÁ¡,					arrParam[2]  = ÀüÇ¥ÀÏÀÚ,
	              arrParam[3]  = ÀüÇ¥¹øÈ£,		arrParam[4]  = ÀüÇ¥»óÅÂ(N),		arrParam[5]  = ºÎ¼­,
	              arrParam[6]  = ºÎ¼­¸í,			arrParam[7]  = ´ã´çÀÚ»ç¹ø,		arrParam[8]  = ´ã´çÀÚ¸í,
	              arrParam[9]  = Àû¿ä,				arrParam[10] = »ç¾÷¼ÒÄÚµå,		arrParam[11] = º»ºÎÄÚµå,
	              arrParam[12] = DTLÇÕ°è±Ý¾×
	----------------------------------------------------------------------------------------------
	Description : ¸ÅÃâ[ÀüÇ¥¹ßÇà - FSLIPDTL]
	parameter   : arrParam[0]  = °èÁ¤ÄÚµå,		arrParam[1]  = °èÁ¤¸í,				arrParam[2]  = °Å·¡Ã³ÄÚµå,
	              arrParam[3]  = °Å·¡Ã³¸í,		arrParam[4]  = ºÎ¼­ÄÚµå,			arrParam[5]  = ºÎ¼­¸í,
	              arrParam[6]  = Àû¿ä,				arrParam[7]  = Â÷º¯±Ý¾×,			arrParam[8]  = ´ëº¯±Ý¾×,
	              arrParam[9]  = ¼¼±Ý°è»ê¼­¹øÈ£, 
	...
	for(var i=1;i<=gcds_data2_2.countrow;i++) {
		...
		if(i==1) {
			...
			if (gcds_data2_2.namevalue(i,"TAXSUM") != "") {	/*¼¼±Ý°è»ê¼­(¸ÅÃâ)-°ø±Þ°¡¾×*/
				...
				arrParam[Number(j+7)]  = gcem_remark2.text;
				arrParam[Number(j+8)]  = 0;
				arrParam[Number(j+9)]  = gcds_data2_2.namevalue(i,"TAXSUM");	//¸ÅÃâ->Â÷º¯[1] => ´ëº¯±Ý¾×
				arrParam[Number(j+10)] = gcem_taxnbr2.text;
				arrParam[Number(j+11)] = gcds_taxknd2.namevalue(gcds_taxknd2.rowposition,"GBCD");
			}

			if (gcds_data2_2.namevalue(i,"TAXVATAMT") != "") {	/*ºÎ°¡°¡Ä¡¼¼[¸ÅÃâ]*/
				j = j + 11;
				arrParam[Number(j+1)]  = "2101100";//º¯°æ-"2101200";	
				arrParam[Number(j+2)]  = "¼±¼öºÎ°¡°¡Ä¡¼¼";//º¯°æ-"ºÎ°¡°¡Ä¡¼¼¿¹¼ö±Ý";
				arrParam[Number(j+3)]  = gcem_vendcd2.text;
				arrParam[Number(j+4)]  = txt_fdcodenm2.value;
				arrParam[Number(j+5)]  = gclx_dept2.bindcolval;
				arrParam[Number(j+6)]  = gclx_dept2.text;
				arrParam[Number(j+7)]  = gcem_remark2.text;
				arrParam[Number(j+8)]  = 0;
				arrParam[Number(j+9)]  = gcds_data2_2.namevalue(i,"TAXVATAMT");	//¸ÅÃâ->Â÷º¯[1] => ´ëº¯±Ý¾×
				arrParam[Number(j+10)] = gcem_taxnbr2.text;
				arrParam[Number(j+11)] = gcds_taxknd2.namevalue(gcds_taxknd2.rowposition,"GBCD");
			}
...
/******************************************************************************
	Description : ¼öÁ¤¼¼±Ý°è»ê¼­ Ã¼Å© ¹öÆ° Ã¼Å©
	              2009.12.04 jys Ãß°¡
******************************************************************************/
function ln_ChkBox(){
...
<comment id="__NSID__"><object  id="gcds_fdcode" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="false"><!-- ÁöÁ¡ÄÚµå[¸ÅÀÔ] -->
</object></comment><script>__ws__(__NSID__);</script> 

<comment id="__NSID__"><object  id="gcds_worktype" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="true"><!-- È¸°è±¸ºÐ[¸ÅÀÔ] -->
</object></comment><script>__ws__(__NSID__);</script> 

<comment id="__NSID__"><object  id="gcds_dept" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="false"><!-- ´ã´çºÎ¼­[¸ÅÀÔ] -->
</object></comment><script>__ws__(__NSID__);</script> 
...
<comment id="__NSID__"><object  id="gcds_actcode2" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="false"><!-- °èÁ¤°ú¸ñ[¸ÅÃâ] -->
	<PARAM NAME="SortExpr" VALUE="+PSEQ">
</object></comment><script>__ws__(__NSID__);</script> 
...
<comment id="__NSID__"><object  id="gcds_empno2" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="true"><!-- ´ã´çÀÚ[¸ÅÃâ] -->
</object></comment><script>__ws__(__NSID__);</script> 
...
<comment id="__NSID__"><object  id="gctr_data1" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" VIEWASTEXT>
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!-- ¸ÅÀÔMST -->
</object></comment><script>__ws__(__NSID__);</script> 
...
<comment id="__NSID__"><object  id="gctr_data2_2" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" VIEWASTEXT>
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!-- ¸ÅÃâDTL -->
</object></comment><script>__ws__(__NSID__);</script> 
...
<script language="javascript" for="gcds_data1" event="onloadCompleted(row,colid)">
	...
	window.status = "Á¤»óÀûÀ¸·Î Á¶È¸µÇ¾ú½À´Ï´Ù.";
	if (row<1) { 
		alert("°Ë»öµÈ µ¥ÀÌÅÍ°¡ ¾ø½À´Ï´Ù.");
		gcds_data2.ClearData();
	}else{
		var row1 = gcds_data1.rowposition;
		if (gcds_data1.RowStatus(row1)!="1") ln_Query('2');//¼¼±Ý°è»ê¼­ »ó¼¼Á¶È¸
...
<script language="javascript" for="gcds_data2" event="onloadCompleted(row,colid)">
	window.status="Á¶È¸°¡ ¿Ï·á µÇ¾ú½À´Ï´Ù.";
	document.all.LowerFrame.style.visibility="hidden";
	ft_cnt2.innerText = "Á¶È¸°Ç¼ö : " + row + " °Ç";
	window.status = "Á¤»óÀûÀ¸·Î Á¶È¸µÇ¾ú½À´Ï´Ù.";

	if (row<1) { alert("°Ë»öµÈ µ¥ÀÌÅÍ°¡ ¾ø½À´Ï´Ù."); 
		gcem_taxsum.text		= gcds_data2.Sum(7,0,0);												//°ø±Þ°¡¾×
		gcem_taxvatamt.text = gcds_data2.Sum(8,0,0);												//ºÎ°¡¼¼¾×
		gcem_taxtot.text		= gcds_data2.Sum(7,0,0)+gcds_data2.Sum(8,0,0);	//ÇÕ°è
...
<script language="javascript" for="gcds_print" event="onloadCompleted(row,colid)">
	...
	if (row<1) { alert("Ãâ·ÂÇÏ½Ç Á¤º¸°¡ ¾ø½À´Ï´Ù"); 
	}else{
		//gcrp_print.preview();	//¼¼±Ý°è»ê¼­ ¹Ì¸®º¸±â
	}
</script>
...
<!-- <script language="javascript" for="gcds_empno" event="onloadCompleted(row,colid)">
	...
	if(cuserid=="ACCOUNT"|| cuserid==null){
		...
		//gcds_empno.NameValue(1,"EMPNMK")="±ÇÁ¤±³";
...
<script language="javascript" for="gcds_data1_2" event="onloadCompleted(row,colid)">
	...
	if (row<1) { 
		...
		var row1 = gcds_data1_2.rowposition;
		if (gcds_data1_2.RowStatus(row1)!="1") ln_Query2('2');	//¼¼±Ý°è»ê¼­ »ó¼¼Á¶È¸
...
<script language="javascript" for="gcds_data2_2" event="onloadCompleted(row,colid)">
	window.status="Á¶È¸°¡ ¿Ï·á µÇ¾ú½À´Ï´Ù.";
	document.all.LowerFrame.style.visibility="hidden";
	ft_cnt2_2.innerText = "Á¶È¸°Ç¼ö : " + row + " °Ç";
	window.status = "Á¤»óÀûÀ¸·Î Á¶È¸µÇ¾ú½À´Ï´Ù.";

	if (row<1) { alert("°Ë»öµÈ µ¥ÀÌÅÍ°¡ ¾ø½À´Ï´Ù."); 
		gcem_taxsum2.text			= gcds_data2_2.Sum(7,0,0);													//°ø±Þ°¡¾×
		gcem_taxvatamt2.text	= gcds_data2_2.Sum(8,0,0);													//ºÎ°¡¼¼¾×
		gcem_taxtot2.text			= gcds_data2_2.Sum(7,0,0)+gcds_data2_2.Sum(8,0,0);	//ÇÕ°è
...
<script language=JavaScript for=gcgd_data2 event=onKeyPress()>
	var row = gcds_data2.rowposition;	//¼¼ºÎ³»¿ª ÇÕ°è[¸ÅÀÔ]
	var row1 = gcds_data1.rowposition;
...
<script language=JavaScript for=gcgd_data2_2 event=onKeyPress()>
	var row = gcds_data2_2.rowposition;	//¼¼ºÎ³»¿ª ÇÕ°è[¸ÅÃâ]
	var row1 = gcds_data1_2.rowposition; 
...
//gcds_code01.ClearAll();
	...
	gcem_count2.text            = gcds_code00.NameValue(1,"FSNBR");   //È¸°èÁ¢¼ö¹øÈ£
    gcem_asq_fr2.text           = gcds_code00.NameValue(1,"ASAQSDAT"); //ÃëµæÀÏÀÚ
    gcem_count.text             = gcds_code00.NameValue(1,"TAXNBR"); //°è»ê¼­¹øÈ£
    gclx_fdcode02.BindColVal    = gcds_code00.NameValue(1,"DEPTCD"); //´ã´çºÎ¼­
    txt_empno.value               = gcds_code00.NameValue(1,"EMPNO");	 //´ã´çÀÚ
...
<script language="javascript" for="gctr_data1" event="onsuccess()">
	gcem_staxnbr.Enable	= true;
	alert("ÀÛ¾÷ÀÌ ¼º°øÀûÀ¸·Î ¿Ï·áµÇ¾ú½À´Ï´Ù.");	//¸ÅÀÔ
</script>

<script language="javascript" for="gctr_data1" event="onfail()">
	gcem_staxnbr.Enable	= true;
	alert("ÀÛ¾÷ÀÌ ¼º°øÀûÀ¸·Î ¿Ï·áµÇÁö ¸øÇß½À´Ï´Ù.");
</script>

<script language="javascript" for="gctr_data1_2" event="onsuccess()">
	gcem_staxnbr2.Enable	= true;
	alert("ÀÛ¾÷ÀÌ ¼º°øÀûÀ¸·Î ¿Ï·áµÇ¾ú½À´Ï´Ù.");	//¸ÅÃâ
</script>
						...
						<comment id="__NSID__"><object  id=gcte_disp classid=clsid:ED382953-E907-11D3-B694-006097AD7252 VIEWASTEXT style="width:260px;height:20px;">
   					  ...
   					  <PARAM NAME="titleHeight"				VALUE="20px">
						  ...
						  <PARAM NAME="Format"						VALUE="
								<T>divid=div_1		title='¸ÅÀÔ'</T>
								<T>divid=div_2		title='¸ÅÃâ'</T>									
						  ">
						</object></comment><script>__ws__(__NSID__);</script> 
					</td>
				</tr>
	...
	<tr>
		<td>
			<table width="867px" border="0" cellpadding=0 cellspacing=0 style="position:relative;left:8px;border:0 solid #708090;border-bottom-width:1px;border-right-width:1px;">
					<tr> 
						<td class="tab37" width="100px" bgcolor="#eeeeee"><nobr>ÁöÁ¡ÄÚµå</nobr></td>
						...
						<td class="tab14" width="100px" bgcolor="#eeeeee"><nobr>»ç&nbsp;¾÷&nbsp;¼Ò</nobr></td>
						<td class="tab18" width="100px"><comment id="__NSID__">
							<object  id=gclx_cocode classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 style="position:relative;left:5px;top:1px;font-size:12px;width:90px;height:200px;">
								<param name=CBData					value="02^¼­¿ï,01^°í¼º">
						...
						<td class="tab14" width="100px" bgcolor="#eeeeee"><nobr>Á¢¼ö¹øÈ£</nobr></td>
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>È¸°è±¸ºÐ</nobr></td>
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>Á¢¼öÀÏÀÚ</nobr></td>
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>´ã´çºÎ¼­</nobr></td>
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>±Í¼Ó±¸ºÐ</nobr></td>
						<td class="tab19" width="149px;"><comment id="__NSID__">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>°ú¼¼±¸ºÐ</nobr></td><!-- =ºÎ°¡¼¼Á¾·ù -->
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>´ã&nbsp;´ç&nbsp;ÀÚ</nobr></td>
						<td class="tab22" width="189px"><comment id="__NSID__">
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>°Å&nbsp;·¡&nbsp;Ã³</nobr></td>
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>ÀÛ¼ºÀÏÀÚ</nobr></td>
						<td class="tab22" width="189px"><comment id="__NSID__">
          ...
          <!-- ¸ÅÀÔÂÊÃß°¡ 2009.09.04.JYS -->
          <tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>°Å·¡Ã³´ã´çÁ¤º¸</nobr></td>
						<td class="tab19" width="189px" ><nobr><comment id="__NSID__">
						  <!-- ´ã´çÀÚ¸í -->
							...
							<!-- <font size="2" color="" style="position:relative;top:-3px">ºÎ¼­</font> -->
              <!-- ´ã´çÀÚ ºÎ¼­¸í -->
              ...
              <!-- Email -->
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>°Å·¡Ã³ Email</nobr></td><!-- =°Å·¡Ã³ Email -->
						<td class="tab19" width="189px"><comment id="__NSID__">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>ÀüÀÚ¹ßÇà±¸ºÐ</nobr></td>		
						<td class="tab22" width="189px"><nobr><comment id="__NSID__">
               <INPUT type="radio" id=rdo_gubun1_1 value="1" onclick="ln_Rdo_Chk('1')">ÀüÀÚ ¹ßÇà
							 <INPUT type="radio" id=rdo_gubun1_2 value="2" onclick="ln_Rdo_Chk('2')">¼ö±â ¹ßÇà
						  <!-- <object id=gcrd_gubun classid=CLSID:754F3DC4-0C79-4C92-AD64-A806D8FF2AB0	style="height:20px;width:170px;position:relative;left:7px;">
								...
								<param name=Format	value="1^ÀüÀÚ ¹ßÇà, 2^ÀÏ¹Ý ¹ßÇà">
							</object> -->
							</comment><script>__ws__(__NSID__);</script></nobr>
						</td>
					</tr>
          <!-- ¸ÅÀÔ³¡ -->
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>Àû&nbsp;&nbsp;&nbsp;&nbsp;¿ä</nobr></td>
						<td class="tab19" width="400px" colspan="3"><nobr><comment id="__NSID__">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>Ãâ·ÂÈ½¼ö</nobr></td>
						<td class="tab22" width="189px"><nobr><comment id="__NSID__">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<param name=CBData			    value="A^¸ÅÀÔÀúÀå,V^¿ª¹ßÇà¿äÃ»,I^¼ö½Å¹Ì½ÂÀÎ,C^¼ö½Å½ÂÀÎ,M^¹ßÇàÃë¼Ò¿äÃ»(°ø±Þ¹Þ´ÂÀÚ),N^¹ßÇàÃë¼Ò¿äÃ»(°ø±ÞÀÚ),R^¼ö½Å°ÅºÎ,O^Ãë¼Ò¿Ï·á,T^¿ª¹ßÇà°ÅºÎ,W^¿ª¹ßÇà¿äÃ» Ãë¼Ò">
                ...
                <param name=Enable 	        value=false>
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>°èÁ¤°ú¸ñ</nobr></td>
				...
				<!-- <nobr><comment id="__NSID__">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>ÃÖÁ¾Ãâ·ÂÀÏ</nobr></td>
					...
					<tr> 
						<td class="tab41" width="100px" bgcolor="#eeeeee"><nobr>¹ßÇà¿©ºÎ</nobr></td>
						<td class="tab23" width="189px;" colspan="3"><comment id="__NSID__">
							<object  id=gclx_taxprtyn classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 style="position:relative;left:5px;top:1px;font-size:12px;width:90px;height:200px;">
								<param name=CBData					value="^,Y^¹ßÇà,N^¹Ì¹ßÇà">
								<param name=CBDataColumns		value="CDCODE,CDNAM">
								<param name=SearchColumn		value="CDNAM">
								<param name=Sort						value="false">
								<param name=ListExprFormat	value="CDNAM^0^90">
						...
						<td class="tab12" width="100px" bgcolor="#eeeeee"><nobr>ÀüÇ¥¹øÈ£</nobr></td>
					...
					<!-- <tr> 
						<td class="tab41" width="100px" bgcolor="#eeeeee"><nobr>°ø±Þ°¡¾×</nobr></td>
						...
						<td class="tab12" width="100px" bgcolor="#eeeeee"><nobr>ºÎ°¡¼¼¾×</nobr></td>
						...
						<td class="tab12" width="100px" bgcolor="#eeeeee"><nobr>ÇÕ°è±Ý¾×</nobr></td>
			...
			<td>
				<comment id="__NSID__"><object  id=gcte_disp2 classid=clsid:ED382953-E907-11D3-B694-006097AD7252 
					style="width:600px;height:20px">
						...
						<PARAM NAME="DisableBackColor"	VALUE="#eeeeee">
						<PARAM NAME="Format"						VALUE="
							<T>divid=layer1  title='¼¼±Ý°è»ê¼­ ¼¼ºÎ³»¿ª'</T>									
						">
				</object></comment><script>__ws__(__NSID__);</script> 
			</td>
		</tr>
...
<div id="layer1" style="position:relative;top:5px;left:8px;width:867px;visibility:hidden;border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0>
		...
		<tr>
		  <td style="width:865;border:0 solid #708090;border-top-width:1px" colspan="2">
				<comment id="__NSID__"><object  id=gcgd_data2 style="width:865px;height:153px;border:0 solid #777777" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49>
					...
					<PARAM NAME="Format"			VALUE="
			<C>ID=TAXMM			Name='¿ù'				HeadAlign=Center HeadBgColor=#B9D4DC Width=20  align=center SumText=''		 SumBgColor=#C3D0DB </C>
			<C>ID=TAXDT			Name='ÀÏ'				HeadAlign=Center HeadBgColor=#B9D4DC Width=20  align=center SumText=''		 SumBgColor=#C3D0DB </C>
			<C>ID=TAXPDTNAM Name='Ç°¸ñ¸í'		HeadAlign=Center HeadBgColor=#B9D4DC Width=200 align=left		SumText='ÇÕ°è' SumBgColor=#C3D0DB </C>
			<C>ID=TAXSTD		Name='±Ô°Ý'			HeadAlign=Center HeadBgColor=#B9D4DC Width=60	 align=left		SumText=''		 SumBgColor=#C3D0DB </C>
			<C>ID=TAXQTY		Name='¼ö·®'			HeadAlign=Center HeadBgColor=#B9D4DC Width=60  align=right	SumText=''		 SumBgColor=#C3D0DB </C> 
			<C>ID=TAXPRIC   Name='´Ü°¡'			HeadAlign=Center HeadBgColor=#B9D4DC Width=60  align=right	SumText=''		 SumBgColor=#C3D0DB </C> 
			<C>ID=TAXSUM		Name='°ø±Þ°¡¾×'	HeadAlign=Center HeadBgColor=#B9D4DC Width=120 align=right	SumText=@sum	 SumBgColor=#C3D0DB</C>
			<C>ID=TAXVATAMT Name='ºÎ°¡¼¼¾×'	HeadAlign=Center HeadBgColor=#B9D4DC Width=120 align=right	SumText=@sum	 SumBgColor=#C3D0DB</C>
			<C>ID=TAXTOT2	  Name='ÇÕ°è'			HeadAlign=Center HeadBgColor=#B9D4DC Width=120 align=right	SumText=@sum	 SumBgColor=#C3D0DB </C>
			<C>ID=BIGO			Name='ºñ°í'			HeadAlign=Center HeadBgColor=#B9D4DC Width=70  align=left		SumText=''		 SumBgColor=#C3D0DB</C>
			<C>ID=EMPNO			Name='ºñ°í'			HeadAlign=Center HeadBgColor=#B9D4DC Width=70  align=left		SumText=''		 SumBgColor=#C3D0DB show=false</C>
	...
	<table cellpadding=0 cellspacing=0 border=0 style="position:relative;top:10px;left:8px;width:867px;border:1 solid #708090">
		<tr>
			<td class="tab11" bgcolor="#eeeeee">½Å¿ëÄ«µå¹øÈ£</td>
			...
			<!-- <td class="tab11" bgcolor="#eeeeee">½Å¿ëÄ«µå°¡¸ÍÁ¡</td>
		...
		<tr>
			<td class="tab12" bgcolor="#eeeeee">°íÁ¤ÀÚ»ê</td>
			...
			<!-- <td class="tab12" bgcolor="#eeeeee">°íÁ¤ÀÚ»ê¸í</td>
			<td>
	...
	<table cellpadding=0 cellspacing=0 border=1 style="position:relative;left:8px;top:13px;border:1 solid #708090;display:none">
		<tr> 
			<td class="tab12" width="100px" bgcolor="#eeeeee"><nobr>°ø±Þ°¡¾×</nobr></td>
			<td class="tab23" width="149px;">
				<comment id="__NSID__"><object  id=gcem_taxsum classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="position:relative;left:5px;width:90px">
					<param name=Text				value="">
					<param name=Alignment		value=2>
		...
		<td>
			<table width="867px" border="0" cellpadding=0 cellspacing=0 style="position:relative;left:8px;border:0 solid #708090;border-bottom-width:1px;border-right-width:1px;">
					<tr> 
						...
						<td class="tab14" width="100px" bgcolor="#eeeeee"><nobr>°è»ê¼­¹øÈ£</nobr></td>
						<td class="tab31" width="89px"><comment id="__NSID__">
					...
					<tr> 
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>°è»ê¼­ÀÏÀÚ</nobr></td>
						<td class="tab19" width="189px"><comment id="__NSID__">
         ...
         <tr> 
              ...
              <!-- Email -->
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>ÀüÀÚ¹ßÇà±¸ºÐ</nobr></td>
						<td class="tab22" width="189px"><nobr><comment id="__NSID__">
						  <INPUT type="radio" id=rdo_gubun2_1 value="1" onclick="ln_Rdo_Chk('3')" disabled>ÀüÀÚ ¹ßÇà
							<INPUT type="radio" id=rdo_gubun2_2 value="2" onclick="ln_Rdo_Chk('4')" disabled>¼ö±â ¹ßÇà
					...
					<tr> 
						...
						<td class="tab22" width="189px"><nobr><comment id="__NSID__">
							...
							<object id=gclx_status2      classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 style="position:relative;left:0px;top:1px;width:100px;">
								<param name=CBData			   value="S^¸ÅÃâÀúÀå,I^¼ö½Å¹Ì½ÂÀÎ,C^¼ö½Å½ÂÀÎ,R^¼ö½Å°ÅºÎ,O^Ãë¼Ò¿Ï·á,M^¹ßÇàÃë¼Ò¿äÃ»(°ø±Þ¹Þ´ÂÀÚ),N^¹ßÇàÃë¼Ò¿äÃ»(°ø±ÞÀÚ),V^¿ª¹ßÇà¿äÃ»,T^¿ª¹ßÇà°ÅºÎ,W^¿ª¹ßÇà¿äÃ» Ãë¼Ò">
								<param name=CBDataColumns	 value="CODE,NAME">
								<param name=SearchColumn	 value=NAME>
								<param name=Sort			     value=false>
                <param name=Enable 	       value=false>
...
<!-- <nobr>
					...
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>¹ßÇà¿©ºÎ</nobr></td>
						<td class="tab19" width="149px;"><comment id="__NSID__">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>¹ßÇà±¸ºÐ</nobr></td>
						<td class="tab19" width="100px"><comment id="__NSID__">
							<object  id=gclx_taxtype2 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 style="position:relative;left:5px;top:1px;font-size:12px;width:90px;height:200px;">
								<param name=CBData					value="Y^¿µ¼ö,N^Ã»±¸">
								<param name=CBDataColumns		value="CDCODE,CDNAM">
								<param name=SearchColumn		value="CDNAM">
								<param name=Sort						value="false">
								<param name=ListExprFormat	value="CDNAM^0^90">
						...
						<td class="tab11" width="100px" bgcolor="#eeeeee"><nobr>ÀüÇ¥¹øÈ£</nobr></td>
						<td class="tab22" width="189px"><comment id="__NSID__">
         	...
         	<!-- ºñ°íÃß°¡ 2010.12.01 JYS -->
					<tr> 
						<td class="tab33" width="100px" bgcolor="#eeeeee"><nobr>¼¼±Ý°è»ê¼­ºñ°í</nobr></td>
						<td class="tab19" width="580px" colspan="4"><nobr><comment id="__NSID__">
						 ...
						 <td class="tab22"  width="189px;"><nobr>
						  <INPUT id=chk_ext type=checkbox  value='0' style="position:relative;top:0px" onclick="ln_ChkBox2()" > <font color="blue" >¿ÜºÎ½Ã½ºÅÛ ¸ÅÃâ¹ßÇà</font>
						<td>
					</tr>

						<!-- ¼öÁ¤¼¼±Ý°è»ê¼­ Ãß°¡  -->
					<tr> 
						<td class="tab41" width="100px" bgcolor="#eeeeee"><nobr>¼öÁ¤¼¼±Ý°è»ê¼­</nobr></td>
						<td class="tab23" width="149px;"><nobr>
						  <INPUT id=chk_tax type=checkbox  value='1' style="position:relative;top:-3px"  onclick="ln_ChkBox()"  >
							...
							<object  id=gclx_amend_code classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 style="position:relative;left:3px;top:2px;font-size:12px;width:150px;height:200px;">
								<param name=CBData					value="^' ',01^±âÀç»çÇ×ÀÇ Âø¿À¡¤¿À·ù,02^°ø±Þ°¡¾× º¯µ¿,03^È¯ÀÔ,04^°è¾àÀÇ ÇØÁ¦,05^³»±¹½Å¿ëÀå »çÈÄ °³¼³,06^Âø¿À¿¡ ÀÇÇÑ ÀÌÁß¹ß±Þ">
								<param name=CBDataColumns		value="CDCODE,CDNAM">
								<param name=SearchColumn		value="CDNAM">
								<param name=Sort						value="false">
						...
						<td class="tab12" width="100px" bgcolor="#eeeeee"><nobr>¼öÁ¤ºñ°í</nobr></td>
			...
			<table border="0" cellpadding="0" cellspacing="0" style="position:relative;top:5px;left:8px;">
				<tr>
		            ...
		            <PARAM NAME="DisableBackColor"	VALUE="#eeeeee">
								<PARAM NAME="Format"						VALUE="
									<T>divid=layer2  title='¼¼±Ý°è»ê¼­ ¼¼ºÎ³»¿ª'</T>									
								">
						</object></comment><script>__ws__(__NSID__);</script> 
					</td>
				</tr>
  ...
  <table cellpadding=0 cellspacing=0 border=0>
		...
		<tr>
		  <td style="width:865;border:0 solid #708090;border-top-width:1px" colspan="2">
			...
			<C>ID=TAXMM			Name='¿ù'				HeadAlign=Center HeadBgColor=#B9D4DC Width=20  align=center SumText='' SumBgColor=#C3D0DB </C>
			<C>ID=TAXDT			Name='ÀÏ'				HeadAlign=Center HeadBgColor=#B9D4DC Width=20  align=center SumText='' SumBgColor=#C3D0DB </C>
			<C>ID=TAXPDTNAM Name='Ç°¸ñ¸í'		HeadAlign=Center HeadBgColor=#B9D4DC Width=240 align=LEFT		SumText='' SumBgColor=#C3D0DB </C>
			<C>ID=TAXSTD		Name='±Ô°Ý'			HeadAlign=Center HeadBgColor=#B9D4DC Width=80	 align=LEFT		SumText='' SumBgColor=#C3D0DB </C>
			<C>ID=TAXQTY		Name='¼ö·®'			HeadAlign=Center HeadBgColor=#B9D4DC Width=80  align=right	SumText='' SumBgColor=#C3D0DB </C> 
			<C>ID=TAXPRIC   Name='´Ü°¡'			HeadAlign=Center HeadBgColor=#B9D4DC Width=80  align=right	SumText='' SumBgColor=#C3D0DB </C> 
			<C>ID=TAXSUM		Name='°ø±Þ°¡¾×'	HeadAlign=Center HeadBgColor=#B9D4DC Width=130 align=right	SumBgColor=#C3D0DB</C>
			<C>ID=TAXVATAMT Name='ºÎ°¡¼¼¾×'	HeadAlign=Center HeadBgColor=#B9D4DC Width=130 align=right	SumText=@sum SumBgColor=#C3D0DB</C>
			<C>ID=BIGO			Name='ºñ°í'			HeadAlign=Center HeadBgColor=#B9D4DC Width=70  align=LEFT		SumText='' SumBgColor=#C3D0DB</C>
					">
				</object></comment><script>__ws__(__NSID__);</script> 
				<fieldset style="width:865;height:20px;border:0 solid #708090;border-top-width:1px;text-align:left;">
...
<!-----------------------------------------------------------------------------
			B I N D  D E F I N I T I O N   -  ¸Å ÀÔ
------------------------------------------------------------------------------>
...
<!-----------------------------------------------------------------------------
			B I N D  D E F I N I T I O N   -  ¸Å Ãâ
------------------------------------------------------------------------------>
...
<!-----------------------------------------------------------------------------
			R E P O R T   D E F I N I T I O N - ¸Å Ãâ ¼¼ ±Ý °è »ê ¼­
------------------------------------------------------------------------------>
