...
<!---------------------------------------------------------------------------
+ 시 스 템 명	:  경리회계 - 계정원장(일별) Popup
+ 프로그램 ID	:  Totalbal_popup.html
+ 기 능 정 의	:  계정원장 팝업창.
+ 작   성  자 :  이 순 미
+ 서 블 릿 명	:	 totalbal_popup_s1
------------------------------------------------------------------------------>
...
<script language="javascript" for="gcgd_disp01" event="OnDblClick()">
	...
	var p_fsdt = gcds_data1.namevalue(row,"FSDAT");		//일자
	var p_fnbr = gcds_data1.namevalue(row,"FSNBR");		//등록번호
		...
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:8px;width:866px;border:1 solid #708090;">
			...
			<tr> 				
				...
				<td class="tab23" colspan="5" width="490px"><nobr>
					<comment id="__NSID__"><object  id=gcem_atcode_fr01 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:50px;height:20px;position:relative;left:5px;top:5px;">		
					...
					<input id="txt_atkornam_fr01" type="text" class="txtbox"  style= "position:relative;top:1px;left:5px;width:130px;height:20px;" maxlength="36"  disabled>&nbsp;&nbsp;~
				 <comment id="__NSID__"><object  id=gcem_atcode_to01 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:50px;height:20px;position:relative;left:2px;top:5px">				
						<param name=Text					value="">
						<param name=Alignment     value=0>
						<param name=Border        value=true>
						<param name=Numeric       value=false>
			...
			<tr> 			
				<td style="width:280" ALIGN=LEFT VALIGN=TOP>
					<comment id="__NSID__"><object  id=gcgd_disp01 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49   
						style="position:relative;left:8px;width:864px;height:300px; border:1 solid #708090;display:block;" viewastext>
						...
						<C> Name='전표번호'		ID={IF(FSDAT='','',FSDAT&'-'&FSNBR)}			HeadAlign=Center HeadBgColor=#B9D4DC Width=110		align=center SumBgColor=#C3D0DB SumText=''   </C> 
						<C> Name='적요'				ID=REMARK			HeadAlign=Center HeadBgColor=#B9D4DC Width=200	align=left	 SumBgColor=#C3D0DB SumText=''   </C> 
...
<comment id="__NSID__"><object  id=gcrp_print classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="PrintSetupDlgFlag"     VALUE="true">
	...
	<X>left=1101 ,top=34 ,right=1937 ,bottom=108 ,backcolor=#000000 ,border=true ,penstyle=solid ,penwidth=1</X>
	...
	<T>id='계  정  원  장' ,left=1093 ,top=24 ,right=1918 ,bottom=87 ,face='HY중고딕' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
	...
	<T>id='차  변' ,left=1709 ,top=291 ,right=2066 ,bottom=365 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0</T>
	...
	<L> left=773 ,top=283 ,right=773 ,bottom=373 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	...
	<T>id='전표번호' ,left=452 ,top=291 ,right=767 ,bottom=365 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0</T>
	<L> left=1310 ,top=283 ,right=1310 ,bottom=373 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='거래처명' ,left=1315 ,top=291 ,right=1696 ,bottom=365 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0</T>
	...
	<T>id='일  자' ,left=243 ,top=291 ,right=442 ,bottom=365 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0</T>
	<T>id='적  요' ,left=778 ,top=291 ,right=1302 ,bottom=365 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0</T>
...
<B>id=default ,left=0,top=0 ,right=2871 ,bottom=50 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='VENDER', left=1315, top=0, right=1696, bottom=45, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1310 ,top=0 ,right=1310 ,bottom=50 </L>
	<C>id='REMARK', left=778, top=0, right=1302, bottom=45, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=773 ,top=0 ,right=773 ,bottom=50 </L>
	<C>id='FSNBRDT', left=452, top=0, right=767, bottom=45, align='left' ,mask='XXXXXXXXX-XXXXXX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=447 ,top=0 ,right=447 ,bottom=50 </L>
	<C>id='ACTDAT', left=243, top=0, right=442, bottom=45, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=241 ,top=0 ,right=241 ,bottom=50 </L>
	<L> left=241 ,top=50 ,right=2810 ,bottom=50 ,penstyle=solid ,penwidth=1 ,pencolor=#A0A0A4 </L>
	<L> left=241 ,top=50 ,right=2810 ,bottom=50 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
</B>
<B>id=Footer ,left=0 ,top=1862 ,right=2871 ,bottom=2000 ,face='Arial' ,size=10 ,penwidth=1
