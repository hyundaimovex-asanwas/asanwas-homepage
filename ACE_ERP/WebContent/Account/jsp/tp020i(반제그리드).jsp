                        ...
                        <td valign='top' width="845px">
							<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_excel width="845px" height="170px" border="1">
							        ...
							        <param name="Format"            value="
							                ...
							                <C> name='남은 금액'  	ID='COL05'  	Width=90  align=RIGHT show=true	DEC=0</C>
							                <C> name='취급점'   	ID='COL06'   	Width=100  align=center show=true	</C>
							                <C> name='TR_SID'    	ID='TR_SID'  	Width=100  align=left  show=false	</C>
							                <C> name='거래처'    	ID='TR_SID'  	Width=110  align=left  show=true	</C>
        	...
        	<td>
        	 <table border='0' cellpadding='0' cellspacing='2' width='845px'>
                    <tr>
                        ...
                        <td height='20px' align='right'>
                            <img src="../../Common/img/btn/com_btn_repay.gif"		         style="cursor:pointer"   onClick="fnRepay()"  >	
                            <img src="../../Common/img/btn/com_btn_repay_cancel.gif"	 style="cursor:pointer;"  onClick="fnRepay_Cancel()"  >
						</td>
                    </tr>
                </table>
             </td>
