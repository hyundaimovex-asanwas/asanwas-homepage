							...
							<td colspan='4' width='400'>
								<table width=400 border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">
            		                <tr height="20px">
	        							...
	        							<td align=middle class="text" width="200px">사번</td>
			...
			%>
								...
								<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=550px; height:260px;" border="1">
									...
									<param name="Format" 		value="
									    <C> name='부서'   			ID='DEPTNM'	align=left editlimit=20 show=true width=200 sumtext=총</C>
									    <C> name='사번'   			ID='EMPNO'	align=left editlimit=20 show=true width=100 sumtext=@count</C>
									    <C> name='성명'      		ID='EMPNMK'	align=left editlimit=20 show=true width=100 sumtext=명</C>
									    <C> name='부서코드'    	ID='DEPTCD'	align=left editlimit=20 show=false width=100 sumtext=명</C>
						                ">
								</object>
								<%=HDConstant.COMMENT_END%>
							</td>
