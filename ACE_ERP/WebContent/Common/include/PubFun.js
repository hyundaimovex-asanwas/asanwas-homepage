...
function CallMonth(){ // 모달팝업 호출 함수
		__calMonthRtn = window.showModalDialog("../..//html/com_month.html","","dialogWidth:180px;dialogHeight:230px;scroll:no;status:no;titlebar:no;center:yes;help:yes;");
}
...
******************************************************************************************/
function lfn_init(){
if ( is_null(gusrid) ||  is_null(gusrpw) ) {
