...
<div id="haHeader">
	...
	<table width="1000" border='0'>
	  <TR>
		...
		<td class="l b" style="padding-left:2px;padding-bottom:1px" id="msgTxt">회계 시스템에 접속하신걸 환영합니다. 사용중 불편사항은 이동훈 과장에게 연락주시면 됩니다.(02-3669-3753)&nbsp;</td>
	...
	<div id="haHeaderMenu">
		<table width="1000" border='0'>
		  <TR>
			<td class="c b" width="158px" style="padding-bottom:0px; color:#111111;"><%=gusrnm%>(<%=gusrid%>)님</td>
			<td class="l b" style="padding-bottom:0px;color:#111111;font-size:14px;padding-left:12px;" id="menu_title">&nbsp;</td>
