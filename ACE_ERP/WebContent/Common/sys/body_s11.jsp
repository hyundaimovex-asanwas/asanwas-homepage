		...
		function fnSetTitle(tree_idx){
			if(tree_idx==0){	//초기 인덱스화면인 경우
		        ...
		        ln_TRSetting(tr_title, 
		            "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>Cm011I_10",
...
<div id="haHeader">
	...
	<div id="haHeaderMenu">
		<table width="999" height=100%>
		  <TR>
			<td class="c b bold" width="158px" style="padding-bottom:0px; color:#ffffff;"><%=gusrnm%>(<%=gusrid%>)님</td>
			<td class="l b bold" style="padding-bottom:0px;color:#ffffff;font-size:14px;padding-left:12px;" id="menu_title">&nbsp;</td>
			<td class="r b" style="color:#ffffff; padding-bottom:0px;padding-right:1px;" id="menu_full">&nbsp;</td>
		  </TR>
		</table>
