...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15"
	...
	onload="fnc_OnLoadProcess();fnOnLoad(<%=tree_idx%>);">
-->
<%
/*=============================================================================
			Status Bar Falsh
...
<div id="haHeader">
	...
	<table width="1000" border='0'>
	  <TR>
		<td class="c b" width="158px" style="padding-bottom:2px"><img src="../../images/common/logo.gif" /></td>
		<td class="r b" width="12px" style="padding-bottom:1px">★</td>
		<td class="l b" style="padding-left:2px;padding-bottom:1px" id="msgTxt">인사 시스템에 접속하신걸 환영합니다. 사용중 불편사항은 이동훈 과장에게 연락주시면 됩니다.(02-3669-3753)&nbsp;</td>
