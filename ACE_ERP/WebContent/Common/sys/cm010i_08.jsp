...
%>
	...
	function fnInit_tree(tree_idx){
		...
		//메뉴트리 조회하기
        var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=1,X-UIClient=G40,"	//여기에 파라미터 추가함 5.x 버전
   	     	+ "tree_idx=" + tree_idx;	//선택된 메뉴 idx를 던진다.
        ln_TRSetting(tr_tree, 
            "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>Cm011I_08",
