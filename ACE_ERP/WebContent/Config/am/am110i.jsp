...
%>
	...
	function fnSelect() {
	        ...
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>Am110I",
	            "JSP(O:DS1=ds1)",
	            param);
	        tr_post(tr1);
   }
			                        ...
			                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
			                        	<tr bgcolor="#6f7f8d">
											...
											<td align=center bgcolor="#ffffff" colspan="3">&nbsp;																		
												<input id="sEMPNO" type="text" class="textbox"  style= "position:relative;left:-0px;top:2px;width:200px; height:20px;">
											</td>
			            					<td align="center" width="100px" class="text">성 명</td>
			                                <td align=center bgcolor="#ffffff" colspan="3">&nbsp;																		
												<input id="sEMPNMK" type="text" class="textbox"  style= "position:relative;left:-0px;top:2px;width:200px; height:20px;">
											</td>
			            				</tr>	
			            			</table>
								</td>
								...
								<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:370" border="1" >
										...
										<param name="Format" 		value="
							               <C> name='부서'       ID='DEPTNM'       	width=70  align=right	  show=true align=left 			Edit=true suppress=1 </C>
							               <C> name='사번'       ID='EMPNO'        	width=50  align=right	  show=true align=left 			Edit=true suppress=2</C>
							               <C> name='성명'       ID='EMPNMK'      	width=50  align=right	  show=true BgColor=#b4f0b4  	editlimit=20 editstyle=popup suppress=3</C>
							               <C> name='S/N'  	 ID='ITEM_SID' 		width=40  align=center 	  show=true edit=true						</C>
							               <C> name='모델명'   	 ID='MODEL_NM' 		width=100  align=center 	  show=true edit=true						</C>
							               <C> name='제조사'     ID='MADE_COMPANY'  width=50  align=center 	  show=true editlimit=200 		edit=true	</C>
							               <C> name='CPU'      	 ID='CPU'     	 	width=100  align=right	  show=true BgColor=#fefec0  	editlimit=12 edit=true </C>
										   ...
										   <C> name='SERIAL_NO'  ID='SERIAL_NO' 		width=60  align=center 	  show=true edit=true						</C>
										">
									</object>
									<%=HDConstant.COMMENT_END%>
								</td>		
