 ...
 *						서비스요청서 전자결재의 기안함 - 로긴 사용자가 기안한 문서만 조회
		...
		function fnSelect() {
        	var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
			          ...
			          + ",v_doc_gu2=" + v_doc_gu2.ValueOfIndex("detail", v_doc_gu2.Index)
						;
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_AP%>Ap120I",
			    "JSP(O:MASTER=ds1)",
			    param);
...
<script language=javascript for=gr1 event="OnDblClick(Row,Colid)">
	...
	// 공사인 경우
	if(ds1.namevalue(Row,"doc_gu")=="40"){	//기안한 문서니까. 승인/반송 버튼은 없음
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
	...
	<table border='0' cellpadding='0' cellspacing='0' width='845'>	
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
						              ...
						              <C> name='기안일시' 	ID='i_date' 		width=180 	align=center editlimit=10 show=true edit=none</C>
		...
		<tr>
			<td>※ 기안함 : 사용자가 직접 기안한 문서(작성중 문서 포함)만 조회됩니다. <br>
			</td>
		</tr>
