 ...
 * [2011-09-29][박경국] ERP 전체 메뉴권한요청 화면!
 * [2013-11-12][심동현] 재구성-실행 이슈
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
    ...
    function fnSelect() {
      ...
      if (ds1.isUpdated) {
		...
		v_job = "S";
           ...
           ln_TRSetting(tr1,
               "<%=dirPath%><%=HDConstant.PATH_MY%>My140I",
			...
			<tr>
	            <td class="r">
	           		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='1050px'>
	           			<tr>
	                        <td align="left" class="text" width="150">메뉴</td>
	                        <td align="left" bgcolor="#ffffff" >&nbsp;
								<select name="v_stat" id="v_stat" onChange="fnSelect();" >
									<option value="">전체</option>
									<option value="150">인사</option>								
									<option value="114">회계</option>
									<option value="116">관광</option>
									
									<option value="143">유통</option>								
									<option value="149">자원</option>
									<option value="493">PMS</option>
									
									<option value="192">정보</option>								
									<option value="118">환경설정</option>
									<option value="117">금강산</option>																		
									<option value="232">사업소관리</option>	
								</select>	
	                        </td>                         
						</tr>
				...
				<table  border="0" cellpadding="0" cellspacing="0" >
				  <tr valign="top"">
					<td width=535>■ 전체 메뉴 리스트<br>
					    ...
					    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=730px; height:550px" border="1">
					        ...
					        <param name="Format"            value="
								<C> name='NO'			id='{CUROW}'		width=35	align=center	value={String(Currow)}   </C>					        				        
					           ...
					           <G> name='메뉴'
					            <C> name='메뉴ID'       ID='TREE_ID'      	Width=80  	align=center </C>
					            <C> name='메뉴번호'     ID='TREE_IDX'     	Width=90  	align=center show=false</C>
					            <C> name='메뉴명1'      ID='TREE_NM1'     	Width=100  	align=center suppress=1</C>
					            <C> name='메뉴명2'      ID='TREE_NM2'     	Width=110  	align=left 	suppress=2</C>
					            <C> name='메뉴명3'      ID='TREE_NM3'     	Width=110  	align=left 	suppress=3</C>
					            <C> name='메뉴명4'      ID='TREE_NM4'     	Width=180  	align=left </C>
					           </G>
					        ">
					    </object>
					...
					<td width=300>■ 권한 요청<br>
					    <%=HDConstant.COMMENT_START%>
					    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr2  style="width=300px; height:550px" border="1">
