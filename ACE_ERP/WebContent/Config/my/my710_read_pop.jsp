...
%>		
	...
	function fnReply(){
		...
		f.action = "my710_exec.jsp?idx=947&brd_creator=<%=dto.getBrd_creator()%>&brd_creator_name=<%=dto.getBrd_creator_name()%>";
		f.submit();
	}
...
<!--  BODY START -->
<body border="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
		...
		<table border="0" cellpadding="0" cellspacing="0" width="460">
			...
			<tr>
				<td align="center">
					<% if(pageFrom.equals("710")){%><a href="javascript:fnReply();"><img src="<%=dirPath%>/Sales/images/b_reply.gif" border="0"></a><%}%>
					<% if(pageFrom.equals("710")){%><a href="javascript:fnKeep();"><img src="<%=dirPath%>/Sales/images/b_keep.gif" border="0"></a><%}%>
					<% if(pageFrom.equals("720")){%><a href="javascript:fnKeep2();"><img src="<%=dirPath%>/Sales/images/b_keep.gif" border="0"></a><%}%>
					<% if(pageFrom.equals("710")){%><a href="javascript:fnDelete();"><img src="<%=dirPath%>/Sales/images/b_del.gif" border="0"></a>
					<%}else if(pageFrom.equals("720")){%><a href="javascript:fnDelete2();"><img src="<%=dirPath%>/Sales/images/b_del.gif" border="0">
					<%}else if(pageFrom.equals("730")){%><a href="javascript:fnDelete3();"><img src="<%=dirPath%>/Sales/images/b_del.gif" border="0"></a><%}%>
