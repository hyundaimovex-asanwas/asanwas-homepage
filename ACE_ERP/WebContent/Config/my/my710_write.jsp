 ...
 * [2011-10-12][심동현] 세션정보에서 사번, 이름 불러오게 수정 (line 544 javascript)
 * [2011-10-12][심동현] exec 파일로 이동시 세션정보 보내기
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
String recipient	= "";		//수신자 아이디
String writer_name	= "";		//작성자 이름
String recipient_name	= "";		//수신자 이름
String user_id = "";
String user_name = "";
String virtual_name	= "";
String real_name		= "";
...
//		if(f.brd_passwd.value==""){alert("비밀번호를 입력해 주세요!");  f.brd_passwd.focus(); return;}
	...
	function fnCustPopup() {
		...
		var strURL;	 
		var strPos;
		strURL = "<%=dirPath%>/Common/help/rv004h_05.jsp"
		strPos = "dialogWidth:405px;dialogHeight:350px;status:no;scroll:no;resizable:no";
		arrResult = showModalDialog(strURL,arrParam,strPos);	
		arrParam = arrResult.split(";");
		document.form1.brd_recipient.value=arrParam[0];//+ "("+GetCookie("vusrid")+")";
		document.form1.brd_recipient_name.value=arrParam[1];//+ "("+GetCookie("vusrid")+")";
	}
                          ...
                          <tr height="30">
                            ...
                            <td style="padding-left:5;"><input type="text" id=TEXT7 name="brd_recipient" value="<%=recipient%>" size="10" maxlength="7" class=textbox  readOnly="true">
                            	<input type="text" id=TEXT8 name="brd_recipient_name" value="<%=recipient_name%>" size="10" maxlength="20" class=textbox  readOnly="true">
	  							<img src="<%=dirPath%>/Sales/images/help.gif" border="0" align=absmiddle onClick="fnCustPopup()" style="cursor:hand;">
...
if(workFlag=="INSERT"){
	document.form1.brd_creator.value="<%=v_login_id%>";
	document.form1.brd_creator_name.value="<%=v_login_name%>";
};
</script>
