...
<%
/******************************************************************************
 * 시스템명 	 : 홈>환경설정>마이페이지>커뮤니티>No_GAUCE
 * 프로그램ID 	 : Config/my/ng010
 * J  S  P		 : Ng010.jsp
 * 서 블 릿		 : Ng010
 * 작 성 자		 : 이동훈
 * 작 성 일		 : 2017-11-23 2017년도 수능날
 * 작 성 내 용   : 가우스 없는 세상에서 살아보고자, IE 아닌 환경에서 접해보고자, ActiveX 그켬!
 * [ 수정일자 ][수정자] 내용
 * [2017-11-23][이동훈] 신규 개발 
 *****************************************************************************/
%>
