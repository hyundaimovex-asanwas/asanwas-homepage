    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송
            dsT_CM_COMMON.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.common.popup.codenm.cmd.CODENMCMD&S_MODE=SHR&GBN="+retObj.gbn+"&COMM_CD="+document.getElementById('txtCOMM_CD_SHR').value+"&UP_CD="+retObj.up_cd;
