    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            if(retObj.gbn2_tag == "Y"){// 기준코드 gbn2_tag 사용 유무
                dsT_CM_COMMON.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.common.popup.commnm.cmd.COMMNMCMD&S_MODE=SHR_03&CD_GBN="+retObj.cd_gbn+"&OCC_CD="+retObj.occ_cd+"&COMM_CD_SHR="+comm_cd_shr;
            	dsT_CM_COMMON.Reset();
            }else{
                dsT_CM_COMMON.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.common.popup.commnm.cmd.COMMNMCMD&S_MODE=SHR&CD_GBN="+retObj.cd_gbn+"&OCC_CD="+retObj.occ_cd+"&COMM_CD_SHR="+comm_cd_shr;       
                dsT_CM_COMMON.Reset();
            }
        }
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center" class="blueTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" class="searchState">공통 코드/코드명&nbsp;</td>
	        ...
	        <td>
	            <table border="0" cellspacing="0" cellpadding="0">
	                <tr align="center">
	                    <td>
	                        <comment id="__NSID__">
	                        <object    id="grdT_CM_COMMON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:450px;height:280px;">
	                            <param name="DataID"            value="dsT_CM_COMMON">
	                            <param Name="Editable"          value="false">
								<param name=HiddenHScroll    value="true">
	                            <param name="Format"            value='
	                            	<C> id=COMM_CD			width=100		name=코드			align=center 	</C>
	                                <C> id=COMM_NM		width=320   	name=코드명    	align=left 	</C>
	                            '>
	                        </object>
