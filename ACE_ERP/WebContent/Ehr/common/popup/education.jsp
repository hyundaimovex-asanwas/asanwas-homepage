...
<html>
    ...
    <head>
    <title>과정코드조회(T_CM_COMMON, Q1)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=common.popup.education.cmd.EDUCATIONCMD&S_MODE=SHR&CD_GBN="+CD_GBN+"&COMM_CD="+COMM_CD;
            dsT_CM_COMMON.Reset();
    ...
    **************************************-->
	...
	<script language=JavaScript for=dsT_CM_COMMON event=OnRowPosChanged(row)>
        ...
        if(dsT_CM_COMMON.countrow > 0){
	        ...
	        dsT_ED_CHASULIST.DataID = "/servlet/GauceChannelSVL?cmd=common.popup.education.cmd.EDUCATIONCMD&S_MODE=SHR_01&EDU_CD="+EDU_CD+"&PIS_YY="+PIS_YY;
