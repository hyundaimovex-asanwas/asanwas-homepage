...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송
            dsT_CM_PERSON.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.common.popup.empl.cmd.EMPLCMD&S_MODE=SHR&ENO_NO="+document.form1.txtENO_NO_SHR.value+"&GUBUN="+retObj.gbn;
    ...
    **************************************-->
	...
	<script language=JavaScript for=grdT_CM_PERSON event=OnDblClick(row,colid)>
		...
		//alert(retObj.eno_no+retObj.eno_nm);		
