    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_ME_PERSON,0,"false","right");      // Grid Style 적용
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견사원정보조회</td>
                    </tr>
                </table>
            </td>
        </tr>
