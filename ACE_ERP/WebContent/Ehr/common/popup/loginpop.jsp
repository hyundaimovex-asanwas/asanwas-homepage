...
<script language="javascript">
       ...
       alert("전화번호가 등록되어 있지 않습니다. 인재지원부로 연락하여 비밀번호를 초기화 하시기 바랍니다.");
       return false;
       }
         ...
         *******************************************************/
         function fnc_Random(){
            ...
            trT_CM_PERSON.post();
            alert("인증번호가 등록된 핸드폰으로 전송되었습니다. 확인 후 인증번호를 입력해 주세요");
         ...
         if( document.getElementById("txtSMS_NUMBER").value != document.getElementById("txtCER_NO").value ) {
    		 alert("인증번호가 다릅니다. 다시 확인하여 주시기 바랍니다.");
			 return false;
			}
		 else{
    		 trT_CM_PERSON.KeyValue = "tr(O:dsT_CM_PERSON=dsT_CM_PERSON)";
                            	...
                            	<table width="300" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<img src="/images/specialHr/arrowGreen.gif" width="8"
											height="15" align="absmiddle"> 사 &nbsp 번 </td><td> <input
									...
									<tr>
										<td height="27" class="hrTextGreen" style="padding-top:5px;">
										<img src="/images/specialHr/arrowGreen.gif" width="8"
											height="15" align="absmiddle"> 이 &nbsp 름</td><td>  <input
									...
									<tr>
										...
										<img src="/images/specialHr/arrowGreen.gif" width="8"
										    height="15" align="absmiddle"> 주민번호</td><td>   <input
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td height="27" class="hrTextGreen" align="left" style="padding-top:5px;padding-bottom:10px;">
                                      ...
                                      <input type="text"   id=txtEM_PHN_NO value="" size="13"  maxlength=14 style="ime-mode:disabled" class="input_ReadOnly"> 번호로 인증번호를 전송합니다.
                                  ...
                                  <tr>
                                      ...
                                      <td height="27" class="hrTextGreen" align="left" style="padding-top:5px;padding-bottom:10px;">
                                       &nbsp<img src="/images/specialHr/arrowGreen.gif" width="8" height="15" align="absmiddle"> 인증번호
