    ...
    *****************************-->
    <script language="javascript" >
		...
		function fnc_FileDelete() {
            ...
            //확인 상태 확인 : 확인 완료 or 확인 진행중이면 파일 삭제 불가,      "저장", "반려", "신규" 상태이면 파일 삭제 가능
		...
		<td align="left">
			...
			<object	id="grdT_ACT_PLANLIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:305px;">
				...
				<param name="Format"				value="
					...
					<C> id='DOC_NM1'			width=100	name='대분류'			align=center	suppress=1</C>
					<C> id='DOC_NM2'			width=100	name='중분류'			align=center	suppress=2</C>
