<!--*************************************************************************
* @source      : acqa030.jsp												*
* @description : Action Plan > 금강산관광 > 관광운영						*
*****************************************************************************
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            trT_ACT_PLANLIST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa030.cmd.ACQA030CMD&S_MODE=SHR&DOC_GB2="+DOC_GB2+"&DOC_GB3="+DOC_GB3;
    ...
    **************************************-->
    ...
    <script for=trT_ACT_PLANLIST event="OnSuccess()">
        ...
        trT_ACT_APPROVAL_SHR.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa030.cmd.ACQA030CMD&S_MODE=SHR_APP&REQ_NO="+document.getElementById("txtREQ_NO").value;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB1_SHR" style="width:10%" class="input_ReadOnly"  readonly value="A"> 
                    <input id="txtDOC_NM1_SHR" style="width:50%" class="input_ReadOnly"  readonly value="금강산 관광 재개">
                </td>			

                <td align="center" class="blueBold">중분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="AA"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="관광운영">                
                </td>
                ...
                <td class="padding2423">
                    ...
                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgDOC_GB3_SHR','','../../images/button/btn_HelpOver.gif',1)">
                    <img src="../../images/button/btn_HelpOn.gif" id="ImgDOC_GB3_SHR" name="ImgDOC_GB3_SHR" width="21" height="20" border="0" align="absmiddle" onClick="fnc_DocNmPopup('GB3');"></a>
                </td>			
			</tr>
		</table>
		</td>
		...
		<td align="left">
			...
			<object	id="grdT_ACT_PLANLIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:305px;">
				...
				<param name="Format"				value="
					...
					<C> id='APP_STATUS'			width=90	name='확인상태'			align=center	show=false value={decode(APP_STATUS_CD,'S','저장','G','확인진행중','R','반려','Y','확인완료','')}</C>
					<C> id='APP_STATUS'			width=90	name='확인상태'			align=center	</C>
				...
				<tr>
			        <td>
						<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
							...
							<tr height="25">
								<td align="center" class="blueBold">확인번호</td>
								<td class="padding2423">
