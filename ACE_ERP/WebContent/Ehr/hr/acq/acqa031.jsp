<!--*************************************************************************
* @source      : acqa030.jsp												*
* @description : Action Plan > 금강산관광 > 영업 및 마케팅					*
*****************************************************************************
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="AB"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="영업 및 마케팅">                
                </td>
