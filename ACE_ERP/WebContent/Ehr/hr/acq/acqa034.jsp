<!--*************************************************************************
* @source      : acqa034.jsp												*
* @description : Action Plan > 금강산관광 > 협력회사						*
*****************************************************************************
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="AE"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="협력회사">                
                </td>
