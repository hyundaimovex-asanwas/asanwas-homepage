<!--*************************************************************************
* @source      : acqa054.jsp												*
* @description : Action Plan > 개성공단 > 대북/대남 협의					*
*****************************************************************************
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            trT_ACT_PLANLIST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa050.cmd.ACQA050CMD&S_MODE=SHR&DOC_GB2="+DOC_GB2+"&DOC_GB3="+DOC_GB3;
    ...
    **************************************-->
    ...
    <script for=trT_ACT_PLANLIST event="OnSuccess()">
        ...
        trT_ACT_APPROVAL_SHR.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa050.cmd.ACQA050CMD&S_MODE=SHR_APP&REQ_NO="+document.getElementById("txtREQ_NO").value;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB1_SHR" style="width:10%" class="input_ReadOnly"  readonly value="C"> 
                    <input id="txtDOC_NM1_SHR" style="width:50%" class="input_ReadOnly"  readonly value="개성 공단 재개">
                </td>			

                <td align="center" class="blueBold">중분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="CE"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="대북/대남 협의">                
                </td>
