<!--*************************************************************************
* @source      : acqa060.jsp												*
* @description : Action Plan > 조직 및 인력	> 전략 및 방향					*
*****************************************************************************
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="DA"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="전략 및 방향">                
                </td>
                
                <td align="center" class="blueBold">세부분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB3_SHR" style="width:20%" class="input_ReadOnly"  readonly value="DA01"> 
                    <input id="txtDOC_NM3_SHR" style="width:50%" class="input_ReadOnly"  readonly value="전략 및 방향">                
                </td>		
			</tr>
		</table>
		</td>
