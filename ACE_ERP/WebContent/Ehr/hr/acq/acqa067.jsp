<!--*************************************************************************
* @source      : acqa067.jsp												*
* @description : Action Plan > 조직 및 인력	> (북측인력)소요인원 추정		*
*****************************************************************************
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="DH"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="(북측인력)소요인원 추정">                
                </td>
                
                <td align="center" class="blueBold">세부분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB3_SHR" style="width:20%" class="input_ReadOnly"  readonly value="DH01"> 
                    <input id="txtDOC_NM3_SHR" style="width:50%" class="input_ReadOnly"  readonly value="(북측인력)소요인원 추정">                
                </td>		
			</tr>
		</table>
		</td>
