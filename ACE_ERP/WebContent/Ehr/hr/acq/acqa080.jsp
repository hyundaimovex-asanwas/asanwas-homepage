<!--*************************************************************************
* @source      : acqa080.jsp												*
* @description : Action Plan > 소요자금 및 조달계획	> 소요자금				*
*****************************************************************************
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            trT_ACT_PLANLIST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa080.cmd.ACQA080CMD&S_MODE=SHR&DOC_GB2="+DOC_GB2+"&DOC_GB3="+DOC_GB3;
    ...
    **************************************-->
    ...
    <script for=trT_ACT_PLANLIST event="OnSuccess()">
        ...
        trT_ACT_APPROVAL_SHR.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.acq.a.acqa080.cmd.ACQA080CMD&S_MODE=SHR_APP&REQ_NO="+document.getElementById("txtREQ_NO").value;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td class="padding2423">
                    <input id="txtDOC_GB1_SHR" style="width:10%" class="input_ReadOnly"  readonly value="E"> 
                    <input id="txtDOC_NM1_SHR" style="width:50%" class="input_ReadOnly"  readonly value="소요자금 및 조달계획">
                </td>			

                <td align="center" class="blueBold">중분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB2_SHR" style="width:10%" class="input_ReadOnly"  readonly value="EA"> 
                    <input id="txtDOC_NM2_SHR" style="width:50%" class="input_ReadOnly"  readonly value="소요자금">                
                </td>
                
                <td align="center" class="blueBold">세부분류</td>
                <td class="padding2423">
                    <input id="txtDOC_GB3_SHR" style="width:20%" class="input_ReadOnly"  readonly value="EA01"> 
                    <input id="txtDOC_NM3_SHR" style="width:50%" class="input_ReadOnly"  readonly value="소요자금">                      
                </td>			
			</tr>
		</table>
		</td>
