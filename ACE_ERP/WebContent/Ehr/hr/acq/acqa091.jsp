    ...
    <script language="javascript" >
		...
		function fnc_SubmitApproval(kind) {
            ...
            for(var i= 1; i <= dsT_ACT_APPROVAL.CountRow; i++){
                ...
                Aeno_no = dsT_ACT_APPROVAL.NameValue(i,"ENO_NO");   	  //확인자
                
				APP_STATUS = dsT_ACT_APPROVAL.NameValue(i,"APP_STATUS");   //확인여부  &&  (app_yn == null)

				if(Aeno_no == gusrid &&  APP_STATUS == "미확인"){
	...
	<tr>
		<td class="paddingTop5" align="right" >
    		...
    		<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('imgConfirm','','../../images/button/btn_ConfirmOver.gif',1)">
    			<img src="../../images/button/btn_ConfirmOn.gif"    name="imgConfirm"  width="60" height="20" border="0" align="absmiddle" onClick="fnc_SubmitApproval('확인');">
    		</a>
		</td>
	</tr>
</table>
		...
		<td align="left">
			...
			<object	id="grdT_ACT_PLANLIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:0px;">
				...
				<param name="Format"				value="
					...
					<C> id='APP_STATUS'			width=90	name='확인상태'			align=center	value={decode(APP_STATUS_CD,'S','저장','G','확인중','R','반려','Y','확인완료','')}</C>
