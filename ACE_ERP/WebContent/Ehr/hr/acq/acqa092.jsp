	        ...
	        <td height="25" background="../../images/common/barBg.gif">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
	                    ...
	                    <td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">의견입력</td>
	                </tr>
	            </table>
	        </td>
	    </tr>
	...
	<table width="450" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="paddingTop8">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top" class="searchState">* 해당 의견를 입력하시고 '확인' 버튼을 누르셔야 처리가 완료됩니다.</span></td>
					</tr>
				</table>
			</td>
		</tr>
