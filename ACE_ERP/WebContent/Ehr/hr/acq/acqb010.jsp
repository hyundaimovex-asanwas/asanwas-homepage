...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			try {
	            dsT_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.acq.b.acqb010.cmd.ACQB010CMD&S_MODE=SHR&COMM_CD="+f.txtCOMM_CD_SHR.value;
	            dsT_CM_COMMON.Reset();
        ...
        function fnc_Save() {
			...
			if(fnc_SaveItemCheck()) {
				...
				tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.acq.b.acqb010.cmd.ACQB010CMD&S_MODE=SAV";
        ...
        function fnc_Delete() {
			...
			tr01T_CM_COMMON.KeyValue = "SVL(I:ds01T_CM_COMMON=ds01T_CM_COMMON)";
			tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.acq.b.acqb010.cmd.ACQB010CMD&S_MODE=DEL";
			tr01T_CM_COMMON.post();
        }
        ...
        function fnc_AddNew() {
            ...
            if (ds01T_CM_COMMON.CountRow < 1) {
//                ds01T_CM_COMMON.setDataHeader("CD_GBN:STRING, COMM_CD:STRING, COMM_NM:STRING, COMM_NM2:STRING, SORT_NO:DECIMAL, END_YMD:STRING, EXT_01:STRING, EXT_02:STRING, EXT_03:STRING, EXT_04:STRING, OTH_DEC:STRING");
...
//			document.getElementById('txtCOMM_CD').value = '';
//			document.getElementById('txtCOMM_NM').value = '';
//			document.getElementById('txtCOMM_NM2').value = '';
//			document.getElementById('medSORT_NO').value = '';
//			document.getElementById('txtEND_YMD').value = '';
//			document.getElementById('txtEXT_01').value = '';
//			document.getElementById('txtEXT_02').value = '';
//			document.getElementById('txtEXT_03').value = '';
//			document.getElementById('txtEXT_04').value = '';
//			document.getElementById('txtOTH_DEC').value = '';
    ...
    **************************************-->
	...
	<script for=grdT_CM_COMMON event=OnClick(Row,Colid)>
		...
		if(Row < 1) {
			...
			try {
				ds01T_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.acq.b.acqb010.cmd.ACQB010CMD&S_MODE=SHR_01&"+overId+"="+overValue;
				ds01T_CM_COMMON.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">지인코드관리</td>
                    <td align="right" class="navigator">HOME/지인관리/지인코드관리/<font color="#000000">지인코드관리</font></td>
                </tr>
            </table>
        </td>
    </tr>
