    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            var gubun  = document.getElementById("txtGUBUN").value;     //재직자인지 아닌지 '0' 재직자만
            

            //데이터셋 전송
            dsT_CM_PERSON.DataID = "/servlet/GauceChannelSVL?cmd=common.popup.empl.cmd.EMPLCMD&S_MODE=SHR&ENO_NO="+eno_no+"&DPT_CD="+dpt_cd+"&GUBUN="+gubun;
            dsT_CM_PERSON.reset();
        ...
        function fnc_OnLoadProcess() {
			...
			document.getElementById("txtDPT_NM_SHR").value  = retObj.dpt_nm;
            
            //신청자 정보 추가
            document.getElementById("lblJOB_NM_A2").innerText   = retObj.job_nm;
            document.getElementById("lblENO_NO_A2").innerText   = retObj.eno_no;
            document.getElementById("lblENO_NM_A2").innerText   = retObj.eno_nm;
            
            //신청자 정보 저장
			document.getElementById("txtGUBUN").value       = retObj.gbn;
			document.getElementById("txtENO_NO").value      = retObj.eno_no;
			document.getElementById("txtENO_NM").value      = retObj.eno_nm;
			document.getElementById("txtDPT_CD").value      = retObj.dpt_cd;
			document.getElementById("txtDPT_NM").value      = retObj.dpt_nm;
			document.getElementById("txtJOB_CD").value      = retObj.job_cd;
			document.getElementById("txtJOB_NM").value      = retObj.job_nm;
