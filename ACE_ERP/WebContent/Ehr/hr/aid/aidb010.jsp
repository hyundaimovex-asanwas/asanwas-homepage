...
<html>
<head>
	<title>불우이웃돕기 장부관리(aidb010)</title>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_AD_DONBOOK.GridToExcel("불우이웃돕기 장부관리", '', 225);
        }
        ...
        function fnc_Remove() {
	        if ( dsT_AD_DONBOOK.CountRow < 1 ) {
                ...
                var fin_nm;
                if(CD_TAG != 'U') {
                    alert("급여/상여에서 들어온 데이타는 삭제하실 수 없습니다.");
                    return;
                }
            	...
            	tmpMSG += "날짜 = "+dsT_AD_DONBOOK.nameValue(dsT_AD_DONBOOK.RowPosition, "DON_YMD")+"\n";
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid(form1.grdT_AD_DONBOOK,15,"true","false");      // Grid Style 적용
			fnc_DisableElementAll(elementList);
        }
    ...
    ***************************************************************************************-->
	...
	<!-----------------------------------------------------+
    | 1. 조회 및 저장용 DataSet								   |
    | 2. 이름은 ds_ + 주요 테이블명(T_AD_DONBOOK)			   |
    | 3. 사용되는 Table List(T_AD_DONBOOK) 				   |
    +------------------------------------------------------>
    ...
    | 2. 이름은 tr_ + 주요 테이블명(T_AD_DONBOOK)			   |
    | 3. 사용되는 Table List(T_AD_DONBOOK)				   |
    +------------------------------------------------------>
	...
	<script language=JavaScript for=dsT_AD_DONBOOK event=CanRowPosChange(row)>
        if(row > 0) {
    		if ( dsT_AD_DONBOOK.NameValue(row, "DON_YMD") == '' ) {
    			alert("[ " + grdT_AD_DONBOOK.GetHdrDispName('-3','DON_YMD')+" ] 를 입력하십시오.");
    			return false;
    		}else if( dsT_AD_DONBOOK.NameValue(row, "CD_GBN") == '' ){
    			alert("[ " + grdT_AD_DONBOOK.GetHdrDispName('-3','CD_GBN')+" ] 를 입력하십시오.");
    			return false;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">불우이웃돕기 장부관리</td>
					<td align="right" class="navigator">HOME/복리후생/불우이웃돕기/<font color="#000000">불우이웃돕기 장부관리</font></td>
				</tr>
			</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_AD_DONBOOK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
						...
						<param name="Format" value='
							...
							<C> id="DON_YMD"	width=90	name="날짜"	align=center	Edit=none</C>
							...
							<C> id="DON_RSN"	width=190	name="적요"	align=center	Edit=none</C>
							<C> id="DON_IN"		width=110	name="수입"	align=right		Edit=none	RightMargin=10</C>
							<C> id="DON_OUT"	width=110	name="지출"	align=right 	Edit=none	RightMargin=10</C>
							<C> id="DON_AMT"	width=110	name="잔액"	align=right		Edit=none	RightMargin=10</C>
						'>
					</object>
