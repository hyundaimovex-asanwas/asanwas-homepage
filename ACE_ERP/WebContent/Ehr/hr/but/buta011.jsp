            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">비용귀속정보 조회</td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" class="searchState">구분선택&nbsp;</td>
                                    <td class="padding2423">
									   <select id="txtSEARCH_GUBUN">
											<option value="COST">COST센터</option>
                        ...
                        <td>
                            ...
                            <object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:680px;height:430px;">
                                ...
                                <param name="Format"            value='
                                    <C> id=GUBUN              width=100  name=구분   align=left  show=false </C>
                                    <C> id=CCTR_CD            width=150   name=CCTR코드   align=left   </C>
                                    <C> id=CCTR_NM            width=300   name=CCTR명   align=left   </C>
