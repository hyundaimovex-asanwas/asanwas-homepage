...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    //          goclick('print');
          ...
          {
              alert("미리보기 버튼을 클릭하여, 출력물을 확인 후 인쇄할 수 있습니다.");
          }
        }
            ...
            <table width="800" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                <tr>
                    ...
                    <td class="padding2423" align="center" width="350">
                        <input type="checkbox" name="chkGUBUN_INS1" style="border:0" checked>철도이용-1
                    </td>
                    <td class="padding2423" align="center" width="350">
                        <input type="checkbox" name="chkGUBUN_INS2" style="border:0" onClick="fnc_GUBUN(this.checked)">철도이용-2
                    </td>
                </tr>
                <tr>
...
<table width="600" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="padding2423">
            ...
            4. <font color=blue><b>미리보기</b></font> 버튼을 클릭하여 출력물을 확인 후 인쇄가 가능합니다. <br>
        </td>
    </tr>
    ...
    <tr height="150">
        <td width="800">
            <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
              ...
              <param name="initdns"   VALUE="[LocationDNS]=aa">
              </object>
