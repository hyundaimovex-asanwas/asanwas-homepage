...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="buta100.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=STR_YMD%>[:END_YMD]=<%=END_YMD%>[:DPT_CD]=<%=DPT_CD%>[:BUT_CITY_CD]=<%=BUT_CITY_CD%>">
