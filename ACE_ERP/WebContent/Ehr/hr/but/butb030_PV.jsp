...
<tr>
    ...
    <td bgcolor="#EAEAEA" valign="middle" align="left">
        ...
        <tr>
            ...
            <td width="">
                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','/images/button/btn_ExcelformOver.gif',1)">
                    <img src="/images/button/btn_ExcelformOn.gif"  name="Image6" width="70" height="20" border="0" align="absmiddle"  onclick="goclick('Excel');"></a>
                <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','/images/button/btn_PrintOver.gif',1)">
                    <img src="/images/button/btn_PrintOn.gif"  name="Image6" width="60" height="20" border="0" align="absmiddle"  onclick="goclick('print_go');"></a>
...
<comment id="__NSID__">
              <object id="aaa" classid="clsid:2E68BEE5-A640-11D2-AEA4-00AA006E5B34" width="1024" height="700" codebase="<%=hnwcodebase%>">
              <param name="hnwsrc"    VALUE="butb030.hnw">
              <param name="initvalue" VALUE="[:str_ymd]=<%=str_ymd%>[:end_ymd]=<%=end_ymd%>[:dpt_cd]=<%=dpt_cd%>[:job_cd]=<%=job_cd%>[:ymd_val]=<%=ymd_val%>">
