...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_DI_DISPATCH.dataid = "/servlet/GauceChannelSVL?cmd=hr.but.b.butb050.cmd.BUTB050CMD&S_MODE=SHR&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&CD_GBN="+cd_gbn;
        ...
        function fnc_Print() {
           if(!fnc_SearchItemCheck()) return;
	        ...
	        var url = "butb050_PV.jsp?STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&CD_GBN="+cd_gbn;
   			window.open(url,"butb050_PV","width=1050,height=700,left=0,top=0,scrollbars=yes,status=yes,resizable=yes");
	        return;
        }
    ...
    ***************************************************************************************-->
    ...
    | 3. 사용되는 Table List(dsT_DI_DISPATCH) 			   |
    +------------------------------------------------------>
    ...
    ***************************************************************************************-->
	...
	<Script For=dsT_DI_DISPATCH Event="OnLoadCompleted(iCount)">
		if (iCount == 0)    {
            ...
            if(dsT_DI_DISPATCH.NameValue(1,"CD_GBN") == "A4"){
                document.form1.grdT_DI_DISPATCH.ColumnProp('COMM_NM', 'Name') = "소속";
            }else if(dsT_DI_DISPATCH.NameValue(1,"CD_GBN") == "A2"){
                document.form1.grdT_DI_DISPATCH.ColumnProp('COMM_NM', 'Name') = "직위";
            }else {
                document.form1.grdT_DI_DISPATCH.ColumnProp('COMM_NM', 'Name') = "성명";
            }
        }
    </Script>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">해외출장비신청내역</td>
					<td align="right" class="navigator">HOME/근태관리/해외출장/<font color="#000000">해외출장비신청내역</font></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
					<comment id="__NSID__">
					<object id="grdT_DI_DISPATCH" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:380px;">
						<param name="DataID" value="dsT_DI_DISPATCH">
						<Param Name="ViewSummary"   value="1" >
						<param name="Format" value='
							<C> id="{CUROW}"	width=39	name="NO"		align=center	value={String(Currow)}					</C>
                            <C> id="COMM_NM"	width=200	name="소속"		align=left     SumText="합 계" suppress=1</C>
                            <C> id="AMOUNT"		width=150	name="금액"		align=right     sumtext=@sum RightMargin="20"						</C>
                            <C> id="APP_CNT"    width=150	name="출장건수" align=right     sumtext=@sum RightMargin="20"						</C>
