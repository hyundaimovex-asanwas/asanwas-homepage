<!--
***********************************************************************
* @source      : butb050_PV.jsp
* @description : 해외출장비지급현황표
***********************************************************************
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="butb050.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=STR_YMD%>[:END_YMD]=<%=END_YMD%>[:CD_GBN]=<%=CD_GBN%>">
