...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //관리자는 모든 조회가 가능
			dsT_DI_DISPATCH.dataid = "/servlet/GauceChannelSVL?cmd=hr.but.c.butc010.cmd.BUTC010CMD&S_MODE=SHR&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&APP_YN="+app_yn+"&APP_STATUS="+app_status+"&PENO_NO="+eno_no+"&ENO_NO="+our_man;
			dsT_DI_DISPATCH.reset();

			dsT_DI_DISPATCH.RowPosition = curRowPosition;
        ...
        function fnc_Delete() {
			...
			if(confirm("[품의번호:"+dsT_DI_DISPATCH.NameValue(dsT_DI_DISPATCH.RowPosition,'ORD_NO')+"]의 정보를 삭제하시겠습니까?")){
				...
				trT_DI_DISPATCH.action = "/servlet/GauceChannelSVL?cmd=hr.but.c.butc010.cmd.BUTC010CMD&S_MODE=DEL";
    ...
    ***************************************************************************************-->
	...
	<script language=JavaScript for=grdT_DI_DISPATCH event="OnDblClick(row,colid)">
		...
		curRowPosition = dsT_DI_DISPATCH.RowPosition;
		if(row < 1) {
			return;
		} else {
            ...
            var url = "/hr/but/butc020.jsp?ORD_NO=" + dsT_DI_DISPATCH.NameValue(dsT_DI_DISPATCH.RowPosition,"ORD_NO") + "&ENO_NO=" + dsT_DI_DISPATCH.NameValue(dsT_DI_DISPATCH.RowPosition,"PENO_NO") + "&APP_STATUS=" + dsT_DI_DISPATCH.NameValue(dsT_DI_DISPATCH.RowPosition,"APP_STATUS") + "&APP_CMT=" + dsT_DI_DISPATCH.NameValue(dsT_DI_DISPATCH.RowPosition,"APP_CMT");
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견품의결재</td>
					<td align="right" class="navigator">HOME/근태관리/파견관리/<font color="#000000">파견품의결재</font></td>
				</tr>
			</table>
			</td>
		</tr>
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="searchState" align="right">파견기간&nbsp;</td>
					<td>
					...
					<td>
						<select id="cmbAPP_STATUS_SHR" style="width:100" onChange="fnc_SearchList();">
                            ...
                            <option value="7" >전표처리중</option>
                            <option value="8" >전표처리완료</option>
						</select>
					</td>
				</tr>
			...
			<td class="paddingTop5">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr height="20">
						...
						<td width="320">※결재를 원하시면 해당 파견품의서를 더블클릭 하세요.</td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_DI_DISPATCH" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:320px;">
						...
						<param name="Format" value='
                            ...
                            <C> id="PENO_NO"	width=95	name="상신자"		align=center    value={PJOB_NM&" "&PENO_NM}	</C>
							<C> id="ORD_DATE"	width=105	name="상신일-시간"	align=center     </C>
							<C> id="APP_ENO_NO"	width=95	name="現결재완료자" align=center    value={APP_JOB_NM&" "&APP_ENO_NM}</C>
                            <C> id="APP_DATE"	width=105	name="결재일/시간"	align=center     </C>
							<C> id="APP_CMT"	width=120	name="결재의견"	    align=left	     </C>
							<C> id="DIS_FR_TO_YMD"	width=110	name="파견기간" align=left	    value={DIS_FR_YMD&"~"&DIS_TO_YMD} </C>
							<C> id="MM"	width=40	name="진행월" align=center	 </C>
						'>
					</object>
