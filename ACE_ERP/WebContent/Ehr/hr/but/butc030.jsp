...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_Print() {
        ...
        var url = "butc030_PV.jsp?str_ymd="+str_ymd+"&end_ymd="+end_ymd+"&dpt_cd="+dpt_cd+"&job_cd="+job_cd+"&ymd_val="+ymd_val;
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견품의신청현황</td>
          <td align="right" class="navigator">HOME/근태관리/파견관리/<font color="#000000">파견품의신청현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
