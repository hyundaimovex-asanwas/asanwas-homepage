    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_DI_DISPATCH.dataid = "/servlet/GauceChannelSVL?cmd=hr.but.c.butc050.cmd.BUTC050CMD&S_MODE=SHR&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&CD_GBN="+cd_gbn;
        ...
        function fnc_Print() {
           if(!fnc_SearchItemCheck()) return;
	        ...
	        var url = "butc050_PV.jsp?STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&CD_GBN="+cd_gbn;
   			window.open(url,"butc050_PV","width=1050,height=700,left=0,top=0,scrollbars=yes,status=yes,resizable=yes");
	        return;
        }
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견비신청내역</td>
					<td align="right" class="navigator">HOME/근태관리/파견관리/<font color="#000000">파견비신청내역</font></td>
				</tr>
			</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_DI_DISPATCH" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:380px;">
						...
						<param name="Format" value='
                            ...
                            <C> id="APP_CNT"    width=150	name="파견건수" align=right     sumtext=@sum RightMargin="20"						</C>
