...
%>
        ...
        function fnc_Delete() {
            ...
            if (confirm("피후견인 [" + dsT_CD_MENTO.NameValue(dsT_CD_MENTO.RowPosition,"ENO_NO") + "][" + dsT_CD_MENTO.NameValue(dsT_CD_MENTO.RowPosition,"ENO_NM") + "], 후견인 [" + dsT_CD_MENTO.NameValue(dsT_CD_MENTO.RowPosition,"MENO_NO") + "][" + dsT_CD_MENTO.NameValue(dsT_CD_MENTO.RowPosition,"MENO_NM") + "] 자료를 제거하시겠습니까?") == false) return;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_CD_MENTO.GridToExcel("후견인등록", '', 225);
            ...
            for ( i = 1; i <= dsT_CD_MENTO.CountRow; i++ ) {
                if ( dsT_CD_MENTO.RowStatus(i) == 1 ||
                    ...
                    if( dsT_CD_MENTO.NameValue(i, "ENO_NO") == '' ) {
                        alert("멘티(Mentee)사번은 필수 입력사항입니다.");
                    ...
                    if (dsT_CD_MENTO.NameValue(i, "ENO_NO") != "" &&
                        ...
                        alert("멘티(Mentee)사번에 입력하신 값은 존재하지 않는 사번입니다. 확인바랍니다.");
                        dsT_CD_MENTO.RowPosition = i;
                        document.getElementById("txtENO_NO").focus();
                        return;
                    }
                    ...
                    if (dsT_CD_MENTO.NameValue(i, "MENO_NO") != "" &&
                        ...
                        alert("후견인사번에 입력하신 값은 존재하지 않는 사번입니다. 확인바랍니다.");
                        dsT_CD_MENTO.RowPosition = i;
                        document.getElementById("txtMENO_NO").focus();
                        return;
                    }
                    ...
                    if (dsT_CD_MENTO.NameValue(i, "ENO_NO") == dsT_CD_MENTO.NameValue(i, "MENO_NO")) {
                        alert("멘티(Mentee)사번과 후견인사번이 동일합니다. 확인바랍니다.");
                        dsT_CD_MENTO.RowPosition = i;
                        document.getElementById("txtENO_NO").focus();
                        return false;
                    }
                    ...
                    // 후견시작일자 CHECK
                    if (!fnc_CheckDate2(dsT_CD_MENTO.NameValue(i, "STR_YMD"), "후견시작일자") && dsT_CD_MENTO.NameValue(i, "STR_YMD") != "") {
                        dsT_CD_MENTO.RowPosition = i;
                        document.getElementById("txtSTR_YMD").focus();
                        return false;
                    }
                    ...
                    // 후견종료일자 CHECK
                    if (!fnc_CheckDate2(dsT_CD_MENTO.NameValue(i, "END_YMD"), "후견종료일자") && dsT_CD_MENTO.NameValue(i, "END_YMD") != "") {
                        dsT_CD_MENTO.RowPosition = i;
                        document.getElementById("txtEND_YMD").focus();
                        return false;
                    }
                    ...
                    if(dsT_CD_MENTO.NameValue(i, "STR_YMD") != '' && dsT_CD_MENTO.NameValue(i, "END_YMD") != '') {
                        if(removeChar(dsT_CD_MENTO.NameValue(i, "STR_YMD"),'-') > removeChar(dsT_CD_MENTO.NameValue(i, "END_YMD"),'-')) {
                            alert("후견시작일자는 반드시 후견종료일자보다 작아야합니다.");
                            dsT_CD_MENTO.RowPosition = i;
                            document.getElementById("txtSTR_YMD").focus();
                            return false;
                        }
    ...
    **************************************-->
    ...
    <Script For=dsT_CD_MENTO Event="OnDataError()">
        ...
        if (this.ErrorCode == 50018) {
            alert("해당 필수입력항목[멘티(Mentee)] 입력 후 다음 작업이 가능합니다.");
        }
        /*
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">멘토(Mentor)등록</td>
                    <td align="right" class="navigator">HOME/교육관리/CDP/멘토링관리/<font color="#000000">멘토(Mentor)등록</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td align="right" class="searchState">진행구분&nbsp;</td>
                                <td class="padding2423">
                                	<select id="cmbEND_GBN_SHR" style="WIDTH:100" onChange="fnc_SearchList();">
                                		<option value="">전체</option>
                                		<option value="1">기간미종료자</option>
                                		<option value="2">기간종료자</option>
                                	</select>
                                </td>
                            </tr>
        ...
        <td class="paddingTop8">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423">
                        <input id="txtSTR_YMD" name="txtSTR_YMD" style="ime-mode:disabled" size="10" maxlength="10" onChange="fnc_CheckDate(this, '후견시작일자');" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                        ...
                        ~
                        <input id="txtEND_YMD" name="txtEND_YMD" style="ime-mode:disabled" size="10" maxlength="10" onChange="fnc_CheckDate(this, '후견종료일자');" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                        ...
                        <object    id="grdT_CD_MENTO" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:250px;">
                            ...
                            <param name="Format"             value="
                                ...
                                <G> name='멘토(Mentor)' HeadBgColor='#F7DCBB'
                                    ...
                                    <C> id='MENO_NO'         width=70    name='사번'       align=center Gte_ColumnType='Number:0:False'</C>
