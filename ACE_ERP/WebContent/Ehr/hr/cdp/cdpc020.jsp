<!--
    ************************************************************************************
    * @Source         : cdpc020.jsp                                                    *
    * @Description    : 멘토(Mentor)양성계획 PAGE                                            *
    * @Developer Desc :                                                                *
    ************************************************************************************
...
<html>
    ...
    <head>
    <title>멘토(Mentor)양성계획(cdpc020)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CD_MENTO.DataId = "/servlet/GauceChannelSVL?cmd=hr.cdp.c.cdpc020.cmd.CDPC020CMD"
                                + "&S_MODE=SHR"
                                + "&MNT_GBN="+MNT_GBN
                                + "&ENO_NO="+ENO_NO
                                + "&DPT_CD="+DPT_CD
...
%>
        ...
        window.showModalDialog("/hr/cdp/cdpc021.jsp", self, "dialogHeight:650px; dialogWidth:870px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
<%
    }
%>
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">멘토링 계획</td>
                    <td align="right" class="navigator">HOME/교육관리/CDP/멘토링관리/<font color="#000000">멘토링 계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td align="right" class="searchState">멘토링기간&nbsp;</td>
                                <td class="padding2423">
                    ...
                    <td>
                        ...
                        <object    id="grdT_CD_MENTO" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:320px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <C> id='OBJ_TXT'             width=200   name='목적'       align=left   </C>
                            ">
                        </object>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="paddingTop8">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top" class="searchState">* 해당 항목을 더블클릭 하시면 멘토링 계획을 등록하거나 수정하실 수 있습니다.</td>
                </tr>
            </table>
        </td>
    </tr>
