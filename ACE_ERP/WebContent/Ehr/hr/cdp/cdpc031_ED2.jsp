...
<%
    ...
    String CONS_YMD = request.getParameter("CONS_YMD");

    /** 외부 XML에서 SQL을 읽어 온다 **/
    String sql = XmlSqlUtils.getSQL("cdp", "CDPC031_SHR_02");
    ...
    Object[] bind = new Object[] {
        ENO_NO, SEQ_NO, CONS_YMD.replaceAll("-", "")
    };
...
//    System.out.println("voList.size()="+voList.size());
    ...
    if (voList.size() > 0)
    {
        for ( i=0; i<voList.size(); i++ )
        {
            ...
            hnwExtQuery.AddData(vo.getString("PLACE_TXT"));
