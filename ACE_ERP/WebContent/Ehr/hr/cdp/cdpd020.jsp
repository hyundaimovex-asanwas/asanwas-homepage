    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CD_OJT.DataId = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd020.cmd.CDPD020CMD"
                                + "&S_MODE=SHR"
                                + "&MNT_GBN="+MNT_GBN
                                + "&ENO_NO="+ENO_NO
                                + "&DPT_CD="+DPT_CD
        ...
        function fnc_Save() {
            ...
            if(fnc_SaveItemCheck()) {
                ...
                trT_CD_OJT.action = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd020.cmd.CDPD020CMD&S_MODE=SAV";
                trT_CD_OJT.post();
...
%>
  ...
  if(dsT_CD_OJT.NameValue(row, "TRA_ENO_NO") == '<%=box.get("SESSION_ENONO")%>' || dsT_CD_OJT.NameValue(row, "ENO_NO") == '<%=box.get("SESSION_ENONO")%>') {
  		eno_no  = dsT_CD_OJT.NameValue(row, "ENO_NO");
        eno_nm  = dsT_CD_OJT.NameValue(row, "ENO_NM");

        window.showModalDialog("/hr/cdp/cdpd021.jsp", self, "dialogHeight:650px; dialogWidth:870px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
  }
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">OJT 계획</td>
                    <td align="right" class="navigator">HOME/교육관리/CDP/OJT관리/<font color="#000000">OJT 계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_CD_OJT" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:250px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <C> id='WRITE_YMD'            width=70    name='계획작성일'       align=center </C>
                            ">
                        </object>
