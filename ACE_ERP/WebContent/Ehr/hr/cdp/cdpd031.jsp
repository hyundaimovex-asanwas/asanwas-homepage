...
<html>
    ...
    <head>
    <title>실무교육(O.J.T)일지등록(cdpd031)</title>
    ...
    *****************************-->
    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CD_OJT.DataId = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd031.cmd.CDPD031CMD&S_MODE=SHR&ENO_NO="+ENO_NO+"&TRA_WEEK="+TRA_WEEK+"&TRA_YMD="+TRA_YMD;
            dsT_CD_OJT.Reset();
        ...
        function fnc_Save() {
            ...
            if(fnc_SaveItemCheck()) {
                ...
                trT_CD_OJTREPORT.action = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd031.cmd.CDPD031CMD&S_MODE=SAV&ENO_NO="+opener.eno_no+"&TRA_WEEK="+opener.tra_week+"&TRA_YMD="+TRA_YMD;
        ...
        function fnc_Print() {
            ...
            var url = "cdpd031_PV.jsp?ENO_NO="+ENO_NO+"&TRA_WEEK="+TRA_WEEK+"&TRA_YMD="+TRA_YMD;
    ...
    <Script For=dsT_CD_OJT Event="OnLoadCompleted(iCount)">
        ...
        if (iCount > 0) {
            ...
            if (opener.gbn == "2") {
                ...
                dsT_CD_OJTREPORT.DataId = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd031.cmd.CDPD031CMD&S_MODE=SHR_02&ENO_NO="+opener.eno_no+"&TRA_WEEK="+opener.tra_week+"&TRA_YMD="+opener.tra_ymd;
                ...
                dsT_CD_OJTREPORT.NameValue(1, "TRA_YMD") = getToday();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">실무교육(O.J.T) 일지등록</td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="paddingTop5">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td align="center" class="creamBold">교육일자</td>
                    <td class="padding2423" >
                ...
                <tr>
                    <td align="center" class="creamBold">지도사원</td>
                    <td class="padding2423" colspan="3">
                ...
                <tr>
                    ...
                    <td class="padding2423" colspan="3">
                        <textarea id="txtTRA_CONTENT"  name="txtTRA_CONTENT" cols="112" rows="5" maxlength="4000" ></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="center" class="creamBold">비고</td>
                    <td class="padding2423" colspan="3">
                        <textarea id="txtTRA_REMARK"  name="txtTRA_REMARK" cols="112" rows="5" maxlength="2000" ></textarea>
                    </td>
                </tr>
<!--
                <tr>
