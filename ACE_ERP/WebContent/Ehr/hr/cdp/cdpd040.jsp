    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CD_OJT.DataId = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd040.cmd.CDPD040CMD"
                                + "&S_MODE=SHR"
                                + "&MNT_GBN="+MNT_GBN
                                + "&ENO_NO="+ENO_NO
                                + "&DPT_CD="+DPT_CD
        ...
        function fnc_Save() {
            ...
            if(fnc_SaveItemCheck()) {
                ...
                trT_CD_OJT.action = "/servlet/GauceChannelSVL?cmd=hr.cdp.d.cdpd040.cmd.CDPD040CMD&S_MODE=SAV&ENO_NO="+ENO_NO;
                trT_CD_OJT.post();
...
%>
    ...
    **************************************-->
    ...
    <Script For=grdT_CD_OJT Event="OnDblClick(row, col)">
        ...
        window.showModalDialog("/hr/cdp/cdpd041.jsp", self, "dialogHeight:850px; dialogWidth:860px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">OJT 개별 지도 평가서</td>
                    <td align="right" class="navigator">HOME/교육관리/CDP/OJT관리/<font color="#000000">OJT 개별 지도 평가서</font></td>
                </tr>
            </table>
        </td>
    </tr>
