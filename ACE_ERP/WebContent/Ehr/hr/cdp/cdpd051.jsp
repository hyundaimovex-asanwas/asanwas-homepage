...
<html>
    ...
    <head>
    <title>O.J.T. 경영지원본부 평가서(cdpd051)</title>
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">O.J.T. 경영지원본부 평가서</td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_CD_OJTEVAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"                  value="
                                <C> id='{currow}'       width=110    name='구분'      sumtext='합계'    align=center  edit=none suppress=1</C>
                    ...
                    <td class="padding2423">
						...
						<object	id="grdT_DI_APPROVAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:340px;height:90px;">
							...
							<param name="Format"				value="
								...
								<C> id='APP_YN'	width=70	name='결재'	align=center	Value={DECODE(APP_YN,'Y','결재','N','부결','미결')} </C>
							">
						</object>
						</comment><script> __ShowEmbedObject(__NSID__); </script>
					</td>
