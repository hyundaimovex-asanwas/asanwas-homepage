    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_CM_UPRQST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code020.cmd.CODE020CMD&S_MODE=SHR_02&ENO_NO="+eno_no+"&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&STS_GBN1="+sts_gbn1+"&STS_GBN3="+sts_gbn3;
    		dsT_CM_UPRQST.reset();
        ...
        */
        ...
        function fnc_Save() {
			...
			trT_CM_UPRQST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code020.cmd.CODE020CMD&S_MODE=SAV";
			trT_CM_UPRQST.post();
        ...
        function fnc_Delete() {
			...
			if(confirm("[일련번호:"+dsT_CM_UPRQST.NameValue(dsT_CM_UPRQST.RowPosition,'SEQ_NO')+"]의 정보를 삭제하시겠습니까?")){
				...
				trT_CM_UPRQST.KeyValue = "tr01(I:dsT_CM_UPRQST=dsT_CM_UPRQST)";
				trT_CM_UPRQST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code020.cmd.CODE020CMD&S_MODE=DEL";
				trT_CM_UPRQST.post();
        ...
        function fnc_AddNew() {
			...
			dsT_CM_UPRQST_SEQ.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code020.cmd.CODE020CMD&S_MODE=SHR_01";
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_CM_UPRQST,15,"false","false");      // Grid Style 적용
    ...
    **************************************-->
    ...
    <script language="javascript"  for=dsT_CM_UPRQST event=OnRowPosChanged(row)>
        if(row > 0) {
            ...
            // 관리자인 경우
            if(oSTS_GBN == "1" && dsT_CM_UPRQST.RowStatus(row) != "1" 
            		&& (gusrid == "6060002" || gusrid == "6180001" || gusrid == "6050006" || gusrid == "2030007" || gusrid == "2070020" || gusrid == "2080003" || gusrid == "2180001")) {
		...
		<td class="paddingTop8">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td align="center" class="blueBold">업무구분</td>
                    ...
                    <td align="center" class="blueBold">처리단계</td>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
		...
		<td>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grdT_CM_UPRQST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:350px;">
    ...
    <tr>
       <td>
          <br><b>&nbsp;&nbsp;<u>※ 가족/자격사항 수정을 요청하시는 분은 담당자에게 관련서류 사본을 스캔하여 보내주시기 바랍니다.(경영지원팀 임보이 사원[☎3902]</u></b>
       </td>
    </tr>
</table>
<!-- 내용 조회 그리드 데이블 끝-->
