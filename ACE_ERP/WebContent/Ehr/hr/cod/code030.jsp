    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            if(PIS_YYMM.substring(0,4) < 2016){

            	alert("2016년 이후 자료만 조회 가능합니다.");
        ...
        function fnc_Print() {
            ...
            if(document.getElementById('txtENO_NO').value == ""){
                alert("해당 월은 아직 인쇄하실 수 없습니다!");
                //pis_yymm.focus();
                return false;
            }             
            
            
            dsT_RP_REPORT.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
												            		+"&S_MODE=SHR_PRINT"
            ...
            dsT_RP_REPORT2.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
													        		+"&S_MODE=SHR_PRINT2"
													                +"&PIS_YY="+PIS_YYMM.substring(0,4)
													                +"&PIS_MM="+PIS_YYMM.substring(5,7)
													        		+"&ENO_NO="+ENO_NO
            ...
            dsT_RP_REPORT3.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
													        		+"&S_MODE=SHR_PRINT3"
													                +"&PIS_YY="+PIS_YYMM.substring(0,4)
													                +"&PIS_MM="+PIS_YYMM.substring(5,7)
													        		+"&ENO_NO="+ENO_NO
        ...
        function fnc_OnLoadProcess() {
		    ...
		    //관리자 권한일 경우
		    if(gusrid == "6060002" || gusrid == "6180001" || gusrid == "2030007" || gusrid == "2070020" ||  gusrid == "2180001" ||  gusrid == "6180022" ) {
		...
		function fnc_ChangeGrid(kind) {
			...
			if(kind == '1'){
				...
				document.getElementById("divCODE030_01").style.display = "";
				document.getElementById("divCODE030_03").style.display = "none";
				document.getElementById("divCODE030_04").style.display = "none";

            }else if(kind == '2'){

					document.getElementById("divCODE030_01").style.display = "none";
					document.getElementById("divCODE030_03").style.display = "";
					document.getElementById("divCODE030_04").style.display = "none";
					...
					document.getElementById("divCODE030_01").style.display = "none";
					document.getElementById("divCODE030_03").style.display = "none";
					document.getElementById("divCODE030_04").style.display = "";
		...
		function fnc_TabOnClick(kind) {
			...
			//개인정보 조회
   			dsT_CP_PAYMASTER_01.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
				                                       + "&S_MODE=SHR"
				                                       + "&PIS_YY="+pis_yymm.substring(0,4)
				                                       + "&PIS_MM="+pis_yymm.substring(5,7)
				                                       + "&ENO_NO="+eno_no
			...
			//그리드 조회
			dsT_CP_PAYMASTER.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
					                                    + "&S_MODE="+shr
					                                    + "&PIS_YY="+pis_yymm.substring(0,4)
					                                    + "&PIS_MM="+pis_yymm.substring(5,7)
					                                    + "&ENO_NO="+eno_no
		...
		function fnc_code031Popup(kind){
			...
			window.showModalDialog("../../../Ehr/hr/cod/code031.jsp", dsT_CP_PAYMASTER, "dialogWidth:510px; dialogHeight:400px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
    ...
    **************************************-->
    ...
    <Script For=dsT_CP_PAYMASTER_01 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
			...
			dsT_CP_PAYMASTER_02.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code030.cmd.CODE030CMD"
				                                       + "&S_MODE=SHR_05"
				                                       + "&PIS_YY="+PIS_YY
				                                       + "&PIS_MM="+PIS_MM
				                                       + "&ENO_NO="+ENO_NO
...
<!-- 내용 조회 그리드 테이블 시작-->
<div id="divCODE030_01" style="position:absolute; left:20; top:280; width:1000; height:500; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="paddingTop5">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    <td align="center" class="blueBold">본사직책수당</td>
                    <td align="center" class="blueBold">기타지불</td>
                    <td align="center" class="blueBold">성과급</td>
                    <td align="center" class="blueBold"></td>
                    <td align="center" class="blueBold"></td>
                </tr>
                <tr height="28">
                    <td class="padding2423">
                        <comment id="__NSID__"><object id="medP06_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%">
                            <param name=Alignment               value=2>
                            <param name=Border                  value=false>
                            <param name=ClipMode                value=true>
                            <param name=ReadOnly                value=true>
                    ...
                    <td class="padding2423">
                     ...
                     <td class="padding2423">
                        ...
                        <comment id="__NSID__"><object id="medGOOD_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%">
                            <param name=Alignment               value=2>
                            <param name=Border                  value=false>
                            <param name=ClipMode                value=true>
                            <param name=ReadOnly                value=true>
...
<div id="divCODE030_03" style="position:absolute; left:20; top:280; width:1000; height:240; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="paddingTop5">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
...
<div id="divCODE030_04" style="position:absolute; left:20; top:280; width:1000; height:170; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="paddingTop5">
			<table border="0" cellspacing="0" cellpadding="0">
...
<div id="divCODE030_03" style="position:absolute; left:20; top:550; width:1000; height:170; z-index:1;" >
<table width="1000"  border="0" cellspacing="0" cellpadding="0">
     <tr>
         <td width="120">
             <!-- 탭오버 -->
...
<A>id=Area1 ,left=0,top=0 ,right=2000 ,bottom=132
	<R>id='급여지급현황.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=132 ,MasterDataID='dsT_RP_REPORT'
		<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=1929 ,face='Tahoma' ,size=10 ,penwidth=1
			...
			<T>id='본사직책수당' ,left=1066 ,top=852 ,right=1323 ,bottom=915 ,face='Tahoma' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{decode(P06_AMT,0,,P06_AMT)}', left=1074, top=937, right=1310, bottom=995, align='right', face='Tahoma', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>

			<T>id='성과급' ,left=1667 ,top=855 ,right=1924 ,bottom=908 ,face='Tahoma' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{decode(GOOD_AMT,0,,GOOD_AMT)}', left=1672, top=939, right=1908, bottom=997, align='right', face='Tahoma', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
		

			<T>id='기타지불' ,left=1365 ,top=857 ,right=1622 ,bottom=910 ,face='Tahoma' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{decode(OTH_AMT,0,,OTH_AMT)}', left=1376, top=937, right=1611, bottom=995, align='right', face='Tahoma', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
...
<object id="bndT_CP_PAYMASTER" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        ...
        <C> Col=P06_AMT      Ctrl=medP06_AMT       Param=text  </C>        
        ...
        <C> Col=GOOD_AMT     Ctrl=medGOOD_AMT      Param=text  </C>        
