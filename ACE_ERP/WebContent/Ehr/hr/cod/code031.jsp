...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			if(kind == "1"){
				...
				dsT_CP_CHANGE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code031.cmd.CODE031CMD&S_MODE=SHR_01&PIS_YY="+PIS_YY+"&PIS_MM="+PIS_MM+"&ENO_NO="+ENO_NO+"&SAL_GBN="+SAL_GBN+"&SEQ="+SEQ;
    			dsT_CP_CHANGE.reset();

			}else{
				
				dsT_CP_CHANGE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.cod.e.code031.cmd.CODE031CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&PIS_MM="+PIS_MM+"&ENO_NO="+ENO_NO+"&SAL_GBN="+SAL_GBN+"&SEQ="+SEQ;
    			dsT_CP_CHANGE.reset();
