...
***********************************************************************
* @source      : code030.jsp
* @description : 신_급상여지급액조회(비주간 현장용) PAGE
***********************************************************************
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_OnLoadProcess() {
		    ...
		    //관리자 권한일 경우
		    if(gusrid == "6060002" ||  gusrid == "2030007" || gusrid == "2070020" || gusrid == "2140002") {
...
<!-- 내용 조회 그리드 테이블 시작-->
<div id="divCODE030_01" style="position:absolute; left:20; top:270; width:1000; height:500; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
...
<div id="divCODE030_03" style="position:absolute; left:20; top:270; width:1000; height:240; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="paddingTop5">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
...
<div id="divCODE030_04" style="position:absolute; left:20; top:270; width:1000; height:170; z-index:1;" >
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="paddingTop5">
			<table border="0" cellspacing="0" cellpadding="0">
...
<A>id=Area2 ,left=0,top=0 ,right=2000 ,bottom=141
	<R>id='누계현황.sbt' ,left=0 ,top=8 ,right=2000 ,bottom=140 ,DetailDataID='dsT_RP_REPORT3' 
		<B>id=Footer ,left=0 ,top=2365 ,right=2000 ,bottom=2870 ,face='Arial' ,size=10 ,penwidth=1
			<L> left=8 ,top=400 ,right=1976 ,bottom=400 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<I>id='../../images/common/icon.jpg' ,left=1601 ,top=407 ,right=1982 ,bottom=503</I>
		</B>
	</R>
</A>
