...
<jsp:include page="/Common/sys/body_s21.jsp"  flush="true"/>
	...
	<table width="1000" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <td>
          <br>&nbsp;&nbsp;현대아산(주)(대표이사 이영하)(이하“회사”라 함)와 근로자 <input id="txtENO_NM" name="txtENO_NM" size="6"  style="ime-mode:disabled">(이하“근로자”라 함)는 회사의 연봉제도에 동의하며 자유의사에 따라 다음과 같이 연봉계약을 체결한다. 
          ...
          <br>&nbsp;&nbsp;&nbsp;&nbsp;2. 시간외수당은 월 52시간의 연장·야간근로에 대한 급여이다.
...
<OBJECT id=gcrp_print9  classid=clsid:CC26E2A9-760B-4EA6-8DDF-DB423FD24089 VIEWASTEXT>
	...
	<T>id='3. 휴일근로수당은 월 16시간의 휴일근로에 대한 급여이다. ' ,left=95 ,top=995 ,right=1879 ,bottom=1032 ,align='left' ,face='문체부 바탕체' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='현대아산(주) (대표이사 이영하) (이하 “회사”라 함)와 근로자 ' ,left=69 ,top=278 ,right=1138 ,bottom=315 ,align='left' ,face='문체부 바탕체' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='SIGN_YMD', left=1392, top=2635, right=1790, bottom=2672, align='left' , face='바탕', size=11, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
</B>
