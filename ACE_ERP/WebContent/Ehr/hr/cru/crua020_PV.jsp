...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="crua020.hnw">
              <param name="initvalue" VALUE="[:REGYY]=<%=REGYY%>[:REGCH]=<%=REGCH%>[:REGSTR]=<%=REGSTR%>[:REGEND]=<%=REGEND%>[:SCHOOL]=<%=SCHOOL%>[:SPLITFLAG]=<%=SPLITFLAG%>[:PASSTAG]=<%=PASSTAG%>">
