...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			if(ActiveIndex == 4){//수신조회
				...
				in_out = document.getElementById('cmbIN_OUT_SHR').value;
                eno_nm = document.getElementById('txtENO_NM_SHR1').value;

				dsT_DO_DOCUMENT_REC.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca020.cmd.DOCA020CMD&S_MODE=SHR_01&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&DPT_CD="+dpt_cd+"&OK_YN="+ok_yn+"&IN_OUT="+in_out+"&ENO_NM="+eno_nm;
				...
				in_out = document.getElementById('cmbIN_OUT_SHR2').value;
                eno_nm = document.getElementById('txtENO_NM_SHR').value;

				dsT_DO_DOCUMENT_DIS.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca020.cmd.DOCA020CMD&S_MODE=SHR_02&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&DPT_CD="+dpt_cd+"&OK_YN="+ok_yn+"&IN_OUT="+in_out+"&ENO_NM="+eno_nm;
        ...
        function fnc_SearchItem() {
			//저장한 공문의 문서번호 조회를 위해 DOCA010를 사용
			if(ActiveIndex == 2){
				dsT_DO_DOCUMENT_ORDNO.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca010.cmd.DOCA010CMD&S_MODE=SHR_03&DOCU_GBN=O&GBN_CD=A";
			} else if(ActiveIndex == 1){
				dsT_DO_DOCUMENT_ORDNO.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca010.cmd.DOCA010CMD&S_MODE=SHR_03&DOCU_GBN=O&GBN_CD=S";
			}
        ...
        function fnc_Save() {//
			...
			if(ActiveIndex == 2){//수신
				...
				var radio = document.form1.rdoIN_OUT;

                dsT_DO_DOCUMENT.ClearData();
				dsT_DO_DOCUMENT.AddRow();
				dsT_DO_DOCUMENT.NameValue(1,'ORD_NO') = document.getElementById("txtORD_NO").value;
				...
				dsT_DO_DOCUMENT.NameValue(1,'IN_OUT') = fnc_RadioValue(radio);

//				if(!fnc_SaveItemCheck1()) return;
				trT_DO_DOCUMENT.KeyValue = "SVL(I:dsT_DO_DOCUMENT=dsT_DO_DOCUMENT)";
				trT_DO_DOCUMENT.action = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca020.cmd.DOCA020CMD&S_MODE=SAV_01";
				trT_DO_DOCUMENT.post();

			}else if(ActiveIndex == 1){//발송

				var radio = document.form1.rdoIN_OUT2;
...
//				if(!fnc_SaveItemCheck2()) return;

				trT_DO_DOCUMENT.KeyValue = "SVL(I:dsT_DO_DOCUMENT=dsT_DO_DOCUMENT)";
				trT_DO_DOCUMENT.action = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca020.cmd.DOCA020CMD&S_MODE=SAV_02";
				trT_DO_DOCUMENT.post();
        ...
        function fnc_Delete() {
			...
			if(ActiveIndex == 4){//수신조회
				...
				if(confirm("문서번호 ["+dsT_DO_DOCUMENT_REC.NameValue(dsT_DO_DOCUMENT_REC.RowPosition,'ORD_NO')+"] 정보를 삭제하시겠습니까?")){
				...
				if(confirm("문서번호 ["+dsT_DO_DOCUMENT_DIS.NameValue(dsT_DO_DOCUMENT_DIS.RowPosition,'ORD_NO')+"] 정보를 삭제하시겠습니까?")){
        ...
        function fnc_Clear() {
            ...
            if(ActiveIndex == 2){//수신
                ...
                document.form1.rdoIN_OUT[0].checked = true;
                
                document.getElementById("txtRCV_DPT").value = "";
                document.getElementById("txtRCV_NM").value = "";
                document.getElementById("txtENO_NM").value = "";
                
                document.getElementById("resultMessage1").value = " ";
                ...
                document.form1.rdoIN_OUT2[0].checked = true;
                ...
                document.getElementById("resultMessage2").value = " ";

            }else if(ActiveIndex == 4){//수신조회

                dsT_DO_DOCUMENT_REC.ClearData();
                document.getElementById("cmbIN_OUT_SHR").value = "";
                document.getElementById("cmbOK_YN_SHR").value = "";
                
                document.getElementById("txtSTR_YMD_SHR").focus();
                
                document.getElementById("resultMessage3").value = " ";
                
            }else if(ActiveIndex == 3){//발송조회
                
                dsT_DO_DOCUMENT_DIS.ClearData();
                document.getElementById("cmbIN_OUT_SHR2").value = "";
                document.getElementById("cmbOK_YN_SHR2").value = "";
                
                document.getElementById("txtSTR_YMD_SHR2").focus();
                
                document.getElementById("resultMessage4").value = " ";
...
%>
        ...
        //Layer ID
        var layerList = new Array(  "tabDOCA020_01"
                                   ,"tabDOCA020_02"
                                   ,"tabDOCA020_03"
                                   ,"tabDOCA020_04"
                                    );        
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">공문관리</td>
					<td align="right" class="navigator">HOME/문서관리/문서관리/<font color="#000000">공문관리</font></td>
				</tr>
			</table>
		</td>
	</tr>
...
<!-- 탭2 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA020_01" style="position:absolute; left:20; top:130; width:800; height:340; z-index:4; visibility:hidden" >
	    ...
	    <tr>
	        <td>
	            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
	                ...
	                <tr>
	                    <td align="center" class="creamBold">문서번호</td>
		...
		<tr>
			<td>
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
					...
					<tr>
						<td class="padding2423">
							<input type="radio" id="radio1" name="rdoIN_OUT2" style="border:none" value="0" checked>대내공문
							<input type="radio" id="radio2" name="rdoIN_OUT2" style="border:none" value="1">대외공문
						</td>
					</tr>
				</table>
			</td>
...
<!-- 탭1 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA020_02" style="position:absolute; left:20; top:130; width:800; height:340; z-index:3;" >
			...
			<td>
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
					...
					<tr>
						<td align="center" class="creamBold">부서명</td>
						<td class="padding2423">
							<input id=txtRCV_DPT name=txtRCV_DPT size="6" maxlength="6" onChange="fnc_GetCommNm('A4', 'txtRCV_DPT','txtRCV_NM')">
							<input id=txtRCV_NM name=txtRCV_NM size="14" class="input_ReadOnly" readonly> 
                            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" name="Image7" width="21" height="20" border="0" align="absmiddle" onClick="fnc_commnmPopup('txtRCV_DPT','txtRCV_NM','부서','DEPT')"></a>
                        </td>
					</tr>
					<tr>
						<td align="center" class="creamBold">담당자</td>
		...
		<tr>
			<td>
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
					...
					<tr>
						<td class="padding2423">
							<input type="radio" id="radio1" name="rdoIN_OUT" style="border:none" value="0" checked>대내공문
							<input type="radio" id="radio2" name="rdoIN_OUT" style="border:none" value="1">대외공문
						</td>
					</tr>
				</table>
			</td>
...
<!-- 탭4 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA020_03" style="position:absolute; left:20; top:100; width:800; height:340;z-index:2; visibility:hidden">
<!-- power Search테이블 시작 -->
    <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="paddingTop8">
                        ...
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="searchState">공문구분&nbsp;</td>
                                    <td class="padding2423">
                                        <select id="cmbIN_OUT_SHR2" name="cmbIN_OUT_SHR2" style="WIDTH: 50%" onChange="fnc_SearchList()" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
                                            <option value=''>전 체</option>
                                            <option value='0'>대 내</option>
                                            <option value='1'>대 외</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            ...
                            <comment id="__NSID__">
                            <object id="grdT_DO_DOCUMENT_DIS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:360px;">
                                ...
                                <param name="Format"            value="
                                    ...
                                    <C> id='ORD_NO'    width=90  name='문서번호'   align=center  edit=None</C>
                                    <C> id='IN_OUT_GB' width=60  name='공문구분'   align=center  edit=None  Value={Decode(IN_OUT,'0','대내공문','1','대외공문')}</C>
                                    <C> id='DPT_NM'    width=80  name='발송부서'   align=left    edit=None</C>
                                    <C> id='ENO_NM'    width=55  name='발송자'     align=center  edit=None</C>
                                    <C> id='DOC_SUB'   width=110 name='제목'       align=left  edit=None</C>
                                    <C> id='COM_NM'    width=90  name='수신처'     align=left  edit=None</C>
...
<!-- 탭3 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA020_04" style="position:absolute; left:20; top:100; width:800; height:340;z-index:1; visibility:hidden">
<!-- power Search테이블 시작 -->
    <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="paddingTop8">
                        ...
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="searchState">공문구분&nbsp;</td>
                                    <td class="padding2423">
                                        <select id="cmbIN_OUT_SHR" name="cmbIN_OUT_SHR" style="WIDTH: 50%" onChange="fnc_SearchList()" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
                                            <option value=''>전 체</option>
                                            <option value='0'>대 내</option>
                                            <option value='1'>대 외</option>
                                        </select>
                        ...
                        <td>
                            ...
                            <object id="grdT_DO_DOCUMENT_REC" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:360px;">
                                ...
                                <param name="Format"            value="
                                    ...
                                    <C> id='ORD_NO'    width=85  name='문서번호'   align=center  edit=None</C>
                                    <C> id='IN_OUT_GB' width=60  name='공문구분'   align=center  edit=None  Value={Decode(IN_OUT,'0','대내공문','1','대외공문')}</C>
                                    <C> id='COM_NM'    width=100 name='발송처'     align=left    edit=None</C>
                                    <C> id='DOC_SUB'   width=125 name='제목'       align=left    edit=None</C>
                                    <C> id='RCV_DPT'   width=100 name='수신부서'   align=left    edit=None  Show=false</C>
                                    <C> id='DPT_NM'    width=100 name='수신부서'   align=left    edit=None</C>
                                    ...
                                    <C> id='CONFIRM'   width=34  name='수령;확인'   align=center     EditStyle=CheckBox  Pointer=Hand    </C>
                                ">
                            </object>
                            </comment><script> __ShowEmbedObject(__NSID__); </script>
