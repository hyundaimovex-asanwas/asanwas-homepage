...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			if(ActiveIndex == 3){//수신조회
				...
				dsT_DO_DOCUMENT_REC.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca030.cmd.DOCA030CMD&S_MODE=SHR_02&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&DPT_CD="+dpt_cd+"&OK_YN="+ok_yn+"&ENO_NM="+eno_nm;
				dsT_DO_DOCUMENT_REC.Reset();
			} else if(ActiveIndex == 2){//발송조회
				...
				dsT_DO_DOCUMENT_DIS.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca030.cmd.DOCA030CMD&S_MODE=SHR_01&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&DPT_CD="+dpt_cd+"&OK_YN="+ok_yn+"&ENO_NM="+eno_nm;
        ...
        function fnc_SearchItem() {
			...
			dsT_DO_DOCUMENT_ORDNO.DataID = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca010.cmd.DOCA010CMD&S_MODE=SHR_03&DOCU_GBN=P&GBN_CD=S";
        ...
        function fnc_Save() {//
			...
			if(ActiveIndex == 1){//발송
				...
				for(var i=0 ; i<dsT_CM_DEPT_COPY.CountRow ; i++) {
					dsT_DO_DOCUMENT.AddRow();
					dsT_DO_DOCUMENT.NameValue(i+1,'SEQ_NO') = i+1;
					dsT_DO_DOCUMENT.NameValue(i+1,'SND_DPT') = document.getElementById("txtSND_DPT").value;
					dsT_DO_DOCUMENT.NameValue(i+1,'DOC_SUB') = document.getElementById("txtDOC_SUB").value;
					dsT_DO_DOCUMENT.NameValue(i+1,'RCV_DPT') = document.getElementById("cmbRCV_DPT")[i].value;
					dsT_DO_DOCUMENT.NameValue(i+1,'ENO_NM') = document.getElementById("txtENO_NM").value;
					dsT_DO_DOCUMENT.NameValue(i+1,'REMARK') = document.getElementById("txtREMARK").value;
				}

				trT_DO_DOCUMENT.KeyValue = "SVL(I:dsT_DO_DOCUMENT=dsT_DO_DOCUMENT)";
				trT_DO_DOCUMENT.action = "/servlet/GauceChannelSVL?cmd=hr.doc.a.doca030.cmd.DOCA030CMD&S_MODE=SAV_01";
				trT_DO_DOCUMENT.post();

			}else if(ActiveIndex == 3){//수신조회
...
%>
                /*
                alert('권한이 없습니다.');
                document.getElementById("resultMessage4").innerText = '* 삭제 할 수 없습니다!';
                return;
                */
<%
    //}
...
%>
        ...
        function fnc_ToExcel() {
            if(ActiveIndex == 3){            //수신조회
               ...
               form1.grdT_DO_DOCUMENT_REC.GridToExcel("행랑_수신관리", '', 225);
            } else if(ActiveIndex == 2){     //발송조회
               if (dsT_DO_DOCUMENT_DIS.CountRow < 1) {
                alert("엑셀로 변환할 자료가 없습니다!");
                return;
               }
               form1.grdT_DO_DOCUMENT_DIS.GridToExcel("행랑_발송관리", '', 225);
            }
        }
        ...
        function fnc_SaveItemCheck() {
			...
			if(ActiveIndex == 1){//발송
				...
				if(form1.cmbRCV_DPT.length == 0){
					alert('수신부서를 입력하세요.');
					form1.cmbRCV_DPT.focus();
					return false;
				}
...
%>
		...
		function select_dpt() {
            ...
            var tempDS = fnc_selectDPT(dsT_CM_DEPT_COPY);
        ...
        //Layer ID
        var layerList = new Array(  "tabDOCA030_01"
                                   ,"tabDOCA030_02"
                                   ,"tabDOCA030_03"
                                    );
...
%>
    ...
    ***************************************************************************************-->
    ...
    +----------------------------------------------->
    <Object ID="dsT_CM_DEPT_COPY" ClassID="CLSID:2506B38B-0FF7-4249-BA3E-8BC1DC399FBB">
        <Param Name="Syncload"        Value="True">
        <Param Name="UseChangeInfo"   Value="True">
        <Param Name="ViewDeletedRow"  Value="False">
    </Object>
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">행랑관리</td>
					<td align="right" class="navigator">HOME/문서관리/문서관리/<font color="#000000">행랑관리</font></td>
				</tr>
			</table>
		</td>
	</tr>
                    ...
                    <td width="120">
                        ...
                        <table width="120" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center" class="overMenu25" onclick="TabEvent(0)" style="cursor:hand" id="TabBtn01">내역작성</td>
                    ...
                    <td>
                        ...
                        <table width="120" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center" class="hiddenMenu25" onclick="TabEvent(1)" style="cursor:hand" id="TabBtn02">발송관리</td>
                    ...
                    <td>
                        ...
                        <table width="120" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="center" class="hiddenMenu25" onclick="TabEvent(2)" style="cursor:hand" id="TabBtn03">수신관리</td>
...
<!-- 탭1 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA030_01" style="position:absolute; left:20; top:130; width:800; height:340; z-index:3;" >
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	        <td>
	            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"  bordercolor="#999999" class="table_cream">
					...
					<tr>
						<td align="center" class="creamBold">발신부서</td>
						<td class="padding2423">
							<input name=txtSND_DPT size="6" maxlength="6" onChange="fnc_GetCommNm('A4', 'txtSND_DPT','txtSND_DPT_NM')">
					...
					<tr>
						<td align="center" class="creamBold">수신부서</td>
						<td class="padding2423">
					...
					<tr>
						<td align="center" class="creamBold">참&nbsp;&nbsp;&nbsp;조</td>
						<td class="padding2423">
							<input id="txtENO_NM" name="txtENO_NM" size="20" onKeyUp="fc_chk_byte(this,20)">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="padding2423">
							<input id="txtREMARK" name="txtREMARK" size="30" onKeyUp="fc_chk_byte(this,60)">
						</td>
					</tr>
	            </table>
	        </td>
        ...
        <tr>
            <td>
             <br>
              &nbsp;&nbsp;※ 행랑 미취급 지점은 택배를 이용하여 발송하시기 바랍니다.<br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(행랑 미취급 지점 : 고성사무소/천안사무소/이천사무소/김포출장소/부산서부지점/김해공항출장소)
            </td>
        </tr>
	</table>
...
<!-- 탭2 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA030_02" style="position:absolute; left:20; top:100; width:800; height:340; z-index:2; visibility:hidden">
<!-- power Search테이블 시작 -->
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="paddingTop8">
	                    ...
	                    <td>
							...
							<object	id="grdT_DO_DOCUMENT_DIS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
	                            ...
	                            <param name="Format"		    value="
									...
									<C> id='DPT_NM'    width=90	 name='발신부서'   align=left  edit=None</C>
									<C> id='SND_DPT'   width=85	 name='발신부서'   align=left  edit=None	Show=false</C>
									<C> id='IPT_NM'    width=55	 name='발신자'     align=center  edit=None</C>
									<C> id='RCV_NM'    width=90	 name='수신부서'   align=left  edit=None</C>
									<C> id='RCV_DPT'   width=85	 name='수신부서'   align=left  edit=None	Show=false</C>
                                    <C> id='ENO_NM'    width=95 name='참조'       align=left  edit=None</C>
									<C> id='REMARK'    width=80 name='비고'       align=left  edit=None</C>
...
<!-- 탭3 조건 입력 테이블 시작 -->
<div class=page id="tabDOCA030_03" style="position:absolute; left:20; top:100; width:800; height:340; z-index:1; visibility:hidden">
<!-- power Search테이블 시작 -->
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="paddingTop8">
					...
					<tr>
						<td align="center" class="greenTable">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="right" class="searchState">수령자명&nbsp;</td>
									<td class="padding2423">
	            ...
	            <table border="0" cellspacing="0" cellpadding="0">
	                <tr>
	                    <td>
							...
							<comment id="__NSID__">
							<object	id="grdT_DO_DOCUMENT_REC" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
	                            ...
	                            <param name="Format"		    value="
                                    ...
                                    <C> id='ENO_NM'    width=95 name='참조'       align=left  edit=None</C>
									<C> id='REMARK'    width=80 name='비고'       align=left  edit=None</C>
                                    <C> id='CONFIRM'   width=54  name='접수확인'   align=center     EditStyle=CheckBox  Pointer=Hand    </C>
									<C> id='OK_YMD'    width=70	 name='수령일자'   align=center  edit=None	MASK=XXXX-XX-XX</C>
