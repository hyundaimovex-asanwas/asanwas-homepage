...
*****************************************************
* @source       : docb010.jsp
* @description : 문서권한설정 PAGE
*****************************************************
* DATE            AUTHOR        DESCRIPTION
*----------------------------------------------------
* 2006/11/21      오대성        최초작성.
* 2006/12/19      한학현        입력단 수정.(수정시 반드시 법무권한설정 같이 수정)
*****************************************************
-->
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			var doc_autho = document.form1.cmbDOC_AUTHO_SHR.value;	//평가그룹

			//역량 평가 적용 결과 정보 조회
			dsT_CM_EMPLIST.dataid = "/servlet/GauceChannelSVL?cmd=hr.doc.b.docb010.cmd.DOCB010CMD&S_MODE=SHR&ENO_NO="+eno_no+"&DPT_CD="+dpt_cd+"&DOC_AUTHO="+doc_autho;
        ...
        function fnc_Save() {
			...
			trT_CM_EMPLIST.action = "/servlet/GauceChannelSVL?cmd=hr.doc.b.docb010.cmd.DOCB010CMD&S_MODE=SAV";
			trT_CM_EMPLIST.post();
        ...
        function fnc_Clear() {
			...
			document.getElementById("cmbDOC_AUTHO_SHR").value = '';
			document.getElementById("txtENO_NO").value = '';
			document.getElementById("txtENO_NM").value = '';
			document.getElementById("txtDPT_CD").value = '';
			document.getElementById("txtDPT_NM").value = '';
			document.getElementById("cmbDOC_AUTHO").value = '';
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">문서권한설정</td>
					<td align="right" class="navigator">HOME/총무(기타)/문서관리/<font color="#000000">문서권한설정</font></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
				...
				<tr>
					...
					<td class="padding2423">
						<select id="cmbDOC_AUTHO" name="cmbDOC_AUTHO" style="width:100%">
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="padding2423">
                                    <select id="cmbDOC_AUTHO_SHR" name="cmbDOC_AUTHO_SHR" style="WIDTH: 50%" onChange="fnc_SearchList()" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
					...
					<td>
						...
						<object	id="grdT_CM_EMPLIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:380px;">
							...
							<param name="Format"				value="
								...
								<C> id='DOC_AUTH'		width=104		name='권한'		align=center		Edit=none								Value={Decode(DOC_AUTHO,'','없음','S','소속부서','A','모든부서')}		</C>
								<C> id='DOC_AUTHO'	width=104		name='권한'		align=center		Edit=none		Show=false																													</C>
							">
						</object>
