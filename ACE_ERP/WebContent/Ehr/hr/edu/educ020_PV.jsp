...
***********************************************************************
* @Source         : educ020.jsp                                       *
* @Description    : 나의교육이력-년도별교육이력 PAGE         
***********************************************************************
...
<%
    ...
    String title_val = "나의 교육 이력("+str_ymd+"년)";
%>
<html>
<head>
<title>미리보기</title>
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="educ020.hnw">
              <param name="initvalue" VALUE="[:eno_no]=<%=eno_no%>[:str_ymd]=<%=str_ymd%>[:title_val]=<%=title_val%>">
