    ...
    *****************************-->
    ...
    var btnList = 'TFTTFFTT';
        ...
        function fnc_SearchItem(yy, mm) {
            ...
            trT_DI_HOLIDAY.Action   = "/servlet/GauceChannelSVL?cmd=hr.edu.c.educ050.cmd.EDUC050CMD&S_MODE=SHR&REG_YMD="+REG_YMD+"&ENO_NO="+ENO_NO;
            trT_DI_HOLIDAY.post();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="right" class="navigator">HOME/교육관리/나의학습정보/<font color="#000000">월간교육일정</font></td>
                </tr>
            </table>
        </td>
    </tr>
...
%>
                <tr>
                    <td onmouseover="doTrans_color(<%=i%>,1)" onmouseout="rollback_color(<%=i%>,1)" id="td_index_1" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="30"><div id="cal1_1" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="30"><div id="cal1_2" align="left">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="30"><div id="cal1_3" align="left">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,2)" onmouseout="rollback_color(<%=i%>,2)" id="td_index_2" style="cursor:hand"><div align="right" id="bbcol">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                            ...
                            <tr>
                                <td height="17" width="140"><div id="cal2_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,3)" onmouseout="rollback_color(<%=i%>,3)" id="td_index_3" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                            ...
                            <tr>
                                <td height="17" width="140"><div id="cal3_3" align="left" style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,4)" onmouseout="rollback_color(<%=i%>,4)" id="td_index_4" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                            ...
                            <tr>
                                <td height="17" width="140"><div id="cal4_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,5)" onmouseout="rollback_color(<%=i%>,5)" id="td_index_5" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                            ...
                            <tr>
                                <td height="17" width="140"><div id="cal5_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,6)" onmouseout="rollback_color(<%=i%>,6)" id="td_index_6" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                            ...
                            <tr>
                                <td height="17" width="140"><div id="cal6_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(<%=i%>,7)" onmouseout="rollback_color(<%=i%>,7)" id="td_index_7" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="40"><div id="cal7_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="40"><div id="cal7_2" align="left">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="40"><div id="cal7_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
%>
                ...
                <tr id="biz"  style="display:none">
                    <td onmouseover="doTrans_color(5,1)" onmouseout="rollback_color(5,1)" id="td_index_1" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal1_1" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal1_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal1_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,2)" onmouseout="rollback_color(5,2)" id="td_index_2" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal2_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal2_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal2_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,3)" onmouseout="rollback_color(5,3)" id="td_index_3" style="cursor:hand"><div align="right">
                        <table border="0"v>
                            <tr>
                                <td height="17" width="90"><div id="cal3_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal3_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal3_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,4)" onmouseout="rollback_color(5,4)" id="td_index_4" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal4_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal4_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal4_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,5)" onmouseout="rollback_color(5,5)" id="td_index_5" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal5_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal5_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal5_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,6)" onmouseout="rollback_color(5,6)" id="td_index_6" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal6_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal6_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal6_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,7)" onmouseout="rollback_color(5,7)" id="td_index_7" style="cursor:hand"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            <tr>
                                <td height="17" width="90"><div id="cal7_1" align="right"></div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal7_2" align="right">&nbsp;</div></td>
                            </tr>
                            <tr>
                                <td height="17" width="90"><div id="cal7_3" align="right">&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                </tr>
