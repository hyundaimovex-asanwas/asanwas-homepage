<!--
    ************************************************************************************
    * @Source         : edud011.jsp                                                    *
    * @Description    : 학습제도가이드 등록(수정)PAGE                                  *
    * @Developer Desc :                                                                *
    ************************************************************************************
...
<html>
    ...
    <head>
    <title>학습제도가이드 등록(수정)(edud011)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud011.cmd.EDUD011CMD&S_MODE=SHR&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Save() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud011.cmd.EDUD011CMD&S_MODE=SAV&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            trT_ED_BOARD.post();
    ...
    **************************************-->
    ...
    <Script For=dsT_ED_BOARD Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            oFileListGDS.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud011.cmd.EDUD011CMD&S_MODE=SHR_01&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            oFileListGDS.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">학습제도가이드 <span id="title"></span></td>
                </tr>
            </table>
        </td>
    </tr>
