...
<html>
    ...
    <head>
    <title>학습제도가이드 내용(edud012)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud012.cmd.EDUD012CMD&S_MODE=SHR&BBS_GBN="+BBS_GBN+"&SEQ_NO="+SEQ_NO;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Delete() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud012.cmd.EDUD012CMD&S_MODE=DEL";
            trT_ED_BOARD.post();
        ...
        function fnc_Modify() {
            ...
            window.showModalDialog("/hr/edu/edud011.jsp", self, "dialogHeight:620px; dialogWidth:870px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">학습제도가이드 내용</td>
                </tr>
            </table>
        </td>
    </tr>
