...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud010.cmd.EDUD010CMD&S_MODE=SHR&BBS_GBN="+bbs_gbn+"&GBN="+GBN+"&TEXT="+TEXT+"&STRREC="+strRec+"&ENDREC="+endRec+"&PAGNUM="+pagNum;
            trT_ED_BOARD.post();   
    ...
    **************************************-->
    ...
    <Script For=grdT_ED_BOARD Event="OnDblClick(row, col)">
        ...
        window.showModalDialog("/hr/edu/edud022.jsp", self, "dialogHeight:620px; dialogWidth:870px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">묻고답하기</td>
                    <td align="right" class="navigator">HOME/교육관리/학습제도안내/<font color="#000000">묻고답하기</font></td>
                </tr>
            </table>
        </td>
    </tr>
