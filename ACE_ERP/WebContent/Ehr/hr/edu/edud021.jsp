<!--
    ************************************************************************************
    * @Source         : edud021.jsp                                                    *
    * @Description    : 묻고답하기 등록(수정/답변)PAGE                                 *
    * @Developer Desc :                                                                *
    ************************************************************************************
...
<html>
    ...
    <head>
    <title>묻고답하기 등록(수정)(edud021)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud021.cmd.EDUD021CMD&S_MODE=SHR&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Save() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud021.cmd.EDUD021CMD&S_MODE=SAV&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no+"&GBN="+opener.gbn;
            trT_ED_BOARD.post();
        ...
        function fnc_OnLoadProcess() {
            ...
            if (opener.gbn == "2") {
                ...
                dsT_ED_BOARD.NameValue(1, "BBS_GBN") = opener.bbs_gbn;
                dsT_ED_BOARD.NameValue(1, "REF_NO")  = opener.ref_no;
                dsT_ED_BOARD.NameValue(1, "STEP_NO") = opener.step_no + 1;
                dsT_ED_BOARD.NameValue(1, "DEPT_NO") = opener.dept_no + 1;
                dsT_ED_BOARD.NameValue(1, "ENO_NO")  = '<%=box.get("SESSION_ENONO")%>';
                dsT_ED_BOARD.NameValue(1, "ENO_NM")  = '<%=box.get("SESSION_ENONM")%>';
            }
        }
    ...
    **************************************-->
    ...
    <Script For=dsT_ED_BOARD Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            oFileListGDS.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.d.edud021.cmd.EDUD021CMD&S_MODE=SHR_01&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            oFileListGDS.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">묻고답하기 <span id="title"></span></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423">
                        <input id="txtENO_NO" size="9" maxlength= "8" class="input_ReadOnly"  readonly>
                        <input id="txtENO_NM" size="9" maxlength= "9" class="input_ReadOnly"  readonly>
                    </td>
                </tr>
                <tr>
                    <td align="center" class="creamBold">제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
                    <td class="padding2423" >
                        <input id="txtSUBJECT_TAG"  name="txtSUBJECT_TAG" style="width:100%" maxlength="40" >
                    </td>
                </tr>
                <tr>
                    <td align="center" class="creamBold">내&nbsp;&nbsp;&nbsp;&nbsp;용</td>
                    <td class="padding2423" >
                        <textarea id="txtCONTENT_TXT"  name="txtCONTENT_TXT" cols="114" rows="16" maxlength="4000" ></textarea>
                    </td>
                </tr>
                <tr>
                                ...
                                <td class="paddingTop5">
                                    ...
                                    <object  id="grdFileListGDS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:705px;height:160px;">
                                        ...
                                        <param name="Format"                  value="
                                            ...
                                            <C> id='FILE_URL'     width=70    name='파일경로'       align=left   </C>
                                        ">
                                    </object>
