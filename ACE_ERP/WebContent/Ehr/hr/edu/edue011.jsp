...
<html>
    ...
    <head>
    <title>공지사항 등록(수정)(edue011)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue011.cmd.EDUE011CMD&S_MODE=SHR&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Save() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue011.cmd.EDUE011CMD&S_MODE=SAV&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            trT_ED_BOARD.post();
    ...
    **************************************-->
    ...
    <Script For=dsT_ED_BOARD Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            oFileListGDS.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue011.cmd.EDUE011CMD&S_MODE=SHR_01&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            oFileListGDS.Reset();
