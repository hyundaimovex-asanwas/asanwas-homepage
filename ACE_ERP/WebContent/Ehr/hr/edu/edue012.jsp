    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue012.cmd.EDUE012CMD&S_MODE=SHR&BBS_GBN="+BBS_GBN+"&SEQ_NO="+SEQ_NO;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Delete() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue012.cmd.EDUE012CMD&S_MODE=DEL";
            trT_ED_BOARD.post();
