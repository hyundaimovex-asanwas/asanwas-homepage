    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_DI_APPROVAL.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.edu.e.edue040.cmd.EDUE040CMD&S_MODE=SHR&STR_YMD_SHR="+str_ymd+"&END_YMD_SHR="+end_ymd+"&APP_YN_SHR="+app_yn;
        ...
        function fnc_OnLoadProcess() {
			...
			document.getElementById("txtSTR_YMD_SHR").value = addDate("M", gcurdate, -1);
    ...
    **************************************-->
	...
	<script language=JavaScript for=grdT_DI_APPROVAL event="OnDblClick(row,colid)">
		if(row < 1) {
            ...
            //if(dsT_DI_APPROVAL.NameString(row, "ENO_NO") == gusrid) {
				...
				<tr align="center">
					...
					<object id="grdT_DI_APPROVAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:500px;">
						...
						<param name="Format" value='
                            ...
                            <C> id="APP_DATE"			width=100	name="결재일/시간"	align=center     </C>
							<C> id="EDU_YMD"			width=150	name="학습기간" 		align=center	 </C>
							<C> id="EDU_NM"			width=270	name="과정명" 			align=left </C>
						'>
					</object>
