    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_DI_APPROVAL.dataid = "/servlet/GauceChannelSVL?cmd=hr.edu.e.edue060.cmd.EDUE060CMD&S_MODE=SHR&STR_YMD_SHR="+str_ymd+"&END_YMD_SHR="+end_ymd+"&APP_YN_SHR="+app_yn;
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">교육결과보고 결재처리</td>
					<td align="right" class="navigator">HOME/기초정보/통합결재/<font color="#000000">교육결과보고 결재처리</font></td>
				</tr>
			</table>
		</td>
	</tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
	<tr>
        ...
        ※결재를 원하시면 해당 교육결과보고 내역을 더블클릭 하세요.
        </td>
	</tr>
</table>
<!-- 조회 상태 테이블 끝 -->
				...
				<tr align="center">
					...
					<object id="grdT_DI_APPROVAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:320px;">
						...
						<param name="Format" value='
							...
							<C> id="EDU_YMD"	width=140	name="학습기간" align=center	suppress=1 </C>
							<C> id="EDU_NM"	width=300	name="과정명" align=left	suppress=1 </C>
						'>
					</object>
