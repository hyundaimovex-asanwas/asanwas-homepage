        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">과정차수관리</td>
                    <td align="right" class="navigator">HOME/교육관리/과정운영자/<font color="#000000">과정차수관리</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_ED_COURSELIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:320px;">
                            ...
                            <param name="Format"                  value="
                                <FC> id='EDU_NM'       width=250   name='과정명'            align=left   suppress = '1'</FC>
                                <FC> id='SEQ_NO'       width=80    name='차수'              align=center </FC>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="paddingTop8">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top" class="searchState">* 해당 항목을 더블클릭 하시면 차수를 수정할 수 있습니다.</td>
                </tr>
            </table>
        </td>
    </tr>
