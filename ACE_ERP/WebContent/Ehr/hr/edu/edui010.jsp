    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_CM_EDUCATION.GridToExcel("교육사항관리", '', 225);
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">교육사항</td>
				<td align="right" class="navigator">HOME/교육관리/현황/<font color="#000000">교육사항</font></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="searchState" align="right">교육분야</td>
				<td class="padding2423" align="left" width="300">
                    ...
                    <td>
                        ...
                        <object    id="grdT_CM_EDUCATION" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <C> id='PLACE_NM'       width='60'      name='교육구분'   align='center' </C>
                                <C> id='EDU_NM'         width='120'     name='과정명'   align='center' </C>
                                <C> id='INT_NAM'        width='120'     name='시행처'     align='center' </C>
                                <C> id='CPT_PNT'        width='80'      name='인정점수'   align='center' </C>
                                <C> id='COST_AMT'       width='80'      name='교육비'     align='right' rightmargin='10' </C>
                                <C> id='DECISION_NM'    width='60'      name='수강상태'   align='center' </C>
                                <C> id='APP_VAL'        width='60'      name='평가점수'   align='center' </C>
