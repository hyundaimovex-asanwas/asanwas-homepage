...
<script language="javascript">
   ...
   function fnc_OnLoadProcess() {
            ...
            if (frame.FrameID == "heqa010") {
               document.getElementById("title1").innerText = "사업본부근태현황"
               document.getElementById("title2").innerText = "사업본부근태현황"
               document.getElementById("dir").innerText = "HOME/경영정보/사업본부정보/"
            }
            else {document.getElementById("title1").innerText = "년간월별근태현황"
                  document.getElementById("title2").innerText = "년간월별근태현황"
                  document.getElementById("dir").innerText = "HOME/근태현황/"
            }
   }
...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15" marginwidth="0" marginheight="0" scroll="auto" onload="fnc_OnLoadProcess();">
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="right" class="navigator"><font color="#000000"><span id="dir"></span><span id="title2"></span></font></td>
				</tr>
			</table>
			</td>
		</tr>
	...
	<!-- 타이틀 바 테이블 끝 -->
        ...
        <comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="eisa010.hnw">
