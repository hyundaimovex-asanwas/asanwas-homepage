...
*****************************************************
* @source       : eisa020.jsp
* @description : 직위/본부별 입퇴사자현황 PAGE
*****************************************************
...
<script language="javascript">
   ...
   function fnc_OnLoadProcess() {
            ...
            if (frame.FrameID == "heqa020") {
               document.getElementById("title1").innerText = "사업본부입퇴사자현황"
               document.getElementById("title2").innerText = "사업본부입퇴사자현황"
               document.getElementById("dir").innerText = "HOME/경영정보/사업본부정보/"
            }
            else {document.getElementById("title1").innerText = "입퇴사자현황"
                  document.getElementById("title2").innerText = "입퇴사자현황"
