...
<script language="javascript">
   ...
   function fnc_OnLoadProcess() {
            ...
            if (frame.FrameID == "heqa030") {
               document.getElementById("title1").innerText = "사업본부이직율현황"
               document.getElementById("title2").innerText = "사업본부이직율현황"
               document.getElementById("dir").innerText = "HOME/경영정보/사업본부정보/"
            }
            else {document.getElementById("title1").innerText = "이직율현황"
                  document.getElementById("title2").innerText = "이직율현황"
...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15" marginwidth="0" marginheight="0" scroll="auto" onload="fnc_OnLoadProcess();">
	...
	<!-- 타이틀 바 테이블 끝 -->
        ...
        <comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="eisa030.hnw">
