...
<html>
    ...
    <head>
    <title>회의보고자료 등록(수정)(eisd021)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.eis.d.eisd021.cmd.EISD021CMD&S_MODE=SHR&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Save() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.eis.d.eisd021.cmd.EISD021CMD&S_MODE=SAV&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            trT_ED_BOARD.post();
        ...
        function fnc_Delete() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.eis.d.eisd021.cmd.EISD021CMD&S_MODE=DEL";
            trT_ED_BOARD.post();
            ...
            if ( dsT_ED_BOARD.isUpdated || oFileListGDS.IsUpdated) {
                for( i = 1; i <= dsT_ED_BOARD.CountRow; i++ ) {
                    if( dsT_ED_BOARD.RowStatus(i) == 1 ||
                        ...
                        // 구분
                        if( dsT_ED_BOARD.NameValue(i, "BBS_GBN") == '' ) {
                            alert("구분은 필수 입력사항입니다.");
                            document.getElementById("cmbBBS_GBN").focus();
                            return false;
                        }
                        ...
                        if (oFileListGDS.CountRow == 0) {
                            alert("파일을 한개이상 첨부하여 저장하시기 바랍니다.");
                            return false;
                        }
        ...
        function fnc_OnLoadProcess() {
            ...
            if (opener.gbn == "2") {
		        ...
		        document.getElementById("cmbBBS_GBN").disabled   = true;
    ...
    **************************************-->
    ...
    <Script For=dsT_ED_BOARD Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            oFileListGDS.DataId = "/servlet/GauceChannelSVL?cmd=hr.eis.d.eisd021.cmd.EISD021CMD&S_MODE=SHR_01&BBS_GBN="+opener.bbs_gbn+"&SEQ_NO="+opener.seq_no;
            oFileListGDS.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">회의보고자료 <span id="title"></span></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423" >
                        <input id="txtENO_NO"  name="txtENO_NO" size="10"  maxlength="8" onblur="javascript: if (this.value == '') {document.getElementById('txtENO_NM').value = ''}" onKeyPress="cfNumberCheck();" onChange="fnc_GetEnoNm('txtENO_NO','txtENO_NM','0','1');">  <input id="txtENO_NM" name="txtENO_NM" size="16" class="input_ReadOnly"  readOnly>
                    ...
                    <td class="padding2423" align="left">
                        <select id="cmbBBS_GBN" style="width:100%" >
                            <option value="5">주간</option>
                            <option value="6">월간</option>
                            <option value="7">전략</option>
                        </select>
                    </td>
                    <td align="center" class="creamBold">날&nbsp;&nbsp;&nbsp;&nbsp;짜</td>
                    <td class="padding2423" >
                        <input id="txtSUBJECT_TAG" style="ime-mode:disabled" size="10" maxlength="10" onblur="cfCheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                        <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgYmd','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" id="ImgYmd" name="ImgYmd" width="21" height="20" border="0" align="absmiddle" onclick="calendarBtn('datetype1','txtSUBJECT_TAG','','610','100');"></a>
                    </td>
                </tr>
                <tr>
                                ...
                                <td class="paddingTop5">
                                    ...
                                    <object  id="grdFileListGDS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:705px;height:160px;">
                                        ...
                                        <param name="Format"                  value="
                                            ...
                                            <C> id='FILE_URL'     width=70    name='파일경로'       align=left   show=false</C>
                                        ">
                                    </object>
...
<object id="bndT_ED_BOARD"" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        <C>Col=BBS_GBN      Ctrl=cmbBBS_GBN      Param=value </C>
