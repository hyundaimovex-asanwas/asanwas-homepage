...
<html>
    ...
    *****************************-->
    ...
    var btnList = 'TFFTFFFT';
        ...
        function fnc_SearchList() {
            ...
            dsT_CM_POST.reset();
            //alert("현재 테스트 데이터. 실서버 반영시 HDTSN.TZIPMSTR로 변경");
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid(form1.grdT_CM_POST,0,"false","false");      // Grid Style 적용

			document.form1.txtDONG_SHR.focus();          //검색 1조건에 Focus
    ...
    ***************************************************************************************-->
    ...
    <!----------------------------------------------+
    | 1. 조회 및 저장용 DataSet                     |
    | 2. 이름은 ds_ + 주요 테이블명(T_CM_POST)      |
    | 3. 사용되는 Table List(T_CM_POST)             |
    +----------------------------------------------->
	        ...
	        <td height="25" background="/images/common/barBg.gif">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
	                    ...
	                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">우편번호검색</td>
                        <td align="right" class="navigator">HOME/업무관리/셀프서비스/<font color="#000000">우편번호검색</font></td>
	                </tr>
	            </table>
	        </td>
	    </tr>
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	        <td class="paddingTop8">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>찾고자 하는 주소의 동(읍/면/리)를 입력하세요<BR>예)방배동, 역삼동</td>
					</tr>
	                <tr>
	                    <td align="center" class="greenTable">
	                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            <tr>
	                                <td align="center" class="searchState">지역명&nbsp;</td>
	                    ...
	                    <td>
	                        ...
	                        <object    id="grdT_CM_POST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
	                            ...
	                            <param name="Format"            value='
	                            	<C> id=ZIPCODE		width=100	name=우편번호	align=center 	Mask=XXX-XXX</C>
	                                <C> id=ADDRESS_TOT	width=620   name=주소	    align=left 	</C>
									<C> id=ADDRESS_ORG	width=320   name=주소ORG    align=center 	Show=false</C>
	                            '>
	                        </object>
