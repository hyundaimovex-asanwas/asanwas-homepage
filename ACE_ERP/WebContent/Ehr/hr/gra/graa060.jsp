        ...
        function fnc_SaveItemCheck() {
            ...
            */
            ...
            if(dsT_CP_WORKLOG.CountRow == 0) {
                alert("해당년도의 승급대상자 선정이 완료되지 않았습니다.");
                return false;
            }

            if(dsT_CP_WORKLOG.NameValue(1, "PRO_STS") == "1") {
                alert("해당년도의 승급심사개인별입력 처리가 완료되지 않았습니다.");
                return false;
            }

            if(dsT_CP_WORKLOG.NameValue(1, "PRO_STS") == "3") {
                alert("해당년도의 승급결과 처리가 이미 이루어졌습니다.");
                return false;
            }
    ...
    **************************************-->
    ...
    <script for=trT_CP_WORKLOG_SHR event="OnSuccess()">
        ...
        if(dsT_CP_WORKLOG.CountRow == 1){ // 저장
	        if(dsT_CP_WORKLOG.NameValue(1, "PRO_STS") == "1") {
	            document.getElementById("txtPRO_STS_MSG").value = "해당년도의 승급심사개인별입력 처리가 완료되지 않았습니다.";
                ...
                document.getElementById("txtPRO_STS_MSG").value = '해당년도의 승급결과 처리가 가능합니다.';
                fnc_Message(document.getElementById("resultMessage"), "MSG_03", dsT_CP_WORKLOG.CountRow);
                ...
                document.getElementById("txtPRO_STS_MSG").value = '해당년도의 승급결과 처리가 이미 이루어졌습니다.';
                fnc_Message(document.getElementById("resultMessage"), "MSG_03", dsT_CP_WORKLOG.CountRow);
                ...
                document.getElementById("txtPRO_STS_MSG").value = '해당년도의 급상여소급 처리가 이미 이루어졌습니다.';
                fnc_Message(document.getElementById("resultMessage"), "MSG_03", dsT_CP_WORKLOG.CountRow);
            ...
            document.getElementById("txtPRO_STS_MSG").value = "해당년도의 승급대상자 선정이 완료되지 않았습니다.";
    ...
    <script for=trT_CP_WORKLOG_SAV event="OnSuccess()">
        if(dsT_CP_WORKLOG.CountRow == 1){ // 저장
            ...
            document.getElementById("txtPRO_STS_MSG").value = '해당년도의 승급결과 처리를 완료하였습니다..';
            document.getElementById("txtPRO_CNT").value = dsT_CP_WORKLOG.NameValue(1, "PRO_CNT");
			...
			<td height="25" background="/images/common/barBg.gif">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">승급결과처리작업</td>
						<td align="right" class="navigator">HOME/인사관리/승급/<font color="#000000">승급결과처리작업</font></td>
					</tr>
				</table>
			</td>
		</tr>
