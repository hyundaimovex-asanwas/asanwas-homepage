    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_Print() {
            ...
            title_val = "'" + REC_YMD_SHR.substr(2,2) + ". 정기승급 현황";

            var url = "graa090_PV.jsp?REC_YMD_SHR="+REC_YMD_SHR+"&title_val="+title_val;
        ...
        function fnc_Clear() {
            ...
            document.getElementById('txtREC_YMD_SHR').value = getTodayArray()[0];
...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15" marginwidth="0" marginheight="0" scroll=auto onkeydown="fnc_HotKey();" onload="fnc_OnLoadProcess();">
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">정기승급 현황</td>
					<td align="right" class="navigator">HOME/인사관리/승급/<font color="#000000">정기승급 현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="searchState" align="right" width="80">해당년도&nbsp;</td>
