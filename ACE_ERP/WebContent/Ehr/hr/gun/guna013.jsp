	<!--*************************************************************************
	* @source      : guna013.jsp												*
	* @description : 개인별근태변경목록 PAGE											*
	*****************************************************************************
	* DATE            AUTHOR        DESCRIPTION									*
	*----------------------------------------------------------------------------			*
	* 2009/11/02            권혁수                      개인별 근태변경최초작성
	***********************************************************************--*-->
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			trT_DI_CHANGE.action = "/servlet/GauceChannelSVL?cmd=hr.gun.a.guna013.cmd.GUNA013CMD"
                                   + "&S_MODE=SHR_LST"
...
%>
        ...
        function fnc_Application() {
    			...
    			cfCopyDataSet(dsT_DI_CHANGE, dsT_DI_CHANGE_CP, "copyHeader=yes,rowFrom=0,rowCnt=0");
    			var str_ymd_shr = document.getElementById("txtSTR_YMD_SHR").value;
    			var end_ymd_shr = document.getElementById("txtEND_YMD_SHR").value;
				var param = "str_ymd_shr="+str_ymd_shr+"&end_ymd_shr="+end_ymd_shr;
    			window.showModalDialog("/hr/gun/guna014.jsp?MODE=INS&"+param, dsT_DI_CHANGE_CP, "dialogWidth:870px; dialogHeight:500px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
    ...
    ***************************************************************************************-->
	...
	<script language=JavaScript for=grdT_DI_CHANGE event="OnDblClick(row,colid)">
		if(row < 1) {
			...
			window.showModalDialog("/hr/gun/guna014.jsp?MODE=READ&"+param, dsT_DI_CHANGE_CP, "dialogWidth:870px; dialogHeight:500px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">근태변경</td>
					<td align="right" class="navigator">HOME/근태관리/일일근태관리/<font color="#000000">근태변경</font></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
					<comment id="__NSID__">
					<object id="grdT_DI_CHANGE" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:280px;">
