...
<%
    ...
    String PIS_YMD_SHR     	= request.getParameter("GUN_YMD_SHR").replaceAll("-","");
	String OCC_CD_SHR    	= request.getParameter("OCC_CD_SHR");

	//System.out.println(PIS_YMD_SHR);
	//System.out.println(OCC_CD_SHR);
...
<comment id="__NSID__">
              ...
              <param name="initvalue" VALUE="[:PIS_YMD_SHR]=<%=PIS_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>">
