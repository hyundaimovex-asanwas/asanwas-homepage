...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        var occ_cd  = f.txtSTR_YMD_SHR.value;
        ...
        if ( dpt_cd == "" || dpt_cd == null ) {
            dpt_nm_val = "전 체";
        } else {
            dpt_nm_val = dpt_nm;
        }

        param = "[@InitPage]=Page1[:occ_cd]=" + occ_cd + "[:str_ymd]=" + str_ymd + "[:end_ymd]=" + end_ymd + "[:dpt_cd]=" + dpt_cd + "[:dpt_nm_val]=" + dpt_nm_val + "[:ymd]=" + ymd + "[:flag]=Y";

        document.form1.aaa.OpenHnw("/hr/gun/guna110.hnw",param);
        biz.style.display = "";
        f.flag.value = "Y";   // 인쇄조건.
    }
 ...
 //           form1.aaa.SetValue('eee','rrrrrrrrrrr');
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    ***************************************************************************************-->
    ...
    | 1. 조회용 DataSet                                                                           |
    | 2. 이름 : dsT_DI_PLAN                                                            |
    | 3. Table List : T_DI_PLAN, T_DI_YEARLY, T_CM_DEPT, VI_T_CM_PERSON2                   |
    +--------------------------------------------------------------------------------------------->
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="padding2423" align="left">
                                    <input type="text" id="txtSTR_YMD_SHR" name="txtSTR_YMD_SHR" style="ime-mode:disabled" size="10" maxlength="10" onblur="fncCheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();" value="2003-07-06">
                                    ...
                                    ~
                                    <input type="text" id="txtEND_YMD_SHR" name="txtEND_YMD_SHR" style="ime-mode:disabled" size="10" maxlength="10" onblur="fncCheckDate(this);" onkeypress="if (event.keyCode == 13) fnc_SearchList(); else cfDateHyphen(this);cfCheckNumber();"  value="2003-10-16">
							    ...
							    <td class="padding2423" align="left">
								    <input id="txtDPT_CD_SHR" size="3" maxlength="2" value="J1">
                                    <input id="txtDPT_NM_SHR" size="12" class="input_ReadOnly" value="정보전략부" readonly>
        ...
        <td width="800">
            <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
                <comment id="__NSID__">
                    ...
                    <param name="hnwsrc"    VALUE="guna110.hnw">
