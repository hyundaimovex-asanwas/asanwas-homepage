        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">부서근태현황</td>
                    <td align="right" class="navigator">HOME/근태관리/일일근태관리/<font color="#000000">부서근태현황</font></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr>
                    <td onmouseover="doTrans_color(<%=i%>,1)" onmouseout="rollback_color(<%=i%>,1)" id="td_index_1" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td width="30"><div id="cal1_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td onmouseover="doTrans_color(<%=i%>,7)" onmouseout="rollback_color(<%=i%>,7)" id="td_index_7" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td width="40"><div id="cal7_3" align="left"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr id="biz"  style="display:none">
                    <td onmouseover="doTrans_color(5,1)" onmouseout="rollback_color(5,1)" id="td_index_1" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td  width="90"><div id="cal1_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,2)" onmouseout="rollback_color(5,2)" id="td_index_2" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td  width="90"><div id="cal2_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,3)" onmouseout="rollback_color(5,3)" id="td_index_3" style="cursor:hand" valign="top"><div align="right">
                        <table border="0"v>
                            ...
                            <tr>
                                <td  width="90"><div id="cal3_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,4)" onmouseout="rollback_color(5,4)" id="td_index_4" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td  width="90"><div id="cal4_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,5)" onmouseout="rollback_color(5,5)" id="td_index_5" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td  width="90"><div id="cal5_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,6)" onmouseout="rollback_color(5,6)" id="td_index_6" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td  width="90"><div id="cal6_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                    <td onmouseover="doTrans_color(5,7)" onmouseout="rollback_color(5,7)" id="td_index_7" style="cursor:hand" valign="top"><div align="right">
                        <table border="0" height="51" style='table-layout:fixed'>
                            ...
                            <tr>
                                <td width="90"><div id="cal7_3" align="right"  style='font-size:11px'>&nbsp;</div></td>
                            </tr>
                        </table>
                    </td>
                </tr>
		...
		<td class="paddingTop3">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td align="center" class="creamBold">오전반차:P,오후:R</td>
                    <td align="center" class="creamBold">미확인:S</td>
                    <td align="center" class="creamBold">여직원휴가:J</td>
                    <td align="center" class="creamBold">출 장:E</td>
                    <td align="center" class="creamBold">교 육:F</td>
                </tr>
                <tr>
                    <td align="center" class="creamBold">훈 련:G</td>
                    <td align="center" class="creamBold">특별휴가:I</td>
                    <td align="center" class="creamBold">대체휴가:T</td>
                    <td align="center" class="creamBold">대체반차:U</td>
                    <td align="center" class="creamBold">산전후휴가:X</td>
                    <td align="center" class="creamBold">파견근무:O</td>
                </tr>
            </table>
        </td>
    </tr>
