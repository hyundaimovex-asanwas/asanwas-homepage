...
<%
    String PIS_YM_SHR     	= request.getParameter("reg_ymd").replaceAll("-","");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="guna220.hnw">
              <param name="initvalue" VALUE="[:PIS_YY_SHR]=<%=PIS_YY_SHR%>[:PIS_MM_SHR]=<%=PIS_MM_SHR%>">
