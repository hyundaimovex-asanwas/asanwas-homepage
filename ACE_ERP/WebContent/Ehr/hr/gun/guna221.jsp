...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_Print() {
		...
		var reg_ymd = document.getElementById("txtREG_YMD_SHR").value;
		if(reg_ymd == ""){
			alert("날짜를 입력하세요");
		}
        //신규 모듈
        ...
        var url = "guna221_PV.jsp?reg_ymd="+reg_ymd;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    function fnc_OnLoadProcess() {
		document.getElementById("txtREG_YMD_SHR").value = getToday();
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">주간근태현황통계</td>
          <td align="right" class="navigator">HOME/근태관리/일일근태관리/<font color="#000000">주간근태현황통계</font></td>
        </tr>
      </table>
    </td>
  </tr>
