...
<%
    String PIS_YMD_SHR     	= request.getParameter("reg_ymd").replaceAll("-","");
	String PIS_YY_SHR		= PIS_YMD_SHR.substring(0,4);
	String PIS_MM_SHR		= PIS_YMD_SHR.substring(4, 6);
	String PIS_DD_SHR		= PIS_YMD_SHR.substring(6, 8);
%>
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="guna221.hnw">
              <param name="initvalue" VALUE="[:PIS_YY_SHR]=<%=PIS_YY_SHR%>[:PIS_MM_SHR]=<%=PIS_MM_SHR%>[:PIS_DD_SHR]=<%=PIS_DD_SHR%>[:PIS_YMD_SHR]=<%=PIS_YMD_SHR%>">
