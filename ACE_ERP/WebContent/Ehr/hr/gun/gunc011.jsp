    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_OnLoadProcess() {
            ...
            document.getElementById("hidGBN_CD").value      = "3";      //'' : 전체, '1' : 정규직원, '2' : 파견사원, '3' : 근태사원
        ...
        function fnc_Confirm() {
            if(dsAPPROVER.NameValue(1, "ENO_NO") == ""
                    || dsAPPROVER.NameValue(2, "ENO_NO") == "") {
                alert("본부장,부서장 결재선을 모두 지정해야 합니다.");
                return;
            }

            for(var i=1; i<=2; i++) {

                dataSet.NameString(i, "ENO_NO") = dsAPPROVER.NameValue(i, "ENO_NO");
                dataSet.NameString(i, "ENO_NM") = dsAPPROVER.NameValue(i, "ENO_NM");
                dataSet.NameString(i, "JOB_CD") = dsAPPROVER.NameValue(i, "JOB_CD");
                dataSet.NameString(i, "JOB_NM") = dsAPPROVER.NameValue(i, "JOB_NM");
                dataSet.NameString(i, "APP_YN_NM") = "미결";
                        ...
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="padding2423">
                                        <input id="txtDPT_CD_SHR" name="txtDPT_CD_SHR" size="3" maxlength="2" onChange="fnc_GetCommNm('A4', 'txtDPT_CD_SHR','txtDPT_NM_SHR')">
        ...
        <tr>
            <td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="creamBold">부서장</td>
                        <td align="center" class="creamBold">직위</td>
        ...
        <tr>
            <td class="paddingTop8">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <br>
                        <td valign="top" class="searchState">* 해당 결재선을 선택하면 부서장/본부장 순으로 지정됩니다.</span></td>
                    </tr>
                </table>
            </td>
        </tr>
