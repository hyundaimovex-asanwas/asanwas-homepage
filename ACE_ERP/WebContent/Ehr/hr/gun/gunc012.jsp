...
<html>
<head>
<title>휴일근무결과보고결재(gunc012)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_OnLoadProcess() {
			...
			document.getElementById("txtHOL_YMD_SHR").value = param.gun_ymd;
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">휴일근무결과보고결재</td>
                    ...
                    <table height="19" cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                <td width="100" rowspan="2" style="padding-left:0px; border-style:none">
                                    <input id="txtHOL_YMD_SHR" readonly size="10" maxLength="10" style="ime-mode:disabled" class="input_ReadOnly" readOnly>
							...
							<param name="Format"				value="
				                ...
				                <G>name=휴일근무결과 	HeadBgColor=#F7DCBB
                                 ...
                                 <G>name=대체휴가	 	HeadBgColor=#F7DCBB
                                  ...
                                  <C> id='HOL_AMT'      width=80            name='휴일수당'                         align=left      Edit=none                  </C>
