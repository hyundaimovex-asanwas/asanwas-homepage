...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        if ( gubun == "1" ) {
            ymd_val ="휴일근무 현황조회('" + reg_ymd.substr(2,2) + ". " + reg_ymd.substr(5,2) + "월 토요일)";
        } else if ( gubun == "2" ) {
            ymd_val ="휴일근무 현황조회('" + reg_ymd.substr(2,2) + ". " + reg_ymd.substr(5,2) + "월 총계)";
        }
        ...
        var url = "gunc050_PV.jsp?reg_ymd="+reg_ymd+"&gubun="+gubun+"&ymd_val="+ymd_val;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    function fnc_OnLoadProcess() {
	    document.form1.txtREG_YM_SHR.value = getToday().substring(0,7);
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">휴일근무현황비교</td>
          <td align="right" class="navigator">HOME/복리후생/국민연금/<font color="#000000">휴일근무현황비교</font></td>
        </tr>
      </table>
    </td>
  </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="padding2423">
                                    ...
                                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('img_YMD_SHR1','','/images/button/btn_HelpOver.gif',1)" onclick="calendarBtn('datetype2','txtREG_YM_SHR','','70','115');">
							    ...
							    <td class="padding2423" align="left">
								    <select id="cmbHOL_GBN_SHR" name="cmbHOL_GBN_SHR" style="width='180';">
                                        <option value="1">전월비교 토요일</option>
                                        <option value="2">전월비교 합계(토,일,휴일)</option>
                                    </select>
							    </td>
                            </tr>
                        </table>
