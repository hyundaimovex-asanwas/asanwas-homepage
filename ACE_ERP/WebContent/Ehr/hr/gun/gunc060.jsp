    ...
    *****************************-->
    ...
    function fnc_Print() {
        ...
        if ( gubun == "0" ) {
            ...
            ymd_val = "('" + reg_ymd.substr(2,2) + ". " + reg_ymd.substr(5,2) + "월 " + reg_ymd.substr(8,2) + "일)";
//            alert(ymd_val);
        } else {
            ...
            if ( gubun == "1" ) {
                ymd_val ="('" + reg_ymd.substr(2,2) + ". " + reg_ymd.substr(5,2) + "월 토요일)";
            } else if ( gubun == "2" ) {
                ymd_val ="('" + reg_ymd.substr(2,2) + ". " + reg_ymd.substr(5,2) + "월 일요일,휴일)";
            }
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">휴일근무현황통계</td>
          <td align="right" class="navigator">HOME/복리후생/국민연금/<font color="#000000">휴일근무현황통계</font></td>
        </tr>
      </table>
    </td>
  </tr>
                            ...
                            <tr>
							    ...
							    <td class="padding2423" align="left">
								    <select id="cmbHOL_GBN_SHR" name="cmbHOL_GBN_SHR" style="width='160';" onChange="fnc_Comchange(this.value)">
                                        ...
                                        <option value="1">월별 토요총괄</option>
                                        <option value="2">월별 일요총괄(공휴일)</option>
                                    </select>
							    </td>
                            </tr>
                        </table>
