...
*****************************************************
* @source       : gund060.jsp
* @description : 연차관리 PAGE
*****************************************************
* DATE            AUTHOR        DESCRIPTION
*----------------------------------------------------
* 2017/04/11      이동훈        최초 작성
*****************************************************
-->
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_DI_YEARLY.GridToExcel("연차확인", '', 225);
					...
					<td>
						...
						<object	id="grdT_DI_YEARLY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:540px;">
							...
							<param name="Format"				value="
								...
								<C> id='HEAD_NM'		width=120			name='본부'				align=center			Edit=None					</C>								
								...
								<C> id='YRP_CNT'		width=100			name='총연차'			align=center			Edit=None		decao=1		</C>
								<C> id='YRP_ATT_H'		width=100			name='사용연차'			align=center			Edit=None		decao=1		</C>
								<C> id='REM_YRP'		width=100			name='잔여연차'			align=center			Edit=None		decao=1		</C>
								<C> id='USE_PER'		width=100			name='사용률'			align=center			Edit=None	                </C>								
							">
						</object>
