    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_DI_MONTHLY.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.gun.d.gund080.cmd.GUND080CMD&S_MODE=SHR_DTL&ENO_NO="+eno_no;
			...
			<td>
				...
				<object	id="grdT_DI_MONTHLY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:400px;">
					...
					<param name="Format"				value="
						...
						<C> id='GET_DT'			width=120			name='생성일자'		align=center	mask='XXXX-XX-XX'</C>
						<C> id='GET_CNT'		width=80			name='생성누계'		align=center	</C>						
						<C> id='USE_DT'			width=120			name='사용일자'		align=center	mask='XXXX-XX-XX'</C>
						<C> id='USE_CNT'		width=80			name='사용누계'		align=center	</C>						
					">
				</object>
