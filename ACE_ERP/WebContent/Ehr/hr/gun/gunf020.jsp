...
*****************************************************
* @source       : gunf020.jsp
* @description : 일자별 근무 현황 PAGE
*****************************************************
* DATE            AUTHOR        DESCRIPTION
*----------------------------------------------------
* 2019/12/02      이동훈        최초 작성
*****************************************************
-->
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			//검색조건
			var pis_ymd = document.form1.txtPIS_YYMMDD.value.replaceStr("-","");	//기준일
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_DI_OVERTIMEWORK.GridToExcel("일자별 근무 현황", '', 225);
                    ...
                    <td align="center" class="blueTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
					            ...
					            <td align="center" class="blueBold">주차</td>
					...
					<td>
						...
						<object	id="grdT_DI_OVERTIMEWORK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:520px;">
							...
							<param name="Format"				value="
								...
								<C> id='STR_TIME'		width=150			name='시간외\\근무시작'		align=center			</C>
								<C> id='END_TIME'		width=150			name='시간외\\근무종료'		align=center			</C>								
