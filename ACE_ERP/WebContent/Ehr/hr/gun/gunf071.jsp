			...
			<td>
				...
				<object	id="grdT_DI_MONTHLY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:400px;">
					...
					<param name="Format"				value="
						...
						<C> id='WORK_STYLE'		width=150			name='근무형태'		align=center	</C>
						<C> id='SET_YMD'		width=150			name='적용일'		align=center	mask='XXXX-XX-XX'</C>	
						<C> id='IPT_MAN'		width=100			name='입력자'		align=center	</C>			
						<C> id='IPT_YMD'		width=150			name='입력일'		align=center	</C>
