...
<head>
    ...
    *****************************-->
    ...
    function fnc_SearchList()
    {
    	...
    	trT_DI_OVERTIMESCHEDULE.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.gun.f.gunf085.cmd.GUNF085CMD&S_MODE=SHR&REQ_NO=<%=req_no%>&ENO_NO=<%=eno_no%>";
	...
	function fnc_SubmitApproval(kind) {
		...
		trT_DI_OVERTIMESCHEDULE_STATE.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.gun.f.gunf085.cmd.GUNF085CMD&S_MODE=SAV";
		...
		<td style="padding-top:2px;">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grdT_DI_OVERTIMESCHEDULE" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:550px;">
