...
*****************************************************
* @source       : gunf090.jsp
* @description : 자동결재선 확인하는 PAGE
*****************************************************
* DATE            AUTHOR        DESCRIPTION
*----------------------------------------------------
* 2020/11/04      이동훈        최초 작성
*****************************************************
-->
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_DI_OVERTIMEWORK.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.gun.f.gunf090.cmd.GUNF090CMD&S_MODE=SHR&ENO_NO="+eno_no;
					...
					<td>
						...
						<object	id="grdT_DI_OVERTIMEWORK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:520px;">
							...
							<param name="Format"				value="
					           ...
					           <G> name='상신자'	HeadBgColor='#dae0ee'			
	                            <C> id=DPT_NM			width=80		name='소속'				align=center suppress=2</C>
	                            <C> id=TEAM_NM			width=170		name='현장/파트'			align=left </C>  
								<C> id=JOB_NM			width=100		name='직위'				align=center </C>   
								<C> id=ENO_NO			width=60		name='사번'				align=center </C>                   
								<C> id=ENO_NM			width=65		name='상신자'				align=center </C>
					           </G>				           
					           <G> name='결재자' 	HeadBgColor='#dae0ee'
	                            <C> id=HDPT_NM			width=80		name='소속'				align=center suppress=1</C> 
	                            <C> id=HTEAM_NM			width=170		name='현장/파트'			align=left </C> 	                            
								<C> id=HJOB_NM			width=70		name='직위'				align=center </C>   	                            
								<C> id=HENO_NO			width=60		name='사번'				align=center </C>    
								<C> id=HENO_NM			width=65		name='결재자'				align=center </C>
					           </G>
							">
						</object>
