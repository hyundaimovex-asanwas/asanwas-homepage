...
<%
    ...
    String sql = null;
    sql = XmlSqlUtils.getSQL("idt", "IDTA010_PRT1");
  	System.out.println(sql);


  	 System.out.println("7777 "+ENO_NO+" 77");
  	 System.out.println("7777 "+CEF_SEC+" 77");
    ...
    if (voList.size() > 0)
    {
        for (int i=0; i<voList.size(); i++)
        {
            ...
            hnwExtQuery.AddData(vo.getString("P_HNM"));
