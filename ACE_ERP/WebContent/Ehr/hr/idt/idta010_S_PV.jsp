...
<%
	...
	String REQ_NO     = request.getParameter("REQ_NO");
  	...
  	rpt_name = "idta010_S.hnw"; // 재직,퇴직,경력증명서
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="idta010_S.hnw">
              <param name="initvalue" VALUE="[:eno_no]=<%=eno_no%>[:gubun]=<%=gubun%>[:CEF_STS]=<%=CEF_STS%>[:REQ_NO]=<%=REQ_NO%>">
