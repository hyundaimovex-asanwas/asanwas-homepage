	            ...
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                <tr>
	                    <td align="center" class="blueTable">
	                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            <tr>
	                                <td align="center" class="searchState">등급 코드&nbsp;</td>
	                    ...
	                    <td>
	                        ...
	                        <object    id="grdT_CM_COMMON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:550px;height:300px;">
	                            ...
	                            <param name="Format"            value='
	                            	<C> id=JOB_CD		width=100	name=직위코드		align=center 	show=false</C>
	                            	<C> id=JOB_NM		width=100	name=직위			align=center 	suppress=1</C>	                            	
	                                <C> id=GRADE_CD		width=80    name=등급    		align=center	</C>
	                                
	                            	<C> id=P01_AMT		width=80	name=기본수당		align=right 	</C>
	                                <C> id=P02_AMT		width=80    name=시간외\\수당   align=right		</C>	                                
	                                
	                            	<C> id=P03_AMT		width=80	name=휴일수당		align=right 	</C>
	                                <C> id=P04_AMT		width=80    name=특수지\\수당   align=right 	</C>	                                
