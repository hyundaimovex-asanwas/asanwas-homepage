...
<jsp:include page="/Common/sys/body_s21.jsp"  flush="true"/>
	...
	<table width="1000" border="1" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <br>&nbsp;&nbsp;'갑'이 지정한 ()(으)로 하며, '갑'의 경영상 사정 또는 인사상 정책에 의하여 변경할 수 있다.<br>
          
          <br>&nbsp;&nbsp;<strong>제3조【 직종 및 직위】 </strong>
          <br>&nbsp;&nbsp;'을'은 직종:    , 직위:        으로 하며, 직종과 직위는 경영상의 필요 및 '을'의 업무능력 및 성과 등을 감안하여 취업규칙에 따라 변경할 수 있다.<br>
          
          <br>&nbsp;&nbsp;<strong>제4조【 담당업무】 </strong>
          <br>&nbsp;&nbsp;'을'의 담당업무는 '갑'이 정한 업무(   ) 및 그에 부수된 업무로 하며, '갑'은 업무상 필요에 따라 이를 변경할 수 있다. '을'은 이에 대하여 이의가 없으며, 
