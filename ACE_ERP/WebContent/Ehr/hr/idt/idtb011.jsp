    ...
    <script language="javascript" >
        ...
        function fnc_Save() {
            ...
            if(!fnc_SaveItemCheck()) {
	            ...
	            trT_CM_CONTRACT.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.idt.b.idtb010.cmd.IDTB010CMD&S_MODE=SAV&CD_GBN=1&ENO_NM="+document.getElementById("txtENO_NM_SHR").text;
	            //prompt('',dsT_CM_CONTRACT.text);
...
<jsp:include page="/Common/sys/body_s21.jsp"  flush="true"/>
	...
	<table width="1000" border="1" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <br>&nbsp;&nbsp;① 근로계약기간은 <input id="txtFROM_YMD" name="txtFROM_YMD" size="6"  style="ime-mode:disabled" >년 <input size="3" >월 <input size="3" >일부터 퇴사일까지로 한다.
          ...
          <br>&nbsp;&nbsp;<strong>제3조【 직종 및 직위】 </strong>
          <br>&nbsp;&nbsp;'을'은 직종:<input id="txtJOB_NM" name="txtJOB_NM" size="10" >, 직위:<input id="txtPOS_NM" name="txtPOS_NM" size="15" >으로 하며, 직종과 직위는 경영상의 필요 및 '을'의 업무능력 및 성과 등을 감안하여 취업규칙에 따라 변경할 수 있다.<br>
          ...
          <br>&nbsp;&nbsp;<strong>제5조【 근로시간 및 휴게시간】</strong>
          ...
          <br>&nbsp;&nbsp;<strong>제6조【 휴일】</strong>
          <br>&nbsp;&nbsp;주휴일 및 취업규칙에서 정한 날을 휴일로 한다.<br>
...
<OBJECT id=gcrp_print9  classid=clsid:CC26E2A9-760B-4EA6-8DDF-DB423FD24089 VIEWASTEXT>
  	<PARAM NAME="MasterDataID"			VALUE="dsT_CM_CONTRACT">
  	<PARAM NAME="DetailDataID"			VALUE="dsT_CM_CONTRACT">
...
<B>id=Header ,left=0,top=0 ,right=2000 ,bottom=2739 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='일부터 퇴사일 까지로 한다.' ,left=868 ,top=452 ,right=1677 ,bottom=489 ,align='left' ,face='문체부 바탕체' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='으로 하며, 직종과 직위는 경영상의 필요 및' ,left=968 ,top=826 ,right=1881 ,bottom=863 ,align='left' ,face='문체부 바탕체' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='③ 휴게시간은 점심시간 1시간으로 함.' ,left=66 ,top=1281 ,right=1881 ,bottom=1318 ,align='left' ,face='문체부 바탕체' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='② 시업 및 종업시각은 사업장 단위로 정하여 시행함.' ,left=66 ,top=1241 ,right=1881 ,bottom=1278 ,align='left' ,face='문체부 바탕체' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='주휴일 및 취업규칙에서 정한 날을 휴일로 한다.' ,left=66 ,top=1471 ,right=1881 ,bottom=1508 ,align='left' ,face='문체부 바탕체' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='WPLACE_NM', left=365, top=677, right=622, bottom=714, align='left', face='바탕', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
