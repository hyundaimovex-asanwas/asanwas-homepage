...
<%
String PIS_YM_SHR		= request.getParameter("PIS_YM_SHR");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="insa020.hnw">
              <param name="initvalue" VALUE="[:PIS_YM_SHR]=<%=PIS_YM_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>">
