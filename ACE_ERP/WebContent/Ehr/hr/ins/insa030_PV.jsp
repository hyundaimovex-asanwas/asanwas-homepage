<!--
***********************************************************************
* @source      : insa030_PV.jsp
* @description : 출장품의신청현황 PAGE
***********************************************************************
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="insa030.hnw">
              <param name="initvalue" VALUE="[:eno_no]=<%=eno_no%>[:job_nm]=<%=job_nm%>[:eno_nm]=<%=eno_nm%>[:dpt_nm]=<%=dpt_nm%>[:hir_ymd]=<%=hir_ymd%>[:cet_no]=<%=cet_no%>[:str_yy]=<%=str_yy%>[:end_yy]=<%=end_yy%>">
