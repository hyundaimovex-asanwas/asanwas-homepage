...
<script language="JavaScript" src="/common/ezgencontrol.js"></script>
...
<comment id="__NSID__">
				<object classid="clsid:2E68BEE5-A640-11D2-AEA4-00AA006E5B34" width=800 height=400
     codebase="/cabfiles/hnwactiv_5_0_0_10.cab#version=5,0,0,10">

              <param name="hnwsrc"    VALUE="insa040.hnw">
              <param name="initvalue" VALUE="[:PIS_YY_SHR]=<%=PIS_YY_SHR%>[:PIS_MM_SHR]=<%=PIS_MM_SHR%>[:DPT_CD_SHR]=<%=DPT_CD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:DPT_NM_SHR]=<%=DPT_NM_SHR%>">
