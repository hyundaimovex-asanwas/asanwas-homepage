...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_Save() {
			...
			trT_CM_PERSON.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.a.insa050.cmd.INSA050CMD&S_MODE=SAV";
			trT_CM_PERSON.post();
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_CM_PERSON,15,"true","false");      // Grid Style 적용
         ...
         ****************************/
         function fnc_FileUpload() {
            ...
            if(dsFILE_UPLOAD.NameValue(1, "FILE_URL") != ""){
                ...
                trFILE_UPLOAD.action   = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.a.insa050.cmd.INSA050CMD&S_MODE=ULD";
                trFILE_UPLOAD.post();
    ...
    ***************************************************************************************-->
	...
	<script language=JavaScript for=dsT_CM_PERSON event=CanRowPosChange(row)>
		...
		if ( dsT_CM_PERSON.NameValue(row,"NPEN_AMT") == "" ) {
			alert("[ " + grdT_CM_PERSON.GetHdrDispName('-3','NPEN_AMT') + " ]은 필수 입력사항입니다");
			return false;
		}
	</script>
				...
				<tr align="center">
					...
					<object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:520px;">
						...
						<param name="Format" value='
							<C> id="{CUROW}"		width=50	name="N0"				align=center	value={String(Currow)}</C>
							<C> id="ENO_NM"			width=250	name="성명"			align=center	Edit=none</C>
							<C> id="ENO_NO"			width=300	name="사번"			align=center	Edit=none</C>
							<C> id="NPEN_AMT"		width=300	name="금액"			align=center	Edit=none</C>
						'>
					</object>
