    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            if(document.tabINSB020.ActiveIndex==1){
                dsT_CM_PERSON_01.dataid = "/servlet/GauceChannelSVL?cmd=hr.ins.b.insb020.cmd.INSB020CMD&S_MODE=SHR_01&STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&OCC_CD_SHR="+OCC_CD_SHR;
                dsT_CM_PERSON_01.reset();
            } else if(document.tabINSB020.ActiveIndex==2){
                dsT_CM_PERSON_02.dataid = "/servlet/GauceChannelSVL?cmd=hr.ins.b.insb020.cmd.INSB020CMD&S_MODE=SHR_02&STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&OCC_CD_SHR="+OCC_CD_SHR;
                dsT_CM_PERSON_02.reset();
            } else if(document.tabINSB020.ActiveIndex==3){
                dsT_CM_PERSON_03.dataid = "/servlet/GauceChannelSVL?cmd=hr.ins.b.insb020.cmd.INSB020CMD&S_MODE=SHR_03&STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&OCC_CD_SHR="+OCC_CD_SHR;
        ...
        function fnc_Save() {
			if(document.tabINSB020.ActiveIndex == 1){
	            if (confirm("취득자의 등급을 변경하시겠습니까?") == false) return;

				// save
				trT_CM_PERSON_SAV.KeyValue = "service_tr06(I:dsT_CM_PERSON_01=dsT_CM_PERSON_01)";
				trT_CM_PERSON_SAV.action   = "/servlet/GauceChannelSVL?cmd=hr.ins.b.insb020.cmd.INSB020CMD&S_MODE=SAV";
        ...
        function fnc_Print() {
            ...
            if(document.tabINSB020.ActiveIndex==1){
	            var url = "insb020_PV.jsp?str_ymd="+str_ymd_shr+"&end_ymd="+end_ymd_shr+"&occ_cd="+occ_cd+"&ymd_val="+ymd_val;
    	        window.open(url,"","width=1050,height=700,left=0,top=0,scrollbars=yes,status=yes,resizable=yes");
        	    return;
			} else if(document.tabINSB020.ActiveIndex==2){
				var url = "insb020_PV_1.jsp?str_ymd="+str_ymd_shr+"&end_ymd="+end_ymd_shr+"&occ_cd="+occ_cd+"&ymd_val="+ymd_val;
    	        window.open(url,"","width=1050,height=700,left=0,top=0,scrollbars=yes,status=yes,resizable=yes");
        	    return;
            } else if(document.tabINSB020.ActiveIndex==3){
            	var url = "insb020_PV_2.jsp?str_ymd="+str_ymd_shr+"&end_ymd="+end_ymd_shr+"&occ_cd="+occ_cd+"&ymd_val="+ymd_val;
    	        window.open(url,"","width=1050,height=700,left=0,top=0,scrollbars=yes,status=yes,resizable=yes");
        	    return;
        ...
        function fnc_ToExcel() {
            ...
            if(document.tabINSB020.ActiveIndex==1){
                ...
                form1.grdT_CM_PERSON_01.GridToExcel("건강보험신고내역서(취득자)", '', 225)
            } else if (document.tabINSB020.ActiveIndex==2){
                if (dsT_CM_PERSON_02.CountRow < 1) {
                    alert("엑셀로 변환할 자료가 없습니다!");
                    return;
                }
                form1.grdT_CM_PERSON_02.GridToExcel("건강보험신고내역서(상실자)", '', 225)
            } else {
                if (dsT_CM_PERSON_03.CountRow < 1) {
                    alert("엑셀로 변환할 자료가 없습니다!");
                    return;
                }
                form1.grdT_CM_PERSON_03.GridToExcel("건강보험신고내역서(보직변경자)", '', 225)
            }
        }
        ...
        function fnc_OnLoadProcess() {
            ...
            //화면겹침버그 임시 해결
            document.tabINSB020.ActiveIndex=2;
            document.tabINSB020.ActiveIndex=1;
...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15" marginwidth="0" marginheight="0" scroll=auto onkeydown="fnc_HotKey();" onload="fnc_OnLoadProcess();">
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">건강보험신고내역서</td>
                    <td align="right" class="navigator">HOME/복리후생/국민연금/<font color="#000000">건강보험신고내역서</font></td>
                </tr>
            </table>
            </td>
        </tr>
    ...
    <!-- 탭 사용 컴퍼넌트 시작 -->
    <comment id="__NSID__">
    <object id=tabINSB020 classid=CLSID:6BA6E0F6-E3A1-45ED-9E03-CBFC682EC63C
        ...
        <param  name="Format"
                value='
                    <T>divid="tabINSB020_01"    title="취득자"</T>
                    <T>divid="tabINSB020_02"    title="상실자"</T>
                    <T>divid="tabINSB020_03"    title="보직변경자"</T>
                    '>
    </object>
    </comment><script> __ShowEmbedObject(__NSID__); </script>

    <!-- 탭1 조건 입력 테이블 시작 -->
    <div class=page id="tabINSB020_01" style="position:absolute; left:20; top:175; width:800; height:300; z-index:3;" >
                ...
                <tr align="center">
                    ...
                    <object id="grdT_CM_PERSON_01" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
                        ...
                        <param name="Format" value='
                            ...
                            <C> id="DPT_NM"         width=110   name="소속"           align=left      Edit=none   SubBgColor="#99FFCC"    leftMargin="10"</C>
                            ...
                            <C> id="CET_NO"         width=100   name="주민번호"         align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id="ZIP_NO"         width=60    name="우편번호"         align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id="ADDRESS"        width=280   name="주소"           align=left     Edit=none   SubBgColor="#99FFCC"    leftMargin="10"</C>
                            <C> id="STDB_AMT"       width=90    name="표준보수월액"       align=right     Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id="HINU_AMT"       width=90    name="건강보험료"          align=right    Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id="HIRG_YMD"       width=80    name="자격취득일"        align=center    Edit=none   SubBgColor="#99FFCC"</C>
                        '>
                    </object>
                    </comment><script> __ShowEmbedObject(__NSID__); </script>
                    </td>
    ...
    <!-- 탭2 조건 입력 테이블 시작 -->
    <div class=page id="tabINSB020_02" style="position:absolute; left:20; top:175; width:800; height:300; z-index:2; visibility:hidden">
                ...
                <tr align="center">
                    ...
                    <object id="grdT_CM_PERSON_02" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
                        ...
                        <param name="Format" value='
                            ...
                            <C> id="HIU_NO"         width=90    name="증번호"           align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id="ENO_NM"         width=60    name="성명"           align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id="CET_NO"         width=120   name="주민번호"     align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id="ZIP_NO"         width=60    name="우편번호"     align=right     Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id="ADDRESS"        width=280   name="주소"       align=left       Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id="PHN_NO"         width=80    name="전화번호"           align=left      Edit=none   SubBgColor="#99FFCC"    leftMargin="10"</C>
                            <C> id="RET_YMD"        width=80    name="자격상실일"        align=center    Edit=none   SubBgColor="#99FFCC"</C>
                        '>
                    </object>
                    </comment><script> __ShowEmbedObject(__NSID__); </script>
                    </td>
    ...
    <!-- 탭3 조건 입력 테이블 시작 -->
    <div class=page id="tabINSB020_03" style="position:absolute; left:20; top:175; width:800; height:300; z-index:2; visibility:hidden">
                ...
                <tr align="center">
                    ...
                    <object id="grdT_CM_PERSON_03" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
                        ...
                        <param name="Format" value='
                            ...
                            <C> id=ENO_NM             width=60    name="성명"           align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id=CET_NO             width=120   name="주민번호"         align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id=CHANGE_YMD         width=80    name="변경일"         align=right     Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id=CHANGE_DPT_NM      width=110   name="변경전 부서"           align=center     Edit=none   SubBgColor="#99FFCC"    leftMargin="10"</C>
                            <C> id=CHANGE_JOB_NM      width=90    name="변경전 직위"           align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id=CHANGE_AMT         width=90    name="변경전 금액"         align=right     Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                            <C> id=BEFORE_DPT_NM      width=110   name="변경후 부서"        align=center    Edit=none   SubBgColor="#99FFCC"</C>
                            <C> id=BEFORE_JOB_NM      width=90    name="변경후 직위"           align=center      Edit=none   SubBgColor="#99FFCC"    leftMargin="10"</C>
                            <C> id=BEFORE_AMT         width=90    name="변경후 금액"           align=right      Edit=none   SubBgColor="#99FFCC"    RightMargin="10"</C>
                        '>
                    </object>
                    </comment><script> __ShowEmbedObject(__NSID__); </script>
                    </td>
