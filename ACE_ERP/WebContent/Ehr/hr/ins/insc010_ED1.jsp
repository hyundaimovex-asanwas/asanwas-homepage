...
<%
    ...
    String sql = XmlSqlUtils.getSQL("ret", "RETA030_SHR_PAY");
    ...
    String 	colStr  =   "WORKING_DATE,BAS_AMT,DUTY_AMT,OT_AMT,WEL_AMT,OSE_AMT,RUN_AMT,MH_AMT,OTH_AMT,LSEV_AMT,PIS_YY,PIS_MM,LAST_DAY,PAST_DAY";
