...
<html>
<head>
	<title>회사지원 산재보험료갱신(insc030)</title>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_Save() {
			...
			trT_CM_PERSON.action = "/servlet/GauceChannelSVL?cmd=hr.ins.c.insc030.cmd.INSC030CMD&S_MODE=SAV";
			trT_CM_PERSON.post();
        }
         ...
         ****************************/
         function fnc_FileUpload() {
            ...
            if(dsFILE_UPLOAD.NameValue(1, "FILE_URL") != ""){
                ...
                trFILE_UPLOAD.action   = "/servlet/GauceChannelSVL?cmd=hr.ins.c.insc030.cmd.INSC030CMD&S_MODE=ULD";
                trFILE_UPLOAD.post();
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">회사지원 산재보험료갱신</td>
					<td align="right" class="navigator">HOME/복리후생/고용보험/<font color="#000000">회사지원 산재보험료갱신</font></td>
				</tr>
			</table>
			</td>
		</tr>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
    				<tr>
                        ...
                        <td width="80" style="padding-right:5px; padding-top:2px;">
                            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('btnExcelform','','/images/button/btn_ExcelformOver.gif',1)"><img src="/images/button/btn_ExcelformOn.gif" name="btnExcelform" border="0" onclick="cfDownload('회사지원 산재보험료.xls', '<%=FILEURL %>/insc030.xls');"></a>
                        </td>
				...
				<tr align="center">
					...
					<object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:420px;">
						...
						<param name="Format" value='
							...
							<C> id="ENO_NM"		width=200	name="성명"						align=center	Edit=none</C>
							<C> id="ENO_NO"		width=200	name="사번"						align=center	Edit=none</C>
							<C> id="AVR_SAL"	width=290	name="회사지원 산재보험료"	    align=right     Edit=none      rightmargin=10</C>
						'>
					</object>
