    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            dsT_CM_PERSON.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.e.inse010.cmd.INSE010CMD&S_MODE=SHR";
            dsT_CM_PERSON.Reset();
        ...
        function fnc_Save() {
			...
			trT_CM_PERSON.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.e.inse010.cmd.INSE010CMD&S_MODE=SAV";
			trT_CM_PERSON.post();
         ...
         ****************************/
         function fnc_FileUpload() {
            ...
            if(dsFILE_UPLOAD.NameValue(1, "FILE_URL") != ""){
                ...
                trFILE_UPLOAD.action   = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.e.inse010.cmd.INSE010CMD&S_MODE=ULD";
                trFILE_UPLOAD.post();
				...
				<tr align="center">
					...
					<object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:520px;">
						...
						<param name="Format" value='
							...
							<C> id="ENO_NM"			width=300	name="성명"				align=center	Edit=none</C>
							<C> id="ENO_NO"			width=300	name="사번"				align=center	Edit=none</C>
							<C> id="INSU_AMT"		width=300	name="보증보험료"	    align=right     Edit=none      rightmargin=10</C>
						'>
					</object>
