...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    *****************************-->
    <script language="javascript" >
        ...
        var dataClassName = "../../../servlet/GauceChannelSVL?cmd=Ehr.ins.f.insf010.cmd.INSF010CMD";
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_SV_SAVELIST,15,"false","false")      // Grid Style 적용
        }
    ...
    **************************************-->
    ...
    <script for=grdT_SV_SAVELIST event=OnDblClick(Row,Colid)>
		...
		if(Row < 1) {
			...
			//window.showModalDialog("../../../Ehr/hr/ins/insf011.jsp?ENO_NO="+oENO_NO+"&ACC_NO="+oACC_NO+"&SAV_CD="+oSAV_CD+"&BNK_CD="+oBNK_CD, "", "dialogWidth:670px; dialogHeight:530px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
...
<!-- 계약사항 -->
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    <td class="blueBold" align="center" rowspan="3">계약사항</td>
                    <td class="blueBold" align="center">계약 종류</td>
                    <td class="padding2423">
                        <select id="cmbSAV_CD2" name="cmbSAV_CD2" style="width:130;">
                            <option value="0">모두</option>
                        </select>
                    </td>
                    <td class="blueBold" align="center">계 약 일</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">만 기 일</td>
                    <td class="padding2423">
                ...
                <tr>
                    <td class="blueBold" align="center">월불입액</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">할 인 율</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">할 인 액</td>
                    <td class="padding2423">
                ...
                <tr>
                    <td class="blueBold" align="center">실월불입액</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">기타불입액</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">기타공제액</td>
                    <td class="padding2423">
...
<!-- 누적사항 -->
                <tr>
                    <td class="blueBold" align="center">누적사항</td>
                    <td class="blueBold" align="center">누적불입액</td>
                    <td class="padding2423">
...
<!-- 해약사항 -->
                <tr>
                    <td class="blueBold" align="center">해약사항</td>
                    <td class="blueBold" align="center">해약여부</td>
                    <td class="padding2423">
                    ...
                    <td class="blueBold" align="center">해 약 일</td>
                    <td class="padding2423" colspan="3">
		...
		<td style="padding-top:2px;">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grdT_SV_SAVELIST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:360px;">
