    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdGT_EV_QSTANS.GridToExcel("직원설문결과", '', 225)
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">직원설문결과</td>
                    <td align="right" class="navigator">HOME/직무이동/직무이동현황/<font color="#000000">직원설문결과</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdGT_EV_QSTANS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"              value="
                                <C> id='QST_ITEM_SNM'         width=199   name='설문항목'  align=left   HeadBgColor='#F7DCBB' Suppress=1 </C>
                                <R>
                                    <G> name=$xkeyname_$$     HeadBgColor='#F7DCBB'
                                        <C> id='DPT_NM_$$'    width=150   name='소속'      align=left   HeadBgColor='#F7DCBB' </C>
                                        <C> id='CNT_$$'       width=70    name='인원'      align=center HeadBgColor='#F7DCBB' </C>
                ...
                <tr align="center">
                    <td>
                        ...
                        <object    id="grdT_EV_QSTANS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:0px;">
                            ...
                            <param name="Format"           value="
                                <C> id='QST_ITEM_SNM'      width=120    name='설문항목'  align=left  </C>
                                <C> id='RNUM'              width=120    name='순서'      align=left  </C>
                                <C> id='ANS'               width=100    name='답변'      align=right </C>
                                <C> id='DPT_NM'            width=100    name='소속'      align=right </C>
                                <C> id='CNT'               width=100    name='인원'      align=left  </C>
