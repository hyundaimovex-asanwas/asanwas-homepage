...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_EV_QSTANS.DataId = "/servlet/GauceChannelSVL?cmd=hr.job.b.jobb040.cmd.JOBB040CMD&S_MODE=SHR&PIS_YYMM="+PIS_YYMM+"&OCC_CD="+OCC_CD;
            dsT_EV_QSTANS.Reset();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdGT_EV_QSTANS.GridToExcel("응답현황총괄표", '', 225)
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_EV_QSTANS,0,"false","false");
    ...
    ***************************************************************************************-->
    ...
    <Object ID="dsGT_EV_QSTANS" Classid="CLSID:2506B38B-0FF7-4249-BA3E-8BC1DC399FBB">
        ...
        <Param Name="GroupExpr"      Value="DPT_NM:TTOT_CNT:TDPT_CNT, JOB_NM, DTOT_CNT:DDPT_CNT">
    </Object>
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="right" class="navigator">HOME/직무이동/직무이동현황/<font color="#000000">응답현황총괄표</font></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="paddingTop3">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
                        <comment id="__NSID__">
                        <object    id="grdGT_EV_QSTANS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:310px;">
                            <param name="DataID"              value="dsGT_EV_QSTANS">
                            <param name="IndWidth"            value=0>
                            <param name="Format"              value="
                                <FC> id='DPT_NM'              width=120   name='소속'      align=center HeadBgColor='#F7DCBB' </FC>
                                <R>
                                    <G> name=$xkeyname_$$  HeadBgColor='#F7DCBB'
                                        <C> id='DTOT_CNT_$$'  width=55    name='대상인원'    align=right  HeadBgColor='#F7DCBB' Value={Decode(DTOT_CNT_$$,'0','',DTOT_CNT_$$)} </C>
                                        <C> id='DDPT_CNT_$$'  width=55    name='응답인원'  align=right  HeadBgColor='#F7DCBB' Value={Decode(DDPT_CNT_$$,'0','',DDPT_CNT_$$)} </C>
                                    </G>
                                </R>
                                <G> name='합계'  HeadBgColor='#F7DCBB'
                                    <C> id='TTOT_CNT'         width=55    name='대상인원'    align=right  HeadBgColor='#F7DCBB' Value={Decode(TTOT_CNT,'0','',TTOT_CNT)} </C>
                                    <C> id='TDPT_CNT'         width=55    name='응답인원'  align=right  HeadBgColor='#F7DCBB' Value={Decode(TDPT_CNT,'0','',TDPT_CNT)} </C>
                                </G>
                            ">
                        </object>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_QSTANS" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:0px;">
                            ...
                            <param name="Format"              value="
                                ...
                                <C> id='TTOT_CNT'             width=100   name='대상인원'        align=center </C>
                                <C> id='TDPT_CNT'             width=100   name='응답인원'      align=center </C>
                                <G> name='응답인원'  HeadBgColor='#F7DCBB'
                                    <C> id='JOB_NM'           width=55    name='직위'      align=right HeadBgColor='#F7DCBB' </C>
                                    <C> id='DTOT_CNT'         width=55    name='대상인원'    align=right HeadBgColor='#F7DCBB' </C>
                                    <C> id='DDPT_CNT'         width=55    name='응답인원'  align=right HeadBgColor='#F7DCBB' </C>
                                </G>
                            ">
                        </object>
                        </comment><script> __ShowEmbedObject(__NSID__); </script>
