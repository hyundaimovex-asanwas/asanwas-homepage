...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="lawa030.hnw">
              <param name="initvalue" VALUE="[:HEAD_CD_SHR]=<%=HEAD_CD_SHR%>[:BOND_GBN_SHR]=<%=BOND_GBN_SHR%>[:ORD_YMD_STR_SHR]=<%=ORD_YMD_STR_SHR%>[:ORD_YMD_END_SHR]=<%=ORD_YMD_END_SHR%>">
