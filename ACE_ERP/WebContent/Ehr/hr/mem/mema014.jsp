    ...
    ******************************************************
    ...
    <script language="javascript" >
        ...
        function fnc_Delete() {
            ...
            if (confirm("학력구분[" + dsT_ME_SCHOOL.NameValue(dsT_ME_SCHOOL.RowPosition,"EDGR_NM") + "] 자료를 제거하시겠습니까?") == false) return;
        ...
        function fnc_SaveItemCheck() {
            ...
            for ( i = 1; i <= dsT_ME_SCHOOL.CountRow; i++ ) {
                if ( dsT_ME_SCHOOL.RowStatus(i) == 1 ||
                    ...
                    // 입학일 CHECK
                    if (!fnc_CheckDate2(dsT_ME_SCHOOL.NameValue(i, "GURS_YMD"), "입학일") && dsT_ME_SCHOOL.NameValue(i, "GURS_YMD") != "") {
                        dsT_ME_SCHOOL.RowPosition = i;
                    ...
                    // 졸업일 CHECK
                    if (!fnc_CheckDate2(dsT_ME_SCHOOL.NameValue(i, "GURE_YMD"), "졸업일") && dsT_ME_SCHOOL.NameValue(i, "GURE_YMD") != "") {
                        dsT_ME_SCHOOL.RowPosition = i;
    ...
    **************************************-->
    ...
    <Script For=dsT_ME_SCHOOL Event="OnDataError()">
        ...
        if (this.ErrorCode == 50018 ) {
            alert("해당 필수입력항목[학력구분/입 학 일/졸업구분] 입력 후 다음 작업이 가능합니다.");
        }
        ...
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td align="center" class="creamBold">입 학 일</td>
                    <td class="padding2423" >
                        <input id="txtGURS_YMD" style="width:80%;ime-mode:disabled" maxlength="10" onChange="fnc_CheckDate(this, '입학일');" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                    ...
                    <td class="padding2423" >
                        <input id="txtGURE_YMD" style="width:80%;ime-mode:disabled" maxlength="10" onChange="fnc_CheckDate(this, '졸업일');" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                ...
                <tr>
                    <td align="center" class="creamBold">학교코드</td>
                    <td class="padding2423">
                    ...
                    <td align="center" class="creamBold">전공코드</td>
                    <td class="padding2423">
                    ...
                    <td align="center" class="creamBold">졸업코드</td>
                    <td class="padding2423">
                    ...
                    <td>
                        ...
                        <object id="grdT_ME_SCHOOL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:794px;height:178px;">
                            ...
                            <param name="Format"                  value="
                                <C> id={currow}        width=37   name='순번'         align=center </C>
                                <C> id=EDGR_CD         width=55   name='코드'         align=center </C>
                                <C> id=EDGR_NM         width=70   name='학력구분'                  </C>
                                <C> id=GURS_YMD        width=80   name='입 학 일'     align=center </C>
                                <C> id=GURE_YMD        width=80   name='졸 업 일'     align=center </C>
                                <C> id=SCH_CD          width=55   name='코드'         align=center </C>
                                <C> id=SCH_NAM         width=90   name='학교'                      </C>
                                <C> id=MAJ_CD          width=55   name='코드'         align=center </C>
                                <C> id=MAJ_NM          width=90   name='전공'                      </C>
                                <C> id=GRD_CD          width=55   name='코드'         align=center </C>
                                <C> id=GRD_NM          width=90   name='졸업구분'                  </C>
                            ">
                        </object>
