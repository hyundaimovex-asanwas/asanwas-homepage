...
<html>
<head>
<title>파견사원 근무수당 현황(memb030)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        document.form1.aaa.OpenHnw("/hr/mem/memb030.hnw",param);
        biz.style.display = "";
        f.flag.value = "Y";   // 인쇄조건.
    }
 ...
 //           form1.aaa.SetValue('eee','rrrrrrrrrrr');
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    function fnc_OnLoadProcess() {
        document.getElementById("txtSTR_YMD_SHR").value = getTodayArray()[0]+"-"+getTodayArray()[1];
     }
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견사원 근무수당 현황</td>
          <td align="right" class="navigator">HOME/인사관리/파견사원/<font color="#000000">파견사원 근무수당 현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
        ...
        <td width="800">
            <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
                <comment id="__NSID__">
                    ...
                    <!-- param name="hnwsrc"    VALUE="memb030.hnw" -->
