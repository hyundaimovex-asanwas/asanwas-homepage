...
<html>
    ...
    <head>
    <title>파견대상업무코드관리(memb060)</title>
    ...
    ******************************************************
    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            try {
                dsT_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.mem.b.memb060.cmd.MEMB060CMD&S_MODE=SHR&COMM_CD="+f.txtCOMM_CD_SHR.value;
                dsT_CM_COMMON.Reset();
        ...
        function fnc_Save() {
            ...
            if(fnc_SaveItemCheck()) {
                ...
                tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.mem.b.memb060.cmd.MEMB060CMD&S_MODE=SAV";
        ...
        function fnc_Delete() {
            ...
            tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.mem.b.memb060.cmd.MEMB060CMD&S_MODE=DEL";
            tr01T_CM_COMMON.post();
        }
    ...
    **************************************-->
    ...
    <script for=grdT_CM_COMMON event=OnClick(Row,Colid)>
        ...
        if(Row < 1) {
            ...
            try {
                ds01T_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.mem.b.memb060.cmd.MEMB060CMD&S_MODE=SHR_01&"+overId+"="+overValue;
                ds01T_CM_COMMON.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견대상업무코드관리</td>
                    <td align="right" class="navigator">HOME/인사관리/파견사원/<font color="#000000">파견대상업무코드관리</font></td>
                </tr>
            </table>
        </td>
    </tr>
