...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        if ( f.gubun[0].checked == true ) {
            gubun    = "1";
            page_val = "Page1";
        }
        else if ( f.gubun[1].checked == true ) {
            gubun    = "2";
            page_val = "Page2";
        }
       
        param = "[@InitPage]=" + page_val + "[:str_ymd]=" + str_ymd + "[:end_ymd]=" + end_ymd + "[:gubun]=" + gubun;

        document.form1.aaa.OpenHnw("/hr/mem/memb070.hnw",param);
//        biz.style.display = "";
        f.flag.value = "Y";   // 인쇄조건.
    }
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견사원 입퇴사자 조회</td>
          <td align="right" class="navigator">HOME/인사관리/파견사원/<font color="#000000">파견사원 입퇴사자 조회</font></td>
        </tr>
      </table>
    </td>
  </tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="padding2423">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <INPUT TYPE="radio" NAME="gubun" VALUE="1" checked>입사자
                                    <INPUT TYPE="radio" NAME="gubun" VALUE="2">퇴사자
                                </td>
							</tr>
                            </tr>
						</table>
        ...
        <td width="800">
            <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
                <comment id="__NSID__">
                    ...
                    <param name="hnwsrc"    VALUE="null_not.hnw">
