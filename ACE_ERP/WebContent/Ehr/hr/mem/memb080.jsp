...
<html>
<head>
<title>파견사원 입,퇴사자 현황(memb080)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        document.form1.aaa.OpenHnw("/hr/mem/memb080.hnw",param);
//        biz.style.display = "";
        f.flag.value = "Y";   // 인쇄조건.
    }
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견사원 입퇴사자 현황</td>
          <td align="right" class="navigator">HOME/인사관리/파견사원/<font color="#000000">파견사원 입퇴사자 현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
