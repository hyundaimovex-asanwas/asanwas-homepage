...
<html>
<head>
<title>부서별 파견사원 현황(memb120)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        document.form1.aaa.OpenHnw("/hr/mem/memb120.hnw",param);
        biz.style.display = "";
        f.flag.value = "Y";   // 인쇄조건.
    }
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">부서별 파견사원 현황</td>
          <td align="right" class="navigator">HOME/인사관리/파견사원/<font color="#000000">부서별 파견사원 현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
        ...
        <td width="800">
            <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
                <comment id="__NSID__">
                    ...
                    <!-- param name="hnwsrc"    VALUE="memb070.hnw" -->
