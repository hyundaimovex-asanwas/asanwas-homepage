		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">직위별인원현황</td>
					<td align="right" class="navigator">HOME/경영정보/인원현황/<font color="#000000">직위별 인원현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="left" class="padding2423">
                                    &nbsp;&nbsp;
                                    <input type="radio" name="rdoGBN_CASE" id="rdoGBN_CASE" style="margin-bottom:-2px;border:0;">전체&nbsp;&nbsp;
									...
									-->
                                    <input type="radio" name="rdoGBN_CASE" id="rdoGBN_CASE" style="margin-bottom:-2px;border:0;">부서별
                                </td>
                            </tr>
                        </table>
                    </td>
