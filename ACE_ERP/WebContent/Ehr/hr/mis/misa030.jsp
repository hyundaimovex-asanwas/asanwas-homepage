...
<html>
<head>
<title>연도별 인원변동추이(misa030)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        var hnwparm = "[Edit_yyyy_fr]="+STR_YMD+"[Edit_yyyy_to]="+END_YMD;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    document.getElementById('txtSTR_YMD_SHR').value = getToday().substring(0,4) - 5;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">연도별 인원변동추이</td>
					<td align="right" class="navigator">HOME/경영정보/인원현황/<font color="#000000">연도별 인원변동추이</font></td>
				</tr>
			</table>
			</td>
		</tr>
...
<!-- power Search테이블 끝 -->
        ...
        <comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misa030.hnw">
