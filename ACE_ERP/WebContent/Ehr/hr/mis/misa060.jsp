...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        var STR_YMD = f.txtYYYY_SHR.value;
        var CH      = f.txtCH_SHR.value;
      	if( document.form1.rdoGBN_CD[0].checked ){
       		var GBN_CD = "SCNAME";
      	} else if( document.form1.rdoGBN_CD[1].checked ){
       		var GBN_CD = "SIKUKN";
      	} else if( document.form1.rdoGBN_CD[2].checked ){
       		var GBN_CD = "SEXGU";
      	}
        var hnwparm = "[Edit_yyyy]="+STR_YMD+"[Edit_ch]="+CH+"[Group GBN_CD]="+GBN_CD;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    document.getElementById('txtYYYY_SHR').value = getToday().substring(0,4);
     }
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="right" class="navigator">HOME/경영정보/인원현황/<font color="#000000">입사지원현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="searchState" align="center" class="creamBold" width="56">년도</td>
                                <td class="padding2423" width = "78">
                                    <input type="text" id="txtYYYY_SHR"  name="txtSTR_YMD_SHR" style="ime-mode:disabled" size="6" value="" maxlength="4" onblur="fncCheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                                ...
                                <td class="searchState" align="center" class="creamBold" width="56">차수</td>
                                <td class="padding2423" width = "64">
                                    <input type="text" id="txtCH_SHR"  name="txtCH_SHR" style="ime-mode:disabled" size="4" value="01" maxlength="2" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                                </td>
                                <td>
                                    <table width="100%" border="1" cellspacing="0" cellpadding="0" width="240">
                                        <tr>
                                            <td width="240" align="center">
                                            <input type="radio" name="rdoGBN_CD" id="rdoGBN_CD" style="margin-bottom:-2px;border:0;" checked>학교별&nbsp;&nbsp;
                                            <input type="radio" name="rdoGBN_CD" id="rdoGBN_CD" style="margin-bottom:-2px;border:0;">지역별&nbsp;&nbsp;
                                            <input type="radio" name="rdoGBN_CD" id="rdoGBN_CD" style="margin-bottom:-2px;border:0;">남여구분
                                            </td>
                                        </tr>
                                    </table>
								</td> 
...
<!-- power Search테이블 끝 -->
        ...
        <comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misa060.hnw">
