...
<html>
<head>
<title>파견사원입퇴사자현황(misa070)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        var hnwparm = "[:PIS_YYYY_FR]="+STR_YMD+"[:PIS_YYYY_TO]="+END_YMD;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    var yyyy = getToday().substring(0,4) - 1;
    var mm   = Number(getToday().substring(5,7)) + 1;
    if (mm < "10") {
        mm = "0" + mm;
    }
	document.getElementById('txtSTR_YMD_SHR').value = yyyy + "-" + mm;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">파견사원입퇴사자현황</td>
					<td align="right" class="navigator">HOME/경영정보/인원현황/<font color="#000000">파견사원입퇴사자현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="searchState" align="center" class="creamBold" width="80">조회기간</td>
                                <td class="padding2423" width = "220">
                                    ...
                                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('img_YMD_SHR1','','/images/button/btn_HelpOver.gif',1)" onclick="calendarBtn('datetype2','txtSTR_YMD_SHR','','114','113');">
                                    ...
                                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('img_YMD_SHR1','','/images/button/btn_HelpOver.gif',1)" onclick="calendarBtn('datetype2','txtEND_YMD_SHR','','204','113');">
                                    <img src="/images/button/btn_HelpOn.gif" name="img_YMD_SHR1" width="21" height="20" border="0" align="absmiddle"></a>
                                </td>
                                <td>&nbsp;</td> 
                            </tr>
...
<!-- power Search테이블 끝 -->
        ...
        <comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misa070.hnw">
