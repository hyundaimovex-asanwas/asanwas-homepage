...
//System.out.println("1"+GBN_SHR);
//System.out.println("2"+GBN_CD_SHR);
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misb010.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=STR_YMD%>[:END_YMD]=<%=END_YMD%>[:GBN_SHR]=<%=GBN_SHR%>">
