...
String STR_YM 	= request.getParameter("STR_MM").replaceAll("-", "");
String END_YM 	= request.getParameter("END_MM").replaceAll("-", "");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misb030.hnw">
              <param name="initvalue" VALUE="[:TOT_YY]=<%=TOT_YY%>[:STR_YM]=<%=STR_YM%>[:END_YM]=<%=END_YM%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>">
