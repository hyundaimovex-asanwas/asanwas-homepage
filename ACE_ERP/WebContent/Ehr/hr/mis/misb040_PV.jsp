...
String STR_STD = Integer.toString(Integer.parseInt(STR_YMD.replaceAll("-", "").substring(0,4)) - 5);
String STR_END = Integer.toString(Integer.parseInt(STR_YMD.replaceAll("-", "").substring(0,4)) - 1);
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misb040.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=STR_YMD%>[:STR_STD]=<%=STR_STD%>[:STR_END]=<%=STR_END%>">
