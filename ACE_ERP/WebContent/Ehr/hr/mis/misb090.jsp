    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
            fnc_commnmPopup('txtDPT_CD_SHR','txtDPT_NM_SHR','소속','DEPT');
        }
        ...
        function fnc_Print() {
            ...
            var url = "misb090_PV.jsp?STR_YMD="+STR_YMD+"&DPT_CD_SHR="+DPT_CD_SHR;
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">월별노동통계현황</td>
                    <td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">월별노동통계현황</font></td>
                </tr>
            </table>
            </td>
        </tr>
