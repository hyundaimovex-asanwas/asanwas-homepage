...
<html>
<head>
	<title>노동력 수요동향조사 보조조사표(misb100)</title>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
            fnc_commnmPopup('txtDPT_CD_SHR','txtDPT_NM_SHR','부서','DEPT');
        }
        ...
        function fnc_Print() {
			...
			var url = "misb100_PV.jsp?STR_YMD="+STR_YMD+ "&DPT_CD=" + DPT_CD;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">노동력 수요동향조사 보조조사표</td>
					<td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">노동력 수요동향조사 보조조사표</font></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="searchState" align="center">부서</td>
					<td class="padding2423"><input id="txtDPT_CD_SHR" name="txtDPT_CD_SHR" size="6" maxlength="6" onKeyPress="JavaScript: if (event.keyCode == 13) fnc_SearchList()" onChange="fnc_FldChange()">
