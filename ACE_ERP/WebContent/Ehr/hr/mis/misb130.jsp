...
<html>
<head>
	<title>노동력 수요동향 조사(misb130)</title>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_Print() {
			...
			var url = "misb130_PV.jsp?STR_YMD="+STR_YMD + "&DPT_CD=" + DPT_CD;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">노동력 수요동향 조사</td>
					<td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">노동력 수요동향 조사</font></td>
				</tr>
			</table>
			</td>
		</tr>
