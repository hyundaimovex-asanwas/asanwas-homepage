...
*****************************************************
* @source       : misb220.jsp
* @description  : 부서별인원증감현황(본사/지방별) PAGE
*****************************************************
...
<html>
<head>
<title>부서별인원증감현황(본사/지방별)(misb220)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_Print() {
        ...
        var url = "misb220_PV.jsp?str_ymd="+str_ymd+"&end_ymd="+end_ymd;
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">부서별인원증감현황</td>
          <td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">부서별인원증감현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
