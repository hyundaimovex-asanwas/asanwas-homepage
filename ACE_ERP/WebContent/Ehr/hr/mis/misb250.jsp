...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_Print() {
        ...
        var url = "misb250_PV.jsp?str_ymd="+str_ymd+"&end_ymd="+end_ymd+"&dpt_cd="+dpt_cd+"&dpt_nm="+dpt_nm+"&cd_gbn="+cd_gbn;
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">산재월별인원현황</td>
          <td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">산재월별인원현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
