...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misb260.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=str_ymd%>[:END_YMD]=<%=end_ymd%>[:CD_GBN]=<%=cd_gbn%>[:DPT_CD]=<%=dpt_cd%>[:DPT_NM]=<%=dpt_nm%>">
