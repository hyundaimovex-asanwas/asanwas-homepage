...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_Print() {
        ...
        var url = "misb270_PV.jsp?str_ymd="+str_ymd+"&dpt_cd="+dpt_cd+"&dpt_nm="+dpt_nm+"&cd_gbn="+cd_gbn;
  ...
  //이곳에 해당 코딩을 입력 하세요
    ...
    document.getElementById('txtSTR_YMD_SHR').value = getToday().substring(0,4);
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">산재임금내역</td>
          <td align="right" class="navigator">HOME/경영정보/통계현황/<font color="#000000">산재임금내역</font></td>
        </tr>
      </table>
    </td>
  </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="padding2423" width = "96">
                                    ...
                                    <input type="text" id="txtSTR_YMD_SHR"  name="txtSTR_YMD_SHR" style="ime-mode:disabled" size="4" value="" maxlength="4" onblur="fncCheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();">
                                    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('img_YMD_SHR1','','/images/button/btn_HelpOver.gif',1)" onclick="calendarBtn('datetype3','txtSTR_YMD_SHR','','98','106');">
