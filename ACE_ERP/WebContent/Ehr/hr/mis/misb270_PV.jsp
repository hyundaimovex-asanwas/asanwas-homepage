<!--
***********************************************************************
* @source      : misb270_PV.jsp
* @description : 산재임금내역 인쇄 PAGE
***********************************************************************
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misb270.hnw">
              <param name="initvalue" VALUE="[:STR_YY]=<%=str_ymd%>[:CD_GBN]=<%=cd_gbn%>[:DPT_CD]=<%=dpt_cd%>[:DPT_NM]=<%=dpt_nm%>">
