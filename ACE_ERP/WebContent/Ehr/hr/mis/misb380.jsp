    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            dsT_CM_PERSON.DataID = "/servlet/GauceChannelSVL?cmd=hr.mis.b.misb380.cmd.MISB380CMD&S_MODE=SHR&STR_YMD="+STR_YMD+"&END_YMD="+END_YMD;
            dsT_CM_PERSON.Reset();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_CM_PERSON.GridToExcel("설문조사 현황", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_CM_PERSON,0,"true","right");
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">설문조사현황</td>
					<td align="right" class="navigator">HOME/인사관리/<font color="#000000">설문조사현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:380px;">
						...
						<param name="Format" value="
                            ...
                            <C> id='TEAM_NM'	width=100	name='팀'            align=left      </C>                                                        
                            ...
                            <C> id='SUB1'         width=70	name='답변1'        	align=center    value={Decode(SUB1,'Y','1번','N','2번','기권')}</C>
                            <C> id='SUB2'         width=70	name='답변2'        	align=center    value={Decode(SUB2,'Y','찬성','N','반대','기권')}</C>                            
                            <C> id='REMARK2'    width=100	name='의견'         align=center    </C>
						">
					</object>
