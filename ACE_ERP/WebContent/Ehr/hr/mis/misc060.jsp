...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_PERSON.ClearData();
            
            dsT_MI_PERSON.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc060.cmd.MISC060CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
            dsT_MI_PERSON.Reset();
            
            form1.grdT_MI_PERSON.Focus();
        ...
        function fnc_OnLoadProcess() {
            ...
            //Grid Style 적용
            cfStyleGrid(form1.grdT_MI_PERSON,0,"false","false");
            
            // 사업년도 및 대상기간 추출
            dsT_CP_WORKLOG.ClearData();
            
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc060.cmd.MISC060CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            ...
            if (ProSts != "4") {
                alert("승급작업에 대한 일괄반영처리를 하실 수 없습니다.");
                return;
            }
            
            if(dsT_MI_PERSON.CountRow == 0) {
                alert("저장 할 자료가 없습니다.");
                return;
            }
            
            if(!confirm("승급대상자 일괄처리를 하시겠습니까?")) {
                return;
            }       
            ...
            dsT_MI_PERSON.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc060.cmd.MISC060CMD&S_MODE=SHR_03&PIS_YY="+PIS_YY;
            dsT_MI_PERSON.Reset();
        }
    ...
    ***************************************************************************************-->
    ...
    <!----------------------------------------------+
    | 1. 조회 및 저장용 DataSet                     |
    | 2. 이름은 ds_ + 주요 테이블명(T_MI_PERSON)    |
    | 3. 사용되는 Table List(T_MI_PERSON)           |
    +----------------------------------------------->
    <Object ID="dsT_MI_PERSON" ClassID="CLSID:2506B38B-0FF7-4249-BA3E-8BC1DC399FBB">
    ...
    **************************************-->
    ...
    +-------------------------------------------------->
    <Script For=dsT_MI_PERSON Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            fnc_Message(document.getElementById("resultMessage"), "MSG_03", dsT_MI_PERSON.CountRow );
            
            ProSts = dsT_MI_PERSON.NameValue(1, "PRO_STS");
    ...
    +------------------------------------------------------>
    <Script For=dsT_MI_PERSON Event="OnLoadError()">
    ...
    +------------------------------------------------------------------>
    <Script For=dsT_MI_PERSON Event="OnDataError()">
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">승급시뮬레이션</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">승급시뮬레이션</font></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="800" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop5">
                         <comment id="__NSID__">
                         <object    id="grdT_MI_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                             <param name="DataID"                  value="dsT_MI_PERSON">
                             ...
                             <param name="Format"                  value="
                                 ...
                                 <C> id='JOB_NM'     width=146     name='직위'        align=center   </C>
                                 <C> id='PHOB_CD'    width=146     name='전호봉'      align=center   </C>
                                 <C> id='FHOB_CD'    width=146     name='후호봉'      align=center   </C>
                                 <C> id='P_CNT'      width=146     name='대상인원'        align=center   </C>
                                 <C> id='F_CNT'      width=146     name='승급인원'        align=center   </C>
                             ">
                         </object>
