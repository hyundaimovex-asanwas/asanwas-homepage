    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            document.getElementById("txtHOLPCT_NO").value = '';
            
            dsT_MI_PAYBASE.ClearData();
            
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc070.cmd.MISC070CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc070.cmd.MISC070CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            var PIS_YY      = document.getElementById("cmbPIS_YY_SHR").value;
            var HOLPCT_NO  = document.getElementById("txtHOLPCT_NO").value;
            ...
            if (dsT_MI_PAYBASE.CountRow == 0) {
                alert("해당 사업년도에 대한 급여사업계획을 먼저 작업하여 주십시오.");
                return;
            }
           
            if (HOLPCT_NO == "") {
                alert("추정인상율은 필수입력사항입니다.");
                document.getElementById("txtHOLPCT_NO").focus();
                return;
            }
            
            if (!fnc_ChgPayPctNo('txtHOLPCT_NO')) {
                return false;
            }
            
            if(!confirm("기존에 생성된 사업계획휴일근무추정인상율 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;

            // 상여작업
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc070.cmd.MISC070CMD&S_MODE=SHR_03&PIS_YY="+PIS_YY+"&HOLPCT_NO="+HOLPCT_NO;
            dsT_MI_PAYBASE.Reset();
    ...
    **************************************-->
    ...
    <Script For=dsT_MI_PAYBASE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            // 휴일근무사업계획 데이터 존재하는지 CHECK
            dsT_MI_BUDGETMST.ClearData();
            
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc070.cmd.MISC070CMD&S_MODE=SHR_04&PIS_YY="+document.getElementById("cmbPIS_YY_SHR").value;
    ...
    <Script For=dsT_MI_BUDGETMST Event="OnLoadCompleted(iCount)">
        ...
        if (iCount > 0 && dsT_MI_BUDGETMST.NameValue(1, "CNT") > 0) {
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">휴일근무사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">휴일근무사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="paddingTop5" height="32" align="right">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423">
                        <input id="txtHOLPCT_NO" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;" onKeyPress="cfCheckNumber3();" onBlur="fnc_ChgPayPctNo('txtHOLPCT_NO');">&nbsp;&nbsp;
...
<object id="bnd" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        <C> Col=HOL_PCT         Ctrl=txtHOLPCT_NO       Param=value </C>
    '>
</object>