    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc080.cmd.MISC080CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
            dsT_MI_PAYBASE.Reset();

            var idx  =  document.getElementById("cmbPIS_YY_SHR").selectedIndex;
            ProSts = dsT_CP_WORKLOG.NameValue(idx+1, "PRO_STS");
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc080.cmd.MISC080CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            var PIS_YY      = document.getElementById("cmbPIS_YY_SHR").value;
            var PAYPCT_NO1  = document.getElementById("txtPAYPCT_NO1").value;
            var PAYPCT_NO2  = document.getElementById("txtPAYPCT_NO2").value;
            var PAYINC_GBN  = document.getElementById("cmbPAYINC_GBN").value;
            ...
            if(!confirm("기존에 생성된 사업계획급여인상율 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;

            if (PAYPCT_NO1 == "") {
                alert("임원에 대한 인상율은 필수입력사항입니다.");
                document.getElementById("txtPAYPCT_NO1").focus();
                return;
            }

            if (!fnc_ChgPayPctNo('txtPAYPCT_NO1')) {
                return false;
            }

            if (PAYPCT_NO2 == "") {
                alert("직원에 대한 인상율은 필수입력사항입니다.");
                document.getElementById("txtPAYPCT_NO2").focus();
                return;
            }

            if (!fnc_ChgPayPctNo('txtPAYPCT_NO2')) {
                return false;
            }


            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc080.cmd.MISC080CMD"
                                  + "&S_MODE=SHR_03"
                                  + "&PIS_YY="+PIS_YY
                                  + "&PAYPCT_NO1="+PAYPCT_NO1
                                  + "&PAYPCT_NO2="+PAYPCT_NO2
                                  + "&PAYINC_GBN="+PAYINC_GBN;
            dsT_MI_PAYBASE.Reset();

        }

        function fnc_ChgPayPctNo(fld){
    ...
    **************************************-->
    ...
    <Script For=dsT_MI_PAYBASE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            document.getElementById("resultMessage").innerText = document.getElementById("cmbPIS_YY_SHR").value + " 년도 자료가 조회되었습니다.";
    ...
    <Script For=dsT_CP_WORKLOG Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            ProSts = dsT_CP_WORKLOG.NameValue(idx, "PRO_STS");
            //alert("T_CP_WORKLOG src "+ProSts);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">급여사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">급여사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td class="paddingTop5" height="32" align="right">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    <td align="center" class="creamBold">인상률</td>
                    <td class="padding2423">
                    &nbsp;임원&nbsp;<input id="txtPAYPCT_NO1" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;" onKeyPress="cfCheckNumber3();" onBlur="fnc_ChgPayPctNo('txtPAYPCT_NO1');">&nbsp;&nbsp;
                    &nbsp;직원&nbsp;<input id="txtPAYPCT_NO2" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;" onKeyPress="cfCheckNumber3();" onBlur="fnc_ChgPayPctNo('txtPAYPCT_NO2');">&nbsp;&nbsp;
                    &nbsp;인상구분
                    <select id="cmbPAYINC_GBN" style="width:90">
                        <option value="1">전체</option>
                        <option value="2">통상임금</option>
                    </select>&nbsp;&nbsp;
