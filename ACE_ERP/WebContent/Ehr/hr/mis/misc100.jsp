    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc100.cmd.MISC100CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc100.cmd.MISC100CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            ...
            if (document.getElementById("txtA_YRP_PCT").value == ""
                    || document.getElementById("txtA_YRP_PCT").value == "0") {
                alert("사무직 인상률을 입력해 주세요.");
                return;
            }
            
            if (document.getElementById("txtM_YRP_PCT").value == ""
                    || document.getElementById("txtM_YRP_PCT").value == "0") {
                alert("택배직 인상률을 입력해 주세요.");
                return;
            }
           
            if(!confirm("기존에 생성된 연차수당사업계획 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;
            
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc100.cmd.MISC100CMD"
                                  + "&S_MODE=SHR_03"
                                  + "&PIS_YY="+PIS_YY
                                  + "&A_YRP_PCT="+document.getElementById("txtA_YRP_PCT").value
                                  + "&M_YRP_PCT="+document.getElementById("txtM_YRP_PCT").value;
            dsT_MI_PAYBASE.Reset();
    ...
    **************************************-->
    ...
    <Script For=dsT_MI_PAYBASE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            // 연차수당사업계획 데이터 존재하는지 CHECK
            dsT_MI_BUDGETMST.ClearData();
            
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc100.cmd.MISC100CMD&S_MODE=SHR_04&PIS_YY="+document.getElementById("cmbPIS_YY_SHR").value;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">연차수당사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">연차수당사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="paddingTop5" height="32" align="right">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423">
                    &nbsp;사무직&nbsp;<input id="txtA_YRP_PCT" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;">&nbsp;%&nbsp;
                    &nbsp;택배직&nbsp;<input id="txtM_YRP_PCT" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;">&nbsp;%&nbsp;
...
<object id="bnd" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        <C> Col=A_YRP_PCT       Ctrl=txtA_YRP_PCT       Param=value </C>
        <C> Col=M_YRP_PCT       Ctrl=txtM_YRP_PCT       Param=value </C>
    '>
</object>