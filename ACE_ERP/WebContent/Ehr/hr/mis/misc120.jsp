    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc120.cmd.MISC120CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc120.cmd.MISC120CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            ...
            if(!confirm("기존에 생성된 중식대사업계획 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;

            // 상여작업
            dsT_MI_PAYBASE.ClearData();
            
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc120.cmd.MISC120CMD&S_MODE=SHR_03&PIS_YY="+PIS_YY;
            dsT_MI_PAYBASE.Reset();
    ...
    **************************************-->
    ...
    <Script For=dsT_MI_PAYBASE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            // 중식대사업계획 데이터 존재하는지 CHECK
            dsT_MI_BUDGETMST.ClearData();
            
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc120.cmd.MISC120CMD&S_MODE=SHR_04&PIS_YY="+document.getElementById("cmbPIS_YY_SHR").value;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">중식대사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">중식대사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
