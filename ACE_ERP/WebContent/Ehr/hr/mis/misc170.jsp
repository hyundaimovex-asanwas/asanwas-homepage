    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_BatchAdjust() {
            ...
            if(!confirm("기존에 생성된 건강검진사업계획 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">건강검진사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">건강검진사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
