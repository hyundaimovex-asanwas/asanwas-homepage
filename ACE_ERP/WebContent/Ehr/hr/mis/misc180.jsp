    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            document.getElementById("txtHUI_PCT").value = '';
            
            dsT_MI_PAYBASE.ClearData();
            
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc180.cmd.MISC180CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY;
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc180.cmd.MISC180CMD&S_MODE=SHR_01";
        ...
        function fnc_BatchAdjust() {
            var PIS_YY      = document.getElementById("cmbPIS_YY_SHR").value;
            var HUI_PCT  = document.getElementById("txtHUI_PCT").value;
            ...
            if (HUI_PCT == "") {
                alert("추정인상율은 필수입력사항입니다.");
                document.getElementById("txtHUI_PCT").focus();
                return;
            }
            
            if (!fnc_ChgPayPctNo('txtHUI_PCT')) {
                return false;
            }
            
            if(!confirm("기존에 생성된 사업계획건강보험추정인상율 정보는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) return;

            // 상여작업
            dsT_MI_PAYBASE.ClearData();
            
            dsT_MI_PAYBASE.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc180.cmd.MISC180CMD&S_MODE=SHR_03&PIS_YY="+PIS_YY+"&HUI_PCT="+HUI_PCT;
            dsT_MI_PAYBASE.Reset();
            ...
            if (splitData.length==1){  //.이 없으면
             inputData = inputData+".0";
                ...
                if (split1 >= 1 ){   //소수점 뒤에 1자리 수이면
                    inputData =(Math.round(inputData*1000))/1000; //소수전 2째자리에서 반올림 ㅡ 
                }
            } else {    //    예외 .이 한개 이상인경우,,
    ...
    **************************************-->
    ...
    <Script For=dsT_MI_PAYBASE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            document.getElementById("txtHUI_PCT").value = dsT_MI_PAYBASE.NameValue(1, "HUI_PCT");
            
            // 건강보험사업계획 데이터 존재하는지 CHECK
            dsT_MI_BUDGETMST.ClearData();
            
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc180.cmd.MISC180CMD&S_MODE=SHR_04&PIS_YY="+document.getElementById("cmbPIS_YY_SHR").value;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">건강보험사업계획</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">건강보험사업계획</font></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td class="paddingTop5" height="32" align="right">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    <td align="center" class="creamBold">보험요율</td>
                    <td class="padding2423">
                        <input id="txtHUI_PCT" size="5" maxlength="5" style="ime-mode:disabled;text-align:right;" onKeyPress="cfCheckNumber3();" onBlur="fnc_ChgPayPctNo('txtHUI_PCT');">&nbsp;&nbsp;
...
<object id="bnd" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        <C> Col=HUI_PCT         Ctrl=txtHUI_PCT       Param=value </C>
    '>
</object>