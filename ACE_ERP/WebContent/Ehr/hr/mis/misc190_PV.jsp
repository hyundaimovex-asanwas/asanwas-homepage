<!--
***********************************************************************
* @source      : misc190_PV.jsp
* @description : 월별근로구분별 인원계획 인쇄 PAGE
***********************************************************************
...
<%
	...
	String str_ymd = request.getParameter("str_ymd").replaceAll("-","").substring(0,4);
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="misc190.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=str_ymd%>">
