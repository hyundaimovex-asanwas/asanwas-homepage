    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc270.cmd.MISC270CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&OCC_CD="+OCC_CD+"&ITEM_CD="+ITEM_CD+"&ENO_NO="+ENO_NO;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_MI_BUDGETMST.GridToExcel("사업구분별월별현황", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc270.cmd.MISC270CMD&S_MODE=SHR_01";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">사업구분별월별현황</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">사업구분별월별현황</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_MI_BUDGETMST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                            ...
                            <param name="Format"                  value="
                                <FC> id='{currow}'     width=45    name='순번'               align=center </FC>
                                <FC> id='HEAD_NM'      width=100   name='본부'               align=left   </FC>
                                <FC> id='DPT_NM'       width=100   name='부서'               align=left   </FC>
                                <FC> id='JOB_NM'       width=70    name='직위'               align=center </FC>
                                <FC> id='ENO_NO'       width=70    name='사번'               align=center </FC>
                                <FC> id='ENO_NM'       width=70    name='성명'               align=center </FC>
                                <C>  id='AMT01'        width=80    name='01월'               align=rigth  </C>
                                <C>  id='AMT02'        width=80    name='02월'               align=rigth  </C>
                                <C>  id='AMT03'        width=80    name='03월'               align=rigth  </C>
                                <C>  id='AMT04'        width=80    name='04월'               align=rigth  </C>
                                <C>  id='AMT05'        width=80    name='05월'               align=rigth  </C>
                                <C>  id='AMT06'        width=80    name='06월'               align=rigth  </C>
                                <C>  id='AMT07'        width=80    name='07월'               align=rigth  </C>
                                <C>  id='AMT08'        width=80    name='08월'               align=rigth  </C>
                                <C>  id='AMT09'        width=80    name='09월'               align=rigth  </C>
                                <C>  id='AMT10'        width=80    name='10월'               align=rigth  </C>
                                <C>  id='AMT11'        width=80    name='11월'               align=rigth  </C>
                                <C>  id='AMT12'        width=80    name='12월'               align=rigth  </C>
                            ">
                        </object>
