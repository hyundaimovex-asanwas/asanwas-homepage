<!--
***********************************************************************
* @source      : misc280_ED.jsp
* @description : 업무별예산(부문별) 조회PAGE
***********************************************************************
...
<%
    ...
    sql = XmlSqlUtils.getSQL("mis", "MISC280_SHR_02");

      Object[] bind = null;
      bind = new Object[] {
            item_cd, pln_yy, occ_cd,  pln_yy,  item_cd, pln_yy,  occ_cd,  pln_yy,  item_cd, occ_cd,  cur_yy,
            occ_cd,  cur_yy, pln_yy,  item_cd, occ_cd,  cur_yy,  pln_yy,  item_cd, occ_cd,  cur_yy,  pln_yy,
            item_cd, occ_cd, cur_yy,  pln_yy,  item_cd, pln_yy,  cur_yy,  pln_yy,  occ_cd,  item_cd, item_cd,
            occ_cd,  cur_yy, pln_yy,  item_cd, item_cd, item_cd, item_cd, item_cd, item_cd, pln_yy,
            occ_cd,  cur_yy, item_cd, pln_yy,  occ_cd,  cur_yy,  item_cd, item_cd, cur_yy,
            occ_cd,  cur_yy, item_cd, cur_yy,  occ_cd,  cur_yy,  item_cd
      };
