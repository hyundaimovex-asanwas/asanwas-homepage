...
<html>
    ...
    <head>
    <title>업무별월별예산(부문별)(misc290)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc290.cmd.MISC290CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&OCC_CD="+OCC_CD+"&ITEM_CD="+ITEM_CD;
        ...
        function fnc_Print() {
            ...
            var url = "misc290_PV.jsp?item_cd="+ITEM_CD+"&occ_cd="+OCC_CD+"&cur_yy="+CUR_YY+"&pln_yy="+PLN_YY;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_MI_BUDGETMST.GridToExcel("업무별월별예산(부문별)", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc290.cmd.MISC290CMD&S_MODE=SHR_01";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">업무별월별예산(부문별)</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">업무별월별예산(부문별)</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_MI_BUDGETMST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                            ...
                            <param name="Format"                  value="
                                <FC> id='HEAD_NM'      width=130   name='구분'               align=center SubBgColor='#99FFCC' subsumtext='합  계' </FC>
