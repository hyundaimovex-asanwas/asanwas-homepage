...
<html>
    ...
    <head>
    <title>업무별예산(항세목별)(misc300)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc300.cmd.MISC300CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&OCC_CD="+OCC_CD+"&ITEM_CD="+ITEM_CD+"&PIS_YY2="+PIS_YY2;
        ...
        function fnc_Print() {
            ...
            var url = "misc300_PV.jsp?item_cd="+ITEM_CD+"&occ_cd="+OCC_CD+"&cur_yy="+CUR_YY+"&pln_yy="+PLN_YY;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_MI_BUDGETMST.GridToExcel("업무별예산(항세목별)", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc300.cmd.MISC300CMD&S_MODE=SHR_01";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">업무별예산(항세목별)</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">업무별예산(항세목별)</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_MI_BUDGETMST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                            ...
                            <param name="Format"                  value="
                                <C>  id='ITEM_NM'         width=140  name='구분'                  align=center SubBgColor='#99FFCC' subsumtext='합  계'</C>
                                <G>  id='BEF_GRP'         name='2006년도 예산' HeadBgColor='#F7DCBB'
                                     <C> id='BEF_AVG'     width=80   name='월간평균'              align=right  SubBgColor='#99FFCC' </C>
                                     <C> id='BEF_SUM'     width=80   name='년 간'                 align=right  SubBgColor='#99FFCC' </C>
                                </G>
                                <G>  id='BEF_GRP2'        name='2006년도 추정실적' HeadBgColor='#F7DCBB'
                                     <C> id='BEF1_SUM'    width=80   name='1월~9월;실적'          align=right  SubBgColor='#99FFCC' </C>
                                     <C> id='BEF2_SUM'    width=80   name='10월~12월;추정실적'    align=right  SubBgColor='#99FFCC' </C>
                                     <C> id='BEF3_SUM'    width=80   name='계'                    align=right  SubBgColor='#99FFCC' </C>
                                     <C> id='BEF_RATE'    width=80   name='계획비;달성율'         align=right  SubBgColor='#99FFCC' subsumtext={SubAvg(BEF_RATE)}</C>
                                </G>
                                <G>  id='AFT_GRP'         name='2007년도 예산' HeadBgColor='#F7DCBB'
                                     <C> id='AFT_AVG'     width=80   name='월간평균'              align=right  SubBgColor='#99FFCC' </C>
                                     <C> id='AFT_SUM'     width=80   name='년 간'                 align=right  SubBgColor='#99FFCC' </C>
                                </G>
                            ">
                        </object>
