...
<html>
    ...
    <head>
    <title>업무별월별예산(항세목별)(misc310)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_MI_BUDGETMST.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc310.cmd.MISC310CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&OCC_CD="+OCC_CD+"&ITEM_CD="+ITEM_CD;
        ...
        function fnc_Print() {
            ...
            var url = "misc310_PV.jsp?item_cd="+ITEM_CD+"&occ_cd="+OCC_CD+"&cur_yy="+CUR_YY+"&pln_yy="+PLN_YY;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_MI_BUDGETMST.GridToExcel("업무별월별예산(항세목별)", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            dsT_CP_WORKLOG.DataId = "/servlet/GauceChannelSVL?cmd=hr.mis.c.misc310.cmd.MISC310CMD&S_MODE=SHR_01";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">업무별월별예산(항세목별)</td>
                    <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">업무별월별예산(항세목별)</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_MI_BUDGETMST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                            ...
                            <param name="Format"                  value="
                                <FC> id='ITEM_NM'      width=140   name='구분'               align=center SubBgColor='#99FFCC' subsumtext='합  계' </FC>
                                <C>  id='AMT00'        width=80    name='합계'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT01'        width=80    name='01월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT02'        width=80    name='02월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT03'        width=80    name='03월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT04'        width=80    name='04월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT05'        width=80    name='05월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT06'        width=80    name='06월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT07'        width=80    name='07월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT08'        width=80    name='08월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT09'        width=80    name='09월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT10'        width=80    name='10월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT11'        width=80    name='11월'               align=rigth  SubBgColor='#99FFCC' </C>
                                <C>  id='AMT12'        width=80    name='12월'               align=rigth  SubBgColor='#99FFCC' </C>
                            ">
                        </object>
