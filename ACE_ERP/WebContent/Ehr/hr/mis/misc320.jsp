...
*****************************************************
* @source       : misc320.jsp
* @description  : 정기승진자 인건비 인상현황 PAGE
*****************************************************
...
<html>
<head>
<title>정기승진자 인건비 인상현황(misc320)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    ...
    function fnc_SearchList() {
        ...
        var url = "misc320_PV.jsp?pis_yy="+str_ymd;
    ...
    <td height="25" background="/images/common/barBg.gif">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">정기승진자 인건비 인상현황</td>
          <td align="right" class="navigator">HOME/경영정보/사업계획/<font color="#000000">정기승진자 인건비 인상현황</font></td>
        </tr>
      </table>
    </td>
  </tr>
