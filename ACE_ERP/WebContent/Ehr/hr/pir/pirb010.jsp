<!--
    ...
    * 2006/09/01  |  한학현   | 최초작성                                                                                           *
    * 2006/09/28  |  한학현   | 개발완료                                                                                           *
    * 2006/11/24  |  한학현   | 본부,소속,팀 통합관련 전체 변경                                                         *
    ************************************************************************************
-->
...
<script language="javascript" >
        ...
        function fnc_Save() {
			if(fnc_SaveItemCheck()) {
				...
				tr01T_CM_DEPT.action = "/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=SAV_01";
				tr01T_CM_DEPT.post();
        ...
        function fnc_Delete() {
			...
			tr01T_CM_DEPT.KeyValue = "SVL(I:ds01T_CM_DEPT=ds01T_CM_DEPT)";
			tr01T_CM_DEPT.action = "/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=DEL";
			tr01T_CM_DEPT.post();
            dsT_CM_DEPT.Reset();//트리도 재구성한다.
        }
        ...
        function fnc_SaveItemCheck() {
			...
			//	oCOM_NO = ds01T_CM_DEPT.NameValue(i,"COM_NO");
			//	if(oCD_GBN.trim() == "A4" && oCOM_NO.trim().length != 0 && oCOM_NO.trim().length != 10){
			//		alert("사업자번호를 형식(XXX-XX-XXXXX)에 맞게 입력해주세요." );
			//		ds01T_CM_DEPT.RowPosition = i;
			//		document.medCOM_NO.Focus();
			//		return false;
			//	}
        ...
        function fnc_OnLoadProcess() {
            //Grid Style 적용
   			cfStyleGrid(form1.grd01T_CM_DEPT,15,"false","right");
			...
			try {
				dsT_CM_DEPT.DataId="/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=SHR";
				dsT_CM_DEPT.Reset();

				ds02T_CM_DEPT.DataId="/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=SHR_02";
				ds02T_CM_DEPT.Reset();
    ...
    **************************************-->
    ...
    <Script For=dsT_CM_DEPT Event="OnLoadCompleted(iCount)">
        if (iCount == 0)    {
			...
			tr01T_CM_DEPT.action = "/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=SAV";
			tr01T_CM_DEPT.post();
            dsT_CM_DEPT.Reset();//트리도 재구성한다.
        } else {
    ...
    <script language=JavaScript for=tvT_CM_DEPT event=OnClick()>
		...
		try {
			ds01T_CM_DEPT.DataID = "/servlet/GauceChannelSVL?cmd=hr.pir.b.pirb010.cmd.PIRB010CMD&S_MODE=SHR_01&"+overId1+"="+overValue1+"&"+overId2+"="+overValue2;
			ds01T_CM_DEPT.Reset();
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">부서코드관리</td>
					<td align="right" class="navigator">HOME/인사관리/조직관리/<font color="#000000">부서코드관리</font></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
        <td class="paddingTop8">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
				...
				<tr>
					<td align="center" class="creamBold">코드구분</td>
					<td class="padding2423"><input id="txtCD_GBN" style="width:100%" maxlength="2"></td>
					<td align="center" class="creamBold">부서코드</td>
				...
				<tr>
					...
					<td align="center" class="creamBold">근무지구분</td>
					<td class="padding2423">
				...
				<tr>
					<td align="center" class="creamBold">회계부서코드</td>
					...
					<td align="center" class="creamBold">사업부</td>
					<td class="padding2423">
					<comment id="__NSID__">
				...
				<!--
						<select id="cmbHEAD_TAG" style="width:100%">
							<option value="" >선택</option>
							<option value="00" >본부부서</option>
							<option value="Q1" >SI사업부</option>
							<option value="Q2" >SM사업부</option>
						</select>
						-->
					</td>

					<td align="center" class="creamBold">현장등급</td>
					<td class="padding2423">
				...
				<tr>
					<td align="center" class="creamBold">지점사업자번호</td>
					<td class="padding2423">
		...
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object id="tvT_CM_DEPT" classid=CLSID:6DD1CE9F-1722-46F0-AF93-B2BC58383CD2 style="width:300px;height:270px">
							...
							<param name=ImgDataID		value="idsT_CM_DEPT">
		...
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grd01T_CM_DEPT" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500px;height:270px">
                            ...
                            <param name="Format"						value="
								<C> id='CURROW'		width=40		name='NO'				align=center		value={CurRow}		</C>
								<C> id='CD_GBN'		width=70	    name='코드구분'		sort=true			align=center				</C>
								<C> id='DPT_CD'		width=70	    name='부서코드'		sort=true			align=center				</C>
								<C> id='DPT_NM'		width=124		name='부서명'			sort=true			align=left 					</C>
								<C> id='STR_YMD'	width=80		name='등록일'			sort=true			align=center 			</C>
								<C> id='END_YMD'	width=80		name='폐기일'			sort=true			align=center				</C>
							">
						</object>
						</comment><script> __ShowEmbedObject(__NSID__); </script>
					</td>
