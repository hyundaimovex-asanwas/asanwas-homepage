    ...
    ******************************************************
    ...
    <script language="javascript" >
        ...
        function fnc_ViewFrameTab(u) {
            ...
            var gubun = "1";//권한에 따른 수정 가능(불가능)을 위한 변수
            ...
            if(iframe != undefined) {
                ...
                if (iframe.src == "about:blank") {
                  ...
                  iframe.src = iframe.load_src + "?ENO_NO="+p_eno_no + "&GUBUN="+gubun + "&mode="+p_mode+"&srcid=pirc010";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">개인정보조회</td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream" frame="vsides">
                ...
                <tr>
                    ...
                    <td class="padding2423">
                        <input id="txtHOB_CD" style="width:15%" maxlength="2"  class="input_ReadOnly"  readonly> <input id="txtHOB_NM" style="width:80%" class="input_ReadOnly"  readonly>
                    </td>
                </tr>
                <tr>
...
<!-- 기본사항 시작 -->
<table width="890" height="294" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
    <tr><td align="center">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                        <tr>
                            <td align="left">
                                ...
                                <input type=hidden id="ENO_NO" size="9">
                            </td>
                        <tr>
                    </table>
                </td>
        ...
        <!-- 인사기본2 시작 -->
        <div id="view_tab_1" style="width:950;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
        <iframe id="iframe_tab_1" src="about:blank" load_src="../../../Ehr/hr/pir/pirc011.jsp" frameborder="0" width="100%" height="100%" marginwidth="2" marginheight="2" scrolling="no" allowtransparency="true"></iframe>
        </div>
        <!-- 인사기본2 끝 -->

        <!-- 가족사항 시작 -->
        <div id="view_tab_2" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_FAMILY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 입사전경력 시작 -->
        <div id="view_tab_3" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_BHISTORY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 입사후경력 시작 -->
        <div id="view_tab_4" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_AHISTORY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 자격면허 시작 -->
        <div id="view_tab_5" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_QUALIFICATION" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 학력사항 시작 -->
        <div id="view_tab_6" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_SCHOOL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 사회공헌 시작 -->
        <div id="view_tab_7" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
                                    <comment id="__NSID__">
                                    <object id="grdT_CM_SERVICE" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
        ...
        <!-- 상벌 사항 시작-->
        <div id="view_tab_8" style="width:800;height:265;border-style:solid;border-color:#999999;border-width:1;display:none;">
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="paddingTop8" height="25">
                        <img src="../../images/common/dotGreen.gif" width="10" height="10" align="absmiddle">
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr align="center">
                                <td>
			                        <comment id="__NSID__">
			                        <object id="grdT_CM_REWARD" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:950px;height:220px;">
