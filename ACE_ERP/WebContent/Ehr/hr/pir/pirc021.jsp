...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			if(kind == "1"){
				dsT_CP_CHANGE.dataid = "/servlet/GauceChannelSVL?cmd=hr.pir.c.pirc021.cmd.PIRC021CMD&S_MODE=SHR_01&PIS_YY="+PIS_YY+"&PIS_MM="+PIS_MM+"&ENO_NO="+ENO_NO+"&SAL_GBN="+SAL_GBN+"&SEQ="+SEQ;
    			dsT_CP_CHANGE.reset();

			}else{
				dsT_CP_CHANGE.dataid = "/servlet/GauceChannelSVL?cmd=hr.pir.c.pirc021.cmd.PIRC021CMD&S_MODE=SHR_02&PIS_YY="+PIS_YY+"&PIS_MM="+PIS_MM+"&ENO_NO="+ENO_NO+"&SAL_GBN="+SAL_GBN+"&SEQ="+SEQ;
    			dsT_CP_CHANGE.reset();
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="right" class="navigator">HOME/기초정보/개인정보/급상여지급액조회/<font color="#000000"><span id="title2"></span></font></td>
				</tr>
			</table>
		</td>
	</tr>
