    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			trT_DI_DILIGENCE.action = "/servlet/GauceChannelSVL?cmd=hr.pir.c.pirc032.cmd.PIRC032CMD"
                                   + "&S_MODE=SHR_LST"
...
%>
        ...
        function fnc_Application() {
    			...
    			window.showModalDialog("/hr/pir/pirc032.jsp?MODE=INS&"+param, dsT_DI_DILIGENCE_CP, "dialogWidth:870px; dialogHeight:500px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
    ...
    ***************************************************************************************-->
	...
	<script language=JavaScript for=grdT_DI_DILIGENCE event="OnDblClick(row,colid)">
		if(row < 1) {
			...
			var end_ymd_shr = document.getElementById("txtEND_YMD_SHR").value;
			var param = "str_ymd_shr="+str_ymd_shr+"&end_ymd_shr="+end_ymd_shr;
			window.showModalDialog("/hr/pir/pirc032.jsp?MODE=READ&"+param, dsT_DI_DILIGENCE_CP, "dialogWidth:870px; dialogHeight:500px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">개인별근태현황등록</td>
					<td align="right" class="navigator">HOME/기초정보/개인정보/<font color="#000000">개인별근태현황등록</font></td>
				</tr>
			</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_DI_DILIGENCE" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:280px;">
						...
						<param name="Format" value='
							...
							<C> id="APP_YN_NM"  width=200   name="결재여부"     align=center    Edit=none    </C>
						'>
					</object>
