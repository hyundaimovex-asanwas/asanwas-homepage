    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Print() {
            ...
            if(document.form1.cmbPRT_KIND4_SHR.checked == true) {
                var PRT_PAGE_04 = "Y";
			}else{
                var PRT_PAGE_04 = "N";
			}
            if(document.form1.cmbPRT_KIND5_SHR.checked == true) {
                var PRT_PAGE_05 = "Y";
			}else{
                var PRT_PAGE_05 = "N";
			}
            ...
            if(document.form1.chkPRT_YN3_SHR.checked == true) {
                var QVAL_03 = "Y";
			}else{
                var QVAL_03 = "N";
			}
            ...
            if(document.form1.chkPRT_YN5_SHR.checked == true) {
                var QVAL_05 = "Y";
			}else{
                var QVAL_05 = "N";
			}
            if(document.form1.chkPRT_YN6_SHR.checked == true) {
                var QVAL_06 = "Y";
			}else{
                var QVAL_06 = "N";
			}
            ...
            if(document.form1.chkPRT_YN8_SHR.checked == true) {
                var QVAL_08 = "Y";
			}else{
                var QVAL_08 = "N";
			}
            if(document.form1.chkPRT_YN9_SHR.checked == true) {
                var QVAL_09 = "Y";
			}else{
                var QVAL_09 = "N";
			}
            if(document.form1.chkPRT_YN10_SHR.checked == true) {
                var QVAL_10 = "Y";
			}else{
                var QVAL_10 = "N";
			}

			var url = "pird015_PV.jsp"
			              + "?OCC_CD="+OCC_CD
                          + "&PRT_SELT="+PRT_SELT
                          + "&NO_SHR="+NO_SHR
                          ...
                          + "&PRT_PAGE_04="+PRT_PAGE_04
                          + "&PRT_PAGE_05="+PRT_PAGE_05
                          + "&QVAL_01="+QVAL_01
                          + "&QVAL_02="+QVAL_02
                          + "&QVAL_03="+QVAL_03
                          + "&QVAL_04="+QVAL_04
            ...
            var hnwParm = "[:OCC_CD]=[:PRT_SELT]=[:NO_SHR]=[:PRT_PAGE_01]=[:PRT_PAGE_02]=[:PRT_PAGE_03]=[:PRT_PAGE_04]=[:PRT_PAGE_05]=";
            hnwParm    += "[:QVAL_01]=[:QVAL_02]=[:QVAL_03]=[:QVAL_04]=[:QVAL_05]=[:QVAL_06]=[:QVAL_07]=[:QVAL_08]=[:QVAL_09]=[:QVAL_10]=";
            ...
            if(document.form1.cmbPRT_KIND4_SHR.checked == true) {
                hnwParm    += "[:PRT_PAGE_04]=Y";
			}else{
                hnwParm    += "[:PRT_PAGE_04]=N";
			}
            if(document.form1.cmbPRT_KIND5_SHR.checked == true) {
                hnwParm    += "[:PRT_PAGE_05]=Y";
			}else{
                hnwParm    += "[:PRT_PAGE_05]=N";
			}
        ...
        function fnc_Clear() {
            ...
            if (dsTemp != null) {
	            ...
	            document.getElementById("cmbPRT_KIND4_SHR").checked  = false;
	            document.getElementById("cmbPRT_KIND5_SHR").checked  = false;
	            document.getElementById("chkPRT_YN1_SHR").checked  = true;
	            document.getElementById("chkPRT_YN2_SHR").checked  = true;
	            document.getElementById("chkPRT_YN3_SHR").checked  = true;
	            document.getElementById("chkPRT_YN4_SHR").checked  = true;
	            document.getElementById("chkPRT_YN5_SHR").checked  = true;
	            document.getElementById("chkPRT_YN6_SHR").checked  = true;
	            document.getElementById("chkPRT_YN7_SHR").checked  = true;
	            document.getElementById("chkPRT_YN8_SHR").checked  = true;
	            document.getElementById("chkPRT_YN9_SHR").checked  = true;
	            document.getElementById("chkPRT_YN10_SHR").checked = true;
	            ...
	            document.getElementById("cmbPRT_KIND4_SHR").checked  = true;
	            document.getElementById("cmbPRT_KIND5_SHR").checked  = true;
                ...
                document.getElementById("cmbPRT_KIND4_SHR").disabled  =  false;
                document.getElementById("cmbPRT_KIND5_SHR").disabled  =  false;
        ...
        function fnc_GUBUN() {
         ...
         if(document.getElementById("chkPRT_GUB").checked  ==  true)  {
              ...
              document.getElementById("cmbPRT_KIND4_SHR").disabled  =  true;
              document.getElementById("cmbPRT_KIND5_SHR").disabled  =  true;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">기술경력카드</td>
                    <td align="right" class="navigator">HOME/인사관리/인사정보출력/<font color="#000000">기술경력카드</font></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td align="center" class="padding2423">
                        <input type="checkbox" name="cmbPRT_KIND1_SHR" id=cmbPRT_KIND1_SHR style="border:0" align="absmiddle" checked>1 Page&nbsp;
                        <input type="checkbox" name="cmbPRT_KIND2_SHR" id=cmbPRT_KIND2_SHR style="border:0" align="absmiddle" checked>2 Page&nbsp;
                        <input type=hidden name="cmbPRT_KIND3_SHR" id=cmbPRT_KIND3_SHR style="border:0" align="absmiddle" >&nbsp;
                        <input type=hidden name="cmbPRT_KIND4_SHR" id=cmbPRT_KIND4_SHR style="border:0" align="absmiddle" >&nbsp;
                        <input type=hidden name="cmbPRT_KIND5_SHR" id=cmbPRT_KIND5_SHR style="border:0" align="absmiddle" >&nbsp;
                    </td>
            ...
            <!--  => 기술경력 사용안함.(이지젠 연결 지우지 않음/기능 정상  원본:인사기록카드)끝 -->
       		<div  id="chkPRT_YN" style="DISPLAY:none">
       			<table>
                <tr>
                   <td align="center" class="creamBold">출력여부</td>
                    <td class="padding2423" colspan="5">
                        <input type="checkbox" name="chkPRT_YN1_SHR"  id=chkPRT_YN1_SHR  style="border:0" align="absmiddle" >신체사항
                        <input type="checkbox" name="chkPRT_YN2_SHR"  id=chkPRT_YN2_SHR  style="border:0" align="absmiddle" >가족관계
                        <input type="checkbox" name="chkPRT_YN3_SHR"  id=chkPRT_YN3_SHR  style="border:0" align="absmiddle" >최종급여&nbsp;
                        <input type="checkbox" name="chkPRT_YN4_SHR"  id=chkPRT_YN4_SHR  style="border:0" align="absmiddle" checked>교육참여
                        <input type="checkbox" name="chkPRT_YN5_SHR"  id=chkPRT_YN5_SHR  style="border:0" align="absmiddle" >해외출장&nbsp;
                        <input type="checkbox" name="chkPRT_YN6_SHR"  id=chkPRT_YN6_SHR  style="border:0" align="absmiddle" >징계
                        <input type="checkbox" name="chkPRT_YN7_SHR"  id=chkPRT_YN7_SHR  style="border:0" align="absmiddle" >고과&nbsp;
                        <input type="checkbox" name="chkPRT_YN8_SHR"  id=chkPRT_YN8_SHR  style="border:0" align="absmiddle" >지인
                        <input type="checkbox" name="chkPRT_YN9_SHR"  id=chkPRT_YN9_SHR  style="border:0" align="absmiddle" >미참여교육
                        <input type="checkbox" name="chkPRT_YN10_SHR" id=chkPRT_YN10_SHR style="border:0" align="absmiddle" >공조부조
                    </td>
                </tr>
                </table>
             <div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <comment id="__NSID__">
                      ...
                      <param name="hnwsrc"    VALUE="pird015.hnw">
