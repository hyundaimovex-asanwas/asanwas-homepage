<!--
***********************************************************************
* @source      : pird080_PV.jsp
* @description : 사원증발급현황 PAGE
***********************************************************************
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="pird080.hnw">
              <param name="initvalue" VALUE="[:PRT_TYPE]=<%=PRT_TYPE%>[:ENO_NO]=<%=ENO_NO%>[:HIRS_YMD_SHR]=<%=HIRS_YMD_SHR%>[:HIRD_YMD_SHR]=<%=HIRD_YMD_SHR%>[:DPT_CD_SHR]=<%=DPT_CD_SHR%>">
