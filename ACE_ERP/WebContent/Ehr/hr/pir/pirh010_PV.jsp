...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="pirh010.hnw">
              <param name="initvalue" VALUE="[:BIR_YMD_SHR]=<%=BIR_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>[:FLAG_SHR]=<%=FLAG_SHR%>[:AGE_SHR]=<%=AGE_SHR%>">
