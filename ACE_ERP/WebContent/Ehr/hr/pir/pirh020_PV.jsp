...
<%
	...
	String EDGR_CD_SHR	= request.getParameter("EDGR_CD_SHR");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="pirh020.hnw">
              <param name="initvalue" VALUE="[:HIR_YMD_SHR]=<%=HIR_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:EDGR_CD_SHR]=<%=EDGR_CD_SHR%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>">
