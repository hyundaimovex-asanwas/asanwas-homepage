...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="pirh031.hnw">
              <param name="initvalue" VALUE="[:HIR_YMD_SHR]=<%=HIR_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>[:HIR_SHR]=<%=HIR_SHR%>[:FLAG_SHR]=<%=FLAG_SHR%>">
