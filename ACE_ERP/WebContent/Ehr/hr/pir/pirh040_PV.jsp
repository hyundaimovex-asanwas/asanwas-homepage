...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="pirh040.hnw">
              <param name="initvalue" VALUE="[:HIR_YMD_SHR]=<%=HIR_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>[:FLAG_SHR]=<%=FLAG_SHR%>[:HIR_SHR_01]=<%=HIR_SHR_01%>[:HIR_SHR_02]=<%=HIR_SHR_02%>">
