...
<head>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			var PMT_TAG_SHR = "2";//대리이하
			var PENO_GBN = "1";//부서장으로 조회
         ...
         ********************************************/
  		function enableInput(){
  		  	for(var i=2; i<5; i++){    // rdoPMT_LBL_TAG_01 ~ 03
  				document.form1.elements[i].disabled = false;
  			}
  			for(var i=14; i<32; i++){  // rdoITEM1_TAG01 ~ 0601
  				document.form1.elements[i].disabled = false;
  			}
  			for(var i=36; i<41; i++){  // rdoHEALTH_GBN_01 ~ 05
  				document.form1.elements[i].disabled = false;
  			}
    ...
    ***************************************************************************************-->
	...
	<script language=JavaScript for=dsT_PM_RECOMMAND event=OnRowPosChanged(row)>
		...
		//본부장수정내용은 부서장이 수정할 수 없다.
		if(dsT_PM_RECOMMAND.NameValue(row, "UPT_MAN") == dsT_PM_RECOMMAND.NameValue(row, "PENO_NO2")){
            disableInput();
		}else{
            setFieldEnable();
            enableInput();
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">부서장추천서관리</td>
					<td align="right" class="navigator">HOME/인사관리/승진/<font color="#000000">부서장추천서관리</font></td>
				</tr>
			</table>
			</td>
		</tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td valign="top">
                            ...
                            &nbsp;※ 추천사유는 6하원칙에 의거 구체적으로 작성해주세요.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※ 본부장 저장 추천서는 수정이 불가능합니다.
                        </td>
                    </tr>
                </table>
            </td>
