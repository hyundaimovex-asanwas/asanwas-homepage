...
<html>
<head>
	<title>최근 5년 승진현황(proa050)</title>
...
//            alert(REC_YMD_SHR + "   " + GBN_CD_SHR + "   " + OCC_CD_SHR);
            var occ_cd_val;
            param = "[@InitPage]=Page1[:REC_YMD_SHR]=" + REC_YMD_SHR;

            document.form1.aaa.OpenHnw("/hr/pro/proa050.hnw",param);
            f.flag.value = "Y";   // 인쇄조건.
        }
 ...
 //           form1.grdVI_T_CM_PERSON.GridToExcel("최근 5년 승진현황", '', 225)
        ...
        function fnc_Clear() {
        	...
        	document.form1.rdoGBN_CD_SHR[0].checked = true;
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">최근 5년 승진현황</td>
					<td align="right" class="navigator">HOME/인사관리/승진/<font color="#000000">최근 5년 승진현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
