    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            param = "[@InitPage]=Page1[:PMT_YMD_SHR]=" + PMT_YMD_SHR + "[:OCC_CD_SHR]=" + OCC_CD_SHR;
            document.form1.aaa.OpenHnw("/hr/pro/proa070.hnw",param);
            biz.style.display = "";
            f.flag.value = "Y";   // 인쇄조건.
     ...
     //           form1.aaa.SetValue('eee','rrrrrrrrrrr');
        ...
        function fnc_OnLoadProcess() {
			...
			document.form1.txtPMT_YMD_SHR.value = getToday().substr(0,4);
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">승진대상자 명단</td>
					<td align="right" class="navigator">HOME/인사관리/승진/<font color="#000000">승진대상자 명단</font></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="padding2423" align="left">
						...
						<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('imgPMT_YMD_SHR','','/images/button/btn_HelpOver.gif',1)" ><img src="/images/button/btn_HelpOn.gif" id="imgPMT_YMD_SHR" name="imgPMT_YMD_SHR" width="21" height="20" border="0" align="absmiddle" onclick="javascript:calendarBtn('datetype3','txtPMT_YMD_SHR','','114','108');"></a>
					</td>
					<td class="searchState" align="right">근로구분</td>
					<td class="padding2423" align="left">
						<select id="cmbOCC_CD_SHR" style="WIDTH: 20%" onChange="fnc_SearchList()">
            ...
            <td width="800">
                <table border="00" bordercolordark="white" bordercolorlight="gray" bordercolor="gray">
                    <comment id="__NSID__">
                        ...
                        <param name="hnwsrc"    VALUE="proa070_NULL.hnw">
