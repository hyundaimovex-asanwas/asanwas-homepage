...
<html>
<head>
	<title>계약직 승진대상자 명단(proa120)</title>
        ...
        function setGridTitle() {
	        ...
	        if( REC_YMD != "" ){
		       	document.grdVI_T_CM_PERSON.Format =''
					...
					+'<C> id="DPT_NM"		width=60	name="부서"			align=left		Edit=none	 LeftMargin="10"</C>'
					+'<C> id="ENO_NM"		width=60	name="성명"			align=center	Edit=none</C>'
					+'<C> id="ENO_NO"		width=60	name="사번"			align=center	Edit=none</C>'
					+'<C> id="HIR_YMD"		width=60	name="입사일"			align=center	Edit=none</C>'
					+'<G> name="현부서"			HeadBgColor="#F7DCBB"'
					+'	<C> id="DPA_YMD"	width=60	name="발령일"			align=center	Edit=none</C>'
					+'	<C> id="DPA_CON"	width=60	name="기간"			align=center	Edit=none</C>'
					+'</G>'
					+'<G> name="최종학력"	HeadBgColor="#F7DCBB"'
					+'	<C> id="SCH_NM"		width=100	name="학교"			align=left		Edit=none	 LeftMargin="10"</C>'
					+'	<C> id="MAJ_NM"		width=100	name="전공"			align=left		Edit=none	 LeftMargin="10"</C>'
					+'	<C> id="GUR_YY"		width=60	name="졸업년도"		align=center	Edit=none</C>'
					+'</G>'
					+'<X>name="인사고과"		HeadBgColor="#F7DCBB"';
				var j = 4;
				for(var i=1; i<5; i++){
					document.grdVI_T_CM_PERSON.Format += '<G> name="'+eval(REC_YMD+"-"+j)+"년"+'"			HeadBgColor="#F7DCBB"';
					document.grdVI_T_CM_PERSON.Format += '	<C> id="GO_'+i+'1"		width=30	name="상"		align=center	Edit=none	 </C>';
					document.grdVI_T_CM_PERSON.Format += '	<C> id="GO_'+i+'2"		width=30	name="하"		align=center	Edit=none	 </C>';
					document.grdVI_T_CM_PERSON.Format += '</G>';
					j = j-1;
				}
				document.grdVI_T_CM_PERSON.Format += ''
					+'</X>'
					+'		<C> id="POS_YN"			width=40	name="포상"			align=center		Edit=none</C>'
					+'		<C> id="DIS_YN"			width=40	name="징계"			align=center		Edit=none</C>'
					+'		<C> id="PRO_YN"			width=40	name="승진;대상"		align=center		Edit=none</C>';
	       	}
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">계약직 승진대상자 명단</td>
					<td align="right" class="navigator">HOME/인사관리/승진/<font color="#000000">계약직 승진대상자 명단</font></td>
				</tr>
			</table>
			</td>
		</tr>
