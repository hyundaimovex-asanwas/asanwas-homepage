...
<%
    ...
    String rec_ymd1 = Integer.toString(Integer.parseInt(rec_ymd) - 1);
    String rec_ymd2 = Integer.toString(Integer.parseInt(rec_ymd) - 2);
    String rec_ymd3 = Integer.toString(Integer.parseInt(rec_ymd) - 3);
    String rec_ymd4 = Integer.toString(Integer.parseInt(rec_ymd) - 4);
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="proa120.hnw">
              <param name="initvalue" VALUE="[:rec_ymd]=<%=rec_ymd%>[:rec_ymd4]=<%=rec_ymd4%>[:rec_ymd3]=<%=rec_ymd3%>[:rec_ymd2]=<%=rec_ymd2%>[:rec_ymd1]=<%=rec_ymd1%>">
