...
<script language="javascript" src="/common/input.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        var today = getToday();
        var dataClassName = "/servlet/GauceChannelSVL?cmd=hr.ret.a.reta030.cmd.RETA030CMD";
        var params = null;
        ...
        function fnc_Save() {
            ...
            dsT_AC_RETMASTER.nameValue(1,"DAY_AVG_AMT")     = document.getElementById("txtDAY_AVG_PAY").value.replace(/,/g,'');
...
*/
        ...
        function fnc_Print() {
            ...
            if ( f.print_flag.value == "Y" ) {
                ...
                var url = "reta030_PV.jsp?"+param1+param2+param3;
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_AC_RETPAY2,0,"true","false");      // Grid Style 적용
        ...
        function bindingAveragePay() {
            //급여일수조정일을 가져옴
            //var edDay       = fnc_covNumber(document.getElementById("txtED_DAY").value);
            ...
            //통상임금 조정
            //3월분 급여 총합 / 근무 일수 * (30 - 급여일수조정)
            //alert("평균:"+avgPay+" ,   통상:"+normalPay);
            //normalPay = Math.ceil(subTotal / pastDay * (30 - edDay)); <--잘못된거라 주석처리, 통상임금이 아니다(20080102 김우태)

            //평균임금 계산
            //3월분 급여 총합 / 근무 일수 * (30 - 급여일수조정) + 산입액
            //avgPay = Math.ceil(subTotal / pastDay * (30 - edDay) + subBon);
            ...
            oAVG_PAY.value = formatNumber(avgPay);
            oDAY_AVG_PAY.value = formatNumber(dayAvgPay);
...
Math.roundPrecision = function(val, precision) {
 ...
 return this.round(val * p) / p;
    ...
    **************************************-->
    ...
    <!-------------------------------------------------+
    | 데이터가 변경 되었을 때 처리 할 로직  |
    +-------------------------------------------------->
    <script language=JavaScript for=dsT_AC_RETPAY event=onColumnChanged(row,colid)>
		dsT_AC_RETPAY2.NameValue(row,'COL_1')
				= dsT_AC_RETPAY.NameValue(row,'COL_1') + dsT_AC_RETPAY.NameValue(row,'COL_2')
				+ dsT_AC_RETPAY.NameValue(row,'COL_3') + dsT_AC_RETPAY.NameValue(row,'COL_4') ;
...
*/
            ...
            document.getElementById("txtDAY_AVG_PAY").value         = formatNumber(dsT_AC_RETMASTER.nameValue(1,"DAY_AVG_AMT"));        //평균임금
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">퇴직금계산처리 (DB형)</td>
					<td align="right" class="navigator">HOME/정산세무/퇴직금관리/<font color="#000000">퇴직금계산처리 (DB형)</font></td>
				</tr>
			</table>
		</td>
	</tr>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
                <tr>
                    ...
                    <td class="content2" width="205">
                        <input type="text" id="txtHIRG_YMD" name="txtHIRG_YMD" style="ime-mode:disabled" size="10" maxlength="10" onblur="fnc_CheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();" class="input_ReadOnly" readonly>
                        ~
                        <input type="text" id="txtRET_YMD" name="txtRET_YMD" style="ime-mode:disabled" size="10" maxlength="10" onblur="fnc_CheckDate(this);" onkeypress="cfDateHyphen(this);cfCheckNumber();" class="input_ReadOnly" readonly>
                        ...
                        <img src="/images/button/btn_HelpOn.gif" name="img_YMD_SHR2" width="21" height="20" border="0" align="absmiddle">
                    </td>
                    ...
                    <td class="content2" width="140">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="10"></td>
                                <td><input id="txtRET_LSE_YY" name="txtRET_LSE_YY" type="text" size="2" class="input_ReadOnly" readonly>년</td>
                                <td><input id="txtRET_LSE_MM" name="txtRET_LSE_MM" type="text" size="2" class="input_ReadOnly" readonly>월</td>
                                <td><input id="txtRET_LSE_DD" name="txtRET_LSE_DD" type="text" size="2" class="input_ReadOnly" readonly>일</td>
                                <td width="10"></td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td class="content2" align="left">
                        <input id="txtRET_LSE_PER" name="txtRET_LSE_PER" type="text" size="10" class="input_ReadOnly" readonly>
<!--
                        &nbsp;
...
<!-- 급여 정보 보기 -->
            <table width="230" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999" id="CAL_TABLE2">
                <tr>
                    <td class="header" height="55">계</td>
                </tr>
            </table>
			<comment id="__NSID__">
            <object id="grdT_AC_RETPAY2" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:100%;height:247px;">
    ...
    <tr>
        <td colspan="2">
            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
                <tr>
                	<td class="header" width="100" height="22">일평균임금</td>
                    ...
                    <td class="header" width="80" height="22">평균임금</td>
                	...
                	<td class="header" width="80">퇴&nbsp;직&nbsp;금</td>
                    <td class="content3" >
                    ...
                    <td class="header" >퇴직위로금</td>
                    <td class="content3">
                        &nbsp;&nbsp;<input id="txtASD_AMT" name="txtASD_AMT" size="14" style="ime-mode:disabled;text-align:right;" onkeypress="cfCheckNumber();" onfocusout="this.value=formatNumber(this.value)"></td>
                </tr>
            </table>
<!-- 급여 정보 보기 -->
		</td>
