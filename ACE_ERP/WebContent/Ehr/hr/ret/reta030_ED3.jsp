...
<%
    ...
    hnwExtQuery.AddField("근속기간");
    hnwExtQuery.AddField("근속년수");
    hnwExtQuery.AddField("당시 기본금");
    hnwExtQuery.AddField("당시 퇴직금");
    hnwExtQuery.AddField("분담금");
    ...
    if (voList.size() > 0)
    {
        for ( int i=0; i<voList.size(); i++ )
        {
            ...
            hnwExtQuery.AddData(vo.getString("LSE_YY")+"년"+vo.getString("LSE_MM")+"월"+vo.getString("LSE_DD")+"일");
