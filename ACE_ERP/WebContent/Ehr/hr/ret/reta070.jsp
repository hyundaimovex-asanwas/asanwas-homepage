...
<html>
<head>
    <title>퇴직금중간정산집행현황(reta070)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        var gridFormat = "<C> id={CUROW}     width=40    align=center    name=NO         value={String(Currow)}</C>"
                       + "<C> id=DPT_NM      width=70    align=center    name=부서   Edit=None    </C>"
                       + "<C> id=JOB_NM      width=70    align=center    name=직위   Edit=None     </C>"
                       + "<C> id=ENO_NO      width=70    align=center    name=사번   Edit=None     </C>"
                       + "<C> id=ENO_NM      width=70    align=center    name=성명    Edit=None    </C>"
                       + "<C> id=SEQ_NO      width=70    align=center    name=회차                Value={Decode(SEQ_NO,'0','퇴직','1','1차','2','2차','3','3차')}</C>"
                       + "<C> id=RAM_YMD     width=70    align=center    name=중간정산일    Edit=None    </C>"
                       + "<C> id=RTR_AMT     width=70    align=center    name=퇴직금합계    Edit=None    </C>"
                       + "<C> id=COMP        width=100   align=center    name=회사부담금    Edit=None    </C>"
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_AC_RETMASTER.GridToExcel("퇴직금중간정산집행현황", '', 225);
        }
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid2(form1.grdT_AC_RETMASTER,0,"false","false");      // Grid Style 적용
        ...
        //항목들의 메세지                                        
        var oElementMsgList = new Array( "시작일"
                                        ,"종료일"
                                        ,"사번");     
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">퇴직금중간정산집행현황</td>
                    <td align="right" class="navigator">HOME/정산세무/퇴직보험관리/<font color="#000000">퇴직금중간정산집행현황</font></td>
                </tr>
            </table>
            </td>
        </tr>
