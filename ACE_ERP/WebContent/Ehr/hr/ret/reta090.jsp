...
*****************************************************
* @source      : reta030.jsp
* @description : 정산세무/퇴직금관리/ 퇴직금예상금액조회(DB형)
*****************************************************
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            var oYMD_VAL        = null;
			var todaySc = "<%=common.util.DateUtil.getCurrentDateStr("yyyy-MM-dd")%>";
            ...
            if(oRET_YMD.value == "") {
                oRET_YMD.value=  todaySc;
            }
			oYMD_VAL = oRET_YMD.value;
...
<%
    //관리자나 총무 관리자 이면 전체 검색하고 일반유저이면 자기정보만 확인
    if(!box.getString("SESSION_ROLE_CD").equals("1002") && !box.getString("SESSION_ROLE_CD").equals("1001")) {
%>
...
%>
        ...
        function bindingTenure() {
            ...
            if(oRET_YMD.value == null || oRET_YMD.value == "") oRET_YMD.value  = document.getElementById(elementNames[type]).value; //정산기준일
        }
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">퇴직금예상금액조회(DB형) </td>
					<td align="right" class="navigator">HOME/정산세무/퇴직금관리/<font color="#000000">퇴직금예상금액조회(DB형) </font></td>
				</tr>
			</table>
		</td>
	</tr>
