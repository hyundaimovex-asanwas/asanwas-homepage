...
String PIS_YY = request.getParameter("PIS_YM").substring(0,4);
String PIS_MM = request.getParameter("PIS_YM").substring(5,7);
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="retb020.hnw">
              <param name="initvalue" VALUE="[:PIS_MM]=<%=PIS_MM%>[:PIS_YY]=<%=PIS_YY%>">
