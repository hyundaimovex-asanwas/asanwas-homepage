    ...
    <script language="javascript">
        ...
        function fnc_FileUpload() {
            ...
            trFILE_UPLOAD.KeyValue = "TR_FILE"
                                   ...
                                   + ",O:dsT_AC_RETINSURANCE=dsT_AC_RETINSURANCE)";     //명부 리스트
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_AC_RETINSURANCE.GridToExcel("보험회사명부입력", '', 225);
        }
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">보험회사명부입력</td>
                    <td align="right" class="navigator">HOME/정산세무/퇴직보험관리/<font color="#000000">보험회사명부입력</font></td>
                </tr>
            </table>
            </td>
        </tr>
				...
				<tr align="center">
					...
					<object id="grdT_AC_RETINSURANCE" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
						...
						<param name="Format" value='
                            ...
                            <C> id=PIS_YY       width=60        align=center    name=기준연도           Edit=None</C>
                            <C> id=BNK_NM       width=90        align=center    name=보험회사            Edit=None</C>
                            <C> id=STATUS       width=70        align=center    name=성명                 HeadCheckShow=true      EditStyle=CheckBox  CheckBoxText=ENO_NM    Pointer=Hand</C>
                            <C> id=CET_NO       width=110       align=center    name=주민번호            Edit=None</C>
                            <C> id=HIRG_YMD     width=70        align=center    name=입사일              Edit=None</C>
                            <C> id=RAM_YMD      width=70        align=center    name=중간정산일          Edit=None</C>
                            <C> id=PAY_AMT      width=90        align=right     name=기준급여            Edit=None  rightmargin=10</C>
                            <C> id=EXP_AMT      width=90        align=right     name=추계액              Edit=None rightmargin=10</C>
                            <C> id=RES_AMT      width=90        align=right     name=예상적립금          Edit=None   rightmargin=10</C>
						'>
					</object>
