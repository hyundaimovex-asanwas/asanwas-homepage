...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="saga010.hnw">
              <param name="initvalue" VALUE="[:APY_YMD_SHR]=<%=APY_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:JOB_CD_SHR]=<%=JOB_CD_SHR%>">
