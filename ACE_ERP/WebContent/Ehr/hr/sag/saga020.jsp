...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CP_PAYMASTER.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga020.cmd.SAGA020CMD&S_MODE=SHR&PIS_YYMM_SHR="+PIS_YYMM_SHR+"&SAL_GBN_SHR="+SAL_GBN_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&SEQ_SHR="+SEQ_SHR;
        ...
        function fnc_Save() {
			...
			tr01T_CP_PAYMASTER.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga020.cmd.SAGA020CMD&S_MODE=SAV&PIS_YYMM_SHR="+PIS_YYMM_SHR+"&SAL_GBN_SHR="+SAL_GBN_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&SEQ_SHR="+SEQ_SHR;
        ...
        function fnc_Delete() {
			...
			trT_CP_PAYMASTER.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga020.cmd.SAGA020CMD&S_MODE=DEL&PIS_YYMM_SHR="+PIS_YYMM_SHR+"&SAL_GBN_SHR="+SAL_GBN_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&SEQ_SHR="+SEQ_SHR;
			trT_CP_PAYMASTER.post();
			fnc_Clear();
        ...
        function fnc_Print() {
		    ...
		    var url = "saga020_PV.jsp?PIS_YYMM_SHR="+PIS_YYMM_SHR+"&SAL_GBN_SHR="+SAL_GBN_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&SEQ_SHR="+SEQ_SHR;
