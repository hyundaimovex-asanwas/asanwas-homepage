...
<script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송
            dsT_CP_WORKLOG.DataID = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SHR&PIS_YYMM_SHR="+PIS_YYMM_SHR+"&OCC_CD_SHR="+OCC_CD_SHR+"&SEQ_SHR="+SEQ_SHR;
         ...
         *******************************************************/
         ...
         function object_sts_1(){
			...
			dsT_CP_WORKLOG.NameValue(i,"OCC_CD")="A";
			dsT_CP_WORKLOG.NameValue(i,"SAL_GBN")="0";
			...
			trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV";
			trT_CP_WORKLOG.Post();
         ...
         function object_sts_2(){
			...
			//트랜잭션 전송
			trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
			trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV_01";
			trT_CP_WORKLOG.Post();
         ...
         function object_sts_7(){
			...
			window.showModalDialog("/hr/sag/saga031.jsp", dsT_CP_WORKLOG, "dialogWidth:600px; dialogHeight:400px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
         ...
         function object_sts_4(){
			...
			//트랜잭션 전송
			trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
			trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV_03";
			trT_CP_WORKLOG.Post();
         ...
         function object_sts_2_reset(){
			...
			if(PRO_STS == "2" || PRO_STS == "7"){//대상자선정, 대상자추가 초기화
				...
				//트랜잭션 전송
				trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
				trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV_02";
				trT_CP_WORKLOG.Post();
			}
         }
         ...
         function object_sts_4_reset(){
			...
			if(PRO_STS == "4"){//금액,세액 계산 초기화
				...
				//트랜잭션 전송
				trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
				trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV_04";
				trT_CP_WORKLOG.Post();
			}
         }
         ...
         function object_sts_6(){
			...
			//트랜잭션 전송
			trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
			trT_CP_WORKLOG.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga030.cmd.SAGA030CMD&S_MODE=SAV_05";
			trT_CP_WORKLOG.Post();
         }
  		...
  		function enableInput(state){
			...
			document.form1.txtPIS_YYMM_SHR.readOnly = true;
  			...
  			if(state == "0"){//작업OPEN가능
				...
				//document.getElementById("btnPRO_STS_7").className="inputDisabled";//대상자추가
				...
				//document.getElementById("btnPRO_STS_7").className="";//대상자추가
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">급여계산처리</td>
					<td align="right" class="navigator">HOME/보상관리/급여관리/<font color="#000000">급여계산처리</font></td>
				</tr>
			</table>
		</td>
	</tr>
        ...
        <td class="paddingTop8">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
				...
				<tr>
					...
					<td align="center" class="creamBold">연봉기준일자</td>
					<td class="padding2423">
	                ...
	                <td class="paddingTop8">
	                    <table width="800" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
	                        ...
	                        <tr height="50">
	                            ...
	                            <!--  	                            
	                            <td align="center" class="padding2423">
	                                <input type="button" id="btnPRO_STS_7" style="cursor:hand;width:110pt;height:25pt;" value=" 대상자추가 " onclick="object_sts_7();">
	                            </td>
	                            -->
	                            <td align="center" class="padding2423">
