<!--
***********************************************************************
* @source         : saga050_ED.jsp 				                                                                                     *
* @description   : 급여대장 PAGE.
***********************************************************************
   ...
   // gbn_cd = "0";
    ...
    if ( gbn_cd.equals("0") ) {
        /** 외부 XML에서 SQL을 읽어 온다 **/
         ...
         sql = XmlSqlUtils.getSQL("sag", "SAGA050_SHR_01");
         System.out.println("구분1 [" + gbn_cd + "]");
         System.out.println(sql);
     } else {
         sql = XmlSqlUtils.getSQL("sag", "SAGA050_SHR_02");
...
//			hnwExtQuery.AddData(vo.getString("GUBUN"));		    // 국내외구분
			...
			//실지급액
            hnwExtQuery.AddData(vo.getString("SALT_AMT"));		// 급여지급액(A)
            hnwExtQuery.AddData(vo.getString("DDTT_AMT"));		// 급여공제액(B)
            ...
            hnwExtQuery.AddData(vo.getString("INV_AMT"));		// 출자금
            hnwExtQuery.AddData(vo.getString("LON_RPY"));		// 대출상환금
            hnwExtQuery.AddData(vo.getString("LON_INT"));		// 대출상환이자
