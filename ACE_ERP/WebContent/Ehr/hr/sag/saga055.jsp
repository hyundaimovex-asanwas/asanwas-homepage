    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Print() {
			...
			var url = "saga055_PV.jsp?pis_ym="+pis_ym+"&dpt_cd="+dpt_cd+"&gbn_cd="+gbn_cd;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">상여대장</td>
                    <td align="right" class="navigator">HOME/보상관리/상여관리/<font color="#000000">상여대장</font></td>
                </tr>
            </table>
        </td>
    </tr>
