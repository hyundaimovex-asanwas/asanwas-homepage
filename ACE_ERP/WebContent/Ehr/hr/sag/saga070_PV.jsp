...
<%
    String PIS_YY = request.getParameter("PIS_YY_SHR");
    String ENO_NO = request.getParameter("ENO_NO_SHR");
    String OCC_CD = request.getParameter("OCC_CD");

    String rpt_name = "";

	if(OCC_CD.equals("A"))  //사무직 이면
	{
		rpt_name = "saga070.hnw";
	}else
	{
		rpt_name = "saga070_M.hnw";
	}
...
<comment id="__NSID__">
              ...
              <param name="initvalue" VALUE="[:PIS_YY]=<%=PIS_YY%>[:ENO_NO]=<%=ENO_NO%>">
