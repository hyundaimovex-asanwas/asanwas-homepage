...
<head>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        var dataClassName = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga090.cmd.SAGA090CMD";
        var params = null;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_CP_WORKLOG.GridToExcel("급여전표처리", '', 225);
        }
        ...
        function fnc_proc1() {
            ...
            if (confirm("전표 작업 OPEN 하시겠습니까? ") == false) return;
        ...
        function fnc_proc2() {
            ...
            if (confirm("급여 회계전표발행을 하시겠습니까? ") == false) return;
        ...
        function fnc_proc3() {
            ...
            if (confirm("일반관리비 (복리후생비) 전표발행을 하시겠습니까? ") == false) return;
    ...
    ***************************************************************************************-->
    ...
    <Script For=dsT_CP_WORKLOG Event="OnLoadCompleted(iCount)">
        ...
        if(iCount == 0) {
            ...
            document.getElementById("txtWRK_NO1").value = dsT_CP_WORKLOG.NameString(1, "WRK_NO1");  //일반관리비(급여)
            document.getElementById("txtWRK_NO2").value = dsT_CP_WORKLOG.NameString(1, "WRK_NO2");  //일반관리비(복리후생비)
            document.getElementById("txtWRK_NO3").value = dsT_CP_WORKLOG.NameString(1, "WRK_NO3");  //소득세/기타
            ...
            if(oPRO_STS.value != 1 && oPRO_STS.value != 5) {
                fnc_ChangeStateElement(true, procBtnList[5]);
            }
        }
    </Script>
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">급여전표처리</td>
                    <td align="right" class="navigator">HOME/보상관리/급여관리/<font color="#000000">급여전표처리</font></td>
                </tr>
            </table>
            </td>
        </tr>
                        ...
                        <td class="padding2423" colspan="3">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    ...
                                    <td><b>일반관리비 (급여)</b></td>
                                    <td><b>일반관리비 (복리후생비)</b></td>
                                    <td><b>소득세/기타</b></td>
                                </tr>
                                <tr>
                                    <td>관리번호&nbsp;<input id="txtWRK_NO1" name="txtWRK_NO1" type="text" class="input_ReadOnly" readonly></td>
                                    <td>그룹번호&nbsp;<input id="txtWRK_NO2" name="txtWRK_NO2" type="text" class="input_ReadOnly" readonly></td>
                                    <td>관리번호&nbsp;<input id="txtWRK_NO3" name="txtWRK_NO3" type="text" class="input_ReadOnly" readonly></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                                <tr height="50">
                                    <td align="center" class="padding2423">
                                        ...
                                        <input type="button" id="btnPROC2" style="cursor:hand;width:140pt;height:25pt;" value=" 급여 가전표생성 " onclick="fnc_proc2()">
                                    	<input type="button" id="btnPROC5" style="cursor:hand;width:140pt;height:25pt;" value=" 작업 COLSE" onclick="fnc_proc5()">
                                    </td>
                                </tr>
                            </table>
                        </td>
