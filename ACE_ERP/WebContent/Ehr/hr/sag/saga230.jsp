...
<script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            */
            ...
            //dsT_CP_PAYTABLE.DataID = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SHR&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR;
			...
			trT_CP_PAYTABLE_SHR.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SHR&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR;
        ...
        function fnc_Save() {
			...
			trT_CP_PAYTABLE.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAV&APY_YMD_SHR="+APY_YMD_SHR;
        ...
        function fnc_Delete() {
			...
			//trT_CP_PAYTABLE.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAV";
			//trT_CP_PAYTABLE.post();
        ...
        function fnc_OnLoadProcess() {
			...
			//최근 저장한 기준일 조회
			ds01T_CP_PAYTABLE.DataID = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SHR_01";
        ...
        function fnc_proc() {
			...
			//트랜잭션 전송
			trT_CP_PAYTABLE.KeyValue = "SVL(I:SAV=dsT_CP_PAYTABLE, O:dsRESULT=dsRESULT)";
			trT_CP_PAYTABLE.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=BILL&APY_YMD_SHR="+APY_YMD_SHR;
			trT_CP_PAYTABLE.post();
		}
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">급여회계가전표(국내)</td>
					<td align="right" class="navigator">HOME/보상관리/급여관리/<font color="#000000">급여회계가전표(국내)</font></td>
				</tr>
			</table>
		</td>
	</tr>
