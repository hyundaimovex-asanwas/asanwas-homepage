...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CM_PERSON.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAP_ACC&CD="+cd;
			trT_CM_PERSON.post();
        }
    ...
    **************************************-->
    ...
    <Script For=dsT_CM_PERSON Event="OnLoadCompleted(iCount)">
        ...
        grdT_CM_PERSON.SetColumn("ACCOUNT_CD");//set focus
    </Script>
    ...
    <script language=JavaScript for=grdT_CM_PERSON event=OnDblClick(row,colid)>
        ...
        var retObj = window.dialogArguments;
		retObj.acc_cd    = dsT_CM_PERSON.NameValue(row,'ACCOUNT_CD');
        retObj.acc_nm    = dsT_CM_PERSON.NameValue(row,'ACCOUNT_NM');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">계정정보조회</td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td>
                            ...
                            <object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:580px;height:430px;">
                                ...
                                <param name="Format"            value='
                                    <C> id=ACCOUNT_CD            width=200   name=ACCOUNT코드   align=left   </C>
                                    <C> id=ACCOUNT_NM            width=360   name=ACCOUNT명   align=left   </C>
                                '>
                            </object>
