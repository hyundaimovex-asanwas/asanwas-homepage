...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CM_PERSON.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAP_WBS&CD="+cd;
			trT_CM_PERSON.post();
        }
    ...
    **************************************-->
    ...
    <script language=JavaScript for=grdT_CM_PERSON event=OnDblClick(row,colid)>
        ...
        var retObj = window.dialogArguments;
        retObj.cctr_cd    = dsT_CM_PERSON.NameValue(row,'CCTR_CD');
		retObj.cctr_nm    = dsT_CM_PERSON.NameValue(row,'CCTR_NM');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">프로젝트정보 조회</td>
                    </tr>
                </table>
            </td>
        </tr>
