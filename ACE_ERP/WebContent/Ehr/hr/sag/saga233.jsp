...
***********************************************************************
* @source      : buta011.jsp
* @description : SAP의 프로젝트정보조회 PAGE
***********************************************************************
...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CM_PERSON.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAP_VENDOR&CD="+cd;
			trT_CM_PERSON.post();
        }
    ...
    **************************************-->
    ...
    <Script For=dsT_CM_PERSON Event="OnLoadCompleted(iCount)">
            ...
            grdT_CM_PERSON.SetColumn("VENDOR_CD");//set focus
    ...
    <script language=JavaScript for=grdT_CM_PERSON event=OnDblClick(row,colid)>
        ...
        var retObj = window.dialogArguments;
        retObj.vendor_cd    = dsT_CM_PERSON.NameValue(row,'VENDOR_CODE');
        retObj.vendor_nm    = dsT_CM_PERSON.NameValue(row,'VENDOR_NAME');
        retObj.business_no    = dsT_CM_PERSON.NameValue(row,'BUSINESS_NO');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">매입처정보 조회</td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" class="searchState">검색&nbsp;</td>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                        <td>
                            <comment id="__NSID__">
                            <object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:580px;height:430px;">
                                <param name="DataID"            value="dsT_CM_PERSON">
                                <param Name="Editable"          value="false">
                                <param name=HiddenHScroll    value="false">
                                <param name="Format"            value='
                                    <C> id=VENDOR_CODE            width=100   name=매입처코드   align=left   </C>
                                    <C> id=VENDOR_NAME            width=200   name=매입처명   align=left   </C>
                                    <C> id=BUSINESS_NO            width=100   name=BUSINESS_NO   align=center </C>
                                    <C> id=ADDR            width=200   name=주소   align=center </C>
                                '>
                            </object>
