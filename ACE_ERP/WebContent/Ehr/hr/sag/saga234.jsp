    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CM_PERSON.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga230.cmd.SAGA230CMD&S_MODE=SAP_COST&CD="+cd;
			trT_CM_PERSON.post();
        }
    ...
    **************************************-->
    ...
    <Script For=dsT_CM_PERSON Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
            ...
            document.getElementById("txtCD_SHR").focus();          //검색 1조건에 Focus
    ...
    <script language=JavaScript for=grdT_CM_PERSON event=OnDblClick(row,colid)>
        ...
        var retObj = window.dialogArguments;
        retObj.dpt_cd    = dsT_CM_PERSON.NameValue(row,'CCTR_CD');
		retObj.dpt_nm    = dsT_CM_PERSON.NameValue(row,'CCTR_NM');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">회계부서정보 조회</td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td>
                            ...
                            <object id="grdT_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:580px;height:430px;">
                                ...
                                <param name="Format"            value='
                                    <C> id=CCTR_CD            width=200   name=CCTR코드   align=left   </C>
                                    <C> id=CCTR_NM            width=360   name=CCTR명   align=left   </C>
                                '>
                            </object>
