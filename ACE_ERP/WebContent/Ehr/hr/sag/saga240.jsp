...
<script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            */
            ...
            //dsT_CP_PAYTABLE.DataID = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=SHR&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR;
			...
			trT_CP_PAYTABLE_SHR.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=SHR&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR;
        ...
        function fnc_Save() {
			...
			trT_CP_PAYTABLE.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=SAV&APY_YMD_SHR="+APY_YMD_SHR;
        ...
        function fnc_Delete() {
			...
			//trT_CP_PAYTABLE.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=DEL";
			//trT_CP_PAYTABLE.post();
        ...
        function fnc_OnLoadProcess() {
			...
			//최근 저장한 기준일 조회
			ds01T_CP_PAYTABLE.DataID = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=SHR_01";
		...
		function fnc_proc() {
			...
			//트랜잭션 전송
			trT_CP_PAYTABLE.KeyValue = "SVL(I:SAV=dsT_CP_PAYTABLE, O:dsRESULT=dsRESULT)";
			trT_CP_PAYTABLE.action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.saga240.cmd.SAGA240CMD&S_MODE=BILL&APY_YMD_SHR="+APY_YMD_SHR;
			trT_CP_PAYTABLE.post();
		}
		...
		function fnc_ChangeGrid() {
			...
			form1.grdT_CP_PAYTABLE.Format = "<C> id='{CUROW}'		width=40		name='NO'						align=center		value={String(Currow)}		BgColor='#EEEEEE'		</C>" +
											...
											"<C> id='ACC_NM'		width=60		name='계정과목'	EditStyle=Lookup	ListWidth=150 Data='dsT_SAP_ACCOUNT:ACCOUNT_CD:ACCOUNT_NM' Edit=none  align=center   LeftMargin=10	 SubBgColor='#99FFCC'	 sumtext='합   계'   </C>" +
											"<C> id='CUS_CD'        width=60        name='거래처'      align=center    SubBgColor='#99FFCC' Edit=none  </C>" +
											"<C> id='CUS_NM'        width=60        name='거래처명' EditStyle=Lookup  Data='dsT_SAP_VENDOR:VENDOR_CODE:VENDOR_NAME'   align=center    SubBgColor='#99FFCC' Edit=none  </C>" +
											"<C> id='PRJ_CD'        width=75        name='프로젝트'        align=center  SubBgColor='#99FFCC'	  Edit=none  </C>" +
											"<C> id='PRJ_NM'        width=75        name='프로젝트명'  EditStyle=Lookup  Data='dsT_SAP_WBS:CCTR_CD:CCTR_NM'    align=center  SubBgColor='#99FFCC'	  Edit=none  </C>" +
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">급여회계가전표(해외)</td>
					<td align="right" class="navigator">HOME/보상관리/급여관리/<font color="#000000">급여회계가전표(해외)</font></td>
				</tr>
			</table>
		</td>
	</tr>
            ...
            <td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    <colgroup>
                     ...
                     <tr>
                        ...
                        <td class="padding2423" colspan="3">
                            ...
                            <img src="/images/button/btn_HelpOn.gif" id="ImgAccCd" name="ImgAccCd" width="21" height="20" border="0" align="absmiddle" onclick="fnc_AccountPopup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgAccCd','','/images/button/btn_HelpOver.gif',1)" style="cursor:hand;">
                        </td>
                        ...
                        <td class="padding2423" colspan="3">
                            ...
                            <img src="/images/button/btn_HelpOn.gif" id="ImgCusCd" name="ImgCusCd" width="21" height="20" border="0" align="absmiddle" onclick="fnc_VendorPopup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgCusCd','','/images/button/btn_HelpOver.gif',1)" style="cursor:hand;">
                        </td>
                   </tr>
                   <tr>
                        ...
                        <td class="padding2423" colspan="3">
                            ...
                            <img src="/images/button/btn_HelpOn.gif" id="ImgPrjCd" name="ImgPrjCd" width="21" height="20" border="0" align="absmiddle" onclick="fnc_PrjPopup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgPrjCd','','/images/button/btn_HelpOver.gif',1)" style="cursor:hand;">
                        </td>
                        ...
                        <td class="padding2423" colspan="3">
                            ...
                            <img src="/images/button/btn_HelpOn.gif" id="ImgDptCd" name="ImgDptCd" width="21" height="20" border="0" align="absmiddle" onclick="fnc_CostDeptPopup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ImgDptCd','','/images/button/btn_HelpOver.gif',1)" style="cursor:hand;">
                        </td>
                   </tr>
                   <tr>
                   ...
                   <tr>
                        ...
                        <td class="padding2423" colspan="3">
                            <input id="txtDESP" name="txtDESP" size="50" class="input_ReadOnly"  maxlength= "8"onkeypress="javascript:if(event.keyCode==13) fnc_SearchEmpNo()" onchange="fnc_SearchEmpNo()">
                        </td>
                        <td align="center" class="creamBold">비 고</td>
                        <td class="padding2423" colspan="3">
                            <input id="txtDESP2" name="txtDESP2" size="50" class="input_ReadOnly"  	maxlength= "8"onkeypress="javascript:if(event.keyCode==13) fnc_SearchEmpNo()" onchange="fnc_SearchEmpNo()">
                        </td>
                   </tr>
                </table>
            </td>
