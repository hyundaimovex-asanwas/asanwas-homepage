...
<script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_CP_PAYTABLE.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.a.saga220.cmd.SAGA220CMD&S_MODE=SHR_09&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR+"&SAL_GBN_SHR="+SAL_GBN_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
		...
		function fnc_ChangeGrid(obj) {
			...
			if(obj == undefined || obj.value == "A"){
				...
				form1.grdT_CP_PAYTABLE.Format = "<C> id='{CUROW}'		width=40	name='NO'				align=center		value={String(Currow)}		BgColor='#EEEEEE'		</C>" +
												"<C> id='ENO_NM'        width=80    name='성명'          	align=center    	SumBgColor=#C3D0DB SumText='계'</C>" +
												"<C> id='ENO_NO'        width=70    name='사번'          	align=center    	SumBgColor=#C3D0DB</C>" +
												"<C> id='JOB_NM'        width=100   name='직위'        		align=center    	SumBgColor=#C3D0DB</C>" +
												"<C> id='ABA_NM'        width=130   name='은행명'      		align=center       	SumBgColor=#C3D0DB</C>" +
												"<C> id='WHAT1'         width=100   name='의뢰인번호'       align=center    	SumBgColor=#C3D0DB</C>" +
												...
												"<C> id='WHAT2'         width=80    name='입지코드'       	align=center    	SumBgColor=#C3D0DB</C>" +
												"<C> id='WHAT3'         width=80    name='적요'       		align=center    	SumBgColor=#C3D0DB</C>" +
												"<C> id='WHAT4'         width=100   name='입력 예금주명'    align=center    	SumBgColor=#C3D0DB</C>" +
												"<C> id='WHAT5'         width=100   name='원장 예금주명'    align=center    	SumBgColor=#C3D0DB</C>" +												
												"<C> id='DESCPT'        width=180   name='비고'      		align=center       	SumBgColor=#C3D0DB</C>"
