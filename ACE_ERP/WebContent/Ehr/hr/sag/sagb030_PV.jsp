...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="sagb030.hnw">
              <param name="initvalue" VALUE="[:PIS_YM]=<%=PIS_YM%>[:OCC_CD]=<%=OCC_CD%>[:SAL_GBN]=<%=SAL_GBN%>[:BON_NUM]=<%=BON_NUM%>[:SAL_CD]=<%=SAL_CD%>[:AD_TAG]=<%=AD_TAG%>[:IPT_MAN]=<%=IPT_MAN%>">
