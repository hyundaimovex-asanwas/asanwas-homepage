...
<html>
<head>
<title>철야당직비본부장결재처리(sagb100)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchItemCheck() {
			...
			var HOL_YMD_SHR = document.getElementById("txtPIS_YM_SHR").value; // 시작년월
		...
		function fnc_Append(app_yn) {
            ...
            var text = "[해당년월:"+dsT_DI_APPROVAL.NameString(dsT_DI_APPROVAL.RowPosition, "GUN_YMD")+", "
                     + "상신자:"+dsT_DI_APPROVAL.NameString(dsT_DI_APPROVAL.RowPosition, "ENO_NM3")+"] "
    ...
    **************************************-->
    ...
    <script language=JavaScript for=dsT_DI_APPROVAL event=OnRowPosChanged(row)>
        ...
        var HOL_YMD = document.getElementById("txtPIS_YM_SHR").value.split("-");
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">철야당직비본부장결재처리</td>
					<td align="right" class="navigator">HOME/근태관리/철야당직/<font color="#000000">철야당직비본부장결재처리</font></td>
				</tr>
			</table>
		</td>
	</tr>
