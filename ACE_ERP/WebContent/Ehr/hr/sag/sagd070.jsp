...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			trT_CP_PAYMASTER.Action = "/servlet/GauceChannelSVL?cmd=hr.sag.a.sagd070.cmd.sagd070CMD&S_MODE=SHR&PIS_YY_SHR="+PIS_YY_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
        ...
        function fnc_Print() {
			...
			var url = "sagd070_PV.jsp?PIS_YY_SHR="+PIS_YY_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&OCC_CD="+OCC_CD;
