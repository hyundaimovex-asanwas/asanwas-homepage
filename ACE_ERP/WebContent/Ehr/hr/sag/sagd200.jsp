...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			if(SAL_GBN == 0){
	            ...
	            dsT_CP_PAYTABLE.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.d.sagd200.cmd.SAGD200CMD&S_MODE=SHR&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
	            dsT_CP_PAYTABLE.Reset();
			}else if(SAL_GBN == 2){
	            //데이터셋 전송
	            dsT_CP_PAYTABLE.UseChangeInfo = true;
	            dsT_CP_PAYTABLE.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.d.sagd200.cmd.SAGD200CMD&S_MODE=SHR_SO&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
	            dsT_CP_PAYTABLE.Reset();
        ...
        function fnc_Print() {
			...
			//급여 소급 구분.
			if(SAL_GBN == 0){
	            dsT_Grid_Detail.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.d.sagd200.cmd.SAGD200CMD&S_MODE=SHR_PRINT&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
	            dsT_Grid_Detail.Reset();
			}else if(SAL_GBN == 2){
	            dsT_Grid_Detail.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.d.sagd200.cmd.SAGD200CMD&S_MODE=SHR_SO&APY_YMD_SHR="+APY_YMD_SHR+"&PAY_YMD="+PAY_YMD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
	            dsT_Grid_Detail.Reset();
			}
        ...
        function fnc_OnLoadProcess() {
			...
			//최근 저장한 기준일 조회
			ds01T_CP_PAYTABLE.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.sag.d.sagd200.cmd.SAGD200CMD&S_MODE=SHR_01";
		...
		function fnc_ChangeGrid(obj) {
			...
			form1.grdT_CP_PAYTABLE.Format =
					...
					"<C> id='P04_AMT'      		width=100       name='특수지수당'      	align=right     </C>" +
					...
					"<C> id='CASH_AMT'      	width=100       name='출납수당'     	align=right     </C>" +
					"<C> id='CAR_AMT'    		width=100       name='차량유지비'     	align=right     </C>" +
					"<C> id='MEAL_AMT'    		width=100       name='식대'     		align=right     </C>" +
					"<C> id='STAY_AMT'    		width=100       name='현지체류비'     	align=right     </C>" +
					"<C> id='DRI_AMT'      		width=100       name='운전수당'      	align=right     </C>" +
					"<C> id='BOSS_AMT'      	width=100       name='사장단수당'      	align=right     </C>" +
					...
					"<C> id='GOOD_AMT'       	width=100       name='성과급'      	align=right     </C>" +					
...
<B>id=DHeader ,left=0,top=0 ,right=4101 ,bottom=199 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='출납수당' ,left=1577 ,top=13 ,right=1799 ,bottom=71 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='개인연금' ,left=1352 ,top=130 ,right=1574 ,bottom=185 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='사장단수당' ,left=1352 ,top=74 ,right=1574 ,bottom=127 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자격수당' ,left=1122 ,top=130 ,right=1347 ,bottom=185 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='운전수당' ,left=1352 ,top=13 ,right=1574 ,bottom=71 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장직책' ,left=1122 ,top=74 ,right=1347 ,bottom=127 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='식대' ,left=1122 ,top=13 ,right=1347 ,bottom=71 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='차량유지비' ,left=894 ,top=130 ,right=1119 ,bottom=185 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='조정수당' ,left=894 ,top=74 ,right=1119 ,bottom=127 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='특수지수당' ,left=894 ,top=13 ,right=1119 ,bottom=71 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='기타지급' ,left=1828 ,top=13 ,right=2064 ,bottom=69 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='학자금' ,left=1577 ,top=74 ,right=1799 ,bottom=127 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='현지체류비' ,left=1577 ,top=130 ,right=1799 ,bottom=185 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='직책수당' ,left=1828 ,top=71 ,right=2064 ,bottom=124 ,face='HY중고딕' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<B>id=default ,left=0,top=0 ,right=4101 ,bottom=175 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='{decode(P04_AMT,0,,P04_AMT)}', left=894, top=5, right=1119, bottom=56, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(P05_AMT,0,,P05_AMT)}', left=894, top=58, right=1119, bottom=108, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(CAR_AMT,0,,CAR_AMT)}', left=894, top=111, right=1119, bottom=161, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(MEAL_AMT,0,,MEAL_AMT)}', left=1124, top=5, right=1349, bottom=56, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<C>id='{decode(CET_AMT,0,,CET_AMT)}', left=1124, top=111, right=1349, bottom=161, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(DRI_AMT,0,,DRI_AMT)}', left=1352, top=5, right=1577, bottom=56, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(BOSS_AMT,0,,BOSS_AMT)}', left=1352, top=58, right=1577, bottom=108, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(PPEN_AMT,0,,PPEN_AMT)}', left=1352, top=111, right=1577, bottom=161, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(SCH_AMT,0,,SCH_AMT)}', left=1580, top=58, right=1797, bottom=108, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(CASH_AMT,0,,CASH_AMT)}', left=1580, top=5, right=1797, bottom=56, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<C>id='{decode(OTH_AMT,0,,OTH_AMT)}', left=1826, top=5, right=2074, bottom=56, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<C>id='{decode(STAY_AMT,0,,STAY_AMT)}', left=1580, top=111, right=1797, bottom=161, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{decode(P06_AMT,0,,P06_AMT)}', left=1826, top=58, right=2074, bottom=108, align='right', face='굴림', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>

</B>
<B>id=LDFooter ,left=0,top=0 ,right=4101 ,bottom=177 ,face='Arial' ,size=10 ,penwidth=1
	...
	<S>id='{Sum(P04_AMT)}' ,left=889 ,top=8 ,right=1119 ,bottom=58 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(P05_AMT)}' ,left=889 ,top=61 ,right=1119 ,bottom=111 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(CAR_AMT)}' ,left=889 ,top=114 ,right=1119 ,bottom=164 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(MEAL_AMT)}' ,left=1122 ,top=8 ,right=1352 ,bottom=58 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	...
	<S>id='{Sum(CET_AMT)}' ,left=1122 ,top=114 ,right=1352 ,bottom=164 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(DRI_AMT)}' ,left=1355 ,top=8 ,right=1585 ,bottom=58 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(PPEN_AMT)}' ,left=1355 ,top=114 ,right=1585 ,bottom=164 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(BOSS_AMT)}' ,left=1355 ,top=61 ,right=1585 ,bottom=111 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(SCH_AMT)}' ,left=1588 ,top=61 ,right=1818 ,bottom=111 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(CASH_AMT)}' ,left=1588 ,top=8 ,right=1818 ,bottom=58 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(OTH_AMT)}' ,left=1842 ,top=8 ,right=2072 ,bottom=58 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	...
	<S>id='{Sum(STAY_AMT)}' ,left=1588 ,top=114 ,right=1818 ,bottom=164 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
	<S>id='{Sum(P06_AMT)}' ,left=1842 ,top=61 ,right=2072 ,bottom=111 ,align='right' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFBF0, Dec=0</S>
