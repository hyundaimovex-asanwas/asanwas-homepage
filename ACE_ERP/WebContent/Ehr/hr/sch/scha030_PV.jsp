...
<%
    String PRINT_NO     	= request.getParameter("PRINT_NO");
	System.out.println("결재번호 [" + PRINT_NO + "]");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="scha030.hnw">
              <param name="initvalue" VALUE="[:PRINT_NO]=<%=PRINT_NO%>">
