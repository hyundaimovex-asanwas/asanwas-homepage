...
<%
    ...
    String maj_nm  = request.getParameter("maj_nm");
    String fsch_nm = request.getParameter("fsch_nm");
    String sel_nm  = request.getParameter("sel_nm");
    String bir_ymd = request.getParameter("bir_ymd");
/*
    ...
    System.out.println("maj_nm ="+maj_nm );
    System.out.println("fsch_nm="+fsch_nm);
    System.out.println("sel_nm ="+sel_nm );
*/
%>
<html>
<head>
...
<comment id="__NSID__">
              ...
              <param name="initvalue" VALUE="[:eno_no]=<%=eno_no%>[:eno_nm]=<%=eno_nm%>[:dpt_nm]=<%=dpt_nm%>[:job_nm]=<%=job_nm%>[:sch_nm]=<%=sch_nm%>[:maj_nm]=<%=maj_nm%>[:fsch_nm]=<%=fsch_nm%>[:sel_nm]=<%=sel_nm%>[:bir_ymd]=<%=bir_ymd%>">
