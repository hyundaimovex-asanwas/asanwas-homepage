    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_ED_BOARD.DataId = "/servlet/GauceChannelSVL?cmd=hr.sel.a.sela022.cmd.SELA022CMD&S_MODE=SHR&BBS_GBN="+BBS_GBN+"&SEQ_NO="+SEQ_NO;
            dsT_ED_BOARD.Reset();
        ...
        function fnc_Delete() {
            ...
            trT_ED_BOARD.action = "/servlet/GauceChannelSVL?cmd=hr.sel.a.sela022.cmd.SELA022CMD&S_MODE=DEL";
            trT_ED_BOARD.post();
    ...
    **************************************-->
    ...
    <Script For=dsT_ED_BOARD Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            document.getElementById("txtENO_NO").innerText      = 'hda'+dsT_ED_BOARD.NameValue(1, "ENO_NO");
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423" >
                        <span id="txtENO_NM" name="txtENO_NM" ></span> (<span id="txtENO_NO"  name="txtENO_NO" ></span>)
                    </td>
