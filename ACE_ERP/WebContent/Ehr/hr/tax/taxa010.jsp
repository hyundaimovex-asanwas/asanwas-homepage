...
<script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송
            dsT_CM_PERSON.DataID = "/servlet/GauceChannelSVL?cmd=hr.tax.a.taxa010.cmd.TAXA010CMD&S_MODE=SHR&PIS_YY_SHR="+PIS_YY_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
            dsT_CM_PERSON.Reset();
