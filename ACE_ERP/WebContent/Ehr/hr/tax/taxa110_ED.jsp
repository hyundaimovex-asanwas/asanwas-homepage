...
<%
    ...
    String PIS_YYMM_Y0      = request.getParameter("PIS_YYMM_Y0").replaceAll("-","");
    String PIS_YYMM_Y1    	= request.getParameter("PIS_YYMM_Y1").replaceAll("-","");

    /** 외부 XML에서 SQL을 읽어 온다 **/
    String Query = XmlSqlUtils.getSQL("tax", "TAXA110_SHR_PRT3");
