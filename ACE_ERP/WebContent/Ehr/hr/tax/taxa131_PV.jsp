<!--
***********************************************************************
* @source      : taxa150_PV.jsp 				                                                                                     *
* @description : 주민세특별징수계산서
***********************************************************************
...
<%
String rptName = "";
String PIS_GBN = request.getParameter("PIS_GBN");
String PIS_YYMM  = request.getParameter("PIS_YYMM").replaceAll("-","");
String DPT_CD  = request.getParameter("DPT_CD").replaceAll("-","");


if (PIS_GBN.equals("1"))
{
	rptName = "taxa1311.hnw";
}else if (PIS_GBN.equals("2"))
{
	rptName = "taxa1312.hnw";
}else if (PIS_GBN.equals("3"))
{
	rptName = "taxa1313.hnw";
}else if (PIS_GBN.equals("4"))
{
	rptName = "taxa1314.hnw";
}
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="<%=rptName%>">
              <param name="initvalue" VALUE="[:PIS_YYMM]=<%=PIS_YYMM%>[:DPT_CD]=<%=DPT_CD%>[:PIS_GBN]=<%=PIS_GBN%>">
