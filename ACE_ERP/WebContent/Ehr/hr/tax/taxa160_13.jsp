    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_OnLoadProcess() {
        	...
        	document.form1.txtPIS_YY_SHR.value = "2013";
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">원천징수영수증_2013</td>
					<td align="right" class="navigator">HOME/정산세무/정산세무/<font color="#000000">소득증명원출력 - 원천징수영수증_2013
</font></td>
				</tr>
			</table>
			</td>
                        ...
                        <table height="19" cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                <td width="40" style="padding-left:0px; border-style:none">
                                    <input type="text" id="txtPIS_YY_SHR" style="ime-mode:disabled" size="5" maxlength= "4" >
                                </td>
