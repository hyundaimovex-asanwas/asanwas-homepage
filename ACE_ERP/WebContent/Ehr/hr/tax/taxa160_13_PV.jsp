...
<%
    ...
    String HNW = "";
    	...
    	if(Integer.parseInt(PIS_YYMM) ==  2013){
				HNW = "taxa160_2013img.hnw";
		}
%>
<html>
<head>
    ...
    <td bgcolor="#EAEAEA" valign="middle" align="left">
        ...
        <tr>
            ...
            <td width="">
                ...
                <input type="button" name="btnPRINT_ALL" value="전체인쇄" onclick="goclick('Print_ALL');"  style="background:white;cursor:hand" onmouseover="this.style.background='#EFEFE9'" onmouseout="this.style.background='white'"></td>
