...
<%
    ...
    String sql = XmlSqlUtils.getSQL("tax2", "TAXB160_PRT_2014_1");
    ...
    /** 필드값 세팅 **/
    String colStr = "ENO_NM,CHI_CNT,PIS_YY,ENO_NO,PIS_MM,OCC_CD,GBN_TAG,MDPT_CD,MJOB_CD,MHOB_CD,SOU_CNT,DFM_CNT,TRB_CNT,GOL_CNT,WCT_CNT,MHS_TAG,LIN_AMT,LMA_AMT,LHO_AMT,LHP_AMT,LHR_AMT,CLS_TAG,DOMW_DD,OUTW_DD,TOTW_DD,DOMT_AMTS,OUTT_AMTS,SALT_AMTS,SALT_AMTT,PAYD_AMTS,PAYO_AMTS,TAX_INCOME,YAB_INCOME,FREE_INCOME,ITXD_AMT,STAX_DED,INCM_TAX,CITI_TAX,HINU_AMT,NPEN_AMT,HINS_AMT,MGR_AMT,MNI_AMT,BADD_AMT,SPSB_AMT,GDED_AMT,GOL_AMT,TBL_DED,WDD_AMT,PER_TOT,MIN_DED,MMA_DED,EDU_DED,CPC_DED,NSE_TOT,PER_DED,INDED_TOT,DON_FWD,TTAX_STD,TAX_AMT,HGR_DED,OTX_DED,TAX_DED,TDED_TOT,DGG_TAX,DJM_TAX,DBW_TAX,AGG_TAX,AJM_TAX,DRE_INTX,DRE_CTTX,DRE_DFTX,CARD_DED,CARD_AMT,SAJU_DED,LSS_DED,LIN_DED,VEN_AMT,VEN_DED,CONT_TAX,LIH_AMT,GRA_AMT,ANN_AMT,GOV_AMT,LIH_DED,GOV_DED,NPEN_DED,ANN_DED,HAN_AMT,AGE_AMT,STA_TOT,VEN2_AMT,HED_AMT,MHEA_AMT,OHEA_AMT,LEN_AMT2,LEN_AMT3,LEN_AMT4,LEN_AMT5,EDU_TAG1,EDU_AMT1,EDU_TAG2,EDU_AMT2,EDU_TAG3,EDU_AMT3,EDU_TAG4,EDU_AMT4,EDU_TAG5,EDU_AMT5,FUN_CNT,GOL_CNT70,GOL_AMT70,CHI_DED,HIG_DED,UNI_DED,SEA_FREE,CASH_AMT,GOV_DED,GOV2_DED,LC1_DED,LC23_DED,IPT_MAN,IPT_YMD,UPT_MAN,UPT_YMD,TAX_DPT,JAO_NO1,JAS_NM1,JAA_AMT1,JAB_AMT1,JAC_AMT1,JAD_AMT1,JAE_AMT1,JAF_AMT1,JAG_AMT1,JAH_AMT1,JAJ_AMT1,JAK_AMT1,JAL_AMT1,JAN_AMT1,JAM_AMT1,JAP_AMT1,JAQ_AMT1,SEQ_NO1,JAI_AMT1,JAO_NO2,JAS_NM2,JAA_AMT2,JAB_AMT2,JAC_AMT2,JAD_AMT2,JAE_AMT2,JAF_AMT2,JAG_AMT2,JAH_AMT2,JAJ_AMT2,JAK_AMT2,JAL_AMT2,JAN_AMT2,JAM_AMT2,JAP_AMT2,JAQ_AMT2,SEQ_NO2,JAI_AMT2,JAO_NO3,JAS_NM3,JAA_AMT3,JAB_AMT3,JAC_AMT3,JAD_AMT3,JAE_AMT3,JAF_AMT3,JAG_AMT3,JAH_AMT3,JAJ_AMT3,JAK_AMT3,JAL_AMT3,JAN_AMT3,JAM_AMT3,JAP_AMT3,JAQ_AMT3,SEQ_NO3,JAI_AMT3,ONE_AMT,LONG4_DED,LONG5_DED,LONG6_DED,LONG7_DED,LONG8_DED,SAVE_DED,SAVE1_DED,SAVE2_DED,SAVE3_DED,LOAN_DED,PLOAN_DED,MRENT_DED,LONG_DED,ADDRESS_HOME,CET_NO,CET_NO2,HIR_YMD,RET_YMD,HOL_YN,RET_AMT,RET_DED,SDATE,EDATE,COMP_NM,PRESIDENT_NM,TAX_NO,CORP_NO,ADDRESS,TEL_NO,SUM,SUM_PAY_AMTS,SUM_PAY_AMTB,SUM_JAI_AMT,SUM_HINU,SUM_HINS,TYPE,STR,END,TAX_OFFICE";
