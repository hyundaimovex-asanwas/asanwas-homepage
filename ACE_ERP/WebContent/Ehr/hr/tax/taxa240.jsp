    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            var PIS_YYMM_SHR = document.getElementById("txtPIS_YYMM_SHR").value;//시작일자

            dsT_CP_PAYMASTER.dataid = "/servlet/GauceChannelSVL?cmd=hr.tax.a.taxa240.cmd.TAXA240CMD&S_MODE=SHR&PIS_YYMM_SHR="+PIS_YYMM_SHR;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_CP_PAYMASTER.GridToExcel("월별원천징수현황", '', 225);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">월별원천징수현황</td>
                    <td align="right" class="navigator">HOME/정산세무/정산세무/지방세납부현황관리/<font color="#000000">월별원천징수현황</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object id="grdT_CP_PAYMASTER" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:320px;">
                            ...
                            <param name="Format"                value="
                                ...
                                <C> id='DPT_NM'         width=100   name='구분'          align=center </C>
                                <C> id='REMARK2'        width=300   name='사업장주소'    align=left   </C>
                                <C> id='OFFICE'         width=120   name='해당지자체'    align=center </C>
                                <G> name='종업원수'    HeadBgColor='#F7DCBB'
	                                <C> id='TOT_CNT_2'  width=70    name='총인원'        align=right  </C>
	                                <C> id='CNT1'        width=70    name='대상인원'      align=right  </C>
                                </G>
                                <C> id='SUM_INCM_TAX'      width=100   name='갑근세'    align=right      value={INCM_TAX1+INCM_TAX}</C>
                                <C> id='SUM_CITI_TAX'      width=100   name='주민세'    align=right      value={CITI_TAX1+CITI_TAX}</C>
                                <C> id='SUM_TAX'        width=100   name='총계'         align=right      value={INCM_TAX1+INCM_TAX+CITI_TAX1+CITI_TAX}</C>
                                <C> id='9'              width=70    name='비고'         align=left   </C>
                            ">
                        </object>
