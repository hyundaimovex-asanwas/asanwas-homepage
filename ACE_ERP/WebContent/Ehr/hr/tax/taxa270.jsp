...
<head>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			dsT_AC_CEFBOOK.DataId = "/servlet/GauceChannelSVL?cmd=hr.tax.a.taxa270.cmd.TAXA270CMD&S_MODE=SHR&STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&CEF_RSN_SHR="+CEF_RSN_SHR+"&HIR_NM="+HIR_NM+"&RET_NM="+RET_NM+"&EXP_NM="+EXP_NM+"&CAR_NM="+CAR_NM;
        ...
        function fnc_Print() {
        	...
        	if ( STR_YMD_SHR == ""|| END_YMD_SHR == "" ) {
                ...
                var url = "taxa270_PV.jsp?STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&CEF_RSN_SHR="+CEF_RSN_SHR+"&HIR_NM="+HIR_NM+"&RET_NM="+RET_NM+"&EXP_NM="+EXP_NM+"&CAR_NM="+CAR_NM;
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_AC_CEFBOOK.GridToExcel("증명서발급현황", '', 225)
        }
    ...
    ***************************************************************************************-->
	...
	<script for=trT_AC_CEFBOOK event="OnSuccess()">
		...
		fnc_Message(document.getElementById("resultMessage"),"MSG_03",dsT_AC_CEFBOOK.CountRow/2-1);
    </script>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">소득증명원발급현황</td>
                    <td align="right" class="navigator">HOME/정산세무/소득증명원출력/<font color="#000000">소득증명원발급현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
                    ...
                    <td class="searchState" align="right" rowspan="3">종&nbsp;&nbsp;&nbsp;류&nbsp;</td>
					<td class="padding2423" align="left" rowspan="3">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left"><input type="checkbox" id="chkHIR_NM" style="border:0" align="absmiddle" checked>근로소득원천징수 영수증</td>
								<td align="left"><input type="checkbox" id="chkEXP_NM" style="border:0" align="absmiddle" checked>근로소득원천징수부</td>
							</tr>
							<tr>
								<td align="left"><input type="checkbox" id="chkRET_NM" style="border:0" align="absmiddle" checked>퇴직소득원천징수 영수증</td>
								<td align="left"><input type="checkbox" id="chkCAR_NM" style="border:0" align="absmiddle" checked>갑근세원천징수 증명서</td>
							</tr>
						</table>
					</td>
				</tr>
                ...
                <tr>
					...
					<td class="padding2423" align="left">
						<select id="cmbCEF_RSN_SHR" style="width:150px" onChange="fnc_SearchList()">
				...
				<tr align="center">
					...
					<object id="grdT_AC_CEFBOOK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
						...
						<param name="Format" value='
							...
							<C> id="CEF_NO"		width=60	name="발급번호"		align=center	Edit=none	 </C>
							...
							<C> id="CEF_SEC"	width=140	name="증명서종류"		align=center	Edit=none	 </C>
