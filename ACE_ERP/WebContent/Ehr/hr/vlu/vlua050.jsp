    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Clear() {
            ...
            document.getElementById("cmbEVL_YY_SHR")[0].selected = true;
            fnc_SearchItem();
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid3(form1.grdT_EV_ESTITEM);
            ...
            document.getElementById("resultMessage").innerText = '*>>>>> 줄바꾸기 방법: Ctrl + Enter <<<<<*';
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                        <td>
                            <comment id="__NSID__">
                              <object id="grdT_EV_ESTITEM" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:810px;height:600px;">
                                <Param Name="DataID"         value="dsT_EV_ESTITEM">
                                <param name="RowHeight"   	value='115'>
                                <param name="TitleHeight" 	value='30'>
                                <param name="Format"                     value="
                                	<FG> name='평가요소(등급/점수)' HeadBgColor='#F7DCBB'
	                                    <FC> id='ABL_NM'       		width=60     name='구  분'      align=center  Multiline=true suppress= 1</FC>
	                                    <FC> id='ABL_CD'       		width=40     name='코드'        align=center </FC>
	                                    <FC> id='ABL_NM_SUB'   	width=70     name='명  칭'      align=left  Multiline=true</FC>
                                    </FG>
                                    <G> name='행동특성 기준' HeadBgColor='#F7DCBB'
	                                    <C>  id='SUBITEM_04'   width=150     name='A(5점)'   align=left   Multiline=true</C>
	                                    <C>  id='SUBITEM_03'   width=150     name='B(4점)'   align=left   Multiline=true</C>
                                    	<C>  id='SUBITEM_02'   width=150     name='C(3점)'   align=left   Multiline=true</C>	
	                                    <C>  id='SUBITEM_01'   width=150     name='D(2점)'   align=left   Multiline=true</C>
                                    </G>
                                ">
                              </object>
