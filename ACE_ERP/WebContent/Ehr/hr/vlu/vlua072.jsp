<!--
    ************************************************************************************
    * @Source         : vlua072.jsp                                                    *
    * @Description    : 개인별 성과평가대상자 설정 PAGE                                *
    * @Developer Desc :                                                                *
    ************************************************************************************
...
<html>
    ...
    <head>
    <title>개인별 성과평가대상자 설정(vlua072)</title>
...
<%
    ...
    String ACH_RATE  = request.getParameter("ACH_RATE");       //비율
%>
    ...
    <script language="javascript" >
        ...
        function fnc_Remove() {
            ...
            if (dsT_EV_EVLIST_DT.CountRow < 1) {
                document.getElementById("resultMessage").innerText = '삭제할 자료가 없습니다.';
                return;
            }
        ...
        function fnc_SaveItemCheck() {
            ...
            if (!dsT_EV_EVLIST_DT.IsUpdated) {
                ...
                if (!dsT_EV_EVLIST_HD.IsUpdated ) {
                    document.getElementById("resultMessage").innerText = '저장 할 대상자가 없습니다..';
                    alert("저장 할 대상자가 없습니다..");
                    return false;
                }
            ...
            // 반영비율 총합체크(총합이 100이 아니면 오류)
            if (dsT_EV_EVLIST_DT.Sum(12,0,0) != 100 && dsT_EV_EVLIST_DT.CountRow != 0) {
                alert("반영비율의 총합이 100 이어야 합니다. ["+dsT_EV_EVLIST_DT.Sum(12,0,0)+"]\n확인 후 저장하세요.");
                return false;
            }
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_EVLIST_DT Event="OnDataError()">
        ...
        if (this.ErrorCode == 50018) {
            alert("1차평가의 필수입력항목[사번/성명] 입력 후 다음 작업이 가능합니다.");
        }
        else if (this.ErrorCode == 50019) {
            alert("1차평가의 사번/성명에 대한 중복값이 존재합니다. 확인바랍니다.");
        }
        else {
            cfErrorMsg(this);
        }
    ...
    <script for=trT_EV_EVLIST_DT event="OnSuccess()">
        ...
        if (form1.txtFLAG.value == "1") {
            ...
            document.getElementById("resultMessage").innerText = '저장이 완료되었습니다.';
        ...
        if ( Colid == 'REFENO_NO1' ||
            ...
            if (obj.eno_no != '' &&
                (dsT_EV_EVLIST_DT.NameValue(Row,'EVLENO_NO')  == obj.eno_no ||
                 dsT_EV_EVLIST_DT.NameValue(Row,'REFENO_NO2') == obj.eno_no ||
                 dsT_EV_EVLIST_DT.NameValue(Row,'REFENO_NO3') == obj.eno_no )) {
                alert('해당 평가자에 대한 참조자가 이미 지정되어 있거나 지정한 평가자와 동일합니다..');
                return;
            }
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">개인별 성과평가대상자 설정</td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_EVLIST_DT" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:250px;">
                            ...
                            <param name="Format"                  value="
                                <FG>  name='1차평가' HeadBgColor='#F7DCBB'
                                    <C> id='EVLHEAD_NM'   width=75    name='본부'      align=left   Edit=None</C>
                                    <C> id='EVLDPT_NM'    width=80    name='소속'      align=left   Edit=None</C>
                                    <C> id='EVLJOB_NM'    width=60    name='직위'      align=center Edit=None</C>
                                    <C> id='EVLENO_NO'    width=75    name='사번'      align=center Edit=Numeric EditStyle=Popup EditLimit=10 </C>
                                    <C> id='EVLENO_NM'    width=60    name='성명'      align=center              EditStyle=Popup EditLimit=20 </C>
                                    <C> id='APPLY_RATE'   width=75    name='반영비율'  EditLimit=6  </C>
                                </FG>
                                <G> name='참조평가 1' HeadBgColor='#F7DCBB'
                                    <C> id='REFHEAD_NM1'  width=75    name='본부'      align=left   Edit=None</C>
                                    <C> id='REFDPT_NM1'   width=80    name='소속'      align=left   Edit=None</C>
                                    <C> id='REFJOB_NM1'   width=60    name='직위'      align=center Edit=None</C>
                                    <C> id='REFENO_NO1'   width=75    name='사번'      align=center Edit=Numeric EditStyle=Popup EditLimit=10 </C>
                                    <C> id='REFENO_NM1'   width=60    name='성명'      align=center              EditStyle=Popup EditLimit=20 </C>
                                </G>
                                <G> name='참조평가 2' HeadBgColor='#F7DCBB'
                                    <C> id='REFHEAD_NM2'  width=75    name='본부'      align=left   Edit=None</C>
                                    <C> id='REFDPT_NM2'   width=80    name='소속'      align=left   Edit=None</C>
                                    <C> id='REFJOB_NM2'   width=60    name='직위'      align=center Edit=None</C>
                                    <C> id='REFENO_NO2'   width=75    name='사번'      align=center Edit=Numeric EditStyle=Popup EditLimit=10 </C>
                                    <C> id='REFENO_NM2'   width=60    name='성명'      align=center              EditStyle=Popup EditLimit=20 </C>

                                </G>
                                <G> name='참조평가 3' HeadBgColor='#F7DCBB'
                                    <C> id='REFHEAD_NM3'  width=75    name='본부'      align=left   Edit=None</C>
                                    <C> id='REFDPT_NM3'   width=80    name='소속'      align=left   Edit=None</C>
                                    <C> id='REFJOB_NM3'   width=60    name='직위'      align=center Edit=None</C>
                                    <C> id='REFENO_NO3'   width=75    name='사번'      align=center Edit=Numeric EditStyle=Popup EditLimit=10 </C>
                                    <C> id='REFENO_NM3'   width=60    name='성명'      align=center              EditStyle=Popup EditLimit=20 </C>
                                </G>
                            ">
                        </object>
