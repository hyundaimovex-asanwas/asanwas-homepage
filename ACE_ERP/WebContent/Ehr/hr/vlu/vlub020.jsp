...
<html>
<head>
<title>개인별평가일정조정_역량(vlub020)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //평가 구조 설정 정보 조회
            dsT_EV_SCHCHG.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub020.cmd.VLUB020CMD&S_MODE=SHR_02&GUBUN="+GUBUN+"&EVL_YY="+year+"&EVL_FRQ="+frq+"&ENO_NO="+eno_no+"&DPT_CD="+dpt_cd+"&GROUP_CD="+group_cd;
            dsT_EV_SCHCHG.reset();

            document.form1.grdT_EV_SCHCHG.SetColumn("IPT_STDT");
        ...
        function fnc_Save() {
                ...
                trT_EV_SCHCHG.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub020.cmd.VLUB020CMD&S_MODE=SAV";
                trT_EV_SCHCHG.post();
        ...
        function fnc_Delete() {
            ...
            if(confirm("["+dsT_EV_SCHCHG.NameValue(dsT_EV_SCHCHG.RowPosition,'ENO_NM')+"]님의 평가일정조정정보를 삭제하시겠습니까?")){
                ...
                trT_EV_SCHCHG.KeyValue = "tr01(I:dsT_EV_SCHCHG=dsT_EV_SCHCHG)";
                trT_EV_SCHCHG.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub020.cmd.VLUB020CMD&S_MODE=DEL";
                trT_EV_SCHCHG.post();
            }
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
            ...
            document.form1.txtEVL_FRQ.value = dsT_EV_ESTINFO.ColumnValue(1,2);
        }
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">개인별평가일정조정_역량</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">개인별평가일정조정_역량</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="padding2423"><input name=txtDPT_CD_SHR size="3" maxlength="6" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList();" onChange="fnc_GetCommNm('A4','txtDPT_CD_SHR','txtDPT_NM_SHR');">
                                ...
                                <td class="padding2423"><input name=txtENO_NO_SHR id=txtENO_NO_SHR size="8" maxlength="10" style="ime-mode:disabled" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList(); cfNumberCheck();" onChange="fnc_GetEnoNm('txtENO_NO_SHR','txtENO_NM','1','1');">
                                    <input name=txtENO_NM id=txtENO_NM size="8" class="input_ReadOnly" readonly> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" name="Image6" width="21" height="20" border="0" align="absmiddle" onclick="fnc_emplPopup('txtENO_NO_SHR','txtENO_NM')"></a>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <object    id="grdT_EV_SCHCHG" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <G> name='평가입력기간' HeadBgColor='#F7DCBB'>
                                    <C> id='IPT_STDT'     width=75    name='시작일'  Edit=Numeric    EditLimit=8   Mask=XXXX-XX-XX   align=center </C>
                                    <C> id='IPT_ENDT'     width=75    name='종료일'  Edit=Numeric  EditLimit=8 Mask=XXXX-XX-XX   align=center </C>
                                </G>
                                <G> name='이의신청기간' HeadBgColor='#F7DCBB'>
                                    <C> id='PROT_STDT'     width=75    name='시작일' Edit=Numeric  EditLimit=8 Mask=XXXX-XX-XX    align=center </C>
                                    <C> id='PROT_ENDT'     width=75    name='종료일' Edit=Numeric  EditLimit=8 Mask=XXXX-XX-XX    align=center </C>
                                </G>
                            ">
                        </object>
