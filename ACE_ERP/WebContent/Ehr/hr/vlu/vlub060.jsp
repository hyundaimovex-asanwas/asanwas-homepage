    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Save() {
            ...
            //트랜잭션 전송
            trT_EV_ABLRST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub060.cmd.VLUB060CMD&S_MODE=SAV";
            trT_EV_ABLRST.Post();
        ...
        function fnc_Remove() {
            ...
            if (confirm("[" + dsT_EV_ABLRST.NameValue(dsT_EV_ABLRST.RowPosition,'ENO_NO') + "] 자료를 제거 하시겠습니까?") == false) return;
         ...
         * 10. 초기화 함수  *
         ********************/
        function fnc_Clear() {    //2006-11-06 by DS
        ...
        function fnc_Reflect() {
            ...
            if(confirm("기존에 적용된 본부장 조정_역량 자료는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) {

                dsT_EV_ABLRST_02.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub060.cmd.VLUB060CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+dsT_EV_ESTINFO.NameValue(1,'EVL_YY')+"&EVL_FRQ="+dsT_EV_ESTINFO.NameValue(1,'EVL_FRQ');
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ABLRST_02 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount > 0)    {
            ...
            trT_EV_ABLRST_01.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub060.cmd.VLUB060CMD&S_MODE=SAV_01&GUBUN="+GUBUN+"&EVL_YY="+dsT_EV_ESTINFO.NameValue(1,'EVL_YY')+"&EVL_FRQ="+dsT_EV_ESTINFO.NameValue(1,'EVL_FRQ');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본부장조정_역량</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본부장조정_역량</font></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id=txtEVL_YY_SHR name=txtEVL_YY_SHR style="width:100%;text-align:center" size="4" class="input_ReadOnly" readonly valid="key=true" field="해당년도">
                                    </td>
                                    <td align="right" class="searchState">회차&nbsp;</td>
                                    <td>
                                        <input id=txtEVL_FRQ_SHR name=txtEVL_FRQ_SHR size="4" maxlength="4" style="text-align:center;" class="input_ReadOnly" readonly>
                                    </td>
                                    ...
                                    <td class="padding2423">
                                        <input name=txtENO_NO_SHR size="8"  maxlength="10" style="ime-mode:disabled" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList(); cfNumberCheck();">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="right" valign="bottom">
                            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image20','','/images/button/BatchAdjustOver.gif',1)"><img src="/images/button/BatchAdjustOn.gif" id="image20" name="image20" width="80" height="20" border="0" align="absmiddle" onClick="fnc_Reflect()"></a>
                        </td>
                    </tr>
                </table>
            </td>
