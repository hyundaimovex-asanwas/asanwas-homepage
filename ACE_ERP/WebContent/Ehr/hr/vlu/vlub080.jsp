...
<html>
    ...
    <head>
    <title>이의신청(개인)_역량(vlub080)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송(이의신청(개인)_역량)
            dsT_EV_PROTEST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub080.cmd.VLUB080CMD&S_MODE=SHR&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=1&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value;
        ...
        function fnc_SearchItem(searchDiv) {
            ...
            if( searchDiv == '2') {
                //이의신청기간 여부 체크
                dsT_EV_ESTINFO_01.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub080.cmd.VLUB080CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=1&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value;
        ...
        function fnc_Save() {
            ...
            trT_EV_PROTEST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub080.cmd.VLUB080CMD&S_MODE=SAV&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=1&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&FLAG="+file_flag;
            trT_EV_PROTEST.Post();
        ...
        function fnc_Delete() {
            ...
            if( !fnc_DeleteEnableCheck() ) {
                alert("접수가 완료된 상태이므로 삭제 할 수 없습니다.")
                return;
            }

            // 특정 컬럼의 값으로 제거 여부를 물어 본다.(컬럼의 값만 바꿔서 사용하세요)
            if (confirm("[" + dsT_EV_PROTEST.ColumnString(1,7) + "] 자료를 제거하시겠습니까?") == false) return;
            dsT_EV_PROTEST.DeleteRow(1);

            stateDiv = 'delete';
            //트랜잭션 전송
            trT_EV_PROTEST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub080.cmd.VLUB080CMD&S_MODE=SAV";
            trT_EV_PROTEST.Post();
        ...
        /********************************************
         * 16. 조건에 따른 이의신청(개인)_역량의 enable/disable 처리    *
         *******************************************/
        function fnc_DisableSet() {
            ...
            document.getElementById("txtPROTEST_TIT").style.color = '#966218';
            document.getElementById("txtPROTEST_TIT").style.border = '#966218 1px solid';
            document.getElementById("txtPROTEST_DEC").readOnly=true;
            document.getElementById("txtPROTEST_DEC").style.backgroundColor = 'EEEEEE';
            document.getElementById("txtPROTEST_DEC").style.color = '#966218';
            document.getElementById("txtPROTEST_DEC").style.border = '#966218 1px solid';
...
<body leftmargin="20" topmargin="14" rightmargin="20" bottommargin="15" marginwidth="0" marginheight="0" scroll=auto onkeydown="fnc_HotKey();" onload="fnc_OnLoadProcess();">
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">이의신청(개인)_역량</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">이의신청(개인)_역량</font></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <!-- power Search테이블 시작 -->
    <table width="800" border="0" cellspacing="0" cellpadding="0">
    <input type="hidden" id="txtEVL_GBN_SHR" name="txtEVL_GBN_SHR" value='1'>
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><input id="txtEVL_YY_SHR" name="txtEVL_YY_SHR" class="input_ReadOnly" size="4" readonly></td>
                                    <td align="right" class="searchBold">회차&nbsp;</td>
                                    <td><input id="txtEVL_FRQ_SHR" name="txtEVL_FRQ_SHR" class="input_ReadOnly" size="2" readonly></td>
                                    <td align="right" class="searchBold">소속&nbsp;</td>
                                    <td><input id="txtDPT_NAME_SHR" name="dept" class="input_ReadOnly" size="10" readonly></td>
                                    <td align="right" class="searchBold">사번&nbsp;</td>
                                    <td><input id="txtENO_NO_SHR" name="txtENO_NO_SHR" class="input_ReadOnly" size="10" readonly></td>
                                    <td align="right" class="searchBold">성명&nbsp;</td>
                                    <td><input id="txtENO_NAME_SHR" name="eno_nm" class="input_ReadOnly" size="10" readonly></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <td>
                <table width="100%" height="160" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        ...
                        <td align="center" class="creamBold">일자</td>
                        <td class="padding2423">
                            <input id=txtANSWER_YMD name=txtANSWER_YMD size="15" class="input_ReadOnly" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" class="creamBold">내<BR><BR>용</td>
