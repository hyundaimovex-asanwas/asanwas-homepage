    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //역량 평가 적용 결과 정보 조회
            dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub110.cmd.VLUB110CMD&S_MODE=SHR&GUBUN="+GUBUN+"&EVL_YY="+year+"&EVL_FRQ="+frq+"&ENO_NO="+eno_no+"&DPT_CD="+dpt_cd+"&GROUP_CD="+group_cd+"&CHG_CHK="+chg_chk;
            dsT_EV_ABLRST.reset();
        ...
        function fnc_Save(s_mode) {
            ...
            if(s_mode != 'SAV_01'){
                ...
                // 해당 Dataset의 Header가 없으면 임의로 Header 선언
            ...
            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub110.cmd.VLUB110CMD&S_MODE="+s_mode+"&GUBUN="+GUBUN+"&EVL_YY="+dsT_EV_ESTINFO.ColumnValue(1,1)+"&EVL_FRQ="+dsT_EV_ESTINFO.ColumnValue(1,2);
            trT_EV_ABLRST.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("등급확정_역량", '', 225);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">등급확정_역량</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">등급확정_역량</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="padding2423"><input id=txtENO_NO_SHR name=txtENO_NO_SHR size="10" maxlength="10" style="ime-mode:disabled" onkeypress="javascript:if(event.keyCode==13) fnc_SearchList(); cfNumberCheck();" onChange="fnc_GetEnoNm('txtENO_NO_SHR','txtENO_NM','1','1');">
                                    <input id=txtENO_NM name=txtENO_NM size="8" class="input_ReadOnly" readonly> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" name="Image4" width="21" height="20" border="0" align="absmiddle" onclick="fnc_emplPopup('txtENO_NO_SHR','txtENO_NM')"></a>
                                </td>
                            </tr>
                        </table>
                    </td>
