...
%>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_EV_AIMLST.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_FRQ="+EVL_FRQ+"&AIM_YMD=1900-01-01&ENO_NO="+ENO_NO+"&EVLENO_NO="+EVLENO_NO;
            dsT_EV_AIMLST.Reset();
        ...
        function fnc_Save() {
            ...
            trT_EV_AIMLST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SAV&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_FRQ="+EVL_FRQ+"&AIM_YMD=1900-01-01&ENO_NO="+ENO_NO+"&EVLENO_NO="+EVLENO_NO;
            trT_EV_AIMLST.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_AIMLST.GridToExcel("목표설정", '', 225);
            ...
            if (dsT_EV_AIMLST.CountColumn == 0) {
                ...
                for (var i = dsT_EV_AIMLST.RowPosition + 1; i <= CountRow; i++) {
                    ...
                    if (TASK_AIM      != dsT_EV_AIMLST.NameValue(i, "TASK_AIM")      ||
                        ...
                        dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition, "ITEM_DEC") = 'Dummy';      // Dummy
        ...
        function fnc_DeleteAimSub() {
            ...
            if (dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition, "AIM_GBN") == 'L') {
                ...
                if (dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition + 1, "AIM_GBN") == 'S') {
                    ...
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"ITEM_SEQ") = '0';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_S") = 'F';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_A") = 'F';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_B") = 'F';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_C") = 'F';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_D") = 'F';
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"HLP_REQ") = 'F';
    ...
    **************************************-->
    ...
    <script for=dsT_EV_AIMLST Event=onColumnChanged(row,colid)>
        var ADDING_PCT = 0;
        var DUTYCD = "<%=box.get("SESSION_DUTYCD")%>";
        ...
        if ((colid == 'GAUGE_GB' || colid == 'AIM_LEVEL') && dsT_EV_AIMLST.NameValue(row, "GAUGE_GB") == '1') {
			...
			var values = colStr.split(" ");
              ...
              for( x = 0; x < values.length; x++ ){
					...
					//alert("values for <"+x+"> = "+values[x]);
					if (values[x] > "0" && values[x] <= "9999999"){
			...
			if(isNaN(StrTo)){
               ...
               form1.grdT_EV_AIMLST.Focus();
				...
				if(DUTYCD > 'A0' && DUTYCD <= 'B9'  ){  // 직책 부서장이상
					StrTo = String(EXT_NUM * 1.20);
  ...
  <!--      var T_CHECK = dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"T_CHECK");
        ...
        if( grdT_EV_AIMLST.Editable == true) {
            ...
            if (colid == 'T_CHECK' ) {
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_S") = T_CHECK;
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_A") = T_CHECK;
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_B") = T_CHECK;
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_C") = T_CHECK;
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"CRITR_D") = T_CHECK;
                dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"HLP_REQ") = T_CHECK;
    ...
    <Script For=dsT_EV_AIMLST Event="OnDataError()">
            ...
            var ADDING_PCT    = '';
            var TASK_CSF = '';
	//	alert("Error Code : " + dsT_EV_AIMLST.ErrorCode + "\n" +
	//	      "Error Message : " + dsT_EV_AIMLST.ErrorMsg + "\n");
        //Dataset관련 Error 처리
        if (this.ErrorCode == 50018) {
            if (dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition, "AIM_GBN") == 'L') {
                if (dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition, "TASK_AIM")      != ""  ||
                    ...
                    dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition, "CRITR_A")      != "" ) {
                    alert("해당 필수입력항목[주요핵심과제/핵심성공 요소(CSF)/KPI(측정방법)/계량구분/목표수준/가중치] 입력 후 다음 작업이 가능합니다.");
                }
                else {
                   // alert("목표를 먼저 입력하시고 세부추진계획을 입력하시기 바랍니다.222");
                }
            }
            else {

                 //   alert("해당 필수입력항목[주요핵심과제/핵심성공 요소(CSF)/KPI(측정방법)/계량구분/목표수준/가중치] 입력 후 다음 작업이 가능합니다.22");
            }
        }
        else {
            cfErrorMsg(this);
    ...
    <Script For=dsT_EV_AIMLST_02 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            form1.txtRETURN_DEC.value = dsT_EV_AIMLST_02.NameValue(1, "RETURN_DEC");

            if ( dsT_EV_AIMLST_02.NameValue(1,"ACCEPT_GBN") == '1' ) {        // 승인일 경우 처리

                document.getElementById("resultMessage").innerText = '* 승인처리 되었으므로 수정 불가 합니다.';
    ...
    <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        if ( iCount == 0 )    {
            ...
            // 평가대상자인지 조회
            dsT_EV_EVLIST_HD.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR_04&GUBUN="+GUBUN+"&EVL_YY="+form1.txtEVL_YY_SHR.value+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+form1.txtEVL_FRQ_SHR.value+"&ENO_NO="+form1.txtENO_NO_SHR.value;
    ...
    <Script For=dsT_EV_EVLIST_HD Event="OnLoadCompleted(iCount)">
        ...
        if ( iCount == 0 )    {
            ...
            // 상단부 데이터 조회
            dsT_EV_SCHCHG.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR_00&GUBUN="+GUBUN+"&EVL_YY="+form1.txtEVL_YY_SHR.value+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+form1.txtEVL_FRQ_SHR.value+"&ENO_NO="+form1.txtENO_NO_SHR.value;
            dsT_EV_SCHCHG.Reset();
        }
    ...
    <Script For=dsT_EV_SCHCHG Event="OnLoadCompleted(iCount)">
        ...
        // 평가자명 조회
        dsT_EV_EVLIST_DT.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_FRQ="+EVL_FRQ+"&ENO_NO="+ENO_NO;
        dsT_EV_EVLIST_DT.Reset();

        // 오늘일자가 목표설정기간사이의 값이면 달성도 및 달성율 입력가능하도록 함
        if (OBJ_STDT <= getToday() && OBJ_ENDT >= getToday()) {
            ...
            //document.getElementById("btnINSSUB").disabled = false;
            //document.getElementById("btnDELSUB").disabled = false;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">목표설정</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">목표설정</font></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="searchState" valign="bottom" align="right">
                        <img  id="btnINSLST" width="80" height="20" src="/images/button/GoalAppend.gif" style="border:0px;padding:0 0 0 0;cursor:hand"  onclick="fnc_InsertAimLst();">
                    </td>
                    <td class="searchState" valign="bottom" align="right">
                        <img  id="btnDELLST" width="80" height="20" src="/images/button/GoalRemove.gif" style="border:0px;padding:0 0 0 0;cursor:hand"  onclick="fnc_DeleteAimLst();">
                    </td>
              <!--         <td class="searchState" valign="bottom" align="right" >
                        <img  id="btnINSSUB" width="100" height="20" src="/images/button/SubAppend.gif" style="border:0px;padding:0 0 0 0;cursor:hand"  onclick="fnc_InsertAimSub();">
                    </td>
                    <td class="searchState" valign="bottom" align="right">
                        <img  id="btnDELSUB" width="100" height="20" src="/images/button/SubRemove.gif" style="border:0px;padding:0 0 0 0;cursor:hand"  onclick="fnc_DeleteAimSub();">
                    </td>     -->
                    <td class="searchState" valign="bottom" align="right">
                        <font color="blue">가중치합계:</font><input type=text id=txtTOT_ADDING_PCT  name=txtTOT_ADDING_PCT size="3" style="text-align:right;font-weight:bold;" readonly>
                    </td>
                </tr>
            </table>
        </td>
