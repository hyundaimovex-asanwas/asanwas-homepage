...
<html>
    ...
    <script language="javascript" >
        ...
        function fnc_SearchList(searchDiv) {
			...
			if( searchDiv == '1' || searchDiv == undefined) {
	            ...
	            //데이터셋 전송(목표설정 조회)
	            dsT_EV_AIMLST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc040.cmd.VLUC040CMD&S_MODE=SHR&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtAIM_YMD_SHR=1900-01-01&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&cmbEVLENO_NO_SHR="+document.getElementById("cmbEVLENO_NO_SHR").value;
	            dsT_EV_AIMLST.Reset();
            } else if( searchDiv == '2' ) {
	            //데이터셋 전송(세부추진계획 조회)
	            dsT_EV_AIMSUB.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc040.cmd.VLUC040CMD&S_MODE=SHR_01&txtEVL_YY_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"EVL_YY")+"&txtEVL_FRQ_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"EVL_FRQ")+"&txtAIM_YMD_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"AIM_YMD")+"&txtENO_NO_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"ENO_NO")+"&txtEVLENO_NO_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"EVLENO_NO")+"&txtAIM_SEQ_SHR="+dsT_EV_AIMLST.NameValue(dsT_EV_AIMLST.RowPosition,"AIM_SEQ");
	            dsT_EV_AIMSUB.Reset();
            }
        ...
        function fnc_SearchItem(searchDiv) {
			...
			if( searchDiv == '3' ) {
	            //목표승인여부 조회
	            dsT_EV_AIMSUB_02.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR_02&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtAIM_YMD_SHR=1900-01-01&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&cmbEVLENO_NO_SHR="+document.getElementById("cmbEVLENO_NO_SHR").value;
			...
			if( searchDiv == '5' ) {
	            //목표설정 입력가능기간 여부
	            dsT_EV_ESTINFO_01.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc030.cmd.VLUC030CMD&S_MODE=SHR_03&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value;
        ...
        function fnc_Save() {
			...
			//트랜잭션 전송
			trT_EV_AIMSUB.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc040.cmd.VLUC040CMD&S_MODE=SAV";
			trT_EV_AIMSUB.Post();
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_AIMSUB_02 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
			...
			if( dsT_EV_AIMSUB_02.NameValue(1,"ACCEPT_GBN") == '1' ) {		//승인일경우 처리
				...
				fnc_DisableSet('3');		//입력불가 처리
			} else {
				fnc_DisableSet('2');		//입력가능 처리
			}
    ...
    <Script For=dsT_EV_EVLIST_DT Event="OnLoadCompleted(iCount)">
		...
		if( flag == true )		//평가적용기간 일때
			fnc_SearchItem('5');		//목표설정기간 여부  조회
    ...
    <script for=trT_EV_AIMSUB event="OnSuccess()">
		...
		fnc_Message(document.getElementById("resultMessagesub"),"MSG_01");
			...
			<td height="25" background="/images/common/barBg.gif">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">세부추진계획</td>
						<td align="right" class="navigator">HOME/인사평가/성과평가/<font color="#000000">세부추진계획</font></td>
					</tr>
				</table>
			</td>
		</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            ...
	                            <tr>
	                                ...
	                                <td class="padding2423">
	                                	<input id=txtEVL_YY_SHR size="4" class="input_ReadOnly" readonly style="text-align:center;" valid='key=true' field='해당년도'>
	                                </td>
	                                <td align="right" class="searchState">회차</td>
	                                <td class="padding2423">
										<input id=txtEVL_FRQ_SHR size="2" class="input_ReadOnly" readonly style="text-align:center;" valid='key=true' field='회차'>
	                                </td>
	                                ...
	                                <td class="padding2423">
	                                	<input id=txtENO_NO_SHR size="10" class="input_ReadOnly" readonly style="text-align:center;" valid='key=true' field='사번'>
	                                </td>
						...
						<td>
							...
							<object	id="grdT_EV_AIMLST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:120px;">
								...
								<param name="Format"					value="
									...
									<C> id='AIM_SEQ'       width=50        name='순번'     align=center		value={String(AIM_SEQ)}		show=false </C>
									...
									<C> id='DIFFICULT_PNT'       width=40        name='난이도'     align=right	editstyle=combo	data='10:10,20:20' </C>
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td align="right" valign="bottom">
				<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('btn_add','','/images/button/btn_AppendOver.gif',1)">  <img src="/images/button/btn_AppendOn.gif"   id="btn_add" name="btn_add" width="60" height="20" border="0" align="absmiddle" onClick="fnc_AddNew();"></a>
				<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('btn_del','','/images/button/btn_RemoveOver.gif',1)">  <img src="/images/button/btn_RemoveOn.gif"   id="btn_del" name="btn_del" width="60" height="20" border="0" align="absmiddle" onClick="fnc_Remove();"></a>
			</td>
		</tr>
	</table>
	<!-- 추가 버튼 테이블 끝 -->
					...
					<tr align="center">
						<td>
							...
							<object	id="grdT_EV_AIMSUB" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:180px;">
								...
								<param name=ColSizing  value="true">
								<param name="Format"					value="
									<C> id='ITEM_SEQ'		width=40		name='순번'			align=center		edit=none		value={String(ITEM_SEQ)}	show=false </C>
