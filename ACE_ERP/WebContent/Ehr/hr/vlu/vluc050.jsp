...
<html>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송(목표승인 조회)
            dsT_EV_AIMLST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc050.cmd.VLUC050CMD&S_MODE=SHR&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtAIM_YMD_SHR=1900-01-01&txtEVLENO_NO_SHR="+document.getElementById("txtEVLENO_NO_SHR").value;
            dsT_EV_AIMLST.Reset();
        ...
        function openPopupWin()
        {
            ...
            url = "/hr/" + "vlu" + "/" + "vluc051.jsp?GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_FRQ="+EVL_FRQ+"&ENO_NO="+ENO_NO+"&EVLENO_NO="+EVLENO_NO+"&ENO_NM="+ENO_NM+"&DPT_NM="+DPT_NM;
    ...
    ***************************************************************************************-->
    ...
    <Object ID ="trT_EV_AIMSUB" ClassID="CLSID:78E24950-4295-43D8-9B1A-1F41CD7130E5">
            ...
            <Param Name=KeyValue    Value="SVL(I:SAV=dsT_EV_AIMLST)">
    </Object>
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">목표승인</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">목표승인</font></td>
                </tr>
            </table>
        </td>
    </tr>
...
<!--table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="paddingTop8">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top" class="searchState">* 0 건의 자료가 조회되었습니다.</td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_AIMLST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"                  value="
                                    <C> id='EVL_YY'       width=80        name='해당년도'     align=left         show=false </C>
                                    <C> id='EVL_FRQ'       width=80        name='회차'     align=left         show=false </C>
                                    <C> id='GROUP_NM'       width=111        name='평가그룹'     align=left </C>
                                    <C> id='HEAD_NM'       width=111        name='본부'     align=left </C>
                                    <C> id='DPT_NM'       width=111        name='소속'     align=left </C>
                                    <C> id='JOB_NM'       width=111        name='직위'     align=left </C>
                                    <C> id='ENO_NO'       width=80        name='사번'     align=center </C>
                                    <C> id='ENO_NM'       width=80        name='성명'     align=center </C>
                                    <C> id='AIM_INPUT_GBN'       width=90        name='목표입력여부'     align=center </C>
                                    <C> id='ACCEPT_GBN'       width=70        name='승인여부'     align=center        editstyle=combo data='0:미승인,1:승인,2:반려,3:승인취소' </C>
                            ">
                        </object>
