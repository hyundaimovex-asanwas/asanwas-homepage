            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="23"><img src="/images/common/barHead.gif" width="23"
                        height="25"></td>
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">면담내용입력</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">면담내용입력</font></td>
                </tr>
            </table>
            </td>
        </tr>
                ...
                <tr align="center">
                    <td><comment id="__NSID__"> <object id="grdT_EV_AIMLST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:674px;height:340px;">
                        ...
                        <param name="Format"         value="
                            ...
                            <C> id='HEAD_NM'        width=120        name='본부'         align=left   </C>
                            <C> id='DPT_NM'         width=119        name='소속'         align=left   </C>
                            <C> id='JOB_NM'         width=119        name='직위'         align=left   </C>
