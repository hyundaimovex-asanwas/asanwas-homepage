...
%>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ACHTBL.GridToExcel("본인평가입력", '', 225);
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_SCHCHG Event="OnLoadCompleted(iCount)">
        ...
        // 오늘일자가 본인평가입력기간사이의 값이면 달성도 및 달성율 입력가능하도록 함
        if (SELF_STDT <= getToday() && SELF_ENDT >= getToday()) {
            ...
            alert('본인평가 입력기간이 아닙니다.');
            document.getElementById("resultMessage").innerText = '* 본인평가 입력기간이 아닙니다.';
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본인평가입력</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본인평가입력</font></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <td>
                    <table width="480" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                        ...
                        <tr>
                            ...
                            <td class="padding2423">
                                성명 <select id="cmbEVLENO_NO_SHR" name="cmbEVL_YY_SHR" style="width:100" onChange="fnc_SearchList()" onKeyPress="JavaScript: if (event.keyCode == 13) fnc_SearchList()">
                                     </select>
                            </td>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_ACHTBL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:220px;">
                            ...
                            <param name="Format"                    value="
                                <FC> id='TASK_AIM'        width=130  name='주요핵심과제'  align=left   Edit='None' </FC>
                                <FC> id='TASK_CSF'   	  width=130  name='핵심성공요소'  align=left   Edit='None' </FC>
                                <FC> id='BASIC_PAR'       width=130  name='KPI(측정방법)' align=left   Edit='None' </FC>
                                <FC> id='AIM_LEVEL'       width=90   name='목표;(Target)' align=left   Edit='None' </FC>
                                <FC> id='ADDING_PCT'      width=40   name='가중치'        align=center Edit='None' </FC>
                                <C>  id='SELF_ACHDEC'     width=130  name='달성도'        align=left   Edit='true' </C>
                                <C>  id='SELF_ACHRAT'     width=40   name='달성율;%'      align=right  Edit='Numeric' EditLimit=3</C>
                                <G>  name='달성도점수' HeadBgColor='#F7DCBB'
                                     <C> id='SELF_ACHPNT' width=40   name='평가'          align=right  Edit='None' </C>
                                     <C> id='SELF_ACHCVT' width=40   name='환산'          align=right  Edit='None' Dec=2 </C>
                                </G>
                            ">
                        </object>
