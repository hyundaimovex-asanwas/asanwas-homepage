...
<%
   ...
   // String EVL_FRQ    = request.getParameter("EVL_FRQ");        //회차
    ...
    String Manager_YN = request.getParameter("Manager_YN");
...
%>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            trT_EV_ACHTBL.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc151.cmd.VLUC151CMD&S_MODE=SHR&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+EVL_FRQ+"&ENO_NO="+ENO_NO+"&DEGREE_GBN=1"+"&EVLENO_NO="+EVLENO_NO+"&GBN="+GBN;
            trT_EV_ACHTBL.post();
            ...
            if (dsT_EV_ACHTBL.CountRow == 0)    {
                ...
                form1.txtTOT_PNT.value  = dsT_EV_ACHTBL.Sum(dsT_EV_ACHTBL.ColumnIndex("EVL_ACHCVT"),0,0) +
                                          dsT_EV_ACHTBL.Sum(dsT_EV_ACHTBL.ColumnIndex("EVL_DIFCVT"),0,0);
                form1.txtTOT_PNT2.value = dsT_EV_ACHTBL.Sum(dsT_EV_ACHTBL.ColumnIndex("EVL_ACHCVT"),0,0) +
                                          dsT_EV_ACHTBL.Sum(dsT_EV_ACHTBL.ColumnIndex("EVL_DIFCVT"),0,0);
            }
        ...
        function fnc_Save() {
            ...
            trT_EV_ACHTBL.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc151.cmd.VLUC151CMD&S_MODE=SAV";
            trT_EV_ACHTBL.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ACHTBL.GridToExcel("평가자평가입력", '', 225);
      ...
      //          fnc_Message(document.getElementById("resultMessage"), "MSG_04");
            ...
            for (var i = 1; i <= dsT_EV_ACHTBL.CountRow; i++) {
                if (dsT_EV_ACHTBL.NameValue(i, "EVL_ACHRAT").trim() == "")  {
                    alert("달성율은 필수 입력항목입니다.");

                    form1.grdT_EV_ACHTBL.SetColumn("EVL_ACHRAT");
        ...
        function fnc_OnLoadProcess() {
            ...
            if("<%=Manager_YN%>" == "Y") {
              document.getElementById("imgadjust").style.display = "none";
              document.getElementById("image3").style.display = "none";
            }
            else{
              document.getElementById("imgadjust").style.display = "";
        ...
        function fnc_BatchBtn() {
            ...
            if (form1.txtREFENO_NO1_SHR.value != "") {
                ACHDEC = "REF1_ACHDEC";
                ACHRAT = "REF1_ACHRAT";
                ACHPNT = "REF1_ACHPNT";
                ACHCVT = "REF1_ACHCVT";
            ...
            for (var i = 1; i <= dsT_EV_ACHTBL.CountRow; i++) {
                ...
                dsT_EV_ACHTBL.NameValue(i, "EVL_ACHDEC") = dsT_EV_ACHTBL.NameValue(i, ACHDEC);
                dsT_EV_ACHTBL.NameValue(i, "EVL_ACHRAT") = dsT_EV_ACHTBL.NameValue(i, ACHRAT);
                dsT_EV_ACHTBL.NameValue(i, "EVL_ACHPNT") = dsT_EV_ACHTBL.NameValue(i, ACHPNT);
                dsT_EV_ACHTBL.NameValue(i, "EVL_ACHCVT") = dsT_EV_ACHTBL.NameValue(i, ACHCVT);
                dsT_EV_ACHTBL.NameValue(i, "EVL_DIFPNT") = dsT_EV_ACHTBL.NameValue(i, DIFPNT);
                dsT_EV_ACHTBL.NameValue(i, "EVL_DIFCVT") = dsT_EV_ACHTBL.NameValue(i, DIFCVT);
        ...
        function fnc_Disp_RefColumn() {
            ...
            // 참조평가자 존재여부에 따라 그리드에서 참조평가자컬럼 1, 2, 3를 보여주거나, 보이지 않게 막는다.
            // 참조평가 1차
            if (dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO1") == '') {
                ...
                form1.txtREFENO_NO1_SHR.value = dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO1");
            ...
            // 참조평가 2차
            if (dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO2") == '') {
                ...
                form1.txtREFENO_NO2_SHR.value = dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO2");
            ...
            // 참조평가 3차
            if (dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO3") == '') {
                ...
                form1.txtREFENO_NO3_SHR.value = dsT_EV_EVLIST_HD.NameValue(1, "REFENO_NO3");
    ...
    **************************************-->
    ...
    <script for=dsT_EV_ACHTBL Event=onColumnChanged(row,colid)>
        ...
        if ( colid == 'EVL_ACHCVT' || colid == 'EVL_DIFCVT' ) {
    ...
    <script language="javascript"  for=grdT_EV_ACHTBL event=OnExit(row,colid,olddata)>
        ...
        if (colid == "EVL_ACHRAT") {
            ...
            if (dsT_EV_ACHTBL.NameValue(row, colid) == "") {
                dsT_EV_ACHTBL.NameValue(row, "EVL_ACHPNT") = 0;
                dsT_EV_ACHTBL.NameValue(row, "EVL_ACHCVT") = 0;
                dsT_EV_ACHTBL.NameValue(row, "EVL_DIFPNT") = 0;
                dsT_EV_ACHTBL.NameValue(row, "EVL_DIFCVT") = 0;
            ...
            for (var i = 1; i <= dsT_EV_ACHPNT.CountRow; i++) {
                ...
                if (dsT_EV_ACHPNT.NameValue(i, "RATE_OVER") <= dsT_EV_ACHTBL.NameValue(row, colid) &&
                    ...
                    dsT_EV_ACHTBL.NameValue(row, "EVL_ACHPNT") = dsT_EV_ACHPNT.NameValue(i, "ACH_PNT");
                    dsT_EV_ACHTBL.NameValue(row, "EVL_ACHCVT") = dsT_EV_ACHPNT.NameValue(i, "ACH_PNT") * (dsT_EV_ACHTBL.NameValue(row, "ADDING_PCT") / 100);
                    dsT_EV_ACHTBL.NameValue(row, "EVL_DIFPNT") = dsT_EV_ACHTBL.NameValue(row, "DIFFICULT_PNT");
                    dsT_EV_ACHTBL.NameValue(row, "EVL_DIFCVT") = dsT_EV_ACHTBL.NameValue(row, "DIFFICULT_PNT") * (dsT_EV_ACHTBL.NameValue(row, "ADDING_PCT") / 100);
            ...
            if (flag == 0) {
                if (dsT_EV_ACHPNT.NameValue(dsT_EV_ACHPNT.CountRow, "RATE_UNDER") <= dsT_EV_ACHTBL.NameValue(row, colid)) {
                    ...
                    dsT_EV_ACHTBL.NameValue(row, "EVL_ACHPNT") = dsT_EV_ACHPNT.NameValue(dsT_EV_ACHPNT.CountRow, "ACH_PNT");
                    dsT_EV_ACHTBL.NameValue(row, "EVL_ACHCVT") = dsT_EV_ACHPNT.NameValue(dsT_EV_ACHPNT.CountRow, "ACH_PNT") * (dsT_EV_ACHTBL.NameValue(row, "ADDING_PCT") / 100);
                    dsT_EV_ACHTBL.NameValue(row, "EVL_DIFPNT") = dsT_EV_ACHTBL.NameValue(row, "DIFFICULT_PNT");
                    dsT_EV_ACHTBL.NameValue(row, "EVL_DIFCVT") = dsT_EV_ACHTBL.NameValue(row, "DIFFICULT_PNT") * (dsT_EV_ACHTBL.NameValue(row, "ADDING_PCT") / 100);
    ...
    <script language="javascript"  for=dsT_EV_ACHTBL event=OnRowPosChanged(row)>
        ...
        //데이터셋 전송
        dsT_EV_AIMSUB.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc151.cmd.VLUC151CMD&S_MODE=SHR_02&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_FRQ="+EVL_FRQ+"&AIM_YMD="+AIM_YMD+"&ENO_NO="+ENO_NO+"&EVLENO_NO="+EVLENO_NO+"&AIM_SEQ="+AIM_SEQ;
        dsT_EV_AIMSUB.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">평가자평가</td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <td>
                    <table width="480" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                        ...
                        <tr>
                            ...
                            <td class="padding2423">
                                성명 <input id=txtEVLENO_NM_SHR name=txtEVLENO_NM_SHR size="12" class="input_ReadOnly" readonly>
                            </td>
                            <!-- Hidden Filed (구분 : '2'이면 평가자가 조건임)-->
                            <input type=hidden name=txtGBN_SHR value="2">
                            <input type=hidden name=txtEVLENO_NO_SHR>
                            <input type=hidden name=txtREFENO_NO1_SHR>
                            <input type=hidden name=txtREFENO_NO2_SHR>
                            <input type=hidden name=txtREFENO_NO3_SHR>
        ...
        <td class="paddingTop5">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <input type=hidden id=txtTOT_PNT2></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_ACHTBL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:230px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <G> name='참조평가(1차)' HeadBgColor='#F7DCBB'
                                    <C> id='REF1_ACHDEC'          width=70    name='달성도'           align=left   Edit='None' Show='false'</C>
                                    <C> id='REF1_ACHRAT'          width=40    name='달성율'           align=right  Edit='None' Show='false'</C>
                                    <C> id='REF1_PNT'             width=40    name='점수'             align=right  Edit='None' Show='false' Dec=2 Value={(REF1_ACHCVT+REF1_DIFCVT)} </C>
                                </G>
                                <G> name='참조평가(2차)' HeadBgColor='#F7DCBB'
                                    <C> id='REF2_ACHDEC'          width=70    name='달성도'           align=left   Edit='None' Show='false'</C>
                                    <C> id='REF2_ACHRAT'          width=40    name='달성율'           align=right  Edit='None' Show='false'</C>
                                    <C> id='REF2_PNT'             width=40    name='점수'             align=right  Edit='None' Show='false' Dec=2 Value={(REF2_ACHCVT+REF2_DIFCVT)} </C>
                                </G>
                                <G> name='참조평가(3차)' HeadBgColor='#F7DCBB'
                                    <C> id='REF3_ACHDEC'          width=70    name='달성도'           align=left   Edit='None' Show='false'</C>
                                    <C> id='REF3_ACHRAT'          width=40    name='달성율'           align=right  Edit='None' Show='false'</C>
                                    <C> id='REF3_PNT'             width=40    name='점수'             align=right  Edit='None' Show='false' Dec=2 Value={(REF3_ACHCVT+REF3_DIFCVT)} </C>
                                </G>
                                <G> name='평가자평가' HeadBgColor='#F7DCBB'
                                    <C> id='EVL_ACHDEC'           width=80    name='달성도'           align=left   Edit='true' </C>
                                    <C> id='EVL_ACHRAT'           width=40    name='달성율'           align=right  Edit='true' Edit='Numeric' EditLimit=3</C>
                                        <C> id='EVL_ACHPNT'       width=35    name='평가'             align=right  Edit='None' </C>
                                        <C> id='EVL_ACHCVT'       width=35    name='환산'             align=right  Edit='None' </C>
...
<object id="bndT_EV_EVLIST_HD" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        ...
        <C>Col=REFENO_NO1   Ctrl=txtREFENO_NO1_SHR  Param=value </C>
        <C>Col=REFENO_NO2   Ctrl=txtREFENO_NO2_SHR  Param=value </C>
        <C>Col=REFENO_NO3   Ctrl=txtREFENO_NO3_SHR  Param=value </C>
    '>
</object>