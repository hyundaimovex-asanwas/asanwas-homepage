...
*****************************************************
* @source       : vluc190.jsp
* @description : 본부장조정확정(Feed Back) PAGE
*****************************************************
...
<html>
<head>
<title>본부장조정확정(Feed Back)(vluc190)</title>
...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Save(p_gbn) {
            ...
            //트랜잭션 전송
            trT_EV_ABLRST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc190.cmd.VLUC190CMD&S_MODE=SAV";
            trT_EV_ABLRST.Post();
        ...
        function fnc_AddNew(p_gbn) {
            ...
            dsT_EV_ABLRST.NameValue(1,"EVL_YY")  = dsT_EV_ESTINFO.NameValue(1,"EVL_YY");
            dsT_EV_ABLRST.NameValue(1,"EVL_GBN") = '2';    //성과
            dsT_EV_ABLRST.NameValue(1,"EVL_FRQ") = dsT_EV_ESTINFO.NameValue(1,"EVL_FRQ");
    ...
    ***************************************************************************************-->
    ...
    <!----------------------------------------------+
    | 1. 조회 및 저장용 DataSet                     |
    | 2. 이름은 ds_ + 주요 테이블명(dsT_EV_ESTINFO)   |
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
            ...
            dsT_EV_ABLRST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc190.cmd.VLUC190CMD&S_MODE=SHR_02&GUBUN="+GUBUN+"&EVL_YY="+document.getElementById("EVL_YY").innerText+"&EVL_GBN=2&EVL_FRQ="+document.getElementById("EVL_FRQ").innerText;
            dsT_EV_ABLRST.Reset();
                ...
                <td height="25" background="/images/common/barBg.gif">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본부장조정확정_성과</td>
                            <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본부장조정확정_성과</font></td>
                        </tr>
                    </table>
                </td>
            </tr>
