    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송(이의신청(개인)_성과)
            dsT_EV_PROTEST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc200.cmd.VLUC200CMD&S_MODE=SHR&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value;
        ...
        function fnc_SearchItem(searchDiv) {
            ...
            if( searchDiv == '2') {
                //이의신청기간 여부 체크
                dsT_EV_ESTINFO_01.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub080.cmd.VLUB080CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value;
        ...
        function fnc_Save() {
            ...
            trT_EV_PROTEST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc200.cmd.VLUC200CMD&S_MODE=SAV&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&txtEVL_FRQ_SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&FLAG="+file_flag;
            trT_EV_PROTEST.Post();
