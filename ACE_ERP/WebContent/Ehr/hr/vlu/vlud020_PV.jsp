...
<%
    ...
    System.out.println("vlud020_PV EVL_YY  ="+EVL_YY );
    System.out.println("vlud020_PV ENO_NO  ="+ENO_NO );
    System.out.println("vlud020_PV DPT_CD  ="+DPT_CD );
    System.out.println("vlud020_PV EVL_FRQ ="+EVL_FRQ);
    System.out.println("vlud020_PV HEAD_CD ="+HEAD_CD);
%>
<html>
<head>
<title>미리보기</title>
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="vlud020.hnw">
              <param name="initvalue" VALUE="[:EVL_YY]=<%=EVL_YY%>[:EVL_FRQ]=<%=EVL_FRQ%>[:ENO_NO]=<%=ENO_NO%>[:DPT_CD]=<%=DPT_CD%>[:HEAD_CD]=<%=HEAD_CD%>">
