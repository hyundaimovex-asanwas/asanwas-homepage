    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_EV_ABLRST.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.d.vlud030.cmd.VLUD030CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+EVL_FRQ+"&HEAD_CD="+HEAD_CD;
            dsT_EV_ABLRST.Reset();
        ...
        function fnc_SearchItem() {
            ...
            dsT_EV_TYPE.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.d.vlud030.cmd.VLUD030CMD&S_MODE=SHR_00&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY;
            dsT_EV_TYPE.Reset();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("본부별평가현황", '', 225)
        ...
        function fnc_OnLoadProcess() {
			...
			form1.grdT_EV_ABLRST_01.HiddenHScroll  = true;
			form1.grdT_EV_ABLRST_01.HiddenVScroll  = true;
			form1.grdT_EV_ABLRST_01.DisableNoHScroll = false;
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본부별평가현황</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본부별평가현황</font></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
                        <comment id="__NSID__">
                        <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:315px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <C> id='GROUP_NM'     width=120   name='평가그룹'   align=left   </C>
                                <C> id='HEAD_NM'      width=120   name='본부명'     align=left   </C>
                                <C> id='DPT_NM'       width=120   name='소속명'     align=left   </C>
                                <C> id='TOT_CNT'      width=63    name='평가인원'   align=right  </C>
                                <C> id='FINAL_GRD_S'  width=63    name='S'          align=right  </C>
                                <C> id='FINAL_GRD_A'  width=63    name='A'          align=right  </C>
                                <C> id='FINAL_GRD_B'  width=63    name='B'          align=right  </C>
                                <C> id='FINAL_GRD_C'  width=63    name='C'          align=right  </C>
                                <C> id='FINAL_GRD_D'  width=63    name='D'          align=right  </C>
                            ">
                        </object>
        ...
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
                        <comment id="__NSID__">
                        <object    id="grdT_EV_ABLRST_01" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:26px;">
                            <param name="DataID"                  value="dsT_EV_ABLRST">
                            <param name="EdiTABLE"                value="false">
                            <param name="DragDropEnable"          value="true">
                            <param name="SortView"                value="Left">
                            ...
                            <param name="Format"                  value="
                                <C> id='{currow}'         width=40    name='순번'       align=center </C>
                                <C> id='GROUP_NM'         width=120   name='평가그룹'   align=center sumtext='합계' </C>
                                <C> id='HEAD_NM'          width=120   name='본부'       align=center </C>
                                <C> id='DPT_NM'           width=120   name='소속'       align=center </C>
                                <C> id='TOT_CNT_NUM'      width=63    name='평가인원'   align=right  sumtext=@sum   </C>
                                <C> id='FINAL_GRD_S_NUM'  width=63    name='S'          align=right  sumtext=@sum   </C>
                                <C> id='FINAL_GRD_A_NUM'  width=63    name='A'          align=right  sumtext=@sum   </C>
                                <C> id='FINAL_GRD_B_NUM'  width=63    name='B'          align=right  sumtext=@sum   </C>
                                <C> id='FINAL_GRD_C_NUM'  width=63    name='C'          align=right  sumtext=@sum   </C>
                                <C> id='FINAL_GRD_D_NUM'  width=63    name='D'          align=right  sumtext=@sum   </C>
                            ">
                        </object>
                        </comment><script> __ShowEmbedObject(__NSID__); </script>
                    </td>
