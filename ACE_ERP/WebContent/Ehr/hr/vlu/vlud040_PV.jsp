...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="vlud040.hnw">
              <param name="initvalue" VALUE="[:EVL_YY]=<%=EVL_YY%>[:EVL_FRQ]=<%=EVL_FRQ%>[:EVL_GBN]=<%=EVL_GBN%>[:ENO_NO]=<%=ENO_NO%>[:DPT_CD]=<%=DPT_CD%>">
