...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="vlud050.hnw">
              <param name="initvalue" VALUE="[:APPLY_GBN]=<%=APPLY_GBN%>[:ENO_NO]=<%=ENO_NO%>[:DPT_CD]=<%=DPT_CD%>[:EVL_YY1]=<%=EVL_YY1%>[:EVL_YY2]=<%=EVL_YY2%>[:EVL_YY3]=<%=EVL_YY3%>[:EVL_YY4]=<%=EVL_YY4%>[:EVL_YY5]=<%=EVL_YY5%>">
