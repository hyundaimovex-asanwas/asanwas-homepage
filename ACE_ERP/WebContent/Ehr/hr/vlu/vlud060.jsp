    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_EV_ABLRST.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.d.vlud060.cmd.VLUD060CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+EVL_FRQ;
            dsT_EV_ABLRST.Reset();
        ...
        function fnc_SearchItem() {
            ...
            dsT_EV_TYPE.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.d.vlud060.cmd.VLUD060CMD&S_MODE=SHR_00&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY;
            dsT_EV_TYPE.Reset();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("평정결과(본부별)", '', 225)
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">평정결과(본부별)</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">평정결과(본부별)</font></td>
                </tr>
            </table>
        </td>
    </tr>
                        ...
                        <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"                  value="
                                <X> name='구    분' HeadBgColor='#F7DCBB'
                                    <C> id='OCC_NM'       width=79    name='근로구분'        align=left  suppress=2 </C>
                                    <C> id='HEAD_NM'      width=80    name='본부'        align=left  suppress=1 </C>
                                    <C> id='GRD_NM'       width=70    name='평가구분'    align=left   </C>
