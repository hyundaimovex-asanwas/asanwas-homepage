...
String sql = XmlSqlUtils.getSQL("vlu", "VLUD060_SHR_01");
...
/** 필드값 세팅 **/
	String 	colStr  = "TYPE,IDX,OCC_NM,HEAD_NM,GRD_NM,TOT_CNT,S_CNT,S_PERS,A_CNT,A_PERS,B_CNT,B_PERS,C_CNT,C_PERS,D_CNT,D_PERS";
