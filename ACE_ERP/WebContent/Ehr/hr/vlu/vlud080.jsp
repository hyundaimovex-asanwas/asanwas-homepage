    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("평정결과(명단)", '', 225)
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ABLRST Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            var szSubSumText = "{decode(curlevel,1,'',2,'',9999,'총  계')}";
            form1.grdT_EV_ABLRST.ColumnProp("OCC_NM", "SubSumText") = szSubSumText;

            var szSubSumText = "{decode(curlevel,1,'소계',2,'계',9999,'')}";
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">평정결과(명단)</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">평정결과(명단)</font></td>
                </tr>
            </table>
        </td>
    </tr>
                        ...
                        <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:350px;">
                            ...
                            <param name="Format"                  value="
                                <X> name='구    분' HeadBgColor='#F7DCBB'
                                    <C> id='OCC_NM'       width=55    name='근로구분'        align=left   SubBgColor=#99FFCC subsumtext='' suppress=2 </C>
                                    <C> id='HEAD_NM'      width=90    name='본부'        align=left   SubBgColor=#99FFCC subsumtext='' suppress=1 </C>
                                    <C> id='GRD_GBN'      width=40    name='인원'        align=center SubBgColor=#99FFCC subsumtext={subsum(S_CNT) + subsum(A_CNT) + subsum(B_CNT) + subsum(C_CNT) + subsum(D_CNT)}</C>
                                </X>
                                <X> name='평 가 등 급 별    인 원' HeadBgColor='#F7DCBB'
                                    <G> name='S;(5%)' HeadBgColor='#F7DCBB'
                                        <C> id='S_DPT'    width=100    name='소속'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='S_JOB'    width=60    name='직위'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='S_ENO'    width=80    name='성명'        align=center SubBgColor=#99FFCC subsumtext={IF(subsum(S_CNT)=0,' ',subsum(S_CNT))}</C>
                                    </G>
                                    <G> name='A;(10%)' HeadBgColor='#F7DCBB'
                                        <C> id='A_DPT'    width=100    name='소속'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='A_JOB'    width=60    name='직위'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='A_ENO'    width=80    name='성명'        align=center SubBgColor=#99FFCC subsumtext={IF(subsum(A_CNT)=0,' ',subsum(A_CNT))}</C>
                                    </G>
                                    <G> name='B;(70%)' HeadBgColor='#F7DCBB'
                                        <C> id='B_CNT'    width=40    name='인원'        align=center SubBgColor=#99FFCC subsumtext={IF(subsum(B_CNT)=0,' ',subsum(B_CNT))} value={decode(B_CNT,'0','',B_CNT)}</C>
                                    </G>
                                    <G> name='C;(10%)' HeadBgColor='#F7DCBB'
                                        <C> id='C_DPT'    width=100    name='소속'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='C_JOB'    width=60    name='직위'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='C_ENO'    width=80    name='성명'        align=center SubBgColor=#99FFCC subsumtext={IF(subsum(C_CNT)=0,' ',subsum(C_CNT))}</C>
                                    </G>
                                    <G> name='D;(5%)' HeadBgColor='#F7DCBB'
                                        <C> id='D_DPT'    width=100    name='소속'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='D_JOB'    width=60    name='직위'        align=left   SubBgColor=#99FFCC </C>
                                        <C> id='D_ENO'    width=80    name='성명'        align=center SubBgColor=#99FFCC subsumtext={IF(subsum(D_CNT)=0,' ',subsum(D_CNT))}</C>
                                    </G>
                                </X>
                            ">
                        </object>
