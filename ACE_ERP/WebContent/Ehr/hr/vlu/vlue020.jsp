    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송(상여금반영조회)
            dsT_EV_EVLAPPLY.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.e.vlue020.cmd.VLUE020CMD&S_MODE=SHR&GUBUN="+GUBUN+"&cmbEVL_YY_SHR="+document.getElementById("cmbEVL_YY_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&txtDPT_CD_SHR="+document.getElementById("txtDPT_CD_SHR").value;
        ...
        function fnc_Save() {
            ...
            //트랜잭션 전송
            trT_EV_EVLAPPLY.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.e.vlue020.cmd.VLUE020CMD&S_MODE=SAV";
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_EVLAPPLY.GridToExcel("상여급반영", '', 225);
        ...
        function fnc_EvlApply() {
            ...
            // 상여금반영 여부를 물어 본다.
            if (confirm(document.getElementById("cmbEVL_YY_SHR").value+"년도 에 대한 상여금 반영을 하시겠습니까?\n기존에 반영한 자료는 삭제됩니다.") == false) return;

            dsT_EV_GRDRATE.ClearData();

            //본부별배분율, 평가반영비율 및 등급별배분율 존재여부 확인
            dsT_EV_GRDRATE.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.e.vlue020.cmd.VLUE020CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+document.getElementById("cmbEVL_YY_SHR").value;
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_EVLAPPLY Event="OnLoadCompleted(iCount)">
        ...
        if( saveDiv == false ) {
            ...
            document.getElementById("resultMessage").innerText = '* 상여금 반영이 완료 되었습니다.';
        }
    ...
    <Script For=dsT_EV_GRDRATE Event="OnLoadCompleted(iCount)">
        ...
        if (iCount > 0) {
            for (var i = 1; i <= iCount; i++) {
                // 구분 '2'(상여금에 대한 등급별비율 여부)이면
                if (dsT_EV_GRDRATE.NameValue(i, "GBN") == "2" && dsT_EV_GRDRATE.NameValue(i, "VAL") == "0") {
                    alert("상여금에 대한 등급별배분율이 미존재합니다.\n등급별배분율설정 데이터를 확인하신 후 작업하시기 바랍니다.");
                    return;
                }
                // 구분 '6'(성과평가최종등급)이면
                else if (dsT_EV_GRDRATE.NameValue(i, "GBN") == "6" && dsT_EV_GRDRATE.NameValue(i, "VAL") == "0") {
            ...
            dsT_EV_EVLAPPLY.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.e.vlue020.cmd.VLUE020CMD&S_MODE=SAV_01&GUBUN="+GUBUN+"&cmbEVL_YY_SHR="+document.getElementById("cmbEVL_YY_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&txtDPT_CD_SHR="+document.getElementById("txtDPT_CD_SHR").value;
            dsT_EV_EVLAPPLY.Reset();
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">상여금반영</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">상여금반영</font></td>
                    </tr>
                </table>
            </td>
        </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td class="padding2423"><select id=cmbEVL_YY_SHR name=cmbEVL_YY_SHR onChange="fnc_SearchItem();"><select></td>
                                        ...
                                        <td class="padding2423"><input id=txtDPT_CD_SHR name=txtDPT_CD_SHR size="8" maxlength="6" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
                                        ...
                                        <td class="padding2423"><input id=txtENO_NO_SHR name=txtENO_NO_SHR size="8" maxlength="10" style="ime-mode:disabled" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList(); cfNumberCheck();">
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_EVLAPPLY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:390px;">
                                ...
                                <param name="Format"                  value="
                                    <C> id='{String(currow)}'    width=50     name='순번'            align=center    edit=none </C>
                                    <C> id='DPT_NM'              width=115    name='부서'          align=left    edit=none </C>
                                    <C> id='JOB_NM'              width=115    name='직위'          align=left    edit=none </C>
                                    <C> id='ENO_NO'              width=115    name='사번'          align=center    edit=none</C>
                                    <C> id='ENO_NM'              width=115    name='성명'          align=center    edit=none </C>
                                    <G> name='성과' HeadBgColor='#F7DCBB'
                                    <C> id='EVL_GBN_2_1'         width=60     name='1회'       align=center        edit=none </C>
                                    <C> id='EVL_GBN_2_2'         width=60     name='2회'       align=center        edit=none </C>
                                    <C> id='EVL_GBN_2_3'         width=60     name='3회'       align=center        edit=none </C>
                                    <C> id='EVL_GBN_2_4'         width=60     name='4회'       align=center        edit=none </C>
                                    </G>
