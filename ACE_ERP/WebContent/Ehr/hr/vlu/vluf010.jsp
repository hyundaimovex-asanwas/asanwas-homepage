...
<script language="javascript" >
        ...
        function fnc_Save() {
			if(fnc_SaveItemCheck()) {
				...
				tr01T_CM_DUTYMST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf010.cmd.VLUF010CMD&S_MODE=SAV_01";
        ...
        function fnc_Delete() {
			...
			tr01T_CM_DUTYMST.KeyValue = "SVL(I:ds01T_CM_DUTYMST=ds01T_CM_DUTYMST)";
			tr01T_CM_DUTYMST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf010.cmd.VLUF010CMD&S_MODE=DEL_01";
			tr01T_CM_DUTYMST.post();
            dsT_CM_DUTYMST.Reset();//트리도 재구성한다.
    ...
    **************************************-->
    ...
    <script language=JavaScript for=tvT_CM_DUTYMST event=OnItemClick()>
		...
		try {
			ds01T_CM_DUTYMST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf010.cmd.VLUF010CMD&S_MODE=SHR_01&"+overId1+"="+overValue1+"&"+overId2+"="+overValue2;
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">직무코드등록</td>
					<td align="right" class="navigator">HOME/인사평가/직무관리/<font color="#000000">직무코드등록</font></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grd01T_CM_DUTYMST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500px;height:375px">
                            ...
                            <param name="Format"						value="
								<C> id='DUTY_CD'		width=100	    name='코드'			sort=true		align=center									</C>
								<C> id='DUTY_NM'		width=184		name='직무명'		sort=true		align=left		 								</C>
