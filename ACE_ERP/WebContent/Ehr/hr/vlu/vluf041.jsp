...
*****************************************************
* @source       : vluf041.jsp
* @description : HRMS PAGE :: 직무조사서_등록
*****************************************************
...
<% String head_nm = request.getParameter("HEAD_NM"); %>
<% String title = request.getParameter("TITLE"); %>

<html>
<head>
<title><%=title%>(vluf041)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Save() {
			...
			trT_EV_DUTYSUB.KeyValue = "tr01(I:dsT_EV_DUTYSUB=dsT_EV_DUTYSUB, I:dsT_EV_DUTYRSH=dsT_EV_DUTYRSH)";
			trT_EV_DUTYSUB.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf041.cmd.VLUF041CMD&S_MODE=SAV&DUTY_NO="+document.getElementById('cmbDUTY_NO').value+"&DUTY_CD="+document.getElementById('txtDUTY_CD').value;
			trT_EV_DUTYSUB.post();
        ...
        function fnc_Exit() {
			...
			if (dsT_EV_DUTYRSH.IsUpdated || dsT_EV_DUTYSUB_01.IsUpdated || dsT_EV_DUTYSUB_02.IsUpdated || dsT_EV_DUTYSUB_03.IsUpdated || dsT_EV_DUTYSUB_04.IsUpdated || dsT_EV_DUTYSUB_05.IsUpdated || dsT_EV_DUTYSUB_06.IsUpdated || dsT_EV_DUTYSUB_07.IsUpdated)  {
        ...
        function fnc_SaveItemCheck() {
			...
			if('<%=title%>' != '직무조사서_등록') return false;
        ...
        function fnc_OnLoadProcess() {
			...
			if(dsTemp.CountRow>0){
				cfCopyDataSet(dsTemp, dsT_EV_DUTYRSH, "copyHeader=yes,rowFrom=1,rowCnt=1");
			} else {
				cfCopyDataSetHeader(dsTemp, dsT_EV_DUTYRSH);
				dsT_EV_DUTYRSH.AddRow();
			}

			document.form1.txtHEAD_NM.value = '<%=head_nm%>';
    ...
    ********************************************-->
    ...
    <Script For=ds01T_EV_DUTYBAS Event="OnLoadCompleted(iCount)">
        if (iCount == 0)    {
			...
			if(dsT_EV_DUTYRSH.NameValue(1,'DUTY_NO') != '') {

				//조사회차
//				document.getElementById("cmbDUTY_NO")[dsT_EV_DUTYRSH.NameValue(1,'DUTY_NO')-1].selected = true;
				for(i=1; i <= iCount; i++){
					if(dsT_EV_DUTYRSH.NameValue(1,'DUTY_NO') == ds01T_EV_DUTYBAS.NameValue(i,"DUTY_NO")){
				...
				dsT_EV_DUTYSUB.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf041.cmd.VLUF041CMD&S_MODE=SHR&DUTY_NO="+dsT_EV_DUTYRSH.NameValue(1,'DUTY_NO')+"&DUTY_CD="+dsT_EV_DUTYRSH.NameValue(1,'DUTY_CD');
			...
			} else if (title == '직무별조사현황_상세') {
				document.form1.txtENO_NM.value = dsT_EV_DUTYRSH.NameValue(1,'HEAD_NM');
				document.form1.txtENO_NM.value = dsT_EV_DUTYRSH.NameValue(1,'ENO_NM');
				document.form1.txtJOB_NM.value = dsT_EV_DUTYRSH.NameValue(1,'JOB_NM');
				document.form1.txtDPT_NM.value = dsT_EV_DUTYRSH.NameValue(1,'DPT_NM');
			}
        }
    </Script>
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="right" class="navigator">HOME/인사평가/직무관리/직무조사/직무조사서/<font color="#000000"><%=title%></font></td>
				</tr>
			</table>
		</td>
	</tr>
                    ...
                    <td align="center" class="greenTable">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td align="right" class="searchState">소속본부&nbsp;</td>
                                <td class="padding2423">
									<input id=txtHEAD_NM name=txtHEAD_NM size="15" class="input_ReadOnly" readOnly>
                                </td>
                                <td align="right" class="searchState">소속부서&nbsp;</td>
                                <td class="padding2423">
									<input id=txtDPT_NM name=txtDPT_NM size="15" class="input_ReadOnly" readOnly>
                                </td>
								<td rowspan="2"></td>
							</tr>
                            <tr>
                                ...
                                <td class="padding2423">
									<input id=txtENO_NM name=txtENO_NM size="10" class="input_ReadOnly" readOnly style="TEXT-ALIGN:center">
                                </td>
                                <td align="right" class="searchState">직위&nbsp;</td>
                                <td class="padding2423">
                            	    <input id=txtJOB_NM name=txtJOB_NM size="15" class="input_ReadOnly" readOnly>
                                </td>
                                ...
                                <td class="padding2423">
									...
									<span id="searchDay">
									<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" name="Image3" width="21" height="20" border="0" align="absmiddle" onClick="calendarBtn('datetype1','txtDUTY_YMD','','500','140');"></a>
									</span>
                                </td>
							</tr>
                        </table>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
				...
				<tr>
					...
					<td class="padding2423">
						...
						<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','/images/button/btn_HelpOver.gif',1)"><img src="/images/button/btn_HelpOn.gif" name="Image4" width="21" height="20" border="0" align="absmiddle" onClick="fnc_dutyPopup('txtTHR_NM','txtSEC_NM','txtDUTY_NM','txtDUTY_CD')"></a>
						</span>
					</td>
				</tr>
			</table>
		...
		<td>
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
				...
				<tr>
					...
					<td class="padding2423">
	                    <textarea id=txtDUTY_OBJ name=txtDUTY_OBJ rows="3" cols="115" maxlength="10" onkeyup="fc_chk_byte(this,800);" ></textarea>
					</td>
				</tr>
			</table>
		</td>
