...
<script language="javascript" >
    ...
    **************************************************************************************************-->
	...
	<!-----------------------------------------------------------------+
    | 1. 카피용 DataSet												   |
    | 2. 이름은 ds_ + 주요 테이블명(dsT_EV_DUTYRSH)					   |
    | 3. 사용되는 Table List(T_EV_DUTYRSH)			   |
    +------------------------------------------------------------------>
...
//		alert("overNm=>"+overNm+",Row=>"+Row+",duty_cd=>"+duty_cd);
		try {
			dsT_EV_DUTYRSH.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.f.vluf070.cmd.VLUF070CMD&S_MODE=SHR&DUTY_NO="+getElementById('cmbDUTY_NO_SHR').value+"&DUTY_CD="+duty_cd;
	...
	<script language=JavaScript for=grdT_EV_DUTYRSH event="OnClick(row,colid)">
		...
		if(row < 1) {
			...
			var url = "/hr/vlu/vluf061.jsp?TITLE=직무기술서현황_세부";
			//선택된 ROW를 dsT_EV_DUTYRSH_CP 복사하여 Modal창에 dsT_EV_DUTYRSH_CP 넘겨준다.
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">직무기술서현황</td>
					<td align="right" class="navigator">HOME/인사평가/직무관리/직무조사/<font color="#000000">직무기술서현황</font></td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<td>
        				...
        				<object	id="grdT_EV_DUTYRSH" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500;height:375px;">
        					...
        					<param name="Format"				value="
        								<C> id={currow}		width=90      name='순번'		 align=center </C>
        								<C> id='DUTY_NO'	width=90      name='조사회차'	 align=center </C>
        								<C> id='DUTY_YMD'	width=150     name='작성일자'	 align=center </C>
        								<C> id='UPT_YMD'	width=150     name='최종수정일'  align=center </C>
        							">
        				</object>
        				</comment><script> __ShowEmbedObject(__NSID__); </script>
        			</td>
