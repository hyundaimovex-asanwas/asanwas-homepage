...
<html>
    ...
    <head>
    <title>이의신청(답변)_종합(vlug100)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_PROTEST.GridToExcel("이의신청(답변)_종합", '', 227);
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">이의신청(답변)_종합</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">이의신청(답변)_종합</font></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_PROTEST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:115px;">
                                ...
                                <param name="Format"                            value="
                                    ...
                                    <C> id='GROUP_NM'      width=80        name='평가그룹'     align=left    edit=none     show=false</C>
                                    ...
                                    <C> id='PROTEST_TIT'   width=170       name='신청제목'     align=left    edit=none </C>
