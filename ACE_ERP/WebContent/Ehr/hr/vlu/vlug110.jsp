...
<html>
<head>
<title>자기평가진행정보_종합(vlug010)</title>
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
            ...
            dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.b.vlub010.cmd.VLUB010CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_GBN=3&EVL_YY="+dsT_EV_ESTINFO.NameValue(1,"EVL_YY")+"&EVL_FRQ="+dsT_EV_ESTINFO.NameValue(1,"EVL_FRQ");
            dsT_EV_ABLRST.reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">자기평가진행정보_종합</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">자기평가진행정보_종합</font></td>
                </tr>
            </table>
            <!-- 타이틀 바 테이블 끝 -->
        </td>
                                ...
                                <td height="175" class="hrWtable" style="padding:20 6 6 6">
                                    <table width="100%" height="163" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><img src="/images/specialHr/inputImg5.gif" width="116" height="80" style="cursor:hand" onClick="fnc_showModal('4','/hr/vlu/vlug080.jsp?GUBUN='+GUBUN,'');"></td>
