    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("등급조정_종합", '', 225);
        ...
        if (iCount > 0) {
            for (var i = 1; i <= iCount; i++) {
                ...
                // 구분 '2'(종합평가작성표)이면
                    ...
                    alert("종합평가를 작성한 데이터가 미존재합니다.\n종합평가 데이터를 확인하신 후 작업하시기 바랍니다.");
                    return;
                }
            }
            ...
            // 조정점수반영
            dsT_EV_ABLRST.DataId = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc170.cmd.VLUC170CMD&S_MODE=SHR_02ALL&GUBUN="+GUBUN+"&EVL_YY="+EVL_YY+"&EVL_GBN="+EVL_GBN+"&EVL_FRQ="+EVL_FRQ+"&GROUP_CD="+GROUP_CD;
            dsT_EV_ABLRST.Reset();
        }
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">등급평정_종합</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">등급평정_종합</font></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                            ...
                            <param name="Format"                  value="
                                ...
                                <C> id='FINAL_PNT'    width=80    name='점수'       align=right  Edit='None' DEC=2</C>
