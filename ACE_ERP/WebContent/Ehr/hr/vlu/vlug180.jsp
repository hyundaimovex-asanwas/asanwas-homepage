    ...
    <script language="javascript" >
        ...
        function fnc_Reflect() {
            ...
            if(confirm("기존에 적용된 본부장 조정 자료는 모두 초기화 됩니다.\n\n그래도 적용 하시겠습니까?")) {
                ...
                dsT_EV_ABLRST_02.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc180.cmd.VLUC180CMD&S_MODE=SHR_01&GUBUN="+GUBUN+"&EVL_YY="+dsT_EV_ESTINFO.NameValue(1,'EVL_YY')+"&EVL_GBN=3&EVL_FRQ="+dsT_EV_ESTINFO.NameValue(1,'EVL_FRQ');
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ABLRST_02 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount > 0)    {
            ...
            trT_EV_ABLRST_01.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc180.cmd.VLUC180CMD&S_MODE=SAV_01&GUBUN="+GUBUN+"&EVL_YY="+dsT_EV_ESTINFO.NameValue(1,'EVL_YY')+"&EVL_GBN=3&EVL_FRQ="+dsT_EV_ESTINFO.NameValue(1,'EVL_FRQ');
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본부장조정_종합</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본부장조정_종합</font></td>
                    </tr>
                </table>
            </td>
        </tr>
