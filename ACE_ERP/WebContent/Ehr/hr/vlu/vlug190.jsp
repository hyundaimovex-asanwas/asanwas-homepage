...
<html>
<head>
<title>본부장조정확정(Feed Back)(vlug190)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_AddNew(p_gbn) {
            ...
            dsT_EV_ABLRST.NameValue(1,"EVL_GBN") = '3';    //성과
    ...
    **************************************-->
    ...
    <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
            ...
            dsT_EV_ABLRST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc190.cmd.VLUC190CMD&S_MODE=SHR_02&GUBUN="+GUBUN+"&EVL_YY="+document.getElementById("EVL_YY").innerText+"&EVL_GBN=3&EVL_FRQ="+document.getElementById("EVL_FRQ").innerText;
            dsT_EV_ABLRST.Reset();
                ...
                <td height="25" background="/images/common/barBg.gif">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">본부장조정확정_종합</td>
                            <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">본부장조정확정_종합</font></td>
                        </tr>
                    </table>
                </td>
            </tr>
