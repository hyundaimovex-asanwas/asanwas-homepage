...
<html>
    ...
    <head>
    <title>이의신청(접수)_성과(vluc210)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //데이터셋 전송(이의신청(접수)_성과)
//            dsT_EV_PROTEST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc210.cmd.VLUC210CMD&S_MODE=SHR&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&txt._SHR="+document.getElementById("txtEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&txtDPT_CD_SHR="+document.getElementById("txtDPT_CD_SHR").value+"&cmbHEAD_CD_SHR="+document.getElementById("cmbHEAD_CD_SHR").value;
            dsT_EV_PROTEST.DataID = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc210.cmd.VLUC210CMD&S_MODE=SHR&GUBUN="+GUBUN+"&txtEVL_YY_SHR="+document.getElementById("txtEVL_YY_SHR").value+"&txtEVL_GBN_SHR=2&cmbEVL_FRQ_SHR="+document.getElementById("cmbEVL_FRQ_SHR").value+"&txtENO_NO_SHR="+document.getElementById("txtENO_NO_SHR").value+"&txtDPT_CD_SHR="+document.getElementById("txtDPT_CD_SHR").value+"&cmbHEAD_CD_SHR="+document.getElementById("cmbHEAD_CD_SHR").value;
        ...
        function fnc_Save() {
            ...
            //트랜잭션 전송
            trT_EV_PROTEST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc210.cmd.VLUC210CMD&S_MODE=SAV";
            trT_EV_PROTEST.Post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_PROTEST.GridToExcel("이의신청(접수)_성과", '', 225);
        ...
        function fnc_SearchItemCheck() {
            ...
            if( form1.cmbEVL_FRQ_SHR.value == '') {
                alert("회차는 필수입력사항입니다.");
                form1.cmbEVL_FRQ_SHR.focus();
                return false;
            }
            return true;
        }
        ...
        function fnc_AcceptGbnSet() {
            ...
            for( i=1; i<=dsT_EV_PROTEST.CountRow; i++ ) {
                if( dsT_EV_PROTEST.NameValue(i, "ANSWER_YMD") == '' && dsT_EV_PROTEST.NameValue(i, "ACCEPT_GBN") == 'F' )    {    //답변이 안된것
   ...
   <Script For=dsT_EV_ESTINFO Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            document.getElementById("cmbEVL_FRQ_SHR").value = dsT_EV_ESTINFO.NameValue(1,"EVL_FRQ");
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">이의신청(접수)_성과</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">이의신청(접수)_성과</font></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td align="center" class="greenTable">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td class="padding2423"><input id="txtEVL_YY_SHR" name="txtEVL_YY_SHR" style="width 100%;text-align: center" size="4" class="input_ReadOnly" readonly></td>
<!--                                <td align="right" class="searchState">회차&nbsp;</td>
                                    <td class="padding2423"><input id="txtEVL_FRQ_SHR" name="txtEVL_FRQ_SHR" style="width 100%;text-align: center" size="2" class="input_ReadOnly" readonly></td>-->
                                    <td align="right" class="searchState">회차&nbsp;</td>
                                    <td class="padding2423">
                                        <select name="cmbEVL_FRQ_SHR" style="WIDTH: 110%" onChange="fnc_SearchList();" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
                                    ...
                                    <td class="padding2423"><input id=txtDPT_CD_SHR style="width 100%" size="8" maxlength="6" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
