...
<html>
    ...
    <head>
    <title>이의신청(답변)_성과(vluc220)</title>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_Save() {
            ...
            //트랜잭션 전송
            trT_EV_PROTEST.Action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc220.cmd.VLUC220CMD&S_MODE=SAV";
            trT_EV_PROTEST.Post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_PROTEST.GridToExcel("이의신청(답변)_성과", '', 227);
        ...
        function fnc_SaveItemCheck() {
            ...
            if ( dsT_EV_PROTEST.isUpdated ) {
                for( i=1; i<=dsT_EV_PROTEST.CountRow; i++ ) {
                    if( dsT_EV_PROTEST.NameValue(i,"ANSWER_YMD") != '' && cfDateExpr(dsT_EV_PROTEST.NameValue(i,"ANSWER_YMD")) == false ) {
            ...
            <td height="25" background="/images/common/barBg.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">이의신청(답변)_성과</td>
                        <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">이의신청(답변)_성과</font></td>
                    </tr>
                </table>
            </td>
        </tr>
...
<!--                                <td align="right" class="searchState">회차&nbsp;</td>
                                    ...
                                    <td class="padding2423"><input id=txtDPT_CD_SHR size="8" maxlength="6" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList();">
                                    ...
                                    <td class="padding2423"><input id=txtENO_NO_SHR style="ime-mode:disabled" size="8" maxlength="10" onKeypress="javascript:if(event.keyCode==13) fnc_SearchList(); cfNumberCheck();">
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_PROTEST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:115px;">
                                ...
                                <param name="Format"                            value="
                                    ...
                                    <C> id='HEAD_NM'       width=84        name='본부'     align=left    edit=none </C>
                                    ...
                                    <C> id='ENO_NAME'       width=70        name='성명'     align=center    edit=none </C>
