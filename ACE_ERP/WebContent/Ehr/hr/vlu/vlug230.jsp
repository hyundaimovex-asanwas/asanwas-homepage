    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //역량 평가 적용 결과 정보 조회
            dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc230.cmd.VLUC230CMD&S_MODE=SHR&GUBUN="+GUBUN+"&EVL_YY="+year+"&EVL_GBN=3&EVL_FRQ="+frq+"&ENO_NO="+eno_no+"&DPT_CD="+dpt_cd+"&GROUP_CD="+group_cd+"&CHG_CHK="+chg_chk;
            dsT_EV_ABLRST.reset();
        ...
        function fnc_Save(s_mode) {
            ...
            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.c.vluc230.cmd.VLUC230CMD&S_MODE="+s_mode+"&GUBUN="+GUBUN+"&EVL_GBN=3&EVL_YY="+dsT_EV_ESTINFO.ColumnValue(1,1)+"&EVL_FRQ="+dsT_EV_ESTINFO.ColumnValue(1,2);
            trT_EV_ABLRST.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("등급확정_종합", '', 225);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">등급확정_종합</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">등급확정_종합</font></td>
                </tr>
            </table>
        </td>
    </tr>
