    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            if (document.form1.rdoGBN_SHR[0].checked) {
	            //정보 조회
	            dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui020.cmd.VLUI020CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR; //+"&GUBUN="+GUBUN;
	            dsT_EV_ABLRST.reset();
            }else{
	            //정보 조회
			...
			if(document.form1.rdoGBN_SHR[0].checked){ //일반
				...
				if (dsT_EV_ABLRST.countrow<1){
					...
					if (confirm("선택한 피고과자 정보를 삭제하시겠습니까?")){
			            ...
			            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui020.cmd.VLUI020CMD&S_MODE=DEL&REG_YM_SHR="+REG_YM_SHR;
			            trT_EV_ABLRST.post();
				...
				if (dsT_EV_ABLRST.countrow<1){
					...
					if (confirm("선택한 부서장 피고과자 정보를 삭제하시겠습니까?")){
						dsT_EV_ABLRST.deleterow(dsT_EV_ABLRST.rowposition);

			            trT_EV_ABLRST.KeyValue = "tr01(I:dsT_EV_ABLRST=dsT_EV_ABLRST)";
			            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui020.cmd.VLUI020CMD&S_MODE=DEL_DPT&REG_YM_SHR="+REG_YM_SHR;
			            trT_EV_ABLRST.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("피고과자선정", '', 225);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">피고과자선정</td>
