    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
		  ...
		  dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui030.cmd.VLUI030CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
		  dsT_EV_ABLRST.reset();
        ...
        function fnc_SearchList2() {
		  ...
		  dsT_EV_ABLRST2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui030.cmd.VLUI030CMD&S_MODE=SHR_01&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&ENO_NOH="+ENO_NOH+"&EVA_SEQ="+EVA_SEQ;
				...
				if(fnc_Chk()){
					...
					if(fnc_Chk2()){
					  ...
					  if (confirm("저장하시겠습니까?")) {
			            ...
			            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui030.cmd.VLUI030CMD&S_MODE=SAV";
			            trT_EV_ABLRST.post();
						//	ln_Query2();
						}
					}
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">고과자지정</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">고과자지정</font></td>
                </tr>
            </table>
        </td>
    </tr>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:400px;height:395px;">
                                ...
                                <param name="Format"                 value="
                                    ...
                                    <FG> name='피고과자'    HeadAlign=Center HeadBgColor=#F7DCBB
	                                    ...
	                                    <FC> id='EMPNMK'   	width=45  	name='성명'  		align=left      edit=none </FC>
	                                </FG>
