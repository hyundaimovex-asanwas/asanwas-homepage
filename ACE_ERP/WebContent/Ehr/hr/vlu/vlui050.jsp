    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
		  	...
		  	if(GUBUN == "1"){ //정규직
		       	//정보 조회
		       	dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&EMPNOH="+EMPNOH+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
			}else{ 			//계약직
		       	//정보 조회
		       	dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_01&REG_YM_SHR="+REG_YM_SHR+"&EMPNOH="+EMPNOH+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
			}
        ...
        function fnc_SearchList2() {
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
			...
			if(document.form1.txtREG_YM_SHR.value !="2012-11"){
				alert("2012년 11월만 실행 가능합니다.");
				return false;
			}
            ...
            dsT_EV_ABLRST.ClearData();
		  	...
		  	if(GUBUN == "1"){ //정규직
		       	...
		       	dsT_EV_ABLRST2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_02&REG_YM_SHR="+REG_YM_SHR+"&EMPNOH="+EMPNOH;
		       	dsT_EV_ABLRST2.reset();
			}else{ 			//계약직

		       	dsT_EV_ABLRST2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_03&REG_YM_SHR="+REG_YM_SHR+"&EMPNOH="+EMPNOH;
		       	dsT_EV_ABLRST2.reset();
			}
        ...
        function fnc_Save() {
			...
			if (dsT_EV_ABLRST.countrow<1){
				...
				if (confirm("저장하시겠습니까?")) {
		            ...
		            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SAV";
		            trT_EV_ABLRST.post();
				}
			}
        }
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
			...
			//직급별 등급 인원수
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_04&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();

			}else{ 			//계약직

		       	dsT_EV_GRADE.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_05&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_GRADE.reset();
			}
			...
			//직급별 rank
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_06&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();

			}else{ 			//계약직

		       	dsT_EV_GRADE2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SHR_07&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_GRADE2.reset();
			}
		    ...
		    if (confirm(document.form1.txtREG_YM_SHR.value+"의 등급생성을 하시겠습니까?")) {
	            ...
	            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SAV_GRD";
	            trT_EV_ABLRST.post();
        ...
        if (iCount < 1)    {
        	...
        	for(var i=1;i<=iCount;i++) {
				...
				if(dsT_EV_ABLRST2.namevalue(i,"DPTAVG")==0){
					...
					dsT_EV_ABLRST2.namevalue(i,"TOTAVG") = dsT_EV_ABLRST2.namevalue(i,"CORAVG")*0.8 + dsT_EV_ABLRST2.namevalue(i,"DPTAVG") ;
			...
			if (confirm("실행하신 정보를 저장하시겠습니까?")) {
	            ...
	            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui050.cmd.VLUI050CMD&S_MODE=SAV_EXE";
	            trT_EV_ABLRST.post();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">고과점수조정</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">고과점수조정</font></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <td class="paddingTop3">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                        <td>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                                ...
                                <param name="Format"                 value="
                                    ...
                                    <FC> id='GRDNM'    	width=70   	name='직위'   		align=left    	edit=none </FC>
                                    <FC> id='EMPNMK'   	width=75  	name='피고과자'  	align=left      edit=none </FC>
                                    <C> id='EMPNMH_1'   width=60  	name='1차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR1'   	width=60  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG1'   	width=60  	name='보정'   		align=center    edit=none </C>
                                    <C> id='EMPNMH_2'   width=60  	name='2차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR2'   	width=60  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG2'   	width=60  	name='보정'   		align=center    edit=none </C>
                                    <C> id='EMPNMH_3'   width=60  	name='3차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR3'   	width=60  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG3'   	width=60  	name='보정'   		align=center    edit=none </C>
								<G> Name='평균' HeadAlign=Center HeadBgColor=#F7DCBB
                                    <C> id='SCRAVG'     width=60   	name='고과'      	align=center    edit=none </C>
                                    <C> id='CORAVG'     width=60   	name='보정'   		align=center    edit=none </C>
                                    <C> id='DPTAVG'     width=60   	name='부서장' 		align=center    edit=none </C>
                                </G>
                                    <C> id='TOTAVG'     width=70   	name='최종;조정'    align=center    edit=none bgcolor='#F5F6CE'</C>
                                    <C> id='GRADE'      width=70   	name='고과;등급'   	align=center    edit=none bgcolor='#F5D0A9'</C>
					 ...
					 <tr>
							<td> <P>&nbsp;&nbsp;* 실&nbsp;&nbsp;&nbsp;&nbsp;행 : 보정평균 점수를 최종 조정에 업데이트함. ( 부서장 평균이 존재하면 보정평균(80%) + 부서장 평균 합산 점수를 적용함 ) <BR>
