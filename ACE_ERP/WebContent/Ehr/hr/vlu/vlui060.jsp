    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
		  ...
		  dsT_EV_ABLRST.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui060.cmd.VLUI060CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
		  dsT_EV_ABLRST.reset();
        ...
        function fnc_SearchList2() {
		  ...
		  dsT_EV_ABLRST2.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui060.cmd.VLUI060CMD&S_MODE=SHR_01&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&ENO_NOH="+ENO_NOH+"&EVA_SEQ="+EVA_SEQ;
				...
				if(fnc_Chk()){
					...
					if(fnc_Chk2()){
					  ...
					  if (confirm("저장하시겠습니까?")) {
			            ...
			            trT_EV_ABLRST.action = "/servlet/GauceChannelSVL?cmd=hr.vlu.i.vlui060.cmd.VLUI060CMD&S_MODE=SAV";
			            trT_EV_ABLRST.post();
						//	ln_Query2();
						}
					}
