    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("고과점수조정(상향)", '', 225);
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">고과점수조정(상향)</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">고과점수조정(상향)</font></td>
                </tr>
            </table>
        </td>
    </tr>
		               ...
		               <colgroup>
		                    ...
		                    <col width="*"></col>
		               		...
		               		<tr>
				                ...
				                <td class="searchState" align="center">소속</td>
                                ...
                                <td class="padding2423" >
                                    <fieldset>
                                    <input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" checked style="margin-bottom:-2px;border:0;">정규직
                                    <input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" style="margin-bottom:-2px;border:0;">계약직
                                    </fieldset>
                                </td>
				            </tr>
							<tr class="paddingTop5" >
								...
								<td class="padding2423">
									...
									<input type="checkbox" name="chkGUBUN_INS1" style="border:0">선택
								</td>
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:340px;">
                                ...
                                <param name="Format"                 value="
                                    ...
                                    <C> id='PAYGRDNM'   width=70   	name='직위'   		align=left    	edit=none </C>

                                    <C> id='EMPNMK'   	width=60  	name='피고과자'  	align=left      edit=none </C>
                                    <C> id='EMPNMH_1'   width=60  	name='1차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR1'   	width=60  	name='점수'      	align=center    DEC=2</C>
                                    <C> id='AVG1'   	width=60  	name='보정'   		align=center    DEC=2</C>


                                    <C> id='EMPNMH_2'   width=60  	name='2차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR2'   	width=60  	name='점수'      	align=center    DEC=2</C>
                                    <C> id='AVG2'   	width=60  	name='보정'   		align=center    DEC=2</C>


                                    <C> id='EMPNMH_3'   width=60  	name='3차;고과자'   align=left      edit=none </C>
                                    <C> id='SCR3'   	width=60  	name='점수'      	align=center    DEC=2</C>
                                    <C> id='AVG3'   	width=60  	name='보정'   		align=center    DEC=2</C>


									<G> Name='평균' HeadAlign=Center HeadBgColor=#F7DCBB

                                    <C> id='SCRAVG'     width=60   	name='고과'      	align=center    DEC=2</C>
                                    <C> id='CORAVG'     width=60   	name='보정'   		align=center    DEC=2</C>
