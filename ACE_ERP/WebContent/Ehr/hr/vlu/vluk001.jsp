...
<script language="javascript" src="/common/calendar/calendar.js"></script>
    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_EV_RQINFO.dataid = "/servlet/GauceChannelSVL?cmd=hr.vlu.k.vluk010.cmd.VLUK010CMD"
                + "&S_MODE=SHR_INFO"
                + "&REG_YM_SHR="+today;
  ...
  //        window.showModalDialog(url, 'win', "dialogWidth:870px; dialogHeight:590px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
    ...
    ***************************************************************************************-->
    ...
    +----------------------------------------------->
    <Object ID="dsT_EV_RQINFO" ClassID="CLSID:2506B38B-0FF7-4249-BA3E-8BC1DC399FBB">
    ...
    **************************************-->
    ...
    | 데이터를 성공적으로 조회 되었을 때 처리 할 로직  |
    +-------------------------------------------------->
    <Script For=dsT_EV_RQINFO Event="OnLoadCompleted(iCount)">

        if (iCount < 1)    {

        } else {
            //개인정보 및 평가정보 Setting
            document.getElementById("EVL_YY").innerText  = dsT_EV_RQINFO.NameValue(1,"EVL_YY");
            document.getElementById("EVL_FRQ").innerText = dsT_EV_RQINFO.NameValue(1,"EVL_FRQ");
            document.getElementById("DPT_NM").innerText  = dsT_EV_RQINFO.NameValue(1,"DPT_NM");
            document.getElementById("LEVEL").innerText   = dsT_EV_RQINFO.NameValue(1,"JIK_NM");
            document.getElementById("ENO_NO").innerText  = dsT_EV_RQINFO.NameValue(1,"ENO_NO");
            document.getElementById("ENO_NM").innerText  = dsT_EV_RQINFO.NameValue(1,"ENO_NM");
            
            //document.getElementById("GRADE").innerText = dsT_EV_RQINFO.NameValue(1,"FINAL_GRD");
            
            document.getElementById("GRADE").innerText = '';
            
            if(dsT_EV_RQINFO.NameValue(1,"IPT_STDT") != '') {
                ipt_stdt = dsT_EV_RQINFO.NameValue(1,"IPT_STDT");
                ipt_endt = dsT_EV_RQINFO.NameValue(1,"IPT_ENDT");
            } else {
                ipt_stdt = dsT_EV_RQINFO.NameValue(2,"IPT_STDT");
                ipt_endt = dsT_EV_RQINFO.NameValue(2,"IPT_ENDT");
            }
            ...
            //if(dsT_EV_RQINFO.NameValue(1,"FINAL_GRD") != ''){
        ...
        <td height="25" background="/images/common/barBg.gif">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">역량평가진행정보</td>
                    <td align="right" class="navigator"><span id="loctitle">&nbsp;</span><font color="#000000">역량평가진행정보</font></td>
                </tr>
            </table>
            <!-- 타이틀 바 테이블 끝 -->
        </td>
                            ...
                            <tr>
                                <td height="175" class="hrWtable" style="padding:20 6 6 6">
                                    <table width="100%" height="163" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center"><img src="/images/specialHr/inputImg4.gif" width="116" height="80" style="cursor:hand"></td>
