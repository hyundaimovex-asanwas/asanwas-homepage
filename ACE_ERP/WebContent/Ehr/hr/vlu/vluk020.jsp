    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            var GBMST_STR = document.form1.cmbGBMST_STR.value;    		//평가구분
        ...
        function fnc_Save() {
			...
			var GB_DTL   = dsT_EV_TEMP.nameValue(dsT_EV_RQSHEET.RowPosition, "GB_DTL");      	//구분
		...
		//	dsT_EV_RQSHEET.nameValue(dsT_EV_RQSHEET.RowPosition, "GBMST") = document.form1.cmbGBMST_STR.value;        				//평가구분
	...
	//	prompt(this,dsT_EV_RQSHEET.text);
        ...
        function fnc_OnLoadProcess() {
	        ...
	        cfStyleGrid_New(form1.grdT_EV_ABLRST,15,"false","false");      // Grid Style 적용
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td>
                        ...
                        <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:600px;height:500px;">
                            ...
                            <param name="Format"                	value="
                                ...
                                <C> id='GB_MST'        		width=80    name='구분'         	align=center   		Edit=None value={IF (GB_MST='01','공통',IF (GB_MST='02','리더십' , IF (GB_MST='03','직무' '')))} suppress=1</C>
                                <C> id='GB_DTL'       	 	width=120    name='항목'         align=left   		Edit=None </C>
                                <C> id='ACT_ITEM'        	width=350  	name='행동지표'     	align=left 			Edit=none</C>
                            ">
                        </object>
				...
				<table border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=3 style='width:400px;height:502px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
					<tr>
						...
						<tr>
						<td style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px"  class="blueBold" align="left"><nobr>&nbsp;구분</nobr></td>
						<td style="height:30px; border:0 solid #708090;border-bottom-width:1px;"><nobr>&nbsp;
								<comment id="__NSID__">
								<object id=gclx_gbmst  classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=100 width=120>
											<param name="CBData" 					value="01^공통,02^리더십,03^직무" />
							...
							<tr>
								<td style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px"  class="blueBold">&nbsp;항목</td>
								<td Style="height:30px;border:0 solid #708090;border-bottom-width:1px"><nobr>&nbsp;
									<input id="txt_gbdtl" name="txt_gbdtl" type="text"  class="txt21" style="position:relative; left:-5px;width:180px;"  >&nbsp;</nobr>
								</td>
							</tr>
							<tr>
								<td style="height:300px;border:0 solid #708090;border-right-width:1px;border-bottom-width:0px"  class="blueBold">&nbsp;행동지표</td>
								<td Style="height:300px;border:0 solid #708090;border-bottom-width:0px">&nbsp;
                              		<textarea id=txt_actitem name=txt_actitem rows="28" cols="45" valid='maxlength=1000' field='내용'></textarea>									
								</td>
							</tr>
						</table>
		  		  </td>
