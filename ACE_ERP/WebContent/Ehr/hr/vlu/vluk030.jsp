    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            //if (document.form1.rdoGBN_SHR[0].checked) {
	            //정보 조회
	            dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk030.cmd.VLUK030CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR; //+"&GUBUN="+GUBUN;
	            dsT_EV_ABLRST.reset();
            //}else{
	            //정보 조회
        ...
        function fnc_Delete() {
			...
			//if(document.form1.rdoGBN_SHR[0].checked){ //일반

				if (dsT_EV_ABLRST.countrow<1){
					alert ("삭제할 정보가 없습니다.");
				}else {
					if (confirm("선택한 피평가자 정보를 삭제하시겠습니까?")){
						dsT_EV_ABLRST.deleterow(dsT_EV_ABLRST.rowposition);

			            trT_EV_ABLRST.KeyValue = "tr01(I:dsT_EV_ABLRST=dsT_EV_ABLRST)";
			            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk030.cmd.VLUK030CMD&S_MODE=DEL&REG_YM_SHR="+REG_YM_SHR;
			            trT_EV_ABLRST.post();
			...
			/*
				...
				if (dsT_EV_ABLRST.countrow<1){
					...
					if (confirm("선택한 부서장 피평가자 정보를 삭제하시겠습니까?")){
						dsT_EV_ABLRST.deleterow(dsT_EV_ABLRST.rowposition);

			            trT_EV_ABLRST.KeyValue = "tr01(I:dsT_EV_ABLRST=dsT_EV_ABLRST)";
			            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk030.cmd.VLUK030CMD&S_MODE=DEL_DPT&REG_YM_SHR="+REG_YM_SHR;
			            trT_EV_ABLRST.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("피평가자선정", '', 225);
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:500px;">
                                ...
                                <param name="Format"                 value="
                                    ...
                                    <C> id='GRDNM'    	width=110   	name='직위'   		align=center    edit=none </C>
                                    <C> id='ENO_NM'   	width=110  		name='성명'  		align=center    edit=none </C>
                                    <C> id='RECNM'    	width=110  		name='입사구분'     	align=center    edit=none </C>
                                    <C> id='GRSTRTDT'   width=110  		name='그룹입사일'   	align=center    edit=none mask='XXXX-XX-XX'</C>
                                    <C> id='STRTDT'     width=110   	name='입사일'      	align=center    edit=none mask='XXXX-XX-XX'</C>
                                    <C> id='LAMDT'     	width=110   	name='최종승진일'   	align=center    edit=none mask='XXXX-XX-XX'</C>
                                    <C> id='WRDT'       width=110   	name='생성고과년월' 	align=center    edit=none mask='XXXX-XX'</C>
                                ">
                            </object>
