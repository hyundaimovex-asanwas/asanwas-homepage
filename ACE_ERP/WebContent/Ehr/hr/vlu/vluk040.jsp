    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
		  ...
		  dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk040.cmd.VLUK040CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
		  dsT_EV_ABLRST.reset();
        ...
        function fnc_SearchList2() {
		  ...
		  dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk040.cmd.VLUK040CMD&S_MODE=SHR_01&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&ENO_NOH="+ENO_NOH+"&EVA_SEQ="+EVA_SEQ;
				...
				if(fnc_Chk()){
					...
					if(fnc_Chk2()){
					  ...
					  if (confirm("저장하시겠습니까?")) {
			            ...
			            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.k.vluk040.cmd.VLUK040CMD&S_MODE=SAV";
			            trT_EV_ABLRST.post();
						//	ln_Query2();
						}
					}
		...
		******************************************************************************/
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("고과자지정", '', 225);
        ...
        cfStyleGrid_New(form1.grdT_EV_ABLRST2,15,"true","false");      // Grid Style 적용
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="35" class="paddingTop5" align="right">
            ...
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../images/button/btn_CancelOver.gif',0)"><img src="../../images/button/btn_CancelOn.gif" name="Image2" width="60" height="20" border="0" align="absmiddle" onClick="fnc_Clear()"></a>
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../images/button/btn_ExcelOver.gif',1)"> <img src="../../images/button/btn_ExcelOn.gif"  name="Image3" width="60" height="20" border="0" align="absmiddle" onClick="fnc_ToExcel()"></a>
        ...
        <tr>
            <td class="paddingTop3">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                        <td>
                            <comment id="__NSID__">
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500px;height:500px;">
                                ...
                                <param name="Format"                 	value="
                                    <FC> id='CHK'     		width=30   	name='' Edit=True  		align=center    EditStyle=CheckBox Pointer=Hand  Edit={IF(CHK='','false','true')}  HeadCheckShow=true sort=false HeadBgColor=#dae0ee</FC>
                                    <FG> name='피고과자'    HeadAlign=Center HeadBgColor=#dae0ee
                                    ...
                                    <FC> id='DEPTNM'    	width=90  	name='소속'     		align=left      	sort=true</FC>
                                    <FC> id='TEAMNM'    	width=90  	name='소속'     		align=left      	sort=true</FC>                                    
                                    <C> id='EMPNMK1'   	width=50  	name='1차;고과자'      	align=center    sort=false</C>
                                    <C> id='EMPNMK2'   	width=50  	name='2차;고과자'   		align=center    sort=false</C>
                                    <C> id='EMPNMK3'    width=50   	name='3차;고과자'      	align=center    sort=false</C>
                                ">
                            </object>
            ...
            <td class="paddingTop3">
                <table border="1" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width=50  class="blueBold" border="1"><nobr>&nbsp;고과자지정</nobr></td>
						<td align=right  colspan=3><nobr>
				            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../images/button/btn_Clear.gif',1)"><img src="../../images/button/btn_Clear.gif" name="Image1" width="60" height="20" border="0" align="absmiddle" onClick="fnc_Init()"></a>
					...
					<tr>
						<td width=50  class="blueBold"><nobr>&nbsp;고과자&nbsp;</nobr></td>
						<td width=150>
						...
						<td width=50 class="blueBold"><nobr>&nbsp;차수</nobr></td>
						<td width=150>
                    ...
                    <tr align="center">
                        <td colspan=4>
                            <comment id="__NSID__">
                            <object    id="grdT_EV_ABLRST2" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500px;height:440px;">
                                ...
                                <param name=ColSizing  				 value="true">
                                <param name="Format"                 value="
                                    <FC>id='CHKOUT'     		width=40   	name='제외'    		align=center    EditStyle=CheckBox  </FC>
                                    <FG>name='피고과자'    	HeadAlign=Center HeadBgColor=#dae0ee
	                                    <FC> id='EMPNO'    		width=70   	name='사번'   		align=center    	edit=none </FC>
	                                    <FC> id='EMPNMK'   		width=70  	name='성명'  		align=center      	edit=none </FC>
	                                </FG>
		                            <FG>name='고과자'    	HeadAlign=Center HeadBgColor=#dae0ee
	                                    <FC>id='EMPNMKH'    	width=70  	name='성명'     		align=center      	edit=none </FC>
	                                    <C>id='EVASEQ'   		width=60  	name='차수'      	align=center    	EditStyle=Combo  Data='1:1차,2:2차,3:3차'</C>
	                                    <C>id='DEPTNM'   		width=80  	name='소속'   		align=left    		edit=none </C>
	                                    <C>id='PAYGRDNM'    	width=70   	name='직위'      	align=center    	edit=none </C>
                                    </FG>
                                ">
                            </object>
                            </comment><script> __ShowEmbedObject(__NSID__); </script>
