    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
		        ...
		        //정보 조회
				dsT_EV_JOBTASK.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul015.cmd.VLUL015CMD&S_MODE=SHR_01&BASIC_YMD_SHR="+BASIC_YMD_SHR+"&ENO_NO="+ENO_NO;
			...
			******************************************************************************/
			function fnc_SetFormat(i){
				  	...
				  	gs_format +="<table  cellpadding=0 cellspacing=0 style=width:1000px;height:30px;font-size:9pt;background-color:#ffffff;>";
					gs_format +="	<tr>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		<textarea id=txt_1"+i+"   style=width:51px;height:100px;overflow:auto;font-size:20pt;text-align:center;vertical-align:center; readOnly></textarea>";
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		 <textarea id=txt_2"+i+" style=width:99px;height:100px;overflow:auto;ime-mode:active; maxlength=50 onBlur=bytelength(this,this.value,50);></textarea>";
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		 <textarea id=txt_3"+i+" style=width:150px;height:100px;overflow:auto;ime-mode:active; maxlength=1000 onBlur=bytelength(this,this.value,200);></textarea>";
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		 <textarea id=txt_4"+i+" style=width:399px;height:100px;overflow:auto;ime-mode:active;  maxlength=50   onBlur=bytelength(this,this.value,600);></textarea>";
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					...
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		 <textarea id=txt_6"+i+" style=width:100px;height:100px;text-align:center;overflow:auto;ime-mode:active; maxlength=50 onBlur=bytelength(this,this.value,4);></textarea>";
					gs_format +="		</td>";
					gs_format +="		<td style=height:105px;border:1 solid #708090>";
					gs_format +="		 <textarea id=txt_7"+i+" style=width:150px;height:100px;text-align:center;overflow:auto;ime-mode:active; maxlength=50 onBlur=bytelength(this,this.value,20);></textarea>";
					gs_format +="		</td>";
					gs_format +="	</tr>";
					gs_format +="</table>";
        ...
        function fnc_Save() {
            ...
            trT_EV_JOBSPEC.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul015.cmd.VLUL015CMD&S_MODE=SAV";
		...
		******************************************************************************************/
        ...
        function fnc_Print() {
        	...
        	dsT_EV_PRINT.namevalue(1,"TITLE")=" 개인별 JOB PROFILE";
...
<!-- 내용 조회 그리드 테이블 시작-->
<table id="table_1" value="" width="998" border="0" cellspacing="0" cellpadding="0">
</table>
<!-- 내용 조회 그리드 데이블 끝-->
...
<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=267 ,face='Arial' ,size=10 ,penwidth=1
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2339 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='소속명 (본부/팀)' ,left=241 ,top=90 ,right=1294 ,bottom=153 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
...
<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=264 ,face='Arial' ,size=10 ,penwidth=1
	...
	<L> left=71 ,top=265 ,right=1947 ,bottom=265 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='(%)' ,left=1508 ,top=230 ,right=1627 ,bottom=259 ,face='굴림' ,size=9 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='비중' ,left=1508 ,top=198 ,right=1627 ,bottom=228 ,face='굴림' ,size=9 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='난이도' ,left=1635 ,top=198 ,right=1752 ,bottom=262 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='발생빈도' ,left=1762 ,top=198 ,right=1942 ,bottom=262 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='과업 내용' ,left=664 ,top=198 ,right=1492 ,bottom=262 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='과업' ,left=328 ,top=198 ,right=654 ,bottom=262 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='직무' ,left=79 ,top=198 ,right=315 ,bottom=262 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=560 ,face='Arial' ,size=10 ,penwidth=1
	<L> left=1947 ,top=0 ,right=1947 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1500 ,top=0 ,right=1500 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1630 ,top=0 ,right=1630 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1757 ,top=0 ,right=1757 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<C>id='DEGREE', left=1635, top=130, right=1752, bottom=558, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='IMPORT', left=1508, top=130, right=1627, bottom=558, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='FREQUENCY', left=1762, top=124, right=1942, bottom=558, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true</C>
	<C>id='JOB', left=79, top=5, right=318, bottom=558, align='left', supplevel=1, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true</C>
	<L> left=71 ,top=0 ,right=323 ,bottom=0 ,supplevel=1 </L>
	<L> left=320 ,top=0 ,right=320 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=659 ,top=0 ,right=659 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<C>id='TASK', left=328, top=5, right=654, bottom=558, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true</C>
	<C>id='TASKDESC', left=664, top=5, right=1492, bottom=558, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true</C>
	<L> left=320 ,top=0 ,right=1947 ,bottom=0 </L>
	<L> left=71 ,top=0 ,right=71 ,bottom=560 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
</B>
