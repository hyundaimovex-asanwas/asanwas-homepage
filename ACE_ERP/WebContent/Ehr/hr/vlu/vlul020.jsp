		...
		******************************************************************************/
		...
		function fnc_Grid_Dblclick(row,col){
				...
				arrParam[0] = document.form1.txtREG_YM_SHR.value; //년월
			  	...
			  	arrParam[3] = document.form1.txtENOH_NO_SHR.value; //고과자
			  	arrParam[4] = document.form1.txtENOH_NM_SHR.value; //고과자
                        ...
                        <td>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:500px;height:550px;">
                                ...
                                <param name="Format"                 		value="
                                    ...
                                    <FC> id='DPT_CH_SCR2'   	width=50   	name='점수'      	align=center    edit=none sumbgcolor=#89add6   value={Round((DPT_CH_SCR),2)} dec=2  </FC>
