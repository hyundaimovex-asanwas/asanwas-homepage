    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
		  ...
		  dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul050.cmd.VLUL050CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
		  dsT_EV_ABLRST.reset();
        ...
        function fnc_SearchList2() {
		  ...
		  dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul050.cmd.VLUL050CMD&S_MODE=SHR_01&REG_YM_SHR="+REG_YM_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR+"&ENO_NOH="+ENO_NOH+"&EVA_SEQ="+EVA_SEQ;
				...
				if(fnc_Chk()){
					...
					if(fnc_Chk2()){
					  ...
					  if (confirm("저장하시겠습니까?")) {
			            ...
			            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul050.cmd.VLUL050CMD&S_MODE=SAV";
			            trT_EV_ABLRST.post();
						//	ln_Query2();
						}
					}
		...
		******************************************************************************/
        ...
        cfStyleGrid_New(form1.grdT_EV_ABLRST,15,"true","right");      // Grid Style 적용
       ...
       **********************/
        function fnc_EmplPopp() {
            ...
            obj.shr_kind = "SHR_01";
            obj.eno_nm = "";
            window.showModalDialog("../../../Ehr/common/popup/empl2.jsp", obj, "dialogWidth:500px; dialogHeight:440px; help:No; resizable:No; status:No; scroll:No; center:Yes;");
            ...
            <td class="paddingTop3">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                        <td>
                            <comment id="__NSID__">
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:490px;height:395px;">
                                ...
                                <param name="Format"                 	value="
                                    <FC> id='CHK'     		width=60   	name='선택' Edit=True  		align=center    EditStyle=CheckBox Pointer=Hand  Edit={IF(CHK='','false','true')}  HeadCheckShow=true sort=false</FC>
                                    <FG> name='피고과자'    HeadAlign=Center HeadBgColor=#dae0ee
	                                    <FC> id='EMPNO'    	width=60   	name='사번'   			align=left    	edit=none sort=true</FC>
	                                    <FC> id='EMPNMK'   	width=60  	name='성명'  			align=left      	edit=none sort=true</FC>
	                                </FG>
                                    <FC> id='DEPTNM'    width=90  	name='소속'     			align=left      sort=true</FC>
                                    <C> id='EMPNMK1'   	width=60  	name='1차;고과자'      	align=center    sort=false</C>
                                    <C> id='EMPNMK2'   	width=60  	name='2차;고과자'   		align=center    sort=false</C>
                                    <C> id='EMPNMK3'    width=60   	name='3차;고과자'      	align=center    sort=false</C>
                                ">
                            </object>
            ...
            <td class="paddingTop3">
                <table border="1" cellspacing="0" cellpadding="0">
                    ...
                    <tr align="center">
                        <td colspan=4>
                            <comment id="__NSID__">
                            <object    id="grdT_EV_ABLRST2" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:490px;height:340px;">
