    ...
    <script language="javascript" >
        ...
        function fnc_SearchList() {
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
		  	...
		  	if(GUBUN == "1"){ //정규직
		       	...
		       	dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
		       	
			}else if(GUBUN == "2"){ //PJT

		       	dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_PJT&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
		       	
		    }else if(GUBUN == "3"){ //팀장

		       	dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_DPT&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
	       	
		    }else if(GUBUN == "4"){ //현장소장

		       	dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_CON&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.reset();
        ...
        function fnc_SearchList2() {
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
			...
			if(document.form1.txtREG_YM_SHR.value !="2016-11"){
				alert("2016년 11월만 실행 가능합니다.");
				return false;
			}
            ...
            dsT_EV_ABLRST.ClearData();
		  	...
		  	if(GUBUN == "1"){ //정규직
		       	...
		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_02&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();
		       	
			}else if(GUBUN == "2"){ //PJT

		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_02_PJT&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();
		       	
			}else if(GUBUN == "3"){ //팀장

		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_02_DPT&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();
		       	
			}else if(GUBUN == "4"){ //현장소장

		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_02_CON&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();		
        ...
        function fnc_Save() {
			...
			if (dsT_EV_ABLRST.countrow<1){
				...
				if (confirm("저장하시겠습니까?")) {
		            ...
		            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SAV";
		            trT_EV_ABLRST.post();
				}
			}
        }
          ...
          var GUBUN 	= "";
			...
			//직급별 등급 인원수
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_04&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();

			}else if(GUBUN == "2"){ //PJT    
				
			    dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_04_PJT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();
			    
			}else if(GUBUN == "3"){ //팀장    
				
			    dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_04_DPT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();
			    
			}else if(GUBUN == "4"){ //현장소장    
				
			    dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_04_CON&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();
			...
			//직급별 rank
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_06&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();

	        }else if(GUBUN == "2"){ //PJT
	        	
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_06_PJT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();
			
			}else if(GUBUN == "3"){ //부서장
				
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_06_DPT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();
			    
			}else if(GUBUN == "4"){ //현장소장
				
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SHR_06_CON&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();
		    ...
		    if (confirm(document.form1.txtREG_YM_SHR.value+"의 등급생성을 하시겠습니까?")) {
	            ...
	            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SAV_GRD";
	            trT_EV_ABLRST.post();
    ...
    <Script For=dsT_EV_ABLRST2 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
			...
			if (confirm("실행하신 정보를 저장하시겠습니까?")) {
	            ...
	            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.l.vlul060.cmd.VLUL060CMD&S_MODE=SAV_EXE";
	            trT_EV_ABLRST.post();
		                    ...
		                    <col width="*"></col>
		               		...
		               		<tr>
                                ...
                                <td class="padding2423" style="width:300" >
                                    ...
                                    <input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" style="margin-bottom:-2px;border:0;" value="2" onClick="JavaScript: {fnc_SearchList();}">팀장
                                    <input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" style="margin-bottom:-2px;border:0;" value="3" onClick="JavaScript: {fnc_SearchList();}">현장소장                                                                        
                                    </fieldset>
                                </td>
