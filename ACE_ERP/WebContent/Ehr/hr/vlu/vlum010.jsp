    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			// 업적 평가 의견 조회
			dsT_EV_EQSCORE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.m.vlum010.cmd.VLUM010CMD"
												     + "&S_MODE=SHR_01"
			...
			// 역량 평가 의견 조회			
			dsT_EV_COMMENT.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.m.vlum010.cmd.VLUM010CMD"
												     + "&S_MODE=SHR_02"
												     + "&REG_YM_SHR="+REG_YM_SHR
												     + "&ENO_NO="+ENO_NO
		     										 + "&EVA_SEQ="+EVA_SEQ;   
			...
			// 최종 평가 결과 조회
			dsT_EV_TOTAL.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.m.vlum010.cmd.VLUM010CMD"
												     + "&S_MODE=SHR_03"
												     + "&REG_YM_SHR="+REG_YM_SHR
												     + "&ENO_NO="+ENO_NO;
