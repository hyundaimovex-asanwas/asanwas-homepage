	<!--*************************************************************************
	* @source      : vluo071.jsp												*
	* @description : 면담일지 파일관리(업로드용) PAGE                           *
	*****************************************************************************
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_OnLoadProcess() {
            ...
            fnc_ConstructCommonCode("dsT_CM_COMMON_Q3", "cmbMEET_GBN","","선 택");   //면담사유 구분 콤보박스
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">면담일지 파일관리</td>
				</tr>
			</table>
			</td>
		</tr>
