    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
          ...
          if(document.form1.rdoGBN_SHR[0].checked){
		  	...
		  	if(GUBUN == "1"){ //정규직
		       	...
		       	//dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		  		dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR&REG_YM_SHR="+REG_YM_SHR;
			  	dsT_EV_ABLRST.reset();
		       	
			}else if(GUBUN == "2"){ //PJT

		       	//dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_PJT&REG_YM_SHR="+REG_YM_SHR+"&GOGA1="+GOGA1+"&JOB_CD_FROM="+JOB_CD_FROM+"&JOB_CD_TO="+JOB_CD_TO;
		       	dsT_EV_ABLRST.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_PJT&REG_YM_SHR="+REG_YM_SHR;
				dsT_EV_ABLRST.reset();
          ...
          */
            ...
            /*
		  	if(GUBUN == "1"){ //정규직
		       	...
		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_02&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();

			}else if(GUBUN == "2"){ //PJT

		       	dsT_EV_ABLRST2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_02_PJT&REG_YM_SHR="+REG_YM_SHR;
		       	dsT_EV_ABLRST2.reset();
        ...
        function fnc_Save() {
			...
			if (dsT_EV_ABLRST.countrow<1){
				...
				if (confirm("저장하시겠습니까?")) {
		            ...
		            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SAV";
		            //prompt(this, dsT_EV_ABLRST.text);
		            trT_EV_ABLRST.post();
				}
			}
        }
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_EV_ABLRST.GridToExcel("고과점수확인", '', 225);
		...
		*/
			...
			//직급별 등급 인원수
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_04&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();

			}else if(GUBUN == "2"){ //PJT    
				
			    dsT_EV_GRADE.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_04_PJT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE.reset();
			...
			//직급별 rank
		  	if(GUBUN == "1"){ //정규직
			 	...
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_06&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();

	        }else if(GUBUN == "2"){ //PJT
	        	
			 	dsT_EV_GRADE2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SHR_06_PJT&REG_YM_SHR="+REG_YM_SHR;
			    dsT_EV_GRADE2.reset();
			...
			*/
		    ...
		    if (confirm(document.form1.txtREG_YM_SHR.value+"의 등급생성을 하시겠습니까?")) {
	            ...
	            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SAV_GRD";
	            trT_EV_ABLRST.post();
    ...
    <Script For=dsT_EV_ABLRST2 Event="OnLoadCompleted(iCount)">
        ...
        if (iCount < 1)    {
			...
			if (confirm("실행하신 정보를 저장하시겠습니까???")) {
	            ...
	            trT_EV_ABLRST.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.vlu.o.vluo080.cmd.VLUO080CMD&S_MODE=SAV_EXE";
	            //prompt(this, dsT_EV_ABLRST2.text);
	            trT_EV_ABLRST.post();
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <!--  
            ...
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../images/button/btn_SaveOver.gif',1)"><img src="../../images/button/btn_SaveOn.gif" name="Image4" width="60" height="20" border="0" align="absmiddle" onClick="fnc_Save()">            
		               ...
		               <colgroup>
		                    ...
		                    <col width="*"></col>
		               		...
		               		<tr>
								...
								<td>
		                        <select id="cmbJOB_CD_FROM" style="width:80px;" onChange="">
		                        </select>
		                        &nbsp;~&nbsp;
		                        <select id="cmbJOB_CD_TO" style="width:80px;" onChange="">
		                        </select>
				                </td>
                    ...
                    <tr align="center">
                        <td>
                            ...
                            <object    id="grdT_EV_ABLRST" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:500px;">
                                ...
                                <param name="Format"                 value="
                                    ...
                                    <FC> id='EMPNO'     width=60   	name='사번'    		align=center    edit=none </FC>
                                    <FC> id='HEAD_NM'   width=80    name='본부'   		align=center  	edit=none </FC>                                    
                                    <FC> id='DEPTNM'    width=80    name='소속'   		align=center  	edit=none </FC>
                                    <FC> id='GRDNM'    	width=60   	name='직위'   		align=center    edit=none </FC>
                                    <FC> id='EMPNMK'   	width=60  	name='피고;과자'  	align=center    edit=none </FC>
                                    
								<G> Name='1차' HeadAlign=Center HeadBgColor=#dae0ee                                    
                                    <C> id='EMPNMH_1'   width=60  	name='고과자'   		align=center    edit=none </C>
                                    <C> id='SCR1'   	width=50  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG1'   	width=50  	name='보정'   		align=center    edit=none </C>
                                </G>              
                                                      
								<G> Name='2차' HeadAlign=Center HeadBgColor=#dae0ee                                     
                                    <C> id='EMPNMH_2'   width=60  	name='고과자'   		align=center    edit=none </C>
                                    <C> id='SCR2'   	width=50  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG2'   	width=50  	name='보정'   		align=center    edit=none </C>
                                </G>                                    

								<G> Name='3차' HeadAlign=Center HeadBgColor=#dae0ee                                     
                                    <C> id='EMPNMH_3'   width=60  	name='고과자'   		align=center    edit=none </C>
                                    <C> id='SCR3'   	width=50  	name='점수'      	align=center    edit=none </C>
                                    <C> id='AVG3'   	width=50  	name='보정'   		align=center    edit=none </C>
                                </G>  

								<G> Name='평균' HeadAlign=Center HeadBgColor=#dae0ee
                                    <C> id='SCRAVG'     width=60   	name='고과'      	align=center    edit=none show=false</C>
                                    <C> id='CORAVG'     width=60   	name='보정1'   		align=center    edit=none show=false</C>
                                </G>
                                
                                    <C> id='FINAL_SCR'     width=50   	name='최종;조정'    align=center    bgcolor='#F5F6CE' </C>
                                    <C> id='GRADE'      width=50   	name='등급'   		align=center    edit=none bgcolor='#F5D0A9' </C>
					 ...
					 <tr>
							<td> <P>&nbsp;&nbsp;* 실&nbsp;&nbsp;&nbsp;&nbsp;행 : 보정평균 점수를 최종 조정에 업데이트함.<BR>
							        ...
							        &nbsp;&nbsp;* 실행 및 등급 생성 버튼을 정규직, PJT, 팀장, 현장소장 각각 한 번만 적용하면 됩니다.<BR>
