    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			dsT_WL_MOVEAPPLY.dataid = "/servlet/GauceChannelSVL?cmd=hr.wel.a.wela030.cmd.WELA030CMD&S_MODE=SHR&STR_YMD="+str_ymd+"&END_YMD="+end_ymd+"&DPT_CD="+dpt_cd+"&ENO_NO="+eno_no;
        ...
        function fnc_Print() {
	        ...
	        var url = "wela030_PV.jsp?STR_YMD="+str_ymd+"&END_YMD="+end_ymd;
		...
		<td height="25" background="/images/common/barBg.gif">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">이주비 지원현황</td>
					<td align="right" class="navigator">HOME/복리후생/이주비/<font color="#000000">이주비 지원현황</font></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grdT_WL_MOVEAPPLY" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:400px;">
							...
							<param name="Format"					value="
								...
								<C> id='RAREA_NM'	width=110	name='발령前;근무지'		align=center </C>
								<C> id='MAREA_NM'	width=110	name='발령後;근무지'		align=center </C>
								...
								<C> id='RPLACE'		width=110	name='출발지'		align=left </C>
								<C> id='MPLACE'		width=110	name='도착지'		align=left </C>
								<C> id='MOVE_AMT'	width=70	name='지원금액'		align=right </C>
								<C> id='REMARK'		width=90	name='비고'			align=left </C>
							">
						</object>
