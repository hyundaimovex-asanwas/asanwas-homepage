...
<script language="javascript" >
        ...
        function fnc_SearchList() {
			...
			try {
	            dsT_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.wel.d.weld010.cmd.WELD010CMD&S_MODE=SHR&COMM_CD="+f.txtCOMM_CD_SHR.value;
	            dsT_CM_COMMON.Reset();
        ...
        function fnc_Save() {
			...
			if(fnc_SaveItemCheck()) {
				...
				tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.wel.d.weld010.cmd.WELD010CMD&S_MODE=SAV";
        ...
        function fnc_Delete() {
			...
			tr01T_CM_COMMON.KeyValue = "SVL(I:ds01T_CM_COMMON=ds01T_CM_COMMON)";
			tr01T_CM_COMMON.action = "/servlet/GauceChannelSVL?cmd=hr.wel.d.weld010.cmd.WELD010CMD&S_MODE=DEL";
			tr01T_CM_COMMON.post();
        }
    ...
    **************************************-->
    ...
    <Script For=ds01T_CM_COMMON Event="OnDataError()">
        ...
        if (this.ErrorCode == 50018) {
	        alert("해당 필수입력항목[코 드] 입력 후 다음 작업이 가능합니다.");
        }
        else if (this.ErrorCode == 50019) {
	        alert("코드에 대한 중복값이 존재합니다. 확인바랍니다.");
        }
        else {
		    cfErrorMsg(this);
	    }
	...
	<script for=grdT_CM_COMMON event=OnClick(Row,Colid)>
		...
		if(Row < 1) {
			...
			try {
				ds01T_CM_COMMON.DataID = "/servlet/GauceChannelSVL?cmd=hr.wel.d.weld010.cmd.WELD010CMD&S_MODE=SHR_01&"+overId+"="+overValue;
				ds01T_CM_COMMON.Reset();
        ...
        <td height="25" background="/images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">콘도공통코드관리</td>
                    <td align="right" class="navigator">HOME/복리후생/콘도/<font color="#000000">콘도공통코드관리</font></td>
                </tr>
            </table>
        </td>
    </tr>
