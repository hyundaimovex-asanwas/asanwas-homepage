...
<%
	...
	String CN_CD     	= request.getParameter("CN_CD");
	String RSV_GBN	= request.getParameter("RSV_GBN");
	String RST_GBN	= request.getParameter("RST_GBN");
	String SEASON_GBN	= request.getParameter("SEASON_GBN");
...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="weld030.hnw">
              <param name="initvalue" VALUE="[:STR_YMD]=<%=STR_YMD%>[:END_YMD]=<%=END_YMD%>[:CN_CD]=<%=CN_CD%>[:RSV_GBN]=<%=RSV_GBN%>[:RST_GBN]=<%=RST_GBN%>[:SEASON_GBN]=<%=SEASON_GBN%>">
