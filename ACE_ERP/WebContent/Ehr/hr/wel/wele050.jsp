...
<html>
<head>
    <title>월별식당이용현황(개인별)(wele050)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            dsT_WL_DININGUSE.dataid = "/servlet/GauceChannelSVL?cmd=hr.wel.e.wele020.cmd.WELE020CMD&S_MODE=SHR&STR_YMD_SHR="+STR_YMD_SHR+"&END_YMD_SHR="+END_YMD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
        ...
        function fnc_OnLoadProcess() {
            ...
            //차후 사번 검색 기능을 넣기 위해 만들어 놓음 (기본적으로 로그인한사번)
    ...
    ***************************************************************************************-->
    ...
    <script language=JavaScript for=medMRN_UNI event=onKillFocus()>
    ...
    <script language=JavaScript for=medAFN_UNI event=onKillFocus()>
    ...
    <script language=JavaScript for=medEVN_UNI event=onKillFocus()>
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">월별식당이용현황(개인별)</td>
                    <td align="right" class="navigator">HOME/복리후생/식당코드/<font color="#000000">월별식당이용현황(개인별)</font></td>
                </tr>
            </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                ...
                <tr>
                    ...
                    <td class="padding2423"><input id="txtENO_NO" name="txtENO_NO" size="12" class="input_ReadOnly" readonly></td>
                    <td align="center" class="creamBold">성&nbsp;&nbsp;명</td>
                    <td class="padding2423"><input id="txtENO_NM" name="txtENO_NM" size="12" class="input_ReadOnly" readonly></td>
                    ...
                    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                        ...
                        <tr>
                            ...
                            <table width="100%" border="0" >
                                <tr>
                                    <td width="90%">
                                        <comment id="__NSID__"><object id="medMRN_UNI" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%" enable="false" class="input_ReadOnly">
                        ...
                        <tr>
                            ...
                            <table width="100%" border="0" >
                                <tr>
                                    <td width="90%">
                                        <comment id="__NSID__"><object id="medAFN_UNI" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%" enable="false" class="input_ReadOnly">
                                            <param name=Alignment               value=2>
                                            <param name=Border                  value=true>
                                            <param name=ClipMode                value=true>
                                            <param name=DisabledBackColor       value="#EEEEEE">
                        ...
                        <tr>
                            ...
                            <table width="100%" border="0" >
                                <tr>
                                    <td width="90%">
                                        <comment id="__NSID__"><object id="medEVN_UNI" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%" enable="false" class="input_ReadOnly">
                                            <param name=Alignment               value=2>
                                            <param name=Border                  value=true>
                                            <param name=ClipMode                value=true>
                                            <param name=DisabledBackColor       value="#EEEEEE">
