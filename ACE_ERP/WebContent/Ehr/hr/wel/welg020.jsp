    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_ToExcel() {
            ...
            form1.grdVI_T_CM_PERSON.GridToExcel("기념일현황", '', 225);
        }
  ...
  //      	document.form1.txtWED_YMD_SHR.value   = "";
        ...
        function fnc_ChangeHeader() {
            ...
            if(chk_val == "0") {
                ...
                oGrid.Format= "<C> id='DPT_NM'     width=100   name='소속'             align=left          Edit=none       LeftMargin=5</C>        "
                            ...
                            + "<C> id='ZIP_NO'     width=55    name='우편번호'         align=center        Edit=none</C>                            "
                            + "<C> id='ADDRESS'    width=350   name='주소'             align=left          Edit=none       LeftMargin=10</C>        "
                            + "<C> id='BIR_YMD'    width=100   name='생년월일'         align=center        Edit=none</C>                            "
                            + "<C> id='S_BIR'      width=100   name='양력기준'         align=center        Edit=none       show = false</C>                            "
                            + "<C> id='EM_PHN_NO'  width=100   name='핸드폰번호'       align=center        Edit=none</C>                            ";

            } else if(chk_val == "1") {
                oGrid.Format= "<C> id='DPT_NM'     width=100   name='소속'             align=left          Edit=none       LeftMargin=10</C>        "
                            + "<C> id='JOB_NM'     width=50    name='직위'             align=center        Edit=none</C>                            "
                            + "<C> id='ENO_NO'     width=60    name='사번'             align=center        Edit=none</C>                            "
                            + "<C> id='ENO_NM'     width=60    name='성명'             align=center        Edit=none</C>                            "
                            + "<C> id='ZIP_NO'     width=55    name='우편번호'         align=center        Edit=none</C>                            "
                            + "<C> id='ADDRESS'    width=350   name='주소'             align=left          Edit=none       LeftMargin=10</C>        "
                            + "<C> id='WED_YMD'    width=100   name='결혼일'           align=center        Edit=none</C>                            "
                            + "<C> id='WED_NM'     width=70    name='배우자성명'       align=center        Edit=none</C>                            "
                            + "<C> id='EM_PHN_NO'  width=100   name='핸드폰번호'       align=center        Edit=none</C>                            ";
                ...
                oGrid.Format= "<C> id='DPT_NM'     width=100   name='소속'             align=left          Edit=none       LeftMargin=10</C>                                    "
                            ...
                            + "<C> id='LSE_YY'     width=60    name='근속년수'         align=center        Edit=none</C>                                                        "
                            + "<C> id='ZIP_NO'     width=55    name='우편번호'         align=center        Edit=none</C>                                                        "
                            + "<C> id='ADDRESS'    width=350   name='주소'             align=left          Edit=none       LeftMargin=10</C>                                    "
                            + "<C> id='EM_PHN_NO'  width=100   name='핸드폰번호'       align=center        Edit=none</C>                                                        ";
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">기념일현황</td>
					<td align="right" class="navigator">HOME/복리후생/<font color="#000000">기념일현황</font></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
                    ...
                    <td class="searchState" align="right">
                        <input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" value="2" checked style="margin-bottom:-2px;border:0;" onClick="changeInput()">입사월<br>
                    </td>
                    <td class="padding2423" align="left">
                        <input type="text" id="txtHIR_YMD_SHR" style="ime-mode:disabled" size="4" maxlength="2">&nbsp;월
                    </td>
					<td class="searchState" align="right">
						<input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" value="0"  style="margin-bottom:-2px;border:0;" onClick="changeInput()">생일<br>
					</td>
					<td class="padding2423" align="left">
					...
					<td class="searchState" align="right">
						<input type="radio" name="rdoGBN_SHR" id="rdoGBN_SHR" value="1" style="margin-bottom:-2px;border:0;" onClick="changeInput()">결혼기념일<br>
					</td>
					<td class="padding2423" align="left">
						<input type="text" id="txtWED_YMD_SHR" style="ime-mode:disabled" size="4" maxlength="2">&nbsp;월
					</td>
				</tr>
			</table>
			</td>
				...
				<tr align="center">
					...
					<object id="grdVI_T_CM_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
						...
						<param name="Format" value='
							...
							<C> id="LSE_YY"		width=60	name="근속년수"		align=center	Edit=none </C>
							<C> id="ZIP_NO"		width=55	name="우편번호"		align=center	Edit=none </C>
							<C> id="ADDRESS"	width=250	name="주소"			align=left		Edit=none	LeftMargin=10</C>
							<C> id="WED_TAG"	width=50	name="결혼여부"		align=center	Edit=none   value={decode(WED_TAG, "Y", "기혼", "미혼")}</C>
							<C> id="WED_NM"		width=70	name="배우자성명"   align=center	Edit=none </C>
