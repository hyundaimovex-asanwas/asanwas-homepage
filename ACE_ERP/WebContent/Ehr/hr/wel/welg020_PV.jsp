...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="welg010.hnw">
              <param name="initvalue" VALUE="[:GBN_SHR]=<%=GBN_SHR%>[:BIR_YMD_SHR]=<%=BIR_YMD_SHR%>[:WED_YMD_SHR]=<%=WED_YMD_SHR%>[:HIR_YMD_SHR]=<%=HIR_YMD_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>">
