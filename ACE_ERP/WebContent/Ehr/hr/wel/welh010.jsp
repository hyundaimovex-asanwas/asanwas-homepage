	<!--*************************************************************************
	* @source      : welh010.jsp												*
	* @description : 차량유지비/교통비/중식비  PAGE									*
	*****************************************************************************
...
<html>
<head>
	<title>차량유지비 교통비 중식비(welh010)</title>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			dsT_WL_CTLNBOOK.dataid = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh010.cmd.WELH010CMD&S_MODE=SHR&PIS_YY_SHR="+PIS_YY_SHR+"&PIS_MM_SHR="+PIS_MM_SHR+"&GBN2_TAG_SHR="+GBN2_TAG_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&FLAG_SHR="+FLAG_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
        ...
        function fnc_Save() {
			...
			trT_WL_CTLNBOOK.action = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh010.cmd.WELH010CMD&S_MODE=SAV";
        ...
        function fnc_Delete() {
            ...
            if (confirm("[" + dsT_WL_CTLNBOOK.ColumnString(dsT_WL_CTLNBOOK.RowPosition,15) + "] 자료를 제거하시겠습니까?") == false) return;
            dsT_WL_CTLNBOOK.DeleteRow(dsT_WL_CTLNBOOK.RowPosition);

			trT_WL_CTLNBOOK.KeyValue = "tr01(I:dsT_WL_CTLNBOOK=dsT_WL_CTLNBOOK)";
			trT_WL_CTLNBOOK.action = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh010.cmd.WELH010CMD&S_MODE=DEL";
			trT_WL_CTLNBOOK.post();
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_WL_CTLNBOOK.GridToExcel("차량유지비/교통비/중식비", '', 225)
        }
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid(form1.grdT_WL_CTLNBOOK,15,"true","false");      // Grid Style 적용
        ...
        function fnc_Create(){
            ...
            dsT_WL_CTLNBOOK.DataId = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh010.cmd.WELH010CMD&S_MODE=INS_01&PIS_YY_SHR="+PIS_YY_SHR+"&PIS_MM_SHR="+PIS_MM_SHR
            dsT_WL_CTLNBOOK.Reset();
        }
    ...
    ***************************************************************************************-->
	...
	<Script For=dsT_WL_CTLNBOOK Event="OnLoadCompleted(iCount)">
		if (iCount == 0)    {
			...
			//dsT_WL_CTLNBOOK.NameValue(iCount, "ENO_NM") = (iCount-1)+"명";
	...
	<Script For=dsT_WL_CTLNBOOK_01 Event="OnLoadCompleted(iCount)">
		if (iCount == 0)    {
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">차량유지비 교통비 중식비</td>
					<td align="right" class="navigator">HOME/복리후생/<font color="#000000">차량유지비 교통비 중식비</font></td>
				</tr>
			</table>
			</td>
		</tr>
	        ...
	        <td class="paddingTop8">
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
					...
					<tr>
						...
						<td align="center" class="creamBold">비과세</td>
						<td class="padding2423">
					...
					<tr>
						<td align="center" class="creamBold">교통비</td>
						<td class="padding2423">
						...
						<td align="center" class="creamBold">조식대공제액</td>
						<td class="padding2423">
							<comment id="__NSID__"><object id="medDEL1_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100">
								<param name=Alignment				value=2>
								<param name=Border					value=true>
								<param name=ClipMode				value=true>
								<param name=DisabledBackColor		value="#EEEEEE">
	...
	<table width="800" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="paddingTop5">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top" class="searchState" width="570"><span id="resultMessage">&nbsp;</span></td>
						<td align="right" class="searchState">
							...
							<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('imgPIS_YM','','/images/button/btn_HelpOver.gif',1)" onclick="calendarBtn('datetype2','txtPIS_YM','','154','116');"><img src="/images/button/btn_HelpOn.gif" name="imgPIS_YM" width="21" height="20" border="0" align="absmiddle"></a>
						</td>
				...
				<tr align="center">
					...
					<object id="grdT_WL_CTLNBOOK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
						...
						<param name="Format" value='
							...
							<FC> id="DPT_NM"		width="95"		name="소속"				align="left"	Edit=none		LeftMargin="10"	 SubBgColor="#99FFCC"	subsumtext="합   계"</FC>
							<FC> id="OCC_CD"		width="70"		name="근로구분구분"			align="center"	Edit=none		Show="false"</FC>
							<FC> id="JOB_CD"		width="40"		name="직위코드"			align="center"	Edit=none		Show="false"</FC>
							<FC> id="JOB_NM"		width="50"		name="직위"				align="center"	Edit=none 		SubBgColor="#99FFCC"</FC>
							...
							<C> id="NO_TAX"		width="75"		name="비과세"				align="right"	Edit=none	RightMargin="10" SubBgColor="#99FFCC"</C>
							<C> id="CAR_AMT"	width="75"		name="차량유지비"			align="right"	Edit=none	RightMargin="10" SubBgColor="#99FFCC"</C>
							<C> id="TRA_AMT"	width="75"		name="교통비"				align="right"	Edit=none	RightMargin="10" SubBgColor="#99FFCC"</C>
							<G> name="중  식  대"  HeadBgColor="#F7DCBB"
								<C> id="LUN_AMT"	width="75"	name="중식대"				align="right"	Edit=none	RightMargin="10" SubBgColor="#99FFCC"</C>
								<C> id="DEL1_AMT"	width="80"	name="조식대공제액"		align="right"	Edit=none		RightMargin="10" SubBgColor="#99FFCC"</C>
								<C> id="DEL2_AMT"	width="80"	name="중식대공제액"		align="right"	Edit=none		RightMargin="10" SubBgColor="#99FFCC"</C>
								<C> id="SUM_AMT"	width="80"	name="중식대지급액"		align="right"	Edit=none		RightMargin="10" SubBgColor="#99FFCC"	value="{(LUN_AMT-DEL1_AMT-DEL2_AMT)}"</C>
							</G>
							<C> id="TOT_AMT"	width="90"		name="합계"				align="right"	Edit=none		RightMargin="10" SubBgColor="#99FFCC"	value={(CAR_AMT+TRA_AMT+(LUN_AMT-DEL1_AMT-DEL2_AMT))}</C>
						'>
					</object>
