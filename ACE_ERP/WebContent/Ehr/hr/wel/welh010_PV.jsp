...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="welh010.hnw">
              <param name="initvalue" VALUE="[:PIS_YY_SHR]=<%=PIS_YY_SHR%>[:PIS_MM_SHR]=<%=PIS_MM_SHR%>[:GBN_CD_SHR]=<%=GBN_CD_SHR%>[:JOB_CD_SHR]=<%=JOB_CD_SHR%>[:DPT_CD_SHR]=<%=DPT_CD_SHR%>[:ENO_NO_SHR]=<%=ENO_NO_SHR%>">
