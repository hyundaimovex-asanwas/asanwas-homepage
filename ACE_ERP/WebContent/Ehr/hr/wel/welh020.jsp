    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
            ...
            dsT_WL_CTLNBOOK.dataid = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh020.cmd.WELH020CMD&S_MODE=SHR&PIS_YY_SHR="+PIS_YY_SHR+"&PIS_MM_SHR="+PIS_MM_SHR+"&GBN2_TAG_SHR="+JOB_CD_SHR+"&DPT_CD_SHR="+DPT_CD_SHR+"&JOB_CD_SHR="+JOB_CD_SHR+"&FLAG_SHR="+FLAG_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
        ...
        function fnc_Save() {
            ...
            trT_WL_CTLNBOOK.action = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh020.cmd.WELH020CMD&S_MODE=SAV";
        ...
        function fnc_Delete() {
            ...
            trT_WL_CTLNBOOK.KeyValue = "tr01(I:dsT_WL_CTLNBOOK=dsT_WL_CTLNBOOK)";
            trT_WL_CTLNBOOK.action = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh020.cmd.WELH020CMD&S_MODE=DEL";
            trT_WL_CTLNBOOK.post();
        ...
        function fnc_DeleteAll() {
            ...
            trT_WL_CTLNBOOK.KeyValue = "tr01(I:dsT_WL_CTLNBOOK=dsT_WL_CTLNBOOK)";
            trT_WL_CTLNBOOK.action = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh020.cmd.WELH020CMD&S_MODE=INIT&PIS_YY_SHR="+PIS_YY_SHR+"&PIS_MM_SHR="+PIS_MM_SHR;
            trT_WL_CTLNBOOK.post();
        ...
        function fnc_OnLoadProcess() {
			...
			document.getElementById("resultMessage").innerText = '교통비/중식대 기준: 연봉테이블. > 중식대 공제 처리만 가능';
            fnc_DisableElementAll(elementList);
        }
         ...
         ****************************/
         function fnc_FileUpload() {
            ...
            if(dsFILE_UPLOAD.NameValue(1, "FILE_URL") != ""){
                ...
                trFILE_UPLOAD.action   = "/servlet/GauceChannelSVL?cmd=hr.wel.h.welh020.cmd.WELH020CMD&S_MODE=SHR_03";
                trFILE_UPLOAD.post();
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">교통비/중식비 산정</td>
                    <td align="right" class="navigator">HOME/복리후생/<font color="#000000">교통비/중식비 산정</font></td>
                </tr>
            </table>
            </td>
        </tr>
                ...
                <tr align="center">
                    ...
                    <object id="grdT_WL_CTLNBOOK" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:300px;">
                        ...
                        <param name="Format" value='
                            ...
                            <C> id="NO_TAX"     width="75"      name="비과세"               show="false" align="right"  Edit=none   RightMargin="10" SubBgColor="#99FFCC"</C>
                            ...
                            <G> name="중  식  대"  HeadBgColor="#F7DCBB"
                                ...
                                <C> id="SUM_AMT"    width="80"  name="중식대지급액"     align="right"   Edit=none       RightMargin="10" SubBgColor="#99FFCC"   value="{(LUN_AMT-DEL2_AMT)}"</C>
                            </G>
                            <C> id="TOT_AMT"    width="90"      name="합계"             align="right"   Edit=none       RightMargin="10" SubBgColor="#99FFCC"   value={(TRA_AMT+(LUN_AMT-DEL2_AMT))}</C>
                        '>
                    </object>
