	<!--*************************************************************************
	* @source      : welj011.jsp												*
	* @description : 통근버스신청목록 PAGE											*
	*****************************************************************************
	* DATE            AUTHOR        DESCRIPTION									*
	*----------------------------------------------------------------------------			*
	* 2009/12/18            권혁수                      통근버스신청목록최초작성
	***********************************************************************--*-->
...
<head>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			trT_WL_BUSAPP.KeyValue = "tr05(O:dsT_WL_BUSAPP=dsT_WL_BUSAPP)";
			trT_WL_BUSAPP.action = "/servlet/GauceChannelSVL?cmd=hr.wel.j.welj010.cmd.WELJ010CMD"
                                   + "&S_MODE=SHR_LST"
                                   + "&PIS_YYMM="+STR_YM_SHR;
			trT_WL_BUSAPP.post();
        }
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_WL_BUSAPP.GridToExcel("통근버스신청목록", '', 225);
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_WL_BUSAPP,15,"true","false");      // Grid Style 적용
    ...
    ***************************************************************************************-->
	...
	<!-----------------------------------------------------+
    | 1. 조회 및 저장용 DataSet								   |
    | 2. 이름은 ds_ + 주요 테이블명(dsT_WL_BUSAPP)			 	   |
    | 3. 사용되는 Table List(dsT_WL_BUSAPP) 				 	   |
    +------------------------------------------------------>
    ...
    ***************************************************************************************-->
    ...
    +------------------------------------------------------>
	<script for=trsT_WL_BUSAPP event="OnSuccess()">
    ...
    +------------------------------------------------------>
	<script for=trsT_WL_BUSAPP event="OnFail()">
        cfErrorMsg(this);
    </script>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">통근버스신청목록</td>
					<td align="right" class="navigator">HOME/복리후생/통근버스/<font color="#000000">통근버스신청목록</font></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
					<comment id="__NSID__">
					<object id="grdT_WL_BUSAPP" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:280px;">
						...
						<param name="Format" value='
                            ...
                            <C> id="PIS_YYMM"   width=70    name="신청년월"     align=center    Edit=none  show=false  </C>
							<C> id="LINE_NM"    width=50   name="노선"         align=center     Edit=none  </C>
							<C> id="STOP_LOC"    width=200   name="탑승지"       align=left     Edit=none  </C>
							<C> id="STOP_TIME"  width=100   name="탑승시간"     align=center    Edit=none   </C>
						'>
					</object>
