	<!--*************************************************************************
	* @source      : welk011.jsp												*
	* @description : 명함신청목록 PAGE											*
	*****************************************************************************
	* DATE            AUTHOR        DESCRIPTION									*
	*----------------------------------------------------------------------------			*
	* 2009/12/18            권혁수                      명함신청목록최초작성
	***********************************************************************--*-->
...
<head>
    ...
    ***************************************************************************************-->
	...
	<script language="javascript">
        ...
        function fnc_ToExcel() {
            ...
            form1.grdT_WL_CARD.GridToExcel("명함신청목록", '', 227);
        ...
        function fnc_OnLoadProcess() {
            ...
            cfStyleGrid(form1.grdT_WL_CARD,15,"true","false");      // Grid Style 적용
    ...
    ***************************************************************************************-->
	...
	<!-----------------------------------------------------+
    | 1. 조회 및 저장용 DataSet								   |
    | 2. 이름은 ds_ + 주요 테이블명(dsT_WL_CARD)			 	   |
    | 3. 사용되는 Table List(dsT_WL_CARD) 				 	   |
    +------------------------------------------------------>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td valign="top" background="/images/common/barGreenBg.gif" class="barTitle">명함신청목록</td>
					<td align="right" class="navigator">HOME/복리후생/명함/<font color="#000000">명함신청목록</font></td>
				</tr>
			</table>
			</td>
		</tr>
				...
				<tr align="center">
					...
					<object id="grdT_WL_CARD" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:280px;">
						...
						<param name="Format" value='
                            ...
                            <C> id="ENG_DPT_NM" width=100    name="영문소속"    align=center   show=false </C>
							<C> id="JOB_NM"		width=100	name="직위"			align=center	Edit=none    </C>
							<C> id="ENG_JOB_NM"	width=100	name="영문직위"		align=center	show=false    </C>
                            <C> id="ENO_NO"     width=70    name="사번"         align=center    Edit=none    </C>
                            <C> id="ENO_NM"     width=100    name="성명"        align=center    Edit=none    </C>
                            <C> id="NAM_ENG"    width=100    name="영문성명"    align=center    Edit=none show=false   </C>
                            <C> id="EMAIL"      width=200    name="이메일"      align=center    Edit=none </C>
                            <C> id="TEL"        width=100    name="전화번호"    align=center   show=false </C>
                            <C> id="MOBILE"     width=100    name="핸드폰"      align=center   show=false </C>
                            <C> id="FAX"        width=100    name="팩스"        align=center   show=false </C>
                            <C> id="ADDR"       width="300"    name="주소"      align=center   show=false </C>
                            <C> id="ENG_ADDR"   width="200"    name="영문주소"  align=center   show=false </C>
                            <C> id="REMARK"   width=200 name="비고"             align=center   show=false </C>
                            <C> id="END_TAG"  width=50  name="확인"             align=center   Edit=True EditStyle=CheckBox,Pointer=Hand HeadCheckShow=true </C>
						'>
					</object>
