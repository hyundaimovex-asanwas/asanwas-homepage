    ...
    *****************************-->
    <script language="javascript" >
        ...
        function fnc_SearchList() {
            ...
            dsT_WL_WELCARD.DataID = "../../../servlet/GauceChannelSVL?cmd=Ehr.wel.n.weln040.cmd.WELN040CMD&S_MODE=SHR&CON_YMD_SHR="+CON_YMD_SHR+"&ENO_NO_SHR="+ENO_NO_SHR;
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_WL_WELCARD,15,"false","false")      // Grid Style 적용
		...
		<td style="padding-top:2px;">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td>
						<comment id="__NSID__">
						<object	id="grdT_WL_WELCARD" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1000px;height:460px;">
							...
							<param name="Format"				value="
                                <FC> id='{currow}'           width=35    name='NO'           align=center    Edit=none   SubBgColor='#99FFCC'</FC>
								<FC> Name='본부'				ID=HEAD_NM	HeadAlign=Center HeadBgColor=#B9D4DC width=100 	align=left,    	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none, sort=true, suppress=2  Value={Decode(CurLevel,2,'본부계',9999,'총계',0,HEAD_NM)}</FC>
								<FC> Name='부서'				ID=DPT_NM		HeadAlign=Center HeadBgColor=#B9D4DC Width=100 	align=left,   	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none, sort=true , suppress=1 Value={Decode(CurLevel,1,'소계',0,DPT_NM)}</FC>
								<FC> Name='팀'				ID=TEAM_NM	HeadAlign=Center HeadBgColor=#B9D4DC Width=150 	align=left,	 	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none, sort=true </FC>
								<FC> Name='성명'				ID=ENO_NM		HeadAlign=Center HeadBgColor=#B9D4DC Width=70 	align=center,   bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none, sort=true </FC>
								<C> Name='승인일자'			ID=APPDT		HeadAlign=Center HeadBgColor=#B9D4DC Width=90 	align=center,  	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, edit=none,  Mask=XXXX-XX-XX, sort=true </C>
								<C> Name='사용액'			ID=REQAMT		HeadAlign=Center HeadBgColor=#B9D4DC Width=90 	align=Right,	 	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none,sort=true </C>
								<C> Name='가맹점'			ID=MEMBER		HeadAlign=Center HeadBgColor=#B9D4DC Width=180 	align=left,   	bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none,sort=true </C>
								<C> Name='구분'		      	ID=TAXGB		HeadAlign=Center HeadBgColor=#B9D4DC Width=60 	align=center,   bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none,EditStyle=Combo Data='N:과세,Y:비과세' sort=true </C>
								<C> Name='결제월'			ID=SETTDT		HeadAlign=Center HeadBgColor=#B9D4DC Width=80 	align=center,	 bgcolor={Decode(CurLevel,1,'#ffffcc',2,'#CCFFCC',9999,'#C3D0DB')}, Edit=none, Mask=XXXX-XX, sort=true </C>
							">
						</object>
