...
<head>
    ...
    <title>전산제출정산현황(yaca011_14)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_Save() {
            ...
            trT_AC_RETACC.action = dataClassName+"&S_MODE=SAV_14";
        ...
        function fnc_OnLoadProcess() {
        	...
        	cfStyleGrid_New(form1.grdT_AC_RETACC,0,"true","true");      // Grid Style 적용
...
<!-----------------------------------------------------+
    ...
    +------------------------------------------------------>
<script language="javascript" for=grdT_AC_RETACC event=OnDblClick(row,colid)>
        ...
        var ENO_NM = dsT_AC_RETACC.NameValue(dsT_AC_RETACC.RowPosition, "ENO_NM");
        
	    var href_page = "yaca020_15.jsp"
	                      + "?PIS_YY="+PIS_YY
                          + "&ENO_NO="+ENO_NO
                          + "&ENO_NM="+ENO_NM
	                      ;
	        
	   window.showModalDialog(href_page, "Modal", "dialogWidth:1100px; dialogHeight:800px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">연말정산제출현황</td>
                    <td align="right" class="navigator">HOME/정산세무/정산세무/<font color="#000000">연말정산제출현황</font></td>
                </tr>
            </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
                    <comment id="__NSID__">
                    <object id="grdT_AC_RETACC" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:1050px;height:500px;">
                        ...
                        <param name="Format" value='
                            ...
                            <C> id=DPT_NM        	width=120       align=center          	name="부서"           Edit="None"</C>
