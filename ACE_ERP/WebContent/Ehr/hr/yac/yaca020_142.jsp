...
* @description : 귀속2014년도 연말정산자료등록2 PAGE                       *
*****************************************************************************
...
<title>연말정산자료 재등록2(2014년도)</title>
        ...
        function fnc_Delete_01() {
         ...
         /* 03. 초기화 함수   */
          ...
          function fnc_RegFamily() {
            ...
            window.showModalDialog(href_page, "", "dialogWidth:660px; dialogHeight:820px; help:No; resizable:No; status:No; scroll:Yes; center:Yes;");
            fnc_SearchList_01();
           }
...
<Script For=dsT_AC_RETACC Event="OnLoadCompleted(iCount)">
        ...
        if (iCount == 0)    {
            ...
            //인사기록표 조회
            dsT_CM_PERSON.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca020.cmd.YACA020CMD&S_MODE=SHR2_142&ENO_NO="+document.getElementById("txtENO_NO_SHR").value;
            dsT_CM_PERSON.reset();
