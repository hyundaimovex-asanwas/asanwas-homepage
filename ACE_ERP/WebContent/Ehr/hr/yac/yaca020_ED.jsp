...
if (PIS_YYMM.length() > 4)
{
    ...
    String sql = XmlSqlUtils.getSQL("yac", "YACA020_PRT_2012");
    //param binding 하기
    ...
    /** 필드값 세팅 **/
   	...
   	String 	colStr  =   "PIS_YY,ENO_NO,ENO_NM,CET_NO,WORKDAY,HOL_YN,CLS_TAG,CHILD,LIN_AMT_NTS,LIN_AMT,MED_AMT_NTS,MED_AMT,EDU_AMT_NTS,EDU_AMT,CARD_AMT_NTS,CARD_AMT,DIR_CARD_AMT_NTS,DIR_CARD_AMT,SCH_AMT_NTS,SCH_AMT,CASH_AMT_NTS,CASH_AMT,MARKET_AMT_NTS,MARKET_AMT,GIBU_AMT_NTS,GIBU_AMT";   
