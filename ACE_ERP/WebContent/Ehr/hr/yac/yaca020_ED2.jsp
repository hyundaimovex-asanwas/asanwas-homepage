...
if (PIS_YYMM.length() > 4)
{
    ...
    String sql = XmlSqlUtils.getSQL("yac", "YACA020_PRT_2012_02");
    ...
    /** 필드값 세팅 **/
   	...
   	String 	colStr  =   "PIS_YY,ENO_NO,JAQ_AMT,JAR_AMT,JAH_AMT,JAP_AMT,NPEN_AMT,PEN_SUM_AMT,HEALTH_AMT,HINS_AMT,LIN_AMT,LIH_AMT,INS_SUM_AMT,MHEA_AMT,OHEA_AMT,HEA_SUM_AMT,GRA_AMT,TAG1_CNT,EDU_AMT1,TAG2_CNT,EDU_AMT2,TAG3_CNT,EDU_AMT3,TAG4_CNT,EDU_AMT4,HED_AMT,EDU_SUM_AMT,LH1_AMT,LH2_AMT,LH2_AMT04,LH3_AMT,LH4_AMT,LH5_AMT,LH6_AMT,LH7_AMT,LH8_AMT,LH_SUM_AMT,GOV_AMT,LC3_AMT,LC2_AMT,LC4_AMT,LC_SUM_AMT";   
