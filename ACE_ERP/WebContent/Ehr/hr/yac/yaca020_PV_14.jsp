<!--
***********************************************************************
* @source      : yaca020_PV_14.jsp
* @description : 2013년도 연말정산 소득공제 신고서 PAGE
***********************************************************************
...
function goclick(x) {
	...
	if(x=="Print_ALL"){
        ...
        if(!confirm("전체 인쇄는 1~4page 전체가 인쇄됩니다.")) {
        	return false;
        }
    ...
    <td bgcolor="#EAEAEA" valign="middle" align="left">
        ...
        <tr>
            <td width="">
                ...
                <input type="button" name="btnPRINT_ALL" value="전체인쇄" onclick="goclick('Print_ALL');"  style="background:white;cursor:hand" onmouseover="this.style.background='#EFEFE9'" onmouseout="this.style.background='white'">
...
<!--여기서부터 코딩입니다//-->
<comment id="__NSID__">
              <object id="aaa" classid="clsid:2E68BEE5-A640-11D2-AEA4-00AA006E5B34" width="1000" height="400" codebase="<%=hnwcodebase%>">
              <param name="hnwsrc"    VALUE="yaca020_14.hnw">
              <param name="initvalue" VALUE="[:ENO_NO]=<%=ENO_NO%>[:PIS_YYMM]=<%=PIS_YYMM%>[:PIS_YY]=<%=PIS_YYMM%>">
