...
<html>
<head>
    <title>부양가족등록(yaca022_2014년도)</title>
	...
	function fnfgnCheck(rrn) // 외국인등록번호유효성검사.
	{
         ...
         ********************************************/
  		function fnc_disableInput(){
            ...
            form1.txt2013_CARD_AMT.Enable = "false";    
            form1.txt2014_CARD_AMT.Enable = "false";
            form1.txt2013_CARD_OVER.Enable = "false";
            form1.txt2014_CARD_OVER.Enable = "false";            
        ...
        function fnc_changeBasManDisabled(){
            ...
            if(rel_cd == "3"){
                if(document.getElementById("chkBAS_MAN").checked == true){//배우자
                    ...
                    form1.txt2013_CARD_AMT.Enable = "true";    
                    form1.txt2014_CARD_AMT.Enable = "true";
                    form1.txt2013_CARD_OVER.Enable = "true";
                    form1.txt2014_CARD_OVER.Enable = "true";                          
                    ...
                    form1.txt2013_CARD_AMT.text =  0;    
                    form1.txt2014_CARD_AMT.text = 0;
                    form1.txt2013_CARD_OVER.text = 0;
                    form1.txt2014_CARD_OVER.text = 0;            
    ...
    ***************************************************************************************-->
    ...
    document.getElementById("txt2014_CARD_AMT").text = parseInt(document.getElementById("txtCARD_AMT_NTS").text) + parseInt(document.getElementById("txtDIR_CARD_AMT_NTS").text) + parseInt(document.getElementById("txtCASH_AMT_NTS").text)
	...
	<script language=JavaScript for=txt2013_CARD_AMT event=onSetFocus()>
    //화면 찍었을때 안에 있는 값이 0 이면 빈칸으로 되도록
    if(document.getElementById("txt2013_CARD_AMT").text == 0){
    	document.getElementById("txt2013_CARD_AMT").text = '';
    }
	</script>

	<script language=JavaScript for=txt2014_CARD_AMT event=onSetFocus()>
    //화면 찍었을때 안에 있는 값이 0 이면 빈칸으로 되도록
    if(document.getElementById("txt2014_CARD_AMT").text == 0){
    	document.getElementById("txt2014_CARD_AMT").text = '';
    }
	</script>
	
	<script language=JavaScript for=txt2013_CARD_OVER event=onSetFocus()>
    //화면 찍었을때 안에 있는 값이 0 이면 빈칸으로 되도록
    if(document.getElementById("txt2013_CARD_OVER").text == 0){
    	document.getElementById("txt2013_CARD_OVER").text = '';
    }
	</script>

	<script language=JavaScript for=txt2014_CARD_OVER event=onSetFocus()>
    //화면 찍었을때 안에 있는 값이 0 이면 빈칸으로 되도록
    if(document.getElementById("txt2014_CARD_OVER").text == 0){
    	document.getElementById("txt2014_CARD_OVER").text = '';
    }
	</script>	
        ...
        <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">부양가족등록_2</td>
                    <td align="right" class="navigator">HOME/정산세무/연말정산/<font color="#000000">부양가족등록_2</font></td>
                </tr>
            </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td class="blueBold" align="center">공제항목</td>
                        <td class="padding2423" colspan="5">
                            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
			                    <colgroup>
			                        <col width="150"></col>
                                ...
                                <tr>
			                        <td class="padding2423" valign="top">
			                            <input type="checkbox" name="chkBAS_MAN" id="chkBAS_MAN" style="border:1" align="absmiddle" value="" onclick="fnc_chkBasMan()">기본공제
			                            <br>
			                            <input type="checkbox" name="chkGOL_70" id="chkGOL_70" style="border:1" align="absmiddle" value="">경로우대공제
			                            <br>
			                            <input type="checkbox" name="chkTRB_MAN" id="chkTRB_MAN" style="border:1" align="absmiddle" value="" onclick="fnc_chkTrbMan();">장애인공제
			                        </td>
			                        ...
			                        <td class="padding2423" align="left" border="1">세대주여부
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="4">구&nbsp;&nbsp;&nbsp;분</td>
                    ...
                    <tr>
                        ...
                        <td class="blueBold" align="center" colspan="3">보장성보험료</td>
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">장애인전용보험료</td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        ...
                        <td class="blueBold" align="center" colspan="3">
                            <table>
                                <tr>
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">장애인특수교육비</td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" rowspan="9">
                            신용카드<br>
                            사용액
                        </td>
                        <td class="blueBold" align="center" colspan="3">신용카드<font color="blue"><b>(대중교통,전통시장 제외)</b></font></td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">직불/선불카드<font color="blue"><b>(대중교통,전통시장 제외)</b></font></td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">현금영수증<font color="blue"><b>(대중교통,전통시장 제외)</b></font></td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">전통시장사용 총액</td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">대중교통이용 총액</td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">2013년 본인 신용카드등 사용액&nbsp;
                            <button id="btnPRO_STS_1"  style="cursor:hand;width:30pt;height:15pt;" onclick="fnc_Alert1();"><font color="blue"><b>설명</b></font></button>                         
                        </td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                            <object id="txt2013_CARD_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100px">
                                <param name=Alignment               value=2>
                                <param name=Border                  value=true>
                                <param name=ClipMode                value=true>
                                <param name=DisabledBackColor       value="#EEEEEE">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">2014년 본인 신용카드등 사용액&nbsp;
                        	<button id="btnPRO_STS_2"  style="cursor:hand;width:30pt;height:15pt;" onclick="fnc_Alert2();"><font color="blue"><b>설명</b></font></button>
                        </td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                            <object id="txt2014_CARD_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100px">
                                <param name=Alignment               value=2>
                                <param name=Border                  value=true>
                                <param name=ClipMode                value=true>
                                <param name=DisabledBackColor       value="#EEEEEE">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">2013년 본인의 추가공제율 사용액&nbsp;
                        	<button id="btnPRO_STS_3"  style="cursor:hand;width:30pt;height:15pt;" onclick="fnc_Alert3();"><font color="blue"><b>설명</b></font></button>
                        </td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                            <object id="txt2013_CARD_OVER" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100px">
                                <param name=Alignment               value=2>
                                <param name=Border                  value=true>
                                <param name=ClipMode                value=true>
                                <param name=DisabledBackColor       value="#EEEEEE">
                    ...
                    <tr>
                        <td class="blueBold" align="center" colspan="3">2014년 하반기 본인의 추가공제율 사용액&nbsp;
                        	<button id="btnPRO_STS_4"  style="cursor:hand;width:30pt;height:15pt;" onclick="fnc_Alert4();"><font color="blue"><b>설명</b></font></button>
                        </td>
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                            <object id="txt2014_CARD_OVER" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100px">
                                <param name=Alignment               value=2>
                                <param name=Border                  value=true>
                                <param name=ClipMode                value=true>
                                <param name=DisabledBackColor       value="#EEEEEE">
                     ...
                     <tr>
                        ...
                        <td class="blueBold" align="center" colspan="3">우리사주조합 출연금</td>                      
                        <td class="padding2423" align="center" style="padding-right:5px"  >
                            <comment id="__NSID__">
                    ...
                    <tr>                  
                     ...
                     <tr>
                        <td class="blueBold" align="center" rowspan="8">
                            주택자금
                        </td>
                        <td class="blueBold" align="center" rowspan="2">주택임차<br>차입금</td>
                        <td class="blueBold" align="center"  colspan="2">대출기관</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px"  >
                            <comment id="__NSID__">
                    ...
                    <tr>
                        ...
                        <td class="blueBold" align="right" colspan="2">개인간&nbsp;&nbsp;
					...
					<tr>
                        <td class="blueBold" align="right" colspan="3">월세액&nbsp;&nbsp;
                    ...
                    <tr>
                        <td class="blueBold" align="center" rowspan="5">장기주택<br>저당차입금</td>
                		<td class="blueBold" align="center" rowspan="3">2011년<br>이전차입분</td>                          
                        <td class="blueBold" align="center">15년 미만</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        ...
                        <td class="blueBold" align="center">15 ~ 29년</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center">30년 이상</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        ...
                        <td class="blueBold" align="center">고정금리/비거치</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td class="blueBold" align="center">기타대출</td>                        
                        <td class="padding2423" align="center" style="padding-right:5px">
                            <comment id="__NSID__">
...
<object id="bndT_AC_FAMILY" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
    ...
    <Param Name="BindInfo", Value='
        ...
        <C>Col=CARD_2013_AMT           Ctrl=txt2013_CARD_AMT            Param=text      </C>
        <C>Col=CARD_2014_AMT         	Ctrl=txt2014_CARD_AMT        	 Param=text      </C>
        <C>Col=CARD_2013_OVER         Ctrl=txt2013_CARD_OVER            Param=text      </C>
        <C>Col=CARD_2014_OVER         Ctrl=txt2014_CARD_OVER            Param=text      </C>
