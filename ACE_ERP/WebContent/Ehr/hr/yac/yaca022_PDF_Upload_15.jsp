<!--*************************************************************************
* @source      : yaca022_PDF_Upload_15.jsp                  *
...
<%--        "<%=request.getParameter("PIS_YY")%>"; --%>
        ...
        function fnc_Famliy_Update_SearchList() {
            ...
            alert("dsT_AC_FAMILY_UPDATE"+dsT_AC_FAMILY_UPDATE.countrow);
        ...
        function fnc_Family_Card_Update(){
        	alert("다시 fnc_Family_Card_Update");
        ...
        function fnc_Save() {
            ...
            alert("전자문서가 등록되었습니다.\n부양가족사항 등록으로 이동하셔서 등록 완료하시기 바랍니다.");
        ...
        function fnc_Delete() {
            ...
            for(var i = 1; i<= dsT_AC_FAMILY_TEMP.CountRow; i++) {
                if(dsT_AC_FAMILY_TEMP.NameValue(i,"FILE_SEQ") == file_seq) {
                    if(dsT_AC_FAMILY_TEMP.NameValue(i,"CET_NO") == my_cet) {
                        app_yn = dsT_AC_FAMILY_TEMP.NameValue(i,"APP_YN");
                    }
			...
			//trT_AC_RENT.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca021.cmd.YACA021CMD&S_MODE=SAV_RENT_15";
            
            
			//&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO+"&FILE_SEQ="+file_seq+"&DEL_TAG=D&MED_CNT="+med_cnt+"&DON_CNT="+don_cnt+"&PEN_CNT="+pen_cnt+"&MY_CET="+my_cet+"&APP_YN="+app_yn;
            ...
            trFILE_CONVERT.action   = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca099.cmd.YACA0099CMD&S_MODE=SAV"
            trFILE_CONVERT.post();
...
//             dsT_AC_FAMILY.dataid = "/servlet/GauceChannelSVL?cmd=hr.yac.a.yaca010.cmd.YACA010CMD&S_MODE=SHR_CHK&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
//             dsT_AC_FAMILY.reset();
            
//             if(dsT_AC_FAMILY.CountRow > 0) {
                
//                 for(var i = 1; i<= dsT_AC_FAMILY.CountRow; i++) {
                    
//                     if(dsT_AC_FAMILY.NameValue(i,"MED_CNT") > 0) {
//                         alert("등록된 의료비내역이 있습니다.\n"+dsT_AC_FAMILY.NameValue(i,"NAM_KOR")+"의 의료비내역 삭제 후 파일삭제가 가능합니다.");
//                         return false;                            
//                     }
//                     if(dsT_AC_FAMILY.NameValue(i,"PEN_CNT") > 0) {
//                         alert("등록된 연금저축내역이 있습니다.\n"+dsT_AC_FAMILY.NameValue(i,"NAM_KOR")+"의 연금저축내역 삭제 후 파일삭제가 가능합니다.");
//                         return false;
//                     }
//                     if(dsT_AC_FAMILY.NameValue(i,"DON_CNT") > 0) {
//                         alert("등록된 기부금내역이 있습니다.\n"+dsT_AC_FAMILY.NameValue(i,"NAM_KOR")+"의 기부금내역 삭제 후 파일삭제가 가능합니다.");
//                         return false;
//                     }
//                 }
         ...
         ***************************/
         function fnc_Upload_Save() { 
        	...
        	return;
        	 ...
        	 alert("fnc_Upload_Save");
             
             var PIS_YY = form1.txtPIS_YY_SHR.value;
             var ENO_NO = form1.txtENO_NO_SHR.value;
             
             if(!fnc_Upload_SaveItemCheck()) return;
            	
             trFILE_CONVERT.KeyValue = "SVL(I:dsT_AC_FAMILY_TEMP=dsT_AC_FAMILY_TEMP)";
             trFILE_CONVERT.action   = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca099.cmd.YACA099CMD&S_MODE=UPT&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO+"&DEL_TAG=N&CET_NO="+CET_NO;
             
             prompt("dsT_AC_FAMILY_TEMP",dsT_AC_FAMILY_TEMP.text);
             
             trFILE_CONVERT.post();
             
             alert("등록되 전자문서를 연말정산 데이터에 반영했습니다. ");
         ...
         function fnc_Upload_SaveItemCheck() { 
        ...
        <td height="25" background="../../images/common/barBg.gif">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" background="../../images/common/barGreenBg.gif" class="barTitle">전자문서등록</td>
    ...
    <tr>
        <td class="paddingTop5">
            <table width="800" border="0" cellspacing="0" cellpadding="0" align = "right">
                ...
                <tr>
                    <td colspan="2">
                        <font color="blue">※삭제하려는 전자문서가 이미 부양가족으로 등록된 경우, 삭제가 불가합니다. (부양가족사항등록에서 해당 내역 삭제 후 첨부파일 삭제)
                        </font>
                    </td>
                </tr>
           </table>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <button id="btnPRO_PERSON"  style="cursor:hand;width:70pt;height:15pt;" onclick="fnc_Upload_Save();"><font color="red"><b>&nbsp;입력 Click!</b></font></button>      
        </td>
    </tr>
    <tr>
        <td>
            ...
            <tr align="center">
                ...
                <object id="grdT_AC_FAMILY_TEMP" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:430px;">
                    ...
                    <param name="Format"            value='
                        ...
                        <C> id="LOCK_YN"   width=50   align=center       name="입력구분"         RightMargin=5    </C>
