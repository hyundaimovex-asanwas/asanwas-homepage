...
<html>
<head>
    <title>개인간 주택임차차입금 원리금 상환액 소득공제 명세서 작성(yaca022_2014년도)</title>
		...
		<tr>
			<td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="blueBold" rowspan="3">임대차<br>계약내용</td>                    
                ...
                <tr align="center">
					...
					<object id="grdT_AC_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:850px;height:150px;">
						...
						<param name="Format" 						value='
							...
							<C> id="CET_NO"					width=85	name="주민등록번호"		    		align=center 	</C>
							...
							<C> id="CET_NO2"				width=85	name="주민등록번호"		    		align=center 	</C>                            
