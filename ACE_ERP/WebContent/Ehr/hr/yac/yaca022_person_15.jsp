...
<html>
<head>
    <title>개인간 주택임차차입금 원리금 상환액 소득공제 명세서 작성(yaca022_2015년도)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_AC_PERSON, 15, "false","false");      // Grid Style 적용         
		...
		<tr>
			<td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="blueBold" rowspan="3">금전<br>소비대차<br>계약내용</td>                       
                        <td align="center" class="blueBold">대주성명</td>
                        <td class="padding2423">
                    ...
                    <tr>
                        <td align="center" class="blueBold">원리금상환액</td>
						<td class="padding2423" align="left">
                            <comment id="__NSID__">
                        ...
                        <td align="center" class="blueBold">이자율</td>
                        <td class="padding2423" >
                    ...
                    <tr>
                      ...
                      <tr>
                        <td align="center" class="blueBold" rowspan="4">임대차<br>계약내용</td>                    
                    ...
                    <tr>
                        ...
                        <td align="center" class="blueBold">전세보증금</td>
                        <td class="padding2423" >
                            <comment id="__NSID__">
					...
					<object id="grdT_AC_PERSON" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:850px;height:150px;">
						...
						<param name="Format" 						value='
                           ...
                           <G> name ="금전소비대차 계약내용"
							...
							<C> id="CET_NO2"				width=85	name="주민등록번호"		    	align=center  Mask="XXXXXX-XXXXXXX" </C>                            
							...
							<C> id="CON2_YMD"				width=70	name="계약시작일"		    		align=center  Mask="XXXX-XX-XX"	</C>
                          	<C> id="DUE2_YMD"				width=70	name="계약종료일"	   				align=center  Mask="XXXX-XX-XX"	</C>
                           </G>
                           <G> name ="임대차 계약내용"
                            <C> id="HOST_NM"				width=70	name="임대인성명"		    		align=center  	</C>
							<C> id="CET_NO"					width=85	name="주민등록번호"		    	align=center 	Mask="XXXXXX-XXXXXXX"</C>
                          	<C> id="ADDRESS"				width=200	name="임대차계약서상주소지"	   	    align=left	    </C>
                            <C> id="AMOUNT"				    width=80	name="전세보증금"		    		align=right	   RightMargin="10"  	</C>
							<C> id="CON_YMD"				width=70	name="계약시작일"		    		align=center   Mask="XXXX-XX-XX"  </C>
                          	<C> id="DUE_YMD"				width=70	name="계약종료일"	   				align=center   Mask="XXXX-XX-XX"  </C>						
