...
<html>
<head>
    <title>월세액 소득공제 명세서 작성(yaca022_2014년도)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
			...
			dsT_AC_RENT.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca021.cmd.YACA021CMD&S_MODE=SHR_RENT_14&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
			dsT_AC_RENT.reset();
        ...
        function fnc_Save() {
			...
			trT_AC_RENT.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca021.cmd.YACA021CMD&S_MODE=SAV_RENT_14";
			trT_AC_RENT.post();   
					...
					<object id="grdT_AC_RENT" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:850px;height:130px;">
						...
						<param name="Format" 						value='
							...
							<C> id="CET_NO"					width=100	name="주민등록번호"		    		align=center 	</C>
                          	<C> id="ADDRESS"				width=350	name="임대차계약서상주소지"	   	align=left	</C>
                            <C> id="AMOUNT"				width=100	name="월세총액"		    			align=right	  RightMargin="10"  	</C>
							<C> id="CON_YMD"				width=80	name="계약시작일"		    		align=center 	</C>
                          	<C> id="DUE_YMD"				width=80	name="계약종료일"	   				align=center	</C>
						'>
					</object>
