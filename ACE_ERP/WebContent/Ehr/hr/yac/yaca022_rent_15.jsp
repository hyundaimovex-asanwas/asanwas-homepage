...
<html>
<head>
    <title>월세액 소득공제 명세서 작성(yaca022_2015년도)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_SearchList() {
			...
			dsT_AC_RENT.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca021.cmd.YACA021CMD&S_MODE=SHR_RENT_15&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
			dsT_AC_RENT.reset();
        ...
        function fnc_OnLoadProcess() {
			...
			cfStyleGrid_New(form1.grdT_AC_RENT, 15, "false","false");      // Grid Style 적용            
		...
		<tr>
			<td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="blueBold">임대인성명</td>
                        <td class="padding2423">
                        ...
                        <td class="padding2423">
                            ...
                            <comment id="__NSID__">
                            <object id="medCET_NO" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:40%" enable="false">
                    ...
                    <tr>
                        <td align="center" class="blueBold">계약상주소지</td>
						<td class="padding2423" align="left">
                            <input id="txtADDRESS" style="width:100%"">
						</td>                    
                        <td align="center" class="blueBold">월세총액</td>
                        <td class="padding2423" >
                            <comment id="__NSID__">
                    ...
                    <tr>
                        <td align="center" class="blueBold">계약시작일</td>
                        <td class="padding2423" >
                        	<comment id="__NSID__">
                            <object id="medCON_YMD" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:20%" enable="false">
                                <param name=Alignment               		value=1>
                                <param name=Border                  		value=true>
                                <param name=ClipMode                		value=true>
                                <param name=Enable                  		value=true>
                        ...
                        <td align="center" class="blueBold">계약종료일</td>
                        <td class="padding2423">
                        	<comment id="__NSID__">
                            <object id="medDUE_YMD" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:30%" enable="false">
                                <param name=Alignment               		value=1>
                                <param name=Border                  		value=true>
                                <param name=ClipMode                		value=true>
                                <param name=Enable                  		value=true>
                     ...
                     <tr> 
                        <td align="center" class="blueBold">주택유형</td>
                        <td class="padding2423">
                        	<comment id="__NSID__">
                            <object id=lxHOUSE_TYPE classid=clsid:D8BCC087-4710-427D-B2E4-A4B93B6EA197 height=120 width=100>
								<param name=CBData			 value="1^단독주택,2^다가구,3^다세대주택,4^연립주택,5^아파트,6^오피스텔,7^기타">
                        ...
                        <td align="center" class="blueBold">주택계약면적(㎡)</td>
                        <td class="padding2423">
                        	<comment id="__NSID__">
                            <object id="medHOUSE_AREA" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:20%" enable="false">
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
					<comment id="__NSID__">
					<object id="grdT_AC_RENT" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:850px;height:130px;">
						...
						<param name="Format" 				value='
                            ...
                            <C> id="HOST_NM"				width=90	name="임대인성명"		    		align=center  	</C>
							<C> id="CET_NO"					width=100	name="주민등록번호"		    	align=center 	Mask="XXXXXX-XXXXXXX"</C>
                          	<C> id="ADDRESS"				width=200	name="임대차계약서상주소지"	   	    align=left	    </C>
                            <C> id="AMOUNT"				    width=100	name="월세총액"		    		align=right	    RightMargin="10"  	</C>
							<C> id="CON_YMD"				width=80	name="계약시작일"		    		align=center 	Mask="XXXX-XX-XX" </C>
                          	<C> id="DUE_YMD"				width=80	name="계약종료일"	   				align=center	Mask="XXXX-XX-XX" </C>
                          	<C> id="HOUSE_TYPE"				width=100	name="주택유형"	   				align=center	EditStyle=Combo  Data="1:단독주택,2:다가구,3:다세대주택,4:연립주택,5:아파트,6:오피스텔,7:기타"</C>
                          	<C> id="HOUSE_AREA"				width=50	name="주택면적"	   				align=center	</C>
						'>
					</object>
