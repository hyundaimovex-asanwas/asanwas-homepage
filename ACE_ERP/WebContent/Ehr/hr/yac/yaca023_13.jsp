...
<html>
<head>
	<title>종전근무지내역입력(yaca023_2013년도)</title>
    ...
    *****************************-->
	...
	<script language="javascript">
        ...
        var dataClassName = "/servlet/GauceChannelSVL?cmd=hr.yac.a.yaca023.cmd.YACA023CMD";
        var params = null;
        ...
        function fnc_SearchList() {
			...
			//dsT_AC_DUTYPLACE.dataid = "/servlet/GauceChannelSVL?cmd=hr.yac.a.yaca023.cmd.YACA023CMD&S_MODE=SHR&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
...
%>
                               <input id="txtPIS_YY_SHR" name="txtPIS_YY_SHR" size="6">
<%
  }
%>
							</td>
            ...
            <td class="paddingTop3">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
						-2013년 계속 근무하신 분은 해당되지 않습니다. 중도입사자만 해당됩니다.<br>
						-2013년 과세기간 중에 근무경력이 있는 종전근무지에 대한 자료 입력</td>
					</tr>
				</table>
