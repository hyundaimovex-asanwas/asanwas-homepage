...
<html>
<head>
	<title>의료비공제내역입력(yaca030_2013년도)</title>
			...
			<td class="paddingTop8">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        ...
                        <td align="center" class="creamBold">증빙코드</td>
                ...
                <tr align="center">
					...
					<object id="grdT_AC_MEDICAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:800px;height:260px;">
                        ...
                        <G> name="대상자" align=center HeadBgColor="#F7DCBB"
                            ...
                            <C> id="REL_CD"     width=100   name="관계"                     			align=left   EditStyle=Lookup Data="dsT_CM_COMMON_FA:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
                    	...
                    	<G> name="지급처" align=center HeadBgColor="#F7DCBB"
                            <C> id="MED_CD"     	width=130   	name="의료증빙코드"             	align=left    EditStyle=Lookup Data="dsT_CM_COMMON_FC:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
