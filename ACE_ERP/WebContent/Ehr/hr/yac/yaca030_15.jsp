...
<%
    ...
    String TRB_MAN 	    = request.getParameter("TRB_MAN");         
...
<html>
<head>
	<title>의료비공제내역입력(yaca030_2015년도)</title>
    ...
    *****************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			//alert("fnc_SearchList");

			var pis_yy   = document.form1.txtPIS_YY_SHR.value;
			var eno_no  = document.form1.txtENO_NO_SHR.value;

			//dsT_AC_MEDICAL.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SHR_14&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
			dsT_AC_MEDICAL.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SHR_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        ...
        function fnc_Save() {
			...
			//trT_AC_MEDICAL.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SAV_14";
			trT_AC_MEDICAL.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SAV_15";
			trT_AC_MEDICAL.Parameters = "PIS_YY="+PIS_YY+",ENO_NO="+ENO_NO;	
			trT_AC_MEDICAL.post();
        ...
        function fnc_UpdateAcc(){
			...
			dsT_AC_MEDICAL2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=ACC_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
			//prompt('',dsT_AC_MEDICAL2.dataid);
        ...
        function fnc_Delete() {
	        ...
	        if( confirm(tmpMSG) ){
			    ...
			    if(status != 1){
                    trT_AC_MEDICAL.KeyValue = "tr01(I:dsT_AC_MEDICAL=dsT_AC_MEDICAL)";
                    //trT_AC_MEDICAL.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=DEL_14";
                    trT_AC_MEDICAL.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=DEL_15";
                    trT_AC_MEDICAL.post();
                }
			}
			fnc_UpdateAcc();
        ...
        function fnc_Add() {
            ...
            document.getElementById("txtCASH_CNT").value = "0";
			...
			for(i=0;i<dsT_AC_MEDICAL.CountRow;i++){
			    ...
			    if(dsT_AC_MEDICAL.RowLevel(i+1) !="9999"){
			    	...
			    	if(dsT_AC_MEDICAL.NameValue(i+1,"MED_CD") == '1') {
		                ...
		                //^^난임시술비는 국세청장이 제공하지 않음.
		                if(dsT_AC_MEDICAL.NameValue(i+1,"GBN_TAG") == "C") {	
			                alert("난임시술비는 국세청장이 제공하는 의료비 자료가 아닙니다.");
			                form1.cmbMED_CD.focus();
	                        return false;    
		                }
			    	}
...
%>
		    ...
		    // 이부분 소스 확인 
		    cfStyleGrid_New(form1.grdT_AC_MEDICAL,15,"false","false");      // Grid Style 적용
						dsT_AC_FAMILY.clearData();
			//dsT_AC_FAMILY.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SHR_FAM_14&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
		    dsT_AC_FAMILY.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca030.cmd.YACA030CMD&S_MODE=SHR_FAM_15&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
			//prompt('dsT_AC_FAMILY.dataid',dsT_AC_FAMILY.dataid);
			dsT_AC_FAMILY.reset();
         ...
         ********************************************/
  		function fnc_disableInput(){
  			...
  			document.getElementById("txtCASH_CNT").className = "input_ReadOnly";
	  		document.getElementById("txtCASH_CNT").readOnly = true;
	  		form1.medCASH_AMT.Enable = "false";
			...
			<td class="paddingTop8">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        ...
                        <td align="center" class="blueBold">관계</td>
                        <td class="padding2423">
                            <select id="cmbREL_CD" style="width=100%" onchange="changeRelTag(this.value)">
                            </select>
                        </td>
                        <td align="center" class="blueBold">주민등록번호</td>
                        <td class="padding2423">
                        ...
                        <td class="padding2423">
                            <select id="cmbGBN_TAG" style="width=100%">
                                ...
                                <option value="C">난임시술비</option>
                            </select>
                        </td>
                    </tr>                        
                        
                    <tr>
                         <td align="center" class="blueBold" rowspan="2">지급처</td>
                        <td align="center" class="blueBold">증빙코드</td>
                    ...
                    <tr>
                        <td align="center" class="blueBold" >진료기관</td>
                        <td class="padding2423" colspan="2">
                            <input id="txtCOM_NM" style="width=100%" maxLength="30" onKeyUp="fc_chk_byte(this,30)">                        
                        </td>
                        <td align="center" class="blueBold">건수</td>
                        <td class="padding2423">
                            <input id="txtCASH_CNT" maxlength="3" style="width=100%;ime-mode:disabled;text-align:right" onKeypress="cfNumberCheck();">
                        </td>
                        <td align="center" class="blueBold">금액 </td>
                          <td class="padding2423" colspan="2">
	                        <comment id="__NSID__">
	                        <object id="medCASH_AMT" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F style="width:100%" enable="false">
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
					<comment id="__NSID__">
					<object id="grdT_AC_MEDICAL" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:900px;height:360px;">
						...
						<param name="Format" 						value='
                            <C> id={currow}    	width=30    	name="NO"                       	align=center    SumBgColor=#C3D0DB  SumText="합계"</C>
                        <G> name="대상자"         HeadBgColor=#dae0ee    TextColor=#34578c  HeadFontStyle = "bold"      
                            <C> id="FAM_NM"     width=60        name="성명"                     		align=center    SumBgColor=#C3D0DB</C>
                            <C> id="REL_CD"     width=120       name="관계"                     		align=left   	EditStyle=Lookup Data="dsT_CM_COMMON_FA:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
                            <C> id="CET_NO"     width=100       name="대상자주민번호"           		align=center    SumBgColor=#C3D0DB</C>
                            <C> id="GBN_TAG"    width=65        name="구분"                     		align=center    EditStyle=Combo  Data="A:장애인,B:65세이상자,C:난임시술비"   SumBgColor=#C3D0DB</C>
                       </G>
                    	<G> name="지급처" HeadBgColor=#dae0ee    TextColor=#34578c  HeadFontStyle = "bold"      
                            <C> id="MED_CD"   	width=200   	name="의료증빙코드"                align=left    	 EditStyle=Lookup Data="dsT_CM_COMMON_FC:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
                            <C> id="COM_NO"    	width=80    	name="사업자번호"               	align=center     SumBgColor=#C3D0DB</C>
                            <C> id="COM_NM"    	width=110   	name="진료기관"                 	align=left       SumBgColor=#C3D0DB</C>
                            <C> id="CASH_CNT"  	width=30    	name="건수"                     	align=right      SumBgColor=#C3D0DB SumText=@sum</C>
                            <C> id="CASH_AMT"  	width=70    	name="지급금액"                 	align=right      SumBgColor=#C3D0DB SumText=@sum</C>
                       </G>
