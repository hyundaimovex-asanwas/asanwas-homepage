...
<html>
<head>
	<title>기부금공제내역입력(yaca040_2015년도)</title>
    ...
    *****************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			//dsT_AC_DONATION.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=SHR_14&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
			dsT_AC_DONATION.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=SHR_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        ...
        function fnc_Save() {
			...
			trT_AC_DONATION.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=SAV_15";
        ...
        function fnc_Delete() {
	        ...
	        if( confirm(tmpMSG) ){
			    ...
			    if(status != 1){
                    ...
                    trT_AC_DONATION.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=DEL_15";
                    trT_AC_DONATION.post();
                }
			}
...
%>
			...
			cfStyleGrid_New(form1.grdT_AC_DONATION,15,"false","false");      // Grid Style 적용
			...
			dsT_AC_FAMILY.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=SHR2_15&PIS_YY="+PIS_YY+"&ENO_NO="+ENO_NO;
        ...
        function fnc_UpdateAcc(){
			...
			dsT_AC_DONATION2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca040.cmd.YACA040CMD&S_MODE=ACC_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
			...
			<td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        ...
                        <td align="center" class="blueBold">기부유형</td>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream" frame="vsides">
                    ...
                    <tr>
                        <td align="center" class="blueBold">상호(법인명)</td>
                        <td class="padding2423" >
                            <input id="txtCOM_NM" style="width=100%" maxLength="60" onKeyUp="fc_chk_byte(this,60)">
                        </td>
                        <td align="center" class="blueBold">기부내용</td>
                        <td class="padding2423">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="blueBold">사업자등록번호</td>
                        <td class="padding2423">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
						...
						<FONT color=#0033CC>
			                            ...
			                            ※정치자금 기부금은 상호와 사업자등록번호를 적지 아니합니다.<BR></FONT>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <tr align="center">
					...
					<object id="grdT_AC_DONATION" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:900px;height:330px;">
						...
						<param name="Format" 						value='
							<C> id={currow}			width=25    name="NO"		               	align=center  SumBgColor=#C3D0DB  SumText="합계"</C>
				    	<G> name="기부자" HeadBgColor=#dae0ee    TextColor=#34578c  HeadFontStyle = "bold"   
							<C> id="FAM_NM"     	width=55    name="성명"                     	align=center  SumBgColor=#C3D0DB </C>
							<C> id="FAM_CD"     	width=60    name="관계"                     	align=center   EditStyle=Lookup Data="dsT_CM_COMMON_FD:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
                            <C> id="FAM_NO"     	width=100    name="대상자주민번호"              align=center  SumBgColor=#C3D0DB </C>
						</G>
                            <C> id="NTS_YN"			width=50	name="구분"		            	align=center    Value={Decode(NTS_YN,"1","국세청","2","그외")} SumBgColor=#C3D0DB</C>
                            <C> id="REL_CD"			width=100	name="기부유형"		            align=left      EditStyle=Lookup Data="dsT_CM_COMMON_FB:CODE:CODE_NAME" SumBgColor=#C3D0DB</C>
                            <C> id="COM_NM"		    width=120	name="상호(법인명)"		    	align=left	    SumBgColor=#C3D0DB </C>

                            <C> id="REMARK"     	width=165    name="기부내용"                 	align=left       SumBgColor=#C3D0DB </C> 
                            <C> id="COM_NO"     	width=80    name="사업자\\등록번호"             align=center    SumBgColor=#C3D0DB </C>
                          	<C> id="TOT_CNT"		width=30	name="건수"                     	align=center	RightMargin="1" SumBgColor=#C3D0DB </C>
