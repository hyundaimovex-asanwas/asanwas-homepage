...
<head>
    ...
    <title>연말정산결과조회(yaca050_2015년도)</title>
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_OnLoadProcess() {
			...
			if(gusrid != "6060002" && gusrid != "2030007" && gusrid != "2140002" && gusrid != "2070020"  && gusrid != "6070001" && gusrid != "2110003"){
        ...
        function fnc_Print() {
        	...
        	//1,2pgae
        	gcds_print.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	//prompt('gcds_print.dataid',gcds_print.dataid );
        	gcds_print.reset();
        	
        	//3page
        	gcds_print3.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_3&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print3.reset();
        	
        	
        	//4page        	
        	gcds_print4.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_4&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print4.reset();
        	
        	gcds_print4_1.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_4_1&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print4_1.reset();
        	
        	gcds_print4_2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_4_2&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print4_2.reset();
        	
        	gcds_print4_3.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_4_3&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print4_3.reset();
        	
        	gcds_print4_4.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca050.cmd.YACA050CMD&S_MODE=YACA050_PRT_15_4_4&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        	gcds_print4_4.reset();
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td class="blueBold" align="center" rowspan="18">세액공제</td>
                    ...
                    <tr>
                        <td class="blueBold" align="left" style="padding-left:10px" rowspan="2" >연금계좌</td>
                        <td class="blueBold" align="left" style="padding-left:10px" >퇴직연금</td>
                        <td class="padding2423" style="padding-left:10px">
		                        <comment id="__NSID__"><object id="txtDCIRP_DED" classid=CLSID:4AEAFD66-8D65-41AC-B1D1-57E7FF2A734F height=20 width=120>
									<param name=Alignment			value=2>
									<param name=Numeric				value=true>
									<param name=IsComma			value=true>
									<param name=MaxLength			value=10>
                    ...
                    <tr>
                        <td class="blueBold" align="left" style="padding-left:10px" >연금저축</td>
                        <td class="padding2423" style="padding-left:10px">
    ...
    ***************************************************************************************-->
	...
	<object id="bndT_AC_RETACC" classid="CLSID:4A35BB2C-B831-4199-A486-FEA332D085D9">
		...
		<Param Name="BindInfo", Value="
			...
			<C>Col=DCIRP_DED				Ctrl=txtDCIRP_DED				Param=text </C>
