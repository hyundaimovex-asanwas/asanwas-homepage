...
<%
    ...
    String TAX_INCOME 	= request.getParameter("TAX_INCOME");
...
<html>
<head>
	<title>연금저축등소득공제내역입력(yaca060_2015년도)</title>
    ...
    *****************************-->
	...
	<script language="javascript">
        ...
        function fnc_SearchList() {
			...
			dsT_AC_PENSION.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca060.cmd.YACA060CMD&S_MODE=SHR_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
        ...
        function fnc_Save() {
			...
			trT_AC_PENSION.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca060.cmd.YACA060CMD&S_MODE=SAV_15";
			trT_AC_PENSION.post();
        ...
        function fnc_UpdateAcc(){
			...
			dsT_AC_PENSION2.dataid = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca060.cmd.YACA060CMD&S_MODE=ACC_15&PIS_YY="+pis_yy+"&ENO_NO="+eno_no;
			//prompt('dsT_AC_PENSION',dsT_AC_PENSION.text);
        ...
        function fnc_Delete() {
        	...
        	if(dsT_AC_PENSION.nameValue(dsT_AC_PENSION.RowPosition, "IN_GB")=="1"){
        		alert("회사 입력분입니다. 삭제 불가합니다.");
        		return false;
        	}
	        ...
	        if( confirm(tmpMSG) ){
			    ...
			    if(status != 1){
                    ...
                    trT_AC_PENSION.action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca060.cmd.YACA060CMD&S_MODE=DEL_15";
                    trT_AC_PENSION.post();
                }
			}
			//fnc_UpdateAcc();
        ...
        function fnc_SaveItemCheck() {
			...
			for(i=0;i<dsT_AC_PENSION.CountRow;i++){
			    ...
			    if(dsT_AC_PENSION.RowLevel(i+1) !="9999"){
			    	...
			    	if(dsT_AC_PENSION.NameValue(i+1,"PEN_TYPE_CD") == '1') {
		                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '21' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '22' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '31' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '32' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '34'|| dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '51' ) {
		                	alert("저축유형이 퇴직연금일 경우\n 확정기여형(DC)과 개인형(IRP)만 저장가능합니다.");
	                    	return false;
		                }
	                }		
	                ...
	                if(dsT_AC_PENSION.NameValue(i+1,"PEN_TYPE_CD") == '2') {
		                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '11' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '12' ||dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '31' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '32' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '34' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '51' ) {
	                ...
	                if(dsT_AC_PENSION.NameValue(i+1,"PEN_TYPE_CD") == '3') {
		                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '11' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '12' ||dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '21' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '22' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '51' ) {
	                ...
	                if(dsT_AC_PENSION.NameValue(i+1,"PEN_TYPE_CD") == '5') {
		                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '11' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '12' ||dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '21' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '22' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '31' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '32' || dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '34') {
	                ...
	                if(TAX_INCOME>70000000){
		                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '32' && dsT_AC_PENSION.NameValue(i+1,"AMOUNT") > 1200000) {
		                	alert("주택청약종합저축 불입금액은 총급여 7천만원 초과시 120만원을 초과할 수 없습니다.");
		                    form1.medAMOUNT.focus();
		                    return false;
		                }
	                }else{
	                	if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '32' && dsT_AC_PENSION.NameValue(i+1,"AMOUNT") > 2400000) {
		                	alert("주택청약종합저축 불입금액은 240만원을 초과할 수 없습니다.");
		                    form1.medAMOUNT.focus();
		                    return false;
		                } 	
	                }
	                ...
	                if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '11') {
	                	dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_NM") = "확정기여형(DC)";
	                }else if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '12'){
	                	dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_NM") = "개인형(IRP)";
	                }else if(dsT_AC_PENSION.NameValue(i+1,"PEN_GUBUN_CD") == '21') {
...
%>
        ...
        function fnc_GetPenGubunList(){
                ...
                if(oSelectT.value == "1"){
                   CdList = new Array(  "11"
			                             ,"12");
			       NmList = new Array( "확정기여형(DC)"				//LF1_AMT
			                             ,"개인형(IRP)");	
        ...
        function fnc_SetPenType(){
         ...
         function fnc_SetPenGubun(){
                ...
                if(oSelectT.value == "11"){
	                document.form1.txtPEN_GUBUN_NM.value = "확정기여형(DC)";
 	                document.form1.cmbPEN_GUBUN_CD.value = "11";
                }
                else if(oSelectT.value == "12"){
                    document.form1.txtPEN_GUBUN_NM.value = "개인형(IRP)";
        ...
        function fnc_In_gb(row){
        	
        	//alert("IN_GB::"+dsT_AC_PENSION.namevalue(row,"IN_GB"));
        	
        	if(dsT_AC_PENSION.namevalue(row,"IN_GB")=="1"){
        		document.getElementById("cmbPEN_TYPE_CD").className = "input_ReadOnly";
     	  		document.getElementById("cmbPEN_TYPE_CD").disabled = true;
     	  		document.getElementById("cmbPEN_GUBUN_CD").className = "input_ReadOnly";
     	  		document.getElementById("cmbPEN_GUBUN_CD").disabled = true;
    ...
    ***************************************************************************************-->
    ...
    <script language="javascript"  for=grdT_AC_PENSION event=OnClick(row,colid)>
		...
		<tr>
			<td class="paddingTop8">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#999999" class="table_cream">
                    ...
                    <tr>
                        <td align="center" class="blueBold">저축(연금)유형</td>
                        <td class="padding2423" align="left">
                        ...
                        <td align="center" class="blueBold">저축(연금)구분</td>
                        <td class="padding2423">
                            <select id="cmbPEN_GUBUN_CD" style="width=100%">  
                                    <option value="11">확정기여형(DC)</option>
                                    <option value="12">개인형(IRP)</option>                              
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr align="center">
                    <td>
					<comment id="__NSID__">
					<object id="grdT_AC_PENSION" classid="clsid:EA8B6EE6-3DD8-4534-B4BB-27148CF0042B" style="width:900px;height:350px;">
						...
						<param name="Format" 						value='
                            ...
                            <C> id="PEN_GUBUN_NM"		width=150	name="저축구분명"		   	 		align=center  Value={decode(PEN_GUBUN_CD,11,"확정기여형(DC)",12,"개인형(IRP)",21,"개인연금저축",22,"연금저축",31,"청약저축",32,"주택청약종합저축",34,"근로자주택마련저축",51,"장기집합투자증권저축")} SumBgColor=#C3D0DB </C>
                            ...
                            <C> id="ACC_NO"				width=130	name="계좌번호"		        	align=center  SumBgColor=#C3D0DB </C>
                          	...
                          	<C> id="IN_GB"				width=110	name="구분"	            		align=center	  RightMargin="10" SumBgColor=#C3D0DB SumText=@sum  Value={decode(IN_GB, 1,"회사입력")}  </C>
						'>
					</object>
