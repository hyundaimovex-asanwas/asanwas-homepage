    ...
    ***************************************************************************************-->
    ...
    <script language="javascript">
        ...
        function fnc_OnLoadProcess() {
            ...
            //년도 초기화
            document.getElementById("txtPIS_YM").value = '2015-12';
        ...
        function fnc_proc3() {
			...
			//트랜잭션 전송
			trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
			trT_CP_WORKLOG.Action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca090.cmd.YACA090CMD&S_MODE=PROC3_142";
			trT_CP_WORKLOG.Post();
        }
        ...
        function fnc_proc6() {
			...
			//트랜잭션 전송
			trT_CP_WORKLOG.KeyValue = "SVL(I:SAV=dsT_CP_WORKLOG)";
			trT_CP_WORKLOG.Action = "../../../servlet/GauceChannelSVL?cmd=Ehr.yac.a.yaca090.cmd.YACA090CMD&S_MODE=PROC6_142";
			trT_CP_WORKLOG.Post();
        }
