...
<comment id="__NSID__">
              ...
              <param name="hnwsrc"    VALUE="ymaa040.hnw">
              <param name="initvalue" VALUE="[:PIS_YYMM_SHR]=<%=PIS_YYMM_SHR%>[:OCC_CD_SHR]=<%=OCC_CD_SHR%>[:SORT_SHR]=<%=SORT_SHR%>[:TITLE_VAL]=<%=TITLE_VAL%>[:GBN_VAL]=<%=GBN_VAL%>[:GBN_HEADER]=<%=GBN_HEADER%>[:OCC_CD_VAL]=<%=OCC_CD_VAL%>">
