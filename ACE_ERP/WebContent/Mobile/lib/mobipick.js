...
(function($, undefined) {
    $.widget("sustainablepace.mobipick", $.mobile.widget, {
        ...
        _bindEvents: function() {
            ...
            p.find(".mobipick-clear").off().on("tap", clear);
        ...
        _setOption: function(key, val) {
            switch (key) {
                ...
                case "intlStdDate":
                    ...
                    break;
                case "locale":
                    this.options[key] = this._isValidLocale(val) ? val : "kr";
                    break;
                default:
                    // Do not update view!
        ...
        // View
        //
        _markup: "<div class='mobipick-main'><div class='mobipick-date-formatted'>Date</div><ul class='mobipick-groups'><li><ul><li><a class='mobipick-next-year'>+</a></li><li><input type='text' class='mobipick-input mobipick-year' /></li><li><a class='mobipick-prev-year'>-</a></li></ul></li><li><ul><li><a class='mobipick-next-month'>+</a></li><li><input type='text' class='mobipick-input mobipick-month' /></li><li><a class='mobipick-prev-month'>-</a></li></ul></li></li><li><ul><li><a class='mobipick-next-day'>+</a></li><li><input type='text' class='mobipick-input mobipick-day' /></li><li><a class='mobipick-prev-day'>-</a></li></ul></ul><ul class='mobipick-buttons'><li><a class='mobipick-set'>Set</a></li><li><a class='mobipick-clear'>Clear</a></li><li><a class='mobipick-cancel'>Cancel</a></li></ul></div>",
        ...
        _updateView: function() {
            ...
            p.find(".mobipick-clear").text(locale.clear || "Clear");
