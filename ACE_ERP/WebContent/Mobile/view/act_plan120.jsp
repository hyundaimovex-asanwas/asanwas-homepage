...
jui.ready([ "grid.xtable" ], function(xtable) {
        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan121.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
					
				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan122.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan123.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
					
				}else if(e.index == "3"){
					
					var url = "/Mobile/view/act_plan124.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "4"){
					
					var url = "/Mobile/view/act_plan125.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");					

				}else if(e.index == "5"){
					
					var url = "/Mobile/view/act_plan126.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "6"){
					
					var url = "/Mobile/view/act_plan127.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");										   	
    ...
    xtable_1_submit = function() {
		...
		result.push({ folder_name : "관광요금"});
		result.push({ folder_name : "홈페이지"});
		result.push({ folder_name : "영업채널"});
		result.push({ folder_name : "사전예약고객"});
		result.push({ folder_name : "전산"});
		result.push({ folder_name : "홍보"});
		result.push({ folder_name : "시범관광"});
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/act_plan120.jsp"> 
