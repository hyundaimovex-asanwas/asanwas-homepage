        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan161.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");														   	

				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan162.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");					   	
				   	
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan163.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
				   	
				}else if(e.index == "3"){
					
					var url = "/Mobile/view/act_plan164.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");					   	
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/act_plan160.jsp"> 
