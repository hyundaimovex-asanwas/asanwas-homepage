        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan221.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
					
				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan222.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan223.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
					
				}else if(e.index == "3"){
					
					var url = "/Mobile/view/act_plan224.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "4"){
					
					var url = "/Mobile/view/act_plan225.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");					

				}else if(e.index == "5"){
					
					var url = "/Mobile/view/act_plan226.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/act_plan220.jsp"> 
