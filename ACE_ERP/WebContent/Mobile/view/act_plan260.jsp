...
jui.ready([ "grid.xtable" ], function(xtable) {
        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan261.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
					
				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan262.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan263.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
					
				}else if(e.index == "3"){
					
					var url = "/Mobile/view/act_plan264.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
    ...
    xtable_1_submit = function() {
		...
		result.push({ folder_name : "조직"});
		result.push({ folder_name : "남측 인력"});
		result.push({ folder_name : "북측 인력"});
		result.push({ folder_name : "관광 자회사"});
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/act_plan260.jsp"> 
