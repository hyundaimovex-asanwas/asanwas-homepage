...
jui.ready([ "grid.xtable" ], function(xtable) {
        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan301.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
					
				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan302.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan303.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
    ...
    xtable_1_submit = function() {
		...
		result.push({ folder_name : "사전준비"});
		result.push({ folder_name : "시설점검"});
		result.push({ folder_name : "개보수"});
