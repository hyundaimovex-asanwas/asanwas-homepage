...
jui.ready([ "grid.xtable" ], function(xtable) {
        ...
        event: {
       	 ...
       	 click:function(e){ 
				...
				if(e.index == "0"){
					...
					var url = "/Mobile/view/act_plan321.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
					
				}else if(e.index == "1"){
					
					var url = "/Mobile/view/act_plan322.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "2"){
					
					var url = "/Mobile/view/act_plan323.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						

				}else if(e.index == "3"){
					
					var url = "/Mobile/view/act_plan324.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
					
				}else if(e.index == "4"){
					
					var url = "/Mobile/view/act_plan325.jsp";
				   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");					   	
    ...
    xtable_1_submit = function() {
		...
		result.push({ folder_name : "송악프라자"});
		result.push({ folder_name : "한누리주유소"});
		result.push({ folder_name : "건설지원"});
		result.push({ folder_name : "LPG 가스판매"});
		result.push({ folder_name : "외부용역"});
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/act_plan320.jsp"> 
