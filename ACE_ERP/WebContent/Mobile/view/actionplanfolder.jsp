        ...
        event: {
			       	 ...
			       	 click:function(e){ 
							...
							if(e.index == "0"){
								...
								var url = "/Mobile/view/act_plan010.jsp";
							   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");							
			
							}else if(e.index == "1"){
								
								var url = "/Mobile/view/act_plan020.jsp";
							   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
								
							}else if(e.index == "2"){
								
								var url = "/Mobile/view/act_plan030.jsp";
							   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
								
							}else if(e.index == "3"){
								
								var url = "/Mobile/view/act_plan040.jsp";
							   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");	
								
							}else if(e.index == "4"){
								
								var url = "/Mobile/view/act_plan050.jsp";
							   	window.open(url,"memoRead_from","scrollbars=yes,toolbar=no,location=no,directories=yes");						
...
<form name="movForm" id="movForm" method="post" action="/Mobile/view/actionplanfolder.jsp"> 
