...
//주민번호 입력시 자동설정 - 경로우대, 자녀, 형제
	...
	if(colid =="RESINO1"){
		...
		//직계비속은 89년 이하
		if( ds3.namevalue(row, "RELAT1") == "4" || ds3.namevalue(row, "RELAT1") == "5" || ds3.namevalue(row, "RELAT1") == "8"){	
	  ...
	  <TABLE cellSpacing=1 cellPadding=3 width=1003 bgColor=#666666 border=0>
        ...
        <TR align=CENTER>
          ...
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CP11000" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CP12000" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
          ...
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CNTAXSUM" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
          ...
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CP42000" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CPENAMT01" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CINSAMT01" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
			...
			<%=HDConstant.COMMENT_END%></TD>
          <TD bgColor=#ffffff><%=HDConstant.COMMENT_START%>
			<object id="CINSAMT02" style= "position:relative;left:0px;top:2px;width:85px;" classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F class="input00">
					<param name=Text 		value="0">
					<param name=Alignment 	value=2>
					<param name=Numeric		value="true">
					<param name=Border	 	value="false">		
      ...
      <TABLE cellSpacing=1 cellPadding=3 width=1003 border=0>
        ...
        <TR>
          <TD width=900><FONT color=#3366ff>&nbsp;&nbsp;☞ 주의사항 
            ...
            <BR>&nbsp;&nbsp;&nbsp;※&nbsp;관계 : 
            위탁아동이 부양가족에 추가되었습니다. 동거입양자는 직계비속자녀, 위탁아동은 위탁아동에 포함 됩니다.
            </FONT>
		  </TD>
...
<!--
          <TD ><FONT color=#3366ff><B>작년 연말정산과 비교하여  인적 공제 항목에 가족 사항 변동이 없으신 분만 체크바랍니다.<br>
		  (인적공제  항목이 전년과 동일한 경우에는 주민등록표등본을 제출하지 않아도 됩니다.)</B>
		  <input type="checkbox" id=chk_p01   value="1" style="position:relative;top:3px;">
		  </FONT>
		  </TD> 
-->
...
<OBJECT id=gr3  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH: 1003px; HEIGHT: 300px;border:1 solid #777777;display:;" viewastext>
	...
	<G> name='인적사항'	
		<C> Name='관계'		ID=RELAT1	HeadAlign=Center align=center   Width=87  EditStyle=Combo
		 Data='0:본인,1:직계존속,2:배우직계,3:배우자,4:직계비속자녀,5:직계비속자녀외,6:형제자매,7:수급자,8:위탁아동'</C>
      ...
      <TABLE cellSpacing=1 cellPadding=3 width=1003 align=center bgColor=#666666  border=2>
       ...
       <TR bgColor=#ffedd2>
        ...
        <TR>
		  ...
		  <comment id="__NSID__">
			<object id=gcra_houseyn classid=CLSID:754F3DC4-0C79-4C92-AD64-A806D8FF2AB0
        ...
        <TR>
		  <TD align=CENTER bgColor=#ffedd2 rowSpan=13>기<BR>타<BR>소<BR>득<BR>공<BR>제</TD>
          <TD align=CENTER bgColor=#fff8ee rowSpan=8>연금
