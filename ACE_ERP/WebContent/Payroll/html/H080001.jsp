...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:	계약직/한국인기본정보
+ 프로그램 ID	: H080001.HTML
+ 기 능 정 의	: 조회|저장|등록|삭제|출력|사진
+ 변 경 이 력	: 정영식 ( 사번변경)
+ 서 블 릿 명	: h080001_s0, h080001_s1, h080001_s2, h080001_s3,	h080001_s4, 
...
function ln_Before(){
	...
	//재직구분
	gcds_srh1.DataID = "/servlet/Person.hclcode_s1?v_str1=1121";
	gcds_srh1.Reset();

	//소속코드 조회조건
	gcds_srh2.DataID = "/servlet/Person.hcdept_s1?v_str1=";
	gcds_srh2.Reset();
	
		//소속코드 조회조건
	gcds_srh3.DataID = "/servlet/Person.hcdept_s3?v_str1=";
	gcds_srh3.Reset();
	...
	//소속-팀 조회
	gcds_deptlevel.DataID = "/servlet/Person.hcdept_s1?v_str1=";
	...
	//직책코드
	gcds_jobgrph.DataID = "/servlet/Person.hclcode_s1?v_str1=2038";
	gcds_jobgrph.Reset();

	//학력코드
	gcds_edccd.DataID = "/servlet/Person.hclcode_s1?v_str1=1115";
	gcds_edccd.Reset();

	//입사코드
	gcds_empdiv.DataID = "/servlet/Person.hclcode_s1?v_str1=1119";
	gcds_empdiv.Reset();

	gcds_empdiv2.DataID = "/servlet/Person.hclcode_s1?v_str1=1119";
	gcds_empdiv2.Reset();
	...
	//은행코드
	gcds_paybnkcd.DataID = "/servlet/Person.hclcode_s1?v_str1=1411";
	gcds_paybnkcd.Reset();

	//호주관계코드
	gcds_hdfamret.DataID = "/servlet/Person.hclcode_s1?v_str1=1132";
	gcds_hdfamret.Reset();

	//사내연고 직위코드
	//gcds_relatgrd.DataID = "/servlet/Person.hclcode_s1?v_str1=2002";
	//gcds_relatgrd.Reset();

	//추천인 직위코드
	//gcds_nomingrd.DataID = "/servlet/Person.hclcode_s1?v_str1=2002";
	//gcds_nomingrd.Reset();

	//사내연고 관계코드
	//gcds_relatre.DataID = "/servlet/Person.hclcode_s1?v_str1=1132";
	//gcds_relatre.Reset();

	//추천인 관계코드
	//gcds_nominre.DataID = "/servlet/Person.hclcode_s1?v_str1=1132";
	//gcds_nominre.Reset();

	//보훈대상자코드
	gcds_mrtdiv.DataID = "/servlet/Person.hclcode_s1?v_str1=1135";
	gcds_mrtdiv.Reset();

	//채용구분
	gcds_recdiv.DataID = "/servlet/Person.hclcode_s1?v_str1=2035";
	gcds_recdiv.Reset();

	//직종
	gcds_jobkind.DataID = "/servlet/Person.hclcode_s1?v_str1=2037";
	gcds_jobkind.Reset();
...
function ln_Query(){
	...
	gcds_data00.DataID = "/servlet/Contract.h080001_s1?"
...
function ln_FamQuery() {
	gcds_data02.DataID = "/servlet/Contract.h080001_s2?"
...
function ln_CarQuery() {
	...
	gcds_data03.DataID = "/servlet/Contract.h080001_s3?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data03.Reset();
}
...
function ln_LicQuery() {
	...
	gcds_data04.DataID = "/servlet/Contract.h080001_s4?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data04.Reset();
}
...
function ln_EduQuery() {
	...
	if (gcds_hieduc.countrow<1) {
		//학력
		gcds_hieduc.DataID = "/servlet/Person.hclcode_s1?v_str1=1115";
		gcds_hieduc.Reset();

		//전공
		gcds_pieduc.DataID = "/servlet/Person.hclcode_s1?v_str1=1129";
		gcds_pieduc.Reset();

		//졸업구분
		gcds_gieduc.DataID = "/servlet/Person.hclcode_s1?v_str1=1118";
		gcds_gieduc.Reset();
	}

	gcds_data05.DataID = "/servlet/Contract.h080001_s5?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data05.Reset();
...
function ln_AssQuery() {
	...
	if (gcds_assret.countrow<1) {
		//관계코드
		gcds_assret.DataID = "/servlet/Person.hclcode_s1?v_str1=1132";
		gcds_assret.Reset();

		//장애구분
		//gcds_disdiv.DataID = "/servlet/Person.hclcode_s1?v_str1=1135";
		//gcds_disdiv.Reset();

		//장애등급
		gcds_disgrd.DataID = "/servlet/Person.hclcode_s1?v_str1=1146";
		gcds_disgrd.Reset();

		//색맹
		gcds_colblnyn.DataID = "/servlet/Person.hclcode_s1?v_str1=2022";
		gcds_colblnyn.Reset();
	}

	gcds_data06.DataID = "/servlet/Contract.h080001_s6?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno")
									 + "&v_str2=A";
	gcds_data06.Reset();
	...
	if (gcds_milidiv.countrow<1) {
		...
		//군별
		gcds_milispec.DataID = "/servlet/Person.hclcode_s1?v_str1=1116";
		gcds_milispec.Reset();

		//역종
		gcds_militype.DataID = "/servlet/Person.hclcode_s1?v_str1=1133";
		gcds_militype.Reset();

		//제대구분
		gcds_militgbn.DataID = "/servlet/Person.hclcode_s1?v_str1=2021";
		gcds_militgbn.Reset();
		
	}

	//병무사항
	gcds_data052.DataID = "/servlet/Contract.h080001_s6?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno")
									 + "&v_str2=B";
	gcds_data052.Reset();
...
function ln_OrdQuery() {
	...
	if (gcds_ordcd.countrow<1) {
		//발령구분
		gcds_ordcd.DataID = "/servlet/Person.ordcode_s1";
		gcds_ordcd.Reset();
...
function ln_ReqQuery() {
	gcds_data10.DataID = "/servlet/Contract.h080001_s9?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data10.Reset();
...
function ln_RewQuery() {
	if (gcds_rewgbn.countrow<1){
		//상벌구분
		gcds_rewgbn.DataID = "/servlet/Person.hclcode_s1?v_str1=2030";
		gcds_rewgbn.Reset();

		//상벌종류
		gcds_rewkin.DataID = "/servlet/Person.hclcode_s1?v_str1=2031";
		gcds_rewkin.Reset();
	}

	gcds_data11.DataID = "/servlet/Contract.h080001_s11?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data11.Reset();
}
		...
		if(ln_Chk()){
			...
			if (confirm("해당 입력정보를 저장하겠습니까 ?")) {
				if (e=="00") {
					...
					gctr_data.Action = "/servlet/Contract.h080001_t1";
...
function ln_Print(){
	if (gcds_data00.countrow<1){
		...
		gcds_report1.DataID = "/servlet/Contract.h080001_s5?v_str1=" + ls_msdata;
		gcds_report1.Reset();

		gcds_report2.DataID = "/servlet/Contract.h080001_s3?v_str1=" + ls_msdata;
		gcds_report2.Reset();

		gcds_report3.DataID = "/servlet/Contract.h080001_s2?v_str1=" + ls_msdata;
		gcds_report3.Reset();

		gcds_report4.DataID = "/servlet/Contract.h080001_s4?v_str1=" + ls_msdata;
		gcds_report4.Reset();

		gcds_report5.DataID = "/servlet/Contract.h080001_s7?v_str1=" + ls_msdata;
		gcds_report5.Reset();

		gcds_report6.DataID = "/servlet/Contract.h080001_s8?v_str1=" + ls_msdata;
		gcds_report6.Reset();

		gcds_report7.DataID = "/servlet/Contract.h080001_s9?v_str1=" + ls_msdata;
		gcds_report7.Reset();

		gcds_report8.DataID = "/servlet/Contract.h080001_s0?v_str1=" + ls_msdata;
		gcds_report8.Reset();

		gcds_report9.DataID = "/servlet/Contract.h080001_s11?v_str1=" + ls_msdata;
		gcds_report9.Reset();
...
//  성별 아랫줄!
	...
	ls_for += "	<I>id='"+rDOMAIN+"/servlet/Contract.h080001_s0?v_str1="+e+"' ,left=1 ,top=207 ,right=332 ,bottom=526</I>																																																	";
	...
	ls_for += "	<C>id='EMPNO', left=1606, top=211, right=1835, bottom=266, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                              ";
	...
	ls_for += "	<C>id='STRTDT',		 left=529, top=466, right=863, bottom=521, align='left' ,mask='XXXX/XX/XX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>           ";
	ls_for += "	<C>id='TODT',  left=1169,top=466, right=1409,bottom=521, align='left' ,mask='XXXX/XX/XX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>           ";
	ls_for += "	<C>id='ENDDT', left=1606, top=467, right=1835, bottom=522, align='left' ,mask='XXXX/XX/XX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>           ";
	//승진일
	//ls_for += "	<C>id='ORDDT',	left=1169, top=402, right=1409, bottom=458, align='left' ,mask='XXXX/XX/XX', face='굴림', size=10, //bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>          ";
	...
	ls_for += "	<T>id='" + ls_t + "', left=1606 ,top=401 ,right=1896 ,bottom=459 ,align='left' ,mask='XXXX/XX/XX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</T>    ";

	var ls_val0 = "";		//성별
	if (gcds_report0.namevalue(1,"SEX") =="1") ls_val0 += "남자"; else ls_val0 += "여자";
	ls_for += "	<T>id='"+ls_val0+"', left=1606 ,top=274 ,right=1641 ,bottom=332 ,align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</T>												";
	//계약구분
	ls_for += "	<C>id='GYGB' ,left=1606 ,top=340 ,right=1835 ,bottom=393 ,align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</T>		";
	...
	var ls_val2 = "";		//호봉
	ls_val2 = gcem_payseq.text + " 호";
	ls_for += "<T>id='" + ls_val2 + "' ,left=1811 ,top=274 ,right=1898 ,bottom=332 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>											";
	...
	//현주소
	ls_for += "	<C>id='CADDRNM', left=487, top=566, right=1891, bottom=622, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>                             ";
	//본적주소 OADDRNM
	...
	ls_for += "	<T>id='사  번' ,left=1422 ,top=211 ,right=1572 ,bottom=266 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>																	 ";
	ls_for += "	<T>id='성  별' ,left=1422 ,top=274 ,right=1572 ,bottom=332 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>																";	
	ls_for += "	<I>id='"+rDOMAIN+"/Common/img/iconlogo.jpg' ,left=703 ,top=63 ,right=776 ,bottom=123</I>																																																												";
	ls_for += " <T>id='호  봉' ,left=1693 ,top=274 ,right=1796 ,bottom=332 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>															 " ;
	ls_for += "	<T>id='人 事 記 錄 表'	,left=25 ,top=19 ,right=1999 ,bottom=122 ,face='굴림' ,size=22 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>                                 ";
	...
	ls_for += "	<T>id='입사일'	,left=339		,top=466 ,right=513		,bottom=521 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>                                    ";
	...
	ls_for += "	<T>id='직  종' ,left=1422 ,top=401 ,right=1572 ,bottom=459 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>				                                    ";
	ls_for += "	<T>id='계약만료일'			,left=975		,top=466 ,right=1150	,bottom=521 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>                                    ";
	...
	ls_for += "	<T>id='무기계약' ,left=1422 ,top=340 ,right=1572 ,bottom=393 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>															  ";
	ls_for += "	<T>id='퇴사일' ,left=1422 ,top=467 ,right=1572 ,bottom=522 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>								                                 ";
...
<!-- <script language="javascript" for="gcds_empdiv" event="onloadCompleted(row,colid)">
	gcds_empdiv.DeleteRow(1);	//별정직
	gcds_empdiv.DeleteRow(2);	//정규직	
	gcds_empdiv.DeleteRow(1);	//재중동포기능직
	gclx_empdiv.index = 0;
</script> -->
...
<script language="javascript" for="gcds_empdiv2" event="onloadCompleted(row,colid)">
  ...
  gcds_empdiv2.insertrow(1);
	...
	gcds_empdiv2.namevalue(1,"MINORNM") = "전체";
	...
	<tr>
		<td cellpadding="0" cellspacing="0" valign="top" style="padding-left:3px;">
			<table height="0" border="0" cellpadding="0" cellspacing="0" style="border:0 solid #708090;border-left-width:1px;border-top-width:1px">
				...
				<tr height="40px">
					<td width="120px;" class="tab11" bgcolor="#eeeeee">입사<br>구분</td>
					<td width="100px;" class="tab21">
				...
				<tr height="35px">
					<td class="tab11" bgcolor="#eeeeee">사번</td>
				...
				<tr>
		            ...
		            <param name=dataid					value=gcds_data00>
						...
						</fieldset><BR><a href="javascript:document.all.gcgd_disp.RunExcel('관광고객조회');	//시트명을 입력합니다.">액셀</a>
					</td>
        </tr>
      </table>
	  </td>
		<td width=80%  height="0" valign="top">
			<table border="0" cellpadding=0 cellspacing=0 style="position:relative;left:4px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
				              ...
				              <td class="tab11" width="80px;" bgcolor="#eeeeee">주민번호</td>
					            <td class="tab21" width="120px">
												<comment id="__NSID__"><OBJECT id=gcem_resino classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
													style="position:relative; left:8px;top:1px; width:92px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
		                  ...
		                  <td class="tab11" width="80px" bgcolor="#eeeeee">생년월일</td>
			                <td class="tab22" width="75px">
												<comment id="__NSID__"><OBJECT id=gcem_birdt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
													style="position:relative; left:8px;top:1px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
														<param name=Alignment			value=0>
														<param name=Border	      value=true>
                ...
                <td class="tab11" bgcolor="#eeeeee">호봉</td>
                <td class="tab22">
                    ...
                    <tr> 
                      ...
                      <td class="tab21" width="98px">
											...
											<td class="tab11" width="80px;" bgcolor="#eeeeee">직책</td>
											...
											<td class="tab21" width="120px">
												<comment id="__NSID__"><OBJECT id=gclx_empdiv classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 
													style="position:relative;left:8px;top:1px;font-size:12px;width:100px;">
														...
														<param name=CBData					value=" ^ ,3^한국인계약직,4^파견계약직,6^파견,7^파견계약직-아르바이트">
														<param name=CBDataColumns		value="MINORCD, MINORNM">
														<param name=SearchColumn		value=MINORNM>
                      ...
                      <td class="tab12" width="80px;" bgcolor="#eeeeee">계약만료일</td>
		            ...
		            <PARAM NAME="DisableBackColor"	VALUE="#eeeeee">
								<PARAM NAME="Format"						VALUE="
								  ...
								  <T>divid=layer11 title='상벌관리'</T>
									<T>divid=layer8  title='어학/전산' show=false</T>
								">
						</OBJECT></comment><script>__ws__(__NSID__);</script>
					</td>
				</tr>
  ...
  <table style="border:1 solid #708090;border-bottom-width:0px;" cellpadding=0 cellspacing=0 border=0 >
  	  ...
  	  <td class="tab21" width="100px">
				<comment id="__NSID__"><OBJECT id=gcem_czipcd classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
					style="position:relative; left:5px;top:2px; width:50px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
						<param name=Alignment			value=0>
						<param name=Border	      value=true>
				...
				<img alt=우편번호조회  id='img_search1' name='img_search1' style="position:relative;left:7px;top:2px;cursor:hand" src='../../Common/img/btn/com_b_search.gif'  onclick="ln_Popup('c')">
			</td>
	...
	<table style="position:relative;top:4px;border:1 solid #708090;border-bottom-width:0px;" cellpadding=0 cellspacing=0 border=0 >
		<tr>
			<td class="tab11" width="75px" bgcolor="#eeeeee">기타사항</td>
			...
			<td class="tab11" width="81px" bgcolor="#eeeeee">종교</td>
		...
		<tr>
			...
			<td class="tab21">
				<comment id="__NSID__"><OBJECT id=gcem_mrydt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
					style="position:relative; left:8px;top:2px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
						<param name=Alignment			value=0>
						<param name=Border	      value=true>
						<param name=Format	      value="YYYY/MM/DD">
						<param name=PromptChar	  value="_">
			...
			<td class="tab21">
				<comment id="__NSID__"><OBJECT id=gcem_inscod classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
					style="position:relative; left:8px;top:2px; width:40px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
						<param name=Alignment			value=2>
						<param name=Border	      value=true>
						<param name=Numeric	      value=true>
		...
		<tr>
			...
			<td class="tab21" width="115px">
				<comment id="__NSID__"><OBJECT id=gcem_payacnt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
					style="position:relative; left:8px;top:1px; width:100px; height:20px; font-family:굴림; fontsize:9pt;z-index:2; " class=txtbox>
						<param name=Alignment			value=0>
						<param name=Border	      value=true>
			...
			<td class="tab11" width="80px" bgcolor="#eeeeee">무기계약</td>
		  ...
		  <td style="width:697;border:0 solid #708090;border-top-width:1px" colspan="2">
            ...
            <param name=dataid					value=gcds_data02>
						...
						<param name=format          value='
							...
							<C> Name=관계			ID=REFCD		HeadAlign=Center HeadBgColor=#B9D4DC Width=67,	align=left,		EditStyle=Lookup, Data="gcds_hdfamret:minorcd:minornm"</C> 
							...
							<F> Name=주민번호 ID=RESINO		HeadAlign=Center HeadBgColor=#B9D4DC Width=100, align=center	MASK="XXXXXX-XXXXXXX"</F> 
						 	<C> Name=학력			ID=LSTEDC		HeadAlign=Center HeadBgColor=#B9D4DC Width=80,	align=left,		EditStyle=Lookup, Data="gcds_edccd:minorcd:minornm" </C> 
							...
							<C> Name=부양			ID=SPTYN		HeadAlign=Center HeadBgColor=#B9D4DC Width=57,	align=center,	EditStyle=combo,	Data="1:부양,2:피부양"</C> 
							...
							<C> Name=수당			ID=PAYYN		HeadAlign=Center HeadBgColor=#B9D4DC Width=42		align=center,	EditStyle=combo,	Data="1:유,2:무"</C> 
						'>
			  </OBJECT></comment><script>__ws__(__NSID__);</script>
		  ...
		  <td style="width:697;border:0 solid #708090;border-top-width:1px" colspan="2">
            ...
            <param name=dataid					value=gcds_data03>
						...
						<param name=format          value='
							...
							<C> Name=회사명			ID=CAPLACE	HeadAlign=Center HeadBgColor=#B9D4DC Width=154 Align=left</C> 
							<C> Name=직위명			ID=POSINM		HeadAlign=Center HeadBgColor=#B9D4DC Width=100  Align=left</C> 
							<C> Name=담당업무		ID=DUTYNM		HeadAlign=Center HeadBgColor=#B9D4DC Width=150 Align=left</C>
							<C> Name=퇴직사유		ID=REMARK		HeadAlign=Center HeadBgColor=#B9D4DC Width=100 Align=left</C>
						'> 
				</OBJECT></comment><script>__ws__(__NSID__);</script>
				<fieldset style="width:700;height:20px;border:0 solid #708090;border-top-width:1px;text-align:left;">
		  ...
		  <td style="width:697;border:0 solid #708090;border-top-width:1px" colspan="2">
            ...
            <param name=dataid					value=gcds_data04>
						...
						<param name=format          value='
							...
							<C> Name=증번호   ID=LCSNO		HeadAlign=Center HeadBgColor=#B9D4DC Width=110	align=center </C> 
							<C> Name=발행처   ID=ISSPART	HeadAlign=Center HeadBgColor=#B9D4DC Width=170	align=left </C> 
            ...
            <param name=dataid					value=gcds_data05>
						...
						<param name=format          value='
							...
							<G> Name=교육기간 HeadBgColor=#B9D4DC
								<C> Name=입학년도 ID=STRYY	HeadAlign=Center HeadBgColor=#B9D4DC Width=80, align=center</C> 
								<C> Name=졸업년도 ID=GRAYY	HeadAlign=Center HeadBgColor=#B9D4DC Width=80, align=center</C> 
							</G>
							<C> Name=학교명		ID=SCHNM	HeadAlign=Center HeadBgColor=#B9D4DC Width=195 </C> 
							<C> Name=학력			ID=EDCCD	HeadAlign=Center HeadBgColor=#B9D4DC Width=95		EditStyle=Lookup, data="gcds_hieduc:minorcd:minornm" </C> 
							<C> Name=전공			ID=PGCCD	HeadAlign=Center HeadBgColor=#B9D4DC Width=119	Editstyle=LookUp, data="gcds_pieduc:minorcd:minornm"</C> 
							<C> Name=학위			ID=EDCDIV HeadAlign=Center HeadBgColor=#B9D4DC Width=85		Editstyle=LookUp, data="gcds_gieduc:minorcd:minornm"</C> 
            '>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
				<fieldset style="width:700;height:20px;border:0 solid #708090;border-top-width:1px;text-align:left;">
					&nbsp;<font id=ft_cnt4 style="position:relative;top:4px;"></font>
		...
		<tr>	
			<td colspan="3">
								...
								<tr>
									<td width="100px;" height="25px">&nbsp;
										<comment id="__NSID__"><OBJECT id=gcem_afrdt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
											style="position:relative; left:1px;top:2px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
												<param name=Alignment			value=0>
												<param name=Border	      value=true>
												<param name=Format	      value="YYYY/MM/DD">
												<param name=PromptChar	  value="_">
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<!--
					<tr>
						<td class="tab11" width="75px" bgcolor="#eeeeee">인보증</td>
						<td class="tab11" width="75px" bgcolor="#eeeeee">성명</td>
						...
						<td class="tab11" width="75px" bgcolor="#eeeeee">주민번호</td>
					...
					<tr>
						<td class="tab11" >&nbsp;</td>
						<td class="tab11" bgcolor="#eeeeee">연락처</td>
						...
						<td class="tab22" colspan="3">
							<comment id="__NSID__"><OBJECT id=gcem_asspostno classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:8px;top:3px; width:50px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
									<param name=Format	      value="000-000">
									<param name=PromptChar	  value="_">
					...
					<tr>
						...
						<td class="tab21" width="145px" >
							<comment id="__NSID__"><OBJECT id=gcem_assno classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:8px;top:1px; width:128px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
									<param name=Format	      value="00000000000000000000">
									<param name=PromptChar	  value="_">
						...
						<td class="tab22" width="95px">
							<comment id="__NSID__"><OBJECT id=gcem_recpamt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:8px;top:1px; width:82px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
									<param name=Numeric	      value=true>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="tab21" width="150px;">
							<comment id="__NSID__"><OBJECT id=gcem_height classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:8px;top:2px; width:25px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
									<param name=Numeric	      value=true>
							...
							<comment id="__NSID__"><OBJECT id=gcem_weight classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:20px;top:2px; width:25px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
									<param name=Numeric	      value=true>
									<param name=Maxlength     value="3">
						...
						<td class="tab22" width="220px;">
							...
							<comment id="__NSID__"><OBJECT id=gcem_eyel classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:12px;top:2px; width:25px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment				value=0>
									<param name=Border					value=true>
									<param name=PromptChar			value="_">
                  ...
                  <param name=MaxDecimalPlace value=1>
							...
							<comment id="__NSID__"><OBJECT id=gcem_eyer classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
								style="position:relative; left:21px;top:2px; width:25px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment				value=0>
									<param name=Border					value=true>
									<param name=PromptChar			value="_">
									<param name=MaxLength       value=2>
		  ...
		  <td style="border:0 solid #708090;border-top-width:1px" colspan="3">
								...
								<tr>
									...
									<td>
										<comment id="__NSID__"><OBJECT id=gcem_militodt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F
											style="position:relative; left:1px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
												<param name=Alignment			value=0>
												<param name=Border	      value=true>
												<param name=Format	      value="YYYY/MM/DD">
												<param name=PromptChar	  value="_">
            ...
            <td class="tab22" width="430px" colspan="3">
							<comment id="__NSID__"><OBJECT id=gcem_milino classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F
								style="position:relative; left:8px;top:2px; width:130px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=txtbox>
									<param name=Alignment			value=0>
									<param name=Border	      value=true>
		...
		<tr>
		  <td style="width:697;" style="border:0 solid #708090;border-top-width:1px;" colspan="2">
            ...
            <param name=dataid					value=gcds_data07>
						...
						<param name=format          value='
							<F> Name=NO ID={CurRow}				HeadAlign=Center HeadBgColor=#B9D4DC Width=30,  align=right </F> 
							<F> Name=발령일자		ID=ORDDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=68,	align=center,			MASK="XXXX/XX/XX"</F> 
						 	<C> Name=발령구분		ID=ORDCD	HeadAlign=Center HeadBgColor=#B9D4DC Width=85,	EditStyle=Lookup, Data="gcds_ordcd:ordcd:ordnm" </C> 
							<C> Name=소속				ID=DEPTNM HeadAlign=Center HeadBgColor=#B9D4DC Width=120 </C> 
							<C> Name=직위				ID=PAYGRD HeadAlign=Center HeadBgColor=#B9D4DC Width=80,  EditStyle=Lookup, Data="gcds_deptlvl:minorcd:minornm"</C>
							<C> Name=호봉				ID=PAYSEQ HeadAlign=Center HeadBgColor=#B9D4DC Width=40,	EditStyle=Lookup, Data="gcds_payseq:minorcd:minornm" </C>
							<C> Name=직급				ID=GRDDIV HeadAlign=Center HeadBgColor=#B9D4DC Width=55,	EditStyle=Lookup, Data="gcds_grddiv:minorcd:minornm"</C>
							<C> Name=종료일			ID=ENDDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=68,	align=center,			Mask="XXXX/XX/XX" show=false </C>
							<C> Name=인사적용일	ID=APPDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=68,	align=center,			Mask="XXXX/XX/XX" </C>
							<C> Name=비고	      ID=ETC	  HeadAlign=Center HeadBgColor=#B9D4DC Width=138,	align=left,			</C>
						'>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
					...
					<tr>
						<td>
							<table border="0" cellpadding=0 cellspacing=0  border=0 style="border:0 solid #708090;border-top-width:1px;">
								...
								<!--
								<tr>
									<td class="tab11" width="100px" bgcolor="#eeeeee">영어</td>
									<td class="tab21" width="100px;">
									...
									<td class="tab11" width="85px" bgcolor="#eeeeee">토익</td>
									<td class="tab21" width="80px;">
										<comment id="__NSID__"><OBJECT id=gcem_toescr classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
											style="position:relative; left:8px;top:3px; width:30px; height:17px; font-family:굴림; font-size:9pt;">
												<param name=Alignment			value=0>
								...
								<tr>
									<td class="tab11" bgcolor="#eeeeee">토플</td>
									<td class="tab21">
										<comment id="__NSID__"><OBJECT id=gcem_tofscr classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
											style="position:relative; left:8px;top:3px; width:30px; height:17px; font-family:굴림; font-size:9pt;">
												<param name=Alignment			value=0>
...
<div id="layer9" style="position:absolute; top:330px; left:350px; width:700px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
 ...
 <!-- 1/20일 고과 안보이게 막음, 각 ID=AVG1 , ID=AVG2, ID=AVG3,  ID=GOGAGB -->
		...
		<tr>
		  <td style="width:697;border:0 solid #708090;border-top-width:1px" colspan="2">
            ...
            <param name=dataid					value=gcds_data10>
						...
						<param name=format          value='
							<F> Name=NO					ID={CurRow} HeadAlign=Center HeadBgColor=#B9D4DC Width=30,  align=right </F> 
							<C> Name=시작일			ID=FRDT			HeadAlign=Center HeadBgColor=#B9D4DC Width=80,	align=center, MASK="XXXX/XX/XX"</C>
							<C> Name=종료일			ID=TODT			HeadAlign=Center HeadBgColor=#B9D4DC Width=80,	align=center, MASK="XXXX/XX/XX"</C>
							<C> Name=교육일수,	ID=EDUDAY		HeadAlign=Center HeadBgColor=#B9D4DC Width=50,	align=right </C>
							<F> Name=교육과정		ID=SUBJECT	HeadAlign=Center HeadBgColor=#B9D4DC Width=160,	align=left</F> 
						 	<C> Name=교육기관		ID=EDUINST	HeadAlign=Center HeadBgColor=#B9D4DC Width=135,	align=left </C> 
							<C> Name=교육평가		ID=EDUPLC		HeadAlign=Center HeadBgColor=#B9D4DC Width=150, align=left </C> 
						'>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
				<fieldset style="width:700;height:20px;border:0 solid #708090;border-top-width:1px;border-bottom-width:1px;text-align:left;">
...
<!---------[TAB 10] (어학/전산)----------->
	...
	<tr>
		<td class="tab32" height="29px">&nbsp;<b>어학/전산</b></td>
	</tr>
		<tr>
			<td>
				<table border="0" cellpadding=0 cellspacing=0  border=0 style="border:0 solid #708090;border-top-width:1px;">
...
<A>id=Area1 ,left=0,top=0 ,right=2000 ,bottom=135 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='education.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=132 ,DetailDataID=gcds_report1
		<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=129 ,face='굴림' ,size=10 ,penwidth=1
			...
			<T>id='학교명'		,left=475		,top=6	,right=1231 ,bottom=125 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='학  력'		,left=1238	,top=6	,right=1463 ,bottom=125 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=63 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='{CURROW}', left=6,			top=3, right=100,		bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='GRAYY',		left=291,		top=3, right=466,		bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='STRYY',		left=109,		top=3, right=284,		bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='SCHNM',		left=475,		top=3, right=1231,	bottom=59, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='EDCNM',		left=1238,	top=3, right=1463,	bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='PGCNM',		left=1472,	top=3, right=1778,	bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='EDIVNM',		left=1788,	top=3, right=1909,	bottom=59, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
		</B>
	</R>
</A>
...
<A>id=Area5 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='hdcareer.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=65 ,DetailDataID=gcds_report5
		<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=150 ,face='굴림' ,size=10 ,penwidth=1
			...
			<T>id='※ 사 내 경 력' ,left=0 ,top=32 ,right=1691 ,bottom=90 ,align='left' ,face='HY견고딕' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='No' ,left=5 ,top=95 ,right=101 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='소  속' ,left=622 ,top=95 ,right=1138 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='발령구분' ,left=315 ,top=95 ,right=614 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='발령일자' ,left=108 ,top=95 ,right=307 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<X>left=1140 ,top=90 ,right=1400 ,bottom=151 ,backcolor=#B1B1B1 ,border=true ,penstyle=solid ,penwidth=1</X>
			<T>id='직급' ,left=1148 ,top=95 ,right=1397 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<X>left=1394 ,top=90 ,right=1529 ,bottom=151 ,backcolor=#B1B1B1 ,border=true ,penstyle=solid ,penwidth=1</X>
			<T>id='호  봉' ,left=1400 ,top=93 ,right=1524 ,bottom=148 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<X>left=1527 ,top=90 ,right=1910 ,bottom=151 ,backcolor=#B1B1B1 ,border=true ,penstyle=solid ,penwidth=1</X>
			<T>id='비 고' ,left=1532 ,top=95 ,right=1905 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
		</B>
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=53 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='PAYSEQ', left=1402, top=0, right=1527, bottom=53 ,mask='XX호봉'</C>
			<C>id='ETC', left=1529, top=0, right=1905, bottom=53, align='left', face='굴림', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
		</B>
	</R>
</A>
...
<A>id=Area3 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='family.sbt'	,left=0			,top=0			,right=2000 ,bottom=68 ,DetailDataID=gcds_report3
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=56 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id={IF (PAYYN=1,'유','무')}, left=1775, top=0, right=1906, bottom=53</C>
...
<A>id=Area6 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='hdorder.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=65 ,DetailDataID=gcds_report6
		<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=150 ,face='굴림' ,size=10 ,penwidth=1
			...
			<T>id='점  수'		,left=1288	,top=97			,right=1584		,bottom=150		,face='굴림'	,size=10		,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='직  위'		,left=1000	,top=97			,right=1278		,bottom=150		,face='굴림'	,size=10		,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
			<T>id='소  속'		,left=369		,top=97			,right=991		,bottom=150		,face='굴림'	,size=10		,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=50 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='DEPTNM',		left=369,		top=0, right=991,		bottom=50, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='SCRGBN',		left=1591,	top=0, right=1906,	bottom=50, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='SCR',			left=1288,	top=0, right=1584,	bottom=50, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='PAYGNM',		left=1000,	top=0, right=1278,	bottom=50, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='EVAYM',		left=109,		top=0, right=359,		bottom=50 ,mask='XXXX/XX', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{CURROW}', left=6,			top=0, right=100,		bottom=50, face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
		</B>
	</R>
</A>
...
<A>id=Area7 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='hdeduc.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=65 ,DetailDataID=gcds_report7
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=53 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='EDUPLC',		left=1603,	top=0, right=1906,	bottom=53, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
		</B>
	</R>
</A>
