...
function ln_Before(){
	//민족코드
	gcds_people.DataID = "/servlet/Person.hclcode_s1?v_str1=2032";
	gcds_people.Reset();

	//송출대리점
	gcds_agency.DataID = "/servlet/Person.hclcode_s1?v_str1=2033";
	gcds_agency.Reset();

	//직종_재중동포 코드
	gcds_jobdty.DataID = "/servlet/Person.hclcode_s1?v_str1=2036";
	gcds_jobdty.Reset();

	//직종_재중동포 코드2 그리드
	gcds_jobdty2.DataID = "/servlet/Person.hclcode_s1?v_str1=2036";
	gcds_jobdty2.Reset();
