...
+ 기 능 정 의	: 조회,저장,삭제,출력
+ 변 경 이 력	: 
+ 서 블 릿 명	: h080006_s1, h080006_s2, h080006_s3, h080006_s4, h080006_t1
------------------------------------------------------------------------------>
...
******************************************************************************/
function ln_Query(){
	gcds_data.DataID = "/servlet/Contract.h080006_s1?"
									 + "v_str1=" + gcem_fr.text
									 + "&v_str2=" + gcem_to.text
...
function ln_Query2(){
	...
	gcds_data1.DataID = "/servlet/Contract.h080006_s3?"
									 + "v_str1=" + gcem_fr.text
									 + "&v_str2=" + gcem_to.text
									 + "&v_str3=" + gclx_prngbn.BindColVal
									 + "&v_str4=" + txt_nmk.value
...
function ln_InfoQuery(){
	...
	gcds_temp.DataID = "/servlet/Contract.h080006_s4?v_str1="+str1;
	gcds_temp.Reset();
		...
		if (gcds_data.countrow <1) {
			...
			if (gcds_data.IsUpdated ){
				...
				if (confirm("해당 증명서 발급정보를 저장하겠습니까 ?")) {
					...
					gctr_data.KeyValue = "Contract.h080006_t1(I:USER=gcds_data)";
					gctr_data.Action = "/servlet/Contract.h080006_t1";
					gctr_data.post();
				}
			}
		}
...
function ln_Print(){
    ...
    else if (gcds_data.namevalue(row,"CERKIND")=="6") gcrp_print6.preview();	//퇴직증명서
	}	
}
...
<table border="0" cellpadding="0" cellspacing="0" width="876" >
    ...
    <td width="100%" height="30">
			<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px;">
			  <tr> 
					<td width="197" background="../../Common/img/com_t_bg.gif"><IMG height=47 src="../img/h080006_head.gif" width=197></td>
				  ...
				  <td class="tab23" width="172px;">
 						<comment id="__NSID__"><OBJECT id=gclx_prngbn classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69
							style="position:relative;left:8px;top:1px;font-size:12px;width:150px;height:200px;" >
								<param name=CBData					value="^전체,1^재직증명서,2^경력증명서,3^출입국(확인)증명서,4^부임명령서,5^귀국증명서,6^퇴직증명서">
								 		...
								 		width="550" height="437" style="border:1 solid #708090" >
			  							...
			  							<param name=Fillarea      value="true"> 
											...
											<param name=Format        value='
												...
												<C>ID=CERKIND,	Name="발급종류",	width=120px,   align=left,			EditStyle=combo, data="1:재직증명서,2:경력증명서,3:출입국(확인)증명서,4:부임명령서,5:귀국증명서,6:퇴직증명서",   HeadBgColor=#B9D4DC  </C>
												<C>ID=CERTINO,	Name="발급번호",	width=90px,		align=center,		mask="XXXX-TXXXX", HeadBgColor=#B9D4DC	</C>																																							 
										...
										<tr> 
										  <td valign=top align=left >
                  							...
                  							style="position:relative;left:8px;top:0px;font-size:12px;width:150px;height:200px;">
                  								<param name=CBData					value="1^재직증명서,2^경력증명서,3^출입국(확인)증명서,4^부임명령서,5^귀국증명서,6^퇴직증명서">
                  								<param name=CBDataColumns		value="Code, Parm">
                  								<param name=SearchColumn		value="Parm">
                   								<param name=Sort						value="false">
                  								<param name=ListExprFormat	value="Parm^0^150">
...
<comment id="__NSID__"><OBJECT id=gcrp_print1 classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="Landscape"					VALUE="0">
	...
	<C>id='CERTINO', left=38, top=191, right=600, bottom=256, align='left' ,mask='제 XXXX - TXXXX 호', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='경 력 증 명 서' ,left=25 ,top=41 ,right=1959 ,bottom=187 ,face='HY견고딕' ,size=26 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='ENDDT', left=344, top=1503, right=1922, bottom=1569, align='left' ,mask='상기자는 XXXX년 XX월 XX일부로 당사 퇴직하였음을 증명함.', face='굴림', size=14, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
	">
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<comment id="__NSID__"><OBJECT id=gcrp_print2 classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="Landscape"					VALUE="0">
	...
	<L> left=322 ,top=272 ,right=322 ,bottom=1472 </L>
	<L> left=984 ,top=625 ,right=984 ,bottom=962 </L>
	<L> left=1309 ,top=628 ,right=1309 ,bottom=966 </L>
	<L> left=119 ,top=2228 ,right=119 ,bottom=2606 </L>
	<L> left=41 ,top=2416 ,right=359 ,bottom=2416 </L>
	<L> left=38 ,top=2225 ,right=356 ,bottom=2225 </L>
	<C>id='OADDR', left=344, top=334, right=1922, bottom=400, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<C>id='CURDT', left=1319, top=1975, right=1819, bottom=2044, align='right' ,mask='XXXX년 XX월 XX일 ', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CERTINO', left=38, top=191, right=600, bottom=256, align='left' ,mask='제 XXXX - TXXXX 호', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='재 직 증 명 서' ,left=25 ,top=41 ,right=1959 ,bottom=187 ,face='HY견고딕' ,size=26 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주민등록번호' ,left=994 ,top=844 ,right=1306 ,bottom=909 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='직     위' ,left=994 ,top=675 ,right=1306 ,bottom=741 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='확   인' ,left=63 ,top=2150 ,right=334 ,bottom=2216 ,face='굴림' ,size=13 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='담' ,left=44 ,top=2437 ,right=119 ,bottom=2497 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='당' ,left=44 ,top=2528 ,right=119 ,bottom=2587 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자' ,left=44 ,top=2353 ,right=119 ,bottom=2406 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='확' ,left=44 ,top=2237 ,right=119 ,bottom=2291 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<I>id='../../Common/img/new_attampt1.jpg' ,left=1134 ,top=2206 ,right=1863 ,bottom=2503</I>
	<T>id='본     적' ,left=47 ,top=328 ,right=316 ,bottom=394 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주     소' ,left=47 ,top=503 ,right=316 ,bottom=569 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='소     속' ,left=47 ,top=669 ,right=316 ,bottom=734 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='성     명' ,left=47 ,top=837 ,right=316 ,bottom=903 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='용     도' ,left=47 ,top=1012 ,right=316 ,bottom=1078 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='입 사 일' ,left=47 ,top=1178 ,right=316 ,bottom=1244 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='비     고' ,left=47 ,top=1347 ,right=316 ,bottom=1412 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='PAYGNM', left=1334, top=675, right=1925, bottom=741, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='RESINO', left=1334, top=844, right=1925, bottom=909, align='left' ,mask='XXXXXX - XXXXXXX', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='STRTDT', left=344, top=1497, right=1922, bottom=1594, align='left' ,mask='상기자는 XXXX년 XX월 XX일부터 당사에 재직하고 있음을 증명함.', face='굴림', size=14, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
	">
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<comment id="__NSID__"><OBJECT id=gcrp_print3 classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="Landscape"					VALUE="0">
	...
	<T>id='직   위' ,left=988 ,top=675 ,right=1275 ,bottom=741 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주민등록번호' ,left=988 ,top=844 ,right=1275 ,bottom=909 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='출 국 (확인) 증명서' ,left=25 ,top=41 ,right=1959 ,bottom=187 ,face='HY견고딕' ,size=26 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='확   인' ,left=63 ,top=2150 ,right=334 ,bottom=2216 ,face='굴림' ,size=13 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='담' ,left=44 ,top=2437 ,right=119 ,bottom=2497 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='당' ,left=44 ,top=2528 ,right=119 ,bottom=2587 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자' ,left=44 ,top=2353 ,right=119 ,bottom=2406 ,face='굴림' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='PAYGNM', left=1294, top=675, right=1925, bottom=741, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='EMPNMK', left=344, top=844, right=975, bottom=909, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CERDAT', left=344, top=1184, right=1213, bottom=1250, align='left' ,mask='XXXX년 XX월 XX일 ~ XXXX년 XX월 XX일', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CERETC', left=344, top=1353, right=1922, bottom=1419, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CURDT', left=1319, top=1975, right=1819, bottom=2044, align='right' ,mask='XXXX년 XX월 XX일 ', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CADDR', left=344, top=509, right=1922, bottom=575, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='OADDR', left=344, top=334, right=1922, bottom=400, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<C>id='CERTINO', left=38, top=191, right=578, bottom=256, align='left' ,mask='제 XXXX - TXXXX 호', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<I>id='../../Common/img/new_attampt1.jpg' ,left=1134 ,top=2206 ,right=1863 ,bottom=2503</I>
	<T>id='본     적' ,left=44 ,top=328 ,right=319 ,bottom=394 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주     소' ,left=44 ,top=503 ,right=319 ,bottom=569 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='소     속' ,left=44 ,top=669 ,right=319 ,bottom=734 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='부임기간' ,left=44 ,top=1178 ,right=319 ,bottom=1244 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='비     고' ,left=44 ,top=1347 ,right=319 ,bottom=1412 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='상기와 같이 출국 하였음을 증명함.' ,left=344 ,top=1503 ,right=1922 ,bottom=1569 ,align='left' ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
	">
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<comment id="__NSID__"><OBJECT id=gcrp_print4 classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="Landscape"					VALUE="0">
	...
	<C>id='CERTINO', left=138, top=503, right=600, bottom=603, align='left' ,mask='제 XXXX - TXXXX 호', face='굴림', size=14, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<C>id='JOBDTYNM', left=428, top=1569, right=1059, bottom=1634, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ORDDT', left=428, top=1709, right=1428, bottom=1775, align='left' ,mask='XXXX년XX월XX일', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='상기와  같이  부임을  명함' ,left=428 ,top=1850 ,right=1428 ,bottom=1950 ,align='left' ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
	">
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<comment id="__NSID__"><OBJECT id=gcrp_print5 classid=CLSID:37D13B2F-E5EB-11D2-973D-00104B15E56F>
  ...
  <PARAM NAME="Landscape"					VALUE="0">
	...
	<C>id='RESINO', left=1294, top=844, right=1925, bottom=909, align='left' ,mask='XXXXXX - XXXXXXX', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CERPLC', left=344, top=1019, right=1922, bottom=1084, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CERTINO', left=38, top=191, right=578, bottom=256, align='left' ,mask='제 XXXX - TXXXX 호', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<I>id='../../Common/img/new_attampt1.jpg' ,left=1134 ,top=2206 ,right=1863 ,bottom=2503</I>
	<T>id='본     적' ,left=44 ,top=328 ,right=319 ,bottom=394 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주     소' ,left=44 ,top=503 ,right=319 ,bottom=569 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='소     속' ,left=44 ,top=669 ,right=319 ,bottom=734 ,face='굴림' ,size=14 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
