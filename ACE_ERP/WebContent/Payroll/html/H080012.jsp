...
function ln_Before(){
	...
	//소속코드 조회조건
	gcds_srh2.DataID = "/servlet/Person.hcdept_s9?v_str1="+gdeptcd+"&v_str2="+gusrid;
//	gcds_srh2.DataID = "/servlet/Person.hcdept_s1?v_str1=";
	...
	//소속코드
	gcds_dept.DataID = "/servlet/Person.hcdept_s9?v_str1="+gdeptcd+"&v_str2=";
	//gcds_dept.DataID = "/servlet/Person.hcdept_s1?v_str1=";
	gcds_dept.Reset();

	//소속-팀 조회
	gcds_deptlevel.DataID = "/servlet/Person.hcdept_s9?v_str1="+gdeptcd+"&v_str2=";
...
function ln_Query(){
  ...
  if(gjobdty=="03"||gjobdty=="04"||gjobdty=="05"||gjobdty=="06"||gjobdty=="17"||gjobdty=="21"||gjobdty=="33"||gjobdty=="34"){
...
/******************************************************************************
	Description : 직책별 조회 권한 설정
	2009.03.27 추가  - 사용안함.
******************************************************************************/
function ln_Jobdty(){
	
	for(i=1;i<=gcds_srh2.countrow;i++){
		if(gcds_srh2.namevalue(i,"DEPTCD")==gdeptcd){
			gclx_srh2.index=i-1;
			//인재지원팀은 제외.
			if(gdeptcd=="C200"||gdeptcd=="C210"){
				break;
			}
			gclx_srh2.enable=false;	
			break;
		}
	}
}
                      ...
                      <td class="tab11" width="80px;" bgcolor="#eeeeee">입사</td>
											<td class="tab21" width="120px">
												<comment id="__NSID__"><OBJECT id=gclx_empdiv classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 
													style="position:relative;left:8px;top:1px;font-size:12px;width:100px;">
														<!-- <param name=ComboDataID			value="gcds_empdiv"> -->
														<param name=CBData					value=" ^ ,3^한국인계약직,4^파견계약직,6^파견,7^파견근로자-아르바이트">
														<param name=CBDataColumns		value="MINORCD, MINORNM">
														<param name=SearchColumn		value=MINORNM>
...
<div id="layer1" style="position:absolute; top:240px; left:180px;">
...
<!---------[TAB 2] 가족사항 그리드----------->
<div id="layer2" style="position:absolute; top:240px; left:179px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
...
<!------[TAB 3] 경력사항 그리드-------->
<div id="layer3" style="position:absolute; top:240px; left:179px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
			<td height="25px" align="right" valign="bottom">
			<!---
...
<!---------[TAB 4] 자격면허사항 그리드----------->
<div id="layer4" style="position:absolute; top:240px; left:179px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
  ...
  <!---------[TAB 5] 학력사항 그리드----------->
<div id="layer5" style="position:absolute; top:240px; left:179px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
			<td height="25px" align="right" valign="bottom">
				<!--
...
<!---------[TAB 6] 신원보증/신체사항/병역 ----------->
<div id="layer6" style="position:absolute; top:240px; left:179px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
...
<!---------[TAB 7] 사내경력 그리드----------->
<div id="layer7" style="position:absolute; top:240px; left:179px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td height="25px" align="right" valign="bottom">
				<!--
		...
		<tr>
		  <td style="width:697;" style="border:0 solid #708090;border-top-width:1px;" colspan="2">
            ...
            <param name=dataid					value=gcds_data07>
						...
						<param name=format          value='
							<F> Name=NO ID={CurRow}				HeadAlign=Center HeadBgColor=#B9D4DC Width=30,  align=right </F> 
							<F> Name=발령일자		ID=ORDDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=70,	align=center,			MASK="XXXX/XX/XX"</F> 
							...
							<C> Name=직위				ID=PAYGRD HeadAlign=Center HeadBgColor=#B9D4DC Width=100, EditStyle=Lookup, Data="gcds_deptlvl:minorcd:minornm"</C>
							<C> Name=호봉				ID=PAYSEQ HeadAlign=Center HeadBgColor=#B9D4DC Width=60,	EditStyle=Lookup, Data="gcds_payseq:minorcd:minornm" </C>
							<C> Name=직급				ID=GRDDIV HeadAlign=Center HeadBgColor=#B9D4DC Width=60,	EditStyle=Lookup, Data="gcds_grddiv:minorcd:minornm"</C>
							<C> Name=종료일			ID=ENDDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=70,	align=center,			Mask="XXXX/XX/XX" </C>
							<C> Name=인사적용일	ID=APPDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=70,	align=center,			Mask="XXXX/XX/XX" </C>
						'>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<!---------[TAB 9] 사내시험+인사고과----------->
<div id="layer9" style="position:absolute; top:240px; left:179px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td height="25px" align="right" valign="bottom">
				<!--
		  ...
		  <td style="width:697;" style="border:0 solid #708090;border-top-width:1px;" colspan="2">
            ...
            <param name=dataid					value=gcds_data09>
						...
						<param name=format          value='
							...
							<C> Name=점수			ID=SCR		HeadAlign=Center HeadBgColor=#B9D4DC Width=80, align=right</C>
							<C> Name=고과등급	ID=SCRGBN	HeadAlign=Center HeadBgColor=#B9D4DC Width=80 ,align=center, edit=none</C>
						'>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
				<!--
...
<!---------[TAB 10] 교육사항----------->
<div id="layer10" style="position:absolute; top:240px; left:179px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td height="25px" align="right" valign="bottom">
				<!--
...
<!---------[TAB 11] 상벌관리 ----------->
<div id="layer11" style="position:absolute; top:240px; left:179px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td height="25px" align="right" valign="bottom">
				<!--
...
<A>id=Area5 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='hdcareer.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=65 ,DetailDataID=gcds_report5
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=53 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='PAYSEQ', left=1653,	top=0, right=1906,	bottom=53, face='굴림', mask='XXXX호봉', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
