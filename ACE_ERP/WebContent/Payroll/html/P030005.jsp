...
function fnOnLoad(tree_idx){
	...
	gcds_manager.DataID = "/servlet/Person.hclcode_s2?v_str1=2060&v_str2="+gusrid;
	gcds_manager.Reset();	
...
function ln_Query(){
  ...
  if(gcds_manager.countrow>0){ //관리자 존재
	...
	gcds_data.DataID = "/servlet/Payroll.p030005_s1?v_str1=" + gcem_curdt.text+"12"
...
function ln_Query02(p) {
	...
	gcds_data2.DataID = "/servlet/Payroll.p030005_s4?v_str1=" + gcem_curdt.text+"12"
									  + "&v_str2=" + gclx_deptcd.bindcolval
									  + "&v_str3=" + fn_trim(txt_empnmk1.value)
									  + "&v_str4=" + p;
...
function ln_Before(){
	...
	//소속코드2
	gcds_dept2.DataID = "/servlet/Person.hcdept_s2?";
	gcds_dept2.Reset();
  ...
  if (gcds_data.countrow<1) {
	  ...
	  //연말정산 관리자 체크
		if(gcds_manager.countrow>0){ 	
			...
			gcds_empno.DataID = "/servlet/Payroll.p030005_s5?v_str1=" + gcem_curdt.text+"12";
...
function ln_Print2(){
	//잠시막아놓음
	//gcds_print2.DataID = "/servlet/Payroll.p030005_s2?v_str1=" + gcem_curdt.text+"12"
