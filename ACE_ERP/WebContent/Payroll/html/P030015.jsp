...
function ln_Query(){
  ...
  if(gcds_manager.countrow>0){ //관리자 존재
	...
	**/
	...
	gcds_data.DataID = "/servlet/Payroll.p030015_s1?v_str1=" + gcem_curdt.text+"12"
...
function ln_Query02(p) {
	...
	gcds_data2.DataID = "/servlet/Payroll.p030015_s4?v_str1=" + gcem_curdt.text+"12"
									  + "&v_str2=" + gclx_deptcd.bindcolval
									  + "&v_str3=" + fn_trim(txt_empnmk1.value)
									  + "&v_str4=" + p;
  ...
  if (gcds_data.countrow<1) {
	  ...
	  //연말정산 관리자 체크
		if(gcds_manager.countrow>0){ 	
			...
			gcds_empno.DataID = "/servlet/Payroll.p030015_s5?v_str1=" + gcem_curdt.text+"12";
