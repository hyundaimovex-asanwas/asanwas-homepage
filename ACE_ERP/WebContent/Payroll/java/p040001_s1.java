...
public class p040001_s1 extends HttpServlet {
...
**********************************************************************************************/
			...
			//	if (str1==null){str1="";}
				...
				String[] strArrCN = new String[]{ 
					...
					"PAYSEQ",  "PAYSEQNM",  "STRTDT", "ENDDT", "GRSTRTDT" , "PAYGNM" 
					}; 
          ...
          */
			logger.dbg.println(this,"111");
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "         LEFT JOIN PAYROLL.HCLCODE D ON A.PAYSEQ =D.MINORCD  AND  D.MINORCD = '1184' "); //호봉
