...
**********************************************************************************************/
				...
				str[1]	= req.getParameter("v_str2");		//퇴사일
        ...
        "SEQ",	 /* 근무지출력순서*/   
          ...
          sql.append("\n").append( " A.EMPNMK,                         ");	/*한글명*/      
					...
					sql.append("\n").append( " X.P10000,                         "); /* 기본급여*/       
					sql.append("\n").append( " X.P11000,                         ");	/* 직책수당 */      
					sql.append("\n").append( " X.P12000,                         ");	/* 시간외수당 */    
					sql.append("\n").append( " X.P21000,                         ");	/* 근속수당*/       
					sql.append("\n").append( " X.P22000,                         ");	/* 자기계발비 */    
          sql.append("\n").append( " X.P23001,                         ");	/* 부양가족*/       
          sql.append("\n").append( " X.P23000,                         ");	/* 부양가족수당*/   
					sql.append("\n").append( " X.P24000,                         ");	/* 차량유지비 */    
					sql.append("\n").append( " X.P25000,                         ");	/* 출납수당*/       
          sql.append("\n").append( " X.P26000,                         ");	/* 운전수당*/       
					sql.append("\n").append( " X.P27000,                         ");	/* 연장수당*/       
					sql.append("\n").append( " X.P28000,                         ");	/* 자격수당*/       
					sql.append("\n").append( " X.P29000,                         ");	/* 남북경협수당*/   
					sql.append("\n").append( " X.P30000,                         ");	/* 사장단수당*/     
					sql.append("\n").append( " X.P31000,                         ");	/* 특수지수당*/     
					sql.append("\n").append( " X.P32000,                         ");	/* 지역근무수당*/   
					sql.append("\n").append( " X.P33001,                         ");	/* 월차일수  */     
					sql.append("\n").append( " X.P33000,                         ");	/* 월차수당*/       
					sql.append("\n").append( " X.P34001,                         ");	/* 연차일수*/       
					sql.append("\n").append( " X.P34000,                         ");	/* 연차수당*/       
          sql.append("\n").append( " X.P35000,                         ");	/* 식대*/           
					sql.append("\n").append( " X.P36000,                         ");	/* 학비보조금*/     
					sql.append("\n").append( " X.P37000,                         ");	/* 개인연금보조금*/ 
          sql.append("\n").append( " X.P38000,                         ");	/* 임원직책수당*/   
					sql.append("\n").append( " X.P39000,                         ");	/* 전월소급*/       
					sql.append("\n").append( " X.PX0010,                         ");	/* 기타지급1*/      
					sql.append("\n").append( " X.PX0020,                         ");	/* 기타지급2*/      
					sql.append("\n").append( " X.PX0030,                         ");	/* 기타지급3*/      
					sql.append("\n").append( " X.PX0040,                         ");	/* 기타지급4*/      
					sql.append("\n").append( " X.P41000,                         ");	/* 정산건강보험*/   
					sql.append("\n").append( " X.P42000,                         ");	/* 정산고용보험*/   
					sql.append("\n").append( " X.T21000,                         ");	/* 정산소득세*/     
					sql.append("\n").append( " X.T22000,                         ");	/* 정산주민세*/     
					sql.append("\n").append( " X.T23000,                         ");	/* 정산농특세*/     
          sql.append("\n").append( " X.S91000,                         ");	/* 지급합계*/       
					sql.append("\n").append( " X.S92000,                         ");	/* 소득합계*/       
					sql.append("\n").append( " X.T11000,                         ");	/* 소득세*/         
          sql.append("\n").append( " X.T12000,                         ");	/* 주민세*/         
					sql.append("\n").append( " X.B11000,                         ");	/* 건강보험료*/     
					sql.append("\n").append( " X.B12000,                         ");	/* 국민연금*/       
					sql.append("\n").append( " X.B13000,                         ");	/* 고용보험*/       
					sql.append("\n").append( " X.B14000,                         ");	/* 여직원회비*/     
					sql.append("\n").append( " X.B15000,                         ");	/* 개인연금*/       
					sql.append("\n").append( " X.B16000,                         ");	/* 공조회비*/       
					sql.append("\n").append( " X.BX0010,                         ");	/* 기타공제1*/      
					sql.append("\n").append( " X.BX0020,                         ");	/* 기타공제2*/      
					sql.append("\n").append( " X.BX0030,                         ");	/* 기타공제3*/      
					sql.append("\n").append( " X.BX0040,                         ");	/* 기타공제4*/      
          sql.append("\n").append( " X.S93000,                         "); /* 공제합계*/  
					sql.append("\n").append( " X.S94000,                         ");	/* 실지급액*/  
					sql.append("\n").append( " X.STRTDT,                         "); /* 입사일 */     
          sql.append("\n").append( " RTRIM(A.GRSTRTDT) AS GRSTRTDT,    ");	/* 그룹입사일*/  
					sql.append("\n").append( " X.TRAINYN,                        ");  /* 수습적용여부 */ 
					sql.append("\n").append( " SUBSTR(X.PAYDT,1,6) AS PAYDTYM,               ");	/* 급여지급년월*/    
					sql.append("\n").append( " X.PAYDT AS PAYDTYMD,               ");	/* 급여지급일*/    
					sql.append("\n").append( " X.SENUM,                          ");	 /* 배부자장경*/    
					sql.append("\n").append( " X.P23002,                         ");	 /* 배우자*/        
					sql.append("\n").append( " X.P23003,                         ");	/* 부모*/          
					sql.append("\n").append( " X.P23004,                         ");	 /* 자녀*/          
					sql.append("\n").append( " X.P23005,                         ");	 /* 장애*/          
          ...
          sql.append("\n").append( " X.SANGRAT,                        ");	 /* 상여율*/
					sql.append("\n").append( " COALESCE((L.APLAMT+L.APLRAT),0) AMT_1 ");	/* 상환액 */
					sql.append("\n").append( " FROM                              ");
          sql.append("\n").append( " (                                                                                                                     ");
          ...
          sql.append("\n").append( "		 SUM(B.P23002)P23002,    SUM(B.P23003)P23003,    SUM(B.P23004)P23004,    SUM(B.P23005)P23005,    SUM(B.P23006)P23006,  ");
					...
					sql.append("\n").append( "     AND SUBSTR(B.APPDT,1,4)= '"  + str[1] + "' ");     //적용년=퇴사년
					...
					sql.append("\n").append( " LEFT JOIN PAYROLL.HCLCODE D ON X.PAYGRD = D.MINORCD AND D.MAJORCD = '2002'                                            "); /*직위*/       
					sql.append("\n").append( " LEFT JOIN PAYROLL.HCLCODE F ON X.JOBGRPH = F.MINORCD AND F.MAJORCD = '2000'                                           ");	 /*직군*/      
					sql.append("\n").append( " LEFT JOIN PAYROLL.HCLCODE G ON X.PAYSEQ = G.MINORCD AND G.MAJORCD = '1184'                                            ");	/*호봉*/       
					sql.append("\n").append( " LEFT JOIN PAYROLL.HCLCODE H ON X.GRDDIV = H.MINORCD AND H.MAJORCD = '2001'                                            ");	/*직급*/       
					sql.append("\n").append( " LEFT JOIN PAYROLL.HCLCODE I ON C.GROUPID = I.MINORCD AND I.MAJORCD = '2051'                                           ");	 /*근무지*/    
					sql.append("\n").append( " LEFT OUTER JOIN PAYROLL.PWRONPAY L ON  X.EMPNO = L.EMPNO  ");
														  													   
				
					sql.append("\n").append( " ORDER BY I.SEQ, D.SEQ,PAYDTYMD ASC, PAYSEQNM DESC, A.EMPNO "); /*지급구분*/
