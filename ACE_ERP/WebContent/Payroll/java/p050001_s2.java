...
public class p050001_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " from  PAYROLL.PWPENTBL A "); 
					//sql.append( " LEFT OUTER JOIN PAYROLL.PWRATE B ON  A.STDYM = B.APPYM AND   RTRIM(B.INSGB) = '2'   ");
