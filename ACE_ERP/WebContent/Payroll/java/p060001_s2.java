...
public class p060001_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "MINORCD"	,	"MINORNM"				
																				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " SELECT  " );	//U
						sql.append( " MINORCD,RTRIM(MINORNM) AS MINORNM " );
						sql.append( "  from PAYROLL.HCLCODE " );
						sql.append( " WHERE MAJORCD='2002' AND USEYN='T' " );
