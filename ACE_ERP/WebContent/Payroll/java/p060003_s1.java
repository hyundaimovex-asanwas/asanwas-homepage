...
public class p060003_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "DEPTNM"	,	"DEPTCD"	,	"SEQ", "PAYGRDNM", "GUBUNSUM"
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append(" SELECT E.DEPTNM AS DEPTNM ,E.DEPTCD,  COALESCE(F.SEQ,0) AS SEQ, F.MINORNM AS PAYGRDNM,                                           \n");
						...
						sql.append(" GROUP BY E.DEPTNM,E.DEPTCD,F.MINORNM,F.SEQ  \n");
						sql.append(" ORDER BY E.DEPTCD ASC, F.SEQ DESC                                                                 \n");
