...
//alert("fnAmtSave v_param : " + v_param);
    ...
    function fnTourCust(dirPath, servletPath){
        ...
        ln_TRSetting(tr_temp, 
            dirPath + servletPath + "Rv200I",
            "JSP(O:CUST=ds_cust_temp, O:CUST_RESULT=ds_cust_result)",
            v_param);
        tr_post(tr_temp);
    }
...
//                        + ",v_rsv_sid="     + getObjectFirst("ds_cust").NameValue(getObjectFirst("ds_cust").RowPosition, "RSV_SID")
//alert(v_param);
	        ln_TRSetting(tr_save, 
	            dirPath + servletPath + "Rv200I",
