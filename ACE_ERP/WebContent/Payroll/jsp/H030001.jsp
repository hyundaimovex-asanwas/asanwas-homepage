...
function ln_Before(){
	...
	gcds_dept99.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>hcdept_s99?v_str1=";
	gcds_dept99.Reset();
...
<!---------[TAB 10] (어학/전산)----------->
	...
	<tr>
		...
		<tr>
			<td>
				<table border="0" cellpadding=0 cellspacing=0  border=0 style="border:0 solid #708090;border-top-width:1px;width:701px">
					<tr>
		...
		<tr>
			<td>
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td>
							<table cellpadding=0 cellspacing=0  border=0 style="border:0 solid #708090;border-top-width:1px;width:700px">
								<tr>
									<td class="tab11" width="70px;" bgcolor="#eeeeee">한글</td>
									<td class="tab21" width="100px;">
			   						<comment id="__NSID__"><OBJECT id=gclx_hwgrdcd classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69
