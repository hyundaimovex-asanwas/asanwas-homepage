...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:	인사
+ 프로그램 ID	: H030003_popup_3.HTML
+ 기 능 정 의	: 사원조회
+ 변 경 이 력	: 
+ 서 블 릿 명	: h030003_s3_1
-------------------------------------------------------------------------------
...
function ln_Start(){
  ...
  if(gs_gubun=="S"){ //임원분들
 		gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h030003_s3_2?"
										 + "v_str1=" +txt_nm.value
										 + "&v_str2=S" 
										 + "&v_str3="+gs_level
										 + "&v_str4="+gs_treecd; 
		...
		gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h030003_s3_1?"
										 + "v_str1=" +txt_nm.value
										 + "&v_str2=S" 
										 + "&v_str3="+gs_level
										 + "&v_str4="+gs_treecd; 
