...
+ 기 능 정 의	: 조회,저장,삭제,출력
+ 변 경 이 력	: 
+ 서 블 릿 명	: h030004_s1, h030001_s0, hcdept_s1
------------------------------------------------------------------------------>
...
function ln_Query(e){
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h030004_s1?v_str1=" + e;
	...
	<tr>
		<td width=100% height="25px" colspan="3">
			<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px;">
			  <tr> 
			    <td width="215" background="../../Common/img/com_t_bg.gif"><IMG height=47 src="../img/h030004_head.gif" width=197></td>
				  ...
				  <td>
		            ...
		            <param name=dataid				value=gcds_data>
				   			...
				   			<param name=format        value='
									<C>ID=EMPNO,		Name=사번,			width=70,		HeadBgColor=#B9D4DC, align=center</C>
									<C>ID=EMPNMK,		Name=성명,			width=67,		HeadBgColor=#B9D4DC, align=left</C>
									<C>ID=DEPTNM,		Name=소속명,		width=158,	HeadBgColor=#B9D4DC, align=left</C>
									<C>ID=PAYGNM,		Name=직위명,		width=100,	HeadBgColor=#B9D4DC, align=left</C>
									<C>ID=GRDDNM,		Name=직급,			width=70,		HeadBgColor=#B9D4DC, align=left</C>
