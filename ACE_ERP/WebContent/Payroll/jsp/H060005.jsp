...
function ln_Query(){
    ...
    //2008.11.11 jys 수정 : 평균 ( 5:5 => 6:4(2차고과) , 5:3:2(3차고과) 로 변경 ==> 4:3:3
		if(gcem_yymm.text<='200807'){
			gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060005_s1?v_str1="+gcem_yymm.text				//고과년월
      ...
      // prompt('1',gcds_data.DataID);
			 ...
			 gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060005_s2?v_str1="+gcem_yymm.text				//고과년월
																												 +"&v_str2="+txt_empnoh.value				//사번
																												 +"&v_str3="+gclx_deptcd.bindcolval	//소속코드
																												 +"&v_str4="+gs_level								//level
																												 +"&v_str5="+gs_treecd							//treecd
...
function ln_Query2(){
  ...
  if(gcem_yymm.text<='200807'){
		gcds_data2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060005_s1?v_str1="+gcem_yymm.text			//고과년월
																											 +"&v_str2="+txt_empnoh.value				//사번
																											 +"&v_str3="+""											//소속코드
																											 +"&v_str4="+""											//level
																											 +"&v_str5="+""											//treecd
   ...
   // prompt('1111::',gcds_data2.DataID);
		...
		gcds_data2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060005_s2?v_str1="+gcem_yymm.text			//고과년월
																											 +"&v_str2="+txt_empnoh.value				//사번
																											 +"&v_str3="+""											//소속코드
																											 +"&v_str4="+""											//level
																											 +"&v_str5="+""											//treecd
