...
<table cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:560px;height:255px;border:1 solid #708090">
	...
	<tr>
		<td rowspan="7" >
			...
			">
			<!-- <C> Name='직군' ID=JOBNM   	HeadAlign=Center HeadBgColor=#B9D4DC Width=50   align=LEFT  </C> 
			<C> Name='구분' ID=GRPNM  	HeadAlign=Center HeadBgColor=#B9D4DC Width=80  align=LEFT </C>  -->
			</OBJECT></comment><script>__ws__(__NSID__);</script>
		</td>
		<td width="100px" border=1>
			...
			<tr >
				...
				<td width="170px" style="border:0 solid #708090;border-right-width:0px;border-top-width:1px;border-left-width:0px;border-bottom-width:1px">
				  ...
				  <img src="../../Person/img/calender.gif" value="calender.gif" id=img_calendar1 OnClick="__GetCallCalendar('gcem_dt', 'Text')" style="position:relative;width:20px;left:1px;top:2px;cursor:hand;">이전
				 </td>
			</tr>
			<tr>
