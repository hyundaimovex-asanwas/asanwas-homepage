...
function ln_Submit_St(){
		gcds_submit2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060014_s6?v_str1="+gcem_yymm.text    //고과년월
...
function ln_Query(){
    ...
    //본사
		gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060014_s1?v_str1="+gcem_yymm.text		//고과년월
														 +"&v_str2="+txt_empnoh.value	//고과자	
    ...
    //
		gcds_data5.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060014_s5?v_str1="+gcem_yymm.text		//고과년월
														 +"&v_str2="+txt_empnoh.value	//고과자	
														 +"&v_str3="+txt_empnm.value	//피고과자
														 +"&v_str4="+gcra_gubun.CodeValue;	//정규직 계약직
...
******************************************************************************/
function ln_Query2(){
		gcds_data2.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060014_s2?v_str1="+gstr_yyyymm						//고과년월
...
//	gcds_col.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060014_p5?v_str1="+gcem_yymm.text		//고과년월
//														+"&v_str2="+txt_empnoh.value;	//고과자
//gcds_col.Reset();
}
...
function ln_FindEmp(e, row){
  if (gusrid!="1990098"&&gusrid!="2020008"&& gusrid!="6070001"&& gusrid!="2050045" && gusrid!="6080002" && gusrid!="6080001") return;
  var result="";
