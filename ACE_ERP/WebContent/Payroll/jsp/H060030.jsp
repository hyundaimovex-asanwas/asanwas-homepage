...
function fnOnLoad(tree_idx){
  ...
  //gcem_evaym.text = gs_date;
	...
	gcds_manager.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>hclcode_s2?v_str1=2061&v_str2="+gusrid;
	gcds_manager.Reset();	
...
function ln_Query(){
 ...
 //초기 화면 로딩때의
  ...
  //인적사항등 
	gcds_mst.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060030_s0?"
...
function ln_Before(){
    ...
    */
		...
		gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060030_s22?"
		                + "v_str1="+gs_empno;
		gcds_data.Reset();
...
//	alert(gs_empno);
	...
	gcds_chk.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h060030_s3?"
		               + "v_str1="+gcem_evaym.text
									 + "&v_str2="+gs_empno;
...
<tr> 
  ...
  <td COLSPAN=2>
	...
	<tr>
	 <td colspan=2>
		<iframe id="ifrm" name="ifrm" src="../../Payroll/jsp/H060030_ifrm.html" frameborder=0 style="position:relative;top:1px;width:872;height:330px;border:1 solid #708090;"></iframe>
	 </td>
	</tr>
