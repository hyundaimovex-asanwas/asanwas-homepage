...
//	var v_str2=gcem_to.text;
 ...
 gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010026_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text + "&v_str3=" + txt_EMPNO.value + "&v_str5=" + v_str5;

//	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010026_s1?v_str5=" + v_str5;
	gcds_data.Reset();
...
function ln_Save(){
  var v_str1=txt_EMPNO.value;
	...
	if(fn_CheckSaveCondt()){
		if(confirm("결재하시겠습니까?")){
		gctr_pyo.Action ="<%=dirPath%><%=HDConstant.PATH_PERSON%>h010026_t1?v_str1=" + v_str1 + "&v_str2=" + v_str2+ "&v_str3=" + v_str3;
  ...
  var check = 'T'
	for(i=1;i<=gcds_data.countrow;i++){
		...
		if(gcds_data.NameValue(i,"CHK") == "T"){
			...
			if ((gcds_data.NameValue(i,"APDT") != "") && (gcds_data.NameValue(i,"APDT") != "99999999")) { 
					alert("승인된 항목은 결재 할수 없습니다."); 
			return false;
			}
...
//		gctr_pyo.action = "/servlet//Person.h010025_t1";
//		gctr_pyo.post();
//	
//	}
}
...
//	if ((APDT.text != "") && (APDT.text != "99999999"))  { 
  ...
  var check = 'T'
	...
	for(i=1;i<=gcds_data.countrow;i++){
		if(gcds_data.NameValue(i,"CHK") == "T"){	
			...
			else if((gcds_data.NameValue(i,"APDT") != "") && (gcds_data.NameValue(i,"APDT") != "99999999"))  { 
					alert("승인된 항목은 취소 할수 없습니다."); 
					check ='F'
					countChk++;
					return false;
...
<comment id="__NSID__"><OBJECT id=gctr_pyo classid=clsid:0A2233AD-E771-11D2-973D-00104B15E56F VIEWASTEXT>
	...
	<PARAM NAME="KeyValue" VALUE="h010026_t1(I:USER=gcds_data)">
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td ><img src="../img/h070002_head.gif"></td>
...
<!-- <comment id="__NSID__"><object id=APDT classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
    ...
    <td COLSPAN=2>
        ...
        <tr> 
					...
					<td width="10"style="border:0 solid #708090;border-right-width:0px;"><nobr>&nbsp;
						...
						<nobr>&nbsp;결재자사번&nbsp;</nobr></td>
						<td width="10">&nbsp;<nobr><input id="txt_EMPNO"  class="txtbox" name="txt_EMPNO" type=text value="" style="border:0px;width:50px;" maxlength="7" onBlur="bytelength(this,this.value,7);"  disabled></nobr></td>
						...
						<nobr>&nbsp;성명&nbsp;</nobr></td>
						<td width="20">&nbsp;<nobr><input id="txt_NAME"  class="txtbox" name="txt_NAME" type=text value="" style="border:0px;width:70px;" maxlength="20" onBlur="bytelength(this,this.value,20);" disabled></nobr></td>

	
						<td width="10" align=RIGHT  style="border:0 solid #708090;border-left-width:1px;border-right-width:1px;" bgcolor="#eeeeee" class="txtbox" >
						<nobr>&nbsp;구분&nbsp;</nobr></td>
						<td ><nobr>
						<comment id="__NSID__"><object id=Radio1_1 classid=CLSID:754F3DC4-0C79-4C92-AD64-A806D8FF2AB0
						         style="position:relative;left:4px;top:0px;height:24;width:275;cursor:hand;" class="txtbox" >
					             <param name=Cols     value="4">
						           <param name=Format   value="1^전체,2^결재,3^미결재,4^결재취소">
  ...
  <tr> 
    <td colspan="2"> 
      <table width="867" cellpadding="0" cellspacing="0" border="0">
        <tr> 
          <td style="width:503">
		<comment id="__NSID__"><OBJECT classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" id=gcgd_pyo   class="txtbox" style="WIDTH: 874px; HEIGHT: 420px;border:1 solid #777777;display:block;" viewastext>
              ...
              <PARAM NAME="BorderStyle"		VALUE="0">
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<C> Name='소속'			 ID=DEPTNM  HeadAlign=Center HeadBgColor=#B9D4DC Width=140 align=LEFT Edit=None   </C> 
