...
function ln_Query(){
  var v_str1=gcem_fr.text;
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h070001_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text+ "&v_str3=" + txt_name.value+ "&v_str4=9"+ "&v_str5=A" ;
	//gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h070001_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text+ "&v_str3=" + txt_name.value+ "&v_str4=&v_str5=A" ;
	gcds_data.Reset();
...
/*
	...
	*/
	if (gcds_data.IsUpdated) {	
		...
		gctr_pyo.Action = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010025_t1?v_str2=" + gcem_to.text+ "&v_str4=" +  gcds_data.namevalue(gcds_data.rowposition,"empno") ;
...
function ln_Delete(){
	...
	if (confirm("선택한 정보를 삭제하시겠습니까?")){
		...
		gctr_pyo.action = "<%=dirPath%><%=HDConstant.PATH_PERSON%>h010025_t1?v_str4=" + txt_EMPNO.value;
		gctr_pyo.post();
//	return ln_Query();
	}
	*/
