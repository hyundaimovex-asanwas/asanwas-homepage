...
function ln_Print(){
	...
	if (gcds_data.countrow<1) alert("출력하실 자료가 없습니다");
		...
		var THeader	 = "EMPNO:STRING(7),EMPNMK:STRING(20),ATTDAY:STRING(8),ATTTIME:STRING(6),CLODAY:STRING(8),CLOTIME:STRING(6),";
				THeader += "DEPTNM:STRING(70),ETC:STRING(30),";	//OVERWK:DECIMAL(4),";
			...
			for (var i=1;i<=gcds_data.countrow;i++){
				...
				gcds_print.namevalue(i,"ETC")						= gcds_data.namevalue(i,"ETC");
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px;">
  <tr> 
    <td background="../../Common/img/com_t_bg.gif"><img src="../img/h090002_head.gif"></td>
	...
	<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
		<tr> 
			<td>
				<comment id="__NSID__"><OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_data style="position:relative;top:3px;WIDTH:568px;HEIGHT: 415px;border:1 solid #777777;display:block;" viewastext class="txtbox">
					...
					<PARAM NAME="Format"			VALUE="  
						<C> Name='성명'				ID=EMPNMK		HeadAlign=Center HeadBgColor=#B9D4DC Width=80		align=LEFT		Edit=None		sort=true</C>
						<C> Name='소속명'			ID=DEPTNM  	HeadAlign=Center HeadBgColor=#B9D4DC Width=160	align=LEFT		Edit=None		sort=true</C> 
						...
						<C> Name='비 고'			ID=ETC		HeadAlign=Center HeadBgColor=#B9D4DC Width=75			align=LEFT			Edit=None		</C>
					">
				</OBJECT></comment><script>__ws__(__NSID__);</script><!-- <C> Name='시간외;근무'	ID=OVERWK		HeadAlign=Center HeadBgColor=#B9D4DC Width=75		align=LEFT		Edit=None		</C> -->
			</td>
			<td>
				...
				<table border= "0" cellpadding=0 cellspacing=0  border=0  style='position:relative;left:0px;top:2px;width:304px;height:415px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
					...
					<tr>
						...
						<td style="border:0 solid #708090;border-right-width:0px;border-bottom-width:1px;" colspan=2>&nbsp;
							...
							<input id="txt_empnm" name="txt_empnm" type="text"		class="txtbox" style= "position:relative;left:-12px;top:3px;width:90px; height:20px;">
			...
			<tr>
				<td style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center class="txtbox"><nobr>&nbsp;비 고&nbsp;</nobr></td>
				<td  Style="height:30px;border:0 solid #708090;border-bottom-width:1px"><nobr>&nbsp;
					<textarea id="txt_etc" class="txtbox"  style= "width:207px; height:74px; overflow:auto;position:relative;left:-6px" maxlength="30" onBlur="bytelength(this,this.value,30);"></textarea>
				</td>
			</tr>
			<tr>
