...
function ln_Query(){
	...
	gcds_data.DataID = "/servlet/Contract.h090004_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text + "&v_str3=" + v_str3 + "&v_str4=" + fn_trim(v_str4)+ "&v_str5=" + v_str5;
	gcds_data.Reset();
...
//prompt('',gcds_data.text);
		if(confirm("결재 하시겠습니까?")){
			gctr_pyo.Action ="/servlet/Contract.h090004_t1?v_str1=" + v_str1 + "&v_str2=" + v_str2 + "&v_str3=" + v_str3;
			gctr_pyo.post();
			ln_Query();
	  }
	} else { return ; }
