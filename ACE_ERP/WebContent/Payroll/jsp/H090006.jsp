...
function fnOnLoad(tree_idx){
	...
	gcem_fr.text = gcurdate.substring(0,5) + "0101";	//시작일자
...
function ln_Add(){
	...
	var v_payseq  = gcds_data.namevalue(gcds_data.rowposition,"MINORCD");	//직위
          ...
          <td style="width:503">
              ...
              <PARAM NAME="BorderStyle" VALUE="0">
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<F> Name='휴가구분'		ID=LAZCD		HeadAlign=Center HeadBgColor=#B9D4DC Width=80	Editstyle=lookup data='gcds_holfee:MINORCD:MINORNM' align=LEFT		Edit=None    BgColor='#f5f5f5'   </F> 
								<C> Name='시작일'			ID=FRDT			HeadAlign=Center HeadBgColor=#B9D4DC Width=70		align=CENTER	Mask='XXXX/XX/XX' Edit=None  </C>
								<C> Name='종료일'			ID=TODT			HeadAlign=Center HeadBgColor=#B9D4DC Width=70		align=CENTER	Mask='XXXX/XX/XX' Edit=None  </C>
          ...
          <td valign=top>
				...
				<table border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0  style='width:384px;height:421px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
					<tr>
			          ...
			          <tr>
						<td style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center class="txtbox" >휴가구분</td>
						<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=3>&nbsp;
		 	...
		 	<tr>
				<td style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center class="txtbox" >휴가내용</br><nobr>(구체적기입)</nobr></td>
			...
			<tr>
				<td style="height:20px;width:50px;border:0 solid #708090;border-right-width:1px;" bgcolor="#eeeeee" class="txtbox"  align=center><nobr>&nbsp;&nbsp;전    년</nobr></td>
