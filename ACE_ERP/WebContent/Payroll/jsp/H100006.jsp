...
function ln_Query(){
	...
	gcds_grid_ec01az.DataID = "/servlet/Contract.h100006_s1?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Print(){
	...
	for(s=1;s<=gcds_grid_ec01az.countrow;s++) {
		...
		if (gcds_grid_ec01az.namevalue(s,"PAYDIV") == 'T') { 
			gcds_report0.namevalue(s,"CTITLE")= "급여 명세서 ["
	  ...
	  gcds_report0.namevalue(s,"TT1200")=gcds_grid_ec01az.namevalue(s,"TT1200");
		...
		gcds_report1.DataID = "/servlet/Contract.h100006_s2?"
...
<script language="javascript" for="gcds_select_ec05az" event="OnLoadStarted()">
	window.status="데이타 조회중입니다..잠시만 기다려 주십시오.";
	// document.all.LowerFrame.style.visibility="visible";
</script>
...
<script language="javascript" for="gcds_report1" event="OnLoadStarted()">
	window.status="데이타 조회중입니다..잠시만 기다려 주십시오.";
	// document.all.LowerFrame.style.visibility="visible";
</script>

<script language="javascript" for="gcds_report1" event="onloadcompleted(row,colid)">
	window.status="조회가 완료 되었습니다.";
	// document.all.LowerFrame.style.visibility="hidden";
</script>
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/h100006_head.gif"></td>
    ...
    <td COLSPAN=2>
        ...
        <tr> 
					...
					<td style="height:30px;border:0 solid #708090;border-right-width:0px;padding-top:2px;border-right-width:1px;"><nobr>&nbsp;
						<comment id="__NSID__"><OBJECT id=gcem_yymm_search classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:-3px;top:1px; width:50px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 ValidFeatures="ignoreStatus=yes" validExp="">
					...
					<td style="height:30px;border:0 solid #708090;border-right-width:1px;padding-left:3px;padding-right:3px;" bgcolor="#eeeeee"><nobr>&nbsp;지급구분&nbsp;</nobr></td>	
					...
					<td width="0" align=RIGHT style="height:30px;border:0 solid #708090;border-right-width:1px;" bgcolor="#eeeeee"><nobr >&nbsp;직군&nbsp;</nobr></td>
					<td style="height:30px;border:0 solid #708090;border-right-width:0px;"><comment id="__NSID__"><OBJECT id=gclx_select_ec03az  name="gclx_select_ec03az" classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 width=50 
					...
					<td width="0" align=RIGHT style="height:30px;border:0 solid #708090;border-right-width:0px;" bgcolor="#ffffff"><nobr >&nbsp;&nbsp;</nobr></td>
			...
			<table cellpadding=0 cellspacing=0 width=150>
				<tr>
					...
					<td style="height:30px;border:0 solid #708090;border-right-width:1px;padding-top:0px;border-top-width:1px;"><nobr>
						<input type="text" id=txt_empnm style="width:70px;" class="txt11" onkeydown="if(event.keyCode==13) ln_Query();">&nbsp;&nbsp;</nobr>
					</td>
  ...
  <tr> 
	...
	<table width="876" cellpadding="0" cellspacing="0" border="0">
		<tr>  			<!--<C> Name='상여'			ID=P11000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right show=false </C>
						<C> Name='근속수당'  	ID=P21000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right show=false</C>
						<C> Name='조장수당'  	ID=P27000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right show=false</C> -->
			<td style="width:340px" valign=top>
				<comment id="__NSID__"><OBJECT id=gcgd_grid_ec01az name=gcgd_grid_ec01az classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH: 363px; HEIGHT: 403px;border:1 solid #777777;display:block;" viewastext>
					...
					<PARAM NAME="Format"			VALUE="  
						...
						<C> Name='구분'				ID=GROUPNM  HeadAlign=Center HeadBgColor=#B9D4DC Width=110 align=left sort=true  </C>
						<C> Name='소속'				ID=DEPTNM   HeadAlign=Center HeadBgColor=#B9D4DC Width=110 align=left sort=true  </C>
						...
						<C> Name='직급'				ID=GRDDIVNM HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=left sort=true </C>				
				    <C> Name='호봉'				ID=PAYSEQNM	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center sort=true </C>
						<C> Name='직위'				ID=PAYGRDNM	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=left sort=true </C>
						<C> Name='입사일'			ID=STRTDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center Mask='XXXX/XX/XX' sort=true </C>
						<C> Name='근무지'			ID=DEPTPRNM	HeadAlign=Center HeadBgColor=#B9D4DC Width=105 align=left sort=true </C>
						<C> Name='최종변동일'	ID=CHAGDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=85 align=center Mask='XXXX/XX/XX' sort=true </C>
					  <C> Name='은행명'			ID=PAYBNKNM	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=left sort=true </C>
						<C> Name='계좌번호'		ID=PAYNUM	HeadAlign=Center HeadBgColor=#B9D4DC Width=120 align=left sort=true </C>
						<C> Name='그룹입사일'	ID=GRSTRTDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=85 align=center Mask='XXXX/XX/XX' sort=true </C>
						<C> Name='입사일'			ID=STRTDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=center Mask='XXXX/XX/XX' sort=true </C>
						<C> Name='수습적용'		ID=TRAINYN	HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=center sort=true Value={decode(TRAINYN,1,'수습',2,'')}</C>
			      <C> Name='발령일'	    ID=DPOFFDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center Mask='XXXX/XX/XX' sort=true</C>
						<C> Name='지급일'			ID=PAYDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center Mask='XXXX/XX/XX' sort=true </C>
						<C> Name='실지급액'		ID=S94000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='지급합계'		ID=S91000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='공제합계'		ID=S93000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기본급여'		ID=P10000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>		
						<C> Name='시간외수당'	ID=P12000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='자격수당'  	ID=P28000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='현장수당'  	ID=P30000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='북측근무수당' ID=P31000		HeadAlign=Center HeadBgColor=#B9D4DC Width=85 align=right</C>
						<C> Name='식대보조'		ID=P35000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C> 
						<C> Name='성과급'		  ID=P38000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C> 
						<C> Name='교통비'  		ID=P24000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='연차수당'		ID=P34000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C> 
						<C> Name='전월소급'		ID=P39000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='휴일수당'		ID=PX0010		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타지급1'	ID=PX0020		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타지급2'	ID=PX0030		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타지급3'	ID=PX0040		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='소득세'		  ID=T11000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='주민세'		  ID=T12000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='건강보험'		ID=B11000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='국민연금'		ID=B12000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='고용보험'		ID=B13000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
			      <C> Name='공조회비'		ID=B16000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='산재보험'		ID=B17000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='보증보험'		ID=BX0010		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타공제1'	ID=BX0020		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타공제2'	ID=BX0030		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='기타공제3'	ID=BX0040		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='정산연금'		ID=P43000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='정산건강'		ID=P41000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='정산고용'		ID=P42000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='정산소득'		ID=T21000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='정산주민'		ID=T22000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='주민번호'		ID=RESINO		HeadAlign=Center HeadBgColor=#B9D4DC Width=90 align=center </C>
						<C> Name='공조회대출'	ID=AMT_2		HeadAlign=Center HeadBgColor=#B9D4DC Width=80 align=right </C>
						<C> Name='고용보험(회사)'	 ID=B23000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
					">
				</OBJECT></comment><script>__ws__(__NSID__);</script>
				<fieldset style="width:365;height:20px;background-color:#FFFFFF;border:1 solid #708090;border-top-width:0px;text-align:LEFT;">
					...
					<td STYLE="PADDING-TOP:0px;" valign=top>
						<table width="503" cellpadding="0" cellspacing="0" border="0">
							<tr> 
								<td valign=top>
									<table border="5" cellpadding=0 cellspacing=0    style='width:508px;height:421px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:0 solid #708090'>
										<tr>
											<td style="height:22px;border:1 solid #708090;" bgcolor="#eeeeee">&nbsp;적용년월</td>
										...
										<tr>
											<td style="height:22px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;입사일자</td>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee">&nbsp;발령일자</td>
											<td style="border:1 solid #708090;border-top-width:0px;border-left-width:0px" colspan=2><nobr>
												<comment id="__NSID__"><OBJECT id=gcem_DPOFFDT  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:1px; width:70px; height:18px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 validFeatures="ignoreStatus=yes" validExp="">
													<param name=Text          value="">
													<param name=Alignment			value=0>
													<param name=ReadOnly			value=True>
													<param name=Border	      value=True>
										...
										<tr>
											<td style="height:0px;border:0 solid #708090;" colspan=6></td>
										</tr>
										<tr>
											...
											<td width=90px style="height:20px;border:1 solid #708090;border-left-width:0px;border-bottom-width:0px;" bgcolor="#B9D4DC" colspan=1><nobr>&nbsp;지급합계</nobr></td>
										...
										<tr>
											...
											<td style="height:20px;border:1 solid #708090;" bgcolor="#eeeeee">&nbsp;시간외수당</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;;border-top-width:1px;" colspan=2>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;border-top-width:1px;" bgcolor="#eeeeee">&nbsp;차량유지비</td>
											<td style="border:1 solid #708090;border-left-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee"><nobr>&nbsp;성과금</nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
                    ...
                    <tr>
										  ...
										  <td style="border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;</td>
										...
										<tr>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee"><nobr><input id="txt_px02"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타지급2" disabled></nobr></td>
											<td style="border:1 solid #708090;border-top-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;본사,현장,해외</td>
											<td style="border:1 solid #708090;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><OBJECT id=gcem_SGUNMU classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"style="position:relative; left:2px;top:0px; width:70px; height:20px;" class=txtbox validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
                      ...
                      <td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;연차수당</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><OBJECT id=gcem_P34000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2><comment id="__NSID__"><OBJECT id=gcem_P28000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr><td style="height:0px;border:0 solid #708090;" colspan=6></td></tr>
										<tr>
											<td style="height:20px;border:1 solid #708090;border-bottom-width:0px;" bgcolor="#B9D4DC" colspan=1><nobr>&nbsp;공제항목</nobr></td>
											<td style="border:0 solid #708090;border-bottom-width:0px;border-right-width:0px;" colspan=2 >&nbsp;</td>
											<td style="height:20px;border:1 solid #708090;border-left-width:1px;" bgcolor="#B9D4DC" colspan=1><nobr>&nbsp;공제합계</nobr></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-bottom-width:0px;" colspan=2 >
										...
										<tr>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;고용보험</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">&nbsp;<font color="#ADADAD">산재보험</font></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											<td style="height:20px;border:0 solid #708090;border-left-width:1px;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr><input id="txt_pb01"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타공제1" disabled></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee"><nobr><input id="txt_pb02"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타공제2" disabled></nobr></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
											...
											<td style="height:20px;border:1 solid #708090;border-left-width:0px;border-top-width:0px;" bgcolor="#eeeeee"><nobr><input id="txt_pb03"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타공제3" disabled></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2><comment id="__NSID__"><OBJECT id=gcem_P43000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;정산건강</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;정산주민</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
                    ...
                    <tr>
											...
											<td style="border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;공조회대출</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><OBJECT id=gcem_amtrat2 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2752 ,face='Arial' ,size=10 ,penwidth=1
	...
	<L> left=29 ,top=1439 ,right=1876 ,bottom=1439 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=923 ,right=1876 ,bottom=923 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=836 ,right=1876 ,bottom=836 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=799 ,right=1876 ,bottom=799 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=714 ,right=1876 ,bottom=714 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=1005 ,right=1876 ,bottom=1005 </L>
	<L> left=29 ,top=714 ,right=29 ,bottom=799 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1876 ,top=714 ,right=1876 ,bottom=799 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='실수령액' ,left=1283 ,top=730 ,right=1455 ,bottom=786 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='S93000', left=876, top=730, right=1257, bottom=786, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='공제총액' ,left=669 ,top=730 ,right=857 ,bottom=786 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='S91000', left=267, top=730, right=640, bottom=786, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='지급총액' ,left=53 ,top=730 ,right=233 ,bottom=786 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='S94000', left=1479, top=730, right=1855, bottom=786, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1463 ,top=720 ,right=1463 ,bottom=799 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	...
	<L> left=1876 ,top=836 ,right=1876 ,bottom=1439 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<C>id='P12000', left=267, top=1016, right=463, bottom=1074, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='P28000', left=267, top=1085, right=463, bottom=1138, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<T>id='기본급' ,left=40 ,top=942 ,right=254 ,bottom=997 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<L> left=1373 ,top=926 ,right=1373 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=1630 ,top=926 ,right=1630 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=262 ,top=926 ,right=262 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=471 ,top=926 ,right=471 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=706 ,top=926 ,right=706 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=1164 ,top=926 ,right=1164 ,bottom=1439 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='' ,left=1384 ,top=1365 ,right=1625 ,bottom=1421 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=29 ,top=836 ,right=29 ,bottom=1439 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	...
	<L> left=262 ,top=1556 ,right=262 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=706 ,top=1556 ,right=706 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=29 ,top=1855 ,right=1876 ,bottom=1855 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=1476 ,right=29 ,bottom=1855 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1876 ,top=1476 ,right=1876 ,bottom=1855 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=1979 ,right=1876 ,bottom=1979 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=29 ,top=1892 ,right=1876 ,bottom=1892 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=262 ,top=1982 ,right=262 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=706 ,top=1982 ,right=706 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	...
	<L> left=29 ,top=2627 ,right=1876 ,bottom=2627 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='누    계     내     역' ,left=48 ,top=2376 ,right=900 ,bottom=2434 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<L> left=1876 ,top=2360 ,right=1876 ,bottom=2622 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='3669-3867, 3669-3915' ,left=945 ,top=2463 ,right=1865 ,bottom=2521 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='급여/상여 문의 및 주소 변경' ,left=945 ,top=2376 ,right=1865 ,bottom=2434 ,face='굴림' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='TS9100', left=53, top=2551, right=312, bottom=2601, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=29 ,top=2360 ,right=29 ,bottom=2622 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	...
	<T>id='공 조 회 대 출' ,left=1402 ,top=1910 ,right=1868 ,bottom=1963 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='공       제       내       역' ,left=529 ,top=1487 ,right=1381 ,bottom=1540 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='PAYSEQNM', left=1384, top=373, right=1722, bottom=431, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PAYGRDNM', left=1384, top=304, right=1722, bottom=360, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='성       명 :' ,left=1098 ,top=230 ,right=1373 ,bottom=286 ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<C>id='EMPNO', left=328, top=230, right=667, bottom=286, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='EMPNMK', left=1384, top=230, right=1722, bottom=286, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=29 ,top=669 ,right=1876 ,bottom=669 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='사       번 :' ,left=61 ,top=230 ,right=323 ,bottom=286 ,align='left' ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='소       속 :' ,left=61 ,top=304 ,right=323 ,bottom=357 ,align='left' ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='부양코드  :' ,left=56 ,top=373 ,right=323 ,bottom=426 ,align='left' ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='DEPTNM', left=328, top=304, right=1040, bottom=357, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='BAEBUSU', left=328, top=373, right=667, bottom=426, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PAYBNKNM', left=328, top=447, right=534, bottom=500, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='계좌번호  :' ,left=56 ,top=447 ,right=323 ,bottom=500 ,align='left' ,face='굴림' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='PAYNUM', left=564, top=447, right=1087, bottom=500, align='left', face='굴림', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='/' ,left=534 ,top=447 ,right=564 ,bottom=500 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<L> left=29 ,top=2064 ,right=1368 ,bottom=2064 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1384 ,top=2064 ,right=1873 ,bottom=2064 </L>
	<C>id='PX0020', left=1175, top=942, right=1365, bottom=997, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PR0020', left=937, top=942, right=1154, bottom=997, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1876 ,top=206 ,right=1876 ,bottom=669 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='시간외수당' ,left=40 ,top=1016 ,right=254 ,bottom=1074 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자격수당' ,left=40 ,top=1085 ,right=254 ,bottom=1138 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='저축종류' ,left=40 ,top=2000 ,right=254 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='갑근세' ,left=40 ,top=1572 ,right=254 ,bottom=1627 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='건강보험' ,left=40 ,top=1715 ,right=254 ,bottom=1773 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='국민연금' ,left=40 ,top=1789 ,right=254 ,bottom=1839 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='주민세' ,left=40 ,top=1646 ,right=254 ,bottom=1699 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=926 ,top=923 ,right=926 ,bottom=1437 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=29 ,top=1355 ,right=1876 ,bottom=1355 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=29 ,top=1283 ,right=1876 ,bottom=1283 </L>
	<L> left=29 ,top=1212 ,right=1876 ,bottom=1212 </L>
	<L> left=29 ,top=1143 ,right=1876 ,bottom=1143 </L>
	<L> left=29 ,top=1077 ,right=1876 ,bottom=1077 </L>
	<L> left=29 ,top=1775 ,right=1876 ,bottom=1775 </L>
	...
	<C>id='B11000', left=267, top=1715, right=463, bottom=1773, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<T>id='공조회비' ,left=937 ,top=1572 ,right=1156 ,bottom=1625 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=29 ,top=1635 ,right=1876 ,bottom=1635 </L>
	<L> left=29 ,top=1707 ,right=1876 ,bottom=1707 </L>
	<L> left=471 ,top=1556 ,right=471 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<C>id='B13000', left=717, top=1572, right=910, bottom=1625, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<L> left=918 ,top=1556 ,right=918 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=926 ,top=1556 ,right=926 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=1164 ,top=1556 ,right=1164 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=1373 ,top=1556 ,right=1373 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=1630 ,top=1556 ,right=1630 ,bottom=1852 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='금융기관' ,left=267 ,top=2000 ,right=463 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=471 ,top=1982 ,right=471 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='총불입기간' ,left=479 ,top=2000 ,right=699 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='누계횟수' ,left=717 ,top=2000 ,right=913 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=926 ,top=1982 ,right=926 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='당월불입액' ,left=937 ,top=2000 ,right=1156 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1164 ,top=1982 ,right=1164 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='누계액' ,left=1175 ,top=2000 ,right=1368 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1373 ,top=1897 ,right=1373 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='상환원금' ,left=1392 ,top=2000 ,right=1619 ,bottom=2053 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1630 ,top=1982 ,right=1630 ,bottom=2326 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='대출잔액' ,left=1392 ,top=2246 ,right=1619 ,bottom=2302 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='상환횟수' ,left=1392 ,top=2164 ,right=1619 ,bottom=2223 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='상환이자' ,left=1392 ,top=2085 ,right=1619 ,bottom=2140 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=29 ,top=2236 ,right=1876 ,bottom=2236 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<L> left=29 ,top=2151 ,right=1876 ,bottom=2151 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='소득누계' ,left=56 ,top=2466 ,right=312 ,bottom=2521 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<L> left=926 ,top=2363 ,right=926 ,bottom=2622 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<C>id='PX0030', left=1175, top=1016, right=1365, bottom=1074, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='PR0030', left=937, top=1016, right=1154, bottom=1074, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P30000', left=712, top=942, right=910, bottom=997, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='현장수당' ,left=479 ,top=942 ,right=699 ,bottom=997 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='P35000', left=712, top=1085, right=910, bottom=1138, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='식대보조' ,left=479 ,top=1085 ,right=699 ,bottom=1138 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='P31000', left=712, top=1011, right=910, bottom=1074, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='북측근무수당' ,left=479 ,top=1011 ,right=699 ,bottom=1074 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='PR0040', left=937, top=1085, right=1154, bottom=1138, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PX0040', left=1175, top=1085, right=1365, bottom=1138, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='전월소급' ,left=1384 ,top=942 ,right=1627 ,bottom=997 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='BX0030', left=717, top=1715, right=910, bottom=1770, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='BR0030', left=479, top=1715, right=699, bottom=1770, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='BX0020', left=717, top=1648, right=910, bottom=1701, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='BR0020', left=479, top=1648, right=699, bottom=1701, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='BX0040', left=717, top=1789, right=913, bottom=1839, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='BR0040', left=479, top=1789, right=699, bottom=1839, align='left', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='정산주민세' ,left=1402 ,top=1715 ,right=1619 ,bottom=1767 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='정산소득세' ,left=1405 ,top=1643 ,right=1622 ,bottom=1696 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='T21000', left=1646, top=1643, right=1844, bottom=1696, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='B16000', left=1175, top=1569, right=1373, bottom=1622, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='T22000', left=1651, top=1712, right=1847, bottom=1765, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='연차수당' ,left=1384 ,top=1011 ,right=1625 ,bottom=1074 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='P38000', left=717, top=1151, right=913, bottom=1209, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='성과급' ,left=482 ,top=1156 ,right=701 ,bottom=1209 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='P34000', left=1648, top=1011, right=1860, bottom=1074, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='P39000', left=1646, top=942, right=1860, bottom=997, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='차량유지비' ,left=931 ,top=1148 ,right=1154 ,bottom=1209 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1384 ,top=1892 ,right=1384 ,bottom=2326 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
	<C>id='P24000', left=1175, top=1148, right=1365, bottom=1209, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='보증보험' ,left=937 ,top=1648 ,right=1156 ,bottom=1701 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='BX0010', left=1175, top=1648, right=1373, bottom=1701, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='공조회대출' ,left=937 ,top=1715 ,right=1156 ,bottom=1767 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='AMT_2', left=1175, top=1715, right=1373, bottom=1767, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='{Decode(COAAMT,0,,COAAMT)}', left=1646, top=2000, right=1863, bottom=2053, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='COLAMT', left=1646, top=2085, right=1863, bottom=2138, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='COACNT', left=1646, top=2164, right=1863, bottom=2220, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<C>id='COJAMT', left=1646, top=2246, right=1863, bottom=2299, align='right', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
</B>
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2753 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='공조회비' ,left=478 ,top=1572 ,right=697 ,bottom=1625 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
