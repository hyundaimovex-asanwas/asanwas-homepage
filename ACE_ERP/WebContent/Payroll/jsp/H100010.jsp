...
function ln_Query(){
	...
	if (str3=="T" || str3=="K" ){	
		gcds_grid_ec01az.DataID = "/servlet/Contract.h100010_s1?v_str1="+str1
																																 +"&v_str2="+str2
																																 +"&v_str3="+str3
																																 +"&v_str4="+str4
																																 +"&v_str5="+str5
...
function ln_Print(){
	if (gcds_grid_ec01az.countrow<1) {
  	...
  	for(s=1;s<=gcds_grid_ec01az.countrow;s++) {
		...
		//REPORT TITLE START--------------------------------------------------------------------------------------
		if (gcds_grid_ec01az.namevalue(s,"PAYDIV") == '계약급여') { 
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/h100010_head.gif"></td>
    ...
    <td COLSPAN=2>
        ...
        <tr> 
					<td width="140px" align=center  style="height:30px;border:0 solid #708090;border-right-width:1px;" bgcolor="#eeeeee">
						<nobr>&nbsp;적용년월</nobr></td>
					<td width="155px" style="height:30px;border:0 solid #708090;border-right-width:0px;padding-top:2px;border-right-width:1px;"><nobr>&nbsp;
					...
					<td width="133px"  align=center style="height:30px;border:0 solid #708090;border-right-width:1px;padding-left:3px;padding-right:3px;" bgcolor="#eeeeee"><nobr>&nbsp;지급구분</nobr></td>	
					<td style="height:30px;border:0 solid #708090;border-right-width:0px;padding-top:2px;"><nobr>
						<comment id="__NSID__"><object id=gclx_select_ec01az  name="gclx_select_ec01az" classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 width=50 style="position:relative;left:8px;top:-1px;font-size:12px;width:80px;height:100px;">
							<param name=CBData					value="T^계약급여,K^격려금">
					...
					<td width="240" align=left style="height:30px;border:0 solid #708090;border-right-width:0px;"><nobr><input id="txt_sang" type="text" style="position:relative;left:-3px;top:1px;width:45px;display:none"></nobr></td>
							...
							<tr> 
								<td valign=top>
									<table border="5" cellpadding=0 cellspacing=0    style='width:876px;height:421px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:0 solid #708090'>
										<tr>
											<td style="height:20px;border:1 solid #708090;" bgcolor="#eeeeee" align=center>&nbsp;적용년월</td>
											...
											<td style="height:20px;border:1 solid #708090;border-left-width:0px;" bgcolor="#eeeeee" align=center>&nbsp;사번</td>
											<td style="border:1 solid #708090;border-left-width:0px;" colspan=2><nobr>
												<input type="text" id=txt_empno class="txt11" maxlength=7 size=8 disabled style="postion:relative;left:8px;width:100px;"></nobr>
											</td>
											<td style="border:1 solid #708090;border-left-width:0px;" bgcolor="#eeeeee" align=center>&nbsp;성명</td>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee" align=center>&nbsp;현장수당</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
										...
										<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center>&nbsp;성과금</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee" align=center><nobr><input id="txt_px01"  type="text" class="txtbox" style="border:1 ;width:85px; height:15px;position:relative;top:2px;left:23px;background-color:#eeeeee" alt="기타지급1" disabled>&nbsp;</nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="height:20px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center><nobr><input id="txt_px02"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:18px;background-color:#eeeeee" alt="기타지급2" disabled></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center><nobr><input id="txt_px03"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:18px;background-color:#eeeeee" alt="기타지급3" disabled></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center><nobr><input id="txt_pb02"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:19px;background-color:#eeeeee" alt="기타공제2" disabled></nobr></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee" align=center><nobr><input id="txt_pb03"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:19px;background-color:#eeeeee" alt="기타공제3" disabled></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee" align=center>&nbsp;공조회대출</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											...
											<td style="height:20px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center><nobr>&nbsp;</nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												&nbsp;
											</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee" align=center>&nbsp;</td>
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2753 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='성과금' ,left=938 ,top=1222 ,right=1156 ,bottom=1278 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
