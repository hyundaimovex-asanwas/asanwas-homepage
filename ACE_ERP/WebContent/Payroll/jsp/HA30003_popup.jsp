...
******************************************************************************/
function ln_Start(){
	if(window.dialogArguments[0] != undefined && window.dialogArguments[0] != "hA30003") { 
	   parentGubun="hA40001";
	}else if(window.dialogArguments[0] == "hA30003") {
		parentGubun="hA30003";
	}
}
...
function ln_Query(e){
	if(parentGubun=="") {							
		gcds_data.DataID = "/servlet/Contract.hA30003_s2?"
										 + "v_str1=" + txt_nm.value;
	}	else if(parentGubun=="hA40001") {	 
		gcds_data.DataID = "/servlet/Contract.hA40001_pop_s1?"
									   + "v_str1=" + txt_nm.value;
  } else if(parentGubun == "hA30003") {	 
		gcds_data.DataID = "/servlet/Contract.hA30003_s2?"
										 + "v_str1=" + txt_nm.value
										 + "&v_str2=" + "T";
	}
	...
	if (e=="A") {
		...
		if(parentGubun=="") {
			window.returnValue = gcds_data.namevalue(row,"EMPNMK") + ";" 
												 ...
												 + "v_str1=" + txt_nm.value;
		}	else if(parentGubun=="hA40001") { //추계퇴직급조회
