...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:	인사
+ 프로그램 ID	: hA50001.html
+ 기 능 정 의	: 야근휴일신청
+ 최 초 이 력	: 문희식
+ 변 경 이 력	: 이순미
+ 서 블 릿 명	: hA50001_s1, hA50001_s2, hA50001_s3, hA50001_t1, hA50001_s1_time
------------------------------------------------------------------------------>
...
function ln_Add(){
	...
	var v_payseq  = gcds_data2.namevalue(gcds_data2.rowposition,"PAYSEQ");	//직위
  ...
  TODT.enable = true;
	FRTIME.enabled = true;			//출근시간
	TOTIME.enabled = true;			//퇴근시간
