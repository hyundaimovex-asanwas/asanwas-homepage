...
function ln_Query(){
	...
	gcds_pay.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p010001_s1?v_str1="+str1+"&v_str2="+str2+"&v_str3="+fn_trim(str3);
	gcds_pay.Reset(); 
...
function ln_Save(){
	...
	//prompt('',gcds_pay.text);
		if (confirm("입력하신 사항을 등록하시겠습니까?")){
			...
			gctr_pay.Action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p010001_t1";
			gctr_pay.post();
			ln_Query();
		}
	}
...
<comment id="__NSID__"><object id="gcds_paycd11" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" VIEWASTEXT> 
	<PARAM NAME="SYNCLOAD" VALUE="TRUE" ><!--급여구분[검색]-->
</object></comment><script>__ws__(__NSID__);</script>
...
<table width="877" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td background="../../Common/img/com_t_bg.gif"><img src="../img/p010001_head.gif"></td>
          ...
          <td>
						<comment id="__NSID__"><OBJECT  id=gcgd_pay classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="WIDTH:630px;HEIGHT:420px;border:1 solid #777777;display:block;" viewastext>
							...
							<PARAM NAME="Format"			VALUE="  
								<C> Name='지급구분'			ID=PAYDIV		HeadAlign=Center HeadBgColor=#B9D4DC Width=80  align=LEFT Data='gcds_paycd1:MINORCD:MINORNM' EditStyle=Lookup</C> 
