...
function ln_Query(){
	...
	gcds_pay.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p010004_s1?v_str1="+fn_trim(str1)
																													 +"&v_str2="+str2
																													 +"&v_str3="+fn_trim(str3)
																													 +"&v_str4="+gs_level
																													 +"&v_str5="+gs_treecd; 
...
//	prompt('',gcds_pay.text);
		if (confirm("입력하신 사항을 등록하시겠습니까?")){
			gctr_pay.KeyValue = "p010004_t1(I:USER=gcds_pay)";
			gctr_pay.Action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p010004_t1";
			gctr_pay.post();
			ln_Query();
		}
	}
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
	...
	<img src="../img/p010007_head.gif"></td>
          ...
          <td>
						<comment id="__NSID__"><OBJECT id=gcgd_pay classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH:876px;HEIGHT:420px;border:1 solid #777777;display:block;" viewastext>
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<F> Name='소속명'			ID=DEPTNM			HeadBgColor=#B9D4DC Width=118		align=LEFT	BgColor='#f5f5f5' EditStyle=Lookup Data='gcds_deptcd:DEPTCD:DEPTNM' edit=none suppress=1</F>
								...
								<C> Name='그룹입사일'	ID=GRSTRTDT		HeadBgColor=#B9D4DC Width=75		align=CENTER Edit=none  Mask='XXXX/XX/XX'</C>
							...
							<G> Name='100%보상'		HeadAlign=Center HeadBgColor=#B9D4DC 
								...
								<C> Name='직책수당'		ID=P11000			HeadBgColor=#B9D4DC Width=72		align=RIGHT Edit=Numeric  </C>
								<C> Name='자기계발'		ID=P22000			HeadBgColor=#B9D4DC Width=72		align=RIGHT Edit=Numeric  </C>
								<C> Name='자격수당'			ID=P28000			HeadBgColor=#B9D4DC Width=72		align=RIGHT Edit=Numeric  </C>
								<C> Name='경협수당'		ID=P29000			HeadBgColor=#B9D4DC Width=72		align=RIGHT Edit=Numeric  </C>
								<C> Name='출납수당'			ID=P25000			HeadBgColor=#B9D4DC Width=72		align=RIGHT Edit=Numeric  </C>
