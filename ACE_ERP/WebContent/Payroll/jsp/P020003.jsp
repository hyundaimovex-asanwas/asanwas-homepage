...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:	급여/월급여변동사항
+ 프로그램 ID	: p020003.HTML
+ 기 능 정 의	: 조회|저장|삭제
+ 변 경 이 력	: 권영법
+ 수 정 이 력	: 정영식 - 2005.07.07 - 본부 - 소속 -팀별 조회조건 추가
+ 수 정 이 력	: 이순미 - 2005.08.02 - 소스 정리
+ 수 정 이 력	: 정영식 - 2005.08.19 - 최종변동일, 수습적용 입력가능
+ 수 정 이 력	: 정영식 - 2005.08.20 - 변동사항 엑셀 버튼 추가
+ 서 블 릿 명	: p020003_s1, p020003_t1
------------------------------------------------------------------------------>
...
function ln_Query(){
	...
	gcds_grid_ec01az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020003_s1?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4 
...
function ln_Save() {
	if (gcds_grid_ec01az.countrow <1) {
		...
		//	prompt('',gcds_grid_ec01az.text);
				gctr_data.KeyValue = "Payroll.p020003_t1(I:USER=gcds_grid_ec01az)";
				gctr_data.Action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020003_t1";
...
function ln_Excel(){
	 ...
	 var str2 = fn_trim(gcem_yearmon_search.Text);
	 var yyyy = ln_prvyyyy(str2.substr(0,4), str2.substr(4,2));
	 var mm = ln_prvmm(str2.substr(4,2));
	 var str1 = yyyy + mm;

	 gcds_excel.DataID ="<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020003_s2?v_str1="+str1+"&v_str2="+str2; 
	 //prompt("",gcds_excel.DataID);
	 gcds_excel.Reset();

	 gcgd_excel.RunExcel( str1 +"과 "+ str2 +' 사이 변경내용');
}
...
<comment id="__NSID__"><OBJECT id=gcds_excel classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	<PARAM NAME="SyncLoad" VALUE="true"><!--변경사항엑셀-->
...
<script language=JavaScript for=gcds_grid_ec01az event=OnColumnChanged(row,colid)>
	...
	gcds_grid_ec01az.NameValue(row,"APLAMT")+
	gcds_grid_ec01az.NameValue(row,"APLRAT")+
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td width=197 ><img src="../img/p020003_head.gif"></td>
        ...
        <tr> 
					...
					<td style="height:30px;border:0 solid #708090;border-right-width:1px;padding-top:2px;"><nobr>&nbsp;
						...
						<td style="height:30px;border:0 solid #708090;border-right-width:1px;"><nobr><comment id="__NSID__"><object id=gclx_select_ec01az  name="gclx_select_ec01az" classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 height=106 width=50 
							...
							<param name=CBData					value="1^정기급여,2^소급급여,4^휴직급여,5^상여급여,6^격려금">
        ...
        <tr> 
          <td style="width:340px" valign=top>
					...
					<td STYLE="PADDING-TOP:0px;" valign=top>
									...
									<table border="0" cellpadding=0 cellspacing=0  border=0  style='width:512px;height:421px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:0 solid #708090'>
										<tr>
											...
											<td style="border:1 solid #708090;border-left-width:0px;" colspan=2><nobr>
												<comment id="__NSID__"><object id=gcem_APPDT  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:1px; width:50px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 validFeatures="ignoreStatus=yes" validExp="">
													<param name=Text          value="">
													<param name=Alignment			value=0>
										...
										<tr>
											...
											<td style="border:1 solid #708090;border-top-width:0px;border-left-width:0px" colspan=2><nobr>
												<comment id="__NSID__"><object id=gcem_strtdt  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:1px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 validFeatures="ignoreStatus=yes" validExp="">
													<param name=Text          value="">
													<param name=Alignment			value=0>
													<param name=ReadOnly			value=True>
													<param name=Border	      value=True>
											...
											<td style="border:1 solid #708090;border-top-width:0px;border-left-width:0px" colspan=2><nobr>
												<comment id="__NSID__"><object id=gcem_enddt  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:1px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 validFeatures="ignoreStatus=yes" validExp="">
													<param name=Text          value="">
													<param name=Alignment			value=0>
													<param name=ReadOnly			value=True>
													<param name=Border	      value=True>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px" colspan=2>
												<comment id="__NSID__"><object id=gcem_paydt1  classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:1px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1 validFeatures="ignoreStatus=yes" validExp="">
													<param name=Text          value="">
													<param name=Alignment			value=0>
													<param name=ReadOnly			value=True>
													<param name=Border	      value=True>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-top-width:0px;border-bottom-width:0px;" colspan=1>&nbsp;</td>
											<td style="height:10px;border:1 solid #708090;border-bottom-width:0px;border-top-width:0px;border-left-width:0px;"  ><nobr></nobr></td>

											<td style="height:20px;" class="tab32"  bgcolor="#eeeeee">&nbsp;본사,현장,해외</td>
											...
											<td style="height:20px;border:1 solid #708090;border-left-width:1px;border-bottom-width:0px;" bgcolor="#B9D4DC" colspan=1><nobr>&nbsp;지급합계</nobr></td>
										...
										<tr>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>	 &nbsp; <comment id="__NSID__"><object id=gclx_trainyn classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 style="position:relative;left:0px;top:3px;font-size:12px;width:70px;height:120px;">
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;산재보험</nobr></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="height:20px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr><input id="txt_pb01"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타공제1"></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee"><nobr><input id="txt_pb03"  type="text" class="txtbox" style="border:1 ;width:80px; height:15px;position:relative;top:2px;left:5px;background-color:#eeeeee" alt="기타공제3"></nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
                       ...
                       <!-- 엑셀을 위한 hidden grid -->
												<comment id="__NSID__"><OBJECT id=gcgd_excel  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="; WIDTH: 363px; HEIGHT: 399px;border:1 solid #777777;display:none; " viewastext>
												<PARAM NAME="DataID"			VALUE="gcds_excel">
											  <PARAM NAME="Format"			VALUE="  
												<C> Name='사번' ID=EMPNO  	HeadAlign=Center HeadBgColor=#B9D4DC Width=55 align=center  </C> 
												<C> Name='성명'			ID=EMPNMK   HeadAlign=Center HeadBgColor=#B9D4DC Width=110  </C>
												<C> Name='변경전'			ID=PREPAYGRD		HeadAlign=Center HeadBgColor=#B9D4DC Width=50 align=center </C>
												<C> Name='변경후'			ID=PAYGRD  	HeadAlign=Center HeadBgColor=#B9D4DC Width=50 align=center   </C> 
												<C> Name='변경내용'		ID=ETC		HeadAlign=Center HeadBgColor=#B9D4DC Width=200 align=left </C>
												">
											  </OBJECT></comment><script>__ws__(__NSID__);</script>
											</td>
										</tr>
										...
										<tr><!-- 대출이자 -->
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;대출원금</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__">
												 <object id=gcem_APLAMT classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="height:20px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">&nbsp;대출이자</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_APLRAT classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">&nbsp;대출잔액</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_APJAMT classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
...
<comment id="__NSID__"><OBJECT id=gcbn_data00 classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	...
	<PARAM NAME="BindInfo"			VALUE="
		...
		<C>Col=APLAMT			Ctrl=gcem_APLAMT		Param=Text</C>	 
		<C>Col=APLRAT			Ctrl=gcem_APLRAT		Param=Text</C>
		...
		<C>Col=APLAMT			Ctrl=gcem_APLAMT		Param=Text</C>
		<C>Col=APLRAT			Ctrl=gcem_APLRAT		Param=Text</C>
		<C>Col=APJAMT			Ctrl=gcem_APJAMT		Param=Text</C>
