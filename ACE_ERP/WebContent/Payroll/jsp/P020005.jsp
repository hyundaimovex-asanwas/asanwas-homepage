...
function ln_Excel(){
	...
	else gcgd_grid_ec01az.GridToExcel("급여내역","",2);
}
...
function ln_Print(){
	...
	for(s=1;s<=gcds_grid_ec01az.countrow;s++) {
		...
		if (gcds_grid_ec01az.namevalue(s,"PAYDIV") == '정기급여') { 
			...
			gcds_report0.namevalue(s,"CTITLE")=gcds_grid_ec01az.namevalue(s,"PAYDIV").substring(0,4) + " 명세서 ["
																				+ gcds_grid_ec01az.namevalue(s,"APPDT").substring(0,4) + "년"
																				+ gcds_grid_ec01az.namevalue(s,"APPDT").substring(4,6) + "월]";
		}
		//REPORT TITLE END----------------------------------------------------------------------------------------
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/p020005_head.gif"></td>
	...
	<table width="876" cellpadding="0" cellspacing="0" border="0">
		<tr> 
			<td style="width:340px" valign=top>
				<comment id="__NSID__"><OBJECT id=gcgd_grid_ec01az name=gcgd_grid_ec01az classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 style="WIDTH: 363px; HEIGHT: 403px;border:1 solid #777777;display:block;" viewastext>
					...
					<PARAM NAME="Format"			VALUE="  
						...
						<C> Name='본부'		ID=GROUPNM  HeadAlign=Center HeadBgColor=#B9D4DC Width=110 align=left sort=true  </C>
            ...
            <C> Name='발령일'	ID=DPOFFDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center Mask='XXXX/XX/XX' sort=true</C>
						...
						<C> Name='직책수당'	ID=P11000	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='시간외수당'	ID=P12000	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='근속수당'		ID=P21000	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='자기계발비'	ID=P22000	HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>

						<C> Name='부양가족수당'	ID=P23000		HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=right </C>
						<C> Name='차량유지비'		ID=P24000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='출납수당'		ID=P25000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='운전수당'		ID=P26000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='연장수당'		ID=P27000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='자격수당'		ID=P28000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='남북경협수당'	ID=P29000		HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=right </C>
						<C> Name='사장단수당'		ID=P30000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>

						<C> Name='특수지수당'		ID=P31000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='지역근무수당'	ID=P32000		HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=right </C>
						<C> Name='학비보조금'		ID=P36000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='개인연금보조금'	ID=P37000		HeadAlign=Center HeadBgColor=#B9D4DC Width=85 align=right </C>
						<C> Name='현장직책수당'		ID=P38000		HeadAlign=Center HeadBgColor=#B9D4DC Width=75 align=right </C>
						<C> Name='년차수당'		ID=P34000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						...
						<C> Name='건강보험료'	ID=B11000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						...
						<C> Name='개인연금'		ID=B15000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
						<C> Name='여직원회비'	ID=B14000		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
            ...
            <C> Name='사내대출'		ID=AMT_1		HeadAlign=Center HeadBgColor=#B9D4DC Width=80 align=right </C>
						...
						<C> Name='유보금액'		ID=UBAMT		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=right </C>
								...
								<td valign=top>
									<table border="5" cellpadding=0 cellspacing=0    style='width:508px;height:421px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:0 solid #708090'>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;;border-top-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P11000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P21000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P22000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P23000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P25000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P26000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P27000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P29000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
											<comment id="__NSID__"><object id=gcem_P37000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_P36000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">&nbsp;현장직책수당</td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_PX0010 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											...
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_B15000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_B14000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;<font color="#ADADAD">산재보험</font></nobr></td>
											<td style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_B17000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 > 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
										...
										<tr>
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;" bgcolor="#eeeeee">&nbsp;사내대출</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
												<comment id="__NSID__"><object id=gcem_amtrat classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1" style="position:relative; left:2px;top:0px; width:70px; height:20px; font-family:굴림; font-size:9pt;" class=objclsEme1 validFeatures="ignoreStatus=yes" validExp=""> 
													<param name=Text          value="">
													<param name=Alignment			value=2>
													<param name=Border	      value=true>
													<param name=ClipMode			value=true>
											...
											<td style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px;" bgcolor="#eeeeee">&nbsp;공조회대출</td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>
										...
										<!-- 	<td style="height:20px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;</nobr></td>
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" colspan=2>&nbsp;</td> -->
											<td style="border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">&nbsp;</td>
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2752 ,face='Arial' ,size=10 ,penwidth=1
	...
	<L> left=937 ,top=2363 ,right=937 ,bottom=2622 ,penstyle=solid ,penwidth=0 ,pencolor=#000000 </L>
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2753 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='현장직책수당' ,left=938 ,top=1222 ,right=1156 ,bottom=1278 ,align='left' ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
