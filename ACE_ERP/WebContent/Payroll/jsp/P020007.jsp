...
function fnOnLoad(tree_idx){
  ...
  nwgubun.value="4_1";
	...
	gcds_pyo4.namevalue(2,"param4")="직책수당계";
...
function ln_Excel_Query(){
	...
	gcds_excel_5_1.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020010_s1?v_str1="+str1+"&v_str2="+str3; 
...
function ln_Excel_Query2(){
  ...
  str5+="소득총액";
	...
	gcds_excel_6_1.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s10?"
									 + "v_str1="  + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Query_3_1(){ //급여변동내역 탭 조회
	...
	alert("적용년월을 입력해주세요");
	 ...
	 //gcgd_create3_1.ColumnProp('PRVYYYYMM', 'Name') = str2_1.substr(0,4)+"년 " + str2_1.substr(4,2)+"월";
	 //gcgd_create3_1.ColumnProp('NOWYYYYMM', 'Name') = str2_2.substr(0,4)+"년 " + str2_2.substr(4,2)+"월";
	 gcgd_create3_1.ColumnProp('PRVYYYYMM', 'Name') = str2_1.substr(4,2)+"월 급여";
	 gcgd_create3_1.ColumnProp('NOWYYYYMM', 'Name') = str2_2.substr(4,2)+"월 급여";
   
	 gcds_grid_ec03az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s1?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2_1
									 + "&v_str3=" + str2_2
									 + "&v_str4=" + str3
...
function ln_Query_4_1(){ 
	...
	gcds_grid_ec04az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s2?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Query_5_1(){																
	...
	gcds_grid_ec05az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s3?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Query_6_1(){ 
	...
	gcds_grid_ec06az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s8?"
									 + "v_str1="  + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4 
  ...
  yyyymmPlusMinus(str2,str1,gs_date3);
	...
	if(gclx_select_7.bindcolval=="1"){
      ...
      str4="Z";
		...
		gcds_change_7.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s17?"
										 + "v_str1="  + str2
										 + "&v_str2=" + str3
										 + "&v_str3=" + str2_1
										 + "&v_str4=" + str4;
		...
		gcds_change_7.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s18?"
										 + "v_str1="  + str2
										 + "&v_str2=" + str3
										 + "&v_str3=" + str2_1
										 + "&v_str4=" + str4;
...
function ln_Report_4_1(e,n){ 
  ...
  if(fn_trim(gclx_select_jigub4.bindcolval)==5){ 	//상여일때와 달리 한다.
	...
	if (str3 == e) {
		gcds_report0.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s4"+n+"?"
										 + "v_str1="	+ str2_1
										 + "&v_str2=" + str2
										 + "&v_str3=" + str3
										 + "&v_str4=" + str4
...
function ln_Report_4_2(e,n){ 
	...
	if (str3 == e) {
	  //2008.09.05 재택반영으로 변경함.
		//gcds_report1.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s5"+n+"?"
    //2010.10.29 부서변경되어도 조회 가능하기위해 수정. 
		//gcds_report1.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s6"+n+"?"
		gcds_report1.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s63"+n+"?"
										 + "v_str1="	+ str2_1
										 + "&v_str2=" + str2
										 + "&v_str3=" + str3
										 + "&v_str4=" + str4
										 ...
										 + "&v_str6=" + str6
										 + "&v_str7=" + str7;
		//prompt('gcds_report636',gcds_report1.DataID );
		gcds_report1.Reset(); 
...
function ln_Report_4_3(e,n){ 
	...
	if (str3 == e) {
	gcds_report2.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s7"+n+"?"
									 + "v_str1="	+ str2_1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Report_5_2(){ //소속별급여지급현황 상세보고서
	...
	gcds_report2.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s6?"
									 + "v_str1=" + str2_1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
...
function ln_Report_3_1(){ //급여변동내역 총인원보고서
	var str2 = fn_trim(gcem_app_yyyymm_3.Text);        //지급년월
       gcds_report0.ClearAll();
		...
		var ls_temp = 
		      ...
		      + "NOWYYYYMM:STRING,"   /*현재년월*/
					...
					+ "A21_AMT:Decimal,"	/* 연차수당          */	
					+ "A22_AMT:Decimal,"	/* 식대         */	
					+ "AA_AMT:Decimal,"	    /* 지급 총합 증감 금액*/		
					+ "ETC_AMT:Decimal," 	/* 기타지급          */	
					+ "ITAA_NUM:Decimal,"	/* 증감계액인원 */      
					+ "ITAA_AMT:Decimal,"	/* 증감계액금액 */      
					+ "ITNUM:Decimal,"	  /* 입퇴사자 소계인원 */ 
					+ "ITAMT:Decimal,"	  /* 입퇴사자 소계금액 */ 
					+ "AA_NUM:Decimal";	  /* 기존인원수*/	       
		gcds_report0.SetDataHeader(ls_temp);
		gcds_report0.Addrow();
	  ...
	  gcds_report0.namevalue(1,"NOWYYYYMM")=gcgd_create3_1.ColumnProp('NOWYYYYMM', 'Name');
		...
		gcds_report0.namevalue(1,"A21_AMT")=gcds_grid_ec03az.Sum(37,0,0);	/* 연차수당 */	
		gcds_report0.namevalue(1,"A22_AMT")=gcds_grid_ec03az.Sum(38,0,0);	/* 식대 */	
		gcds_report0.namevalue(1,"AA_AMT")= gcds_grid_ec03az.Sum(42,0,0); /* 지급 총합 증감 금액*/		
		gcds_report0.namevalue(1,"ETC_AMT")=gcds_grid_ec03az.Sum(43,0,0);	/* 기타지급 */
		gcds_report0.namevalue(1,"ITAA_NUM")=gcds_grid_ec03az.Sum(44,0,0);/* 증감계액인원 */     
		gcds_report0.namevalue(1,"ITAA_AMT")=gcds_grid_ec03az.Sum(45,0,0);/* 증감계액금액 */     
		gcds_report0.namevalue(1,"ITNUM")=gcds_grid_ec03az.Sum(46,0,0);	  /* 입퇴사자 소계인원 */
		gcds_report0.namevalue(1,"ITAMT")= gcds_grid_ec03az.Sum(47,0,0);  /* 입퇴사자 소계금액 */	
		gcds_report0.namevalue(1,"AA_NUM")=gcds_grid_ec03az.Sum(48,0,0);	/* 기존인원수*/	       
}
...
function ln_Report_7_1(){ //급여변동내역 총인원보고서
    ...
    gcds_report0.ClearAll();
       ...
       str3 = "급여 소급내역";
		}else if (gclx_select_7.bindcolval=="4"){
       str3 = "기타 급여";
		}else{
...
function ln_Print(){
	...
	if (nwgubun.value=='4_1' && fn_trim(gclx_select_jigub4.BindColVal) == '1') {	//급여 지급현황[정기]
		if (gcds_grid_ec04az.countrow<1) {
			...
			if (str1.length != 6) {
				...
				var v_pay01 = "1";
				var v_pay02 = "";
				ln_Report_4_1(v_pay01,v_pay02);	 //총인원
				ln_Report_4_3(v_pay01,v_pay02);  //임원
				ln_Report_4_2(v_pay01,v_pay02);  //임원외 상세
				gcrp_print.preview();
			}
		}
	} else if ( (nwgubun.value=='4_1' && fn_trim(gclx_select_jigub4.BindColVal) == '5')||(nwgubun.value=='4_1' && fn_trim(gclx_select_jigub4.BindColVal) == '6') ){	//급여 지급현황[상여]
		...
		if (gcds_grid_ec04az.countrow<1) {
			...
			if (str1.length != 6) {
			  ...
			  //alert("step1");
				var v_pay01 = gclx_select_jigub4.BindColVal;
				ln_Report_4_1(v_pay01,"4");
				ln_Report_4_3(v_pay01,"7");
				//재택근무 때문에 변경함. 200809
				//ln_Report_4_2(v_pay01,"5");
				ln_Report_4_2(v_pay01,"6");
  ...
  }	else if (nwgubun.value=='3_1') { //급여변동현황
...
function ln_Excel(){
  if(nwgubun.value=="4_1"){
	  ...
	  if (gcds_change_7.countrow<1) alert("다운로드하실 자료가 없습니다.");
		else{
			var strmm = gcem_app_yyyymm_7.text;
			strmm = strmm.substring(4,6);
			gcgd_create7_1.RunExcel(strmm+'월 급여변동자');
		}
	}
}
...
function ln_Excel_bank(){
	...
	gcds_excel.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_s9?v_str1="+str1+"&v_str2="+str2;
	gcds_excel.Reset();
}
...
/*******************************************************************************
  Description : 지급현황 관련 근무지 출력순, 근무지 출력순 코드, 근무지 출력순 명 
	              PBPAY에 업데이트 하기 
******************************************************************************/
function ln_Update(){

  //마감 체크 하기 - 마감전 건에 대해서만 가능함.
	gcds_chk.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>closechk_s?v_str1="+ gcem_yyyymm41.text+"&v_str2=1"; 
	//prompt("",gcds_chk.DataID);
	gcds_chk.Reset();

  if(gcds_chk.countrow>0){
	  //alert(gcds_chk.namevalue(gcds_chk.rowposition,"WRKSTS"));
		if(gcds_chk.namevalue(gcds_chk.rowposition,"WRKSTS")=="C"){
			alert(gcem_yyyymm41.text+"는 이미 마감되었습니다. 확인하십시요.");
			return false;
		}
	}else{
	  alert(gcem_yyyymm41.text+"는 급여 데이터가 존재하지 않습니다. 확인하십시요.");
		return false
	}
  ...
  gcds_temp.Addrow();
	gcds_temp.namevalue(gcds_temp.rowposition,"APPDT") = gcem_yyyymm41.text;

	if (gcds_temp.IsUpdated) {
		if (confirm("지급년월 "+gcem_yyyymm41.text+" 의 출력순 관련정보를 급여테이블에 업데이트 하시겠습니까? ")){	
			gctr_data.Action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p020007_t1?";
			gctr_data.Parameters = "v_str1="+gcem_yyyymm41.text;
			gctr_data.post();
		}	
	}
}
...
------------------------------------------------------------------------------>
<comment id="__NSID__">
<OBJECT id=gcds_pyo4 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
...
<OBJECT id=gcds_chk classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	<PARAM NAME="SyncLoad" VALUE="true"><!-- 임시 DataSet-->
</OBJECT>
...
------------------------------------------------------------------------------>
 <object id=gctr_data classid=clsid:0A2233AD-E771-11D2-973D-00104B15E56F VIEWASTEXT>
	...
	<PARAM NAME="KeyValue" VALUE="p020007_t1(I:USER=gcds_temp)">
</object>
...
<script language="javascript" for="gcds_grid_ec06az" event="onloadcompleted(row,colid)">
	...
	else
	{
		...
		gcds_pyo6.namevalue(1,"param5")=gcds_grid_ec06az.Sum(9,0,0)+"";
		//gcds_pyo6.namevalue(1,"param6")="건강보험계";
		gcds_pyo6.namevalue(1,"param7")=gcds_grid_ec06az.Sum(37,0,0)+"";
		//gcds_pyo6.namevalue(1,"param8")="소득세계";
		gcds_pyo6.namevalue(1,"param9")=gcds_grid_ec06az.Sum(35,0,0)+"";

		gcds_pyo6.namevalue(2,"param1")=gcds_grid_ec06az.countRow;
		//gcds_pyo6.namevalue(2,"param2")="실지급액계";
		gcds_pyo6.namevalue(2,"param3")=gcds_grid_ec06az.Sum(53,0,0)+"";
		//gcds_pyo6.namevalue(2,"param4")="직책수당계";
		gcds_pyo6.namevalue(2,"param5")=gcds_grid_ec06az.Sum(10,0,0)+"";
		//gcds_pyo6.namevalue(2,"param6")="국민연금계";
		gcds_pyo6.namevalue(2,"param7")=gcds_grid_ec06az.Sum(38,0,0)+"";
		//gcds_pyo6.namevalue(2,"param8")="주민세계";
		gcds_pyo6.namevalue(2,"param9")=gcds_grid_ec06az.Sum(36,0,0)+"";

		//gcds_pyo6.namevalue(3,"param4")="시간외수당계";
		gcds_pyo6.namevalue(3,"param5")=gcds_grid_ec06az.Sum(11,0,0)+"";
		//gcds_pyo6.namevalue(3,"param6")="고용보험계";
		gcds_pyo6.namevalue(3,"param7")=gcds_grid_ec06az.Sum(39,0,0)+"";
		//gcds_pyo6.namevalue(3,"param8")="공제계";
		gcds_pyo6.namevalue(3,"param9")=gcds_grid_ec06az.Sum(52,0,0)+"";
		gcds_pyo6.RowPosition = 4;
			...
			<table cellpadding="0" cellspacing="0" border="0" style='width:125px;height:62px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
				...
				<tr> 
					<td align=center  style="border:0 solid #708090;"><nobr>&nbsp;
						<SELECT id="nwgubun" name="nwgubun" style="width:122px;" onchange="ln_visible_hidden(this.value);">
...
<!-- 급여변동현황 -->
<DIV ID="gcgd_create3" STYLE="display:none;">
		...
		<tr> 
			...
			<td style="height:30px;border:0 solid #708090;border-right-width:1px;padding-top:2px;border-top-width:0px;border-bottom-width:1px"><nobr>
				<comment id="__NSID__"><object id=gclx_select_div3  name="gclx_select_div3" classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  style="position:relative;left:8px;top:2px;font-size:12px;width:120px;height:200px;">
					...
					<param name=ListExprFormat	value="DEPTNM^0^100">
...
<!-- 급여 소득 총액 [검색]-->
<DIV ID="gcgd_create6" STYLE="display:none;">
	<table  cellpadding="0" cellspacing="0" border="0" style='width:737px;height:20px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
		<tr> 
			<td width="10" align=RIGHT  style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" bgcolor="#eeeeee">
				<nobr>&nbsp;적용년월&nbsp;&nbsp;</nobr></td>
...
<!--소속별 지급현황 검색키워드-->
<DIV ID="gcgd_create5" STYLE="display:none;">   
	<table  cellpadding="0" cellspacing="0" border="0" style='width:737px;height:20px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
    <tr> 
			<td width="10" align=RIGHT  style="height:30px;border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;" bgcolor="#eeeeee"><nobr>&nbsp;지급년월&nbsp;&nbsp;</nobr></td>
			<td style="height:30px;border:0 solid #708090;border-right-width:0px;padding-top:2px;border-right-width:1px;border-bottom-width:1px;"><nobr>
      ...
      <table width="876" cellpadding="0" cellspacing="0" border="0">
        <tr> 
          <td style="width:340px" valign=top>
						<DIV ID="gcgd_create1_1" STYLE="display:none;"> </div>
						<DIV ID="gcgd_create2_1" STYLE="display:none;">  </div>
						<DIV id=gcgd_create2_2 style="position:absolute;top:112px;left:347px;display:none"></div>
						<comment id="__NSID__"><OBJECT id=gcgd_create3_1 classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  codebase="http://www.singiro.co.kr/Common/cab/toinbgrid.cab#version=1,1,0,135"  style="WIDTH: 875px; HEIGHT: 416px;border:1 solid #777777;display:none;" viewastext>
						  ...
						  <PARAM NAME="viewSummary" VALUE="1">
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<X> Name='증감계액'   	HeadAlign=Center HeadBgColor=#B9D4DC Width=65
										<G> Name='계' HeadAlign=Center HeadBgColor=#B9D4DC Width=65
										<C> Name='인원' ID=ITAA_NUM  	HeadAlign=Center HeadBgColor=#B9D4DC Width=40 SumText=@sum SumBgColor=#C3D0DB   align=RIGHT </C> 
										<C> Name='금액' ID=ITAA_AMT  	HeadAlign=Center HeadBgColor=#B9D4DC Width=80  SumText=@sum SumBgColor=#C3D0DB  align=RIGHT </C> 
										</G>
								</X>
								<X> Name='입퇴사자'   	HeadAlign=Center HeadBgColor=#B9D4DC Width=65
										...
										<G> Name='소계' HeadAlign=Center HeadBgColor=#B9D4DC Width=65
										<C> Name='인원' ID=ITNUM  	HeadAlign=Center HeadBgColor=#B9D4DC Width=30 SumText=@sum SumBgColor=#C3D0DB  align=RIGHT </C> 
										<C> Name='금액' ID=ITAMT  	HeadAlign=Center HeadBgColor=#B9D4DC Width=80 SumText=@sum SumBgColor=#C3D0DB  align=RIGHT  </C> 
										</G>
								</X>
								<X> Name='기존인원'   	HeadAlign=Center HeadBgColor=#B9D4DC Width=65
              			...
              			<G> Name='소계' HeadAlign=Center HeadBgColor=#B9D4DC Width=65
										<C> Name='인원' ID=AA_NUM  	HeadAlign=Center HeadBgColor=#B9D4DC Width=30 SumText=@sum SumBgColor=#C3D0DB  align=RIGHT </C> 
              ...
              <PARAM NAME="BorderStyle" VALUE="0">
							...
							<PARAM NAME="SortView"		VALUE="left">
							<PARAM NAME="Format"			VALUE="  
								<FC> Name='소속'				ID=GROUPNM BgColor='#f5f5f5' HeadAlign=Center HeadBgColor=#B9D4DC Width=105 align=left    SumBgColor=#C3D0DB sort=true </FC>
            ...
            <!--소속별 지급현황-->
              ...
              <PARAM NAME="DataID"			VALUE="gcds_excel_6_1">
							<PARAM NAME="SuppressOption" value="1">
						  <PARAM NAME="Format"			VALUE="  
								<C> Name='구분'           ID=GROUPNM   		HeadAlign=Center HeadBgColor=#B9D4DC Width=140  align=left   </C> 
              ...
              <PARAM NAME="BorderStyle" VALUE="0">
							...
							<PARAM NAME="Format"			VALUE="  
								...
								<FC> Name='직위'				ID=PAYGRDNM  HeadAlign=Center HeadBgColor=#B9D4DC Width=75   align=left   BgColor='#f5f5f5' SumBgColor=#C3D0DB sort=true </FC> 
                ...
                <G> Name='공통수당' HeadAlign=Center HeadBgColor=#B9D4DC
									...
									<C> Name='직책'		  	ID=P11000 HeadAlign=Center HeadBgColor=#B9D4DC Width=60  align=RIGHT SumBgColor=#C3D0DB </C> 
									...
									<C> Name='학자금'		  ID=P36000 HeadAlign=Center HeadBgColor=#B9D4DC Width=60  align=RIGHT SumBgColor=#C3D0DB </C> 
                ...
                <G> Name='변동수당' HeadAlign=Center HeadBgColor=#B9D4DC
									...
									<C> Name='해외수당'		ID=P31000 HeadAlign=Center HeadBgColor=#B9D4DC Width=65  align=RIGHT SumBgColor=#C3D0DB </C> 
									<C> Name='전월소급'   ID=P39000 HeadAlign=Center HeadBgColor=#B9D4DC Width=65  align=RIGHT SumBgColor=#C3D0DB </C> 
                ...
                <C> Name='비고'				  ID=ORDNM2     HeadAlign=Center HeadBgColor=#B9D4DC Width=60   align=left   BgColor='#f5f5f5' SumBgColor=#C3D0DB sort=true </FC>
						...
						<fieldset id=ft_div1 style="width:876px;height:20px;background-color:#FFFFFF;border:1 solid #708090;border-top-width:0px;text-align:LEFT;display:none">
							<font id=ft_cnt1 style="position:relative;top:4px;"></font>&nbsp;
						</fieldset>
						<fieldset id=ft_div2 style="position:absolute;left:0px;top:529px;width: 342px;height:20px;background-color:#FFFFFF;border:1 solid #708090;border-top-width:0px;text-align:LEFT;display:none">
...
<A>id=Area1 ,left=0,top=0 ,right=2871 ,bottom=132
	<R>id='급여지급현황_총인원.sbt' ,left=0 ,top=0 ,right=2831 ,bottom=132, MasterDataID='gcds_report0' 
		<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=582 ,face='Arial' ,size=10 ,penwidth=1
			...
			<T>id='월' ,left=1312 ,top=13 ,right=1384 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
			...
			<T>id='지급 현황' ,left=1556 ,top=13 ,right=1868 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
			<T>id='년' ,left=1138 ,top=13 ,right=1220 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
...
<A>id=Area2 ,left=0,top=0 ,right=2871 ,bottom=133
	<R>id='급여지급현황_본사근무자.sbt' ,left=0 ,top=0 ,right=2831 ,bottom=132 , MasterDataID='gcds_report2' 
		<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=395 ,face='Arial' ,size=10 ,penwidth=1
			<T>id='2   임원(본사)' ,left=32 ,top=0 ,right=352 ,bottom=48 ,align='left' ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='고용보험' ,left=1312 ,top=127 ,right=1482 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='기타' ,left=1492 ,top=127 ,right=1672 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{B11000R-B11000}', left=955, top=320, right=1124, bottom=368, align='right', Dec=0</C>
			<C>id='B11000R', left=955, top=259, right=1124, bottom=310, align='right'</C>
			<C>id='B11000', left=955, top=201, right=1124, bottom=249, align='right'</C>
			<C>id='{B12000R-B12000}', left=1132, top=320, right=1307, bottom=368, align='right', Dec=0</C>
			<C>id='B12000R', left=1132, top=259, right=1307, bottom=310, align='right'</C>
			<C>id='{B13000R-B13000}', left=1310, top=320, right=1484, bottom=368, align='right', Dec=0</C>
			<C>id='B13000R', left=1310, top=259, right=1484, bottom=310, align='right'</C>
			<C>id='BXTOTAL', left=1490, top=204, right=1677, bottom=251, align='right'</C>
			<C>id='BXTOTALR', left=1490, top=262, right=1677, bottom=312, align='right'</C>
			<C>id='{BXTOTALR-BXTOTAL}', left=1490, top=323, right=1677, bottom=370, align='right', Dec=0</C>
			<C>id='{T12000R-T12000}', left=778, top=320, right=953, bottom=368, align='right', Dec=0</C>
			<C>id='T12000R', left=778, top=259, right=953, bottom=310, align='right'</C>
			<C>id='B13000', left=1310, top=201, right=1484, bottom=249, align='right'</C>
			<C>id='B12000', left=1132, top=201, right=1307, bottom=249, align='right'</C>
			<C>id='T12000', left=778, top=201, right=953, bottom=249, align='right'</C>
			<C>id='{T11000R-T11000}', left=598, top=318, right=773, bottom=365, align='right', Dec=0</C>
			<C>id='T11000R', left=598, top=257, right=773, bottom=307, align='right'</C>
			<C>id='T11000', left=598, top=201, right=773, bottom=249, align='right'</C>
			<T>id='주민세' ,left=778 ,top=127 ,right=947 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='공제내역' ,left=601 ,top=66 ,right=1886 ,bottom=116 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{B23170R-B23170}', left=2270, top=320, right=2466, bottom=368, align='right', Dec=0</C>
			<C>id='B23170R', left=2270, top=259, right=2466, bottom=310, align='right'</C>
			<C>id='B23170', left=2270, top=201, right=2466, bottom=249, align='right'</C>
			<T>id='지급계' ,left=381 ,top=69 ,right=561 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{B23000R-B23000}', left=1910, top=320, right=2080, bottom=368, align='right', Dec=0</C>
			<C>id='B23000R', left=1910, top=259, right=2080, bottom=310, align='right'</C>
			<C>id='{B17000R-B17000}', left=2090, top=320, right=2260, bottom=368, align='right', Dec=0</C>
			<C>id='B17000R', left=2090, top=259, right=2260, bottom=310, align='right'</C>
			<C>id='B17000', left=2090, top=201, right=2260, bottom=249, align='right'</C>
			<T>id='산재보험' ,left=2090 ,top=127 ,right=2260 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='B23000', left=1910, top=201, right=2080, bottom=249, align='right'</C>
			<T>id='고용보험' ,left=1910 ,top=127 ,right=2080 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=2270 ,top=122 ,right=2471 ,bottom=122 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=1902 ,top=122 ,right=2273 ,bottom=122 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='계' ,left=2270 ,top=127 ,right=2466 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=2265 ,top=122 ,right=2265 ,bottom=378 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=1900 ,top=58 ,right=1900 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='회사지원' ,left=1905 ,top=66 ,right=2461 ,bottom=116 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{S93000R-S93000}', left=1685, top=320, right=1894, bottom=368, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='S93000R', left=1685, top=259, right=1894, bottom=310, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='S93000', left=1685, top=201, right=1894, bottom=249, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=1487 ,top=124 ,right=1487 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1307 ,top=124 ,right=1307 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1127 ,top=124 ,right=1127 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=953 ,top=124 ,right=953 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=34 ,top=254 ,right=2781 ,bottom=254 </L>
			<L> left=773 ,top=124 ,right=773 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='실지급액' ,left=2487 ,top=69 ,right=2773 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{COUNTR-COUNTP}', left=270, top=320, right=347, bottom=368, align='right', Dec=0</C>
			<T>id='인원' ,left=270 ,top=69 ,right=347 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=1677 ,top=122 ,right=1900 ,bottom=122 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=590 ,top=122 ,right=1680 ,bottom=122 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=71 ,top=312 ,right=71 ,bottom=378 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='COUNTR', left=270, top=259, right=347, bottom=310, align='right'</C>
			<C>id='COUNTP', left=273, top=201, right=349, bottom=249, align='right'</C>
			<T>id='건강보험' ,left=955 ,top=127 ,right=1124 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='국민연금' ,left=1132 ,top=127 ,right=1302 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='소득세' ,left=598 ,top=127 ,right=767 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='S94000R', left=2487, top=259, right=2773, bottom=310, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{S94000R-S94000}', left=2487, top=320, right=2773, bottom=368, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='S94000', left=2487, top=201, right=2773, bottom=249, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=69 ,top=312 ,right=2781 ,bottom=312 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='계' ,left=1685 ,top=127 ,right=1894 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=2781 ,top=58 ,right=2781 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=2474 ,top=58 ,right=2474 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=590 ,top=58 ,right=590 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=1680 ,top=122 ,right=1680 ,bottom=378 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<C>id='S91000R', left=360, top=259, right=582, bottom=310, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{S91000R-S91000}', left=360, top=320, right=582, bottom=368, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='S91000', left=360, top=201, right=582, bottom=249, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=352 ,top=58 ,right=352 ,bottom=378 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=257 ,top=58 ,right=257 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=32 ,top=58 ,right=32 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='전월대비증감' ,left=77 ,top=320 ,right=246 ,bottom=368 ,align='right' ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CYYYY', left=45, top=259, right=140, bottom=310, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=259 ,right=164 ,bottom=310 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CMM', left=153, top=259, right=204, bottom=310, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='월' ,left=201 ,top=259 ,right=246 ,bottom=310 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CYYYYO', left=45, top=201, right=140, bottom=249, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=201 ,right=164 ,bottom=249 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CMMO', left=153, top=201, right=204, bottom=249, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='월' ,left=201 ,top=201 ,right=246 ,bottom=249 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=34 ,top=378 ,right=2781 ,bottom=378 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=34 ,top=188 ,right=2781 ,bottom=188 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='구  분' ,left=45 ,top=69 ,right=246 ,bottom=177 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=32 ,top=56 ,right=2781 ,bottom=56 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=2082 ,top=124 ,right=2082 ,bottom=381 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
		</B>
	</R>
</A>
...
<A>id=Area3 ,left=0,top=0 ,right=2871 ,bottom=141
	<R>id='급여지급현황_detail.sbt' ,left=0 ,top=8 ,right=2831 ,bottom=140 , DetailDataID='gcds_report1' 
		<B>id=default ,left=0,top=0 ,right=2871 ,bottom=431 ,face='Arial' ,size=10 ,penwidth=1
			<L> left=32 ,top=95 ,right=2781 ,bottom=95 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='구  분' ,left=45 ,top=106 ,right=246 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DEPTNM', left=93, top=40, right=606, bottom=85, align='left', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=32 ,top=225 ,right=2781 ,bottom=225 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='월' ,left=201 ,top=238 ,right=246 ,bottom=286 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCMMO', left=153, top=238, right=204, bottom=286, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=238 ,right=164 ,bottom=286 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCYYYYO', left=45, top=238, right=140, bottom=286, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DCYYYY', left=45, top=296, right=140, bottom=347, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=32 ,top=291 ,right=2781 ,bottom=291 </L>
			<T>id='월' ,left=201 ,top=296 ,right=246 ,bottom=347 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCMM', left=153, top=296, right=204, bottom=347, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=296 ,right=164 ,bottom=347 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='인원' ,left=270 ,top=106 ,right=347 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=71 ,top=349 ,right=2781 ,bottom=349 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='{DCOUNTR-DCOUNTP}', left=270, top=357, right=347, bottom=405, align='right', Dec=0</C>
			<C>id='DCOUNTR', left=270, top=296, right=347, bottom=347, align='right'</C>
			<C>id='DCOUNTP', left=270, top=238, right=347, bottom=286, align='right'</C>
			<L> left=257 ,top=98 ,right=257 ,bottom=410 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=32 ,top=415 ,right=2781 ,bottom=415 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='전월대비증감' ,left=77 ,top=357 ,right=246 ,bottom=405 ,align='right' ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=32 ,top=98 ,right=32 ,bottom=415 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=593 ,top=98 ,right=593 ,bottom=415 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='주민세' ,left=778 ,top=167 ,right=945 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='소득세' ,left=598 ,top=167 ,right=767 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='건강보험' ,left=955 ,top=167 ,right=1124 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='국민연금' ,left=1132 ,top=167 ,right=1302 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=947 ,top=159 ,right=947 ,bottom=415 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='DS93000', left=1683, top=238, right=1892, bottom=286, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=1675 ,top=159 ,right=1675 ,bottom=415 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=2474 ,top=98 ,right=2474 ,bottom=415 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='실지급액' ,left=2487 ,top=106 ,right=2773 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{DS94000R-DS94000}', left=2487, top=357, right=2773, bottom=405, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DS94000R', left=2487, top=296, right=2773, bottom=347, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS94000', left=2487, top=238, right=2773, bottom=286, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=2781 ,top=98 ,right=2781 ,bottom=415 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<C>id='{DS91000R-DS91000}', left=357, top=357, right=579, bottom=405, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DS91000R', left=357, top=296, right=579, bottom=347, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS91000', left=357, top=238, right=579, bottom=286, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=352 ,top=95 ,right=352 ,bottom=418 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=773 ,top=159 ,right=773 ,bottom=415 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=71 ,top=352 ,right=71 ,bottom=418 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='{currow+2}', left=32, top=40, right=87, bottom=85, align='left', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DS93000R', left=1683, top=296, right=1892, bottom=347, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{DS93000R-DS93000}', left=1683, top=357, right=1892, bottom=405, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<T>id='계' ,left=1683 ,top=167 ,right=1892 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='기타' ,left=1487 ,top=167 ,right=1672 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='지급계' ,left=360 ,top=106 ,right=582 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=1127 ,top=159 ,right=1127 ,bottom=415 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1304 ,top=161 ,right=1304 ,bottom=418 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='고용보험' ,left=1310 ,top=167 ,right=1479 ,bottom=217 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DT11000', left=598, top=238, right=767, bottom=286, align='right'</C>
			<C>id='DT11000R', left=598, top=296, right=767, bottom=347, align='right'</C>
			<C>id='{DT11000R-DT11000}', left=598, top=357, right=767, bottom=405, align='right', Dec=0</C>
			<L> left=1482 ,top=161 ,right=1482 ,bottom=418 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1900 ,top=95 ,right=1900 ,bottom=413 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=1675 ,top=159 ,right=1897 ,bottom=159 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<T>id='공제내역' ,left=598 ,top=106 ,right=1889 ,bottom=156 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='고용보험' ,left=1908 ,top=161 ,right=2077 ,bottom=212 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=2080 ,top=159 ,right=2080 ,bottom=415 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='회사지원' ,left=1910 ,top=103 ,right=2455 ,bottom=153 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=2260 ,top=159 ,right=2260 ,bottom=415 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<T>id='산재보험' ,left=2085 ,top=161 ,right=2254 ,bottom=212 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='계' ,left=2262 ,top=161 ,right=2466 ,bottom=212 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DT12000', left=775, top=238, right=942, bottom=286, align='right'</C>
			<C>id='DB11000', left=953, top=238, right=1122, bottom=286, align='right'</C>
			<C>id='DB12000', left=1132, top=238, right=1302, bottom=286, align='right'</C>
			<C>id='DB13000', left=1310, top=238, right=1479, bottom=286, align='right'</C>
			<C>id='DBXTOTAL', left=1487, top=238, right=1672, bottom=286, align='right'</C>
			<C>id='DT12000R', left=775, top=296, right=942, bottom=347, align='right'</C>
			<C>id='DB11000R', left=953, top=296, right=1122, bottom=347, align='right'</C>
			<C>id='DB12000R', left=1132, top=296, right=1302, bottom=347, align='right'</C>
			<C>id='DB13000R', left=1310, top=296, right=1479, bottom=347, align='right'</C>
			<C>id='DBXTOTALR', left=1487, top=296, right=1672, bottom=347, align='right'</C>
			<C>id='{DT12000R-DT12000}', left=775, top=357, right=942, bottom=405, align='right', Dec=0</C>
			<C>id='{DB11000R-DB11000}', left=953, top=357, right=1122, bottom=405, align='right', Dec=0</C>
			<C>id='{DB12000R-DB12000}', left=1132, top=357, right=1302, bottom=405, align='right', Dec=0</C>
			<C>id='{DB13000R-DB13000}', left=1310, top=357, right=1479, bottom=405, align='right', Dec=0</C>
			<C>id='{DBXTOTALR-DBXTOTAL}', left=1487, top=357, right=1672, bottom=405, align='right', Dec=0</C>
			<L> left=595 ,top=159 ,right=1672 ,bottom=159 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='DB23000', left=1905, top=238, right=2074, bottom=286, align='right'</C>
			<C>id='DB17000', left=2088, top=238, right=2257, bottom=286, align='right'</C>
			<C>id='DB23170', left=2265, top=238, right=2466, bottom=286, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DB23000R', left=1905, top=296, right=2074, bottom=347, align='right'</C>
			<C>id='DB17000R', left=2088, top=296, right=2257, bottom=347, align='right'</C>
			<C>id='{DB23000R-DB23000}', left=1905, top=357, right=2074, bottom=405, align='right', Dec=0</C>
			<C>id='{DB17000R-DB17000}', left=2088, top=357, right=2257, bottom=405, align='right', Dec=0</C>
			<C>id='{DB23170R-DB23170}', left=2265, top=357, right=2466, bottom=405, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DB23170R', left=2265, top=296, right=2466, bottom=347, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=1902 ,top=159 ,right=2262 ,bottom=159 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=2257 ,top=159 ,right=2471 ,bottom=159 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
		</B>
	</R>
</A>
...
<A>id=Area1 ,left=0,top=0 ,right=2871 ,bottom=132
	<R>id='급여지급현황_총인원.sbt' ,left=0 ,top=0 ,right=2831 ,bottom=132, MasterDataID='gcds_report0' 
		<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=598 ,face='Arial' ,size=10 ,penwidth=1
			<X>left=746 ,top=5 ,right=1982 ,bottom=106 ,backcolor=#C0C0C0 ,border=true ,penstyle=solid ,penwidth=2</X>
			<L> left=32 ,top=228 ,right=2781 ,bottom=228 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<C>id='TODATEE', left=2580, top=132, right=2783, bottom=180, align='right' ,mask='XXXX.XX.XX', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='구  분' ,left=45 ,top=241 ,right=246 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=34 ,top=360 ,right=2781 ,bottom=360 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			...
			<L> left=257 ,top=230 ,right=257 ,bottom=550 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=352 ,top=230 ,right=352 ,bottom=550 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<C>id='S93000', left=1667, top=373, right=1889, bottom=421, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='S91000', left=360, top=373, right=582, bottom=421, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{S93000R-S93000}', left=1667, top=492, right=1889, bottom=540, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='{S91000R-S91000}', left=360, top=492, right=582, bottom=540, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='S93000R', left=1667, top=431, right=1889, bottom=482, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='S91000R', left=360, top=431, right=582, bottom=482, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=1659 ,top=294 ,right=1659 ,bottom=550 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=590 ,top=230 ,right=590 ,bottom=550 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=2474 ,top=230 ,right=2474 ,bottom=550 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=2781 ,top=230 ,right=2781 ,bottom=550 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='Print Date:' ,left=2315 ,top=132 ,right=2577 ,bottom=180 ,align='right' ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='1   총인원' ,left=32 ,top=180 ,right=241 ,bottom=222 ,align='left' ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='계' ,left=1667 ,top=299 ,right=1889 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CYYYY', left=884, top=13, right=1056, bottom=98, align='right', face='HY헤드라인M', size=20, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0</C>
			<L> left=69 ,top=484 ,right=2781 ,bottom=484 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='S94000', left=2487, top=373, right=2773, bottom=421, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{S94000R-S94000}', left=2487, top=492, right=2773, bottom=540, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='S94000R', left=2487, top=431, right=2773, bottom=482, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{T11000R-T11000}', left=595, top=492, right=765, bottom=540, align='right', Dec=0</C>
			<C>id='T11000R', left=595, top=431, right=765, bottom=482, align='right'</C>
			<C>id='T12000', left=778, top=373, right=945, bottom=421, align='right'</C>
			<C>id='T11000', left=595, top=373, right=765, bottom=421, align='right'</C>
			<T>id='단위 : 원' ,left=2580 ,top=180 ,right=2783 ,bottom=222 ,align='right' ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='COUNTP', left=273, top=373, right=349, bottom=421, align='right'</C>
			<C>id='COUNTR', left=270, top=431, right=347, bottom=482, align='right'</C>
			<L> left=71 ,top=484 ,right=71 ,bottom=550 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=593 ,top=294 ,right=1672 ,bottom=294 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='인원' ,left=270 ,top=241 ,right=347 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{COUNTR-COUNTP}', left=270, top=492, right=347, bottom=540, align='right', Dec=0</C>
			<T>id='실지급액' ,left=2487 ,top=241 ,right=2773 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CMM', left=1143, top=13, right=1230, bottom=98, align='right', face='HY헤드라인M', size=20, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0</C>
			<T>id='월' ,left=1233 ,top=13 ,right=1304 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
			<T>id='지급 현황' ,left=1482 ,top=13 ,right=1794 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
			<T>id='년' ,left=1058 ,top=13 ,right=1140 ,bottom=98 ,face='HY헤드라인M' ,size=20 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#C0C0C0</T>
			<L> left=770 ,top=296 ,right=770 ,bottom=553 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=947 ,top=294 ,right=947 ,bottom=550 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1296 ,top=294 ,right=1296 ,bottom=550 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1479 ,top=294 ,right=1479 ,bottom=550 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1894 ,top=228 ,right=1894 ,bottom=548 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=1664 ,top=294 ,right=1894 ,bottom=294 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=1124 ,top=296 ,right=1124 ,bottom=553 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=2074 ,top=296 ,right=2074 ,bottom=553 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='S93000', left=2260, top=370, right=2469, bottom=418, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='지급계' ,left=365 ,top=241 ,right=569 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='소득세' ,left=606 ,top=299 ,right=749 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='주민세' ,left=786 ,top=302 ,right=929 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='건강보험' ,left=963 ,top=302 ,right=1106 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='국민연금' ,left=1138 ,top=302 ,right=1281 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='고용보험' ,left=1320 ,top=302 ,right=1463 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='기타' ,left=1498 ,top=302 ,right=1640 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='산재보험' ,left=2098 ,top=299 ,right=2241 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='고용보험' ,left=1913 ,top=299 ,right=2056 ,bottom=349 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='T12000R', left=778, top=431, right=947, bottom=482, align='right'</C>
			<C>id='{T12000R-T12000}', left=778, top=495, right=947, bottom=542, align='right', Dec=0</C>
			<C>id='B13000', left=1310, top=373, right=1476, bottom=421, align='right'</C>
			<C>id='B13000R', left=1307, top=431, right=1476, bottom=482, align='right'</C>
			<C>id='{B13000R-B13000}', left=1307, top=495, right=1476, bottom=542, align='right', Dec=0</C>
			<C>id='BXTOTAL', left=1490, top=373, right=1656, bottom=421, align='right'</C>
			<C>id='BXTOTALR', left=1487, top=431, right=1656, bottom=482, align='right'</C>
			<C>id='{BXTOTALR-BXTOTAL}', left=1487, top=495, right=1656, bottom=542, align='right', Dec=0</C>
			<C>id='{B17000R-B17000}', left=2082, top=495, right=2252, bottom=542, align='right', Dec=0</C>
			<C>id='B17000R', left=2082, top=431, right=2252, bottom=482, align='right'</C>
			<C>id='B17000', left=2085, top=373, right=2252, bottom=421, align='right'</C>
			<T>id='공제내역' ,left=603 ,top=241 ,right=1881 ,bottom=291 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='CTITLE', left=1326, top=13, right=1471, bottom=98, face='HY헤드라인M', size=20, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0</C>
			<L> left=2252 ,top=294 ,right=2252 ,bottom=550 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<C>id='S93000R', left=2260, top=429, right=2469, bottom=479, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{S93000R-S93000}', left=2260, top=489, right=2469, bottom=537, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<L> left=2254 ,top=294 ,right=2474 ,bottom=294 </L>
			<C>id='B23000', left=1900, top=373, right=2069, bottom=421, align='right', MargineX=3</C>
			<C>id='B23000R', left=1900, top=434, right=2069, bottom=482, align='right', MargineX=3</C>
			<C>id='{B23000R-B23000}', left=1900, top=492, right=2069, bottom=540, align='right', MargineX=3</C>
			<T>id='계' ,left=2257 ,top=302 ,right=2469 ,bottom=352 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=1900 ,top=294 ,right=2252 ,bottom=294 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='회사지원' ,left=1910 ,top=241 ,right=2458 ,bottom=291 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
		</B>
	</R>
</A>
...
<A>id=Area3 ,left=0,top=0 ,right=2871 ,bottom=141
	<R>id='급여지급현황_detail.sbt' ,left=0 ,top=8 ,right=2831 ,bottom=140 , DetailDataID='gcds_report1' 
		<B>id=default ,left=0,top=0 ,right=2871 ,bottom=402 ,face='Arial' ,size=10 ,penwidth=1
			<L> left=29 ,top=66 ,right=2781 ,bottom=66 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='구  분' ,left=45 ,top=74 ,right=249 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DEPTNM', left=95, top=21, right=606, bottom=66, align='left', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=29 ,top=196 ,right=2781 ,bottom=196 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='월' ,left=201 ,top=206 ,right=249 ,bottom=257 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCMMO', left=153, top=206, right=204, bottom=257, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=206 ,right=164 ,bottom=257 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCYYYYO', left=45, top=206, right=140, bottom=257, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DCYYYY', left=45, top=267, right=140, bottom=318, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=29 ,top=259 ,right=2781 ,bottom=259 </L>
			<T>id='월' ,left=201 ,top=267 ,right=249 ,bottom=318 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DCMM', left=153, top=267, right=204, bottom=318, align='right', face='굴림', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<T>id='.' ,left=138 ,top=267 ,right=164 ,bottom=318 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='인원' ,left=270 ,top=74 ,right=349 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=74 ,top=320 ,right=2781 ,bottom=320 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='{DCOUNTR-DCOUNTP}', left=270, top=325, right=349, bottom=376, align='right', Dec=0</C>
			<C>id='DCOUNTR', left=270, top=267, right=349, bottom=318, align='right'</C>
			<C>id='DCOUNTP', left=270, top=206, right=349, bottom=257, align='right'</C>
			<L> left=585 ,top=130 ,right=1664 ,bottom=132 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=254 ,top=66 ,right=254 ,bottom=381 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<L> left=29 ,top=386 ,right=2781 ,bottom=386 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='전월대비증감' ,left=77 ,top=325 ,right=249 ,bottom=376 ,align='right' ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=29 ,top=66 ,right=29 ,bottom=386 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='주민세' ,left=770 ,top=135 ,right=939 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='계' ,left=1667 ,top=135 ,right=1886 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DBXTOTALR', left=1484, top=267, right=1654, bottom=318, align='right'</C>
			<C>id='{DBXTOTALR-DBXTOTAL}', left=1484, top=325, right=1654, bottom=376, align='right', Dec=0</C>
			<L> left=942 ,top=130 ,right=942 ,bottom=386 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1119 ,top=130 ,right=1119 ,bottom=386 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=1296 ,top=130 ,right=1296 ,bottom=386 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='DS93000', left=1667, top=206, right=1886, bottom=257, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS93000R', left=1667, top=267, right=1886, bottom=318, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='{DS93000R-DS93000}', left=1667, top=325, right=1886, bottom=376, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<L> left=1656 ,top=130 ,right=1656 ,bottom=386 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=2474 ,top=66 ,right=2474 ,bottom=386 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='실지급액' ,left=2487 ,top=74 ,right=2773 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{DS94000R-DS94000}', left=2487, top=325, right=2773, bottom=376, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DS94000R', left=2487, top=267, right=2773, bottom=318, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS94000', left=2487, top=206, right=2773, bottom=257, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=2781 ,top=66 ,right=2781 ,bottom=386 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<C>id='{DS91000R-DS91000}', left=357, top=325, right=579, bottom=376, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='DS91000R', left=357, top=267, right=579, bottom=318, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS91000', left=357, top=206, right=579, bottom=257, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DT12000', left=770, top=206, right=939, bottom=257, align='right'</C>
			<L> left=352 ,top=66 ,right=352 ,bottom=389 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=765 ,top=130 ,right=765 ,bottom=386 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=74 ,top=323 ,right=74 ,bottom=389 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<C>id='{currow+1}', left=29, top=21, right=87, bottom=66, align='left', face='굴림', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<L> left=585 ,top=64 ,right=585 ,bottom=384 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='지급계' ,left=360 ,top=74 ,right=574 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='건강보험' ,left=945 ,top=138 ,right=1117 ,bottom=188 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='국민보험' ,left=1124 ,top=140 ,right=1296 ,bottom=191 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DT12000R', left=770, top=267, right=939, bottom=318, align='right'</C>
			<C>id='{DT12000R-DT12000}', left=770, top=325, right=939, bottom=376, align='right', Dec=0</C>
			<C>id='{DT11000R-DT11000}', left=593, top=325, right=762, bottom=376, align='right', Dec=0</C>
			<C>id='DT11000R', left=593, top=267, right=762, bottom=318, align='right'</C>
			<C>id='DT11000', left=593, top=206, right=762, bottom=257, align='right'</C>
			<L> left=1479 ,top=132 ,right=1479 ,bottom=389 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<T>id='소득세' ,left=593 ,top=135 ,right=762 ,bottom=185 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<L> left=1892 ,top=66 ,right=1892 ,bottom=386 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
			<T>id='공제내역' ,left=593 ,top=74 ,right=1881 ,bottom=124 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DBXTOTAL', left=1484, top=206, right=1654, bottom=257, align='right'</C>
			<T>id='기타' ,left=1484 ,top=138 ,right=1654 ,bottom=188 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='고용보험' ,left=1304 ,top=138 ,right=1476 ,bottom=188 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='DB13000', left=1304, top=206, right=1476, bottom=257, align='right'</C>
			<C>id='DB13000R', left=1304, top=267, right=1476, bottom=318, align='right'</C>
			<C>id='{DB13000R-DB13000}', left=1304, top=325, right=1476, bottom=376, align='right', Dec=0</C>
			<C>id='{DB23000R-DB23000}', left=1897, top=331, right=2069, bottom=381, align='right', Dec=0</C>
			<C>id='DB23000R', left=1897, top=273, right=2069, bottom=323, align='right'</C>
			<C>id='DB23000', left=1897, top=212, right=2069, bottom=262, align='right'</C>
			<T>id='고용보험' ,left=1897 ,top=143 ,right=2069 ,bottom=193 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='산재보험' ,left=2080 ,top=143 ,right=2249 ,bottom=193 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<T>id='계' ,left=2257 ,top=140 ,right=2466 ,bottom=191 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
			<C>id='{DS93000R-DS93000}', left=2257, top=331, right=2466, bottom=381, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
			<C>id='{DB17000R-DB17000}', left=2080, top=331, right=2249, bottom=381, align='right', Dec=0</C>
			<C>id='DB17000R', left=2080, top=273, right=2249, bottom=323, align='right'</C>
			<C>id='DB17000', left=2080, top=212, right=2249, bottom=262, align='right'</C>
			<C>id='DS93000R', left=2257, top=273, right=2466, bottom=323, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<C>id='DS93000', left=2257, top=212, right=2466, bottom=262, align='right', face='Arial', size=10, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
			<L> left=2074 ,top=132 ,right=2074 ,bottom=389 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=2252 ,top=130 ,right=2252 ,bottom=386 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<L> left=1894 ,top=130 ,right=2257 ,bottom=130 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
			<L> left=2252 ,top=130 ,right=2471 ,bottom=130 </L>
			<L> left=1656 ,top=130 ,right=1892 ,bottom=130 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
			<T>id='회사지원' ,left=1900 ,top=74 ,right=2463 ,bottom=124 ,face='굴림' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
		</B>
	</R>
</A>
...
<B>id=FHeader ,left=0,top=0 ,right=2000 ,bottom=331 ,face='Arial' ,size=10 ,penwidth=1
	<C>id='CYYYY', left=492, top=3, right=733, bottom=90, align='right' ,mask='XXXX년 ', face='Arial', size=20, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CMM', left=736, top=3, right=1532, bottom=90, align='left' ,mask='XX월 소속별 급여지급 현황', face='Arial', size=20, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
...
<comment id="__NSID__"><OBJECT id=gcrp_print3  classid=clsid:37D13B2F-E5EB-11D2-973D-00104B15E56F VIEWASTEXT>
  ...
  <PARAM NAME="PrintSetupDlgFlag" VALUE="true">
	...
	<PARAM NAME="Format" VALUE="
<B>id=FHeader ,left=0,top=0 ,right=4101 ,bottom=968 ,face='Arial' ,size=10 ,penwidth=1
	<L> left=0 ,top=587 ,right=3977 ,bottom=587 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=167 ,top=677 ,right=667 ,bottom=677 </L>
	<L> left=1558 ,top=770 ,right=659 ,bottom=770 </L>
	<T>id='기본' ,left=1588 ,top=741 ,right=1704 ,bottom=820 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='시간외' ,left=1863 ,top=741 ,right=1976 ,bottom=820 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='근속' ,left=1998 ,top=712 ,right=2109 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자 기' ,left=2125 ,top=712 ,right=2238 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='가 족' ,left=2246 ,top=712 ,right=2357 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='차 량' ,left=2376 ,top=712 ,right=2490 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자격' ,left=2506 ,top=712 ,right=2619 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='수당' ,left=2506 ,top=765 ,right=2619 ,bottom=831 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='직책' ,left=1730 ,top=741 ,right=1844 ,bottom=820 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='유지비' ,left=2376 ,top=765 ,right=2490 ,bottom=831 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='부양비' ,left=2246 ,top=765 ,right=2357 ,bottom=831 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='계발비' ,left=2125 ,top=765 ,right=2238 ,bottom=831 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='수당' ,left=1998 ,top=765 ,right=2109 ,bottom=831 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=669 ,top=781 ,right=730 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='금액' ,left=738 ,top=781 ,right=881 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=892 ,top=781 ,right=955 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='금액' ,left=963 ,top=781 ,right=1106 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=1117 ,top=781 ,right=1180 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='금액' ,left=1188 ,top=781 ,right=1331 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=1341 ,top=781 ,right=1405 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='금액' ,left=1413 ,top=781 ,right=1556 ,bottom=863 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='소계(B)' ,left=1341 ,top=683 ,right=1556 ,bottom=765 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='퇴사' ,left=1117 ,top=683 ,right=1331 ,bottom=765 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='입사' ,left=892 ,top=683 ,right=1106 ,bottom=765 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='금액' ,left=492 ,top=736 ,right=656 ,bottom=818 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=418 ,top=736 ,right=482 ,bottom=818 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='인원' ,left=172 ,top=736 ,right=233 ,bottom=818 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='합계' ,left=5 ,top=881 ,right=159 ,bottom=966 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=0 ,top=587 ,right=172 ,bottom=868 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=0 ,top=966 ,right=3982 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=0 ,top=870 ,right=3982 ,bottom=870 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='직위' ,left=8 ,top=791 ,right=108 ,bottom=865 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='PRVYYYYMM', left=175, top=606, right=402, bottom=669, face='굴림', size=8, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='NOWYYYYMM', left=421, top=606, right=654, bottom=669, face='굴림', size=8, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PRVNUM', left=167, top=894, right=230, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A8_AMT', left=2503, top=894, right=2622, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A6_AMT', left=2244, top=894, right=2368, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A5_AMT', left=2114, top=894, right=2238, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A4_AMT', left=1987, top=894, right=2111, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A3_AMT', left=1860, top=894, right=1982, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A2_AMT', left=1720, top=894, right=1852, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A1_AMT', left=1574, top=894, right=1712, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAMT', left=1413, top=894, right=1556, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITNUM', left=1341, top=894, right=1405, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='TAEAMT', left=1188, top=894, right=1331, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='TAENUM', left=1117, top=894, right=1180, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='IBSAAMT', left=963, top=894, right=1106, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='IBSANUM', left=892, top=894, right=955, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAA_AMT', left=738, top=894, right=881, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAA_NUM', left=669, top=894, right=730, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='NEXAMT', left=492, top=894, right=656, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='NEXNUM', left=418, top=894, right=482, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PRVAMT', left=241, top=894, right=405, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='단위 : 원' ,left=3805 ,top=516 ,right=3977 ,bottom=577 ,align='right'</T>
	<C>id='TODATEE', left=3826, top=447, right=3977, bottom=508, align='right' ,mask='XXXX.XX.XX'</C>
	<T>id='Print Date:' ,left=3630 ,top=447 ,right=3823 ,bottom=508 ,align='right'</T>
	<T>id='금액' ,left=241 ,top=736 ,right=405 ,bottom=818 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=233 ,top=680 ,right=233 ,bottom=966 </L>
	<L> left=484 ,top=680 ,right=484 ,bottom=966 </L>
	<L> left=733 ,top=775 ,right=733 ,bottom=960 </L>
	<L> left=1405 ,top=775 ,right=1405 ,bottom=960 </L>
	<L> left=1180 ,top=775 ,right=1180 ,bottom=960 </L>
	<L> left=958 ,top=775 ,right=958 ,bottom=960 </L>
	<L> left=167 ,top=587 ,right=167 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=664 ,top=587 ,right=664 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=413 ,top=587 ,right=413 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='구분' ,left=66 ,top=595 ,right=159 ,bottom=677 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1339 ,top=680 ,right=1339 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1114 ,top=680 ,right=1114 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1715 ,top=677 ,right=1715 ,bottom=966 </L>
	<L> left=1855 ,top=677 ,right=1855 ,bottom=966 </L>
	<L> left=1984 ,top=677 ,right=1984 ,bottom=966 </L>
	<L> left=2111 ,top=677 ,right=2111 ,bottom=966 </L>
	<L> left=2241 ,top=677 ,right=2241 ,bottom=966 </L>
	<L> left=2368 ,top=677 ,right=2368 ,bottom=966 </L>
	<L> left=2498 ,top=677 ,right=2498 ,bottom=966 </L>
	<L> left=2625 ,top=677 ,right=2625 ,bottom=966 </L>
	<L> left=2879 ,top=677 ,right=2879 ,bottom=966 </L>
	<L> left=3011 ,top=677 ,right=3011 ,bottom=966 </L>
	<L> left=3122 ,top=677 ,right=3122 ,bottom=966 </L>
	<L> left=3241 ,top=677 ,right=3241 ,bottom=966 </L>
	<L> left=3371 ,top=677 ,right=3371 ,bottom=966 </L>
	<L> left=3493 ,top=677 ,right=3493 ,bottom=966 </L>
	<L> left=3620 ,top=677 ,right=3620 ,bottom=966 </L>
	<C>id='A10_AMT', left=2627, top=894, right=2749, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A11_AMT', left=2754, top=894, right=2879, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A12_AMT', left=2884, top=894, right=3008, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A21_AMT', left=3246, top=894, right=3368, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ETC_AMT', left=3498, top=894, right=3617, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='휴    일' ,left=3376 ,top=712 ,right=3490 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='해외' ,left=2760 ,top=712 ,right=2873 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='남북' ,left=2630 ,top=712 ,right=2746 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='경협' ,left=2630 ,top=767 ,right=2746 ,bottom=833 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='수당' ,left=2760 ,top=770 ,right=2873 ,bottom=836 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장' ,left=2884 ,top=712 ,right=3011 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='수당' ,left=2884 ,top=773 ,right=3011 ,bottom=839 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='연금' ,left=3127 ,top=778 ,right=3241 ,bottom=844 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='개인' ,left=3127 ,top=712 ,right=3241 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='근무수당' ,left=3376 ,top=773 ,right=3490 ,bottom=839 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='A13_AMT', left=3376, top=894, right=3487, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='전월소급' ,left=3625 ,top=741 ,right=3765 ,bottom=807 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='A14_AMT', left=3625, top=894, right=3760, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='기타지급' ,left=3498 ,top=743 ,right=3620 ,bottom=810 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장' ,left=3016 ,top=712 ,right=3114 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='식대' ,left=3016 ,top=773 ,right=3114 ,bottom=839 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='CTITLE', left=1516, top=273, right=2585, bottom=362, face='HY중고딕', size=20, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0, border=true, penstyle=solid, penwidth=2, pencolor=#000000, Dec=0</C>
	<L> left=0 ,top=590 ,right=0 ,bottom=960 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1564 ,top=587 ,right=1564 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=2749 ,top=680 ,right=2749 ,bottom=968 </L>
	<L> left=3768 ,top=677 ,right=3768 ,bottom=963 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=3768 ,top=770 ,right=3985 ,bottom=770 </L>
	<T>id='소계(C)' ,left=3831 ,top=683 ,right=3945 ,bottom=762 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=3829 ,top=770 ,right=3829 ,bottom=955 </L>
	<T>id='금액' ,left=3834 ,top=775 ,right=3977 ,bottom=857 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='A7_AMT', left=2371, top=894, right=2495, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A9_AMT', left=3122, top=894, right=3239, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='AA_AMT', left=3834, top=892, right=3977, bottom=953, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A22_AMT', left=3016, top=894, right=3119, bottom=955, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='AA_NUM', left=3776, top=892, right=3826, bottom=953, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='인원' ,left=3776 ,top=775 ,right=3829 ,bottom=857 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='입퇴사자' ,left=1135 ,top=606 ,right=1318 ,bottom=669 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='기존인원' ,left=1577 ,top=606 ,right=3969 ,bottom=669 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=886 ,top=587 ,right=886 ,bottom=966 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=3982 ,top=585 ,right=3982 ,bottom=968 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=892 ,top=677 ,right=3987 ,bottom=677 </L>
	<T>id='전월대비' ,left=685 ,top=616 ,right=868 ,bottom=656 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='증감내역' ,left=685 ,top=654 ,right=868 ,bottom=693 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='A(B+C)' ,left=685 ,top=691 ,right=868 ,bottom=730 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='연차' ,left=3249 ,top=712 ,right=3363 ,bottom=781 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='수당' ,left=3249 ,top=778 ,right=3363 ,bottom=844 ,face='굴림' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
<B>id=default ,left=0,top=0 ,right=4101 ,bottom=68 ,face='Arial' ,size=10 ,penwidth=1
	<C>id='PAYGRDNM', left=5, top=5, right=159, bottom=66, align='left', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='NEXNUM', left=418, top=5, right=482, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='NEXAMT', left=492, top=5, right=656, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAA_NUM', left=669, top=5, right=730, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAA_AMT', left=738, top=5, right=881, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='IBSANUM', left=892, top=5, right=955, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='IBSAAMT', left=963, top=5, right=1106, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='TAENUM', left=1117, top=5, right=1180, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='TAEAMT', left=1188, top=5, right=1331, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITNUM', left=1341, top=5, right=1405, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ITAMT', left=1413, top=5, right=1556, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PRVNUM', left=164, top=5, right=230, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PRVAMT', left=241, top=5, right=405, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A1_AMT', left=1574, top=5, right=1712, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A2_AMT', left=1720, top=5, right=1852, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A3_AMT', left=1860, top=5, right=1982, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A4_AMT', left=1987, top=5, right=2111, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A5_AMT', left=2114, top=5, right=2238, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A6_AMT', left=2244, top=5, right=2368, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A7_AMT', left=2371, top=5, right=2495, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A8_AMT', left=2503, top=5, right=2622, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A10_AMT', left=2627, top=5, right=2749, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A11_AMT', left=2754, top=5, right=2879, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A12_AMT', left=2884, top=5, right=3008, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A9_AMT', left=3122, top=5, right=3239, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A21_AMT', left=3246, top=5, right=3371, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A13_AMT', left=3376, top=5, right=3487, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='ETC_AMT', left=3498, top=5, right=3617, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A22_AMT', left=3016, top=5, right=3119, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='A14_AMT', left=3625, top=5, right=3760, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='AA_AMT', left=3834, top=5, right=3971, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='AA_NUM', left=3776, top=5, right=3826, bottom=66, align='right', face='Arial', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=0 ,top=0 ,right=0 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=664 ,top=0 ,right=664 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=167 ,top=0 ,right=167 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=233 ,top=0 ,right=233 ,bottom=69 </L>
	<L> left=413 ,top=0 ,right=413 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=484 ,top=0 ,right=484 ,bottom=69 </L>
	<L> left=733 ,top=0 ,right=733 ,bottom=69 </L>
	<L> left=886 ,top=0 ,right=886 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=958 ,top=0 ,right=958 ,bottom=69 </L>
	<L> left=1114 ,top=0 ,right=1114 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1180 ,top=0 ,right=1180 ,bottom=69 </L>
	<L> left=1339 ,top=0 ,right=1339 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1405 ,top=0 ,right=1405 ,bottom=69 </L>
	<L> left=1564 ,top=0 ,right=1564 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=1715 ,top=0 ,right=1715 ,bottom=69 </L>
	<L> left=1855 ,top=0 ,right=1855 ,bottom=69 </L>
	<L> left=1984 ,top=0 ,right=1984 ,bottom=69 </L>
	<L> left=2111 ,top=0 ,right=2111 ,bottom=69 </L>
	<L> left=2241 ,top=0 ,right=2241 ,bottom=69 </L>
	<L> left=2368 ,top=0 ,right=2368 ,bottom=69 </L>
	<L> left=2498 ,top=0 ,right=2498 ,bottom=69 </L>
	<L> left=2625 ,top=0 ,right=2625 ,bottom=69 </L>
	<L> left=2749 ,top=0 ,right=2749 ,bottom=69 </L>
	<L> left=2879 ,top=0 ,right=2879 ,bottom=69 </L>
	<L> left=3011 ,top=0 ,right=3011 ,bottom=69 </L>
	<L> left=3122 ,top=0 ,right=3122 ,bottom=69 </L>
	<L> left=3241 ,top=0 ,right=3241 ,bottom=69 </L>
	<L> left=3371 ,top=0 ,right=3371 ,bottom=69 </L>
	<L> left=3493 ,top=0 ,right=3493 ,bottom=69 </L>
	<L> left=3620 ,top=0 ,right=3620 ,bottom=69 </L>
	<L> left=3768 ,top=0 ,right=3768 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=3829 ,top=0 ,right=3829 ,bottom=69 </L>
	<L> left=3982 ,top=0 ,right=3982 ,bottom=69 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<L> left=5 ,top=71 ,right=3987 ,bottom=69 </L>
</B>
<B>id=DFooter ,left=0,top=0 ,right=4101 ,bottom=0 ,face='Arial' ,size=10 ,penwidth=1
	<L> left=0 ,top=0 ,right=3982 ,bottom=0 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
</B>
<B>id=Footer ,left=0 ,top=2753 ,right=4101 ,bottom=2870 ,face='Arial' ,size=10 ,penwidth=1
	<L> left=5 ,top=0 ,right=4056 ,bottom=0 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='#p/#t' ,left=13 ,top=19 ,right=4069 ,bottom=98</T>
	<I>id='../../Common/img/icon.jpg' ,left=3633 ,top=24 ,right=4014 ,bottom=95</I>
</B>
...
<comment id="__NSID__"><OBJECT id=gcrp_print7  classid=clsid:37D13B2F-E5EB-11D2-973D-00104B15E56F VIEWASTEXT>
  ...
  <PARAM NAME="PrintSetupDlgFlag" VALUE="true">
	<PARAM NAME="PreviewZoom"				VALUE="100">
	<PARAM NAME="Format" VALUE="
<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=351 ,face='Arial' ,size=10 ,penwidth=1
	<X>left=894 ,top=5 ,right=1918 ,bottom=106 ,backcolor=#C0C0C0 ,border=true ,penstyle=solid ,penwidth=2</X>
	<C>id='CTITLE', left=923, top=13, right=1900, bottom=98, face='HY헤드라인M', size=20, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0</C>
	...
	<L> left=11 ,top=209 ,right=11 ,bottom=352 ,penstyle=solid ,penwidth=4 ,pencolor=#000000 </L>
	<L> left=2818 ,top=209 ,right=2818 ,bottom=352 ,penstyle=solid ,penwidth=4 ,pencolor=#000000 </L>
	<T>id='자기계발' ,left=1132 ,top=283 ,right=1225 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='근무일수' ,left=558 ,top=220 ,right=733 ,bottom=280 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=11 ,top=355 ,right=2818 ,bottom=352 ,penstyle=solid ,penwidth=4 ,pencolor=#000000 </L>
	<T>id='변동수당' ,left=1924 ,top=220 ,right=2588 ,bottom=280 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=64 ,top=212 ,right=64 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=209 ,top=212 ,right=209 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=333 ,top=212 ,right=333 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1921 ,top=212 ,right=1921 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=2590 ,top=209 ,right=2590 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=556 ,top=280 ,right=730 ,bottom=280 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1924 ,top=280 ,right=2588 ,bottom=280 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='순' ,left=21 ,top=220 ,right=58 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=479 ,top=209 ,right=479 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='소계' ,left=1799 ,top=283 ,right=1918 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=743 ,top=280 ,right=1924 ,bottom=280 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='전월소급' ,left=2347 ,top=283 ,right=2458 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='해외수당' ,left=2233 ,top=283 ,right=2344 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=2461 ,top=283 ,right=2461 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=2344 ,top=283 ,right=2344 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=2230 ,top=283 ,right=2230 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=2127 ,top=283 ,right=2127 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='소계' ,left=2463 ,top=283 ,right=2588 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='비고' ,left=2762 ,top=220 ,right=2813 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='계' ,left=2596 ,top=220 ,right=2757 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=2760 ,top=209 ,right=2760 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='소속' ,left=69 ,top=220 ,right=209 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='변동일' ,left=212 ,top=220 ,right=331 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='직위' ,left=336 ,top=220 ,right=476 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='성명' ,left=482 ,top=220 ,right=550 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='본사' ,left=556 ,top=283 ,right=598 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장' ,left=601 ,top=283 ,right=643 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='해외' ,left=646 ,top=283 ,right=688 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='계' ,left=691 ,top=283 ,right=733 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=553 ,top=209 ,right=553 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=598 ,top=283 ,right=598 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=643 ,top=283 ,right=643 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=688 ,top=283 ,right=688 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=736 ,top=212 ,right=736 ,bottom=352 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='기본급' ,left=738 ,top=283 ,right=852 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=852 ,top=283 ,right=852 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='직책' ,left=855 ,top=283 ,right=947 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='시간외' ,left=950 ,top=283 ,right=1042 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='근속수당' ,left=1045 ,top=283 ,right=1130 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1130 ,top=283 ,right=1130 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1225 ,top=283 ,right=1225 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=947 ,top=283 ,right=947 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1042 ,top=283 ,right=1042 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='남북경협' ,left=1408 ,top=283 ,right=1503 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='개인연금' ,left=1505 ,top=283 ,right=1598 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1503 ,top=283 ,right=1503 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='학자금' ,left=1601 ,top=283 ,right=1691 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='차량유지' ,left=1924 ,top=283 ,right=2024 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장식대' ,left=2130 ,top=283 ,right=2230 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='현장수당' ,left=2027 ,top=283 ,right=2127 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=2024 ,top=283 ,right=2024 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='기타지급' ,left=1693 ,top=283 ,right=1797 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='자격수당' ,left=1318 ,top=283 ,right=1405 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='가족부양' ,left=1228 ,top=283 ,right=1315 ,bottom=344 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1598 ,top=283 ,right=1598 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1691 ,top=283 ,right=1691 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1405 ,top=283 ,right=1405 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1315 ,top=283 ,right=1315 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<T>id='공통수당' ,left=738 ,top=220 ,right=1916 ,bottom=280 ,face='굴림' ,size=6 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1797 ,top=283 ,right=1797 ,bottom=352 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	...
	<C>id='GUBUN', left=11, top=159, right=667, bottom=201, align='left', face='굴림', size=9, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
<B>id=default ,left=0,top=0 ,right=2871 ,bottom=69 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='P23000', left=1228, top=0, right=1315, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P28000', left=1318, top=0, right=1405, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P24000', left=1924, top=0, right=2024, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=64 ,top=0 ,right=64 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=1315 ,top=0 ,right=1315 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=2818 ,top=0 ,right=2818 ,bottom=66 ,penstyle=solid ,penwidth=4 ,pencolor=#000000 </L>
	<L> left=2461 ,top=0 ,right=2461 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	...
	<C>id='DEPTNMK2', left=69, top=0, right=209, bottom=66, align='left', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=209 ,top=0 ,right=209 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<C>id='CHAGDT', left=212, top=0, right=331, bottom=66 ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='PAYGRDNM', left=336, top=0, right=476, bottom=66, align='left', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<L> left=2024 ,top=0 ,right=2024 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=2230 ,top=0 ,right=2230 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P31000', left=2233, top=0, right=2344, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=2344 ,top=0 ,right=2344 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P39000', left=2347, top=0, right=2458, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='CHG_SUM', left=2463, top=0, right=2588, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=2590 ,top=0 ,right=2590 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=2760 ,top=0 ,right=2760 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	...
	<C>id='ORDNM2', left=2762, top=0, right=2813, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=11 ,top=69 ,right=2818 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<L> left=333 ,top=0 ,right=333 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	...
	<C>id='HJDAY', left=601, top=0, right=643, bottom=66 ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=643 ,top=0 ,right=643 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='FSDAY', left=646, top=0, right=688, bottom=66 ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=688 ,top=0 ,right=688 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='DAY_SUM', left=691, top=0, right=733, bottom=66 ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=736 ,top=0 ,right=736 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<C>id='P10000', left=738, top=0, right=852, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=852 ,top=0 ,right=852 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P11000', left=855, top=0, right=947, bottom=66, align='right' ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P12000', left=950, top=0, right=1042, bottom=66, align='right' ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P21000', left=1045, top=0, right=1130, bottom=66, align='right' ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1130 ,top=0 ,right=1130 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P22000', left=1132, top=0, right=1225, bottom=66, align='right' ,mask='XXXX/XX/XX', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1225 ,top=0 ,right=1225 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1042 ,top=0 ,right=1042 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=947 ,top=0 ,right=947 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1405 ,top=0 ,right=1405 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P29000', left=1408, top=0, right=1503, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='P37000', left=1505, top=0, right=1598, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1503 ,top=0 ,right=1503 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='P36000', left=1601, top=0, right=1691, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<L> left=1921 ,top=0 ,right=1921 ,bottom=69 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<C>id='COM_SUM', left=1799, top=0, right=1918, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=1797 ,top=0 ,right=1797 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1691 ,top=0 ,right=1691 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<L> left=1598 ,top=0 ,right=1598 ,bottom=66 ,penstyle=dot ,penwidth=1 ,pencolor=#000000 </L>
	<C>id='ETC_SUM', left=1693, top=0, right=1797, bottom=66, align='right', face='굴림', size=6, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
