...
function ln_Query(){
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_s11?v_str1="+str1; 
...
function ln_Create(){
	...
	if(gcds_ihead.IsUpdated) {	
		...
		if (confirm("생성 하시겠습니까?")){	
				...
				gctr_data.action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_t11";
...
function ln_Display(){
		...
		gcds_down_a.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_s12?v_str1=2010";
		gcds_down_a.Reset();

		gcds_down_b.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_s13?v_str1=2010";	
		gcds_down_b.Reset();

		gcds_down_c.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_s14?v_str1=2010";	
		gcds_down_c.Reset();

		gcds_down_d.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030020_s15?v_str1=2010";	
		gcds_down_d.Reset();
...
<table width="875" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
 <tr> 
	...
	<img src="../img/p030020_head.gif"></td>
