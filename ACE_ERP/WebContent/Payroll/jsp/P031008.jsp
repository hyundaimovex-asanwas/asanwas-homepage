...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	: 연말정산관리 - 소득자별 원천징수부
+ 프로그램 ID	: P031008.HTML    2010년 버젼
+ 기 능 정 의	: 조회,저장,삭제
+ 변 경 이 력	: 
...
+ 변  경   자 : JYS        
-----------------------------------------------------------------------------
+ 변 경 내 용	: 원천징수영수정 입력 확정 후 공제신고서반영 
+              ( 공제신고서 반영하면 자동 마감됨 ) 
+ 변 경 일 자	: 2010.11.30
+ 변  경   자 : JYS     
------------------------------------------------------------------------------>
...
function ln_Query(){
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p031008_s3?v_str1=" + gcem_curdt.text
...
function ln_Sum02(){	
  ...
  //식대계
  gcds_data.namevalue(gcds_data.rowposition,"SFRE006")  = Number(gcem_fre01006.text)+Number(gcem_fre02006.text)+
																													Number(gcem_fre03006.text)+Number(gcem_fre04006.text)+
																													Number(gcem_fre05006.text)+Number(gcem_fre06006.text)+
																													Number(gcem_fre07006.text)+Number(gcem_fre08006.text)+
																													Number(gcem_fre09006.text)+Number(gcem_fre10006.text)+
																													Number(gcem_fre11006.text)+Number(gcem_fre12006.text);
}
...
/******************************************************************************	
 Description : 원천징수부 확정 데이터 공제신고서에 반영
******************************************************************************/		
function ln_Apply(){	

  /**
	gcds_create.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p031008_s2?v_str1=" + gcem_curdt.text //정산일자
																													+"&v_str2=Y" 
  ...
  **/
	...
	if(gcds_data.Countrow>1){
		if (gcds_data99.namevalue(2,"WRKSTS") == 'C') {
			alert("이미 마감처리 되었습니다.");
			return false;
		}
  }
  ...
  if (confirm("공제신고서에 반영하시겠습니까?")) {
	    gcds_temp.ClearAll();
			ln_SetDataHeader();
			gcds_temp.Addrow();
			gcds_temp.namevalue(gcds_temp.rowposition,"APPYY")="2010";

			gctr_data2.action = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p030008_t2";
			//prompt('gcds_temp::',gcds_temp.text);
			gctr_data2.post();
	}
}
...
function ln_Finish(){
	...
	if(gcds_data.Countrow>1){
		if (gcds_data99.namevalue(2,"WRKSTS") == 'C') {
			...
			gcds_data99.namevalue(2,"WRKSTS") = 'C';
...
<object id="gcds_data99" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" > 
...
<OBJECT id=gctr_data2 classid=clsid:0A2233AD-E771-11D2-973D-00104B15E56F VIEWASTEXT>
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4">
	<PARAM NAME="KeyValue" VALUE="p030008_t2(I:USER=gcds_temp)">
</OBJECT>

<OBJECT id=gctr_data3 classid=clsid:0A2233AD-E771-11D2-973D-00104B15E56F VIEWASTEXT>
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4">
	<PARAM NAME="KeyValue" VALUE="worksts_t1(I:USER=gcds_worksts)">
</OBJECT>
</comment><script>__ws__(__NSID__);</script>
...
<script language="javascript" for="gctr_data2" event="onsuccess()">
  ln_WorkSts('Y102001S','2','공제신고서반영'); //작업상태
	alert("작업이 성공적으로 완료되었습니다.");
</script>

<script language="javascript" for="gctr_data2" event="onfail()">
  ln_WorkSts('Y102001S','E','공제신고서반영'); //작업상태
  ...
  <tr> 
    ...
    <td width="685" align="right" background="../../Common/img/com_t_bg.gif" style="padding-top:4px;"><nobr>
		...
		<!--<img src="../../Common/img/btn/com_b_contribute.gif"	style="cursor:hand" onclick="ln_Print3()">-->
		  ...
		  <img src="../../Common/img/btn/com_b_entry_apply.gif"	style="cursor:hand" onclick="ln_Apply()">&nbsp;&nbsp;
...
--------------------------------------------------------------------------------------------->
			<table width=100% border=0 cellspacing=0 cellpadding=0>
				...
				<tr>
					...
					<!---------------------------------근로소득지금명세--계------------------------------------>
					 <TR>
						<TD style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px;border-bottom-width:0px;" bgcolor="#eeeeee" colspan=2 align=center>&nbsp;계</TD>
						<TD ALIGN=CENTER height=25  style="border:1 solid #708090;border-top-width:0px;border-left-width:0px;border-bottom-width:0px;">
						...
						<TD style="border:1 solid #708090;border-top-width:0px;border-left-width:0px;border-bottom-width:0px;" ALIGN=CENTER>
					...
					<td>
						...
						<table border= "0" class=itemdisp cellpadding=0 cellspacing=0  style='width:512x;height:30px;font-size:9pt;background-color:#ffffff;border:1 solid #708090'>
							 <TR>
								...
								<TD width=270 style="height:20px;border:1 solid #708090;border-top-width:0px;border-right-width:0px;border-left-width:0px" bgcolor="#eeeeee" colspan=2 ALIGN=CENTER>기타비과세</TD>		
               </TR>
							 <TR>		
								<TD width=90x  style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER >지급연월</TD>
								<TD width=110  style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER >외화</TD>
								<TD width=90x  style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER >원화</TD>	
								<TD width=135x style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER >차량</TD>	
								<TD width=135x style="height:20px;border:1 solid #708090;border-top-width:0px;border-right-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER >식대</TD>
							 </TR>
							 ...
							 <TR>            
								...
								<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
									<input id="txt_fre01004" name="txt_fre01004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20>
								</TD> -->
								...
								<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
								<comment id="__NSID__"><object id=gcem_fre01006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"  >
									<param name=Text          value="">
									<param name=Alignment	  value=2>
									<param name=Border	      value=true>
									<param name=Numeric	      value=true>
...
<!-------------------------------비과세소득----2---------------------------------------->
								...
								<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
									<input id="txt_fre02004" name="txt_fre02004" type="text" style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
								</TD> -->
								<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;"" ALIGN=CENTER height=23>
								<comment id="__NSID__"><object id=gcem_fre02005 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"  >
									...
									<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
								<comment id="__NSID__"><object id=gcem_fre02006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"  >
									<param name=Text          value="">
									<param name=Alignment	  value=2>
									<param name=Border	      value=true>
									<param name=Numeric	      value=true>
...
<!-------------------------------비과세소득----3---------------------------------------->
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre03004" name="txt_fre03004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre03006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre04004" name="txt_fre04004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre04006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								 <input id="txt_fre05004" name="txt_fre05004" type="text"  style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre05005 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								...
								<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre05006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>	
								<input id="txt_fre06004" name="txt_fre06004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre06006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre07004" name="txt_fre07004" type="text" style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre07006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre08004" name="txt_fre08004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre08006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							<input id="txt_fre09004" name="txt_fre09004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre09006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre10004" name="txt_fre10004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre10006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F   style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
								<input id="txt_fre11004" name="txt_fre11004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre11006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							<input id="txt_fre12004" name="txt_fre12004" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_fre12006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>	
							...
							<!-- <TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=23>
							<input id="" name="" type="text" 	style="width:80px;height:19;position:relative;top:1px;" maxlength=20 ALIGN=CENTER>
							</TD> -->
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;border-right-width:0px" ALIGN=CENTER height=23>
							<comment id="__NSID__"><object id=gcem_sfre006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F   style="width:80px;height:19;position:relative;top:1px;"    >
								<param name=Text          value="">
								<param name=Alignment	  value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
				...
				<tr>
					...
					<table border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0 width=600	style='width:640px;height:25px;font-size:9pt;background-color:#ffffff;border:1 solid #708090'>
						<TR>
							...
							<TD style="height:18px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ROWSPAN=2 ALIGN=CENTER width=200 >감면세액</TD>
						...
						<TR>		
							...
							<TD width=200 style="height:18px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" ALIGN=CENTER>지방소득세</TD>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=20>
							<comment id="__NSID__"><object id=gcem_col01002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;" >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=20>
							<comment id="__NSID__"><object id=gcem_col01003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;" >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER height=20>
							<comment id="__NSID__"><object id=gcem_col01006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;" >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
  					...
  					<!---------------------근로소득원천징수---2------------------------->
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col02002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col02003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col02006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col03002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col03003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col03006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col04002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col04003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col04006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col05002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col05003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col05006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col06002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col06003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col06006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col07002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col07003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col07006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col08002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col08003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col08006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<comment id="__NSID__"><object id=gcem_col09002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" align=center>
							<comment id="__NSID__"><object id=gcem_col09003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="height:20px;border:1 solid #708090;border-top-width:0px;border-left-width:0px" bgcolor="#eeeeee" align=center>
							<comment id="__NSID__"><object id=gcem_col09006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col10002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col10003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col10006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col11002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col11003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col11006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col12002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:80px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col12003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_col12006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
						...
						<TR>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_scol002 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F	style="width:80px;height:18;position:relative;top:1px;left:0;"   >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_scol003 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
							...
							<TD  style="border:1 solid #708090;border-left-width:0px;border-top-width:0px;" ALIGN=CENTER  height=20>
							<comment id="__NSID__"><object id=gcem_scol006 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  style="width:70px;height:18;position:relative;top:1px;left:0;"  >
								<param name=Text          value="">
								<param name=Alignment	    value=2>
								<param name=Border	      value=true>
								<param name=Numeric	      value=true>
...
<comment id="__NSID__"><object id=gcbn_pyo classid=CLSID:9C9AB433-EA85-11D2-A4F9-00608CEBEE49> 
	...
	<param name=BindInfo  value='
		...
		<C>Col=FRE01006		        Ctrl=gcem_fre01006				Param=Text</C>
		...
		<C>Col=FRE02006		        Ctrl=gcem_fre02006				Param=Text</C>
		...
		<C>Col=FRE03006		        Ctrl=gcem_fre03006				Param=Text</C>
		...
		<C>Col=FRE04006		        Ctrl=gcem_fre04006				Param=Text</C>
		...
		<C>Col=FRE05006		        Ctrl=gcem_fre05006				Param=Text</C>
		...
		<C>Col=FRE06006		        Ctrl=gcem_fre06006				Param=Text</C>
		...
		<C>Col=FRE07006		        Ctrl=gcem_fre07006				Param=Text</C>
		...
		<C>Col=FRE08006		        Ctrl=gcem_fre08006				Param=Text</C>
		...
		<C>Col=FRE09006		        Ctrl=gcem_fre09006				Param=Text</C>
		...
		<C>Col=FRE10006		        Ctrl=gcem_fre10006			  Param=Text</C>
		...
		<C>Col=FRE11006		        Ctrl=gcem_fre11006				Param=Text</C>
		...
		<C>Col=FRE12006		        Ctrl=gcem_fre12006				Param=Text</C>
		...
		<C>Col=SFRE006		        Ctrl=gcem_sfre006				  Param=Text</C>
