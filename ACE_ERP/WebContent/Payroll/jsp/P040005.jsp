...
<!-------------------------------------------------------------------------------
+ ½Ã ½º ÅÛ ¸í	:	±Þ¿©/ÅðÁ÷±Ý³»¿ªÁ¶È¸
+ ÇÁ·Î±×·¥ ID	: p010005.HTML
+ ±â ´É Á¤ ÀÇ	: Á¶È¸|Ãâ·Â
+ º¯ °æ ÀÌ ·Â	: 
+ ¼ö Á¤ ÀÌ ·Â	: ÀÌ¼ø¹Ì - 2005.08.03 - ¼Ò½º Á¤¸®
+ ¼­ ºí ¸´ ¸í	: p040005_s1
------------------------------------------------------------------------------>
...
var ls_temp="CTITLE:STRING,APPDT:STRING,EMPNO:STRING,EMPDIV:STRING,EMPNMK:STRING,DEPTNM:STRING,PAYGRDNM:STRING,STRTDT:STRING,";
	...
	gcds_report0.namevalue(1,"JDDAY")=strDUYEAR+"³â "+strDUYMM+"¿ù";
...
/******************************************************************************
	Description : Ãâ·Â - ÅðÁ÷¼Òµæ¿øÃµÂ¡¼ö¿µ¼öÁõ/Áö±ÞÁ¶¼­
******************************************************************************/
function ln_Print2(){
	if (gcds_data.countrow<1) {
		alert("Ãâ·ÂÇÏ½Ç Á¤º¸°¡ ¾ø½À´Ï´Ù");
	...
	gcds_report0.namevalue(i,"JDDAY")	 = strDUYEAR+"³â "+strDUYMM+"¿ù";
	...
	gcds_report0.namevalue(i,"AMT01")		= parseInt(strJAMT+strJMUN+strJRAT);	//(102) °è
	...
	gcds_report0.namevalue(i,"AMT02")		= parseInt(strS91STD)/parseInt(strDUYEAR1);	//ÅðÁ÷°ú¼¼Ç¥ÁØ¡À±Ù¼Ó¿¬¼ö

	var strT91AMT  = gcds_data.namevalue(gcds_data.rowposition,"T91AMT");

	gcds_report0.namevalue(i,"AMT03")		= parseInt(strT91AMT)*parseInt(strDUYEAR1);	//¿¬Æò±Õ»êÃâ¼¼¾×*±Ù¼Ó¿¬¼ö
	...
	gcds_report0.namevalue(i,"AMT04")		= Math.floor(parseInt(amt04_floor)/10)*10;	//»êÃâ¼¼¾×-¼¼¾×°øÁ¦

	var strS91000 = gcds_data.namevalue(gcds_data.rowposition,"S91000");

	gcds_report0.namevalue(i,"AMT05")		= parseInt(strS91000+strJAMT);	//(104) °è(13)
	gcds_report0.namevalue(i,"AMT06")		= parseInt(strS91000+strJAMT+strJMUN+strJRAT);	//(104) °è(16)
	gcds_report0.namevalue(i,"AMT07")		= parseInt(strDUYEAR*12)+parseInt(strDUYMM);	//(17) ±Ù¼Ó¿ù¼ö
	...
	gcds_report0.namevalue(i,"AMT08")		= parseInt(strT23000)-parseInt(strJ_T2300);		//°áÁ¤¼¼¾×-Á¾(Àü)±Ù¹«Áö ±â³³ºÎ¼¼¾×
	gcds_report0.namevalue(i,"AMT09")		= parseInt(strT23000)+parseInt(strT24000);		//°è (29) ¼Òµæ¼¼+ÁÖ¹Î¼¼
	gcds_report0.namevalue(i,"AMT10")		= parseInt(strJ_T2300)+parseInt(strJ_T2400);	//°è (30) ¼Òµæ¼¼+ÁÖ¹Î¼¼
	gcds_report0.namevalue(i,"AMT11")		= parseInt(strT24000)+parseInt(strJ_T2400);		//°è (31) ÁÖ¹Î¼¼(°áÁ¤¼¼¾×+Á¾(Àü)±Ù¹«Áö ±â³³ºÎ¼¼¾×)
	gcds_report0.namevalue(i,"AMT12")		= (parseInt(strT24000)+parseInt(strJ_T2400))	//°è (31) ¼Òµæ¼¼+ÁÖ¹Î¼¼(ÃÑ)
																			+ (parseInt(strT23000)-parseInt(strJ_T2300));	
  
	gcds_report0.namevalue(i,"CURDT")=	gs_date;

	if (i==1) { 
		gcds_report0.namevalue(i,"HTITLE")	=	"(¹ß Çà ÀÚ º¸ °í ¿ë)";
	}else if(i==2) {
		gcds_report0.namevalue(i,"HTITLE")	=	"(¹ß Çà ÀÚ º¸ °ü ¿ë)";
	}else if(i==3) {
		gcds_report0.namevalue(i,"HTITLE")	=	"(¼Ò µæ ÀÚ º¸ °ü ¿ë)";
	}
...
var str2=gcds_data.namevalue(gcds_data.rowposition,"ENDDT");
	...
	gcds_report4.Reset(); //±×¸®µå
	gcds_report4.rowposition=1;
}

/******************************************************************************
	Description : Ãâ·Â - »ó¿©¸í¼¼¼­
******************************************************************************/
function ln_Print4(){
	if (gcds_data.countrow<1) {
		alert("Ãâ·ÂÇÏ½Ç Á¤º¸°¡ ¾ø½À´Ï´Ù");
			...
			//REPORT TITLE START--------------------------------------------------------------------------------------
			gcds_report0.namevalue(1,"CTITLE")="ÀüÃ¼ »ó¿©´ëÀå";
			gcrp_print4.preview();		//»ó¿©´ëÀå
	}
}
...
<comment id="__NSID__"><OBJECT id=gcds_report4 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	...
	<PARAM NAME="SyncLoad" VALUE="true"><!-- »ó¿© ¸í¼¼¼­ Á¶È¸ DataSet-->
</OBJECT></comment><script>__ws__(__NSID__);</script>
...
<script language="javascript" for="gcds_data" event="OnLoadStarted()">
	...
	gcem_BASAMT_SUM.Text= "";//±Þ¿©ÇÕ°è
	gcem_BASBUS_SUM.Text= "";//»ó¿©ÇÕ°è
	gcem_BAEAMT_SUM.Text= "";//±âÅ¸¼ö´çÇÕ°è
</script>
...
<script language="javascript" for="gcds_grid_ec02az" event="OnLoadStarted()">
	ft_cnt1.innerText="Ãß°è ÅðÁ÷±Ýµ¥ÀÌÅ¸ Á¶È¸ÁßÀÔ´Ï´Ù.";
	window.status="Ãß°è ÅðÁ÷±Ýµ¥ÀÌÅ¸ Á¶È¸ÁßÀÔ´Ï´Ù.";
	//document.all.LowerFrame.style.visibility="visible";
</script>
...
<script language=JavaScript for=gcds_data event=OnRowPosChanged(row)>
	if(row >0){
	 ...
	 gcem_AVGETC.Text = Math.round((str_bamtsum2/str_bdaysum2)*30);		//±âÅ¸Æò±Õ AVGETC

	 gcem_AVGAMT.Text = //±âº»±Þ Æò±Õ
	 Math.round((gcds_data.NameValue(row,"BASAMT1")+
	 gcds_data.NameValue(row,"BASAMT2")+
	 gcds_data.NameValue(row,"BASAMT3")+
	 gcds_data.NameValue(row,"BASAMT4"))/3);

	 gcem_AVGBOS.Text = //»ó¿©±Ý Æò±Õ
...
<script language="javascript" for="gctr_data" event="OnSuccess()">
	alert("¿äÃ»ÇÏ½Å ÀÛ¾÷À» ¼º°øÀûÀ¸·Î ¼öÇàÇÏ¿´½À´Ï´Ù.");
</script>
<script language="javascript" for="gctr_data" event="onerror()">
	alert("¿äÃ»ÇÏ½Å ÀÛ¾÷À» ¼º°øÀûÀ¸·Î ¼öÇàÇÏÁö ¸øÇß½À´Ï´Ù.");
</script>
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    ...
    <td align="right" style="padding-top:4px;" background="../../Common/img/com_t_bg.gif">
			<img src="../../Common/img/btn/com_b_redetail.gif"	style="cursor:hand" onclick="ln_Print4()"><!--»ó¿©¸í¼¼¼­--> 
			<img src="../../Common/img/btn/com_b_account.gif"	style="cursor:hand" onclick="ln_Print3()"><!--Á¤»ê¿µ¼öÁõ--> 
			<img src="../../Common/img/btn/com_b_retirec.gif"	style="cursor:hand" onclick="ln_Print2()"><!--ÅðÁ÷¿µ¼öÁõ--> 
	    <img src="../../Common/img/btn/com_b_reinfor.gif" style="cursor:hand" onclick="ln_Print()"><!--Åð»çÅëº¸¼­--> 
  ...
  <tr> 
	...
	<table cellpadding=0 cellspacing=0>
      ...
      <td style="height:20px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:0px" bgcolor="#eeeeee"><nobr>&nbsp;¼º¸í&nbsp;</nobr></td>
  ...
  <table width="876" cellpadding="0" cellspacing="0" border="0">
			...
			<td colspan=2>
				<comment id="__NSID__"><OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_create  style="WIDTH: 280px; HEIGHT: 276px;border:1 solid #777777;display:block;" viewastext>
					...
					<PARAM NAME="Format"			VALUE="  
						<C> Name='¼Ò¼Ó' ID=DEPTNM   HeadAlign=Center HeadBgColor=#B9D4DC Width=80 </C>
						<C> Name='¼º¸í' ID=EMPNMK HeadAlign=Center HeadBgColor=#B9D4DC Width=50 align=center   </C>
						<C> Name='»ç¹ø' ID=EMPNO  	HeadAlign=Center HeadBgColor=#B9D4DC Width=50   align=center </C> 
						<C> Name='Åð»çÀÏ' ID=ENDDT HeadAlign=Center HeadBgColor=#B9D4DC Width=65 align=center Mask='XXXX/XX/XX' </C>
					">
				</OBJECT></comment><script>__ws__(__NSID__);</script>
		  </td>
		</tr>
	...
	<table width="282" height="482" border= "0" cellpadding=0 cellspacing=0  border=0  style=' height:28px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
		<tr>
			<td style="height:20px; width:40px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;ÅðÁ÷»çÀ¯&nbsp;</nobr></td>
		...
		<tr>
      <td  style="height:20px; width:40px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;»ç¹ø/¼º¸í&nbsp;</nobr></td>
		...
		<tr>
			<td  style="height:25px; width:40px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;¼Ò¼Ó/Á÷À§&nbsp;</nobr></td>
		...
		<tr>
			<td  style="height:25px; width:40px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;ÀÔ/Åð»çÀÏ&nbsp;</nobr></td>
		...
		<tr>
      <td  style="height:23px; width:60px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±Ù¹«±â°£&nbsp;</nobr></td>
			<td  width="100%" style="height:20px;border:0 solid #708090;border-right-width:0px;border-bottom-width:1px" bgcolor="#ffffff"><nobr><INPUT TYPE=TEXT STYLE="width:20px; padding-top:4px;text-align:right;" id=txt_DUYEAR class="txt21" readonly  value="" >&nbsp;&nbsp;³â<INPUT TYPE=TEXT STYLE="width:20px;  padding-top:4px;text-align:right;" id=txt_DUYMM class="txt21" readonly  value="" >&nbsp;&nbsp;°³¿ù<INPUT TYPE=hidden STYLE="width:20px; padding-top:4px ;text-align:right;" id=txt_DUDAY class="txt21" readonly  value="" >&nbsp;&nbsp;<!-- ÀÏ -->&nbsp; </nobr></td> 
		</tr>	
		<tr>
			<td  style="height:23px; width:60px; border:0 solid #708090;border-right-width:1px;border-bottom-width:0px" bgcolor="#eeeeee"><nobr>&nbsp;ÁÖ¼Ò&nbsp;</nobr></td>
...
<table width="591" border= "0" cellpadding=0 cellspacing=0  style='height:28px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
	<tr>
		<TD colspan=10 align="left" style="height:20px; border:0 solid #708090;border-right-width:0px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;1.ÅðÁ÷±Ý°è»ê³»¿ª-Á÷¿ø&nbsp;</nobr></TD>                     
  </tr>   
	<tr>
		<TD colspan=4 align="center" style="height:20px; border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âº»±Þ+Á÷Ã¥¼ö´ç+½Ã°£¿Ü¼ö´ç&nbsp;</nobr></TD> 
		<TD colspan=2 align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;»ó¿©±Ý¤ý³âÂ÷¼ö´ç&nbsp;</nobr></TD> 
		<TD colspan=4 align="center" style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âÅ¸ ¼ö´ç&nbsp;</nobr></TD> 
	</tr>   
	<tr>
		...
		<td align=center style=" width:70px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>1st¿ù</nobr></td>
		...
		<td  align=center style="height:20px; width:70px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>1st¿ù</nobr></td>
	...
	<tr>
		...
		<TD align=center  style="height:20px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>2nd¿ù</nobr></td>
		...
		<TD align=center  style="height:20px; width:70px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>2nd¿ù</nobr></td>
	...
	<tr>
		...
		<TD align=center  style="height:20px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>3th¿ù</nobr></td>
		<TD align=center style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px"><nobr>
	...
	<tr>
		...
		<TD align=center  style="height:20px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>4th¿ù</nobr></td>
		...
		<TD align=center  style="height:20px; width:70px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>4th¿ù</nobr></td>
		<TD align=center  style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px"><nobr>
	...
	<tr>
		<TD align=center colspan=3  style="height:22px;border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>³âÂ÷ÀÏ¼ö</nobr></TD> 
		<TD align=center  style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px"><nobr>
		...
		<TD align=center   style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>³âÂ÷¼ö´ç</nobr></TD> 
		<TD align=center  style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px"><nobr>
		...
		<TD align=center colspan=3  style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>Æò±Õ³âÂ÷¼ö´ç</nobr></TD> 
	...
	<tr>
		<td colspan=3 align=center  style="height:22px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>ÇÕ°è</nobr></td>
		<TD  align=center style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px"><nobr>
		...
		<td  align=center style="height:20px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>ÇÕ°è</nobr></td>
		<TD  align=center style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px"><nobr>
		...
		<td colspan=3 align=center   style="height:20px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee">ÇÕ°è</td>
		<TD align=center  style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px"><nobr>
	...
	<tr>
		<TD align=center colspan=3  style="height:22px;border:0 solid #708090;border-right-width:1px; border-bottom-width:0px" bgcolor="#eeeeee"><nobr>Æò±Õ</nobr></TD> 
		...
		<TD align=center   style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px" bgcolor="#eeeeee"><nobr>Æò±Õ</nobr></TD> 
		<TD align=center  style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px"><nobr>
		...
		<TD align=center colspan=3  style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px" bgcolor="#eeeeee"><nobr>Æò±Õ</nobr></TD> 
		<TD align=center  style="border:0 solid #708090;border-right-width:0px; border-bottom-width:0px"><nobr>
...
<table width="591" border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0  style='height:28px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
	<tr>
		<TD colspan=8 align="left" style="height=22px; border:0 solid #708090;border-right-width:0px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;2.±âÅ¸¼ö´ç³»¿ª&nbsp;</nobr></TD> 
	</tr>   
	<tr>
		<TD align="center" style=" height:20px;border:0 solid #708090;border-right-width:1px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>±Ù¼Ó¼ö´ç</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>ÀÚ±â°è¹ßºñ</nobr></TD> 
		<td align="center" style="height:20px; width:70px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>Â÷·®À¯Áöºñ</nobr></td>
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>³²ºÏ°æÇù¼ö´ç</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>ÀÓ¿øÁ÷Ã¥¼ö´ç</nobr></TD>
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>¿¬Àå¼ö´ç</nobr></TD>
		<TD align="center" style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px;width:81px" bgcolor="#eeeeee"><nobr>±âÅ¸</nobr></TD> 
	...
	<tr>
		<td align="center"  style="height:23px; border:0 solid #708090;border-right-width:1px;border-bottom-width:0px" ><nobr>
			<comment id="__NSID__"><object id=gcem_P21000 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"	style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1		validFeatures="ignoreStatus=yes" validExp=""> <!-- ±Ù¼Ó¼ö´ç -->
				<param name=Text          value="">
				<param name=Alignment			value=2>
				<param name=Border	      value=true>
				<param name=ClipMode			value=true>
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px"><nobr>
			<comment id="__NSID__"><object id=gcem_P22000                
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- ÀÚ±â°è¹ßºñ -->
				<param name=Text          value="">
				<param name=Alignment			value=2>
				<param name=Border	      value=true>
				<param name=ClipMode			value=true>
		...
		<td align="center"  style=" border:0 solid #708090;border-right-width:1px;border-bottom-width:0px" ><nobr>
			<comment id="__NSID__"><object id=gcem_P24000               
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- Â÷·®À¯Áöºñ -->
				<param name=Text          value="">
				<param name=Alignment	  value=2>
				<param name=Border	      value=true>
				<param name=ClipMode	  value=true>
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px"><nobr>
			<comment id="__NSID__"><object id=gcem_P29000               
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- ³²ºÏ°æÇù¼ö´ç -->
				<param name=Text          value="">
				<param name=Alignment	  value=2>
				<param name=Border	      value=true>
				<param name=ClipMode	  value=true>
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px"><nobr>
			<comment id="__NSID__"><object id=gcem_P38000                 
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- ÀÓ¿øÁ÷Ã¥¼ö´ç -->
				<param name=Text          value="">
				<param name=Alignment	  value=2>
				<param name=Border	      value=true>
				<param name=ClipMode	  value=true>
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:0px"><nobr><comment id="__NSID__"><object id=gcem_P27000 
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- ¿¬Àå¼ö´ç -->
				<param name=Text          value="">
				<param name=Alignment	  value=2>
				<param name=Border	      value=true>
				<param name=ClipMode	  value=true>
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:0px; border-bottom-width:0px"><nobr>
			<comment id="__NSID__"><object id=gcem_PX0000                
			 classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
						style="position:relative; left:1px;top:1px; width:70px; height:20px; font-family:±¼¸²; font-size:9pt;  " class=objclsEme1
						validFeatures="ignoreStatus=yes" validExp=""> <!-- ±âÅ¸ -->
				<param name=Text          value="">
				<param name=Alignment			value=2>
				<param name=Border	      value=true>
				<param name=ClipMode			value=true>
...
<table width="591" border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0 style='height:28px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
	<tr>
		<td colspan=7 align="left" style="height:20px; width:70px; border:0 solid #708090;border-right-width:0px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;3.ÅðÁ÷±ÝÁ¤»ê³»¿ª&nbsp;</nobr></td>
  </tr>   
	<tr>
		<td align="center" style="height:20px; width:81px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>±Þ¿©</nobr></td>
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>ÅðÁ÷±Ý</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>³âÂ÷¼ö´ç</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>»ó¿©</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>Áö±ÞÇÕ°è</nobr></TD> 
		<TD  align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>½ÇÁö±Þ¾×</nobr></TD> 
...
<table width="591" border= "0" class=itemdisp cellpadding=0 cellspacing=0  border=0  style='height:28px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
	<tr>
		<td colspan=7 align="left" style="height:20px;  border:0 solid #708090;border-right-width:0px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;4.°øÁ¦³»¿ª&nbsp;</nobr></td>
  </tr>   
	<tr>
		<td align="center" style="height:20px; width:81px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>Á¤»ê°©±Ù¼¼</nobr></td>
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>Á¤»êÁÖ¹Î¼¼</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>Á¤»ê±¹¹Î¿¬±Ý</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>Á¤»ê°Ç°­º¸Çè</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>Á¤»ê°í¿ëº¸Çè</nobr></TD> 
		<TD  align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px; width:81px;" bgcolor="#eeeeee"><nobr>ÅðÁ÷¼Òµæ¼¼</nobr></TD> 
		<TD  align="center" style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>ÅðÁ÷ÁÖ¹Î¼¼</nobr></TD> 
	</tr>   
	<tr>
	...
	<tr>
		<td align="center" style="height:20px; border:0 solid #708090;border-right-width:1px;border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âÅ¸1&nbsp;</nobr></td>
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âÅ¸2&nbsp</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âÅ¸3&nbsp</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;±âÅ¸4&nbsp</nobr></TD> 
		<TD align="center" style="border:0 solid #708090;border-right-width:1px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;ÅðÁ÷ÀüÈ¯±Ý&nbsp;</nobr></TD> 
		...
		<TD align="center" style="border:0 solid #708090;border-right-width:0px; border-bottom-width:1px" bgcolor="#eeeeee"><nobr>&nbsp;°øÁ¦ÇÕ°è&nbsp;</nobr></TD> 
	</tr>   
	<tr>
		<td align="center" style="height:23px;  border:0 solid #708090;border-right-width:1px;border-bottom-width:0px" ><nobr>
...
<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=2622 ,face='±¼¸²' ,size=10 ,penwidth=1
	...
	<T>id='ÁÖ¹Î¹øÈ£ :' ,left=1453 ,top=197 ,right=1619 ,bottom=253 ,align='left'</T>
	<T>id='ÁÖ¼Ò :' ,left=266 ,top=197 ,right=378 ,bottom=253 ,align='left'</T>
	<C>id='CTITLE', left=1328, top=125, right=1903, bottom=178, align='right' ,mask='XXXX³â XX¿ù XXÀÏ', face='±¼¸²', size=12, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='1.ÀÎÀû»çÇ×' ,left=34 ,top=197 ,right=247 ,bottom=250 ,align='left' ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ç ¹ø :' ,left=47 ,top=275 ,right=194 ,bottom=328 ,align='left'</T>
	<C>id='STRTDT', left=600, top=275, right=816, bottom=328, align='left' ,mask='XXXX/XX/XX'</C>
	<T>id='ÀÔ»çÀÏ :' ,left=450 ,top=275 ,right=584 ,bottom=328 ,align='left'</T>
	...
	<T>id='¼º ¸í :' ,left=1513 ,top=275 ,right=1628 ,bottom=328 ,align='left'</T>
	<C>id='DEPTNM', left=1050, top=275, right=1491, bottom=328, align='left'</C>
	<T>id='¼Ò      ¼Ó :' ,left=863 ,top=275 ,right=1038 ,bottom=328 ,align='left'</T>
	...
	<T>id='»ç À¯ :' ,left=1513 ,top=337 ,right=1628 ,bottom=391 ,align='left'</T>
	<C>id='JDDAY', left=1050, top=337, right=1491, bottom=391, align='left'</C>
	<T>id='ÀçÁ÷±â°£ :' ,left=863 ,top=337 ,right=1038 ,bottom=391 ,align='left'</T>
	<C>id='ENDDT', left=600, top=337, right=813, bottom=391, align='left' ,mask='XXXX/XX/XX'</C>
	<T>id='Åð»çÀÏ :' ,left=450 ,top=337 ,right=584 ,bottom=391 ,align='left'</T>
	<C>id='PAYGRDNM', left=209, top=337, right=381, bottom=391, align='left'</C>
	<T>id='Á÷ À§ :' ,left=47 ,top=337 ,right=194 ,bottom=391 ,align='left'</T>
	...
	<T>id='2.ÅðÁ÷±Ý °è»ê³»¿ª' ,left=16 ,top=412 ,right=375 ,bottom=466 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Åð    Á÷    ±Ý' ,left=1531 ,top=478 ,right=1800 ,bottom=531</T>
	<T>id='±âÅ¸ ¹× ¿ùÂ÷¼ö´ç' ,left=950 ,top=478 ,right=1400 ,bottom=531</T>
	<T>id='»ó¿©±Ý ¹× ³âÂ÷¼ö´ç' ,left=497 ,top=478 ,right=931 ,bottom=531</T>
	<T>id='±âº»±Þ + Á÷Ã¥ + ½Ã°£¿Ü' ,left=50 ,top=478 ,right=466 ,bottom=531</T>
	...
	<C>id='CMM1', left=1097, top=553, right=1175, bottom=606 ,mask='XX¿ù'</C>
	...
	<C>id='CMM1', left=184, top=553, right=263, bottom=606 ,mask='XX¿ù'</C>
	...
	<T>id='°è  »ê  ³»  ¿ª' ,left=1531 ,top=616 ,right=1800 ,bottom=669</T>
	<C>id='BAEAMT2', left=1188, top=616, right=1403, bottom=669, align='right'</C>
	<C>id='CMM2', left=1097, top=616, right=1175, bottom=669 ,mask='XX¿ù'</C>
	...
	<C>id='CMM2', left=184, top=616, right=263, bottom=669 ,mask='XX¿ù'</C>
	...
	<C>id='CMM3', left=1097, top=678, right=1175, bottom=731 ,mask='XX¿ù'</C>
	...
	<C>id='CMM3', left=184, top=678, right=263, bottom=731 ,mask='XX¿ù'</C>
	...
	<C>id='CMM4', left=1097, top=741, right=1175, bottom=794 ,mask='XX¿ù'</C>
	...
	<C>id='CMM4', left=184, top=741, right=263, bottom=794 ,mask='XX¿ù'</C>
	...
	<T>id='ÇÕ°è' ,left=38 ,top=866 ,right=259 ,bottom=919</T>
	<C>id='BASAMT_SUM', left=272, top=866, right=484, bottom=919, align='right'</C>
	<T>id='ÇÕ°è' ,left=944 ,top=866 ,right=1172 ,bottom=919</T>
	<C>id='BAEAMT_SUM', left=1188, top=866, right=1403, bottom=919, align='right'</C>
	<T>id='ÃÑ  Æò  ±Õ  °è' ,left=1531 ,top=866 ,right=1800 ,bottom=919</T>
	...
	<T>id='Æò        ±Õ' ,left=944 ,top=928 ,right=1172 ,bottom=981</T>
	...
	<T>id='±âÅ¸' ,left=1425 ,top=1069 ,right=1644 ,bottom=1122</T>
	<T>id='¿¬Àå¼ö´ç' ,left=1188 ,top=1069 ,right=1406 ,bottom=1122</T>
	<T>id='ÀÓ¿øÁ÷Ã¥¼ö´ç' ,left=941 ,top=1069 ,right=1169 ,bottom=1122</T>
	<T>id='±Ù¼Ó¼ö´ç' ,left=41 ,top=1069 ,right=259 ,bottom=1122</T>
	...
	<T>id='Áö                  ±Þ   (A)' ,left=41 ,top=1278 ,right=925 ,bottom=1334</T>
	<T>id='°ø                  Á¦   (B)' ,left=950 ,top=1278 ,right=1869 ,bottom=1334</T>
	<L> left=22 ,top=1266 ,right=1900 ,bottom=1266 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='4.ÅðÁ÷±Ý Á¤»ê³»¿ª' ,left=16 ,top=1206 ,right=925 ,bottom=1262 ,align='left' ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=25 ,top=1344 ,right=1900 ,bottom=1344 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='Àû     ¿ä' ,left=950 ,top=1356 ,right=1169 ,bottom=1409</T>
	<T>id='È®     ÀÎ' ,left=716 ,top=1356 ,right=925 ,bottom=1409</T>
	<T>id='±Ý               ¾×' ,left=272 ,top=1356 ,right=706 ,bottom=1409</T>
	<T>id='Àû     ¿ä' ,left=41 ,top=1356 ,right=263 ,bottom=1409</T>
	<L> left=25 ,top=1412 ,right=1900 ,bottom=1412 </L>
	<T>id='±Ù·Î¼ÒµæÁ¤»ê' ,left=1425 ,top=1419 ,right=1884 ,bottom=1472</T>
	<T>id='ÅðÁ÷¼ÒµæÁ¤»ê' ,left=1188 ,top=1419 ,right=1406 ,bottom=1472</T>
	<C>id='JUSPAY', left=275, top=1419, right=638, bottom=1472, align='right'</C>
	<T>id='±Þ     ¿©' ,left=41 ,top=1419 ,right=263 ,bottom=1472</T>
	...
	<T>id='»ó     ¿©' ,left=41 ,top=1481 ,right=263 ,bottom=1534</T>
	...
	<T>id='Åð Á÷ ±Ý' ,left=44 ,top=1544 ,right=266 ,bottom=1597</T>
	...
	<T>id='³âÂ÷¼ö´ç' ,left=41 ,top=1606 ,right=263 ,bottom=1659</T>
	...
	<T>id='ÇÕ °è (A)' ,left=41 ,top=1981 ,right=263 ,bottom=2034</T>
	...
	<T>id='ÅðÁ÷±ÞÀÌÃ¼' ,left=41 ,top=2044 ,right=263 ,bottom=2097</T>
	...
	<T>id='Â÷ÀÎÁö±Þ¾× (A-B)' ,left=1013 ,top=2119 ,right=1303 ,bottom=2175 ,align='left'</T>
	<T>id='5.¹Ý³³È®ÀÎ' ,left=28 ,top=2119 ,right=609 ,bottom=2172 ,align='left' ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¿©±Ç¹Ý³³Áõ' ,left=41 ,top=2256 ,right=259 ,bottom=2309</T>
	...
	<T>id='È¸»ç½ÅºÐÁõ' ,left=41 ,top=2319 ,right=259 ,bottom=2372</T>
	...
	<T>id='¼ö     ·®' ,left=275 ,top=2194 ,right=706 ,bottom=2247</T>
	<T>id='È®   ÀÎ' ,left=716 ,top=2194 ,right=925 ,bottom=2247</T>
	<T>id='¼ö    ·®' ,left=1194 ,top=2194 ,right=1656 ,bottom=2247</T>
	...
	<T>id='Á¾  ·ù' ,left=41 ,top=2194 ,right=259 ,bottom=2247</T>
	<L> left=113 ,top=2387 ,right=113 ,bottom=2603 </L>
	<T>id='Àç' ,left=38 ,top=2525 ,right=106 ,bottom=2578</T>
	<T>id='°á' ,left=38 ,top=2422 ,right=106 ,bottom=2475</T>
	<T>id='´ã   ´ç' ,left=131 ,top=2397 ,right=375 ,bottom=2450</T>
	...
	<T>id='Åð  »ç  Åë  º¸' ,left=653 ,top=3 ,right=1331 ,bottom=94 ,face='HYÁß°íµñ' ,size=20 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='³âÂ÷ÀÏ¼ö' ,left=38 ,top=803 ,right=259 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FFFBF0 ,backcolor=#FFFFFF</T>
	<T>id='Æò        ±Õ' ,left=38 ,top=928 ,right=259 ,bottom=981</T>
	<C>id='AVGAMT', left=272, top=928, right=484, bottom=981, align='right'</C>
	<T>id='ÀÚ±â°è¹ßºñ' ,left=272 ,top=1069 ,right=484 ,bottom=1122</T>
	...
	<T>id='³âÂ÷¼ö´ç' ,left=494 ,top=803 ,right=706 ,bottom=856</T>
	<T>id='ÇÕ°è' ,left=494 ,top=866 ,right=706 ,bottom=919</T>
	<T>id='Æò        ±Õ' ,left=494 ,top=928 ,right=706 ,bottom=981</T>
	...
	<T>id='Æò±Õ³âÂ÷¼ö´ç' ,left=944 ,top=803 ,right=1166 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#FFFBF0 ,backcolor=#FFFFFF</T>
	<T>id='3.±âÅ¸¼ö´ç ³»¿ª' ,left=16 ,top=1000 ,right=597 ,bottom=1053 ,align='left' ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='P24000', left=494, top=1131, right=706, bottom=1184, align='right'</C>
	<T>id='Â÷·®À¯Áöºñ' ,left=494 ,top=1069 ,right=706 ,bottom=1122</T>
	<T>id='³²ºÏ°æÇù¼ö´ç' ,left=716 ,top=1069 ,right=931 ,bottom=1122</T>
	...
	<T>id='°Ë   Åä' ,left=403 ,top=2397 ,right=622 ,bottom=2450</T>
	<T>id='ºÎ ¼­ Àå' ,left=650 ,top=2397 ,right=894 ,bottom=2450</T>
	<T>id='»ç   Àå' ,left=1506 ,top=2397 ,right=1875 ,bottom=2450</T>
	<T>id='º» ºÎ Àå' ,left=1213 ,top=2397 ,right=1456 ,bottom=2450</T>
	<T>id='Áß   ¿ª' ,left=919 ,top=2397 ,right=1163 ,bottom=2450</T>
	<T>id='ÇÕ°è (B)' ,left=950 ,top=2044 ,right=1169 ,bottom=2097</T>
	<T>id='±â  Å¸3' ,left=950 ,top=1981 ,right=1169 ,bottom=2034</T>
	<T>id='±â  Å¸2' ,left=950 ,top=1919 ,right=1169 ,bottom=1972</T>
	<T>id='±â  Å¸1' ,left=950 ,top=1856 ,right=1169 ,bottom=1909</T>
	<T>id='ÅðÁ÷ÀüÈ¯±Ý' ,left=950 ,top=1794 ,right=1169 ,bottom=1847</T>
	<T>id='°í¿ëº¸Çè' ,left=950 ,top=1731 ,right=1169 ,bottom=1784</T>
	<T>id='°Ç°­º¸Çè' ,left=950 ,top=1669 ,right=1169 ,bottom=1722</T>
	<T>id='±¹¹Î¿¬±Ý' ,left=950 ,top=1606 ,right=1169 ,bottom=1659</T>
	<T>id='ÁÖ ¹Î ¼¼' ,left=950 ,top=1544 ,right=1169 ,bottom=1597</T>
	<T>id='°© ±Ù ¼¼' ,left=950 ,top=1481 ,right=1169 ,bottom=1534</T>
	<T>id='È®     ÀÎ' ,left=1669 ,top=1356 ,right=1888 ,bottom=1409</T>
	<L> left=1659 ,top=1347 ,right=1659 ,bottom=1412 ,penstyle=dot ,penwidth=0 ,pencolor=#000000 </L>
	<T>id='±Ý               ¾×' ,left=1188 ,top=1356 ,right=1647 ,bottom=1409</T>
	<C>id='', left=1194, top=2256, right=1656, bottom=2309, align='right'</C>
	<C>id='', left=1194, top=2319, right=1656, bottom=2375, align='right'</C>
	<T>id='±â   Å¸' ,left=950 ,top=2319 ,right=1169 ,bottom=2372</T>
	<T>id='°Ç°­º¸ÇèÁõ' ,left=950 ,top=2256 ,right=1169 ,bottom=2309</T>
	<T>id='Á¾   ·ù' ,left=950 ,top=2194 ,right=1169 ,bottom=2247</T>
	<C>id='', left=1672, top=2256, right=1878, bottom=2309, align='right'</C>
	<T>id='È®   ÀÎ' ,left=1672 ,top=2194 ,right=1881 ,bottom=2247</T>
...
<!-------------------------------------------------------------------------------------------
   ¢Ã º¸°í¼­ Á¤ÀÇºÎºÐ - ÅðÁ÷¼Òµæ¿øÃµÂ¡¼ö¿µ¼öÁõ
-------------------------------------------------------------------------------------------->  
...
<B>id=default ,left=0,top=0 ,right=2000 ,bottom=2740 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='°ü¸®' ,left=59 ,top=156 ,right=172 ,bottom=194 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¹øÈ£' ,left=59 ,top=197 ,right=172 ,bottom=234 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=178 ,top=147 ,right=178 ,bottom=241 </L>
	<T>id='ÅðÁ÷¼Òµæ¿øÃµÂ¡¼ö¿µ¼öÁõ/Áö±ÞÁ¶¼­' ,left=522 ,top=184 ,right=1297 ,bottom=262 ,align='left' ,face='HYÁß°íµñ' ,size=12 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=6 ,top=2491 ,right=1903 ,bottom=2491 ,penstyle=solid ,penwidth=2 ,pencolor=#000000 </L>
	<T>id='1. °ÅÁÖÁö±¹°ú °ÅÁÖÁö±¹ÄÚµå´Â ¿Ü±¹ÀÎ¿¡ ÇØ´çÇÏ´Â °æ¿ì¿¡ ÇÑÇÏ¿© ±âÀçÇÏ¸ç, ±¹Á¦Ç¥ÁØÈ­±â±¸(ISO)°¡ Á¤ÇÑ ISOÄÚµå Áß ±¹¸í¾à¾î ¹× ±¹°¡ÄÚµå¸¦ ±âÀçÇÕ´Ï´Ù.' ,left=13 ,top=2316 ,right=1897 ,bottom=2347 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='2. ¿øÃµÂ¡¼öÀÇ¹«ÀÚ´Â Áö±ÞÀÏÀÌ ¼ÓÇÏ´Â ¿¬µµÀÇ ´ÙÀ½ ¿¬µµ 2¿ù¸»ÀÏ(ÈÞ¾÷ ¶Ç´Â Æó¾÷ÇÑ °æ¿ì¿¡´Â ' ,left=13 ,top=2350 ,right=1897 ,bottom=2381 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='    ÈÞ¾÷ÀÏ ¶Ç´Â Æó¾÷ÀÏÀÌ ¼ÓÇÏ´Â ´ÞÀÇ ´ÙÀ½ ´Þ ¸»ÀÏ)±îÁö Áö±ÞÁ¶¼­¸¦ Á¦ÃâÇÔ.' ,left=13 ,top=2384 ,right=1897 ,bottom=2416 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id
,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼Ò' ,left=13 ,top=1034 ,right=103 ,bottom=1081 ,face='±¼¸²' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='º°' ,left=13 ,top=981 ,right=103 ,bottom=1028 ,face='±¼¸²' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Ã³' ,left=13 ,top=928 ,right=103 ,bottom=975 ,face='±¼¸²' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±Þ' ,left=13 ,top=875 ,right=103 ,bottom=922 ,face='±¼¸²' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Áö' ,left=13 ,top=822 ,right=103 ,bottom=869 ,face='±¼¸²' ,size=10 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='ÇÕ  °è' ,left=1531 ,top=797 ,right=1897 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='(103) Á¾(Àü)' ,left=1238 ,top=797 ,right=1516 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='(102) Á¾(Àü)' ,left=947 ,top=797 ,right=1225 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='(101) ÁÖ(Çö)' ,left=653 ,top=797 ,right=931 ,bottom=856 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='10)Áö±ÞÃ³±¸ºÐ' ,left=116 ,top=797 ,right=641 ,bottom=856 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¨ï±Í ¼Ó ¿¬ µµ' ,left=13 ,top=728 ,right=494 ,bottom=787 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±îÁö' ,left=1081 ,top=728 ,right=1156 ,bottom=787 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='ENDDT', left=869, top=728, right=1075, bottom=787, align='right' ,mask='XXXX³â', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	<T>id='ºÎÅÍ' ,left=781 ,top=728 ,right=856 ,bottom=787 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='STRTDT', left=569, top=728, right=775, bottom=787, align='right' ,mask='XXXX³â', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<T>id='¨îÁÖ   ¼Ò' ,left=197 ,top=659 ,right=494 ,bottom=719 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=188 ,top=653 ,right=1903 ,bottom=653 </L>
	<T>id='¨ì¼º   ¸í' ,left=197 ,top=591 ,right=494 ,bottom=650 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¨íÁÖ¹Îµî·Ï¹øÈ£' ,left=966 ,top=591 ,right=1356 ,bottom=650 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¼ÒµæÀÚ' ,left=16 ,top=591 ,right=181 ,bottom=719 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¨ë¼Ò Àç Áö(ÁÖ¼Ò)' ,left=197 ,top=522 ,right=494 ,bottom=581 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¨é´ë Ç¥ ÀÚ(¼º¸í)' ,left=197 ,top=453 ,right=494 ,bottom=512 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=188 ,top=447 ,right=1903 ,bottom=447 </L>
	<T>id='¨ç»ç¾÷ÀÚµî·Ï¹øÈ£' ,left=197 ,top=384 ,right=494 ,bottom=444 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=6 ,top=378 ,right=1903 ,bottom=378 </L>
	<T>id='ÀÇ¹«ÀÚ' ,left=22 ,top=487 ,right=178 ,bottom=534 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Â¡   ¼ö' ,left=22 ,top=434 ,right=178 ,bottom=481 ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=188 ,top=381 ,right=188 ,bottom=722 </L>
	<T>id='¨êÁÖ¹Î(¹ýÀÎ)µî·Ï¹øÈ£' ,left=966 ,top=453 ,right=1356 ,bottom=512 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¨è¹ýÀÎ¸í(»óÈ£)' ,left=966 ,top=384 ,right=1356 ,bottom=444 ,align='left' ,face='±¼¸²' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='°ÅÁÖ±¸ºÐ' ,left=1341 ,top=156 ,right=1584 ,bottom=206 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ºñ°ÅÁÖÀÚ2' ,left=1753 ,top=156 ,right=1900 ,bottom=206 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='°ÅÁÖÀÚ1' ,left=1597 ,top=156 ,right=1725 ,bottom=206 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id
,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='27)°æ·Î¿ì´ë' ,left=288 ,top=1006 ,right=494 ,bottom=1041 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='26)ºÎ¾ç°¡Á·' ,left=288 ,top=969 ,right=494 ,bottom=1003 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='25)¹è¿ìÀÚ' ,left=288 ,top=931 ,right=656 ,bottom=966 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='29)ºÎ³àÀÚ' ,left=288 ,top=1081 ,right=656 ,bottom=1116 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='24)º»   ÀÎ' ,left=288 ,top=894 ,right=656 ,bottom=928 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='22)±Ù·Î¼Òµæ°øÁ¦' ,left=131 ,top=819 ,right=656 ,bottom=853 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='21)ÃÑ ±Þ ¿©(16)' ,left=131 ,top=781 ,right=656 ,bottom=816 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='°øÁ¦' ,left=194 ,top=953 ,right=259 ,bottom=991 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='±Ý' ,left=128 ,top=1387 ,right=169 ,bottom=1425 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='µæ' ,left=128 ,top=1300 ,right=169 ,bottom=1337 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼Ò' ,left=128 ,top=1212 ,right=169 ,bottom=1250 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÇÕ' ,left=128 ,top=1125 ,right=169 ,bottom=1162 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='11)±Ù¹«Ã³¸í' ,left=131 ,top=481 ,right=656 ,bottom=516 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='12)»ç¾÷ÀÚµî·Ï¹øÈ£' ,left=131 ,top=519 ,right=656 ,bottom=553 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='13)±Þ   ¿©' ,left=131 ,top=556 ,right=656 ,bottom=591 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='14)»ó   ¿©' ,left=131 ,top=594 ,right=656 ,bottom=628 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¼º   ¸í' ,left=1441 ,top=1844 ,right=1616 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ü°è' ,left=1347 ,top=1844 ,right=1428 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÁÖ¹Îµî·Ï¹øÈ£' ,left=1628 ,top=1844 ,right=1947 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ü°è' ,left=694 ,top=1844 ,right=778 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼º   ¸í' ,left=788 ,top=1844 ,right=966 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÁÖ¹Îµî·Ï¹øÈ£' ,left=978 ,top=1844 ,right=1334 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=22 ,top=1916 ,right=1950 ,bottom=1916 </L>
	<L> left=22 ,top=1878 ,right=1953 ,bottom=1878 </L>
	<T>id='°ü°è' ,left=31 ,top=1844 ,right=116 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼º   ¸í' ,left=128 ,top=1844 ,right=309 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÁÖ¹Îµî·Ï¹øÈ£' ,left=319 ,top=1844 ,right=675 ,bottom=1878 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='69)ºÎ¾ç°¡Á·°øÁ¦ÀÚ ¸í¼¼ [´çÇØ ¼ÒµæÀÚÀÇ ÁÖ¹Îµî·ÏÇ¥µîº»»ó¿¡ µîÀçµÇÁö ¾Æ´ÏÇÔ¿¡µµ, ±âº»°øÁ¦ ¶Ç´Â ÁÖ°¡°øÁ¦¸¦ ¹Þ´Â Áö¸¦ ±âÀçÇÕ´Ï´Ù.]' ,left=25 ,top=1806 ,right=1944 ,bottom=1837 ,align='left' ,face='±¼¸²' ,size=8 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¸í' ,left=28 ,top=1706 ,right=119 ,bottom=1744 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='±â³³ºÎ' ,left=131 ,top=1691 ,right=297 ,bottom=1722 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='³ó¾îÃÌÆ¯º°¼¼' ,left=1222 ,top=1612 ,right=1409 ,bottom=1647 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°è' ,left=1422 ,top=1612 ,right=1691 ,bottom=1647 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼Òµæ¼¼' ,left=669 ,top=1612 ,right=931 ,bottom=1647 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÁÖ¹Î¼¼' ,left=944 ,top=1612 ,right=1206 ,bottom=1647 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á¦' ,left=1078 ,top=1475 ,right=1172 ,bottom=1525 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ø' ,left=1078 ,top=1419 ,right=1172 ,bottom=1469 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='¸é' ,left=1075 ,top=1225 ,right=1175 ,bottom=1256 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=122 ,top=1609 ,right=1953 ,bottom=1609 </L>
	<T>id='Á¦' ,left=178 ,top=1469 ,right=272 ,bottom=1537 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ø' ,left=178 ,top=1394 ,right=272 ,bottom=1462 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='º°' ,left=178 ,top=1319 ,right=272 ,bottom=1387 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Æ¯' ,left=178 ,top=1247 ,right=272 ,bottom=1316 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á¦' ,left=181 ,top=1112 ,right=272 ,bottom=1144 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ø' ,left=181 ,top=1081 ,right=272 ,bottom=1112 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='Ãß' ,left=181 ,top=1019 ,right=272 ,bottom=1050 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±âº»' ,left=194 ,top=912 ,right=259 ,bottom=950 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á¾' ,left=128 ,top=1037 ,right=169 ,bottom=1075 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1181 ,top=1116 ,right=1950 ,bottom=1116 </L>
	<C>id='Column', left=500, top=1044, right=656, bottom=1078 ,mask='(XX¸í)', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='Á¤' ,left=50 ,top=1044 ,right=97 ,bottom=1081 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ê' ,left=50 ,top=1156 ,right=97 ,bottom=1194 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¸í' ,left=50 ,top=1269 ,right=97 ,bottom=1306 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='Á¶' ,left=1075 ,top=781 ,right=1175 ,bottom=819 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Æ¯' ,left=1075 ,top=825 ,right=1175 ,bottom=862 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼Ò' ,left=1075 ,top=869 ,right=1175 ,bottom=906 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='µæ' ,left=1075 ,top=912 ,right=1175 ,bottom=950 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°ø' ,left=1075 ,top=956 ,right=1175 ,bottom=994 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á¦' ,left=1075 ,top=1000 ,right=1175 ,bottom=1037 ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='Column', left=500, top=1006, right=656, bottom=1041 ,mask='(XX¸í)', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='Column', left=500, top=969, right=656, bottom=1003 ,mask='(XX¸í)', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='¼Ò   µæ' ,left=28 ,top=741 ,right=278 ,bottom=775 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=281 ,top=741 ,right=1953 ,bottom=741 </L>
	<T>id='20)°è(17+18+19)' ,left=1594 ,top=706 ,right=1947 ,bottom=741 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='18)±âÅ¸ºñ°ú¼¼' ,left=669 ,top=706 ,right=1175 ,bottom=741 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='17) ¾ß°£±Ù·Î¼ö´ç' ,left=288 ,top=706 ,right=656 ,bottom=741 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ºñ°ú¼¼' ,left=28 ,top=706 ,right=278 ,bottom=741 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=1441 ,top=437 ,right=1441 ,bottom=703 </L>
	<L> left=922 ,top=437 ,right=922 ,bottom=703 </L>
	<T>id='15)ÁÖ½Ä¸Å¼ö¼±ÅÃ±ÇÀÇ Çà»ç·Î ¾òÀº ¼Òµæ' ,left=131 ,top=631 ,right=656 ,bottom=666 ,align='left' ,face='±¼¸²' ,size=7 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id
,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='46)½Å¿ëÄ«µåµî¼Òµæ°øÁ¦' ,left=1191 ,top=897 ,right=1581 ,bottom=925 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='49)Á¶Æ¯ ¼Òµæ °øÁ¦ °è' ,left=1191 ,top=1009 ,right=1581 ,bottom=1037 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='50)Á¾ÇÕ¼Òµæ°ú¼¼Ç¥ÁØ' ,left=1072 ,top=1047 ,right=1581 ,bottom=1075 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='51)»êÃâ¼¼¾×' ,left=1072 ,top=1084 ,right=1581 ,bottom=1112 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='52)¼Òµæ¼¼¹ý' ,left=1191 ,top=1122 ,right=1581 ,bottom=1150 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='53)Á¶¼¼Æ¯·ÊÁ¦ÇÑ¹ý' ,left=1191 ,top=1159 ,right=1581 ,bottom=1187 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='55)°¨¸é¼¼¾×°è' ,left=1191 ,top=1234 ,right=1581 ,bottom=1262 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='56)±Ù·Î¼Òµæ' ,left=1191 ,top=1272 ,right=1581 ,bottom=1300 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='57)³³¼¼Á¶ÇÕ°øÁ¦' ,left=1191 ,top=1309 ,right=1581 ,bottom=1337 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='63)¼¼¾×°øÁ¦°è' ,left=1191 ,top=1534 ,right=1581 ,bottom=1562 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='60)¿Ü±¹³³ºÎ' ,left=1191 ,top=1422 ,right=1581 ,bottom=1450 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='59)±âºÎ Á¤Ä¡ÀÚ±Ý' ,left=1191 ,top=1384 ,right=1581 ,bottom=1412 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='58)ÁÖÅÃÂ÷ÀÔ±Ý' ,left=1191 ,top=1347 ,right=1581 ,bottom=1375 ,align='left' ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°á Á¤ ¼¼ ¾×(51-55-63)' ,left=1075 ,top=1575 ,right=1581 ,bottom=1603 ,align='left' ,face='±¼¸²' ,size=9 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Çö´ë¾Æ»ê' ,left=519 ,top=212 ,right=769 ,bottom=241 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='º»»ç' ,left=522 ,top=291 ,right=772 ,bottom=319 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Çö´ë¾Æ»ê' ,left=1444 ,top=212 ,right=1694 ,bottom=241 ,align='left' ,face='±¼¸²' ,size=9 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<C>id='RESSUM', left=1622, top=1574, right=1934, bottom=1603, align='right', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='»ç¿ë¾×' ,left=1703 ,top=1650 ,right=1944 ,bottom=1681 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='68)Çö±Ý¿µ¼öÁõ' ,left=1703 ,top=1616 ,right=1944 ,bottom=1644 ,face='±¼¸²' ,size=8 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<!-----------------------------------------------------------------------------
			R E P O R T   D E F I N I T I O N   -   #### »ó¿© ¸í¼¼¼­ ±Þ ¿© ####
------------------------------------------------------------------------------>
...
<B>id=Header ,left=0,top=0 ,right=2871 ,bottom=175 ,face='Arial' ,size=10 ,penwidth=1
	<C>id='CTITLE', left=908, top=56, right=1976, bottom=143, face='HYÁß°íµñ', size=20, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0, border=true, penstyle=solid, penwidth=2, pencolor=#000000, Dec=0</C>
	<T>id='´ÜÀ§ : ¿ø' ,left=2572 ,top=122 ,right=2789 ,bottom=185 ,align='right' ,face='±¼¸²' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=246 ,face='Arial' ,size=10 ,penwidth=1
	<T>id='¼º¸í' ,left=45 ,top=74 ,right=278 ,bottom=127 ,face='±¼¸²' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id
,align='right' ,face='±¼¸²' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
</B>
<B>id=default ,left=0,top=0 ,right=2871 ,bottom=214 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id={decode(curlevel,1,'¸í')}, left=556, top=111, right=601, bottom=161, align='left', supplevel=1, face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Dec=0</C>
	...
	<C>id={decode(curlevel,1,'¼Ò °è',PAYGRDNM)}, left=45, top=106, right=278, bottom=156, supplevel=2, face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<C>id={decode(curlevel,1,'',PAYDTYM)}, left=328, top=8, right=675, bottom=50, align='left', supplevel=1 ,mask='XXXX³â XX¿ù »ó¿©', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true, Dec=0</C>
...
<B>id=Tail ,left=0,top=0 ,right=2871 ,bottom=236 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='¸í' ,left=579 ,top=132 ,right=632 ,bottom=180 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	...
	<T>id='ÇÕ °è' ,left=45 ,top=132 ,right=278 ,bottom=180 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÃÑ¿ø' ,left=341 ,top=132 ,right=482 ,bottom=180 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<B>id=Header ,left=0,top=0 ,right=2871 ,bottom=180 ,face='Arial' ,size=10 ,penwidth=1
	...
	<T>id='´ÜÀ§ : ¿ø' ,left=2574 ,top=122 ,right=2791 ,bottom=180 ,align='right' ,face='±¼¸²' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='CTITLE', left=908, top=56, right=1976, bottom=143, face='HYÁß°íµñ', size=20, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0, border=true, penstyle=solid, penwidth=2, pencolor=#000000, Dec=0</C>
</B>
<B>id=DHeader ,left=0,top=0 ,right=2871 ,bottom=249 ,face='Arial' ,size=10 ,penwidth=1
	<T>id='¼º¸í' ,left=45 ,top=74 ,right=278 ,bottom=127 ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ç¹ø' ,left=45 ,top=13 ,right=278 ,bottom=71 ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Áö±ÞÀ²' ,left=2580 ,top=191 ,right=2802 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=2818 ,top=3 ,right=2818 ,bottom=243 ,penstyle=solid ,penwidth=7 ,pencolor=#000000 </L>
	<T>id='Áö±Þ³â¿ù-±¸ºÐ' ,left=333 ,top=13 ,right=648 ,bottom=71 ,align='left' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±Þ¿©¿ÜÁö±Þ¾×' ,left=2260 ,top=74 ,right=2535 ,bottom=127 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¼Ò¼Ó' ,left=333 ,top=191 ,right=616 ,bottom=243 ,align='left' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°©±Ù¼¼' ,left=2283 ,top=132 ,right=2535 ,bottom=185 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Áö±ÞÀÏÀÚ' ,left=333 ,top=74 ,right=616 ,bottom=127 ,align='left' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±ÞÈ£' ,left=45 ,top=191 ,right=278 ,bottom=246 ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á÷À§' ,left=45 ,top=132 ,right=278 ,bottom=185 ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=32 ,top=249 ,right=2813 ,bottom=249 ,penstyle=solid ,penwidth=5 ,pencolor=#000000 </L>
	<T>id='Â÷·®À¯Áöºñ' ,left=1016 ,top=191 ,right=1228 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°¡Á·ºÎ¾çºñ' ,left=1016 ,top=132 ,right=1228 ,bottom=185 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÀÚ±â°è¹ßºñ' ,left=1016 ,top=74 ,right=1228 ,bottom=127 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Ãâ³³' ,left=1299 ,top=16 ,right=1513 ,bottom=74 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¿îÀü¼ö´ç' ,left=1299 ,top=77 ,right=1513 ,bottom=135 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='¿¬Àå¼ö´ç' ,left=1299 ,top=132 ,right=1513 ,bottom=191 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÀÚ°Ý¼ö´ç' ,left=1299 ,top=193 ,right=1513 ,bottom=249 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='³²ºÏ°æÇù¼ö´ç' ,left=1585 ,top=13 ,right=1839 ,bottom=71 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»çÀå´Ü¼ö´ç' ,left=1585 ,top=74 ,right=1839 ,bottom=127 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Æ¯¼öÁö¼ö´ç' ,left=1585 ,top=132 ,right=1839 ,bottom=185 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='°³ÀÎ¿¬±Ý' ,left=1942 ,top=13 ,right=2167 ,bottom=71 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÇÐÀÚ±Ý' ,left=1942 ,top=74 ,right=2167 ,bottom=127 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÀÓ¿øÁ÷Ã¥¼ö´ç' ,left=1905 ,top=132 ,right=2167 ,bottom=185 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Àü¿ù¼Ò±Þ' ,left=2307 ,top=13 ,right=2535 ,bottom=71 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Áö±Þ°è' ,left=2257 ,top=191 ,right=2535 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±âÅ¸Áö±Þ' ,left=1905 ,top=191 ,right=2167 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±Ù¼Ó¼ö´ç' ,left=1016 ,top=13 ,right=1228 ,bottom=71 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Áö¿ª±Ù¹«¼ö´ç' ,left=1585 ,top=191 ,right=1839 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='½Ã°£¿Ü' ,left=725 ,top=132 ,right=937 ,bottom=188 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='È£ºÀ°è' ,left=722 ,top=191 ,right=937 ,bottom=246 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á÷Ã¥¼ö´ç' ,left=725 ,top=74 ,right=937 ,bottom=127 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=2540 ,top=5 ,right=2540 ,bottom=249 ,penstyle=solid ,penwidth=3 ,pencolor=#000000 </L>
	<L> left=32 ,top=3 ,right=32 ,bottom=243 ,penstyle=solid ,penwidth=7 ,pencolor=#000000 </L>
	<T>id='±âº»±Þ' ,left=725 ,top=13 ,right=937 ,bottom=71 ,align='right' ,face='HYÁß°íµñ' ,size=11 ,bold=true ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
...
<B>id=default ,left=0,top=0 ,right=2871 ,bottom=225 ,face='Arial' ,size=10 ,penwidth=1
	...
	<X>left=2215 ,top=161 ,right=2535 ,bottom=214 ,backcolor=#C0C0C0 ,border=true ,penstyle=solid ,penwidth=1</X>
	<C>id='{decode(S91000,0,'',S91000)}', left=2225, top=161, right=2532, bottom=212, align='right', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#C0C0C0, Dec=0</C>
	<C>id='{decode(curlevel,1,'',PAYDTYM)}', left=328, top=5, right=675, bottom=50, align='left', supplevel=1 ,mask='XXXX³â XX¿ù »ó¿©', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF, Multiline=true, Dec=0</C>
	<C>id='{decode(curlevel,1,'',PAYDTYMD)}', left=328, top=58, right=656, bottom=106, align='left', supplevel=1 ,mask='XXXX-XX-XX', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
