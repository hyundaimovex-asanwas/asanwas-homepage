...
<!-------------------------------------------------------------------------------
+ 시 스 템 명	:	급여/퇴직금세액계산
+ 프로그램 ID	: p040008.HTML
+ 기 능 정 의	: 조회|계산
+ 변 경 이 력	: 
+ 수 정 이 력	: 이순미 - 2005.08.03 - 소스 정리
+ 서 블 릿 명	: p040008_s1, p040008_s2
------------------------------------------------------------------------------>
...
function ln_Create() {
	...
	if(str1.length < 6 )	{
		...
		gcds_select_create.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p040008_s1?"
										 + "v_str1=" + str1
										 + "&v_str2=" + str2
										 + "&v_str3=" + str3
										 + "&v_str4=SP_P300002";
...
function ln_Query(){
	...
	gcds_grid_ec01az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p040008_s2?"
												 + "v_str1=" + str1
												 + "&v_str2=" + str2;
												 //+ "&v_str3=" + str3;
...
<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td><img src="../img/p040008_head.gif"></td>
  ...
  <tr> 
	...
	<table  cellpadding="0" cellspacing="0" border="0" style='width:877px;height:20px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
		<tr> 
			...
			<img src="../img/calender.gif" value="calender.gif" id=img_calendar1 OnClick="__GetCallCalendar('gcem_ec02af', 'Text')" style="position:relative;width:20px;left:5px;cursor:hand;">&nbsp;</nobr></td> 
			<td width=400>&nbsp;</td>
	</tr>
</table>
