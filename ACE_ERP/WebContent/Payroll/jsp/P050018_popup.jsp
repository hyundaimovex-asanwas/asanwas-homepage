...
function ln_Query(){
	...
	gcds_data.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p050018_pop_s1?"
										 + "v_str1=" + txt_nm.value;
	gcds_data.Reset();
...
<script language=JavaScript for="gcgd_disp" event=onKeyPress(keycode)>
	if (keycode == 13) {
	ln_Close('A');
	}
</script>
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:360px;border:1 solid #708090">
	<tr>
		...
		<td>
		<img src="../../Common/img/btn/com_b_find.gif" alt="성명을 검색합니다" style="position:relative;left:2px;top:1px;cursor:hand;" onclick="ln_Query()"></td>
	</tr>
</table>
