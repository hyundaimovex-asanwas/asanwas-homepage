...
function fnOnLoad(tree_idx){
	...
	//직급코드
	gcds_select_ec03az.DataID = "<%=dirPath%><%=HDConstant.PATH_PERSON%>hclcode_s1?v_str1=2001"; 
...
function ln_Query(){
	...
	var str_Format=""
	 + "<FC> Name='호봉' ID=PAYSEQNM BgColor='#f5f5f5'  	HeadAlign=Center HeadBgColor=#B9D4DC Width=120 SumBgColor=#C3D0DB SumText='합계' align=LEFT  </FC> "
	...
	var str4 = gclx_select_ec03az.BindColVal;
	var str5 = kname.value;  //급여항목구분
	gcds_grid_ec01az.ClearData();

	gcds_grid_ec01az.DataID = "<%=dirPath%><%=HDConstant.PATH_PAYROLL%>p060004_s1?v_str1="+str1
													 +"&v_str2="+str2
													 +"&v_str3="+str3
													 +"&v_str4="+str4
													 +"&v_str5="+str5;
...
function ln_Excel(){
	...
	else gcgd_create.RunExcel('호봉표인원현황');
}
...
<comment id="__NSID__"><object id="tb_CDataSet" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" > 
	...
	<param name=GroupExpr	value="PAYSEQNM: MINORCD,PAYGRDNM,GUBUNSUM">
</object></comment><script>__ws__(__NSID__);</script>
...
<table width="877" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
  <tr> 
    <td  background="../../Common/img/com_t_bg.gif"><img src="../img/p060004_head.gif"></td>
  ...
  <tr> 
    ...
    <tr> 
      ...
      <td width="10" style="border:0 solid #708090;border-right-width:1px;"  bgcolor="#eeeeee"><nobr>&nbsp;직급&nbsp;</nobr></td>
			<td width="10" style="border:0 solid #708090;border-right-width:1px;"><nobr>
      ...
      <td width="10" style="border:0 solid #708090;border-right-width:1px;"  bgcolor="#eeeeee"><nobr>&nbsp;성명&nbsp;</nobr></td>
			<td><nobr>&nbsp;<INPUT TYPE=TEXT STYLE="width:80px;" class=txt21 id=kname name=kname>&nbsp;</nobr></td> 
          ...
          <td style="border-bottom-width:0px;" >
						<comment id="__NSID__"><OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_create  style="WIDTH: 874px; HEIGHT: 410px;border:1 solid #777777;display:block;" viewastext>
							...
							<PARAM NAME="Format"					VALUE="  
								<FC> Name='호봉' ID=PAYSEQNM  BgColor='#f5f5f5' HeadAlign=Center HeadBgColor=#B9D4DC Width=120 SumBgColor=#C3D0DB SumText='합계'
								    align=LEFT  </C> 
								<FC> Name='계' ID=CrossTabSum Value={CrossTabCount()} HeadAlign=Center HeadBgColor=#B9D4DC Width=90  SumBgColor=#C3D0DB align=RIGHT Edit=Numeric align=center </FC> 
       					">
            </OBJECT></comment><script>__ws__(__NSID__);</script>
