...
function ln_Before(){
	...
	gcds_dept99.DataID = "/servlet/Person.hcdept_s99?v_str1=";
	gcds_dept99.Reset();
	...
	//직위코드[검색조건]
	gcds_paygrd2.DataID = "/servlet/Person.hclcode_s1?v_str1=2002";
	gcds_paygrd2.Reset();
	...
	//장애코드
	gcds_hitchyn.DataID = "/servlet/Person.hclcode_s1?v_str1=1146";
	gcds_hitchyn.Reset();
...
function ln_Query(){
	...
	gcds_data00.DataID = "/servlet/Person.h030001_s1?"
...
function ln_FamQuery() {
	gcds_data02.DataID = "/servlet/Person.h030001_s2?"
...
function ln_CarQuery() {
	gcds_data03.DataID = "/servlet/Person.h030001_s3?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data03.Reset();
}
...
function ln_LicQuery() {
	...
	gcds_data04.DataID = "/servlet/Person.h030001_s4?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data04.Reset();
}
...
function ln_EduQuery() {
	...
	gcds_data05.DataID = "/servlet/Person.h030001_s5?v_str1="+gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data05.Reset();
...
function ln_AssQuery() {
	...
	if (gcds_assret.countrow<1) {
		...
		//장애구분
		//gcds_disdiv.DataID = "/servlet/Person.hclcode_s1?v_str1=1136";
		//gcds_disdiv.Reset();
	...
	gcds_data06.DataID = "/servlet/Person.h030001_s6?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno")
									 + "&v_str2=A";
	gcds_data06.Reset();
	...
	//병무사항
	gcds_data052.DataID = "/servlet/Person.h030001_s6?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno")
									 + "&v_str2=B";
	gcds_data052.Reset();
...
function ln_OrdQuery() {
	...
	gcds_data07.DataID = "/servlet/Person.h030001_s7?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data07.Reset();
}
...
function ln_DeuQuery() {
	...
	gcds_data09.DataID = "/servlet/Person.h030001_s8?"
										 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");

					//	 prompt('',gcds_data09.DataID);
	gcds_data09.Reset();
}
...
function ln_ReqQuery() {
	gcds_data10.DataID = "/servlet/Person.h030001_s9?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data10.Reset();
...
function ln_RewQuery() {
	...
	gcds_data11.DataID = "/servlet/Person.h030001_s11?"
									 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data11.Reset();
}
		...
		if(ln_Chk()){
			if (confirm("해당 입력정보를 저장하겠습니까 ?")) {
				if (e=="00") {
					...
					gctr_data.Action = "/servlet/Person.h030001_t"+parseInt(e);
					gctr_data.Parameters = "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
				}
			gctr_data.post();
			}
...
function ln_Print(){
	...
	if (gcds_data00.countrow<1) {
		...
		gcds_report1.DataID = "/servlet/Person.h030001_s5?v_str1=" + ls_msdata;
		gcds_report1.Reset();

		gcds_report2.DataID = "/servlet/Person.h030001_s3?v_str1=" + ls_msdata;
		gcds_report2.Reset();

		gcds_report3.DataID = "/servlet/Person.h030001_s2?v_str1=" + ls_msdata;
		gcds_report3.Reset();

		gcds_report4.DataID = "/servlet/Person.h030001_s4?v_str1=" + ls_msdata;
		gcds_report4.Reset();

		gcds_report5.DataID = "/servlet/Person.h030001_s7?v_str1=" + ls_msdata;
		gcds_report5.Reset();

		gcds_report6.DataID = "/servlet/Person.h030001_s8?v_str1=" + ls_msdata;
		gcds_report6.Reset();

		gcds_report7.DataID = "/servlet/Person.h030001_s9?v_str1=" + ls_msdata;
		gcds_report7.Reset();

		gcds_report8.DataID = "/servlet/Person.h030001_s0?v_str1=" + ls_msdata;
		gcds_report8.Reset();

		gcds_report9.DataID = "/servlet/Person.h030001_s11?v_str1=" + ls_msdata;
		gcds_report9.Reset();
...
function ln_RptFor(e){
	...
	ls_for += "	<I>id='"+rDOMAIN+"/servlet/Person.h030001_s0?v_str1="+e+"' ,left=1 ,top=208 ,right=275 ,bottom=526</I>																																																	";
...
<OBJECT id=gcds_dept classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	...
	<OBJECT id=gcds_dept99 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	<PARAM NAME="SyncLoad" VALUE="false">
	<PARAM NAME="SortExpr" VALUE="+treecd">
</OBJECT>
...
<script language="javascript" for="gcds_data00" event="onloadCompleted(row,colid)">
	...
	if (gcds_data00.countrow>0){
		if (gcds_data00.namevalue(1,"picture")=="") {
			...
			photo.src="/servlet/Person.h030001_s0?v_str1="+str1;
		}
	} else {
...
<script language="javascript" for="gcds_srh2" event="onloadCompleted(row,colid)">
	...
	if(gjobdty=="03"||gjobdty=="04"||gjobdty=="05"||gjobdty=="06"||gjobdty=="17"||gjobdty=="21"||gjobdty=="34"){
		ln_Jobdty();			
	}
</script>
		...
		<td width=80%  height="0" valign="top">
			<table border="0" cellpadding=0 cellspacing=0 style="position:relative;left:4px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
                ...
                <td class="tab21">
									...
									<input type="text" id=txt_payseq class="txt11" style="position:relative;left:12px;top:-3px;width:30px;" maxlength="4" onBlur="bytelength(this,this.value,4);">
                      ...
                      <td class="tab21" width="120px">
												<comment id="__NSID__"><OBJECT id=gclx_empdiv classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 
													style="position:relative;left:8px;top:1px;font-size:12px;width:100px;">
														...
														<param name=CBData					value=" ^ ,1^정규직,2^별정직,0^운전직,8^PJT">
														<param name=CBDataColumns		value="MINORCD, MINORNM">
														<param name=SearchColumn		value=MINORNM>
														<param name=Sort						value=false>
														<param name=ListExprFormat	value="MINORNM^0^100">
...
<!--						<td class="tab22">&nbsp;&nbsp;(사내)</td> -->
						...
						<td class="tab21" width="98px"><input type="text" id=txt_hpno class="txt11" style="width:85px;" maxlength="15" onBlur="bytelength(this,this.value,15);"></td>
		  		  <td class="tab11" width="75px" bgcolor="#eeeeee">eMail</td>
					  <td class="tab22" width="170px"><input type="text" id=txt_email class="txt11" style="width:140px;" maxlength="30" onBlur="bytelength(this,this.value,30);"></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" style="border:0 solid #708090;border-top-width:1px">
					<tr>
						...
						<td class="tab21" width="230px;">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="110px;" height="25px">&nbsp;
										<comment id="__NSID__"><OBJECT id=gcem_afrdt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
											style="position:relative;left:-4px;top:2px; width:70px; height:20px; font-family:굴림; font-size:9pt;z-index:2; " class=objclsEme1>
												<param name=Alignment			value=0>
												<param name=Border	      value=true>
												<param name=Format	      value="YYYY/MM/DD">
												<param name=PromptChar	  value="_">
  ...
  <table style="position:relative;top:5px;border:1 solid #708090;border-bottom-width:0px;" cellpadding=0 cellspacing=0 border=0 >
		...
		<tr>
		  <td style="border:0 solid #708090;border-top-width:1px" colspan="3">
            ...
            <td class="tab22" width="420px" colspan="3">
		...
		<tr>
		  <td style="width:697;border:0 solid #708090;border-top-width:1px" colspan="2">
            ...
            <param name=dataid					value=gcds_data07>
						...
						<param name=format          value='
							<F> Name=NO ID={CurRow} HeadAlign=Center   HeadBgColor=#B9D4DC   Width=30,  align=right </F> 
							<F> Name=발령일자 ID=ORDDT	HeadAlign=Center HeadBgColor=#B9D4DC Width=80,	align=center, MASK="XXXX/XX/XX"</F> 
						 	<C> Name=발령구분 ID=ORDCD	HeadAlign=Center HeadBgColor=#B9D4DC Width=110, EditStyle=Lookup, Data="gcds_ordcd:ordcd:ordnm" </C> 
							<C> Name=소속			ID=DEPTNM HeadAlign=Center HeadBgColor=#B9D4DC Width=150, </C> 
							<C> Name=직위			ID=PAYGRD HeadAlign=Center HeadBgColor=#B9D4DC Width=80, EditStyle=Lookup, Data="gcds_deptlvl:minorcd:minornm"</C>
							<C> Name=호봉			ID=PAYSEQ HeadAlign=Center HeadBgColor=#B9D4DC Width=80, EditStyle=Lookup, Data="gcds_payseq:minorcd:minornm" </C>
							<C> Name=비고			ID=ETC    HeadAlign=Center HeadBgColor=#B9D4DC Width=150, </C> 
						'>
				</OBJECT></comment><script>__ws__(__NSID__);</script>
<!--
...
<!---------[TAB 8] 어학+전산----------->
<div id="layer8" style="position:absolute; top:330px; left:350px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td width="100px;">&nbsp;</td>
			<td height="25px" align="right" valign="bottom">
...
<div id="layer9" style="position:absolute; top:330px; left:350px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
 ...
 <!-- 1/20일 고과 안보이게 막음,   <C> Name='판정' ID=GRADE3  	HeadAlign=Center HeadBgColor=#B9D4DC Width=65, align=center,</C>									
									<C> Name='1차' ID=AVG1  	HeadAlign=Center HeadBgColor=#B9D4DC Width=65, align=center, </C> 
									<C> Name='2차' ID=AVG2  	HeadAlign=Center HeadBgColor=#B9D4DC Width=65, align=center, </C> 
									<C> Name='3차' ID=AVG3  	HeadAlign=Center HeadBgColor=#B9D4DC Width=65, align=center, </C>   ID=GOGAGB -->


				</OBJECT></comment><script>__ws__(__NSID__);</script>

				<!-- <C> Name=소속			ID=DEPTCD HeadAlign=Center HeadBgColor=#B9D4DC Width=250, EditStyle=lookup, Data='gcds_dept99:deptcd:deptnm' </C>  -->
				<!--
...
<A>id=Area5 ,left=0,top=0 ,right=2000 ,bottom=70 ,face=굴림체,  size=10 ,penwidth=1 ,PageSkip=false
	<R>id='hdcareer.sbt' ,left=0 ,top=0 ,right=2000 ,bottom=65 ,DetailDataID=gcds_report5
		<B>id=DHeader ,left=0,top=0 ,right=2000 ,bottom=150 ,face='굴림' ,size=10 ,penwidth=1
			...
			<T>id='직  위' ,left=1148 ,top=95 ,right=1397 ,bottom=151 ,face='굴림' ,size=10 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#B1B1B1</T>
		...
		<B>id=default ,left=0,top=0 ,right=2000 ,bottom=53 ,face='굴림' ,size=10 ,penwidth=1
			...
			<C>id='PAYGNM', left=1148, top=0, right=1397, bottom=53, align='left'</C>
			<L> left=1394 ,top=0 ,right=1394 ,bottom=53 </L>
			<C>id='PAYSNM', left=1402, top=0, right=1527, bottom=53</C>
