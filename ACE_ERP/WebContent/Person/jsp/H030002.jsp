...
function ln_Query(){
	...
	ls_data += "/servlet/Person.h030002_s1?";
...
function ln_PrintQuery(){
	...
	gcds_temp.DataID = "/servlet/Person.h030002_s2";
	gcds_temp.Reset();
...
function ln_Print(){
	...
	if (chk_p05.checked && gcds_data1.countrow>0) {	//본부 소속별 현황
		gcds_temp.ClearAll();
		ls_data += "/servlet/Person.h030002_s2?";
...
function ln_BasPrint(){
	...
	if (chk_p04.checked && gcds_data1.countrow>0) {	//인사기본정보
		gcds_temp2.ClearAll();
		//gcds_temp.DataID = "/servlet/Person.h030002_s3";
		ls_data += "/servlet/Person.02_s3?";
...
function ln_Before(){
	...
	//자격증
	gcds_license.DataID = "/servlet/Person.hclcode_s1?v_str1=1127";
	gcds_license.Reset();
