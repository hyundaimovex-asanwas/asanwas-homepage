...
function ln_Query(){
	...
	gcds_data00.DataID = "/servlet/Person.h030006_s1?"
...
function ln_EduQuery() {
	...
	gcds_data05.DataID = "/servlet/Person.h030001_s5?"
								  	 + "v_str1=" + gcds_data00.namevalue(gcds_data00.rowposition,"empno");
	gcds_data05.Reset();
...
function ln_AssQuery() {
	...
	if (gcds_assret.countrow<1) {
		...
		//장애등급
		gcds_disgrd.DataID = "/servlet/Person.hclcode_s1?v_str1=1136";
		gcds_disgrd.Reset();
...
function ln_DeuQuery() {
	...
	gcds_data09.DataID = "/servlet/Person.h030001_s8?"
									...
									//	 	prompt(this,gcds_data09.DataID); 
	gcds_data09.Reset();
}
...
function ln_PrintQuery(){
	...
	gcds_temp.DataID = "/servlet/Payroll.p020005_s1?"
									 + "v_str1=" + str1
									 + "&v_str2=" + str2
									 + "&v_str3=" + str3
									 + "&v_str4=" + str4
	...
	if (!gcds_data00.IsUpdated ){
		alert("저장하실 정보가 없습니다.");
			...
			if (confirm("해당 입력정보를 저장하겠습니까 ?")) {
					gctr_data.KeyValue = "Person.h030006_t1(I:USER=gcds_data00)";
					gctr_data.Action = "/servlet/Person.h030006_t1";
					gctr_data.post();
			}
	}
}
...
//대출상환 END--------------------------------------------------------------------------------------------
    var str6= '1';///fn_trim(gclx_select_ec01az.BindColVal);// 상여구분
	   ...
	   {gcds_report0.namevalue(1,"SANGNAME") ="상   여   율 :";
		...
		gcds_report1.DataID = "/servlet/Payroll.p050005_s1?" 
...
/********************
    ...
    alert("row::"+row);
		alert("row2::"+row2);
		alert("level2nm::"+level2nm);
		alert("dlevel::"+dlevel);


		alert("DEPTCD::"+gcds_data00.namevalue(row,"DEPTCD"));

		alert("LEVEL::"+gcds_data00.namevalue(row,"DEPTCD"));
...
<script language="javascript" for="gcgd_disp" event="onclick(row,colid)">
		...
		if (gcds_data00.namevalue(row,"picture")=="") {
			...
			photo.src="http://www.singiro.co.kr/servlet/Person.h030001_s0?v_str1="+str1;
		}
</script>
...
<iframe id="LowerFrame" name="work" style="visibility:hidden;position:absolute; left:280px; top:240px;" FrameBorder="0" src="../../Common/img/flash/loading.swf" width="320px" height="42px"></iframe> 
	...
	<tr height="30px">
		<td colspan="2">
			...
			<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px;">
			  <tr> 
					<td width="215" background="../../Common/img/com_t_bg.gif"><IMG height=47 src="../img/h030006_head.gif" width=197></td>
...
<div id="layer1" style="position:absolute; top:330px; left:175px;">
				...
				<table cellpadding=0 cellspacing=0 border=0>
					<tr>
					  ...
					  <td class="tab22" width="240px">
							<input type="text" id=txt_email class="txt11" style="position:relative;top:2px;width:200px;border:2;background-color:#ffffcc"  maxlength="30" onBlur="bytelength(this,this.value,30);" ></td>
					</tr>
				</table>
			</td>
		</tr>
...
<!---------[TAB 2] 가족사항 그리드----------->
<div id="layer2" style="position:absolute; top:330px; left:175px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
...
<!---------[TAB 3] 경력사항 그리드----------->
<div id="layer3" style="position:absolute; top:330px; left:175px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
		  <td style="width:875;" colspan="2">
...
<!---------[TAB 4] 자격면허사항 그리드----------->
<div id="layer4" style="position:absolute; top:330px; left:175px; visibility:hidden; border:1 solid #708090">
  <table cellpadding=0 cellspacing=0 border=0 >
		<tr>
		  <td style="width:875;" colspan="2">
  ...
  <!---------[TAB 5] 학력사항 그리드----------->
<div id="layer5" style="position:absolute; top:330px; left:175px; visibility:hidden; ">
...
<!---------[TAB 6] 신원보증/신체사항 ----------->
<div id="layer6" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
...
<!---------[TAB 7] 인사발령+상벌 그리드----------->
<div id="layer7" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
		  <td style="width:875;">
...
<!---------[TAB 8] 어학+전산----------->
<div id="layer8" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
			<td colspan="3">
...
<!---------[TAB 9] 사내시험+인사고과----------->
<div id="layer9" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
...
<!---------[TAB 10] 교육사항----------->
<div id="layer10" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
		  <td style="width:875;">
...
<!---------[TAB 11] 상벌관리 ----------->
<div id="layer11" style="position:absolute; top:330px; left:175px; visibility:hidden; border:0 solid #708090;border-top-width:1px;">
  <table cellpadding=0 cellspacing=0 border=0 style="border:0 solid #708090;border-left-width:1px;border-right-width:1px">
		<tr>
		  <td style="width:875;" colspan="2">
