...
function ln_Query(arg){
	...
	if (arg=="gcds_data1") {  //월별특근현황
		...
		ln_ForSel(pam);
		obj.DataID = "/servlet/Person.h050004_s1?v_str1=" + gcem_date1.text + "&v_str2=";
		//prompt("월별특근현황",obj.DataID);
	}  else if (arg=="gcds_data2") {               //소속별특근현황
		txt_bigo.value = "";
		pam = gcem_date2.text.substring(0,6);
		obj.DataID = "/servlet/Person.h050004_s4?v_str1=" + pam + "&v_str2=" + ln_Getbyymm(pam);
	}  else if (arg=="gcds_data3") {
		obj.DataID = "/servlet/Person.h050004_s6?v_str1=" + gcem_date3.text 
																									+ "&v_str2=" + gclx_dept.bindcolval
																									+ "&v_str3=" + gs_level
																									+ "&v_str4=" + gs_treecd;
	}  else if (arg=="gcds_data4") {
		obj.DataID = "/servlet/Person.h050004_s5?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text + "&v_str3=" + fn_trim(gclx_gbn.bindcolval);
	} else if (arg=="gcds_data5") {
		obj.DataID = "/servlet/Person.h050004_s7?v_str1=" + gcem_date5.text + "&v_str2=" +	fn_trim(gclx_gbn5.bindcolval);
	} else if (arg=="gcds_data6") {
		obj.DataID = "/servlet/Person.h050004_s8?v_str1=" + gcem_date6.text + "&v_str2=" +	fn_trim(gclx_gbn6.bindcolval);
	} else if (arg=="gcds_data7") {
		obj.DataID = "/servlet/Person.h050004_s77?v_str1=" + gcem_date7_fr.text + "&v_str2=" +gcem_date7_to.text	
  }
	obj.Reset();
}
...
function ln_Before(arg) {
	gcds_holfee.DataID = "/servlet/Person.h050004_s3";
	gcds_holfee.Reset();
	...
	// 근태구분
	gcds_feegbn.DataID = "/servlet/Person.h050004_s3";
	gcds_feegbn.Reset();

	// 근태구분2
	gcds_duty.DataID = "/servlet/Person.hclcode_s1?v_str1=1124&v_str2=C";
	gcds_duty.Reset();
}
...
function ln_PrintSet7(){
	if(gclx_gubun7.bindcolval=="A"){ //평일
		gcds_print7.DataID = "/servlet/Person.h050004_s88?v_str1=" + gcem_date7_fr.text + "&v_str2=" +gcem_date7_to.text;	
		//prompt(this,gcds_print7.DataID);
    gcds_print7.Reset();
	}else if(gclx_gubun7.bindcolval=="B"){ //주말
		gcds_print7.DataID = "/servlet/Person.h050004_s89?v_str1=" + gcem_date7_fr.text + "&v_str2=" +gcem_date7_to.text;	
		//prompt(this,gcds_print7.DataID);
    gcds_print7.Reset();
	}
}
...
<script language="javascript" for="gcds_crossTab" event="onloadCompleted(row,colid)">
  ...
  //비고가져오기
	gcds_etc.DataID = "/servlet/Person.h050004_s78?v_str1="+gcem_date7_to.text	;
	gcds_etc.Reset();	
	for(i=1;i<=row;i++){
