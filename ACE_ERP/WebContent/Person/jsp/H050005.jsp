...
function ln_Before(){
  ...
  */
  	...
  	//소속코드[조회조건]
	if(g_managegb=="Y"){
		gcds_deptcd_0.DataID = "/servlet/Person.hcdept_s4?v_str1="+gdeptcd;
		gcds_deptcd_0.Reset();
  }else{
		gcds_deptcd_0.DataID = "/servlet/Person.hcdept_s1?v_str1=";
		gcds_deptcd_0.Reset();
  ...
  //직위코드[검색조건]
	...
	//년차수
	gcds_year.DataID = "/servlet/Person.h050005_s3?v_str1="+gusrid+"&v_str2="+gcurdate.substring(0,4)+gcurdate.substring(5,7);
