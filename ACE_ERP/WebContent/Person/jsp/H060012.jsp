...
******************************************************************************/
function ln_Query(){
	gcds_data.DataID="/servlet/Person.h060012_s1?v_str1="+fn_trim(gcem_yymm.text)
...
function ln_Save(){
	...
	if (gcds_data.countrow<1){
		...
		if (confirm("선택한 정보를 저장하시겠습니까?")){
			gctr_data.action = "/servlet/Person.h060012_t1";
			gctr_data.post();
			ln_Query()
		}
	}
...
<table width="877" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px"  >
  <tr> 
    <td  background="../../Common/img/com_t_bg.gif"><img src="../img/h060012_head.gif"></td>
  ...
  <tr>
    <td COLSPAN=2 valign="top">
	   ...
	   style='width:877px;height:30px;font-size:9pt;background-color:#ffffff;BORDER-LEFT-WIDTH:1px;border:1 solid #708090'>
        <tr> 
						<td width="10px"   style="border:0 solid #708090;border-right-width:1px;" bgcolor="#eeeeee"><nobr>&nbsp;고과년월&nbsp;&nbsp;</nobr></td>
						...
						<td width="10" style="border:0 solid #708090;border-right-width:1px;"><nobr>&nbsp;
							...
							&nbsp;&nbsp;</nobr></td>  
						<td width="10"   style="border:0 solid #708090;border-right-width:1px;"      
							bgcolor="#eeeeee"><nobr>&nbsp;&nbsp;&nbsp;&nbsp;직위&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></td>
						<td width="10" style="border:0 solid #708090;border-right-width:1px;"><nobr>&nbsp;
							...
							&nbsp;&nbsp;</nobr></td>  
						<td width="10px"   style="border:0 solid #708090;border-right-width:1px;"      
							bgcolor="#eeeeee"><nobr>&nbsp;성명&nbsp;&nbsp;&nbsp;&nbsp;</nobr></td> 
						<td width="10" Style="border:0 solid #708090;border-bottom-width:0px"><nobr>&nbsp;   
							<input id="txt_name" name="txt_name" type="text" class="txt11" style="width:120px;position:relative; left:-5px"   onkeydown="if(event.keyCode==13) ln_Query();">&nbsp;</nobr></td>	
