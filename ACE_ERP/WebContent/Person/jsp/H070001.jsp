...
function ln_Query(){
  ...
  var v_str1=gcem_fr.text;
	...
	gcds_data.DataID = "/servlet/Person.h070001_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text+"&v_str3="+fn_trim(gusrid)+"&v_str4=1";
	gcds_data.Reset();
...
*/
	...
	if (gcds_data.IsUpdated) {	
		...
		gctr_pyo.Action = "/servlet/Person.h070001_t1?v_str2=" + gcem_to.text+ "&v_str4=" + txt_EMPNO.value;
...
function ln_Delete(){
	...
	if (confirm("선택한 정보를 삭제하시겠습니까?")){
		...
		gctr_pyo.action = "/servlet/Person.h070001_t1?v_str4=" + txt_EMPNO.value;
		gctr_pyo.post();
//	return ln_Query();
	}
}
