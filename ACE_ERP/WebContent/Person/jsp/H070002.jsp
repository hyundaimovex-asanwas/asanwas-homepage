...
//	var v_str2=gcem_to.text;
 ...
 gcds_data.DataID = "/servlet/Person.h010026_s1?v_str1=" + gcem_fr.text + "&v_str2=" + gcem_to.text + "&v_str3=" + txt_EMPNO.value + "&v_str5=" + v_str5;

//	gcds_data.DataID = "/servlet/Person.h010026_s1?v_str5=" + v_str5;
	gcds_data.Reset();
...
function ln_Save(){
  var v_str1=txt_EMPNO.value;
	...
	if(fn_CheckSaveCondt()){
		if(confirm("결재하시겠습니까?")){
		gctr_pyo.Action ="/servlet/Person.h010026_t1?v_str1=" + v_str1 + "&v_str2=" + v_str2+ "&v_str3=" + v_str3;
