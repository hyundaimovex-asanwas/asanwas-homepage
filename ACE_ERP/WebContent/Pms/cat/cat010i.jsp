...
<%
/******************************************************************************
 * 시스템명		: 입찰 공고 / 투찰업체 목록  업로드
 * 프로그램ID 	: cat010I computer added tender
  * J  S  P		: Pms/cat/cat010i.jsp
 * 서 블 릿		: Cat010I
 * 작 성 자		: 심동현
 * 작 성 일		: 2017-06-27 
 * [수  정   일  자][수정자] 내용
 * [2017-06-27][심동현] 액셀 파일 1개에 마스터, 디테일 자료가 함게 들어가 있슴
 *						그래서 여기에서 추가로 마스터 정보를 수정하기 불편해 파일을 나눔
 *						이건 업로드/저장 전용 화면
 * [2017-07-06][심동현] 이상한 오류다 흠..
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td align=left>
				<table  border="0" cellpadding="0" cellspacing="0" width="845px">
					<tr>
						<td align="right" >
							<img src="<%=dirPath%>/Sales/images/reset.gif"  style="cursor:pointer" align=absmiddle onclick="fnReset()">
		...
		<tr>
			<td>
				...
				<table  border="0" cellpadding="0" cellspacing="0" >
					<tr>
						<td align="left" width="80px" >▶ 엑셀파일 : </td>       
						<td bgcolor=#ffffff align=left>&nbsp;<input type="text" name="file_path" value="" style="width:610px;" class="input01"></td>
						<td style="background:#fff; text-align: left;">&nbsp;<OBJECT id=gcip_file classid=<%=HDConstant.CT_INPUT_FILE_CLSID%> style="width:70; height:20;"  >
									<param name="Text"		value="찾아보기">
								</OBJECT></td>
						<td style="width: 80px; background:#fff; text-align: left;">&nbsp;<img src="<%=dirPath%>/Sales/images/excel_apply.gif" style="cursor:pointer"  border='0' onClick='javascript:fnExcelApply();'></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>※ 업로드 파일은 .xls 확장자이고, 첫째 시트의 이름이 "<b>All_company_list</b>" 이어야 합니다.<br />
				처음 업로드할 때 추가 입력정보를 수정해야 하고, 그 이후 수정은 [공고/투찰 조회] 메뉴를 활용해 주세요.
