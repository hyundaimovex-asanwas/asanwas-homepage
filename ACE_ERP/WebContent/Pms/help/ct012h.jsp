...
<%
/******************************************************************************
 * 시스템명 	 : 현장명 및 계약내용 조회 헬프
 * 프로그램ID 	 : PMS/Help/ct012h.jsp
 * J  S  P		 : ct012h.jsp
 * 서 블 릿		 : help/Ct012H
 * 작 성 자		 : 심동현
 * 작 성 일		 : 2011-07-01
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='710px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='계약일자'	ID='DATE_CT'		Width=70	ALIGN=CENTER</c>
                            <c> Name='현장명'   ID='SITE_NM'		Width=100	ALIGN=LEFT</c>
                            <c> Name='발주처'   ID='ORDERER_NM'		Width=70	ALIGN=LEFT</c>
                            <c> Name='계약\\차수'	ID='SITE_SEQ_CT_CD'	Width=40	ALIGN=CENTER</c>
                            <c> Name='변경\\차수'	ID='SITE_SEQ_CH_CD'	Width=40	ALIGN=CENTER</c>
                            <c> Name='계약금액'	ID='AMT_CT_TOT'		Width=80	ALIGN=RIGHT	decao=0</c>
                            <c> Name='공급가'	ID='AMT_CT'			Width=80	ALIGN=RIGHT	decao=0</c>
                            <c> Name='부가세'	ID='AMT_CT_VAT'		Width=70	ALIGN=RIGHT	decao=0</c>
						<G> Name='계약기간'
                            <c> Name='시작일'	ID='DATE_BEGIN'     Width=70	ALIGN=CENTER</c>
                            <c> Name='종료일'	ID='DATE_END'		Width=70	ALIGN=CENTER</c>
						</G>
