	  ...
	  function fnOnLoad(){
		...
		function fnSelect() {
			...
			//기본사항 조회 
		     ...
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H", "JSP(O:DS_DEFAULT1=ds_default1)",  param);
		    ...
		    ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H", "JSP(O:DS_DEFAULT2=ds_default2)",  param);
		    ...
		    tr_post(tr1);
		     ...
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H", "JSP(O:DS_DEFAULT3=ds_default3)",  param);
		     ...
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H", "JSP(O:DS_DEFAULT4=ds_default4)",  param);
		...
		function fnApply_1(){
			...
			if (confirm("승인하시겠습니까?")) {
			    ...
			    ln_TRSetting(tr2,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H","JSP(O:msgDS=msgDS)", param);
		...
		function fnApply_2(){
			...
			if (confirm("반송하시겠습니까?")) {
				...
				ln_TRSetting(tr3,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr710H","JSP(O:msgDS=msgDS)", param);
