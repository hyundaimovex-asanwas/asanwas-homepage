	    ...
	    */
		...
		function fnSelect() {
			...
			//기본사항 조회 
		     ...
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr750H", "JSP(O:DS_DEFAULT1=ds_default1)",  param);
			...
			ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr750H", "JSP(O:DS_DEFAULT2=ds_default2)",  param);
			...
			tr_post(tr1);		     
			 ...
			 ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pr750H", "JSP(O:DS_DEFAULT3=ds_default3)",  param);
	...
	<td height=25 width=950 colspan =2>
		...
		<object id=gr_RcpDpt classid=<%=HDConstant.CT_GRID_CLSID%> width='950px' height='300px' border='1'>
			...
			<param name="Format" 				value="
	             ...
	             <C> name='작업일자' 					ID='DT_WORK'	   			width=80 		align=CENTER	edit=none SumBgColor=#C3D0DB </C>
	             <C> name='장비명' 						ID='MD_EQUIP'    			width=100 		align=left		edit=none SumBgColor=#C3D0DB </C>
	             ...
	             <C> name='작업내용'					ID='DS_WORK'  			width=100 		align=left		edit=none SumBgColor=#C3D0DB </C>           
	             <C> name='공종명'						ID='DS_ITEM'  				width=100 		align=CENTER	edit=none SumBgColor=#C3D0DB </C>        
	             <C> name='업체명'						ID='DS_VENDOR'  			width=100 		align=left		edit=none SumBgColor=#C3D0DB </C>   	 	                 
           ">
		</object>   
		<%=HDConstant.COMMENT_END%>		
	</td>
