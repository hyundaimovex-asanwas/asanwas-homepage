	    ...
	    */
		...
		function fnSelect() {
			...
			//기본사항 조회 
	         var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
		                       ...
		                       + ",v_date_cgcd="+g_WinParam[7]; 
		                       //alert(param);
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(O:DS_DEFAULT6=ds_default6)",  param);
		    // prompt('',ds_default.dataid);   
		     tr_post(tr1);
		     
		  // 업체별견적내역
	         var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
		                      + ",v_est_sid="+g_WinParam[6]
		                       + ",v_rqst_sid="+g_WinParam[5];
		                     // alert(param);
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(O:DS_DEFAULT7=ds_default7 )",  param);
		    // prompt('',ds_default.dataid);   
		     tr_post(tr1);
	         ...
	         var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
		                       ...
		                       + ",v_date_cgcd="+g_WinParam[7] ;
		                    // alert(param);
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(O:DS_DEFAULT8=ds_default8 )",  param);
		    // prompt('',ds_default.dataid);   
		     tr_post(tr1);
		     ...
		     if(strAppline_gb=="1"){
				...
				if(0[4]==""||0[4]=="undefined"||array2[4]=="undefined"||array2[4]==""){ //결재선을 안만든 경우 
					 ...
					 var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=5"
				                     ...
				                     + ",v_empno3="+array4[3]
				                     + ",v_empno4="+array5[3];
				     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(O:DS_DEFAULT5=ds_default2)",  param);
				     tr_post(tr1);
				    ...
				    var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=2"
				                     + ",v_sid="+array2[4];
				 	//alert(param);
				     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(O:DS_DEFAULT2=ds_default2)",  param);
				     tr_post(tr1);
				}
		...
		function fnApply_1() {
		   ...
		   //prompt('',ds_approve.text);
		    ...
		    ln_TRSetting(tr3,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_02", "JSP(I:DS_APPROVE=ds_approve,O:msgDS=msgDS)", "proType=A, dsType=1");
	        tr_post(tr3);
		}
		...
		//alert(row);
			 var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                  ...
                  //  + ",v_vend_cd="+getObjectFirst("ds_tender").NameValue(row, "VEND_CD");
		                  ...
		                  //     alert(param);
		     ln_TRSetting(tr1,"<%=dirPath%><%=HDConstant.PATH_HELP%>Pu040H_03", "JSP(O:DS_DEFAULT8=ds_default8 )",  param);
		    // prompt('',ds_default.dataid);   
		     tr_post(tr1);
		}
...
<object  id=ds_default99 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	<PARAM NAME="SyncLoad" VALUE="false">
</object>
	...
	<td height=25 width=950 colspan =2>
		...
		<object id=gr_apline classid=<%=HDConstant.CT_GRID_CLSID%> width='950px' height='100px' border='1'>
			...
			<param name="Format" 			value="
              ...
              <C> name='의견'	    ID=AP_DESC     		           width=200	align=center editlimit=200 show=true edit=true</C>
