...
//			alert("svend_cd::"+svend_cd);
			...
			function fnSelect() {
			    ...
			    v_job="S";
				ds_detail.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Pu060H_01?proType=S&dsType=1&sest_sid=" + sest_sid+"&svend_cd="+svend_cd;
			...
			function fnSettle() {
				...
				if(v_job!="calc"){
					for( i=1; i<=ds_detail.CountRow; i++ ) {
						...
						getObjectFirst("ds_detail").NameValue(i, "SUM_AMT")=getObjectFirst("ds_detail").NameValue(i, "EST_AMT") * getObjectFirst("ds_detail").NameValue(i, "EST_ITEM_CNT");
				    }
			...
			function fnApply(){
			   ...
			   if (ds_detail.isUpdated ){ 
			        ...
			        var v_param = "proType=<%=HDConstant.PROCESS_TYPE_APPLY%>,dsType=1"
			         ...
			         ln_TRSetting(tr1, 
			             "<%=dirPath%><%=HDConstant.PATH_HELP%>Pu060H_01",
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:350px;">
						<tr>
							<td  height=25>
								<img src="<%=dirPath%>/Sales/images/p_icon.gif" align=left><font style="position:relative;top:0px;width:540;height:0;left:10px;"><%=title%></font>
							</td>
						</tr>
					</table>
				</td>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:4px;top:7px;width:300px">
						<tr>
							<td align=right>
								<img src="<%=dirPath%>/Sales/images/settle.gif" 	style="cursor:pointer" align=absmiddle position:relative;left:3px;top:3px; onClick="fnSettle();">
							    <img src="<%=dirPath%>/Sales/images/save.gif"	 id=app style="cursor:pointer;position:relative;left:3px;top:3px;"  onClick="fnApply()">
...
%>
					<comment id="__NSID__"><object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%>  style="width=950px; height:400px;border:1 solid #777777;">
						...
						<param name="Format" 		  value="
							...
							<c> Name='품목'			ID='ITEM_NM'		     Width=220  align=center   edit = none  SumText='합계'    </c>
							<c> Name='규격' 		ID='ITEM_SIZE'	  	 Width=220  align=center   edit = none  </c>
							<c> Name='단위 ' 		ID='ITEM_UNIT'	  	 Width=60  align=center   edit = none  </c>
							<c> Name='수량' 		ID='EST_ITEM_CNT'	 Width=100  align=center   edit = none 	dec=0	 </c>
							<c> Name='단가V' 		ID='EST_AMT'	  	 	 Width=150  align=right      edit = true		SumText=@sum	dec=0	bgColor=<%=HDConstant.GRID_ITEM%></c>
							<c> Name='금액' 		ID='SUM_AMT'	  	 	 Width=150  align=right      edit = none	SumText=@sum	dec=0	</c>
						">
