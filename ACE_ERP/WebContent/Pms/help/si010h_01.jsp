...
%>
        <script language="javascript">
            ...
            function fnSelect() {
                ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Si010H_01?proType=S&dsType=1&v_keyword=" + keyword.value ;
                //prompt('',ds1.Dataid);
                ds1.Reset();
            }
            ...
            function fnAdd() {
                ...
                window.returnValue = ds1.namevalue(row, "CDCODE") + ";" +
                                                   ds1.namevalue(row, "CDNAM") ;
                fnClose();
            }
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center><font style="position:relative;top:1px;width:120;height:15;left:5px;">원가 조회</font>
                            </td>
                        </tr>
                        <tr>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='479px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='원가코드'    ID='CDCODE'     Width=100  align=center </c>
                            <c> Name='원가명'       ID='CDNAM'       Width=300</c>
                        ">
                    </object>
                    <%=HDConstant.COMMENT_END%> 
                </td>
