...
/******************************************************************************
 * 시스템명 	 :  계정과목  조회 헬프
 * 프로그램ID : PMS/Help/si010h_02.jsp
 * J  S  P		 : sy030h_01.jsp
 * 서 블 릿	 : help/Si010H_01
 * 작 성 자	 : 정영식
 * 작 성 일	 : 2012-05-25
 * 기능정의	 : 원가조회 / 선택
 * [ 수정일자 ][수정자] 내용
...
%>
        <script language="javascript">
            ...
            function fnSelect() {
                ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Si010H_02?proType=S&dsType=1&v_keyword=" + keyword.value ;
                ds1.Reset();
            }
            
            function fnAdd() {
                var row = ds1.rowposition;
                window.returnValue = ds1.namevalue(row, "ATCODE") + ";" +
                                                   ds1.namevalue(row, "ATKORNAM") ;
                fnClose();
            }
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center><font style="position:relative;top:1px;width:120;height:15;left:5px;">계정과목 조회</font>
                            </td>
                        </tr>
                        <tr>
                            <td class="text" width="100px" height="30" style="border:1 solid #708090">계정과목명 </td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='479px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='계정과목코드'    ID='ATCODE'           Width=100  align=center </c>
                            <c> Name='계정과목명'       ID='ATKORNAM'       Width=300</c>
                        ">
                    </object>
                    <%=HDConstant.COMMENT_END%> 
                </td>
