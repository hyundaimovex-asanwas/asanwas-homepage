...
/******************************************************************************
 * 시스템명 	 :  거래처 조회 헬프
 * 프로그램ID 	 : PMS/Help/sy030h_01.jsp
 * J  S  P		 : sy030h_01.jsp
 * 서 블 릿		 : help/Sy030H_01
 * 작 성 자		 : 박경국
 * 작 성 일		 : 2011-12-23
 * 기능정의		 : 거래처 검색 / 선택
 * [ 수정일자 ][수정자] 내용
...
%>
        <script language="javascript">
            ...
            function fnSelect() {
                ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Sy030H_01?proType=S&dsType=1&v_keyword=" + keyword.value ;
                ds1.Reset();
            }
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
                        ...
                        <tr>
                            <td class="text" width="100px" height="30" style="border:1 solid #708090">거래처명</td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='479px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='거래처 코드'    ID='VEND_CD'     Width=100  align=center </c>
                            <c> Name='거래처 명'      ID='VEND_NM'     Width=300</c>
