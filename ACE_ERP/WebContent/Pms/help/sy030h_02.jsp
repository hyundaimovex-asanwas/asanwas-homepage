...
/******************************************************************************
 * 시스템명 	 :  품목조회 헬프
 * 프로그램ID 	 : PMS/Help/sy030h_02.jsp
 * J  S  P		 : sy030h_02.jsp
 * 서 블 릿		 : help/Sy030H_02
 * 작 성 자		 : 박경국
 * 작 성 일		 : 2011-12-23
 * 기능정의		 : 품목 검색 / 선택
 * [ 수정일자 ][수정자] 내용
...
%>
        <script language="javascript">
            ...
            function fnSelect() {
                ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Sy030H_02?proType=S&dsType=1&v_keyword=" + keyword.value ;
                ds1.Reset();
            }
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center><font style="position:relative;top:1px;width:120;height:15;left:5px;">품목 조회</font>
                            </td>
                        </tr>
                        <tr>
                            <td class="text" width="100px" height="30" style="border:1 solid #708090">품목명</td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='479px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='품목SID'    ID='ITEM_SID'     Width=100  align=center </c>
                            <c> Name='품목 명'      ID='ITEM_NM'     Width=300</c>
