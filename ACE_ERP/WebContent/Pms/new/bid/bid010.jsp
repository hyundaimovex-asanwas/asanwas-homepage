...
<script language="javascript">
    ...
    function fnSelect() {
    	...
    	var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
	   	...
	   	ln_TRSetting(tr1, 
		            "<%=dirPath%><%=HDConstant.PATH_BID%>Bid010",
    ...
    function fnAnalysis() {
		...
		var bid_nm =ds_default.NameValue(ds_default.rowposition,"BID_NM");
		var order_amt =ds_default.NameValue(ds_default.rowposition,"ESTIMATE_AMT");
		var order_nm =ds_default.NameValue(ds_default.rowposition,"ORDER_NM");
		...
		strURL = "<%=dirPath%>/Pms/new/bid/bid018.jsp";
        ...
        <tr>
            <td align='right'>
                <table border='0' cellpadding='0' cellspacing='0' width='1000px'>
                    <tr>
			     		<td align=left>     
							<img src="<%=dirPath%>/Sales/images/data_confirm.gif"		style="cursor:pointer" onclick="fnAnalysis()">             
                        </td>	
			     		<td align=right>
							<img src="<%=dirPath%>/Sales/images/excel_apply.gif"		style="cursor:pointer" onclick="fnConfirm()">    
            ...
            <td class="r">
           		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='1000px'>
           			<tr>
                        ...
                        <td align=left class="text"  width="100">입찰기간</td>
            ...
            <td valign="top">
                <object id="gr_default" classid=<%=HDConstant.CT_GRID_CLSID%> width='1000px' height='600px' border='1'>
                    ...
                    <param name="Format"            value="
                      ...
                      <G>name='입찰'
                         <C> name='입찰코드' 		ID='BID_CD'    		width=80 		align=CENTER 		mask='XXXXXXX-XXX'</C>
                         <C> name='입찰명' 			ID='BID_NM'   		width=200 		align=LEFT			</C> 
                      </G>
                         <C> name='발주처' 			ID='ORDER_NM'   	width=150 		align=LEFT			</C>
                         <C> name='추정액' 			ID='ESTIMATE_AMT'   width=90 		align=RIGHT			DEC=0</C>                         
                         <C> name='입찰일자'    	ID='BID_DT'    		width=80 		align=CENTER	  	mask='XXXX-XX-XX' </C>
                         <C> name='등록자'   		ID='NM_INSERT'   	width=60 		align=CENTER	 	</C>
                         <C> name='사업성검토' 		ID='CD_TYPE'    	width=80 		align=CENTER	 	value={decode(CD_TYPE,'O','적격','X','부적격','C','조건부 적격','진행중')} BgColor={IF(CD_TYPE='X','#FF0000','')}</C>                           
                         <C> name='낙찰여부' 		ID='DS_RESULT'    	width=80 		align=CENTER	 	</C>  
                         <C> name='Remark' 			ID='REMARK'    		width=130 		align=left	 		</C> 
                 ">                             
                </object>   
 		    </td>
        </tr>
