...
<script language="javascript">
            ...
            function fnSelect() {
            	...
            	var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"  	
												+ ",v_order=" + order_cd						//수주code            	
            										;

        		ln_TRSetting(tr1, 
        	        	"<%=dirPath%><%=HDConstant.PATH_BID%>Bid031",
 ...
 <div>
		...
		<table border="0" cellpadding="0" cellspacing="0" >
			  ...
			  <tr>
				...
				<td style="border:1 solid #708090;border-width:0 1 1 0;" class="l">&nbsp;
					<input id="profit_rate"    type="text"   class="txtbox"  style= "position:relative;width:340px;height:20px;">		
				</td>
			  </tr>		
	...
	<%=HDConstant.COMMENT_START%>
	     <object id=bn1 classid=<%=HDConstant.CT_BINDER_CLASSID%>>
	             ...
	             <param name=BindInfo    		value="
					...
					<C>Col=CONTRACT_AMT    	 	Ctrl=contract_amt     			Param=Text  </C>		
					<C>Col=EXECUTE_AMT   	 	Ctrl=execute_amt   				Param=Text  </C>
					<C>Col=SALES_PROFIT	 		Ctrl=sales_profit      			Param=Text  </C>	
