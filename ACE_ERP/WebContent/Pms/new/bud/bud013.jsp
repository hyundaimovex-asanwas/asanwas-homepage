...
function ln_Query(e){
	    ...
	    ln_TRSetting(tr1, 
	        "<%=dirPath%><%=HDConstant.PATH_BUD%>Bud013",
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:580px;border:1 solid #708090">
	<tr>
		<td class="tab12" width="180px;" bgcolor="#eeeeee">Item</td>
		<td width="210px">
			<input type="text" class="txt11" id="item_nm" style="width:200px;" onkeydown="if(event.keyCode==13) ln_Query();">
		</td>
		
		<td>
			<img src="<%=dirPath%>/Common/img/btn/com_b_find.gif" alt="Item Search" style="position:relative;left:2px;top:1px;cursor:hand;" onclick="ln_Query()">
		</td>
	</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:5px;top:10px">
	<tr>
		<td class="tab21" colspan="3">
			<OBJECT classid=<%=HDConstant.MxGrid_CLSID_S%> id=gcgd_disp style="width:580;height:240px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
					...
					<C>ID=DS_KSITEM,		Name=item,			width=250,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left, 	sort = true</C>
					<C>ID=AMT_ITEM,			Name=cost,			width=150,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=right, 	sort = true decao=0</C>
				">
	    </OBJECT>
		</td>
	</tr>
