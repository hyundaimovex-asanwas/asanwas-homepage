...
<script language="javascript" >
    ...
    function fnInit() {
        ...
        var cost_cd = '180501' ;// strParam[0];   주석 풀어줘야됨
...
<script language=JavaScript for=grd_ITEM_D event=OnPopup(Row,Colid,data,xpos,ypos)>
					var cost_cd = ds_ITEM_D.NameValue(ds_ITEM_D.rowposition,"COST_CD");
				//	var no_budget =  ds_item_d.NameValue(ds_item_d.rowposition,"NO_BUDGET");	
					...
					var strURL;
					var strPos;
			if(ds_ITEM_D.namevalue(ds_ITEM_D.rowposition,"COST_CD") == ""){		
					...
					sApproveLine = arrResult; 
						if (arrResult != null) {
				    		...
				    		arrParam = arrResult.split(";");
				    	   	ds_ITEM_D.Namevalue(ds_ITEM_D.rowposition,"COST_CD")=arrParam[0];
				        }
									...
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td align="center">
													<input name="txtCOMM_CD_SHR" style="width 100%;" class="divInput" ></td> <!--onKeypress="javascript:if(event.keyCode==13)fnc_SearchList()"  -->
												<td align="left"></td>
											</tr>
										</table>
									</td>
