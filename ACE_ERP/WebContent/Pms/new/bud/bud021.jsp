...
<script language="javascript"  for=tb_TreeView event=OnClick()>
	...
	//alert("Row : "+Row+", overValue1 : "+overValue1+", overValue2 : "+overValue2+", overId1 : "+overId1+", overId2 : "+overId2);
...
<script language=JavaScript for=grd_ITEM_D event=OnPopup(Row,Colid,data,xpos,ypos)>
		...
		strURL = "<%=dirPath%>/Pms/new/bud/bud013.jsp";
		
		strPos = "dialogWidth:600px;dialogHeight:380px;status:no;scroll:no;resizable:no";
							                ...
							                <tr align="left">
							                    <td> 
							                        <object id="grd_ITEM_D" classid=<%=HDConstant.MxGrid_CLSID_S%>" style="width:740px;height:620px;">
							                            ...
							                            <param name="Format"						value="
							                                <C> id='COST_CD'				name='CODE'			width=70			show=false</C>							                            
							                                <C> id='DS_KSITEM'				name='Content'		width=160			align=left</C>									                                
							                               ...
							                               <G> name='실행' 							                                
							                                ...
							                                <C> id='ITEM_CD'				name='품목\\코드'	width=50			align=center show=false</C> 						                                
							                                <C> id='ITEM_NM'				name='품목\\코드'	width=100			align=left EditStyle=Popup </C> 
							                            ">
							                        </object>
							                    </td>
							                </tr>
							                ...
							                <tr align="left">
							                    <td> 
							                        <object id="grd_ITEM_D_grid" classid=<%=HDConstant.MxGrid_CLSID_S%>" style="width:1000px;height:620px;">
														...
														<param name=ColSelect    					value="True">								                            
							                            <param name="Format"						value="
							                                <C> id='DS_KSITEM'				name='Content'		width=150			align=left</C>									                                
							                                <C> id='CD_COST'				name='CODE'			width=80			align=left</C>
							                                <C> id='NO_BUDGET'				name='차수' 		align=center	 	show=false</C> 
							                ...
							                <tr align="left">
							                    <td> 
							                        <object id="grd_ITEM_D_grid3" classid=<%=HDConstant.MxGrid_CLSID_S%>" style="width:1000px;height:620px;">
							                            ...
							                            <param name="VIEWSUMMARY"					value=0>
							                            <param name="Format"						value="
							                                <C> id='DS_KSITEM'				name='Content'		width=150			align=left edit=none</C>									                                
							                                <C> id='CD_COST'				name='CODE'			width=70			align=left edit=none</C>
							                                <C> id='NO_BUDGET'				name='차수' 		align=center	 	show=false edit=none</C> 	
							                                <C> id='COST_YN'				name='ITEM' 		width=40			align=center	value={decode(COST_YN,'N',,'Y','Y', )} edit=none</C> 	
							                               <G> name='도급' 
							                                <C> id='ORDER_AMT_OLD'			name='최초'			width=70			align=right decao = 0 edit=none</C> 
							                                <C> id='ORDER_AMT_NOW'			name='현재'			width=70			align=right decao = 0 edit=none</C>
							                                <C> id='ORDER_AMT_DIF'			name='증감'			width=70			align=right decao = 0 show=false edit=none</C>
							                               </G>	
							                               <G> name='가예산' 							                                
							                                <C> id='PRO_ACT_AMT_OLD'		name='최초'			width=70			align=right decao = 0 edit=none</C>
							                                <C> id='PRO_ACT_AMT_NOW'		name='현재'			width=70			align=right decao = 0 edit=none</C> 
							                                <C> id='PRO_ACT_AMT_DIF'		name='증감'			width=70			align=right decao = 0 show=false edit=none</C> 
							                               </G>		
							                               
							                               <G> name='입찰예산' 			             							                                
							                                <C> id='BID_ACT_AMT_OLD'		name='최초'			width=70			align=right decao = 0 edit=none</C>
							                                <C> id='BID_ACT_AMT_NOW'		name='현재'			width=70			align=right decao = 0 edit=none</C> 
							                                <C> id='BID_ACT_AMT_DIF'		name='증감'			width=70			align=right decao = 0 show=false edit=none</C> 
							                               </G>		
							                               			                               
							                               <G> name='실행예산' 							                                						                                
							                                <C> id='EXE_ACT_AMT_OLD'		name='최초'			width=70			align=right decao = 0 edit=none</C>
							                                <C> id='EXE_ACT_AMT_NOW'		name='현재'			width=70			align=right decao = 0 edit=none</C> 
							                                <C> id='EXE_ACT_AMT_DIF'		name='증감'			width=70			align=right decao = 0 edit=none</C> 
							                               </G>
							                                <C> id='ITEM_CD'				name='품목\\코드'	width=50			align=center show=false</C> 						                                
							                                <C> id='ITEM_NM'				name='품목\\코드'	width=90			align=left EditStyle=Popup </C> 	
							                            ">
							                        </object>
							                    </td>
							                </tr>
