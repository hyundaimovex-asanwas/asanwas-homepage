...
<script language="javascript">
	...
	function ln_Query(e){
		    ...
		    ln_TRSetting(tr1, 
				        "<%=dirPath%><%=HDConstant.PATH_PUR%>Rq012",
			...
			<OBJECT classid=<%=HDConstant.MxGrid_CLSID_S%> id=gcgd_disp style="width:360;height:250px;border:0 solid #708090;border-left-width:1px;border-top-width:1px;">
				...
				<param name="sortview"    	 		value=left>
			  	<PARAM NAME="Format"				VALUE="  
						<C>ID=COST_CD,		Name=코드,			width=120,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort = true</C>
						<C>ID=PLJ_NM,		Name=프로젝트,		width=220,		HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left, 	sort = true</C>
