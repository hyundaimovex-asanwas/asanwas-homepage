            ...
            <td class="r">&nbsp;&nbsp;&nbsp;            
                <object id=gr_culd classid=<%=HDConstant.MxGrid_CLSID_S%> width='1000px' height='300px' border='1'>
                    ...
                    <param name="Format"            value="
		                ...
		                <C> name='실행 단가'    		ID='EXE_ACT_UP'    	Width=100  	align=RIGHT 	edit=none   DEC=0</C>
		                <C> name='실행 금액'   			ID='EXE_ACT_AMT' 	Width=120  	align=RIGHT 	edit=none	DEC=0</C>
		                <C> name='청구 수량' 			ID='ALREADY_QN'   	Width=100	align=center 	edit=none	DEC=0</C>
		                <C> name='청구 금액' 			ID='ALREADY_AMT'   	Width=120	align=RIGHT 	edit=none	DEC=0</C>
		                <C> name='청구' 	 			ID='REQUEST_QN'  	Width=90  	align=center 	show=false  </C>
