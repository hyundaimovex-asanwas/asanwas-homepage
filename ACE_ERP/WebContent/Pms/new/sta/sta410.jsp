...
<script language="javascript">
    ...
    function fnCreateSelect(rowPos) {
       ...
       var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                         ...
                         + ",v_todt=" + to_date
                         + ",v_empno=" + v_empno.value
                         //+ ",v_pl_dept=" + ds_cul.namevalue(ds_cul.RowPosition,"PL_DEPT")
                         + ",v_group_nm=" + ds_cul.namevalue(rowPos,"GROUP_NM")
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		   
    <table border='0' cellpadding='0' cellspacing='0' width="845px"> 
        ...
        <tr height='10px'>
            <td class="bold"><font size="2" color="blue">[원천징수 거래 처리내역]</font></td>
        </tr>
        <tr>
            <td valign="top">
                        ...
                        <td valign='top' width="1000px">
							<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_cul width="1000px" height="170px" border="1">
						        ...
						        <param name="Format"            value="
						        	<C> name='Chk.'				ID='CHKYN'   	width=30 	align=CENTER	edit=true 		editstyle=CheckBox </C>
						        	<C> name='처리 그룹명'		ID='GROUP_NM'	width=140 	align=left 		suppress='1' 	edit=none</C>
        ...
        <tr>
        	<td>
	        	<table cellpadding="0" cellspacing="0" border="0" style="width:1002px;height:200px;font-size:9pt;background-color:#ffffff;" > 
					<tr>
						<td colspan =9 style="height:145px;">
								<object id=gr_slipdtl classid=<%=HDConstant.CT_GRID_CLSID%> width='1000px' height='240px' border='1'>
									...
									<param name="Format"		  	    	value=" 
									    <C>Name='순번'		   		ID=FSNUM 	       Width=30	    align=center  	edit=none   </C> 
										<C>Name='계정코드'  		ID=ATCODE 	       Width=55     align=left	    edit=none   </C> 
										<C>Name='계정명'	   		ID=ATKORNAM	       Width=170	align=left	    edit=none   SumText='합   계'</C> 
										<C>Name='차변금액'  		ID=DEAMT 	       Width=95     align=right		edit=none   SumText={sum(Number(DEAMT))}  color =#0000FF  sumcolor =#0000FF  Value={Number(DEAMT)}</C> 
										<C>Name='대변금액'  		ID=CRAMT 	       Width=95	    align=right    	edit=none   SumText={sum(Number(CRAMT))}  color =#FF0000  sumcolor =#FF0000  Value={Number(CRAMT)}</C> 										
					...
					<tr>
					    <td width="25px"   align=center  bgcolor="#5c7cac" style="height:20px;border:3" ><font color="white">순번</font></td>
					    <td width="104px"       	align=center  bgcolor="#5c7cac" style="border:3;">
					    	<input type=text    id=txt_fsrefnm01   		name=txt_fsrefnm01  value="부서"          size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px"      align=center  bgcolor="#5c7cac"> 
							<input type=text    id=txt_fsrefnm03   		name=txt_fsrefnm03  value="관리항목3"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px"      align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm04   		name=txt_fsrefnm04  value="관리항목4"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px"      align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm05   		name=txt_fsrefnm05  value="관리항목5"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px" class="tab35"     align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm06   		name=txt_fsrefnm06  value="관리항목6"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px" class="tab35"     align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm07   		name=txt_fsrefnm07  value="관리항목7"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px" class="tab35"     align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm08   		name=txt_fsrefnm08  value="관리항목8"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
						...
						<td width="104px" class="tab35"     align=center  bgcolor="#5c7cac" > 
						    <input type=text    id=txt_fsrefnm09   		name=txt_fsrefnm09  value="관리항목9"  size="15"  class=txt41  style="position:relative;top:1px;width:100px;height:17px;background-color:#5c7cac;text-align:center;color:white" readonly tabindex=-1>
