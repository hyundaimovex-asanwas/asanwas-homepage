 ...
 * 마스터 저장 후 재조회 ?
 * [2013-11-05][심동현] 完	조회 프로시저까지 완료, 저장(업데이트)도 완료, 신규/삭제 해봐야 함
 *							마스터 저장 완료, 디테일 입력/수정/삭제 완료
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='300px'>
                    <tr>
                        <td height='25px' align='right'>
							...
							<img src="<%=dirPath%>/Sales/images/new.gif"		style="cursor:pointer"  onClick="fnAddRowDsDefault()" >
                    		...
                    		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='845px'>
                    			<tr>
                                    ...
                                    <td bgcolor="#FFFFFF">&nbsp;<input type="text" name='v_bid_kind_nm' id='v_bid_kind_nm' style="width:130px;" class='input01' onkeydown="if(event.keyCode==113) fnSelKindPopup('<%=dirPath%>');" readOnly="readonly">
                                        <img src="<%=dirPath%>/Sales/images/help.gif" align="absmiddle" style="cursor:pointer" onclick="fnSelKindPopup('<%=dirPath%>');" alt="조회창 팝">
                                        <img src="<%=dirPath%>/Sales/images/trash.gif" align="absmiddle" style="cursor:pointer" onclick="fnSelKindCleanup();" alt="값 지우기">
                    ...
                    <tr>
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='233px' border='1'>
                                ...
                                <param name="Format"            value="
									 ...
									 <C> name='시작일' 		ID='CT_DATE_BEGIN'    	width=60 	align=CENTER	Edit=None show=false</C>
									 <C> name='종료일' 		ID='CT_DATE_END	'    	width=60 	align=CENTER	Edit=None show=false</C>
                        ...
                        <td valign="top">
							<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666" align="right">
								<tr height="21px">
									<td width="120px" class="text">입찰일자</td>
								...
								<tr height="21px">
									...
									<td bgcolor='#ffffff'>&nbsp;<input type="text" name='v_bid_kind_nm1' id='v_bid_kind_nm1' style="width:90px;" class='textbox' onkeydown="if(event.keyCode==113) fnSelKindPopup1('<%=dirPath%>');" readOnly="readonly">
                                        <img src="<%=dirPath%>/Sales/images/help.gif" align="absmiddle" style="cursor:pointer" onclick="fnSelKindPopup1('<%=dirPath%>');" alt="조회창 팝">
								...
								<tr height="21px">
									...
									<td colspan="1" bgcolor='#ffffff'>&nbsp;
			                            <object id=v_act_amt classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=120 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:105px; height:17px;">
			                                <param name=Text        value="">
									...
									<td colspan="2" bgcolor='#ffffff' align=right>&nbsp;<input type="text" name='v_act_amt_kor' id="v_act_amt_kor"   align=right style="width:220px;" class='textbox' > 원</td>
								</tr>								
								<tr height="21px">
									<td width="120px" class="boardt02">예가</td>
									<td colspan="1" bgcolor='#ffffff'>&nbsp;
			                            <object id=v_act_amt_ha classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=120 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:105px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Format      value="">
			                                <param name=Cursor      value="iBeam">
									...
									<td colspan="2" bgcolor='#ffffff' align="right">&nbsp;<input type="text" name='v_act_amt_ha_kor' id="v_act_amt_ha_kor"   align=center style="width:220px;" class='textbox' > 원</td>
								</tr>
							</table>
                        </td>
                    </tr>
            ...
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="Format"            value="
					  ...
					  <G> name='1차'
                         <C> name='입찰가(천원)'		ID='BID_AMT'    	width=90 	align=right 	 decao=0</C>
					  ...
					  <G> name='2차'
                         <C> name='입찰가(천원)'		ID='BID_AMT2'    	width=90 	align=right 	 decao=0</C>
				...
				<br><br>
                ※ <b>업체명은 수정되지 않습니다. 행삭제 후 행추가로 입력해 주세요.　</b>
            </td>
        </tr>
    </table>
