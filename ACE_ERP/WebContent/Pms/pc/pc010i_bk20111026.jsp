 ...
 * 예가 계산 수식 추가
 * 현장명만 놔두고 나머지 생략 : 바인딩 폼 수정 (혹시 모르니 쿼리는 남겨놓았음..어려운 쿼리였음..)
 * 저장 후 메세지 : 저장되었스빈다.?
 * 마스터 저장 후 재조회 
...
//		fnInit_tree(tree_idx);	//트리초기화 호출
    ...
    function fnInit() {
		...
		//데이터셋 헤더 초기화 = 빈 조회
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_PC%>Pc010I",
                ...
                <table  border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                        <td valign='top' width="300px">
                            <%=HDConstant.COMMENT_START%>
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='259px' border='1'>
                                ...
                                <param name="Format"            value="
                                     ...
                                     <C> name='구분'		ID='BID_STYLE' 		width=60 	align=CENTER	editstyle=lookup Data='ds_bid_style:detail:detail_nm' suppress=2 sumtext='총'  sumtextalign='right'</C>
                        ...
                        <td valign="top">
							<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666">
								...
								<tr height="21px">
									<td width="120px" class="text">발주처</td>
									<td bgcolor='#ffffff' width="146">&nbsp;<input type="text" name='v_orderer_nm' id="v_orderer_nm" style="width:130px;" class='input01' readOnly="readonly">
										<input type="hidden"  name='v_orderer_sid' id='v_orderer_sid'></td>
									<td width="120px" class="text">계약차수</td>
									<td bgcolor='#ffffff' width="146">&nbsp;<input type="text" name='v_site_seq_ct' id="v_site_seq_ct" style="width:130px;" class='input01' readOnly="readonly"></td>
								</tr>
								<tr height="21px">
									<td width="120px" class="text">변경차수</td>
									<td bgcolor='#ffffff'>&nbsp;<input type="text" name='v_site_seq_ch' id="v_site_seq_ch" style="width:130px;" class='input01' readOnly="readonly"></td>
									<td width="120px" class="text">계약금액</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_amt_ct_tot classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=130 align=center class="input01" style= "position:relative;left:0px;top:0px;width:129px; height:17px;">
			                                <param name=Text        value="">
								...
								<tr height="21px">
									<td width="120px" class="text">공급가액</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_amt_ct classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=130 align=center class="input01" style= "position:relative;left:0px;top:0px;width:129px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Format      value="">
			                                <param name=Cursor      value="iBeam">
									...
									<td width="120px" class="text">부가세</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_amt_ct_vat classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=130 align=center class="input01" style= "position:relative;left:0px;top:0px;width:129px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Format      value="">
			                                <param name=Cursor      value="iBeam">
								...
								<tr height="21px">
									<td width="120px" class="text">시작일</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_ct_date_begin classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=80 align=center class="input01" style= "position:relative;left:0px;top:0px;width:79px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="0000-00-00">
			                                <param name=Cursor      value="iBeam">
									...
									<td width="120px" class="text">종료일</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_ct_date_end classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=80 align=center class="input01" style= "position:relative;left:0px;top:0px;width:79px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="0000-00-00">
			                                <param name=Cursor      value="iBeam">
								...
								<tr height="21px">
									<td width="120px" class="boardt02">당사예산</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_act_amt classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=130 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:129px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Format      value="">
			                                <param name=Cursor      value="iBeam">
									...
									<td width="120px" class="boardt02">당사예산(한)</td>
									<td bgcolor='#ffffff'>&nbsp;<input type="text" name='v_act_amt_kor' id="v_act_amt_kor" style="width:130px;" class='textbox' ></td>
								</tr>
								<tr height="21px">
									<td width="120px" class="boardt02">하도급예산(예가)</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            <object id=v_act_amt_ha classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=130 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:129px; height:17px;">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Format      value="">
			                                <param name=Cursor      value="iBeam">
									...
									<td width="120px" class="boardt02">하도급예산(한)</td>
									<td bgcolor='#ffffff'>&nbsp;<input type="text" name='v_act_amt_ha_kor' id="v_act_amt_ha_kor" style="width:130px;" class='textbox' ></td>
								</tr>
	...
	<%=HDConstant.COMMENT_START%>
	     <object id=bn1 classid=<%=HDConstant.CT_BINDER_CLASSID%>>
	             ...
	             <param name=BindInfo    value="
					...
					<C>Col=ORDERER_NM     Ctrl=v_orderer_nm       Param=Value </C>
					<C>Col=ORDERER_SID    Ctrl=v_orderer_sid      Param=Value </C>
					<C>Col=SITE_SEQ_CT    Ctrl=v_site_seq_ct    Param=Value </C>
					<C>Col=SITE_SEQ_CH    Ctrl=v_site_seq_ch    Param=Value </C>
					<C>Col=AMT_CT_TOT     Ctrl=v_amt_ct_tot     Param=Text </C>
					<C>Col=AMT_CT         Ctrl=v_amt_ct         Param=Text </C>
					<C>Col=AMT_CT_VAT     Ctrl=v_amt_ct_vat     Param=Text </C>
					<C>Col=CT_DATE_BEGIN  Ctrl=v_ct_date_begin  Param=Text </C>
					<C>Col=CT_DATE_END    Ctrl=v_ct_date_end    Param=Text </C>
