 ...
 * 마스터 저장 후 재조회 ?
 * [2013-07-08][박경국] 자재 입찰등록 화면 신규생성 
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<script language="javascript">
    ...
    function fnInit() {
		...
		//데이터셋 헤더 초기화 = 빈 조회
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_PC%>Pc030I1",
                    ...
                    <tr>
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='233px' border='1'>
                                ...
                                <param name="Format"            value="
                                     ...
                                     <C> name='품목명'  		ID='CT_KIND_NM'    	width=60 	align=left 		Edit=None suppress=4 sumtext='건' sumtextalign='left'</C>
                        ...
                        <td valign="top">
							<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666" align="right">
								...
								<tr height="21px">
									<td width="120px" class="boardt02">납품 시작일</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
									...
									<td width="120px" class="boardt02">납품 종료일</td>
									<td bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
								...
								<tr height="21px">
									<td width="120px" class="boardt02">품목명</td>
								...
								<tr height="21px">
									...
									<td colspan="1" bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
			                            ...
			                            </object><%=HDConstant.COMMENT_END%> 천원 										
									</td>
