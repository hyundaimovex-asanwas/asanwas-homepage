...
<script language="javascript">
    ...
    function fnSelect() {
		if (ds_default.IsUpdated || ds_tender.IsUpdated) {
	        ...
	        //alert(param);
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_PU%>Pu020S",
	...
	******************************************************************************/
	...
	function fnExcelDs1() {
        ...
        getObjectFirst("gr_default").SetExcelTitle(1, "value:접수조회; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr_default").GridToExcel("접수조회","접수조회.xls", 8);
        if(ds_tender.RowCount==0){
            return;
        }
        getObjectFirst("gr_tender").SetExcelTitle(0, "");
        getObjectFirst("gr_tender").SetExcelTitle(1, "value:접수품목; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr_tender").GridToExcel("접수품목","접수품목.xls", 8);
 	}	 	
                        ...
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='233px' border='1'>
                                ...
                                <param name="Format"            value="
                                     <C> name='작업상태'	ID='RQST_STATUS'    	width=100 	align=CENTER	Edit=None 			  sort=true	show=false	</C>
                                     <C> name='작업상태'	ID='RQST_STATUS_NM'    	width=80 	align=CENTER	Edit=None 		  sort=true		show=true</C>
                                     <C> name='일자' 		ID='RQST_DATE'    		width=80 	align=CENTER	Edit=None 		  sort=true		</C>
                                     <C> name='청구번호'	ID='RQST_NO' 			width=120 align=CENTER	Edit=None		  sort=true	</C>
                                     <C> name='청구SID'    ID='RQST_SID'       		show=false width=60 	align=CENTER	Edit=None 		  sort=true		decao=0	Edit=None  sumtext='@cnt' sumtextalign='right'</C>
                                     <C> name='현장코드'	ID='SITE_CD'    			width=80 	align=CENTER	Edit=None 		  sort=true		show=TRUE</C>
                        ...
                        <td valign="top">
							<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666" align="right">
								<tr height="21px">
									...
									<td width="120px" class="text">업체선정</td>
									<td colspan="1"	bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
								...
								<tr height="21px">
									...
									<td  width="145px"	bgcolor='#ffffff'>&nbsp;<input type="text"  edit='false' name='v_rqst_no' id="v_rqst_no" style="width:130px;" class='input01'  readOnly="readonly"  > </td>
								</tr>
								<tr height="21px">
								...
								<tr height="21px">
									<td width="120px" class="text">접수특기사항</td>
									<td bgcolor='#ffffff' colspan="3">&nbsp;<input type="text" name='v_rqstac_memo' id="v_rqstac_memo" style="width:380px;" class='input01'    >
                                    </td>
								</tr>
								<tr height="21px">
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='250px' border='1'>
                    ...
                    <param name=SortView  value="Right">
                    <param name="Format"            value="
                         <C> name='RQST_SID' 		ID='RQST_SID'   		width=40 		align=CENTER	 edit=none 	show=false	  sort=true	 </C>
                         <C> name='ITEM_SID' 		ID='ITEM_SID'   		width=40 		align=CENTER	 edit=none 	show=false	  sort=true	 </C>
                         <C> name='품명' 				ID='ITEM_NM'    		width=150 	align=CENTER	 edit=none editstyle=popup bgColor=<%=HDConstant.GRID_ITEM%>	  sort=true	</C>
                         ...
                         <C> name='비고' 				ID='RQST_NOTE'    	width=100 	align=LEFT	 	 edit=none</C>
                 ">                             
                </object>   
                <%=HDConstant.COMMENT_END%>
