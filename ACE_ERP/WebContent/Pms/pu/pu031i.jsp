...
%>
	...
	function fnAddRow1() {
		ds1.addrow();
		ds1.namevalue(ds1.rowposition,"ITEM_LEVEL")= getObjectFirst("menu_level").value;
							...
							<table border="0"  cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td align="right" height="30px">		
										...
										<img src="<%=dirPath%>/Sales/images/plus.gif"	style="cursor:pointer" onClick="fnAddRow1()" >
										<!-- <img src="<%=dirPath%>/Sales/images/minus.gif"  style="cursor:pointer" onClick="fnDeleteRow1()" >-->
						...
						<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:370" border="1" >
								...
								<param name="Format" 			value="
									...
									<C> name='품목레벨'     	ID='ITEM_LEVEL'     	width=100		align=center editlimit=5 	show=true edit=none </C>
