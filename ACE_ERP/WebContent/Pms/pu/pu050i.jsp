                ...
                <table border='0' cellpadding='0' cellspacing='0' width='845px'>
                    <tr>
                        ...
                        <td align=right >
							...
							<img src="<%=dirPath%>/Sales/images/excel.gif"		style="cursor:hand"	onClick="fnExcelDS1()">		<!-- 엑셀 -->
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='233px' border='1'>
                                ...
                                <param name="Format"            value="
                                     <C> name='작업상태'	ID='RQST_STATUS'    	width=80 	align=CENTER	Edit=None 		show=TRUE	suppress=1</C>
            ...
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="Format"            value="
                         ...
                         <C> name='용도' 				ID='RQST_USE'    	width=150 	align=CENTER	 </C>
                         <C> name='소요일' 				ID='DATE_USE'    	width=80 		align=CENTER	 </C>
