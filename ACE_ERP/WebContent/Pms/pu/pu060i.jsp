 ...
 * [ 수정일자 ][수정자] 내용
 * [2011-11-24][박경국] 신규
 * [2012-11-02][심동현] 테이블에 도급수량(DG_CNT) 컬럼 추가
 * [2012-11-05][심동현] ITEM_SEQ  추가
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='200px' border='1'>
                    ...
                    <param name="ViewSummary"       value="1">
                    <param name="Format"            value="
	                     <C> name='선택' 			ID='USE_YN'    		width=30 		align=CENTER	edit=true	editstyle=checkbox </C>
						...
						<G> name='도급'                         
                         ...
                         <C> name='단가'    		ID='DG_AMT'    	    width=67 		align=right	 show=true decao=0	edit=none	sumtext='총'  sumtextalign='right'  </C>
                         <C> name='금액'   			ID='DG_SUM_AMT'		width=77 		align=right	 show=true edit=none	decao=0	sumtext='@sum' sumtextalign='right'  </C>
                        </G>
                        <G> name='예산'
                         <C> name='수량' 			ID='RQST_CNT'   	width=47 		align=right	 edit=none</C>
                         <C> name='단가' 			ID='YS_AMT'   		width=67 		align=right	 decao=0 edit=none	 sumtext='원'  sumtextalign='left'</C>
                         <C> name='금액'    		ID='YS_SUM_AMT'		width=77 		align=right	 show=true edit=none	decao=0	 sumtext='@sum' sumtextalign='right'</C>
                        </G>
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_detail" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="BorderStyle"       value="0">
                    <param name="Format"            value="
	                     <C> name='선정YN(3)' 			ID='CHOICE_YN'    		edit=true	width=80 		 show=true align=CENTER	editstyle=checkbox 	bgColor=<%=HDConstant.GRID_ITEM%> </C>
                         <C> name='EST_SID' 			ID='EST_SID'	   		width=80 		align=CENTER	edit=none  show=false</C>
                         ...
                         <C> name='증감비율(%자동)'		ID='UD_RATE'  		width=100 		align=right		dec=1 edit=none</C>
                 ">                             
                </object>   
                <%=HDConstant.COMMENT_END%>
            </td>
