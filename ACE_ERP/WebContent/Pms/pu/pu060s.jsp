                        ...
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='103px' border='1'>
                                ...
                                <param name="Format"            value="
                                     <C> name='작업상태'	ID='RQST_STATUS'    	width=80 	align=CENTER	Edit=None 		show=false	suppress=1  sort=true	</C>
                                     <C> name='작업상태'	ID='RQST_STATUS_NM'    	width=80 	align=CENTER	Edit=None 		show=true  sort=true	</C>
                                     ...
                                     <C> name='견적SID'    ID='EST_SID'       			width=60 	align=CENTER	Edit=None 		decao=0	Edit=None </C>
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_est" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='80px' border='1'>
                    ...
                    <param name=SortView  value="Right">
                    <param name="Format"            value="
                         <C> name='견적SID(시스템 고유번호)' 			ID='EST_SID'	   		width=200 		align=CENTER	edit=none show=false  sort=true	</C>
                         <C> name='청구SID(시스템 고유번호)' 		ID='RQST_SID'   		width=200 		align=CENTER	edit=none show=false  sort=true	</C>
                         <C> name='견적서 순번'     	    ID=CurRow   	        width=100	    align=center  show=true edit=none Value={CurRow}  sort=true	 </C>
                         <C> name='견적담당자사번' 		ID='EST_EMPNO'   		width=100 		align=CENTER	editlimit=7 edit=false show=true  sort=true	</C>
                         <C> name='견적마감일자'	 		ID='DATE_TO'   			width=100 		align=CENTER	editlimit=8	edit=false show=true  sort=true	</C>
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="ViewSummary"       value="1">
                    <param name="Format"            value="
	                     <C> name='선택' 				ID='USE_YN'    		edit=none		width=50 		align=LEFT	editstyle=checkbox </C>
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_detail" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="BorderStyle"       value="0">
                    <param name="Format"            value="
	                     <C> name='선정YN(5)' 			ID='CHOICE_YN'    		edit=true	width=80 		 show=true align=LEFT	editstyle=checkbox  </C>
                         <C> name='EST_SID' 			ID='EST_SID'	   		width=80 		align=CENTER	edit=none  show=false</C>
                         ...
                         <C> name='결정금액'		ID='TOT_FN_EST_AMT'  	width=90 		align=right 	 decao=0	</C>
                         <C> name='증감액'				ID='UD_EST_AMT'  	width=90 		align=right 	 decao=0 edit=none</C>                                                  
                         <C> name='품의일자'			ID='DATE_CON' 	 	width=90 		align=right 	 editlimit=8  show=false</C>   
                 ">                             
                </object>   
                <%=HDConstant.COMMENT_END%>
