...
<script language="javascript">
    ...
    function fnSelect() {
		if (ds_default.IsUpdated || ds_tender.IsUpdated) {
	        ...
	        //alert(param);
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_PU%>Pu110S",
...
/*
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr_default").SetExcelTitle(1, "value:자재청구조회; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr_default").GridToExcel("자재청구조회","자재청구조회.xls", 8);
  ...
  //첨부파일(1) 다운로드_열기
	...
	******************************************************************************/
    ...
    function fnFile(){
		...
		var real_fileList =txt_real_file.value;
		var sys_fileList =txt_sys_file.value;
		var real_file= new Array();
		var sys_file= new Array();
		real_file = real_fileList.split(":");	//배열로 정리
		sys_file = sys_fileList.split(":");	//배열로 정리
		
							location.href = '/services/Pms/common/sys/download.jsp?dir=pu010&filename='+real_file+'&sysfilename='+sys_file; //운영
//			location.href = '/Pms/common/sys/download.jsp?dir=pu010&filename='+real_file+'&sysfilename='+sys_file; //로컬
	}
</script>
                    		...
                    		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='845px'>
                    			<tr>
									...
									<td align="left"  bgcolor="#ffffff">&nbsp;
			                            <input type="text" name='sNowEmpnm' id='sNowEmpnm' size='8'   class='input01'>
			                            <input type="text" name='sNowEmpno' id='sNowEmpno' size='7'   class='input01'>
									</td>
                                ...
                                <tr>
			                        ...
			                        <td align=left bgcolor="#ffffff" WIDTH="80">&nbsp;<%=HDConstant.COMMENT_START%>
                        ...
                        <td valign='top' width="300px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='300px' height='233px' border='1'>
                                ...
                                <param name="Format"            value="
                                     <C> name='청구일자' 		ID='RQST_DATE'    		width=80 	align=CENTER	Edit=None  sort=true			suppress=1</C>
                                     <C> name='현장명'		ID='SITE_NM' 				width=120 align=CENTER	Edit=None	 sort=true	suppress=2</C>
                                     ...
                                     <C> name='작업상태'	ID='RQST_STATUS_NM'    	width=80 	align=CENTER	Edit=None 	 sort=true		show=true</C>
                                     ...
                                     <C> name='현장코드'	ID='SITE_CD'    			width=80 	align=CENTER	Edit=None  sort=true			show=false</C>
                                     <C> name='현장담당자사번'	ID='PU_EMPNO'    	width=60 	align=CENTER	Edit=None  sort=true			</C>
                        ...
                        <td valign="top">
							<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666" align="right">
								...
								<tr height="21px">
									...
									<td bgcolor='#ffffff' colspan="3">&nbsp;<input type="text" name='v_rqst_memo' id="v_rqst_memo" style="width:400px;" class='input01' readOnly="readonly"  >
                                    </td>
								</tr>
								<tr height="21px">
								...
								<tr>
									...
									<td colspan="1"	bgcolor='#ffffff'>&nbsp;<%=HDConstant.COMMENT_START%>
										<object id=lc_put_wh classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=150 width=100 border="0" align=absmiddle class='input01' readOnly="readonly">
									...
									<td  width="145px"	bgcolor='#ffffff'>&nbsp;<input type="text" name='v_pu_empno' id="v_pu_empno" style="width:100px;" class='input01' readOnly="readonly"' > </td>
								</tr>
								<tr height="21px">
								...
								<tr height="21px">
									...
									<td bgcolor='#ffffff' colspan="3">&nbsp;
                                        <input type="hidden"  name='txt_sys_file' id='txt_sys_file' class='input01' readOnly="readonly">
            ...
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='150px' border='1'>
                    ...
                    <param name="Format"            value="
                         ...
                         <C> name='품명' 				ID='ITEM_NM'    		width=150 	align=CENTER	  sort=true	</C>
                         <C> name='규격' 				ID='ITEM_SIZE'   		width=150 		align=CENTER	  sort=true	 </C>
                         <C> name='단위' 				ID='ITEM_UNIT'   		width=60 		align=CENTER	 sumtext='총'  sumtextalign='right'   sort=true	</C>
                         <C> name='수량' 				ID='RQST_CNT'   		width=60 		align=CENTER	 decao=2	</C>
                        <G> name='도급'
                         <C> name='단가'    		ID='DG_AMT'    	    width=85 		align=CENTER	 show=true decao=0	 </C>
                         <C> name='금액(자동)'   	ID='DG_SUM_AMT'   width=85 		align=CENTER	 sumtext='@sum' sumtextalign='right'	show=true edit=none	decao=0	 </C>
                         </G>
                         <G> name='예산'
                         <C> name='단가' 			ID='YS_AMT'   			width=85 		align=CENTER	 decao=0 sumtext='원'  sumtextalign='left'</C>
                         <C> name='금액(자동)'    	ID='YS_SUM_AMT'    width=85 		align=CENTER	 sumtext='@sum' sumtextalign='right'	show=true edit=none	decao=0	 </C>
						</G>
                         <C> name='용도' 				ID='RQST_USE'    	width=150 	align=CENTER	 show=false</C>
                         <C> name='소요일' 				ID='DATE_USE'    	width=80 		align=CENTER	 sumtext='원'  sumtextalign='left'</C>
