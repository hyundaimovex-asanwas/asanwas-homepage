...
<script language="javascript">
    ...
    function fnInit() {
       ...
       ds_rqst_use.Reset();	//사용처
		...
		//데이터셋 헤더 초기화 = 빈 조회
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_PU%>Pu140I",
        ...
        <tr>
            <td valign="top">
                ...
                <object id="gr_tender" classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='200px' border='1'>
                    ...
                    <param name="Format"            value="
	                     <C> name='선택' 				ID='USE_YN'    		edit=true		width=50 		align=LEFT	editstyle=checkbox 	bgColor=<%=HDConstant.GRID_ITEM%> </C>
                        ...
                        <G> name='도급'
                         <C> name='단가'    		ID='DG_AMT'    	    width=85 		align=right show=true decao=0	edit=none	sumtext='총'  sumtextalign='right' </C>
                         <C> name='금액'   	ID='DG_SUM_AMT'   width=85 		align=right show=true edit=none	decao=0	sumtext='@sum' sumtextalign='right' </C>
                         </G>
                         <G> name='예산'
                         <C> name='단가' 			ID='YS_AMT'   			width=85 		align=right decao=0 edit=none	 sumtext='원'  sumtextalign='left'</C>
