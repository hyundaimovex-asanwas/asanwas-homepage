...
<script language="javascript">
    ...
    function fnInit() {
        ...
        //vt_fr_inout_dt.Text = "20120601";
        //vt_to_inout_dt.Text = "20120630";
    ...
    function fnCreateSelect() {
       ...
       var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_SI%>Si050I1",
            "JSP(O:DS_DEFAULT=ds_slipdtl)",
            param);
            //prompt('',param);
     	...
     	if(fnSave_Chk()){
  			 if (gcds_slipmst.IsUpdated) {
				if (confirm("저장 하시겠습니까?")){	
					tr2.Action = "<%=dirPath%><%=HDConstant.PATH_SI%>Si050I_t1"
					tr2.Parameters = "v_str1="+gusrid+",v_str2="+gfdcode;
				    //<param name="KeyValue"    value="Si050I_t1(I:USER1=gcds_slipmst,I:USER2=gcds_slipdtl,I:USER3=gcds_banjaemst,I:USER4=gcds_banjae,I:USER5=gcds_pmstsi,O:USER9=gcds_slipno )">    
				    //tr2.keyvalue="Si050I_t1(I:USER3=gcds_slipmst,I:USER4=gcds_slipdtl,I:USER6=gcds_banjae,I:USER14=gcds_banjaemst,I:USER7=gcds_pmstsi,O:USER5=gcds_slipno )"; 
					//prompt('gcds_slipmst',gcds_slipmst.text);
					//prompt('gcds_slipdtl',gcds_slipdtl.text);
					//prompt('gcds_banjaemst',gcds_banjaemst.text);
					//prompt('gcds_banjae',gcds_banjae.text);
					//prompt('gcds_pmstsi',gcds_pmstsi.text);
	...
	function fnSlipdtlSetDataHeader() {
     ...
     <%//head생성%>
	function fnTsiSetDataHeader() {
    	 var s_temp = "INOUT_SID:DECIAML,FDCODE:STRING,FSDAT:STRING,FSNBR:STRING";
		 gcds_pmstsi.SetDataHeader(s_temp);
    }
    ...
    function fnSlipmstSettting() {
		...
		gcds_slipmst.namevalue(srow,"FSKND")= "B";         //자동 - 구매   
    ...
    function fnTsiSettting() {
    	for(var t=1;t<=ds_default.CountRow;t++){
    	    ...
    	    if(ds_default.namevalue(t,"ATKORNAM")!=""){
	    		gcds_pmstsi.addrow();
	    		gcds_pmstsi.namevalue(gcds_pmstsi.rowposition,"INOUT_SID")= ds_default.namevalue(t,"INOUT_SID");
	    	}
    	}
   }
    ...
    <%//전표부서 팝%>
    function fnSelDeptPopup(dirPath){
...
<object id=ds_default classid=<%=HDConstant.CT_DATASET_CLSID%>>  <!--조회-->
    ...
    <param name="SubsumExpr"	value="2:INGB_CD,1:ATCODE">
</object>
...
<object id=gcds_slipno classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
 ...
 <!--출납정보-->
<object id=gcds_pmstsi classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
	<PARAM NAME="SyncLoad" VALUE="true">
</object>
...
<object  id="tr2" classid=<%=HDConstant.CT_TR_CLSID%>>
    ...
    <param name="ServerIP"     value="">
    <param name="Action"         value="">
    <param name="KeyValue"    value="Si050I_t1(I:USER3=gcds_slipmst,I:USER4=gcds_slipdtl,I:USER6=gcds_banjae,I:USER14=gcds_banjaemst,I:USER7=gcds_pmstsi,O:USER5=gcds_slipno )"> 
    <param name="Parameters" value="">
</object>
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		   
    <table border='0' cellpadding='0' cellspacing='0' width="845px"> 
        ...
        <tr height='10px'>
            <td><b><font size="2" color="blue">[출금정보]</font></b></td>
        </tr>
        <tr>
            <td valign="top">
                        ...
                        <td valign='top' width="845px">
                            ...
                            <object id=gr_default classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='170px' border='1'>
                                ...
                                <param name="Format"                 value="
                                     ...
                                     <C> name='지점'            ID='FDCODE'      	          width=50 	align=center 	    </C>
                                     <C> name='접수일자'     ID='FSDAT'      	              width=70 	align=center 	    </C>
                                     <C> name='점수번호'     ID='FSNBR'      	              width=70 	align=center 	    </C>
