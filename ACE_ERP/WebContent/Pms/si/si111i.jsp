 ...
 * [2014-06-13][심동현] si110i를 복사해서 새로 만듬. 인원/장비/주요자재 데이터를 그냥 입력 (메모식..)
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<script language="javascript">
    ...
    function fnInit() {
		...
		//데이터셋 헤더 초기화 = 빈 조회
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_SI%>Si111I",
	...
	function fnPopBP(dirPath,row){	
		...
		if(ds_detail1.namevalue(row,"bp_sid")>0){
   		...
   		if (arrResult != null) {
  			...
  			for (row = 1; row < ds_detail1.countrow; row++) {
  				...
  				if (ds_detail1.namevalue(row,"bp_sid") == arrParam[0] && ds_detail1.namevalue(row,"bid_site_kind") == arrParam[2]) {
  					alert("같은 협력회사와 공종을 중복 등록할 수 없습니다!");
...
<object id=ds_wd classid=<%=HDConstant.MxDataSetU_CLSID_S%>> 
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_detail1 classid=<%=HDConstant.MxDataSetU_CLSID_S%>> 
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_detail2 classid=<%=HDConstant.MxDataSetU_CLSID_S%>> 
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_detail3 classid=<%=HDConstant.MxDataSetU_CLSID_S%>> 
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_wm_chk classid=<%=HDConstant.MxDataSetU_CLSID_S%>> 
    <param name="SyncLoad"  value="false"/>
</object>


<object id=ds_gc_weather classid=<%=HDConstant.MxDataSetU_CLSID_S%>> <!-- general code-->
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_gc_wdcode classid=<%=HDConstant.MxDataSetU_CLSID_S%>> <!-- general code-->
    <param name="SyncLoad"  value="false"/>
</object>
<object id=ds_gc_bskind classid=<%=HDConstant.MxDataSetU_CLSID_S%>> <!-- general code-->
    <param name="SyncLoad"  value="false"/>
</object>
...
<object  id="tr2" classid=<%=HDConstant.MxLogicalTRU_CLSID_S%>>
    <param name="KeyName"    value="toinb_dataid4"/>
    <param name="ServerIP"   value=""/>
    <param name="Action"     value=""/>
    <param name="KeyValue"   value=""/>
                    	...
                    	<td>
                    		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='890px'>
                    			<tr>
                                    ...
                                    <td bgcolor="#FFFFFF" >&nbsp;<input type="text" name='v_site_nm' id="v_site_nm" style="width:360px;" class='input01'  onkeydown="if(event.keyCode==113) fnSelSitePopup('<%=dirPath%>');" readOnly="readonly" value="강남보금">
                                        <input type="hidden"  name='v_site_sid' id='v_site_sid' value=249>
			                        ...
			                        <td align="left" bgcolor="#ffffff">&nbsp;
			                            <object id=v_date classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style= "position:relative;left:0px;top:2px;width:79px; height:17px;">
                ...
                <table  border='0' cellpadding='0' cellspacing='0' id="tb_cust_id">
                    <tr>
                        <td valign='top'>
							<table border="0" cellpadding="0" cellspacing="1" bgcolor="#666666" align="right">
								<tr height="21px">
									<td width="130px"  bgcolor="#ffffff" rowspan="2" align="center">&nbsp;
										<input type="hidden" name='site_sid' id="site_sid"  readOnly="readonly">
			                            <object id=w_date classid=<%=HDConstant.MxMaskEditU_CLSID_S%> height=17 width=80 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:79px; height:17px;" tabindex="1">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="YYYY-MM-DD">
			                                <param name=Cursor      value="iBeam">
									...
									<td width="80px" class="text"  rowspan="2" >날씨</td>
									<td width="110px" bgcolor="#ffffff" rowspan="2" >&nbsp;
			                            <object id=lc_gc_weather classid=<%=HDConstant.MxComboU_CLSID_S%> height=150 width=100 border="0"  tabindex="2">
									...
									<td width="80px" bgcolor="#ffffff" align="center">
			                            <object id=TEMP_MIN classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style="position:relative;left:0px;top:2px;width:30px; height:17px;"  tabindex="3">
			                                <param name=Text        value="">
									...
									<td width="80px" class="text"  rowspan="2" >공정율</td>
									<td width="60px" class="text" >계획</td>
									<td width="80px" bgcolor="#ffffff" align="center">
			                            <object id=RATE_PLAN classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style="position:relative;left:0px;top:2px;width:40px; height:17px;" tabindex="5">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Numeric  	value="true">
			                                	<param name=MaxLength	value=3>
								...
								<tr height="21px">
									...
									<td width="80px" bgcolor="#ffffff" align="center">
			                            <object id=TEMP_MAX classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style="position:relative;left:0px;top:2px;width:30px; height:17px;"  tabindex="4">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Numeric  	value="true">
			                                	<param name=MaxLength	value=3>
									...
									<td bgcolor="#ffffff" align="center">
			                            <object id=RATE_RESULT classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style="position:relative;left:0px;top:2px;width:40px; height:17px;" tabindex="6">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=2>
			                                <param name=Numeric  	value="true">
			                                	<param name=MaxLength	value=3>
                    ...
                    <tr>
                        <td valign='top'><br>
							<table border="0" cellpadding="0" cellspacing="1" bgcolor="#666666" align="right">
								<tr height="21px">
									<td colspan="2" class="text">인원/기계</td>
									<td colspan="2" class="text">주요작업</td>
									<td width="150px" rowspan="2" class="text">비고</td>
								</tr>
								<tr height="21px">
									<td width="100px" class="text" >전일</td>
									<td width="100px" class="text" >금일</td>
									<td width="267px" class="text" >전일</td>
									<td width="267px" class="text" >금일</td>
								</tr>
								<tr height="50px">
									<td bgcolor="#ffffff" align="center">
			                            <object id=man_pre classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style= "position:relative;left:0px;top:0px;width:30px; height:17px;" tabindex="7">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                            ...
			                            <object id=machine_pre classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style= "position:relative;left:0px;top:0px;width:30px; height:17px;" tabindex="8">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="000">
			                                <param name=Cursor      value="iBeam">
									...
									<td bgcolor="#ffffff" align="center">
			                            <object id=man_now classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style= "position:relative;left:0px;top:0px;width:30px; height:17px;" tabindex="9">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="000">
			                                <param name=Cursor      value="iBeam">
			                            ...
			                            <span style= "position:relative;left:0px;top:0px;width:10px; height:17px;">&nbsp;/&nbsp;</span>
			                            <object id=machine_now classid=<%=HDConstant.MxMaskEditU_CLSID_S%> class="textbox" style= "position:relative;left:0px;top:0px;width:30px; height:17px;"  tabindex="10">
			                                <param name=Text        value="">
			                                <param name=Alignment   value=1>
			                                <param name=Format      value="000">
			                                <param name=Cursor      value="iBeam">
                    ...
                    <tr>
                        ...
                        <object id=gr_wd classid=<%=HDConstant.MxGridU_CLSID_S%> width='888px' height='200px' border='1'>
                            ...
                            <param name="Format"            value="
                                 ...
                                 <C> name='금일작업'	ID='WD_NOW'   	width=382 	align=left	Edit=true  multiline=true</C>
                                 <C> name='명일작업'    ID='WD_POST'	width=382 	align=left	Edit=true  multiline=true</C>
                         ">                             
                        </object>                        
                        </td>
                    </tr>
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="1" align="right">
                          ...
                          <tr>
                          	<td valign='top'>
		                        <object id=gr_detail1 classid=<%=HDConstant.MxGridU_CLSID_S%> width='270px' height='100px' border='1'>
		                            ...
		                            <param name="Format"            value="
										<G> name='인원'
		                                 <C> name='회사'		ID='BP_NM'  width=80 	align=left  EditStyle=popup</C>
		                                 ...
		                                 <C> name='금일'    	ID='NOW_COMMIT'		width=50 	align=CENTER	Edit=true</C>
		                                 <C> name='누계'    	ID='TOT_COMMIT'		width=60 	align=CENTER	Edit=None</C>
										</G>
		                         ">
		                        </object>   
                          	</td>
                          	<td></td>
                          	<td valign='top'>
		                        <object id=gr_detail2 classid=<%=HDConstant.MxGridU_CLSID_S%> width='270px' height='100px' border='1'>
		                            ...
		                            <param name="Format"            value="
										<G> name='장비'
		                                 <C> name='장비'		ID='ITEM_NM_S'		width=80 	align=left		 EditStyle=popup</C>
                          	...
                          	<td></td>
                          	<td valign='top'>
		                        <object id=gr_detail3 classid=<%=HDConstant.MxGridU_CLSID_S%> width='330px' height='100px' border='1'>
		                            ...
		                            <param name="Format"            value="
										<G> name='주요자재'
		                                 <C> name='품명'		ID='ITEM_NM'		width=80 	align=left   EditStyle=popup</C>
