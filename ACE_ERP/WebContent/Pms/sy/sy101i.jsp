	...
	<script language="javascript">
		...
		function fnAddRowDs2() {
			...
			if (ds2.RowStatus(ds2.RowPosition) == 1 && ds2.namevalue(ds2.rowposition,"detail") == "" && ds2.namevalue(ds2.rowposition,"detail_nm") == "" ) {
					alert('헤더코드 추가 전에는 디테일을 추가할 수 없습니다');
						...
						<table cellpadding="0" cellspacing="0" >
							...
							<tr>
								<td align="left" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									<object classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" id="gr2"  style="WIDTH:690px;HEIGHT:290px" border="1">
										...
										<param name="Format"		value="  
										    <C> name='분류코드' 		ID='head'        Width=60 	align=left editlimit=5 show=true</C>
										    <C> name='코드'       	ID='detail'      Width=70 	align=left editlimit=10 show=true  sort=true</C>
										    <C> name='코드명'    		ID='detail_nm'   Width=170 	align=left editlimit=50 show=true</C>
										    <C> name='속성15'       	ID='item15'      Width=60 	align=left editlimit=50 show=true sort=true</C>
