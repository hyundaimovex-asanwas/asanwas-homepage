...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:360px;border:0 solid #c5c5c5">
	<tr>
	  <td class="tab_a1111" style="width:90px;height:30px;">업체코드명</td>
        ...
        <img src="../img/btn/btn_find.gif" alt="회사명" style="position:relative;left:8px;top:3px;cursor:hand;" onclick="ln_Query()">
		</td>
	</tr>
</table>
		...
		<td colspan="3">
			...
			<OBJECT id=gcgd_disp class="tab_b1111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:360;height:329px;"  >
							...
							<PARAM NAME="Format"			VALUE="  
								<C>ID=VEND_SID  	Name=회사코드 	width=80 	HeadBgColor=#eeeeee align=center sort = true</C>
								<C>ID=VEND_NM		Name=회사명 	  width=200 	HeadBgColor=#eeeeee align=left	 sort = true</C>
								<C>ID=LOCAL_GU_NM		Name=지역 	  width=80 	HeadBgColor=#eeeeee align=left	 sort = true</C>
												">
	    </OBJECT><%=HDConstant.COMMENT_END%>
		</td>
	</tr>
