...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
					...
					<tr valign="top"">
						<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
								  	<C> name='출입경구분'    		ID='CQ_GUBN'   	width=70 	align=center editlimit=50 show=true SumText='총계'</C>
								  	<C> name='목적대분류'	    ID='NORTH_PURPOSE_L_CD'   		width=90	align=left editlimit=30 show=true</C>
					                <C> name='목적중분류'	    ID='NORTH_PURPOSE_S_CD'   		width=90	align=left editlimit=30 show=true SumText=@count</C>
								  	<C> name='목적상세'   			ID='NORTH_PURPOSE'	width=80 	align=center 	editlimit=61 show=true </C>
									<C> name='목적지'   			ID='TARGET_AREA'  	width=60 	align=center 	editlimit=61 show=true </C>
									...
									<C> name='관광구분'   			ID='TOUR_TYPE'  	width=55 	align=center	editlimit=61 show=true </C>
								<C> name='차량승인번호'   		ID='CAR_PERMIT_NO'	width=80	align=left 		editlimit=61 show=false </C>
								<C> name='운전자재외국민여부'   ID='DRIVER_LIVE_OUT_YN'	width=115 align=center 		editlimit=61 show=false </C>
									<C> name='운전자(주민번호)'   	ID='REGI_NO'  		width=100 	align=center 		editlimit=61 show=true </C>
									<C> name='여권번호'   			ID='PASS_NO'  		width=60 	align=center 		editlimit=61 show=true </C>
									...
									<C> name='총기/마약류 소지여부' ID='GUN_YN'  		width=125 	align=center 		editlimit=61 show=true </C>
									<C> name='외지 차량용품 구입외주수리 여부'	ID='OUTSRC_YN'  	width=190 	align=center 	editlimit=61 show=true </C>
									<C> name='적재여부'   			ID='CARGO_YN'  		width=60 	align=center 		editlimit=61 show=true </C>
									<C> name='승무원물품휴대여부'   ID='ITEM_YN'  		width=115 	align=center 		editlimit=61 show=true </C>
	               					">
							</object>   
							<%=HDConstant.COMMENT_END%>	
							</div>
							...
							<object id=gr2 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
									...
									<C> name='적재화물이름'    		ID='FREIGHT_NAME'   		width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재화물수량'    		ID='FREIGHT_AMOUNT'   	width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재화물수량단위'    	ID='FREIGHT_UNIT'   		width=100 	align=center editlimit=50 show=true</C>
		           					">
							</object>   
							<%=HDConstant.COMMENT_END%>	
							</div>
	...
	※ 차량탑승 메뉴에서 <B>운전자가 지정되지 않은 차량</B>은 조회에서 누락됩니다.<br>
