                            ...
                            <table border='0' cellpadding="0" cellspacing="1" width="845" bgcolor="#666666">
                                ...
                                <tr>
                                    ...
                                    <td align=left bgcolor="#ffffff" valign="middle" colspan=5>&nbsp;
                                        <input type="text" name="barcoding" id=barcoding value="" maxlength="12"  onkeyup="fnBarcoding();">
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td width='845'>
                            ...
                            <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='380px' border='1'>
                                ...
                                <param name="Format"            value="
                                    ...
                                    <C> name='출입경 비고사항'	ID='REMARKS'    width=300 align=left Edit=Any EditLimit='24'</C>
                                 ">
                            </object>
                            <%=HDConstant.COMMENT_END%>     
                        </td>
