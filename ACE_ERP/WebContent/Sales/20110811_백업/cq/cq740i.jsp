...
%>		
		...
		function fnApply() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_CQ%>Cq740I",
			    "JSP(I:DS1=ds1)",
			    param);
...
%>
	...
	<script language="javascript"  for=gr1 event=OnClick(row,colid)>
	    if(row==0 && colid=="close_yn"){
	        for(var i=1; i<=ds1.CountRow; i++){
	            ds1.NameValue(i, "close_yn") = ds1.NameValue(1, "close_yn");
	        }
	    }
   </script>
<%
					...
					<tr height="30px">
						<td width=545>
							<table border='0' cellpadding="0" cellspacing="1" width="345" bgcolor="#666666">
								<tr>
									<td align=left class="text"  width="110">입경일자</td>
						...
						<td width='845'>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
								  <C> name='입경일자'    	ID='caln_date'   		width=100 	align=center 	edit=none		editlimit=8 mask=XXXX-XX-XX show=true</C>
