...
%>		
	...
	function fnInit(){
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_CU%>Cu010Ipm",
			"JSP(O:CUST_TYPE=initds7,O:SAUP=initds8,O:BUY_TYPE=initds9,O:CU019=initds10,O:CU020=initds11)",
            "proType=<%=HDConstant.PROCESS_TYPE_INIT%>,dsType=1");
        tr_post(tr1);
				...
				<tr width="560px" bgcolor="#ffffff">
				  <td width="90px" bgcolor="#ffffff" valign=top>
					...
					<table border="0" cellpadding="0" cellspacing="1" width="103px" bgcolor="#666666">
					  ...
					  <tr bgcolor="#ffffff">
						<td align=center height='25px' class='boardt02' onclick="fnUploadPop_employ()" style="cursor:hand">[재직증명서]</td>
					  </tr>
					  <tr bgcolor="#ffffff">
					  ...
					  <tr bgcolor="#ffffff">
						<td align=center height='25' class='boardt02' onclick="fnUploadPop_pass()" style="cursor:hand">[여권사본]</td>
					  </tr>
					  <tr bgcolor="#ffffff">
					...
					<table border="0" cellpadding="0" cellspacing="1" width="455px" bgcolor="#666666">
					  ...
					  <tr>
						...
						<td bgcolor='#ffffff' colspan="3">&nbsp;&nbsp;
                        	<input type=text name=txt_address1 id=txt_address1 size=50 class="textbox" OnKeyUp="cfLengthCheck(this, 60);">
						</td>
					  </tr>																																																						
					  <tr id=inner_person style="display:inline">
