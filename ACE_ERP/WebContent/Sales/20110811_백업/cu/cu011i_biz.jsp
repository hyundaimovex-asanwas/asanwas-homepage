...
<!--------------------------------- 코딩 부분 시작 ------------------------------->										
  ...
  <table border="0" width="845px"  cellpadding="0" cellspacing="0">
		  ...
		  <tr valign="top"">
			...
			<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:380" border="1" >
				...
				<param name="Format" 			value="
			    	...
			    	<C> name='사진명단 제출여부√'	ID='VISIT_K_LIST'	width=140   align=CENTER	editlimit=20 show=true  editstyle=lookup  data='lkDS_visit_k_list:detail:detail_nm'</C>
	...
	<tr>
	  ...
	  　 [방북신청현황], [확정명단(사업자)]에서 보이는 숫자보다 일반적으로 많아야 정상입니다.
	  </td>
	</tr>
