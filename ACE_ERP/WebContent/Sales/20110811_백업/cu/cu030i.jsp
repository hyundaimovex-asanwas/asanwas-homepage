...
%>
	...
	%>		
 		<script language=JavaScript  for=ds1 event="OnLoadError()">
			...
			window.status="<%=HDConstant.AS_MSG_SEARCH_ERR%>";			fnHideLoading();
		</script>
	<%
	///////////////////////////////////////////////////////////////////////////////
	  ...
	  <table  cellpadding="0" cellspacing="0" border="0">
		<tr> 
			...
			<table  border="0" cellpadding="0" cellspacing="1" bgcolor="#666666" width="500px">
			  <tr> 
				...
				<td align="center" bgcolor="#ffffff"><nobr>
					...
					<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="영업담당자를 검색합니다" style="cursor:hand;position:relative;left:0px;top:1px" align=center onclick="fnPopup('1');">
		  ...
		  <td width="325" align="right"><table  cellpadding="0" cellspacing="0" border="0"><nobr>
			...
			<img src="<%=dirPath%>/Sales/images/plus.gif"	 style="cursor:hand;position:relative;left:3px;top:3px"  onClick="fnAddRowDs1()" >
			<img src="<%=dirPath%>/Sales/images/minus.gif" style="cursor:hand;position:relative;left:3px;top:3px" onClick="fnDeleteRowDs1()" >
			<img src="<%=dirPath%>/Sales/images/save.gif"	style="cursor:hand;position:relative;left:3px;top:3px" onClick="fnApply()">
			<img src="<%=dirPath%>/Sales/images/cancel.gif"	style="cursor:hand;position:relative;left:3px;top:3px" onClick="fnCancelDs1()"></nobr>
		  </td>
		</tr>
	  </table>	
	</td>
		  ...
		  <td valign=top>
			<table  border="0" cellpadding="0" cellspacing="1" bgcolor="#666666" width="610px">
			  ...
			  <tr>
				...
				<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="우편변호를 검색합니다" style="cursor:hand;position:relative;left:-5px;top:1px" align=center onclick="fnPopup('2');">
				</td>
				...
				<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="지역코드를 검색합니다" style="cursor:hand;position:relative;left:-5px;top:1px" align=center onclick="fnPopup('3');">
			  ...
			  <tr>
				...
				<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="영업담당자를 검색합니다" style="cursor:hand;position:relative;left:-5px;top:1px" align=center onclick="fnPopup('4');">
...
%>
     ...
     <object id=bn1 classid=<%=HDConstant.CT_BINDER_CLASSID%>>
 	 ...
 	 <C>Col=address2               Ctrl=txt_address2             Param=value</C>
  	 <C>Col=desc                   Ctrl=txt_desc                 Param=value</C>
