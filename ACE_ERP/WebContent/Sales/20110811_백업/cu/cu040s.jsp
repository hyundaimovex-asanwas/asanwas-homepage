...
%>		
		...
		function fnOnLoad(tree_idx){
			...
			cfStyleGrid(getObjectFirst("gr1"), "comn");	//그리드 스타일 적용
			fnInit(); 
		} 
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").GridToExcel("대리점 조회", "대리점 조회.xls", 8);
									...
									<td>
										...
										<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='430px' border='1'>
											...
											<param name="Format" 			value="
									                ...
									                <FC> name='대리점코드'    		ID='client_cd'   		width=100  align=center editlimit=5 show=true (FixedColumn) sort=true</FC>
									                <FC> name='거래처코드'      	ID='vend_cd'     		width=100	  align=right editlimit=13 show=true (FixedColumn)</FC>
									                <C> name='대리점명'    		ID='client_nm'   		width=150  align=left editlimit=30 show=true</C>
									                <C> name='구분' 				ID='agen_gu_name'       width=40  align=center editlimit=50 show=true</C>
									                ...
									                <C> name='수수료율'   		ID='commi_rate'  		width=80  align=right editlimit=7 show=true</C>
									                <C> name='계약'     			ID='cunt_status_name'   width=160  align=left editlimit=50 show=true</C>
									                ...
									                <C> name='휴대전화'    		ID='mobile_no'   		width=120  align=left editlimit=15 show=true</C>
									                ...
									                <C> name='계약일자'    		ID='cont_date'   		width=120  align=center editlimit=8 show=true</C>
									                <C> name='만기일자'  			ID='expire_date'        width=60  align=center editlimit=8 show=true</C>
									                <C> name='보증보험회사명'   	ID='insur_comp_cd_name' width=150  align=left editlimit=50 show=true</C>
