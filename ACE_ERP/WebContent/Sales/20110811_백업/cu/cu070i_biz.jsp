...
%>		
	...
	function fnEducDate() {	
		ln_TRSetting(tr1, 
            	"<%=dirPath%><%=HDConstant.PATH_CU%>Cu070I",
		...
		<td valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="1" width="840px" bgcolor="#666666">
				<tr height='25px'>
					...
					<td width='100px' class='text'>교육예정일자</td>
					<td bgcolor="#ffffff"><nobr>&nbsp;
	 					<%=HDConstant.COMMENT_START%>
						<object id=txt_educ_plan_dt classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=150 width=100 border="0" align=absmiddle>
							<param name=ComboDataID		value=codeDs1>
							<param name=SearchColumn	value="title_nm">
							<param name=EditExprFormat	value="% %;caln_date,title_nm">
							<param name=ListExprFormat  value="title_nm^0^100">
						</object>
						<%=HDConstant.COMMENT_END%>	
					</td>
	...
	<tr>
		<td width="100%">
			<table  border="0" cellpadding="0" cellspacing="0" width="100%" >
								...
								<td>
									...
									<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=840px; height:300px" border="1">
                                        ...
                                        <param name="Format"            value=" 
									        ...
									        <C> name='교육예정일자'		ID='educ_plan_dt'   Width=80  	align=center editstyle=lookup data='codeDs1:caln_date:title_nm' BgColor=#fefec0</C>
				...
				<tr>
					<td>※ 교육을 듣지 않은 <b>사업자</b>는 누구나 신청가능합니다.<br>
						　<font size=3 color=red><b>방북교육 신청 후 반드시 [방문증명서 발급 신청]을 하셔야 방문증이 발급됩니다.</b></font>
