...
%>		
	...
	function fnInit(){		
		...
		ds8.Reset(); //방북목적		
 		ds9.DataId="<%=dirPath%><%=HDConstant.PATH_HELP%>Sy001H?proType=S&dsType=2&s_Head=CU023";
		ds9.Reset(); //발급상태
...
/*	function fnAddRow() {
		...
		ds1.addRow();
		ds1.namevalue(ds1.rowposition,"req_dt")=txt_req_dt.text;	//출일자
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td>
			<table  border="0" cellpadding="0" cellspacing="1" bgcolor="#666666" width="840px">
				<tr height=25px>
					...
					<td align="left" bgcolor="#ffffff">&nbsp;
                        <%=HDConstant.COMMENT_START%>
                            <object id=txt_educ_dt classid=<%=HDConstant.CT_EMEDIT_CLSID%>   height='16px' width='70px' align='absmiddle' class='textbox'>            
					...
					<td width='100px' class='text'>지역</td>
					<td bgcolor='#ffffff'><nobr>&nbsp;
					    <%=HDConstant.COMMENT_START%>
						<object id=drp_saup_sid_s classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=120 width=150 border="0" align=absmiddle>
							<param name=ComboDataID		value=ds4>
	                        <param name=BindColumn      value="saup_sid">
	                        <param name=BindColVal      value="saup_nm">
	...
	<tr>
		<td valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="1" width="840px" bgcolor="#666666">
				<tr height='25px'>
					<td width=20px align=center rowspan=2 bgcolor="#303030" style="color:#ffffff;weight:heavy;">세<br>팅</td>
					<td width='100px' class='text'>신청일자</td>
					<td bgcolor="#ffffff">&nbsp;
					<%=HDConstant.COMMENT_START%>
 					<object id=txt_req_dt classid=<%=HDConstant.CT_EMEDIT_CLSID%>   height='16px' width='70px' align='absmiddle' class='textbox'>            
  						<param name=Format      value="YYYY-MM-DD">
   						<PARAM NAME=InputFormat value="YYYYMMDD">
   						<param name=Alignment   value=1>
   						<param name=ClipMode    value=true>
				...
				<tr height='25px'>
					<td align="center" class="text" >방북작업구분</td>
					<td align="left" bgcolor="#ffffff">&nbsp;
					   <%=HDConstant.COMMENT_START%>
	...
	<tr>
		<td width="100%">
			<table  border="0" cellpadding="0" cellspacing="0" width="100%" >
					...
					<td  valign="top">
						<table border="0" cellpadding="0" cellspacing="0" width="840px" >
							<tr>
								<td>
									<%=HDConstant.COMMENT_START%>
									<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=840px; height:300px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <FC> name='성명'			ID='cust_nm'        Width=60 align=left editstyle=popup sumtext=계 edit=none</FC>
									        ...
									        <C> name='교육예정일자'		ID='educ_plan_dt'   Width=80  	align=center edit=none</C>
									        <C> name='교육유무'			ID='n_educ_yn'     	Width=60  align=center editstyle=lookup data='ds3:detail:detail_nm' edit=none</C>
									        <C> name='작업구분'			ID='n_job_gu'    	Width=90  align=center editstyle=lookup data='ds2:detail:detail_nm' BgColor=#fefec0</C>
                                            <C> name='발급상태'			ID='n_card_yn'    	Width=60  align=center editstyle=lookup data='ds9:detail:detail_nm' edit=none</C>
                                            ...
                                            <C> name='educ_sid'			ID='educ_card_sid'	Width=120  	align=Left edit=true show=false</C>
				...
				<tr>
					<td>※ 방북교육을 받았거나 교육신청이 되어 있는 <b>사업자</b>는 누구나 신청가능합니다.<br>
					　　노랑색 항목만 수정가능합니다.
