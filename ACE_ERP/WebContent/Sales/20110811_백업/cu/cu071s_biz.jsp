 ...
 * [2010-04-06][박경국] 북한방문증명서 발급신청자 명단(방북교육은 통통 온라인 교육으로 진행)
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<script language=JavaScript  for=ds1 event="OnLoadCompleted(row)">
    ...
    if(v_job == "H") { sReqDt.value=ds1.namevalue(row,"req_dt"); return; }
    if( row < 1){
        alert(row + " 검색된 데이타가 없습니다."); 
    }
</script>
                ...
                <tr>
                    <td>
                        <table width=700 border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
                            <tr bgcolor="#6f7f8d">
            					<td height="30px" class="text">신청일자</td>
                                <td align="left" bgcolor="#ffffff">&nbsp;																						
							     <%=HDConstant.COMMENT_START%><object id=sReqDt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=17 width=70 align='absmiddle' class="textbox">			
