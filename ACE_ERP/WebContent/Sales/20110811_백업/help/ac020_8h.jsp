 ...
 * 작 성 자     : 심동현
 * 작 성 일     : 2008-08-13
 * 기능: 출발일별 현황 (가상계좌, 계좌이체)SUB
 * [ 수정일자 ][수정자] 내용
 * [2008-08-13][심동현] 커리 수정하면서 그리드 수정.
 *****************************************************************************/
%>
...
%>
            ...
            cfStyleGrid(getObjectFirst("gr1"), "comn");
              var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
				...
				ln_TRSetting(tr1, 
				    ...
				    "JSP(O:DS100=ds1)",
				    param);	//서블릿에서는 ds1의 이름으로 호출할 프로시저를 구분한다 
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:보증금대체; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("보증금대체","보증금대체.xls", 8);
		}
        </script>
...
<body border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
	...
	<iframe id="loadingBar" 
        ...
        <table width=98% align=center>
            <tr height=30>
                <td width=50% align=left><img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>보증금 대체</span></td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
							...
							<c> Name='모객율'    	ID='CUST_RATE'      Width=60   align=right  DEC=2</c>
                            <c> Name='입금일자'    	ID='PAY_DATE'     	Width=80   align=center suppress=4 </c>
                            <c> Name='입금자명'    	ID='ORDER_NM'      	Width=80  align=left   suppress=4 </c>
                            <c> Name='블럭번호'    	ID='BLOCK_NO'      	Width=80   align=center</c>	
