...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:가상계좌; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("가상계좌","가상계좌.xls", 8);
		}
        </script>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>가상계좌</span></td>
                        </tr>
                    </table>
                </td>
                <td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                            ...
                            <c> Name='매출액'    	ID='TOUR_AMT'     	Width=100  align=right  dec=0 suppress=3  SumText=@sum SumTextAlign=right</c>
                            <c> Name='입금일자'     	ID='PAY_DATE'     	Width=100  align=right  dec=0</c>
                            <c> Name='입금자'     	ID='U_EMPNO'      	Width=100  align=left  	dec=0</c>
                            ...
                            <c> Name='정산액'     	ID='TOUR_AMT_1'     Width=100  align=right 	dec=0 suppress=4 </c>
