			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:4px;top:7px;width:200px">
						<tr>
							<td align=right>
							    <img src="<%=dirPath%>/Sales/images/save.gif"	 id=app style="cursor:hand;position:relative;left:3px;top:3px;display:none"  onClick="fnApply()">
								<img src="<%=dirPath%>/Sales/images/cancel.gif" id=can style="cursor:hand;position:relative;left:3px;top:3px;display:none"  onclick="fnCancel()">
								<img src="<%=dirPath%>/Sales/images/p_exit.gif"    style="cursor:hand;position:relative;left:3px;top:3px;" onClick="fnClose()">  
							</td>
						</tr>
					</table>
				</td>
