...
%>
        <script language="javascript">
            ...
            function fnSelect() {
                ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Cq002H?proType=S&dsType=1&v_keyword=" + keyword.value ;
                ds1.Reset();
            }
            ...
            function fnAdd() {
                ...
                window.returnValue = ds1.namevalue(row, "CAR_NO") + ";" +
                                     ds1.namevalue(row, "CAR_NM") + ";" +
                                     ds1.namevalue(row, "CAR_SID");
                fnClose();
            }
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center><font style="position:relative;top:1px;width:50;height:15;left:5px;">차량조회</font>
                            </td>
                        </tr>
                        <tr>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='479px' height='248px' border='1'>
                        ...
                        <param name="Format"        value="
                            <c> Name='차량등록번호'        ID='CAR_NO'      Width=200  align=center </c>
                            <c> Name='차명'               ID='CAR_NM'     Width=100</c>
