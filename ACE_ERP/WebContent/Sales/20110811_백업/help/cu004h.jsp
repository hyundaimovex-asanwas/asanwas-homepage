...
%>
		<script language="javascript">
			...
			function fnSubSelect1() {
				ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_HELP%>Cu004H?proType=S&dsType=1&keyWord=" + keyword.value;
				ds1.Reset();
			}
			...
			<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;width:219px;">
						<tr>
							<td colspan=2 height=25>
								<img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <font style="position:relative;top:1px;width:100;height:15;">거래처정보</font>
								<input type="hidden" name="custsid">
							</td>
						</tr>
						<tr>
							<td class="text" width="100px" height="30" style="border:1 solid #708090">거래처명/코드</td>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:4px;top:7px;width:247px">
						<tr>
							<td align=right><img src="<%=dirPath%>/Sales/images/p_find.gif" alt="거래처를 검색합니다" style="position:relative;left:8px;top:0px;cursor:hand;" onclick="fnSelect();">
...
%>
					<comment id="__NSID__"><object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=479px; height:248px;border:1 solid #777777;">
						...
						<param name="Format" 		value="
							<c> Name='거래처 코드'	ID='vend_cd'		HeadAlign=Center HeadBgColor=#B9D4DC Width=120  leftmargin=10 </c>
							<c> Name='거래처 명' 		ID='vend_nm'	  	HeadAlign=Center HeadBgColor=#B9D4DC Width=359 leftmargin=10</c>
						">
