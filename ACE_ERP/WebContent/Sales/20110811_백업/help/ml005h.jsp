 ...
 * 작 성 자     : 심동현
 * 작 성 일     : 2011-01-17
 * 기능정의     : 쇼핑몰 관리자 전용 요금결제 help
 * [수정일자][수정자] 내용
 * [20110117][심동현] 기존 결제창을 이용한 쇼핑몰 관리자 전용 결제 help
...
%>
    <script language="javascript">
         ...
         * 4 : 무통장입금
         * 5 : 기타대체
         * 6 : 신용카드 Online : 직원/대리점 결제
         * 7 : 신용카드 Online Direct : 고객 결제         
         */		
		...
		subimg__a_url[7].src="<%=dirPath%>/Sales/images/ac_08_on.gif";
        ...
        subimg__url[7].src="<%=dirPath%>/Sales/images/ac_08.gif";
...
//alert("strParam : " + strParam + " : " + strParam.length);
		...
		var v_order_no	= strParam[9];       //주문번호	2011-01-19 수정..		
        ...
        function fnOnLoad(){
            ...
            getObjectFirst("v_login_id").value = v_order_no;	// 다이렉트 결제용 : 아이디=주문번호
			getObjectFirst("v_login_pass").value = c_pay_amt;	// 다이렉트 결제용 : 패스워드 = 결제금액^^ㅋㅋ 20110120
        ...
        function fnCardTrans(){
            ...
            if(c_pay_manage_no == "")
                fnGetManageNo(c_pay_amt,c_pay_gubn,"03");
...
//alert(document.acc_frm.action);
        ...
        * 카드결제 Direct
        */
        function fnDirectCardTrans(){

        	if(v_login_id.value==""){
        		alert("아이디 <%=HDConstant.A_MSG_MUST_INPUT%>");
        		return;
        	}
        	if(v_login_pass.valuse=="" || c_pay_date2.Text.trim().length!=8){
        		alert("패스워드 <%=HDConstant.A_MSG_MUST_INPUT%>");
        		return;
        	}

        	c_pay_gubn = "120"; //온라인카드 다이렉트
			...
			v_param = "proType=<%=HDConstant.PROCESS_TYPE_APPLY%>"
                    + ",dsType=1"
                    + ",v_pay_manage_no="+c_pay_manage_no
		            + ",v_login_id=" + v_login_id.value 
		            + ",v_login_pass=" + v_login_pass.value
                    ;
            ln_TRSetting(tr_save2, 
                "<%=dirPath%><%=HDConstant.PATH_HELP%>Ml005H",
                "JSP(I:DIRECT=ds_etc)",
        ...
        //결제 관리 번호 추출 (2011-01-17 새 버젼으로 수정 BY SDH)
        function fnGetManageNo(p_pay_amt, p_pay_cd, p_sales_gubn){
			v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                    + ",dsType=1"
                    + ",v_client_cd="+v_client_cd
		            + ",v_pay_amt_tot=" + p_pay_amt 
		            + ",v_pay_cd=" + p_pay_cd
                    + ",v_sales_gubn=" + p_sales_gubn
                    ;
            ln_TRSetting(tr1, 
                "<%=dirPath%><%=HDConstant.PATH_HELP%>Ml005H",
                            ...
                            <td width="83" valign="top">
                                <table width="83" border="0" cellspacing="0" cellpadding="0" align=center>
                                    <tr id="tr_ac_0" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_01_on.gif" name="ac_0" onMouseOver="changesub(0)" onMouseOut="changesubout(0)" style="cursor:hand;display:inline" onClick="changesubclick(0),fnOnChangTab(0)"></td>
                                    </tr>
                                    <tr id="tr_ac_1" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_02.gif" name="ac_1" onMouseOver="changesub(1)" onMouseOut="changesubout(1)" style="cursor:hand;display:inline" onClick="changesubclick(1),fnOnChangTab(1)"></td>
                                    </tr>
                                    <tr id="tr_ac_2" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_03.gif" name="ac_2" onMouseOver="changesub(2)" onMouseOut="changesubout(2)" style="cursor:hand;display:inline" onClick="changesubclick(2),fnOnChangTab(2)"></td>
                                    </tr>
                                    <tr id="tr_ac_3" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_04.gif" name="ac_3" onMouseOver="changesub(3)" onMouseOut="changesubout(3)" style="cursor:hand;display:inline" onClick="changesubclick(3),fnOnChangTab(3)"></td>
                                    </tr>
                                    <tr id="tr_ac_4" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_05.gif" name="ac_4" onMouseOver="changesub(4)" onMouseOut="changesubout(4)" style="cursor:hand;display:inline" onClick="changesubclick(4),fnOnChangTab(4)"></td>
                                    </tr>
                                    <tr id="tr_ac_5" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_06.gif" name="ac_5" onMouseOver="changesub(5)" onMouseOut="changesubout(5)" style="cursor:hand;display:inline" onClick="changesubclick(5),fnOnChangTab(5)"></td>
                                    </tr>
                                    <tr id="tr_ac_6" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_07.gif" name="ac_6" onMouseOver="changesub(6)" onMouseOut="changesubout(6)" style="cursor:hand;display:inline" onClick="changesubclick(6),fnOnChangTab(6)"></td>
                                    </tr>
                                    <tr id="tr_ac_7" style="display:inline">
                                        <td height="45"><img src="<%=dirPath%>/Sales/images/ac_08.gif" name="ac_7" onMouseOver="changesub(7)" onMouseOut="changesubout(7)" style="cursor:hand;display:inline" onClick="changesubclick(7),fnOnChangTab(7)"></td>
                                    </tr>
                                </table>
                            </td>
                            <td width=5></td>
                                    ...
                                    <tr>
                                        ...
                                        ---------------------------------------------------------------------------->
                                            <table width="770" border="0" cellspacing="0" cellpadding="0" align="center" id="ac" style="display:none">
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#FFFFCC">&nbsp;&nbsp;<%=HDConstant.COMMENT_START%>
                                        ...
                                        ---------------------------------------------------------------------------->
                                            ...
                                            <table width="770" border="0" cellspacing="0" cellpadding="0" align="center" id="ac" style="display:none">
                                                <tr>
                                                    ...
                                                    <td width="70" height="30" align="center">결제금액</td>
                                                    <td width=230 bgcolor="#FFFFCC">&nbsp;&nbsp;<%=HDConstant.COMMENT_START%>
                                                        <object id=c_pay_amt classid=<%=HDConstant.CT_EMEDIT_CLSID%> height='16px' width='100px' align='absmiddle' class='textbox'>            
                                                            <param name=Alignment   value=1>
                                                            <param name=ClipMode    value=true>
                                                            <param name=Border      value=false>
                                                ...
                                                <tr height="30">
                                                    <td align="right">
                                                        <table width="270" height="30" border="0" cellpadding="0" cellspacing="0" >
                                                            <tr>
                                                                <td align="right"><img src="<%=dirPath%>/Sales/images/add.gif" style="cursor:hand" onClick="fnGiftAdd()"></td>
                                                                <td width="60" align="right"><img src="<%=dirPath%>/Sales/images/delete.gif" style="cursor:hand" onClick="fnGiftDel()"></td>
                                                                <td width="68" align="center"><img src="<%=dirPath%>/Sales/images/cancel.gif" style="cursor:hand" onClick="fnGiftCancel()"></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                		...
                                                		<table width=100%>
                                                		   <tr>
																...
																<td >&nbsp;<input name="v_bank_acc_no" id="v_bank_acc_no" type="text" style="width:130px;" class="textbox" readOnly>
			                                                    	<img src="<%=dirPath%>/Sales/images/help.gif" style="cursor:hand" align='absmiddle' onClick="fnBankAccountPopup()">
			                                                    </td>
            			                                        ...
            			                                        <td colspan=2 align="right" ><img src="<%=dirPath%>/Sales/images/refer.gif" style="cursor:hand" onClick="fnSelect()"></td>
                        			                        </tr>
															<tr>
                                        ...
                                        ---------------------------------------------------------------------------->
                                            <table width="770" border="0" cellspacing="0" cellpadding="0" align="center" id="ac" style="display:none">
                                                <tr>
                                                    <td width=30><img src="<%=dirPath%>/Sales/images/red_dot01.gif"></td>                                       
                                                    <td width="70" height="30" align="center">접속경로</td>
                                                    <td width=300 bgcolor="#FFFFCC">&nbsp;&nbsp;<input name="v_ADDR" id="v_ADDR" value="https://com.hdasan.com/shop_login.asp" type="text" style="width:250px;"  class="textbox" readonly></td>
	                                                <td rowspan=4>일반적인 온라인 신용카드 결제방식입니다.<br><br>
	                                                	
	                                                	<b><font color="red">카드전표 증빙</font></b>을 원하는 고객에게<br>
	                                                	옆의 로그인 아이디와 패스워드로<br>
	                                                	경로로 접속 안내합니다.<br><br>
	                                                	
	                                                	로그인하면 고객이 장바구니를 확인 후 <br>
	                                                	직접 온라인카드 결제를 진행하고<br>
	                                                	신용카드 전표를 출력할 수 있습니다.<br><br>
	                                                	
	                                                	<B>아이디=주문번호, 패스워드=결제금액</B> 입니다.
	                                                </td>
                                                </tr>
                                                <tr>
                                                    <td width=30><img src="<%=dirPath%>/Sales/images/red_dot01.gif"></td>                                       
                                                    <td width="70" height="30" align="center">아 이 디</td>
                                                    <td width=300 bgcolor="#FFFFCC">&nbsp;&nbsp;<input name="v_login_id" id="v_login_id" type="text" style="width:100px;" maxlength=12 class="textbox" ></td>
                                                </tr>
                                                <tr>
                                                    <td width=30><img src="<%=dirPath%>/Sales/images/red_dot01.gif"></td>                                       
                                                    <td width="70" height="30" align="center">패스워드</td>
                                                    <td width=300 bgcolor="#FFFFCC">&nbsp;&nbsp;<input name="v_login_pass" id="v_login_pass" type="text" style="width:100px;" maxlength=12 class="textbox" ></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="<%=dirPath%>/Sales/images/red_dot01.gif"></td>                                       
                                                    <td width="70" height="30" align="center">결제금액</td>
                    ...
                    <table width="100%" height="35" bgcolor="#66CCFF">
                        <tr>
                            ...
                            <%
                                if(v_card_no.equals("")){
                            %>
                                <img name=ac_btn_0 id=ac_btn_0 style="display:none; Cursor:hand" onClick="fnNonAccountTrans()"  src="<%=dirPath%>/Sales/images/create.gif">
                                <img name=ac_btn_1 id=ac_btn_1 style="display:none; Cursor:hand" onClick="fnAccountTrans()" src="<%=dirPath%>/Sales/images/acc_transfer.gif">
                                <img name=ac_btn_2 id=ac_btn_2 style="display:none; Cursor:hand" onClick="fnCardTrans()"  src="<%=dirPath%>/Sales/images/account.gif">
                                <img name=ac_btn_3 id=ac_btn_3 style="display:none; Cursor:hand" onClick="fnGiftTrans()"  src="<%=dirPath%>/Sales/images/account.gif">
                                <img name=ac_btn_4 id=ac_btn_4 style="display:none; Cursor:hand" onClick="fnTongJangTrans()"  src="<%=dirPath%>/Sales/images/account.gif">
                                <img name=ac_btn_5 id=ac_btn_5 style="display:none; Cursor:hand" onClick="fnEtcTrans()"  src="<%=dirPath%>/Sales/images/account.gif">
                                <img name=ac_btn_6 id=ac_btn_6 style="display:none; Cursor:hand" onClick="fnEtcTrans()"  src="<%=dirPath%>/Sales/images/account.gif">
                                <img name=ac_btn_7 id=ac_btn_7 style="display:none; Cursor:hand" onClick="fnDirectCardTrans()"  src="<%=dirPath%>/Sales/images/b_ok.gif">                                
                            <%
                                } else {
                            %>
                                <img name=ac_btn_2 id=ac_btn_2 style="display:none; Cursor:hand" onClick="fnCardCancel()"  src="<%=dirPath%>/Sales/images/adm_cancel.gif">
                            <%
                                }
                            %>
                            </td>
            ...
            <tr>
                <td><br><h3>　　※ 안정적인 결제 진행을 위해 다른 마우스나 키보드 조작은 잠시 멈춰주시기 바랍니다.</h3>
                    <form name="acc_frm" method=post target="acc_iframe">
                        ...
                        <input type=hidden name="c_return_url" value="<%=HDConstant.KCP_RETURN_URL_MALL%>">
