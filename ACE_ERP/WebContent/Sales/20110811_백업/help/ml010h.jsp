...
%>
	function fnCustPopup() {
		...
		strPos = "dialogWidth:410px;dialogHeight:450px;status:no;scroll:no;resizable:no";
		 ...
		 function fnAdd() {
					...
					window.returnValue =
									     ...
									     ds1.namevalue(row, "MOBILE_NO")		+";"+ 
		   							     ...
		   							     ds1.namevalue(row, "ORDERER_COMPANY")				+";"+ 
    ...
    <param name="Parameters" value="">
	  ...
	  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
		<table border="0" cellpadding="0" cellspacing="0" width='500px' style="position:relative;top:1px;width:50;height:15;left:3;">
			<tr>
				<td align='center' width='500px' colspan='6'>
					<table  border="0" cellpadding="0" cellspacing="0" width='500px'>
						<tr>
							<td colspan=6 height=25 width="500px" align=left>
						...
						<tr>
							<td width=500 colspan="6">
								<table  border="0" cellpadding="0" cellspacing="0" width='500px' align="right">
									<tr>									
						...
						<tr>
							<td align=left class="text" border='1' cellspacing="1">주문자</td>
							...
							<td align=left class="text">핸드폰번호</td>
							<td align=left bgcolor="#ffffff"><input id="Mobile_No" type="text" class="txtbox" size=15 maxlength="100" onkeydown="if(event.keyCode==13) fnSelect();"></td>	
						</tr>								
						</tr>
					<tr height="5px" >
				<td colspan='4'></td>
			...
			%>
								<%=HDConstant.COMMENT_START%>
								<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=515px; height:450px;" border="1">
									...
									<param name="Format" 		value="
										    ...
										    <FC> name='주문자'   ID='USER_NM'      Width=100   align=center     editlimit=20  Sort=True</FC>
                                            <FC> name='핸드폰'   ID='MOBILE_NO'   Width=90   align=left      	editlimit=20 </FC>
                                            <C> name='전화번호'  ID='TEL_NO'      	Width=90   align=left      	editlimit=20</C>
                                            <C> name='소속'  ID='ORDERER_COMPANY'      	Width=115   align=left      	editlimit=50</C>
                                            <C> name='유치자'     ID='EMPNO'         Width=100   align=center     editlimit=20  EditStyle=popup</C>
    					                ">
								</object>
								<%=HDConstant.COMMENT_END%>
							</td>
