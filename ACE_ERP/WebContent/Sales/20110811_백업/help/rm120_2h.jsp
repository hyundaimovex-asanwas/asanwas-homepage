...
<%
	...
	StringUtil.printMsg("방상태 ==> " , sRoomStatus, this);
	StringUtil.printMsg("방번호 ==> " , sKeySeq, this);
...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").GridToExcel("블럭예약","블럭예약.xls", 8);
		}
        </script>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width=200>
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>블럭예약</span></td>
                        </tr>
                    </table>
                </td>
                <td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
							...
							<C> name='TXT2'	ID='txt2'	 width=100 align=left editlimit=20 show=true</C>
							<C> name='TXT3'	ID='txt3'	 width=150 align=left editlimit=19 show=true</C>
							<C> name='TXT4'	ID='txt4'	 width=150 align=left editlimit=55 show=true</C>
							<C> name='TXT5'	ID='txt5'	 width=170 align=left editlimit=27 show=true</C>
							<C> name='TXT6'	ID='txt6'	 width=170 align=left editlimit=52 show=true</C>
							<C> name='TXT7'	ID='txt7'	 width=100 align=left editlimit=50 show=true</C>
