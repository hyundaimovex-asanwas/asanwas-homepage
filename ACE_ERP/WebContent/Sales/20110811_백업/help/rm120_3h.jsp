...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").GridToExcel("일반예약","일반예약.xls", 8);
		}
        </script>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width=200>
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>일반예약</span></td>
                        </tr>
                    </table>
                </td>
                <td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                    		<C> name='TXT1'	ID='txt1'	 width=150 align=left editlimit=79 show=true</C>
							...
							<C> name='TXT5'	ID='txt5'	 width=150 align=left editlimit=27 show=true</C>
							<C> name='TXT6'	ID='txt6'	 width=150 align=left editlimit=52 show=true</C>
							<C> name='TXT7'	ID='txt7'	 width=150 align=left editlimit=50 show=true</C>
