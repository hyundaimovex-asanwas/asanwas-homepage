  ...
  <tr>
	<td align=center>
					...
					<table width=300 border="0" cellspacing="0" cellpadding="0" bgcolor="#fdfde7">
						<tr height=30>
							<td background="<%=dirPath%>/Sales/images/map/w_bg.gif" align="center">고장객실 <!-- <input type=text  id=box_txt1 style="border:0 solid #ffffff;font-size:14px;font-weight:bold;color:white;width:100%;text-align:center;background:#73be10;">--></td>	
						</tr>
						<tr>
							<td height="5"></td>
						</tr>
									...
									<tr>
										...
										<td bgcolor="#FFFFFF" align=center>
											<table width="90%" height="110" border="0" cellspacing="0" cellpadding="0">
												...
												<tr height=26>
													<td align="center" colspan=3><TEXTAREA id=box_txt5 style="border:1 solid #999999;font-size:12px;width:90%;height:50px;"></TEXTAREA>
														<%
														/*---------------------------------------------------------------------------->
															Object ID   : 그리드 , gr1
															Data ID     : ds1
														...
														%>
														<%=HDConstant.COMMENT_START%>
														<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='94%' height='100px' border=1 STYLE="DISPLAY:NONE;">
