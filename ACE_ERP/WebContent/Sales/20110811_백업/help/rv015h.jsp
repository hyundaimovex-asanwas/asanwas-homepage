...
%>          
       <script language=JavaScript for=ds1 event=OnLoadCompleted(rowcnt)>
            ...
            acc_cd.value = ds1.namevalue(1,"acc_cd");
...
<!--  BODY START -->
    <body border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
       ...
       <table width="300" height="320" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:4px;top:10px">
			...
			<tr>
	            <td height=25>
	                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align='absmiddle'><font style="position:relative;top:1px;width:60;height:15;left:5px;">기타대체</font>
	            </td>
	        </tr>
			<tr>
				<td height="3" bgcolor="#35ace8"></td>
                ...
                <td align="center" background="<%=dirPath%>/Sales/images/c_bg.gif" valign="top">
					<table width="90%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td width="110" height="22" align="left">계정과목</td>
