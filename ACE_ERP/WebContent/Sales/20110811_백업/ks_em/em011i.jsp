...
function ln_Query(){
	...
	gcds_data01.DataID = "<%=dirPath%><%=HDConstant.PATH_EM%>Em011_S1?"
											 + "v_str1="+gclx_team_cd_s.bindcolval 
											 + "&v_str2="+fn_trim(txt_empno.value) 
											 + "&v_str3="+fn_trim(txt_empnmk.value)
                       + "&v_str4="+gclx_dept_cd_s.bindcolval
											 + "&v_str5="+chk_s.value;
	gcds_data01.Reset();
			...
			<table cellpadding=0 cellspacing=1 style="width:824px;height:20px;" bgcolor="#708090">
				<tr>
				  <td bgcolor="#eeeeee" width="70" align = center>부서</td>
					<td bgcolor="#FFFFFF">
						<%=HDConstant.COMMENT_START%>
						<object id=gclx_dept_cd_s classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69
			...
			<td>
				<table cellpadding=0 cellspacing=1 style="width:290px;">
                    ...
                    <input type="text"		 id=chknm2 value="직종선택"  style="position:relative;top:-4px;width:55px;border-width:0px" >
										...
										<table cellpadding=0 cellspacing=1 style="width:410px;height:100px;" bgcolor="#708090">
											<tr height="22">
												...
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
														<object id=gclx_ord_cd classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69
														style="position:relative;left:8px;top:1px;font-size:12px;width:120px;" >
														<param name=ComboDataID			value="gcds_cm012">
														<param name=CBDataColumns		value="COM_CODE, COM_SNAME">
														<param name=SearchColumn		value=COM_SNAME>
														<param name=Sort				    value=false>
												...
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
														<OBJECT id=gcem_ord_dt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  tabindex="1"
											...
											<tr height="22">
												...
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
														...
														style="position:relative;left:8px;top:1px;font-size:12px;width:120px;height:300px" >
											...
											<tr height="22">
												...
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
														...
														style="position:relative;left:8px;top:3px;font-size:12px;width:50px;" >
														<param name=ComboDataID			value="gcds_cm032">
														<param name=CBDataColumns		value="COM_CODE, COM_SNAME">
														<param name=SearchColumn		value=COM_SNAME>
														<param name=Sort				    value=false>
														<param name=ListExprFormat	value="COM_SNAME^0^45 ">
														<param name=BindColumn			value=COM_CODE>
														</object></comment>	<script>__ws__(__NSID__);</script>
														<input type="checkbox" id=blchk   value=""            style="position:relative;left:10px;top:-2px;cursor:hand;width:22px" onClick="ln_ChkBox_Chk(3)">
                            <input type="text"		 id=blchknm value="BLACK LIST"  style="position:relative;left:2px;top:-2px;width:65px;border-width:0px" >
												</td>
											</tr>
											<tr height="22">
												<td bgcolor="#eeeeee" align="center">발령직종</td>
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
														<object id=gclx_job_cd classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69
														style="position:relative;left:8px;top:1px;font-size:12px;width:120px;" >
														<param name=ComboDataID			value="gcds_cm004">
														<param name=CBDataColumns		value="ITEM2,COM_CODE,COM_SNAME">
														<param name=SearchColumn		value="COM_SNAME">
														<param name=Sort				    value=false>
														<param name=ListExprFormat	value="ITEM2^0^50,COM_SNAME^0^120">
														<param name=BindColumn			value=COM_CODE>
														</object></comment>	<script>__ws__(__NSID__);</script>
												</td>
												<td bgcolor="#eeeeee" align="center">기능구분</td>
												<td bgcolor="#FFFFFF"><%=HDConstant.COMMENT_START%>
								...
								<tr>
									<td>
										<table cellpadding=0 cellspacing=1  style="width:390px;height:272px;" bgcolor="#708090">
											<tr>
												<td bgcolor="#FFFFFF">
													<%=HDConstant.COMMENT_START%>
                          ...
                          <C>ID=RETGB,    Name=귀국   	  width=70,  HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=left, sort = true EditStyle=Lookup,Data='gcds_cm032_g:COM_CODE:COM_SNAME'</C>
													<C>ID=BLCHK,    Name=BLCHK	    width=70,  HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, </C>
													">
													</OBJECT><%=HDConstant.COMMENT_END%>
