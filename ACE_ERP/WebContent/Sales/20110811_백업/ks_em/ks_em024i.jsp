...
function ln_Query(){
	...
	gcds_data00.DataID = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em024_S1"
...
function ln_Save(){
	...
	if (gcds_data00.IsUpdated) {
			...
			gctr_data.KeyValue = "KS_Em024_t1(I:USER=gcds_data00)";
				
				gctr_data.action = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em024_t1"
											 + "?v_str1=" + gclx_dept_cd.bindcolval		// 직장구분       
											 + "&v_str2=" + gcem_att_dt.text;					// 출근일자        
								//			 + "&v_str3=" + txt_empno.value 			    	// 직번       
								//			 + "&v_str4=" + txt_empnmk.value;			  		// 성명   
...
function ln_Close(){  
	...
	//ln_SetDataHeader2();
			...
			gctr_data.KeyValue = "KS_Em024_t3(I:USER=gcds_data02)";
				
			gctr_data.action = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em024_t3"
											 + "?v_str1=" + gclx_dept_cd.bindcolval		// 직장구분       
											 + "&v_str2=" + gcem_att_dt.text;					// 출근일자        
								//			 + "&v_str3=" + txt_empno.value 			    	// 직번       
								//			 + "&v_str4=" + txt_empnmk.value;			  		// 성명   
...
function ln_Close_Chk(){  
			...
			for(i=1;i<=gcds_data00.countrow;i++){	
				...
				gctr_data.KeyValue = "KS_Em024_t4(I:USER=gcds_data00)";	
						
				gctr_data.action = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em024_t4"				
												 + "?v_str1=" + gclx_dept_cd.bindcolval		// 직장구분       
												 + "&v_str2=" + gcem_att_dt.text;					// 출근일자        									
				...
				<table width="820" border="0"  cellspacing="0" cellpadding="0"><!-- 버튼 영역 시작-->
					<tr>									
						<td align="right" height="30px">		
							...
							<img src="<%=dirPath%>/Sales/images/btn_change.gif" style="cursor:hand" onclick="ln_Change()">
							<img src="<%=dirPath%>/Sales/images/bundle.gif" style="cursor:hand" onclick="ln_Bundle()">
					...
					<tr>
						<td bgcolor="#FFFFFF" align="left" class="tab_z0101">
  						...
  						<PARAM NAME="Format"			VALUE="  
								...
								<FC>Name='마감',		ID=FINI_GB,width=55,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center SumBgColor=#C3D0DB edit=none value={IF (FINI_GB='N','X',IF (FINI_GB='Y','현장마감' ,''))}</FC>
                				<FC>Name=선택,       		ID=CHK     ,width=30,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, EditStyle='CheckBox',  SumBgColor=#C3D0DB show=false</FC>
                				...
                				<FC>Name=시간로임,     ID=TIME_PAY ,width=65,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, sort =false  SumBgColor=#C3D0DB edit=none</FC>
								...
								<C>Name=수정,  		ID=MODI_YN ,width=55,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center SumBgColor=#C3D0DB value={IF (FINI_GB='N','미수정',IF (FINI_GB='Y','수정' ,''))}</C>               				
                				<C>Name=출근시간,     ID=A_TM,  width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center,  SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=퇴근시간,     ID=L_TM ,width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center,   SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=조퇴시간,       ID=E_TM   ,width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=외출시간,       ID=G_TM  ,width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=복귀시간,  ID=R_TM  ,width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=오전,     ID=M_H,  width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center,  SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=오후,     ID=A_H,   width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center,   SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=연장,     ID=O_H,   width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=야간,     ID=N_H,   width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=조퇴,  	 ID=E_H,   width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=지각,     ID=T_H,   width=60,HeadBgColor=#B9D4DC,dec=1, bgcolor=#ffffff, align=center,  SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=외출,     ID=G_H,  width=60,HeadBgColor=#B9D4DC, dec=1,bgcolor=#ffffff, align=center,   SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
                				<C>Name=월로임,       ID=M_PAY,   width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=계산용\\출근,   ID=C_A_TM,  width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=계산용\\퇴근, 	 ID=C_L_TM,  width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
								<C>Name=계산용\\조퇴, 	 ID=C_E_TM,  width=60,HeadBgColor=#B9D4DC, bgcolor=#ffffff, align=center, SumBgColor=#C3D0DB edit=none mask='XX:XX'</C>
							">
							</OBJECT><%=HDConstant.COMMENT_END%>
