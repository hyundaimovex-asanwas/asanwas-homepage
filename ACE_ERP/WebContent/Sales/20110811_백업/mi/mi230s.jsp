...
%>
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_MI%>Mi230S",
            "JSP(O:DS1=ds_master)",
            v_param);
        tr_post(tr1);
    }
...
%>
    function fnExcel() {
        ...
        getObjectFirst("gr1").SetExcelTitle(1, "value:연령별 인원현황; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr1").GridToExcel("연령별 인원현황", "연령별 인원현황.xls", 8);
    }
                    ...
                    <td width=845>
                        ...
                        <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845; height:420px" border="1">
                            ...
                            <param name="Format"            value=" 
	                            <C> name='구분'     ID='GU_ANME'      Width=100   Edit=none align=Left   sumText='합계'</C>
