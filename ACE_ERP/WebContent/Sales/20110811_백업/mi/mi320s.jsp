...
%>		
	...
	function fnOnLoad(tree_idx){
		...
		function fnSelect() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_MI%>Mi320S",
			    "JSP(O:DS1=ds1)",
			    param);
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:성별 연령별; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("성별 연령별","성별 연령별.xls", 8);
		}
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='300px' border='1'>
								...
								<param name="Format" 			value="
									...
									<C> name='구분'   	ID='AGE_CD'  	width=80 	align=center editlimit=61 show=true sumText='합계' </C>
									<G> name='계'
									...
									<G> name='내국인'
									<C> name='남'   		ID='QTY_M10'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									<C> name='여'   		ID='QTY_F10'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									</G>
									<G> name='외국인'
									<C> name='남'   		ID='QTY_M20'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									<C> name='여'   		ID='QTY_F20'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									</G>
