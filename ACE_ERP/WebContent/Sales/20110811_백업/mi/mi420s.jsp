...
%>
    function fnExcel() {
        ...
        getObjectFirst("gr1").SetExcelTitle(1, "value:월별 매출 현황; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr1").GridToExcel("월별 매출 현황", "월별 매출 현황.xls", 8);
    }
                ...
                <tr>
                    <td width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">
                            <tr>
                                <td width="100px" height="25px" class="text">작업년도</td>
                    ...
                    <td width=845>
                        ...
                        <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845; height:450px" border="1">
                            ...
                            <param name="Format"            value=" 
                                ...
                                <C> name='계'       ID='MM_AMT_TT'         Width=100   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='1월'      ID='MM_AMT_01'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='2월'      ID='MM_AMT_02'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='3월'      ID='MM_AMT_03'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='4월'      ID='MM_AMT_04'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='5월'      ID='MM_AMT_05'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='6월'      ID='MM_AMT_06'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='7월'      ID='MM_AMT_07'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='8월'      ID='MM_AMT_08'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='9월'      ID='MM_AMT_09'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='10월'     ID='MM_AMT_10'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='11월'     ID='MM_AMT_11'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                                <C> name='12월'     ID='MM_AMT_12'         Width=90   Edit=none align=Right  SumText=@sum dec=0</C>
                            ">
                        </object>
                        <%=HDConstant.COMMENT_END%>
                    </td>
