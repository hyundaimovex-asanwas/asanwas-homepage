				...
				<tr>
					<td valign="top">
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="title" style="width:597px;" value="<%=title%>"></td>
						</tr>
						...
						<tr>
							...
							<td colspan="3"><textarea name="content" style="width:597px;height:218px;"><%=content%></textarea></td>
						</tr>
                  <% 
                  		if(fileRecord != null){ 
                  %>						
						...
						<td colspan="3">
                           ...
                           <%//바로 위에서 수정화면 본문에 이미지를 보여준다. 호..제법 괜찮다.
                           }
						...
						<tr>
							...
							<td colspan="3">
								...
								<tr>
									...
									<td>
                                      <span  style="position:relative;left:7px;top:0px;height:19;width:40;background-image:url(<%=imageServer%>/tour_img/btn/btn_s_filesch.gif);background-repeat:no-repeat;clip:rect(0 40 19 0)">
                                      <input  type='file' name='file_nm' onChange="this.form.file1.value=this.value" style="width:40;height:19;filter:alpha(opacity=0);" ></span>
								    </td>
								</tr>
