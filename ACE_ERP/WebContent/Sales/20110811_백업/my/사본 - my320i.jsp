...
%>
    ...
    <script language=JavaScript for=ds1 event=OnLoadCompleted(row)>
        //alert(ds1.NameValue(row, "USE_YN") + " : " + ds1.NameValue(row, "SE_YN_NM"));
        agen_gu.Enable = "false";
        dir_yn.Enable = "false";
        area_cd.Enable = "false";
        cunt_status.Enable = "false";
        use_yn.Enable = "false";
    </script>
                                    ...
                                    <td width='100%'height='244px'>
                                        <table border='0' cellpadding='0' cellspacing='1' width='100%' height='244px' bgcolor="#666666">
                                            <tr>
                                                ...
                                                <td  bgcolor='#FFFFFF'>
                                                    &nbsp;<input type='text' id='client_nm'       name='client_nm'        value='' maxlength='30' size='20'   class='input01' readOnly> <!-- 매출처 명 -->
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan='3' width='300px' bgcolor='#FFFFFF'>
                                                    &nbsp;&nbsp;<input type='text' id='client_dam_nm'   name='client_dam_nm'    value='' maxlength='20' size='20'   class='textbox'> <!-- 매출처담당자 -->
                                                </td>
                                                ...
                                                <td valign=top>
                                                    <div id=tab1 style="position:absolute; width:845; height:97">     
                                                        ...
                                                        <object id=gr2 classid=<%=HDConstant.CT_GRID_CLSID%> style="left:5; top:5; width=845; height=97" border='1'>                                       
                                                            ...
                                                            <param name="Format"            value="                                                                                                                                 
                                                               <C> name='매출처SID'        ID='client_sid'         align=left editlimit=12 width=100 show=false</C>
                                                    ...
                                                    <div id=tab3 style="position:absolute; width:845; height:97">     
                                                        <%=HDConstant.COMMENT_START%>                                                                                                        
                                                        <object id=gr4 classid=<%=HDConstant.CT_GRID_CLSID%> style="left:5; top:5; width=845; height=97" border='1'>                                       
                                                            <param name="DataID"            value="ds4">                                                                                                                            
                                                            <param name="Fillarea"          value="true">                                                                                                                           
                                                            <param name="Editable"          value="false">                                                                                                                           
                                                            <param name="BorderStyle"       value="0">                                                                                                                       
                                                            <param name="Format"            value="                                                                                                                                 
                                                                <C> name='매출처SID'   ID='client_sid'  width=100 align=left editlimit=12 show=false</C>
