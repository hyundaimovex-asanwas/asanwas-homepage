        ...
        <td>
            <table border=0 cellspacing="0" cellpadding="0" width="100%">
                <tr>
					...
					<td align="right" width="50%" style="padding-right:6px"><img src="<%=dirPath%>/Sales/images/refer.gif"   style="cursor:hand;position:relative;left:3px;top:3px" onclick="fnSelect()">
