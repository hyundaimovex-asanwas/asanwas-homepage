...
%>
	function fnSelectDs1() {
		ds1.DataId = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm020I?proType=S&dsType=1&s_DongCd="+txt_dong_cd.value.toUpperCase()
...
%>
		function fnApply() {
				if (ds1.IsUpdated) {
					if (fnChk()) {
						tr1.KeyValue = "Rm020I(I:INPUT_DATA=ds1)";
						tr1.Action = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm020I?proType=A&dsNum=1";
						tr1.post();
						ds1.resetstatus();
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor=orange> 
  <tr>
  	...
  	<td align=right style="padding-right:10px">
		...
		<img src="<%=dirPath%>/Sales/images/cancel.gif"	style="cursor:hand;position:relative;left:3px;top:3px" onClick="fnCancelDs1()">
		</nobr>
  	</td>  	
  </tr>
  <tr>
