...
%>		
		...
		function fnSelectDs1() {
			if (ds1.IsUpdated ) {
				...
				ds1.ClearAll();
				ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210I_N?dsType=1&proType=S&sSaupSid="+ds2.namevalue(ds2.RowPosition, "saup_sid")+"&sUpjangSid="+ds3.namevalue(ds3.RowPosition, "upjang_sid")+"&sBgnUseDate="+bgn_date.text+"&sEndUseDate="+end_date.text;
				ds1.Reset();
			}		
		}
<%
...
%>
			function fnSelectDs3() {
				ds3.Dataid  = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210I_N?dsType=2&proType=INIT&sSaupSid="+ds2.namevalue(ds2.RowPosition, "saup_sid");
				ds3.Reset();
			}
<%
///////////////////////////////////////////////////////////////////////////////
...
%>
			function fnSelectDs4() {
				ds4.Dataid  = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210I_N?dsType=3&proType=INIT&sHead=RM006";
				ds4.Reset(); //시즌				
			}			
		/*
		 * 행추가 , 신규 
		...
		function fnApply() {
			...
			if (ds1.IsUpdated) {
				...
				tr1.Action = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210I_N?proType=A&dsNum=1";
				tr1.post();
			}else{
				alert("수정된 행이 없습니다.");
			}		
