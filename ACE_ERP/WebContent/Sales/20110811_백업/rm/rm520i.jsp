...
//		ds_btnAuth.DataId = "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>BtnAuth?proType=S&dsType=1&userid=2030003&tree_idx=555";//테스트용.
		ds_btnAuth.DataId = "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>BtnAuth?proType=S&dsType=1&userid="+GetCookie("vusrid")+"&tree_idx="+tree_idx;//서버용.
		ds_btnAuth.Reset();
				  ...
				  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
					<tr bgcolor="#6f7f8d">
					  ...
					  <td align=left bgcolor="#ffffff" width=210>&nbsp;
                        <%=HDConstant.COMMENT_START%> <object id=lc_goods classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=100 width=100 border="0" align=absmiddle>
					...
					<tr bgcolor="#6f7f8d">
					  ...
					  <td align=left bgcolor="#ffffff" valign="middle">&nbsp;
                        ...
                        <comment id="__NSID__"><object id=sAcceptEndDate
					  ...
					  <td align=left bgcolor="#ffffff" width=210>&nbsp;
                        <%=HDConstant.COMMENT_START%> <object id=sBlockStatusCd classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=150 width=100 border="0" align=absmiddle>
			...
			<object id=gr2 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:230" border="1">
				...
				<param name="Format" value="
				  ...
				  <G> name='실적내역'
				      ...
				      <C> name='비율'     ID='actual_rate'  bgColor={IF( select_div='Y','#FFD253',IF( select_div='N',IF(block_status_cd='RQ','#FFFFFF','#D8D5D5' ),'#FFFFFF') ) } HeadAlign=Center Width=40  align=right editlimit=22 edit=none sumbgcolor=#E0CFE4 show=true</C>
				  </G>
