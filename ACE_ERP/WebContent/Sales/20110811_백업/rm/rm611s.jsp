...
%>
        function fnSelect() {
            ...
            ln_TRSetting(tr1, 
                "<%=dirPath%><%=HDConstant.PATH_RM%>Rm611S",
                    ...
                    <td>
                        <table border=0 cellspacing=0 cellpadding=0 width="100%">
                            <tr>
                                <td>
                                    <%=HDConstant.COMMENT_START%>
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_master  style="width=845; height:420px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='블록요금\\①'	ID='BLOCK_AMT'      Width=60   SumText=@sum Edit=none align=Right decao=0 suppress=8</C>
                                            <C> name='보증금\\②=①*0.2'		ID='DEPOSIT_AMT'        Width=60   SumText=@sum Edit=none align=Right decao=0 suppress=9</C>
                                            <C> name='입금액\\③'		ID='TOT_AMT'       	Width=60   SumText=@sum Edit=none align=Right decao=0</C>
                                            ...
                                            <C> name='대체가능액\\⑤=③*④'	ID='REFUND_AMT'        	Width=70   SumText=@sum Edit=none align=Right decao=0</C>
                                            <C> name='환입액'		ID='EARNING_AMT'       	Width=60   SumText=@sum Edit=none align=Right decao=0</C>
                                            <C> name='대체완료액'		ID='PAY_AMT'        Width=70   SumText=@sum Edit=none align=Right decao=0</C>
                                            ...
                                            <C> name='입금일자'     ID='D_PAY_DATE'           Width=80   Edit=none align=Center </C>
                                            <C> name='입금액'      ID='D_PAY_AMT'            Width=60   Edit=none align=Right decao=0 SumText=@sum</C>
                                            <C> name='관리번호'     ID='D_PAY_MANAGE_NO'      Width=90  Edit=none align=Left    </C>
                                            <C> name='입금방법'     ID='D_PAY_CD'             Width=60   Edit=none align=Center </C>
                                            <C> name='입금여부'      ID='D_PAY_YN'            Width=60   Edit=none align=Center </C>
