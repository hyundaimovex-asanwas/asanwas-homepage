                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                        <td height=25>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td  align="left">주민/여권번호&nbsp;<%=HDConstant.COMMENT_START%>
                ...
                <tr>
                    <td>
                        <table width="100%" height="30" border="0" cellspacing="0" cellpadding="0">
                            <tr>                                
                                <td width="95"><img src="<%=dirPath%>/Sales/images/tab_01_on.gif"></td>
                                <td width="200" align=right valign=middle>고객등록 자료조회<input type=checkbox name=v_accept_check id=v_accept_check>
                    ...
                    <td height="497" valign=top style="padding-top:4px">
                        ...
                        <table id=tb_tourlist style="display:inline" border=0 cellspacing=0 cellpadding=0>
                            <tr>
                                <td valign=top>
                                    <%=HDConstant.COMMENT_START%>
                                    <object classid=<%=HDConstant.CT_GRID_CLSID%> id=gr_tourlist  style="width=293px; height:538" border="1">
