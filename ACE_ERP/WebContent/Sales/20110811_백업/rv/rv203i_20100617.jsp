						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
						              <FC> name='대리점코드'    ID='client_cd'   	width=100	align=left editlimit=5 show=false edit=none</FC>
						              ...
						              <FC> name='대리점명'    	ID='client_nm'   	width=80 	align=left editlimit=50 show=false suppress=1 edit=none</FC>
						              <C> name='출발일'    	ID='depart_date'   	width=60 	align=center editlimit=16 show=false edit=none</FC>
						              <C> name='상품명'      	ID='goods_nm'     	width=80 	align=left editlimit=30 show=false edit=none</FC>
						              <C> name='성명'      	ID='cust_nm'     	width=60 	align=left editlimit=30 show=false edit=none</FC>
						              <C> name='동행자'    		ID='m_cust_nm'   	width=60 	align=left editlimit=30 show=false edit=none</C>
						              <C> name='관계'      		ID='join_cd'     	width=40 	align=left editlimit=50 show=false edit=none</C>
						              <C> name='직장/직위'   		ID='company_nm'  	width=200 	align=left editlimit=61 show=false edit=none</C>
						              <C> name='고객관리번호'    	ID='manage_no'   	width=100	align=left editlimit=14 show=false edit=none</C>
						              <C> name='주소'     		ID='address1'    	width=150 	align=left editlimit=60 show=false edit=none</C>
						              <C> name='반/조'        	ID='class'       	width=80 	align=left editlimit=54 show=false edit=none</C>
						              <C> name='객실등급' 		ID='room_type_cd' 	width=60 	align=left editlimit=10 show=false edit=none</C>
						              <C> name='방번호'      	ID='room_no'     	width=60 	align=left editlimit=10 show=false edit=none</C>
						              <C> name='관광요금' 		ID='tot_tour_amt' 	width=80 	align=right editlimit=12 show=false decao=0 edit=none</C>
						              <C> name='옵션요금' 		ID='tot_opt_amt' 	width=80 	align=right editlimit=12 show=false decao=0 edit=none</C>
						              <C> name='연락처(자택)'    	ID='tel_no'      	width=150 	align=left editlimit=20 show=false edit=none</C>
						              <C> name='연락처(핸드폰)'    	ID='mobile_no_full'      	width=150 	align=left editlimit=20 show=false edit=none</C>
						              <C> name='입력자'			ID='i_empnm'		width=60	align=left show=false edit=none</C>
 						              <C> name='수정자'			ID='u_empnm'		width=60	align=left show=false edit=none</C>
						              ...
						              <C> name='ACCEPT_SID'      	ID='rsv_sid'     	width=100 	align=left editlimit=15 show=false edit=none</C>
   						              <C> name='방문횟수'		ID='north_cnt'		width=60	align=right show=false dec=0 edit=none</C>
   						              <C> name='고객구분'		ID='cust_gu'		width=60	align=left show=false dec=0 edit=none</C>
                                      <C> name='인증여부'       ID='regi_yn_t_name' width=70 	align=CENTER	Edit=None	show=false</C>
						              ...
						              <C> name='참고사항'   	ID='remarks'  		width=200 	align=left editlimit=61 show=false edit=none</C>
						              <C> name='유치자'        ID='empnm'       	width=50 	align=left editlimit=20 show=false edit=none</C>
               					">
							</object>   
							<%=HDConstant.COMMENT_END%>		
						</td>
