		...
		<tr height="30px">
			<td width='845px'>
				<table border='0' cellpadding='0' cellspacing='1' width='845' bgcolor="#666666">
					<tr height='25px'>
	                    <td height="20" class="text">대리점</td>
                                    ...
                                    <td valign=top>
										...
										<object id=mxTab classid=CLSID:ED382953-E907-11D3-B694-006097AD7252 style="position:absolute; left:170; top:180; width:845; height:20">
											...
											<param name="Format"			value='
												<T>divid="mxTab_page1"	title="방북신청현황"</T>
												<T>divid="mxTab_page2"	title="방북승인신청(일괄등록)"</T>
												'>
										</object>
										<%=HDConstant.COMMENT_END%>	
                                        ...
                                        <%=HDConstant.COMMENT_START%>
                                        <object id=gr2 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='350px' border='1'>
                                            ...
                                            <param name=SortView  value="right">
                                            <param name="Format"        value="
                                            	<C> name='주민등록번호'	ID='REGI_NO'			width=100 align=center Edit=None sumtext=계</C>
												...
												<C> name='성별'				ID='GENDER'			width=40 align=center Edit=None</C>
												<C> name='국적'     			ID='NATION_NM'    	width=50 	align=center editlimit=60 show=true sumtext=명</C>
											    <C> name='생년월일'    		ID='BIRTH_DATE'   	width=60 	align=center editlimit=50 show=true</C>
												<C> name='성명'		ID='CUST_NM'				width=60 align=center Edit=None  sort = true</C>
												<C> name='성명(한자)'		ID='NAME_CHINESE'				width=60 align=center Edit=None  </C>
												<C> name='직위'		ID='POSITIONS'			width=60 align=left Edit=None </C>
												<C> name='신장'		ID='HEIGHT'				width=60 align=left Edit=None </C>
												<C> name='직장명'		ID='COMPANY_NM'		width=100 align=left Edit=None suppress=1  sort = true</C>
												<C> name='휴대전화'			ID='MOBILE_NO'		width=100 align=center Edit=None</C>
												<C> name='직장전화'			ID='TEL_CM'		width=100 align=center Edit=None</C>
												<C> name='팩스'				ID='FAX_NO'		width=100 align=center Edit=None</C>
												<C> name='집전화'				ID='TEL_NO'		width=100 align=center Edit=None</C>
												<C> name='우편번호'			ID='ZIP_CD'		width=100 align=center Edit=None</C>
												<C> name='주소'    			ID='ADDRESS1'   	width=120 	align=left editlimit=50 show=true</C>
												<C> name='상세주소'    		ID='ADDRESS2'   	width=120 	align=left editlimit=50 show=true</C>
												<C> name='소재지'    			ID='ADDRESS'   	width=120 	align=left editlimit=50 show=true</C>
												<C> name='방북증형태'		ID='N_CARD_FORM'		width=60 align=left Edit=None</C>
												<C> name='방문경험'			ID='NORTH_CNT'			width=60 align=left Edit=None</C>
												<C> name='여권유효기간시작일'			ID='PASS_ISSUE_DATE'			width=120 align=left Edit=None</C>
												<C> name='여권유효기간종료일'			ID='PASS_EXPIRE_DATE'			width=120 align=left Edit=None</C>
