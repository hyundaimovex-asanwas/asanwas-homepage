 ...
 * 기능정의     :
 * [수  정   일  자][수정자] 내용
 * [2010-08-25][박경국] 서비스 요청내역(사업소 업장 중심 뷰) 신규화면 구성.
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>
        ...
        function fnSelect() {
			...
			//alert(param);
            ln_TRSetting(tr1,
                "<%=dirPath%><%=HDConstant.PATH_RV%>Rv273S",
                "JSP(O:MASTER=ds1)",
                param);
            tr_post(tr1);
        }
            ...
            <td width='845px'>
                <table border='0' cellpadding='0' cellspacing='1' width='845' bgcolor="#666666">
                    ...
                    <tr height='25px'>
                        ...
                        <td align=left bgcolor="#ffffff">&nbsp;<%=HDConstant.COMMENT_START%>
                            <object id=v_depart_date classid=<%=HDConstant.CT_EMEDIT_CLSID%> height=17 width=66 align=center class="textbox">
                        ...
                        <td>
                            ...
                            <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='400px' border='1'>
                                ...
                                <param name="Format"              value="
                                   	<G>  name='이용정보'
	                                    <C> name='메뉴구분'       	ID='MENU_GUBN_NM'  	width=80     align=center 	suppress=1    </C>
	                                    <C> name='영업장'           ID='UPJANG_NM'    	width=100   align=left     	suppress=2    </C>
	                                    <C> name='메뉴명'           ID='MENU_NM'      	width=120   align=left     	suppress=3    </C>
	                                    <C> name='이용일자'        ID='USE_DATE'  		width=100   align=center 	suppress=4    </C>
	                                    <C> name='회차'          	ID='USE_SEQ'      	width=40     align=left   	suppress=5    </C>
                                   ...
                                   <G> name='단체정보'
	                                    <C> name='단체명'           ID='GROUP_NM'       width=80     align=left      		</C>
	                                    <C> name='출발일자'        ID='DEPART_DATE'  width=100     align=center        </C>
	                                    <C> name='상품'            	ID='GOODS_NM'     width=80      align=left  			</C>
