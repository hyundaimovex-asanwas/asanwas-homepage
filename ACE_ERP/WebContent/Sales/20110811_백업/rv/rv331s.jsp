 ...
 * 기능정의     : 입금확인2
 * [수  정   일  자][수정자] 내용
 * [2007-12-27][심동현] 기존 입금확인에서 2개 그리드 join하여 하나로 처리
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv331S",
...
<table width="845" border="0" cellspacing="0" cellpadding="0">
    <tr>
                    ...
                    <td width=845>
                        ...
                        <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845; height:440px" border="1">
                            ...
                            <param name="Format"            value=" 
                                <FC> name='출발일자'       ID='DEPART_DATE'    Width=65   Edit=none align=CENTER suppress=1 SUMTEXT=@CNT</FC>
                                <C> name='신청번호'       ID='VIEW_ACCEPT_NO'      Width=110   SumText='결제예정금액' Edit=none align=Left suppress=3</C>
                                <C> name='성명'           ID='CUST_NM'        Width=60   Edit=none align=Left suppress=4 sort=true</C>
                                ...
                                <C> name='판매가'         ID='TOT_TOUR_AMT'   Width=70   Edit=none align=Right Dec=0 suppress=7</C>
                                <C> name='총입금액'       ID='TOT_PAY_AMT'    Width=70   Edit=none align=Right Dec=0 suppress=8</C>
                                <C> name='상품'          ID='GOODS_NM'       Width=100  Edit=none align=Left suppress=2</C>
                                <C> name='주민/여권번호'  ID='MANAGE_NO'      Width=100   Edit=none align=Left suppress=9</C>
                                
                                <C> name='입금일자'        ID='PAY_DATE'        Width=65   Edit=none align=CENTER suppress=10</C>
                                <C> name='결제\\방법'      ID='PAY_CD_NM'          Width=40   Edit=none align=CENTER</C>
                                <C> name='결제\\여부'      ID='PAY_YN'          Width=40   Edit=none align=Center</C>
                                <C> name='회계\\구분'   ID='ACCT_GUBN_NM'   Width=40   Edit=none align=Center</C>
                                <C> name='결제금액'		ID='PAY_AMT'      	Width=70   SumText=@sum  Edit=none align=Right dec=0</C>
                                <C> name='결제관리번호'	ID='PAY_MANAGE_NO' 	Width=100  Edit=none align=CENTER Dec=0</C>
     ...
     <tr>
         <td><BR>※ 관광객 1인에 여러개의 결제 건이 있는 경우 판매가와 총입금액의 합계는 그만큼 늘어나 표시됩니다.<BR>
			　주의하시기 바랍니다.
