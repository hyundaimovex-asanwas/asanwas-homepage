																...
																<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
																	...
																	<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:340" border="1" >
																		...
																		<param name="Format" 			value="
															               <C> name='방북\\허가√'      ID='south_permit_yn'     width=40 align=center editstyle=checkbox editlimit=1 value={IF(south_permit_yn='Y','T','F')} show=true </C>
															               <C> name='북입국\\허가√'      ID='north_permit_yn'   width=40 align=center editstyle=checkbox editlimit=1 value={IF(north_permit_yn='Y','T','F')} show=true</C>
															               <C> name='취소사유'    ID='cancel_cd_nm'   width=80 align=center show=true</C>
															               <C> name='신청번호'    ID='accept_no'   width=90 align=left editlimit=15 edit=none show=true</C>
															               <C> name='성명'      ID='cust_nm'     width=60 align=left editlimit=30 edit=none show=true</C>
															               <C> name='주민번호'    ID='manage_no'   width=90 align=left editlimit=20 edit=none show=true </C>
															               <C> name='방북교육일'      ID='educ_dt'     width=65 align=left editlimit=8 edit=none show=true</C>
															               <C> name='전화번호'       ID='tel_no'      width=80 align=left editlimit=20 edit=none show=true</C>
															               <C> name='객실타입' ID='room_type_cd'       width=55  align=center editlimit=10 edit=none show=true</C>
															               <C> name='직장명'   ID='company_nm'  width=110 align=left editlimit=30 edit=none show=true</C>
															               <C> name='직위'    ID='positions'   width=40 align=left editlimit=30 edit=none show=true</C>
															               <C> name='예약SID'      ID='rsv_sid'     width=50 align=right editlimit=12 edit=none show=false</C>
																		">
																	</object>
																	<%=HDConstant.COMMENT_END%>
																</td>		
