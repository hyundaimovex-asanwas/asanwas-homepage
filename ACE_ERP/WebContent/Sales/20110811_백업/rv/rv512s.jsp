 ...
 * 기능정의		 : 취소/환불 내역 조회
 * [수  정   일  자][수정자] 내용
 * [2008-07-21][심동현] 신규 작성 from ac430s(환불내역조회)
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>
    ...
    function fnSelect() {
		...
		//imgDs.ClearAll();
        ln_TRSetting(tr1,
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv512S",
	...
	<tr>
		<td width="845px">
		    ...
		    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> style="width=845px; height:350" border="1" >
				...
				<G> name='요청정보'
	                <C> name='요청관리번호'		ID='req_no'  width=90  Align=center Edit=None show=True Suppress=1</C>
	                <C> name='작업상태'   		ID='status_cd' width=60  align=center editstyle=lookup edit=none Data='ds_status2:detail:detail_nm' show=true Suppress=1</C>
	                <C> name='작업유형'   		ID='job_type' width=60  align=center editstyle=lookup edit=none Data='codeDsSrch:detail:detail_nm' show=true Suppress=1</C>
	                <C> name='공제코드'			ID='refund_charge_cd'	align=center	Width=60	Show=True	editstyle=lookup Data='codeDs1:detail:detail_nm' Suppress=1</C>
	                <C> name='공제율'    		ID='charge_rate' align=Right 	Width=50	show=True decao=1 Suppress=1</C>
				...
				<G> name='예약정보'
	                ...
	                <C> name='주민/여권번호'    ID='manage_no'   	width=60 align=left editlimit=20 show=false Suppress=1</C>
	                <C> name='판매가'			ID='tour_amt'    	width=70 Align=Right Show=True decao=0 Suppress=1</C>
				</G>
				<G> name='입금정보'
	                <C> name='입금액'			ID='pay_amt'		width=70 Align=Right Show=True decao=0</C>
	                ...
	                <C> name='환불액'			ID='refund_amt'		width=70 align=Right show=True decao=0</C>
					<C> name='환입액'       	ID='FUND_AMT'       width=70 align=right   show=true decao=0 </C>
				</G>
				<G> name='환불정보'
					...
					<C> name='영업\\담당자'     ID='SAL_DAM_NM'     width=60 align=center   editlimit=50 show=true Suppress=3</C>
	                <C> name='요청\\신청자'		ID='rq_empno'		width=70 align=center edit=none show=true Suppress=3</C>	                
	                <C> name='요청\\신청일자'	ID='accept_date'	width=70 align=left edit=none show=true mask='XXXX-XX-XX' Suppress=3</C>
	                <C> name='영업\\접수자'		ID='re_empno'		width=70 align=center edit=none show=true Suppress=3</C>	                
	                <C> name='영업\\접수일시'	ID='re_date'		width=70 align=left edit=none show=true Suppress=3</C>
	                <C> name='정산\\접수자'		ID='ac_empno'		width=70 align=center edit=none show=true Suppress=3</C>	                
	                <C> name='정산\\접수일시'	ID='ac_date'		width=70 align=left edit=none show=true Suppress=3</C>
	                <C> name='환불일\\(결재)'	ID='refund_date'	width=70 align=center edit=none show=true mask='XXXX-XX-XX' Suppress=3</C>
	                <C> name='환불일\\(입금)'	ID='refund_date_tr'	width=70 align=center edit=none show=true mask='XXXX-XX-XX' Suppress=3</C>
					<C> name='수정일'			ID='U_DATE'			width=80 align=center   editlimit=50 show=true mask='XXXX-XX-XX' Suppress=3</C>	                
	               ">
			</object>
			<%=HDConstant.COMMENT_END%>
		</td>
