...
%>
	...
	function fnSetHeader(){
		if (ds1.countrow < 1){
			var s_temp1 = "STATUS_CD:STRING,ACCEPT_DATE:STRING,ACCEPT_NO:STRING,CUST_NM:STRING,REQ_NO:STRING,CLIENT_SID:INT,CLIENT_DAM_NM:STRING,MOBILE_NO:STRING,DEPART_DATE:STRING,ACCEPT_SID:INT,SAL_AMT:INT,PAY_AMT:INT,TSAL_AMT:INT,TAX_AMT:INT,TOT_AMT:INT,REASON:STRING,DESC:STRING";
	...
	function fnPopup2() {    
		...
		if (arrResult != null) {
			...
			sal_amt.text = arrParam[5];			
			pay_amt.text = arrParam[6];						
			
			tot_amt.text = Math.round(sal_amt.text * 0.1);
			tsal_amt.text = Math.round(tot_amt.text/1.1);			
			tax_amt.text = Math.round(tot_amt.text - tsal_amt.text);
		} else {
	    	accept_sid.value = 0;
			accept_no.value = '';
			sal_amt.text = 0;			
				...
				<tr valign="top"">
					<td align="left" width="290px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<param name="Format" 			value="
				                ...
				                <C> name='판매액'      ID='sal_amt'     align=left editlimit=12 show=false</C>
				                <C> name='입금액'      ID='pay_amt'     align=left editlimit=12 show=false</C>                
				                <C> name='공급가액'     ID='tsal_amt'    align=left editlimit=12 show=false</C>
				                <C> name='부가세'      ID='tax_amt'     align=left editlimit=12 show=false</C>
				                <C> name='합계'      ID='tot_amt'     align=left editlimit=12 show=false</C>                
											...
											<td>
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													...
													<tr>
														...
														<td height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
															<input id="req_no" type="text" class="boardt04"   value="" size="20">
														</td>																																																			
													</tr>
													<tr>
													...
													<tr>
														...
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">공급가액</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
														     <%=HDConstant.COMMENT_START%>
														     <object id=tsal_amt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=17 width=129 align=center class="textbox">			
																<param name=Text 		value="">
																<param name=Alignment 	value=2>
																<param name=Format 		value="">
																<param name=Cursor	 	value="iBeam">
													...
													<tr>
														...
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">부가세</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
														     <%=HDConstant.COMMENT_START%>
														     <object id=tax_amt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=17 width=129 align=center class="textbox">			
																<param name=Text 		value="">
																<param name=Alignment 	value=2>
																<param name=Format 		value="">
																<param name=Cursor	 	value="iBeam">
													...
													<tr>
														...
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text" >합계</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
														     <%=HDConstant.COMMENT_START%>
														     <object id=tot_amt classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=17 width=129 align=center class="textbox">			
																<param name=Text 		value="">
																<param name=Alignment 	value=2>
																<param name=Format 		value="">
																<param name=Cursor	 	value="iBeam">
...
<comment id="__NSID__"><object id=bn1 classid=CLSID:9C9AB433-EA85-11D2-A4F9-00608CEBEE49>     
	...
	<param name=BindInfo	value="                                                
         ...
         <C>Col=tsal_amt         Ctrl=tsal_amt           Param=text </C>
         <C>Col=tax_amt          Ctrl=tax_amt            Param=text </C>
         <C>Col=tot_amt          Ctrl=tot_amt            Param=text </C>         
