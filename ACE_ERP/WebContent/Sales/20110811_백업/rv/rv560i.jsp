...
%>
	...
	function fnInit(){
        ...
        ln_TRSetting(tr2, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv560I",
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															...
															<input id="room_type_nm" type="text" class="boardt04"  size="15" value="" style="text-align:left;" readonly>																																														
															<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="확정등급을 검색합니다" style="cursor:hand;position:relative;left:-0px;top:0px" align=center onclick="fnPopup4();">																																																				
														</td>
													</tr>	
													<tr>
