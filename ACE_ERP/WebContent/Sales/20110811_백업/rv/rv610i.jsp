...
<script language="javascript">
    ...
    function fnSelect() {
		if (ds_master.isUpdated || ds_detail.isUpdated) { 
	        ...
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv610I",
		...
		if (ds_master.IsUpdated || ds_detail.IsUpdated) {
            if(ds_master.IsUpdated){
                for(i=1;i<=ds_master.CountRow;i++) {
                    if(ds_master.NameValue(i, "RSV_CLOSE_DATE")=="" || ds_master.NameValue(i, "RSV_CLOSE_DATE").length!=8){
                        alert("마감일자 <%=HDConstant.A_MSG_MUST_INPUT%>");
                        gr_master.SetColumn("RSV_CLOSE_DATE");
            ...
            if(ds_detail.IsUpdated){
                for(i=1;i<=ds_detail.CountRow;i++) {
                    if(ds_detail.NameValue(i, "TL_DATE")!="" && ds_detail.NameValue(i, "TL_DATE").length!=8){
                        alert("T/L 일자 <%=HDConstant.A_MSG_MUST_INPUT%>");
                        gr_detail.SetColumn("TL_DATE");
        ...
        if(Colid == "TL_DATE"){
            ...
            if(ds_detail.NameValue(Row, Colid)!=olddata){
                ...
                switch(first_date.getDay()+1){
                    case 1 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "일";
                        break;
                    case 2 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "월";
                        break;
                    case 3 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "화";
                        break;
                    case 4 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "수";
                        break;
                    case 5 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "목";
                        break;
                    case 6 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "금";
                        break;
                    case 7 :
                        ds_detail.NameValue(Row, "YOIL_NM") = "토";
                        break;
                }
            }
                                ...
                                <td align="left" width="240px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_master  style="width=240px; height:460px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='마감일자'    ID='RSV_CLOSE_DATE'     Width=80  align=center mask=XXXX-XX-XX Edit=Numeric</C>
                                        ">
                                    </object>
                                    <%=HDConstant.COMMENT_END%>
                                </td>       
                                ...
                                <td align="right" width="595px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_detail  style="width:595px; height:460px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='T/L 일자√'     ID='TL_DATE'         Width=80  align=center mask=XXXX-XX-XX Edit=Numeric EditLimit=8</C>
