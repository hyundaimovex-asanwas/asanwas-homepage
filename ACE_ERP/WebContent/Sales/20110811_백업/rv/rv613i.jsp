 ...
 * 작 성 자		 : 심동현
 * 작 성 일		 : 2009-04-06
 * 기능정의		 : PLZ 관광 마감 조회,등록,삭제,저장
 * [ 수정일자 ][수정자] 내용
 * [2009-04-06][심동현] 복사해서 생성
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<script language="javascript">
    ...
    function fnSelect() {
		if (ds_master.isUpdated || ds_detail.isUpdated) { 
	        ...
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv613I",
		...
		if (ds_master.IsUpdated || ds_detail.IsUpdated) {
            if(ds_master.IsUpdated){
                for(i=1;i<=ds_master.CountRow;i++) {
                    if(ds_master.NameValue(i, "PLZ_CLOSE_DATE")=="" || ds_master.NameValue(i, "PLZ_CLOSE_DATE").length!=8){
                        alert("마감일자 <%=HDConstant.A_MSG_MUST_INPUT%>");
                        gr_master.SetColumn("PLZ_CLOSE_DATE");
            ...
            if(ds_detail.IsUpdated){
                for(i=1;i<=ds_detail.CountRow;i++) {
                    if(ds_detail.NameValue(i, "TL_DATE_PLZ")!="" && ds_detail.NameValue(i, "TL_DATE_PLZ").length!=8){
                        alert("T/L 일자 <%=HDConstant.A_MSG_MUST_INPUT%>");
                        gr_detail.SetColumn("TL_DATE_PLZ");
    ...
    <script language=JavaScript for=gr_detail event=OnExit(Row,Colid,olddata)>
        ...
        if(Colid == "TL_DATE_PLZ"){
            ...
            if(v_tl_date=="" || v_tl_date.length!=8) {
                ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "";
                return;
            }
            ...
            if(ds_detail.NameValue(Row, Colid)!=olddata){
                ...
                switch(first_date.getDay()+1){
                    case 1 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "일";
                        break;
                    case 2 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "월";
                        break;
                    case 3 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "화";
                        break;
                    case 4 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "수";
                        break;
                    case 5 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "목";
                        break;
                    case 6 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "금";
                        break;
                    case 7 :
                        ds_detail.NameValue(Row, "YOIL_NM_PLZ") = "토";
                        break;
                }
            }
                                ...
                                <td align="left" width="240px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_master  style="width=240px; height:460px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='마감일자'    ID='PLZ_CLOSE_DATE'     Width=80  align=center mask=XXXX-XX-XX Edit=Numeric</C>
                                        ">
                                    </object>
                                    <%=HDConstant.COMMENT_END%>
                                </td>       
                                ...
                                <td align="right" width="595px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_detail  style="width:595px; height:460px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='남측T/L(PLZ)√'	ID='TL_DATE_PLZ'      Width=100  align=center mask=XXXX-XX-XX Edit=Numeric EditLimit=8</C>
                                            <C> name='요일'        		ID='YOIL_NM_PLZ'      Width=45  align=center Edit=none bgcolor='<%=HDConstant.GRID_ITEM%>'</C>
                                            <C> name='참고사항(PLZ)'	ID='REMARKS_PLZ'      Width=215  align=left Edit=Any EditLimit=50</C>
                                        ">
                                    </object>
                                    <%=HDConstant.COMMENT_END%>
                                </td>
