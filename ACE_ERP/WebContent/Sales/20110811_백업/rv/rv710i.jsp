						...
						<table border="0"  cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="right" height="30px">		
									<img src="<%=dirPath%>/Sales/images/class_condition.gif"   	style="cursor:hand" onclick="fnPopup()">
				...
				<tr height="45px">
					...
					<td align="right">
						<table border="0"  cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="right" height="30px">		
									<img src="<%=dirPath%>/Sales/images/class_delete.gif"   	style="cursor:hand" onclick="fnEraser()">
									<img src="<%=dirPath%>/Sales/images/auto_assign.gif"		style="cursor:hand" onClick="fnAuto();">																			
					 			</td>
							</tr>	
						</table>
					</td>														
						...
						<table  border="0" cellpadding="0" cellspacing="0">
							<tr valign="top"">
								<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<%=HDConstant.COMMENT_START%>
									<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:320" border="1" >
