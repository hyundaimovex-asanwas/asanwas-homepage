 ...
 * [2009-04-29][심동현] 검색조건 고정 후 여행스케치만 오픈..
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
//	        ds2.Reset(); //지역코드	        
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:PLZ예약확정명단; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("PLZ예약확정명단","PLZ예약확정명단.xls", 8);
		}
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
						              ...
						              <C> name='상품명'      	ID='goods_nm'     	width=90 	align=left editlimit=30 show=true</C>
						              <FC> name='신청서번호'    ID='accept_no'   	width=120 	align=left editlimit=16 show=true</FC>
						              ...
						              <C> name='직장/직위'   	ID='company_nm'  	width=200 	align=left editlimit=61 show=False</C>
						              <C> name='고객관리번호'   ID='manage_no'   	width=80	align=left editlimit=14 show=true</C>
						              <C> name='주소'     		ID='address1'    	width=150 	align=left editlimit=60 show=False</C>
						              ...
						              <C> name='반/조'        	ID='class'       	width=80 	align=left editlimit=54 show=False</C>
						              <C> name='객실등급' 		ID='room_type_cd' 	width=60 	align=left editlimit=10 show=true</C>
						              <C> name='방번호'      	ID='room_no'     	width=60 	align=left editlimit=10 show=False</C>
						              <C> name='순판매액' 		ID='tot_tour_amt' 	width=80 	align=right editlimit=12 show=true decao=0</C>
						              <C> name='연락처(자택)'   ID='tel_no'      	width=150 	align=left editlimit=20 show=False</C>
						              <C> name='연락처(핸드폰)' ID='mobile_no_full' width=150 	align=left editlimit=20 show=true</C>
						              <C> name='입력자'			ID='i_empnm'		width=60	align=left show=False	</C>
 						              <C> name='수정자'			ID='u_empnm'		width=60	align=left show=False	</C>
						              ...
						              <C> name='RSV_SID'      	ID='rsv_sid'     	width=100 	align=left editlimit=12 show=false</C>
   						              <C> name='방문횟수'		ID='north_cnt'		width=60	align=right show=False dec=0</C>
   						              <C> name='고객구분'		ID='cust_gu'		width=60	align=left 	show=False</C>
