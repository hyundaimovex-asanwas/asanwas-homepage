...
<script language="javascript">
    ...
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv840S",
    ...
    function fnExcel() {
        ...
        getObjectFirst("gr_master").SetExcelTitle(1, "value:예약인원조회 ; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr_master").GridToExcel("예약인원조회", "예약인원조회.xls", 8);
    }
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666" align=left>
                                        <tr bgcolor="#6f7f8d" height=25>
                                            ...
                                            <td class="text" width="80">예약일자</td>
                                            <td align=left bgcolor="#ffffff">&nbsp;<%=HDConstant.COMMENT_START%>
                                ...
                                <td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_master  style="width=845px; height:420px" border="1">
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <C> name='예약일시'     ID='RSV_DATE'       Width=80    align=center edit=none</C>
                                            ...
                                            <C> name='동행자'      ID='M_CUST_NM'      Width=60    align=center edit=none</C>
