...
<script language="javascript">
    ...
    function fnSelect() {
        ...
        ln_TRSetting(tr1,
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv850S",
    ...
    function fnExcel() {
        ...
        getObjectFirst("gr_master").SetExcelTitle(1, "value:객실이용현황(요약) ; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr_master").GridToExcel("객실이용현황(요약)", "객실이용현황(요약).xls", 8);
    }
...
<object id=ds_master2 classid=<%=HDConstant.CT_DATASET_CLSID%>>
    ...
    <param name=GroupExpr   value="SAUP_SID:UPJANG_NM,CALN_DATE,TT_CNT:ST_CNT:N1_CNT:N2_CNT">
</object>
                                ...
                                <td align="left" width="845px" bordercolor="#000000">
                                    ...
                                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_master  style="width=845px; height:420px" border="1">
                                        ...
                                        <param name="Format"            value="
                                            <FC> name='사업장'          ID='SAUP_SID'     Width=100    align=left edit=none suppress=1 Show=False</FC>
                                            <FC> name='업장명'          ID='UPJANG_NM'    Width=100    align=left edit=none suppress=1 SubSumText=''</FC>
                                            <R>
                                                <G>name=$xkeyname_$$ mask='XX/XX'
                                                    <C> name='계'    ID=TT_CNT_$$ Width=30    align=right   edit=none fontstyle=bold</C>
                                                    <C> name='PRE'   ID=ST_CNT_$$ Width=30    align=right   edit=none</C>
                                                    <C> name='1박'    ID=N1_CNT_$$ Width=30    align=right   edit=none</C>
                                                    <C> name='2박'    ID=N2_CNT_$$ Width=30    align=right   edit=none</C>
                                                </G>
                                            </R>
                                        ">
                                    </object>
