					...
					<td width=845>
					    ...
					    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845px; height:360px" border="1">
					        ...
					        <param name="Format"            value="
					            <C> name='부서'      	ID='DEPTNM'    Width=80  align=center suppress=1 edit=none</C>
					            <C> name='성명'      	ID='EMPNMK'    Width=80  align=center suppress=2 edit=none</C>
					            <C> name='사번'      	ID='EMPNO'   Width=60  align=center suppress=2 edit=none</C>
					            <C> name='메뉴ID'       ID='TREE_ID'   Width=60  align=left  edit=none </C>
					            <C> name='메뉴번호'     ID='TREE_IDX'  Width=60  align=center  edit=none</C>
					            <C> name='메뉴명1'      ID='TREE_NM1'  Width=60  align=left suppress=3 edit=none</C>
					            <C> name='메뉴명2'      ID='TREE_NM2'  Width=60  align=left suppress=4 edit=none</C>
					            <C> name='메뉴명3'      ID='TREE_NM3'  Width=90  align=left suppress=5 edit=none</C>
