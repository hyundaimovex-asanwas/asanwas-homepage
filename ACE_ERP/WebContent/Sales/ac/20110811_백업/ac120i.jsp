                    ...
                    <td width=520>
                        ...
                        <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=520; height:430px" border="1">
                            ...
                            <param name="Format"            value=" 
								...
								<C> name='출발일자'       	ID='DEPART_DATE'    Width=70   	align=Left 	Edit=none suppress=1 mask='XXXX-XX-XX'</C>
								<C> name='복귀일자'       	ID='ARRIVE_DATE'    Width=70   	align=Left 	Edit=none suppress=2 mask='XXXX-XX-XX'</C>
								<C> name='박수'       		ID='NIGHTS' 	   Width=40   	align=Left 	Edit=none suppress=3</C>
								...
								<C> name='객실코드'     	ID='ROOM_TYPE'   	Width=80   	align=Left 	Edit=none   suppress=4</C>
