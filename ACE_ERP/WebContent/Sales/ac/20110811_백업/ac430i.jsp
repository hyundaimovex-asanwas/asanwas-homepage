												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left" colspan="3">&nbsp;
															...
															<img src="<%=dirPath%>/Sales/images/refund_com.gif"   id=to 	    style="cursor:hand;position:relative;left:3px;top:3px;display:none" onclick="fnStatusSet('TO')">
															<img src="<%=dirPath%>/Sales/images/refund_po.gif"    id=po 	    style="cursor:hand;position:relative;left:3px;top:3px;display:none" onclick="fnStatusSet('PO')">
															<img src="<%=dirPath%>/Sales/images/refund_hold.gif"  id=pc		style="cursor:hand;position:relative;left:3px;top:3px;display:none" onClick="fnStatusSet('PC')">																																														
															<img src="<%=dirPath%>/Sales/images/trans_com.gif"  id=so		style="cursor:hand;position:relative;left:3px;top:3px;display:none" onClick="fnStatusSet('SO')">																																														
														</td>																									
													</tr>
													<tr>
