...
%>		
		...
		function fnSelect() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_AC%>Ac510S",
			    "JSP(O:DS1=ds1)",
			    param);
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:일별총괄장; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("일별총괄장","일별총괄장.xls", 8);
		}
			...
			<td width='845px'>
				<table border='0' cellpadding='0' cellspacing='1' width='845' bgcolor="#666666">
					<tr height='30px'>
                        ...
                        <td align="center" width="80px" height="30px" class="text">영업장</td>
						...
						<td align=left class="text"  width="60">신청서번호</td>
	                    <td align=left bgcolor="#ffffff">&nbsp;																							
							<%=HDConstant.COMMENT_START%>
							<object id=sAcceptNo classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=17 width=65 align=center class="textbox" style= "position:relative;left:0px;top:0px;width:65px; height:17px;">			
								<param name=Text 		value="">
								<param name=Alignment 	value=1>
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
									...
									<C> name='시즌'					ID='SEASON_CD'			width=100	align=left suppress=2 </C>
									<C> name='상품'   				ID='GOODS_NM'  			width=100 	align=left editlimit=61 show=true suppress=3</C>
									<C> name='확정등급'   			ID='ROOM_TYPE_CD'  		width=100 	align=left editlimit=61 show=true </C>
									<C> name='고객구분'   			ID='CUST_GU_NM'  		width=80 	align=left editlimit=61 show=true </C>
									<C> name='연령'   				ID='AGE_CD_NM'  		width=50 	align=left editlimit=61 show=true </C>
									<C> name='할인유형'   			ID='CUST_TYPE_NM'  		width=80 	align=left editlimit=61 show=true </C>
									<C> name='인원'   				ID='QTY'  				width=50 	align=right editlimit=61 show=true SumText=@sum SumTextAlign=right</C>

									<G> name='관광 및 숙박기준 매출'
										<C> name='관광요금'   			ID='TOUR_PRICE'  		width=100 	align=right editlimit=61 show=true dec=0</C>
										<C> name='숙박기준가'   		ID='TOUR_BASE_PRICE'  	width=100 	align=right editlimit=61 show=true dec=0</C>
									...
									<G> name='숙박비 단가조정'
										<C> name='기준숙박단가'   	ID='BASE_ROOM_PRICE'  	width=100 	align=right editlimit=61 show=true dec=0</C>
										<C> name='기준숙박비'   		ID='BASE_ROOM_AMT'  	width=100	align=right editlimit=61 show=true SumText=@sum SumTextAlign=right dec=0</C>
										<C> name='조정율(%)'   			ID='CONT_RATE'  		width=100	align=right editlimit=61 show=true dec=2</C>
										<C> name='조정숙박단가'   	ID='CONT_BASE_PRICE'  	width=100	align=right editlimit=61 show=true dec=0</C>
										<C> name='조정숙박비'   		ID='CONT_BASE_AMT'  	width=100	align=right editlimit=61 show=true SumText=@sum SumTextAlign=right dec=0</C>
									</G>
									
									<C> name='일수'   				ID='NIGHTS'  			width=30 	align=right editlimit=61 show=true dec=0</C>
