...
%>		
		...
		function fnSelect() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_AC%>Ac530S",
			    "JSP(O:DS1=ds1)",
			    param);
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:월별총괄장; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("월별총괄장","월별총괄장.xls", 8);
		}
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
									...
									<C> name='고객구분'   			ID='CUST_GU_NM'  		width=100 	align=left editlimit=61 show=true suppress=1 </C>
									<C> name='상품'   				ID='GOODS_NM'  		width=100 	align=left editlimit=61 show=true </C>
									<C> name='연령구분'   			ID='AGE_CD_NM'  		width=100 	align=left editlimit=61 show=true suopress=2</C>
									<C> name='할인유형'   			ID='CUST_TYPE_NM'  		width=100 	align=left editlimit=61 show=true </C>
