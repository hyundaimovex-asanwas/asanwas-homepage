										...
										<table width="530px" cellpadding="0" cellspacing="0" >
													...
													<table width="530px" border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">
														...
														<tr>
															...
															<td height="25px"  bgcolor="#FFFFFF" align="left" colspan="">&nbsp;
																...
																<img src="<%=dirPath%>/Sales/images/help.gif" border="0" id="empno_btn"  ALT="판매자를 검색합니다" style="cursor:hand;position:relative;left:-0px;top:0px" align=absmiddle onclick="fnPopup2();">
														...
														<tr>
															...
															<td height="25px"  bgcolor="#FFFFFF" align="left" colspan="3">&nbsp;
																...
																<img src="<%=dirPath%>/Sales/images/help.gif" border="0" id="empno_btn"  ALT="거래처를 검색합니다" style="cursor:hand;position:relative;left:-0px;top:0px" align=absmiddle onclick="fnPopup();">
											...
											<tr>
												...
												<tr>
													...
													<img src="<%=dirPath%>/Sales/images/minus.gif"		style="cursor:hand" onClick="fnDeleteRowDs2();"></td>
												</tr>
												</td>
											</tr>
