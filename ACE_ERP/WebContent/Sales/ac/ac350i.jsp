...
%>
	...
	function fnInit(){
        ...
        ln_TRSetting(tr2, 
            "<%=dirPath%><%=HDConstant.PATH_AC%>Ac350I",
			...
			<table  border="0" cellpadding="0" cellspacing="0">
				<tr valign="top"">
					<td align="left" width="290px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
						    <%=HDConstant.COMMENT_START%>
						    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> style="width=290px; height:360" border="1" >
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left" colspan="3">&nbsp;
															...
															<img src="<%=dirPath%>/Sales/images/settle_com.gif"		style="cursor:hand;position:relative;left:3px;top:3px" onClick="fnStatusSet('TO')">																																																																																																																												
														</td>																									
													</tr>
													<tr>
													...
													<tr>
														...
														<td height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
															<input id="mobile_no" type="text" class="boardt04" style="text-align:left;"  value="" size="20" readonly>
														</td>	
													</tr>		
													<tr>
