...
%>      
	...
	function fnOnLoad(tree_idx){
        ...
        function fnSaveDetail(){
            ...
            ln_TRSetting(tr1, 
                "<%=dirPath%><%=HDConstant.PATH_AC%>Ac740I",
                "JSP(I:DETAIL=ds_detail,O:RESULT2=ds_detail_result)",
                v_param);
            tr_post(tr1);
        }
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                    <tr>
                        <td height='25px' align='right'>
                            ...
                            <img src="<%=dirPath%>/Sales/images/new.gif"   style="cursor:pointer" align=absmiddle onClick="fnAdd()">
                            <img src="<%=dirPath%>/Sales/images/delete.gif" style="cursor:pointer" align=absmiddle onClick="fnDelete()">
                            <img src="<%=dirPath%>/Sales/images/save.gif"  style="cursor:pointer" align=absmiddle onclick="fnSave()">
                        ...
                        <td width=615 valign=top>
                            <table border=0 cellspacing=0 cellpadding=0 width="100%">
                                        ...
                                        <table border=0 cellspacing="1" bgcolor="#666666" cellpadding=0 width="100%">
                                            ...
                                            <tr height=25>
                                                ...
                                                <td align=left bgcolor="#ffffff">&nbsp;<input type="text" name='v_pay_empno' id='v_pay_empno' value='' size='11' readonly='readonly'  class='input01'>
                                                    <img src="<%=dirPath%>/Sales/images/help.gif" border="0" style="cursor:pointer" id="empno_btn" onclick="javascript:fnEmpPopup();" align='absmiddle'>
                                ...
                                <tr height=37 valign=middle align=right>
                                    <td>
                                        <img src="<%=dirPath%>/Sales/images/plus.gif"  id="plus_btn"  style="cursor:pointer" align=absmiddle onClick="fnAddRow()">
                                        <img src="<%=dirPath%>/Sales/images/minus.gif" id="minus_btn" style="cursor:pointer" align=absmiddle onClick="fnDeleteRow()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
