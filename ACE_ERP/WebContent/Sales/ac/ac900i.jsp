...
%>		
		...
		function fnApply() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_AC%>Ac900I",
			    "JSP(I:DS1=ds1)",
			    param);
					...
					<tr height="30px">
						<td width=545>
							<table border='0' cellpadding="0" cellspacing="1" width="345" bgcolor="#666666">
								<tr>
									<td align=left class="text"  width="110">정산일자</td>
						...
						<td width='845'>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<param name="Format" 			value="
								  <C> name='정산일자'    	ID='caln_date'   		width=100 	align=center 	edit=none		editlimit=8 mask=XXXX-XX-XX show=true</C>
