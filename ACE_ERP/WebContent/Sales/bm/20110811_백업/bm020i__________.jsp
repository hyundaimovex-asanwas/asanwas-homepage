	...
	******************************************************************************/
	function ln_Query(){
			if(gcra_snkorea.CodeValue==1){
					...
					gcds_data_2.Reset();
					var ii2 = gcds_data_2.countrow;
					if(ii2 > 0){
						for(int i2 = 1 ; i2 <= ii2 ; i2++){
							gcds_data_2.namevalue(i2, "CHK") = "T";
						}
					}
			}
	}
	...
	******************************************************************************/
	function ln_Save(){
		if(gcra_snkorea.CodeValue==1){
					...
					gctr_data.KeyValue = "bm020i_t01(I:DATA=gcds_data_1)";
					...
					gctr_data.KeyValue = "bm020i_t02(I:DATA=gcds_data_2)";
	...
	******************************************************************************/
	function ln_Excel(){
			if(gcra_snkorea.CodeValue==1){
					...
					else gcgd_disp1.GridToExcel("입출경관리:남->북 ","C:\\Temp\\입출경관리:남->북.xls",2);
			} else {
					SetTitle1("입출경관리:북->남");
					if (gcds_data_2.countrow<1) alert(gn_Msg(4));
					else gcgd_disp2.GridToExcel("입출경관리:북->남","C:\\Temp\\입출경관리:북->남.xls",2);
			}
	}
...
<jsp:include page="/Common/sys/body_s.jsp"  flush="false"/>
  ...
  <tr> 
    <td colspan=2>
      ...
      <table width="395" cellpadding="0" cellspacing="0" border="0">
				 ...
				 <tr> 
						<td>
							<comment id="__NSID__"><OBJECT  id=gcgd_disp1 class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:877px;height:580px;" viewastext>
...
<!--								<param name=UseChangeInfo    value=false>		//-->
								<param name="Format"				value="  
									...
									<C> Name='선택'		   ID=CHK			    HeadAlign=Center HeadBgColor=#EEEEEE Width=50	align=center editstyle=checkbox HeadCheck=false HeadCheckShow=true editable=true </C>
      ...
      <table width="395" cellpadding="0" cellspacing="0" border="0">
				 ...
				 <tr> 
						<td>
							<comment id="__NSID__"><OBJECT  id=gcgd_disp2 class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:877px;height:580px;" viewastext>
...
<!--								<param name=UseChangeInfo    value=false>		//-->
								<param name="Format"				value="  
									...
									<C> Name='성명'	  	    ID=CUST_NM			 HeadAlign=Center HeadBgColor=#EEEEEE Width=65	align=center edit=none</C> 
									<C> Name='국적'	  	    ID=NATION_NAME	 HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center edit=none</C> 
									...
									<C> Name='입국목적'	    ID=NORTH_PURPOSE HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center edit=none</C> 
									<C> Name='입국전직장'	  ID=VEND_NM	  	 HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=left   edit=none</C> 
