...
<script language="javascript">
	...
	******************************************************************************/
	function ln_Query(){
					var sdata = "/services/servlet/sales.bm.bm999i"
 ...
 ******************************************************************************/
	...
	******************************************************************************/
	function ln_Save(){
				...
				gctr_data.KeyValue = "bm999t(I:DATA=gcds_data_1)";
				gctr_data.Action = "/services/servlet/sales.bm.bm999t";
						...
						<td>
							<comment id="__NSID__"><OBJECT  id=gcgd_disp1 class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:877px;height:410px;" viewastext>
								...
								<param name="Format"				value="  
									...
									<C> Name='VEND_SID'	  	 ID=VEND_SID		HeadAlign=Center HeadBgColor=#EEEEEE Width=100	 align=center edit=none</C> 
									<C> Name='VEND_CD'	  	 ID=VEND_CD			HeadAlign=Center HeadBgColor=#EEEEEE Width=100 align=left   edit=none</C> 
