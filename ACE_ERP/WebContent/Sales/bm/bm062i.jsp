...
<script language="javascript">
  ...
  var gs_date = gn_Replace(gcurdate,"/");
	...
	******************************************************************************/
	function ln_Query(){
		var sdata = "/services/servlet/sales.bm.bm062i_s01"
	...
	******************************************************************************/
    ...
    gcds_data.NameValue(gcds_data.rowposition,"HAIR_DATE") = gcem_acdate_fr.text;
	}
	...
	******************************************************************************/
	function ln_Save(){
		...
		gctr_data.KeyValue = "bm062i_t01(I:DATA=gcds_data)";
		gctr_data.Action = "/services/servlet/sales.bm.bm062i_t01";
	...
	******************************************************************************/
	function ln_Excel(){
		 ...
		 } else {gcgd_disp.GridToExcel("이발관리","C:\\Test\\dsh1033.xls",2);}
	}
...
<!--			<img src="/services/Sales/images/print.gif"	style="position:relative;top:-5px;cursor:hand;" align=absmiddle onclick="ln_Print()">	//-->
  ...
  <tr> 
    <td colspan=2>
		    ...
		    <tr>
					<td class="tab_b0011" align=left><font size='-1' face='돋움'><b>*기본이용료:3$/회</b></font></td>				
				</tr>
			</table>		
		</td>
	</tr>
						...
						<comment id="__NSID__"><OBJECT  id=gcgd_disp class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:876px;height:383px;" viewastext>
							...
							<param name="Format"				value="  
								<F> Name='No.'				ID={CURROW} 	HeadAlign=Center HeadBgColor=#EEEEEE Width=30		align=center</F>
									<C> Name='소속회사'		ID=VEND_NM			 HeadAlign=Center HeadBgColor=#EEEEEE Width=200	align=left   edit=none</C> 
									<C> Name='팀'	      	ID=TEAM_NM			 HeadAlign=Center HeadBgColor=#EEEEEE Width=120	align=left   edit=none</C> 
									<C> Name='실무번호'		ID=WORK_NO			 HeadAlign=Center HeadBgColor=#EEEEEE Width=120	align=center edit=none</C> 
									<C> Name='성명'		    ID=CUST_NM			 HeadAlign=Center HeadBgColor=#EEEEEE Width=80	align=center edit=none</C> 
									<C> Name='정산여부'		ID=CALC_YN			 HeadAlign=Center HeadBgColor=#EEEEEE Width=80 	align=center EditStyle=CheckBox</C> 
								">
            </OBJECT></comment><script>__ws__(__NSID__);</script>
