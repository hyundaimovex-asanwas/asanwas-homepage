    ...
    <td>
		    ...
		    <tr>
					...
					<td class="tab_b0001">
						...
						<img src="/services/Sales/images/refer.gif"		style="position:relative;left:190px;top:2px;cursor:hand" onclick="ln_Query()">
					</td>	
				</tr>
		    <tr>
					<td class="tab_a0101">접&nbsp;수&nbsp;자:</td>
					<td class="tab_b0001">
						<fieldset class=field_01 style="width:70px;">
						<comment id="__NSID__"><OBJECT id=gcem_ classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F
							class="gcem_01" style="width:52px;">
        ...
        <tr> 
          <td>
						<comment id="__NSID__"><OBJECT  id=gcgd_disp class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:876px;height:200px;" viewastext>
							...
							<param name="Format"				value="  
								<F> Name='No.'				ID={CURROW} 	HeadAlign=Center HeadBgColor=#EEEEEE Width=30		align=center</F>
								<C> Name='운전자'		  ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='위반일자'		ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='위반장소'		ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='위반내용'	  ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='주유량'		  ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='벌점'		    ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=100	align=center</C> 
								<C> Name='조치사항'		ID=			HeadAlign=Center HeadBgColor=#EEEEEE Width=200	align=center</C> 
								">
            </OBJECT></comment><script>__ws__(__NSID__);</script>
