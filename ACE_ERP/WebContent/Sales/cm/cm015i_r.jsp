	...
	if (p=="A") {
		if(gcds_data01.countrow<1) {
			alert("선택하실 내용이 없습니다.");
						...
						window.returnValue = gcds_data01.namevalue(row,"CARNO_SID") + ";"		//차량현지번호
														 + gcds_data01.namevalue(row,"CAR_NO");		        //차량번호
						window.close();
...
<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:10px;top:5px;width:650px;border:0 solid #c5c5c5">
	<tr>
		<td class="tab_a1111">차량번호</td>
		<td class="tab_b0011">
...
<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:5px;top:10px">
	<tr>
		<td colspan="3">
			<comment id="__NSID__">
						<OBJECT  id=gcgd_disp1 class="tab_b1111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:650px;height:250px;" viewastext>
							...
							<param name="Format"				value="  
								...
								<C> Name='차량번호'		ID=CAR_NO			HeadAlign=Center HeadBgColor=#EEEEEE Width=200	align=center</C>
								<C> Name='차대번호'		ID=CAR_DNO			HeadAlign=Center HeadBgColor=#EEEEEE Width=200	align=center</C>
								<C> Name='현지번호'		ID=CAR_RNO			HeadAlign=Center HeadBgColor=#EEEEEE Width=200	align=center</C>
								">
            </OBJECT></comment><script>__ws__(__NSID__);</script>
		</td>
	</tr>
	<tr>
		<td>
			<fieldset id=ft_div1 style="width:650;height:20px;border:1 solid #c5c5c5;border-top-width:0px;text-align:left;">
