          ...
          <td>
						<comment id="__NSID__"><OBJECT  id=gcgd_disp1 class="tab_b0111" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  style="width:410px;height:200px;" viewastext>
							...
							<param name="Format"				value="  
								...
								<C> Name='유종'	ID=OIL_TYPE		HeadAlign=Center HeadBgColor=#EEEEEE Width=120		align=right show=true EditStyle=Combo 					Data='0:경유,1:휘발유,2:등유,3:주유차(경유)'</C> 
								<C> Name='단가'	ID=OP_UNIT		HeadAlign=Center HeadBgColor=#EEEEEE Width=120		align=right show=true </C> 
								<C> Name='시작일자'	  	ID=OP_DATE		HeadAlign=Center HeadBgColor=#EEEEEE Width=100		align=center show=true mask='XXXX/XX/XX'</C> 
								">
            </OBJECT></comment><script>__ws__(__NSID__);</script>
