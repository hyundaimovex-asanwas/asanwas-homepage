...
<script language="javascript">
   ...
   function view_send4(brd_no,ref,ref_step){
		var readURL ="../my/my710_read_pop.jsp?pageFrom=710&idx=400&brd_no="+brd_no+"&ref="+ref+"&ref_step="+ref_step;
		...
		<tr>
			<td >
					...
					<table width="867" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td height="30" colspan="5" align=left><jsp:include page="/Sales/common/include/updatenote04.jsp" /></td>
						</tr>
					</table>
