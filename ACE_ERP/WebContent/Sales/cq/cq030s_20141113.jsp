 ...
 * [¼ö  Á¤   ÀÏ  ÀÚ][¼öÁ¤ÀÚ] ³»¿ë
 * [2006-10-31][½Éµ¿Çö] À§Ä¡ ¹× µðÅ×ÀÏ ¼öÁ¤,¿Ü±¹ÀÎ¿ë °ü±¤Áõ Ãß°¡
 * [2007-09-12][½Éµ¿Çö] »õ ¸Þ´ºÆ®¸® Àû¿ë
 * [2007-12-11][½Éµ¿Çö] ÀÌ¸§ ÆùÆ® º¼µå Àû¿ë, »çÀÌÁî Å©°Ô
 * [2008-08-18][½Éµ¿Çö] Ãë¼ÒÀÚÀÇ °æ¿ìµµ ÇÊ¿ä½Ã Ãâ·Â°¡´ÉÇÒ ¼ö ÀÖ°Ô.
 * [2010-10-26][½Éµ¿Çö] 2010 ÀÌ»ê°¡Á· ´ëºñ °ü±¤Áõ À§Ä¡ ¼öÁ¤.
 * [2013-08-26][½Éµ¿Çö] 2013 ÀÌ»ê°¡Á· ÁØºñ Çà»ç°ü·Ã °ü±¤Áõ »çÁø À§Ä¡ ¼öÁ¤. 
 *					cq030s_20130826 ¹öÀüÀÌ ¹é¾÷
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<td  width="840px">
			                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
			                            ...
			                            <tr bgcolor="#6f7f8d">
		            						...
		            						<td align=center class="text">Ãë¼ÒÀÚÆ÷ÇÔ</td>
			                                <td align=left bgcolor="#ffffff" valign="middle">&nbsp;
			                                	<input type=checkbox name="check_status_cd" id="check_status_cd">Æ÷ÇÔ
			                                </td>	
								...
								<td align="left" width="840px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=840px; height:410px" border="1">
                                        ...
                                        <param name="Format"            value="
											...
											<C> name='¿¹¾à»óÅÂ' 	ID='STATUS_CD'			Width=100  align=center edit=none</C>
									    ">
									</object>
									<%=HDConstant.COMMENT_END%>										
								</td>		
	...
	<tr>
		<td>¡Ø ÃÊÃ»(96)¹ÝÀÇ °æ¿ì °ü±¤°´formÀ» ¼±ÅÃÇÏ¸é [¿Ü±Ý-ÃÊÃ»-01-1] Ã³·³ Ãâ·ÂµÇ°í,
		¡¡»ç¾÷ÀÚformÀ» ¼±ÅÃÇÏ¸é [½Ç¹«¹øÈ£]·Î Ãâ·ÂµË´Ï´Ù.<br>
		¡Ø [Ãë¼ÒÀÚÆ÷ÇÔ]À» Ã¼Å©ÇÏ¸é Ãë¼ÒÀÚµµ Ãâ·ÂÇÒ ¼ö ÀÖ½À´Ï´Ù.
		</td>
	</tr>
...
<B>id=default ,left=0,top=0 ,right=2970 ,bottom=1974 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='unity_no', left=1677, top=672, right=1998, bottom=717, face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
...
<B>id=default ,left=0,top=0 ,right=2970 ,bottom=1973 ,face='Arial' ,size=10 ,penwidth=1
	<T>id='¹ø      È£' ,left=25 ,top=820 ,right=190 ,bottom=862 ,align='left' ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='unity_no', left=2098, top=1917, right=2420, bottom=1962, face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=1940, top=1830, right=2550, bottom=1863, face='3 of 9 Barcode', size=13, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=1940, top=1863, right=2550, bottom=1894, face='3 of 9 Barcode', size=13, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=1940, top=1798, right=2550, bottom=1830, face='3 of 9 Barcode', size=13, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='¼ºº°' ,left=2435 ,top=1404 ,right=2515 ,bottom=1446 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='sex', left=2535, top=1404, right=2635, bottom=1446, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=2078 ,top=1455 ,right=2425 ,bottom=1455 </L>
	<L> left=2523 ,top=1455 ,right=2600 ,bottom=1455 </L>
	<C>id='comment2', left=1950, top=1760, right=2600, bottom=1798, align='left', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='comment1', left=1910, top=1723, right=2600, bottom=1760, align='left', face='±¼¸²', size=9, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=2078 ,top=1718 ,right=2600 ,bottom=1718 </L>
	<L> left=2078 ,top=1521 ,right=2600 ,bottom=1521 </L>
	<L> left=2078 ,top=1587 ,right=2600 ,bottom=1587 </L>
	<L> left=2078 ,top=1652 ,right=2600 ,bottom=1652 </L>
	<C>id='birthday', left=2080, top=1470, right=2635, bottom=1512, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='address1', left=2080, top=1601, right=2635, bottom=1643, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<T>id='»ý³â¿ùÀÏ' ,left=1900 ,top=1470 ,right=2060 ,bottom=1512 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á÷ÀåÁ÷À§' ,left=1900 ,top=1535 ,right=2060 ,bottom=1577 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ç ´Â °÷' ,left=1900 ,top=1601 ,right=2060 ,bottom=1643 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='±â      °£' ,left=1900 ,top=1666 ,right=2060 ,bottom=1709 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÀÌ      ¸§' ,left=1900 ,top=1404 ,right=2060 ,bottom=1446 ,face='±¼¸²' ,size=11 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='company_nm', left=2080, top=1535, right=2723, bottom=1577, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_nm', left=2080, top=1390, right=2425, bottom=1446, align='left', face='±¼¸²', size=13, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=748, top=612, right=1175, bottom=640, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=748, top=584, right=1175, bottom=612, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=0, top=588, right=428, bottom=616, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=0, top=616, right=428, bottom=647, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<T>id='±â      °£' ,left=33 ,top=1905 ,right=195 ,bottom=1950 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ç ´Â °÷' ,left=33 ,top=1826 ,right=195 ,bottom=1868 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='Á÷ÀåÁ÷À§' ,left=33 ,top=1732 ,right=195 ,bottom=1774 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='»ý³â¿ùÀÏ' ,left=33 ,top=1652 ,right=195 ,bottom=1695 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<T>id='ÀÌ      ¸§' ,left=33 ,top=1575 ,right=195 ,bottom=1615 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<C>id='sex', left=800, top=1575, right=878, bottom=1620, align='left', face='±¼¸²', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='birthday', left=233, top=1652, right=878, bottom=1695, align='left', face='±¼¸²', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='fr_to_date2', left=233, top=1905, right=878, bottom=1950, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='address1', left=233, top=1826, right=878, bottom=1868, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=215 ,top=1627 ,right=648 ,bottom=1627 </L>
	<T>id='¼ºº°' ,left=678 ,top=1575 ,right=758 ,bottom=1615 ,face='±¼¸²' ,size=12 ,bold=false ,underline=false ,italic=false ,forecolor=#000000 ,backcolor=#FFFFFF</T>
	<L> left=785 ,top=1627 ,right=875 ,bottom=1627 </L>
	<L> left=215 ,top=1706 ,right=875 ,bottom=1706 </L>
	<L> left=215 ,top=1786 ,right=875 ,bottom=1786 </L>
	<L> left=215 ,top=1959 ,right=878 ,bottom=1959 </L>
	<L> left=215 ,top=1877 ,right=878 ,bottom=1877 </L>
	<C>id='company_nm', left=233, top=1732, right=1170, bottom=1774, align='left', face='±¼¸²', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_nm', left=233, top=1563, right=653, bottom=1615, align='left', face='±¼¸²', size=14, bold=true, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days1', left=598, top=82, right=943, bottom=124, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days2', left=598, top=122, right=943, bottom=164, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days1', left=1703, top=82, right=2048, bottom=124, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days2', left=1703, top=122, right=2048, bottom=164, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='birthdayN', left=1703, top=328, right=2048, bottom=373, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='address1', left=1703, top=490, right=2348, bottom=534, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='room_type', left=1818, top=553, right=2018, bottom=595, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='dong_nm', left=1993, top=553, right=2195, bottom=595, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='room_no', left=2123, top=553, right=2323, bottom=595, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='upjang_eng_nm', left=1583, top=553, right=1885, bottom=595, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days1', left=140, top=91, right=488, bottom=134, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='nights_days2', left=140, top=131, right=488, bottom=173, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='class_teams', left=140, top=185, right=488, bottom=230, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='depart_date', left=140, top=258, right=488, bottom=298, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_nm', left=140, top=312, right=488, bottom=356, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_enm', left=140, top=352, right=488, bottom=380, align='left', face='±¼¸²', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='birthday', left=140, top=384, right=488, bottom=427, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='room_no', left=308, top=471, right=483, bottom=513, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='dong_nm', left=220, top=471, right=393, bottom=513, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='upjang_eng_nm', left=8, top=471, right=285, bottom=513, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='address1', left=628, top=410, right=1273, bottom=455, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='upjang_eng_nm', left=503, top=480, right=820, bottom=523, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='room_type', left=810, top=480, right=985, bottom=523, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='dong_nm', left=1058, top=480, right=1235, bottom=523, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='room_no', left=1245, top=480, right=1420, bottom=523, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_enm', left=1703, top=286, right=2048, bottom=314, align='left', face='±¼¸²', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_nm', left=1703, top=246, right=2048, bottom=286, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='class_teams', left=1703, top=169, right=2050, bottom=213, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='arrive_date', left=2065, top=190, right=2410, bottom=234, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='depart_date', left=2065, top=91, right=2410, bottom=134, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='arrive_date', left=965, top=190, right=1310, bottom=234, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='depart_date', left=965, top=91, right=1310, bottom=134, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=2368, top=661, right=2793, bottom=691, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no1', left=2368, top=691, right=2793, bottom=720, face='3 of 9 Barcode', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='unity_no', left=1678, top=673, right=1998, bottom=717, face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='class_teams', left=598, top=166, right=943, bottom=211, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='birthday', left=598, top=300, right=943, bottom=342, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_enm', left=598, top=270, right=943, bottom=298, align='left', face='±¼¸²', size=7, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='cust_nm', left=598, top=227, right=943, bottom=272, align='left', face='±¼¸²', size=11, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<I>id='picture_info' ,left=2135 ,top=911 ,right=2458 ,bottom=1314</I>
	<C>id='REMARKS', left=2438, top=921, right=2635, bottom=1071, align='left', face='±¼¸²', size=38, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<I>id='TAG_NK' ,left=1915 ,top=921 ,right=2093 ,bottom=1099</I>

	<C>id='work_no2', left=233, top=820, right=653, bottom=862, align='left', face='±¼¸²', size=12, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<L> left=215 ,top=874 ,right=653 ,bottom=874 </L>
	<I>id='TAG_NK' ,left=25 ,top=926 ,right=208 ,bottom=1106</I>
	<I>id='picture_info' ,left=310 ,top=1051 ,right=630 ,bottom=1468</I>
	<C>id='REMARKS', left=660, top=926, right=870, bottom=1076, align='left', face='±¼¸²', size=38, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	<C>id='work_no2', left=2105, top=1338, right=2410, bottom=1380, align='left', face='±¼¸²', size=10, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
</B>
