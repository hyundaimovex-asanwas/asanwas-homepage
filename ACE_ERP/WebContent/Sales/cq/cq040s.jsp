 ...
 * 					마무리가 살짝 아쉽네. 기능이 다 완성되면 UI를 한번씩 검토하는 습관을 들이면 좋겠다.
 *					실행상의 오류는 없도록 수정하고,
 *					성별 컬럼은 좀더 줄여주는게 좋겠고, 기타 GRID의 사이즈같은 것들은 다 조
 * [2015-10-02][심동현] 5년 지나 내가 수정중.-_-
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
								...
								<td align="left" width="840px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=840px; height:410px" border="1">
                                        ...
                                        <param name="Format"            value="
                                            <C> name='No.'          ID='{CURROW}'	Width=30  align=center edit=none SumText='총계'</C>
									        ...
									        <C> name='관광증\\번호' ID='tour_no'    Width=50  align=center edit=none</C>
									        <C> name='성명'         ID='cust_nm'    Width=60  align=CENTER edit=none</C>
									        <C> name='성별'      	ID='sex'        Width=40  align=center edit=none</C>
                                            ...
                                            <C> name='사는곳'       ID='address1'   Width=85  align=CENTER edit=none</C>
									        <C> name='국적/민족'    	ID='COUNTRY_NM'    Width=80  align=CENTER edit=none</C>
