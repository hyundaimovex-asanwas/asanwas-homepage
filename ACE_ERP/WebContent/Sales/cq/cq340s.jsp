...
%>		
		...
		function fnSelect() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_CQ%>Cq340S",
			    "JSP(O:DS1=ds1)",
			    param);
					...
					<tr>
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='370px' border='1'>
								...
								<C> name='차량승인번호'   		ID='CAR_PERMIT_NO'	width=80	align=left 		editlimit=61 show=true </C>
								<C> name='운전자재외국민여부'   ID='DRIVER_LIVE_OUT_YN'	width=115 align=center 		editlimit=61 show=true </C>
