 ...
 * 시스템명		: 차량목록 - 통통 업로드용
 * 프로그램ID 	: CQ340S
 * 기능정의		: 예약정보(차량)를 통통양식으로 다운로드 받는 화면. 통통에 업로드하면 대북/군부용 액셀파일로 다운가능.
 * [수  정   일  자][수정자] 내용
 * [2007-09-12][심동현] 새 메뉴트리 적용
 * [2010-02-08][박경국] 예약확정명단(통통업로드 용)화면 신규.
 * [2010-03-22][심동현] 새 검색조건으로 수정 : 차량탑승과 동일하게
 * [2011-06-21][박경국] New 통통업로드 용 차량출입계획화면.
 * [2015-09-10][심동현] 15년 통통양식으로 수정: 차량탑승 데이터 반영 
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>		
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:통통업로드(차량신청); font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("통통업로드(차량신청)","통통업로드(차량신청).xls", 8);
	        /*
	        if(ds2.RowCount==0){
	            return;
	        } 
	        getObjectFirst("gr2").SetExcelTitle(0, "");
	        getObjectFirst("gr2").SetExcelTitle(1, "value:통통업로드(차량적재화물정보); font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr2").GridToExcel("통통업로드(차량적재화물정보)","통통업로드(차량적재화물정보).xls", 8);
	        
	         if(ds2.RowCount==0){
	            return;
	        } 
	        getObjectFirst("gr3").SetExcelTitle(0, "");
	        getObjectFirst("gr3").SetExcelTitle(1, "value:통통업로드(승무원휴대물품); font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr3").GridToExcel("통통업로드(승무원휴대물품)","통통업로드(승무원휴대물품).xls", 8);
	        
	         if(ds2.RowCount==0){
	            return;
	        } 
	        getObjectFirst("gr4").SetExcelTitle(0, "");
	        getObjectFirst("gr4").SetExcelTitle(1, "value:통통업로드(차량정보변경); font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr4").GridToExcel("통통업로드(차량정보변경)","통통업로드(차량정보변경).xls", 8);
			*/
		}
...
<object id=ds1 classid=<%=HDConstant.CT_DATASET_CLSID%>> <!--차량정보-->
	<param name="SyncLoad" 	value="true">
</object>
<object id=ds2 classid=<%=HDConstant.CT_DATASET_CLSID%>> <!--차량적재화물정보-->
	<param name="SyncLoad" 	value="true">
</object>
<object id=ds3 classid=<%=HDConstant.CT_DATASET_CLSID%>> <!--승무원휴대물품-->
	<param name="SyncLoad" 	value="true">
</object>
<object id=ds4 classid=<%=HDConstant.CT_DATASET_CLSID%>> <!--차량변경정보-->
	<param name="SyncLoad" 	value="true">
</object>
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
	...
	<table border='0' cellpadding='0' cellspacing='0' width='1002'>	
		...
		<tr height="30px">
			<td>
				<table border='0' cellpadding='0' cellspacing='1' width='1002' bgcolor="#666666">
					<tr height='25px'>
						<td width="70px" height="20px" class="text">신청서번호</td>
						...
						<td align="left" width="1002" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							<object id=mxTab classid=CLSID:ED382953-E907-11D3-B694-006097AD7252 style="position:absolute; left:13; top:180; width:845; height:20">
								...
								<param name="Format"			value='
									<T>divid="mxTab_page1"	title="차량신청"</T>
									<T>divid="mxTab_page2"	title="차량적재화물"</T>
									<T>divid="mxTab_page3"	title="승무원휴대물품"</T>
									<T>divid="mxTab_page4"	title="차량변경신청"</T>
									'>
							</object>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='1000' height='370px' border='1'>
								...
								<param name="Format" 			value="
								  	<C> name='출입경\\구분'    	ID='CQ_GUBN'   		width=50 	align=center editlimit=50 show=true SumText='총' SumTextAlign=right</C>
								  	<C> name='목적대'	    ID='NORTH_PURPOSE_L_CD'	width=50	align=center editlimit=30 show=true SumText=@count SumTextAlign=right</C>
					                <C> name='목적중'	    ID='NORTH_PURPOSE_S_CD' width=50	align=center editlimit=30 show=true SumText='대' SumTextAlign=left </C>
								  	<C> name='목적상세'   		ID='NORTH_PURPOSE'	width=140 	align=center 	editlimit=61 show=true </C>
									<C> name='출경일자'    		ID='DEPART_DATE'   	width=80 	align=center editlimit=50 show=true</C>
									<C> name='출경시간'    		ID='DEPART_TIME'   	width=60 	align=center editlimit=50 show=true</C>
									<C> name='입경일자'    		ID='ARRIVE_DATE'   	width=80 	align=center editlimit=50 show=true</C>
									<C> name='입경시간'    		ID='ARRIVE_TIME'   	width=60 	align=center editlimit=50 show=true</C>
									<C> name='운전자성명'	   	ID='DRIVER_NM' 		width=80 	align=center 		editlimit=61 show=true </C>
									<C> name='운전자(생년월일)' ID='DRIVER_BIRTHDAY' width=100 	align=center 		editlimit=61 show=true </C>
									<C> name='차량등록번호'		ID='CAR_NO'  		width=100 	align=center	editlimit=61 show=true </C>
									<C> name='차량명칭' 		ID='RIDE_CAR_NM'  	width=70 	align=center 	editlimit=61 show=true SORT=TRUE</C>
									<C> name='차량호수' 		ID='RIDE_CAR_NUM'  	width=55 	align=center 	editlimit=61 show=true </C>
									<C> name='목적지'   		ID='TARGET_AREA'  	width=50 	align=center 	editlimit=61 show=true </C>
									<C> name='관광유형'			ID='TOUR_TYPE'  	width=55 	align=center	editlimit=61 show=true </C>
									<C> name='탑승인원'   		ID='RIDE_PERSONS'  	width=60 	align=center	editlimit=61 show=true </C>
									<C> name='총기마약류\\소지여부' ID='GUN_YN'  	width=80 	align=center 		editlimit=61 show=true </C>
									<C> name='외지차 차량용품\\구입여부'	ID='OUTSRC_YN' width=100 	align=center 	editlimit=61 show=true </C>
									<C> name='심사여부'   		ID='AUDIT_YN'  		width=60 	align=center 		editlimit=61 show=true </C>
									<C> name='비고'   			ID='REMARKS'  		width=80 	align=center 		editlimit=61 show=true </C>
	               					">
							</object>   
							...
							<object id=gr2 classid=<%=HDConstant.CT_GRID_CLSID%> width='1000' height='370px' border='1'>
								...
								<param name=ViewSummary     value=1>
								 <param name="SuppressOption"    value="1">
								<param name="Format" 			value="
									<C> name='일련번호'    				ID='{CURROW}'   	width=70		align=center 	show=true SumText='총계'</C>
								  	<C> name='통행구분'    				ID='CQ_GUBN'   	width=70 	align=center editlimit=50 show=true</C>
									<C> name='차량등록번호'   			ID='CAR_NO'  		width=100 	align=center	editlimit=61 show=true SumText=@count</C>
								  	<C> name='출입경일'    				ID='DP_AR_DATE'  	width=80 	align=center editlimit=50 show=true</C>
									<C> name='출입경시간'    			ID='DP_AR_TIME'   	width=80 	align=center editlimit=50 show=true</C>
									<C> name='적재화물이름'    		ID='FREIGHT_NAME'   		width=200 	align=center editlimit=50 show=true</C>
									<C> name='적재화물수량'    		ID='FREIGHT_AMOUNT'   	width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재화물수량단위'    	ID='FREIGHT_UNIT'   		width=200 	align=center editlimit=50 show=true</C>
		           					">
							</object>   
							...
							<object id=gr3 classid=<%=HDConstant.CT_GRID_CLSID%> width='1000' height='370px' border='1'>
								...
								<param name="Format" 			value="
									<C> name='일련번호'    				ID='{CURROW}'   	width=70		align=center 	show=true SumText='총계'</C>
								  	<C> name='통행구분'    				ID='CQ_GUBN'   	width=70 	align=center editlimit=50 show=true SumText=@count</C>
									<C> name='차량등록번호'   			ID='CAR_NO'  		width=100 	align=center	editlimit=61 show=true </C>
								  	<C> name='출입경일'    				ID='DP_AR_DATE'  	width=80 	align=center editlimit=50 show=true</C>
									<C> name='출입경시간'    			ID='DP_AR_TIME'   	width=80 	align=center editlimit=50 show=true</C>
									<C> name='휴대품명'    				ID='CARRY_NAME'   		width=100 	align=center editlimit=50 show=true</C>
									<C> name='휴대품규격'    			ID='CARRY_STANDARD'   	width=100 	align=center editlimit=50 show=true</C>
									<C> name='휴대품수량'    			ID='CARRY_AMOUNT'   		width=100 	align=center editlimit=50 show=true</C>
									<C> name='구입금액(천원)'    		ID='SUM'   				width=100 	align=center editlimit=50 show=true</C>
		           					">
							</object>   
							</div>
							...
							<object id=gr4 classid=<%=HDConstant.CT_GRID_CLSID%> width='1000' height='370px' border='1'>
								...
								<param name=ViewSummary     value=1>
								 <param name="SuppressOption"    value="1">
								<param name="Format" 			value="
									<C> name='차량승인번호'   		ID='CAR_PERMIT_NO'	width=80	align=left 		editlimit=61 show=true SumText='총계'</C>								
									<C> name='차량등록번호'   		ID='CAR_NO'  		width=100 	align=center	editlimit=61 show=true </C>							
									<C> name='운전자(주민번호)'   	ID='REGI_NO'  		width=100 	align=center 		editlimit=61 show=true SumText=@count</C>								
									<C> name='소속'   				ID='COMPANY_NM'  	width=80 	align=left 		editlimit=61 show=true </C>
									<C> name='탑승인원'   			ID='CAR_PERSONS'  	width=60 	align=center	editlimit=61 show=true </C>
									<C> name='차량명칭'   			ID='RIDE_CAR_NM'  	width=70 	align=center 	editlimit=61 show=true </C>
									<C> name='정렬순서'   			ID='{STRING(CURROW)}' 	width=60 	align=center 		editlimit=61 show=true </C>
									<C> name='비고'   					ID='REMARKS'  		width=80 	align=center 		editlimit=61 show=true </C>
									<C> name='적재물(품명)'    		ID='FREIGHT_NAME'   		width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재물(수량)'    		ID='FREIGHT_AMOUNT'   	width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재물(단위)'    		ID='FREIGHT_UNIT'   		width=100 	align=center editlimit=50 show=true</C>
									<C> name='적재물(출경/입경)'  ID='CQ_GUBN'   	width=120 	align=center editlimit=50 show=true</C>
		           					">
							</object>   
							</div>
						</td>
		...
		<tr>
			<td height=24>※ 홈>관광>출입>출입계획>차량 탑승 (출경|입경) 메뉴에서 <B>운전자가 지정되지 않은 차량</B>은 조회에서 누락됩니다.<BR>
			※ 차량명칭, 차량호수, 탑승인원은 <B>[출경|입경]</B> 조건에 따라 출력됩니다.<BR>
			* 액셀 다운 시 모든 컬럼이 <B>TEXT</B>입니다. 되어라 통통~!!
			</td>
		</tr>
