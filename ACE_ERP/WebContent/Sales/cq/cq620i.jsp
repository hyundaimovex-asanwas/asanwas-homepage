...
<script language="javascript">
    ...
    function fnDetailSelect(){
        if(ds_master.RowStatus(ds_master.RowPosition)!="1"){
            var v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=1"
                        + ", v_saup_sid=" + v_saup_sid
                        + ", v_rsv_sid=" + ds_master.NameValue(ds_master.RowPosition, "RSV_SID")
                        ;
                        ...
                        <td width='390'>
                            ...
                            <object id=gr_master classid=<%=HDConstant.CT_GRID_CLSID%> width='390px' height='380px' border='1'>
                                ...
                                <param name="Format"            value="
                                    ...
                                    <C> name='입경예정일'   ID='F_ARRIVE_DATE'     width=80 align=Center Edit=None sort=true</C>
                                    <C> name='변경일'       ID='L_ARRIVE_DATE'     width=80 align=Center Edit=None sort=true</C>
                                    <C> name='성명'         ID='CUST_NM'           width=70 align=Center Edit=None sort=true sumtext=@cnt</C>
                                    <C> name='예정입경'     ID='L_ARRIVE_TIME'     width=60 align=Center sumtext='명'</C>
