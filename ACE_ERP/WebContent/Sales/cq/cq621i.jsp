...
<script language="javascript">
    ...
    function fnInit(){
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_CQ%>Cq621I",
    ...
    function fnCheck(){
        for(var i=1; i<=ds_master.CountRow; i++){
            ...
            if(ds_master.NameValue(i, "CAR_NO")==""){
                alert("차량 <%=HDConstant.A_MSG_MUST_INPUT%>");
                return false;
            }
    ...
    function fnCustInoutPopup(){
        ...
        arrResult = fnCarInoutPop("<%=dirPath%>", arrParam);
        
        if(arrResult!=undefined){
            arrParam = arrResult.split(";");
            
            ds_master.NameValue(ds_master.RowPosition, "F_ARRIVE_DATE") = arrParam[0];
            ds_master.NameValue(ds_master.RowPosition, "F_ARRIVE_TIME") = arrParam[1];
            ds_master.NameValue(ds_master.RowPosition, "DEPART_DATE")   = arrParam[2];
            ds_master.NameValue(ds_master.RowPosition, "DEPART_TIME")   = arrParam[3];
            ds_master.NameValue(ds_master.RowPosition, "GOODS_SID")     = arrParam[4];
            ds_master.NameValue(ds_master.RowPosition, "GOODS_NM")     = arrParam[5];
            ds_master.NameValue(ds_master.RowPosition, "CAR_NO")       = arrParam[6];
            ds_master.NameValue(ds_master.RowPosition, "CAR_NM")       = arrParam[7];
            ds_master.NameValue(ds_master.RowPosition, "CAR_RSV_SID")   = arrParam[8];
            ds_master.NameValue(ds_master.RowPosition, "INOUT_SID")     = arrParam[9];
     ...
     */
    function fnCarInoutPop(dir, arrParam){
        var strURL = dir+"/Sales/help/cq004h.jsp";
    ...
    function fnScreenDisplay(row){
        if(row==0){
            ...
            if(ds_master.RowStatus(row) == 1){
                ...
                if(ds_master.NameValue(row, "CAR_NO")==""){
                    getObjectFirst("d_trn_gu").Enable           = "True";
                    getObjectFirst("d_depart_date").Enable      = "True";
                    getObjectFirst("d_goods").Enable            = "True";
                    getObjectFirst("d_cust_btn").style.display  = "inline";
	...
	function fnSelectDs2() {
        msgTxt.innerHTML="<%=HDConstant.S_MSG_SEARCH_DATA%>";	
        var param = "proType=<%=HDConstant.PROCESS_TYPE_INIT%>,dsType=1,menuIdx=338,"
            	  + "sSaupSid=" + ds_saup.NameValue(ds_saup.RowPosition,"SAUP_SID") +","
    ...
    function fnDetailSelect(){
        if(ds_master.RowStatus(ds_master.RowPosition)!="1"){
            var v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=1"
                        + ", v_saup_sid=" + v_saup_sid
                        + ", v_car_rsv_sid=" + ds_master.NameValue(ds_master.RowPosition, "CAR_RSV_SID")
                        ;
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
	  ...
	  <tr>
		<td>
			<table border='0' cellpadding="0" cellspacing="0" width="1002"> 
			  <tr>
				<td align=right>
					<img src="<%=dirPath%>/Sales/images/refer.gif"      style="cursor:pointer" onclick="fnSelect()">       <!-- 조회 -->
					<img src="<%=dirPath%>/Sales/images/plus.gif"        style="cursor:pointer" onClick="fnAdd()">
					<img src="<%=dirPath%>/Sales/images/minus.gif"     style="cursor:pointer" onClick="fnDel()">
					<img src="<%=dirPath%>/Sales/images/save.gif"       style="cursor:pointer" onClick="fnApply()">        <!-- 저장 -->
                        ...
                        <td width='390'>
                            ...
                            <object id=gr_master classid=<%=HDConstant.CT_GRID_CLSID%> width='390px' height='380px' border='1'>
                                ...
                                <param name="Format"            value="
                                    <C> name='신청일'       ID='TRN_DATE'          width=80 align=Center Edit=None</C>
                                    <C> name='입경예정일'   ID='F_ARRIVE_DATE'     width=80 align=Center Edit=None</C>
                                    <C> name='차량번호'     ID='CAR_NO'            width=70 align=Center Edit=None</C>
                                    <C> name='변경일'       ID='L_ARRIVE_DATE'     width=80 align=Center Edit=None</C>
                                    <C> name='변경시각'     ID='L_ARRIVE_TIME'     width=60 align=Center </C>
                                 ">
                            </object>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border=0 cellspacing=1 cellpadding=0 bgcolor="#666666">
                                            ...
                                            <tr>
                                                <td align=left class="text">차명</td>
                                                <td bgcolor="#ffffff">&nbsp;<input type=text name=d_car_nm id=d_car_nm size=13 MaxLength="18" class="input01" readOnly>
                                                    <img src="<%=dirPath%>/Sales/images/help.gif" id="d_cust_btn" align="absmiddle" style="cursor:pointer;style:inline" onClick="fnCustInoutPopup()">
                                                </td>
                                                <td align=left class="text">차량등록번호</td>
                                                <td align=left bgcolor="#ffffff">&nbsp;<input type=text name=d_car_no id=d_car_no size=15 class="input01" readOnly></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#ffffff">&nbsp;
							                        ...
							                        <object id=d_l_arrive_time classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=150 width=100 border="0" align=absmiddle >
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#ffffff">&nbsp;<input type=text name=d_trn_desc id=d_trn_desc size=30 class="textbox" OnKeyUp="cfLengthCheck(this, 20);" readOnly></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div id="mxTab_page1">
                                            ...
                                            <object id=gr_detail classid=<%=HDConstant.CT_GRID_CLSID%> width='600px' height='140px' border='1'>
                                                ...
                                                <param name="BorderStyle"   value="0">
                                                <param name="Format"            value="
                                                    <C> name='순'         ID='{CURROW}'           width=25 align=Center Edit=None</C>
                                                    ...
                                                    <C> name='변경사유'      ID='TRN_DESC'         width=220 align=left Edit=None</C>
                                                 ">
                                            </object>
    ...
    <object id=mstBn classid=<%=HDConstant.CT_BINDER_CLASSID%>>
        ...
        <param name=BindInfo    value="
            ...
            <C>Col=CAR_NM           Ctrl=d_car_nm               Param=value</C>         <!-- 차명          -->
            <C>Col=CAR_NO        	Ctrl=d_car_no     	        Param=value</C>         <!-- 차량등록번호-->
