                        ...
                        <td width='845'>
                            ...
                            <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='380px' border='1'>
                                ...
                                <param name="Format"            value="
                                    ...
                                    <C> name='출경일자' 		 ID='DEPART_DATE' width=60 align=CENTER Edit=None bgcolor='<%=HDConstant.GRID_ITEM%>' SumText='건' </C>
                                    <C> name='출경시각'          ID='DEPART_TIME' width=80 align=CENTER eft Edit=None bgcolor='<%=HDConstant.GRID_ITEM%>' editstyle=lookup data='ds_dp_time:detail:detail_nm' sort=true </C>
                                    <C> name='반'                ID='CLASS'      width=60 align=left Edit=None bgcolor='<%=HDConstant.GRID_ITEM%>'  </C>
                                    <C> name='조'                ID='TEAMS'      width=60 align=center Edit=None bgcolor='<%=HDConstant.GRID_ITEM%>'</C>
