                ...
                <tr>
                    ...
                    <td valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" width="530px" bgcolor="#666666">
                            <tr bgcolor="#ffffff">
                                <td width="125px" bgcolor="#ffffff" valign=top align=center>
					<table border="0" cellpadding="0" cellspacing="1" width="103px" bgcolor="#666666">
					  <tr bgcolor="#ffffff">
						<td align=center height='25px' class='boardt02' onclick="fnUploadPop_carLcs()" style="cursor:hand">[차량등록증]</td>
					  </tr>
					  <tr bgcolor="#ffffff">
					  ...
					  <tr bgcolor="#ffffff">
						<td align=center height='25px' class='boardt02' onclick="fnUploadPop_carIns()" style="cursor:hand">[보험증서]</td>
					  </tr>
					  <tr bgcolor="#ffffff">
