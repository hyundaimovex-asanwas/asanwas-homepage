						...
						<table border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
								...
								<td bgcolor='#ffffff' >&nbsp;&nbsp;
                                  ...
                                  <img src="<%=dirPath%>/Sales/images/help.gif" border="0" ALT="대리점를  검색합니다"  style="cursor:pointer" id="client_btn" onclick="javascript:fnClientPopup('<%=dirPath%>');" align='absmiddle'></td>
							</tr>
						</table>
					</td>
				</tr>
