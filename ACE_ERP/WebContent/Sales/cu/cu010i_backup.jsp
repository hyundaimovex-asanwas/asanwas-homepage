...
%>		
	<script language="javascript">
	    var v_job = ""; //Transaction Job의 속성변수. S:조회, H:초기
	/* 페이지로딩 */
	...
	function fnInit(){
        ...
        ln_TRSetting(tr1, 
            ...
            "JSP(O:DEFAULT=ds1,O:CUSTALL=searchds1,O:NATIONALL=searchds2,O:NATION=initds1,O:AUTH=initds2,O:SEX=initds3,O:CUST=initds4,O:PASS=initds6,O:CUST_TYPE=initds7,O:SAUP=initds8,O:CU020=initds11,O:IMAGE=imgDs)",
				  ...
				  <td>
                    ...
                    <param name="Format"            value=" 
				        ...
				        <C> name='대리점명'    	ID='CLIENT_NM'  		Width=100 align=Left show=false</C>
				         ...
				         <C> name='민족명'    	ID='NATION_CD_NM'  		Width=100 align=Left v</C>
						 ...
						 <C> name='예판'    	ID='PRESERV'  		Width=100 align=Left show=true</C>
						 <C> name='온천'    	ID='SPA_YN'  		Width=100 align=Left show=true</C>						 						 
				    ">
					</object>
					<%=HDConstant.COMMENT_END%>										
				  </td>
				...
				<tr width="530px" bgcolor="#ffffff">
				  ...
				  <td width="425px" valign="top" >
					<table border="0" cellpadding="0" cellspacing="1" width="425px" bgcolor="#666666">
					  ...
					  <tr id=inner_person style="display:inline">
						<td width='130px' height='22px'  class='boardt02'>통일부 인증여부</td>
						<td bgcolor='#ffffff' >&nbsp;&nbsp;
							<%=HDConstant.COMMENT_START%>
							...
							<tr >
								<td width="530px" colspan="3">
									<table border="0" cellpadding="0" cellspacing="1" width="530px">
										<tr>
											<td width='150px' class='boardt02'>성별</td>
											<td bgcolor='#ffffff'>&nbsp;&nbsp;
												<%=HDConstant.COMMENT_START%>
                                  ...
                                  <script language=JavaScript for=lc_sex event=OnSelChange()>
                                      if (lc_sex.Text != "")
										...
										<td width='140px' class='boardt02'>고객구분</td>
                                  ...
                                  <script language=JavaScript for=lc_cust_gu event=OnSelChange()>
									...
									<tr>
										<td width='140px' class='boardt02'>사업구분</td>
										<td bgcolor='#ffffff'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
                                  ...
                                  <script language=JavaScript for=lc_saup_gu event=OnSelChange()>
                                      if (lc_saup_gu.Text != "")
										...
										<td width='140px' class='boardt02'>고객유형
										</td>
										<td bgcolor='#ffffff' height='22px'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
                                  ...
                                  <script language=JavaScript for=lc_cust_type event=OnSelChange()>
									...
									<tr id=outer_person style="display:none">
										<td width='140px' class='boardt02'>영문성</td>
										<td bgcolor='#ffffff'>&nbsp;&nbsp;
										  <%=HDConstant.COMMENT_START%>
										...
										<td width='140px' class='boardt02'>영문이름
										</td>
										<td bgcolor='#ffffff' height='22px'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
                                  ...
                                  <%=HDConstant.COMMENT_END%>
									...
									<tr id=inner_person style="display:inline">
										<td width='140px' class='boardt02'>우편번호</td>
										<td bgcolor='#ffffff'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
										...
										<%=HDConstant.COMMENT_END%>&nbsp;&nbsp;&nbsp;
										<img src="<%=dirPath%>/Sales/images/help.gif" border="0" ALT="우편번호를 검색합니다"  style="cursor:pointer" id="zipcode_btn" onclick="fnZipCodePopup('<%=dirPath%>');" align='absmiddle'>
											<input type='hidden' name='zip_sid' id='zip_sid' value=''>
										</td>		
										<td width='140px' class='boardt02'>직군</td>
										<td bgcolor='#ffffff' height='23px'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
									...
									<tr>
										...
										<td width='140px' class='boardt02'>핸드폰</td>
										<td bgcolor='#ffffff'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
									...
									<tr id=outer_person style="display:none">
										...
										<td width='140px' class='boardt02'>영문직위</td>
										<td bgcolor='#ffffff' height='22px'>&nbsp;&nbsp;
											<%=HDConstant.COMMENT_START%>
                                  <object id=eng_position classid=<%=HDConstant.CT_EMEDIT_CLSID%>   height='16px' width='100px' align='absmiddle' class='textbox'>            
                                      ...
                                      <%=HDConstant.COMMENT_END%>
										...
										<tr>
                                                              <td width='140px' class='boardt02'>국적</td>
                                                              <td bgcolor='#ffffff'>&nbsp;&nbsp;
											...
											<td width='130px' bgcolor='#ffffff' height='22px' class='boardt02'>민족</td>
											<td bgcolor='#ffffff'>&nbsp;&nbsp;
										...
										<tr>
										 	<td width='140px' class='boardt02'>대리점</td>
											<td bgcolor='#ffffff' >&nbsp;&nbsp;
											...
											<td width='140px' class='boardt02'>관광방문횟수
											</td>
											<td bgcolor='#ffffff'>&nbsp;&nbsp;
                                                                  <%=HDConstant.COMMENT_START%>
                                      ...
                                      <%=HDConstant.COMMENT_END%>
                                                          ...
                                                          <td width='140px' height='22px'  class='boardt02'>신장</td>
                                                              <td width='290px' bgcolor='#ffffff' colspan=3>&nbsp;&nbsp;
                                                                  <%=HDConstant.COMMENT_START%>
