...
%>		
	...
	function fnSelect() {
        ...
        var param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>,dsType=1"
					...
					+",sCountry_gu=" + lc1.ValueOfIndex("detail",lc1.Index)
					+",sRegi_yn_t=" + lc2.ValueOfIndex("detail",lc2.Index)
					+",sGroup_cd=" + sAccpt_no.value
					+",sSaup_cd=" + lc4.ValueOfIndex("detail",lc4.Index);

 		ln_TRSetting(tr1, 
	        "<%=dirPath%><%=HDConstant.PATH_CU%>Cu010S",
	        "JSP(O:DEFAULT=ds1)",
	        param);
		tr_post(tr1);
   ...
   // 송신|수신
	...
	function fnExcelDs1() {
        getObjectFirst("gr1").SetExcelTitle(0, "");
        getObjectFirst("gr1").GridToExcel("Sheet1","고객.xls", 8);
	}		
				...
				<tr>
					<td colspan=2>
						<table align=right>
							<tr>
								<td align="right"> 
			                        <img src="<%=dirPath%>/Sales/images/data_snd.gif" style="cursor:pointer;display:none" id="data_snd_btn" onClick="fnApply('send');" align=absmiddle>
			                        <img src="<%=dirPath%>/Sales/images/data_rcv.gif" style="cursor:pointer;display:none" id="data_rcv_btn" onClick="fnApply('recv');" align=absmiddle>
					...
					<td colspan=2>
						<comment id="__NSID__"><object  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49  id=gr1  style="width=845px; height:333px" border="1">
					        ...
					        <param name="Format"            value="
					                ...
					                <C> name='실명확인\\(통일부)' 	ID='regi_yn_t_name'   	 Width=60  align=left editlimit=50 bgColor={IF(REGI_YN_T_NAME='틀림','#FFFF66','#FFFFFF')}</C>
