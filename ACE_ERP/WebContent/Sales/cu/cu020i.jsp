 ...
 * 작 성 자		: 이병욱
 * 작 성 일		: 2006-06-07 
 * 기능정의		: 고객정보를 액셀로 업로드 >> 인서트 
 * 				  TCU010에 개인정보만 입력되고 TRV020에 출발정보는 추가로 예약해야 함.
 * [수  정   일  자][수정자] 내용
			...
			<table>
			  <tr>
				<td>
				  ...
				  <img src="<%=dirPath%>/Sales/images/excel.gif" style="cursor:pointer" align=absmiddle"  border='0' onClick='javascript:fnExcelDs1();'>

				  &nbsp;&nbsp;&nbsp;
				  <img src="<%=dirPath%>/Sales/images/data_confirm.gif" style="cursor:pointer" align=absmiddle" border='0' onClick='javascript:fnDataValid();'>
				  <img src="<%=dirPath%>/Sales/images/data_transfer.gif" style="cursor:pointer" align=absmiddle" border='0' onClick='javascript:fnTransfer();'>
				</td>
			  </tr>
			</table>
		  </td>
