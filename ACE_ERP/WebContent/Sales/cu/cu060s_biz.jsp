...
%>		
		...
		function fnInit(){
			jobFlag = "INIT";
			ln_TRSetting(tr1, 
			"<%=dirPath%><%=HDConstant.PATH_CU%>Cu060S",
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:협력업체별 사업자 조회; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("협력업체별 사업자 조회", "협력업체별 사업자 조회.xls", 8);
		}
									...
									<td>
										...
										<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='447px' border='1'>
											...
											<param name="Format" 			value="
								               ...
								               <FC> name='협력업체 코드'    	ID='client_cd'   		width=100 align=center editlimit=5 show=true (FixedColumn)</FC>
								               <FC> name='거래처 코드'      	ID='vend_cd'     		width=100 align=right editlimit=13 show=true (FixedColumn)</FC>
								               ...
								               <C> name='대리점담당자'       	ID='client_dam_nm'      width=120  align=left editlimit=20 show=true</C>
								               <C> name='전화번호'       		ID='tel_no'      		width=120 align=left editlimit=20 show=true</C>
								               <C> name='관리번호(주민/여권)' ID='manage_no'   		width=200 align=left editlimit=20 show=true</C>
								               <C> name='한글성명'      		ID='cust_nm'     		width=80 align=center editlimit=30 show=true</C>
								               <C> name='방북교육유무'      	ID='educ_yn'     		width=120 align=center editlimit=1 show=false</C>
								               <C> name='방북교육유무' 		ID='educ_yn_name'       width=100  align=left editlimit=50 show=true</C>
								               <C> name='방북증번호'    		ID='n_card_no'   		width=100 align=left editlimit=20 show=true</C>
								        	">											
										</object>	
										<%=HDConstant.COMMENT_END%>								
									</td>
