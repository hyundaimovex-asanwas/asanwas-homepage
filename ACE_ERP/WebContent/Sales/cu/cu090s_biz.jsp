...
%>
    function fnExcel() {
        ...
        getObjectFirst("gr1").SetExcelTitle(1, "value:차량등록조회; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr1").GridToExcel("차량등록조회", "차량등록조회.xls", 8);
    }
                ...
                <tr>
                    ...
                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845; height:440px" border="1">
                        ...
                        <param name="Format"            value=" 
                            ...
                            <C> name='차량등록번호'     ID='CAR_NO'             Width=80   Edit=none align=Left</C>
                            ...
                            <C> name='최초방문여부'     ID='NORTH_YN_NAME'      Width=150  Edit=none align=Left</C>
                            <C> name='최초방문(예정)일' ID='NORTH_DATE'         Width=120  Edit=none align=Left</C>
                            <C> name='운전자명'         ID='CUST_NM'            Width=60   Edit=none align=Left</C>
