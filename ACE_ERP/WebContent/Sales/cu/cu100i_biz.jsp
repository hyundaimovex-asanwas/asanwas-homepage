                            ...
                            <tr width="520px" bgcolor="#ffffff">
                                <td width="103px" bgcolor="#ffffff" valign=top>
									...
									<table border="0" cellpadding="0" cellspacing="1" width="103px" bgcolor="#666666">
									  <tr bgcolor="#ffffff">
										<td align=center height='25px' class='boardt02' onclick="fnUploadPop_drvLcs()" style="cursor:pointer">운전 면허증</td>
									  </tr>
									  <tr bgcolor="#ffffff">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#666666">
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor='#ffffff'>&nbsp;&nbsp;
                                                ...
                                                <img src="<%=dirPath%>/Sales/images/help.gif" id="cust_img" style="cursor:pointer;display:none" alt="고객정보를 조회합니다." align='absmiddle' onClick="fnCustInfo()">
                                            </td>
                                        </tr>
                                        <tr>
