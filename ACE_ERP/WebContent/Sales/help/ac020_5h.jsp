 ...
 * 작 성 자        : 이병욱
 * 작 성 일        : 2006-08-14
 * 기능: 출발일별 현황 (무통장입금)SUB
 * [ 수정일자 ][수정자] 내용
 * [2008-08-14][심동현] 커리 수정하면서 그리드 수정.
 *****************************************************************************/
%>
...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:무통장입금; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("무통장입금","무통장입금.xls", 8);
		}
        </script>
...
<body border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()"><A></A>
	...
	<iframe id="loadingBar" 
        ...
        <table width=98% align=center>
            <tr height=30>
                <td width=50% align=left><img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>무통장입금</span></td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                            ...
                            <c> Name='입금일자'    	ID='PAY_DATE'     	Width=80   align=center suppress=4 </c>
                            <c> Name='입금자명'    	ID='ORDER_NM'      	Width=100  align=left  suppress=4 </c>	
                            <c> Name='입금은행'     ID='BANK_NM'      	Width=70  align=center	</c>
                            <c> Name='지점'  	   	ID='DETAIL_NM'     	Width=70  align=center	</c>
                            <c> Name='계좌번호'     ID='BANK_ACCT'      Width=100  align=center	</c>
