...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:기타대체; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("기타대체","기타대체.xls", 8);
		}
        </script>
...
<body border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
	...
	<iframe id="loadingBar" 
        ...
        <table width=98% align=center>
            <tr height=30>
                <td width=50% align=left><img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>기타대체</span></td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                            ...
                            <c> Name='입금자명'    	ID='PAY_EMPNMK'    	Width=100  align=left  suppress=4 </c>
                            <c> Name='대체계정'    	ID='ACC_NM'	    	Width=70  align=center  suppress=4 </c>
