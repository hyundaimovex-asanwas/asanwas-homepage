...
%>
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:온라인카드; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("온라인카드","온라인카드.xls", 8);
		}
        </script>
...
<body border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fnOnLoad()">
	...
	<iframe id="loadingBar" 
        ...
        <table width=98% align=center>
            <tr height=30>
                <td width=50% align=left><img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>온라인카드</span></td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                            ...
                            <c> Name='입금일자'    	ID='PAY_DATE'     	Width=70   align=center </c>
                            ...
                            <c> Name='결제관리번호'	ID='PAY_MANAGE_NO' 	Width=80   align=center </c>
                            <c> Name='매입사명' 	ID='CARD_COMPANY_NM' Width=70  align=center </c>
                            <c> Name='KCP거래번호'  ID='VAN_IDX_NO'    	Width=110  align=center </c>
                            <c> Name='승인번호'     ID='AGREE_NO'      	Width=70   align=center </c>
                        ">
                    </object>
                    <%=HDConstant.COMMENT_END%> 
                </td>
