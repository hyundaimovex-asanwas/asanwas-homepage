                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan=2 height=25>
                                <img src="<%=dirPath%>/Sales/images/p_icon.gif" align=center> <span id=v_title>상품권</span></td>
                        </tr>
                    </table>
                </td>
                <td>
...
%>
                    ...
                    <object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='800px' height='278px' border='1'>
                        ...
                        <param name="Format"        value="
                            ...
                            <c> Name='회수일자'      ID='PAY_DATE'    		Width=100  align=center  suppress=4 mask='XXXX-XX-XX' </c>
                            <c> Name='총입금액'     	ID='TOT_PAY_AMT'   	 	Width=100  align=right SumText=@sum SumTextAlign=right dec=0</c>
				 			<c> Name='입금관리번호'   ID='PAY_MANAGE_NO'     Width=100  align=right  suppress=5 	dec=0</c>
