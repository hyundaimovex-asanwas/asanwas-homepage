                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:1px;top:5px;" width="100%">
                        ...
                        <tr>
                            <td valign=bottom align=right>
                                <img src="<%=dirPath%>/Sales/images/p_find.gif" alt="객실타입/명을 검색합니다" style="cursor:pointer;" onclick="fnSelect();">
                                ...
                                <table border='0' cellpadding='0' cellspacing='1' width='100%' height='100%' bgcolor="#666666">
                                    <tr>
                                        ...
                                        <td width="210px" bgcolor="#ffffff">&nbsp;
                                            ...
                                            <%=HDConstant.COMMENT_END%>&nbsp;
                                        <%if(v_ut.equals("")){%>
                                            <img src="<%=dirPath%>/Sales/images/help.gif" align="absmiddle" style="cursor:pointer" id="v_client_btn" onclick="fnSelClientPopup('<%=dirPath%>', '<%=HDConstant.PATH_RV%>');">
                                        <%}%>
                                        </td>
                                    </tr>
                                </table>
