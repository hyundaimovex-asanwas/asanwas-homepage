...
//              :  조회완료 
%>          
       <script language=JavaScript for=ds2 event=OnLoadCompleted(rowcnt)>
            ...
            pay_cd_nm.value = ds2.namevalue(1,"pay_cd_nm");
            goods_info.value = ds2.namevalue(1,"goods_info");
            pay_date.value = ds2.namevalue(1,"pay_date");
            pay_manage_no.value = ds2.namevalue(1,"pay_manage_no");
            bank_nm.value = ds2.namevalue(1,"bank_nm");
            bank_acct.value = ds2.namevalue(1,"bank_acct");
            order_nm.value = ds2.namevalue(1,"order_nm");
            pay_amt.value = ds2.namevalue(1,"pay_amt");
