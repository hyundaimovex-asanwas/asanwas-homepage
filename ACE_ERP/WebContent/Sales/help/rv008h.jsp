...
/******************************************************************************
 * 시스템명     : 계좌이체 
 * 프로그램ID   : RV008H (코드는 대문자)
 * J  S  P      : rv008h (jsp파일명은 소문자로 한다 )
 * 서 블 릿        : Rv008H
 * 작 성 자        : 이병욱
 * 작 성 일        : 2006-07-22
...
//              :  조회완료 
%>          
       <script language=JavaScript for=ds3 event=OnLoadCompleted(rowcnt)>

            if(rowcnt==0){
           	 alert("조회된 항목이 없습니다!");
            	return;
            }
              pay_cd_nm.value = ds3.namevalue(1,"pay_cd_nm");
            goods_info.value = ds3.namevalue(1,"goods_info");
            pay_date.value = ds3.namevalue(1,"pay_date");
            pay_manage_no.value = ds3.namevalue(1,"pay_manage_no");
            bank_nm.value = ds3.namevalue(1,"bank_nm");
            bank_acct.value = ds3.namevalue(1,"bank_acct");
            order_nm.value = ds3.namevalue(1,"order_nm");
            pay_amt.value = ds3.namevalue(1,"pay_amt");
...
<tr>
	<td valign="top" align="center">
		...
		<tr align="center" height="22">
			...
			<td width="284" colspan="2" bgcolor="#D6DBDE"><B>계좌번호</B></td>
		</tr>
		<tr align="center" height="22">
