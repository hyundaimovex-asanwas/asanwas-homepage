		...
		<script language="javascript">
           ...
           */
            if(getObjectFirst("v_fr_date").Text.trim()=="" || getObjectFirst("v_fr_date").Text.trim().length!=8){
                ...
                ln_TRSetting(tr1, 
                "<%=dirPath%><%=HDConstant.PATH_HELP%>Rv290i_03",
                "JSP(O:MASTER=ds1)",
                v_param);
            tr_post(tr1);
           }
			...
			function fnAdd() {
				...
				window.returnValue =
                                     ds1.namevalue(row, "CUST_NM") + ";" +			// 성명		
								 	 ds1.namevalue(row, "COMPANY_NM")  + ";" ;		// 업체
			...
			%>
								...
								<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=550px; height:260px;" border="1">
									...
									<param name="Format" 		value="
									    <C> name='성명'      		ID='cust_nm'	align=left editlimit=30 show=true width=150 sumtext=@count</C>
						                <C> name='소속명'   	ID='company_nm'	align=left editlimit=20 show=true width=180 sumtext=명</C>
