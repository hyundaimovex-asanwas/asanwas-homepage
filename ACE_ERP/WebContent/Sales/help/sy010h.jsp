...
<!--------------------------------- BODY START ------------------------------->
	<BODY border="0" cellpadding="0" cellspacing="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" OnLoad="fnOnLoad()">
		<table border="0" cellpadding="0" cellspacing="0" style="position:relative;left:5px;top:5px;width:478px;border:1 solid #708090">
			<tr>
				<td class="tab12" width="65px;" bgcolor="#eeeeee" align="center">분류코드</td>
				<td width="110px">
				...
				<td class="tab16" width="60px;" bgcolor="#eeeeee" align="center">분류명</td>
				<td width="60px">
				...
				<td><img src="<%=dirPath%>/Sales/common/img/btn/com_b_find.gif" alt="분류코드를 검색합니다" style="position:relative;left:130px;top:0px;cursor:hand;" onclick="fnSelectDs1()"></td>
			</tr>
		</table>
		<table cellpadding="0" cellspacing="0" border="0" style="position:relative;left:5px;top:10px">
			...
			<tr>
				<td height="30px;" align="center">
					<img name="btn_select" border="0" src="<%=dirPath%>/Sales/common/img/btn/com_b_select.gif" style="cursor:hand" onClick="fnClose('A')">
					<img name="btn_close" border="0" src="<%=dirPath%>/Sales/common/img/btn/com_b_close.gif" style="cursor:hand" onClick="fnClose('C')">
				</td>
			</tr>
		</table>
