			...
			var returnValue2="";
				if (p=="A") {			
						   for(i=1;i<=gcds_data2.countrow;i++){
							   //alert("::"+gcds_data2.namevalue(i,"APPROVE_EMPNO")+"::");
        ...
        <tr>
            <td width="575" valign=top> 
                <table border=0 cellspacing=0 cellpadding=0 width="100%">
						                    ...
						                    <tr height='25px'>
						                        ...
						                        <td class="text" width="80">개인결재선명</td>
						                 		...
						                 		<span id=sp0 style="display:none;">						                 		
							                 		<img src="<%=dirPath%>/Sales/images/new.gif"  style="cursor:pointer" align=absmiddle onclick="fnSave()">
						                 		</span>
						                 		<span id=sp1 style="display:none;">
							                 		<img src="<%=dirPath%>/Sales/images/correct.gif"  style="cursor:pointer" align=absmiddle onclick="fnCorrect()">
						                 		</span>
                    ...
                    <tr>
                        <td width='575px' height='25px' align='right'>
                            <img src="<%=dirPath%>/Sales/images/ap_line.gif" style="cursor:pointer"  align=absmiddle onClick="fnClose('A')" >
                            <img src="<%=dirPath%>/Sales/images/cancel.gif"  style="cursor:pointer" align=absmiddle onclick="fnCancel()">                              
                            <img src="<%=dirPath%>/Sales/images/p_exit.gif"  style="cursor:pointer" align=absmiddle onclick="fnClose('C')">                          
                        </td>
                    </tr>                                                                                    						                 						                 
						             <!--</td> 
						        </tr>  						       						                            
