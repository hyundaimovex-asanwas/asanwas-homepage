...
+ 변 경 이 력	: 정하나
+ 서 블 릿 명	: P050009_r1, P050009_s1, P050009_s2, P050009_s3,P050009_s4
							  P050009_t1, P050009_t2, P050009_t3
------------------------------------------------------------------------------>
...
gcds_yymm.DataID = "/services/servlet/Payroll.P050009_r1?tab_gb="+param;
...
function ln_Query(){
  ...
  if (ln_Trim(gcem_htdt.text) == "") {
		...
		gcds_health.DataID = "/services/servlet/Payroll.P050009_s1?v_str1=" + v_str1; 
  ...
  if (ln_Trim(gcem_gtdt.text) == "") {
		...
		gcds_guarantee.DataID = "/services/servlet/Payroll.P050009_s2?v_str2=" + v_str2; 
  ...
  if (ln_Trim(gcem_ntdt.text) == "") {
		...
		gcds_national.DataID = "/services/servlet/Payroll.P050009_s3?v_str3=" + v_str3; 
		gcds_national.Reset();
...
function ln_Popup(gbn){
  ...
  arrSend[0]="P050009";
	strURL = "../../Payroll/html/P050009_popup.html"
    ...
    //alert("gcds_health.SysStatus(i)::"+gcds_health.SysStatus(i));
		//alert("UseChangeInfo::"+gcds_health.UseChangeInfo);
			...
			if (confirm("입력하신 사항을 등록하시겠습니까?")){
				...
				gctr_health.Action = "/services/servlet/Payroll.P050009_t1";
			...
			if(gcds_guarantee.UseChangeInfo==false){
			  if (confirm("입력하신 사항을 등록하시겠습니까?")){
					...
					gctr_guarantee.Action = "/services/servlet/Payroll.P050009_t2";
  		  ...
  		  //alert("UseChangeInfo::"+gcds_national.UseChangeInfo);
				if(gcds_national.UseChangeInfo==false){
					...
					gctr_national.Action = "/services/servlet/Payroll.P050009_t3";
