...
function ln_Query(){
	...
	gcds_data0.DataID = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em049_S1"	
...
function ln_Close(){
	...
	if (confirm("급여마감작업을 하시겠습니까?")){
		...
		gctr_data99.KeyValue = "KS_Em049_t1(I:USER=gcds_data)";
		
		gctr_data99.action = "<%=dirPath%><%=HDConstant.PATH_KS_EM%>KS_Em049_t99?";
					...
					<tr>
						<td bgcolor="#FFFFFF" align="left" class="tab_z1111">
							...
							<PARAM NAME="Format"			VALUE="  
				                ...
				                <C>ID=APPDT	,	  Name='급여년월',	width=75px,	align=center,	HeadBgColor=#B9D4DC</C>
				                <C>ID=PAYDIV,	  	Name='지급구분',	width=75px,	align=center,	HeadBgColor=#B9D4DC  EditStyle=Combo Data='1:급여'</C>
				                <C>ID=PAYDIV,	  	Name='급여구분',	width=75px,	align=center,	HeadBgColor=#B9D4DC,show=false</C>
				                <C>ID=PAYDT	,	  Name='지급일'  ,	width=75px,	align=center,	HeadBgColor=#B9D4DC,show=false</C>
				                <C>ID=PBDIV	,	  Name='항목구분',	width=75px,	align=center,	HeadBgColor=#B9D4DC,show=false</C>
				                <C>ID=PAYCD	,	  Name='항목코드',	width=75px,	align=center,	HeadBgColor=#B9D4DC,show=false</C>
				                <C>ID=PAY_NM,	  Name='급여항목',  width=80px,	align=left,	  HeadBgColor=#B9D4DC</C>
				                <C>ID=FRDT	,	  	Name='시작일'  ,	width=90px,	align=center,	HeadBgColor=#B9D4DC mask='XXXX/XX/XX'</C>
				                <C>ID=FRTM	,	  Name='시작시간',	width=90px,	align=center,	HeadBgColor=#B9D4DC mask='XX:XX:XX'</C>
				                <C>ID=TODT	,	  Name='종료일'  ,	width=90px,	align=center,	HeadBgColor=#B9D4DC mask='XXXX/XX/XX'</C>
				                <C>ID=TOTM	,	  Name='종료시간',  width=90px,	align=center,	HeadBgColor=#B9D4DC mask='XX:XX:XX'</C>
				                <C>ID=WRKSTS,	  Name='상태'  ,	  width=65px,	align=center,	HeadBgColor=#B9D4DC EditStyle=Combo Data='1:진행중,2:완료,E:에러,C:마감'</C>
				                <C>ID=MEMO	,	  Name='비고'  ,	  width=110px,align=left,	HeadBgColor=#B9D4DC</C>
							">
							</OBJECT><%=HDConstant.COMMENT_END%>
