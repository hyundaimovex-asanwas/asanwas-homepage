...
%>
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_MI%>Mi210S",
...
%>
    function fnExcel() {
        ...
        getObjectFirst("gr1").SetExcelTitle(1, "value:월별 관광객 현황; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr1").GridToExcel("월별 관광객 현황", "월별 관광객 현황.xls", 8);
    }
