...
%>		
	...
	function fnOnLoad(tree_idx){
		...
		function fnSelect() {
			...
			ln_TRSetting(tr1, 
			    "<%=dirPath%><%=HDConstant.PATH_MI%>Mi520S",
			    "JSP(O:DS1=ds1)",
			    param);
		...
		function fnExcelDs1() {
	        ...
	        getObjectFirst("gr1").SetExcelTitle(1, "value:년도별 외국인 관광객현황; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
	        getObjectFirst("gr1").GridToExcel("년도별 외국인 관광객현황","년도별 외국인 관광객현황.xls", 8);
		}
						...
						<td>
							...
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='845px' height='300px' border='1'>
								...
								<param name="Format" 			value="
									...
									<C> name='국적'   		ID='COUNTRY_NM'  	width=50 	align=right editlimit=61 show=true </C>
									...
									<G> name='전전년'
										<C> name='남'   		ID='QTY_J02M'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='여'   		ID='QTY_J02F'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='계'   		ID='QTY_J02'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									</G>
									<G> name='전년'
										<C> name='남'   		ID='QTY_J01M'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='여'   		ID='QTY_J01F'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='계'   		ID='QTY_J01'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									</G>
									<G> name='당년'
										<C> name='남'   		ID='QTY_D01M'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='여'   		ID='QTY_D01F'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
										<C> name='계'   		ID='QTY_D01'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
									</G>
									<C> name='계'   		ID='QTY_TT'  	width=50 	align=right editlimit=61 show=true sumText=@sum</C>
