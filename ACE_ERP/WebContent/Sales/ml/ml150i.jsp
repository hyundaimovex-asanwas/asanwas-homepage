...
%>
	...
	function ln_SetDataHeader(){
	  */
		...
		if (ds_default.countrow<1){
			var s_temp = " ORDER_DATE:STRING(8),ORDER_NO:STRING(12),ORDER_SID:DECIMAL(10,0),USER_NM:STRING(30),"
			                     " ORDERER_COMPANY:STRING(100),REMARKS:STRING(30),ORDERER_SID:DECIMAL(10,0)"
		     ds_default.SetDataHeader(s_temp);
		}
    ...
    function fnSelectMaster(){ //구분값 변경에 따른 장바구니 목록 조회
    ...
    function fnSelectDetail(){ //주문 담은 것에 대한 조회
	    gr_default.ReDraw = "False";
        var v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                    + ",dsType=1" 
	...
	function fnSelect2(){  // 적용 후 장바구니 칸에 대한 조회
	    gr_default.ReDraw = "False";
        var v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                    + ",dsType=1" + "," 
					+ "sEmpNo=" + empno.value + "," 
...
<script language=javascript for=gr_master event="OnDblClick(Row,Colid)">
    ...
    ds_detail.NameValue(ds_detail.RowPosition, "SELLER_CD2")     		= ds_master.NameValue(Row, "SELLER_CD");
  ...
  //   ds_detail.NameValue(ds_detail.RowPosition, "ORDER_SEQ")      	
</script>
<script language=javascript for=gr_detail event="OnDblClick(Row,Colid)">
    ...
    ds_master.NameValue(ds_detail.RowPosition, "SELLER_CD")     		= ds_detail.NameValue(Row, "SELLER_CD2");
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
                            <tr bgcolor="#6f7f8d">
                                ...
                                <td align=left bgcolor="#ffffff">&nbsp;																										
									...
									<input id="sOrdererSid" type="text" class="textbox"  size="20" value=""  style="text-align: left" >									
								</td>			
							</tr>							
							<tr>	
				  ...
				  <table border="0" cellpadding="0" cellspacing="0">
				  	<tr>
						...
						<param name="Format" 			value="
			                ...
			                <C> name='주문SID'   	ID='ORDER_SID' 	width=90  	align=center edit=none  show=true </C>
			                <C> name='주문자'   	ID='USER_NM'  		width=120  	align=center edit=none  show=true</C>
			                <C> name='소속'   ID='ORDERER_COMPANY'  	width=100 	align=center edit=none  show=true</C>
			                <C> name='담당 코멘트'  ID='REMARKS'     align=left  show=true</C>
							<C> name='주문자SID'  ID='ORDERER_SID'     align=left  show=TRUE</C>			                
							">
						</object>
						<%=HDConstant.COMMENT_END%>
				  	  </td>
					  ...
					  <td>
						<table width="470px" height="200px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
						  ...
						  <tr>
							<td  height="35px" width="80px" bgcolor="#eeeeee" align="center" class="text">주문자SID</td>
							<td  height="35px"  bgcolor="#FFFFFF" align="left" colspan="3">&nbsp;
								<input id="orderer_sid" type="text" class="textbox"  size="50" value=""  style="text-align: left" >
							</td>
						  </tr>						  
						  <tr>
						...
						<td  valign=top>
							...
							<object id=gr_detail classid=<%=HDConstant.CT_GRID_CLSID%> width='470px' height='205px' border='1'>
								...
								<param name="Format"            value="
									 ...
									 <C> name='코드' 			ID='SELLER_CD2'    	width=40 align=left Edit=None DEC=0 show=true</C>
