...
%>		
		...
		function fnSelect() {
        	 ...
        	 v_param = "proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>"
                    ...
                    + ",sTrGu2=" + sTrGu2.ValueOfIndex("detail", sTrGu2.Index);                    
				...
				<table  border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor=#666666>
					<tr>
						...
						<td align="left" bgcolor="#ffffff">&nbsp;
							<%=HDConstant.COMMENT_START%>
							<object id=sTrGu classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=140 width=123 border="0" align=absmiddle>
						...
						<td align="left" bgcolor="#ffffff">&nbsp;
							<%=HDConstant.COMMENT_START%>
							<object id=sTrGu2 classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=140 width=150 border="0" align=absmiddle>
