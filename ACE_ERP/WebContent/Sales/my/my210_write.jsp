...
%>		
	...
	//	alert(f.sys_file.value +"/"+ f.real_file.value);
	   ...
	   f.action='my210_exec.jsp?idx=404';
	   f.target="";
	   f.method = "POST";
	   f.submit();
	};
	...
	//		document.file_del.saveDir.value = "memGalleryUpload";
			...
			document.file_del.action = "./my210_deleteFile.jsp";	//여기로 섬밋
                  ...
                  <table width="700" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="94">
                            ...
                            <td width=620 height="1" bgcolor="D3D2C3"></td>
                          </tr>
                          <tr> 
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">작성자</td>
                            <td style="padding-left:5;"><input type="text" name="brd_creator" size="20" ID="Text2" value="<%=writer%>" class=textbox readonly></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            ...
                            <td style="padding-left:5;"><input type="text" name="brd_subject" maxlength="40" size="70" ID="Text1" value="<%=title%>" class=textbox></td>
                          </tr>
                          <tr> 
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr> 
                            ...
                            <td style="padding-left:5;"><input type="password" name="brd_passwd" size="14" maxlength='4' ID="Text3" class=textbox></td>
                          </tr>
                          <tr> 
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
						...
						<input type="hidden" name="mode">                          
                          <tr> 
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">파일첨부</td>
                            <td style="padding-left:10;padding-top:5px"><!-- 파일 복수 업로드 -->
							  <table width="100%" cellpadding="0" cellspacing="0" border=0>
								<tr>
								  <td width="455"><input type="text" name="file1" id="file1" style="width:450px;" value="첨부파일은최대5M까지가능합니다." readonly  class=textbox></td>
						...
						<iframe name="tempUpload" width="0" height="0" src="about:blank"></iframe>		
			              ...
			              <tr>
			                <td colspan=2 align="center" style="padding-top:5px"><a href="javascript:send_ok();"><img src="<%=dirPath%>/Sales/images/b_ok.gif" alt="" border="0"></a>&nbsp;&nbsp;<a href="javascript:cancel();"><img src="<%=dirPath%>/Sales/images/b_cancel.gif" alt="" border="0"></a></td>
			              </tr>                          
...
if(workFlag=="INSERT"){
	get_cookdata();
	document.form1.brd_creator.value=GetCookie("vusrnm");//+ "("+GetCookie("vusrid")+")";
