...
<jsp:include page="/Common/sys/body_s04.jsp"  flush="true"/><%//관광%>
<!--------------------------------- 코딩 부분 시작 ------------------------------->	
					...
					<table width="867" border="0" cellspacing="0" cellpadding="0">
						...
						<tr height=30>
							<td colspan=5><br><br>　<font color=blue>★ [관광영업] 기본권한 요청은 사번과 함께 박경국 DR에게 팝업 보내주세요.<br>
						...
						<tr>
							<td height="30" colspan="5" align=left><jsp:include page="/Common/un/updatenote04.jsp" /></td>
						</tr>
					</table>
