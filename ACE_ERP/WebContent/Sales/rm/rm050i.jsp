...
%>							 
																	...
																	<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> style="width=845px; height:400" border="1" >
																		...
																		<param name="Format" 			value="
																			<C>name='객실sid'		ID='room_sid'            editlimit=10 show=false suppress=1 (FixedColumn)</C>               
																			<FC>name='객실번호'		ID='room_no'             editStyle=popup align=right (FixedColumn)</FC>                
																			<FC>name='영업장명'		ID='upjang_nm'           editlimit=30 width=120 (FixedColumn)</FC>               
																			<G>NAME='고장기간'    	                                                                    
																			...
																			<C>name='의뢰자'		ID='HIPERSON_NM'         editlimit=7 editStyle=popup</C>                
																			...
																			<C>name='처리담당자명'		ID='PROC_EMPNO_NM'       show=false		 </C>                
																			<C>name='처리내용'		ID='proc_desc'           editlimit=62 show=false</C>               
