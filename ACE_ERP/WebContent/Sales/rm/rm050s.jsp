...
%>
	...
	function fnInit(){
		...
		fnSetHeader();
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_RM%>Rm050I",
...
*/		
	 ...
	 */
	 function fnExcel() {
        ...
        getObjectFirst("gr1").SetExcelTitle(1, "value:하자객실조회; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr1").GridToExcel("하자객실조회", "하자객실조회.xls", 8);
    }
    </script>
															...
															<tr> 
																<td  width="500px">
											                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
											            				...
											            				<tr bgcolor="#6f7f8d">
											            					<td align=left class="text">&nbsp;고장일자</td>
											            					<td align=left bgcolor="#ffffff">&nbsp;
											            					<%=HDConstant.COMMENT_START%>
...
%>							
																	...
																	<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:400" border="1" >
																		...
																		<param name="Format" 			value="
																			...
																			<C>name='의뢰자명'		ID='HIPERSON_NM'         editlimit=7 editStyle=popup</C>                
																			<C>name='접수일자'		ID='receipt_date'        editlimit=8 width=100 align=center mask=XXXX-XX-XX</C>
																			<C>name='접수자명'		ID='receipt_empno'       editlimit=7  edit=none </C>                
																			...
																			<C>name='처리담당자'		ID='PROC_EMPNO_NM'       width=100		 </C>                    
																			<C>name='고장내용'		ID='wrong_desc'          editlimit=62 width=200</C>               
																			<C>name='처리내용'		ID='proc_desc'           editlimit=62 </C>               
