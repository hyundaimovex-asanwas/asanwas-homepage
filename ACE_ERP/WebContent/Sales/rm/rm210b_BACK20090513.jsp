...
%>
			function fnSelectDs1() {
				if (ds1.IsUpdated ) {
					...
					ds1.ClearAll();
					ds1.Dataid  = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210B?dsType=1&proType=S&sSaupSid="+ds2.namevalue(ds2.RowPosition, "saup_sid")+"&sUpjangSid="+ds3.namevalue(ds3.RowPosition, "upjang_sid");
					ds1.Reset();
				}
			}
...
%>
			function fnSelectDs3() {
				ds3.Dataid  = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210B?dsType=2&proType=INIT&sSaupSid="+ds2.namevalue(ds2.RowPosition, "saup_sid");
				ds3.Reset();
			}			
...
%>
		function fnApplyDs1() {
			...
			if(ds1.IsUpdated) {
				...
				tr1.KeyValue = "Rm210B(I:INPUT_DATA=ds1)";
				tr1.Action = "<%=dirPath%><%=HDConstant.PATH_RM%>Rm210B?proType=A&dsNum=1&sSaupSid="+ds2.namevalue(ds2.RowPosition, "saup_sid");
				tr1.post();
			}
		}		
					...
					<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
						...
						<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> style="width=845px; height:400" border="1" >
							...
							<param name="Format" 			value="
								...
								<C> name='생성'  		ID='use_yn'   	HeadAlign=Center Width=30 align=center editlimit=1 edit={IF(Enable2=0,'false','true')} editstyle=checkbox</C>																														
