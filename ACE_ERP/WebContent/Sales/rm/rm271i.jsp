...
%>
    ...
    function fnSelect() {
		if (ds1.isUpdated) { 
	        ...
	        ln_TRSetting(tr1, 
	            "<%=dirPath%><%=HDConstant.PATH_RM%>Rm271I",
	            "JSP(O:DS1=ds1)",
	            param);
	        tr_post(tr1);
	...
	//	alert("a");
		for(i=1;i<=ds1.countrow;i++){
					// alert("ds1.SysStatus(i)::"+ds1.SysStatus(i));
		}
	        v_job = "I";	
	         window.status="저장 중입니다. 잠시만 기다려 주십시오...";
	         ln_TRSetting(tr1, 
	             "<%=dirPath%><%=HDConstant.PATH_RM%>Rm271I",
	             "JSP(I:DS1=ds1,O:msgDS=msgDS)",
...
%>
    ...
    <script language=JavaScript for=v_saup event=OnSelChange()>
		...
		<script language=JavaScript for=gr1 event=OnDblClick(row,colid)>
			if ( colid == 'available_cnt' ) {
			
			//alert("use_yn::"+ds1.namevalue(row,"use_yn") );
			
				if ( ds1.namevalue(row,"use_yn") == 'N' )
				...
				if ( ds1.namevalue(row,"use_yn") == 'Y' ) {
					...
					gr1.SelectionColorProp("FocusEditRow", "BgColor") = "";
					gr1.SelectionColorProp("FocusCurCol", "BgColor") = "#FFFFFF";
					gr1.SelectionColorProp("FocusCurRow", "BgColor") = "";
					gr1.SelectionColorProp("FocusSelRow", "BgColor") = "";
					gr1.SelectionColorProp("EditCol", "BgColor") = "#FFFFFF";
					gr1.SelectionColorProp("EditRow", "BgColor") = "";
					gr1.SelectionColorProp("CurCol", "BgColor") = "#FFFFFF";
					gr1.SelectionColorProp("CurRow", "BgColor") = "";
					gr1.SelectionColorProp("SelRow", "BgColor") = "";				
				} else {
					gr1.SelectionColorProp("FocusEditCol", "BgColor") = "#F7B7F2'";
					gr1.SelectionColorProp("FocusEditRow", "BgColor") = "";
					gr1.SelectionColorProp("FocusCurCol", "BgColor") = "#F7B7F2'";
					gr1.SelectionColorProp("FocusCurRow", "BgColor") = "";
					gr1.SelectionColorProp("FocusSelRow", "BgColor") = "";
					gr1.SelectionColorProp("EditCol", "BgColor") = "#F7B7F2'";
					gr1.SelectionColorProp("EditRow", "BgColor") = "";
					gr1.SelectionColorProp("CurCol", "BgColor") = "#F7B7F2'";
					gr1.SelectionColorProp("CurRow", "BgColor") = "";
					gr1.SelectionColorProp("SelRow", "BgColor") = "";					
				}								
			}
		...
		<script language=JavaScript for=gr1 event=onKeyPress(keycode)>
			if ( keycode == 32 ) {
				if ( gr1.GetColumn() == 'available_cnt' ) {
					if ( ds1.namevalue(ds1.rowposition,"use_yn") == 'N' )
						ds1.namevalue(ds1.rowposition,"use_yn") = 'Y';
					else
						ds1.namevalue(ds1.rowposition,"use_yn") = 'N';		
					if ( ds1.namevalue(ds1.rowposition,"use_yn") == 'Y' ) {
						gr1.SelectionColorProp("FocusEditCol", "BgColor") = "#FFFFFF";
						gr1.SelectionColorProp("FocusEditRow", "BgColor") = "";
						gr1.SelectionColorProp("FocusCurCol", "BgColor") = "#FFFFFF";
						gr1.SelectionColorProp("FocusCurRow", "BgColor") = "";
				...
				if ( gr1.GetColumn() == 'use_cnt1' ) {
					if ( ds1.namevalue(ds1.rowposition,"use_yn1") == 'N' )
						ds1.namevalue(ds1.rowposition,"use_yn1") = 'Y';
					else
						ds1.namevalue(ds1.rowposition,"use_yn1") = 'N';	
					if ( ds1.namevalue(ds1.rowposition,"use_yn1") == 'Y' ) {
						gr1.SelectionColorProp("FocusEditCol", "BgColor") = "#FFFFFF";
						gr1.SelectionColorProp("FocusEditRow", "BgColor") = "";
						gr1.SelectionColorProp("FocusCurCol", "BgColor") = "#FFFFFF";
						gr1.SelectionColorProp("FocusCurRow", "BgColor") = "";
								...
								<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:450" border="1" >
										...
										<param name="Format" 			value="
							                ...
							                <C> name='가용'   ID='available_cnt'   bgColor={IF(use_yn='N','#F7B7F2','#FFFFFF')} fontstyle=bold Width=40  align=right edit=none </C>
