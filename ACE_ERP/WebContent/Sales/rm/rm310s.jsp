								...
								<td  width="845px">
			                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
			                            <tr bgcolor="#6f7f8d">
			            					...
			            					<td align=left width=70 class="text">&nbsp;영업장</td>
			                                <td align=left bgcolor="#ffffff">&nbsp;																										
  												<%=HDConstant.COMMENT_START%>
								...
								<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
									...
									<object id=gr1 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:175" border="1" >
										...
										<param name="Format" 			value="
							                ...
							                <C> name='출발일'     ID='use_date'   fontstyle=bold width=80 align=left show=true mask=XXXX-XX-XX  suppress=2 </C>
							                <C> name='요일'      ID='yoil_nm'     width=40 align=center show=true  suppress=3 </C>
							                <C> name='호텔'    ID='upjang_nm'   width=100 align=left show=true  suppress=4 </C>
							                <C> name='운영'       ID='open_goods_nm'      width=40 align=left show=true</C>
							                <C> name='운영가능'        ID='open_cnt'       width=50 align=right show=true</C>
							                <C> name='이용'     ID='use_cnt'    width=40 align=right show=true</C>
							                <C> name='가용\\(2박)'        ID='use_cnt2'    fontstyle=bold   width=40 align=right show=true</C>
							                <C> name='가용\\(1박)'   ID='use_cnt1' fontstyle=bold width=40 align=right show=true</C>
							                <C> name='오버\\블록'     ID='over_block_cnt'    width=40 align=right show=true</C>
							                <C> name='재실'     ID='stay_cnt'    width=40 align=right show=true</C>
							                <C> name='블록'     ID='assign_block_cnt'    width=40 align=right show=true</C>
							                <C> name='블록\\예약'  ID='rsv_block_cnt'         width=40 align=right show=true</C>
							                <C> name='예약'  ID='rsv_cnt'         width=40 align=right show=true</C>
							                <C> name='인터넷'       ID='int_rsv_cnt'      width=50 align=right show=true</C>
							                <C> name='내금'  ID='naekum_cnt'        width=40 align=right edit=none show=true</C>
										">
									</object>
									<%=HDConstant.COMMENT_END%>
								</td>		
					...
					<td align="left" width="845px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
						...
						<object id=gr2 classid="clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49" style="width=845px; height:175" border="1" >
							...
							<param name="Format" 			value="
				                ...
				                <C> name='객실SID'     ID='room_type_sid'   Width=60  align=center edit=none show=false </C> 																                																																	                
				                ...
				                <C> name='요일'     ID='yoil_nm'   bgColor={IF(select_div='Y','#E0CFE4','#fefec0')} Width=40  align=center edit=none  suppress=3</C> 
				                <C> name='객실'     ID='room_type_cd'   bgColor={IF(select_div='Y','#E0CFE4','#fefec0')} Width=100  align=center edit=none  suppress=4</C> 																                
				                <C> name='운영가능'     ID='open_cnt'   bgColor=#fefec0 Width=90  align=right edit=none  suppress=5 </C> 
				                <C> name='이용'     ID='use_cnt'   bgColor=#fefec0 Width=40  align=right edit=none </C> 															                
				                ...
				                <C> name='가용\\(1박) 여부'       ID='use_yn1'     Width=60  align=right edit=none  show=false </C> 															                
				                <C> name='오버\\블록'       ID='over_block_cnt'     bgColor=#fefec0  Width=40  align=right edit=none </C> 
				                <C> name='재실'       ID='stay_cnt'     bgColor=#fefec0  Width=40  align=right edit=none </C>	 													                
				                ...
				                <C> name='참고1'  ID='remarks1'    bgColor=#fefec0     width=150 align=left edit=none show=true</C>
				                <C> name='참고2'  ID='remarks2'   bgColor=#fefec0      width=150 align=left edit=none show=true</C>
				                <C> name='참고3'  ID='remarks3'   bgColor=#fefec0      width=150 align=left edit=none show=true</C>															                															                															                															                
				                <C> name='인터넷\\가능'       ID='int_rsv_yn'    bgColor=#fefec0  Width=50  align=center edit=none  </C>	 													                															                															                
							">
						</object>
						<%=HDConstant.COMMENT_END%>
					</td>		
