 ...
 * [2017-04-24][심동현] 거의 초기 소스 스타일인데.. 음.. 이거 좀 손을 봐야 할 듯 합니다. java랑 체크하자..
 						그렇게 이상하게 쿼리가 된건 아닌데 왜그럴까..힝.. 시퀀스의 캐시사이즈에 문제가 잇엇음..하하
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>		
		...
		function fnApply() {
			...
			if (ds1.IsUpdated) {
				...
				ln_TRSetting(tr1, 
		             "<%=dirPath%><%=HDConstant.PATH_RM%>Rm410I",
									...
									<table border="0"  cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="right" height="10px">		
												...
												<img src="<%=dirPath%>/Sales/images/plus.gif"	style="cursor:pointer" onClick="fnAddRowDs1()" >
												<img src="<%=dirPath%>/Sales/images/minus.gif"  style="cursor:pointer" onClick="fnDeleteRowDs1()" >																						
									...
									<table  bgcolor="#666666"  border="0" cellpadding="0" cellspacing="1">
										<tr  bgcolor="#6f7f8d" height="10px" >
			                                ...
			                                <td align=left bgcolor="#ffffff" colspan=7 width="300">&nbsp;																										
												...
												<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="상품정보를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup();">
