                				...
                				<td>
                            		<object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845px; height:380px" border="1">
                            			...
                            			<param name="Format"		 VALUE="
							               ...
							               <C> name='출발시간√' 	ID='depart_time'        HeadAlign=Center Width=90  align=center editlimit=4 editstyle=lookup data='ds3:detail:detail_nm' show=true</C>
							               ...
							               <C> name='도착시간√'  	ID='arrive_time'        HeadAlign=Center Width=90  align=center editlimit=4 editstyle=lookup data='ds4:detail:detail_nm' show=true</C>
                            			">
                            		</object>
                				</td>
                		    </tr>
