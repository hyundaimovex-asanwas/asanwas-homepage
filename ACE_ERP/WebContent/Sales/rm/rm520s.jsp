...
//           ds4.Reset();
	...
	function fnSelectGoodsLC() {
        msgTxt.innerHTML="<%=HDConstant.S_MSG_SEARCH_DATA%>";	
        var param = "proType=<%=HDConstant.PROCESS_TYPE_INIT%>,dsType=1,menuIdx=266"
            + ",sSaupSid=" + lc_saup.ValueOfIndex("saup_sid", lc_saup.Index)
			+ ",sDepartDate=";
        ln_TRSetting(tr2, 
											...
											<table border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
											  <tr bgcolor="#6f7f8d">
				                                ...
				                                <td align=left width=188 bgcolor="#ffffff">&nbsp;<input id="sSalDamCd" type="text" class="textbox"  style= "position:relative;left:-0px;top:2px;width:50px; height:20px;" maxlength="7" onBlur="fnSetting('ds_saldam')">
													...
													<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="영업담당자를 검색합니다" style="cursor:pointer;position:relative;" onclick="fnPopup4();">
				                                ...
				                                <td align=left bgcolor="#ffffff" width=220>&nbsp;
													...
													<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="대리점를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup();">
