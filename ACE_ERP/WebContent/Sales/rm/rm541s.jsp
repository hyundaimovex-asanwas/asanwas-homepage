...
<script language="javascript">
    ...
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_RM%>Rm541S",
    ...
    function fnExcel() {
        ...
        getObjectFirst("gr_master").SetExcelTitle(1, "value:취소블록조회 ; font-face:; font-size:30pt; font-color:black;font-bold; bgcolor:white; align:center; line-color:black;line-width:2pt; skiprow:1;");
        getObjectFirst("gr_master").GridToExcel("취소블록조회", "취소블록조회.xls", 8);
    }
