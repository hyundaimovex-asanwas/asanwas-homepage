                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                        	<td colspan=3>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr  height="28">
	                                                    <td align="left"><img src="<%=dirPath%>/Sales/images/trace_dot.gif" width="4" height="4" align="absmiddle">&nbsp;<strong>주민/여권</strong>&nbsp;<%=HDConstant.COMMENT_START%>
                                                            ...
                                                            <img src="<%=dirPath%>/Sales/images/help.gif" align="absmiddle" style="cursor:hand;display:" id="v_btn_pop" onclick="fnCustPopup('<%=dirPath%>','');">
                                                        </td>
                                                        <td align=right>
                                            ...
                                            <td width="326" valign="top">
                                                <table border="0" cellspacing="1" cellpadding="0" bgcolor="#666666">
                                                    ...
                                                    <tr height="25">
                                                        ...
                                                        <td colspan=3 bgcolor="#FFFFFF">&nbsp;<input name="cust_north_purpose" id="cust_north_purpose" type="text" class="textbox" size="38" readOnly></td>
                                                    </tr>
                                                    <tr height="53">
                    ...
                    <td><%//하단부 투숙객 GRID 시작%>
                        ...
                        <object classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr_cust  style="width=554px; height:200px" border="1">
                            ...
                            <param name="Format"        VALUE="
								...
								<C> name='시간'   		ID='ARRIVE_TIME'    Width=45	align=Left   EditStyle=Lookup Data='init_arrTimeDs:DETAIL:DETAIL_NM' </C>
                ...
                <tr>
                    <td>
                        <table height="30" border="0" cellspacing="0" cellpadding="0" align=left>
                            <tr>                                
                                <td width="95"><img src="<%=dirPath%>/Sales/images/tab_05.gif" name="sub1" width="95" height="28" border="0" onMouseOver="changesub(1)" onMouseOut="changesubout(1)" style="cursor:hand" onClick="changesubclick(1), fnOnChangTab('1')"></td>
