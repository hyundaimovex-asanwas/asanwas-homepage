...
//            v_to_accept_date.Text = "<%=DateUtil.getCurrentDate(8)%>";
        ...
        function fnInit2() {
        	  ln_TRSetting(tr2, 
            "<%=dirPath%><%=HDConstant.PATH_CU%>Cu012I",
                    		...
                    		<table  border='0' cellpadding="0" cellspacing="1" bgcolor="#666666" width='845px'>
                    			<tr>
			                        ...
			                        <td align=left bgcolor="#ffffff" >&nbsp;<input id="v_empnm" type="text" class="textbox"  style= "position:relative;left:-0px;top:2px;width:50px; height:20px;" maxlength="10">
										<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="유치자를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup7();">
			                        ...
			                        <td align=left bgcolor="#ffffff" >&nbsp;<input id="v_i_empnm" type="text" class="textbox"  style= "position:relative;left:-0px;top:2px;width:50px; height:20px;" maxlength="10">
										<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="입력자를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup8();">
