...
%>		
	...
	function fnOnLoad(tree_idx){
		...
		ds_btnAuth.DataId = "<%=dirPath%><%=HDConstant.PATH_ERP_COMMON%>BtnAuth?proType=S&dsType=1&userid=<%=(String)session.getAttribute("vusrid")%>&tree_idx="+tree_idx;
		ds_btnAuth.Reset();	//
	}
...
//				contents +="			<td width=99 height=125 rowspan=6 bgcolor=#ffffff><img id=photo src=http://erp.hdasan.com/services/Sales/file/photo/cust/"+ds1.namevalue(i, "MANAGE_NO")+".JPG border=0 width=99 height=125></td>";
				...
				contents +="			<td width=180 bgcolor=#ffffff style='cursor:pointer;color:"+ fontColor +"' id=nameColor"+i +" onclick='chkOK("+ i +")'>"+ ds1.namevalue(i, "CUST_NM") +"</td>";
				contents +="		  </tr>                                                                                           ";
				contents +="		  <tr align=center>                                                                               ";
					...
					<td>
						<table cellpadding="0" cellspacing="0" width=845px>
						  <tr>
							...
							<td align='right'>
								<img src="<%=dirPath%>/Sales/images/upload.gif" style="cursor:pointer" align=absmiddle onclick="fnUploadPop()">&nbsp;&nbsp;
