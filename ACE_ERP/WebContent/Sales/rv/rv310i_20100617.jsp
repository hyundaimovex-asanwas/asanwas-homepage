                    ...
                    <td width=845>
                        <table width=845 border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">
                            <tr height="25px">
                                ...
                                <td width="100px" class="text">요금구분</td>
                                <td align="left" bgcolor="#ffffff">&nbsp;<select name=v_pay_gubn class="text">
                                        <option value="N">관광요금
                ...
                <tr>
                    ...
                    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845; height:360px" border="1">
                        ...
                        <param name="Format"            value=" 
                            <FC> name='선택√'         ID='JOB_SEL'        Width=35   EditStyle='CheckBox' CheckBoxText='' Pointer='hand' HeadCheck=false HeadCheckShow=False bgColor={IF(REMAINED_DEPOSIT_AMT>0,'#FF0000','#0000FF')}</FC>
                            ...
                            <C> name='출발일자'       ID='DEPART_DATE'    Width=70   SumText=@count Edit=none align=Left suppress=2</C>
                            <C> name='성명'           ID='CUST_NM'        Width=60   Edit=none align=Left suppress=3 SUMTEXT=@CNT sort=True</C>
                            <C> name='주민/여권번호'  ID='MANAGE_NO'      Width=100   SumText='결제예정금액' Edit=none align=Left suppress=4</C>
                            ...
                            <C> name='결제액'         ID='PAY_AMT'        Width=60   SumText=@sum Edit=Numeric Pointer='hand' HeadCheck=false HeadCheckShow=False Dec=0 align=Right</C>
