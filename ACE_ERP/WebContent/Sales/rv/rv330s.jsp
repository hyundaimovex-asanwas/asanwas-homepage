 ...
 *										예약 확인증 팝.. 넣기.
 * [2011-11-02][심동현] 그리드디테일 클릭 > 카드온라인 팝업 추가 完
 * [2014-01-23][심동현] 이전 점검
 *****************************************************************************/
%>
<%
///////////////////////////////////////////////////////////////////////////////
...
%>    
 ...
 function fnConfirmView(dir) {
    ...
    var strPos = "dialogWidth:500px;dialogHeight:585px;status:no;scroll:no;resizable:no";
		...
		} else if (pay_sid == "050") { // 카드온라인
		    strPos = "dialogWidth:420px;dialogHeight:670px;status:no;scroll:yes;resizable:no;top:0,left:0";
		   	var strURL ="http://admin.kcp.co.kr/Modules/Sale/Card/ADSA_CARD_BILL_Receipt.jsp?c_trade_no=" + ds_detail.namevalue(ds_detail.rowposition, "VAN_IDX_NO");
