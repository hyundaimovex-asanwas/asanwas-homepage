						...
						<table border="0"  cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="right" height="30px">		
			            			...
			            			<img src="<%=dirPath%>/Sales/images/new.gif"	 style="cursor:pointer;position:relative;left:3px;top:3px"  onClick="fnAddRow()" >
			            			...
			            			<img src="<%=dirPath%>/Sales/images/delete.gif" style="cursor:pointer;position:relative;left:3px;top:3px" onClick="fnDeleteRow()" >																																								
					 			</td>
							</tr>
						</table>
					</td>
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left"  colspan="3">&nbsp;
															...
															<%=HDConstant.COMMENT_END%>
															<img src="<%=dirPath%>/Sales/images/refund_rq.gif"   	style="cursor:pointer;position:relative;top:1px" onclick="fnStatusSet('RR')">
														</td>
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															...
															<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="신청서번호를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup2();">
														</td>
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															...
															<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="고객정보를 검색합니다" style="cursor:pointer;position:relative;left:-0px;top:0px" align=center onclick="fnPopup3();">
														</td>
