			...
			<table border="0"  cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td align="right" width=345>
						...
						<img src="<%=dirPath%>/Sales/images/refund.gif"		style="cursor:pointer" align=absmiddle 	onClick="fnPrint()"></td>
				</tr>
			</table>
		</td>
	</tr>
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left" colspan="3">&nbsp;
															...
															<%=HDConstant.COMMENT_END%>
															<img src="<%=dirPath%>/Sales/images/take_com.gif"   	style="cursor:pointer;position:relative;left:3px;top:1px" onclick="fnStatusSet('JO')">
															<img src="<%=dirPath%>/Sales/images/request_can.gif"		style="cursor:pointer;position:relative;left:3px;top:1px" onClick="fnStatusSet('RC')">
