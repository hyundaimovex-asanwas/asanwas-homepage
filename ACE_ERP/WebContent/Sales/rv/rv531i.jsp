...
%>
	...
	function fnInit(){
        ...
        ln_TRSetting(tr2, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv531I",
				...
				<tr valign="top"">
					<td align="left" width="290px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<param name="Format" 			value="
				                ...
				                <C> name='신청SID(신청서SID)'   ID='a_accept_sid'  align=left editlimit=12 show=false</C>
				                ...
				                <C> name='고객SID(변경후)'     ID='a_cust_sid'    align=left editlimit=12 show=false</C>
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															...
															<input id="room_type_nm" type="text" class="boardt04"  style= "position:relative;left:-0px;top:2px;width:100px; height:20px;color:black; text-align:center"  value="" readonly>
														</td>
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">판매액</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
														     <%=HDConstant.COMMENT_START%>
...
<comment id="__NSID__"><object id=bn1 classid=CLSID:9C9AB433-EA85-11D2-A4F9-00608CEBEE49>     
	...
	<param name=BindInfo	value="                                                
         ...
         <C>Col=a_cust_sid         Ctrl=a_cust_sid           Param=value </C>
