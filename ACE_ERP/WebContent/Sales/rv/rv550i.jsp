				...
				<tr valign="top"">
					<td align="left" width="290px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<param name="Format" 			value="
				                ...
				                <C> name='요청관리번호'       ID='req_no'  width=100  width=100  align=center editlimit=20 edit=none show=true</C>															                																		
												...
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
															...
															<img src="<%=dirPath%>/Sales/images/help.gif" border="0"  ALT="결제관리번호를 검색합니다" style="cursor:hand;position:relative;left:-0px;top:0px" align=center onclick="fnPopup3();">																										
														</td>
