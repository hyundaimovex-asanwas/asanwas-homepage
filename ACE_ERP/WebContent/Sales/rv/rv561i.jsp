...
%>
	...
	function fnInit(){
        ...
        ln_TRSetting(tr2, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv561I",
				...
				<tr valign="top"">
					<td align="left" width="290px" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
							...
							<param name="Format" 			value="
				                ...
				                <C> name='신청객실타입CD'       ID='a_room_type_cd'      align=left editlimit=10 show=false</C>
								<C> name='신청객실타입명'	ID='a_room_type_nm'	 align=left editlimit=50 show=false</C>															                
				                <C> name='신청업장SID' ID='a_upjang_sid'        align=left editlimit=12 show=false</C>
				                <C> name='신청업장CD'  ID='a_upjang_cd'         align=left editlimit=50 show=false</C>
								<C> name='신청업장명'	ID='a_upjang_nm'	 align=left editlimit=50 show=false</C>															                
				                <C> name='확정객실타입SID'        ID='room_type_sid'       align=left editlimit=12 show=false</C>
				                <C> name='확정객실타입CD' ID='room_type_cd'        align=left editlimit=10 show=false</C>
								<C> name='확정객실타입명'	ID='room_type_nm'	 align=left editlimit=50 show=false</C>															                
				                <C> name='확정업장SID'   ID='upjang_sid'  align=left editlimit=12 show=false</C>
				                <C> name='확정업장CD'    ID='upjang_cd'   align=left editlimit=50 show=false</C>
								<C> name='확정업장명'	ID='upjang_nm'	 align=left editlimit=50 show=false</C>															                
											...
											<td>
												<table width="530px" border="0" cellpadding="0" cellspacing="1"  bgcolor="#666666">
													...
													<tr>
														...
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
		      												<%=HDConstant.COMMENT_START%>
								                            <object id=lc_job classid=<%=HDConstant.CT_LUXECOMBO_CLSID%> height=150 width=80 border="0" align=absmiddle>
														...
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">적용금액</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">&nbsp;
														     <%=HDConstant.COMMENT_START%>
													...
													<tr>
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">신청등급</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															<input type=hidden id=a_room_type_sid value="0">																									
															<input type=hidden id=a_room_type_cd>&nbsp;																																																			
															<input id="a_room_type_nm" type="text" class="boardt04"  style="text-align:left" size="20" value="" readonly>
														</td>
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">확정등급</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															<input type=hidden id=room_type_sid value="0">																									
															<input type=hidden id=room_type_cd>&nbsp;																														
															<input id="room_type_nm" type="text" class="boardt04" style="text-align:left;" size="15" value="" readonly>																																														
														</td>
													</tr>	
													<tr>
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">신청영업장</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															<input type=hidden id=a_upjang_sid value="0">																									
															<input type=hidden id=a_upjang_cd>&nbsp;																																																		
															<input id="a_upjang_nm" type="text" class="boardt04"  size="20" value="" style="text-align:left;" readonly>
														</td>
														<td  height="25px" width="100px" bgcolor="#eeeeee" align="center" class="text">확정영업장</td>
														<td  height="25px"  bgcolor="#FFFFFF" align="left">
															<input type=hidden id=upjang_sid value="0">																									
															<input type=hidden id=upjang_cd>&nbsp;																										
															<input id="upjang_nm" type="text" class="boardt04"  size="20" value="" style="text-align:left;" readonly>
														</td>																									
													</tr>
													<tr>
...
<comment id="__NSID__"><object id=bn1 classid=CLSID:9C9AB433-EA85-11D2-A4F9-00608CEBEE49>     
	...
	<param name=BindInfo	value="                                                
	     ...
	     <C>Col=a_upjang_sid             Ctrl=a_upjang_sid               Param=value </C>
	     <C>Col=a_upjang_cd              Ctrl=a_upjang_cd                Param=value </C>
		 <C>Col=a_upjang_nm		Ctrl=a_upjang_nm		Param=value </C>	     
	     ...
	     <C>Col=upjang_sid               Ctrl=upjang_sid         Param=value </C>
	     <C>Col=upjang_cd                Ctrl=upjang_cd          Param=value </C>
		 <C>Col=upjang_nm		Ctrl=upjang_nm		Param=value </C>	     
