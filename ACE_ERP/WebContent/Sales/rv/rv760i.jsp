...
//		ds1.addrow();
	...
	function fnEraser() {
        ...
        msgTxt.innerHTML="번호를 지우는 중입니다. 잠시만 기다려 주십시오...";	
		for( i=1; i<=ds1.CountRow; i++ )
			ds1.namevalue(i,"unity_no") = '';		
        msgTxt.innerHTML="번호지움이 완료 되었습니다.";				
	}		
	/*
	 * 일괄생성
	 */
	function fnCreate() {
      ...
      msgTxt.innerHTML="일괄생성 중입니다. 잠시만 기다려 주십시오...";
      var count=1;
      ...
      msgTxt.innerHTML="일괄생성이 완료되었습니다.";		
	}
	</script>
						...
						<table border="0"  cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="right" height="30px">		
									<img src="<%=dirPath%>/Sales/images/eraser.gif"   	style="cursor:pointer" onclick="fnEraser()">
									<img src="<%=dirPath%>/Sales/images/bundle.gif"		style="cursor:pointer" onClick="fnCreate();">																																		
									<img src="<%=dirPath%>/Sales/images/add_create.gif"		style="cursor:pointer" onClick="fnAddRow();">			
