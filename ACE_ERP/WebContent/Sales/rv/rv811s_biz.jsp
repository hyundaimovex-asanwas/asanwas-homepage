...
%>		
		...
		function fnInit() {
	        ...
	        ds_code2.Reset();	//운전여부
	        ds_code3.DataId = "<%=dirPath%><%=HDConstant.PATH_HELP%>Sy001H?dsType=2&proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>&s_Head=RM014&s_item1=Y";
	        ds_code3.Reset();	//출경시각
	        ds_code4.DataId = "<%=dirPath%><%=HDConstant.PATH_HELP%>Sy001H?dsType=2&proType=<%=HDConstant.PROCESS_TYPE_SEARCH%>&s_Head=RM015&s_item1=Y";
	        ds_code4.Reset();	//입경시각
...
<object id=ds_code3 classid=<%=HDConstant.CT_DATASET_CLSID%>>
    <param name="SyncLoad"  value=false>
</object>
<object id=ds_code4 classid=<%=HDConstant.CT_DATASET_CLSID%>>
    <param name="SyncLoad"  value=false>
</object>
...
<!--------------------------------- 코딩 부분 시작 ------------------------------->		
	...
	<table border='0' cellpadding='0' cellspacing='0' width='845'>	
		<tr>
			<td width='845px'>
				<table  border='0' cellpadding='0' cellspacing='0' width='1000'>
					<tr>
						<td>
							<table   border='0' cellpadding='0' cellspacing='1' width='800' bgcolor='#666666'>
								<tr>
		...
		<tr height="30px">
			<td width='845px'>
				<table border='0' cellpadding='0' cellspacing='1' width='1000' bgcolor="#666666">
					<tr height='30px'>
			...
			<td height=360>
				<table  border='0' cellpadding='0' cellspacing='1' >
					<tr>
						<td>
							<%=HDConstant.COMMENT_START%>
							<object id=mxTab classid=<%=HDConstant.CT_TAB_CLSID%> style="position:absolute; left:13; top:170; width:845; height:20">
							...
							<div class=page id="mxTab_page1" style="position:absolute; left:13; top:190; width:1000; height:330">
							<%=HDConstant.COMMENT_START%>
							<object id=gr1 classid=<%=HDConstant.CT_GRID_CLSID%> width='1000px' height='330px' border='1'>
								...
								<param name="Format" 			value="
						              ...
						              <FC> name='출발일'    	   			ID='depart_date'   width=60 		align=center editlimit=16 show=true</FC>
						              <C> name='방문기간'    	   		ID='arrive_date'    width=80 		align=center editlimit=16 show=false</C>
						              <C> name='상품명'      		ID='goods_nm'     width=105 		align=left 	editlimit=30 show=true suppress=2</C>
						              <C> name='신청서번호'    	ID='accept_no'   	width=100 	align=left 	editlimit=16 show=true suppress=3</C>
							...
							<div class=page id="mxTab_page2" style="position:absolute; left:13; top:190; width:1000; height:330">
							<%=HDConstant.COMMENT_START%>
							<object id=gr2 classid=<%=HDConstant.CT_GRID_CLSID%> width=1000 height=330 border=1 style="display:;">
								...
								<G> name='출입정보'
									...
									<C> name='상품명'    	ID='GOODS_NM'  		width=105 	align=left editlimit=15 edit=none show=true suppress=2 </C>
									<C> name='출발일자'    	ID='DEPART_DATE'    width=65 	align=CENTER	Edit=None suppress=3 mask='XXXX-XX-XX'</C>
									<C> name='시간'    		ID='DEPART_TIME'	width=80 	align=center	Edit=None suppress=4 editstyle=lookup data='ds_code3:detail:detail_nm' </C>
									<C> name='복귀일자'     ID='arrive_date' 	width=65 	align=CENTER	Edit=None suppress=5 mask='XXXX-XX-XX'</C>
									<C> name='시간'     	ID='arrive_time' 	width=80 	align=CENTER	Edit=None suppress=6 editstyle=lookup data='ds_code4:detail:detail_nm' </C>
								</G>
								<G> name='출입시 차량정보'
							...
							<div class=page id="mxTab_page3" style="position:absolute; left:13; top:190; width:1000; height:330">
							<object id=gr3 classid=<%=HDConstant.CT_GRID_CLSID%> width=1000 height=330 border=1 style="display:;">
			                    ...
			                    <param name="Format"            value=" 
									...
									<C> name='상품명'    	ID='GOODS_NM'  		width=105 	align=left editlimit=15 edit=none show=true suppress=2 SUMTEXT=명</C>
									<C> name='출발일자'    	ID='DEPART_DATE'    width=65 	align=CENTER	Edit=None suppress=3 mask='XXXX-XX-XX'</C>
									<C> name='시간'    		ID='DEPART_TIME'	width=80 	align=center	Edit=None suppress=4 editstyle=lookup data='ds_code3:detail:detail_nm' </C>
									<C> name='복귀일자'     ID='arrive_date' 	width=65 	align=CENTER	Edit=None suppress=5 mask='XXXX-XX-XX'</C>
									<C> name='시간'     	ID='arrive_time' 	width=80 	align=CENTER	Edit=None suppress=6 editstyle=lookup data='ds_code4:detail:detail_nm' </C>
