...
%>      
        ...
        function fnInit() {
            ...
            ln_TRSetting(tr1, 
                ...
                "JSP(O:S_SAUP_DS=ds2,O:S_ARRIVE_GOODS_DS=ds4)",
        ...
        function fnSelect() {
            ...
            ln_TRSetting(tr1, 
                "<%=dirPath%><%=HDConstant.PATH_RV%>Rv831S",
                "JSP(O:DS1=ds1)",
                param);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
       <td width="422" height="30" align="left" valign="middle" class="tt"><img src="/HDASan/Sales/images/icon.gif" width="14" height="14"> 투숙객 현황</td>
     </tr>
</table>
            ...
            <td width='845px'>
                <table border='0' cellpadding='0' cellspacing='1' width='845' bgcolor="#666666">
                    <tr height='30px'>
                        ...
                        <td align=left class="text"  width="80">작업일자</td>
                        <td align=left bgcolor="#ffffff">&nbsp;                                                                                         
                            <%=HDConstant.COMMENT_START%>
