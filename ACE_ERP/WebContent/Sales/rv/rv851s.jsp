...
<script language="javascript">
    ...
    function fnSelect() {
        ...
        ln_TRSetting(tr1, 
            "<%=dirPath%><%=HDConstant.PATH_RV%>Rv851S",
...
<object id=ds_master2 classid=<%=HDConstant.CT_DATASET_CLSID%>>
    ...
    <param name=GroupExpr   value="UPJANG_NM:ROOM_TYPE_CD:ROOM_TYPE_NM,CALN_DATE,TOT_CNT:STY_CNT:NA1_CNT:NB1_CNT:NT2_CNT:NT2N_CNT:NT2G_CNT:SN1_CNT:SN2_CNT:NT2C_CNT">
</object>
                                        ...
                                        <param name="Format"            value=" 
                                            ...
                                            <R>
                                                <G>name=$xkeyname_$$ mask='XX/XX'
                                                    ...
                                                    <C> name='2N(C)' ID=NT2C_CNT_$$ Width=40    align=right   edit=none</C>
