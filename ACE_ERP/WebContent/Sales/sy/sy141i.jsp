					...
					<td width=845>
					    ...
					    <object  classid=<%=HDConstant.CT_GRID_CLSID%>  id=gr1  style="width=845px; height:360px" border="1">
					        ...
					        <param name="Format"            value="
					            <C> name='체크'      	ID='CHK'   	   Width=40  align=center EditStyle=CheckBox edit=True</C>
					            <C> name='상태'     	ID='AUTH_RQ'   Width=50  align=center editstyle=lookup data='ds_status1:detail:detail_nm' edit=none Sumtext=계</C>
					            ...
					            <C> name='요청일자'     ID='U_DATE'    Width=80  align=center  edit=none</C>
					            <C> name='레벨'     	ID='TREE_LV'   Width=40  align=center  edit=none</C>
					            <C> name='메뉴ID'       ID='TREE_ID'   Width=70  align=left  edit=none</C>
					            <C> name='메뉴번호'     ID='TREE_IDX'  Width=70  align=center  edit=none</C>
					            <C> name='메뉴명1'      ID='TREE_NM1'  Width=70  align=left suppress=1 edit=none</C>
					            <C> name='메뉴명2'      ID='TREE_NM2'  Width=70  align=left suppress=2 edit=none</C>
					            <C> name='메뉴명3'      ID='TREE_NM3'  Width=70  align=left suppress=3 edit=none</C>
					            <C> name='메뉴명4'      ID='TREE_NM4'  Width=100  align=left edit=none  Sort=True</C>
					        ">
					    </object>
					    <%=HDConstant.COMMENT_END%>
					</td>
