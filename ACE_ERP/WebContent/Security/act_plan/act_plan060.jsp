...
jui.ready([ "grid.xtable" ], function(xtable) {
        ...
        event: {
        	 ...
        	 click:function(e){ 
					...
					if(e.index == "0"){
						...
						alert("등록된 문서가 없습니다.");
						//var url = "/HDAsan/Security/act_plan/act_plan501.jsp";
						...
						alert("등록된 문서가 없습니다.");
						//var url = "/HDAsan/Security/act_plan/act_plan502.jsp";
    ...
    xtable_1_submit = function() {
        ...
        var result = [];
			...
			result.push({ folder_name : "소요 자금"});
			result.push({ folder_name : "조달 계획"});
