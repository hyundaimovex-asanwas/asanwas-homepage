        ...
        event: {
        	 ...
        	 click:function(e){ 
					...
					if(e.index == "0"){
						...
						var url = "/HDAsan/Security/act_plan/act_plan201.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");							
						
					}else if(e.index == "1"){
						
						var url = "/HDAsan/Security/act_plan/act_plan202.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");	
						
					}else if(e.index == "2"){
						
						var url = "/HDAsan/Security/act_plan/act_plan203.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");						
						
					}else if(e.index == "3"){
						
						var url = "/HDAsan/Security/act_plan/act_plan204.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");	
						
					}else if(e.index == "4"){
						
						var url = "/HDAsan/Security/act_plan/act_plan205.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");					

					}else if(e.index == "5"){
						
						var url = "/HDAsan/Security/act_plan/act_plan206.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");	
						
					}else if(e.index == "6"){
						
						var url = "/HDAsan/Security/act_plan/act_plan207.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");						
						
					}else if(e.index == "7"){
						
						var url = "/HDAsan/Security/act_plan/act_plan208.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");	
						
					}else if(e.index == "8"){
						
						var url = "/HDAsan/Security/act_plan/act_plan209.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");					
						
					}else if(e.index == "9"){
						
						var url = "/HDAsan/Security/act_plan/act_plan210.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");	
						
					}else if(e.index == "10"){
						
						var url = "/HDAsan/Security/act_plan/act_plan211.jsp";
						
					   	window.open(url,"memoRead_from","scrollbars=no,toolbar=no,location=no,directories=no,noresize");						
						
					}else if(e.index == "11"){
						
						var url = "/HDAsan/Security/act_plan/act_plan212.jsp";
