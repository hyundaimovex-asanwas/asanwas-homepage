...
function ln_Save() {
    	...
    	if (fnChk()) {
			...
			if (ds_default2.CountColumn == 0) {
				ds_default2.setDataHeader("DRIVE_DT:STRING, FROM_TM:STRING, TO_TM:STRING, CAR_NO:STRING, DRIVER:STRING, DRIVE_BEFORE:STRING, DRIVE_AFTER:STRING, REMARK:STRING");
			}
			...
			ds_default2.namevalue(1,"CAR_NO") = strParam[1].substr(0,1);	 
			ds_default2.namevalue(1,"DRIVER") = txt_driver_no.value;	 				
			ds_default2.namevalue(1,"DRIVE_BEFORE") = txt_drive_before.value;	 			
			ds_default2.namevalue(1,"DRIVE_AFTER")  = txt_drive_after.value;	   	
			ds_default2.namevalue(1,"REMARK") = txt_remark.value;
			 
			
		     ln_TRSetting(tr2, "<%=dirPath%><%=HDConstant.PATH_LI%>Lc075",  "JSP(I:DS_DEFAULT2=ds_default2)",  "proType=A, dsType=1");
...
function fnChk() {      	
		...
		//if(txt_drive_before.value >= txt_drive_after.value){
		//	alert("주행거리를 확인해주세요.");
		//	return false;
		//}
	...
	<tr> 
		<td>
			<table border="0" cellpadding="0" cellspacing="0" >
			  ...
			  <tr>
				<td height="25px" style="border:1 solid #708090;border-width:0 1 1 1;" class="text l" >&nbsp;&nbsp;&nbsp;<font color="#ff0000">*</font>&nbsp;주행전거리</td>
				<td style="border:1 solid #708090;border-width:0 1 1 0;" class="l">&nbsp;
					<input id="txt_drive_before"    type="text"   class="txtbox"  style= "position:relative;width:120px;height:20px;" >(숫자만 입력하세요)
				</td>
			  </tr>

			  <tr>
				<td height="25px" style="border:1 solid #708090;border-width:0 1 1 1;" class="text l" >&nbsp;&nbsp;&nbsp;<font color="#ff0000">*</font>&nbsp;주행후거리</td>
				<td style="border:1 solid #708090;border-width:0 1 1 0;" class="l">&nbsp;
					<input id="txt_drive_after"    type="text"   class="txtbox"  style= "position:relative;width:120px;height:20px;" >(숫자만 입력하세요)
				</td>
			  </tr>
