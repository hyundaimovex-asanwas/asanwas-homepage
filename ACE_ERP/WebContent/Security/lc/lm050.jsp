	...
	<tr> 
		<td>
			...
			<object  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcgd_disp02  style="position:relative;left:0px;width:880px; height:640px; border:1 solid #708090;display:block;" viewastext>
					...
					<C> Name='회의실'		  		ID=CAR_NO 	  	HeadAlign=Center HeadBgColor=#B9D4DC Width=140 		align=center value={Decode(CAR_NO,'33','3층 소회의실3','34','3층 소회의실4','42','4층 소회의실1','43','4층 소회의실2')}</C>
                    <C> Name='8'  	        	ID=TIME8		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME8	,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>
					<C> Name='9'      			ID=TIME9		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME9	,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>                    
					<C> Name='10'         		ID=TIME10		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME10,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>                    
					<C> Name='11'  	      		ID=TIME11		HeadAlign=Center HeadBgColor=#B9D4DC Width=65		align=center BgColor={Decode(TIME11,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>
                    <C> Name='12'  	        	ID=TIME12		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME12,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>
					<C> Name='13'      			ID=TIME13		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME13,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>                    
					<C> Name='14'         		ID=TIME14		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME14,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>                    
					<C> Name='15'  	      		ID=TIME15		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME15,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>
                    <C> Name='16'  	        	ID=TIME16		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME16,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>
					<C> Name='17'      			ID=TIME17		HeadAlign=Center HeadBgColor=#B9D4DC Width=65 		align=center BgColor={Decode(TIME17,'승인','#1DDB16','예약','#FAED7D','반송','#FFA7A7')} </C>                    
					">
			</object></comment><script>__ws__(__NSID__);</script>
		</td>
	</tr>
