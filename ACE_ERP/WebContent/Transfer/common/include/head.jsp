...
<%//	<script language="javascript" src="<%=dirPath/Sales/common/js/common.js"></script>      %>
	...
	<script language="javascript" src="<%=dirPath%>/Transfer/common/include/transfer.js"></script>  

	<Script language="javascript" src="<%=dirPath%>/Transfer/common/include/common.js"></script>

	<Script language="javascript" src="<%=dirPath%>/Transfer/common/include/order01.js"></script>
	
	<Script language="javascript" src="<%=dirPath%>/Common/include/PubFun.js"></script>
