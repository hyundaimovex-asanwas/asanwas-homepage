...
/*--------------------------------------------------------------------------------
+ 시 스 템 명	:	현대아산  OMS
+ 프로그램 ID	: TR00102.HTML
+ 기 능 정 의	: 반출주문등록
+ 변 경 이 력	: 정미선
+ 서 블 릿 명	: TR00102.HTML
----------------------------------------------------------------------------------
+ 수정내용 :  웹스피어 - > 웹로직 ( DB2 - > 오라클11g, JDK 1.4 -> 1.6) 소스 변경
+ 수 정 자 :  정영식
+ 수정일자 :  2013.10.28
----------------------------------------------------------------------------------
+ 서블릿명 :
...
******************************************************************************/ --> 
<OBJECT id=gcDs1 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="true"> 
</OBJECT>

<OBJECT id=gcds_dump classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="true"> 
</OBJECT> 

<OBJECT id=gcDs2 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="false"> 
</OBJECT>  

<OBJECT id=gcDs3 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="false">
	 <param name=UseChangeInfo    value=false>  
</OBJECT>

<OBJECT id=gcDs4 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="true"> 
</OBJECT>

<OBJECT id=gcDs5 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	 <param name=SyncLoad value="false"> 
</OBJECT>  

<OBJECT id=gcDs_etc0 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc1 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name='SyncLoad'              value='true'>  
</OBJECT>

<OBJECT id=gcDs_etc2 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc3 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc4 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc5 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc6 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc7 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc8 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc9 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc10 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
	<param name=UseFilter             value="true">
</OBJECT>

<OBJECT id=gcDs_etc11 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_samp classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc12 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc13 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc14 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc15 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc16 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_0etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_1etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_2etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_3etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDs_4etc classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcDsrpt1 classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>
...
<OBJECT id=gcds_project classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad              value="true">  
</OBJECT>

<OBJECT id=gcds_chk classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad     value="true">  
</OBJECT>

<OBJECT id=gcds_uplaodtemp classid=clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49 >
	<param name=SyncLoad     value="true">  
</OBJECT>
...
------------------------------------------------------------------------------>
<OBJECT id="gcTr01" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문 마스터-->
</OBJECT>

<OBJECT id="gcTr02" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문상세-->
</OBJECT>

<OBJECT id="gcTr03" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문차량정보-->
</OBJECT>

<OBJECT id="gcTr04" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문차량정보-->
</OBJECT>

<OBJECT id="gcTr05" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문 마스터 임시-->
</OBJECT> 

<OBJECT id="gcTr06" classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	<PARAM NAME="KeyName"  VALUE="toinb_dataid4"><!--주문 마스터 임시-->
</OBJECT>  
...
<script language=JavaScript for=gcDs_etc10 event=onFilter(row)>
	if (gcDs_etc10.NameValue(row,"LINE_PART") == LINE_PART.BindColVal) {
		return true;
	} else {
		return false;
	}
...
<script language=JavaScript for=gcDs_etc10 event=OnRowsetChanged()>
	if (gcDs_etc10.namevalue(1,"PROJECT")!=""){
...
<script language=JavaScript for=gcDs4 event=OnRowPosChanged(row)>
    ...
    //alert("gcDs4::OnRowPosChanged(row)::gcDs4.CountRow:"+gcDs4.CountRow+"saveing::"+saveing); 
...
<script language="javascript" for=gcGR3 event=OnHeadCheckClick(Col,Colid,bCheck)>
	if (bCheck=="1"){
		for (var i=1; i<=gcDs3.countrow; i++) {
			gcDs3.namevalue(i,"CHK") = "";
			CheckTrueSameAs(i,"CHK");
		}
	} else {
		for (var i=1; i<=gcDs3.countrow; i++) {
			gcDs3.namevalue(i,"CHK") = "T";
			CheckTrueSameAs(i,"CHK");
		}
	}
</script>
	...
	<table width="866" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px"  > 
		<tr> 
			<td width="865" align="right" background="<%=dirPath%>/Common/img/com_t_bg.gif" style="padding-top:4px;">
				...
				<!--<img src="../../../Common/img/btn/btn_rtn.gif" id=img_rtn style="cursor:hand" onclick="ln_HistBack()"> -->
				<!--<img src="../../../Common/img/btn/btn_rtn.gif" id=img_sts1 style="cursor:hand" onclick="ln_HistBack01()"> -->
				<img id=btn_cancel  src="<%=dirPath%>/Common/img/btn/com_b_cancle.gif" style="cursor:hand" onclick="ln_Cancel()">
			 	<img id=btn_regdata src="<%=dirPath%>/Common/img/btn/btn_reg.gif" style="cursor:hand" onclick="ln_RegData()">  
				<img src="<%=dirPath%>/Common/img/btn/btn_rtn.gif" id=img_rtn2    style="cursor:hand;display:none" onclick="ln_HistBack2()"> 
		...
		<tr>
			<td colspan=2>
				<div id=step1 style=display:block>
							...
							<td>
								<table cellpadding="0" cellspacing="0" border="0" style="width:874px;height:30px;font-size:9pt;background-color:#ffffff;border:1 solid #708090;">
									<tr> 
										...
										<td class="tab11_left"> 
											<OBJECT id=LINE_PART  style='position:relative;left:8px;top:1px;width:170px;height:200' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 tabindex="1">
									...
									<tr>
										...
										<td class="tab11_left">
											<OBJECT id=CARGO_TYPE  style='position:relative;left:8px;top:1px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  width=170 height=100 tabindex="4"  >
										...
										<td class="tab22"> 
											<OBJECT id=DLVL_TYPE  style='position:relative;left:8px;top:1px;height:150' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  width=170 height=100  tabindex="5">
									...
									<tr >
										...
										<td class="tab21">
											...
											style="position:relative; left:0px;top:5px; width:70px;height:17px;font-family:굴림; font-size:9pt;z-index:2;">
												...
												<param name=Format	      value="YYYY/MM/DD">
												<param name=PromptChar	  value="_">
											</OBJECT>&nbsp;:&nbsp;<input id="TX1" name="TX1" type="text" class="txt11_none1" style='width:55;position:relative;left:-4px;top:1px' value="입고일자" readonly> ) 
										</td>
											...
											<table border=0 cellpadding=0 cellspacing=0 style="width:100%">
												<tr>
													...
													<td>
														<table border=0 cellpadding=0 cellspacing=0 style="width:100%">
															<tr>
																<td class="tab11_left" style="height:25px;width:69px;text-align:center" bgcolor="#eeeeee">업체명</td>
																...
																<td class="tab11_left" style="width:80px;text-align:center" bgcolor="#eeeeee">담당자</td>
																...
																<td class="tab11_left" style="width:80px;text-align:center" bgcolor="#eeeeee">전화번호</td>
																<td class="tab13_left" ><input type="text" class="txt11" id=txt_recp_tel style="position:relative;left:8px;width:100px;"></td>
															</tr>
															<tr>
																<td class="tab12_left" style="height:25px;text-align:center" bgcolor="#eeeeee">주소</td>
									...
									<tr id=tr_att_file style="display:none">
										...
										<td colspan=3 style="border:0 solid #777777;border-top-width:1px;" >
											...
											<OBJECT classid=CLSID:69F1348F-3EBE-11D3-973D-0060979E2A03	id=gcip_file style="position:relative;left:8px;top:0px;width:100; height:20;" tabindex="14">
						...
						<tr>
							<td>
								<table border=0 cellpadding=0 cellspacing=0 id=tab_car>
									...
									<tr>
										<td>
											<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR0 style="width:872;height:122px;border:1 solid #777777;display:block" viewastext>
							...
							<td style="width:100%">
								<div id=pl_ci_add_div style="display:none">
									<table cellpadding=0 cellspacing=0 border=0 style="position:relative;top:0px;">	
										<tr>
											<td height=30px align=left width=70px><img src="../img/head_4.gif" style="position:relative;left:0px;top:0px;"></td> 
											<td valign="bottom">
												...
												<table  cellpadding="0" cellspacing="0" border="0" style="width:100%;font-size:9pt;background-color:#ffffff;border:1 solid #708090"  style="position:relative;left:0px;top:0px;"> 
													<tr> 
														...
														(&nbsp;<input id='PL_SHIPPER'  name="PL_SHIPPER" type="text"   size=16 maxlength=50  value="" style="position:relative;left:0px;top:0px;" class=txt11 tabindex="32">
																<img src="<%=dirPath%>/Common/img/btn_find.gif" style="position:relative;left:0px;top:3px;cursor:hand" tabindex="33" id=btn_calshipper onclick="Call_SHIPPER();">&nbsp;)
														</td>
													...
													<tr> 
														<td class=tab11_left bgcolor="#eeeeee">&nbsp;통지처 (&nbsp;<input id="PL_BRKR"  name="PL_BRKR" type="text"   size=16 maxlength=50  value="" style="position:relative;left:0px;top:0px;" class=txt11 tabindex="36">
																<img src="<%=dirPath%>/Common/img/btn_find.gif" style="position:relative;left:0px;top:3px;cursor:hand" tabindex="37" id=btn_calbrkr onclick ="Call_BRKR();">&nbsp; )
														</td>
													...
													<tr> 
														...
														(&nbsp;<input id='PL_CSN'  name="PL_CSN" type="text"  size=16 maxlength=50  value="" style="position:relative;left:0px;top:0px;" class=txt11 tabindex="39">
																<img src="<%=dirPath%>/Common/img/btn_find.gif" style="position:relative;left:0px;top:3px;cursor:hand" tabindex="40" id=btn_calcs onclick="Call_CS();">&nbsp;)
														</td>
					...
					<table cellpadding=0 cellspacing=0 border=0 style="width:100%">
						<tr><td align=center colspan=2> <img src="<%=dirPath%>/Common/img/btn/btn_prdetail.gif" onclick="Master_Save();" style='cursor:hand' alt="물품 상세정보 입력 화면으로 이동합니다."> 
						</td></tr>
						<tr><td height=20px></td></tr> 
					</table> 
				</div>
				...
				<div id=step2 style=display:none>
					<table cellpadding=0 cellspacing=0 border=0>
						<tr>
							...
							<td valign="bottom">
								<table height="30" border="0" cellpadding="1" cellspacing="0" style="position:relative;top:-3px;width:799px;left:0" > 
									<tr>
										<td align=right> 
						...
						<tr>
							<td colspan=2> 
											...
											<table cellpadding="0" cellspacing="0" border="0" style=" width:100%;height:20px;font-size:9pt;background-color:#ffffff;border:0 solid #708090"> 
												...
												<tr>
													...
													<td class="tab11_left"  colspan=2 >&nbsp;
														...
														<OBJECT id=TOTAL_PKG_CBM  class="txt11_right" style='width:90;position:relative;left:0px;top:2px;height:15' classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=24 width=120 tabindex="62"> 
															<param name=Alignment				value=2>
															<param name=Numeric					value=true>
															<param name=IsComma					value=true>
															<param name=MaxLength				value=10>
													...
													<td class="tab11_left" colspan=2 >&nbsp;
														...
														<OBJECT id=PKG_WGHT  class="txt11_right" style='width:90;position:relative;left:0px;top:2px;height:15' classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=24 width=120 tabindex="63"> 
															<param name=Alignment				value=2>
															<param name=Numeric					value=true>
															<param name=IsComma					value=true>
															<param name=MaxLength				value=10>
												...
												<tr>
													...
													<td class="tab11_left" >&nbsp;
														...
														<OBJECT id=UNIT_PRICE  class="txt11_right" style='width:90;position:relative;left:0px;top:2px;height:15' classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F height=24 width=120 tabindex="52"> 
															<param name=Alignment				value=2>
															<param name=Numeric					value=true>
															<param name=IsComma					value=true>
															<param name=MaxLength				value=10>
													...
													<td class="tab11_left"   align=left colspan=5>
														&nbsp;
														<OBJECT id=DTL_LD_CAR  style='border:0;position:relative;left:0px;top:2px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  width=120 height=100  tabindex="43">
														...
														&nbsp;&nbsp; FIXED&nbsp;<input type="checkbox" id=fixed name=fixed class="chk1" value="C" style='position:relative;left:-1px;top:2px' tabindex="44" > 
													</td>  
												</tr>  
												<tr>
												...
												<tr>
													...
													<td class="tab11_left" align=left colspan=5>&nbsp;
														<OBJECT id=DTL_OFF_CAR  style='border:0;position:relative;left:0px;top:2px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  width=120 height=100  tabindex="45">
														...
														<input type="checkbox" id=fixed1 name=fixed1 class="chk1" value="C" style='position:relative;left:-1px;top:2px' tabindex="46" > 
													</td> 
												</tr>
												<tr>
													<td class="tab11_left" style="text-align:center" bgcolor="#eeeeee" width='100px'>추가정보</td>
													<td class="tab11_left"   align=left colspan=5>&nbsp;
													<input id="DTL_OFF_CAR_NM" name="DTL_OFF_CAR_NM" type="text" class="txt11" style='width:325;position:relative;left:0px;top:0px' tabindex="47"></td>
												</tr>
												<tr id=cargoType style=display:none>
													...
													<td class="tab12_left" colspan=7>&nbsp;
														...
														<OBJECT id=OpenFile classid=CLSID:69F1348F-3EBE-11D3-973D-0060979E2A03
														...
														<!-- <input id=txt_fileinfo type=text style="width:120"> -->
								...
								<table border=0 cellpadding=0 cellspacing=0 style="width:100%">
									<tr>
										<td colspan=2>
											<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR1 style="width:870;height:401px;border:1 solid #777777;display:block" viewastext>
...
<!-- ***************************************************************************************************** -->
								...
								<div id=Car_disp style="display:block">
									<table border=0 cellpadding=0 cellspacing=0 style="width:100%">
										<tr>
											...
											<td valign="bottom">
												<table height="30" border="0" cellpadding="1" cellspacing="0" style="position:relative;top:0px;width:790px;left:0" background="<%=dirPath%>/Common/img/under_bar5.gif">
													<tr>
										...
										<tr>
											<td colspan=2 style="height:130px"> 
												...
												<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR2 style="width:872;height:122px;border:1 solid #777777;display:block" viewastext>
													<PARAM NAME="DataID"			VALUE="gcDs4">
													<PARAM NAME="TitleHeight" VALUE="23">
													<PARAM NAME="RowHeight"		VALUE="20">
													<PARAM NAME="BorderStyle" VALUE="0">
												...
												<table  cellpadding="0" cellspacing="0" border="0" style="width:876px;height:150px;font-size:9pt;display:none" >
													<tr>
														<td width=500>
															...
															<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR2_old style="width:500;height:122px;border:1 solid #777777;display:block" viewastext>
																<PARAM NAME="DataID"			VALUE="gcDs4">
																<PARAM NAME="TitleHeight" VALUE="23">
																<PARAM NAME="RowHeight"		VALUE="20">
																<PARAM NAME="BorderStyle" VALUE="0">
															...
															<table cellpadding="0" cellspacing="0" border="0" style=" width:370;height:125px;font-size:9pt;"  >
																<tr>
																	...
																	<td class=tab18 colspan=3>&nbsp;
																		...
																		<OBJECT id=CAR_TYPE  style='border:0;position:relative;left:0px;top:2px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69  width=120 height=100  tabindex="64">
																		...
																		<img src="<%=dirPath%>/Common/img/btn_find.gif" style="position:relative;left:2px;top:0px;" onclick="CallCarType();">
																	</td>
																...
																<tr style='display:none'>
																	<td class=tab11_left style="height:30px;text-align:center" bgcolor="#eeeeee">반출일자</td>
																	<td class=tab11_left colspan=1 align=left>&nbsp;
																		
																		<OBJECT id=CAR_EDT_DATE classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F  
																		...
																		<img src="<%=dirPath%>/Common/img/btn_calendar.gif" style="position:relative;left:0px;top:1px;"onclick="__GetCallCalendar2('CAR_EDT_DATE', 'Text','LOAD_DATE', 'Text');" tabindex="68"> 
																	</td>
																	<td class=tab11_left style="text-align:center" bgcolor="#eeeeee">납품일자</td>
																	<td class=tab11_left colspan=1 align=left>&nbsp;
																		<OBJECT id=LOAD_DATE classid=CLSID:E6876E99-7C28-43AD-9088-315DC302C05F 
						...
						<tr>
							<td>
								<table cellpadding=0 cellspacing=0 border=0>
									...
									<tr>
										<td colspan=2>
											<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR3 style="width:870;height:304px;border:1 solid #777777;display:block" viewastext>
												...
												<PARAM NAME="ViewSummary"			VALUE="1">  
												<PARAM NAME="Format"					VALUE="
													<C> Name=''			ID=CHK			HeadAlign=Center HeadBgColor=#eeeeee Width=20 CheckBoxText='Stsnm'	Pointer=Hand EditStyle=CheckBox HeadCheck=false		HeadCheckShow=true align=center HeadVAlign=TOP, edit=none</C>   
													<C> Name='No1.'  ID=CurRow     HeadAlign=Center HeadBgColor=#eeeeee Width=30  align=right edit=none bgcolor=@acolor Value={CurRow}</C>
													<C> Name='No2.'	ID=ORDER_SEQ	HeadAlign=Center HeadBgColor=#eeeeee Width=30  align=right edit=none bgcolor=@acolor</C>   
		...
		<tr style="display:none">
			<td>
				<OBJECT id=gclx_samp classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69>
