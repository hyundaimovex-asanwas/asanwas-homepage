...
<SCRIPT language=JavaScript>
	...
	******************************************************************************/
	function ln_Query(PicUrl){ 
		if(strim(PicUrl) == '') pictures.src ='../../Transfer/img/0000000.gif' ; 
	...
	******************************************************************************/
	function ln_Query1(PicUrl){ 
		if(strim(PicUrl) == '')	pictures1.src ='../../Transfer/img/0000000.gif' ; 
	...
	<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
		<tr> 
			<td width="876" align="right" background="../../common/img/com_t_bg.gif" style="padding-top:4px;">
				...
				<img src="../../../Common/btn/com_b_query.gif" style="cursor:hand" onclick="ln_Query()">
			</td>
		</tr>
			...
			<td colspan=2>
			  <table cellpadding="0" cellspacing="0" border="0" style="width:876px;height:30px;font-size:9pt;background-color:#ffffff;border:1 solid #708090">
					...
					<tr>  
						...
						<td class="tab11_left">
						  <%=HDConstant.COMMENT_START%><OBJECT id=WORK_FORM  style='border:0;position:relative;left:8px;top:1px;width:120px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69>
					...
					<tr>
						...
						<td colspan=3>
						<img id=pictures src= '../../../Common/img/0000000.gif' width=600 height=300 onclick="window.open(this.src,'','resizable=yes,scrollbars=no,status=no')"></td>
					</tr> 
				</table> 
			</td>
		</tr> 
