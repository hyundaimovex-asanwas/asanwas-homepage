		...
		<tr>
			<td colspan=2>
			  <table cellpadding="0" cellspacing="0" border="0" style="width:876px;height:30px;font-size:9pt;background-color:#ffffff;border:1 solid #708090">
					<tr>
						<td class="tab12" style="width:80px;height:30px;text-align:center" bgcolor="#eeeeee">반출일자</td>
						...
						<td>
							<%=HDConstant.COMMENT_START%><OBJECT id=LINE_PART  style='border:0;position:relative;left:8px;top:1px;width:160px;height:110' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69>
