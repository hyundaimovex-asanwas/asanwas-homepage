		...
		<tr> 
			<td width="876" align="right" background="../../common/img/com_t_bg.gif" style="padding-top:4px;">
			  <img src="../../../Common/img/btn/com_b_cancle.gif" style="cursor:hand" onclick="ln_Cancel()">
				<img src="../../../Common/img/btn/com_b_excel.gif" style="cursor:hand" onclick="Excel()"> 
		...
		<tr>
			<td colspan=2>
			  <table cellpadding="0" cellspacing="0" border="0" style="width:100%;height:30px;font-size:9pt;background-color:#ffffff;border:1 solid #708090">
					<tr>
						<td class="tab12_left" style="text-align:center" bgcolor="#eeeeee" width=75>반입일자</td>
						<td class="tab12_left" >&nbsp;
							<%=HDConstant.COMMENT_START%>
						...
						<td class="tab12_left" style="text-align:center" bgcolor="#eeeeee" width=75>Project</td>
						<td>&nbsp;
							<%=HDConstant.COMMENT_START%>
							...
							<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=Grid1 style="width:876px;height:443px;border:1 solid #777777;border-right-width:0px;display:block" viewastext>
								...
								<PARAM NAME="Format"			VALUE="  
									...
									<G> Name='배정정보' HeadBgColor=#D5EDFB 
										<C> Name='배정번호'			ID=CAR_SEQ_NO HeadAlign=Center HeadBgColor=#eeeeee Width=70  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none</C>  
										<C> Name='반출/반입'			ID=IN_OUT			HeadAlign=Center HeadBgColor=#eeeeee Width=70  bgcolor={IF(ING_STS='C','Gold')} align=center Value={Decode(IN_OUT,'I','반입','O','반출','반출')} show=false</C>
										<C> Name='구분'					ID=TYPE				HeadAlign=Center HeadBgColor=#eeeeee Width=70  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none</C>
										<C> Name='차량종류'			ID=CARTYPENO	HeadAlign=Center HeadBgColor=#eeeeee Width=100 bgcolor={IF(ING_STS='C','Gold')} align=left   edit=none EditStyle=Lookup Data='gcDs_etc5:CAR_TYPE:CAR_NAME'</C> 
										<C> Name='주문번호'			ID=ORDER_NO		HeadAlign=Center HeadBgColor=#eeeeee Width=75  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none </C>  
										<C> Name='PROJECT'			ID=LINE_PART	HeadAlign=Center HeadBgColor=#eeeeee Width=140 bgcolor={IF(ING_STS='C','Gold')} align=left   edit=none EditStyle=Lookup Data='gcds_etc1:MINORCD:MINORNM'</C>
										<C> Name='입고예정일자'		ID=LD_DATE		HeadAlign=Center HeadBgColor=#eeeeee Width=90  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none MASK='XXXX-XX-XX', Show=false</C>
										<C> Name='반입일자'			ID=EDT_DATE		HeadAlign=Center HeadBgColor=#eeeeee Width=80  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none MASK='XXXX-XX-XX'</C> 
										<C> Name='대표품목'			ID=CTN_STDRD	HeadAlign=Center HeadBgColor=#eeeeee Width=137 bgcolor={IF(ING_STS='C','Gold')} align=left   edit=none </C> 
									</G>
									<G> Name='배차정보' HeadBgColor=#FAFCA7
										<C> Name='차량번호'			ID=CAR_NO			HeadAlign=Center HeadBgColor=#eeeeee Width=100 bgcolor={IF(ING_STS='C','Gold')} align=center edit=none</C> 
										<C> Name='운전자번호'		ID=PERSON_NO	HeadAlign=Center HeadBgColor=#eeeeee Width=75  bgcolor={IF(ING_STS='C','Gold')} align=center, show=false</C>
										<C> Name='운전자명'			ID=PERSON_NO	HeadAlign=Center HeadBgColor=#eeeeee Width=75  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none EditStyle=Lookup Data='gcDs_etc6:person_no:prsn_name'</</C>
										<C> Name='출발시간'			ID=START_TIME HeadAlign=Center HeadBgColor=#eeeeee Width=65  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none MASK='XX:XX'</C>
										<C> Name='복귀일자'			ID=RTRN_DATE	HeadAlign=Center HeadBgColor=#eeeeee Width=75  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none MASK='XXXX-XX-XX'</C>
										<C> Name='복귀시간'			ID=RTRN_TIME	HeadAlign=Center HeadBgColor=#eeeeee Width=65  bgcolor={IF(ING_STS='C','Gold')} align=center edit=none MASK='XX:XX'</C>
									</G>
