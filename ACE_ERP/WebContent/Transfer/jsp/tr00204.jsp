...
<SCRIPT language=JavaScript>
	...
	******************************************************************************/
	function ls_Query(){
		...
		if(ETD_DT.Text == "" ) alert("반입일자를 입력하십시오");
	...
	******************************************************************************/
	function NewCar(){
		...
		strURL = "tr00104_e1.jsp?gstr1=&gstr2=insert&gstr3=I";
	...
	******************************************************************************/
	function UpdateCar(){
		...
		strURL = "tr00104_e1.jsp?gstr1="+car_seq_no+"&gstr2=update&gstr3=I";
	...
	<table width="876" cellpadding="0" cellspacing="0" border="0" style="position:relative;left:3px">
		<tr> 
			<td  width="876" align="right" background="../../common/img/com_t_bg.gif" style="padding-top:4px;position:relative; left:-2px;">
				...
				<img src="../../../Common/img/btn/com_b_query.gif" style="cursor:hand" onclick="ls_Query()">
			</td>
		</tr>
						...
						<td class=tab11 style="border:1 solid #777777;border-top-width:0px;" >
							...
							<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGr1 style="width:100%;height:121px;border:0 solid #777777;display:block" viewastext>
								...
								<PARAM NAME="Format"			VALUE="   
									...
									<C> Name='대표품목'			ID=CTN_STDRD	HeadAlign=Center HeadBgColor=#eeeeee Width=228	align=left</C> 
									<C> Name='구분'					ID=CARGO_TYPE HeadAlign=Center HeadBgColor=#eeeeee Width=80		align=center</C>
									<C> Name='총용적(CBM)'	ID=CAR_CBM		HeadAlign=Center HeadBgColor=#eeeeee Width=110  align=right</C> 
									<C> Name='총중량(KG)'		ID=CAR_TON		HeadAlign=Center HeadBgColor=#eeeeee Width=110  align=right</C> 
					...
					<tr>
						<td class="tab11" style="border:1 solid #777777;border-top-width:0px;" >
							...
							<OBJECT classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 id=gcGR2 style="width:100%;height:261px;display:block" viewastext>
								...
								<PARAM NAME="RowHeight"				VALUE="20">
								<PARAM NAME="Format"					VALUE="
									<F> Name=''				ID=CHECK			HeadAlign=Center HeadBgColor=#eeeeee Width=20 Pointer=Hand EditStyle=CheckBox HeadCheck=false HeadCheckShow=true align=center, edit=none</F> 
									...
									<F> Name='업체명'	ID=VEND_NM		HeadAlign=Center HeadBgColor=#eeeeee Width=120  align=left    edit=none bgcolor=@acolor sumtext='Total' suppress=1</F>  
