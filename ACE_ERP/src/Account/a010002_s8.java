...
**********************************************************************************************/
				...
				str[1] = req.getParameter("v_str2");	//출력구분(체크)
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " RTRIM(A.PRTNBR)   PRTNBR,      /*출력등록번호*/							\n");
						sql.append( " RTRIM(A.ATCODE)   ATCODE,      /*출력계정코드*/							\n");
						sql.append( " RTRIM(A.PRTNAM)   PRTNAM,      /*출력명*/										\n");
						sql.append( " RTRIM(A.LRDIV)		LRDIV,       /*좌우구분*/									\n");
						sql.append( " RTRIM(A.PRTLT)		PRTLT,       /*산식차변*/									\n");
						sql.append( " RTRIM(A.PRTRT)		PRTRT,       /*산식대변*/									\n");
						sql.append( " RTRIM(A.PRTSEQ)   PRTSEQ,      /*출력번호*/									\n");
						sql.append( " RTRIM(A.PRTNO)		PRTNO	       /*삭제유무*/								\n");
