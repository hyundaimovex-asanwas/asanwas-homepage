...
public class a010049_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "             WHEN FND_A.REGNO='2218113834' THEN '현대아산주식회사(고성본사)'  		\n");
					sql.append( "             END FND_REGNO_NAME,   B.EMAIL                                         				\n");
					sql.append( "        A.FND_USER_NAME,   A.SMART_ID,                           									\n");
					sql.append( "        A.SMART_PASSWORD, B.EMAIL AS SMART_EMAIL                       					\n");
					...
					if(!str[0].equals(""))sql.append( " WHERE A.FND_REGNO='"+str[0]+"'											\n");
