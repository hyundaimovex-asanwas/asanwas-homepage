...
public class a010052_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{   "CHK",          "VEND_CD",	   "VEND_NM",	    "VEND_ID",	 "VEND_NO",   	"VD_DIRECT",	
													...
													"WRDT",	        "WRID",	       "UPDT",	        "UPID",
                                                    "STATUS",	    "RQID",	       "RQDT",	       
                                                    "CFID",	        "CFDT",	       "BSID",	        "BSDT",      "EMPNMK",   "SB_REASON",  "VENDER_USERGB", "EMPNO"
									           }; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "          A.CFID,              A.CFDT,        A.BSID,        A.BSDT,  B.EMPNMK, A.SB_REASON, \n" );
					sql.append( "          SUBSTR(VEND_CD,1,1)  AS VENDER_USERGB,  \n" );
					sql.append( "          CASE WHEN SUBSTR(VEND_CD,1,1)='K' THEN SUBSTR(VEND_CD,2,8) ELSE '' END EMPNO   \n" );
					...
					if (str7.equals("A")) sql.append( " AND (A.VEND_CD LIKE 'F%' OR A.VEND_CD LIKE 'K%') \n");
					sql.append( " ORDER BY VEND_CD 													\n");
					
				    //System.out.println("a010052_s1::"+sql.toString());
/*********************************************************************************************/
