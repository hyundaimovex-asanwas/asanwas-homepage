...
public class a020001_s2 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					sql.append( "  SELECT RTRIM(A.DEPTCD) DEPTCD, RTRIM(B.DEPTNM) DEPTNM 				");
					...
					if(!str1.equals("")) { sql.append( " WHERE A.EMPNO = '"+str1+"' "); }
