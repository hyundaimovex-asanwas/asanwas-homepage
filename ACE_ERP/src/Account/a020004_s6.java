...
public class a020004_s6 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "  SELECT COUNT(*) CNT FROM ACCOUNT.ACAPPFUND \n" );
					sql.append( "   WHERE FDCODE = '"+str[0]+"'               \n" );
					sql.append( "     AND APPFSDAT = '"+str[1]+"'             \n" );
					sql.append( "     AND APPFSNBR = '"+str[2]+"'             \n" );
					sql.append( "     AND PAYSTAT  IN ('2','3' )              \n" );
