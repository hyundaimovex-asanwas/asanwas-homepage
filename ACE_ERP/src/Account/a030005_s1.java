...
public class a030005_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String  str2    = req.getParameter("v_str2");//회계일자 from
				String  str3    = req.getParameter("v_str3");//회계일자 to
				...
				if (!GauceReq.isBuilderRequest()) {
					...
					sql.append( " SELECT F.FSDAT FSDAT, F.FSNBR FSNBR, F.FSSEQ FSSEQ, G.ATKORNAM ATKORNAM, nvl(F.DEBAMT,0) DEBAMT, " );
					...
					if(!str1.equals("")) sql.append( "				WHERE C.FDCODE = '"+str1+"'     							" );
					...
					sql.append( "   ORDER BY F.FSNBR, F.FSDAT, F.FSSEQ  													" );
