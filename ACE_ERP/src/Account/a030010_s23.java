...
public class a030010_s23 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {
					...
					if(str6.equals("A")){ //전체
						...
						sql.append( "								 WHERE A.ATCODE = B.ATCODE                                        \n" );
						if(!str1.equals("")) sql.append( " AND A.FDCODE IN('01','02','04')                                \n" );
						sql.append( "									 AND A.ACTYYMM BETWEEN '"+str2+"' AND '"+str3+"'                 \n" );
						if(!str4.equals("")) sql.append( " AND A.COCODE = '"+str4+"'                                       \n" );
						if(!str5.equals("")) sql.append( " AND A.DIVCD = '"+str5+"'                                       \n" );
						sql.append( "									 AND A.ATCODE LIKE '4%' \n");
						...
						sql.append( "  						   GROUP BY  B.ATDECR,B.ATCODE                                                                                                         \n" );
						sql.append( "								 UNION ALL                                                        \n" );
						sql.append( "							  SELECT B.ATDECR  AS ATDECR, B.ATCODE  AS ATCODE, A.FODETOT DETOT, A.FOCRTOT CRTOT \n" );
						sql.append( "								  FROM ACCOUNT.MDMTOTAL A,ACCOUNT.ACTCODE B                       \n" );
						sql.append( "								 WHERE A.ATCODE = B.ATCODE                                        \n" );
						if(!str1.equals("")) sql.append( " AND A.FDCODE='03'                                \n" );
						sql.append( "									 AND A.ACTYYMM BETWEEN '"+str2+"' AND '"+str3+"'                 \n" );
						if(!str4.equals("")) sql.append( " AND A.COCODE = '"+str4+"'                                       \n" );
						if(!str5.equals("")) sql.append( " AND A.DIVCD = '"+str5+"'                                       \n" );
						sql.append( "									 AND A.ATCODE LIKE '4%' \n" );
						...
						sql.append( "              FROM (                                                                                                                                 \n" );
						sql.append( "  						       SELECT B.ATDECR  AS ATDECR, B.ATCODE     AS ATCODE,                                                                                  \n" );
						sql.append( "  							            A.FODETOT AS DETOT, A.FOCRTOT AS CRTOT                                                                             \n" );
						sql.append( "										   FROM ACCOUNT.MTOTALBAL A, ACCOUNT.ACTCODE B                                                                                        \n" );
						sql.append( "										  WHERE A.ATCODE = B.ATCODE                                                                                                           \n" );
						sql.append( "										    AND A.FDCODE = '03'                                                                                                               \n" );
						sql.append( "										    AND A.ACTYYMM BETWEEN '"+str2+"' AND '"+str3+"' \n" );
