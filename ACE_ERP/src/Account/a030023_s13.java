...
public class a030023_s13 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "  FROM(                                                                                                                   \n" );
					sql.append( "         --전기이월                                                                                                       \n" );
					sql.append( "         SELECT A.ATCODE,  R1.FSREFVAL, C.ATDECR,                                                                         \n" );
					...
					if(!str[3].equals("")&&!str[4].equals(""))sql.append( " AND B.FSREFVAL BETWEEN '" +str[3]+ "' AND '" +str[4]+ "'                       \n" );
					sql.append( "                 )R1                                                                                                      \n" );
					...
					sql.append( "  GROUP BY X.FSREFVAL, X.ATDECR, Y.VEND_NM                                                                               \n" );
