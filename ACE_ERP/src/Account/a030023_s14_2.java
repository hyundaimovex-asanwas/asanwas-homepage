...
public class a030023_s14_2 extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;	// 웹페이지의 폼의 전송방식이 Post 타입일 경우
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					if(!str[3].equals(""))
						sql.append( " AND A.FSREFVAL >= '"+str[3]+"' AND A.FSREFVAL <= '"+str[4]+"' \n" );
					...
					sql.append( " FROM ( \n" );
					sql.append( "   SELECT  C.ACTDAT,D.REMARK,C.DETOT,C.CRTOT,C.FDCODE,C.FSDAT,C.FSNBR,C.FSSEQ,C.ATCODE, C.ATDECR \n" );
