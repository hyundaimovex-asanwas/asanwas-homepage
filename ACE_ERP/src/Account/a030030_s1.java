...
public class a030030_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{   "DEAMT", "CRAMT","DETOT","CRTOT", "MDETOT", "MCRTOT"
																						
				}; 

				int[] intArrCN = new int[]{ 15, 15, 15, 15, 15,	15
				}; 
			
				int[] intArrCN2 = new int[]{ 0, 0, 0, 0, 0, 0
				}; 
				...
				if (!GauceReq.isBuilderRequest()) {
					...
					if(str1.equals("A")){ //전체
						 ...
						 sql.append("SELECT SUM(X.DEAMT) DEAMT, SUM(X.CRAMT)CRAMT,                                       \n  ");
						...
						//서울일 경우 계정원장에 전기이월이익잉여금을 일집계에서 가져옴.
						if(str1.equals("02")){
							sql.append("		UNION ALL                                                                        \n"); 
					...
					//System.out.println("a030030_s1"+sql.toString());
/*********************************************************************************************/
