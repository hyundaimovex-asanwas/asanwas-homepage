...
public class a030040_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{    "FDEAMT", "FCRAMT", "DEAMT", "CRAMT","DETOT","CRTOT", "MDETOT", "MCRTOT"
																						
				}; 

				int[] intArrCN = new int[]{   15, 15, 15, 15, 15, 15, 15, 15
				}; 
			
				int[] intArrCN2 = new int[]{  0, 0, 0, 0, 0, 0, 0, 0
				}; 
				...
				if (!GauceReq.isBuilderRequest()) {
					...
					sql.append(" 	GROUP BY C.FSREFVAL, A.ATCODE                                                             \n");
					sql.append(" )X                                                                                           \n");
					//sql.append(" GROUP BY X.FSREFVAL                                                                \n");

					//System.out.println("a030040_s1"+sql.toString());
/*********************************************************************************************/
