...
public class a040001_t2_2_ee extends HttpServlet{
	/**
	 * 
	 */
		   ...
		   try{
				...
				for (int j = 0; j < rows.length; j++){
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						//System.out.println("a040001_t2_2_ee# Query : \n" + sql);							
		...
		*************************************************************************************/
		 ...
		 if (userSet2 != null) { //null체크
				...
				for (int ab = 0; ab < rows2.length; ab++){			   
					...
					UpdateSql11.append( " COSTCD= '" +rows2[ab].getString(idx2COSTCD)+"' 	");
					...
					///logger.dbg.println(this,UpdateSql11.toString());
