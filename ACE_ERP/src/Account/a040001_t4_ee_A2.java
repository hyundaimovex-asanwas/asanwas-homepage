...
public class a040001_t4_ee_A2 extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try {
				...
				String str34="";  //REMARK3
				String str35="";  //S_BIZPLACE
				String str36="";  //COSTCD
				...
				str34=rows1[0].getString(idx1[32]);  //REMARK3
				str35=rows1[0].getString(idx1[33]);  //S_BIZPLACE
				str36=rows1[0].getString(idx1[34]);  //COSTCD
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						********************************************************************/
						...
						if (j==0) {
							...
							//System.out.println("a040001_t4_ee_A2# Query : \n" + sql);								
							...
							InsertSql.append( " SEQ, GUBUN, AMEND_CODE, AMEND_REMARK, EXTCHK, REMARK2,	");
							InsertSql.append( " REMARK3, S_BIZPLACE,COSTCD	");
							...
							InsertSql.append( " "+str28+",'"+str29+"','"+str30+"','"+str31+"'	,'"+str32+"','"+str33+"',	");
							InsertSql.append( "'"+str34+"','"+str35+"','"+str36+"'	");
							InsertSql.append( "  )																				");

							//logger.dbg.println(this,"step5::"+InsertSql.toString() );
