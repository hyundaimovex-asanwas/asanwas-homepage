...
public class a050001_s2_1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT nvl(COUNT(DISTINCT A.CCCODE),0) CCCODE1, nvl(COUNT(A.CCCODE),0) CCCODE2,  	\n");
					sql.append( " 			nvl(SUM(A.TAXSUM),0) TAXSUM1, nvl(SUM(A.TAXVATAMT),0) TAXVATAMT1 					\n");
