...
public class a050001_t2 extends HttpServlet{
	/**
	 * 
	 */
        	...
        	//전자세금계산서 이외 발행분 합계 //////////////////////////////////////////////////////////////////////////////
				...
				for (int k = 0; k < rows2.length; k++){
					if(rows2[k].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						DeleteSql.append( " DELETE FROM ACCOUNT.AVATRPT1 								");
						...
						**************************************************************************/
						...
						DeleteSql2.append( " DELETE FROM ACCOUNT.AVATRPT3 						");
						...
						InsertSql2.append( " INSERT INTO ACCOUNT.AVATRPT3 (				\n");
       ...
       //전자세금계산서 이외 발행분 상세 //////////////////////////////////////////////////////////////////////////////
				...
				for (int j = 0; j < rows.length; j++){
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						**************************************************************************/
						...
						InsertSql.append( " INSERT INTO ACCOUNT.AVATRPT1 (						\n");
            ...
            /**************************************************************************
						...
						**************************************************************************/
						...
						DeleteSql3.append( " DELETE FROM ACCOUNT.AVATRPT5 						");
						...
						InsertSql3.append( " INSERT INTO ACCOUNT.AVATRPT5 (				\n");
