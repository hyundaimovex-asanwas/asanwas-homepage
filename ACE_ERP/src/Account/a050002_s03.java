...
public class a050002_s03 extends HttpServlet {
	/**
	 * 
	 */
          ...
          -1,-1,-1
				...
				if (!GauceReq.isBuilderRequest()) {					
					StringBuffer sql = new StringBuffer();
			          ...
			          sql.append("\n        A.BSNSCND,                                                      ");
			          sql.append("\n        A.BSNSKND,                                                      ");
			          sql.append("\n        TRIM(B.VD_DIRECT) VD_DIRECT ,                                   ");
			          sql.append("\n        TRIM(B.ADDRESS1) ADDRESS1 ,                                     ");
			          sql.append("\n        TRIM(B.BSNS_CND) BSNS_CND ,                                     ");
			          sql.append("\n        TRIM(B.BSNS_KND) BSNS_KND                                       ");
			          sql.append("\n   FROM ACCOUNT.AVATRPT1 A, (SELECT                                     ");
			          sql.append("\n                                 VEND_ID,                               ");
			          sql.append("\n                                 MAX(VD_DIRECT) AS VD_DIRECT ,          ");
			          sql.append("\n                                 MAX(ADDRESS1) AS ADDRESS1,             ");
			          sql.append("\n                                 MAX (BSNS_CND) AS BSNS_CND,            ");
			          sql.append("\n                                 MAX(BSNS_KND) AS BSNS_KND              ");
