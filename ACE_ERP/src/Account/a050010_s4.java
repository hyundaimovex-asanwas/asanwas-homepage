...
public class a050010_s4 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
          ...
          7, 9, 1,15, 1, 15, 74
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("       	DCNT, 	TVCNT,	NUMEXP1, TREQAMT,	NUMEXP2, TTAXAMT,	FILLER \n");
 					sql.append("   FROM ACCOUNT.AVATRPT83 \n");
 					sql.append("  WHERE RCDGB='TL' \n");
