...
public class a050013_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
		  ...
		  "FDCODE",	"DATADIV",	"ACCYM",	"RPTGB",	 "VENDID",	
					"VENDNM",	"VDDIRECT",	"VDADDR", "BSNSCND", "BSNSKND",
					"PERIOD", "WRDT",     "FILLER"
				}; 
		 ...
		 16, 8,60 
		  ...
		  -1, -1, -1
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("        VENDNM,	VDDIRECT,	VDADDR,	BSNSCND,	BSNSKND,  \n");
					sql.append("        PERIOD,	WRDT,	FILLER                          \n");
					sql.append("   FROM ACCOUNT.AVATRPT91 \n");
