...
public class a050013_s3 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				"SEQNO",   "EXPTNO",  "SHIPDT", "CURRCD", "EXCHANGE",	
				"FOAMT",   "KOAMT",	  "FILLER"
				}; 
		 ...
		 15,15,90  
		   ...
		   2 , 0, -1
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("        SEQNO,	EXPTNO,	 SHIPDT, CURRCD, EXCHANGE,	  \n");
					sql.append("        FOAMT,	KOAMT,	 FILLER                       \n");
					sql.append("   FROM ACCOUNT.AVATRPT93 \n");
