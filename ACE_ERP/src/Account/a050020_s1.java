...
public class a050020_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
					...
					"CO_CRNO",	 "CO_NM",        "CO_RENM",   "CO_NO",      "CO_DT",
					"PH_NO",	 "SPACE",       
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("        CO_CRNO,CO_NM,CO_RENM,CO_NO,CO_DT,           \n");
					sql.append("        PH_NO,SPACE,                                 \n");
					sql.append("        CREATE_ID,CREATE_DATE,UPDATE_ID,UPDATE_DATE  \n");
					sql.append("   FROM ACCOUNT.EHDT001 \n");
