...
public class a070001_s3 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "FDCODE", "ACDATE"  }; 

				int[] intArrCN = new int[]{ 2, 8  }; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT FDCODE, ACDATE  " );
					sql.append( " FROM ACCOUNT.AFUNDEND " );
