...
public class a070003_s2 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String  str4	= req.getParameter("v_str4"); //주간구분
				String  str5	= req.getParameter("v_str5"); //ID체크   
				String  str6	= req.getParameter("v_str6"); //구분값     
				String  str7	= req.getParameter("v_str7"); //구분값      
				...
				String[] strArrCN = new String[]{ 
					...
					"STATDIV","ATKORNAM", "VENDCD", "VENDNM"
				};
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " RTRIM(A.VENDCD) VENDCD,  /*거래처*/		\n");
					sql.append( " RTRIM(B.VEND_NM) VENDNM  /*거래처명*/		\n");
					sql.append( " FROM ACCOUNT.AFUNDWEK A,ACCOUNT.ACTCODE F,	\n");
					...
					sql.append( " AND A.VENDCD=B.VEND_CD									\n");
 					...
 					if(!str7.equals("")&&!str7.equals("1")) sql.append( " AND A.UPID= '"+str6+"'		\n");

 					System.out.println("# a070003_s2 : \n" + sql.toString());
/*********************************************************************************************/
