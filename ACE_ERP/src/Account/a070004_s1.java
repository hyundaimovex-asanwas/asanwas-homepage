...
public class a070004_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String  str3	= req.getParameter("v_str3"); //신청년월fr
				String  str4	= req.getParameter("v_str4"); //신청년월to
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " WHERE A.REMCODE=F.ATCODE									\n");
 					...
 					if (!str3.equals("")) sql.append( " AND A.ACYYMM BETWEEN '"+str3+"' AND '"+str4+"'		");
