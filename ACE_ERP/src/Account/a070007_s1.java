...
public class a070007_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "CDREMARK", "CDCODE", "GRP","CDNAM" ,"QUANTY", "ACAMT", "REMARK" ,"SUMAMT"};

				int[] intArrCN = new int[]{11, 4, 1, 7, 6, 15, 132,15 };
			
				int[] intArrCN2 = new int[]{ -1, -1, -1, 0, 0, 0, -1 ,0};
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " TO_NUMBER(A.CDNAM) * nvl(B.QUANTY,0)  AS SUMAMT 							\n");
					sql.append( " FROM ACCOUNT.COMMDTIL A LEFT OUTER JOIN ACCOUNT.ACASHSUR B 	\n");
					sql.append( " ON CDCODE=CASHUNIT 											\n");
					...
					sql.append( " ORDER BY TO_NUMBER(PSEQ)  									\n");
                    
					//System.out.println("a070007_s1::"+sql.toString());
/*********************************************************************************************/
