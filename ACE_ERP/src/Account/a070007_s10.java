...
public class a070007_s10 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "FDCODE", "ACDATE", "AJDTFR", "AJDTTO", "OFDCODE", "OACDATE", "WRID","UPID" };

				int[] intArrCN	= new int[]{  2, 8, 8, 8, 2, 8, 10, 10};
				...
				if (!GauceReq.isBuilderRequest()) {			
					...
					*/
					...
					StringBuffer sql = new StringBuffer();
					sql.append( " SELECT FDCODE, ACDATE, AJDTFR, AJDTTO, FDCODE AS OFDCODE, ACDATE AS OACDATE,''WRID, ''UPID \n");
					sql.append( "   FROM ACCOUNT.ACASHDTAJ				\n");
					sql.append( "  WHERE 1=1							\n");
					if(!str1.equals(""))	sql.append( " AND FDCODE='"+str1+"'	\n");
					if(!str2.equals(""))	sql.append( " AND ACDATE='"+str2+"' \n");
  
					//System.out.println("a070007_s10::"+sql.toString());
