...
public class a070007_s5 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					/*
					sql.append( " SELECT FDCODE FROM ACCOUNT.ASURVEND 	");
					sql.append( " WHERE FDCODE ='" + str1 + "'						");
					sql.append( " AND ACDATE >'" + str2 + "'								");
					*/
  
					sql.append( " SELECT COUNT(*) CNT FROM ACCOUNT.ACASHSUR 	\n");
					sql.append( " WHERE FDCODE ='" + str1 + "'				\n");
					sql.append( " AND ACDATE >'" + str2 + "'				\n");
					sql.append( " AND REMARK ='Y'	            			\n");
					
					//System.out.println("a070007_s5::"+sql.toString());
