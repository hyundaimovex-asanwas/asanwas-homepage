...
public class a070020_t1 extends HttpServlet{
	/**
	 * 
	 */
		...
		try{
			...
			try {
			  ...
			  //logger.err.println(this,"STEP1::");
				...
				InsertSql.append( " INSERT INTO ACCOUNT.ACUSTPAY (  " );
				...
				UpdateSql.append( " UPDATE  ACCOUNT.ACUSTPAY  SET  " );
				...
				DeleteSql.append( " DELETE  FROM ACCOUNT.ACUSTPAY   " );
