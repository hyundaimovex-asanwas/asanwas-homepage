...
public class a070021_t1 extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		*************************************************************************************/
		...
		/************************************************************************************
		 @ ACCOUNT.ACUSTPAY 대금지급에 생성전표의 접수 번호 UPDATE  
		************************************************************************************/
		 ...
		 if (userSet7 != null) {
			    ...
			    int idx7TSDAT        = userSet7.indexOfColumn("TSDAT");  
				int idx7TSNBR       = userSet7.indexOfColumn("TSNBR");    
				int idx7TSSEQ       = userSet7.indexOfColumn("TSSEQ");   
				...
				UpdateSql7.append( " UPDATE ACCOUNT.ACUSTPAY SET " );
				UpdateSql7.append( "               FSDAT =?" );
			    UpdateSql7.append( "              ,FSNBR = ?" );
				UpdateSql7.append( "  WHERE FDCODE=?" );
			    UpdateSql7.append( "       AND TSDAT=?" );
			    UpdateSql7.append( "       AND TSNBR=?" );
			    UpdateSql7.append( "       AND TSSEQ=?" );
				...
				for (int b=0;b<rows7.length;b++){
					...
					gsmt7.bindColumn(1,idx7FSDAT);
					gsmt7.bindColumn(2,idx7FSNBR);
					gsmt7.bindColumn(3,idx7FDCODE);
					gsmt7.bindColumn(4,idx7TSDAT);
					gsmt7.bindColumn(5,idx7TSNBR);
					gsmt7.bindColumn(6,idx7TSSEQ);
