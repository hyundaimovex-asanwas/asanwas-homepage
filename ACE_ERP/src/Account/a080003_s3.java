...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "			COALESCE(A.BGTAMT,0) BGTAMT,					/*배정액*/				\n");
						sql.append( "			COALESCE(A.REBGTAMT,0) REBGTAMT,			/*재배정액*/			\n");
						sql.append( "			COALESCE(A.RESULTAMT,0) RESULTAMT,			/*기집행누계액*/		\n");
						sql.append( "			COALESCE(A.REMAINTAMT,0) REMAINTAMT,		/*가용사용잔액*/		\n");
						sql.append( "			COALESCE(A.BGTRQAMT,0) BGTRQAMT,			/*요청액*/				\n");
