...
public class a080005_s6 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
					"DEPTNM","ATKORNAM","SATNM",  "BGTMM",
					"BASICBGT","ADDBGT1","REALBGT"
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " SUM(A.BASICBGT) BASICBGT,											/*배정액*/					\n");
						sql.append( " SUM(A.ADDBGT)+SUM(CHGABGT)+SUM(CHGTBGT)+SUM(DEPTBGT)  ADDBGT1,	/*변경액*/			\n");
						sql.append( " SUM(A.REALBGT)  REALBGT 											/*실행예산*/		\n");
						...
						sql.append( " GROUP BY D.CDNAM,F.ATKORNAM,S.CDNAM,A.BGTMM									\n");	//D.CDNAM,
						sql.append( " ORDER BY BGTMM,DEPTNM,ATKORNAM,SATNM												\n");
