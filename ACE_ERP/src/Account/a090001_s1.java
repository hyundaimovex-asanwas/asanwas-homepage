...
**********************************************************************************************/
				...
				String  str8	= req.getParameter("v_str8");    //ast1st    제1구분 대분류  = 지점      
				String  str9	= req.getParameter("v_str9");    //자산명 조회
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " A.ASTNAME,                      /*자산이름==> 자산코드*/    \n");
