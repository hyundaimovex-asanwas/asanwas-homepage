...
public class a090001_s10 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{		"FDCODE","ATCODE","AST1ST","AST2ND","AST3RD",
																																...
																																"CHGWHAT","CHGQTY","CHGAMT","RELFIRM","RPSTARTDT",
																																"RPENDDT","WRDT","WRID"	}; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " DECTYPE,        ");  
					sql.append( " CHGWHAT,      ");  
					sql.append( " IFNULL(CHGQTY,0) CHGQTY,          ");  
					sql.append( " IFNULL(CHGAMT,0) CHGAMT,         ");  
					sql.append( " RELFIRM,         ");  
					sql.append( " RPSTARTDT,     ");  
					sql.append( " RPENDDT,        ");  
					sql.append( " WRDT ,             ");  
					sql.append( " WRID              ");  	
					sql.append( " FROM   ACCOUNT.ASTCHG      ");
