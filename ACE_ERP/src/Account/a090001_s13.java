...
public class a090001_s13 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "FDCODE","ATCODE","AST1ST","AST2ND","AST3RD",
													"ASTSEQ","ASTMOVNO","MOVDATE","AMNGDEPT","AUSEDEPT",
													"ACOSTCD","MOVNOTE","WRDT","WRID" }; // ,"ASTMOVNO"}; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " ASTSEQ,    ");
 					...
 					sql.append( " WRDT,   	 ");
 					sql.append( " WRID   	 ");
					sql.append( " FROM   ACCOUNT.ASTMOVING      ");
					...
					sql.append( "  order by int(ASTMOVNO)     ");
