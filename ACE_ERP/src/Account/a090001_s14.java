...
public class a090001_s14 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " ASTSEQ,           ");        
					sql.append( " LEASENO,           ");      
					sql.append( " LEASEDATE,          ");    
					sql.append( " LEASECLS,           ");     
					sql.append( " LEASEHOLD,          ");   
					sql.append( " LEASETERM,          ");   
					sql.append( " IFNULL(LEASEAMT,0) LEASEAMT,            ");   
					sql.append( " IFNULL(LEASEGAMT,0) LEASEGAMT,           ");  
					sql.append( " LEASEWHY,            ");  
					sql.append( " LEASESTS,              ");  
					sql.append( " IFNULL(LEASEPYUNG,0) LEASEPYUNG,         ");  
					sql.append( " WRDT,                  ");    
					sql.append( " WRID                ");  
					sql.append( " FROM   ACCOUNT.ASTLEASE      ");
