...
public class a090001_s7 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " ASTSEQ,    ");
					sql.append( " INSURENO,    ");
					sql.append( " INSUREDATE,    ");
					sql.append( " INSHEETNO,    ");
					sql.append( " INSSTARTDT,    ");
					sql.append( " INSENDDT,    ");
					sql.append( " INSTERM,    ");
					sql.append( " nvl(INSAMT,0)  INSAMT,    ");
					sql.append( " nvl(INSEDAMT,0)  INSEDAMT,    ");
					sql.append( " INSFIRM,    ");
					sql.append( " INSNOTE,    ");
					sql.append( " WRDT,    ");
					sql.append( " WRID    ");
					sql.append( " FROM   ACCOUNT.ASTINSURE      ");
