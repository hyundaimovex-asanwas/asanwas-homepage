...
public class a090001_s9 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{"FDCODE","ATCODE","AST1ST","AST2ND","AST3RD",
																												...
																												"MORTAMT","MORTDTL","MORTORDER","WRDT","WRID"}; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " MORTDATE,        "); 
					sql.append( " MORTBANK,       "); 
					sql.append( " CLOSEORNOT,   "); 
					sql.append( " CLOSEDATE,      "); 
					sql.append( " nvl(BOOKAMT,0) BOOKAMT,         "); 
					sql.append( " MORTSIZE,        "); 
					sql.append( " MORTJDGDT,      "); 
					sql.append( " nvl(JUDGAMT,0)  JUDGAMT,          "); 
					sql.append( " nvl(MORTAMT,0)  MORTAMT,         "); 
					sql.append( " MORTDTL,          "); 
					sql.append( " MORTORDER,     "); 
					sql.append( " WRDT,               "); 
					sql.append( " WRID                 "); 
					sql.append( " FROM   ACCOUNT.ASTMORT      ");
