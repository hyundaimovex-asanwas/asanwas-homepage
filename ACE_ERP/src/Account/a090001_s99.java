...
public class a090001_s99 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " AND  A.ATUSEYN='Y'  " );
					if (str1.equals("")) sql.append( "  AND A.ATCODE LIKE '1220%'	" );	
					else if(!str1.equals(""))sql.append( " AND A.ATCODE = '" + str1+ "'		" );				
