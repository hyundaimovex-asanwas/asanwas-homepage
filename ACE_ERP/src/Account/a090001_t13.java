...
public class a090001_t13 extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				String   LEASENO	= reqGauce.getParameter("LEASENO"); 
				...
				if(IsUpdated.equals("2")){
					...
					UpdateSql.append( " UPDATE ACCOUNT.ASTLEASE  SET   "); 
					UpdateSql.append( " LEASEDATE     = '"+str7+"',	      ");
					UpdateSql.append( " LEASECLS      	= '"+str8+"',	    ");
					UpdateSql.append( " LEASEHOLD   = '"+str9+"',	      ");
					UpdateSql.append( " LEASETERM   	= '"+str10+"',	    ");
					UpdateSql.append( " LEASEAMT     			= '"+str11+"',	    ");
					UpdateSql.append( " LEASEGAMT   		= '"+str12+"',	      ");
					UpdateSql.append( " LEASEWHY    		= '"+str13+"',	      ");
					UpdateSql.append( " LEASESTS      = '"+str14+"',	      ");
					UpdateSql.append( " LEASEPYUNG = '"+str15+"',	      ");
					...
					UpdateSql.append( " AND LEASENO =  '"+LEASENO+"'	");
				...
				if (IsUpdated.equals("1")){				
					...
					Statement stmt = conn.createStatement();
							...
							String sql = "SELECT COALESCE(MAX(LEASENO),0)+1 AS LEASENO FROM  ACCOUNT.ASTLEASE "
										 + "	WHERE FDCODE  = '"+str1+"'"	
								         + "    AND	  AST1ST  = '"+str3+"'"	
								         + "    AND   AST2ND  = '"+str4+"'"  
									     + "    AND   AST3RD  = '"+str5+"'" 				
							...
							InsertSql.append( " INSERT INTO ACCOUNT.ASTLEASE (FDCODE,ATCODE,AST1ST,AST2ND,AST3RD,");
							InsertSql.append( "ASTSEQ,LEASEDATE,LEASECLS,LEASEHOLD,LEASETERM,");
							InsertSql.append( "LEASEAMT,LEASEGAMT,LEASEWHY,LEASESTS,LEASEPYUNG,");
							InsertSql.append( "WRDT,WRID,LEASENO  ) ");
				...
				DeleteSql.append( " DELETE FROM ACCOUNT.ASTLEASE   " );
				...
				DeleteSql.append( " AND LEASENO  =  '"+LEASENO+"'   	");	
