...
public class a090004_s11 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
          ...
          "AST2ND"	     ,"JSGUBUN"	     ,"ASTYUSE"	     ,"JUNCAMT"	     ,"DANGCAMT"	   ,
          "JUNMALSAMT"	 ,"JUNDANGSAMT"	 ,"DANGSAMT"	   ,"JANJONAMT"
        };  
          ...
          0, 0, 0, 0
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append("\n    AND A.DEPRENDDT LIKE SUBSTR('"+str1+"',1,4)||'%') A,ACCOUNT.COMMDTIL Z                                              ");
					}
					sql.append("\n  WHERE A.AST2ND = Z.CDCODE                                                                                     ");
					sql.append("\n    AND Z.CMTYPE = '2101'                                                                                       ");
					sql.append("\n GROUP BY A.AST2ND,Z.CDNAM,A.ASTYUSE                                                                            ");
