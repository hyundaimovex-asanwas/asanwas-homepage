...
public class a090021_s12 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
			  ...
			  String  str2= req.getParameter("v_str2");    //계정코드 
				...
				String[] strArrCN = new String[]{ "FDCODE",	   "ATCODE",	"AST1ST",	    "AST2ND",	  "AST3RD",
											                    "ASTSEQ",	  "AMMODEL",	"AMAKEDATE",	"ASUBSTD",	"AMAKENO",
											                    "AMWEIGHT",	"AMFORM",	  "AMOIL"	}; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( "         ASTSEQ, AMMODEL, AMAKEDATE, ASUBSTD,AMAKENO,  ");    
 					sql.append( "         nvl(AMWEIGHT,0) AMWEIGHT,AMFORM, AMOIL     ");
					sql.append( "   FROM  ACCOUNT.ASTADINFO3N      ");
