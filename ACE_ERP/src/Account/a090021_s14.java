...
public class a090021_s14 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{"FDCODE",   "ATCODE",   "AST1ST",   "AST2ND",  "AST3RD",
																				 "ASTSEQ",   "LEASENO",  "LEASEDATE","LEASECLS","LEASEHOLD",
																				 "LEASETERM","LEASEAMT", "LEASEGAMT","LEASEWHY","LEASESTS",
																				 "LEASEPYUNG","WRDT",    "WRID",     "VEND_NM" }; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( "        A.ASTSEQ,    A.LEASENO, A.LEASEDATE, A.LEASECLS,  A.LEASEHOLD,               \n");        
					sql.append( "        A.LEASETERM, nvl(A.LEASEAMT,0) LEASEAMT,nvl(A.LEASEGAMT,0) LEASEGAMT,  \n");      
					sql.append( "        A.LEASEWHY,  A.LEASESTS,nvl(A.LEASEPYUNG,0) LEASEPYUNG,                   		\n");  
					sql.append( "        A.WRDT,      A.WRID,    B.VEND_NM                        		\n");    
					sql.append( "   FROM ACCOUNT.ASTLEASE A                                       	\n");
					sql.append( "   LEFT  JOIN ACCOUNT.GCZM_VENDER B ON A.LEASEHOLD = B.VEND_CD   \n");
