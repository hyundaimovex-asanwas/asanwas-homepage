...
public class a090021_s4 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "FDCODE","ATCODE",   "AST1ST",   "AST2ND","AST3RD",
																					"ASTSEQ","ASTSOJE",  "ASTPOST",  "ASTCON","ASTUSE",
																					"ASTSIZE","ASTPYUNG","ASTREGYMD","ASTREGNO" }; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( " 	      ASTSEQ, ASTSOJE, ASTPOST, ASTCON, ASTUSE,  	\n");
 					sql.append( "         ASTSIZE,ASTPYUNG,ASTREGYMD,ASTREGNO      		\n");
					sql.append( "   FROM  ACCOUNT.ASTADINFO1N      								\n");
