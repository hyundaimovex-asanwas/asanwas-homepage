...
public class a090021_s7 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "FDCODE",	   "ATCODE",		   "AST1ST",		  "AST2ND",		  "AST3RD",		
																					"ASTSEQ",	   "INSURENO",		 "INSUREDATE",	"INSHEETNO",	"INSSTARTDT",		
																					"INSENDDT",	 "INSTERM",		   "INSAMT",		  "INSEDAMT",		"INSFIRM",		
																					"INSNOTE",	 "WRDT",		     "WRID",        "VEND_NM"}; 
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					sql.append( "         A.ASTSEQ,   A.INSURENO, A.INSUREDATE,  A.INSHEETNO,  A.INSSTARTDT, 	\n");
					sql.append( "         A.INSENDDT, A.INSTERM,  nvl(A.INSAMT,0)  INSAMT, 									\n");
					sql.append( "         nvl(A.INSEDAMT,0)  INSEDAMT,   A.INSFIRM,        										\n");
					sql.append( "         A.INSNOTE,  A.WRDT,     A.WRID,   B.VEND_NM         								\n");
					sql.append( "   FROM  ACCOUNT.ASTINSURE A                                 									\n");
					sql.append( "   LEFT  JOIN ACCOUNT.GCZM_VENDER B ON A.INSFIRM = B.VEND_CD 					\n");
