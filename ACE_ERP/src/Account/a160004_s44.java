...
public class a160004_s44 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("  COALESCE(B.BP24000R,0) AS DBP24000R, -- 차량 */                               \n ");
					sql.append("  COALESCE(B.S91000R,0) AS DS91000R, -- 급여계 */                              \n ");
					...
					sql.append("   GROUP BY B.PRTSEQ, B.PRTCOD, B.PRTDEPTNM ) B ");
					sql.append("  ORDER BY SEQ, MINORCD, DEPTNM ");
				
					//logger.dbg.println(this,"44::"+sql.toString());
