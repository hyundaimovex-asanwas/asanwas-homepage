...
public class a160006_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
						...
						"EA_NO",	 "EA_AD",	    "TOT_AMT",	    "EXP_AMT",    "INC_AMT",     
						"TAX_RATE",	 "INC_TAX",	    "LINC_TAX",	    "FVS_TAX",    "SUM_AMT",
						"INOUT_GB",	 "INCOME_GB",	    	             
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("        EA_NO,	    EA_AD,	    TOT_AMT,	EXP_AMT,	INC_AMT,   \n");
					sql.append("        TAX_RATE,	INC_TAX,	LINC_TAX,	FVS_TAX,	SUM_AMT,   \n");
					sql.append("        INOUT_GB,	INCOME_GB,	                                   \n");
					sql.append("        CREATE_ID,	CREATE_DATE,	UPDATE_ID,	UPDATE_DATE       \n");
					sql.append("   FROM ACCOUNT.PINCOME                                            \n");
