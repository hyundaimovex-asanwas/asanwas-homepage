...
public class a200001_s3 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
					...
					"BANCOD","BANNAM","GETDATE","GETMEN","STATDIV",
					"STDATE","UPDT","UPID"
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " RTRIM(A.BCDIV)    BCDIV,      /*구분*/						\n");
						sql.append( " RTRIM(A.BANCOD)   BANCOD,			/*은행코드*/				\n");
						sql.append( " RTRIM(B.CDNAM)    BANNAM,     /*은행명*/					\n");
						sql.append( " RTRIM(A.GETDATE)  GETDATE,		/*수령일자*/				\n");
						sql.append( " RTRIM(A.GETMEN)   GETMEN,			/*수령인*/					\n");
						sql.append( " RTRIM(A.STATDIV)  STDIV,			/*처리구분*/				\n");
						sql.append( " RTRIM(A.STDATE)   STDATE,			/*처리일자*/				\n");
