...
**********************************************************************************************/
				...
				str[1] = req.getParameter("v_str2");	//배서일자fr
				str[2] = req.getParameter("v_str3");	//배서일자to
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "  RTRIM(A.STRDATE)    STRDATE1,   /*배서일자*/      			\n");
						sql.append( "  RTRIM(A.CHKMAN)     CHKMAN,     /*배서인*/        			\n");
						sql.append( "  RTRIM(A.ADDRESS)    ADDRESS,    /*주소*/          			\n");
						sql.append( "  RTRIM(A.VD_TELNO)   VD_TELNO,   /*연락처*/        			\n");
