...
public class a200002_s3 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				str[1] = req.getParameter("v_str2");	//수탁일자fr
				str[2] = req.getParameter("v_str3");	//수탁일자to
				...
				String[] strArrCN = new String[]{ 
					...
					"BANCOD","ORDDATE","ORDAMT","DRAMT","STRDATE2",
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "  RTRIM(A.STRDATE)     STRDATE1,   /*수탁일자*/      	\n");
