...
public class a200002_s4 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				str[1] = req.getParameter("v_str2");	//할인일자fr
				str[2] = req.getParameter("v_str3");	//할인일자to
				...
				String[] strArrCN = new String[]{ 
					...
					"BANCOD","DCDAYS","DCRATE","DCAMT","DRAMT",
					"STRDATE2","ENDDATE","VEND_CD","VEND_NM"
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "  RTRIM(A.STRDATE)     STRDATE1,   /*할인일자*/      	\n");
						sql.append( "  RTRIM(A.BANCOD)      BANCOD,     /*할인은행*/      	\n");
						sql.append( "  COALESCE(A.DCDAYS,0) DCDAYS,     /*할인일수*/      	\n");
						sql.append( "  COALESCE(A.DCRATE,0) DCRATE,		  /*할인율*/        	\n");
						sql.append( "  COALESCE(A.DCAMT,0)  DCAMT,		  /*할인료*/        	\n");
						...
						sql.append( "  FROM ACCOUNT.ABINHAL A                            	  \n");
						...
						sql.append( " ORDER BY STRDATE1,BANCOD													\n");
