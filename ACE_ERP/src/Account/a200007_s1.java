...
public class a200007_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				str[2] = req.getParameter("v_str3");	//만기일자fr
				str[3] = req.getParameter("v_str4");	//만기일자to
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " ORDER BY FDCODE,ENDDATE,STRDATE,VEND_NM,REFCODE2		\n");
