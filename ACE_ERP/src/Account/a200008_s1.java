...
public class a200008_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				str[2] = req.getParameter("v_str3");	//회계일자fr
				str[3] = req.getParameter("v_str4");	//회계일자to
				...
				String[] strArrCN = new String[]{ 
					"FDCODE","ACTDAT","REFCODE2","DRAMT","CRAMT",
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " RTRIM(A.ACTDAT)		ACTDAT,			/*전표일자*/				\n");
						...
						if(!str[2].equals("")) sql.append( " AND A.ACTDAT BETWEEN '"+str[2]+"'	AND '"+str[3]+"'\n");	//회계일자
						sql.append( " ORDER BY FDCODE,ACTDAT,REFCODE2										\n");
