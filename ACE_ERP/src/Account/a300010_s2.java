...
public class a300010_s2 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "        X.SSDAT,   X.SSNBR, X.VENDCD AS VEND_CD , G.VEND_NM,  X.CRAMT JANAMT, X.BILLSNO, ''WRID, ''UPID, X.JOBDT \n");	
						sql.append( "   FROM ACCOUNT.ABILLSMST X, ACCOUNT.GCZM_VENDER G         \n");	
						sql.append(  " WHERE X.VENDCD = G.VEND_CD(+)                            \n");	
						sql.append(  "   AND X.ATCODE IN ('2100120','2100530')                  \n"); 
						...
						*/
						...
						System.out.println("# a300010_s2 Query : \n" + sql);
