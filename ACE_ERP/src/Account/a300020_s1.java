...
public class a300020_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "        FDCODE, 0 DEAMT_SUM, 0 CRAMT_SUM, SUM(CRAMT) JANAMT,'1'GUBUN        \n");	
						sql.append( "   FROM ACCOUNT.ABILLSMST                                                   \n");	
						sql.append( "  WHERE ATCODE IN ('2100120','2100530')                                     \n");  //지급어음	
						...
						*/
						...
						//System.out.println("# a300020_s1 Query : \n" + sql);
