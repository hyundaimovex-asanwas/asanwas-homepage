...
public class a300020_s5 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "        X.FDCODE, Y.DEAMT_SUM, Y.CRAMT_SUM, X.DEAMT JANAMT, (Y.DEAMT_SUM) JANAMT_SUM, ''WRID, ''UPID ,'2' GUBUN \n");
						...
						*/
						...
						//System.out.println("# a300020_s5 Query : \n" + sql);
