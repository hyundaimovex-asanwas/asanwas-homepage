...
**********************************************************************************************/
				...
				str[2] = req.getParameter("v_str3");	//만기일자_fr
				str[3] = req.getParameter("v_str4");	//만기일자_to
				str[4] = req.getParameter("v_str5");	//발행일자_fr
				str[5] = req.getParameter("v_str6");	//발행일자_to
				str[6] = req.getParameter("v_str7");	//어음구분
