...
public class a300065_s3 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "        SUM(A.SUPAMT)SUPAMT,  SUM(A.SUPVATAMT)SUPVATAMT,\n");
						sql.append( "        SUM(A.SUPAMT)+SUM(A.SUPVATAMT) AS APPAMT,       \n");
						sql.append( "        A.REMARK, A.PAYGB,                      \n");
						sql.append( "         CASE WHEN A.PAYGB='1' THEN '보통예금'    \n");
						sql.append( "              WHEN A.PAYGB='2' THEN '현금'       \n");
						sql.append( "              WHEN A.PAYGB='3' THEN '외화보통예금' \n");
						...
						sql.append( "    AND A.PAYKND IN ('2','3','4')                            \n"); //고정지겁건.
						...
						*/
						...
						//System.out.println("# a300060_s3 Query : \n" + sql);
