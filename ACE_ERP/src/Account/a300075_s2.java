...
public class a300075_s2 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT  '"+str[0]+"'  AS FDCODE , 'A00000000'   AS FSDAT, '000000' AS FSNBR, '00000' AS FSSEQ, '000' AS FSNUM,      \n");
					...
					sql.append( "        X.TAXNBR, X.TAXKND, X.TAXDAT                                                                                 \n");
					sql.append( "  FROM (                                                                                                             \n");
					sql.append( " 	        --반제계정은 0 ( 외상매입금 또는 미지급금 )                                                                         \n");
					sql.append( "         SELECT A.ATCODE||'1' AS SEQ,                                                                                \n");
					sql.append( "                CASE WHEN SUBSTR(A.ATCODE,1,2)='44' THEN  '2100510' ELSE '2100110' END ATCODE,                       \n");
					sql.append( "                0 AS DEAMT,                               \n");
					sql.append( "                0 AS CRAMT,                               \n");
					sql.append( "                A.VENDCD,A.VENDNM, A.COSTGB, A.COSTBGT,                                                              \n");
					sql.append( "                A.REMARK, '' DOCUMCD, '' DOCUVAL,   A.TAXNBR,   '' TAXKND,  '' TAXDAT,                               \n");
					sql.append( "                (A.VENDCD||'#-#'||A.REMARK) VENDREAMRK, '1' AS SEQ2                                                  \n");
					sql.append( "           FROM ACCOUNT.ACAPPFUND A,  ACCOUNT.ACTCODE Z                                                              \n");
					sql.append( "          WHERE ( A.PAYFSDAT='' OR A.PAYFSDAT IS NULL )                                                              \n");
					sql.append( "            AND A.ATCODE = Z.ATCODE(+)                                                                               \n");
					sql.append( "            AND A.APPNO IN ("+str[4]+")                                                                              \n");
					sql.append( "          UNION ALL                                                                                                  \n");
					sql.append( " 	        --( 보통예금/현금/외화보통예금/현금(외화) )                                                                       \n");
					sql.append( "         SELECT A.ATCODE||'2' AS SEQ,                                                                                \n");
					sql.append( "                CASE WHEN PAYGB='1' THEN  '1110150'       \n");
					sql.append( "                     WHEN PAYGB='2' THEN  '1110110'       \n");
					sql.append( "                     WHEN PAYGB='3' THEN  '1110160'       \n");
					sql.append( "                     WHEN PAYGB='4' THEN  '1110120'       \n");
					sql.append( "                 END ATCODE,                              \n");
					...
					sql.append( "                A.VENDCD,A.VENDNM, A.COSTGB, A.COSTBGT,                                                              \n");
					sql.append( "                A.REMARK, '' DOCUMCD, '' DOCUVAL,   A.TAXNBR,   '' TAXKND,  '' TAXDAT,                               \n");
					sql.append( "                (A.VENDCD||'#-#'||A.REMARK) VENDREAMRK, '2' AS SEQ2                                                  \n");
					sql.append( "           FROM ACCOUNT.ACAPPFUND A,  ACCOUNT.ACTCODE Z                                                              \n");
					sql.append( "          WHERE ( A.PAYFSDAT='' OR A.PAYFSDAT IS NULL )                                                              \n");
					sql.append( "            AND A.ATCODE = Z.ATCODE(+)                                                                               \n");
					sql.append( "            AND A.APPNO IN ("+str[4]+")                                                                              \n");
					...
					//System.out.println("a300075_S2 : " + sql);
