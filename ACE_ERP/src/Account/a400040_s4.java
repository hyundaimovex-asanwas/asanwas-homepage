...
public class a400040_s4 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "  WHERE X.REPTDT = (SELECT MAX(REPTDT) FROM ACCOUNT.ACREPLAN  WHERE REPTDT <'"+str[0]+"') \n");
						sql.append( "    AND X.CUAMT<>0   \n");
						sql.append( "  ORDER BY X.RSTSEQ   \n");
							
						System.out.println("# a400040_s4 Query : \n" + sql);
