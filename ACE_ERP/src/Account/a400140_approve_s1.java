...
public class a400140_approve_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
						...
						"AP_SEQ",    "AP_TYPE",      "AP_EMPNO",     "ENO_NM",  "AP_JOBNM",
						"AP_DPTNM",  "AP_STATUS_D",  "AP_DESC",      "U_EMPNO", "U_DATE", "U_IP"  
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "        A.AP_SEQ,   A.AP_TYPE,     A.AP_EMPNO, B.ENO_NM, A.AP_JOBNM,   \n");
						sql.append( "        A.AP_DPTNM, A.AP_STATUS_D, A.AP_DESC,                          \n");
