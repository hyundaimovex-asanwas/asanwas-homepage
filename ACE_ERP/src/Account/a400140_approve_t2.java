...
public class a400140_approve_t2 extends HttpServlet{
	/**
	 * 
	 */
				...
				for (int k = 0; k < rows3.length; k++){
				   ...
				   if(rows3[k].getJobType() == GauceDataRow.TB_JOB_INSERT) {
					 ...
					 //채번시작
						...
						sql0.append( "  SELECT LPAD(NVL(MAX(TO_NUMBER(SUBSTR(SIGNET_MGR_NO,5,7))),0)+1,3,0)  \n"); 
						sql0.append( "    FROM ACCOUNT.SIGNET_COR \n"); 
