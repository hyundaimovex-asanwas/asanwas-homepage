...
public class a400150_approve_s0 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
						...
						"APP_DATE",  "REMARK",
						"WRID",      "WRDT",          "UPID",       "UPDT",
						"APP_TEAMNM", "APP_EMPNM",    "SEND_DATE_CONFIRM"
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "   FROM ACCOUNT.SIGNET_USE A ,  ASNHR.T_CM_PERSON B , ASNHR.T_CM_DEPT C                     \n");
						...
						*/
						...
						//System.out.println("# a400150_approve_s0 Query : \n" + sql);
