...
public class a500020_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String  str2	= req.getParameter("v_str2"); //은행명
				String  str3	= req.getParameter("v_str3"); //상태값
				String  str4	= req.getParameter("v_str4"); //번호 구분(사업자번호 or 주민번호)
				String  str5	= req.getParameter("v_str5"); //번호 data
				String  str6	= req.getParameter("v_str6"); //계좌번호			
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "		 A.ATT_FILE_NAME ,  A.V_ACCTNO_CHK, SYS_FILE_NAME                                   \n");		
					...
					if (!str2.equals("")) sql.append( " AND A.BANK_CD = '" + str2 + "'										\n");
					...
					if (!str5.equals("")) sql.append( " AND A.VEND_ID LIKE '%" + str5 + "%'									\n");					
					if (!str6.equals("")) sql.append( " AND A.ACCT_NO LIKE '%" + str6 + "%'									\n");	
