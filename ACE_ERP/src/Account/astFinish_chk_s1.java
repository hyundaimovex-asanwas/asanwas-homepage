...
public class astFinish_chk_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String  str4 = req.getParameter("v_str4");    //월
				...
				if (!GauceReq.isBuilderRequest()) {	
					...
					if (!str3.equals("")) sql.append( " AND YEAR  = '" + str3 + "' 	\n");
					if (!str4.equals("")) sql.append( " AND MONTH = '" + str4 + "' 	\n");
