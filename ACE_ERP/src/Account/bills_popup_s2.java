...
**********************************************************************************************/
				...
				String  str1 = req.getParameter("v_str1");    //구분 : 전체 - A 
				String  str2 = req.getParameter("v_str2");    //사번
				String  str3 = req.getParameter("v_str3");    //계산서일자 fr
				String  str4 = req.getParameter("v_str4");    //계산서일자 to
				String  str5 = req.getParameter("v_str5");    //지점
				String  str6 = req.getParameter("v_str6");    //연결 구분 (1- 미연결, 2 -기 연결)
