...
public class comm_upatcode_t2 extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
      ...
      //외화
        ...
        //1.일집계 해당월의 상위 데이타 삭제 
				String  sql001 = " DELETE FROM ACCOUNT.TOTALBAL A "
				...
				String  sql002 = " UPDATE ACCOUNT.TOTALBAL SET DEUPTOT = DETOT , CRUPTOT =CRTOT, FODEUPTOT = FODETOT , FOCRUPTOT =FOCRTOT "
				...
				String  sql003 = " DELETE FROM ACCOUNT.MTOTALBAL A "
				...
				String  sql004 = " UPDATE ACCOUNT.MTOTALBAL SET DEUPTOT = DETOT , CRUPTOT =CRTOT,FODEUPTOT = FODETOT , FOCRUPTOT =FOCRTOT  "
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 
          ...
          //기존금액 저장
					...
					//sql_d.append( "    AND A.ACTDAT ='20060529'                         ");
					//sql_d.append( "    AND A.ATCODE ='4111800'                         ");
          ...
          strAtgrp="";
					...
					while(rs_d.next())	{		//
            //iicnt +=1;
            //ssCnt = String.valueOf(iicnt);
					  //logger.dbg.println(this,"ssCnt:::"+ssCnt);
						//loop돌기
            ...
            //logger.dbg.println(this,"rs_d.gstrAtupcode:::"+gstrAtupcode);
              ...
              //icnt+=1;
                  ...
                  //logger.dbg.println(this,"일별Select::::"+sql_u1.toString());	
								//}
