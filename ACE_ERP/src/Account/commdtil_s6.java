...
public class commdtil_s6 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT Q.FDCODE, Q.H_ASTNBR, Q.ASTNAME, Q.ASTNM, Q.ASAQSDAT,	 \n " );
					sql.append( " 	   Q.COSTCD, Q.COSTNM, Q.ASAQSDIV, Q.ASAQSDIVNM,        	 \n " );
					sql.append( " 	   Q.ASTAQAMT ,  Q.ASTUSER, Q.USERNM,                   	 \n " );
					sql.append( " 	   Q.BUYFROM, Q.VEND_NM , Q.ASTSTATNM                   	 \n " );
					sql.append( "   FROM (                                                    	 \n " );
					...
					sql.append( "						        B.ASTAQAMT,  B.ASTUSER, ASNHR.SF_GET_ENONAME('01',B.ASTUSER) AS USERNM,                                            \n " );
                    sql.append( "						        B.BUYFROM, TRIM(C.VEND_NM) AS VEND_NM,TRIM(Q.CDNAM) AS ASTSTATNM                                                      	 \n " );
					sql.append( "						   FROM ACCOUNT.ASTMSTN A                                                      																			\n " );
					sql.append( "						   LEFT JOIN ACCOUNT.ASTBASICN B ON A.FDCODE = B.FDCODE AND A.AST1ST = B.AST1ST AND A.AST2ND = B.AST2ND  	\n " );
					...
					if(str4.equals("1")){
					  sql.append( "						   AND ( A.FSDAT IS NULL AND A.FSNBR IS NULL AND A.FSSEQ IS NULL)                                       	\n " );	
					...
					if (str4.equals("1")){	
						...
						sql.append( " 				                    FROM ACCOUNT.FSLIPREF K1,                                        	\n " );
						sql.append( " 						                      ACCOUNT.FSLIPMST K2                                         	\n " );
						sql.append( " 				                  WHERE K1.FDCODE = K2.FDCODE                                       	\n " );
						sql.append( " 					                   AND K1.FSDAT = K2.FSDAT                                         	\n " );
						sql.append( " 					                   AND K1.FSNBR = K2.FSNBR                                         	\n " );
						sql.append( " 					                   AND K2.ACTDAT >='20120601'                                      	\n " );
						sql.append( " 					                   AND K1.FSREFCD ='1135'                                          	\n " );
						sql.append( " 					                   AND K1.FSREFVAL = Q.H_ASTNBR                                    	\n " );
						sql.append( " 					                   AND K1.FDCODE = Q.FDCODE                                        	\n " );
						sql.append( " 					                   AND K1.FDCODE ='" + str1 + "'                                         	\n " );
						sql.append( " 					                   AND ( TRIM(K1.FSREFVAL) <>'' AND K1.FSREFVAL IS NOT NULL)       	\n " );
						sql.append( " 				                  )                                                                  	\n " );
					}
                    
                    sql.append( " 	ORDER BY Q.H_ASTNBR		\n " );
          
                    System.out.println("commdtil_s6 \n" + sql.toString());	
