...
public class discount_popup_s1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ 
					...
					"BANCOD","DCDAYS","DCRATE","DCAMT","SLIPYN",
					"DRAMT","STRDATE2","ENDDATE","VEND_CD","VEND_NM",
					"BANNAM"
				}; 
				...
				for (int i=0; i<strArrCN.length; i++) { //set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "  RTRIM(A.STRDATE)     STRDATE,    /*할인일자*/      	\n");
						...
						sql.append( "  RTRIM(D.CDNAM)       BANNAM      /*할인은행*/      	\n");
