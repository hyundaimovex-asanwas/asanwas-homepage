...
public class dishonor_popup_t1 extends HttpServlet{
	/**
	 * 
	 */
		...
		try{
			...
			try {
				...
				String[] StrArrCN = new String[] {
					...
					"RTNDATE","RTNAMT","SLIPYN"//,"UPDT","UPID"
				};
				...
				for (int j = 0; j < rows.length; j++){
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						********************************************************************/
						...
						InsertSql.append( " INSERT INTO ACCOUNT.ABINBUD (						");
						InsertSql.append( " FDCODE,ATCODE,FUNDDIV,REFCODE2,STRDATE,	");
						InsertSql.append( " RTNDATE,RTNAMT,SLIPYN										");
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_UPDATE) {
						...
						UpdateSql.append( " UPDATE ACCOUNT.ABINBUD SET								");
						UpdateSql.append( " STRDATE=?, RTNDATE=?, RTNAMT=?, SLIPYN=?,	");
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE) {
						...
						DeleteSql.append( " DELETE FROM ACCOUNT.ABINBUD 															");
