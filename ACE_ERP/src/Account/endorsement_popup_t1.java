...
public class endorsement_popup_t1 extends HttpServlet{
	/**
	 * 
	 */
		...
		try{
			...
			try {
				...
				String[] StrArrCN = new String[] {
					...
					"CHKMAN","ADDRESS","VD_TELNO","UPDT","UPID"
				};
				...
				for (int j = 0; j < rows.length; j++){
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						********************************************************************/
						...
						InsertSql.append( " INSERT INTO ACCOUNT.ABINBAE (						");
						InsertSql.append( " FDCODE,ATCODE,FUNDDIV,REFCODE2,STRDATE,	");
						InsertSql.append( " CHKMAN,ADDRESS,VD_TELNO									");
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_UPDATE) {
						...
						UpdateSql.append( " UPDATE ACCOUNT.ABINBAE SET									");
						UpdateSql.append( " STRDATE=?, CHKMAN=?, ADDRESS=?, VD_TELNO=?,	");
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE) {
						...
						DeleteSql.append( " DELETE FROM ACCOUNT.ABINBAE 															");
