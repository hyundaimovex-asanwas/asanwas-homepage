...
public class excel_upload_a160005_t1 extends HttpServlet{
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
        ...
        ////////////////////////////////////////////////////////////////////////////// 
				...
				if (ds2 != null) {
					...
					ds2.addDataColumn(new GauceDataColumn("EA_CRNO",      GauceDataColumn.TB_STRING, 10));   //소득자사업자등록번호
					ds2.addDataColumn(new GauceDataColumn("EA_FMARK",     GauceDataColumn.TB_STRING, 50));   //소득자상호
					ds2.addDataColumn(new GauceDataColumn("EA_FAD",       GauceDataColumn.TB_STRING, 100));   //소득자사업장소재지
					ds2.addDataColumn(new GauceDataColumn("EA_BSGB",      GauceDataColumn.TB_STRING, 50));   //소득자업종구분
					...
					ds2.addDataColumn(new GauceDataColumn("RESID_NM",     GauceDataColumn.TB_STRING, 20));   //거주지국
					ds2.addDataColumn(new GauceDataColumn("RESID_GB",     GauceDataColumn.TB_STRING, 2));   //거주지국코드
