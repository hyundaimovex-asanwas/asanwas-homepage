...
public class Tp020I_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		*************************************************************************************/
		...
		/************************************************************************************
		 @ SALES.TAC080 및  ACCOUNT.ASTTAXMST 에 UPDATE 처리 
		************************************************************************************/
		 ...
		 if (userSet7 != null) {
				...
				int idx7TR_SID       	= userSet7.indexOfColumn("TR_SID");
				...
				UpdateSql7.append( " UPDATE SALES.TAC080 SET " );
				UpdateSql7.append( "               FDCODE =?" );
			    UpdateSql7.append( "              ,FSDAT = ?" );
			    UpdateSql7.append( "              ,FSNBR = ?" );
				UpdateSql7.append( "  WHERE TR_SID=?" );
