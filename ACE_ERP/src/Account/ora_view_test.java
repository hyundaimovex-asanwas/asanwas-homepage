...
public class ora_view_test extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				**/
				...
				String[] strArrCN = new String[]{ "GUBUN", "CD_GBN", "DPT_CD", "DPT_NM", "GBN_CD" };

				int[] intArrCN = new int[] {  10,  10, 10, 40 , 10}; 
...
*/
				   ...
				   //Object datasourceRef=initContext.lookup("java:/comp/env/jdbc/asanhr1");
				    ...
				    query.append("  SELECT GUBUN, CD_GBN, DPT_CD, DPT_NM, GBN_CD FROM ASNHR.T_CM_DEPT ");
