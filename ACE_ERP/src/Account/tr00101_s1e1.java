...
public class tr00101_s1e1 extends HttpServlet {
	/**
	 * 
	 */
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (isNotOnlyHeader) {					
						...
						sql.append(" SELECT CMTYPE,CDCODE,CDNAM,CDREMARK ") ;
						sql.append(" FROM ACCOUNT.COMMDTIL " ) ; 
						sql.append(" WHERE CMTYPE ='0030' " ) ;  
						sql.append(" AND DSUDT != '20051231' " ) ;  

					
        if(str1 != null )       sql.append( " AND CDNAM LIKE '%" + str1 + "%' " ) ; 
        if(str2 != null )       sql.append( " AND CDCODE  = '" + str2 + "' " ) ; 
