...
public class H100012_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "EMPNO","EMPNMK","BCHK","PAYSEQ","DEPTCD","PAYGRD","GRDDIV","PAYSEQ2"
																				}; //9
				...
				if (!GauceReq.isBuilderRequest()) {					
                    ...
                    sql.append( "           (PAYSEQ+1) AS PAYSEQ2 \n");
