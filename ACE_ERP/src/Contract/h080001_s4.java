...
public class h080001_s4 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT ");
					sql.append( "    A.EMPNO,A.SEQ,A.LCSTYPE,A.LCSCD,A.LCSNO, ");
					sql.append( "		 RTRIM(A.GETDT) AS GETDT,A.CHGDT,RTRIM(A.ISSPART) AS ISSPART,RTRIM(A.STRDT) AS STRDT,RTRIM(A.LOSDT) AS LOSDT, ");
					sql.append( "		 A.APPYN, RTRIM(B.MINORNM) AS LCSTNM, RTRIM(C.MINORNM) AS LCSCNM ");
