...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "		 RTRIM(B.DEPTNM) AS DEPTNM, RTRIM(C.MINORNM) AS PAYGNM," );
					sql.append( "      RTRIM(D.MINORNM)AS PAYSNM, RTRIM(E.ORDNM) AS ORDNM ");
					
					//sql.append( "		 COALESCE(RTRIM(B.DEPTNM),'') AS DEPTNM, COALESCE(RTRIM(C.MINORNM),'') AS PAYGNM," );
					//sql.append( "      COALESCE(RTRIM(D.MINORNM),'') AS PAYSNM, COALESCE(RTRIM(E.ORDNM),'') AS ORDNM ");
