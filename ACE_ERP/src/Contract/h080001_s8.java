...
public class h080001_s8 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "        RTRIM(A.PAYGRD) AS PAYGRD,  RTRIM(A.GRSTRTDT) AS GRSTRTDT, RTRIM(A.LAMDT) AS LAMDT,RTRIM(A.WRDT) AS WRDT, GRADE3  \n ");
