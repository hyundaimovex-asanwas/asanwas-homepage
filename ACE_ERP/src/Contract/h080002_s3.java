...
public class h080002_s3 extends HttpServlet {
...
**********************************************************************************************/
				...
				int[] intArrCN = new int[]{  7,  2, 13, 20,  4,
																		40, 60,  4,  1,  1,
																		 1,  1,  1,  1,  1,
																		40, 40, 3
																	}; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT ");
					sql.append( "     A.EMPNO,A.SEQ,A.RESINO,A.FAMNM,RTRIM(A.REFCD) AS REFCD, ");
					...
					sql.append( "			RTRIM(B.MINORNM) AS REFNM, RTRIM(C.MINORNM) AS LSTNM, RTRIM(A.AGE) AS AGE ");
