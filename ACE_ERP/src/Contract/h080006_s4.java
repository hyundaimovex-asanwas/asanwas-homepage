...
public class h080006_s4 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "	PAYROLL.T_HOORDER B, ");
					...
					sql.append( "	FROM PAYROLL.T_HOORDER Y ");
					sql.append( "	WHERE Y.ORDDT = (SELECT MAX(X.ORDDT) ");
					sql.append( "	                 FROM PAYROLL.T_HOORDER X ");
					sql.append( "	                 WHERE X.ORDDT < (SELECT MAX(F.ORDDT) ");
					sql.append( "	                                  FROM PAYROLL.T_HOORDER F ");
					...
					sql.append( "	AND B.ORDDT = (SELECT MAX(F.ORDDT) FROM PAYROLL.T_HOORDER F WHERE F.EMPNO='"+str1+"') ");
