...
public class h080007_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "EMPNO","SEQ",
																					"RESISEQ", 
																					"RESINO","FAMNM","REFCD",
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "     A.RESINO,A.FAMNM,RTRIM(A.REFCD) AS REFCD, ");
					sql.append( "     RTRIM(A.SCHNM) AS SCHNM,RTRIM(A.CMPNM) AS CMPNM,A.LSTEDC,A.LIVEYN,A.GETYN, ");
					sql.append( "     RTRIM(A.PAYYN) PAYYN,A.DISYN,A.SPTYN,A.MEDINYN,A.EDUEXYN, ");
