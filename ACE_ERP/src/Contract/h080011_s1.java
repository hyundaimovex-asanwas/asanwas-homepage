...
public class h080011_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "	 RTRIM(A.PAYGRD) AS PAYGRD,A.PAYSEQ,RTRIM(A.ENDDT) AS ENDDT,RTRIM(A.APPDT) AS APPDT, B.EMPNMK, \n");
					sql.append( "	 '' AS REGDAT,  C.TREECD, IFNULL(D.SEQ,0) AS SEQ2,RTRIM(A.GRDDIV) AS GRDDIV, RTRIM(A.ETC) ETC \n");
