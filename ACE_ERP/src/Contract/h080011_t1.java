...
public class h080011_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				DeleteSql.append( "DELETE FROM PAYROLL.T_HOORDER WHERE EMPNO = ? AND ORDDT = ? AND SEQ = ? AND ORDCD = ? AND DEPTCD = ? " );
