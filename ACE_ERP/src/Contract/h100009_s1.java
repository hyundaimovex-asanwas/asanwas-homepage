...
public class h100009_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "  B.P11000, ");	/* 직책수당 - 상여 */
					sql.append( "  B.P30000, ");	/* 사장단수당-현장수당*/
					sql.append( "  B.P31000, ");	/* 특수지수당 - 북측근무수당*/
          ...
          sql.append( " LEFT JOIN PAYROLL.HCDEPT C ON  B.DEPTCD=C.DEPTCD ");
				  sql.append( " LEFT JOIN PAYROLL.HCLCODE D ON  B.PAYDIV=D.MINORCD AND D.MAJORCD='1120' "); /*지급구분*/
                    ...
                    if (str[2].equals("K")) 
						sql.append( " AND B.PAYDIV IN('K') ");   //지급구분
