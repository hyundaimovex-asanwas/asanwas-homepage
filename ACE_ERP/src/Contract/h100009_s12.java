...
public class h100009_s12 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " LEFT JOIN PAYROLL.T_HIPERSON A ON A.EMPNO=B.EMPNO                           			\n");
					...
					if (str[1].equals("K")) sql.append( " AND B.PAYDIV IN ('K')  ");
					sql.append( " ORDER BY C.MINORNM, A.EMPNMK ");
					
					//logger.dbg.println(this,"OK :: "+sql.toString());
