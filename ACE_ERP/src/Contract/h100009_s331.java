...
public class h100009_s331 extends HttpServlet {
...
**********************************************************************************************/
          ...
          4, // 근무지코드   
				...
				if (!GauceReq.isBuilderRequest()) {					
  				...
  				sql.append("	  (CASE WHEN B.PRTCOD='' THEN 'XXX' ELSE B.PRTCOD END) AS MINORCD,                       	 \n ");
					...
					sql.append("    SUM(B.P10000) AS P10000R, SUM(B.P11000) AS P11000R, SUM(B.P30000) AS P30000R,            \n ");
					sql.append("    SUM(B.P31000) AS P31000R, SUM(B.P12000) AS P12000R,                                      \n ");
					sql.append("   (SUM(B.P21000)+ SUM(B.P22000)+ SUM(B.P23000)+ SUM(B.P24000)+ SUM(B.P25000)+               \n ");
					sql.append("    SUM(B.P26000)+ SUM(B.P27000)+ SUM(B.P28000)+ SUM(B.P29000)+ SUM(B.P32000)+               \n ");
					sql.append("    SUM(B.P33000)+ SUM(B.P34000)+ SUM(B.P36000)+ SUM(B.P37000)+ SUM(B.P38000)+               \n ");
					sql.append("    SUM(B.P39000)+ SUM(B.P35000)+ SUM(B.PX0010)+ SUM(B.PX0020)+ SUM(B.PX0030)+               \n ");
					...
					sql.append("    SUM(B.B11000) AS B11000R, SUM(B.B12000) AS B12000R, -- 국민연금*/                        \n ");
          ...
          if (str[2].equals("T")) sql.append( " AND B.PAYDIV IN ('T') \n ");          //지급구분
					...
					sql.append("    SUM(B.P10000) AS P10000, SUM(B.P11000) AS P11000, SUM(B.P30000) AS P30000,               \n ");
					sql.append("    SUM(B.P31000) AS P31000, SUM(B.P12000) AS P12000,                                        \n ");
					sql.append("   (SUM(B.P21000)+ SUM(B.P22000)+ SUM(B.P23000)+ SUM(B.P24000)+ SUM(B.P25000)+               \n ");
					sql.append("    SUM(B.P26000)+ SUM(B.P27000)+ SUM(B.P28000)+ SUM(B.P29000)+ SUM(B.P32000)+               \n ");
					sql.append("    SUM(B.P33000)+ SUM(B.P34000)+ SUM(B.P36000)+ SUM(B.P37000)+ SUM(B.P38000)+               \n ");
					sql.append("    SUM(B.P39000)+ SUM(B.P35000)+ SUM(B.PX0010)+ SUM(B.PX0020)+ SUM(B.PX0030)+               \n ");
