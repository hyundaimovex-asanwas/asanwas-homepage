...
public class h100009_s5 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("	LEFT JOIN (                                                                                                            \n ");
					sql.append("	SELECT B.APPDT,COALESCE(SUM(B.S94000),0) AS TOTALSUM, COALESCE(COUNT(B.EMPNO),0) AS TOTALCOUNT \n ");
					sql.append("  FROM PAYROLL.PBPAY B  \n ");
					sql.append("	WHERE RTRIM(B.APPDT) <> '' \n ");
