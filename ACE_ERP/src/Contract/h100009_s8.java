...
public class h100009_s8 extends HttpServlet {
          ...
          3,
	        ...
	        0,	 /* 출납수당*/	   						   
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
                    ...
                    if (str[3].equals("K")) 
					sql.append( " AND C.PAYDIV IN ('K') \n ");   //지급구분	
						
		
				    if (str[3].equals("T")) 
					sql.append( " AND C.PAYDIV IN  ('T') \n ");   //지급구분								
            ...
            sql.append( "                0 CNT5,0 SUM5	,	0 CNT6,0 SUM6	         \n");
						...
						sql.append( "           AND E.PAYDIV  IN ('5')	 											\n");
                         ...
                         if (str[3].equals("T")) 
					   sql.append( "    AND E.PAYDIV  IN ('T') \n ");   //지급구분		
				               if (str[3].equals("K")) 
					sql.append( " AND E.PAYDIV IN ('K') \n ");   //지급구분	
                   ...
                   if (str[3].equals("T")) 
					sql.append( "     AND G.PAYDIV IN  ('T') \n ");   //지급구분					
										
						
                     if (str[3].equals("K")) 
					sql.append( " AND G.PAYDIV IN ('K') \n ");   //지급구분	
