...
public class h100010_s1 extends HttpServlet {
...
**********************************************************************************************/
        ...
        "AMT_2",   //공조회대출
          ...
          sql.append( "  A.RESINO,  ");   //주민번호
					...
					if (str[12].equals("T")) 
					sql.append( " LEFT OUTER  JOIN PAYROLL.PCWRKPAY L ON  B.APPDT = L.APPDT     AND B.PAYDIV = L.PAYDIV  AND L.PAYCD IN('T000001', 'T500000')");
