...
public class dd110_sp extends SuperServlet {
	...
	public void makeSql(){
		...
		arr_sql[1].append ("{call ASNHR.PR_DD110S_SP0(?,?,?) }" );
	...
	public void select(Connection conn, HttpGauceRequest greq, HttpGauceResponse gres) throws ServletException, Exception {
		...
		try {
			...
			for(int i=0; i<dSets.length;i++){
				...
				if(dSets[i].getName().equals("gcds_data09")){

						GauceDataSet ds1 = gis.read("gcds_data09"); 
