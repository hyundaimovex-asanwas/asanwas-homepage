...
public class ADAY030DAO extends AbstractDAO {
	/**
	 * ADAY030DAO 생성자 이며, FirstRow 기능을 지원하기 위해서는 아래와 같이
	 * Connection, TrBox객체를 이용해서 생성자를 만들어 주어야 한다.
	 * @param p_conn	Connection
	 * @param p_tr		TrBox
	 * @throws CException
	 */
	public ADAY030DAO(String p_conn, TrBox p_tr) throws CException {
		/** SuperClass의 생성자 호출 **/
		super(p_conn, p_tr);
	}
     ...
     * @throws CException
	 */
	public int ADAY030_CHK(GauceValueObject vo) throws CException {
		
	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_CHK");
     ...
     * @throws CException
     */
	public int ADAY030_CHK_01(GauceValueObject vo) throws CException {
	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_CHK_01");
     ...
     * @throws CException
     */
	public int ADAY030_CHK_02(GauceValueObject vo) throws CException {
	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_CHK_02");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("ada", "ADAY030_SHR");

		/** SQL에 바인딩 될 값을 순차적으로 넣어 준다 **/
		Object[] bind = new Object[] {
                JSPUtil.rns(p_box.get("PIS_YYMM")).replaceAll("-", ""),
                JSPUtil.rns(p_box.get("PIS_YYMM")).replaceAll("-", "")                
        };
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_01");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_02(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_02");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_03(CBox p_box) throws CException {
		...
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_03");
	 ...
	 * @throws CException
	 */
	public GauceDataSet ADAY030_SHR_04(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_04");
	 ...
	 * @throws CException
	 */
	public GauceDataSet ADAY030_SHR_05(CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_05");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_06(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_06");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_LSE(CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_LSE");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_PRINT0(CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_PRINT0");
	 ...
	 * @throws CException
	 */
	public void ADAY030_SHR_PRINT(CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_SHR_PRINT");
	 ...
	 * @throws CException
	 */
	public void ADAY030_INS(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_INS");
	 ...
	 * @throws CException
	 */
	public void ADAY030_INS_01(GauceValueObject vo, CBox p_box) throws CException {
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_INS_01");
	 ...
	 * @throws CException
	 */
	public void ADAY030_UPT(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_UPT");
     ...
     * @throws CException
     */
	public void ADAY030_UPT_01(GauceValueObject vo, CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_UPT_01");
     ...
     * @throws CException
     */
	public void ADAY030_UPT_OK(GauceValueObject vo, CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_UPT_OK");
     ...
     * @throws CException
	 */
	public void ADAY030_UPT_02(GauceValueObject vo, CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_UPT_02");
     ...
     * @throws CException
	 */
	public void ADAY030_UPT_02_NEXT(GauceValueObject vo, CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_UPT_02_NEXT");
	 ...
	 * @throws CException
	 */
	public void ADAY030_DEL(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_DEL");
     ...
     * @throws CException
	 */
	public void ADAY030_DEL_01(GauceValueObject vo, CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("aid", "ADAY030_DEL_01");
    ...
    public String PROC_CHK(CBox p_box, GauceValueObject vo) throws CException {
        ...
        /** 경공조금 신청건 **/
        String sql = "{ call ASNHR.PKG_XF_ADAY030.PROC_CHK(?, ?, ?, ?, ?, ?, ?, ?) }";
	...
	public void PROC_D(CBox p_box) throws CException {
	    ...
	    /** 경공조금 지급 처리  **/
	    String sql = "{ call ASNHR.PKG_XF_ADAY030.PROC_D(?, ?) }";
    ...
    public void PROC_E(CBox p_box) throws CException {
        ...
        /** 경공조금 지급 처리  **/
        String sql = "{ call ASNHR.PKG_XF_ADAY030.PROC_E(?, ?, ?) }";
	 ...
	 * @throws CException
	 */
	public GauceDataSet ADAY030_PRC_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_PRC_SHR_01");
	 ...
	 * @throws CException
	 */
	public GauceDataSet ADAY030_PRC_SHR_02(GauceDataSet ds) throws CException {
     ...
     * @throws CException
     */
	public void ADAY030_PRC_UPT_01(CBox p_box ) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("aid", "ADAY030_PRC_UPT_01");
     ...
     * @throws CException
     */
	public void ADAY030_PRC_MAKE_HTML(CBox p_box,GauceDataSet ds, GauceDataSet dsDecision, GauceDataSet dsFile) throws CException {
