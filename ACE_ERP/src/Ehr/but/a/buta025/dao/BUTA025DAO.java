...
public class BUTA025DAO extends AbstractDAO {

	/**
	 * BUTA025DAO 생성자 이며, FirstRow 기능을 지원하기 위해서는 아래와 같이
	 * Connection, TrBox객체를 이용해서 생성자를 만들어 주어야 한다.
	 * @param p_conn	Connection
	 * @param p_tr		TrBox
	 * @throws CException
	 */
	public BUTA025DAO(String p_conn, TrBox p_tr) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_01");
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_02(CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_SHR_03(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_03");
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_SHR_04(CBox p_box) throws CException {

		//System.out.println("==================="+p_box);		
		
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_04");
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_SHR_05(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_05");
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_PRINT(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_PRINT");
		...
		prop.add("BUT_FROM_TO", ColumnProp.COLUMN_TYPE_STRING, 50, ColumnProp.CONSTRAINT_TB_NORMAL);		
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_PRINT2(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_PRINT2");
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_PRINT3(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_PRINT3");
		...
		prop.add("APP_STATUS", ColumnProp.COLUMN_TYPE_STRING, 50, ColumnProp.CONSTRAINT_TB_NORMAL);				
	 ...
	 * @throws CException
	 */
	public void BUTA025_SHR_PRINT4(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_PRINT4");
	 ...
	 * @throws CException
	 */
	public void BUTA025_INS_01(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_INS_01");
	 ...
	 * @throws CException
	 */
	public void BUTA025_INS_02(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_INS_02");
	 ...
	 * @throws CException
	 */
	public void BUTA025_INS_03(GauceValueObject vo, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_01(CBox p_box, GauceValueObject vo, String APP_YN) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_02(CBox p_box, GauceValueObject vo) throws CException {
	...
	public void BUTA025_UPT_APP(CBox p_box) throws CException {
	...
	public void BUTA025_UPT_STA(CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_06(CBox p_box, GauceValueObject vo) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_03(CBox p_box, GauceValueObject vo) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_04(CBox p_box, GauceValueObject vo) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_SAV_DATE(CBox p_box, GauceValueObject vo) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_DILIGENCE(CBox p_box, GauceValueObject vo) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_UPT_05(CBox p_box, GauceValueObject vo) throws CException {
     ...
     * @throws CException
     */
	public void BUTA025_DEL_01(CBox p_box ) throws CException {
     ...
     * @throws CException
     */
	public void BUTA025_DEL_02(CBox p_box ) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_SHR_06(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_06");
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_SHR_06(String NEXT_ENO, String Next_msg,CBox p_box) throws CException {
	...
	public GauceDataSet BUTA025_SHR_07(String NEXT_ENO, String Next_msg,CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("but", "BUTA025_SHR_07");
	 ...
	 * @throws CException
	 */
	public void BUTA025_DIL_INS_01(String YYYY, String ENO_NO,  String DPT_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_DIL_SHR_01(String STR_YYYYMM, String END_YYYYMM, String ENO_NO, String STR_YYYYMMDD, String END_YYYYMMDD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_DIL_UPT_01(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_DIL_UPT_02(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void BUTA025_DIL_UPT_03(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet BUTA025_CNT(GauceValueObject vo) throws CException {
