...
public class CODE060DAO extends AbstractDAO {
	/**
	 * PIRA020DAO 생성자
	 ...
	 * @throws CException
	 */
	public CODE060DAO(String p_dsId, TrBox p_tr) throws CException {
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR(CBox p_box) throws CException {

		/** 외부 XML에서 급상여지급액 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR");
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 급상여지급액 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_01");
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR_02(CBox p_box) throws CException {

		/** 외부 XML에서 일반 공제 내역 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_02");
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR_03(CBox p_box) throws CException {

		/** 외부 XML에서 저축/대출 내역 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_03");
	 ...
	 * @throws CException
	 */
	public GauceDataSet CODE060_SHR_04(CBox p_box) throws CException {

		/** 외부 XML에서 작업 완료 여부 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_04");
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR_05(CBox p_box) throws CException {

		/** 외부 XML에서 급상여지급액 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_05");
	 ...
	 * @throws CException
	 */
	public void CODE060_SHR_06(CBox p_box) throws CException {

		/** 외부 XML에서 급상여지급액 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_06");

		//작업완료 여부를 조회
		GauceDataSet ds = this.CODE060_SHR_04(p_box);
	 ...
	 * @throws CException
	 */
	public void  CODE060_SHR_PRINT(CBox p_box) throws CException {


	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_PRINT");
	 ...
	 * @throws CException
	 */
	public void  CODE060_SHR_PRINT2(CBox p_box) throws CException {

		/** 외부 XML에서 저축/대출 내역 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_PRINT2");
	 ...
	 * @throws CException
	 */
	public void  CODE060_SHR_PRINT3(CBox p_box) throws CException {

		/** 외부 XML에서 급상여지급액 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("cod", "CODE060_SHR_PRINT3");
