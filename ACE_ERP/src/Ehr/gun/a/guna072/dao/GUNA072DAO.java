...
public class GUNA072DAO extends AbstractDAO {

	/**
	 * GUNA072DAO 생성자 이며, FirstRow 기능을 지원하기 위해서는 아래와 같이
	 * Connection, TrBox객체를 이용해서 생성자를 만들어 주어야 한다.
	 * @param p_conn	Connection
	 * @param p_tr		TrBox
	 * @throws CException
	 */
	public GUNA072DAO(String p_conn, TrBox p_tr) throws CException {
		/** SuperClass의 생성자 호출 **/
		super(p_conn, p_tr);
	}
	 ...
	 * @throws CException
	 */
	public void GUNA072_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_01");
	 ...
	 * @throws CException
	 */
	public void GUNA072_SHR_02(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_02");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_PLAN(CBox p_box) throws CException {
        ...
        /** 외부 XML에서 SQL을 읽어 온다 **/
        String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_PLAN_01");
     ...
     * @throws CException
     */
    public GauceDataSet  GUNA072_SHR_PLAN_01(CBox p_box) throws CException {
        String REQ_NO = JSPUtil.rns(p_box.get("REQ_NO")) ;
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT(CBox p_box, GauceValueObject vo) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_CNT(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_CNT");
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_01(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_01");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_03(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_03");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_05(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_05");
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_02(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_01");
		String COLNAME = "";
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_03(String PIS_YYMMDD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 */
	public void GUNA072_UPT_0400(CBox p_box, String APP_YN) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_0400");
	 ...
	 * T_DI_CHANGE 에 반영
	 */
	public void GUNA072_UPT_0401(CBox p_box, String APP_YN) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_0401");
	 ...
	 */
	public void GUNA072_UPT_0402(CBox p_box, String APP_YN) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_0402");
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_0403(CBox p_box, String APP_YN) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_UPT_0403");
	 ...
	 * @throws CException
	 */
	public void GUNA072_INS_01(CBox p_box, String PIS_YYMMDD) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_INS_01");
	 ...
	 * @throws CException
	 */
	public void GUNA072_INS_02(String PIS_YYMMDD, String ENO_NO, String REMARK, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_INS_02");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_PLAN_02(CBox p_box) throws CException {
		...
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_PLAN_02");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_PLAN_03(CBox p_box) throws CException {
        String dpt_cd  = p_box.get("DPT_CD");
        String REQ_NO = JSPUtil.rns(p_box.get("REQ_NO")) ;
        String YYYYMM = DateUtil.getAfterDate(REQ_NO.substring(0,8), 0,1,0);
        String YYYY   = YYYYMM.substring(0,4);
        String MM     = YYYYMM.substring(4,6);
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_PLAN_03");
	 ...
	 * @throws CException
	 */
	public void GUNA072_INS_PLAN_01(String eno_no, String dpt_cd, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_PLAN_01(String PIS_YY, String PIS_MM, String DD, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public void GUNA072_UPT_PLAN_02(String PIS_YY, String PIS_MM, String ENO_NO, String GUN_CD, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUND072_SHR_ACC_01(CBox p_box) throws CException {
		
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_02_DH");
		...
		String  mm4 = pis_mm.substring(6,8);
		String  mm5 = pis_mm.substring(8,10);
		String  mm6 = pis_mm.substring(10,12);
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUND072_SHR_ACC_02(CBox p_box) throws CException {
		String REQ_NO = JSPUtil.rns(p_box.get("REQ_NO"));
		String YYYY   = REQ_NO.substring(0,4);
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_01_DH");
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_ACC_03(CBox p_box) throws CException {
		...
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_ACC_03");
	 ...
	 * @throws CException
	 */
	public void GUNA072_INS_ACC_01(String eno_no, String dpt_cd, CBox p_box) throws CException {
	 ...
	 * @throws CException
	 */
	public GauceDataSet GUNA072_SHR_ACC_02(CBox p_box) throws CException {

        String REQ_NO = JSPUtil.rns(p_box.get("REQ_NO")) ;
        String YYYY   = REQ_NO.substring(0,4);
        
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_ACC_04");
	 ...
	 * @throws CException
	 */
	public void GUNA072_SHR_APP(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNA072_SHR_APP");
