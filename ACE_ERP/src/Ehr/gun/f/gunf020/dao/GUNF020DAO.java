...
public class GUNF020DAO extends AbstractDAO {
	/**
	 ...
	 * @throws CException
	 */
	public GUNF020DAO(String p_conn, TrBox p_tr) throws CException {
		/** SuperClass의 생성자 호출 **/
		super(p_conn, p_tr);
	}
	 ...
	 * @throws CException
	 */
	public void GUNF020_SHR(CBox p_box) throws CException {
		
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNF020_SHR");
	 ...
	 * @throws CException
	 */
	public void GUNF020_SHR_DTL(CBox p_box) throws CException {
		
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNF020_SHR_DTL");
	 ...
	 * @throws CException
	 */
	public void GUNF020_SHR_WEEK(CBox p_box) throws CException {
		
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("gun", "GUNF020_SHR_WEEK");
