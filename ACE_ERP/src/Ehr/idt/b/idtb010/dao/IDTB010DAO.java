...
public class IDTB010DAO extends AbstractDAO {
	/**
	 * IDTB010DAO 생성자 이며, FirstRow 기능을 지원하기 위해서는 아래와 같이
	 * Connection, TrBox객체를 이용해서 생성자를 만들어 주어야 한다.
	 * @param p_conn	Connection
	 * @param p_tr		TrBox
	 * @throws CException
	 */
	public IDTB010DAO(String p_conn, TrBox p_tr) throws CException {
		/** SuperClass의 생성자 호출 **/
		super(p_conn, p_tr);
	}
	 ...
	 * @throws CException
	 */
	public void IDTB010_SHR(CBox p_box) throws CException {
		...
		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_SHR");
	 ...
	 * @throws CException
	 */
	public void IDTB010_SHR_01(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_SHR_01");
	 ...
	 * @throws CException
	 */
	public void IDTB010_SHR_02(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_SHR_02");
	 ...
	 * @throws CException
	 */
	public void IDTB010_INS(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_INS");
		...
		/** SQL에 바인딩 될 값을 순차적으로 넣어 준다 **/
		Object[] bind = new Object[] {
				JSPUtil.rns(vo.get("CD_GBN")),     // 종류
				JSPUtil.rns(vo.get("ENO_NM")),     // 이름
				JSPUtil.rns(vo.get("FROM_YMD")),    // 계약시작
				JSPUtil.rns(vo.get("TO_YMD")),    // 계약종료일자
				JSPUtil.rns(vo.get("MONTH")),    // 개월수
				...
				JSPUtil.rns(vo.get("JOB_NM")),    // 직종
				JSPUtil.rns(vo.get("POS_NM")),    // 직위
	 ...
	 * @throws CException
	 */
	public void IDTB010_UPT(GauceValueObject vo, CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_UPT");
     ...
     * @throws CException
     */
	public void IDTB010_UPT_PRT(CBox p_box) throws CException {

	    /** 외부 XML에서 SQL을 읽어 온다 **/
	    String sql = XmlSqlUtils.getSQL("idt", "IDTB010_UPT_PRT");
	 ...
	 * @throws CException
	 */
	public void IDTB010_DEL(CBox p_box) throws CException {

		/** 외부 XML에서 SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("idt", "IDTB010_DEL");
