...
public class VLUO010DAO extends AbstractDAO {
    /**
     * VLUO010DAO 생성자
     ...
     * @throws CException
     */
	public VLUO010DAO(String p_dsId, TrBox p_tr) throws CException {
     ...
     * @throws CException
     */
	public void VLUO010_SHR(CBox p_box ) throws CException {

		/** 외부 XML에서 목표설정 (조회) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR");
     ...
     * @throws CException
     */
	public void VLUO010_SHR_PRT(CBox p_box ) throws CException {

		/** 외부 XML에서 목표설정 (조회) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_PRT");
     ...
     * @throws CException
     */
	public void VLUO010_SHR_00(CBox p_box ) throws CException {

		/** 외부 XML에서 개인별평가일정 정보를 조회 데이터 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_00");
     ...
     * @throws CException
     */
	public GauceDataSet VLUO010_SHR_01(CBox p_box ) throws CException {

		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_01");
     ...
     * @throws CException
     */
	public GauceDataSet VLUO010_SHR_02(CBox p_box ) throws CException {

		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_02");
     ...
     * @throws CException
     */
    public void VLUO010_SHR_01_OLD(CBox p_box ) throws CException {

        /** 외부 XML에서 목표순번 최대값  (조회) SQL을 읽어 온다 **/
        String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_01_OLD");
     ...
     * @throws CException
     */
    public GauceDataSet VLUO010_SHR_03(CBox p_box ) throws CException {

        /** 외부 XML에서 목표입력 기간 여부  (조회) SQL을 읽어 온다 **/
        String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_03");
     ...
     * @throws CException
     */
	public void VLUO010_SHR_04(CBox p_box ) throws CException {
     ...
     * @throws CException
     */
	public void VLUO010_SHR_YMD(CBox p_box ) throws CException {

		/** 외부 XML에서 평가일정 조회 SQL 읽음 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SHR_YMD");
     ...
     * @throws CException
     */
	public void VLUO010_INS(CBox p_box, GauceValueObject vo ) throws CException {

		/** 외부 XML에서 목표설정 (입력) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_INS");
     ...
     * @throws CException
     */
	public void VLUO010_SAV_01(CBox p_box,  GauceValueObject vo) throws CException {

		/** 외부 XML에서 목표설정 (입력) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_UPT_01");
     ...
     * @throws CException
     */
	public void VLUO010_SAV_011(CBox p_box) throws CException {

		/** 외부 XML에서 목표설정 (입력) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_UPT_011");
     ...
     * @throws CException
     */
	public void VLUO010_SAV_02(CBox p_box, GauceValueObject vo ) throws CException {

		/** 외부 XML에서 목표설정 (입력) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_SAV_02");
     ...
     * @throws CException
     */
	public void VLUO010_INS_01(CBox p_box, GauceValueObject vo ) throws CException {

		/** 외부 XML에서 목표설정 (입력) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_INS_01");
     ...
     * @throws CException
     */
	public void VLUO010_UPT(CBox p_box, GauceValueObject vo ) throws CException {

		/** 외부 XML에서 목표설정 (수정) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_UPT");
     ...
     * @throws CException
     */
	public void VLUO010_UPT_01(CBox p_box) throws CException {
     ...
     * @throws CException
     */
	public void VLUO010_UPT_02(CBox p_box) throws CException {

		/** 외부 XML에서 목표설정 (수정) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_UPT_02");
     ...
     * @throws CException
     */
	public void VLUO010_UPT_03(CBox p_box) throws CException {

		/** 외부 XML에서 목표설정 (수정) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_UPT_03");
     ...
     * @throws CException
     */
	public void VLUO010_DEL(CBox p_box, GauceValueObject vo) throws CException {

        //마스터삭제
		/** 외부 XML에서 목표설정 (삭제) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_DEL");
     ...
     * @throws CException
     */
	public void VLUO010_DEL_01(CBox p_box, GauceValueObject vo) throws CException {

        //마스터삭제
		/** 외부 XML에서 목표설정 (삭제) SQL을 읽어 온다 **/
		String sql = XmlSqlUtils.getSQL("vlu", "VLUO010_DEL_01");
