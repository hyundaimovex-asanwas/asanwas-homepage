...
public class KS_Em010_T2 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
        ...
        for (int i=0; i<strArrCN.length; i++) {
          ...
          /*
		         ...
		         InsertSql.append( " INSERT INTO NORTHHR.TCM315												\n" )
            ...
            logger.dbg.println(this,"TEST_INSERT");//로그남기는것
	          ...
	          /*
						...
						StringBuffer UpdateSql = new StringBuffer();
						 ...
						 UpdateSql.append( " UPDATE NORTHHR.TCM315				\n")
											.append( " SET												\n")
											.append( " FAMI_NM=?,									\n")	
											.append( " BIRTHDAY=?,								\n")	
											.append( " JOB_NM=?,									\n")	
					  	...
					  	//logger.dbg.println(this, "rows[j].getString(idx[0])::::"+rows[j].getString(idx[0]));
							...
							if(rows[j].getString(idx[3]).equals("007")){  //퇴사일 경우 계약에 반영
								...
								StringBuffer UpdateSql2 = new StringBuffer();			
								 UpdateSql2.append( " UPDATE NORTHHR.TCM300	\n")
												           .append( " SET                        \n")
											             .append( " USESTS='1', \n")
								                   .append( " END_DT='', \n")
