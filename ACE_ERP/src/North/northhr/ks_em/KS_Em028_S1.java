...
public class KS_Em028_S1 extends HttpServlet {
...
**********************************************************************************************/
        ...
        for(int i=0;i<6;i++){
				...
				String[] strArrCN = new String[]{  "HOL_DT", "EMPNO",   "EMPNMK",  
                                           			 ...
                                           			 "DAY_CD", "DAY_NM",  "DEPT_CD", "DEPT_NM",   "VEND_CD", "VEND_NM", 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	   B.VEND_CD,  E.DETAIL_NM AS VEND_NM,																	 \n");
						...
						sql.append( "	   LEFT JOIN NORTHHR.TSY010 E ON E.DETAIL =B.VEND_CD AND E.HEAD = 'KS007' AND TRIM(E.DETAIL)<>''		\n");		
						
						sql.append( "	  WHERE 1=1																				\n");
						if(!str[0].equals(""))sql.append( "	  AND B.DEPT_CD = '"+str[0]+"'					\n");
						if(!str[1].equals(""))sql.append( "	  AND B.VEND_CD = '"+str[1]+"'					\n");
