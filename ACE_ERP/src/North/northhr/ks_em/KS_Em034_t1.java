...
public class KS_Em034_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				String str1 =  req.getParameter("v_str1"); 	//휴가시작일  
				String str2 =  req.getParameter("v_str2"); 	//휴가종료일  
								
				GauceDataSet userSet = reqGauce.getGauceDataSet("USER");
         
				String[] strArrCN = new String[]{ "HOL_DT", "EMPNO",  
