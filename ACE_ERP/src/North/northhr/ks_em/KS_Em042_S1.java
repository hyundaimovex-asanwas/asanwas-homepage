...
public class KS_Em042_S1 extends HttpServlet {
...
**********************************************************************************************/
				...
				int[] intArrCN = new int[] {6, 1, 10,  30, 1, 8,
				...
				int[] intArrCN2 = new int[]{ -1, -1, -1, -1, -1, -1,				//5
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	SELECT DISTINCT B.PAY_YM,	B.PAY_GB,	A.EMPNO,	A.EMPNMK, 							\n");		
						sql.append( "				 A.SEX,	B.PAY_DT,	 	   																			\n");							
						...
						sql.append( "				 nvl(A.WORK_CD,' ')  AS WORK_CD,    														\n");		
						sql.append( "				 nvl(A.C_VEND_CD,' ') AS C_VEND_CD,    													\n");								
						sql.append( "				 nvl(A.CLASS_CD,' ') AS CLASS_CD,    														\n");													
						...
						if(!str3.equals(""))sql.append( "	  AND B.VEND_CD = '"+str3+"'      	\n");												
						sql.append( " ORDER BY A.DEPT_CD, C_VEND_CD, A.VEND_CD, D_PAY DESC, A.JOB_CD			\n");
