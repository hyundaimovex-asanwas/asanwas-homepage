...
public class P010008_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "EMPNO","EMPNMK","BCHK","PAYSEQ","DEPTCD","PAYGRD","PAYSEQ2"
																				}; //7

				int[] intArrCN = new int[]{ 7, 20, 1, 4 ,4 , 4 ,4
																	}; //7
				...
				if (!GauceReq.isBuilderRequest()) {					
                    ...
                    sql.append( "            RTRIM(A.DEPTCD) AS DEPTCD,RTRIM(A.PAYGRD) AS PAYGRD, (PAYSEQ+1) AS PAYSEQ2  \n");
