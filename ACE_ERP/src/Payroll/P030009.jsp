...
<B>id=default ,left=0,top=0 ,right=2001 ,bottom=2787 ,face='Arial' ,size=10 ,penwidth=1
	...
	<C>id='REF8_1', left=569, top=1047, right=650, bottom=1168, face='굴림', size=8, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
	...
	<C>id='REF4_1', left=742, top=1044, right=816, bottom=1165, face='굴림', size=8, bold=false, underline=false, italic=false, forecolor=#000000, backcolor=#FFFFFF</C>
