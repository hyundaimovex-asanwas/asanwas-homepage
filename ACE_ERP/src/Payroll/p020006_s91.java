...
public class p020006_s91 extends HttpServlet {
...
**********************************************************************************************/
        ...
        "B23000","COACNT","COAAMT","COJAMT","COLAMT"
          ...
          //sql.append( " CASE WHEN A.EMPNO='1990013' THEN '41' ELSE D.SEQ END SEQ2  \n " );	/* 예외처리 */
				  sql.append( "CASE WHEN A.EMPNO='1990005' THEN '548'  \n " );	/* 예외처리 */
					sql.append( "     WHEN A.EMPNO='2070031' THEN '549'  \n " );	/* 예외처리 */
					sql.append( "     ELSE D.SEQ END SEQ2,               \n " );	/* 예외처리 */
					sql.append( " X.B23000, X.COACNT, X.COAAMT, X.COJAMT, X.COLAMT  \n " );	/* 2011.03.03 추가 */
          ...
          sql.append( "		 SUM(B.P23002)P23002,    SUM(B.P23003)P23003,    SUM(B.P23004)P23004,    SUM(B.P23005)P23005,    SUM(B.P23006)P23006,  \n " );
					...
					sql.append( "		 MAX(B.PRTSEQ)SEQ,     \n " );
					sql.append( "		 SUM(B.B23000)B23000,    SUM(B.COACNT)COACNT,    SUM(B.COAAMT)COAAMT,    SUM(B.COJAMT)COJAMT,    SUM(B.COLAMT)COLAMT   \n " );
