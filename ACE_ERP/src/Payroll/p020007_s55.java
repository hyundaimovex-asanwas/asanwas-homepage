...
public class p020007_s55 extends HttpServlet {
...
**********************************************************************************************/
          ...
          sql.append("  SUM(B.B13000) AS B13000R, -- 추가  고용보험*/         \n ");
					...
					sql.append("  ORDER BY D.SEQ, D.MINORCD, D.MINORNM ) B  ");
          ...
          sql.append("  SUM(B.B13000) AS B13000,  -- 추가  고용보험*/          \n ");
					...
					sql.append("  GROUP BY D.SEQ, D.MINORCD, D.MINORNM ");
					sql.append("  ORDER BY D.SEQ, D.MINORCD, D.MINORNM ) A    \n ");

					sql.append("  ON A.MINORCD = B.MINORCD ");
          sql.append("  ORDER BY B.SEQ, B.MINORCD, B.DEPTNM ");
