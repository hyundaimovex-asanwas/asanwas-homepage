...
public class p020007_s636 extends HttpServlet {
...
**********************************************************************************************/
          ...
          4, // 근무지코드   
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("                                                               \n ");
					sql.append(" SELECT  B.SEQ, B.MINORCD, B.DEPTNM,                           \n ");
					...
					sql.append("				 COALESCE(A.B13000,0) AS DB13000, -- 추가  고용보험*/  \n ");
          ...
          sql.append("				 COALESCE(B.B13000R,0) AS DB13000R, -- 추가  고용보험*/\n ");
					...
					sql.append("					   SUM(B.B11000) AS B11000R, SUM(B.B12000) AS B12000R, SUM(B.B13000) AS B13000R, 	 \n ");
					sql.append("					  (SUM(B.P41000)+ SUM(B.P42000)+ SUM(B.T21000)+ SUM(B.T22000)+ SUM(B.T23000)+    	 \n ");
					sql.append("					   SUM(B.B14000)+ SUM(B.B15000)+ SUM(B.B16000)+ SUM(B.BX0010)+ SUM(B.BX0020)+    	 \n ");
					sql.append("					   SUM(B.BX0030)+ SUM(B.BX0040)+ SUM(B.APLAMT)+ SUM(B.APLRAT)+                  	 \n ");
					sql.append("					   SUM(B.COAAMT)+ SUM(B.COLAMT)) AS BXTOTALR ,                                   	 \n ");
					sql.append("					   SUM(B.S93000) AS S93000R, SUM(B.S94000) AS S94000R, -- 실지급액*/             	 \n ");
					...
					sql.append("					   SUM(B.P31000)+ SUM(B.P32000)+ SUM(B.P33000)+ SUM(B.P34000)+ SUM(B.P36000)+    	 \n ");
					sql.append("					   SUM(B.P37000)+ SUM(B.P38000)+ SUM(B.P39000)+ SUM(B.P35000)+ SUM(B.PX0010)+    	 \n ");
					sql.append("					   SUM(B.PX0020)+ SUM(B.PX0030)+ SUM(B.PX0040)) AS PXTOTAL, -- 기타지급합계*/    	 \n ");
					sql.append("					   SUM(B.S91000) AS S91000, SUM(B.T11000) AS T11000, SUM(B.T12000) AS T12000,    	 \n ");
					sql.append("					   SUM(B.B11000) AS B11000, SUM(B.B12000) AS B12000, SUM(B.B13000) AS B13000,   	 \n ");
					sql.append("					  (SUM(B.P41000)+ SUM(B.P42000)+ SUM(B.T21000)+ SUM(B.T22000)+ SUM(B.T23000)+    	 \n ");
					sql.append("					   SUM(B.B14000)+ SUM(B.B15000)+ SUM(B.B16000)+ SUM(B.BX0010)+ SUM(B.BX0020)+    	 \n ");
					sql.append("					   SUM(B.BX0030)+ SUM(B.BX0040)+ SUM(B.APLAMT)+ SUM(B.APLRAT)+                   	 \n ");
					sql.append("             SUM(B.COAAMT)+ SUM(B.COLAMT)) AS BXTOTAL ,                                      \n ");
					sql.append("					   SUM(B.S93000) AS S93000,  SUM(B.S94000) AS S94000, -- 실지급액*/              	 \n ");
