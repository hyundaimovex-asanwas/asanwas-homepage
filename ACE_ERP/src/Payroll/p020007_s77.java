...
public class p020007_s77 extends HttpServlet {
...
**********************************************************************************************/
          ...
          sql.append("  COALESCE(A.B13000,0) AS B13000, -- 추가 : 고용보험*/ \n ");
          ...
          sql.append("  COALESCE(B.B13000R,0) AS B13000R, -- 추가 : 고용보험*/  \n ");
          ...
          sql.append("  SUM(B.B13000) AS B13000R, -- ^^추가 : 고용보험*/      \n ");
					...
					sql.append( " AND B.DEPTCD IN( SELECT DEPTCD FROM PAYROLL.HCDEPT WHERE GROUPID='01'  AND USEYN='T' ) "); //본사

					if (str[2].equals("1")) 
					sql.append( " AND B.PAYDIV IN( '1','3','4') ");   //지급구분
					if (str[2].equals("5")||str[2].equals("6")) 
					sql.append( " AND B.PAYDIV IN( '5','6') ");   //지급구분
