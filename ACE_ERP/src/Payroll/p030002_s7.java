...
public class p030002_s7 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					StringBuffer sql = new StringBuffer();
						...
						sql.append(" (SELECT COUNT(EMPNO) FROM PAYROLL.YCINDIPN WHERE A.EMPNO=EMPNO) EMPCNT,  \n");
						...
						sql.append(" GROUP BY A.YYYY,A.EMPNO,B.EMPNMK,B.RESINO,B.CADDR01,B.CADDR02						\n");	
