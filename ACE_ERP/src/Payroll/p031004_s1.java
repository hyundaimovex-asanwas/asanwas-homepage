...
public class p031004_s1 extends HttpServlet {
...
**********************************************************************************************/
        ...
        str[0]  = req.getParameter("v_str1");   // 귀속년도
		  	...
		  	for (int s=0;s<1;s++) {
				...
				String[] strArrCN = new String[]{ "CHK","EMPNMK", "EMPNO", "DEPTCD", "DEPTNM", "APPYY"	};  
					                              
				int[] intArrCN = new int[]{ 1, 20,  7,  4,	20, 4 }; 
          ...
          sql.append(" SELECT '' CHK,  B.EMPNMK, A.EMPNO, A.DEPTCD, TRIM(C.DEPTNM)DEPTNM , A.APPYY        \n");
					sql.append("   FROM PAYROLL.YCENTRY10 A                                                         \n");
					...
					//sql.append("    AND A.EMPNO IN ('2010017','3090006')                                                  \n");
