...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append("   B.REF,			/*퇴직사유																 */            \n");
					sql.append("   RTRIM(B.REF1) REF1,  /*여권반납증										 */            \n");
					sql.append("   RTRIM(B.REF2) REF2,  /*회사신분증										 */            \n");
					sql.append("   RTRIM(B.REF3) REF3,  /*건강보험증										 */            \n");
					sql.append("   RTRIM(B.REF4) REF4,  /*기타													 */            \n");
