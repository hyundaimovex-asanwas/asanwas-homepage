...
public class p050001_t1 extends HttpServlet{
			...
			try {
				...
				for (int j = 0; j < rows.length; j++){
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						sql2 = " SELECT STDYM,GRDCD FROM PAYROLL.PWINSTBL WHERE ";
						...
						if(rs2.next()){ 
							...
							UpdateSql.append( "UPDATE PAYROLL.PWINSTBL SET " );  
							...
							InsertSql.append( "INSERT INTO PAYROLL.PWINSTBL ( " );
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE ) {
						...
						DeleteSql.append( "DELETE FROM PAYROLL.PWINSTBL WHERE STDYM = ? AND GRDCD	= ? " );
