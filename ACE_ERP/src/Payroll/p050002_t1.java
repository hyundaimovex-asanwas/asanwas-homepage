...
public class p050002_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( "INSERT INTO PAYROLL.PWINDIPN_H ( " );
				InsertSql.append( "EMPNO,APPYM,GRDCD,RESINO,STDAMT, INSAMT,MEDSNO,GETDT,LOSDT,REPDT " );
				InsertSql.append( ") VALUES( " );
				InsertSql.append( " ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ) " );

				UpdateSql = new StringBuffer();
				UpdateSql.append( "UPDATE PAYROLL.PWINDIPN_H SET  " );  
				...
				DeleteSql.append( "DELETE FROM PAYROLL.PWINDIPN_H WHERE EMPNO = ? AND APPYM	= ?" );
            ...
            /*
						sql2 = " SELECT EMPNO,APPYM,RESINO FROM PAYROLL.PWINDIPN_H WHERE ";
