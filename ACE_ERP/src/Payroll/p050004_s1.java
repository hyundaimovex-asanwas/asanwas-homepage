...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " LEFT OUTER JOIN (SELECT EMPNO,MAX(GRAYY) AS GRAYY  FROM PAYROLL.HIEDUC GROUP BY EMPNO) B ON  A.EMPNO = B.EMPNO   ");
					sql.append( " LEFT OUTER JOIN PAYROLL.HCDEPT C ON  A.DEPTCD = C.DEPTCD   ");
					sql.append( " LEFT OUTER JOIN PAYROLL.HIEDUC D ON  A.EMPNO = D.EMPNO AND D.GRAYY=B.GRAYY  ");
				//	sql.append( " LEFT OUTER JOIN PAYROLL.HIEDUC D ON  A.EMPNO = D.EMPNO AND D.STRYY=B.STRYY  ");
					...
					sql.append( " ORDER BY A.DEPTCD  ASC , A.EMPNO ASC ");
