...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "EVAYM",	 "EMPNO",	 "EMPNMK",    "DEPTCD", "DEPTNM", 
					                                             "PAYGRD", "GRDNM", "GRSTRTDT", "LRMDT",	 "WRDT",	
				...
				if (!GauceReq.isBuilderRequest()) {					
                    ...
                    sql.append( "             A.PAYGRD,  D.MINORNM AS GRDNM,     A.GRSTRTDT,  A.LRMDT,    A.WRDT,  ");
                    ...
                    sql.append( " WHERE A.EVAYM    LIKE '" + str1+"%'" );
                    sql.append( "     AND A.DEPTCD  LIKE '" + str2 +"%'");
					sql.append( "     AND A.PAYGRD  LIKE '" + str3 +"%'");
					sql.append( "     AND B.EMPNMK  LIKE '" + str4 +"%'");
