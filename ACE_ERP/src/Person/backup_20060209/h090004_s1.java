...
**********************************************************************************************/
				...
				String  str4	= req.getParameter("v_str4");	//결재자명
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " FROM PAYROLL.T_HLDUTY D ");
					sql.append( "	LEFT JOIN PAYROLL.T_HIPERSON A ON A.EMPNO  =  D.EMPNO ");
					sql.append( "	LEFT JOIN PAYROLL.T_HIPERSON B ON B.EMPNO  =  D.SGNID ");
					sql.append( "	LEFT JOIN PAYROLL.T_HIPERSON C ON C.EMPNO  =  D.AGRID ");
					...
					else if (str3.equals("B"))  {	//미결재
						sql.append( " AND SGDT is null  " ); 
					}
					else if (str3.equals("C"))  {	//결재취소
						sql.append( " AND SGDT = '99999999' "); 
					}
					
					if (!str4.equals(""))  {			//결재자명
						sql.append( " AND B.EMPNMK = '"+str4+"' "); 
					}
