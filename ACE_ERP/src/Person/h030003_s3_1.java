...
public class h030003_s3_1 extends HttpServlet {
...
**********************************************************************************************/
        ...
        if (str4==null) str4 = "";
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "     SELECT  \n");
				//	sql.append( "		  A.EMPNO,A.EMPNMK, B.MINORNM AS PAYGNM, SUBSTR(C.DEPTNM,1,20)DEPTNM,  \n");
		 		...
		 		/*
				    ...
				    if (str2.equals("S")&&str3.equals("")) sql.append( "  AND B.MEMO IN('0','20','22') \n");
				  */                                      
