...
public class h030003_s3_2 extends HttpServlet {
...
**********************************************************************************************/
        ...
        if (str4==null) str4 = "";
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT A.EMPNO,A.EMPNMK, B.MINORNM AS PAYGNM, C.DEPTNM,                       \n");
					...
					sql.append( "    AND TRIM(B.MEMO) ='0'                                                      \n");
					sql.append( "    AND A.PAYGRD BETWEEN '060' AND '120'                                       \n");
					sql.append( "    AND A.EMPNMK LIKE '" + str1 + "%'                                          \n");
					sql.append( "  ORDER BY  B.SEQ, A.GRSTRTDT                                                  \n");				
