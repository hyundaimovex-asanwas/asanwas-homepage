...
**********************************************************************************************/
          ...
          sql.append( "               CASE WHEN SUBSTR(A.EMPNO,1,1) IN ('1','2') THEN B.EMPNMK ELSE T.EMPNMK END EMPNMK ,\n");
					...
					sql.append( "               IFNULL(A.TOTAVG,0)TOTAVG, IFNULL(A.SCR1,0)SCR1,  IFNULL(A.AVG1,0)AVG1,  IFNULL(A.SCR2,0)SCR2, IFNULL(A.AVG2,0)AVG2, \n");
					sql.append( "               IFNULL(A.SCR3,0)SCR3,     IFNULL(A.AVG3,0)AVG3,  IFNULL(A.SCR4,0)SCR4,  IFNULL(A.AVG4,0)AVG4,  											\n");
