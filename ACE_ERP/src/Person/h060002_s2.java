...
public class h060002_s2 extends HttpServlet {
...
**********************************************************************************************/
          ...
          sql.append( " SELECT A.EVAYM,   A.EMPNO,  B.EMPNMK, A.DEPTCD, C.DEPTNM,                     	\n"); 
					sql.append( " 	     A.PAYGRD,  D.MINORNM AS GRDNM, B.GRSTRTDT,B.STRTDT, A.WRDT,             	\n"); 
					sql.append( "        B.LAMDT,   A.RECDIV, E.MINORNM AS RECNM,  A.JOBREF,                   	  \n"); 
					sql.append( "        D.SEQ,     B.PAYSEQ                                                  	  \n"); 
					sql.append( "   FROM PAYROLL.HVEMP_DPT A                                                    	\n"); 
					sql.append( "   LEFT JOIN PAYROLL.V_HIPERSON B ON A.EMPNO = B.EMPNO  AND B.USESTS<>'3'      	\n"); 
          ...
          sql.append( "  WHERE A.EVAYM <> ''																														\n");
					...
					sql.append( "  ORDER BY D.SEQ, B.PAYSEQ DESC, B.GRSTRTDT                                      \n");
