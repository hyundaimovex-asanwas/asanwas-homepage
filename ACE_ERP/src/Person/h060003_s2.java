...
**********************************************************************************************/
        ...
        if (str5==null ) {str5 ="";}
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( "        X.EVASEQ,X.DEPTCD, X.DEPTNM, X.STRTDT, \n" );
					sql.append( "        X.PAYGRD,X.PAYGRDNM,X.OLDEMPNOH,X.OLDEVASEQ \n" );
					sql.append( "   FROM ( \n" );
					sql.append( "         SELECT '' CHKOUT, A.EVAYM, A.EMPNOH, (B.EMPNMK)AS EMPNMKH, A.EMPNO , \n" );
					...
					sql.append( "           FROM PAYROLL.HVHEMP A \n" );
					...
					if (!str6.equals("")) sql.append( " AND CAST(A.EVASEQ  AS CHAR(1))= '" + str6 + "'  \n");
