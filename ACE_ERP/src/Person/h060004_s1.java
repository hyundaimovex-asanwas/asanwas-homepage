...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					if(str4.equals("2")){ //계약직
					
							 sql.append( "  SELECT A.EVAYM, A.EMPNO,   \n");
					     //2008.06.04 임의막음.
							 //sql.append( "         CASE WHEN A.EMPNO IN('1990091','2030008','2070005','2070006','2070026') THEN K.EMPNMK ELSE C.EMPNMK END EMPNMK,    \n");
               ...
               if (!str4.equals("")) sql.append( " AND  A.GRSREF = '"+ str4 + "' \n");
							 sql.append( "      AND SUBSTR(A.EMPNO,1,1) <> '6'                 \n");
							 sql.append( "  ORDER BY E.SEQ, INTEGER(PAYSEQ) DESC, C.GRSTRTDT                                                               \n");
              ...
              sql.append( "  SELECT A.EVAYM, A.EMPNO,                  \n");
						  ...
						  //2008.06.10 임의막음
							...
							sql.append( "        AND A.EVAYM = '" + str1 +"'                                                                            \n");
							sql.append( "        AND B.EMPNOH= '" + str2 +"'                                                                            \n");
							sql.append( "        AND A.EMPNO NOT IN('1990091','2030008','2070005','2070006','2070026') \n"); //예외처리
