...
public class h060004_t2 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( "INSERT INTO PAYROLL.HVSCORE_DPT ( EVAYM,EMPNOH,EMPNO,EVASEQ,GRPCD,DIVCD,JOBGRPH,PRTSEQ,SCR,SCRGBN) " );
				InsertSql.append( "                                 VALUES  (?,?,?,?,?,?,?,?,?,?)" );
  
				DeleteSql = new StringBuffer();
				DeleteSql.append( "  DELETE  FROM PAYROLL.HVSCORE_DPT " );
        ...
        if(rows[0].getJobType() == GauceDataRow.TB_JOB_UPDATE) {
						...
						String sql = " SELECT SUM(SCR) SCR FROM PAYROLL.HVSCORE_DPT " +
            ...
            //UPDATE
				    ...
				    UpdateSql.append( " UPDATE PAYROLL.HVEMP_DPT SET " );
            ...
            GauceStatement gsmt2 = conn.getGauceStatement(UpdateSql.toString());
				...
				logger.dbg.println(this,"7error"); 
				conn.rollback();
