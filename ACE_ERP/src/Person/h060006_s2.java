...
public class h060006_s2 extends HttpServlet {
...
**********************************************************************************************/
        ...
        if (str5==null ) {str5 ="";}
          ...
          sql.append( " SELECT X.CHKOUT, X.EVAYM,    X.EMPNOH,   X.EMPNMKH,  X.EMPNO, X.EMPNMK,          \n" );
					...
					sql.append( " FROM (                                                                           \n" );
					sql.append( "				SELECT '' CHKOUT, A.EVAYM,                                                 \n" );
					sql.append( "							A.EMPNOH,B.EMPNMK AS EMPNMKH,                                        \n" );
					sql.append( "							A.EMPNO ,C.EMPNMK AS EMPNMK,                                         \n" );
					sql.append( "							A.EVASEQ,A.DEPTCD, RTRIM(A.DEPTNM) DEPTNM, RTRIM(B.STRTDT) STRTDT,   \n" );
					sql.append( "							A.PAYGRD, RTRIM(D.MINORNM) AS PAYGRDNM,                              \n" );
					sql.append( "							A.EMPNOH AS OLDEMPNOH,A.EVASEQ AS OLDEVASEQ                          \n" );
					sql.append( "				 FROM PAYROLL.HVHEMP_DPT A                                                 \n" );
