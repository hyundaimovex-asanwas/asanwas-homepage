...
public class h060006_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( " INSERT INTO PAYROLL.HVHEMP_DPT( EVAYM,EMPNOH,EMPNO,EVASEQ,DEPTCD,DEPTNM,PAYGRD) " );
				InsertSql.append( "                                 VALUES  (?,?,?,?,?,?,?)" );
        
				UpdateSql = new StringBuffer();
				UpdateSql.append( " UPDATE PAYROLL.HVHEMP_DPT SET EMPNOH=?,EVASEQ=?, DEPTCD=?,DEPTNM=?, PAYGRD=?" );
			  UpdateSql.append( "  WHERE EVAYM = ?" );
				...
				DeleteSql.append( "  DELETE FROM PAYROLL.HVHEMP_DPT " );
