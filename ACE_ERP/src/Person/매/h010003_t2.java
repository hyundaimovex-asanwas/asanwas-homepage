...
public class h010003_t2 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( " TREECD = '99999999', " );
				...
				UpdateSql.append( " TREECD = '99999999', " );
				...
				DeleteSql.append( " TREECD = '99999999', " );
				...
				for (int j = 0; j < rows.length; j++){
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						gsmt.bindColumn(7, idxUSEYN);			
						gsmt.bindColumn(8, idxREDTAXYN);
						//gsmt.bindColumn(10, idxLEVEL);	
						gsmt.bindColumn(9, idxDEPTCD);
						gsmt.executeUpdate(); 
						gsmt.close();  
					}
