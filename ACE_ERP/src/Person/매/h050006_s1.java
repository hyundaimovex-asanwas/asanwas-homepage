...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "EMPNO","EMPNMK", "ATTDAY","ATTTIME","CLODAY",
																				  ...
																				  "TREECD","SEQ","EMPDIV"};//,"PAYGNM"}; //OVERWK->ETC
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( " RTRIM(C.DEPTNM) DEPTNM, C.TREECD, D.SEQ,A.EMPDIV																\n");
						...
						sql.append( " WHERE RTRIM(A.EMPNO)  <> ''	AND A.EMPDIV IN ('1','2')	                          \n");
						...
						if (!str2.equals("")||!str6.equals("")) {
							...
							//sql.append( " AND E.ATTDAY >= '" + str2 + "' AND E.CLODAY <= '" + str6 + "' 						  \n");
						}
						...
						sql.append( " ORDER BY ATTDAY ASC, C.TREECD ASC, D.SEQ ASC																		\n");
