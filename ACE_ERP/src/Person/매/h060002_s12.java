...
public class h060002_s12 extends HttpServlet {
...
**********************************************************************************************/
        ...
        if (str7==null ) {str7 ="";}
          ...
          sql.append( "       AND NOT EXISTS ( SELECT U.EMPNO,U.EMPNMK,U.STRTDT FROM PAYROLL.T_HIPERSON U                                 \n");
					...
					sql.append( "    AND NOT EXISTS ( SELECT W.EMPNO,W.EMPNMK,W.GRSTRTDT FROM PAYROLL.T_HIPERSON W                                \n");
					sql.append( "                      WHERE W.GRSTRTDT >( SELECT DISTINCT ((year('"+str9+"')-1)||'"+str10+"')                 \n");
					...
					sql.append( "    AND NOT EXISTS ( SELECT X.EMPNO,X.EMPNMK,X.GRSTRTDT FROM PAYROLL.HIPERSON X                                \n");
					sql.append( "                      WHERE (SUBSTR(X.GRSTRTDT,1,4)||'-'||                                                     \n");
					sql.append( "                             SUBSTR(X.GRSTRTDT,5,2)||'-'||                                                     \n");
					sql.append( "                             SUBSTR(X.GRSTRTDT,7,2))>(SELECT DISTINCT (CAST(('"+str9+"')AS DATE)- 6 MONTHS)   \n");
					sql.append( "                                                         FROM PAYROLL.HIPERSON X)                              \n");
					sql.append( "                       AND X.USESTS='1'                                                                        \n");
					sql.append( "                       AND X.EMPDIV ='6'                                                                       \n");
					sql.append( "                       AND X.RECDIV IN('7')                                                                \n");
					sql.append( "                       AND P.EMPNO = X.EMPNO                                                                   \n");
					sql.append( "                     )                                                                                         \n");
					sql.append( "                                                                                                               \n");
