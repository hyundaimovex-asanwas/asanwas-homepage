...
**********************************************************************************************/
				...
				String  str3= req.getParameter("v_str3");  //피고과자사번
				String  str4= req.getParameter("v_str4");  //차수
				String  str5= req.getParameter("v_str5");  //직급 구분 (과장이상/대리이하)
				String  str6= req.getParameter("v_str6");  //고과 구분 (업적고과/능역고과)
