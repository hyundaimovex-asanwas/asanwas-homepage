...
public class ActivityBean {
    ...
    public void List(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            String totalQuery = ("select count(*) count from asan.ceotrend where category = 'ceotrend' and isdel = '0' ");
            ...
            String listQuery = "select idx, title, content, sysimg1, sysimg2, sysimg3, regtime, hit, status from asan.ceotrend where category = 'ceotrend' and isdel = '0' ";
    ...
    public void Read(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
             ...
             * 현재 게시물 내용 보기
             */
            beans = mdao.selectQuery("select idx, title, content, img1,sysimg1, img2, sysimg2, img3, sysimg3, regtime, hit, status from asan.ceotrend where category= 'ceotrend' and isdel = '0' and idx = '" + idx + "'");
    ...
    /**
     * 관리자 ceo 동정 삭제 - Update 로 isdel = 1 삭제
     * @author : ikara
     * @2005. 10. 14
     */
