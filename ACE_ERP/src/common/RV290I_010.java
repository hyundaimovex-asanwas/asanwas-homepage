...
public class RV290I_010 extends SuperServlet {

	public void makeSql() {
		// TODO Auto-generated method stub
		for(int i=0; i<arr_sql.length; i++)
			arr_sql[i] = new StringBuffer();
			arr_sql[1].append (" {call SALES.PR_RV290I_010 (?, ?)}");
	...
	public void select(GauceDBConnection conn, GauceRequest req,
		...
		try{
			String 	COMPANY_NM		= HDUtil.nullCheckStr(req.getParameter("COMPANY_NM"));			
			String 	CUST_NM	 	= HDUtil.nullCheckStr(req.getParameter("CUST_NM"));	
			...
			while(it.hasNext()){
				...
				ds1 = req.getGauceDataSet(gauceName);
					...
					if(gauceName.equals("MASTER")){
						...
						cstmt.setString (1, COMPANY_NM);
						cstmt.setString	(2, CUST_NM);
