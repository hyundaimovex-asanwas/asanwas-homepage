...
public class thms_202_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{  
															...
															"RESULT_CP",								//
															"RESULT_AMT", "RESULT_AMT_KOR",	"REMARK"															//
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						StringBuffer sql = new StringBuffer();
								...
								sql.append( "				 A.BID_AMT,	 A.BID_AMT_PCT1,	 A.BID_AMT_PCT2,												\n");
								sql.append( "				 A.BID_AMT2,	 A.BID_AMT2_PCT1,	 A.BID_AMT2_PCT2,											\n");
								sql.append( "				 A.RESULT_CP,	IFNULL(A.RESULT_AMT,0) RESULT_AMT	, 											\n");
								sql.append( "				 A.RESULT_AMT_KOR,	 A.REMARK																			\n");
