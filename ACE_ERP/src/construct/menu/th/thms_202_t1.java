...
public class thms_202_t1 extends HttpServlet{
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{  								
															...
															"SITE_CD",	"CNST_CD", "ORD_CD",

															"ACT_AMT", "START_DT","END_DT",

															"ACT_AMT_HA", "START_DT_HA","END_DT_HA", "T_DAY"
        	...
        	if (rows[j].getJobType() ==  GauceDataRow.TB_JOB_INSERT) {
						...
						StringBuffer InsertSql = new StringBuffer();			
								...
								InsertSql.append( " INSERT INTO THMS.THMS010(                                                 \n")		
											 .append( "SITE_CD,  CNST_CD, ORDER_CD, 											\n" )	
											 .append( "ACT_AMT, START_DT, END_DT, 												\n" )	
											 .append( "ACT_AMT_HA, START_DT_HA, END_DT_HA, T_DAY )					\n" )	
											 .append( " VALUES																					\n" )
											 .append( " (?,?,?,?,?,?,?,?,?,?)																\n" );//2
