...
public class thms_303_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String  str3	= req.getParameter("v_str3"); if (str3 == null) { str3 = ""; }				//업체명
				String  str4	= req.getParameter("v_str4"); if (str4 == null) { str4 = ""; }				//입찰일자fr
				String  str5	= req.getParameter("v_str5"); if (str5 == null) { str5 = ""; }				//입찰일자to
				String  str6	= req.getParameter("v_str6"); if (str6 == null) { str6 = ""; }				//추천부서
				String  str7	= req.getParameter("v_str7"); if (str7 == null) { str7 = ""; }				//입찰구분
				...
				String[] strArrCN = new String[]{  
															...
															"BID_NUM", "BID_STYLE", "SITE_CD", "SITE_NM",  "CNST_CD", "CNST_NM",
				...
				int[] intArrCN = new int[] {   20, 3, 10, 30, 10, 30,
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	SELECT  A.BID_NUM, A.BID_STYLE,	A.SITE_CD,																							\n");
					...
					if(!str1.equals(""))sql.append( "	  AND A.SITE_CD =		'"+str1+"'	 AND 	B.SITE_CD =		'"+str1+"'							\n");
					if(!str2.equals(""))sql.append( "	  AND A.CNST_CD =		'"+str2+"'	 AND 	B.CNST_CD =	'"+str2+"'							\n");
					if(!str3.equals(""))sql.append( "	  AND B.BID_COM =		'"+str3+"'																				\n");
					if (!str4.equals("")&&!str5.equals(""))sql.append( "AND A.BID_DAY BETWEEN '"+str4+"' AND '"+str5+"'						\n");
					if(!str6.equals(""))sql.append( "	  AND A.RECO_CD =		'"+str6+"'																				\n");
					if(!str7.equals(""))sql.append( "	  AND A.BID_STYLE =		'"+str7+"'																		\n");
