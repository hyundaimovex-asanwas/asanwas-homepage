...
public class thms_303_s3 extends HttpServlet {
...
**********************************************************************************************/
				// 웹페이지에서 조건값을 넘겨받음
				String  str1	= req.getParameter("v_str1"); if (str1 == null) { str1 = ""; }				//업체코드
				...
				String[] strArrCN = new String[]{   "COOP_CD",	"COOP_NM",		"COOP_YYMM", "COOP_VGB",
					
																	"COOP_CERT",		"COOP_DIRECT",		
																		
																	"ADDRESS",		"COOP_STYLE",		"CREAT_DT",		//8
				...
				int[] intArrCN = new int[] {   10, 50, 10, 1, 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	SELECT  COOP_CD,			COOP_NM,   		COOP_YYMM,	COOP_VGB,								\n");
						sql.append( "				 COOP_CERT, 		COOP_DIRECT,																			\n");
						sql.append( "				 ADDRESS, 			COOP_STYLE,	 CREAT_DT,														\n");
						sql.append( "				 LICENSE1, 			IFNULL(CON_CAPA1,0) CON_CAPA1,											\n");
						sql.append( "				 LICENSE2, 			IFNULL(CON_CAPA2,0) CON_CAPA2,											\n");
						sql.append( "				 LICENSE3, 			IFNULL(CON_CAPA3,0) CON_CAPA3,											\n");
