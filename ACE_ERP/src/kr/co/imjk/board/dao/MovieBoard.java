 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MovieBoard extends DAOHome{
	...
	public int  getTotalCount(String part, String keyword) throws  DbException , Exception  { 
        ...
        sql.append(" WHERE BOARD_TYPE='10' ");
        sql.append(subSql);
        /*
        sql.append(" SELECT   \n");
		sql.append("   count(*)  \n");
		...
		sql.append("     FROM TBRD_BOARD_MA  WHERE BOARD_TYPE = '10'  \n");
		sql.append(subSql);
		sql.append(" ) A,(  \n");
    ...
    public Tbrd_board_ma_bean[] getList(int rowsPerPage, int requestedPage, String part, String keyword ) throws  Exception{
       ...
       //SQL
		...
		sql.append(" ) B   \n");
		sql.append(" WHERE A.BOARD_SEQ = B.BOARD_SEQ(+)   \n");
		sql.append(" AND A.BOARD_TYPE='10'  \n");
		sql.append(subSql);
    ...
    /**  
     * 동영상 게시판의  현재 게시물과 이전,이후 게시물의 목록
