...
/*******************************************************************
    ...
    프로퍼티 파일 Loding
    Default 는 /WEB-INF/classes/imjkmd.properties
********************************************************************/
    Properties getResource(String name) throws IOException {
        InputStream is=getClass().getResourceAsStream("/"+name+".properties");
        if (is!=null) {
...
****************************************************************************/
    ...
    public String getProperty(String systemName,String key) throws IOException {
