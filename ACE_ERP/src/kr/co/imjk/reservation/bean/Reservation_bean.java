...
public class Reservation_bean{
	...
	private String confirm_yn; //확정여부(콜센터확인)
    private int cnt;
    ...
    private String depart_time;	//출경시간
    private String arrive_time;	//입경시간
	...
	private int m_rsv_sid ;  //방장 예약 SID
    private String rsv_sid_multi ;  //예약 SID (다중결제일경우)
    private String saup_sid;			//사업장ID - 1:금강산, 2:개성
    private String weekend_yn;		//주말여부
    private String foreigner_cd;	//내-외국인코드
	...
	private String room_type_str; //객실타입str
	...
	private String pay_amt_multi; //(다중결제일경우)
	...
	private String dup_yn = "";		//중복여부	2009-02-23
	private String spa_yn = "";		//온천당첨	2009-03-06	
	...
	// STTER
	public void setForeigner_cd(String foreigner_cd) {
		this.foreigner_cd = foreigner_cd;
	}
	...
	public void setM_rsv_sid(int m_rsv_sid) {
			this.m_rsv_sid = m_rsv_sid;
	}
	...
	public void setSpa_yn(String spa_yn) {
		this.spa_yn = spa_yn;
	}
	...
	public String getConfirm_yn() {
			return Util.getString(this.confirm_yn, "");
	}
    public int getCnt(){
        return cnt;
    } 
	...
	public String getPay_date() {
		return Util.getString(this.pay_date, "");
	}
	public String getCard_no() {
		return Util.getString(this.card_no, "");
	}
	public String getAgree_no() {
		return Util.getString(this.agree_no, "");
	}
	public String getBank_nm() {
		return Util.getString(this.bank_nm, "");
	}
	public String getBank_acct() {
		return Util.getString(this.bank_acct, "");
	}
	public String getDup_yn() {
		return Util.getString(this.dup_yn, "");
	}

	public String getSpa_yn() {
		return Util.getString(this.spa_yn, "");
	}
