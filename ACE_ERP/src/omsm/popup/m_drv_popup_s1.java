...
public class m_drv_popup_s1 extends SuperServlet {
	private static final long serialVersionUID = 1L;
	
	public void makeSql() {
		for(int i=0; i<arr_sql.length; i++)
			arr_sql[i] = new StringBuffer();
		    arr_sql[0].append (" SELECT DRV_ID,DRV_NAME,BIRTH_DATE,DRV_PHONE,DRV_USE \n");
		    arr_sql[0].append ("        ,DRV_CLOSE_DATE,REMARK,WORK_CD \n");
		    arr_sql[0].append ("        ,CREATE_ID,CREATE_DATE,UPDATE_ID,UPDATE_DATE \n");
		    arr_sql[0].append ("   FROM OMS.T_AL0030 \n");
		    arr_sql[0].append ("  WHERE DRV_NAME LIKE ? \n");		
 	}
