...
public class Pu060S extends SuperServlet {
	...
	public void makeSql(){
		...
		//마스터 조회
		arr_sql[0].append ("{call PMS.PR_PU060S_01(?,?,?,?,?     ,?) }" );

		//TENDER 조회
		arr_sql[1].append ("{call PMS.PR_PU060S_02(?,?,?) }" );

		//DETAIL 조회
		arr_sql[2].append ("{call PMS.PR_PU060S_03(?,?,?) }" );
