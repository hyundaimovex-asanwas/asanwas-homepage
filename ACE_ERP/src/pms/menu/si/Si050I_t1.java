...
public class Si050I_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		*************************************************************************************/
		...
		/************************************************************************************
		 @ PMS.TSI010 및  ACCOUNT.ASTTAXMST 에 UPDATE 처리 
		************************************************************************************/
		 ...
		 if (userSet7 != null) {
				...
				int idx7INOUT_SID       = userSet7.indexOfColumn("INOUT_SID");
				...
				UpdateSql7.append( " UPDATE PMS.TSI010 SET " );
				UpdateSql7.append( "               FDCODE =?" );
			    UpdateSql7.append( "              ,FSDAT = ?" );
			    UpdateSql7.append( "              ,FSNBR = ?" );
				UpdateSql7.append( "  WHERE INOUT_SID=?" );
				...
				for (int b=0;b<rows7.length;b++){
					...
					gsmt7.bindColumn(4,idx7INOUT_SID);
