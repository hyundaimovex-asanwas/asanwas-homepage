...
public class Si110I extends SuperServlet {
	...
	public void apply(Connection conn, HttpGauceRequest greq, HttpGauceResponse gres)  throws ServletException, Exception {
		...
		try{
			...
			if (ds_detail1 != null) {
				...
				int colNm_bp_job		= ds_detail1.indexOfColumn("bp_job");
				...
				for(int i=0; i<rows.length; i++){
					...
					StringUtil.printMsg("colNm_bp_job",rows[i].getString(colNm_bp_job),this);
					...
					*/
					...
					cstmt.setString(4, rows[i].getString(colNm_bp_job));		//직종 20140623
					cstmt.setInt(5, rows[i].getInt(colNm_bid_sid));
					cstmt.setInt(6, rows[i].getInt(colNm_commit_cnt));
