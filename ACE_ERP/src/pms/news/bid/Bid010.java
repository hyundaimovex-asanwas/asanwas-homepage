...
public class Bid010 extends SuperServlet {
	...
	public void makeSql(){
		for(int i=0; i<arr_sql.length; i++)
			arr_sql[i] = new StringBuffer();
				...
				//	default 조회
				arr_sql[1].append ("{call PMS.PR_NEW_BID010_01(?,?,?,?,?)}");
				
				
				
				// bid011.jsp Detail 조회
				arr_sql[2].append ("{call PMS.PR_NEW_BID010_02(?,?,?)}");
				

				
				//	insert/update 쿼리
				arr_sql[4].append ("{call PMS.PR_NEW_BID010_03(?,?,?,?)}");
