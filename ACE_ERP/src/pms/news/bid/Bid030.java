...
public class Bid030 extends SuperServlet {
	...
	public void makeSql(){
		for(int i=0; i<arr_sql.length; i++)
			arr_sql[i] = new StringBuffer();
				...
				//	default 조회
				arr_sql[1].append ("{call PMS.PR_NEW_BID030_01(?,?,?,?)}");
				
				
				
				// bid031.jsp Detail 조회
				arr_sql[2].append ("{call PMS.PR_NEW_BID030_02(?,?,?)}");
				

				
				//	insert/update 쿼리
				arr_sql[3].append ("{call PMS.PR_NEW_BID030_03(?,?,?,?)}");
