...
public class Itm030 extends SuperServlet {
	...
	public void makeSql(){
		...
		for(int i=0; i<arr_sql.length; i++)
			...
			arr_sql[i] = new StringBuffer();
				...
				//ds_default 조회
				arr_sql[1].append ("{call PMS.PR_NEW_ITM030S_01(?,?,?,?)}");
				

				//ds_default 저장
				arr_sql[2].append ("{call PMS.PR_NEW_ITM030S_02(?,?,?,?,?,?,?,?,?,?,?,?)}");
