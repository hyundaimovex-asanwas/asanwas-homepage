...
public class Rq041 extends SuperServlet {
	...
	public void makeSql(){
		for(int i=0; i<arr_sql.length; i++)
			...
			arr_sql[i] = new StringBuffer();
				...
				arr_sql[0].append ("{call PMS.PR_NEW_RQ040S_01(?,?) }" );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void init(Connection conn, HttpGauceRequest greq, HttpGauceResponse gres)  throws ServletException, Exception {
		...
		try {
            ...
            int v_site_sid 					= HDUtil.nullCheckNum(greq.getParameter("v_site_sid"));			// 협력사
            String v_project 				= HDUtil.nullCheckStr(greq.getParameter("v_project"));			// 협력사
