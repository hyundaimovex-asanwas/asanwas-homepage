...
public class bm020i_s01 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			...
			try {
				...
				sql.append( "			CASE WHEN T3.COUNTRY_GU IN ('10') THEN	\n" );
				sql.append( "			                S1.ADDRESS1 || ' ' ||   LEFT(S1.ADDRESS2, LENGTH(S1.ADDRESS2) - POSSTR(S1.ADDRESS2, ' '))	\n" );
				sql.append( "			          ELSE	\n" );
				sql.append( "			               T3.ADDRESS1	 	\n" );
...
//				sql.append( "         'F' AS CHK															\n" );
//				sql.append( "         CASE IFNULL(M1.SN_YN, 'F')  = 'F' THEN 'F' ELSE 'T' END CHK	\n" );
				sql.append( "         IFNULL(M1.SN_YN, 'F') AS CHK							\n" );
				...
				//logger.dbg.println("bm020i_s01", sql.toString());
