...
public class bm022i_t01 extends HttpServlet{
				...
				for (int j = 0; j < rows.length; j++){
					...
					if (rows[j].getJobType() ==  GauceDataRow.TB_JOB_UPDATE) {
						...
						UpdateSql.append( " UPDATE SALES.TCM040																		\n" )
										.append( "		 SET LSTAY_REGI=?, U_EMPNO=?, U_DATE=CURRENT TIMESTAMP	\n" )
						...
						gsmt.bindColumn(1,  idx[1]);	//LSTAY_REGI
