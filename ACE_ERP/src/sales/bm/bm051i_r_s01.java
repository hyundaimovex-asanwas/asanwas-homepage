...
public class bm051i_r_s01 extends HttpServlet {
		...
		try {
			...
			try {
				...
				String[] strArrCN = new String[]{
											    	"CUST_SID",	"CLIENT_NM",	"TEAM_NM",	"WORK_NO",	"CUST_NM"
													};
				...
				//logger.dbg.println("bm051i_r_s01",sql.toString());
