...
public class bm055i_t02 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
			    ...
			    String  str1	= reqGauce.getParameter("v_str1");	//gs_date
			    String  str2	= reqGauce.getParameter("v_str2");	//CUST_SID
			    String  str3	= reqGauce.getParameter("v_str3");	//gusrid
				...
				for (int j = 0; j < rows.length; j++){
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE) {
						...
						UpdateSql.append( " UPDATE SALES.TCM100																	\n" )
										 .append( "		 SET RT_DATE='"+str1+"', CUST_SID='"+str2+"',						\n" )
										 .append( "				U_EMPNO='"+str3+"', U_DATE=CURRENT TIMESTAMP		\n" )
										 .append( "	WHERE RT_SID=?                                                                      " );
