...
public class cm013i_t01 extends HttpServlet{
...
//					logger.dbg.println(this, "i:::" +i+"::::"+idx[i]);
				...
				*********************************************************************************/   
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						InsertSql.append( " INSERT INTO SALES.TCM170 (															\n" )
									 .append( "		   CARNO_SID, ACCI_DATE, ACCI_TIME, ACCI_PLACE, WORK_NO,	\n" )
									 .append( "			ACCI_CONTENT, ACCI_FU, I_EMPNO, I_DATE							\n" )
									 .append( "	) VALUES (																						\n" )
				...
				if(rows[j].getJobType() == GauceDataRow.TB_JOB_UPDATE) {
					...
					UpdateSql.append( " UPDATE SALES.TCM170																													\n" )
									 .append("			SET ACCI_DATE=?, ACCI_TIME=?, ACCI_PLACE=?, WORK_NO=?,												\n" )
									 .append("				ACCI_CONTENT=?, ACCI_FU=?, U_EMPNO=" + userid + " , U_DATE=CURRENT TIMESTAMP		\n" )
