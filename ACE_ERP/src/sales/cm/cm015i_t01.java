...
public class cm015i_t01 extends HttpServlet{
...
//				logger.dbg.println(this,"step1");//로그남기는것
				String[] strArrCN = new String[]{
													"REPAIR_SID",				"CARNO_SID",				"CUST_SID",					"RR_DATE",					"WH_DATE",
													"OWH_DATE",				"REPAIR_FEE",				"REPAIR_CAUSE",			"REPAIR_CONTENT1",		"REPAIR_CONTENT2",
													"REPAIR_CONTENT3",		"REPAIR_CONTENT4",		"REPAIR_CONTENT5",		"CALC_YN"
													};
...
//					logger.dbg.println(this, "i:::" +i+"::::"+idx[i]);
				...
				*********************************************************************************/   
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						InsertSql.append( " INSERT INTO SALES.TCM190 (																										\n" )
									 .append( "		    CARNO_SID, CUST_SID, RR_DATE, WH_DATE, OWH_DATE,													\n" )
									 .append( "		    REPAIR_FEE, REPAIR_CAUSE, REPAIR_CONTENT1, REPAIR_CONTENT2,									\n" )
									 .append( "			REPAIR_CONTENT3, REPAIR_CONTENT4, REPAIR_CONTENT5, CALC_YN, I_EMPNO, I_DATE		\n" )
									 .append( "	) VALUES (																																	\n" )
									 .append( "			?, ?, ?, ?, ?, ?, ?, ?, ?,																											\n" )
				...
				if(rows[j].getJobType() == GauceDataRow.TB_JOB_UPDATE) {
					...
					UpdateSql.append( " UPDATE SALES.TCM190																														\n" )
									 .append("			SET CUST_SID=?, RR_DATE=?, WH_DATE=?, OWH_DATE=?,														\n" )
									 .append("				REPAIR_FEE=?, REPAIR_CAUSE=?, REPAIR_CONTENT1=?,															\n")
									 .append("			    REPAIR_CONTENT2=? , REPAIR_CONTENT3=?, REPAIR_CONTENT4=?, REPAIR_CONTENT5=?,		\n")
									 .append("			    CALC_YN=?, U_EMPNO=" + userid + " , U_DATE=CURRENT TIMESTAMP										\n" )
									 .append("	WHERE REPAIR_SID="+str1+"																													" );
					//logger.dbg.println(this,UpdateSql.toString());//로그남기는것
					GauceStatement gsmt = conn.getGauceStatement(UpdateSql.toString());

					gsmt.setGauceDataRow(rows[j]);
//logger.dbg.println(this,"::" + rows[j].getString(idx[13]) + "::");
