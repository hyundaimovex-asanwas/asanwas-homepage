...
**********************************************************************************************/
        ...
        for(int i=0;i<=5;i++){
				...
				String[] strArrCN = new String[]{  "EMPNO","EMPNMK", "ATT_DT", "CUST_SID",
                                           ...
                                           "CHK", "I_EMPNO","U_EMPNO","I_DATE","U_DATE", "JOB_CD","SKILL_CD","JOB_NM","SKILL_NM"                                 
																		  	}; //
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	   LEFT OUTER JOIN SALES.TSY010 G ON RTRIM(G.DETAIL) = RTRIM(A.WORK_CD)  AND G.HEAD='CM014' AND RTRIM(G.DETAIL)<>''   \n");
