...
public class Em022_T extends HttpServlet{
...
*********************************************************************************/   
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_INSERT) {
						...
						InsertSql.append( " INSERT INTO SALES.TCM430                       \n" )
										 .append( " (EMPNO,YYYYMM,CUST_SID,VEND_CD,DEPT_CD,        \n" )//PK EMPNO
										 .append( " TEAM_CD,WORK_CD,TELUBO_PAY,TELSAVE_PAY,REMARK, \n" )
...
*********************************************************************************/
         	...
         	if (rows[j].getJobType() ==  GauceDataRow.TB_JOB_UPDATE) {
						 ...
						 UpdateSql.append( " UPDATE SALES.TCM430      \n")
											.append( " SET                      \n")
											.append( " VEND_CD=?,               \n")
											.append( " DEPT_CD=?,               \n")
											.append( " TEAM_CD=?,               \n")
...
*********************************************************************************/
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE) {
						  ...
						  DeleteSql = new StringBuffer();
							DeleteSql.append( " DELETE  FROM SALES.TCM430		\n")
											 .append( "	WHERE EMPNO=?								\n")
                       .append( " AND YYYYMM=?                \n");
