	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
        ...
        for (int i=0; i<strArrCN.length; i++) {
           ...
           /*********************************************************************************************/
						...
						UpdateSql9.append("         PAY_SUM = BASIC_TOT+O_TIME_TOT+RET_PAY+SEN_PAY+AIR_PAY+B20_PAY+BON_PAY+LST_PAY,   \n" );
						UpdateSql9.append("         DEDUCT_SUM =TEL_PAY+ADV_PAY+TELUBO_PAY+TELSAVE_PAY+ETC_PAY,  \n" );
						UpdateSql9.append("         REAL_PAY_SUM =BASIC_TOT+O_TIME_TOT+RET_PAY+SEN_PAY+AIR_PAY+B20_PAY+BON_PAY+LST_PAY-(TEL_PAY+ADV_PAY+TELUBO_PAY+TELSAVE_PAY+ETC_PAY)  \n" );
