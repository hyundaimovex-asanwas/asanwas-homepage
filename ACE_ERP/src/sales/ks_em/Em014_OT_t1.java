...
public class Em014_OT_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
        ...
        //String strEndymd=strATT_DT.substring(0,6)+"31";      //출역년월의 마지막날 - 입사일과 비교
				...
				String[] strArrCN = new String[]{ "EMPNO",     "ATT_DT",  "WORK_GB", "O_TIME_TOT","O_NTIME"
           ...
           /**********************************************
            일자별생성
					 **********************************************/
					 ...
					 InsertSql.append( " UPDATE SALES.TCM350 SET   WORK_GB =?, O_TIME_TOT=?,  O_NTIME=?                \n" )
										.append( "  WHERE EMPNO =?                             \n" )
						        .append( "    AND ATT_DT =?                            \n" );
