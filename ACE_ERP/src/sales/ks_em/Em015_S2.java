...
public class Em015_S2 extends HttpServlet {
...
**********************************************************************************************/
        ...
        for(int i=0;i<7;i++){
				...
				String[] strArrCN = new String[]{  "EMPNO",   "EMPNMK",  "YYYY",   "SEQ",    "CUST_SID",
                                           ...
                                           "H_YN",    "SEQ2",    "CHK",    "REWARD_YM",   "BON_YM", "BACK_GB", "ORG_BON_YM",
					                                 "I_EMPNO", "I_DATE",  "U_EMPNO","U_DATE", "CON_YEARNM", "SSTART_DT"                                
																		  	}; //
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	        A.H_YN,    IFNULL(A.SEQ2,0) SEQ2, '' CHK,    A.REWARD_YM,   A.BON_YM, A.BACK_GB, A.ORG_BON_YM, \n");
						sql.append( "	        A.I_EMPNO, A.I_DATE,  A.U_EMPNO, A.U_DATE,   E.DETAIL_NM AS CON_YEARNM, B.START_DT AS SSTART_DT \n");
						...
						sql.append( "	   LEFT JOIN SALES.TCM345 F ON F.EMPNO =A.EMPNO AND F.SEQ = A.SEQ2 \n");
						sql.append( "	   LEFT JOIN SALES.TSY010 E ON E.DETAIL =F.CON_YEAR AND E.HEAD = 'CM017' AND TRIM(E.DETAIL)<>''\n");
