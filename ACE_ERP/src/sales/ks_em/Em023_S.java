...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "PAY_YM",  "PAY_DIV",   "EMPNO",  "EMPNMK",     "START_DT",
                                          ...
                                          "REAL_PAY_SUM", "PASS_NO","SEX",  "JOB_CD",     "JOB_NM",     
					                                ...
					                                "CHGYMD", "RO_TIME","HO_TIME","HO_DAY" ,"SKILL_CD",
					                                "CON_YEAR"
																			}; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "					IFNULL(B.END_DT,'') AS END_DT, B.AGENCY_CD, ( A.H_DAY+A.H_DAY2)H_DAY,  A.W_DAY1, A.W_DAY2,    \n");
						...
						sql.append( "					SUBSTR(A.PAY_YM,5,2)||'월 급여명세서( '||SUBSTR(REPLACE(CHAR((CAST(SUBSTR(A.PAY_YM,1,4)||'-'||SUBSTR(A.PAY_YM,5,2)||'-01' AS DATE) - 1 MONTH ) ,ISO),'-',''),5,2)||'월분 )' MM,           \n");
						sql.append( "					(W_DAY1+W_DAY2)W_DAY,            \n");	
						sql.append( "         E.DETAIL_NM AS DEPT_NM, F.DETAIL_NM AS TEAM_NM, G.DETAIL_NM AS WORK_NM,                                   \n");
						sql.append( "         B.CHGYMD, A.RO_TIME, A.HO_TIME, (A.HO_DAY+A.HO_DAY2) HO_DAY , A.SKILL_CD, B.CON_YEAR                             \n");
						...
						sql.append( "	ORDER BY B.START_DT,  B.EMPNMK                 \n");
