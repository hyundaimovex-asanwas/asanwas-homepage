...
public class KS_Em023_t2 extends HttpServlet{
...
/*
					 ...
					 .append( " "+rows[j].getDouble(idx[12])+",\n" )
					 .append( " "+rows[j].getDouble(idx[13])+",\n" )
					 .append( " "+rows[j].getDouble(idx[14])+",\n" )
					 .append( " '"+rows[j].getString(idx[15])+"',\n" )
					 .append( " '"+rows[j].getString(idx[16])+"',\n" )
					 .append( " '"+rows[j].getString(idx[17])+"',\n" )
					 .append( " '"+rows[j].getString(idx[18])+"',\n" )
					 .append( " '"+rows[j].getString(idx[19])+"',\n" )
					 .append( " '"+rows[j].getString(idx[20])+"',\n" )
					 .append( " '"+rows[j].getString(idx[21])+"',\n" )
					 .append( " '"+rows[j].getString(idx[22])+"',\n" )
					 .append( " '"+rows[j].getString(idx[23])+"',\n" )
					 .append( " "+rows[j].getDouble(idx[24])+",\n" )
					 .append( " "+rows[j].getDouble(idx[25])+",\n" )
					 .append( " "+rows[j].getDouble(idx[26])+",\n" )
					 .append( " "+rows[j].getDouble(idx[27])+",\n" )
					 .append( " "+rows[j].getDouble(idx[28])+",\n" )
					 .append( " "+rows[j].getDouble(idx[29])+",\n" )
					 .append( " "+rows[j].getDouble(idx[30])+",\n" )
					 .append( " '"+rows[j].getString(idx[31])+"',\n" )
					 .append( " CURRENT TIMESTAMP,				\n" )					 
					 .append( " '"+rows[j].getString(idx[33])+"',\n" )		
					 .append( " CURRENT TIMESTAMP)				\n" );	
...
/*				 
					 InsertSql.append( " INSERT INTO SALES.KST100(                                                     \n" )										
										 ...
										 .append( "E_H,            T_H,            G_H,							\n" )           					
										 .append( "I_EMPNO,    I_DATE,       U_EMPNO,   U_DATE     )                          \n" )										
										.append( " SELECT   '"+str2+"' AS ATT_DT, A.EMPNO,   A.VEND_CD,  A.DEPT_CD,    \n" )
										.append( "  A.JOB_CD,   A.WORK_CD,  A.C_VEND_CD,  A.CLASS_CD, 				\n" )										
										.append( "  '' AS WEEK_GB, '' AS WORK_GB, ''  SAYU_GB,''  MODI_YN,			 \n")										
										.append( "  '0' M_PAY, '0'  D_PAY, '0'  T_PAY,                      \n" )         									                                
										.append( "  '' A_TM, ''  L_TM, ''  E_TM, ''  G_TM, ''  R_TM,     \n" )                           				
										.append( "  '' FINI_GB,    ''  C_A_TM,    ''  C_L_TM,   ''   C_E_TM,      \n" )                             				 
										.append( "  '0' M_H,          '0'  A_H,         '0'   O_H,       '0'     N_H,      \n" )                                   				 
										.append( "  '0' E_H,          '0'   T_H,         '0'    G_H,			\n" )										
										.append( "        '"+str3+"' , CURRENT TIMESTAMP,'"+str3+"',CURRENT TIMESTAMP    \n" )										
										.append( "   FROM SALES.KST010 A                                                         \n" )										
										.append( "  WHERE  A.EMPNO = '"+str3+"'                                              \n" );
