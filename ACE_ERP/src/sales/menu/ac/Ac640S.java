...
public class Ac640S extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[1].append("{call SALES.PR_AC640S_01(?,?,?,?,?,?)}");
	}
	...
	public void select(GauceDBConnection conn, GauceRequest req,
		...
		String sSalDamSid = HDUtil.nullCheckStr(req.getParameter("sSalDamSid")); 	// 영업담당자
		
		StringUtil.printMsg("사업소 sss",sSaup_sid+"",this);
