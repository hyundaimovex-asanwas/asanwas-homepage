...
public class bm027i_r_s01 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			...
			try {
				...
				String  str2	= GauceReq.getParameter("v_str2"); //사업자번호
				...
				String[] strArrCN = new String[]{
												    	"CUST_SID",	"POSITIONS",	 	"WORK_NO",	"CUST_NM"
																};
