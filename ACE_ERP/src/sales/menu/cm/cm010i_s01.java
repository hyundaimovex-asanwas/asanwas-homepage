...
public class cm010i_s01 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			...
			try {
				...
				String  str1	= GauceReq.getParameter("v_str1"); //차량번호
				String  str2	= GauceReq.getParameter("v_str2"); //차대번호
				...
				//logger.dbg.println("cm010i_s01",sql.toString());
