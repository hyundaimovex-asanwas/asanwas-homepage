...
public class Cq540I extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[1].append("CALL SALES.PR_CQ540I_01(?,?,?)"); // 조회
		arr_sql[2].append("CALL SALES.PR_CQ540I_02(?,?,?,?,?	,?,?)");	// 저장
	}
...
//			 iParamIp = "CQ540I IP".substring(0,13);	
//		}
