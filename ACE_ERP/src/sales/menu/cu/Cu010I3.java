...
public class Cu010I3 extends SuperServlet{
	...
	public void makeSql(){
		...
		arr_sql[2].append ("SELECT 																										\n")
				  ...
				  .append ("   ,T1.FIRST_NM  ,T1.LAST_NM,T1.HEIGHT				\n")//18
				  .append ("   ,T2.CLIENT_NM 	         				          			\n")
		...
		//고객정보 등록  
			  arr_sql[5].append ("INSERT INTO SALES.TCU010 (								\n")
						...
						.append (",PASS_TYPE		  	,REGI_YN_T     	 , REGI_YN          	\n")//11
						.append (",CLIENT_SID			,COUNTRY_GU		,GROUP_CD			\n")//14
						.append (",FIRST_NM			,LAST_NM	,HEIGHT		\n")//17
						.append (",U_EMPNO     		,U_DATE         ,U_IP	,CUST_GU		\n")
						.append ("     ) VALUES (											\n")
						.append ("SALES.SWS_TCU010_ID.NEXTVAL					, 			 \n")
						.append ("	?,?,?,?,?,  ?,?,?,?,?,  ?,?,?,?,?     ,?,?, 		 			\n")
						.append ("	?, CURRENT_TIMESTAMP, ? 	,'1'	)					\n");
