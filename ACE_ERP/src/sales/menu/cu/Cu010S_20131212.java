...
public class Cu010S_20131212 extends SuperServlet {
	...
	public void select(Connection conn, HttpGauceRequest greq, HttpGauceResponse gres) throws ServletException, Exception {
		...
		String sCountry_gu	= HDUtil.nullCheckStr(req.getParameter("sCountry_gu"));	//06.국적구분  
		String sSaup_gu		= HDUtil.nullCheckStr(req.getParameter("sSaup_gu"));	//07.사업구분  
		String sManage_no	= HDUtil.nullCheckStr(req.getParameter("sManage_no"));	//08.주민여권  
