...
public class Em010_Cm019 extends HttpServlet {
...
**********************************************************************************************/
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						logger.dbg.println(this,"Em010_Cm019"+sql.toString());
						stmt = conn.getGauceStatement(sql.toString());

						logger.dbg.println(this,"Em010_Cm019_01");
		 				stmt.executeQuery(dSet);
						logger.dbg.println(this,"Em010_Cm019_02");
