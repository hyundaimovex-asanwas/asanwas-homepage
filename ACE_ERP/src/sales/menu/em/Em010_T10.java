...
public class Em010_T10 extends HttpServlet{
...
*/
		         ...
		         InsertSql.append( " INSERT INTO SALES.TCM335                  \n" )
											.append( " (EMPNO,	SEQ,		START_DT,	END_DT, EDU_CD,\n" )
											.append( " EDU_YN,	EDU_CO,	I_EMPNO,	U_EMPNO,I_DATE,\n" )
											.append( " U_DATE)                                   \n" )
											.append( " VALUES                                    \n" )
											.append( " (?,?,?,?,?,                               \n" )
...
//						logger.dbg.println(this,UpdateSql.toString());//로그남기는것
					...
					if(rows[j].getJobType() == GauceDataRow.TB_JOB_DELETE) {
						...
						DeleteSql.append( " DELETE  FROM SALES.TCM335		\n")
										 .append( "	WHERE EMPNO=?								\n")
				  					 .append( " AND SEQ=?									  \n");
