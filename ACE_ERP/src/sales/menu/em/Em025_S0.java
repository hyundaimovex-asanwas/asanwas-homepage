...
public class Em025_S0 extends HttpServlet {
...
**********************************************************************************************/
				...
				if (!GauceReq.isBuilderRequest()) {		
							...
							sql.append( "	SELECT A.PAY_YM, B.ITEM2 AS GROUP, C.DETAIL_NM AS GROUPNM,                             \n");
							...
							sql.append( "	       SUM(IFNULL(A.REAL_PAY_SUM,0))REAL_PAY_SUM ,C.ITEM2 AS SEQ                       \n");
							...
							sql.append( "	 ORDER BY INTEGER(C.ITEM2)                                                             \n");
