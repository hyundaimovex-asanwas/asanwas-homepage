...
public class My400H_01 extends SuperServlet {
		...
		try{
			  if (ds1 != null) {
				  ...
				  GauceDataColumn[] 	cols = ds1.getDataColumns();
						...
						int s_ap_m_sid		= HDUtil.nullCheckNum(greq.getParameter("s_ap_m_sid"));
						String s_empnmk		= HDUtil.nullCheckStr(greq.getParameter("sEmpNmk"));
						String s_empno		= HDUtil.nullCheckStr(greq.getParameter("sEmpNo"));
						String s_ap_desc	= HDUtil.nullCheckStr(greq.getParameter("sApDesc"));
						/*
						...
						StringUtil.printMsg("s_ap_desc",s_ap_desc,this);
						*/
							  cstmt = conn.prepareCall("{call SALES.PR_MY400i_03(?,?,?,?,?,    ?,?,?,?) }");
							  cstmt.setInt(1, s_ap_m_sid);
		  					  cstmt.setString(2, s_empnmk);
							  cstmt.setString(3, s_empno);
							  cstmt.setString(4, iParamEmpno);
							  cstmt.setString(5, iParamIp);
							  cstmt.registerOutParameter(6,  java.sql.Types.VARCHAR);
							  cstmt.registerOutParameter(7,  java.sql.Types.VARCHAR);
							  cstmt.registerOutParameter(8, java.sql.Types.VARCHAR);
							  cstmt.setString(9, s_ap_desc);
