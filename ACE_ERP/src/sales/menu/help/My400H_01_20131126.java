...
public class My400H_01_20131126 extends SuperServlet {
			...
			while(it.hasNext()){
				...
				if(ds1!=null){
					...
					if(gauceName.equals("AP_LINE_DS")){
						...
						String s_empno		= HDUtil.nullCheckStr(req.getParameter("sEmpNo"));
						String s_ap_desc	= HDUtil.nullCheckStr(req.getParameter("sApDesc"));
