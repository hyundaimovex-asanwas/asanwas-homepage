...
public class Rv290I_05 extends SuperServlet {
	...
	public void makeSql() {
		...
		for(int i=0; i<arr_sql.length; i++)
			...
			arr_sql[1].append (" {call SALES.RV290I_05 (?)}");
	...
	public void select(GauceDBConnection conn, GauceRequest req,
		...
		try{
			String 	v_fr_date	 	= HDUtil.nullCheckStr(req.getParameter("v_sn"));		//sn
