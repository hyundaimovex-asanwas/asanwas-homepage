...
public class Em011_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				String[] strArrCN = new String[]{ "EMPNO","ORD_DT","SEQ","CUST_SID","ORD_CD",
					                                "VEND_CD","DEPT_CD","TEAM_CD","WORK_CD","SKILL_CD",
																					"JOB_CD", "I_EMPNO","I_DATE","U_EMPNO","U_DATE",
					                                "C_VEND_CD", "RETGB", "BLCHK"
																			  };
        ...
        for (int i=0; i<strArrCN.length; i++) {
           ...
           //발령 Insert
					 ...
					 InsertSql.append( " INSERT INTO SALES.TCM305                          \n" )
										.append( "( EMPNO,	 ORD_DT,	 SEQ,	CUST_SID,	ORD_CD,        \n" )
										.append( "  VEND_CD, DEPT_CD,  TEAM_CD,	WORK_CD,	SKILL_CD,  \n" )
										.append( "  JOB_CD,I_EMPNO, I_DATE,	 U_EMPNO,	U_DATE, C_VEND_CD, RETGB, BLCHK )         \n" )
										.append( "  VALUES                                       \n" )
										.append( " ( ?,?,?,?,?,?,?,?,?,?,                        \n" )
