...
**********************************************************************************************/
        ...
        for(int i=0;i<=5;i++){
				...
				String[] strArrCN = new String[]{  "EMPNO","EMPNMK", "ATT_DT", "CUST_SID",
                                           ...
                                           "CHK", "I_EMPNO","U_EMPNO","I_DATE","U_DATE", "JOB_CD","SKILL_CD",  "O3_TIME","O4_TIME"                                 
																		  	}; //
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (!GauceReq.isBuilderRequest()) {					
						...
						sql.append( "	       RTRIM(A.W_TIME)W_TIME,   RTRIM(A.W2_TIME)W2_TIME ,A.W_TIME_TOT,                                       \n");
						sql.append( "	       A.W_REMARK,  RTRIM(A.O_TIME)O_TIME,   RTRIM(A.O2_TIME)O2_TIME, A.O_TIME_TOT,  A.O_DTIME, A.O_NTIME,    \n");
						sql.append( "	       A.O_REMARK, A.REMARK,  ''CHK, A.I_EMPNO,  A.I_DATE,  A.U_EMPNO, A.U_DATE, A.JOB_CD, A.SKILL_CD,  RTRIM(A.O3_TIME)O3_TIME,   RTRIM(A.O4_TIME)O4_TIME  \n");
