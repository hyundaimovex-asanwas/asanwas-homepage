...
public class Em_com_s3 extends HttpServlet {
...
**********************************************************************************************/
				...
				String  str2	= req.getParameter("v_str2"); //teamcd


				GauceRes.enableFirstRow(dSet);

				String[] strArrCN = new String[]{ "COM_CODE",	"COM_SNAME", "ITEM2" }; 

				int[] intArrCN = new int[] { 10,50,20}; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					if(!str2.equals("")&&!str2.equals("00000")&&!str2.equals("88888"))sql.append( "	  AND RTRIM(DETAIL) IN ('"+str2+"')	\n");
					if(str2.equals("88888"))sql.append( "	  AND (ITEM2 IS NULL OR ITEM2 ='')	\n");
