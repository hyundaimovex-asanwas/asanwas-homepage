...
public class Mi120S extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[1].append("CALL SALES.PR_MI120S_01(?,?,?)");
	...
	public void select(GauceDBConnection conn, GauceRequest req,
		...
		StringUtil.printMsg("sJob_Date			",sJob_Date, this);
		StringUtil.printMsg("sCust_Gu			",sCust_Gu, this);
