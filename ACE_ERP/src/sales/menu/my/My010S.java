 ...
 * 받은편지함
 */
public class My010S extends BaseCommand {
	...
	public String select(Connection conn, HttpServletRequest req,
		...
		try {
			...
			StringUtil.printMsg("받는사람", user_id, this );
		...
		return "/Sales/my/my010s.jsp?menu_title=my010s&ut=A&mt=M";
	}
	...
	public String insert(Connection conn, HttpServletRequest req,
		...
		return "/servlet/sales.common.my.BaseServlet?actId=my010s&process_flag="+HDConstant.PROCESS_TYPE_SEARCH+"&ut=A&mt=M&menu_title=my010s";
	}
	...
	public String modify(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my010v.jsp?menu_title=my010v&ut=A&mt=M";
	}
	...
	public String reply(Connection conn, HttpServletRequest req,
		...
		try {
			...
			StringUtil.printMsg("받는사람", param.get("out_login_id"), this );
