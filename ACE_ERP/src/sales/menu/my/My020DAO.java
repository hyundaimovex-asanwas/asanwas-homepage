...
public class My020DAO  extends CommonDAO {
    public My020DAO() {
        super();
    }
    ...
    public ArrayList list(My020DTO entity, String where_sql,Connection conn) throws SQLException {
        ...
        sql.append(" WHERE  send_login_id = ?");

        if(StringUtil.isNotNull(where_sql)){
            sql.append(where_sql);
        }
        System.out.println("DAO list");
        System.out.println(entity.getSend_login_id());
        ...
        pstmt.setString(1, entity.getSend_login_id());
