...
public class My130I extends BaseCommand {
	...
	public void makeSql() {
		...
		arr_sql[0].append("SELECT * FROM SALES.TMY020 		\n")
				  .append("WHERE BRD_GU = '03' 				\n")
				  .append("		AND DELYN='N' 				\n")
//				  .append("		AND REF_STEP=0				\n")
//				   .append("		AND REF_STEP=0				\n")
				  .append("ORDER BY ref desc, REF_STEP asc, brd_no desc \n");
...
//		
	...
	public String select(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my130s.jsp?menu_title=my130s&ut=A&mt=M";
	}
	...
	public String insert(Connection conn, HttpServletRequest req,
		...
		return "/services/servlet/sales.common.my.BaseServlet?actId=my130s&process_flag="+HDConstant.PROCESS_TYPE_SEARCH+"&ut=A&mt=M&menu_title=my130s";
	}
	...
	public String delete(Connection conn, HttpServletRequest req,
		...
		return "/servlet/sales.common.my.BaseServlet?actId=my130s&process_flag="+HDConstant.PROCESS_TYPE_SEARCH+"&ut=A&mt=M&menu_title=my130s";
	}
	...
	public String modify(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my130v.jsp?menu_title=my130v&ut=A&mt=M";
	}
	...
	public String edit(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my130m.jsp?menu_title=my130v&ut=A&mt=M";
	}
