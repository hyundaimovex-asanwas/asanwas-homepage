...
public class My310Manager extends CommonManager {	//커넥션정보가 있는 CommonManager를 상속합니다. 
    My310DAO dao = null;
    ...
    public My310DTO select(SmartRequest sr){
        My310DTO entity = new My310DTO();
        My310DTO dto = null;
    ...
    public void setDTO(SmartRequest sr,My310DTO dto)throws Exception{
