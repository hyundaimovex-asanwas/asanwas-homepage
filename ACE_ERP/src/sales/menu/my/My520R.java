...
public class My520R extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[0].append("CALL SALES.PR_MY520R_01(?,?)"); // 계좌이체 & 가상계좌
	}
	...
	public void select(GauceDBConnection conn, GauceRequest req,
		...
		String sSendLoginId 	= HDUtil.nullCheckStr(req.getParameter("send_login_id"));
		//String sSendDate 	= HDUtil.nullCheckStr(req.getParameter("send_date"));
			...
			while(it.hasNext()){
				...
				if(ds1!=null){
					...
					if(gauceName.equals("DS2")){
						...
						cstmt.setString(2, sSendLoginId);
