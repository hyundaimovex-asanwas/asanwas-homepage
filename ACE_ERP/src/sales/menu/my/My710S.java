...
public class My710S extends BaseCommand {
...
//		
	...
	public String select(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my710s.jsp?menu_title=my710s&ut=A&mt=M";
	}
	...
	public String insert(Connection conn, HttpServletRequest req,
		...
		return "/servlet/sales.common.my.BaseServlet?actId=my710s&process_flag="+HDConstant.PROCESS_TYPE_SEARCH+"&ut=A&mt=M&menu_title=my710s";
	}
	...
	public String modify(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my710v.jsp?menu_title=my710v&ut=A&mt=M";
	}
	...
	public String edit(Connection conn, HttpServletRequest req,
		...
		return "/Sales/my/my710m.jsp?menu_title=my710v&ut=A&mt=M";
	}
