...
public class My730DAO extends CommonDAO {
	public My730DAO() {
		super(); 
	}
    
	//게시물 리스트 조회시
	public ArrayList list(My730DTO entity, String where_sql,int requestedPage,int pageSize ,String v_login_id,String v_login_name,Connection conn) throws SQLException {
		...
		try {
			...
			if(chk_page > 0){	//1페이지가 아닌 경우
				...
				sql.append("  AND YN_DEL_KEEP    = 'N' 	");
				sql.append("  AND ((yn_keep_recipient='Y' and brd_recipient=?) or (yn_keep_creator='Y' and brd_creator=?))	");
	...
	public ArrayList alllist(My730DTO entity, String where_sql,int requestedPage,int pageSize ,String v_login_id,String v_login_name,Connection conn) throws SQLException {
		java.sql.PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
		ArrayList arrBeans = new ArrayList();
	...
	public ArrayList mainlist(My730DTO entity, String where_sql,String v_login_id,String v_login_name,Connection conn) throws SQLException {
		java.sql.PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
		ArrayList arrBeans = new ArrayList();
	...
	//게시물 조회시 : 
	public My730DTO select(My730DTO entity, Connection conn) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
		StringBuffer sql1 = new StringBuffer();
		My730DTO dto = new My730DTO();
...
//System.out.println("730DAO");
	...
	//	보관함 조회시 : 
	  public My730DTO keep(My730DTO entity, Connection conn) {
		  PreparedStatement pstmt = null;
		  ResultSet rs = null;
		  StringBuffer sql = new StringBuffer();
		  StringBuffer sql1 = new StringBuffer();
...
//	System.out.println("730DAO");
	...
	//보낸쪽지 	보관함 
	  public My730DTO keep2(My730DTO entity, Connection conn) {
		  PreparedStatement pstmt = null;
		  ResultSet rs = null;
		  StringBuffer sql = new StringBuffer();
		  StringBuffer sql1 = new StringBuffer();
...
//	System.out.println("710DAO");
	...
	public long insert(My730DTO dto, Connection conn) {
		PreparedStatement pstmt = null;
	...
	public long rep_insert(My730DTO dto, Connection conn) {
		PreparedStatement pstmt = null;
		StringBuffer sql = new StringBuffer();
		StringBuffer sql2 = new StringBuffer();
	...
	public long update(My730DTO dto, Connection conn) {
		PreparedStatement pstmt = null;
		StringBuffer sql = new StringBuffer();
		ResultSet rs = null;
		long ret = 0;
	...
	public long delete(My730DTO dto, Connection conn)  {
		PreparedStatement pstmt = null;
		StringBuffer sql = new StringBuffer();
		long ret = 0;
	...
	public long delete2(My730DTO dto, Connection conn)  {
		PreparedStatement pstmt = null;
		StringBuffer sql = new StringBuffer();
		long ret = 0;
	...
	public long delete3(My730DTO dto, Connection conn)  {
			PreparedStatement pstmt = null;
			StringBuffer sql = new StringBuffer();
			long ret = 0;
	...
	public long reply(My730DTO dto, Connection conn)  {
			PreparedStatement pstmt = null;
			StringBuffer sql = new StringBuffer();
			long ret = 0;
