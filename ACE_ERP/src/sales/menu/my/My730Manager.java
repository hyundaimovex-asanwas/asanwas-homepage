...
public class My730Manager extends CommonManager {	//커넥션정보가 있는 CommonManager를 상속합니다. 
    My730DAO dao = null;
    ...
    public My730DTO select(SmartRequest sr){
        My730DTO entity = new My730DTO();
        My730DTO dto = null;
        ...
        try{
            ...
            //System.out.println("730Manager---상세 ---------");
            dto.nvl();
        }catch(Exception e){
            error(e);
        }finally{
	...
	public My730DTO keep(SmartRequest sr){
		My730DTO entity = new My730DTO();
		My730DTO dto = null;
	...
	public My730DTO keep2(SmartRequest sr){
			My730DTO entity = new My730DTO();
			My730DTO dto = null;
    ...
    public void setDTO(SmartRequest sr,My730DTO dto)throws Exception{
