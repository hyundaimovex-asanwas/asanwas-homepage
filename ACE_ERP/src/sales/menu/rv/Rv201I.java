...
public class Rv201I extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[1].append("CALL SALES.PR_RV201I_01(?)");						//조회하기
		arr_sql[2].append("CALL SALES.PR_RV201I_02(?,?,?,?,?,  ?,?,?,?,?,  ?,?,?)");	//수정된 상세내역 값 저장하기
