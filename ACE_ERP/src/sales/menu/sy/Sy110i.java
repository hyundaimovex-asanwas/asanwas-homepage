...
public class Sy110i extends HttpServlet {
	/**
	 * 
	 */
...
//			 dataset 구분 param
			...
			switch(dsType) {
				case 1 :
					...
					query   += "" 		
							+ "\n\t" + "SELECT " 									
							+ "\n\t" + "	zip_sid, zip_cd, address1, address2, address3, post_box "
							+ "\n\t" + "FROM "
							+ "\n\t" + "	SALES.TSY110 " 
							+ "\n\t" + "WHERE 1=1 "
							+ "\n" ;
...
//					가지고 올 테이블의 컬럼 상태를 초기화 한다 
					...
					ds1.addDataColumn(new GauceDataColumn("address1",	 	GauceDataColumn.TB_STRING, 10));
					ds1.addDataColumn(new GauceDataColumn("address2",	 	GauceDataColumn.TB_STRING, 15));
					ds1.addDataColumn(new GauceDataColumn("address3", 		GauceDataColumn.TB_STRING, 45));
