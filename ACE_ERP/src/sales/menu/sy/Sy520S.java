...
public class Sy520S extends SuperServlet {
	...
	public void makeSql() {
		...
		arr_sql[1].append("CALL SALES.PR_SY520S_01(?,?)");
		arr_sql[2].append("CALL SALES.PR_SY520S_02(?,?)");
		arr_sql[3].append("CALL SALES.PR_SY520S_03(?,?)");
		arr_sql[4].append("CALL SALES.PR_SY520S_04(?,?)");
		arr_sql[5].append("CALL SALES.PR_SY520S_05(?,?)");
		arr_sql[6].append("CALL SALES.PR_SY520S_06(?,?)");
		arr_sql[7].append("CALL SALES.PR_SY520S_07(?,?)");
