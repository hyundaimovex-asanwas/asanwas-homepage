...
public class HDConstant { 
    ...
    //security 패스
	public static final String PATH_LI = "/servlet/security.menu.li.";
	public static final String PATH_HELP = "/servlet/security.menu.help.";
    public static final String PATH_COMMON = "/servlet/security.common.";
