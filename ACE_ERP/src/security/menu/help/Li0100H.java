			...
			while (it.hasNext()) {
				...
				if(ds1!=null){
					...
					if(gauceName.equals("DS_DEFAULT")){              //문서정보 조회 
						...
						//StringUtil.printMsg("정보조회::","ㅇㅇ",this);
					...
					if(gauceName.equals("DS_DEFAULT2")){              //결재선조회 (
						cstmt = conn.prepareCall(arr_sql[1].toString());
	
						//StringUtil.printMsg("결재선조회::","ㅇㅇ",this);
	
						int  v_sid		= HDUtil.nullCheckNum(req.getParameter("v_sid")); 		// 등록번호
					...
					if(gauceName.equals("DS_DEFAULT5")){              //결재선조회 ( 
					...
					if(gauceName.equals("DS_DEFAULT9")){              //수신부서조회 
