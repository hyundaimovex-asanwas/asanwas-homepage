...
public class Lm050 extends SuperServlet {
	...
	public void makeSql(){
		...
		//Main 조회
		arr_sql[0].append ("{call SECURITY.PR_LM050S_00(?,?) }" );			
		
		arr_sql[1].append ("{call SECURITY.PR_LM050S_01(?,?) }" );
		
		arr_sql[2].append ("{call SECURITY.PR_LM050S_02(?,?) }" );		
