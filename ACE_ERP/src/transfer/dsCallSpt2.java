...
public class dsCallSpt2 extends HttpServlet {
...
logger.dbg.println(this,"SP_HDSSD21");
	 		      query.append("  CALL TRANSFER.SP_HDSSD21(?,?,?) ");
                
 logger.dbg.println(this,"SP_HDSSD22");
						cstmt = conn.prepareCall(query.toString());
 logger.dbg.println(this,"SP_HDSSD23");
 ...
 logger.dbg.println(this,"SP_HDSSD24");
						cstmt.execute();
 logger.dbg.println(this,"SP_HDSSD25");
