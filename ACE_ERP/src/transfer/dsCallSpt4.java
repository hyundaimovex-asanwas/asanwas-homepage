...
public class dsCallSpt4 extends HttpServlet {
...
**********************************************************************************************/
              ...
              //   logger.dbg.println(this,"LLLLLLLL");
				...
				if (!GauceReq.isBuilderRequest()) {					
						...
						logger.dbg.println(this,"SP_HDSSD41");
	 		      
                       query.append("  CALL HDASAN_EDI.SP_SSD21LS(?) ");

                        logger.dbg.println(this,"SP_HDSSD42");
						cstmt = conn.prepareCall(query.toString());
						logger.dbg.println(this,"SP_HDSSD43");

						cstmt.setString(1, str[0] );
 				
						cstmt.registerOutParameter (1, Types.CHAR);
				
                        logger.dbg.println(this,"SP_HDSSD44");

						cstmt.execute();

						logger.dbg.println(this,"SP_HDSSD45");
