...
public class dsEdCarNo extends HttpServlet {
...
**********************************************************************************************/
        ...
        String str4 = GauceReq.getParameter("gstr4");   
				...
				String[] strArrCN = new String[]{ "CAR_NO", "ACCSECTION","START_DATE","CAR_SEQ_NO" }; 

				int[] intArrCN = new int[] { 20, 1,8,20 }; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (isNotOnlyHeader) {					
						StringBuffer sql = new StringBuffer();
											sql.append(" SELECT CAR_NO,ACCSECTION,START_DATE,CAR_SEQ_NO  ") ; 
											sql.append(" FROM TRANSFER.LTCARACC  ") ; 
											sql.append(" WHERE CAR_SEQ_NO IS NOT NULL ") ; 
if(str1 != null)			sql.append(" AND START_DATE ='" + str1 + "'" ) ; 
