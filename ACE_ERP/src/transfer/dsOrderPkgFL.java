...
public class dsOrderPkgFL extends HttpServlet {
...
**********************************************************************************************/
        ...
        String str4 = GauceReq.getParameter("gstr4");   
				...
				String[] strArrCN = new String[]{ "PORDER_NO", "FTYPE","IMG","FIELNAME","CREATE_USR","UPDATE_USR" }; 

				int[] intArrCN = new int[] { 20,2,100,100,10,10}; 
			
				int[] intArrCN2 = new int[]{ -1,-1,-2,-1,-1,-1 }; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (isNotOnlyHeader) {					
						...
						sql.append(" SELECT PORDER_NO,FTYPE,'' AS  IMG") ; 
						sql.append(" ,FIELNAME,CREATE_USR,UPDATE_USR ") ; 
						sql.append(" FROM TRANSFER.LTORDPCKFL ") ;  
					  sql.append(" WHERE PORDER_NO IS NOT NULL  ") ;   
if( str1 != null ) { sql.append(" AND PORDER_NO  = '" +str1 + "'" ) ; }
if( str2 != null ) { sql.append(" AND FTYPE  = '" +str2 + "'" ) ; } 
