...
public class dsOrderdetail_2 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "ORDER_NO","ORDER_SEQ","ARTC_CD","ARTC_NM","STN_SZ",
					                                ...
					                                "PUNIT_CNT","PUNIT_UNIT","PUNIT_WGHT","PKG_LNGTH","PKG_HEIGHT",
																					...
																					"VEND_NM","CHECK","LINE_PART","T_CBM" ,"T_WEIGHT",
																					"BGTYPE" ,"JAN_ARTC_CNT", "CNT_STS", "DLVL_TYPE"}; 
             ...
             .append( "					IFNULL(D.ARTC_CNT,0)-IFNULL(X.ARTC_CNT,0) AS JAN_ARTC_CNT, \n")
						 .append( "					CASE WHEN D.ARTC_CNT - X.ARTC_CNT>0 THEN 'A'  -- 부분 입고   \n")
						 .append( "					     WHEN D.ARTC_CNT - X.ARTC_CNT=0 THEN 'B'  -- 전체 입고   \n")
						 .append( "					     ELSE 'C' END CNT_STS,                     -- 미입고      \n")
						 .append( "					M.DLVL_TYPE \n") // 2008.10.30 JYS 
						 .append( "		FROM TRANSFER.LTORDERDTL D, \n")
						 .append( "				 TRANSFER.LTORDERMST M, \n") 
						 .append( "				 ACCOUNT.GCZM_VENDER G \n")
						 .append( "		LEFT JOIN ( SELECT H.ORDER_NO, H.ORDER_SEQ, SUM(H.ARTC_CNT) ARTC_CNT	\n")
						 .append( "		       FROM TRANSFER.LTINWRHS H                                     	\n")
						 .append( "		      WHERE H.ORDER_NO='" + str1 + "'                               	\n")
						 .append( "		      GROUP BY H.ORDER_NO, H.ORDER_SEQ                              	\n")
						 .append( "		    ) X ON X.ORDER_NO = D.ORDER_NO AND X.ORDER_SEQ = D.ORDER_SEQ    	\n")       
