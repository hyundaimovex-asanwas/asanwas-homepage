...
public class hscode_s01 extends HttpServlet {
...
**********************************************************************************************/
		   	...
		   	if (!GauceReq.isBuilderRequest()) {
					...
					if (gstr1.equals("1")) query.append("	  AND MAJOR_CD = '" + gstr2 + "' ");
					else if (gstr1.equals("2")) query.append("	  AND MINOR_CD LIKE '" + gstr2 + "%' \n AND LENGTH(MINOR_CD) > 6");
					else if (gstr1.equals("3")) query.append("	  AND MINOR_NM LIKE '" + gstr2 + "%' \n AND LENGTH(MINOR_CD) > 6");
