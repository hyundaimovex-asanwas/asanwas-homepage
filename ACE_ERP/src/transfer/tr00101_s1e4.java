...
public class tr00101_s1e4 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{"CAR_TYPE","CAR_NAME","CAR_LENGTH","CAR_WIDTH","CAR_HEIGHT","CAR_CBM","CAR_TON","CAR_CLASS" }; 

				int[] intArrCN = new int[] { 4,30,13,13,13,13,13,4   }; 
			
				int[] intArrCN2 = new int[]{ -1,-1,2,2,2,2,2,-1   }; 
				...
				for (int i=0; i<strArrCN.length; i++) { // set column column 
					...
					if (isNotOnlyHeader) {					
						...
						sql.append(" CAR_WIDTH,CAR_HEIGHT,CAR_CBM,CAR_TON,CAR_CLASS  ") ; 
