...
public class tr00101_s4 extends HttpServlet {
    ...
    if (client.indexOf("MSIE 5.5") != -1) {
		...
		if (stype.equals("A")) workbook.setSheetName(0 , "개성 반출 물품 리스트" ,HSSFWorkbook.ENCODING_UTF_16);
		else workbook.setSheetName(0 , "금강산 반출 물품 리스트" ,HSSFWorkbook.ENCODING_UTF_16);
