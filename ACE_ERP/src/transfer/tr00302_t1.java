...
public class tr00302_t1 extends HttpServlet{
...
/*
				...
				UpdateSqll.append( "        PERSON_NO = ?, " );
				UpdateSqll.append( "        CAR_NO = ?, " );
				UpdateSqll.append( "        START_TIME = ? " );
				UpdateSqll.append( " WHERE ACCESSNO = ? "  );
				UpdateSqll.append( " AND   ACCSECTION = ?  " );
				UpdateSqll.append( " AND   SEQ_NO = ?  " );
*/
...
//logger.dbg.println(this,UpdateSql.toString());
					...
					UpdateSqll.append( " UPDATE TRANSFER.LTPSRNACC SET \n" )
										...
										.append( "        START_TIME = '" + rows[j].getString(idxSTART_TIME)+ "' \n" )
