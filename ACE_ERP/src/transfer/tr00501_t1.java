...
public class tr00501_t1 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( "INSERT INTO TRANSFER.LTLCODE ( " );
				InsertSql.append( "MAJORCD,MINORCD,MINORNM,SEQ,USEYN,MEMO " );
				InsertSql.append( ") VALUES( " );
				InsertSql.append( "?, ?, ?, ?, ?, ? ) " );
  
				UpdateSql = new StringBuffer();
				UpdateSql.append( "UPDATE TRANSFER.LTLCODE SET " );
				...
				DeleteSql.append( "DELETE FROM TRANSFER.LTLCODE WHERE MAJORCD = ? AND MINORCD = ? " );
