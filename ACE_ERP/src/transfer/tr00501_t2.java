...
public class tr00501_t2 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) {
		...
		try{
			...
			try {
				...
				InsertSql.append( "INSERT INTO TRANSFER.LTHCODE ( " );
				InsertSql.append( "MAJORCD,MAJORNM,USEYN,MEMO " );
				InsertSql.append( ") VALUES( " );
				InsertSql.append( "?, ?, ?, ? ) " );
  
				UpdateSql = new StringBuffer();
				UpdateSql.append( "UPDATE TRANSFER.LTHCODE SET " );
				...
				DeleteSql.append( " DELETE FROM TRANSFER.LTHCODE WHERE MAJORCD = ? " );
				DeleteSql2.append( " DELETE FROM TRANSFER.LTLCODE WHERE MAJORCD = ? " );
