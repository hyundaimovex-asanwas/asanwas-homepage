...
public class tr00508_popup_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "MAJORCD", "MINORCD", "MINORNM" 																		
																	};

				int[] intArrCN = new int[]{ 4, 10, 50
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT DISTINCT IFNULL(MAJORCD,'') MAJORCD, MINORCD,IFNULL(MINORNM,'') MINORNM  \n" );
					//sql.append( " IFNULL(A.RDS_GOODS,'') RDS_GOODS, D.CARTYPENO,A.CAR_TYPE,IFNULL(E.CAR_NAME,'') CAR_NAME   \n" );
					sql.append( " FROM TRANSFER.LTLCODE \n" );
					sql.append( " WHERE MAJORCD = '0006' \n" );
					...
					if (!str1.equals("")) sql.append( " AND MINORNM LIKE '"+str1+"%' \n" );
