...
public class tr00513_s2 extends HttpServlet {
...
**********************************************************************************************/
				...
				sql.append( " SELECT LINE_PART, CAL_DT, WEEK_DAY, HOLY_DIV, APP_DT1,   \n" )
					 .append( "				 APP_DT2, APP_DT3, HOLY_TYPE, CAL_REM, CREATE_DT,  \n" )
					 .append( "				 CREATE_USR, UPDATE_DT, UPDATE_USR  \n" )
					 .append( "		FROM TRANSFER.LTCALENDAR   \n" )
					 .append( "  WHERE CAL_DT = '" + str2 + "' " )
					 .append( "    AND LINE_PART IN (" + str1 + ") " );
