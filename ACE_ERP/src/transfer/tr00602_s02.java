...
public class tr00602_s02 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "MAIGBN","USERNM", "MAIYMD", "MAISEQ", "MAIREP", "MAITIME", 
																					"MAISMAN", "MAISUBJ", "MAIDESC", "MAIFILES", "MAIFNAME",
																					"MAIFILE", "REGNM", "MAIFLAG"
																				}; 

				int[] intArrCN = new int[]{ 1,   30, 8,    5,  5,  12,
																	 60, 255, 3000, 13, 100,
																		1,  30,    1
																	}; 
			
				int[] intArrCN2 = new int[]{ -1, -1,  -1,  0,  0, -1, 
																		 -1, -1, -1,  0, -1,
																		 -2, -1, -1
																	 }; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT A.MAIGBN, B.USERNM, A.MAIYMD, A.MAISEQ, A.MAIREP, A.MAITIME, \n ")
					   .append( "				 RTRIM(A.MAISMAN) MAISMAN, RTRIM(A.MAISUBJ) MAISUBJ, RTRIM(A.MAIDESC) MAIDESC, A.MAIFILES, A.MAIFNAME, \n " )
					   .append( "				 '' MAIFILE, RTRIM(B.REGNM) REGNM, A.MAIFLAG \n " )
             ...
             .append( "				 LEFT OUTER JOIN TRANSFER.LTUSER B ON RTRIM(A.MAISMAN) = RTRIM(B.USERID) \n " )
					...
					sql.append( "  ORDER BY A.MAIYMD DESC, A.MAISEQ DESC, A.MAIREP \n ")
