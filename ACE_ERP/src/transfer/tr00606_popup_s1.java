...
public class tr00606_popup_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "USERID","USERPW","USERNM","REGNO","ZIPCD",
																					...
																					"TEL", "MOBILE", "VEND_ID", "REGFLAG", "TEMPFLAG"
												};
				...
				if (isNotOnlyHeader) {		
					...
					sql.append(" SELECT DISTINCT " )
						 .append("				A.USERID,A.USERPW,A.USERNM,A.REGNO,A.ZIPCD,    \n " )
						 .append("				A.ADDR1,A.ADDR2,A.REGNM,A.TEL1,A.TEL2,    \n " )
						 .append("				A.TEL3,A.FAX1,A.FAX2,A.FAX3,A.MOBILE1,    \n " )
						 .append("				A.MOBILE2,A.MOBILE3,A.EMAIL,A.RELPART,A.CREATE_DT,    \n " )
						 .append("				A.CREATE_USR,A.UPDATE_DT,A.UPDATE_UST,   \n " )
						 .append("				A.TEL1||'-'||A.TEL2||'-'||A.TEL3 AS TEL,  \n " )
						 .append("				A.MOBILE1||'-'||A.MOBILE2||'-'||A.MOBILE3 AS MOBILE, B.VEND_ID,  \n " )
						 .append("				CASE WHEN A.REGNO = B.VEND_ID THEN 'Y' ELSE 'N' END REGFLAG, A.TEMPFLAG \n " )
						 .append("	 FROM TRANSFER.LTUSER A  \n " )
						 .append("				LEFT JOIN ACCOUNT.GCZM_VENDER B ON A.REGNO= B.VEND_ID \n " )
						 .append("	WHERE A.USERID IS NOT NULL " );

					if (str1 !=null) sql.append(" AND A.USERID LIKE UPPER('%" + str1 + "%')");
