...
public class tr00606_s1 extends HttpServlet {
...
**********************************************************************************************/
				...
				String[] strArrCN = new String[]{ "USERID","USERNM" }; 
				...
				if (!GauceReq.isBuilderRequest()) {					
					...
					sql.append( " SELECT RTRIM(USERID) USERID,RTRIM(USERNM) USERNM \n" );
					sql.append( " FROM TRANSFER.LTUSER \n" );
  					sql.append( " WHERE USER_DIV = 'T' \n" );
