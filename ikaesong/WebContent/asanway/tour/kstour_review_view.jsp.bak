...
function best(){
	...
	if(val){
		if(confirm("Best 게시물로 선정하시겠습니까?")){
			...
			obj.action = "kstour_review_ok.jsp";
			obj.submit();
		}else{
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                					<td align=right> 
                						...
                						<a href="kstour_review.jsp"><img src=../img/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='kstour_review.jsp'"></a><img src=../img/tour_img/btn_r.gif align=absmiddle>
                					</td>
                				</tr>
                			</table>
