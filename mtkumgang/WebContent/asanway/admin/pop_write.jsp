	...
	<script language="javascript">
	   <!--
		...
		function checkForm() {
			...
			if(getBytes(form.id.value) > 20 ) {
				alert("ID는 20자 이내로 입력해 주십시오.");
				form.id.focus();
				return false;
			}


			if(isAlphaNumCheck(form.id.value) == false) {
				alert("ID는 영문과 숫자만 사용 가능합니다.");
				form.id.focus();
				return false;
			}
			...
			if(getBytes(form.name.value) > 20 ) {
				alert("이름은 10자 이내로 입력해 주십시오");
				form.name.focus();
				return false;
			}
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
          ...
          <td style="padding:0 10 0 10;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><font color="C1B69C">| </font><input type="text" name="id" style="width:200px;height:20px" ></td>
                <td height="25"><img src="../img/bottom_02.gif" hspace="5" align="absmiddle">이름</td>
                <td><font color="C1B69C">| </font><input type="text" name="name" style="width:200px;height:20px" ></td>
              </tr>
                <td height="25"><img src="../img/bottom_02.gif" hspace="5" align="absmiddle">비밀번호</td>
                <td><font color="C1B69C">| </font><input type="password" name="password" style="width:200px;height:20px" ></td>
                <td height="25"><img src="../img/bottom_02.gif" hspace="5" align="absmiddle">비밀번호확인</td>
                <td><font color="C1B69C">| </font><input type="password" name="password2" style="width:200px;height:20px" ></td>
              </tr>
              <tr>
                 <td height="25"><img src="../img/bottom_02.gif" hspace="5" align="absmiddle">이메일</td>
                 <td colspan=3><font color="C1B69C">|</font> <input type="text" name="email" style="width:200px;height:20px" ></td>
              </tr>
              <tr>
                <td height="10"></td>
                <td colspan=3></td>
								...
								<%} else {
					             ...
					             %>
											...
											<tr height=20>
												...
												<td width=10><input type=checkbox name=auth_check onClick="setAuthData(<%=k%>)" ></td>
											</tr>
								<%		k++;
    										}
					                  	}
  ...
  <tr bgcolor="FCFCF6">
    <td height="25"></td>
	<td align="right" valign="top" style="padding-top:10;">
		<h3>
		<input type=image src="../img/pop_bt_01.gif" width="69" height="20" hspace="4" border="0"></a>
		<a href="javascript:window.close();"><img src="../img/bt_11.gif" border="0"></a>
		</h3>
	</td>
	<td></td>
  </tr>
