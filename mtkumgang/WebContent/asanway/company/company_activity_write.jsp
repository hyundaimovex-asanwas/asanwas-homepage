              ...
              <tr>
                <td valign="top" style="padding: 15 0 0 20;">
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<!--content start -->
					<form name="form" method="post" action="company_activity_insert.jsp"  enctype="multipart/form-data" onSubmit="return goInsert()">
                    ...
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">이미지 1</td>
                            <td style="padding-left:5;"><input type="file" name="img1" size="31" style="width:300px;height:20px">(* 권장 이미지 사이즈 : 204 * 163)
                            </td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr>
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">이미지 2</td>
                            <td style="padding-left:5;"><input type="file" name="img2" size="31" style="width:300px;height:20px">(* 권장 이미지 사이즈 : 204 * 163) </td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr>
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">이미지 3</td>
                            <td style="padding-left:5;"><input type="file" name="img3" size="31" style="width:300px;height:20px">(* 권장 이미지 사이즈 : 204 * 163) </td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr>
                            ...
                            <td style="padding: 10 0 10 5 ;" valign="top" ><textarea name="content" rows="5" wrap="VIRTUAL" style="width:400px;"></textarea></td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
