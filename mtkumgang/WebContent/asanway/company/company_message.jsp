    ...
    <td valign="top"><table width="850" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="padding: 15 0 0 20;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    ...
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
						  <tr>
                            <td>
                              <form name="search" method="get" action="company_message.jsp">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td width="100" align="center"><font color="433C2C" width=100>등록일</font></td>
                            <td></td>
                            <td width="120" align="center"><font color="433C2C" width=120>등록</font></td>
	                    ...
	                    %>
		                          <tr>
		                            ...
		                            <td></td>
		                            <td style="padding-left:5;"><a href="company_message_read.jsp?idx=<%= hm.get("IDX") %>"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 28, Utility.ko((String)hm.get("TITLE")) ) %></a><% if( Utility.NewDay((String)hm.get("REGTIME")) ) {%> <img src="/asanway/img/bt_19.gif"><% } %></td>
		                            <td></td>
						...
						<Table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<%if(helper.getBeforegroup() > 0){%>
									<a href="/asanway/company/company_message.jsp?page=<%=helper.getBeforegroup()%>"><img src="../img/bt_05.gif" width="36" height="11" hspace="8"></a>
								<% } else { %>
							...
							<!--
								...
								<%if(helper.getBefore() > 0){%>
									<a href="/asanway/company/company_message.jsp?p=<%=helper.getBefore()%>"><img src="/admin/common/img/btn_pre.gif" border="0"></a>
								<% } else { %>
							...
							-->
								<td>
									...
									%>
										...
										<%  } else { %>
										<a href="/asanway/company/company_message.jsp?page=<%= i %>"><%= i %></a>&nbsp;
										<%  }
									  } %>
									<% if(totalP  == 0) { %>1<% } %>
								</td>
							<!--
								<td width="64" align="right">
									<% if(helper.getAfter() > 0){%>
										<a href="/asanway/company/company_message.jsp?p=<%=helper.getAfter()%>"><img src="/admin/common/img/btn_next.gif" border="0"></a>
									<% } else { %>
							 ...
							 -->
								<td>
									<%if(helper.getAftergroup() > 0){%>
										<a href="/asanway/company/company_message.jsp?page=<%=helper.getAftergroup()%>"><img src="../img/bt_05.gif" width="36" height="11" hspace="8"></a>
									<% } else { %>
										<img src="../img/bt_05.gif" width="36" height="11" hspace="8">
									<% } %>
								</td>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="/asanway/company/company_message_write.jsp"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
