...
<!--
	function goDel(idx){
		var idx = idx;
		if (confirm("삭제하시겠습니까?")) {
				location.href="/asanway/company/company_message_action.jsp?cmd=Delete&idx="+idx;
		}
	}
                ...
                <td valign="top" style="padding: 15 0 0 20;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td>
                               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr bgcolor="F2F1E2">
                                  ...
                                  <td colspan="3" bgcolor="F2F1E2" style="padding-left:5;"><a href="company_message_read.htm"><%= Utility.ko( (String)read.get("TITLE") ) %></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                 ...
                                 <tr bgcolor="F2F1E2">
                                  ...
                                  <td colspan="3" bgcolor="F2F1E2" style="padding-left:5;"><%= (read.get("SUMMARY") == null) ? "" : Utility.nl2br(Utility.ko( (String)read.get("SUMMARY") ) ) %></td>
                                </tr>
                              </table>
                             </td>
                          </tr>
                      ...
                      <td >
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="company_message_read.jsp?idx=<%= preview.get("IDX") %>"><%= Utility.ko( (String)preview.get("TITLE") )%></a></td>
                          </tr>
						<% } %>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
						...
						<% if( nextview.size() != 0 )  {%>
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="company_message_read.jsp?idx=<%= nextview.get("IDX") %>"><%= Utility.ko( (String)nextview.get("TITLE") ) %></a></td>
                          </tr>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
                          </tr>
                    ...
                    <tr>
                      ...
                      <a href="company_message_modify.jsp?idx=<%= read.get("IDX") %>"><img src="../img/bt_08.gif" width="40" height="20" border="0"></a>
                      <a href="javascript:goDel(<%=read.get("IDX")%>)"><img src="../img/bt_09.gif" width="40" height="20" hspace="3" border="0"></a>
                      <a href="company_message.jsp"><img src="../img/bt_10.gif" width="40" height="20" border="0"></a>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
