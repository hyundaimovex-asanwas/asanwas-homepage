...
<%
	BodoBean bb = new BodoBean();
	bb.List(request, response);
%>
                ...
                <td valign="top" style="padding: 15 0 0 20;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
                          <tr>
                            ...
                            <form name="search" method="get" action="cyber_bodo_list.jsp">
                                <tr>
                    ...
                    <tr>
                      <td>
						...
						<% if ( list.size() == 0 ) { %>
                          ...
                          <tr>
                            <td height="25" align="center" colspan="9">등록된 보도자료가 없습니다. </td>
                          </tr>
					...
					%>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td style="padding-left:5;"><a href="cyber_bodo_read.jsp?idx=<%= hm.get("IDX") %>"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 25, Utility.ko((String)hm.get("TITLE")) ) %></a></td>
                            <td></td>
                            <td align="center">
                            <% if(filelist.size() == 0 )  {%>
						...
						<Table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<%if(helper.getBeforegroup() > 0){%>
									<a href="/asanway/cyber/cyber_bodo_list.jsp?page=<%=helper.getBeforegroup()%>"><img src="../img/bt_05.gif" width="36" height="11" hspace="8"></a>
								<% } else { %>
							...
							-->
								<td>
									...
									%>
										...
										<%  } else { %>
										<a href="/asanway/cyber/cyber_bodo_list.jsp?page=<%= i %>"><%= i %></a>&nbsp;
										<%  }
									  } %>
									<% if(totalP  == 0) { %>1<% } %>
								</td>
							 ...
							 -->
								<td>
									<%if(helper.getAftergroup() > 0){%>
										<a href="/asanway/cyber/cyber_bodo_list.jsp.jsp?page=<%=helper.getAftergroup()%>"><img src="../img/bt_05.gif" width="36" height="11" hspace="8"></a>
									<% } else { %>
										<img src="../img/bt_05.gif" width="36" height="11" hspace="8">
									<% } %>
								</td>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="cyber_bodo_write.jsp"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
