        ...
        <tr> 
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<form name="form" method="post" action="cyber_bodo_insert.jsp" enctype="multipart/form-data" onSubmit="return goInsert()">
				<input type="hidden" name="category" value="report">				

				
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>보도자료 등록</b></td>
                    </tr>
                    <tr> 
                      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" height="156">
                          ...
                          <tr> 
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">섬네일 
                              이미지</td>
                            <td style="padding-left:5;"> <input type="file" name="imgfile" size="50" style="width:300px;height:20px">(* 권장 이미지 사이즈 : 79 * 62)
                            </td>
                          </tr>
                          <tr> 
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr> 
                            ...
                            <td  style="padding: 10 10 10 10 ;">
								...
								<input type=file name='file1' size="50" style='width:400px;height:20px'><br>
								<input type=file name='file2' size="50" style='width:400px;height:20px;'><br>
								<input type=file name='file3' size="50" style='width:400px;height:20px'>
