              ...
              <tr>
                <td valign="top" style="padding: 15 0 0 20;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>임직원 경조사 </b></td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
						  <tr>
                            <td>
                              <form name="search" method="post" action="cyber_hero_list.jsp">
	                                        ...
	                                        <td width="180" > <table border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
	                                            <tr>
	                                              <td>
	                                              		...
	                                              		<%} else { %>
															<img src="/common/download.jsp?dir=hero&sysfilename=<%=imgfile%>" width="209" height="163">
	                                              		<%}%>
	                                              </td>
	                                            </tr>
	                                          </table></td>
	                                            ...
	                                            <tr>
	                                              <td height="20" align="right" >
	                                                <table border="0" cellspacing="0" cellpadding="0">
	                                                  <tr>
	                                                    <td>&nbsp;</td>
	                                                    <td style="padding-left:5;"><a href="cyber_hero_read.jsp?page=<%=currentP%>&idx=<%=idx%>"><b>more</b></a></td>
	                                                  </tr>
	                                                </table></td>
	                                            </tr>
	                                            <tr>
                          ...
                          <tr>
		                    ...
		                    %>
			                          ...
			                          <tr>
			                            ...
			                            <td></td>
			                            <td style="padding-left:5;"><a href="cyber_hero_list.jsp?page=<%=currentP%>&idx=<%= hm.get("IDX") %>"><%=b%><%=  Utility.getStringcut( 28, Utility.ko((String)hm.get("TITLE")) )%></b></a><% if( Utility.NewDay((String)hm.get("REGTIME")) ) {%> <img src="/asanway/img/bt_19.gif"><% } %></td>
			                            <td></td>
						...
						<Table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<%if(helper.getBeforegroup() > 0){%>
									<a href="/asanway/cyber/cyber_hero_list.jsp?page=<%=helper.getBeforegroup()%>"><img src="../img/bt_05.gif" width="36" height="11" hspace="8"></a>
								<% } else { %>
							...
							<!--
								...
								<%if(helper.getBefore() > 0){%>
									<a href="/asanway/cyber/cyber_hero_list.jsp?p=<%=helper.getBefore()%>"><img src="/admin/common/img/btn_pre.gif" border="0"></a>
								<% } else { %>
							...
							-->
								<td>
									...
									%>
										...
										<%  } else { %>
										<a href="/asanway/cyber/cyber_hero_list.jsp?page=<%= i %>"><%= i %></a>&nbsp;
										<%  }
									  } %>
									<% if(totalP  == 0) { %>1<% } %>
								</td>
							<!--
								<td width="64" align="right">
									<% if(helper.getAfter() > 0){%>
										<a href="/asanway/cyber/cyber_hero_list.jsp?p=<%=helper.getAfter()%>"><img src="/admin/common/img/btn_next.gif" border="0"></a>
									<% } else { %>
							 ...
							 -->
								<td>
									<%if(helper.getAftergroup() > 0){%>
										<a href="/asanway/cyber/cyber_hero_list.jsp?page=<%=helper.getAftergroup()%>"><img src="../img/bt_06.gif" width="36" height="11" hspace="8"></a>
									<% } else { %>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="cyber_hero_write.jsp"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
