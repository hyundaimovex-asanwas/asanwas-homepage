              ...
              <tr>
                <td valign="top" style="padding: 15 0 0 20;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<!--contents end -->
                    <form name="form" method="post" action="cyber_hero_insert.jsp" enctype="multipart/form-data"  onSubmit="return goInsert()">
						<input type="hidden" name="category" value="<%=category%>">
                    <tr>
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>임직원 경조사  등록</b></td>
                    </tr>
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="95">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"><input type="text" name="regday" style="width:100px;height:20px"  maxlength=10 onClick=Calendar(this);  ></td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr>
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">섬네일
                              이미지</td>
                            <td style="padding-left:5;"> <input type="file" name="imgfile" style="width:300px;height:20px" >(* 권장 이미지 사이즈 : 209 * 163)  </td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                            <td height="1" bgcolor="D3D2C3"></td>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;">
                        <div align="right"><input type=image src="../img/bt_07.gif" width="40" height="20" border="0"></a>
                        </div>
                      </td>
                    </tr>
                    <tr>
