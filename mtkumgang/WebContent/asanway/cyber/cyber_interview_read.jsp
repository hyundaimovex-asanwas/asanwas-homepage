...
<!--
	function goDel(idx){
		var idx = idx;
		if (confirm("삭제하시겠습니까?")) {
				location.href="/asanway/cyber/cyber_interview_delete.jsp?idx="+idx;
		}
	}
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td >
                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="cyber_interview_read.jsp?idx=<%= preview.get("IDX") %>"><%= Utility.ko( (String)preview.get("TITLE") )%></a></td>
                          </tr>
						<% } %>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
						...
						<% if( nextview.size() != 0 )  {%>
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="cyber_interview_read.jsp?idx=<%= nextview.get("IDX") %>"><%= Utility.ko( (String)nextview.get("TITLE") ) %></a></td>
                          </tr>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
                          </tr>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;">
                      		<a href="cyber_interview_modify.jsp?page=<%=request.getParameter("page")%>&idx=<%= read.get("IDX") %>"><img src="../img/bt_08.gif" width="40" height="20" border="0"></a>
                      		<a href="javascript:goDel(<%=read.get("IDX")%>)"><img src="../img/bt_09.gif" width="40" height="20" hspace="3" border="0"></a>
                      		<a href="cyber_interview_list.jsp"><img src="../img/bt_10.gif" width="40" height="20" border="0"></a>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
