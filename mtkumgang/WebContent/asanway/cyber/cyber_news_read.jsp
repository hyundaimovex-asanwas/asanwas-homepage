...
<!--
	function doDel(idx)
	{
		...
		if (confirm("삭제하시겠습니까?")) {
			...
			location.href="/asanway/cyber/cyber_news_delete.jsp?idx="+idx;
		} else {
                ...
                <td valign="top" style="padding: 15 0 0 20;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <!-- 이전글 다음글-->
						...
						<% if( preview.size() != 0 ) { %>
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="cyber_news_read.jsp?idx=<%= preview.get("IDX") %>"><%= Utility.ko( (String)preview.get("TITLE") )%></a></td>
                          </tr>
						<% } %>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
						...
						<% if( nextview.size() != 0 )  {%>
                          <tr>
                            ...
                            <td style="padding-left:5;"><a href="cyber_news_read.jsp?idx=<%= nextview.get("IDX") %>"><%= Utility.ko( (String)nextview.get("TITLE") ) %></a></td>
                          </tr>
                          <tr>
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
                          </tr>
                    ...
                    <tr>
                      ...
                      <a href="cyber_news_modify.jsp?idx=<%= read.get("IDX") %>"><img src="../img/bt_08.gif" width="40" height="20" border="0"></a>
                      <a href="javascript:doDel('<%= read.get("IDX")  %>')"><img src="../img/bt_09.gif" width="40" height="20" hspace="3" border="0"></a>
                      <a href="cyber_news_list.jsp"><img src="../img/bt_10.gif" width="40" height="20" border="0"></a>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
