        ...
        <tr> 
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<form name="form" method="post" action="cyber_news_insert.jsp" enctype="multipart/form-data" onSubmit="return goInsert()">
                          ...
                          <tr> 
                            ...
                            <!-- <textarea name="textarea" rows="5" wrap="VIRTUAL" style="width:400;"></textarea>-->
								<FCK:editor id="content" basePath="/FCKeditor/"
									...
									imageBrowserURL="/FCKeditor/imgupload/dir_Imglist.jsp"
