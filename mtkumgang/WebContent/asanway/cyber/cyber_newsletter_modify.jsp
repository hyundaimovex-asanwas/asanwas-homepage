        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<form name="form" method="post" action="cyber_newsletter_update.jsp" enctype="multipart/form-data" onSubmit="return goInsert()">
                       ...
                       <table width="100%" border="0" cellspacing="0" cellpadding="0" height="125">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;">
								...
								<option value="user" <%= read.get("CATEGORY").equals("user") ? "selected" : "" %>>일반회원</option>
								<option value="admin" <%= read.get("CATEGORY").equals("admin") ? "selected" : "" %>>관계자</option>
								</select>
                            </td>
                          </tr>
                          <tr>
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%">
										<tr>
											<td style="padding-bottom:6px">
												<img src="/common/download.jsp?filename=<%= Utility.ko((String)read.get("IMG"))%>&dir=newsletter&sysfilename=<%= Utility.ko((String)read.get("SYSIMG"))%>" border="0" width="580">
											</td>
                            ...
                            <script>
                            	...
                            	<!--
									...
									<div id="vimage1" style="display:<% if( read.get("IMG") == null && read.get("IMG").toString().trim().equals("") ) { %>block<%} else { %>none<% } %>">
										<img src="/img/newsletter/newsletter_popup_title.gif" width="580"></div>
