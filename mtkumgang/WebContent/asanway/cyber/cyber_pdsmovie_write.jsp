        ...
        <tr>
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<form name="form" method="post" action="cyber_pdsmovie_action.jsp?cmd=I" enctype="multipart/form-data" onSubmit="return goInsert()">
					<input type="hidden" name="category" value="pdsmovie">

                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>자료실 - 동영상 등록 </b></td>
                    </tr>
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="156">
                         <tr>
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"> <input type="text" name="movielink" style="width:400px;height:20px" >
                            </td>
                          </tr>
