                      ...
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="187">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;">
                            	<select name="section2"  style="width:150px;height:20px" >
                                      <option value="1" <% if( read.get("SECTION2").equals("1") ) { %>selected<% } %>>가판</option>
                                      <option value="2" <% if( read.get("SECTION2").equals("2") ) { %>selected<% } %>>종합판</option>
                                      <option value="3" <% if( read.get("SECTION2").equals("3") ) { %>selected<% } %>>석간 </option>
                                </select>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;"> <input type="text" name="fileloc" style="width:200px;height:20px" value="<%= (read.get("FILELOC") == null)?"":read.get("FILELOC")%>"> ex) 20051115  (*서버 절대 경로 : /was/file_upload/scrappaper/)
                            </td>
                          </tr>
