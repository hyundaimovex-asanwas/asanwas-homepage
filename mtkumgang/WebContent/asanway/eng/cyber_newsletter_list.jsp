          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" style="padding: 15 0 0 20;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td>
                      <a href="cyber_newsletter_list.jsp?category=enguser">일반유저</a> / <a href="cyber_newsletter_list.jsp?category=engadmin">관계자</a>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="cyber_newsletter_write.jsp?category=<%=category%>"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
