...
<!--
	function doDel(idx){
		...
		if (confirm("삭제하시겠습니까?")) {
			...
			location.href="/asanway/eng/cyber_newsletter_action.jsp?cmd=D&idx="+idx;
		}
	}
	...
	function sendMail(){
		if (confirm("메일을 발송하시겠습니까 ?")) {
			// 확인 버튼을 눌렀을 때 실행해야 할 프로그램
			location.href="cyber_newsletter_action.jsp?cmd=send&idx=<%= read.get("IDX") %>&category=<%= category %>";
		}
	}
//-->
              ...
              <tr>
                <td valign="top" style="padding: 15 0 0 20;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr bgcolor="F2F1E2">
                                  ...
                                  <td bgcolor="F2F1E2" style="padding-left:5;"><%= read.get("CATEGORY").equals("enguser") ? "일반회원" : "관계자"  %></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                      <td valign="top" style="padding:10 10 10 10;"><img src="/asanway/common/download.jsp?filename=<%= Utility.ko((String)read.get("IMG"))%>&dir=engnewsletter&sysfilename=<%= Utility.ko((String)read.get("SYSIMG"))%>" border="0" style="width:580px;"></td>
                    </tr>
                    <tr>
