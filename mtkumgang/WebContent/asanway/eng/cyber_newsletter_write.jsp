        ...
        <tr>
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<form name="form" method="post" action="cyber_newsletter_action.jsp?cmd=I" enctype="multipart/form-data" onSubmit="return goInsert()">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="125">
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;">
								...
								<option value="enguser">일반회원</option>
								<option value="engadmin">관계자</option>
								</select>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <script>
                            	...
                            	<!--
									...
									<div id="vimage1" style="display:block; padding-top:5px;"><img src="/english/img/common/newsletter_popup_title.gif" width="580"></div>
