...
%>
	...
	<% if(result > 0 ) { %>
			<script language=javascript>
				alert('등록되었습니다.');
				location.replace('/asanway/eng/cyber_pdsmovie_list.jsp');
			</script>
	<% } else {	%>
			<script language=javascript>
...
%>
		<% if(result > 0 ) { %>
				<script language=javascript>
					alert('수정되었습니다.');
					location.href="/asanway/eng/cyber_pdsmovie_read.jsp?idx=<%=request.getAttribute("idx")%>";
				</script>
		<% } else {	%>
				<script language=javascript>
...
%>
		<% if(result > 0 ) { %>
				<script language=javascript>
					alert('삭제되었습니다..');
					location.href="/asanway/eng/cyber_pdsmovie_list.jsp";
				</script>
		<% } else {	%>
				<script language=javascript>
