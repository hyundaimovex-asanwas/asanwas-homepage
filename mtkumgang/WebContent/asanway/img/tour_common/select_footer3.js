...
SS_ENV.CR.ReverseBackground = '#DFDFDF';
SS_ENV.CR.ReverseText = '#666666';
SS_ENV.CR.Border = '#F0F0F0';
SS_ENV.CR.BorderActive = '#E9E9E9';
SS_ENV.ImgPrefix = '';
SS_ENV.DefaultHeight =11;
SS_ENV.ButtonWidth = 14;
...
SS_ENV.OptionNobrStyle = ''
  + ' font-size:10px;padding-left:5px;line-height:11px;'
  + ' font-family:verdana;color:#707070;';
// SaySelect Variables
...
function SS_create (srcHTML, ListMax, bAutoDetect, ListUpDown)
{
  // property
  ...
  if(ListUpDown=="up"){
  	this.bListDown = (ListMax && '-'==ListMax.toString().substr(0, 1)) ? true : false;  
  } else {
...
function SS_write (srcHTML, ListMax, bAutoDetect, ListUpDown)
{
  var oSS = new SS_create(srcHTML, ListMax, bAutoDetect, ListUpDown);
  oSS.display();
  return oSS;
}
...
function SS_createTitleDiv ()
{
  this.TitleDiv = SS_createElement(""
    ...
    + "    <td width="+(SS_ENV.ButtonWidth + 1 )+" align=center style='word-wrap:normal'></td>"
    + "    <td style='display:none' width="+(SS_ENV.ButtonWidth + 1 )+" align=center style='word-wrap:normal'></td>"
  ...
  this.TitleTable.cells(0).childNodes(0).innerText = this.options[this.selectedIndex].innerText;
  this.TitleTable.cells(1).innerHTML = "<img src='../../asanway/img//tour_img/select_arrow.gif' border=0 align=absmiddle>";
  this.TitleTable.cells(2).innerHTML = "<img src='../../asanway/img//tour_img/select_arrow_on.gif' border=0 align=absmiddle>";
  this.TitleTable.cells(3).appendChild(this.select);
  this.TitleWrapper = document.createElement(""
    + "<img src='../../asanway/img//tour_img/spacer.gif'"
