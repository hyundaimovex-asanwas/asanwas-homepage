                  ...
                  <table width="100%" border="0" cellspacing="10" cellpadding="0">
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;">
								...
								<input type="radio" name="gender" value="F"  <%if(read.get("GENDER").equals("F")){%> checked <%}%>>여 &nbsp;
                            	<input type="radio" name="gender" value="M" <%if(read.get("GENDER").equals("M")){%> checked <%}%>>남  &nbsp;
							</td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                          ...
                          <tr>
                            ...
                            <td style="padding-left:5;">
	                            <input type="radio" name="addrgbn" value="H" <%if(read.get("ADDRGBN").equals("H")){%> checked <%}%>>자택 &nbsp;
	                            <input type="radio" name="addrgbn" value="C" <%if(read.get("ADDRGBN").equals("C")){%> checked <%}%>>직장 &nbsp; &nbsp;
	                            <font color="bbbbbb">|</font>&nbsp;&nbsp;
	                            <input type=hidden name="zip" value="<%=read.get("ZIP")%>">
	                            <input type=text name="zip1" value="<%=read.get("ZIP").toString().substring(0,3)%>" size=3>-
	                            <input type=text name="zip2" value="<%=read.get("ZIP").toString().substring(3,6)%>" size=3>
                          ...
                          <tr>
                            ...
                            <td  style="padding: 10 10 10 10 ;">
                            	<input type="radio" name="telgbn" value="H" <%if(read.get("TELGBN").equals("H")){%> checked <%}%>>자택&nbsp;
	                            <input type="radio" name="telrgbn" value="C" <%if(read.get("TELGBN").equals("C")){%> checked <%}%>>직장&nbsp; &nbsp;
	                             <font color="bbbbbb">|</font>&nbsp;&nbsp;
                          ...
                          <!--
                          <tr>
                          	<input type=hidden name="fax" value="<%=read.get("FAX")%>">
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;">FAX</td>
                            <td style="padding-left:5;">
                            	 <input type=text name="fax1" value="<%=(read.get("TITLE") == null) ? "" : Utility.getTel((String)read.get("FAX"),1)%>" size=4> -
	                             <input type=text name="fax2" value="<%=(read.get("TITLE") == null) ? "" :Utility.getTel((String)read.get("FAX"),2)%>" size=4> -
	                             <input type=text name="fax3" value="<%=(read.get("TITLE") == null) ? "" :Utility.getTel((String)read.get("FAX"),3)%>" size=4>
                            </td>
                          </tr>
                          <tr>
                            <td height="1" bgcolor="D3D2C3"></td>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;">
                      		<a href="javascript:window.close();"><img src=/asanway/img/pop_bt_05.gif border=0></a>
                      </td>
                    </tr>
                    <tr>
