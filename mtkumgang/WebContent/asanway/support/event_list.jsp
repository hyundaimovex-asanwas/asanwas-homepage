                ...
                <td valign="top" style="padding: 15 0 0 20;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
                          <tr>
                            ...
                            <form name="search" method="get" action="event_list.jsp">
                    ...
                    <tr>
                      <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="3" bgcolor="D3D2C3" <%= (category.equals("entry") ) ? "colspan=15" : "colspan=13" %>></td>
                          </tr>
                          <tr>
                            <td height="6"></td>
						...
						<% } %>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td width="70" align="center"><font color="433C2C">시작일</font></td>
                            <td></td>
                            <td width="70" align="center"><font color="433C2C">마감일</font></td>
                            <td></td>
                            <td width="70" align="center"><font color="433C2C">등록일</font></td>
						<% if( category.equals("entry") ) {  %>
                            <td></td>
                            <td width="70" align="center"><font color="433C2C">진행상태</font></td>
						<% }  %>
                            <td></td>
                          ...
                          <tr>
                            <td height="1" bgcolor="D3D2C3" <%= (category.equals("entry") ) ? "colspan=15" : "colspan=13" %>></td>
                          </tr>

					<% if ( list.size() == 0 ) { %>
                          <tr>
                            <td height="25" align="center" colspan="15">등록된 글이 없습니다.
                          </tr>
                    <% } else {
                    ...
                    %>
                          <tr>
                            ...
                            <td></td>
                            <td style="padding-left:5;"><a href="event_read.jsp?category=<%= category %>&idx=<%= hm.get("IDX") %>"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 22, Utility.ko((String)hm.get("TITLE")) ) %></a><% if( Utility.NewDay((String)hm.get("REGTIME")) ) {%> <img src="/asanway/img/bt_19.gif"><% } %></td>
                            <td></td>
                            <td align="center"><%= hm.get("STARTDATE").toString().substring(0,4) %>.<%= hm.get("STARTDATE").toString().substring(4,6) %>.<%= hm.get("STARTDATE").toString().substring(6,8) %></td>
                            <td></td>
                            <td align="center"><%= hm.get("ENDDATE").toString().substring(0,4) %>.<%= hm.get("ENDDATE").toString().substring(4,6) %>.<%= hm.get("ENDDATE").toString().substring(6,8) %></td>
                            <td></td>
                            <td align="center"><%= hm.get("REGTIME").toString().substring(0, 10) %></td>
						<% if(category.equals("entry") ) { %>
                            <td></td>
                            <td align="center"><!--  <%= hm.get("PROGRESS") %>-->
                            <%
                            	if( Utility.dateCompareB( (String)hm.get("STARTDATE"), ymd) && Utility.dateCompareB( ymd, (String)hm.get("ENDDATE")) ){
                            	    out.write("	진행중");
                            	} else if( Utility.dateCompareB(ymd, (String)hm.get("STARTDATE") ) ){
									out.write("	대기중");
                            	} else {
                            		out.write("종료");
								}
					...
					<% } } %>
                          ...
                          <tr>
                            <td height="2" bgcolor="D3D2C3" <%= (category.equals("entry") ) ? "colspan=15" : "colspan=13" %>></td>
                          </tr>
						...
						<Table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<%if(helper.getBeforegroup() > 0){%>
									<a href="event_list.jsp?category=<%= category %>&page=<%=helper.getBeforegroup()%>"><img src="../img/bt_05.gif" border=0 width="36" height="11" hspace="8"></a>
								<% } else { %>
							...
							-->
								<td>
									...
									%>
										...
										<%  } else { %>
										<a href="event_list.jsp?category=<%= category %>&page=<%= i %>"><%= i %></a>&nbsp;
										<%  }
									  } %>
									<% if(totalP  == 0) { %>1<% } %>
								</td>
							 ...
							 -->
								<td>
									<%if(helper.getAftergroup() > 0){%>
										<a href="event_list.jsp?category=<%= category %>&page=<%=helper.getAftergroup()%>"><img src="../img/bt_06.gif" border=0 width="36" height="11" hspace="8"></a>
									<% } else { %>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="event_write.jsp?category=<%= category %>"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
