                          ...
                          <tr> 
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr bgcolor="F2F1E2"> 
                                  <td width="100" height="30" align="center" bgcolor="DEDDCF">진행상태</td>
                           ...
                           %>
                                ...
                                <% } %>
                                <tr bgcolor="F2F1E2"> 
                                	<td width="100" height="30" align="center" bgcolor="DEDDCF">기간</td>
                                	<td bgcolor="F2F1E2" style="padding-left:5;"><%= read.get("STARTDATE").toString().substring(0,4) %>년 <%= read.get("STARTDATE").toString().substring(4,6) %>월<%= read.get("STARTDATE").toString().substring(6,8) %>일 ~ 
											<%= read.get("ENDDATE").toString().substring(0,4) %>년 <%= read.get("ENDDATE").toString().substring(4,6) %>월<%= read.get("ENDDATE").toString().substring(6,8) %>일                                 	
                                	</td>
                                </tr>
                                <tr> 
                                  <td height="1" bgcolor="D3D2C3"></td>
                    		...
                    		<td width="100" valign="top" align="center">
		                    	...
		                    	<td>
		                    		...
		                    		<% if(commentlist.size() == 0 ) {  %>
			                    		...
			                    		<tr>
				                    		<td colspan="4"><a href="event_excel.jsp?idx=<%= read.get("IDX") %>">참여자 정보 Excel 다운로드</a>
				                    	</td>
			                    		</tr>
			                    		<% } %>
			                    		<% } } %>
