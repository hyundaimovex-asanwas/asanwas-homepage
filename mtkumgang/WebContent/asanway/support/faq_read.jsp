...
<!--
	function doDel(idx)
	{
		...
		if (confirm("삭제하시겠습니까?")) {
			...
			location.href="faq_delete.jsp?category=<%= category %>&idx="+idx;
		} else {
              ...
              <tr> 
                <td valign="top" style="padding: 15 0 0 20;"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>FAQ 내용보기</b></td>
                    </tr>
                    <tr> 
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
                          <tr> 
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr bgcolor="F2F1E2"> 
                                  <td width="100" height="30" align="center" bgcolor="DEDDCF">카테고리</td>
                                  <td colspan="3" bgcolor="F2F1E2" style="padding-left:5;"><%= section %></td>
                                </tr>
                                <tr> 
                                ...
                                <tr bgcolor="F2F1E2"> 
                                  <td width="100" height="30" align="center" bgcolor="DEDDCF">질문</td>
                      ...
                      <!-- 이전글 다음글-->
						...
						<% if( preview.size() != 0 ) { %>
                          ...
                          <tr> 
                            ...
                            <td style="padding-left:5;"><a href="faq_read.jsp?category=<%= category %>&idx=<%= preview.get("IDX") %>"><%= Utility.ko( (String)preview.get("TITLE") )%></a></td>
                          </tr>
						<% } %>
                          <tr> 
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
						...
						<% if( nextview.size() != 0 )  {%>
                          <tr> 
                            ...
                            <td style="padding-left:5;"><a href="faq_read.jsp?category=<%= category %>&idx=<%= nextview.get("IDX") %>"><%= Utility.ko( (String)nextview.get("TITLE") ) %></a></td>
                          </tr>
                          <tr> 
                            <td colspan="2" height="1" bgcolor="DBDACB"></td>
                          </tr>
                    ...
                    <tr> 
                      ...
                      <a href="faq_modify.jsp?category=<%= category %>&idx=<%= read.get("IDX") %>"><img src="../img/bt_08.gif" width="40" height="20" border="0"></a>
                      <a href="javascript:doDel('<%= read.get("IDX")  %>')"><img src="../img/bt_09.gif" width="40" height="20" hspace="3" border="0"></a>
                      <a href="faq.jsp"><img src="../img/bt_10.gif" width="40" height="20" border="0"></a>
                      </td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
