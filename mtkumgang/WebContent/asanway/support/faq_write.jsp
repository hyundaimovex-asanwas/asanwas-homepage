              ...
              <tr>
				...
				<input type="hidden" name="status" value="0">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>FAQ 등록
					</b></td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="94">
                          ...
                          <tr>
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;"><p>답변</p>
                              </td>
