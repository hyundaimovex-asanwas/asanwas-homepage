...
<%
	...
	bean.List(request, response, "gonggi");
%>
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" style="padding: 15 0 0 20;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>뉴스</b></td>
                    </tr>
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-style:solid; border-color:#DEDDCF; border-width:1;">
                          <tr>
                            ...
                            <form name="search" method="get" action="cyber_news_list.jsp">
                                <tr>
					...
					<% if ( list.size() == 0 ) { %>
                          <tr>
                            <td height="25" align="center" colspan="9">등록된 뉴스가 없습니다.
                          </tr>
                    <% } else {
                    ...
                    %>
                          <tr>
                            <td height="25" align="center"><a href="cyber_news_read.jsp?idx=<%= hm.get("IDX") %>"><%= num-- %></a></td>
                            <td></td>
                            <td style="padding-left:5;"><a href="cyber_news_read.jsp?idx=<%= hm.get("IDX") %>"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 25, Utility.ko((String)hm.get("TITLE")) ) %></a><% if( Utility.NewDay((String)hm.get("REGTIME")) ) {%> <img src="/asanway/img/bt_19.gif"><% } %></td>
                            <td></td>
						...
						<Table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<%if(helper.getBeforegroup() > 0){%>
									<a href="/asanway/cyber/cyber_news_list.jsp?page=<%=helper.getBeforegroup()%>"><img src="../img/bt_05.gif" border=0 width="36" height="11" hspace="8"></a>
								<% } else { %>
							...
							-->
								<td>
									...
									%>
										...
										<%  } else { %>
										<a href="/asanway/cyber/cyber_news_list.jsp?page=<%= i %>"><%= i %></a>&nbsp;
										<%  }
									  } %>
									<% if(totalP  == 0) { %>1<% } %>
								</td>
							 ...
							 -->
								<td>
									<%if(helper.getAftergroup() > 0){%>
										<a href="/asanway/cyber/cyber_news_list.jsp?page=<%=helper.getAftergroup()%>"><img src="../img/bt_06.gif" border=0 width="36" height="11" hspace="8"></a>
									<% } else { %>
                    ...
                    <tr>
                      <td align="right"   style="padding-top:5;"><a href="cyber_news_write.jsp"><img src="../img/bt_07.gif" width="40" height="20" border="0"></a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
