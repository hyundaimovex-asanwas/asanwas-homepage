        ...
        <tr> 
          ...
          <td valign="top" bgcolor="FCFCF6"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<form name="form" method="post" action="qna_update.jsp" onSubmit="return goUpdate()">
				<input type="hidden" name="category" value="<%=category %>">
				<input type="hidden" name="idx" value="<%= read.get("IDX") %>">
								                
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="40" class="large"><img src="../img/bt_03.gif" width="10" height="14" align="absmiddle">&nbsp;&nbsp;<b>QNA 수정
					</b></td>
                    </tr>
                    <tr> 
                      <td>                                           
                       <table width="100%" border="0" cellspacing="0" cellpadding="0" height="125"><!--
                          ...
                          <tr> 
                            ...
                            <textarea name="content" rows="5" wrap="VIRTUAL" style="width:100%;height:400px;"><%= Utility.ko( (String)read.get("CONTENT") ) %></textarea>
                            </td>
                          </tr>
                          <tr> 
                            <td height="1" bgcolor="D3D2C3"></td>
