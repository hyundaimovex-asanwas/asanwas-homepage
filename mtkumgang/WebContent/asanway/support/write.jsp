...
* 작성인 : 김종문
* 작성날자 : 2005년 10월 21일
* 요약 설명 : Category 정보 받아서 공지사항 및 FAQ 등록
**
* 수정시간  : 수정인 : 수정내용
*
*
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="94">
                          ...
                          <tr> 
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;"><%= ( category.equals("gonggi") ) ? "제목" : "질문" %></td>
                          ...
                          <tr> 
                            <td height="30" bgcolor="F2F1E2" valign="top"  style="padding: 10 0 0 15 ;"><p><%= ( category.equals("gonggi") ) ? "내용" : "답변" %></p>
                              </td>
