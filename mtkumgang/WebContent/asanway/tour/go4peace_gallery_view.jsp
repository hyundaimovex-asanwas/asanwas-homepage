...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		...
		form.action = "go4peace_gallery_delete_ok.jsp?idx="+<%= read.get("IDX") %>;
		form.submit();
	}else{
		return;
	}
          	      ...
          	      <TABLE cellspacing=0 cellpadding=0 width=650>
          	       <!-- loc -->
          	         <TR valign=top>
          		        ...
          		        <span class=locon>회원갤러리(PLZ)</A> </span></TD>
          	          </TR>
          	       <!-- //loc -->
          	       </TABLE>
                  </TD>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
                			...
                			<tr>
                				<td class='title'><img src=../img/tour_img/bu_blue_title.gif align=texttop class=rmar10>회원갤러리(PLZ)</td>
                			</tr>
                			<tr><td height=17></td></tr>
                			</table>
                
                		<form name="writeFrm" action="go4peace_gallery_modify_ok.jsp" method="post" enctype="multipart/form-data">
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
	                         ...
	                         <td class=lpad10 style='padding-top:7;padding-bottom:7;' height=150 valign=top>
															<% if(read.get("FILE_NAME0") != null) { %>
																<img src="/common/download.jsp?dir=go4peace&sysfilename=<%= read.get("FILE_NAME0") %>" onload="if(this.width>530) this.width=530;"><br><br>
															<% } %>
