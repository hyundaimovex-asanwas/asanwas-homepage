...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		...
		form.action = "go4peace_notice_delete_ok.jsp?idx="+<%= read.get("IDX") %>;
		form.submit();
	}else{
		return;
	}
          	...
          	<TR valign=top>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		...
                		<form name="writeFrm" action="go4peace_notice_modify_ok.jsp" method="post" enctype="multipart/form-data">
	  <input type="hidden" name="CATEGORY" value="go4notice">
	  ...
	  <input type="hidden" name="idx" value="<%= idx %>">
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr height=28>
                                                              ...
                                                              <textarea name="CONTENT" rows="15" cols="86"><%= (read.get("CONTENT") == null) ? "" : Utility.ko((String)read.get("CONTENT")) %></textarea> 
                                 </td>
                				</tr>
