      ...
      <table width="850" height="100%" border="0" cellpadding="0" cellspacing="0">
          	      ...
          	      <TABLE cellspacing=0 cellpadding=0 width=650>
          	       <!-- loc -->
          	         <TR valign=top>
          		        ...
          		        <span class=locon>여행후기(포천PLZ)</span>
          		        </TD>
          	          </TR>
          	       <!-- //loc -->
          	       </TABLE>
          		...
          		<TD width=650 valign=top>
          			...
          			<tr>
          				<td>
          					...
          					<tr>
          						<td class='title'><img src='../img/tour_img/bu_blue_title.gif' align=texttop class=rmar10>여행후기(포천PLZ)</td>
          					</tr>
          					</table>
          					<br>
          					<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		%>
          						<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                    <td><%= num-- %></td>
                                    <td align="left"><a href="go4peace_travel_view.jsp?idx=<%= hm.get("IDX") %>&page=<%=currentP%>&category=go4travel&searchkey=<%=searchkey%>&searchvalue=<%=searchvalue%>" class="board_tx03"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 28, Utility.ko((String)hm.get("TITLE")) ) %></a></td>
			...
			<Table border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
					...
					<%if(helper.getBeforegroup() > 0){%>
						<a href="go4peace_travel.jsp?category=go4travel&page=<%=helper.getBeforegroup()%>"><img src="/asanway/img/imjk_img/btn_prev.gif" hspace="7"></a>
					<% } else { %>
					...
					<td>
						...
						%>
							...
							<%  } else { %>
							<a href="go4peace_travel.jsp?category=go4travel&page=<%= i %>"><%= i %></a>&nbsp;
							<%  }
						  } %>
						<% if(totalP  == 0) { %>1<% } %>
					</td>
					<td>
						<%if(helper.getAftergroup() > 0){%>
							<a href="go4peace_travel.jsp?category=go4travel&page=<%=helper.getAftergroup()%>"><img src="/asanway/img/imjk_img/btn_next.gif" hspace="7"></a>
						<% } else { %>
			...
			<!-- --------------------------- 페이지 ----------------------- -->
                      ...
                      <tr>
          					...
          					<tr>
          						<td align=right>
          							<form name="search" method="get" action="go4peace_travel.jsp">
