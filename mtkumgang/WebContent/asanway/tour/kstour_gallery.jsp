          			...
          			<td>
						...
						<td width="200" align="center">
						  ...
						  <tr> 
						    <td colspan="3">
						      <div style="border:1px solid;border-color:#D0D0D0;width:123;height:93;">
						      	<a href="kstour_gallery_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>">
						  ...
						  <tr> 
						    ...
						    <td width="117"><a href="kstour_gallery_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><u><%=Util.getStringLimit((title).trim(),8)%></u></a></td>
						    <td width="3" rowspan="3"></td>
						  </tr>
						  <tr> 
				...
				%>
          				...
          				<table width=100% border=0 cellspacing=0 cellpadding=0>
          					<tr>
			                      ...
			                      "kstour_gallery.jsp", "500", key_str ,
          				...
          				<tr>
          					<td align=right>
							<!--검색 START -->
							  <FORM METHOD=POST NAME=searchForm ACTION="kstour_gallery.jsp">
