...
function colDeleteComment(board_seq, comment_seq){
	if(confirm("삭제 하시겠습니까?")){
		...
		document.f1.action = "kstour_gallery_ok.jsp";
...
<FORM METHOD=POST name="f1" ACTION="kstour_gallery_ok.jsp"  onsubmit="return chk();" >
			...
			<table border=0 cellspacing=0 cellpadding=0>
				<tr>
					<td  border="0" ><%=HtmlUtil.doPageCut(requestedPage, pageCount , position , 
									  "kstour_gallery_comment.jsp", "500", key_str+"&board_seq="+board_seq ,
