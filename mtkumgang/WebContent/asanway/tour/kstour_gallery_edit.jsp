...
<%@ page import="kr.co.imjk.board.dao.KsTourGalleryBoard"%>
...
if (board_seq > 0){
	//DAO
	KsTourGalleryBoard dao = new KsTourGalleryBoard();
    //DTO
          ...
          <TABLE cellspacing=0 cellpadding=0 width=650>
          	...
          	<TR valign=top>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
							...
							<FORM METHOD=POST name="mainForm" ACTION="kstour_gallery_ok.jsp" >
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                                 <td align=right>
								  ...
								  <img src=<%=imageServer%>tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='kstour_gallery.jsp'"><img src=<%=imageServer%>tour_img/btn_r.gif align=absmiddle>         					
                                 </td>
                				</tr>
                			</table>
                            </FORM>
				...
				<table width=100% border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td>
								<iframe id="myframe" src="kstour_gallery_comment.jsp?board_seq=<%=board_seq%>" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"  vspace="0" hspace="0" style="overflow:visible; width:100%;"></iframe>
						</td>
