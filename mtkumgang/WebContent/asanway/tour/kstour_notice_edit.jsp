...
String saveDirName 		=  Config.getInstance().getProperty("imjkmd","noticeEditorUpload");
...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		obj.cmd.value = "del";
		obj.action = "kstour_notice_ok.jsp";
		obj.submit();
	}else{
		return;
	}
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
                			...
                			<FORM METHOD=POST name="mainForm" ACTION="kstour_notice_ok.jsp" onsubmit="return chk();">
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                                 <td align=right>
                                  ...
                                  <img src=../img/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='kstour_notice.jsp?page=<%=requestedPage%><%=key_str%>'"><img src=../img/tour_img/btn_r.gif align=absmiddle>         					
                                 </td>
                				</tr>
                			</table>
                			</FORM>
