...
function goSearch(){
   ...
   if (form.keyword.value == ""){
    ...
    form.action="kstour_prevent.jsp";
    form.submit();
          	      ...
          	      <TABLE cellspacing=0 cellpadding=0 width=650>
          	       <!-- loc -->
          	         <TR valign=top>
          		        ...
          		        <span class=locon>지난이벤트보기(개성)</span>
          		        </TD>
          	          </TR>
          	       <!-- //loc -->
          	       </TABLE>
          			...
          			<tr>
          				<td>
          					...
          					<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								%>
          						<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                    ...
                                    <td align="left"><a href="kstour_prevent_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><%=title%></a></td>
          					...
          					<table width=100% border=0 cellspacing=0 cellpadding=0>
			                      ...
			                      "kstour_prevent.jsp", "500", key_str ,
			                      imageServer+"/imjk_img/", blockPerPage)%>
                                   ...
                                   <tr>
          						  <td colspan=2 align=right>
          						    <img src=../img/tour_img/btn_l.gif align=absmiddle><input type=button value="신규등록" class="btn" onclick="location.href='kstour_prevent_edit.jsp'" onfocus="this.blur();"><img src=../img/tour_img/btn_r.gif align=absmiddle style='margin-right:1;'></td>  
          						  </td>
          						</tr>
          					</table>
