...
<%@ page import="kr.co.imjk.board.dao.KsTourPrRoom"%>
...
// DB연결 객체
KsTourPrRoom dao = new KsTourPrRoom();
          		...
          		<TD width=650 valign=top>
          			...
          			<tr>
          				<td>
          					...
          					<tr>
          						<td class='title'><img src='../img/tour_img/bu_blue_title.gif' align=texttop class=rmar10>홍보자료실</td>
          					</tr>
          					</table>
          					<br>
          					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						%>
          						...
          						<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                    <td><%=board_seq%></td>
                                    <td><%=type_code%></td>
                                    <td align="left"><a href="kstour_prroom_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><%=title%></a></td>
                                    <td><%=regdate%></td>
                                    <td><%=read_num%></td>                  
          						</tr>
          						<tr><td colspan=5 height=1 class=linec1></td></tr>	   						
                        ...
                        %>																																																													
          					...
          					<table width=100% border=0 cellspacing=0 cellpadding=0>
                                ...
                                <td align=center>
                                 ...
                                 <table width=600 border=0 cellspacing=0 cellpadding=0>
                                  <tr>
                                   <td align=center>
                                   <%=HtmlUtil.doPageCut(requestedPage, pageCount , position , "kstour_prroom.jsp", "500", key_str ,imageServer+"/imjk_img/", blockPerPage)%>
                                   </td>
                                  </tr>
                                 </table>
                                 <!--페이징 -->
                             ...
                             <tr>
                                <td colspan=2 align=right>
                                  <img src=../img//tour_img/btn_l.gif align=absmiddle><input type=button value="신규등록" class="btn" onclick="location.href='kstour_prroom_edit.jsp'" onfocus="this.blur();"><img src=../img//tour_img/btn_r.gif align=absmiddle style='margin-right:1;'></td>  
                                </td>
          					 </tr>
          					</table>
          					...
          					<tr>
							      ...
							      <!--검색 START -->
							      <FORM METHOD=POST NAME=searchForm ACTION="kstour_prroom.jsp">
