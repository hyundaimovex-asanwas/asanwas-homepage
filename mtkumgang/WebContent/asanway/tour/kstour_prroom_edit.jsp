                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
                			...
                			<tr>
                				<td class='title'><img src=<%=imageServer%>/tour_img/bu_blue_title.gif align=texttop class=rmar10>홍보자료실</td>
                			</tr>
                			<tr><td height=17></td></tr>
                			</table>

							<FORM METHOD=POST name="mainForm" ACTION="kstour_prroom_ok.jsp"  encType="multipart/form-data">
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                                 <td align=right>
								  ...
								  <%}%>
								  <img src=<%=imageServer%>/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='kstour_prroom.jsp'"><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle>         					
                                 </td>
                				</tr>
                			</table>
                            </FORM>
