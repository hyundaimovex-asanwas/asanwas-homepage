          			...
          			<td>
          				...
          				<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr><td colspan=4 height=1 class=linec1></td></tr>
          					...
          					<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                   ...
                                   <td><%=type_name%></td>
                                   <td align=left><a href="kstour_question_edit.jsp?board_seq=<%=board_seq%><%=key_str%><%=page_str%>"><%=Util.getStringLimit(title,30)%></a></td>
                                   <td><%=read_num%></td>
          					</tr>
          					<tr><td colspan=4 height=1 class=linec1></td></tr>
          						<%
          				...
          				<table width=100% border=0 cellspacing=0 cellpadding=0>
          					<tr>
			                      ...
			                      "kstour_question.jsp", "500", key_str ,
          					...
          					<tr>
          					  <td colspan=2 align=right>
          					    <img src=<%=imageServer%>tour_img/btn_l.gif align=absmiddle><input type=button value="신규등록" class="btn" onclick="location.href='kstour_question_edit.jsp'" onfocus="this.blur();"><img src=<%=imageServer%>tour_img/btn_r.gif align=absmiddle style='margin-right:1;'></td>  
          					  </td>
          					</tr>
          				</table>
          				...
          				<tr>
          					<td align=right>
							<!--검색 START -->
							  <FORM METHOD=POST NAME=searchForm ACTION="kstour_question.jsp">
