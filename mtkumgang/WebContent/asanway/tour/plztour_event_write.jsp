...
function write_ok() {
	...
	if(form.TITLE.value.length <= 0) {
		...
		form.TITLE.focus();
		return;
	} else if(form.ST_DATE.value.length <= 0) {
		alert("시작일 을 입력해 주세요.");
		form.CONTENT.focus();
		return;
	} else if(form.ED_DATE.value.length <= 0) {
		alert("종료일 을 입력해 주세요.");
		form.CONTENT.focus();
		return;
	}
          	      ...
          	      <TABLE cellspacing=0 cellpadding=0 width=650>
          	       <!-- loc -->
          	         <TR valign=top>
          		        ...
          		        <span class=locon>이벤트</A> </span></TD>
          	          </TR>
          	       <!-- //loc -->
          	       </TABLE>
                  </TD>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
                			...
                			<tr>
                				<td class='title'><img src=../img/tour_img/bu_blue_title.gif align=texttop class=rmar10>이벤트</td>
                			</tr>
                			<tr><td height=17></td></tr>
                			</table>
                		<form name="writeFrm" action="plztour_event_write_ok.jsp" method="post" enctype="multipart/form-data">
