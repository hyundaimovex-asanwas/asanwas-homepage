          	...
          	<TR valign=top>
          		...
          		<TD width=650 valign=top>
											    ...
											    <% if ( list.size() == 0 ) { %>
											      ...
											      <!-- 01 -->
															      ...
															      <table width="210" cellspacing="0" cellpadding="0" border="0">
																      	...
																      	<td>
																	        ...
																	        <tr>
																	        	<td bgcolor="#FFFFFF" align="center">
																	        		<a href=plztour_gallery_view.jsp?idx=<%= hm.get("IDX") %>&page=<%=currentP%>&category=gallery&searchkey=<%=searchkey%>&searchvalue=<%=searchvalue%>>
																	        			<img src="/common/download.jsp?dir=plz&sysfilename=<%= hm.get("FILE_NAME0") %>" border="0" width="200" height="150"></a>
																	        		</td>
																	        </tr>
																	        </table>
																      ...
																      <tr>
																      	<td height="25"><a href="plztour_gallery_view.jsp?idx=<%= hm.get("IDX") %>&page=<%=currentP%>&category=gallery&searchkey=<%=searchkey%>&searchvalue=<%=searchvalue%>" class="gallerytxt"><%= (hm.get("TITLE") == null) ? "" : Utility.getStringcut( 28, Utility.ko((String)hm.get("TITLE")) ) %></a></td>
																      </tr>
																      <tr>
																      	<td>
																	        <table width="100%" cellspacing="0" cellpadding="0" border="0">
																								...
																								<Table border="0" cellspacing="0" cellpadding="0" align="center">
																									<tr>
																										...
																										<%if(helper.getBeforegroup() > 0){%>
																											<a href="plztour_gallery.jsp?category=gallery&page=<%=helper.getBeforegroup()%>"><img src="/asanway/img/imjk_img/btn_prev.gif" hspace="7"></a>
																										<% } else { %>
																										...
																										<td>
																											...
																											%>
																												...
																												<%  } else { %>
																												<a href="plztour_gallery.jsp?category=gallery&page=<%= i %>"><%= i %></a>&nbsp;
																												<%  }
																											  } %>
																											<% if(totalP  == 0) { %>1<% } %>
																										</td>
																										<td>
																											<%if(helper.getAftergroup() > 0){%>
																												<a href="plztour_gallery.jsp?category=gallery&page=<%=helper.getAftergroup()%>"><img src="/asanway/img/imjk_img/btn_next.gif" hspace="7"></a>
																											<% } else { %>
                      ...
                      <tr>
          					...
          					<tr>
          						<td align=right>
          							<form name="search" method="get" action="plztour_gallery.jsp">
