...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		...
		form.action = "plztour_notice_delete_ok.jsp?idx="+<%= read.get("IDX") %>;
		form.submit();
	}else{
		return;
	}
          	...
          	<TR valign=top>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		...
                		<form name="writeFrm" action="plztour_notice_modify_ok.jsp" method="post" enctype="multipart/form-data">
