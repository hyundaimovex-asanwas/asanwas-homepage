...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		...
		form.action = "plztour_	qna_delete_ok.jsp?idx="+<%= read.get("IDX") %>;
		form.submit();
	}else{
		return;
	}
        ...
        <tr>
          ...
          <TABLE cellspacing=0 cellpadding=0 width=650>
          	...
          	<TR valign=top>
				...
				<form name="writeFrm" action="plztour_qna_modify_ok.jsp" method="post" enctype="multipart/form-data">
                				...
                				<tr>
									...
									<!--
										...
										<%// if(use_yn.equals("1")){%>
									     ...
									     <%//}%>
										<img src=../img/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='plztour_qna.jsp?category=qna'"><img src=../img/tour_img/btn_r.gif align=absmiddle>         					
