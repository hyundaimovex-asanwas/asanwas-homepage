...
function openDel(){
	...
	if(confirm("정말 삭제하시겠습니까?")){
		...
		form.action = "plztour_travel_delete_ok.jsp?idx="+<%= read.get("IDX") %>;
		form.submit();
	}else{
		return;
	}
          	...
          	<TR valign=top>
                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		...
                		<form name="writeFrm" action="plztour_travel_modify_ok.jsp" method="post" enctype="multipart/form-data">
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
	                         ...
	                         <td class=lpad10 style='padding-top:7;padding-bottom:7;' height=150 valign=top>
															<% if(read.get("FILE_NAME0") != null) { %>
																<img src="/common/download.jsp?dir=plz&sysfilename=<%= read.get("FILE_NAME0") %>" onload="if(this.width>700) this.width=700;">
															<% } %>
