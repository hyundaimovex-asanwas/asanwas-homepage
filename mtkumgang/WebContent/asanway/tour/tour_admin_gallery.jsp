          	...
          	<TD width=650 valign=top>
          		...
          		<tr>
          			<td>
          				...
          				<tr>
          					<td class='title'><img src='<%=imageServer%>tour_img/bu_blue_title.gif' align=texttop class=rmar10>갤러리</td>
          				</tr>
          				</table>
          				<br>
						 <!--게시판 리스트 -->               
						...
						if(record.length <= 0){ %>
							...
							<div align="center">등록된 자료가 없습니다.</div>
						  <tr>
						...
						<td width="200" align="center">
						  ...
						  <tr> 
						    <td colspan="3">
						      <div style="border:1px solid;border-color:#D0D0D0;width:123;height:93;">
						      	<a href="tour_admin_gallery_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>">
						  ...
						  <tr> 
						    ...
						    <td width="117"><a href="tour_admin_gallery_view.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><u><%=Util.getStringLimit((title).trim(),15)%></u></a></td>
						    <td width="3" rowspan="3"></td>
						  </tr>
						  <tr> 
						  ...
						  <tr> 
						    <td><%=Util.replaceAll(regdate,"-",".")%>&nbsp;(조회:<%=read_num%>)</td>
						  </tr>
						</table>
				...
				%>
          				...
          				<table width=100% border=0 cellspacing=0 cellpadding=0>
          					<tr>
			                      ...
			                      "tour_admin_gallery.jsp", "500", key_str ,
          					...
          					<tr>
          					  <td colspan=2 align=right>
          					    <img src=<%=imageServer%>tour_img/btn_l.gif align=absmiddle><input type=button value="신규등록" class="btn" onclick="location.href='tour_admin_gallery_edit.jsp'" onfocus="this.blur();"><img src=<%=imageServer%>tour_img/btn_r.gif align=absmiddle style='margin-right:1;'> 
          					  </td>
          					</tr>
          				</table>
          				...
          				<tr>
          					<td align=right>
							<!--검색 START -->
							  <FORM METHOD=POST NAME=searchForm ACTION="tour_admin_gallery.jsp">
          						<table border=0 cellspacing=0 cellpadding=0>
          						<tr>
          						  <td   align=right>
                                                                      <select name="part" style='width:80;' >
                                                                      <option <%if(part.equals("")){%>selected<%}%> value=''>선택</option>
                                                                      <option <%if(part.equals("21")){%>selected<%}%> value='21'>금강산</option>
                                                                      <option <%if(part.equals("22")){%>selected<%}%> value='22'>봉래산</option>
                            			                <option <%if(part.equals("23")){%>selected<%}%> value='23'>풍악산</option>
                            				     <option <%if(part.equals("24")){%>selected<%}%> value='24'>개골산</option>
                                                                    </select>
                                                                    <input type=text style='width:200;' name="keyword" value="<%=keyword%>" style="display:">
