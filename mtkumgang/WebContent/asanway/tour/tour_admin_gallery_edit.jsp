<%--
  ...
  - 수정자:2006.08
  - 저작권 표시: IMJ Korea
  - 설명: 관리자 - 고객센터>관리자 등록 갤러리 신규등록 or 수정
--%>
                	...
                	<tr>
                		<td>
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
								...
								<tr height=28>
                					<td class='tdcolor th' align=center>분류선택</td>
                					<td class=lpad10 colspan=7>
										<select name="type_code" style='width:80;'>
                                          <option <%if(type_code.equals("")){%>selected<%}%>  value=''>선택</option>
                                          <option <%if(type_code.equals("21")){%>selected<%}%> value='21'>금강산</option>
                                          <option <%if(type_code.equals("22")){%>selected<%}%> value='22'>봉래산</option>
										  <option <%if(type_code.equals("23")){%>selected<%}%> value='23'>풍악산</option>
										  <option <%if(type_code.equals("24")){%>selected<%}%> value='24'>개골산</option>
										  <option <%if(type_code.equals("25")){%>selected<%}%> value='25'>내금-이윤정</option>
                                          </select>
										 </td>
                				</tr>
								...
								<tr height=28 >
                                 <td class='tdcolor th' align=center valign=top style=padding-top:7;>이미지</td>
                                 <td class=lpad10 colspan=7>
                                    <input type="file" name="attachFile01"  size="25"><font color=red>**이미지최적화사이즈:600*400 pixel</font>
