                           ...
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
          					<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr align=center height=28 align=center height=35>
									<td colspan="7" align="center" height="30">등록된 데이터가  않습니다.</td>
								</tr>
								...
								%>					    
          						<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                    <!--<td><input type=checkbox name="check_yn" value="<%=board_seq%>"></td>-->
                                    <td><%=BoardUtil.getNum(allCount,requestedPage,rowsPerPage,(i+1))%></td>
                                    <td align=left>
                                       <a href="tour_praise_view.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><%=title%></a>
                                    </td>   
          					...
          					<tr>
          						<td align=right>
          							...
          							<FORM METHOD=POST ACTION="tour_praise.jsp">
          							<tr>
          							  <td >
