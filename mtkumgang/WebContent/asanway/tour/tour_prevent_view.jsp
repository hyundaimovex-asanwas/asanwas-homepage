...
function goEdit(){	
	f = document.mainForm;
    f.action = "tour_prevent_edit.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>";
	f.submit();
...
<form method=post name="mainForm" action="tour_prevent_ok.jsp"  encType="multipart/form-data">
