                ...
                <TD width=650 valign=top>
                	...
                	<tr>
                		<td>
							...
							<FORM METHOD=POST name="mainForm" ACTION="tour_prroom_eng_ok.jsp"  encType="multipart/form-data">
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                                 <td align=right>
								  ...
								  <%}%>
								  <img src=<%=imageServer%>/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='tour_prroom_eng.jsp'"><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle>         					
                                 </td>
                				</tr>
                			</table>
                            </FORM>
