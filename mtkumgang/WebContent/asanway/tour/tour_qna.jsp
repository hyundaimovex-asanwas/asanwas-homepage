          			...
          			<td>
						...
						<FORM METHOD=POST name="mainForm" ACTION="tour_qna.jsp" >
							...
							<%
									...
									for(int i=0;i<record.length; i++){ 
										...
										<tr align=center height=28 align=center height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
											   ...
											   <td align="left">
											       <%if(use_yn.equals("0")){%>
												      <a href="tour_qna_edit.jsp?board_seq=<%=board_seq%>"><%=Util.getStringLimit(title,15)%></a> &nbsp;<font color=red>삭제된게시물</font>
												   <%}else{%>
												       <a href="tour_qna_edit.jsp?board_seq=<%=board_seq%>"><%=Util.getStringLimit(title,30)%></a>
												   <%}%>
											   </td>
											   <td>
									                   <%
          				...
          				<tr>
          					<td align=right>
							<!--검색 START -->
							  <FORM METHOD=POST NAME=searchForm ACTION="tour_qna.jsp">
