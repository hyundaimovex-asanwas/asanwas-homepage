        ...
        <tr>
          ...
          <TABLE cellspacing=0 cellpadding=0 width=650>
          	...
          	<TR valign=top>
				...
				<FORM METHOD=POST name="mainForm" ACTION="tour_qna_ok.jsp" >
                		...
                		<td>
							...
							<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                                 <td align=right>
                                  <%if(prev_board_seq>0){%> 
                                  <img src=<%=imageServer%>/tour_img/btn_l.gif align=absmiddle><input type=button value='<<이전'  class=btn onclick="location.href='tour_qna_edit.jsp?board_seq=<%=prev_board_seq%><%=key_str%><%=page_str%>'" ><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle style=margin-right:1;>
                                  <%}%>
								  <%if(next_board_seq>0){%>
								  <img src=<%=imageServer%>/tour_img/btn_l.gif align=absmiddle><input type=button value='다음>>'  class=btn onclick="location.href='tour_qna_edit.jsp?board_seq=<%=next_board_seq%><%=key_str%><%=page_str%>'" ><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle style=margin-right:1;>
								  <%}%>
								  </td>
                				</tr>
                			</table>
									...
									<table cellpadding="0" cellspacing="0" width="640">
										<tr>
											...
											<td background="<%=imageServer%>a_cellbg25.gif">
												<p>: <%if(prev_board_seq>0){%> <a href="tour_qna_edit.jsp?board_seq=<%=prev_board_seq%><%=key_str%><%=page_str%>">&nbsp;<%=Util.getStringLimit(prev_title.trim(),40)%></a> <%}else{%> 이전글이 없습니다. <% } %></p>
											</td>
										</tr>
										<tr>
											...
											<td>
												<p>: <%if(next_board_seq>0){%> <a href="tour_qna_edit.jsp?board_seq=<%=next_board_seq%><%=key_str%><%=page_str%>">&nbsp;<%=Util.getStringLimit(next_title.trim(),40)%></a> <%}else{%> 다음글이 없습니다. <% } %></p>
											</td>
										</tr>
									</table>
								</td>
                				...
                				<tr>
									...
									<!--
										...
										<% if(use_yn.equals("1")){%>
									     ...
									     <%}%>
										<img src=<%=imageServer%>/tour_img/btn_l.gif align=absmiddle><input type=button value=목록 class=btn onclick="location.href='tour_qna.jsp'"><img src=<%=imageServer%>/tour_img/btn_r.gif align=absmiddle>         					
