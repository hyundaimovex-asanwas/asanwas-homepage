          				...
          				<td>
          					...
          					<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								%>
          						<tr height=28 style="cursor:hand" onmouseOver="this.style.backgroundColor='#E5E5E5';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                                            ...
                                                            <td>&nbsp;&nbsp;<%=re_img%><a href="tour_review_view.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>"><%=Util.getStringLimit((title).trim(),30)%></a><!-- <%=new_img%> --></td>
          					...
          					<tr>
          						<td align=right>
          							...
          							<FORM METHOD=POST ACTION="tour_review.jsp">
          							<tr>
          							  <td >
