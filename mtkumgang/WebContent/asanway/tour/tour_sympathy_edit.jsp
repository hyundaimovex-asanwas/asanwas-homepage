	       	      ...
	       	      <TABLE cellspacing=0 cellpadding=0 width=650>
	       	       <!-- loc -->
	       	         <TR valign=top>
	       		        ...
	       		        <span class=locon>여행 공감대 주제수정</A> </span>
	       		        </TD> 
	       	          </TR>
	       	       <!-- //loc -->
	       	       </TABLE>
                			...
                			<table width=100% border=0 cellspacing=0 cellpadding=0>
                				...
                				<tr>
                					<td align=right>
                						...
                						<img src=../img/tour_img//btn_l.gif align=absmiddle><input type=button value=취소 class=btn onclick="window.close();"><img src=../img/tour_img//btn_r.gif align=absmiddle>         					
                					</td>
                				</tr>
                			</table>
