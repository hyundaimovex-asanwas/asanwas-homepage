...
//검색 - 내가쓴글 아이디
String search_id = ParamUtil.getReqParameter(request.getParameter("search_id"));
// 검색 - 검색어
...
<form method=post  name=mainForm action="qna_list.jsp">
				...
				<tr>
					<td valign="top">
						...
						<col width="50"><col width="390"><col width="110"><col width="80"><col width="60">
            ...
            <% if(record.length <= 0){ %>							
						<tr><td height="1" colspan="5" class="line_dg"></td></tr>
						<tr align="center">
							<td height="26" colspan="5">데이타가 존재하지 않습니다.</td>
							<td>123</td>
						</tr>
             ...
             %>		
						...
						<tr align="center">
							...
							<!-- 회원이쓴글:X  OR  자기글:X   ==> 패스워드 확인후 연결   -->
                             ...
                             <!--회원이쓴글:O AND 자기글:O-->
                                    <%}else if(!user_id.equals("") && user_id.equals(session_id)){%>
                                     <a href="qna_view.jsp?board_seq=<%=board_seq%><%=key_str%><%=page_str%>" class="listtxt06"><%=Util.getStringLimit(title,30)%> &nbsp;</a>&nbsp;<%=reply_yn_name%>
									<%}%>
                            <%}else{%>
                                    <a href="qna_view.jsp?board_seq=<%=board_seq%><%=key_str%><%=page_str%>" class="listtxt06"><%=Util.getStringLimit(title,30)%></a>&nbsp;<%=reply_yn_name%>
                            <%}%>
						...
						<tr>
			                ...
			                <td width="30%" align="right">
			                   <a href="qna_edit.jsp"><img src="<%=imageServer%>/tour_img/btn/btn_cus_question.gif" class="btn"></a><!-- 질문하기 -->
			                </td>			                
						</tr>
						</table>
						<!-- paging/ -->	
...
<form  method=post  name="searchForm" action="qna_list.jsp">						
						...
						<tr>
							...
							<select name="part">
                                                                              ...
                                                                              <option <%if(part.equals("6")){%>selected<%}%> value='6' >이메일</option>
						...
						<tr><td align="center"><img src="<%=imageServer%>tour_img/customer/txt_tip_qna.gif"></td></tr>
						</table>
</form>						
					</td>
				</tr>
