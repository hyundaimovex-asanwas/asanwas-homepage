    ...
    <INPUT TYPE="hidden" name="position" value="<%=position%>">
				...
				<tr>
					<td valign="top">
						...
						<tr>
							<td height="110" align="right"><img src="<%=imageServer%>/tour_img/txt_write11.gif" style="margin-right:13px;"><!-- 문의내용 --></td>
						...
						<tr>
							...
							<td align="right"><a href="qna_list.jsp?board_seq=<%=board_seq%><%=key_str%><%=page_str%>"><img src="<%=imageServer%>/tour_img/btn/btn_cus_listview.gif" class="btn"></a><!-- 목록보기 --></td>
						</tr>
						</table>
						<!-- button/ -->
					</td>
