			...
			<td>
				...
				<tr>
				  <td>                  <table width="690" cellpadding="0" cellspacing="1" border="0" class="tabline" style="margin-top:10px;margin-bottom:60px;">
                    <tr align="center"> 
                      <td height="26" colspan="2" class="bg_white"><p class="style1">大众池 </p></td>
                      <td colspan="2" class="bg_white"><p class="style1">家庭池家庭池  </p></td>
                      <td colspan="2" class="bg_white"><p class="style1">治病鱼 </p></td>
                    </tr>
                    <tr align="center"> 
                      <td width="17%" height="26" class="bg_white"><p class="style1">成年人</p></td>
                      <td width="17%" class="bg_white"><p class="style1">儿童</p></td>
                      <td width="18%" class="bg_white"><p class="style1">8人间</p></td>
                      <td width="18%" class="bg_white"><p class="style1">15人间</p></td>
                      <td width="15%" class="bg_white"><p class="style1">成年人</p></td>
                      <td width="15%" class="bg_white"><p class="style1">儿童</p></td>
                    </tr>
                    <tr align="center"> 
                      <td height="26" class="bg_white"><p>$12/1次 </p></td>
                      <td class="bg_white"><p class="style1">$10/1次</p></td>
                      <td rowspan="2" class="bg_white"><p class="style1">基本费$30，每人多加$10</p></td>
                      <td rowspan="2" class="bg_white"><p class="style1">基本费$80，每人多加$10&#13;</p></td>
                      <td class="bg_white" rowspan="2"><p class="style1">$10/30分钟</p></td>
                      <td class="bg_white" rowspan="2"><p class="style1">$8/30分钟</p></td>
                    </tr>
                    <tr align="center"> 
