...
<tr valign="top">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <!-- -->
		...
		<tr>
			<td height="165" colspan="2" valign="top"><img src="<%=imageServer%>/chn_img/footer/contactus_visual.jpg"></td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr valign="top">
			<td width="174"><!--  left menu --><img src="<%=imageServer%>/chn_img/leftMenu85.gif" width="174"></td>
			<td>
				<!-- / content  -->
				...
				<tr>
					...
					<tr>
						<td height="54"><img src="<%=imageServer%>/chn_img/footer/tit_footer05.gif"></td>
						</td>
					</tr>
					</table>
					<!-- TITLE & LINEMAP/ -->
				...
				<tr>
					<td valign="top">
						...
						<tr><td valign="top" height="25" colspan="4"><img src="<%=imageServer%>/chn_img/footer/txt_contactus_01.gif"></td></tr>
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td width="178" height="26" align="LEFT"><img src="<%=imageServer%>/chn_img/footer/txt04.gif"></td>
						...
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="LEFT"><img src="<%=imageServer%>/chn_img/footer/txt05.gif"></td>
						...
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="LEFT"><img src="<%=imageServer%>/chn_img/footer/txt06.gif"></td>
						...
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="LEFT"><img src="<%=imageServer%>/chn_img/footer/txt07.gif"></td>
						...
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="LEFT"><img src="<%=imageServer%>/chn_img/footer/txt08.gif"></td>
						...
						<table width="690" cellpadding="0" cellspacing="0" border="0">
						<tr><td valign="top" height="27" colspan="2"><img src="<%=imageServer%>/chn_img/footer/txt_contactus_02.gif"></td></tr>
						<tr>
							<td width="12"></td>
							<td width="678">- 地址: (110-793) 首尔市 钟路区 桂洞 140-2 现代大楼 12层</td>
						</tr>
						<tr>
							<td></td>
							<td>- 电话: 02)3669-3000 (观光 代表咨询)</td>
						</tr>
						<tr><td height="34" colspan="2"></td></tr>
						<tr><td valign="top" height="27" colspan="2"><img src="<%=imageServer%>/chn_img/footer/txt_contactus_03.gif"></td></tr>
						<tr>
							<td></td>
							<td>- 地铁: 3号线 安国站下车 3号出口 步行三分钟<br><br>
           - 公交车: 支线公交(绿色) – 1012 号<br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;干线公交(黄色) – 151号, 162 号, 171 号, 172 号, 272 号, 601 号</td>
						</tr>
						<tr><td height="27" colspan="2"></td></tr>
						<tr><td colspan="2"><img src="<%=imageServer%>/chn_img/footer/map.gif"></td></tr>
						</table>
					</td>
				</tr>
				</table>
