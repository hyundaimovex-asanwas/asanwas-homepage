        ...
        <td><table width="679" cellpadding="0" cellspacing="0" border="0" style='margin-left:11px;'>
            ...
            <tr valign="top">
              <td><img src="<%=imageServer%>/chn_img/apply/img_res_p0201.gif"><br>
                <a href="agent/agent_list.jsp" target="_self"><img src="<%=imageServer%>/chn_img/btn/btn_a2.gif" border="0" style='margin:14 0 0 9px;'></a>
                <!--<a href="javascript:;" onClick="javascript:alert('준비 중 입니다.');"><img src="<%=imageServer%>/chn_img/btn/btn_onlinereser.gif" border="0" style='margin:14 0 0 9px;'></a>< --></td>
