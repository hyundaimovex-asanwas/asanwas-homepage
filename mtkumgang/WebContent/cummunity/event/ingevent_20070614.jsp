...
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="<%=imageServer%>/tour_img/community/img_ingevent_0531.jpg" width="682" height="544" border="0" usemap="#Map" /></td>
  </tr>
</table>
<map name="Map" id="Map"><area shape="rect" coords="229,980,457,1032" href="#top" onclick="Q_navi01();"/>
                  ...
                  <area shape="rect" coords="589,502,665,527" href="http://www.mtkumgang.com/cummunity/event/prevent_view.jsp?board_seq=1512&requestedPage=1&part=&keyword=" onFocus="this.blur()">
                </map></body>
