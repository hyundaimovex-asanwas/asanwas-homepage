...
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr> 
          <td><img src="<%=imageServer%>/tour_img/community/event_page_080605.jpg" width="682" height="730" border="0" usemap="#Map" />
            <map name="Map" id="Map">
              ...
              <area shape="rect" coords="251,321,325,348" href="http://www.mtkumgang.com/utility/notice/notice_view.jsp?board_seq=3878&requestedPage=1&part=&keyword=" onFocus="this.blur()">
