...
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr> 
          <td><img src="<%=imageServer%>/tour_img/community/event_page_080703.jpg" width="682" height="1092" border="0" usemap="#gogogo">
            <map name="gogogo">
              <!--10주년 -->
              ...
              <!--내금강문화유적 -->
              <area shape="rect" coords="592,135,668,164" href="http://www.mtkumgang.com/utility/notice/notice_view.jsp?board_seq=3993&requestedPage=1&part=&keyword="onFocus="this.blur()">
              <!--지마켓 -->
              ...
              <area shape="rect" coords="588,865,664,894" href="http://www.mtkumgang.com/utility/notice/notice_view.jsp?board_seq=3697&requestedPage=1&part=&keyword=" onFocus="this.blur()">
                        <area shape="rect" coords="253,1043,327,1071" href="http://www.mtkumgang.com/utility/notice/notice_view.jsp?board_seq=3878&requestedPage=1%02%22=&keyword=" onFocus="this.blur()">
                      </map></td>
  </tr>
</table>
