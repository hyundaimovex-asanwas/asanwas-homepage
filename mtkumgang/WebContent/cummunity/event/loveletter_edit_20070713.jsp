...
<input type=hidden name=user_name style=width:100; value="<%=user_name%>">
				...
				<tr>
					<td valign="top">
						...
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/tour_img/event/event_s_06.gif"><!-- 받는 분:user_nick --></td>
							<td colspan="3"><input type="text" style="width:200px;" name=user_nick value="<%=user_nick%>">
							&nbsp;&nbsp;&lt;금강산 가시는 분&gt; </td>
						</tr>
						<tr><td height="1" colspan="4" class="line_dg"></td></tr>
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/tour_img/event/event_s_08-1.gif"><!-- 보내는 분 --></td>
						...
						<tr><td height="1" colspan="4" class="line_dg"></td></tr>
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/tour_img/event/event_s_12.gif"></td>
							<td><input type="text" style="width:200px;" name="user_icon" value="<%=user_icon%>"><!-- 출발일:user_icon --></td>
							<td colspan="2">&nbsp;&nbsp;</td>
						</tr>
						<tr><td height="1" colspan="4" class="line_dg"></td></tr>
						<tr>
