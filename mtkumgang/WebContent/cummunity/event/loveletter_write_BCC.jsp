			...
			<td>
				...
				<tr>
					<td valign="top">
						...
						<tr><td height="1" colspan="4" class="line_dg"></td></tr>
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/tour_img/event/event_s_08-1.gif"><!-- 연락처 --></td>
						...
						<tr>
							<td align="right" class="tpad_3 rpad_10"><a href="#"><img src="<%=imageServer%>/tour_img/event/s_event_1_lovego_bt_2.gif" border="0"></a>
