...
<table width="800" height="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="580"><img src="<%=imageServer%>song_img/img_map01.jpg" width="580" height="380" border="0" usemap="#Map"></td>
...
<map name="Map">
  <area shape="circle" coords="170,69,21" href="javascript:getItem(1);">
  <area shape="circle" coords="271,40,20" href="javascript:getItem(2);">
  <area shape="circle" coords="134,217,22" href="javascript:getItem(3);">
  <area shape="circle" coords="418,205,21" href="javascript:getItem(4);">
  <area shape="circle" coords="439,331,21" href="javascript:getItem(5);">
</map>
</body>
</html>
