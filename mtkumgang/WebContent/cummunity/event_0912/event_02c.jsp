...
<table width="800" height="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="580"><img src="<%=imageServer%>song_img/img_map03.jpg" width="580" height="380" border="0" usemap="#Map"></td>
...
<map name="Map">
  <area shape="circle" coords="327,85,21" href="javascript:getItem(1);">
  <area shape="circle" coords="485,77,20" href="javascript:getItem(2);">
  <area shape="circle" coords="106,103,22" href="javascript:getItem(3);">
  <area shape="circle" coords="238,355,21" href="javascript:getItem(4);">
  <area shape="circle" coords="411,134,21" href="javascript:getItem(5);">
</map>
</body>
</html>
