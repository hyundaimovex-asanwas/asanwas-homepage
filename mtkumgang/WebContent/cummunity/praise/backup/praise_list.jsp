	...
	<td valign="top">
		...
		<tr valign="top">
			<td width="174"><!--  left menu flash -->
				<script language="javascript">
					f_id = "leftMenu05";//플래시 아이디
					f_name ="<%=imageServer%>/tour_swf/leftMenu05.tour_swf"; //플래시 파일명
					f_width = "174";//가로크기
					f_height ="207"; //세로높이
						...
						<tr>
							<td valign="top">
								...
								<tr>
									...
									<td width="339"><input type="text" name="title" style="width:328px;" class="input05"></td>
									<td width="56"></td>
								</tr>
								<tr><td colspan="3" height="7"></td></tr>
								<tr>
									<td><img src="<%=imageServer%>/tour_img/community/txt_praise02.gif"></td>
									<td><textarea name="content" style="width:328px;height:79px;overflow:auto;" class="textarea05"></textarea></td>
									<td><img src="<%=imageServer%>/tour_img/btn/btn_comm_praise.gif" width="56" height="56" onClick="javascript:chk();" style="cursor:hand"><!-- 칭찬하기 --></td>
								</tr>
								</table>
							</td>
						</tr>
