		...
		<tr valign="top">
			<td width="174"><!--  left menu flash -->
				<script language="javascript">
					...
					f_name ="<%=imageServer%>/tour_swf/leftMenu05.swf"; //플래시 파일명
					f_width = "174";//가로크기
					f_height ="207"; //세로높이
			...
			<td>
				...
				<tr>
					<td valign="top">
						...
						<tr><td height="1" colspan="8" class="line_dg"></td></tr>
						<tr>
							<td colspan="8" style="padding:15 15 25 13px;" valign="top" height="230">dkfjsldfjslkdjflskdjfls</td>
						</tr>
						</table>
						<!-- view table / -->
						...
						<tr>
							<td class="lpad_5"><!-- <a href="#"><img src="<%=imageServer%>/tour_img/btn/btn_comm_modify.gif" class="btn"></a> --><a href="#"><img src="<%=imageServer%>/tour_img/btn/btn_comm_delete.gif" class="btn"></a></td>
