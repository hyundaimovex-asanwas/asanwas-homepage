         ...
         <TD width=650 valign=top>
         	...
         	<tr>
         		<td>
					...
					<input type=hidden name=user_name style=width:100; value="<%=session_name%>">
					...
					<INPUT TYPE="hidden" name="sort_no" value="<%=sort_no%>">
         			<table width=100% border=0 cellspacing=0 cellpadding=0>
         				...
         				<tr height=28>
         					...
         					<td class=lpad10><%=session_name%>(<%=session_id%>)</td>
         				...
         				<tr height=28 colspan=4>
						  ...
						  <input type=hidden value="<%="<br><br>---------------------------------------<br>"+content%>" name="content" id="content">
                          </td>
         				</tr>              
         			</table><br>
         			<table width=100% border=0 cellspacing=0 cellpadding=0>         				     			
         				<tr>
         					<td align=right>
								...
								<img src=../../asanway/img/tour_img/btn_l.gif align=absmiddle><input type=submit value=답변하기 class=btn ><img src=../../asanway/img/tour_img/btn_r.gif align=absmiddle><img src=../../asanway/img/tour_img/btn_r.gif align=absmiddle style=margin-right:1;>
