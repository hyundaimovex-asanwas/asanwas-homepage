...
<% if(best_record.length > 0 ){ %>
										<tr valign="top">
											...
											<td class="tpad_5"><!--<br>
												...
												<img src="<%=imageServer%>/tour_img/bu/bu_gray_rec.gif" vspace="3" hspace="3"><span class="fs11 txt_lpurple">추천123</span>-->											</td>
											<td></td>
										</tr>
										<tr>
											<td colspan="3" class="tpad_5 lpad_5 txt_lpurple"><!--<br>이현대 / 05.12.01-->											</td>
										</tr>
<% }else{ %>
										<tr valign="top">
											<td><img src="<%=imageServer%>/tour_img/bu/ico_best2.gif"></td>
											<td class="tpad_5">
												2008년 6월 4일에 베스트여행후기를 발표합니다</td>
											<td></td>
										</tr>
										<tr>
