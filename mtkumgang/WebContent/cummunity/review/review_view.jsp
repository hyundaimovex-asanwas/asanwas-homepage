...
%>
						...
						<tr>
							...
							<% if(session_id.equals(user_id)){ %>
							  <a href="review_edit.jsp?board_seq=<%=board_seq%>"><img src="<%=imageServer%>/tour_img/btn/btn_comm_modify.gif" class="btn"></a>
							...
							<td align="right">
							  ...
							  <a href="review_edit.jsp"><img src="<%=imageServer%>/tour_img/btn/btn_comm_newwrite.gif" class="btn"></a>
							  <% } %>
