		...
		<tr valign="top">
			...
			<td>
				...
				<tr>
					...
					<tr>
						<td height="54"><img src="<%=imageServer%>/eng_img/guide/play5_title_01.gif"></td>
				...
				<tr>
				  <td height="68"><p><img src="<%=imageServer%>/eng_img/guide/play05_img01.gif"></p>
				    <p>&nbsp;</p></td>
				</tr>
								<tr>
				  <td height="68"><p><img src="<%=imageServer%>/eng_img/guide/play05_img02.gif"></p>
				    <p>&nbsp;</p></td>
				</tr>
				<tr>
					<td valign="top">
