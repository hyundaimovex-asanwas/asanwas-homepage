				...
				<tr>
					<td valign="top">
						...
						<tr>
							...
							<td width="140" class="lpad_10 tpad_3">Seong Woon Kim</td>
							<td width="140" class="lpad_10 tpad_3"><a href="mailto:swkim0729@hdasan.com">swkim0729@hdasan.com</a></td>
							<td width="300" class="lpad_10 tpad_3">02-3669-3897</td>
						</tr>
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/eng_img/footer/txt05.gif"></td>
							<td class="lpad_10 tpad_3">Seong Wook Park</td>
							<td class="lpad_10 tpad_3"><a href="mailto:straight62@naver.com">straight62@naver.com</a></td>
							<td class="lpad_10 tpad_3">02-3669-3824</td>
						</tr>
						<tr><td height="1" class="line_dg" colspan="4"></td></tr>
						<tr>
							<td height="26" align="right"><img src="<%=imageServer%>/eng_img/footer/txt06.gif"></td>
							<td class="lpad_10 tpad_3">Eun Ki Jo</td>
