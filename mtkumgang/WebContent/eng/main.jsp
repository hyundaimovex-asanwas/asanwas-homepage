...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td width="194" valign="top"><img src="<%=imageServer%>/eng_img/guide/eng_logo.gif"></td>
    <td width="690" height="87" valign="top"><table cellpadding="0" cellspacing="0">
      <tr>
        <td height="34" valign="top" align="right"><a href="http://www.mtkumgang.com" target="_blank"><img src="<%=imageServer%>/eng_img/common/korea_bt.gif" border="0"></a></td>
      </tr>
      <!--원뎁스 시작-->
      <tr>
  ...
  <tr>
    <td height="165" colspan="2" valign="top"><script language="javascript">
                  writeObject("<%=imageServer%>/eng_img/eng_swf/eng_main.swf","100%","529","transparent")
              </script></td>
    <td width="187" bgcolor="#FFFFFF"></td>
				<td bgcolor="#FFFFFF"></td>
    <!--<td background="<%=imageServer%>/eng_img/common/main_right.jpg" bgcolor="3F7D7C"></td>-->
  </tr>
</table>
<tr>
	<td valign="bottom">
		...
		<tr>
			<td width="922">
				...
				<tr valign="top"> 
					<td width="145" height="20" rowspan="2"><a href="javascript:;" onClick="javascript:familyPop('http://www.hyundai-asan.com/english/index.jsp')"><img src="<%=imageServer%>/eng_img/footer_logo.gif"></a></td>
					<td width="645" class="tpad_3">
					<a href="/eng/include/intro.jsp"><img src="<%=imageServer%>/eng_img/footer_01.gif"></a>
					<a href="/eng/include/agreement.jsp"><img src="<%=imageServer%>/eng_img/footer_02.gif"></a>
					<a href="/eng/include/privacy.jsp"><img src="<%=imageServer%>/eng_img/footer_03.gif"></a>
					<a href="/eng/include/contactus.jsp"><img src="<%=imageServer%>/eng_img/footer_04.gif"></a>
					</td>
					<td width="135">
