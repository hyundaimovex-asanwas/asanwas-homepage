<%--
  - 작성자: 심동현
  - doctype 선언이 없어서, 없는게 기본값으로 html5가 아닐까 합니다~! 20150701
--%>
...
<table cellpadding="0" cellspacing="0" border="0" width="932">
  ...
  <tr>
	<td><table cellpadding="0" cellspacing="0" border="0" width="932">
		  <tr>
		  	<td width="133"><a href="hddf_main.jsp" ><img src="./imgs/hddf_ci.jpg" ></a></td>
		  	<td width="30"></td>
		  	<td valign="bottom"><table cellpadding="0" cellspacing="0" border="0" width="769">
			  	  <tr>
				  	<td valign="bottom" align="center" style="border-right:2 solid #000"><a href="hddf_is.jsp" ><img src="./imgs/top_nav1.gif" ></a></td>
			  		<td valign="bottom" align="center" style="border-right:2 solid #000"><a href="hddf_guide.jsp" ><img src="./imgs/top_nav2.gif" ></a></td>
			  		<td valign="bottom" align="center"><a href="hddf_list.jsp" ><img src="./imgs/top_nav3.gif" ></a></td>
				  </tr>
				</table></td>
		  </tr>
		</table></td>
  ...
  <tr>
	<td><table cellpadding="0" cellspacing="0" border="0" width="932">
		  <tr>
		  	...
		  	<table width="133" cellpadding="0" cellspacing="0" border="0">
		  	  ...
		  	  <tr>
		  	  	<td><a href="hddf_list.jsp" ><img src="./imgs/but1.jpg" width="133"></a></td>
		  	  </tr>
		  	  <tr height="20"><td></td></tr>
		  	  <tr>
		  	  	<td><a href="hddf_list.jsp?part=01" ><img src="./imgs/but2.jpg" width="133" ></a></td>
		  	  </tr>
		  	  <tr height="20"><td></td></tr>
		  	  <tr>
			...
			<form name="frm" method="post" action="hddf_list.jsp" >
			  <tr>
				<td valign="bottom" align="left" style="padding-left:84px;padding-bottom:5px;"><!-- /search -->
					<select name="part">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="932">
	  <tr height="50">
		<td style="border-top:1 solid #000"><a href="mailto:suno@hdasan.com" ><img src="./imgs/footer.gif" ></a></td>
	  </tr>
	</table>
	</td>
  </tr>
