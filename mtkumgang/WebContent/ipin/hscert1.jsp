	...
	function jsSubmit(){	
		...
		for(i=0; i<form1.auth_req_cd.length; i++){
			if(form1.auth_req_cd[i].checked){
				isChecked = true;
				form1.hs_cert_msr_cd.value	= i+"0";			//요청수단코드
		    break;
			}
		}
	...
	<form name="form1" action="hscert2.jsp" method="post">
		...
		<table>
			...
			<tr>
				<td>인증수단</td>
				<td>
					<input type="radio" name="auth_req_cd" value="00">전체
					<input type="radio" name="auth_req_cd" value="10" checked>휴대폰
					<input type="radio" name="auth_req_cd" value="20">신용카드
					<input type="radio" name="auth_req_cd" value="30">공인인증서
				</td>
			</tr>
			<tr>
				<td>주민번호</td>
				<td>
					<input type="text" name="reg_no1" value="" maxlength="6" size="8">-
