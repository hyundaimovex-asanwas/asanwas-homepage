			...
			<td>
				...
				<tr>
					...
					<tr>
						...
						<td align="right" class="linemap"><img src="<%=imageServer%>/jpn_img/common/con_img_1.gif" class="linemap_margin"><a href="#" class="linemap">HOME</a><img src="<%=imageServer%>/jpn_img/common/con_img_2.gif" class="linemap_margin2"><a href="#" class="linemap">Tour Tip</a><img src="<%=imageServer%>/jpn_img/common/con_img_2.gif" class="linemap_margin2"><a href="#" class="linemap">Route Guide</a><img src="<%=imageServer%>/jpn_img/common/con_img_2.gif" class="linemap_margin2"><span class="linemap_now">Kuryongyon Course</span></td>
					</tr>
					</table>
					<!-- TITLE & LINEMAP/ -->
					</td>
