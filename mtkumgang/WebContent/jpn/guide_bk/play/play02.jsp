		...
		<tr valign="top">
			...
			<td>
				...
				<tr>
					...
					<tr>
						<td height="54"><img src="<%=imageServer%>/jpn_img/guide/play2_title_01.gif"></td>
				...
				<tr>
				  <td height="36"><img src="<%=imageServer%>/jpn_img/guide/play02_img01.jpg"></td>
				</tr>
				<tr>
				  <td>                  <table width="399" cellpadding="0" cellspacing="1" border="0" class="tabline" style="margin-top:10px;margin-bottom:60px;">
                    <tr align="center"> 
                      <td width="17%" height="26" class="bg_white">区分</td>
                      <td width="17%" class="bg_white"> 一般</td>
                      <td width="17%" class="bg_white">青少年</td>
                    </tr>
                    <tr align="center"> 
                      <td height="26" class="bg_white">特別席</td>
                      <td class="bg_white"> $ 30</td>
                      <td class="bg_white"> $ 30</td>
                    </tr>
                    <tr align="center"> 
                      <td height="26" class="bg_white">一般席</td>
				...
				<tr>
				  <td height="68"><img src="<%=imageServer%>/jpn_img/guide/play02_img02.gif">
				    </td>
				</tr>
				<tr>
				  <td height="68"><p><img src="<%=imageServer%>/jpn_img/guide/play02_img03.gif"></p>
				    <p>&nbsp;</p></td>
				</tr>
				<tr>
					<td valign="top">
