		...
		<tr valign="top">
			...
			<td>
				...
				<tr>
					...
					<tr>
						<td height="54"><img src="<%=imageServer%>/jpn_img/guide/play4_title_01.gif"></td>
				...
				<tr>
				  <td height="36"><img src="<%=imageServer%>/jpn_img/guide/play04_img01.gif"></td>
				</tr>
				<tr>
				  <td>                  <table width="399" cellpadding="0" cellspacing="1" border="0" class="tabline" style="margin-top:10px;margin-bottom:60px;">
                    <tr align="center"> 
                      <td width="17%" height="26" class="bg_white">マッサージ</td>
                      <td width="17%" class="bg_white"> 時間
</td>
                      <td width="17%" class="bg_white">料金</td>
                    </tr>
                    <tr align="center"> 
                      <td rowspan="3" class="bg_white">足マッサージ </td>
                      <td height="26" class="bg_white"> 30分 </td>
                    ...
                    <tr align="center">
                      <td height="26" class="bg_white">40分</td>
                      <td class="bg_white">$ 34</td>
                    </tr>
                    <tr align="center">
                      <td rowspan="2" class="bg_white">全身マッサージ </td>
                      <td height="26" class="bg_white">40分</td>
                      <td class="bg_white">$ 39</td>
                    </tr>
                    <tr align="center"> 
                      <td height="26" class="bg_white"> 60 分</td>
				...
				<tr>
				  <td height="68"><p><img src="<%=imageServer%>/jpn_img/guide/play04_img02.gif"></p>
				    <p>&nbsp;</p></td>
				</tr>
				<tr>
					<td valign="top">
