	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td valign="top"><img src="<%=imageServer%>/jpn_img/apply/reservation_title.gif"></td>
			<td height="165" valign="top" width="690"><img src="<%=imageServer%>/jpn_img/apply/reservation_visul.jpg"></td>
