...
<tr>
	<td width="100%">
			...
			<tr valign="top">
				<td class="tpad_20 lpad_20"><img src="<%=imageServer%>/jpn_img/preview/pop_tit_movview.gif"></td>
				<td align="right" class="tpad_20 rpad_15"><img src="<%=imageServer%>/jpn_img/preview/pop_logo.gif"></td>
			</tr>
			</table>
			<!-- 타이틀 / -->
...
<%}%>
			...
			<tr>
				<td align="center"><a href="javascript:;" onClick="window.close();"><img src="<%=imageServer%>/jpn_img/preview/btn_pre_confirm.gif"></a><!-- 확인 --></td>
			</tr>
