                      ...
                      <td style="padding-top:28px; padding-bottom:25px;"><img src="/kaesong/images/board/menu_06_txt.gif" width="181" height="14"> 
                        <table width="610" cellpadding="0" cellspacing="0">
                          <tr> 
							...
							<% if(record.length <= 0){ %>						
								<tr align="center">
									<td height="26" align="center">등록된 데이터가 없습니다.</td>
								</tr>
							<%
							}else{
								//리스트 화면에 전시
							...
							%>						
                                <tr> 
                                  <td>
								    <table width="610" cellpadding="0" cellspacing="0" class="page_s">
                                      <tr> 
                                        <td width="50" height="25" align=center><%=BoardUtil.getNum(allCount,requestedPage,rowsPerPage,(i+1))%></td>
                                        <td width="391" style="padding-top:0px; padding-left: 25px; padding-right: 0px; padding-bottom: 0px;"><a href="board_view.jsp?board_seq=<%=board_seq%>&requestedPage=<%=requestedPage%><%=key_str%>" class="listtxt06"><%=title%></a></td>
                                        <td width="95" align=center><%=reg_date_string%></td>
                                        <td width="72" align="center"><%=read_num%></td>
                                      </tr>
                                      <tr> 
                          ...
                          <tr> 
                            <td>
								<!-- /paging -->
								<table cellspacing="0" cellpadding="0" border="0" width="600" height="50" align=center>
								<tr>
									<td align="center">
										<%=HtmlUtil.doPageCut(requestedPage, pageCount , position , "board_list.jsp", "500", key_str ,imageServer+"/imjk_img/", blockPerPage)%>
									</td>
								</tr>
								</table>
								<!-- paging/ -->
                            ...
                            <td><table width="610" height="45" border="0" cellpadding="0" cellspacing="2" bgcolor="#C5C5C5">
                                <tr> 
                                  <td height="50" bgcolor="#FFFFFF">
									...
									<form name="frm" method="post" action="board_list.jsp">
								    <table width="292" align="center" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="63"> <div align="center"> 
                                            <select name="part" class="logbox">
                                        ...
                                        <td width="57" align="center"><a href="javascript:openSch();"><img src="/kaesong/images/board/search.gif" width="47" height="19" border="0"></a></td>
                                      </tr>
                                    </table>
									</form>
									</td>
