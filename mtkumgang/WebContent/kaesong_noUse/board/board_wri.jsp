                    ...
                    <tr> 
                      <td style="padding-top:28px; padding-bottom:25px;"><img src="/kaesong/images/board/menu_06_txt.gif" width="181" height="14"> 
                        <table width="610" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <table width="610" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td> <table width="610" border="0" cellspacing="0" cellpadding="0">
                                      <tr> 
                                        <td height="1" colspan="3" bgcolor="A9A9A9"></td>
                                      </tr>
                                      <tr> 
                                        <td width="78" height="1"></td>
                                      </tr>
                                      <tr> 
                                        <td><img src="/kaesong/images/board/write_title.gif" width="78" height="23"></td>
                                        <td width="8">&nbsp;</td>
                                      ...
                                      <tr> 
                                        <td bgcolor="#A9A9A9"><div align="center"><img src="/kaesong/images/board/write_contents.gif" width="35" height="18"></div></td>
                                        <td>&nbsp;</td>
                                        <td style="padding-top:7px; padding-left: 0px; padding-right: 0px; padding-bottom:7px;"><textarea name="textarea" cols="82" rows="10" ></textarea></td>
                                      </tr>
                                      <tr> 
                          ...
                          <tr> 
                            <td><div align="right"><a href="#"><img src="/kaesong/images/board/button_write.gif" width="53" height="20" hspace="1" border="0"></a> <a href="board_list.jsp"><img src="/kaesong/images/board/button_list.gif" width="60" height="20" hspace="4" border="0"></a> 
                              </div></td>
                          </tr>
                        </table></td>
                    </tr>
