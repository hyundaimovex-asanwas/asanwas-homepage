							...
							<tr>
							 ...
							 <td height="20px" valign="top" style="padding-left:10px; padding-top:3px;">
								<div id="Layer1" style="position:absolute; z-index:1; style="height:17px;"> 
									<table cellpadding="0" cellspacing="0">
										<tr>
											<td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_1','','/kaesong/images/kaesong_main/sub_1o.gif',1)"><img src="/kaesong/images/kaesong_main/sub_1.gif" name="sub_img_1" border="0"></a></td>
											<td><a href="info/info_01.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_2','','/kaesong/images/kaesong_main/sub_2o.gif',1)"><img src="/kaesong/images/kaesong_main/sub_2.gif" name="sub_img_2" border="0"></a></td>
								...
								<div id="Layer2" style="position:absolute; z-index:2; visibility: hidden; style="height:17px;"> 
									<table cellpadding="0" cellspacing="0">
										<tr>
											<td style="padding-left:114px;"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_4','','/kaesong/images/kaesong_main/2sub_1o.gif',1)"><img src="/kaesong/images/kaesong_main/2sub_1.gif" name="sub_img_4" border="0"></a></td>
								...
								<div id="Layer3" style="position:absolute; z-index:3; visibility: hidden; style="height:17px;"> 
									<table cellpadding="0" cellspacing="0">
										<tr>
											<td style="padding-left:217px;"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_8','','/kaesong/images/kaesong_main/3sub_1o.gif',1)"><img src="/kaesong/images/kaesong_main/3sub_1.gif" name="sub_img_8" border="0"></a></td>
											<td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_9','','/kaesong/images/kaesong_main/3sub_2o.gif',1)"><img src="/kaesong/images/kaesong_main/3sub_2.gif" name="sub_img_9" border="0"></a></td>
											<td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_img_10','','/kaesong/images/kaesong_main/3sub_3o.gif',1)"><img src="/kaesong/images/kaesong_main/3sub_3.gif" name="sub_img_10" border="0"></a></td>
