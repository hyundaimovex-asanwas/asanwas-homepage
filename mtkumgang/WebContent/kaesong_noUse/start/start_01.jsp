...
<body onLoad="MM_preloadImages('/kaesong/images/start/leftmenu_01o.gif','/kaesong/images/kaesong_main/top_menu_1o.gif','/kaesong/images/kaesong_main/top_menu_2o.gif','/kaesong/images/kaesong_main/top_menu_3o.gif','/kaesong/images/kaesong_main/top_menu_4o.gif','/kaesong/images/kaesong_main/top_menu_5o.gif','/kaesong/images/kaesong_main/top_menu_6o.gif','/kaesong/images/kaesong_main/sub_1o.gif','/kaesong/images/kaesong_main/sub_2o.gif','/kaesong/images/kaesong_main/sub_3o.gif','/kaesong/images/kaesong_main/2sub_1o.gif','/kaesong/images/kaesong_main/2sub_2o.gif','/kaesong/images/kaesong_main/2sub_3o.gif','/kaesong/images/kaesong_main/2sub_4o.gif','/kaesong/images/kaesong_main/3sub_1o.gif','/kaesong/images/kaesong_main/3sub_2o.gif','/kaesong/images/kaesong_main/3sub_3o.gif','/kaesong/images/kaesong_main/3sub_4o.gif','/kaesong/images/kaesong_main/4sub_1o.gif','/kaesong/images/kaesong_main/4sub_2o.gif','/kaesong/images/kaesong_main/5sub_1o.gif','/kaesong/images/kaesong_main/5sub_2o.gif','/kaesong/images/kaesong_main/5sub_3o.gif','/kaesong/images/kaesong_main/6sub_1o.gif','/kaesong/images/kaesong_main/6sub_2o.gif','/kaesong/images/kaesong_main/6sub_3o.gif','/kaesong/images/kaesong_main/6sub_4o.gif')">
	<table cellpadding="0" cellspacing="0" width="100%" height="100%">
		<tr>
			<td height="235" background="/kaesong/images/info/sub_02.gif">
				<table width="890" cellpadding="0" cellspacing="0">
					<tr>
						<td><table width="890" cellpadding="0" cellspacing="0">
             <tr>
              ...
              <td valign="top" style="padding-top:7px;"><table cellpadding="0" cellspacing="0">
                ...
                <tr>
                 <!--투뎁스 서브메뉴 start-->
                 <td height="20px" valign="top" style="padding-left:10px; padding-top:3px;"><div id="Layer1" style="position:absolute; z-index:1; style="height:17px;">
              ...
              <!--탑메뉴끝-->
					...
					<tr>
						<td><img src="/kaesong/images/start/sub_visual_3.jpg"></td>
					</tr>
					<tr>
				...
				<table width="890" height="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td height="100%" valign="top" style="padding-left:30px;" width="220">
							<!--레프트메뉴시작-->
							<table cellpadding="0" cellspacing="0">
							 <tr><td><img src="/kaesong/images/start/leftmenu_title.gif"></td>
							 </tr>
							 <tr>
								 <td><img src="/kaesong/images/start/leftmenu_01o.gif"></td>
								<!--<td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_01','','/kaesong/images/start/leftmenu_01o.gif',1)"><img src="/kaesong/images/start/leftmenu_01.gif" name="sub_01" border="0"></a></td>-->
							 </tr>
							 <tr><td><a href="start_02.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_02','','/kaesong/images/start/leftmenu_02o.gif',1)"><img src="/kaesong/images/start/leftmenu_02.gif" name="sub_02" border="0"></a></td>
							 </tr>
							 <tr>
							 	<td><a href="start_03.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_03','','/kaesong/images/start/leftmenu_03o.gif',1)"><img src="/kaesong/images/start/leftmenu_03.gif" name="sub_03" border="0"></a></td>
							 </tr>
								<tr>
								<td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub_04','','/kaesong/images/start/leftmenu_04o.gif',1)"><img src="/kaesong/images/start/leftmenu_04.gif" name="sub_04" border="0"></a></td>
							 </tr>
							</table>
							<!--레프트메뉴끝-->
						</td>
						<td valign="top">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td style="padding-right:20px;" width="670" height="31" align="right" valign="top" background="/kaesong/images/info/subtop_bg.gif"><a href="#" class="linemap">Home</a> &gt; <a href="#" class="linemap">출발안내</a> &gt; <span class="linemap_now">짐꾸리기</span></td>
								</tr>
								<tr>
									...
									<!--내용넣어주세요-->
										<table cellpadding="0" cellspacing="0">
											<tr>
												<td><img src="/kaesong/images/start/start_sub1_01.gif"></td>
											</tr>
											<tr>
												<td style="padding-top:19px; padding-bottom:28px;"><img src="/kaesong/images/start/start_sub1_02.gif"></td>
											</tr>
											<tr>
												<td><img src="/kaesong/images/start/start_sub1_03.gif"></td>
											</tr>
											<tr>
												<td style="padding-top:14px; padding-bottom:24px;">
													<table cellpadding="0" cellspacing="0">
														<tr>
															<td style="padding-right:20px; padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_04.jpg"></td>
															<td style="padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_05.jpg"></td>
														</tr>
														<tr>
															<td style="padding-right:20px; padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_06.jpg"></td>
															<td style="padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_07.jpg"></td>
														</tr>
														<tr>
															<td style="padding-right:20px; padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_08.jpg"></td>
															<td style="padding-bottom:5px;"><img src="/kaesong/images/start/start_sub1_09.jpg"></td>
														</tr>
														<tr>
															<td style="padding-right:20px;"><img src="/kaesong/images/start/start_sub1_10.jpg"></td>
															<td><img src="/kaesong/images/start/start_sub1_11.jpg"></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr><td style="padding-bottom:22px;"><img src="/kaesong/images/start/start_sub1_12.gif"></td></tr>	
											<tr><td height="1" bgcolor="D6D6D6"></td></tr>
											<tr><td style="padding-top:17px; padding-bottom:19px;"><img src="/kaesong/images/start/start_sub1_13.gif"></td></tr>
											<tr><td style="padding-bottom:23px;"><img src="/kaesong/images/start/start_sub1_14.gif"></td></tr>
											<tr><td height="1" bgcolor="D6D6D6"></td></tr>
										</table>
									</td>
								</tr>
