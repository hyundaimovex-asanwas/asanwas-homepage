			...
			<td height="100%" valign="top">
				<table width="890" height="100%" cellpadding="0" cellspacing="0">
                  ...
                  <table width="610" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td align="center" style="padding-bottom:24px;"> <table cellpadding="0" cellspacing="0">
                          <tr align="center"> 
                            <td style="padding-left:4px; padding-right:18px;"><img src="/kaesong/images/trip/con_sub1_03.gif"></td>
                          </tr>
                          <tr> 
                            <td height="237" style="padding-top:8px; padding-bottom:10px;"> 
                              <table cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td style="padding-bottom:10px;" width="61" align="right">아침</td>
                                  <td style="padding-left:15px; padding-bottom:10px;">남→북 
                                    이동</td>
                                </tr>
                              </table>
                              <table cellpadding="0" cellspacing="0" width="262" align="center">
                                <tr> 
                              ...
                              <table cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top" style="padding-bottom:10px; padding-top:10px;" width="61" align="right">오전<br>
                                    일정</td>
                                  <td valign="top" style="padding-left:15px; padding-bottom:10px; padding-top:10px;"><font color="FF6C00">박연폭포<br>
                                    관음사 관광</font></td>
                                </tr>
                              </table>
                              <table cellpadding="0" cellspacing="0" width="262" align="center">
                              ...
                              <table cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td valign="top" style="padding-left:15px; padding-bottom:10px; padding-top:10px;"><b>중식 
                                    (현지식당)</b></td>
                                </tr>
                              </table>
                              <table cellpadding="0" cellspacing="0" width="262" align="center">
                              ...
                              <table cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top" style="padding-bottom:10px; padding-top:10px;" width="61" align="right">오후<br>
                                    일정</td>
                                  <td width="169" valign="top" style="padding-left:15px; padding-bottom:10px; padding-top:10px;"><font color="FF6C00">고려박물관 
                                    관광<br>
                                    선죽교 관광<br>
                                    민속여관 관광</font></td>
                                </tr>
                              ...
                              <table cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td valign="top" style="padding-bottom:10px; padding-top:10px;" width="61" align="right">저녁</td>
                                  <td width="87" valign="top" style="padding-left:15px; padding-bottom:10px; padding-top:10px;">북→남 
                                    이동</td>
                                </tr>
                              </table>
							  <table cellpadding="0" cellspacing="0" width="262" align="center">
                        ...
                        <p>※ 주말에는 박연폭포 대신 <strong><font color="#FF6C00">왕건왕건/공민왕릉 
                          코스</font></strong> 또는 <strong><font color="#FF6C00">영통사 
                          코스</font></strong>를 선택하실 수 있습니다. </p></td>
                    </tr>
                    <tr>
                      <td style="padding-bottom:24px;"><table width="610" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td><img src="/kaesong/images/trip/img01.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img02.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img03.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img04.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img05.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img06.jpg" width="610" height="105"></td>
                          </tr>
                          <tr> 
                            <td>&nbsp;</td>
                          </tr>
                          <tr> 
                            <td><img src="/kaesong/images/trip/img07.jpg" width="610" height="105"></td>
                          </tr>
                        </table>
                       </td>
                    </tr>
