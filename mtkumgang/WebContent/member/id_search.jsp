...
<form name=form1 method=post action=member_action.jsp >
					...
					<td valign="top">
						...
						<tr valign="top">
							...
							<td width="484" style="padding:35 0 18 0px;">
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tr><td><img src="<%=imageServer%>/tour_img/login/txt_login31.gif"></td></tr>
								<tr><td style="padding:18 0 0 0px;"><img src="<%=imageServer%>/tour_img/login/txt_login32.gif"></td></tr>
								</table>
							</td>
						</tr>
						<tr valign="top">
							...
							<td height="100" class="bg_sky">
								...
								<tr>
									<td width="52"><img src="<%=imageServer%>/tour_img/login/txt05.gif"><!-- 이름 --></td>
									<td width="432"><input type="text" name="name" style="width:121px;" class="input09" tabindex=1></td>
								</tr>
								<tr><td colspan="2" height="5"></td></tr>
								<tr>
									<td><img src="<%=imageServer%>/tour_img/login/txt06.gif"><!-- 주민번호 --></td>
									<td class="txt_dsky">
									<input type="text" name="regno1" maxlength="6" style="width:121px;" class="input09"  onkeyup=movenext(this.form.regno1,this.form.regno2,6)     tabindex=2> - 
									<input type="password" name="regno2" maxlength="7" style="width:121px;" class="input09" onkeypress="if (13 == event.keyCode) checkForm1();" tabindex=3>
									<a href="javascript:checkForm1();"><img src="<%=imageServer%>/tour_img/btn/btn_confirm.gif" align="absmiddle" hspace="10"></a><!-- 확인 --></td>
								</tr>
								</table>
							</td>
						</tr>
