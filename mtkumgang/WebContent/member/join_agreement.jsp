...
<%	
	...
	//아이핀 서버와 통신을 위한 키파일 생성 &실명인증 
	//HTML 페이지에 write할 Writer 객체 생성, 외부 프로그램 실행을 위한 Runtime 객체 생성
	Writer writer    = response.getWriter();
	Runtime oRuntime = Runtime.getRuntime();

	//실명인증
	//날짜 연산을 위한 Calendar와 SimpleDateFormat 객체 생성
	//응답 코드 포맷을 위한 DecimalFormat 객체 생성
...
%>
<%
	 //20110614..새로운 실명인증 도입 전... 실명인증 도입을 하기 위해 원래 있던 부분..
...
<a href="javascript:goWarning();"><img src="<%=imageServer%>/tour_img/btn/btn_mem_confirm.gif" class="btn" alt="aaaaaaa"></a>						
					...
					<table cellpadding="0" cellspacing="0" width="624">
						<tr>
							...
							<td class="ti_b">주민등록번호 실명확인 대신 아이핀 인증을 통한 가입을 원하시면 <br>
							아래 '아이핀 인증'버튼을 눌러 회원가입을 진행해 주세요. </td>
						</tr>
						<tr>
					...
					<table cellpadding="0" cellspacing="0" width="624">
						<tr>
							<td width="9" valign="top"><img src="<%=imageServer%>/tour_img/mem/bl03.gif"></td>
							<td class="ti_b">아이핀(I-PIN)은 정부가 주관하는 주민번호 대체수단입니다.<BR>
							<B>아이핀서비스는 인터넷 상에서 개인을 식별할 수 있는 아이핀ID와 비밀번호를 부여</B>하여<BR>
							인터넷 사이트 회원가입 또는 성인인증 시, 주민등록번호의 사용 없이 본인임을 식별할 수 <BR>
							있도록 지원하는 서비스입니다.
							</td>
						</tr>
						<tr>
					...
					<table cellpadding="0" cellspacing="0" width="624">
						...
						<td width="200"></td>
						<td>
				<!--	<input type="button" value="아이핀" align="right" style="font-family:돋음; font-weight:bold; color:white; background-color:limegreen;"        onclick="certKCBIpin()"/> -->
					<input type="button" value="아이핀" align="right" style="font-family:돋음; font-weight:bold; color:white; background-color:limegreen;"        onclick="goWarning()"/> 
