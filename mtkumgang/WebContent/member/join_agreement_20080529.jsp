...
<!--
	...
	function checkForm()
	{
	    ...
	    if ( s_str.match(/\S/)==null ) {
		  alert("공백만 입력하면 안됩니다. 이름을 입력해 주십시요.");
		  form.name.focus();
		   return;
	    }
	    ...
	    if ( s_str.match(/\S/)==null ) {
		  alert("공백만 입력하면 안됩니다. 주민번호를 입력해 주십시요.");
		  form.regno1.focus();
		   return;
	    }	 
...
부 칙 (시행일) 이 약관은 2003년 04월 01일부터 시행합니다.
						...
						<tr>
						 <td height="40">&nbsp;&nbsp;
							<input type="radio" name="agrck" value="Y" class="noborder" checked><img src="<%=imageServer%>/tour_img/mem/txt_mem15.gif">
							&nbsp;&nbsp;&nbsp;
						...
						<tr><td height="1" class="line_dg"></td></tr>
						<tr><td height="40"></td></tr>
						<tr><td align="center"><a href="javascript:checkForm();"><img src="<%=imageServer%>/tour_img/btn/btn_mem_confirm.gif" class="btn"></a><a href="javascript:document.all.reset();"><img src="<%=imageServer%>/tour_img/btn/btn_mem_cancel.gif" class="btn"></a></td></tr>
						</table>
</form>
<%
