...
<%
	...
	String name = clearXSS(request.getParameter("name"),avatag );
	String regno1 = clearXSS(request.getParameter("regno1"),avatag );
	String regno2 = clearXSS(request.getParameter("regno2"),avatag );
				...
				<tr>
					<td valign="top">
						...
						<tr>
							...
							<td><input type="text" name="name" maxlength=20 value="<%=name%>" readonly style="width:152px;"></td>
						</tr>
						<tr><td height="1" colspan="3" class="line_dg"></td></tr>
						<tr>
							...
							<input type="text" name="regno1" style="width:152px;"  value="<%=regno1%>" readonly> - 
							<input type="text" name="regno2" style="width:152px;" value="<%=regno2%>" readonly></td>
						</tr>
						<tr><td height="1" colspan="3" class="line_dg"></td></tr>
						<tr>
