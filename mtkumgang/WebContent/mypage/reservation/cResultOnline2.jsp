<%/*--
  ...
  - 수정자 : 심동현 
  - 일자 : 2007-04-09
  - 설명 : 복수의 인원에 대해 결제할 경우
  -				결제총액이 개인 결제금액으로 인서트됨.
  -				u_pay_amt 라는 스트링으로 개인들의 결제금액을 "|"로 구분하여 받음
...
<%
    ...
    String u_pay_amt = ParamUtil.getReqParameter(request.getParameter("u_pay_amt"));	 //개인결제금액 (추가필드)
 ...
 if(req_tx.equals("pay")){   
     ...
     if (!bSucc.equals("false")){
            ...
            if(res_cd.equals("0000")){  
				...
				bean.setPay_cd(c_pay_gubn);		//결제코드 세팅.2007-04-09
                ...
                bean.setRsv_sid_multi(rsv_sid);					//여러명 예약 아이디
				bean.setPay_amt_multi(u_pay_amt);			//여러명 결제금액2007-04-09
