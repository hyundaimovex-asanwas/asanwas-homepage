...
//request parameters
r_mail  = ParamUtil.getReqParameter(request.getParameter("r_mail"), "z@z.com");
r_pass = ParamUtil.getReqParameter(request.getParameter("r_pass"), "1111");
chk_confirm = ParamUtil.getReqParameter(request.getParameter("chk_confirm"), "2");   // 1 : 회원예약, 2:비회원예약
