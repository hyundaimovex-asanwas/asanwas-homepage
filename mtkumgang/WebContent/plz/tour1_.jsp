	...
	<td valign="top">
		...
		<tr valign="top">
			...
			<td>
				...
				<tr><td><img src="<%=imageServer%>/tour_img/plz/img_plz02_01_02.jpg" width="690" height="227" border="0" usemap="#Map"></td></tr>
...
<map name="Map"><area shape="rect" coords="279,178,372,198" href="#"><area shape="rect" coords="377,177,464,200" href="#"><area shape="rect" coords="468,177,559,200" href="#"><area shape="rect" coords="561,176,660,200" href="#"></map></body>
</html>