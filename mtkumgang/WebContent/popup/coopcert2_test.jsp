...
<%
String doTira = request.getParameter("doTira");					// *** 협력사 구분 nCo관광/출입 nOm물류 ***
//세션 체크 ///////////////////////////////////////////////////////////////////////
...
okname 파라미터
**************************************************************************/
	String aed = request.getParameter("aed");						// *** 아이디 ***
...
String target_id = "coopCert";
String return_url ="";

if(doTira.equals("nCo")){	//관광
//	return_url = "http://toursales.hdasan.com/services/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID+"&doTira="+doTira ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
	return_url = "http://10.61.108.35:9095/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID+"&doTira="+doTira ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
}
if(doTira.equals("nOm")){	//물류
//	return_url = "http://oms.hdasan.com/services/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID+"&doTira="+doTira ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
	return_url = "http://10.61.108.35:9095/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID+"&doTira="+doTira ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"align="left">
  	<tr>
	  	<td><label ><h3>본인인증 진행 중(4)</h3></label></td>
  	</tr>
  	<tr>
