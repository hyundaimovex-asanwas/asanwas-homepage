...
**************************************************************************/
	...
	String client_ip = "203.242.32.195";										// 회원사 IP, InetAddress.getLocalHost().getHostAddress() 로 얻어올 수 있음.
...
String target_id = "http://localhost:9080/newPwd3.jsp";							///////////////////////////////////////////////맞낭?;; 
//String return_url = "https://www.mtkumgang.com/popup/hscert3.jsp";	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
//String return_url = "http://localhost:9080/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
String return_url = "http://erp.hdasan.com/services/newIndeX_act2.jsp?SAed="+aed+"&ssID="+ssID ;	// ** 본인인증 완료후 리턴될 URL (도메인 포함 full path)
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"align="left">
  	<tr>
	  	<td align="center"></td>
	  	<td><label ><h3>195_본인인증 진행 중!!!</h3></label></td>
  	</tr>
</table>
</body>
</html>
