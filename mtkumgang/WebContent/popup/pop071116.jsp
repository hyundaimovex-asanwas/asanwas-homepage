...
<table width="400" height="380" cellpadding="0" cellspacing="0">
  <tr> 
    <td valign="top"><img src="/popimgs/popup_20071116.gif" width="400" height="355" border="0" usemap="#Map"></td>
  </tr>
  <tr>
...
<map name="Map">
  <area shape="rect" coords="317,306,394,327" href="javascript:goPage4();" onFocus="this.blur()">
  <area shape="rect" coords="319,226,395,250" href="javascript:goPage3();"onFocus="this.blur()">
  <area shape="rect" coords="320,67,396,90" href="javascript:goPage1();"onFocus="this.blur()">
<area shape="rect" coords="319,143,395,164" href="javascript:goPage2();"onFocus="this.blur()"></map>
</body>
</html>
