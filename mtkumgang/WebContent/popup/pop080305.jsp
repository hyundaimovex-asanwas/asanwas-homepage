...
<!--
	...
	function goPage2()
	{
		opener.location="http://www.mtkumgang.com/utility/notice/notice_view.jsp?board_seq=3424&requestedPage=1&part=&keyword=";
		window.close();    
	}
...
<table width="400" cellpadding="0" cellspacing="0">
  <tr> 
    <td valign="top"><img src="/popimgs/imgevent080305.gif" width="400" height="355" border="0" usemap="#Map">
<map name="Map">
      
      <area shape="rect" coords="311,152,398,177" href="http://gen.gmarket.co.kr/challenge/neo_sangsul/html_sangsul/plan_display_43766.asp?sid=43766&goodscode=&stat=S3&subkind=" target="_blank" onFocus="this.blur()"><area shape="rect" coords="314,85,396,114" href="javascript:goPage2();"  onFocus="this.blur()">
