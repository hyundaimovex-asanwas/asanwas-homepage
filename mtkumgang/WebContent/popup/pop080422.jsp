...
<table width="400" cellpadding="0" cellspacing="0">
  <tr> 
    <td valign="top"><img src="/popimgs/imgevent080422.gif" width="400" height="355" border="0" usemap="#Map">
<map name="Map">
	  ...
	  <area shape="rect" coords="318,246,397,270" href="javascript:goPage1();"  onFocus="this.blur()">
        <area shape="rect" coords="317,331,396,355" href="http://baton.hdasan.com/" target="_blank"  onFocus="this.blur()">
    </map></td>
  </tr>
  <tr>
