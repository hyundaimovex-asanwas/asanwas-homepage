...
<table width="400" cellpadding="0" cellspacing="0">
  <tr> 
    <td valign="top"><img src="/popimgs/imgevent080620.gif" width="400" height="437" border="0" usemap="#Map">
      <map name="Map">
        ...
        <area shape="rect" coords="319,327,396,354" href="javascript:goPage4();" onFocus="this.blur()">
        <area shape="rect" coords="318,411,397,433" href="javascript:goPage5();" onFocus="this.blur()">
    </map></td>
  </tr>
  <tr>
