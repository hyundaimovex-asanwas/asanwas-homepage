	...
	<tr>
		...
		<!--컨텐츠 시작-->
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>	
					<td style="padding:31 0 19 27"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_01.gif"></td>
				</tr>
				<tr>
					<td align="center">
							...
							<tr>
								<td align="center">
									<table cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" width="746" height="291">
										<tr>
											<td height="30" valign="bottom" style="padding:0 0 0 10"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_02.gif"></td>
										</tr>
										<tr>
											<td height="5"></td>
										</tr>
										<tr>
											<td class="fs14" style="padding:10 0 0 10"><a href="javascript:moveMonth(-1)"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_prev.gif" border="0"></a> <b><%=today_ymd.substring(0,4)%>년 <%=today_ymd.substring(4,6)%>월</b> <a href="javascript:moveMonth(1)"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step2_next.gif" border="0"></a></td>
										</tr>
										<tr>
													...
													<tr>
														<td width="386" height="210" align="center" valign="bottom" bgcolor="B8C7D0">
															<table cellpadding="0" cellspacing="1" width="100%">
																<tr>
																	<td height="30"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_sun.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_mon.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_tue.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_wed.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_thu.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_fri.gif"></td>
																	<td><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step2_sat.gif"></td>
																</tr>
<%
...
%>
														...
														<td valign="top"> 
															<table cellpadding="0" cellspacing="0" width="330">
																...
																<tr>
																	<td align="right"><a href="javascript:prevStep()" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/eng/step_prev.gif" border="0"></a> <a href="javascript:nextStep()" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/eng/step_next.gif" border="0"></a></td>
																</tr>
															</table>
														</td>
													</tr>
