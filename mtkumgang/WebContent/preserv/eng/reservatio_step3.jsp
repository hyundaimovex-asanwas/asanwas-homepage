		...
		if(result != null) {
			...
			if(lists.length == 0) {
				...
				for(var i=0 ; i<cnt ; i++) {
					...
					content += "		</td>\n";
					content += "		<td align=center><img src=<%=imageServer%>/tour_img/reservation/eng/reservatio_step3_viewbt.gif onclick=javascript:open_info('"+sel_upjang_sid+"','"+trim(room_type_sid)+"') onMouseOver=this.style.cursor='hand'></td>\n";
					content += "	</tr>\n";
					content += "	<tr>\n";
					content += "		<td colspan=5 height=3></td>\n";
					content += "	</tr>\n";
	...
	<tr>
		...
		<!--컨텐츠 시작-->
			<table cellpadding="0" cellspacing="0" width="770">
				<tr>	
					<td style="padding:31 0 19 27"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step3_01.gif"></td>
				</tr>
				<tr>
					<td align="center">
							...
							<tr>
								<td align="center">
									<table cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" width="746" height="291">
										<tr>
											<td width="328" height="30" valign="bottom" style="padding:0 0 0 10"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step3_02.gif"></td>
											<td valign="bottom"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step3_03.gif"></td>
										</tr>
										<tr>
											<td height="5"></td>
											<td></td>
...
%>
																			<tr onMouseOver="this.style.backgroundColor='#FFE9BB'; this.style.cursor='hand'" onMouseOut="this.style.backgroundColor='#F8F8F8'" onClick="javascript:view_Detail('<%=result[i].getUpjang_sid()%>','<%=result[i].getUpjang_nm()%>')">
																				...
																				<td align="center"><img src="<%=imageServer%>/tour_img/reservation/eng/reservatio_step3_viewbt.gif" onclick="javascript:open_info('<%=result[i].getUpjang_sid()%>','')"></td>
																			</tr>
																			<tr>
																				<td colspan="3" height="3"></td>
																			</tr>
										...
										<tr>
											...
											<td valign="top">
												<table width="100%" cellpadding="0" cellspacing="0">
													<tr>
														<td align="right">
															<div id="btn"><a href="javascript:prevStep()" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/eng/step_prev.gif" border="0"></a> <a href="javascript:nextStep()" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/eng/step_next.gif" border="0"></a></div></td>
													</tr>
											  </table>
											</td>
										</tr>
