...
<%
	...
	String[] arr_room_sid = sel_room_sid.split(",");
	String[] arr_room_nm = new String[arr_room_sid.length];
	String[] arr_room_max = new String[arr_room_sid.length];
...
<script language="javascript">
	...
	function nextStep() {
			...
			for(var j=0 ; j<int_max ; j++) {
				...
				if(nm != "") {
					...
					//전화번호 크기가 작을경우
						...
						total_person_info += "pinfo_"+arr_room_sid[i]+"_"+i+"_"+j+"_"+nm+"_"+jumin+"_"+tel_no+",";
					}
				} 
			}
		}	
		...
		if(errorFlag == "true") {
			...
			document.resv.action = "reservatio_step5.jsp";
			document.resv.submit();
		} else {
																			...
																			<tr>
																			  <td height="18" class="res03"><input name="nm_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" style="width:61px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"></td>
																				...
																				<td align="center" class="res03"><select name="tel_first_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" class="linemap_now" style="width:50px; height:18; border:1px #EFB345 solid; color:#666666; font-size:11px; font-face:돋움;"  type="text">
                                                                                  ...
                                                                                  </select> - <input name="tel_second_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" style="width:45px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"> 
                                                                                  - <input name="tel_third_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" style="width:45px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"></td>
																				<td width="74"></td>
																				<td align="center" class="res03"><div id=<%="price_gbn"+"_"+i+"_"+j%>></div></td>
																				<td align="center" class="res03"><div id=<%="price"+"_"+i+"_"+j%>></div></td>
																			</tr>
<%
