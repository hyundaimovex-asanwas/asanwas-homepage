...
%>
<%
  String reviewType = "01"; //온천관광
  String returnUrl = "order_goods_01.jsp";
%>
<%
			...
			<td>
				...
				<tr>
					<td colspan="2">
						...
						<tr valign="top">
							<td><img src="<%=imageServer%>/tour_img/apply/top_txt_app31.gif" style="margin-top:12px;"></td>
				...
				<tr valign="top">
					<td width="300">
						...
						<tr>
							<td valign="top" height="261"><img src="<%=imageServer%>/tour_img/apply/img_order11.jpg" width="269" height="246" id="limg"></td>
						</tr>
						<tr>
							<td><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order11.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s11.jpg" width="83" height="48"></a><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order12.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s12.jpg" width="83" height="48" style="margin-left:10px;"></a><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order13.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s13.jpg" width="83" height="48" style="margin-left:10px;"></a></td>
						</tr>
						</table>
					</td>
					<td width="390">
						...
						<tr valign="top">
							...
							<td width="23"></td>
							<td>온정리에 위치한 금강산온천은 지명에서 알 수 있듯이 예부터 온천이 유명한 곳입니다. 조선 세조 임금도 이곳에서 피부병을 치료했다고 전해질만큼 그 탁월한 효능이 오래도록 사람들의 입에 오르내렸습니다.<br>온천관광은 편안한 휴식과 일상의 피로를 회복하고 싶어하는 관광객에게 알맞은 상품입니다. 특히 천연 소나무 산림욕을 즐기며 비로봉, 집선봉, 채하봉 등 금강산의 비경을 한눈에 조망할 수 있는 노천탕에서의 온천은 마치 신선이 된 듯한 착각을 일으키게 합니다.</td>
						</tr>
						<tr><td colspan="4" height="7"></td></tr>
						<tr><td class="line_g2" colspan="4" height="1"></td></tr>
						<tr>
...
<div id="dateview1" <%if(dateview.equals("1")){%>style="display:show;"<%}else{%>style="display:none;"<%}%>>
								...
								<tr>
									...
									<td class="bg_white lpad_20" height="26">온천(개별탕)</td>
									<td class="bg_white lpad_20"></td>
								</tr>
								<tr>
...
<div id="dateview3" <%if(dateview.equals("3")){%>style="display:show;"<%}else{%>style="display:none;"<%}%>>
								...
								<tr>
									...
									<td class="bg_white lpad_20">온천(개별탕)</td>
									<td class="bg_white lpad_20"></td>
								</tr>
								<tr>
