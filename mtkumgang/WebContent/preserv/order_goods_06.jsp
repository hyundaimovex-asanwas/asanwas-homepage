...
%>
<%
  String reviewType = "06"; //기업연수워크샵
  String returnUrl = "order_goods_06.jsp";
%> 
<%
			...
			<td>
				...
				<tr>
					<td colspan="2">
						...
						<tr valign="top">
							<td><img src="<%=imageServer%>/tour_img/apply/top_txt_app36.gif" style="margin-top:12px;"></td>
				...
				<tr valign="top">
					<td width="300">
						...
						<tr>
							<td valign="top" height="261"><img src="<%=imageServer%>/tour_img/apply/img_order61.jpg" width="269" height="246" id="limg"></td>
						</tr>
						<tr>
							<td><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order61.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s61.jpg" width="83" height="48"></a><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order62.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s62.jpg" width="83" height="48" style="margin-left:10px;"></a><a href="javascript:;" onmouseover="limg.src='<%=imageServer%>/tour_img/apply/img_order63.jpg'"><img src="<%=imageServer%>/tour_img/apply/img_order_s63.jpg" width="83" height="48" style="margin-left:10px;"></a></td>
						</tr>
						</table>
					</td>
					<td width="390">
						...
						<tr valign="top">
							...
							<td width="23"></td>
							<td>금강산은 산의 경치도 아름답지만 풍부한 즐길거리와 단체 수용 시설이 있어 단체행사를 하기에 최상의 조건을 가지고 있습니다. <br>대규모 연회장과, 세미나, 공연시설이 준비되어 있고 크고작은 수많은 행사를 진행한 전문가들이 최적의 지원을 약속합니다.<br>※ 단체의 성격에따라 관광일정 조정이 가능합니다.</td>
						</tr>
						<tr><td colspan="4" height="7"></td></tr>
						<tr><td class="line_g2" colspan="4" height="1"></td></tr>
						<tr>
...
<div id="dateview1" <%if(dateview.equals("1")){%>style="display:show;"<%}else{%>style="display:none;"<%}%>>
								...
								<tr>
									<td class="bg_white lpad_20" height="26">12:10</td>
								...
								<tr>
									<td class="bg_white lpad_20" height="26">16:00</td>
									<td class="bg_white lpad_20">숙소 체크인</td>
									<td class="bg_white lpad_20"></td>
								</tr>
								<tr>
									<td class="bg_white lpad_20" height="26">16:30</td>
								...
								<tr>
									<td class="bg_white lpad_20" height="26">19:00</td>
									<td class="bg_white lpad_20">연회 및 오리엔테이션</td>
...
<div id="dateview2" <%if(dateview.equals("2")){%>style="display:show;"<%}else{%>style="display:none;"<%}%>>
								...
								<tr>
									<td class="bg_white lpad_20" height="26">12:30</td>
								...
								<tr>
									...
									<td class="bg_white lpad_20" height="26">금강산의 밤(세미나, 교육, 대회 등)<br>	금강산 나이트라이프<br>(호프&주점, 노래방, 야외 바베큐 등)</td>
...
<div id="dateview3" <%if(dateview.equals("3")){%>style="display:show;"<%}else{%>style="display:none;"<%}%>>
								...
								<tr>
									<td class="bg_white lpad_20" height="26">08:00</td>
									<td class="bg_white lpad_20">만물상 또는 삼일포/해금강 코스 관광</td>
									<td class="bg_white lpad_20"></td>
								</tr>
								<tr>
									<td class="bg_white lpad_20" height="26">11:30</td>
									<td class="bg_white lpad_20">중식</td>
									<td class="bg_white lpad_20"></td>
								</tr>
								<tr>
