          ...
          <tr valign="top">
                        ...
                        <table width="690" cellpadding="0" cellspacing="0" border="0">
                          ...
                          <tr>
                            <td height="33" class="bg_lgreen lpad_15 txt_dgreen"><img src="<%=imageServer%>/tour_img/bu/bu_dgreen_rec.gif" align="absmiddle">
                                ...
                                최성수기기간 : 7.27 ~ 8.11 / 9.28 ~ 10.27
                                <%}else if(menu_item1.equals("20")){%>
                                성수기기간 : 3.22 ~ 7.26 / 8.12 ~ 9.27 / 10.28 ~ 11.30
                                <%}else if(menu_item1.equals("01")){%>
                                비수기기간 : 11.25 ~ 3.21
                                <%}%>                            </td>
                          </tr>
	        ...
	        %>
              ...
              <table width="690" border="0" cellpadding="0" cellspacing="0">
				...
				%>
				☞ 포함 내역 :  조식비, 관광가이드안내비. 여행자보험료, 입출국 수속비, 명승지입장료</span>
				<%
					}
				%>
				</td>
                ...
                <col width="165" style="padding:15 5 15 15px;">
                  ...
                  <tr>
                    ...
                    <td class="cwlg"><p>금요일/토요일 출발 : 1박 2일 <br>
                            ...
                            <strong> 최성수기 60,000원 추가 </strong></strong></p></td>
                    <td class="cwlg"><br>
                      대학생/성인만 해당</td>
                  </tr>
                  <% 
                  ...
                  <tr>
                    <td class="cwlg"><div align="center">주말요금</div></td>
                    <td class="cwlg"><p>금요일/토요일 출발 : 당일<br>
                          <strong>성수기 20,000원 추가</strong></p></td>
                    <td class="cwlg"><br>
                      대학생/성인만 해당</td>
                  </tr>
                  <%
                  ...
                  <tr>
                    <td class="cwlg"><div align="center">주말요금</div></td>
                    <td class="cwlg"><p>금요일/토요일 출발 : 2박 3일<br>
                          <strong>성수기 50,000원 추가<br>
                            최성수기 90,000원 추가 </strong></p></td>
                    <td class="cwlg"><br>
                      대학생/성인만 해당</td>
                  </tr>
                  <%
                    ...
                    <td class="cwlg"><p><strong>내금강관광 요금 :  기본 2박 3일 관광요금 <font color=red>+ 50,000원</font></strong></p>
                      ...
                      <table width="500" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                          ...
                          <tr>
                            ...
                            <td width="87" bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>비수기</strong></font></div></td>
                            <td width="83" bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>성수기</strong></font></div></td>
                            <td width="93" bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>최성수기</strong></font></div></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>290,000</strong></font></div></td>
                            <td bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>300,000</strong></font></div></td>
                            <td bgcolor="#F7F7F7"><div align="center"><font color="#993399"><strong>370,000</strong></font></div></td>
                          </tr>
                      </table>
