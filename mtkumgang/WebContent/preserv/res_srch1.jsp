...
<form name=myform method='post' action=res_srchOK.jsp>
<input type="hidden" name="chk_confirm">
						...
						<tr>
							...
							<td style="padding-top:16px">
<form name=myform1 method='post' action=res_srchOK.jsp>
<input type="hidden" name="chk_confirm">
									<table height="44" cellpadding="0" cellspacing="0" border="0">
									<tr valign="top">
										<td width="70" height="25"><img src="<%=imageServer%>/reservation/img/txt_01.gif" vspace="4"><!-- 성명 --></td>
										<td width="227"><input type="text" name="cust_nm" style="width:215px;" class="input09" tabindex="4"></td>
										<td rowspan="2"><a href="javascript:checkForm('3');"><img src="<%=imageServer%>/tour_img/mypage/btn_confirm.gif" tabindex="6"></a><!-- 확인 --></td>
									</tr>
									<tr valign="top">
										<td><img src="<%=imageServer%>/reservation/img/txt_02.gif" vspace="4"><!-- 주민번호 --></td>
										<td><input type="password" name="manage_no" style="width:215px;" class="input09"  tabindex="5"></td>
									</tr>
									</table>
</form>									
							</td>
						...
						<tr>
							<td colspan=2>　　　　　※ 본인의 <b>예약상황을 확인</b>할 수 있으며,<b> 
													   금강산 온천 무료 입장</b>당첨여부도 아래와 같이 확인할 수 있습니다.</TD>
						</tr>
						</table>

							<table>
								<tr valign="top">
									<td><img src="/popimgs/spa.jpg" width="720" height="191" border="0"><!-- 온천담청자 안내문 --></td>
								</tr>
							</table>
					</td>
				</tr>
