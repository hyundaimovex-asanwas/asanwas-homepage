    ...
    <td>
				...
				<tr>
					<td valign="top">
						...
						%>
						<table width="690" cellpadding="0" cellspacing="0" border="0">
						<col width="50"><col width="120"><col width="95"><col width="95">
						<col width="80"><col width="95"><col width="155">
						...
						<tr align="center">
							...
							<td colspan=2 align=center><b>관광 재개 후 선택</b></td>
						...
						<tr>
							<td align="center">
								<%=HtmlUtil.doPageCut(requestedPage, pageCount , position , "res_srch2.jsp", "500", key_str ,imageServer+"/imjk_img/", blockPerPage)%>
						</tr>
						</table>
						<!-- paging/ -->
					</td>
