...
<!--
  function PageMov(val) {
     if (val == "list"){
        document.form.action="res_srch2.jsp";
     }else if(val == "02"){
        document.form.action="res_srch4.jsp";
     }
...
//                                         }
								...
								<table cellspacing="0" cellpadding="0" border="0" width="510">
								<tr>
									<td valign="top" height="26" colspan="4" style="padding-top:8px">※ 예약 7일 이내 입금하지 않으면 자동 취소 될 수 있습니다.</td>
								</tr>
								</table>
...
%>
								...
								<tr align="center">
									...
									<%if( status_cd.equals("RA")  ||  status_cd.equals("DP")){%>
        									<%
        									  if (pay_yn.equals("Y")){	//완료인 경우 영수증 띄우기
        									%>
        									    <a href="javascript:popConfirm('<%=rsv_sid%>')"><img src="<%=imageServer%>/tour_img/btn/btn_s_view.gif"></a>
        									<%
                                              }else{  
        									%>
	        ...
	        %>
								...
								<table cellspacing="0" cellpadding="0" border="0" width="510" style="margin-top:14px;">
								  ...
								  <tr>
									<td height="53" colspan="2"><B>※ 상기요금은 출발일/시즌 별로 변동될 수 있으니 상담원을 통해<br>
										　　확인하시기 바랍니다.</B><br>
										<B>※ 현대아산 관광안내 (02-3669-3000)</B>
<!-- ※ 관광요금은 상담원 안내 후 결제바랍니다. (02-3669-3000)</B>-->
									</td>
								  </tr>
<!--								  <tr>
