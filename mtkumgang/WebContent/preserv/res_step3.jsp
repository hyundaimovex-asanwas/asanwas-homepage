...
//사전예약용 수정~:)
	...
	String saup_sid 	= "1";								//관광지 코드
	String start_ymd 	= "20091111";						//출발일자
	String weekend_yn 	= "N";								//주말여부
	...
	//여기서 오류나네 20100624 : 열린방이 없으면 오류나네..여기서..쩝..
...
//			alert(total_person_info);
			document.resv.action = "res_step3_proc.jsp";
			document.resv.submit();
		} else {
...
<table cellpadding="0" cellspacing="0" height="470" width=720>
  <tr>
	...
	<tr>
		...
		<!--컨텐츠 시작-->
			<table cellpadding="0" cellspacing="0" width="720">
				<tr>	
					<td style="padding:20 0 10 16"><img src="<%=imageServer%>/reservation/img/title_step3.gif"></td>
				</tr>
				<tr>
					<td align="center">
						<table cellpadding="0" cellspacing="0" width="700" height="325" bgcolor="E3E3E3">
							<tr>
								<td align="center">
									<table cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" width="696" height="321">
										<!--<tr>
											<td height="30" valign="bottom" style="padding:0 0 0 10">
												<table cellpadding="0" cellspacing="0">
													<tr>
														<td valign="top" style="padding-left:15px;"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step4_con.gif" align="absmiddle"> <span class="pagingon"><%=limit_ymd.substring(0,4)%>년 <%=Integer.parseInt(limit_ymd.substring(4,6))%>월 <%=Integer.parseInt(limit_ymd.substring(6,8))%>일까지</span> 관광객등록을 해주셔야 관광예약이 됩니다.</td>
													</tr>
												</table>	
											</td>	
										</tr>
										...
										<tr>
											<td valign="top" style="padding:5 0 0 10">
												<table cellpadding="0" cellspacing="0">
													<tr>
														<td  width="726" height="251" valign="middle" align="center">
															<table cellpadding="0" cellspacing="0" width="674" height="249" bgcolor="F8F8F8" border=1 bordercolor=#B8C7D0>
																<tr>
																	<td><div style="overflow-y:scroll; width:674; height:249; padding:10px; scrollbar-highlight-color: #CCCCCC; scrollbar-shadow-color: #CCCCCC; scrollbar-arrow-color: #CCCCCC; scrollbar-face-color: #FFFFFF; scrollbar-3dlight-color: #FFFFFF; scrollbar-darkshadow-color: #FFFFFF; scrollbar-track-color: #FFFFFF;">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td width="67" align="center" class="res01">이름</td>
																				<td width="219" align="center" class="res01">주민등록번호</td>
																				<td width="186" align="center" class="res01">핸드폰번호</td>
																			...
																			<tr>
																			  <td height="18" class="res03"><input name="nm_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" style="width:61px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"></td>
																				...
																				<td align="center" class="res03"><select name="tel_first_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" class="linemap_now" style="width:50px; height:18; border:1px #EFB345 solid; color:#666666; font-size:11px; font-face:돋움;"  type="text">
                                                                                  ...
                                                                                  </select> - <input name="tel_second_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" maxlength=4 style="width:45px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"> 
                                                                                  - <input name="tel_third_<%=arr_room_sid[i]%>_<%=i%>_<%=j%>" type="text" maxlength=4 style="width:45px; height:18px; border:1px #ABABAB solid; color:#666666; font-size:11px; font-face:돋움;"></td>
																			</tr>
<%
																}
%>
