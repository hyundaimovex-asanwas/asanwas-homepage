	...
	<tr>
		...
		<!--컨텐츠 시작-->
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>	
					<td style="padding:31 0 19 27"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step1_01.gif"></td>
				</tr>
				<tr>
					<td align="center">
										...
										<tr>
											<td align="center" valign="top">
												<table cellpadding="0" cellspacing="0">
													...
													<tr>
														<td></td>
														<td align="center" style="padding:7 0 0 0"><a href="javascript:reservation('28')" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step1_bt_1.gif" border="0"></a></td>
														<td width="25"></td>
														<td align="center" style="padding:7 0 0 0"><a href="javascript:reservation('27')" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step1_bt_2.gif" border="0"></a></td>
														<td width="25"></td>
														<td align="center" style="padding:7 0 0 0"><a href="javascript:reservation('30')" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step1_bt_3.gif" border="0"></a></td>
														<td></td>
													</tr>
												</table>
										  </td>
