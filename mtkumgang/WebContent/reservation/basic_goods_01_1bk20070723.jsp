						...
						<tr>
                          ...
                          <table cellspacing="1" cellpadding="3" border="0" width="690" class="tabline">
							...
							<table cellspacing="1" cellpadding="3" border="0" width="690">
								<tr><td colspan="3" height="31" valign="bottom" class="txt_orange2 fs11 lpad_10">※ 상기 일정은 현지 사정에 의하여 변경될 수 있습니다.</td></tr>
								<tr><td colspan="3" height="12"></td></tr>
		                 		<tr><td colspan="3"><img src="<%=imageServer%>/tour_img/apply/img_tip_order.gif"></td></tr>
								</table>
								</table>
								</div>
								<!-- 표1 / -->
                          ...
                          <table cellspacing="1" cellpadding="3" border="0" width="690" class="tabline">
                            ...
                            <tr> 
                              <td class="bg_white" align="center" height="26">08:00~18:00</td>
                              <td class="bg_white lpad_20">내금강코스 관광코스 및 중식</td>
                              <td class="bg_white lpad_20"></td>
                            </tr>
                            <tr> 
							...
							<table cellspacing="1" cellpadding="3" border="0" width="690">
								<tr><td colspan="3" height="31" valign="bottom" class="txt_orange2 fs11 lpad_10">※ 상기 일정은 현지 사정에 의하여 변경될 수 있습니다.</td></tr>
								<tr><td colspan="3" height="12"></td></tr>
		                 		<tr><td colspan="3"><img src="<%=imageServer%>/tour_img/apply/img_tip_order02.gif"></td></tr>
								</table>
								</table>
								</div>
								<!-- 표2 / -->
