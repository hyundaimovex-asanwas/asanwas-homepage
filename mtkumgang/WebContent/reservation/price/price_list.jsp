                        ...
                        <table width="690" cellpadding="0" cellspacing="0" border="0">
                          ...
                          <tr>
							...
							<%if (menu_item1.equals("30")){ %>
                                <a href="price_list.jsp?menu_item1=30&menu_item4=<%=menu_item4%>&use_date=20091031"><img src="<%=imageServer%>/tour_img/apply/tab_day01on.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'"></a><a href="price_list.jsp?menu_item1=20&menu_item4=<%=menu_item4%>&use_date=20091101"><img src="<%=imageServer%>/tour_img/apply/tab_day02.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day02.gif'"></a><a href="price_list.jsp?menu_item1=10&menu_item4=<%=menu_item4%>&use_date=20091120"><img src="<%=imageServer%>/tour_img/apply/tab_day05.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day05.gif'"></a><a href="price_list.jsp?menu_item1=01&menu_item4=<%=menu_item4%>&use_date=20091201"><img src="<%=imageServer%>/tour_img/apply/tab_day04.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day04.gif'"></a><img src="<%=imageServer%>/tour_img/apply/tab_day_rig.gif">
                                <%}else if (menu_item1.equals("20")){ %>
                                <a href="price_list.jsp?menu_item1=30&menu_item4=<%=menu_item4%>&use_date=20091031"><img src="<%=imageServer%>/tour_img/apply/tab_day01.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day01.gif'"></a><a href="price_list.jsp?menu_item1=20&menu_item4=<%=menu_item4%>&use_date=20091101"><img src="<%=imageServer%>/tour_img/apply/tab_day02on.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'"></a><a href="price_list.jsp?menu_item1=10&menu_item4=<%=menu_item4%>&use_date=20091120"><img src="<%=imageServer%>/tour_img/apply/tab_day05.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day05.gif'"></a><a href="price_list.jsp?menu_item1=01&menu_item4=<%=menu_item4%>&use_date=20091201"><img src="<%=imageServer%>/tour_img/apply/tab_day04.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day04.gif'"></a><img src="<%=imageServer%>/tour_img/apply/tab_day_rig.gif">
								<%}else if (menu_item1.equals("10")){ %>
                                <a href="price_list.jsp?menu_item1=30&menu_item4=<%=menu_item4%>&use_date=20091031"><img src="<%=imageServer%>/tour_img/apply/tab_day01.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day01.gif'"></a><a href="price_list.jsp?menu_item1=20&menu_item4=<%=menu_item4%>&use_date=20091101"><img src="<%=imageServer%>/tour_img/apply/tab_day02.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day02.gif'"></a><a href="price_list.jsp?menu_item1=10&menu_item4=<%=menu_item4%>&use_date=20091120"><img src="<%=imageServer%>/tour_img/apply/tab_day05on.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'"></a><a href="price_list.jsp?menu_item1=01&menu_item4=<%=menu_item4%>&use_date=20091201"><img src="<%=imageServer%>/tour_img/apply/tab_day04.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day04.gif'"></a><img src="<%=imageServer%>/tour_img/apply/tab_day_rig.gif">
                                <%}else if (menu_item1.equals("01")){ %>
                                <a href="price_list.jsp?menu_item1=30&menu_item4=<%=menu_item4%>&use_date=20091031"><img src="<%=imageServer%>/tour_img/apply/tab_day01.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day01.gif'"></a><a href="price_list.jsp?menu_item1=20&menu_item4=<%=menu_item4%>&use_date=20091101"><img src="<%=imageServer%>/tour_img/apply/tab_day02.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day02.gif'"></a><a href="price_list.jsp?menu_item1=10&menu_item4=<%=menu_item4%>&use_date=20091120"><img src="<%=imageServer%>/tour_img/apply/tab_day05.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day05.gif'"></a><a href="price_list.jsp?menu_item1=01&menu_item4=<%=menu_item4%>&use_date=20091201"><img src="<%=imageServer%>/tour_img/apply/tab_day04on.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'"></a><img src="<%=imageServer%>/tour_img/apply/tab_day_rig.gif">
                                <%}else{%>
                                <a href="price_list.jsp?menu_item1=30&menu_item4=<%=menu_item4%>&use_date=20091031"><img src="<%=imageServer%>/tour_img/apply/tab_day01.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day01on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day01.gif'"></a><a href="price_list.jsp?menu_item1=20&menu_item4=<%=menu_item4%>&use_date=20091101"><img src="<%=imageServer%>/tour_img/apply/tab_day02.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day02on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day02.gif'"></a><a href="price_list.jsp?menu_item1=10&menu_item4=<%=menu_item4%>&use_date=20091120"><img src="<%=imageServer%>/tour_img/apply/tab_day05.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day05on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day05.gif'"></a><a href="price_list.jsp?menu_item1=01&menu_item4=<%=menu_item4%>&use_date=20091201"><img src="<%=imageServer%>/tour_img/apply/tab_day04.gif" onMouseOver="this.src='<%=imageServer%>/tour_img/apply/tab_day04on.gif'" onMouseOut="this.src='<%=imageServer%>/tour_img/apply/tab_day04.gif'"></a><img src="<%=imageServer%>/tour_img/apply/tab_day_rig.gif">
                            <%}%>                            </td>
                          </tr>
                          <tr>
                            <td height="33" class="bg_lgreen lpad_15 txt_dgreen"><img src="<%=imageServer%>/tour_img/bu/bu_dgreen_rec.gif" align="absmiddle">
                                <% if(menu_item1.equals("30")){%>
                                최성수기기간 : 5.1 ~ 5.08 / 9.26 ~ 10.31
                                <%}else if(menu_item1.equals("20")){%>
                                성수기기간 : 4.11 ~ 4.30 / 5.09 ~ 5.30 / 7.11 ~ 9.25 / 11.1 ~ 11.14
								<%}else if(menu_item1.equals("10")){%>
                                평수기기간 : 3.21 ~ 4.10 / 5.31 ~ 7.10 / 11.16 ~ 11.28
                                <%}else if(menu_item1.equals("01")){%>
                                비수기기간 : 1.1 ~ 3.20 / 11.29 ~ 12.31
                                <%}%>                            </td>
                          </tr>
                        </table>
                      <!-- 시즌선택 / -->                    </td>
