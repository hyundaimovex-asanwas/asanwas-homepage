										...
										<tr>
											<td height="30" valign="bottom" style="padding:0 0 0 10">
												<table cellpadding="0" cellspacing="0">
													<tr>
														<td><a href="reservatio_step4.jsp" onFocus="this.blur()"><img src="<%=imageServer%>/tour_img/reservation/reservatio_step4_02_2.gif" border="0"></a> <img src="<%=imageServer%>/tour_img/reservation/reservatio_step4_03.gif"></td>
