...
if(chk_confirm.equals("2")){
	...
	//request parameters
	String depart_date 	= request.getParameter("depart_date");		//출발일
	String cust_nm 	= request.getParameter("cust_nm");		//성명
	String manage_no= request.getParameter("manage_no");	//주민번호

	if (depart_date.equals("") || cust_nm.equals("") || manage_no.equals("")){  //빈 폼인 경우
	%>
	    <script language="javascript">
	       alert("출발일 또는 성명 또는 주민번호를 입력하지 않았습니다.");
	       document.location.href="theone_srch1.jsp";
	    </script>
	<%   
	}
