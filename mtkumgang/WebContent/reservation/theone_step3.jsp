...
<script language="javascript">
	...
	function nextStep() {
		...
		if(start_ymd == "") {
			...
			if(goods_sid=="61"||goods_sid=="67"||goods_sid=="68"||goods_sid=="71"||goods_sid=="30"||goods_sid=="35") {
				document.resv.action = "theone_step5.jsp";	//인원등록화면으로 바로 이동.
			} else {	
				document.resv.action = "theone_step4.jsp";	//호텔|객실등급 선택화면
			}
	...
	function sel_day(day, weekend_yn) {
		...
		dv.innerHTML = "<span class=fs14>고객님의 <b>여행기간</b>은 </span><br><span class=pagingon>"+str_year+"년 "+str_month+"월 "+str_day+"일 부터 "+end_year+"년 "+end_month+"월 "+end_day+"일 까지</span><br>입니다";
							...
							<tr>
								<td align="center">
									<table cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" width="746" height="324">
										...
										<tr>
											<td class="fs14" style="padding:10 0 0 10"><a href="javascript:moveMonth(-1)">◀</a> <b><%=today_ymd.substring(0,4)%>년 <%=today_ymd.substring(4,6)%>월</b> <a href="javascript:moveMonth(1)">▶</a></td>
										</tr>
										<tr>
