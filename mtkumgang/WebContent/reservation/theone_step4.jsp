...
<script language="javascript">
	...
	function nextStep() {
		...
		if(sel_room_sid == "") {
			...
			document.resv.action = "theone_step5.jsp";
			document.resv.submit();
		}
	}
...
//		window.open("theone_step4_pop.jsp?upjang_sid="+upjang_sid+"&room_sid="+room_sid ,"info", "width=540, height=330");
	}
</script>
</head>
<body>
	...
	<tr>
		...
		<!--컨텐츠 시작-->
			<table cellpadding="0" cellspacing="0" width="770">
				<tr>	
					<td style="padding:31 0 19 27"><img src="<%=imageServer%>/reservation/img/theone_m_title_4.gif"></td>
				</tr>
				<tr>
					<td align="center">
