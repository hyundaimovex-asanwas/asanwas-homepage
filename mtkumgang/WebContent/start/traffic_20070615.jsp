				...
				<tr>
					<td>
						...
						<tr>
                            ...
                            <tr align="center"> 
                              <td width="38" height="26" class="bg_white">구간</td>
                              <td width="34" class="bg_white">지역</td>
                              <td width="37" class="bg_white">출발일</td>
                              <td width="65" class="bg_white">버스<br>
                                회사</td>
                              <td width="57" class="bg_white">연락처</td>
                              <td width="33" class="bg_white">출발<br>
                                시간</td>
                              <td width="250" class="bg_white">출발지</td>
                              <td width="72" class="bg_white">왕복요금<span class="fs11">(인)</span></td>
                              <td width="60" class="bg_white">약도</td>
                            </tr>
                            <tr align="center"> 
                              <td class="bg_white" rowspan="2">1박2일<br>
                                (11시)</td>
                              <td class="bg_white b" rowspan="2">서울</td>
                              <td class="bg_white" rowspan="2">매일</td>
                              <td class="bg_white" rowspan="2">대화<br>
                                관광</td>
                            ...
                            <tr align="center"> 
                              ...
                              <td class="bg_white lpad_5" align="left">종합운동장 6번출구 
                                GS편의점 앞</td>
                            ...
                            <tr align="center"> 
                              <td rowspan="2" class="bg_white">1박2일<br>
                                (8시)<br>
                                ㆍ<br>
                                당일 </td>
                              <td rowspan="2" class="bg_white b">서울</td>
                              <td rowspan="2" class="bg_white"><b>화,금,토</b> <p>화:당일<br>
                                  (수)관광</p>
                                <p>금:당일/<br>
                                  1박2일<br>
                                  (토)관광</p>
                                <p>토:당일<br>
                                  (일)관광</p></td>
                              <td rowspan="2" class="bg_white"><p>대원<br>
                                  관광</p>
                              ...
                              <td class="bg_white lpad_5" align="left">광화문 사거리 
                                서대문방향 70m 국민은행 앞<br> <img src="<%=imageServer%>/tour_img/start/date01.gif" width="240" height="170"> 
                              </td>
                            ...
                            <tr align="center"> 
                              ...
                              <td class="bg_white lpad_5" align="left">종합운동장 6번출구 
                                GS편의점 앞<br> <img src="<%=imageServer%>/tour_img/start/date02.gif" width="240" height="170"> 
                              </td>
                              <td class="bg_white"><a href="javascript:;" onclick="window.open ('popup_map_jamsil.jsp', 'movieview', 'width=500,height=500,scrollbars=no,toolbar=no,location=no,directories=no,top=100,left=100,noresize');"><img src="<%=imageServer%>/tour_img/btn/btn_s_view.gif"></a> 
                                <!-- 보기 -->
                              </td>
                            ...
                            <tr align="center"> 
                              ...
                              <td class="bg_white" rowspan="2"><p>대화<br>
                                  관광</p>
