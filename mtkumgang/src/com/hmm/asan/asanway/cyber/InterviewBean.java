...
public class InterviewBean {
    ...
    private String dirName = WEBConstants.INTERVIEWUPLOADDIR;
    private int maxFileSize = WEBConstants.INTERVIEWUPLOADMAX;
    ...
    public void List(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            String totalQuery = ("select count(*) count from asan.notice where category = 'interview' and isdel = '0' ");
            ...
            String listQuery = "select idx, title,  summary, imgfile, sysimgfile, regtime, hit, status from asan.notice where category = 'interview' and isdel = '0' ";
    ...
    public int Insert(HttpServletRequest request, HttpServletResponse response) {
        //System.out.println("interview Insert");
    ...
    public void Read(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
             ...
             * 현재 게시물 내용 보기
             */
            beans = mdao.selectQuery("select idx, title, summary, content, hit, regtime, imgfile, sysimgfile from asan.notice where category= 'interview' and isdel = 0 and idx = '" + idx + "'");
