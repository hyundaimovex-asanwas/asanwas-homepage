 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class QnABoard  extends DAOHome{
    ...
    public Tbrd_board_ma_bean[] getList(int pageSize, int requestedPage, String part, String keyword, String orderBy ) throws  Exception{
        ...
        if(chk_page > 0){
	        ...
	        query.append(" 		( SELECT BOARD_SEQ from asan.TBRD_BOARD_MA WHERE BOARD_TYPE = '07' AND USE_YN='1' \n");
	        query.append(          subSql              );
	        ...
	        query.append("       ) as tmp       ");
	        query.append(" ) AND \n");
	        query.append(" BOARD_TYPE = '07' AND USE_YN='1'  \n");
	        query.append(subSql);
	        query.append(orderbySql);
	        ...
	        query.append(" WHERE BOARD_TYPE = '07' AND USE_YN='1'  \n");
	        query.append(subSql);			
	        query.append(orderbySql);
        	query.append(" FETCH FIRST "+pageSize+" ROWS ONLY  \n");
        }
     ...
     */
	 ...
	 public Tbrd_board_ma_bean [] getPrevAndNextBoard(int board_seq) throws DbException , Exception {
		...
		sql.append(" WHERE BOARD_TYPE ='07' and USE_YN='1' and BOARD_SEQ = ?			");
