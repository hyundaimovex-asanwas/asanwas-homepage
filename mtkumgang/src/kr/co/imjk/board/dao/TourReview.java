 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TourReview  extends DAOHome{ 
    ...
    public Tbrd_board_ma_bean[] getList(int requestedPage, int pageSize, String part, String keyword ) throws  Exception{
        ...
        query.append(" SELECT RowNum as RNUM, X.* FROM ( \n"); 
        query.append(" SELECT BOARD_SEQ, REF_NO , LEVEL_NO , SORT_NO , TITLE,  \n");
    	query.append(" CONTENT, USER_ID , USER_NAME, USE_YN, \n");
    	query.append(" BOARD_TOP_NO , READ_NUM , REG_DATE, BEST, RECOMM_NUM \n");
    	query.append(" from asan.TBRD_BOARD_MA  \n");
    	query.append(" where board_type='01'  and USE_YN = '1' \n");
    	query.append(subSql)			;
    	query.append(" order by REF_NO DESC,SORT_NO, LEVEL_NO , BOARD_SEQ DESC, BOARD_TOP_NO \n");
    	query.append("      ) X \n");
        query.append(" ) X1 \n");
        query.append("WHERE X1.RNum > "+ (requestedPage-1)*pageSize +" and X1.RNum <= "+ requestedPage*pageSize +" \n");
        ...
        if(chk_page > 0){      
	        ...
	        .append(" 		( select board_seq from asan.TBRD_BOARD_MA where board_type='01' and USE_YN = '1' \n")
	        .append(subSql)			
	        ...
	        .append(" as tmp ) and \n")
	        .append(" board_type='01'  and USE_YN = '1' \n")
	        .append(subSql)	
	        .append(" order by REF_NO DESC,SORT_NO, LEVEL_NO , BOARD_SEQ DESC, BOARD_TOP_NO ")
        	...
        	.append(" where board_type='01'  and USE_YN = '1' \n")
        	.append(subSql)			
        	.append(" order by REF_NO DESC,SORT_NO, LEVEL_NO , BOARD_SEQ DESC, BOARD_TOP_NO \n")
    ...
    public Tbrd_board_ma_bean[] getFrontList(int requestedPage, int pageSize, String part, String keyword ) throws  Exception{
        ...
        query.append(" SELECT BOARD_SEQ, REF_NO , LEVEL_NO , SORT_NO , TITLE,  \n");
    	query.append(" CONTENT, USER_ID , USER_NAME, USE_YN, \n");
    	query.append(" BOARD_TOP_NO , READ_NUM , REG_DATE, BEST, RECOMM_NUM, COMMENT_NUM \n");
    	query.append(" from asan.TBRD_BOARD_MA  \n");
    	query.append(" where board_type='01'  and USE_YN = '1' \n");
    	query.append(subSql)			;
    	query.append(" order by REF_NO DESC,SORT_NO, LEVEL_NO , BOARD_SEQ DESC, BOARD_TOP_NO \n");
        ...
        throws DbException , Exception 
    {
		...
		String query = new StringBuffer()
			...
			.append(" REF_NO , LEVEL_NO , SORT_NO , TITLE,		")
			.append(" CONTENT, USER_ID , USER_NICK, USE_YN,					")
			.append(" BOARD_TOP_NO , READ_NUM , REG_DATE FROM (			")
			.append(" SELECT												")
			.append(" REF_NO , LEVEL_NO , SORT_NO , TITLE,		")
			.append(" CONTENT, USER_ID , USER_NICK, USE_YN,					")
			.append(" BOARD_TOP_NO , READ_NUM , REG_DATE					")
			.append(" FROM asan.TBRD_BOARD_MA									")
			.append(" WHERE board_type='01' and USE_YN = '1' AND BEST = '1'		")
        	.append(" ORDER BY BOARD_SEQ DESC ")
        	.append(" ) A WHERE rownum < 2 ").toString(); 
        try {         
            pstmt = dbconn.prepareStatement(query);
            // 변수 바인딩
        ...
        throws DbException , Exception 
    {
        ...
        updateSql.append(" WHERE REF_NO=? AND SORT_NO > ? AND BOARD_TYPE = '01' ").toString();;
     ...
     */
	 ...
	 public Tbrd_board_ma_bean [] getPrevAndNextBoard(int board_seq) throws DbException , Exception {
		...
		sql.append(" WHERE BOARD_TYPE ='01' AND USE_YN='1' and BOARD_SEQ = ?							");
