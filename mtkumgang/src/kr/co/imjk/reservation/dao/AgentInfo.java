...
// 2010-03-26 	원래건 대북관광대리점만 검색 AGEN_GU IN ('4','5')
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AgentInfo  extends DAOHome{
    ...
    public Agent_bean[] getAgentList(String area_cd , String keyword, String part) throws  Exception{
       ...
       //SQL  
        String sql = new StringBuffer()
            ...
            .append("  WHERE client_gu='1' and use_yn='Y' AND AGEN_GU IN ('4','5')   \n")
	        .append(subSql)
	        .append(subSql1)			
        ...
        try {
            ...
            // 결과 담기
			//System.out.println("just infoSQL="+sql);
